...
const content = `<path class="l4rdon97u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:traffic-outline" /></template>
<style>
.l4rdon97u {
  fill: currentColor;
