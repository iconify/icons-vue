...
const content = `<circle class="cpk0fnbgt"/><path class="k1p9zn2ba"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tecka" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
