...
const content = `<path class="mliqtsbmc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-unread-20-regular" /></template>
<style>
.mliqtsbmc {
  fill: currentColor;
