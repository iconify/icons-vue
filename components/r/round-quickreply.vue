...
const content = `<path class="c-50wubap"/><path class="diw9kacno"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-quickreply" /></template>
<style>
.c-50wubap {
  fill: currentColor;
