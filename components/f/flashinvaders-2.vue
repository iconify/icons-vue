...
const content = `<rect class="jc1oydeao"/><path class="r52trebrd"/><path class="sc8shdbnj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:flashinvaders-2" /></template>
<style>
.jc1oydeao {
  width: 39px;
  height: 31px;
...
.sc8shdbnj {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m16.53 20.77l3.092.035v5.681l-3.092.036zm11.653.075l3.092.036v5.68l-3.092.036z");
}
