...
const content = `<path class="jupl0bbhy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sports-and-outdoors-outline-rounded" /></template>
<style>
.jupl0bbhy {
  fill: currentColor;
