...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="rk0603btk"/><path class="dhf6_i89b"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:money-note-circle" /></template>
<style>
.dhf6_i89b {
