...
const content = `<path class="yhmii4x-u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:filter-drama-rounded" /></template>
<style>
.yhmii4x-u {
  fill: currentColor;
