...
const content = `<path class="muw_7abqj"/><path class="sumapfbut"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-web-asset-off" /></template>
<style>
.muw_7abqj {
  fill: currentColor;
