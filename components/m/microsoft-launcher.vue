...
const content = `<path class="ap407vyjn"/><path class="mnorxrhlo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:microsoft-launcher" /></template>
<style>
.ap407vyjn {
  fill: none;
  stroke: currentColor;
