...
const content = `<path class="i9clfwm2k"/><rect class="n9k_5mebz"/><path class="m7b-5tb2t"/><rect class="tycctcc5m"/><path class="ghm2g9bvn"/><path class="fav0c8b9g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:widgetable" /></template>
<style>
.fav0c8b9g {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M22.643 29.85v1.69h2.714v-1.69");
}
