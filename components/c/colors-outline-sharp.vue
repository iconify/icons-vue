...
const content = `<path class="s15-9-g5u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:colors-outline-sharp" /></template>
<style>
.s15-9-g5u {
  fill: currentColor;
