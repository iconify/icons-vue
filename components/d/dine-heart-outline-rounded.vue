...
const content = `<path class="luv7ifbzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dine-heart-outline-rounded" /></template>
<style>
.luv7ifbzh {
  fill: currentColor;
