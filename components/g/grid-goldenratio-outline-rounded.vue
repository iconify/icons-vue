...
const content = `<path class="ebepk12xa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:grid-goldenratio-outline-rounded" /></template>
<style>
.ebepk12xa {
  fill: currentColor;
