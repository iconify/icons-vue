...
const content = `<g class="nrj6p8qat"><path class="c2k-m-3ae"/><path class="bh7yztb1g"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:message-square-two-tone" /></template>
<style>
.bh7yztb1g {
