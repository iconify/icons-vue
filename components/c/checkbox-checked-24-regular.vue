...
const content = `<path class="si8lgrdvs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:checkbox-checked-24-regular" /></template>
<style>
.si8lgrdvs {
  fill: currentColor;
