...
const content = `<path class="dvip71sgs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screen-share-outline" /></template>
<style>
.dvip71sgs {
  fill: currentColor;
