...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="openmoji:hand-with-index-finger-and-thumb-crossed-medium-skin-tone" /></template>
