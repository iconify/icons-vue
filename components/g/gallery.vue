...
const content = `<path class="rw6tfwchs"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gallery" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
