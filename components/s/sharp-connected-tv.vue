...
const content = `<path class="g-swdpb8u"/><path class="f8ds4-b2j"/><path class="r0xmiylwe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-connected-tv" /></template>
<style>
.f8ds4-b2j {
  fill: currentColor;
