...
const content = `<path class="glq9-8bco"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-7-32-filled" /></template>
<style>
.glq9-8bco {
  fill: currentColor;
