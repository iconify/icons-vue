...
const content = `<path class="l8_7j5bsz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dr-web" /></template>
<style>
.l8_7j5bsz {
  fill: none;
  stroke: currentColor;
