...
const content = `<path class="jjx0zcbii"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-simple-checkmark-28-regular" /></template>
<style>
.jjx0zcbii {
  fill: currentColor;
