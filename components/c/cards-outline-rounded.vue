...
const content = `<path class="qomt5qbgu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cards-outline-rounded" /></template>
<style>
.qomt5qbgu {
  fill: currentColor;
