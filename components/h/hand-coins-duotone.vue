...
const content = `<g class="cuyn6tgcc"><path class="q8b8gz2in"/><path class="yawh7zbhm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:hand-coins-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
