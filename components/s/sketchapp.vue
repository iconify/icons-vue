...
const content = `<circle class="v6_s_250k"/><path class="vacibb3-a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:sketchapp" /></template>
<style>
.v6_s_250k {
  cx: 128px;
  cy: 128px;
