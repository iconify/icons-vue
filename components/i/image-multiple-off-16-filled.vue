...
const content = `<path class="nk-oxrbuo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-multiple-off-16-filled" /></template>
<style>
.nk-oxrbuo {
  fill: currentColor;
