...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="a5r0_s7lj"/><path class="wib5uabwc"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:loop-minus-circle" /></template>
<style>
.a5r0_s7lj {
  fill-rule: evenodd;
