...
const content = `<path class="pgzuebbed"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:play-pause-outline-rounded" /></template>
<style>
.pgzuebbed {
  fill: currentColor;
