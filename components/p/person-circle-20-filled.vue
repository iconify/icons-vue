...
const content = `<path class="vlo0f9blk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-circle-20-filled" /></template>
<style>
.vlo0f9blk {
  fill: currentColor;
