...
const content = `<path class="s8j3vgb4d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:call-received-rounded" /></template>
<style>
.s8j3vgb4d {
  fill: currentColor;
