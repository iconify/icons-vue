...
const content = `<path class="gpxndnb-u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-image-break-right-rounded" /></template>
<style>
.gpxndnb-u {
  fill: currentColor;
