...
const content = `<path class="uhi3ryb8j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-search-20-filled" /></template>
<style>
.uhi3ryb8j {
  fill: currentColor;
