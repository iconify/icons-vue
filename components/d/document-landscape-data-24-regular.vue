...
const content = `<path class="kvut2rvmh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-landscape-data-24-regular" /></template>
<style>
.kvut2rvmh {
  fill: currentColor;
