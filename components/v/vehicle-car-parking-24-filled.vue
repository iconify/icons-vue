...
const content = `<path class="i4y99ozkp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-car-parking-24-filled" /></template>
<style>
.i4y99ozkp {
  fill: currentColor;
