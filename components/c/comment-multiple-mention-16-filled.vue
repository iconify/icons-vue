...
const content = `<path class="mscvfcb-z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-multiple-mention-16-filled" /></template>
<style>
.mscvfcb-z {
  fill: currentColor;
