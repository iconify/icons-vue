...
const content = `<path class="nv32pvb9p"/><path class="blxortd8u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:nginx" /></template>
<style>
.blxortd8u {
