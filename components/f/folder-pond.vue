...
const content = `<path class="h0qgeuwow"/><path class="x883ttbsb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:folder-pond" /></template>
<style>
.h0qgeuwow {
  fill: none;
  stroke: currentColor;
