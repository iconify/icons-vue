...
const content = `<path class="k-wul_bec"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:artflow" /></template>
<style>
.k-wul_bec {
  fill: none;
  stroke: currentColor;
