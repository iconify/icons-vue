...
const content = `<path class="ujiybcczk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:thumbs-up-sharp-fill" /></template>
<style>
.ujiybcczk {
  fill: currentColor;
