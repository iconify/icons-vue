...
const content = `<path class="fw1c15b4d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-sim-card-download" /></template>
<style>
.fw1c15b4d {
  fill: currentColor;
