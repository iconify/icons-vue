...
const content = `<path class="bsbwcx51z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:blackberrysupportcenter" /></template>
<style>
.bsbwcx51z {
  fill: none;
  stroke: currentColor;
