...
const content = `<path class="gvpzxdbes"/><path class="abbsc_-2x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-qr-code" /></template>
<style>
.abbsc_-2x {
  fill: currentColor;
