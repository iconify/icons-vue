...
const content = `<path class="yskyyeehl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:group-add-rounded" /></template>
<style>
.yskyyeehl {
  fill: currentColor;
