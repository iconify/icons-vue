...
const content = `<circle class="cpk0fnbgt"/><rect class="yi_-_1bee"/><path class="za8jycb2m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:android-12-u-for-kwgt" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
