...
const content = `<path class="i-y1-vbiz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:yamap-social-trekking" /></template>
<style>
.i-y1-vbiz {
  fill: none;
  stroke: currentColor;
