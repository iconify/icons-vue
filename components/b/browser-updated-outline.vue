...
const content = `<path class="q1q1gvb6o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:browser-updated-outline" /></template>
<style>
.q1q1gvb6o {
  fill: currentColor;
