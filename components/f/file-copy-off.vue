...
const content = `<path class="z0jul06jl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:file-copy-off" /></template>
<style>
.z0jul06jl {
  fill: currentColor;
