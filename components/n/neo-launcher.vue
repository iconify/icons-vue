...
const content = `<path class="p8t2csbzk"/><path class="fa1heb6_x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:neo-launcher" /></template>
<style>
.fa1heb6_x {
  fill: none;
  stroke: currentColor;
