...
const content = `<path class="psmmytbzd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hotel-class-sharp" /></template>
<style>
.psmmytbzd {
  fill: currentColor;
