...
const content = `<path class="mm88lwa2m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:walk-bike-outline" /></template>
<style>
.mm88lwa2m {
  fill: currentColor;
