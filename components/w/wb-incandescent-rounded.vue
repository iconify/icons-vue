...
const content = `<path class="lhtdhgnne"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wb-incandescent-rounded" /></template>
<style>
.lhtdhgnne {
  fill: currentColor;
