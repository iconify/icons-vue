...
const content = `<path class="bqdp-2klb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-border-20-filled" /></template>
<style>
.bqdp-2klb {
  fill: currentColor;
