...
const content = `<path class="evx6b-boq"/><path class="ai9s8sb_e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:norton-lifelock-identity" /></template>
<style>
.ai9s8sb_e {
  fill: none;
  stroke: currentColor;
