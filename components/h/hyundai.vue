...
const content = `<path class="ob4_xbb3o"/><ellipse class="c70y4bb7g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hyundai" /></template>
<style>
.c70y4bb7g {
  cx: 24px;
  cy: 24px;
