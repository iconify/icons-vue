...
const content = `<path class="f9seoblxt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:assistant-direction-rounded" /></template>
<style>
.f9seoblxt {
  fill: currentColor;
