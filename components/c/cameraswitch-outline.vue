...
const content = `<path class="v5s86tq7x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cameraswitch-outline" /></template>
<style>
.v5s86tq7x {
  fill: currentColor;
