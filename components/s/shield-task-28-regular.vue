...
const content = `<path class="dve7_vrmk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-task-28-regular" /></template>
<style>
.dve7_vrmk {
  fill: currentColor;
