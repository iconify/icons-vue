...
const content = `<path class="yz424mbfo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screen-rotation-alt" /></template>
<style>
.yz424mbfo {
  fill: currentColor;
