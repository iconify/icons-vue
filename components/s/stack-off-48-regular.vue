...
const content = `<path class="ep3588b8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:stack-off-48-regular" /></template>
<style>
.ep3588b8v {
  fill: currentColor;
