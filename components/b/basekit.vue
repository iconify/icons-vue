...
const viewBox = {"width":256,"height":217};
const content = `<path class="epgj2sndf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:basekit" /></template>
<style>
.epgj2sndf {
  fill: var(--svg-color--02161f, #02161f);
