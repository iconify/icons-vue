...
const content = `<path class="tjplvxbqf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:game-bumper-left-rounded" /></template>
<style>
.tjplvxbqf {
  fill: currentColor;
