...
const content = `<path class="b-u6_l2jg"/><path class="mcio6uiyp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-post-add" /></template>
<style>
.b-u6_l2jg {
  fill: currentColor;
