...
const content = `<path class="uvboyxbap"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:free-fire-max" /></template>
<style>
.uvboyxbap {
  fill: none;
  stroke: currentColor;
