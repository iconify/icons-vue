...
const content = `<path class="b_6p4xbae"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cards-stack-rounded" /></template>
<style>
.b_6p4xbae {
  fill: currentColor;
