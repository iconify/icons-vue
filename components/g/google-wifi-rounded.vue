...
const content = `<path class="lvf3x8tzo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:google-wifi-rounded" /></template>
<style>
.lvf3x8tzo {
  fill: currentColor;
