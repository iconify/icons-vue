...
const content = `<path class="ii801jbgy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:highlight-text-cursor-outline-rounded" /></template>
<style>
.ii801jbgy {
  fill: currentColor;
