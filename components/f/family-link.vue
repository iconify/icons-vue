...
const content = `<path class="wlxx2lbds"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:family-link" /></template>
<style>
.wlxx2lbds {
  fill: currentColor;
