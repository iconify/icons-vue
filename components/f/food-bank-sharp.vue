...
const content = `<path class="lj7o20men"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:food-bank-sharp" /></template>
<style>
.lj7o20men {
  fill: currentColor;
