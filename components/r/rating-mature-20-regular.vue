...
const content = `<path class="lhp22zb3p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:rating-mature-20-regular" /></template>
<style>
.lhp22zb3p {
  fill: currentColor;
