...
const content = `<path class="qcsw4r4sc"/><path class="gdpz_rbbn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-fossify-24" /></template>
<style>
.gdpz_rbbn {
  fill: none;
  stroke: currentColor;
