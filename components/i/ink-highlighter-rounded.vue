...
const content = `<path class="bvcfu1n9z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ink-highlighter-rounded" /></template>
<style>
.bvcfu1n9z {
  fill: currentColor;
