...
const content = `<g class="cuyn6tgcc"><path class="jx6oxdb-q"/><path class="grrd7kdwy"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:text-align-center-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
