...
const content = `<path class="h-p04lbnz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-header-arrow-up-20-regular" /></template>
<style>
.h-p04lbnz {
  fill: currentColor;
