...
const content = `<path class="g11-f5jcj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-hint-16-filled" /></template>
<style>
.g11-f5jcj {
  fill: currentColor;
