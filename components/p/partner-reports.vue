...
const content = `<path class="xou2fkb2c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:partner-reports" /></template>
<style>
.xou2fkb2c {
  fill: currentColor;
