...
const content = `<path class="m34x_vqnq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-add-24-regular" /></template>
<style>
.m34x_vqnq {
  fill: currentColor;
