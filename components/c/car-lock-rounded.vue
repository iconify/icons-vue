...
const content = `<path class="ahamkfbfd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:car-lock-rounded" /></template>
<style>
.ahamkfbfd {
  fill: currentColor;
