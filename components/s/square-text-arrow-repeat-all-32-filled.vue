...
const content = `<path class="xunfwgbws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-text-arrow-repeat-all-32-filled" /></template>
<style>
.xunfwgbws {
  fill: currentColor;
