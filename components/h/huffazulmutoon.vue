...
const content = `<path class="rbmygyaws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:huffazulmutoon" /></template>
<style>
.rbmygyaws {
  fill: none;
  stroke: currentColor;
