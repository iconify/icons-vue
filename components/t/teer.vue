...
const content = `<g class="jcy56wb7h"><path class="h2h2-88_p"/><path class="tqxpk6bsc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:teer" /></template>
<style>
.h2h2-88_p {
  d: path("M20.381 5.812c.338 0 .619-.224.619-.562s-.281-.562-.619-.562H3.62c-.338 0-.619.224-.619.562s.225.562.563.562h7.874V18.75a.562.562 0 1 0 1.126 0V5.812z");
}

.jcy56wb7h {
  fill: var(--svg-color--000563, #000563);
}
