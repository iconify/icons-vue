...
const content = `<path class="iufmyzz5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:zap-duotone" /></template>
<style>
.iufmyzz5x {
  fill: none;
  stroke: currentColor;
