...
const content = `<path class="o68mh0zwm"/><path class="u5lf4zxyw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-video-stable" /></template>
<style>
.o68mh0zwm {
  fill: currentColor;
