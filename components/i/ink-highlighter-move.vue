...
const content = `<path class="t4i5ejjeo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ink-highlighter-move" /></template>
<style>
.t4i5ejjeo {
  fill: currentColor;
