...
const content = `<path class="m73ap_x8l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:camera-switch-24-regular" /></template>
<style>
.m73ap_x8l {
  fill: currentColor;
