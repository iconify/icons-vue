...
const content = `<path class="xrd5802fp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sq-mixpad" /></template>
<style>
.xrd5802fp {
  fill: none;
  stroke: currentColor;
