...
const content = `<path class="ni2bub5uu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:true-iservice" /></template>
<style>
.ni2bub5uu {
  fill: none;
  stroke: currentColor;
