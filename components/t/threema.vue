...
const content = `<path class="c79up9btt"/><circle class="bcofmaczm"/><circle class="xci3rjb6a"/><circle class="ff9qsyb5f"/><path class="vtpojk0cy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:threema" /></template>
<style>
.bcofmaczm {
  cx: 13.63px;
  cy: 40.6px;
