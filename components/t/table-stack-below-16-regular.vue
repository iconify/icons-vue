...
const content = `<path class="yi2o8ac0k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-stack-below-16-regular" /></template>
<style>
.yi2o8ac0k {
  fill: currentColor;
