...
const content = `<path class="ts7adeb7q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:other-houses" /></template>
<style>
.ts7adeb7q {
  fill: currentColor;
