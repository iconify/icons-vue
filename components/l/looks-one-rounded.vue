...
const content = `<path class="xqrldet9m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:looks-one-rounded" /></template>
<style>
.xqrldet9m {
  fill: currentColor;
