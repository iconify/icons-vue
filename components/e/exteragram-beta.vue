...
const content = `<circle class="cpk0fnbgt"/><path class="qvf8r5b7m"/><path class="y4_zhub-v"/><path class="uue68c1bj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:exteragram-beta" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
