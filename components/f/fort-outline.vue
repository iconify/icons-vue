...
const content = `<path class="vdwv_hr3x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fort-outline" /></template>
<style>
.vdwv_hr3x {
  fill: currentColor;
