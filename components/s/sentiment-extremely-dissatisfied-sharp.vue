...
const content = `<path class="m3kdsqc3x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sentiment-extremely-dissatisfied-sharp" /></template>
<style>
.m3kdsqc3x {
  fill: currentColor;
