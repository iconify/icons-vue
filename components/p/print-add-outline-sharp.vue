...
const content = `<path class="xaxang7xf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:print-add-outline-sharp" /></template>
<style>
.xaxang7xf {
  fill: currentColor;
