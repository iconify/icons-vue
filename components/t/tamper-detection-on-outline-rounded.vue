...
const content = `<path class="bjxb880bf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tamper-detection-on-outline-rounded" /></template>
<style>
.bjxb880bf {
  fill: currentColor;
