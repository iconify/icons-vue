...
const content = `<path class="a4hto6rhv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:network-wifi-3-bar-outline-sharp" /></template>
<style>
.a4hto6rhv {
  fill: currentColor;
