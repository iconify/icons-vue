...
const content = `<path class="nn88yebqs"/><path class="w7o-i1byk"/><path class="hs1_l2qhj"/><path class="ftgxv3bbb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-mauritius" /></template>
<style>
.ftgxv3bbb {
