...
const content = `<path class="q9ucc8xlp"/><circle class="ss8spzbmy"/><path class="tgjn83f7e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:company-portal" /></template>
<style>
.q9ucc8xlp {
  fill: none;
  stroke: currentColor;
