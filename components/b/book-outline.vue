...
const content = `<path class="u_av7wbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:book-outline" /></template>
<style>
.u_av7wbxi {
  fill: currentColor;
