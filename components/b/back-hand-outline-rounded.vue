...
const content = `<path class="wm5y1aciw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:back-hand-outline-rounded" /></template>
<style>
.wm5y1aciw {
  fill: currentColor;
