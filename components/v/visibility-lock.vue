...
const content = `<path class="mbamfsbgd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:visibility-lock" /></template>
<style>
.mbamfsbgd {
  fill: currentColor;
