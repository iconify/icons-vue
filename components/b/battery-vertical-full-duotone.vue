...
const content = `<g class="cuyn6tgcc"><path class="ichl0c_jx"/><path class="ppc1_sdxh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:battery-vertical-full-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
