...
const content = `<path class="uo1ul1vwu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:bell-simple-ringing-fill" /></template>
<style>
.uo1ul1vwu {
  fill: currentColor;
