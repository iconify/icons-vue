...
const content = `<path class="ikg84js2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-motorcycle-24-filled" /></template>
<style>
.ikg84js2k {
  fill: currentColor;
