...
const content = `<path class="e69pfu9yz"/><path class="oc6lpdnwg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:healthup" /></template>
<style>
.e69pfu9yz {
  fill: none;
  stroke: currentColor;
