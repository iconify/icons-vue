...
const content = `<path class="h8mv83bwb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mouse-rounded" /></template>
<style>
.h8mv83bwb {
  fill: currentColor;
