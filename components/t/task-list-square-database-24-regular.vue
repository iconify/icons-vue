...
const content = `<path class="mqwjs4b6l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:task-list-square-database-24-regular" /></template>
<style>
.mqwjs4b6l {
  fill: currentColor;
