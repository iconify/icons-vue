...
const content = `<path class="q51fxnbks"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:brunch-dining-outline-sharp" /></template>
<style>
.q51fxnbks {
  fill: currentColor;
