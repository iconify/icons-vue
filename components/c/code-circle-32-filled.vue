...
const content = `<path class="x_ulmybxv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:code-circle-32-filled" /></template>
<style>
.x_ulmybxv {
  fill: currentColor;
