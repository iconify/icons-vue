...
const content = `<path class="baodtyzze"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calculator-multiple-16-filled" /></template>
<style>
.baodtyzze {
  fill: currentColor;
