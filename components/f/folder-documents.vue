...
const content = `<path class="h0qgeuwow"/><path class="wgih9pc1t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:folder-documents" /></template>
<style>
.h0qgeuwow {
  fill: none;
  stroke: currentColor;
