...
const content = `<path class="klek95cuf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:power-settings-circle-sharp" /></template>
<style>
.klek95cuf {
  fill: currentColor;
