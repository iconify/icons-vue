...
const content = `<path class="xkgxibbiy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-feedback-32-light" /></template>
<style>
.xkgxibbiy {
  fill: currentColor;
