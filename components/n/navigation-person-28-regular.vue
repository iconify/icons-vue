...
const content = `<path class="hith56bnr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:navigation-person-28-regular" /></template>
<style>
.hith56bnr {
  fill: currentColor;
