...
const content = `<path class="y9-kdr89l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:back-hand-outline" /></template>
<style>
.y9-kdr89l {
  fill: currentColor;
