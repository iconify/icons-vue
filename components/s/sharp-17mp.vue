...
const content = `<path class="b0vefmbhj"/><path class="k4n51fjcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-17mp" /></template>
<style>
.b0vefmbhj {
  fill: currentColor;
