...
const content = `<g class="cuyn6tgcc"><path class="fm-62acml"/><path class="ei6tmd95j"/><path class="icycv3bbh"/><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:wifi-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
