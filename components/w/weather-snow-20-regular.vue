...
const content = `<path class="g8a_0dbal"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-snow-20-regular" /></template>
<style>
.g8a_0dbal {
  fill: currentColor;
