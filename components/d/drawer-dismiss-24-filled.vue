...
const content = `<path class="agxy7hb9r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drawer-dismiss-24-filled" /></template>
<style>
.agxy7hb9r {
  fill: currentColor;
