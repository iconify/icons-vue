...
const content = `<path class="epduyqcxm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chair-umbrella-rounded" /></template>
<style>
.epduyqcxm {
  fill: currentColor;
