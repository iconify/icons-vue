...
const content = `<path class="xp97wmbdf"/><path class="ynqbq5bbs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:celighting" /></template>
<style>
.xp97wmbdf {
  fill: none;
  stroke: currentColor;
