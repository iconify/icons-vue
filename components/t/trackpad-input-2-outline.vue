...
const content = `<path class="jhj-l9e0z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:trackpad-input-2-outline" /></template>
<style>
.jhj-l9e0z {
  fill: currentColor;
