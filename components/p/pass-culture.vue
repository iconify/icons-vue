...
const content = `<path class="zoxkmh-wy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pass-culture" /></template>
<style>
.zoxkmh-wy {
  fill: none;
  stroke: currentColor;
