...
const content = `<path class="e_w9hqbjv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:reset-exposure-outline" /></template>
<style>
.e_w9hqbjv {
  fill: currentColor;
