...
const content = `<path class="xt__lld1g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:parent-child-dining-outline" /></template>
<style>
.xt__lld1g {
  fill: currentColor;
