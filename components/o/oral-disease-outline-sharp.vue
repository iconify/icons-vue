...
const content = `<path class="qy3g766mi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:oral-disease-outline-sharp" /></template>
<style>
.qy3g766mi {
  fill: currentColor;
