...
const content = `<path class="icumjjbqo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:calendar-view-week-outline-rounded" /></template>
<style>
.icumjjbqo {
  fill: currentColor;
