...
const content = `<path class="v8w2eacgw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:book-rounded" /></template>
<style>
.v8w2eacgw {
  fill: currentColor;
