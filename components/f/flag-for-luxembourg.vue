...
const content = `<path class="t76_qd-2z"/><path class="xmwf8-bmx"/><path class="gjp-xhbgq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-luxembourg" /></template>
<style>
.gjp-xhbgq {
