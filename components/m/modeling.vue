...
const content = `<path class="h44pmbc4a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:modeling" /></template>
<style>
.h44pmbc4a {
  fill: currentColor;
