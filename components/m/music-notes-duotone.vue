...
const content = `<g class="cuyn6tgcc"><path class="lw-000x2o"/><path class="ol-mgyh9x"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:music-notes-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
