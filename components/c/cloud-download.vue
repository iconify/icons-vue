...
const content = `<path class="jphxtcb3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloud-download" /></template>
<style>
.jphxtcb3l {
  fill: currentColor;
