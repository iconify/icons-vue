...
const content = `<path class="ok0n06bth"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:lightbulb-28-regular" /></template>
<style>
.ok0n06bth {
  fill: currentColor;
