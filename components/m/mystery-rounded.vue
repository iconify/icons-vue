...
const content = `<path class="n7tuntbsl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mystery-rounded" /></template>
<style>
.n7tuntbsl {
  fill: currentColor;
