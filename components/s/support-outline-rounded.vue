...
const content = `<path class="qy4t45age"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:support-outline-rounded" /></template>
<style>
.qy4t45age {
  fill: currentColor;
