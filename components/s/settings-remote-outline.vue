...
const content = `<path class="oxqm9ybxq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-remote-outline" /></template>
<style>
.oxqm9ybxq {
  fill: currentColor;
