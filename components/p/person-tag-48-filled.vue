...
const content = `<path class="xridx3bjj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-tag-48-filled" /></template>
<style>
.xridx3bjj {
  fill: currentColor;
