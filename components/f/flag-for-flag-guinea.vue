...
const content = `<path class="fohd6dqnc"/><path class="ri605c5ot"/><path class="jivigcjut"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-guinea" /></template>
<style>
.fohd6dqnc {
