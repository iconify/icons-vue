...
const content = `<path class="mgqee7a1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:airline-seat-flat-angled-outline-sharp" /></template>
<style>
.mgqee7a1m {
  fill: currentColor;
