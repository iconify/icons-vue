...
const content = `<path class="agmoftj-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:hard-drive-28-filled" /></template>
<style>
.agmoftj-g {
  fill: currentColor;
