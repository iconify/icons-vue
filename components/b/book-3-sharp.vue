...
const content = `<path class="m542yft4w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:book-3-sharp" /></template>
<style>
.m542yft4w {
  fill: currentColor;
