...
const content = `<path class="izh-56iaf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:globe-clock" /></template>
<style>
.izh-56iaf {
  fill: currentColor;
