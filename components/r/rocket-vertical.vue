...
const content = `<path class="pjskkj_tw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:rocket-vertical" /></template>
<style>
.pjskkj_tw {
  fill: none;
  stroke: currentColor;
