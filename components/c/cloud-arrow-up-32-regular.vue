...
const content = `<path class="r5k8ou6rf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-arrow-up-32-regular" /></template>
<style>
.r5k8ou6rf {
  fill: currentColor;
