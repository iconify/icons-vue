...
const content = `<circle class="hzzz1jv6x"/><g class="n1mjunbsu"><path class="jq25ehbhr"/><path class="xpgxgacrc"/><path class="nhijxpb7z"/><path class="wmjgukcrx"/><path class="xuum2bd5u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-saudi-arabia" /></template>
<style>
.hzzz1jv6x {
  cx: 32px;
  cy: 32px;
