...
const content = `<path class="xu_bhwaeb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:priority-high-rounded" /></template>
<style>
.xu_bhwaeb {
  fill: currentColor;
