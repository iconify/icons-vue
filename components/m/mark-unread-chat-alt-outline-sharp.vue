...
const content = `<path class="rmzz7obqv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mark-unread-chat-alt-outline-sharp" /></template>
<style>
.rmzz7obqv {
  fill: currentColor;
