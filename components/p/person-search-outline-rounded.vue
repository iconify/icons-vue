...
const content = `<path class="gjulsrbzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:person-search-outline-rounded" /></template>
<style>
.gjulsrbzh {
  fill: currentColor;
