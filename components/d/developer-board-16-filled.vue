...
const content = `<path class="e175pl24f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:developer-board-16-filled" /></template>
<style>
.e175pl24f {
  fill: currentColor;
