...
const content = `<path class="rllg4jbeh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-in-default-20-regular" /></template>
<style>
.rllg4jbeh {
  fill: currentColor;
