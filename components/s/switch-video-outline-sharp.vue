...
const content = `<path class="oz6dnlkwp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:switch-video-outline-sharp" /></template>
<style>
.oz6dnlkwp {
  fill: currentColor;
