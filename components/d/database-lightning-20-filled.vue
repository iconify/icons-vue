...
const content = `<path class="bkrft4tst"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:database-lightning-20-filled" /></template>
<style>
.bkrft4tst {
  fill: currentColor;
