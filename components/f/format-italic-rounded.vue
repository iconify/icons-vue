...
const content = `<path class="g-bdycc_y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-italic-rounded" /></template>
<style>
.g-bdycc_y {
  fill: currentColor;
