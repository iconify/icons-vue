...
const content = `<path class="tr5_wcbtk"/><defs><path id="SVGWj2HCcSM" class="k0zim5bgm"/></defs><clipPath id="SVGhSdoVdxD"><use href="#SVGWj2HCcSM"/></clipPath><path clip-path="url(#SVGhSdoVdxD)" class="bv5c2ibwv"/><defs><use href="#SVGWj2HCcSM" id="SVGt5NmHeUS"/></defs><clipPath id="SVGKUt7mcPv"><use href="#SVGt5NmHeUS"/></clipPath><path clip-path="url(#SVGKUt7mcPv)" class="bov79unqc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:index-pointing-up-medium-light-skin-tone" /></template>
<style>
.bov79unqc {
