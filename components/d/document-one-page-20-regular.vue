...
const content = `<path class="cys0_xbyi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-one-page-20-regular" /></template>
<style>
.cys0_xbyi {
  fill: currentColor;
