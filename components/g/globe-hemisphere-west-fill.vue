...
const content = `<path class="c9n5lq75j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:globe-hemisphere-west-fill" /></template>
<style>
.c9n5lq75j {
  fill: currentColor;
