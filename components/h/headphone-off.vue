...
const content = `<g class="cuyn6tgcc"><path class="ngxdn5ure"/><path class="za5ig0byw"/><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:headphone-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
