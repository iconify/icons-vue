...
const content = `<path class="tbgg1hewu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:unfold-less-double-outline-sharp" /></template>
<style>
.tbgg1hewu {
  fill: currentColor;
