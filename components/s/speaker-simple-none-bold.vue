...
const content = `<path class="ezuom-15v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:speaker-simple-none-bold" /></template>
<style>
.ezuom-15v {
  fill: currentColor;
