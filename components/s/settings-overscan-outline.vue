...
const content = `<path class="jb5ini4qb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-overscan-outline" /></template>
<style>
.jb5ini4qb {
  fill: currentColor;
