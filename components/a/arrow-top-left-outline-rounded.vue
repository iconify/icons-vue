...
const content = `<path class="yjdc53bix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-top-left-outline-rounded" /></template>
<style>
.yjdc53bix {
  fill: currentColor;
