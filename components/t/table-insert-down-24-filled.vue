...
const content = `<path class="r9uvx5b4g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-insert-down-24-filled" /></template>
<style>
.r9uvx5b4g {
  fill: currentColor;
