...
const content = `<path class="b930okb8k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:bust-in-silhouette" /></template>
<style>
.b930okb8k {
