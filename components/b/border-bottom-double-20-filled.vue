...
const content = `<path class="wk1vw805e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-bottom-double-20-filled" /></template>
<style>
.wk1vw805e {
  fill: currentColor;
