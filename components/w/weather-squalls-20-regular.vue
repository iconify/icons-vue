...
const content = `<path class="b9c7-rblg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-squalls-20-regular" /></template>
<style>
.b9c7-rblg {
  fill: currentColor;
