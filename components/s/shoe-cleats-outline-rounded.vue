...
const content = `<path class="fmwmdy5va"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shoe-cleats-outline-rounded" /></template>
<style>
.fmwmdy5va {
  fill: currentColor;
