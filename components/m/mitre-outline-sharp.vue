...
const content = `<path class="ep474mtsi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mitre-outline-sharp" /></template>
<style>
.ep474mtsi {
  fill: currentColor;
