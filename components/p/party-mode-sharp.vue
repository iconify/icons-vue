...
const content = `<path class="cveu0vb5j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:party-mode-sharp" /></template>
<style>
.cveu0vb5j {
  fill: currentColor;
