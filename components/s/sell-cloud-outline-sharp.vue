...
const content = `<path class="s3wdvccmy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sell-cloud-outline-sharp" /></template>
<style>
.s3wdvccmy {
  fill: currentColor;
