...
const content = `<path class="l65pn3-yu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:paint-brush-subtract-28-regular" /></template>
<style>
.l65pn3-yu {
  fill: currentColor;
