...
const content = `<path class="ynmu9iyer"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vertical-distribute-rounded" /></template>
<style>
.ynmu9iyer {
  fill: currentColor;
