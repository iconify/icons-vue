...
const content = `<g class="cuyn6tgcc"><path class="sky9_jb5a"/><path class="iim3yabax"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:swimming-pool-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
