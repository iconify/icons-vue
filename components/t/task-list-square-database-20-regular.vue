...
const content = `<path class="t3t860bbz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:task-list-square-database-20-regular" /></template>
<style>
.t3t860bbz {
  fill: currentColor;
