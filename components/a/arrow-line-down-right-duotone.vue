...
const content = `<g class="cuyn6tgcc"><path class="qo0hq7bkk"/><path class="hohzx5b_l"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-line-down-right-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
