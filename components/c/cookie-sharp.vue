...
const content = `<path class="vdjsdlbjl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cookie-sharp" /></template>
<style>
.vdjsdlbjl {
  fill: currentColor;
