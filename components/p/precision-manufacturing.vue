...
const content = `<path class="ze6x00aaa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:precision-manufacturing" /></template>
<style>
.ze6x00aaa {
  fill: currentColor;
