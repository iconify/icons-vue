...
const content = `<g class="nrj6p8qat"><path class="aewu89bmt"/><path class="v674iq-1b"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:battery-low-two-tone" /></template>
<style>
.aewu89bmt {
  fill: currentColor;
