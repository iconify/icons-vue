...
const content = `<path class="fjbsftb-h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:passport-outline" /></template>
<style>
.fjbsftb-h {
  fill: currentColor;
