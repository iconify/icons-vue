...
const content = `<path class="knxk4vb9u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-work-week-28-filled" /></template>
<style>
.knxk4vb9u {
  fill: currentColor;
