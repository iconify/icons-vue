...
const content = `<path class="u_l5v5b8i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:privacy-tip-sharp" /></template>
<style>
.u_l5v5b8i {
  fill: currentColor;
