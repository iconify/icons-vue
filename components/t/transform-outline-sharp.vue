...
const content = `<path class="i-ggjj1hd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:transform-outline-sharp" /></template>
<style>
.i-ggjj1hd {
  fill: currentColor;
