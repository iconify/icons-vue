...
const content = `<path class="u4oza4b2f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bike-dock" /></template>
<style>
.u4oza4b2f {
  fill: currentColor;
