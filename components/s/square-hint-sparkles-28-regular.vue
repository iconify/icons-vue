...
const content = `<path class="o-af48b8i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-sparkles-28-regular" /></template>
<style>
.o-af48b8i {
  fill: currentColor;
