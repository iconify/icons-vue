...
const content = `<path class="x9sou5cat"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:question-exchange-outline-sharp" /></template>
<style>
.x9sou5cat {
  fill: currentColor;
