...
const content = `<path class="wtkzxl7fu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:video-frame-save-outline-rounded" /></template>
<style>
.wtkzxl7fu {
  fill: currentColor;
