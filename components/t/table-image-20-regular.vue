...
const content = `<path class="d_h6gibpp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-image-20-regular" /></template>
<style>
.d_h6gibpp {
  fill: currentColor;
