...
const content = `<path class="xt493fbfh"/><path class="yti64cb1n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-system-security-update" /></template>
<style>
.xt493fbfh {
  fill: currentColor;
