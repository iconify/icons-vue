...
const content = `<path class="ufi3njwsa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:delete-arrow-back-16-filled" /></template>
<style>
.ufi3njwsa {
  fill: currentColor;
