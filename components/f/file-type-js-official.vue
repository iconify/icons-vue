...
const content = `<path class="mk9t3jbai"/><path class="z7_gasbdq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-js-official" /></template>
<style>
.mk9t3jbai {
