...
const content = `<path class="pvdobww4b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fertile-outline-rounded" /></template>
<style>
.pvdobww4b {
  fill: currentColor;
