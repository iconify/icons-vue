...
const content = `<g class="nrj6p8qat"><path class="s-_3y1_8e"/><path class="o1cj845kj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:scan-text-two-tone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
