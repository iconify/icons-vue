...
const content = `<path class="gvq_a3q4t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:disroot" /></template>
<style>
.gvq_a3q4t {
  fill: none;
  stroke: currentColor;
