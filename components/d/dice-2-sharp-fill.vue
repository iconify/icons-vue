...
const content = `<path clip-rule="evenodd" class="ciwk1uokv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:dice-2-sharp-fill" /></template>
<style>
.ciwk1uokv {
  fill: currentColor;
  fill-rule: evenodd;
