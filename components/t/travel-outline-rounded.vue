...
const content = `<path class="we4jdj13e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:travel-outline-rounded" /></template>
<style>
.we4jdj13e {
  fill: currentColor;
