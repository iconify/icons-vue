...
const content = `<path class="pa2hi_6ca"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:table-outline-rounded" /></template>
<style>
.pa2hi_6ca {
  fill: currentColor;
