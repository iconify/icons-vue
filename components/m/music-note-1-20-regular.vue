...
const content = `<path class="qiqvm4b6j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:music-note-1-20-regular" /></template>
<style>
.qiqvm4b6j {
  fill: currentColor;
