...
const content = `<path class="co_aj7bjd"/><path class="tiiogib3e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:crex" /></template>
<style>
.co_aj7bjd {
  fill: none;
  stroke: currentColor;
