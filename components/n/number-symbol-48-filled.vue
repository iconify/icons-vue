...
const content = `<path class="m8odusmee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-symbol-48-filled" /></template>
<style>
.m8odusmee {
  fill: currentColor;
