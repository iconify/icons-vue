...
const content = `<path class="ad7q2_lmz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:create-new-folder-rounded" /></template>
<style>
.ad7q2_lmz {
  fill: currentColor;
