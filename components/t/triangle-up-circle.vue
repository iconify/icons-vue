...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="asxrf7cqm"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:triangle-up-circle" /></template>
<style>
.asxrf7cqm {
