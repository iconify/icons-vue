...
const content = `<g class="cuyn6tgcc"><path class="y3t1xhbwb"/><path class="dwli9uvuq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-off-24-regular" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.dwli9uvuq {
  d: path("M20.5 12c0 1.53-.404 2.966-1.112 4.206l1.094 1.094A9.95 9.95 0 0 0 22 12c0-5.523-4.477-10-10-10a9.95 9.95 0 0 0-5.3 1.518l1.094 1.094A8.5 8.5 0 0 1 20.5 12");
}
