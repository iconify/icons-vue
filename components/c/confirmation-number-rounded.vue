...
const content = `<path class="te6fesvvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:confirmation-number-rounded" /></template>
<style>
.te6fesvvo {
  fill: currentColor;
