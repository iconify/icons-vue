...
const content = `<path class="nh618bb8m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:meal-dinner-outline" /></template>
<style>
.nh618bb8m {
  fill: currentColor;
