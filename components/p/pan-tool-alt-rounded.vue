...
const content = `<path class="jcd5nob3v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pan-tool-alt-rounded" /></template>
<style>
.jcd5nob3v {
  fill: currentColor;
