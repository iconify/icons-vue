...
const content = `<path class="krmz_vv4m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-radar-rounded" /></template>
<style>
.krmz_vv4m {
  fill: currentColor;
