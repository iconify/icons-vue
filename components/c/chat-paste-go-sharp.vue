...
const content = `<path class="hce0lvbah"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chat-paste-go-sharp" /></template>
<style>
.hce0lvbah {
  fill: currentColor;
