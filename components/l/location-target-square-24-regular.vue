...
const content = `<path class="blbymubtv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-target-square-24-regular" /></template>
<style>
.blbymubtv {
  fill: currentColor;
