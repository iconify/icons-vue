...
const content = `<path class="thdm4llus"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-transmission-sharp" /></template>
<style>
.thdm4llus {
  fill: currentColor;
