...
const content = `<path class="uxcafdd3h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cell-center-16-regular" /></template>
<style>
.uxcafdd3h {
  fill: currentColor;
