...
.wca5i3bgg {
  d: path("M11.296 11.674c0-.395.32-.715.714-.715h8.571c.395 0 .715.32.715.715v8.57c0 .395-.32.715-.715.715H12.01a.714.714 0 0 1-.714-.714z");
}
