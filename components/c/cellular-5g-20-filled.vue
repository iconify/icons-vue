...
const content = `<path class="tclbb73he"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cellular-5g-20-filled" /></template>
<style>
.tclbb73he {
  fill: currentColor;
