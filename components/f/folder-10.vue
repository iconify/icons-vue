...
const content = `<path class="h0qgeuwow"/><path class="rme23obij"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:folder-10" /></template>
<style>
.h0qgeuwow {
  fill: none;
  stroke: currentColor;
