...
const content = `<path class="w7cyw3bdi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-nest-cam-wired-stand" /></template>
<style>
.w7cyw3bdi {
  fill: currentColor;
