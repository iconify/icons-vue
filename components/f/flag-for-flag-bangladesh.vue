...
const content = `<path class="uv87a1b1b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-flag-bangladesh" /></template>
<style>
.uv87a1b1b {
  fill: currentColor;
