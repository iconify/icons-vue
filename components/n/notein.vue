...
const content = `<path class="m_k_j-bmr"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:notein" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
