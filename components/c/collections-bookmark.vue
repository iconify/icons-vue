...
const content = `<path class="ul0g_5bwa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:collections-bookmark" /></template>
<style>
.ul0g_5bwa {
  fill: currentColor;
