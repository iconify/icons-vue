...
const content = `<path class="qnx05d3oz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tamper-detection-off-sharp" /></template>
<style>
.qnx05d3oz {
  fill: currentColor;
