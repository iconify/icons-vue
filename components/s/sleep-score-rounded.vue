...
const content = `<path class="qk0w7l8an"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sleep-score-rounded" /></template>
<style>
.qk0w7l8an {
  fill: currentColor;
