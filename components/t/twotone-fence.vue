...
const content = `<path class="qyxdx9bvb"/><path class="y6lcu3bsj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-fence" /></template>
<style>
.qyxdx9bvb {
  fill: currentColor;
