...
const content = `<path class="t5tc23yzt"/><path class="ifu-ee78w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:phonograph" /></template>
<style>
.ifu-ee78w {
  fill: none;
  stroke: currentColor;
