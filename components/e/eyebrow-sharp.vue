...
const content = `<path class="t--55gbgr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:eyebrow-sharp" /></template>
<style>
.t--55gbgr {
  fill: currentColor;
