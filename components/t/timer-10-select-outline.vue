...
const content = `<path class="janghotwc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:timer-10-select-outline" /></template>
<style>
.janghotwc {
  fill: currentColor;
