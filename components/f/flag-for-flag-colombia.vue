...
const content = `<path class="rj-y8llhr"/><path class="y51vjfbzm"/><path class="z2w88ujgm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-colombia" /></template>
<style>
.rj-y8llhr {
