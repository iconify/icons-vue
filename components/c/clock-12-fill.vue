...
const content = `<path clip-rule="evenodd" class="tzg4uzwts"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:clock-12-fill" /></template>
<style>
.tzg4uzwts {
  fill: currentColor;
  fill-rule: evenodd;
