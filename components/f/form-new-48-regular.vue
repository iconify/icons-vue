...
const content = `<path class="b1zxaqb3w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:form-new-48-regular" /></template>
<style>
.b1zxaqb3w {
  fill: currentColor;
