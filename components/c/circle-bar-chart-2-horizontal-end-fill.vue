...
const content = `<path clip-rule="evenodd" class="x2u4hqven"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-bar-chart-2-horizontal-end-fill" /></template>
<style>
.x2u4hqven {
  fill: currentColor;
  fill-rule: evenodd;
