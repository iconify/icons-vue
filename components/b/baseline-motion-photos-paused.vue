...
const content = `<path class="tletp5bcr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-motion-photos-paused" /></template>
<style>
.tletp5bcr {
  fill: currentColor;
