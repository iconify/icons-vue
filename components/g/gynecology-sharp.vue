...
const content = `<path class="snsx35bdh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gynecology-sharp" /></template>
<style>
.snsx35bdh {
  fill: currentColor;
