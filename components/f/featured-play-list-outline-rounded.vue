...
const content = `<path class="vbdtv35wb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:featured-play-list-outline-rounded" /></template>
<style>
.vbdtv35wb {
  fill: currentColor;
