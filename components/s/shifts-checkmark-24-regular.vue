...
const content = `<path class="hlvuclb1s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shifts-checkmark-24-regular" /></template>
<style>
.hlvuclb1s {
  fill: currentColor;
