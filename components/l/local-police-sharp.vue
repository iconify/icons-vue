...
const content = `<path class="r8aq2shys"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-police-sharp" /></template>
<style>
.r8aq2shys {
  fill: currentColor;
