...
const content = `<path class="hpuumt4_z"/><path class="gq39ifblq"/><path class="grrqyobhn"/><path class="c-ntt1b8g"/><path class="ut2d5ibrr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:older-adult-dark-skin-tone" /></template>
<style>
.c-ntt1b8g {
