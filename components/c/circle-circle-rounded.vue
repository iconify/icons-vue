...
const content = `<path class="s_ozw8dgs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:circle-circle-rounded" /></template>
<style>
.s_ozw8dgs {
  fill: currentColor;
