...
const content = `<path class="g79y6-bgf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-dismiss-32-filled" /></template>
<style>
.g79y6-bgf {
  fill: currentColor;
