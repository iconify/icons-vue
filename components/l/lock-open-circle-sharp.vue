...
const content = `<path class="bgzvtebtt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lock-open-circle-sharp" /></template>
<style>
.bgzvtebtt {
  fill: currentColor;
