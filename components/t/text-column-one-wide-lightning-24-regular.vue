...
const content = `<path class="ok3q25btk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-column-one-wide-lightning-24-regular" /></template>
<style>
.ok3q25btk {
  fill: currentColor;
