...
const content = `<path class="vzft8inuq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flashlight-on-outline-rounded" /></template>
<style>
.vzft8inuq {
  fill: currentColor;
