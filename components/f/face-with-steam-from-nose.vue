...
const content = `<path class="ngpmpqbbo"/><path class="q7_6racbg"/><path class="l_xyl8gdb"/><path class="pltvod1_y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:face-with-steam-from-nose" /></template>
<style>
.l_xyl8gdb {
  fill: var(--svg-color--f5f8fa, #f5f8fa);
  d: path("M15.391 20.08a1 1 0 0 0-1.239.39l-5 8A1 1 0 0 0 10 30h3a1 1 0 0 0 .97-.758l2-8a1 1 0 0 0-.579-1.162m11.457 8.39l-5-8a.998.998 0 0 0-1.817.772l2 8c.111.446.51.758.969.758h3a1 1 0 0 0 .848-1.53");
}
