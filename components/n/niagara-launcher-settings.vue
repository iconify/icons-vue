...
const content = `<path class="nfcns186s"/><path class="p66hbe72u"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:niagara-launcher-settings" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
