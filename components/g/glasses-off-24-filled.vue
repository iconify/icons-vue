...
const content = `<path class="v-apzua3y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:glasses-off-24-filled" /></template>
<style>
.v-apzua3y {
  fill: currentColor;
