...
const content = `<path class="ueqiyibmc"/><circle class="p-2qbob1x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:sun" /></template>
<style>
.p-2qbob1x {
  cx: 32px;
  cy: 32px;
