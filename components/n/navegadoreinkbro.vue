...
const content = `<circle class="cpk0fnbgt"/><path class="i9vw3qbpa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:navegadoreinkbro" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
