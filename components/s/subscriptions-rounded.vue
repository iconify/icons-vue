...
const content = `<path class="ctcm3ugng"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:subscriptions-rounded" /></template>
<style>
.ctcm3ugng {
  fill: currentColor;
