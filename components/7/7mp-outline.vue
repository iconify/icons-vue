...
const content = `<path class="adj9lrbmk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:7mp-outline" /></template>
<style>
.adj9lrbmk {
  fill: currentColor;
