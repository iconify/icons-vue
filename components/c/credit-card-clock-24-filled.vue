...
const content = `<path class="b5lu179ab"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:credit-card-clock-24-filled" /></template>
<style>
.b5lu179ab {
  fill: currentColor;
