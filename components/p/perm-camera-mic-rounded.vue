...
const content = `<path class="c2b-3se8j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:perm-camera-mic-rounded" /></template>
<style>
.c2b-3se8j {
  fill: currentColor;
