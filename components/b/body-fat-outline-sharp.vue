...
const content = `<path class="n32ocrbto"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:body-fat-outline-sharp" /></template>
<style>
.n32ocrbto {
  fill: currentColor;
