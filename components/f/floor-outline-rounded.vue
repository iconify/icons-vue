...
const content = `<path class="roil36c4w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:floor-outline-rounded" /></template>
<style>
.roil36c4w {
  fill: currentColor;
