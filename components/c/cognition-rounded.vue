...
const content = `<path class="djdzo_6tb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cognition-rounded" /></template>
<style>
.djdzo_6tb {
  fill: currentColor;
