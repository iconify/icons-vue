...
const content = `<path class="syjae1b_p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fire-extinguisher-sharp" /></template>
<style>
.syjae1b_p {
  fill: currentColor;
