...
const content = `<path class="c55ld79rm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:globe-uk-outline-rounded" /></template>
<style>
.c55ld79rm {
  fill: currentColor;
