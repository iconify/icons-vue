...
const content = `<path class="hruo_abtq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lab-research-rounded" /></template>
<style>
.hruo_abtq {
  fill: currentColor;
