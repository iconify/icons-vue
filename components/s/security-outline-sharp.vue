...
const content = `<path class="rt5j9ksrx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:security-outline-sharp" /></template>
<style>
.rt5j9ksrx {
  fill: currentColor;
