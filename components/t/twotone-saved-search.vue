...
const content = `<path class="dnm3onb1d"/><path class="yxkhq_k1e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-saved-search" /></template>
<style>
.dnm3onb1d {
  fill: currentColor;
