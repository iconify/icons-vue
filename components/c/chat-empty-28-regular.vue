...
const content = `<path class="fzjyz8bjk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-empty-28-regular" /></template>
<style>
.fzjyz8bjk {
  fill: currentColor;
