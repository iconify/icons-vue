...
const content = `<path class="irjbj6bdk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-night-sight" /></template>
<style>
.irjbj6bdk {
  fill: currentColor;
