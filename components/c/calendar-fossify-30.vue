...
const content = `<path class="e01sr8btz"/><path class="gdpz_rbbn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-fossify-30" /></template>
<style>
.e01sr8btz {
  fill: none;
  stroke: currentColor;
