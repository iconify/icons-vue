...
const content = `<path class="zgvhk9jrg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:link-square-20-filled" /></template>
<style>
.zgvhk9jrg {
  fill: currentColor;
