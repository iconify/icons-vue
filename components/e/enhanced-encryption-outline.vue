...
const content = `<path class="g3_lm2bol"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:enhanced-encryption-outline" /></template>
<style>
.g3_lm2bol {
  fill: currentColor;
