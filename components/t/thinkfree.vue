...
const content = `<path class="jr4cddiiz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:thinkfree" /></template>
<style>
.jr4cddiiz {
  fill: none;
  stroke: currentColor;
