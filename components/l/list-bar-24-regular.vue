...
const content = `<path class="bs156tb1g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:list-bar-24-regular" /></template>
<style>
.bs156tb1g {
  fill: currentColor;
