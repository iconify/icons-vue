...
const content = `<path class="ngpmpqbbo"/><circle class="kj0pf60du"/><circle class="m6p13_k8l"/><path class="ji_k_ktap"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:smiling-face-with-smiling-eyes" /></template>
<style>
.ji_k_ktap {
