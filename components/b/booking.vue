...
const content = `<path class="fd5ejpbjq"/><path class="j6pveybsy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:booking" /></template>
<style>
.fd5ejpbjq {
  fill: none;
  stroke: currentColor;
