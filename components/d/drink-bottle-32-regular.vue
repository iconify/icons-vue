...
const content = `<path class="zyk0_821t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drink-bottle-32-regular" /></template>
<style>
.zyk0_821t {
  fill: currentColor;
