...
const content = `<path class="oz02r-bnm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-create-new-folder" /></template>
<style>
.oz02r-bnm {
  fill: currentColor;
