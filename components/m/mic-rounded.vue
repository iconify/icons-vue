...
const content = `<path class="ae6chwb2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mic-rounded" /></template>
<style>
.ae6chwb2k {
  fill: currentColor;
