...
const content = `<path class="v1visxxau"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-video-28-filled" /></template>
<style>
.v1visxxau {
  fill: currentColor;
