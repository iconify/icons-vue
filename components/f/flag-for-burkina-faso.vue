...
const content = `<path class="empvinbnb"/><path class="pq5wyac_p"/><path class="apezmub0d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-burkina-faso" /></template>
<style>
.apezmub0d {
