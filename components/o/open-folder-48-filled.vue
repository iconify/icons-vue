...
const content = `<path class="j5gso7bdq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:open-folder-48-filled" /></template>
<style>
.j5gso7bdq {
  fill: currentColor;
