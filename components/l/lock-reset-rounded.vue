...
const content = `<path class="yhzvrl7_d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lock-reset-rounded" /></template>
<style>
.yhzvrl7_d {
  fill: currentColor;
