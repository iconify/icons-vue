...
const content = `<path class="rqdwi9b4r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-24-regular" /></template>
<style>
.rqdwi9b4r {
  fill: currentColor;
