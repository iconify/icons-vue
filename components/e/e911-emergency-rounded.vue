...
const content = `<path class="kb9z6j27j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:e911-emergency-rounded" /></template>
<style>
.kb9z6j27j {
  fill: currentColor;
