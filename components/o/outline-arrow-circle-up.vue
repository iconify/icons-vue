...
const content = `<path class="v4ev5gbkq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-arrow-circle-up" /></template>
<style>
.v4ev5gbkq {
  fill: currentColor;
