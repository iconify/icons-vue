...
const content = `<path class="xa5l26bqw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-device-thermostat" /></template>
<style>
.xa5l26bqw {
  fill: currentColor;
