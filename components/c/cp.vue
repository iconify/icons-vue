...
const content = `<path class="v6p10vrys"/><path class="wyxcxvb0z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cp" /></template>
<style>
.v6p10vrys {
  fill: none;
  stroke: currentColor;
