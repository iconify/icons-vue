...
const content = `<path class="yiqhc7rth"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:water-drops-sharp" /></template>
<style>
.yiqhc7rth {
  fill: currentColor;
