...
const content = `<path class="ob79izbzi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:device-band" /></template>
<style>
.ob79izbzi {
  fill: currentColor;
