...
const content = `<path class="ui-rn8buy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:vpn-key-alert-outline-rounded" /></template>
<style>
.ui-rn8buy {
  fill: currentColor;
