...
const content = `<path class="k5awdz8dt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:directions-boat-outline-rounded" /></template>
<style>
.k5awdz8dt {
  fill: currentColor;
