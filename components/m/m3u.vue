...
const content = `<path class="yx-gxt2ba"/><path class="qgo1_rb9f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:m3u" /></template>
<style>
.qgo1_rb9f {
  fill: none;
  stroke: currentColor;
