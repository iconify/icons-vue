...
const content = `<path class="qq19zibfc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:edgesensor-low-outline-sharp" /></template>
<style>
.qq19zibfc {
  fill: currentColor;
