...
const content = `<path class="zmch8p7ne"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-seat-off-outline-rounded" /></template>
<style>
.zmch8p7ne {
  fill: currentColor;
