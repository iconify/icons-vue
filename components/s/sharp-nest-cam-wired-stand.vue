...
const content = `<path class="onnprvu2s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-nest-cam-wired-stand" /></template>
<style>
.onnprvu2s {
  fill: currentColor;
