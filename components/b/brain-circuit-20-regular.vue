...
const content = `<path class="r8l-epbur"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:brain-circuit-20-regular" /></template>
<style>
.r8l-epbur {
  fill: currentColor;
