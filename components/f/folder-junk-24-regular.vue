...
const content = `<path class="fgjjwbcgk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-junk-24-regular" /></template>
<style>
.fgjjwbcgk {
