...
const content = `<g class="cuyn6tgcc"><path class="jb06j1bvi"/><path class="lgutubc7a"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:butterfly-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
