...
const content = `<path class="x6za-q1rn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-local-laundry-service" /></template>
<style>
.x6za-q1rn {
  fill: currentColor;
