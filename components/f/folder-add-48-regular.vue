...
const content = `<path class="n841ppb-m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-add-48-regular" /></template>
<style>
.n841ppb-m {
  fill: currentColor;
