...
const content = `<path class="wnfounbyj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:file-png-sharp" /></template>
<style>
.wnfounbyj {
  fill: currentColor;
