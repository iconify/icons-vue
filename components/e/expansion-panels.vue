...
const content = `<path class="ds7ls8-pv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:expansion-panels" /></template>
<style>
.ds7ls8-pv {
  fill: currentColor;
