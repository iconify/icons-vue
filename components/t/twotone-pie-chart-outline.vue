...
const content = `<path class="id0axxbjz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-pie-chart-outline" /></template>
<style>
.id0axxbjz {
  fill: currentColor;
