...
const content = `<path class="uhebgnj9o"/><path class="ypvgdc24h"/><path class="t685ucb9o"/><path class="zgojaebmi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-guinea-bissau" /></template>
<style>
.t685ucb9o {
