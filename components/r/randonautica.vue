...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:randonautica" /></template>
<style>
.i2k561b5m {
  fill: none;
  stroke: currentColor;
...
.nhxtanb3g {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M21.106 20.224c-2.129 1.14-4.442-.275-3.708-2.887c1.478-.329 3.847.41 3.847 1.803v2.085c.006.901 1.563 3.008 2.755 4.127c1.192-1.12 2.749-3.226 2.755-4.127V19.14c0-1.394 2.37-2.132 3.847-1.803c.734 2.612-1.58 4.027-3.708 2.887");
}
