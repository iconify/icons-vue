...
const content = `<path class="jisuf4ykc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:control-point-duplicate-sharp" /></template>
<style>
.jisuf4ykc {
  fill: currentColor;
