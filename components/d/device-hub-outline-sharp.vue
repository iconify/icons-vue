...
const content = `<path class="f7lfju_2t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:device-hub-outline-sharp" /></template>
<style>
.f7lfju_2t {
  fill: currentColor;
