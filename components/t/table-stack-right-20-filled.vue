...
const content = `<path class="y-d-pibhe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-stack-right-20-filled" /></template>
<style>
.y-d-pibhe {
  fill: currentColor;
