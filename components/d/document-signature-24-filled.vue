...
const content = `<path class="u7gkxq44o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-signature-24-filled" /></template>
<style>
.u7gkxq44o {
  fill: currentColor;
