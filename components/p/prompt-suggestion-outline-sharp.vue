...
const content = `<path class="f8u4do2yo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:prompt-suggestion-outline-sharp" /></template>
<style>
.f8u4do2yo {
  fill: currentColor;
