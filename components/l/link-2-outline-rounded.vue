...
const content = `<path class="gcv1ahbwt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:link-2-outline-rounded" /></template>
<style>
.gcv1ahbwt {
  fill: currentColor;
