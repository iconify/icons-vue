...
const content = `<path class="v3v9vn4-z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-connect-without-contact" /></template>
<style>
.v3v9vn4-z {
  fill: currentColor;
