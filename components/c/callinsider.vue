...
const content = `<path class="ar_detoxq"/><path class="j3od30b-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:callinsider" /></template>
<style>
.ar_detoxq {
  fill: none;
  stroke: currentColor;
