...
const content = `<path class="d1dswbrxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:more-horiz-outline-rounded" /></template>
<style>
.d1dswbrxi {
  fill: currentColor;
