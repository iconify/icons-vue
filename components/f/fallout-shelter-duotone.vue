...
const content = `<g class="cuyn6tgcc"><path class="wkvi16bdi"/><path class="ra7e18u0p"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:fallout-shelter-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
