...
const content = `<path class="v7vjwjboz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-screen-rotation" /></template>
<style>
.v7vjwjboz {
  fill: currentColor;
