...
const content = `<path class="k12cijsrl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:checkmark-lock-16-filled" /></template>
<style>
.k12cijsrl {
  fill: currentColor;
