...
const content = `<path class="mbnsx5b-q"/><path class="jz98izv6t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:serviigo" /></template>
<style>
.jz98izv6t {
  fill: none;
  stroke: currentColor;
