...
const content = `<path class="y6mo4wb6h"/><path class="g5ucdpzqm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hearoes" /></template>
<style>
.g5ucdpzqm {
  fill: none;
  stroke: currentColor;
...
.y6mo4wb6h {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m28.043 24.535l-6.81-3.932v7.864z");
}
