...
const content = `<path class="eneviw4ox"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pip-outline-sharp" /></template>
<style>
.eneviw4ox {
  fill: currentColor;
