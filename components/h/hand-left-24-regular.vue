...
const content = `<path class="pn-4vvb2j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:hand-left-24-regular" /></template>
<style>
.pn-4vvb2j {
  fill: currentColor;
