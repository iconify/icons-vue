...
const content = `<path class="yqyjmbbxq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mountain-steam-sharp" /></template>
<style>
.yqyjmbbxq {
  fill: currentColor;
