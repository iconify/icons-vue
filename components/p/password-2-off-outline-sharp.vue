...
const content = `<path class="a667o9btw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:password-2-off-outline-sharp" /></template>
<style>
.a667o9btw {
  fill: currentColor;
