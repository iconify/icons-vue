...
const content = `<path class="d3d_ez37o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:paragliding-outline-rounded" /></template>
<style>
.d3d_ez37o {
  fill: currentColor;
