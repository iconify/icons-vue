...
const content = `<g class="cuyn6tgcc"><path class="zzkrtobrt"/><path class="u0d0qdwvo"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:pi-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
