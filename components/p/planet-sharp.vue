...
const content = `<path class="tv81psshr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:planet-sharp" /></template>
<style>
.tv81psshr {
  fill: currentColor;
