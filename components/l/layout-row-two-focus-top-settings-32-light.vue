...
const content = `<path class="p2-_3qb6m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-two-focus-top-settings-32-light" /></template>
<style>
.p2-_3qb6m {
  fill: currentColor;
