...
const content = `<g class="nrj6p8qat"><path class="x1q46ybnx"/><path class="ir3b3wkce"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:scissors-duotone" /></template>
<style>
.ir3b3wkce {
  stroke-opacity: 0.4;
  d: path("M8.1213 15.8787L17 3M15.8787 15.8787L12 10.2526M9.5708 6.729L7 3");
}
