...
const content = `<g class="ft5dv1b6b"><path class="iq6goxu_x"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:like-16-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
