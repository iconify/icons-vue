...
const content = `<path class="dfs3gqt3y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:next-frame-20-filled" /></template>
<style>
.dfs3gqt3y {
  fill: currentColor;
