...
const content = `<path class="p85e3om7s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-shapes-sharp" /></template>
<style>
.p85e3om7s {
  fill: currentColor;
