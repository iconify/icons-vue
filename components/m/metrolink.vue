...
const content = `<path class="qli6s1b2q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:metrolink" /></template>
<style>
.qli6s1b2q {
  fill: none;
  stroke: currentColor;
