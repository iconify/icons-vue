...
const content = `<path class="kodbzlbjp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:badge-rounded" /></template>
<style>
.kodbzlbjp {
  fill: currentColor;
