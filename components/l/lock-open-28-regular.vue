...
const content = `<path class="ivn-iebet"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:lock-open-28-regular" /></template>
<style>
.ivn-iebet {
  fill: currentColor;
