...
const content = `<circle class="t2zlgc8_u"/><circle class="be4hwp76b"/><circle class="i2o5n6bvz"/><path class="nmiz3hk6o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:words-of-wonders-crossword" /></template>
<style>
.be4hwp76b {
  cx: 12.375px;
  cy: 17.945px;
