...
const content = `<path class="u5buzsbvy"/><path class="kkx5edbgm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-triangular-flag" /></template>
<style>
.kkx5edbgm {
