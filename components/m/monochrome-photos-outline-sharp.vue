...
const content = `<path class="kwx7uybhx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:monochrome-photos-outline-sharp" /></template>
<style>
.kwx7uybhx {
  fill: currentColor;
