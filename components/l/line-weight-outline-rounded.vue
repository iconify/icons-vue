...
const content = `<path class="dah3rcbmn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:line-weight-outline-rounded" /></template>
<style>
.dah3rcbmn {
  fill: currentColor;
