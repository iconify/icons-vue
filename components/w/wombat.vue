...
const content = `<g class="ft5dv1b6b"><path clip-rule="evenodd" class="xjbg7d2mg"/><path class="r8ubdjxur"/><path clip-rule="evenodd" class="zf2k2zb1r"/><path class="medc6_bmd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:wombat" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
