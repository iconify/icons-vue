...
const content = `<path class="widl7oxnw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chevron-circle-left-48-regular" /></template>
<style>
.widl7oxnw {
  fill: currentColor;
