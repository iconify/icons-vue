...
const content = `<path class="sylijrbbc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:door-arrow-left-24-regular" /></template>
<style>
.sylijrbbc {
  fill: currentColor;
