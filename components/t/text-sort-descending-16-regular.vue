...
const content = `<path class="ostgovb9y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-sort-descending-16-regular" /></template>
<style>
.ostgovb9y {
  fill: currentColor;
