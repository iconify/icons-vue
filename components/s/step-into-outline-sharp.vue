...
const content = `<path class="ry0isibeq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:step-into-outline-sharp" /></template>
<style>
.ry0isibeq {
  fill: currentColor;
