...
const content = `<path class="u3cvbw03w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-checkmark-32-regular" /></template>
<style>
.u3cvbw03w {
  fill: currentColor;
