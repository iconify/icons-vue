...
const content = `<path class="rq3stlbut"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sim-card-lock-rounded" /></template>
<style>
.rq3stlbut {
  fill: currentColor;
