...
const content = `<path class="j681h_w8w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:space-bar-outline-rounded" /></template>
<style>
.j681h_w8w {
  fill: currentColor;
