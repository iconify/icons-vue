...
const content = `<path class="f8q025bvt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-back-ios-new-rounded" /></template>
<style>
.f8q025bvt {
  fill: currentColor;
