...
const content = `<path class="w0unte1ss"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:row-child-16-filled" /></template>
<style>
.w0unte1ss {
  fill: currentColor;
