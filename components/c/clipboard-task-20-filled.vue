...
const content = `<path class="dos41bcuv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-task-20-filled" /></template>
<style>
.dos41bcuv {
  fill: currentColor;
