...
const content = `<path class="q0ralojdi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:folded-hands-sharp" /></template>
<style>
.q0ralojdi {
  fill: currentColor;
