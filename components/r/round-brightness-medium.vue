...
const content = `<path class="t21lvgckw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-brightness-medium" /></template>
<style>
.t21lvgckw {
  fill: currentColor;
