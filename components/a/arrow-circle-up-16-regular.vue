...
const content = `<path class="o3lw51fjp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-up-16-regular" /></template>
<style>
.o3lw51fjp {
  fill: currentColor;
