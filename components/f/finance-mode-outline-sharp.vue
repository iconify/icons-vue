...
const content = `<path class="myyiprbhb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:finance-mode-outline-sharp" /></template>
<style>
.myyiprbhb {
  fill: currentColor;
