...
const content = `<path class="yeiavkbpm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:syringe-sharp" /></template>
<style>
.yeiavkbpm {
  fill: currentColor;
