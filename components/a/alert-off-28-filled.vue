...
const content = `<path class="p78c8acxj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:alert-off-28-filled" /></template>
<style>
.p78c8acxj {
  fill: currentColor;
