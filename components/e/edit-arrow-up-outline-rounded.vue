...
const content = `<path class="d13ecrkor"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-arrow-up-outline-rounded" /></template>
<style>
.d13ecrkor {
  fill: currentColor;
