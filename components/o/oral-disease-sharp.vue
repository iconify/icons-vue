...
const content = `<path class="farlmoe7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:oral-disease-sharp" /></template>
<style>
.farlmoe7l {
  fill: currentColor;
