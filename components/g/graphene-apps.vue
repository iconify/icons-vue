...
const content = `<path class="krpmkmbio"/><path class="bk3fbk7rx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:graphene-apps" /></template>
<style>
.bk3fbk7rx {
  fill: none;
  stroke: currentColor;
