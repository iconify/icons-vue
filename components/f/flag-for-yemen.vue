...
const content = `<path class="t76_qd-2z"/><path class="n8-91eb0z"/><path class="ffqvh7osi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-yemen" /></template>
<style>
.ffqvh7osi {
