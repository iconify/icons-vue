...
const content = `<path class="hfl6swz2m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-span-out-16-regular" /></template>
<style>
.hfl6swz2m {
  fill: currentColor;
