...
const content = `<path class="fenmy1bcf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-text-link-24-filled" /></template>
<style>
.fenmy1bcf {
  fill: currentColor;
