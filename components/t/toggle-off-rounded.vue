...
const content = `<path class="h9tfpd8og"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:toggle-off-rounded" /></template>
<style>
.h9tfpd8og {
  fill: currentColor;
