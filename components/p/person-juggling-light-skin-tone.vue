...
const content = `<path class="iwettlg_h"/><path class="dn2fo_78v"/><path class="gj5ftgs4z"/><path class="tkzmid9ym"/><path class="qcth5guvn"/><path class="vjnaa0b7a"/><path class="mo5r4wbzu"/><path class="j2cdgfbun"/><circle class="ut_t21syf"/><circle class="o5-krulhj"/><circle class="u3kv_m4fm"/><path class="aqn8fhbrz"/><path class="e_nwc3kfp"/><path class="j5-nhvrkf"/><path class="d7f2vfqst"/><path class="brkjq0r0m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:person-juggling-light-skin-tone" /></template>
<style>
.aqn8fhbrz {
