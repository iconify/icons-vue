...
const content = `<path class="dgh7jhswh"/><path class="k161_wbmt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:id-button" /></template>
<style>
.dgh7jhswh {
