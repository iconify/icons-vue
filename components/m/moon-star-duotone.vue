...
const content = `<g class="nrj6p8qat"><path class="z_eex4b_i"/><path class="q41if-b8j"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:moon-star-duotone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
