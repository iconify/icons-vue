...
const content = `<path class="e844l6bna"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-left-20-filled" /></template>
<style>
.e844l6bna {
  fill: currentColor;
