...
const content = `<path class="pvnagdbyu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:media-link-sharp" /></template>
<style>
.pvnagdbyu {
  fill: currentColor;
