...
const content = `<path class="pjusxob1u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:looks-two" /></template>
<style>
.pjusxob1u {
  fill: currentColor;
