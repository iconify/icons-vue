...
const content = `<path class="uxxb-y3rc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-left-2-outline-sharp" /></template>
<style>
.uxxb-y3rc {
  fill: currentColor;
