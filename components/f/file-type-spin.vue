...
const content = `<g class="u8pjmubgg"><path class="n8qupvb2w"/><path class="cbznf35ej"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-spin" /></template>
<style>
.cbznf35ej {
