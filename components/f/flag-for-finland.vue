...
const content = `<path class="pmeol1b8p"/><path class="sd9ob5qik"/><path class="ehiw23vsj"/><path class="ib2y5sbss"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-finland" /></template>
<style>
.ehiw23vsj {
