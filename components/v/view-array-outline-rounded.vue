...
const content = `<path class="a3gry6c8u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:view-array-outline-rounded" /></template>
<style>
.a3gry6c8u {
  fill: currentColor;
