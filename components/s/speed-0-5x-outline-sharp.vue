...
const content = `<path class="o9h3gacma"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speed-0-5x-outline-sharp" /></template>
<style>
.o9h3gacma {
  fill: currentColor;
