...
const content = `<path class="ew2ctzpne"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-rotate-outline-rounded" /></template>
<style>
.ew2ctzpne {
  fill: currentColor;
