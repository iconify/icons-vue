...
const content = `<g class="ft5dv1b6b"><path class="hahjchect"/><path class="ivezg_brr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:0x0" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
