...
const content = `<path class="eirbqmrfx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:filter-dismiss-24-filled" /></template>
<style>
.eirbqmrfx {
  fill: currentColor;
