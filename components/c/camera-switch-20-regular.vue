...
const content = `<path class="vbzq8-5mu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:camera-switch-20-regular" /></template>
<style>
.vbzq8-5mu {
  fill: currentColor;
