...
const content = `<path class="lwfrorbrl"/><path class="a1gd2d18g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-indonesia" /></template>
<style>
.a1gd2d18g {
