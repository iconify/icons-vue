...
const content = `<path class="kz92n-n6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sync-desktop-sharp" /></template>
<style>
.kz92n-n6a {
  fill: currentColor;
