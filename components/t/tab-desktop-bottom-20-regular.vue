...
const content = `<path class="q__bxxbpi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-desktop-bottom-20-regular" /></template>
<style>
.q__bxxbpi {
  fill: currentColor;
