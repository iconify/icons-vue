...
const content = `<defs><linearGradient id="SVGZqqvkcRW" x1="25.141%" x2="92.394%" y1="20.136%" y2="101.477%"><stop offset="0%" class="ioxr5abkn"/><stop offset="56.639%" class="d2lupyzth"/><stop offset="100%" class="g8yysmbuw"/></linearGradient><linearGradient id="SVGQCBM8MVq" x1="90.716%" x2="32.749%" y1="79.092%" y2="9.825%"><stop offset="0%" class="senu6acit"/><stop offset="100%" class="z4gvas4re"/></linearGradient></defs><path fill="url(#SVGZqqvkcRW)" class="s00zjybnm"/><path fill="url(#SVGQCBM8MVq)" class="hqe6unbrg"/><path class="jhiso9brk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:emacs" /></template>
<style>
.d2lupyzth {
  stop-color: var(--svg-color--7e55b3, #7e55b3);
  stop-opacity: 0.996;
}

.g8yysmbuw {
  stop-color: var(--svg-color--a52ecb, #a52ecb);
  stop-opacity: 0.992;
}

.hqe6unbrg {
  d: path("M128 0C57.3 0 0 57.316 0 128s57.3 128 128 128s128-57.316 128-128S198.7 0 128 0m0 7.05c66.752 0 120.88 54.143 120.88 120.95S194.752 248.95 128 248.95S7.12 194.807 7.12 128S61.248 7.05 128 7.05");
}

.ioxr5abkn {
  stop-color: var(--svg-color--8381c5, #8381c5);
}
...
.s00zjybnm {
  d: path("M253 128c0 69.036-55.964 125-125 125S3 197.036 3 128S58.964 3 128 3s125 55.964 125 125");
}

.senu6acit {
  stop-color: var(--svg-color--411f5d, #411f5d);
}

.z4gvas4re {
  stop-color: var(--svg-color--5b2a85, #5b2a85);
}
