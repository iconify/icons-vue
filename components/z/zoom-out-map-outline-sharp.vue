...
const content = `<path class="msnsrwb0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:zoom-out-map-outline-sharp" /></template>
<style>
.msnsrwb0l {
  fill: currentColor;
