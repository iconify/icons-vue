...
const content = `<path class="dvn59fbiq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:bookmark-fill" /></template>
<style>
.dvn59fbiq {
  fill: currentColor;
