...
const content = `<path class="m6k-8ebtj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:device-tablet-speaker-thin" /></template>
<style>
.m6k-8ebtj {
  fill: currentColor;
