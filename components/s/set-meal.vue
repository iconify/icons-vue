...
const content = `<path class="caxzgabna"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:set-meal" /></template>
<style>
.caxzgabna {
  fill: currentColor;
