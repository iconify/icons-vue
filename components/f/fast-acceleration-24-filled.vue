...
const content = `<path class="f_30s_bhp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:fast-acceleration-24-filled" /></template>
<style>
.f_30s_bhp {
  fill: currentColor;
