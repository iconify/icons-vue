...
const content = `<path class="wanjjomet"/><path class="l12mn-bas"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:stickerconv" /></template>
<style>
.l12mn-bas {
  fill: none;
  stroke: currentColor;
