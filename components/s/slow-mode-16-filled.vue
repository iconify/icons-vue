...
const content = `<g class="ft5dv1b6b"><path class="uc3w9-beg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slow-mode-16-filled" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
