...
const content = `<path class="a2oysibve"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flights-and-hotels-rounded" /></template>
<style>
.a2oysibve {
  fill: currentColor;
