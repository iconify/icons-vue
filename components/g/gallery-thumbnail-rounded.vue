...
const content = `<path class="j2-u0o07y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gallery-thumbnail-rounded" /></template>
<style>
.j2-u0o07y {
  fill: currentColor;
