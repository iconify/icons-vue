...
const content = `<path class="rayy1nbpj"/><circle class="hedj3bbrm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-coffee-maker" /></template>
<style>
.hedj3bbrm {
  cx: 13px;
  cy: 9px;
