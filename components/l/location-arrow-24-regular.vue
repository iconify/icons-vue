...
const content = `<path class="p28bg-b-k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-arrow-24-regular" /></template>
<style>
.p28bg-b-k {
  fill: currentColor;
