...
const content = `<path class="gux1bwocm"/><path class="gz-595baz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:octoapp" /></template>
<style>
.gux1bwocm {
  fill: none;
  stroke: currentColor;
