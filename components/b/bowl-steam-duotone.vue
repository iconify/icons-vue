...
const content = `<g class="cuyn6tgcc"><path class="kbvl4ihde"/><path class="fgdrbchbc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:bowl-steam-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
