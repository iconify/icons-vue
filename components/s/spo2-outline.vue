...
const content = `<path class="vqyfqwbrp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:spo2-outline" /></template>
<style>
.vqyfqwbrp {
  fill: currentColor;
