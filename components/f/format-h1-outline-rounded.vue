...
const content = `<path class="kjo4aac_r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-h1-outline-rounded" /></template>
<style>
.kjo4aac_r {
  fill: currentColor;
