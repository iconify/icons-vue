...
const content = `<path class="cm89s6bls"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-rotate-90-right-24-filled" /></template>
<style>
.cm89s6bls {
  fill: currentColor;
