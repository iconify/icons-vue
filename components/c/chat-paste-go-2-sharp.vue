...
const content = `<path class="k_peabbbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chat-paste-go-2-sharp" /></template>
<style>
.k_peabbbq {
  fill: currentColor;
