...
const content = `<path class="b1bqggbmr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:widget-width" /></template>
<style>
.b1bqggbmr {
  fill: currentColor;
