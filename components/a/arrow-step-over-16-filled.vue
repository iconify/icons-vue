...
const content = `<path class="t64c-cbnv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-over-16-filled" /></template>
<style>
.t64c-cbnv {
  fill: currentColor;
