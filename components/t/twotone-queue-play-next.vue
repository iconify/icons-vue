...
const content = `<path class="wln_egx2i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-queue-play-next" /></template>
<style>
.wln_egx2i {
  fill: currentColor;
