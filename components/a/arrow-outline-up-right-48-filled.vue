...
const content = `<path class="y33dty8ym"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-outline-up-right-48-filled" /></template>
<style>
.y33dty8ym {
  fill: currentColor;
