...
const content = `<path class="bosqagb8f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:curtains" /></template>
<style>
.bosqagb8f {
  fill: currentColor;
