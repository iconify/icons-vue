...
const content = `<path class="ydvxkiaxr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:inking-tool-20-filled" /></template>
<style>
.ydvxkiaxr {
  fill: currentColor;
