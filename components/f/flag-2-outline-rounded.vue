...
const content = `<path class="h1pc88gbr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flag-2-outline-rounded" /></template>
<style>
.h1pc88gbr {
  fill: currentColor;
