...
const content = `<path class="ptyn3bc8y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vrpano-sharp" /></template>
<style>
.ptyn3bc8y {
  fill: currentColor;
