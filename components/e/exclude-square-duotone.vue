...
const content = `<g class="cuyn6tgcc"><path class="lbs7d8pkk"/><path class="kpxwuyboe"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:exclude-square-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
