...
const content = `<path class="d7wn9ybib"/><path class="yl7pb8bpv"/><path class="rag_k9bcf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kinderundgift" /></template>
<style>
.d7wn9ybib {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M20.24 9.76v3.39c-5.6 1.12-6.58 5.47-6.58 16.61c0 6.21.13 9.61.27 11.48a2.43 2.43 0 0 0 2.43 2.26h15.28a2.43 2.43 0 0 0 2.43-2.26c.14-1.87.27-5.27.27-11.48c0-10.9-.94-15.3-6.21-16.53V9.76Z");
}
