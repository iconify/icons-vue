...
const content = `<path class="nbka8m1qy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:manage-search-outline-sharp" /></template>
<style>
.nbka8m1qy {
  fill: currentColor;
