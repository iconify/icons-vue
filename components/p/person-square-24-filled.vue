...
const content = `<path class="qdlrdfimg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-square-24-filled" /></template>
<style>
.qdlrdfimg {
  fill: currentColor;
