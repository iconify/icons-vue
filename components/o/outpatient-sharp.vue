...
const content = `<path class="s4cztrbuo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:outpatient-sharp" /></template>
<style>
.s4cztrbuo {
  fill: currentColor;
