...
const content = `<path class="y8mfgchqb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-0-28-filled" /></template>
<style>
.y8mfgchqb {
  fill: currentColor;
