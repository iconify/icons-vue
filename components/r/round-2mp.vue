...
const content = `<path class="k4n51fjcs"/><path class="ntc971kyr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-2mp" /></template>
<style>
.k4n51fjcs {
  fill: currentColor;
