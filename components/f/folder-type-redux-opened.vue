...
const content = `<path class="esj31h_aj"/><path class="qx4enldyv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-redux-opened" /></template>
<style>
.esj31h_aj {
  fill: var(--svg-color--a07bdb, #a07bdb);
...
.qx4enldyv {
  fill: var(--svg-color--aa9fbc, #aa9fbc);
