...
const content = `<path class="mw34jbcmv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:copy-move-16-regular" /></template>
<style>
.mw34jbcmv {
