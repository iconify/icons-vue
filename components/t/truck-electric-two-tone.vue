...
const content = `<g class="nrj6p8qat"><path class="wy94go95p"/><path class="tdfa7bwou"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:truck-electric-two-tone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
