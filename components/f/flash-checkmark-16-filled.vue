...
const content = `<path class="tv58fzrmx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flash-checkmark-16-filled" /></template>
<style>
.tv58fzrmx {
  fill: currentColor;
