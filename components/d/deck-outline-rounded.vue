...
const content = `<path class="lizac4bmd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:deck-outline-rounded" /></template>
<style>
.lizac4bmd {
  fill: currentColor;
