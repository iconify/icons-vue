...
const content = `<path class="q62tq9w9i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-left-2-sharp" /></template>
<style>
.q62tq9w9i {
  fill: currentColor;
