...
const content = `<path class="l549yac8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-javascript-24-filled" /></template>
<style>
.l549yac8v {
  fill: currentColor;
