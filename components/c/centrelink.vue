...
const content = `<path class="h2c4eippx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:centrelink" /></template>
<style>
.h2c4eippx {
  fill: none;
  stroke: currentColor;
