...
const content = `<path class="x3kycrbvl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:code-block-48-regular" /></template>
<style>
.x3kycrbvl {
  fill: currentColor;
