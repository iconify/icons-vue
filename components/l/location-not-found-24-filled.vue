...
const content = `<path class="x-gknkd4y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-not-found-24-filled" /></template>
<style>
.x-gknkd4y {
