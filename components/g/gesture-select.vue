...
const content = `<path class="v0xj9li7u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gesture-select" /></template>
<style>
.v0xj9li7u {
  fill: currentColor;
