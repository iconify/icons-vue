...
const content = `<g class="gp_8x1bzb"><path class="uordzqcti"/><path clip-rule="evenodd" class="r0p7iiqoh"/><path class="de8pmevzp"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-down-sharp-duotone" /></template>
<style>
.de8pmevzp {
  d: path("M18 15L18 22M14.7071 18.7071L18 22L21.2929 18.7071");
}
