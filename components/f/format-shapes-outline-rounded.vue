...
const content = `<path class="jms1oc23q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-shapes-outline-rounded" /></template>
<style>
.jms1oc23q {
  fill: currentColor;
