...
const content = `<path class="ns6-accrl"/><path class="ca2py5bvu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-european-union" /></template>
<style>
.ca2py5bvu {
