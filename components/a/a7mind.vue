...
const content = `<path class="fosmfdcqr"/><path class="a1us_nbwa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:a7mind" /></template>
<style>
.a1us_nbwa {
  fill: none;
  stroke: currentColor;
