...
const content = `<path class="y480_kbid"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:groups-rounded" /></template>
<style>
.y480_kbid {
  fill: currentColor;
