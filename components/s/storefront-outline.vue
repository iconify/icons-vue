...
const content = `<path class="s99jvp1_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:storefront-outline" /></template>
<style>
.s99jvp1_k {
  fill: currentColor;
