...
const content = `<path class="gnpygbbki"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:workspaces-rounded" /></template>
<style>
.gnpygbbki {
  fill: currentColor;
