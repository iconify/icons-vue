...
const content = `<path class="emtt51zmc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-bullet-list-square-clock-20-regular" /></template>
<style>
.emtt51zmc {
  fill: currentColor;
