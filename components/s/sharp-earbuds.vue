...
const content = `<path class="jir5rib-n"/><path class="amldhzbwv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-earbuds" /></template>
<style>
.amldhzbwv {
  fill: currentColor;
  d: path("M6 3h3v6H6zm9 12h3v6h-3z");
}
