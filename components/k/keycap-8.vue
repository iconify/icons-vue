...
const content = `<path class="onhjkz4gg"/><path class="w0yxpgd2i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:keycap-8" /></template>
<style>
.onhjkz4gg {
  fill: currentColor;
