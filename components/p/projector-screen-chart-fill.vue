...
const content = `<path class="ljg4yvblr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:projector-screen-chart-fill" /></template>
<style>
.ljg4yvblr {
  fill: currentColor;
