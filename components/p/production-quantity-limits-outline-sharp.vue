...
const content = `<path class="pfeip5bhz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:production-quantity-limits-outline-sharp" /></template>
<style>
.pfeip5bhz {
  fill: currentColor;
