...
const content = `<path class="vgkvsph1k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-right-contract-28-regular" /></template>
<style>
.vgkvsph1k {
  fill: currentColor;
