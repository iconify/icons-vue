...
const content = `<path class="a4uqagbla"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-smile-slight-24-filled" /></template>
<style>
.a4uqagbla {
  fill: currentColor;
