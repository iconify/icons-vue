...
const content = `<path class="np8th6blo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:e-mobiledata-outline-rounded" /></template>
<style>
.np8th6blo {
  fill: currentColor;
