...
const content = `<path class="mh052qbzr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:photo-prints-rounded" /></template>
<style>
.mh052qbzr {
  fill: currentColor;
