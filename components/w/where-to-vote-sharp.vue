...
const content = `<path class="osircmb4w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:where-to-vote-sharp" /></template>
<style>
.osircmb4w {
  fill: currentColor;
