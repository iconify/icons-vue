...
const content = `<path class="xhvoflq1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-junk-24-filled" /></template>
<style>
.xhvoflq1m {
