...
const content = `<path class="ajeb0yitx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:device-eq-24-regular" /></template>
<style>
.ajeb0yitx {
  fill: currentColor;
