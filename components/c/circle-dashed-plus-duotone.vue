...
const content = `<g class="nrj6p8qat"><path class="neicvubrs"/><path class="zasenvc8n"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-plus-duotone" /></template>
<style>
.neicvubrs {
  stroke-opacity: 0.4;
