...
const content = `<g class="cuyn6tgcc"><g clip-rule="evenodd" class="d2kvgvbvc"><path class="n0lwyub-i"/><path class="l6h7k98sk"/></g><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:hands-clapping-checkmark-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
