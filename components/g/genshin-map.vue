...
const content = `<rect class="j3s9ivbxi"/><path class="mifyh2y2j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:genshin-map" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
