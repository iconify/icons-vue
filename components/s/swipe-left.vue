...
const content = `<path class="ux36m3bks"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-left" /></template>
<style>
.ux36m3bks {
  fill: currentColor;
