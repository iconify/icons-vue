...
const content = `<path class="jqx-5dbya"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shutter-speed-add-outline-sharp" /></template>
<style>
.jqx-5dbya {
  fill: currentColor;
