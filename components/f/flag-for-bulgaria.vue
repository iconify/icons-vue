...
const content = `<path class="o_gjz8qww"/><path class="qnxn34bwt"/><path class="smx0ezbgg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-bulgaria" /></template>
<style>
.o_gjz8qww {
