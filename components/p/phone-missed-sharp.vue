...
const content = `<path class="jmvwts82k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phone-missed-sharp" /></template>
<style>
.jmvwts82k {
  fill: currentColor;
