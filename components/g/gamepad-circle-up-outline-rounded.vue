...
const content = `<path class="xlus_xzpg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gamepad-circle-up-outline-rounded" /></template>
<style>
.xlus_xzpg {
  fill: currentColor;
