...
const content = `<g class="nrj6p8qat"><path class="r63fawbfm"/><path class="b1w71sb4l"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:app-x-two-tone" /></template>
<style>
.b1w71sb4l {
