...
const content = `<path class="ujm0h4bcx"/><path class="k4n51fjcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-14mp" /></template>
<style>
.k4n51fjcs {
  fill: currentColor;
