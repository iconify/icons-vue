...
const content = `<path class="jj87vsbvn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:folder-zip-sharp" /></template>
<style>
.jj87vsbvn {
  fill: none;
  stroke: currentColor;
