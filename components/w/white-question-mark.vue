...
const content = `<g class="l_kccubev"><path class="g-flxwbkg"/><ellipse class="iqsqdf5ym"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:white-question-mark" /></template>
<style>
.g-flxwbkg {
