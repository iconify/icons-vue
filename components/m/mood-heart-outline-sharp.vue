...
const content = `<path class="vh9vevbrt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mood-heart-outline-sharp" /></template>
<style>
.vh9vevbrt {
  fill: currentColor;
