...
const content = `<path class="qlgp5ebmv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-32-regular" /></template>
<style>
.qlgp5ebmv {
  fill: currentColor;
