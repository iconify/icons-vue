...
const content = `<path class="d692x4ldc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:19mp-outline-sharp" /></template>
<style>
.d692x4ldc {
  fill: currentColor;
