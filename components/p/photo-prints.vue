...
const content = `<path class="tb39y4-os"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:photo-prints" /></template>
<style>
.tb39y4-os {
  fill: currentColor;
