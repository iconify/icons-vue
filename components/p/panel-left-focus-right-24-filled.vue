...
const content = `<path class="me2to6bxo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-focus-right-24-filled" /></template>
<style>
.me2to6bxo {
  fill: currentColor;
