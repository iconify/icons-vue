...
const content = `<path class="m697vtbai"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-asterisk-16-filled" /></template>
<style>
.m697vtbai {
  fill: currentColor;
