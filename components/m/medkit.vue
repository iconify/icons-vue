...
const content = `<path class="mugaay10b"/><path class="ppy-cnbns"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:medkit" /></template>
<style>
.mugaay10b {
  fill: none;
  stroke: currentColor;
