...
const content = `<path class="oz69kacll"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:replace-video-sharp" /></template>
<style>
.oz69kacll {
  fill: currentColor;
