...
const content = `<path class="pgj-hyjez"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:all-match-outline-sharp" /></template>
<style>
.pgj-hyjez {
  fill: currentColor;
