...
const content = `<path class="gvp8s8blr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-person-pin-circle" /></template>
<style>
.gvp8s8blr {
  fill: currentColor;
