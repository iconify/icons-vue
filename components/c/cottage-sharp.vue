...
const content = `<path class="yak8xvb1t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cottage-sharp" /></template>
<style>
.yak8xvb1t {
  fill: currentColor;
