...
const content = `<path class="f8uoyppqu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:person-apron-outline-sharp" /></template>
<style>
.f8uoyppqu {
  fill: currentColor;
