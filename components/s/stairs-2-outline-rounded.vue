...
const content = `<path class="j-fqp1bus"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stairs-2-outline-rounded" /></template>
<style>
.j-fqp1bus {
  fill: currentColor;
