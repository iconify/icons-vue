...
const content = `<path class="rcjv7l0qj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-image-inline-right-outline-rounded" /></template>
<style>
.rcjv7l0qj {
  fill: currentColor;
