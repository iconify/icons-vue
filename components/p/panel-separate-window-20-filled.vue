...
const content = `<path class="do5dsof4e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-separate-window-20-filled" /></template>
<style>
.do5dsof4e {
  fill: currentColor;
