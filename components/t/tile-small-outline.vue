...
const content = `<path class="cisgpqbfm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tile-small-outline" /></template>
<style>
.cisgpqbfm {
  fill: currentColor;
