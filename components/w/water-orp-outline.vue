...
const content = `<path class="z9bd_d4fr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:water-orp-outline" /></template>
<style>
.z9bd_d4fr {
  fill: currentColor;
