...
const content = `<path class="k69hoqb5f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-switch-28-filled" /></template>
<style>
.k69hoqb5f {
  fill: currentColor;
