...
const content = `<path class="nnyg7zfam"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-do-not-disturb-off" /></template>
<style>
.nnyg7zfam {
  fill: currentColor;
