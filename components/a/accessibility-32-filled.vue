...
const content = `<path class="cg-y-zb2l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:accessibility-32-filled" /></template>
<style>
.cg-y-zb2l {
  fill: currentColor;
