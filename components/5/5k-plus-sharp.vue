...
const content = `<path class="ul8vdebjz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:5k-plus-sharp" /></template>
<style>
.ul8vdebjz {
  fill: currentColor;
