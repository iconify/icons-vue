...
const content = `<path class="d1274ac1p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:image-not-supported-outline-rounded" /></template>
<style>
.d1274ac1p {
  fill: currentColor;
