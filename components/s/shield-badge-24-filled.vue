...
const content = `<path class="qasqk0b5c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-badge-24-filled" /></template>
<style>
.qasqk0b5c {
  fill: currentColor;
