...
const content = `<path class="ow5yfjbgq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-edit-sharp" /></template>
<style>
.ow5yfjbgq {
  fill: currentColor;
