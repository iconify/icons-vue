...
const content = `<path class="kd5qyfghb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:trackpad-input-2-outline-sharp" /></template>
<style>
.kd5qyfghb {
  fill: currentColor;
