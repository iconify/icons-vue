...
const content = `<g class="gp_8x1bzb"><path class="xgaf0nbdt"/><path class="w5-w_sbbd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-x-sharp" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
