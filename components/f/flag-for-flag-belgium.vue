...
const content = `<path class="oh2-6ea0q"/><path class="f4cj0ct6j"/><path class="jjq608bfj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-belgium" /></template>
<style>
.f4cj0ct6j {
