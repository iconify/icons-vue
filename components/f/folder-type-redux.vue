...
const content = `<path class="cluw3sbgs"/><path class="qx4enldyv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-redux" /></template>
<style>
.cluw3sbgs {
  fill: var(--svg-color--7e55bf, #7e55bf);
