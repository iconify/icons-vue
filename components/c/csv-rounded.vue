...
const content = `<path class="yo5becbgy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:csv-rounded" /></template>
<style>
.yo5becbgy {
  fill: currentColor;
