...
const content = `<path class="ncr1s1pyc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:computer" /></template>
<style>
.ncr1s1pyc {
  fill: currentColor;
