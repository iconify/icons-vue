...
const content = `<path class="xvq1-xbht"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:block-outline-rounded" /></template>
<style>
.xvq1-xbht {
  fill: currentColor;
