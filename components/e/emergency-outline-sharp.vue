...
const content = `<path class="ph3glsp7n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:emergency-outline-sharp" /></template>
<style>
.ph3glsp7n {
  fill: currentColor;
