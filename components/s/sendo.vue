...
const content = `<circle class="jqyms83vg"/><circle class="dbtmipl6y"/><path class="bq26zcc9v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sendo" /></template>
<style>
.bq26zcc9v {
  fill: none;
  stroke: currentColor;
