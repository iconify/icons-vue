...
const content = `<path class="q7-ov2u7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:info-i-rounded" /></template>
<style>
.q7-ov2u7l {
  fill: currentColor;
