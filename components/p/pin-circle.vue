...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="o3z7ckbpw"/><path class="uefum42kt"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:pin-circle" /></template>
<style>
.hdxpysbbn {
