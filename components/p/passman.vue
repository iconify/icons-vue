...
const content = `<path class="m4mh00-gx"/><path class="nhx4d0svz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:passman" /></template>
<style>
.m4mh00-gx {
  fill: none;
  stroke: currentColor;
