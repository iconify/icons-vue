...
const content = `<path class="clczc7bxp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:emergency-outline-rounded" /></template>
<style>
.clczc7bxp {
  fill: currentColor;
