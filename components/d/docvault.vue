...
const content = `<path class="kg4ghsblu"/><g class="y9tr6bcfx"><circle class="yoe7t2mag"/><path class="u8koz3bib"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:docvault" /></template>
<style>
.kg4ghsblu {
  fill: none;
  stroke: currentColor;
