...
const content = `<g class="hntgybcog"><path class="e77gki8ci"/><path class="jr8d9xc7c"/><path class="gfzbj7b6z"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:warehouse-outline-thin" /></template>
<style>
.e77gki8ci {
