...
const content = `<path class="imyabqbyq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:directions-off-outline-rounded" /></template>
<style>
.imyabqbyq {
  fill: currentColor;
