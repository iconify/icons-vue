...
const content = `<path class="ajkl6hbze"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-truck-profile-32-filled" /></template>
<style>
.ajkl6hbze {
  fill: currentColor;
