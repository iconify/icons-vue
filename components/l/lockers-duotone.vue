...
const content = `<g class="cuyn6tgcc"><path class="hi-0p8mzi"/><path class="y3_oe60fu"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:lockers-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
