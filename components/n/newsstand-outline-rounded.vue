...
const content = `<path class="r4w1fxb4h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:newsstand-outline-rounded" /></template>
<style>
.r4w1fxb4h {
  fill: currentColor;
