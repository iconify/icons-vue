...
const content = `<path class="uvjbj_bxp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:note-rounded" /></template>
<style>
.uvjbj_bxp {
  fill: currentColor;
