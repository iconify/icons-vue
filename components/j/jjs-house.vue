...
const content = `<path class="djx6rxq4w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:jjs-house" /></template>
<style>
.djx6rxq4w {
  fill: none;
  stroke: currentColor;
