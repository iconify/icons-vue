...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:audio-lines-sparkles-sharp-fill" /></template>
<style>
.ahftqnl7w {
  d: path("M8 8.8444L8 19M16 6L16 11.03M4 9.6141L4 15M12 2L12 13.0097M20 9L20 12.2225");
}
