...
const content = `<path class="hd1mpyb7k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:account-tree-outline-rounded" /></template>
<style>
.hd1mpyb7k {
  fill: currentColor;
