...
const content = `<path class="wdbvpi-0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-charging-50-outline-rounded" /></template>
<style>
.wdbvpi-0l {
  fill: currentColor;
