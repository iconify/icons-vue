...
const content = `<path class="j6zpbo33b"/><path class="sekm_jbqk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:myfastweb" /></template>
<style>
.j6zpbo33b {
  fill: none;
  stroke: currentColor;
