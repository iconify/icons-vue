...
const content = `<path class="jx2pxn5bi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:torrents-csv-android" /></template>
<style>
.jx2pxn5bi {
  fill: none;
  stroke: currentColor;
