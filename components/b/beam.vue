...
const content = `<path class="wue3fnbpy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:beam" /></template>
<style>
.wue3fnbpy {
  fill: none;
  stroke: currentColor;
