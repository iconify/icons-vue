...
const content = `<path class="ko5__fboe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tree-deciduous-28-regular" /></template>
<style>
.ko5__fboe {
  fill: currentColor;
