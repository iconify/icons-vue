...
const content = `<path class="zdop9-bxj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:alert-off-16-filled" /></template>
<style>
.zdop9-bxj {
  fill: currentColor;
