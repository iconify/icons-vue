...
const content = `<g class="nrj6p8qat"><path class="c-bzonblr"/><path class="kqaa63eeo"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:toast-stack-outline-regular" /></template>
<style>
.c-bzonblr {
