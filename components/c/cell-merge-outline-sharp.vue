...
const content = `<path class="suvnrxilp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cell-merge-outline-sharp" /></template>
<style>
.suvnrxilp {
  fill: currentColor;
