...
const content = `<path class="vl2phqoog"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:litres" /></template>
<style>
.vl2phqoog {
  fill: none;
  stroke: currentColor;
