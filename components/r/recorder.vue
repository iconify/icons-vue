...
const content = `<path class="gx7tuob1t"/><path class="dxx0-ftqn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:recorder" /></template>
<style>
.dxx0-ftqn {
  fill: none;
  stroke: currentColor;
