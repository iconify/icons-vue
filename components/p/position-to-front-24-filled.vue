...
const content = `<path class="y12clfbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:position-to-front-24-filled" /></template>
<style>
.y12clfbxi {
  fill: currentColor;
