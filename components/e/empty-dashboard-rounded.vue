...
const content = `<path class="xcbg7zvkh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:empty-dashboard-rounded" /></template>
<style>
.xcbg7zvkh {
  fill: currentColor;
