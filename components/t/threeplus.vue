...
const content = `<path class="i4kl4mb3s"/><path class="v5e-yac1z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:threeplus" /></template>
<style>
.i4kl4mb3s {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M17.704 24.425c-4.017-.351-5.713-2.81-1.848-5.128c1.661-.998 5.554-2.933 1.221-3l-6.988-.115c-2.23-.036-6.275-1.036-3.828-3.636C18.06.012 37.863 5.092 29.39 20.744c12.066 9.713 1.159 20.072-5.01 21.285C12.724 44.322 4.43 37.877 5.8 30.612c.543-2.895 3.22-5.351 6.583-5.34c4.137.065 5.437 2.974 5.43 5.984c2.984.318 5.788-2.39 4.607-4.92c-.615-1.314-1.543-1.632-4.716-1.909zM42.5 18.837h-9.366m4.683 4.683v-9.365");
}
