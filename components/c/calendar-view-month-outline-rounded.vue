...
const content = `<path class="xd6ga4bjc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:calendar-view-month-outline-rounded" /></template>
<style>
.xd6ga4bjc {
  fill: currentColor;
