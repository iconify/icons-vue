...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-trending-up-sparkles-duotone" /></template>
<style>
.e1_6k6xoi {
  d: path("M19 4.8586C20.8514 6.6735 22 9.2026 22 12C22 17.5228 17.5228 22 12 22C6.4772 22 2 17.5228 2 12M7 14.5L10.2 11.3L12.7 13.8L16.6 9.9M14 9.5L16.5 9.5C16.7761 9.5 17 9.7239 17 10L17 12.5");
}
