...
const content = `<path class="agof0e_rv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-passkey-16-filled" /></template>
<style>
.agof0e_rv {
  fill: currentColor;
