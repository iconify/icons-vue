...
const content = `<g class="y9tr6bcfx"><path class="rl0xfmb9n"/><path class="qle6e8b3u"/></g><g class="y9tr6bcfx"><rect class="w5ztvbg7m"/><path class="w9v12qzbx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-simple-30" /></template>
<style>
.qle6e8b3u {
