...
const content = `<path class="x4o0nkzxo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-horiz-075-outline" /></template>
<style>
.x4o0nkzxo {
  fill: currentColor;
