...
const content = `<path class="bb8kwm8po"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-words-48-regular" /></template>
<style>
.bb8kwm8po {
  fill: currentColor;
