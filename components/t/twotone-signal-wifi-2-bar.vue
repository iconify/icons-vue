...
const content = `<path class="ogp381bbc"/><path class="oiy13ij0f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-signal-wifi-2-bar" /></template>
<style>
.ogp381bbc {
  fill: currentColor;
