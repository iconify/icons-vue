...
const content = `<path class="x0z43pb8o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-arrow-clockwise-32-filled" /></template>
<style>
.x0z43pb8o {
  fill: currentColor;
