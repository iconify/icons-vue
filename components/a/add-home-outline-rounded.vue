...
const content = `<path class="fz2jf5b9f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:add-home-outline-rounded" /></template>
<style>
.fz2jf5b9f {
  fill: currentColor;
