...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-outgoing-duotone" /></template>
<style>
.jok7bp-pn {
  d: path("M21.5 2.5L17 7M22 8L22 2.5C22 2.2239 21.7761 2 21.5 2L16 2");
}
