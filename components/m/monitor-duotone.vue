...
const content = `<g class="cuyn6tgcc"><path class="f8fisnbwt"/><path class="qqrc35qgr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:monitor-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
