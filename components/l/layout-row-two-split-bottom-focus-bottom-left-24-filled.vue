...
const content = `<path class="h8_mh9_0p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-two-split-bottom-focus-bottom-left-24-filled" /></template>
<style>
.h8_mh9_0p {
  fill: currentColor;
