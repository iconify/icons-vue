...
const content = `<circle class="ihwennzfv"/><path class="oysc_swgr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-light-mode" /></template>
<style>
.ihwennzfv {
  cx: 12px;
  cy: 12px;
