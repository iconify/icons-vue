...
const content = `<path class="q3q3ojbrt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:supervised-user-circle-rounded" /></template>
<style>
.q3q3ojbrt {
  fill: currentColor;
