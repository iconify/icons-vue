...
const content = `<g class="ft5dv1b6b"><defs><mask id="SVGxTg2acWC"><path class="k5-vjlrin"/><g clip-rule="evenodd" class="kvn14gsjy"><path class="c440bubqs"/><path class="wc3s_ujig"/><path class="w-ow18bux"/></g></mask></defs><circle mask="url(#SVGxTg2acWC)" class="bd9gczbnq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:earth-asia-circle-filled" /></template>
<style>
.bd9gczbnq {
  cx: 13px;
  cy: 13px;
