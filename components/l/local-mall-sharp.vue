...
const content = `<path class="ngav9l2_f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-mall-sharp" /></template>
<style>
.ngav9l2_f {
  fill: currentColor;
