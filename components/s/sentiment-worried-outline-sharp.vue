...
const content = `<path class="pqn563buj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sentiment-worried-outline-sharp" /></template>
<style>
.pqn563buj {
  fill: currentColor;
