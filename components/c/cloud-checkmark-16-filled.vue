...
const content = `<path class="u-r1ws25t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-checkmark-16-filled" /></template>
<style>
.u-r1ws25t {
  fill: currentColor;
