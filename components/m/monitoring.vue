...
const content = `<path class="thl3w8b5f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:monitoring" /></template>
<style>
.thl3w8b5f {
  fill: currentColor;
