...
const content = `<path class="loobaw_qm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shuffle-on-outline" /></template>
<style>
.loobaw_qm {
  fill: currentColor;
