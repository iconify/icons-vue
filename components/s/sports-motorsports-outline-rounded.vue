...
const content = `<path class="zlyolbb3x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sports-motorsports-outline-rounded" /></template>
<style>
.zlyolbb3x {
  fill: currentColor;
