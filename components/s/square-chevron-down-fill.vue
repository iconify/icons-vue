...
const content = `<path class="m4k1ngbxs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-chevron-down-fill" /></template>
<style>
.m4k1ngbxs {
  fill: currentColor;
