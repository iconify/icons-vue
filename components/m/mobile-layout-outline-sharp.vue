...
const content = `<path class="ujnf8nxsp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-layout-outline-sharp" /></template>
<style>
.ujnf8nxsp {
  fill: currentColor;
