...
const content = `<path class="t0hnn1bfr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:record-voice-over-sharp" /></template>
<style>
.t0hnn1bfr {
  fill: currentColor;
