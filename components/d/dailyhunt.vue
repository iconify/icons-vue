...
const content = `<path class="yb6q80s4w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dailyhunt" /></template>
<style>
.yb6q80s4w {
  fill: none;
  stroke: currentColor;
