...
const content = `<path class="duc3gge8t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stack-group-outline-rounded" /></template>
<style>
.duc3gge8t {
  fill: currentColor;
