...
const content = `<g class="gp_8x1bzb"><path class="qlh6dmbhz"/><path class="dabf_d2bk"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:heart-plus-sharp-duotone" /></template>
<style>
.dabf_d2bk {
