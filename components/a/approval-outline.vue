...
const content = `<path class="lwqvkwb_c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:approval-outline" /></template>
<style>
.lwqvkwb_c {
  fill: currentColor;
