...
const content = `<path class="n59yplbqx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:playing-cards-outline" /></template>
<style>
.n59yplbqx {
  fill: currentColor;
