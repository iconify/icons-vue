...
const content = `<path class="cqz-tojzc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:voice-selection-off-outline-rounded" /></template>
<style>
.cqz-tojzc {
  fill: currentColor;
