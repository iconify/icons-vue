...
const content = `<path class="iwettlg_h"/><path class="zu1zhse9f"/><path class="n5xxc7bgs"/><path class="o5m6dgb6m"/><path class="knul81byb"/><path class="vjnaa0b7a"/><path class="mo5r4wbzu"/><path class="j2cdgfbun"/><circle class="ut_t21syf"/><circle class="o5-krulhj"/><circle class="u3kv_m4fm"/><path class="q4uolacju"/><path class="dsrb_8a9x"/><path class="vgfpwkz3u"/><path class="lgz8_jxsd"/><path class="brkjq0r0m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:person-juggling-medium-light-skin-tone" /></template>
<style>
.brkjq0r0m {
