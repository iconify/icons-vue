...
const content = `<path class="e3iaui2sd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:switch-video-outline" /></template>
<style>
.e3iaui2sd {
  fill: currentColor;
