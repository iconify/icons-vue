...
const content = `<path class="ke5g8vb9v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:page-control-outline-rounded" /></template>
<style>
.ke5g8vb9v {
  fill: currentColor;
