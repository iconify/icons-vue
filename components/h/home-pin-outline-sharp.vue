...
const content = `<path class="r0qqiezef"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:home-pin-outline-sharp" /></template>
<style>
.r0qqiezef {
  fill: currentColor;
