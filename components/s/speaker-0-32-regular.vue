...
const content = `<path class="buwfomhhp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-0-32-regular" /></template>
<style>
.buwfomhhp {
  fill: currentColor;
