...
const content = `<path class="kqk1_ubtd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:nightlife-outline-sharp" /></template>
<style>
.kqk1_ubtd {
  fill: currentColor;
