...
const content = `<path class="d76g10s-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:notification-add-outline-rounded" /></template>
<style>
.d76g10s-g {
  fill: currentColor;
