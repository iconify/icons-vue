...
const content = `<path class="a9cahsbad"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:psychology-alt-outline-sharp" /></template>
<style>
.a9cahsbad {
  fill: currentColor;
