...
const content = `<path class="igrvstbvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:your-trips-rounded" /></template>
<style>
.igrvstbvo {
  fill: currentColor;
