...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-dashed-quarter-sharp-fill" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.ljt96p77g {
  ...
  d: path("M12 7L17 7L17 12L12 12L12 7Z");
}
