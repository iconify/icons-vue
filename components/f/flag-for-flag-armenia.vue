...
const content = `<path class="d245zxgwh"/><path class="njmok7f2v"/><path class="u7es78bok"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-armenia" /></template>
<style>
.d245zxgwh {
