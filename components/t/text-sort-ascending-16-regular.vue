...
const content = `<path class="q5k3k4qvs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-sort-ascending-16-regular" /></template>
<style>
.q5k3k4qvs {
  fill: currentColor;
