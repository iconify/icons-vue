...
const content = `<path class="kcl1kybcf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stairs-2-outline-rounded" /></template>
<style>
.kcl1kybcf {
  fill: currentColor;
