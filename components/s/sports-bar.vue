...
const content = `<path class="dzdlu85xs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sports-bar" /></template>
<style>
.dzdlu85xs {
  fill: currentColor;
