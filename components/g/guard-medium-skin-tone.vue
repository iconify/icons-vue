...
const content = `<path class="pvzv9cbkt"/><path class="e8gedzito"/><g class="n1mjunbsu"><circle class="ed6fmyb9l"/><circle class="fqau1xbcn"/></g><g class="fbp0m0b1e"><path class="cm3wbab7c"/><circle class="h3w494vbn"/></g><path class="qkva-gbfy"/><circle class="u6l8n6jdv"/><circle class="unarhpbhk"/><path class="d_lvc1h7j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:guard-medium-skin-tone" /></template>
<style>
.cm3wbab7c {
