...
const content = `<path class="hq-02ackl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:multiple-airports" /></template>
<style>
.hq-02ackl {
  fill: currentColor;
