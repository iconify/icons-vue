...
const content = `<path class="c1knh1qlc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:inbox-outline-sharp" /></template>
<style>
.c1knh1qlc {
  fill: currentColor;
