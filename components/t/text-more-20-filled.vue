...
const content = `<path class="c5motpble"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-more-20-filled" /></template>
<style>
.c5motpble {
  fill: currentColor;
