...
const content = `<path class="fgdzerhph"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dehaze-rounded" /></template>
<style>
.fgdzerhph {
  fill: currentColor;
