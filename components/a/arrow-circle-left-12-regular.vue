...
const content = `<path class="xz_nvxyje"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-left-12-regular" /></template>
<style>
.xz_nvxyje {
  fill: currentColor;
