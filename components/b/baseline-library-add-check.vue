...
const content = `<path class="az65jfbpn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-library-add-check" /></template>
<style>
.az65jfbpn {
  fill: currentColor;
