...
const content = `<path class="e3mo6wb_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-truck-cube-24-regular" /></template>
<style>
.e3mo6wb_q {
  fill: currentColor;
