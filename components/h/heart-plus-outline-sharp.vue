...
const content = `<path class="es2iet5nb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:heart-plus-outline-sharp" /></template>
<style>
.es2iet5nb {
  fill: currentColor;
