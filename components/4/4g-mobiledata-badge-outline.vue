...
const content = `<path class="z648xlbre"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:4g-mobiledata-badge-outline" /></template>
<style>
.z648xlbre {
  fill: currentColor;
