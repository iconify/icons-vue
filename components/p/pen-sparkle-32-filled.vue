...
const content = `<path class="udcgrcbwl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pen-sparkle-32-filled" /></template>
<style>
.udcgrcbwl {
  fill: currentColor;
