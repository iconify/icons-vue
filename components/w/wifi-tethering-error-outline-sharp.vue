...
const content = `<path class="q_2pgsm1s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wifi-tethering-error-outline-sharp" /></template>
<style>
.q_2pgsm1s {
  fill: currentColor;
