...
const content = `<path class="avv_6oe-z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-copy-16-filled" /></template>
<style>
.avv_6oe-z {
  fill: currentColor;
