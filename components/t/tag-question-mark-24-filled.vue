...
const content = `<path class="fjvaddcgx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tag-question-mark-24-filled" /></template>
<style>
.fjvaddcgx {
  fill: currentColor;
