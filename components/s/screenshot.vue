...
const content = `<path class="pv0aslowo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screenshot" /></template>
<style>
.pv0aslowo {
  fill: currentColor;
