...
const content = `<path class="s__tse86q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:group-auto-outline-rounded" /></template>
<style>
.s__tse86q {
  fill: currentColor;
