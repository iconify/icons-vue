...
const content = `<path class="p8ko_5bpy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-cell-four-focus-top-right-16-filled" /></template>
<style>
.p8ko_5bpy {
  fill: currentColor;
