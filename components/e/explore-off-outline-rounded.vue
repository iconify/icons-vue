...
const content = `<path class="nn00s8uhi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:explore-off-outline-rounded" /></template>
<style>
.nn00s8uhi {
  fill: currentColor;
