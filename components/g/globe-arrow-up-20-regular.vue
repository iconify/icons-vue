...
const content = `<path class="p9f9zzbkw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-arrow-up-20-regular" /></template>
<style>
.p9f9zzbkw {
  fill: currentColor;
