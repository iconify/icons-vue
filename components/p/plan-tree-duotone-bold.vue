...
const content = `<g class="s0phu2bbs"><path class="vcsiwjg-w"/><path class="kkk3u9byv"/><path class="fwd-czbqw"/><path class="ffl_tubrp"/><path class="fl42iabgs"/><path class="s4opvo9pz"/><path class="siocq_7mf"/><path class="iic1bs66d"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:plan-tree-duotone-bold" /></template>
<style>
.ffl_tubrp {
