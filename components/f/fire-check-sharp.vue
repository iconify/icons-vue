...
const content = `<path class="r7mb0_bgx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fire-check-sharp" /></template>
<style>
.r7mb0_bgx {
  fill: currentColor;
