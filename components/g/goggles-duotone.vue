...
const content = `<g class="cuyn6tgcc"><path class="tnywv3bky"/><path class="emb35rbnq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:goggles-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
