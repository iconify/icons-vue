...
const content = `<path class="n_8_l4huj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:filter-list-outline-rounded" /></template>
<style>
.n_8_l4huj {
  fill: currentColor;
