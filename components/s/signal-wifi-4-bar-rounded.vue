...
const content = `<path class="u6suhn5sk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:signal-wifi-4-bar-rounded" /></template>
<style>
.u6suhn5sk {
  fill: currentColor;
