...
const content = `<path class="gkm4cdcjx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-8-32-regular" /></template>
<style>
.gkm4cdcjx {
  fill: currentColor;
