...
const content = `<path class="ch3pgy7xe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:panorama-wide-angle-outline-rounded" /></template>
<style>
.ch3pgy7xe {
  fill: currentColor;
