...
const content = `<path class="s6iwyub8g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:summarize" /></template>
<style>
.s6iwyub8g {
  fill: currentColor;
