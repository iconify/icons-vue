...
const content = `<path class="nf3jo9bly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:star-half-outline-sharp" /></template>
<style>
.nf3jo9bly {
  fill: currentColor;
