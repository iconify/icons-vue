...
const content = `<path class="j9c59ccli"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-laptop-20-filled" /></template>
<style>
.j9c59ccli {
  fill: currentColor;
