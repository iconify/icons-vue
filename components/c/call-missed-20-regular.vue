...
const content = `<path class="ri3nhnbcu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-missed-20-regular" /></template>
<style>
.ri3nhnbcu {
  fill: currentColor;
