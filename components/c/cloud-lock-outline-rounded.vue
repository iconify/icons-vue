...
const content = `<path class="z6__0acyo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloud-lock-outline-rounded" /></template>
<style>
.z6__0acyo {
  fill: currentColor;
