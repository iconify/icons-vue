...
const content = `<path class="xx2z4so5p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screen-rotation-up" /></template>
<style>
.xx2z4so5p {
  fill: currentColor;
