...
const content = `<path class="n1ev47boa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:contact-emergency-outline-rounded" /></template>
<style>
.n1ev47boa {
  fill: currentColor;
