...
const content = `<path class="tlp7-zbik"/><path class="te-t7_dow"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dice" /></template>
<style>
.te-t7_dow {
  fill: none;
  stroke: currentColor;
...
.tlp7-zbik {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M21.535 4.5c6.002 3.288 10.194 8.469 16.688 11.999c-4.302 4.834-6.865 10.938-11.344 15.62c-5.636-4.337-11.726-6.948-17.102-11.31C12.134 14.629 17.8 10.726 21.535 4.5");
}
