...
const content = `<path class="acf0wdbzk"/><path class="hrll78j7d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:folder-favourites" /></template>
<style>
.acf0wdbzk {
  fill: none;
  stroke: currentColor;
