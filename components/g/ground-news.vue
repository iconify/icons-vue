...
const content = `<path class="f5hpembek"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ground-news" /></template>
<style>
.f5hpembek {
  fill: none;
  stroke: currentColor;
