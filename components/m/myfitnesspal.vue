...
const content = `<path class="o9-xfbu_z"/><path class="l2gju6blm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:myfitnesspal" /></template>
<style>
.l2gju6blm {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M5.005 24.793a19 19 0 1 1 37.99-.826q.01.413 0 .826");
}
