...
const content = `<path class="zggjoq3se"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stack-star" /></template>
<style>
.zggjoq3se {
  fill: currentColor;
