...
const content = `<path class="ngw-kgbnr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:watch-off-sharp" /></template>
<style>
.ngw-kgbnr {
  fill: currentColor;
