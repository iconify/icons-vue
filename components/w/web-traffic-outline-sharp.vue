...
const content = `<path class="l7exfsbns"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:web-traffic-outline-sharp" /></template>
<style>
.l7exfsbns {
  fill: currentColor;
