...
const content = `<path class="l7z8sbmfc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:star-emphasis-24-regular" /></template>
<style>
.l7z8sbmfc {
  fill: currentColor;
