...
const content = `<path class="t2xr28o0y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:description-rounded" /></template>
<style>
.t2xr28o0y {
  fill: currentColor;
