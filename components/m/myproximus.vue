...
const content = `<path class="ukr40eb8k"/><path class="vf2dpm4ov"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:myproximus" /></template>
<style>
.ukr40eb8k {
  fill: none;
  d: path("M19.171 19.171a37 37 0 0 1 .32 4.829a37 37 0 0 1-.32 4.829a36.5 36.5 0 0 1 9.658 0a36.5 36.5 0 0 1 0-9.658a37 37 0 0 1-4.829.32a37 37 0 0 1-4.829-.32");
}
