...
const content = `<path class="i7l8un8lo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:code-block-32-regular" /></template>
<style>
.i7l8un8lo {
  fill: currentColor;
