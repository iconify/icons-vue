...
const content = `<path class="kiew8t6so"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cells-merge-16-filled" /></template>
<style>
.kiew8t6so {
  fill: currentColor;
