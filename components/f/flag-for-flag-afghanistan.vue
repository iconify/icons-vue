...
const content = `<path class="jz2sxlvic"/><path class="z64_nnbjs"/><path class="a0nnzebbf"/><g class="n1mjunbsu"><path class="gm0ka3d_z"/><path class="bgvfeiryn"/><path class="nt1d70ojc"/><path class="ycqz95b4u"/><path class="s1-wgn1mm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-afghanistan" /></template>
<style>
.a0nnzebbf {
...
.bgvfeiryn {
  d: path("M34.1 34.7h.1v1h-.1zm-5.8 1.1h1.1v-1.3h-1.1v.3L26.1 31l.1-.2q0-.3-.3-.3t-.3.3c0 .3.1.3.3.3h.1l.1.1c-.2 0-.4.5-.9.9c-.3.2-.5.9-.6 1.3v.9c0 .2-.2.6-.1.7c.3.2.7.8.9 1c.1.1.3-.6.4-1.1v-.1c.1-.4.1-.9.4-1.2l.1-.1c.2-.2.6-.4.8-.6l1.3 2.3zm0-8.5h1v.2h-1zm0 .4h1v2h-1zm.5-1.5c-.2 0-.6.4-.5.8h1.1c0-.4-.4-.8-.6-.8");
}

.gm0ka3d_z {
  d: path("M35.8 37h-1.1c0 .5-.1.9-.4 1.2h2.2c-.4-.3-.7-.8-.7-1.2m.1-6.2l.6-.7h-2l-1-.7l-3.1-.1l-.9.8h-2l.6.7zm-5.3-1.6h2.7c.4-.2.5-.9.5-1.2c0-1.1-.7-1.6-1.4-1.6c-.1 0-.2-.1-.3-.2c-.1-.2-.1-.4-.1-.4c-.1 0 0 .1-.1.4c0 .1-.1.2-.3.2c-.9 0-1.5.7-1.4 1.6c0 .6.1 1 .4 1.2m3.9 8.2l-.5-.3v-.6l-.3-.2v-.6l-.5-.2V35l-.4-.1v-.5l-.6-.2l-.3-.2v-.4h-2v-.3c0-1 1.3-1.9 2.1-1.9c1 0 2.1.9 2.1 1.9v1h.1v-1c0-.9-1.1-2-2.1-2h3.6v-.1h-7.6v.1h3.6c-.6 0-2.1.7-2.1 2v3.6h.8v.7h-1c-.1 0-.2-.2-.2-.4h-1c0 .5-.3.9-.7 1.3h3v-.8h.8l.2.8h.7l-.3-.8h.7l.5.8h1l-.7-.8c0-.3 1.1-.3 1.1-.3m-4-1.3h.6l.1.7h-.7zm1.4 1.3h-.6l-.1-.7h.5l-.2-.7h.3l.4.7h-.5zm.7 0l-.4-.7h.6l.6.7z");
}
