...
const content = `<path class="l7h2c0bjz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dew-point-rounded" /></template>
<style>
.l7h2c0bjz {
  fill: currentColor;
