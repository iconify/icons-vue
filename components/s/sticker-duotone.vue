...
const content = `<g class="cuyn6tgcc"><path class="byubznbjk"/><path class="srk4dydzl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:sticker-duotone" /></template>
<style>
.byubznbjk {
  d: path("M216 136c-8 24-56 72-80 80v-32a48 48 0 0 1 48-48Z");
