...
const content = `<path class="ddqrdktkg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:map-pin-plus-sharp" /></template>
<style>
.ddqrdktkg {
  fill: none;
  stroke: currentColor;
