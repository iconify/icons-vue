...
const content = `<path class="ck_7zvbqo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:unpaved-road-rounded" /></template>
<style>
.ck_7zvbqo {
  fill: currentColor;
