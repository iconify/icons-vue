...
const content = `<path class="lfs7o-z6k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:switch-video-rounded" /></template>
<style>
.lfs7o-z6k {
  fill: currentColor;
