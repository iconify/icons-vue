...
const content = `<path class="ev07zpwgw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:filester" /></template>
<style>
.ev07zpwgw {
  fill: none;
  stroke: currentColor;
