...
const content = `<path class="nxe6wy_9v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-inbox-person-48-filled" /></template>
<style>
.nxe6wy_9v {
  fill: currentColor;
