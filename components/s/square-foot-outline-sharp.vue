...
const content = `<path class="fp16j4y1q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:square-foot-outline-sharp" /></template>
<style>
.fp16j4y1q {
  fill: currentColor;
