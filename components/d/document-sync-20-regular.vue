...
const content = `<path class="sqc0sz-zf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-sync-20-regular" /></template>
<style>
.sqc0sz-zf {
  fill: currentColor;
