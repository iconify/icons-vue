...
const content = `<path class="fg8_m3rti"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wrap-text-outline-sharp" /></template>
<style>
.fg8_m3rti {
  fill: currentColor;
