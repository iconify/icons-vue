...
const content = `<path class="furtsucfu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:left-panel-open-rounded" /></template>
<style>
.furtsucfu {
  fill: currentColor;
