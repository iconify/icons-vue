...
const content = `<path class="lgbh8kbvx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sports-football-outline-rounded" /></template>
<style>
.lgbh8kbvx {
  fill: currentColor;
