...
const content = `<path class="vfzgipfhb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sticky-note-2-rounded" /></template>
<style>
.vfzgipfhb {
  fill: currentColor;
