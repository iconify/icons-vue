...
const content = `<path class="ps0u0acdb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:translate-cc" /></template>
<style>
.ps0u0acdb {
  fill: currentColor;
