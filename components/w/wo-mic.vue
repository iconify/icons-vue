...
const content = `<path class="dr18h6byf"/><path class="rkz4pmrct"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wo-mic" /></template>
<style>
.dr18h6byf {
  fill: none;
  stroke: currentColor;
