...
const content = `<path class="pir9lutmr"/><path class="uwkc_6ncb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-looks-6" /></template>
<style>
.pir9lutmr {
  fill: currentColor;
