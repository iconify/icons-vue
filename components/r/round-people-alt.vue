...
const content = `<path class="i37g3gb8u"/><circle class="rw0diq37y"/><path class="o72jhfb5y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-people-alt" /></template>
<style>
.i37g3gb8u {
  fill: currentColor;
  fill-rule: evenodd;
