...
const content = `<path class="cz05u5bga"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-park-20-filled" /></template>
<style>
.cz05u5bga {
  fill: currentColor;
