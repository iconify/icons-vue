...
const content = `<path class="x-n8b540u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:app-folder-48-filled" /></template>
<style>
.x-n8b540u {
  fill: currentColor;
