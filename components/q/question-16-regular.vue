...
const content = `<path class="hhp4o7bip"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:question-16-regular" /></template>
<style>
.hhp4o7bip {
  fill: currentColor;
