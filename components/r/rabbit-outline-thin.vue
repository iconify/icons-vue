...
const content = `<g class="hntgybcog"><path class="osjmvib6z"/><path class="le7pjtb_z"/><path class="iv17tcb7u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:rabbit-outline-thin" /></template>
<style>
.hntgybcog {
  fill: none;
  stroke: currentColor;
