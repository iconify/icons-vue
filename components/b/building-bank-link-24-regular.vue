...
const content = `<path class="ep3v9_e_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-bank-link-24-regular" /></template>
<style>
.ep3v9_e_q {
  fill: currentColor;
