...
const content = `<path class="eg_4t4p1a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ajaib" /></template>
<style>
.eg_4t4p1a {
  fill: none;
  stroke: currentColor;
