...
const content = `<path class="wcldf2bam"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-eight-thin" /></template>
<style>
.wcldf2bam {
  fill: currentColor;
