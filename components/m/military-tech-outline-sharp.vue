...
const content = `<path class="wyltl5bae"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:military-tech-outline-sharp" /></template>
<style>
.wyltl5bae {
  fill: currentColor;
