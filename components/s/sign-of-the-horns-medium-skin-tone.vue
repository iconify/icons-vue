...
const content = `<path class="vulh3zbnc"/><defs><path id="SVGTOqBNeBR" class="izn13ybjx"/></defs><clipPath id="SVGwOpa3N9h"><use href="#SVGTOqBNeBR"/></clipPath><g clip-path="url(#SVGwOpa3N9h)" class="byeg-0b8a"><path class="iepnxq05z"/><path class="vlyeqrv8u"/></g><defs><use href="#SVGTOqBNeBR" id="SVGjQNi3cMO"/></defs><clipPath id="SVGSOmC5dIl"><use href="#SVGjQNi3cMO"/></clipPath><g clip-path="url(#SVGSOmC5dIl)"><path class="nc_wetqbj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:sign-of-the-horns-medium-skin-tone" /></template>
<style>
.byeg-0b8a {
