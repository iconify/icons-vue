...
const content = `<path class="gqt8wpb3n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:call-log-rounded" /></template>
<style>
.gqt8wpb3n {
  fill: currentColor;
