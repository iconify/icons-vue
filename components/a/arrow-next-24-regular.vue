...
const content = `<path class="vbsw7dhtf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-next-24-regular" /></template>
<style>
.vbsw7dhtf {
  fill: currentColor;
