...
const content = `<path class="i-w1j6b1w"/><path class="q4dvkc--n"/><path class="kns8wvxzb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-estonia" /></template>
<style>
.i-w1j6b1w {
