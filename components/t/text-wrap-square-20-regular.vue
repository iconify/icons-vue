...
const content = `<path class="myhrqnbam"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-wrap-square-20-regular" /></template>
<style>
.myhrqnbam {
  fill: currentColor;
