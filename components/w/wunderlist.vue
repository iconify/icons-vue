...
const content = `<path class="gde7x16an"/><path class="t--ozbbml"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wunderlist" /></template>
<style>
.gde7x16an {
  fill: none;
  stroke: currentColor;
