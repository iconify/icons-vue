...
const content = `<path class="qtf3h-bln"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:plug-connected-28-filled" /></template>
<style>
.qtf3h-bln {
  fill: currentColor;
