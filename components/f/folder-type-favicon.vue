...
const content = `<path class="wq_efls1z"/><circle class="fi_zd0r9l"/><circle class="gg2gvfbwf"/><path class="lw9ofs1oy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-favicon" /></template>
<style>
.fi_zd0r9l {
  cx: 21px;
  cy: 21px;
...
.wq_efls1z {
  fill: var(--svg-color--5789b2, #5789b2);
