...
const content = `<path class="nqg2x5b6d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:timer-10-alt-1" /></template>
<style>
.nqg2x5b6d {
  fill: currentColor;
