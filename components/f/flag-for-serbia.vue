...
const content = `<path class="d245zxgwh"/><path class="i-w1j6b1w"/><path class="u8n7pgbwg"/><path class="n3n003rjk"/><path class="sm1i2kbkx"/><path class="ul6ehu22i"/><path class="d94ghhbko"/><g class="n1mjunbsu"><path class="jk-c6_bxf"/><path class="n3yao3y8p"/></g><path class="d_i99-brh"/><path class="t_xzuccno"/><path class="mvw6eh3hm"/><path class="q0hz4_g2f"/><path class="nvsye1b0j"/><path class="wmiua2bps"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-serbia" /></template>
<style>
.d_i99-brh {
  fill: var(--svg-color--428bc1, #428bc1);
  d: path("M27 11.7h-2v2h2z");
}
...
.d94ghhbko {
  fill: var(--svg-color--ed4c5c, #ed4c5c);
  d: path("M21.6 28.6v7.3c0 2.2 2 4 4.4 4s4.4-1.8 4.4-4v-7.3z");
}
...
.jk-c6_bxf {
  d: path("M24.8 27.3h2.5v15h-2.5z");
}

.mvw6eh3hm {
  fill: var(--svg-color--ed4c5c, #ed4c5c);
  d: path("M27.4 17.2c.8-.7 1.3-1.4 1.7-2.1c-.7-.2-1.4-.3-2-.2c.1.8.2 1.6.3 2.3m-2.8 0c.1-.8.2-1.6.4-2.4c-.6-.1-1.3 0-2 .2c.2.8.8 1.5 1.6 2.2m8-1.4c-.1-.1-.3-.3-.6-.4s-.6-.2-.8-.2c-.1.8-.4 1.6-1.1 2.4c.3 0 .6-.1.8-.2c.8-.4 1.3-.9 1.7-1.3q.15-.15 0-.3m-11.8-.7c-.2 0-.5.1-.8.2c-.5.2-.8.6-.6.7c.4.4.9.8 1.7 1.3c.2.1.5.1.8.2c-.7-.8-1-1.5-1.1-2.4");
}
