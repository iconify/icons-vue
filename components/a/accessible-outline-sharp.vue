...
const content = `<path class="sr3rjmb5s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:accessible-outline-sharp" /></template>
<style>
.sr3rjmb5s {
  fill: currentColor;
