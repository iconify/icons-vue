...
const content = `<path class="xk6bg3bqz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:heart-duotone" /></template>
<style>
.xk6bg3bqz {
  fill: none;
  stroke: currentColor;
