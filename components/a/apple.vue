...
const content = `<path class="ab4wjjbaj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:apple" /></template>
<style>
.ab4wjjbaj {
  fill: none;
  stroke: currentColor;
