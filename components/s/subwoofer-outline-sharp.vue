...
const content = `<path class="y2yv6gqvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:subwoofer-outline-sharp" /></template>
<style>
.y2yv6gqvo {
  fill: currentColor;
