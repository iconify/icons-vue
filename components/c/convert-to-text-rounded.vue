...
const content = `<path class="uq0hnhn0u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:convert-to-text-rounded" /></template>
<style>
.uq0hnhn0u {
  fill: currentColor;
