...
const content = `<path class="z_-dxqbld"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-developer-mode" /></template>
<style>
.z_-dxqbld {
  fill: currentColor;
