...
const content = `<path class="zx25fp2bt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:keybase" /></template>
<style>
.zx25fp2bt {
  fill: none;
  stroke: currentColor;
