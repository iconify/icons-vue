...
const content = `<path class="g82sbnbey"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:climate-mini-split-outline-sharp" /></template>
<style>
.g82sbnbey {
  fill: currentColor;
