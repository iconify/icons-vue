...
const content = `<path class="syres0bdg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-photo-size-select-large" /></template>
<style>
.syres0bdg {
  fill: currentColor;
