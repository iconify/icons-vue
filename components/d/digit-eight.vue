...
const content = `<linearGradient id="ssvg-id-digit-eighta" gradientUnits="userSpaceOnUse" x1="64.01" y1="101.51" x2="64.01" y2="25.39"><stop offset=".485" class="fboms9lpk"/><stop offset="1" class="vlzxxcccm"/></linearGradient><path fill="url(#ssvg-id-digit-eighta)" class="hmvhuccvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:digit-eight" /></template>
<style>
.fboms9lpk {
