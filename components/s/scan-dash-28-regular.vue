...
const content = `<path class="q_bd20b8l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-dash-28-regular" /></template>
<style>
.q_bd20b8l {
  fill: currentColor;
