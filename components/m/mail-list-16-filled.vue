...
const content = `<path class="nnd_knvou"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-list-16-filled" /></template>
<style>
.nnd_knvou {
  fill: currentColor;
