...
const content = `<path class="qwbwgegos"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ink-marker-outline-rounded" /></template>
<style>
.qwbwgegos {
  fill: currentColor;
