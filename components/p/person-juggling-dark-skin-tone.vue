...
const content = `<path class="iwettlg_h"/><path class="b0ykmccmm"/><path class="rzjjj6u-q"/><path class="r6k0p8_gh"/><path class="ca1sb8b7i"/><path class="osbidgq_b"/><path class="iz15lyb8w"/><path class="j2cdgfbun"/><circle class="ut_t21syf"/><circle class="o5-krulhj"/><circle class="u3kv_m4fm"/><path class="bjgsohbit"/><path class="t3h50ub1t"/><path class="j5x5xy2yr"/><path class="tt2p-sb-m"/><path class="brkjq0r0m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:person-juggling-dark-skin-tone" /></template>
<style>
.b0ykmccmm {
