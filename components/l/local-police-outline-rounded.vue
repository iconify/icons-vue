...
const content = `<path class="nnlnm5bjh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-police-outline-rounded" /></template>
<style>
.nnlnm5bjh {
  fill: currentColor;
