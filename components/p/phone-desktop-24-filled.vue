...
const content = `<path class="rlob8wilr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-desktop-24-filled" /></template>
<style>
.rlob8wilr {
  fill: currentColor;
