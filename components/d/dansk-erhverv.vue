...
const content = `<circle class="cpk0fnbgt"/><path class="ssotmt_sx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dansk-erhverv" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
