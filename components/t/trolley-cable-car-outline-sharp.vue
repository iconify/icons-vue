...
const content = `<path class="x_h42ibvk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:trolley-cable-car-outline-sharp" /></template>
<style>
.x_h42ibvk {
  fill: currentColor;
