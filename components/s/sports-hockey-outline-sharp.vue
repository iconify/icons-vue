...
const content = `<path class="yojppbvpf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sports-hockey-outline-sharp" /></template>
<style>
.yojppbvpf {
  fill: currentColor;
