...
const content = `<path class="bac1l6b6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:voice-over-off-rounded" /></template>
<style>
.bac1l6b6a {
  fill: currentColor;
