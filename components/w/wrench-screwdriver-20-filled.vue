...
const content = `<path class="dtvvnlb9l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:wrench-screwdriver-20-filled" /></template>
<style>
.dtvvnlb9l {
  fill: currentColor;
