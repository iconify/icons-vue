...
const content = `<g class="gp_8x1bzb"><path class="ygul10psw"/><path class="jcie6qvkq"/><path class="unky6y77u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:app-window-minus-sharp-two-tone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.jcie6qvkq {
  d: path("M12 21L3 21L3 3L21 3L21 12M14 18L22 18");
}
