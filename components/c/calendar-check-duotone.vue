...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:calendar-check-duotone" /></template>
<style>
.bp-w5nx6c {
  fill: currentColor;
...
.mbsn9hbid {
  d: path("M7 11L17 11M8 3L8 7M16 3L16 7M15 18L17 20L21 16");
}
