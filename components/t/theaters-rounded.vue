...
const content = `<path class="na-vreb0w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:theaters-rounded" /></template>
<style>
.na-vreb0w {
  fill: currentColor;
