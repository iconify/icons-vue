...
const content = `<path class="fo75vtb5o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-add-24-regular" /></template>
<style>
.fo75vtb5o {
  fill: currentColor;
