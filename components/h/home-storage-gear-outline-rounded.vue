...
const content = `<path class="kq872a-ap"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:home-storage-gear-outline-rounded" /></template>
<style>
.kq872a-ap {
  fill: currentColor;
