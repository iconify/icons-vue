...
const content = `<path class="jcz2ubbkm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-retail-24-regular" /></template>
<style>
.jcz2ubbkm {
  fill: currentColor;
