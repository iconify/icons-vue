...
const content = `<path class="hs43d5bcd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layer-diagonal-sparkle-20-regular" /></template>
<style>
.hs43d5bcd {
  fill: currentColor;
