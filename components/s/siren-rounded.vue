...
const content = `<path class="svmwrsbtv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:siren-rounded" /></template>
<style>
.svmwrsbtv {
  fill: currentColor;
