...
const content = `<path class="nqcfzybmh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bubbles-outline" /></template>
<style>
.nqcfzybmh {
  fill: currentColor;
