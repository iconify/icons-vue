...
const content = `<path class="ph37z3bzk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:boy-outline-sharp" /></template>
<style>
.ph37z3bzk {
  fill: currentColor;
