...
const content = `<path class="m0e2xabce"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-image-break-left-outline-rounded" /></template>
<style>
.m0e2xabce {
  fill: currentColor;
