...
const content = `<path class="tc96-ibom"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:move-selection-down-rounded" /></template>
<style>
.tc96-ibom {
  fill: currentColor;
