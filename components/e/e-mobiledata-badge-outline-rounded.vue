...
const content = `<path class="aaij1-b3u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:e-mobiledata-badge-outline-rounded" /></template>
<style>
.aaij1-b3u {
  fill: currentColor;
