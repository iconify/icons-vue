...
const content = `<path class="ssi4v93ar"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:edit-settings-24-regular" /></template>
<style>
.ssi4v93ar {
  fill: currentColor;
