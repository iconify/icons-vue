...
const content = `<g class="ft5dv1b6b"><path class="i6wxj9g3o"/><path class="zvm2qbe9r"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-environments" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
