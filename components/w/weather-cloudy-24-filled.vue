...
const content = `<path class="b86-vge4t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-cloudy-24-filled" /></template>
<style>
.b86-vge4t {
  fill: currentColor;
