...
const content = `<path class="jo_g8mbzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dual-screen-tablet-20-regular" /></template>
<style>
.jo_g8mbzh {
  fill: currentColor;
