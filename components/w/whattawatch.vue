...
const content = `<path class="n6nmnacgu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:whattawatch" /></template>
<style>
.n6nmnacgu {
  fill: none;
  stroke: currentColor;
