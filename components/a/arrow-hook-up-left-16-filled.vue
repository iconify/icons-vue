...
const content = `<path class="z5sgk726v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-hook-up-left-16-filled" /></template>
<style>
.z5sgk726v {
  fill: currentColor;
