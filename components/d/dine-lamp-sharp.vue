...
const content = `<path class="uib214brz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dine-lamp-sharp" /></template>
<style>
.uib214brz {
  fill: currentColor;
