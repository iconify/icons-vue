...
const content = `<path class="l54lqr3ay"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-one-page-multiple-sparkle-20-filled" /></template>
<style>
.l54lqr3ay {
  fill: currentColor;
