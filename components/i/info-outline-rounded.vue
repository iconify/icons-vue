...
const content = `<path class="g_e7pkgoo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:info-outline-rounded" /></template>
<style>
.g_e7pkgoo {
  fill: currentColor;
