...
const content = `<path class="hbx9k22-r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:2d-outline-sharp" /></template>
<style>
.hbx9k22-r {
  fill: currentColor;
