...
const content = `<path class="hfhqt3bqz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shifts-activity-24-filled" /></template>
<style>
.hfhqt3bqz {
  fill: currentColor;
