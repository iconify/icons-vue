...
const content = `<path class="c79pedctg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:desktop-landscape-rounded" /></template>
<style>
.c79pedctg {
  fill: currentColor;
