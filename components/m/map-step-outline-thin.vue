...
const content = `<g class="hntgybcog"><path class="xrrcnmb6x"/><path class="c6ayt6bgs"/><path class="lv-mj3bxw"/><path class="oqq60ccjl"/><path class="e54_mjwsr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:map-step-outline-thin" /></template>
<style>
.c6ayt6bgs {
  d: path("M9.5 12h3");
}
