...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:click-assistant" /></template>
<style>
.iy9nwm0gz {
  fill: none;
  stroke: currentColor;
...
.zzxnrhb1d {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M30.516 36.764h4.168M23.221 8.626h18.758M25.305 34.68h16.674M23.22 13.837V7.584A2.08 2.08 0 0 1 25.305 5.5h14.59a2.08 2.08 0 0 1 2.084 2.084v29.18a2.08 2.08 0 0 1-2.084 2.084h-14.59a2.08 2.08 0 0 1-2.084-2.084");
}
