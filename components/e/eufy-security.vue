...
const content = `<path class="qb9y_z9bo"/><path class="a078x0b7t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:eufy-security" /></template>
<style>
.a078x0b7t {
  fill: none;
  stroke: currentColor;
...
.qb9y_z9bo {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m24 24l5.303-5.303A7.5 7.5 0 1 0 31.5 24");
}
