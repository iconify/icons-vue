...
const content = `<path class="w_5zo7oqb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:markdown-rounded" /></template>
<style>
.w_5zo7oqb {
  fill: currentColor;
