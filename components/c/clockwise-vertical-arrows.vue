...
const content = `<g class="y94jm1b4c"><path class="i143i8nkz"/><path class="wxro2xbgs"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:clockwise-vertical-arrows" /></template>
<style>
.i143i8nkz {
