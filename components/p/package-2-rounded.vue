...
const content = `<path class="ukgay5b8j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:package-2-rounded" /></template>
<style>
.ukgay5b8j {
  fill: currentColor;
