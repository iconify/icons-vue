...
const content = `<path class="iox5xvbzs"/><circle class="nl4qj1x6s"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:8ballpool" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
