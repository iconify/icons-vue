...
const content = `<path class="saemzdbmf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-3-sharp" /></template>
<style>
.saemzdbmf {
  fill: currentColor;
