...
const content = `<path class="anytvqbtf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:photo-camera-outline" /></template>
<style>
.anytvqbtf {
  fill: currentColor;
