...
const content = `<path class="p118-oagg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:eye-hide-24-regular" /></template>
<style>
.p118-oagg {
  fill: currentColor;
