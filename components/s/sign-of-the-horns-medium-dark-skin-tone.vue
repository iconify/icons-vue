...
const content = `<path class="g9kcjzbty"/><g class="rn7um9m2r"><path class="k-4s_kb-m"/><path class="axs-tfgmh"/><path class="t3uwr7rnt"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:sign-of-the-horns-medium-dark-skin-tone" /></template>
<style>
.axs-tfgmh {
