...
const content = `<path class="zb29r871t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:personal-bag-off-outline-sharp" /></template>
<style>
.zb29r871t {
  fill: currentColor;
