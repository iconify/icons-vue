...
const content = `<path class="ca8axbb3p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:crop-interim-20-regular" /></template>
<style>
.ca8axbb3p {
  fill: currentColor;
