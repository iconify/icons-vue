...
const content = `<path class="r8n-a5e1c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-quote-off-sharp" /></template>
<style>
.r8n-a5e1c {
  fill: currentColor;
