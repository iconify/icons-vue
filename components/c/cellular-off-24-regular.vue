...
const content = `<path class="vpjxd-bvn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cellular-off-24-regular" /></template>
<style>
.vpjxd-bvn {
  fill: currentColor;
