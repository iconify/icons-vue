...
const content = `<path class="iezjb0bkd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:print-connect" /></template>
<style>
.iezjb0bkd {
  fill: currentColor;
