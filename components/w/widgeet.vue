...
const content = `<path class="yqs4uwbzy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:widgeet" /></template>
<style>
.yqs4uwbzy {
  fill: none;
  stroke: currentColor;
