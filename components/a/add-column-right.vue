...
const content = `<path class="qfo0fvwhf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-column-right" /></template>
<style>
.qfo0fvwhf {
  fill: currentColor;
