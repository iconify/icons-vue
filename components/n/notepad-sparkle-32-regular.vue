...
const content = `<path class="m4lhzoeyo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notepad-sparkle-32-regular" /></template>
<style>
.m4lhzoeyo {
  fill: currentColor;
