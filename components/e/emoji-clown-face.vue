...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-clown-face" /></template>
<style>
.hjjdgubiq {
  fill: none;
  stroke: currentColor;
