...
const content = `<g class="ft5dv1b6b"><path class="heuurj2jw"/><path class="t8k7ey_3u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:eye-show-16-filled" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
...
.t8k7ey_3u {
  d: path("M5.5 9.5a2.5 2.5 0 1 1 5 0a2.5 2.5 0 0 1-5 0z");
  fill: currentColor;
}
