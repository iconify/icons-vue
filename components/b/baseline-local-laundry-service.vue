...
const content = `<path class="zc12bws7j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-local-laundry-service" /></template>
<style>
.zc12bws7j {
  fill: currentColor;
