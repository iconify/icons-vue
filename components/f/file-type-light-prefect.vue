...
const content = `<path class="vgbowipnf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-light-prefect" /></template>
<style>
.vgbowipnf {
