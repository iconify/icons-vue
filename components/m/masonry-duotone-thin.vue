...
const content = `<g class="hntgybcog"><path class="dq1p4tb5h"/><path class="ra9h64bkb"/><path class="cuqegsxii"/><path class="k0nzkxbmq"/><path class="v0renrgmb"/><path class="g9-a5bsup"/><path class="j3t1fbcok"/><path class="r2hn0nart"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:masonry-duotone-thin" /></template>
<style>
.cuqegsxii {
  fill: currentColor;
