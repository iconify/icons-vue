...
const content = `<path class="ue5mvwb9g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:laptop-multiple-24-filled" /></template>
<style>
.ue5mvwb9g {
  fill: currentColor;
