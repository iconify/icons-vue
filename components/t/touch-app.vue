...
const content = `<path class="icxbuzb-x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:touch-app" /></template>
<style>
.icxbuzb-x {
  fill: currentColor;
