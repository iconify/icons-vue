...
const content = `<path class="i7be26mrn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:card-membership-outline" /></template>
<style>
.i7be26mrn {
  fill: currentColor;
