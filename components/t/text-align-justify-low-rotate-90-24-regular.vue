...
const content = `<path class="ht401hbxd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-align-justify-low-rotate-90-24-regular" /></template>
<style>
.ht401hbxd {
  fill: currentColor;
