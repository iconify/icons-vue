...
const content = `<g class="nrj6p8qat"><path class="ciz47rm9a"/><path class="bdvz-nbcv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shield-key-duotone" /></template>
<style>
.bdvz-nbcv {
  d: path("M14 9.5C14 10.6046 13.1046 11.5 12 11.5C10.8954 11.5 10 10.6046 10 9.5C10 8.3954 10.8954 7.5 12 7.5C13.1046 7.5 14 8.3954 14 9.5ZM12 11.5L12 17.5M12 15.5L14 15.5");
}
