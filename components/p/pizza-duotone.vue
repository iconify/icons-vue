...
const content = `<g class="cuyn6tgcc"><path class="j1v--rbgf"/><path class="tmxn91bip"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:pizza-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
