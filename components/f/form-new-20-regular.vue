...
const content = `<path class="foayfgx4b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:form-new-20-regular" /></template>
<style>
.foayfgx4b {
  fill: currentColor;
