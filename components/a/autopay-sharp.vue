...
const content = `<path class="gnp9mkbdz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:autopay-sharp" /></template>
<style>
.gnp9mkbdz {
  fill: currentColor;
