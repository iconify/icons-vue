...
const content = `<path class="s17lyrb2a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-suggest-outline-sharp" /></template>
<style>
.s17lyrb2a {
  fill: currentColor;
