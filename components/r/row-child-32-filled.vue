...
const content = `<path class="di6tccc9c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:row-child-32-filled" /></template>
<style>
.di6tccc9c {
  fill: currentColor;
