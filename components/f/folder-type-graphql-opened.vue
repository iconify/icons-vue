...
const content = `<path class="kqf4vkbqu"/><path class="mc9e9ubli"/><path class="frw5wffpw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-graphql-opened" /></template>
<style>
.frw5wffpw {
...
.kqf4vkbqu {
  fill: var(--svg-color--fad7ee, #fad7ee);
