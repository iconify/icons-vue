...
const content = `<path class="kq319tbpr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stars-2-outline-rounded" /></template>
<style>
.kq319tbpr {
  fill: currentColor;
