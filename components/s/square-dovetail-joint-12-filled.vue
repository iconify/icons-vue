...
const content = `<path class="kwe1dxbuz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-dovetail-joint-12-filled" /></template>
<style>
.kwe1dxbuz {
  fill: currentColor;
