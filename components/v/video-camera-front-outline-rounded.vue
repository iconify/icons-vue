...
const content = `<path class="st4-y7b_y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:video-camera-front-outline-rounded" /></template>
<style>
.st4-y7b_y {
  fill: currentColor;
