...
const content = `<path class="ph_g70bsu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:plug-connect-rounded" /></template>
<style>
.ph_g70bsu {
  fill: currentColor;
