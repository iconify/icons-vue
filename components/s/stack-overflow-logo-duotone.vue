...
const content = `<g class="cuyn6tgcc"><path class="rj-p1fbma"/><path class="sfe550oar"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:stack-overflow-logo-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
