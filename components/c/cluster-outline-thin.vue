...
const content = `<g class="hntgybcog"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="n708z7b3q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:cluster-outline-thin" /></template>
<style>
.hntgybcog {
  fill: none;
  stroke: currentColor;
