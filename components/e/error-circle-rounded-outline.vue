...
const content = `<path class="l7lujz2tm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:error-circle-rounded-outline" /></template>
<style>
.l7lujz2tm {
  fill: currentColor;
