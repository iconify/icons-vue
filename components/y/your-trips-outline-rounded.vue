...
const content = `<path class="x9u22abgy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:your-trips-outline-rounded" /></template>
<style>
.x9u22abgy {
  fill: currentColor;
