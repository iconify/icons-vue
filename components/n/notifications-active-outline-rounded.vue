...
const content = `<path class="r47923e4m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:notifications-active-outline-rounded" /></template>
<style>
.r47923e4m {
  fill: currentColor;
