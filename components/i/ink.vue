...
const content = `<rect class="j3s9ivbxi"/><path class="smgbc4x0x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ink" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
