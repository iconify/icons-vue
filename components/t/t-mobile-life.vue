...
const content = `<path class="tr6hs4bwc"/><path class="kdeml0bcn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:t-mobile-life" /></template>
<style>
.kdeml0bcn {
  fill: none;
  stroke: currentColor;
...
.tr6hs4bwc {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M35.11 17.036h-5.471v5.471h5.471zm-22.22 0h5.469v5.47l-.001.001h-5.47v-5.47z");
}
