...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:sunrise-duotone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
...
.yjfo42_6x {
  d: path("M12 9V2M8.5 5.5L12 2L15.5 5.5");
}
