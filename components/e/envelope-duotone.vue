...
const content = `<g class="cuyn6tgcc"><path class="irtov08ks"/><path class="ocfyvbcla"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:envelope-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
