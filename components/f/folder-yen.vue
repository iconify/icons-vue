...
const content = `<path class="h0qgeuwow"/><path class="rbd5cac6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:folder-yen" /></template>
<style>
.h0qgeuwow {
  fill: none;
  stroke: currentColor;
