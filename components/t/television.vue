...
const content = `<path class="n4ajmtmbn"/><defs><path id="SVGPDAgjdCR" class="y8ah0ebdo"/></defs><use href="#SVGPDAgjdCR" class="j71m3fb1u"/><path class="upm1f3bmu"/><circle class="knacuz12l"/><circle class="dqa5t_byx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:television" /></template>
<style>
.dqa5t_byx {
  cx: 108.81px;
  cy: 55.16px;
...
.upm1f3bmu {
  ...
  d: path("M96.27 94.62c-.12 1.07-.32 2.04-.57 2.91c-1.96 6.93-7.39 7.88-14.78 8.41c-8.31.6-16.69.9-25.04.9q-13.605 0-27.18-1.11c-6.67-.54-11.11-2.74-12.53-10.09c-2.24-11.56-1.32-24.19-.16-35.85c.83-8.46 4.67-12.37 12.71-13.13c8.81-.83 17.69-1 26.53-1c9.02 0 18.07.25 27.06.98c4.25.35 9.57.85 12.09 5.04c3.9 6.44 2.74 35.87 1.87 42.94");
}

.y8ah0ebdo {
  d: path("M121.45 105.27c0 5.94-4.86 10.8-10.8 10.8c0 0-26.68 1.87-46.65 1.87s-46.66-1.87-46.66-1.87c-5.94 0-10.8-4.86-10.8-10.8V47.38c0-5.94 4.86-10.8 10.8-10.8c0 0 16.82-2.04 45.74-2.04c28.91 0 47.57 2.04 47.57 2.04c5.94 0 10.8 4.86 10.8 10.8z");
}
