...
const content = `<path class="eh1ii__7t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:trolley-cable-car-outline-sharp" /></template>
<style>
.eh1ii__7t {
  fill: currentColor;
