...
const content = `<path class="or4rvibwt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-taxi-outline-rounded" /></template>
<style>
.or4rvibwt {
  fill: currentColor;
