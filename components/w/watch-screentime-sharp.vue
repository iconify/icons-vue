...
const content = `<path class="birhkmyva"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:watch-screentime-sharp" /></template>
<style>
.birhkmyva {
  fill: currentColor;
