...
const content = `<path class="vcfobj0ps"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-checkmark-20-filled" /></template>
<style>
.vcfobj0ps {
  fill: currentColor;
