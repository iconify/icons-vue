...
const content = `<path class="zxi4rpbni"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:boy-outline-rounded" /></template>
<style>
.zxi4rpbni {
  fill: currentColor;
