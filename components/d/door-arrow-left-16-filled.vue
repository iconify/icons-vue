...
const content = `<path class="xeykfhrfr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:door-arrow-left-16-filled" /></template>
<style>
.xeykfhrfr {
  fill: currentColor;
