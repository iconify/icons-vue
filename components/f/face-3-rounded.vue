...
const content = `<path class="u2csflboo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-3-rounded" /></template>
<style>
.u2csflboo {
  fill: currentColor;
