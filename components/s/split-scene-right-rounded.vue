...
const content = `<path class="jzvssyego"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:split-scene-right-rounded" /></template>
<style>
.jzvssyego {
  fill: currentColor;
