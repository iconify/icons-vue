...
const content = `<path class="kh4p8bbgg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:thumb-down-outline" /></template>
<style>
.kh4p8bbgg {
  fill: currentColor;
