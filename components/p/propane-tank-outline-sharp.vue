...
const content = `<path class="kmgo8tz3d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:propane-tank-outline-sharp" /></template>
<style>
.kmgo8tz3d {
  fill: currentColor;
