...
const content = `<g class="cuyn6tgcc"><path class="ichl0c_jx"/><path class="gsb5jpc4v"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:battery-vertical-high-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
