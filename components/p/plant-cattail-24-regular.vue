...
const content = `<path class="l61mzacgl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:plant-cattail-24-regular" /></template>
<style>
.l61mzacgl {
  fill: currentColor;
