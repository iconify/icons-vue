...
const content = `<path class="wo5kdgb7r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:add-alert-outline-rounded" /></template>
<style>
.wo5kdgb7r {
  fill: currentColor;
