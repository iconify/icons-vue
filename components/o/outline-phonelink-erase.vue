...
const content = `<path class="i_xtz6mpc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-phonelink-erase" /></template>
<style>
.i_xtz6mpc {
  fill: currentColor;
