...
const content = `<g class="cuyn6tgcc"><path class="q2jk2o6bo"/><path class="tyvb2pbis"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:bathtub-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.q2jk2o6bo {
  d: path("M240 104v40a48 48 0 0 1-48 48H64a48 48 0 0 1-48-48v-40h120v40h64v-40Z");
