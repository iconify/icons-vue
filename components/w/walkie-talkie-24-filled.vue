...
const content = `<path class="spqi9kylg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:walkie-talkie-24-filled" /></template>
<style>
.spqi9kylg {
  fill: currentColor;
