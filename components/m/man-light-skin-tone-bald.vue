...
const content = `<path class="xyd3f8brp"/><path class="f5-xe1s4o"/><path class="tfj0swb0e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:man-light-skin-tone-bald" /></template>
<style>
.f5-xe1s4o {
