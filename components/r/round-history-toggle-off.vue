...
const content = `<path class="e7adwcc2b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-history-toggle-off" /></template>
<style>
.e7adwcc2b {
  fill: currentColor;
