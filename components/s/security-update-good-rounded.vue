...
const content = `<path class="jhgxy3quh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:security-update-good-rounded" /></template>
<style>
.jhgxy3quh {
  fill: currentColor;
