...
const content = `<path class="r4cl5rwns"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-settings-28-regular" /></template>
<style>
.r4cl5rwns {
  fill: currentColor;
