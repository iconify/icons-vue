...
const content = `<path class="w3awjs2op"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-open-32-regular" /></template>
<style>
.w3awjs2op {
  fill: currentColor;
