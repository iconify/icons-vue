...
const content = `<path class="c1y3s1b6n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:subscriptions-outline" /></template>
<style>
.c1y3s1b6n {
  fill: currentColor;
