...
const content = `<path class="gl4bdsb9c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:widget-medium-outline-sharp" /></template>
<style>
.gl4bdsb9c {
  fill: currentColor;
