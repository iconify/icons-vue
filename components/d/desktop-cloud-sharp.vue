...
const content = `<path class="y-eh1cb7d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:desktop-cloud-sharp" /></template>
<style>
.y-eh1cb7d {
  fill: currentColor;
