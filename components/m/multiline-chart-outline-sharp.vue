...
const content = `<path class="l1ps4lbok"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:multiline-chart-outline-sharp" /></template>
<style>
.l1ps4lbok {
  fill: currentColor;
