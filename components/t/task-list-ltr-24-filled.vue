...
const content = `<path class="kg3gunbyo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:task-list-ltr-24-filled" /></template>
<style>
.kg3gunbyo {
  fill: currentColor;
