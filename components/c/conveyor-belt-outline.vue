...
const content = `<path class="gi3418eki"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:conveyor-belt-outline" /></template>
<style>
.gi3418eki {
  fill: currentColor;
