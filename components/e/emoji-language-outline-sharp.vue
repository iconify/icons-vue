...
const content = `<path class="e6i9-_b3y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:emoji-language-outline-sharp" /></template>
<style>
.e6i9-_b3y {
  fill: currentColor;
