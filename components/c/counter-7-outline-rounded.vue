...
const content = `<path class="pix5jbrca"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:counter-7-outline-rounded" /></template>
<style>
.pix5jbrca {
  fill: currentColor;
