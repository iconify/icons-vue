...
const content = `<path class="tucfh4qwq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:google-wifi-rounded" /></template>
<style>
.tucfh4qwq {
  fill: currentColor;
