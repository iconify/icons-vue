...
const content = `<path class="fxg-wqbrk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:hourglass-simple-high-thin" /></template>
<style>
.fxg-wqbrk {
  fill: currentColor;
