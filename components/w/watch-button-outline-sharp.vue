...
const content = `<path class="cjeiyibdn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:watch-button-outline-sharp" /></template>
<style>
.cjeiyibdn {
  fill: currentColor;
