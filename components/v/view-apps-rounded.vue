...
const content = `<path class="ld7ecm2bn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:view-apps-rounded" /></template>
<style>
.ld7ecm2bn {
  fill: currentColor;
