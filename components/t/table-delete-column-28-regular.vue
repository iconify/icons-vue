...
const content = `<path class="row_1sbnc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-delete-column-28-regular" /></template>
<style>
.row_1sbnc {
  fill: currentColor;
