...
const content = `<path class="bs7sa0bpz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-baby-changing-station" /></template>
<style>
.bs7sa0bpz {
  fill: currentColor;
