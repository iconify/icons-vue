...
const content = `<path class="dih0xwbok"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:brightness-high-24-filled" /></template>
<style>
.dih0xwbok {
  fill: currentColor;
