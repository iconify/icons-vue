...
const content = `<path class="n9dllv1ts"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-photo-size-select-small" /></template>
<style>
.n9dllv1ts {
  fill: currentColor;
