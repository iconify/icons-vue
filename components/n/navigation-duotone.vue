...
const content = `<path class="xra4d6b9e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:navigation-duotone" /></template>
<style>
.xra4d6b9e {
  fill: none;
  stroke: currentColor;
