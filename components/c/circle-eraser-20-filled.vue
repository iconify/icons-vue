...
const content = `<path class="m--udc3le"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:circle-eraser-20-filled" /></template>
<style>
.m--udc3le {
  fill: currentColor;
