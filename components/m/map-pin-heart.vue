...
const content = `<path class="pfrfmybyj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:map-pin-heart" /></template>
<style>
.pfrfmybyj {
  fill: none;
  stroke: currentColor;
