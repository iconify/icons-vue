...
const content = `<path class="yxe-y4k4n"/><path class="kk7rowbeb"/><path class="fjji9zucp"/><path class="harl5vqek"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-electron" /></template>
<style>
.fjji9zucp {
...
.yxe-y4k4n {
  fill: var(--svg-color--597c82, #597c82);
