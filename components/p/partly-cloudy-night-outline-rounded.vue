...
const content = `<path class="ni4u64bec"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:partly-cloudy-night-outline-rounded" /></template>
<style>
.ni4u64bec {
  fill: currentColor;
