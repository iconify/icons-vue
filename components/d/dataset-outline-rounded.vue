...
const content = `<path class="f35a2tbxy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dataset-outline-rounded" /></template>
<style>
.f35a2tbxy {
  fill: currentColor;
