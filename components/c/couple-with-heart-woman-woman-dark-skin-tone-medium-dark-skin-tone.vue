...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="openmoji:couple-with-heart-woman-woman-dark-skin-tone-medium-dark-skin-tone" /></template>
