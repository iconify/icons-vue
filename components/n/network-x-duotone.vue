...
const content = `<g class="cuyn6tgcc"><path class="vlyk_yblj"/><path class="ef9p29bsy"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:network-x-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.vlyk_yblj {
  d: path("M152 40v32a8 8 0 0 1-8 8h-32a8 8 0 0 1-8-8V40a8 8 0 0 1 8-8h32a8 8 0 0 1 8 8M80 168H48a8 8 0 0 0-8 8v32a8 8 0 0 0 8 8h32a8 8 0 0 0 8-8v-32a8 8 0 0 0-8-8");
