...
const content = `<path class="k29z59bmu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tab-unselected-outline-sharp" /></template>
<style>
.k29z59bmu {
  fill: currentColor;
