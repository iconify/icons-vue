...
const content = `<path class="xoibrbc9z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-increase-24-regular" /></template>
<style>
.xoibrbc9z {
  fill: currentColor;
