...
const content = `<path class="rlua6bypz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:badge-critical-battery-outline" /></template>
<style>
.rlua6bypz {
  fill: currentColor;
