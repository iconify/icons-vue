...
const content = `<path class="t76_qd-2z"/><path class="n8-91eb0z"/><path class="p5rts3bzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-hungary" /></template>
<style>
.n8-91eb0z {
