...
const content = `<path class="o3zt9pqgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stars-sharp" /></template>
<style>
.o3zt9pqgh {
  fill: currentColor;
