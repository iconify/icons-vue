...
const content = `<path class="gfte6dbyk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-downward-alt-rounded" /></template>
<style>
.gfte6dbyk {
  fill: currentColor;
