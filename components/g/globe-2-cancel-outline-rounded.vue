...
const content = `<path class="k0lt4virc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:globe-2-cancel-outline-rounded" /></template>
<style>
.k0lt4virc {
  fill: currentColor;
