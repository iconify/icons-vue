...
const content = `<path class="wc55ihbbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:smart-card-reader-outline-sharp" /></template>
<style>
.wc55ihbbq {
  fill: currentColor;
