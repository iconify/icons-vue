...
const content = `<path class="vxonir6if"/><path class="l-31-qbep"/><path class="m8de_ixuf"/><path class="udjducbbc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:keycap-asterisk" /></template>
<style>
.l-31-qbep {
