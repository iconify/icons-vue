...
const content = `<path class="r9ef8n5so"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-dash-20-regular" /></template>
<style>
.r9ef8n5so {
  fill: currentColor;
