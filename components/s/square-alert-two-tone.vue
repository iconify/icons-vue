...
const content = `<g class="nrj6p8qat"><path class="dl2nz2boo"/><path class="i5lvicvhn"/><path class="c5yb8bdcb"/><path class="pcr6xabis"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-alert-two-tone" /></template>
<style>
.c5yb8bdcb {
  d: path("M12 7V13");
}
