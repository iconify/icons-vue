...
const content = `<path class="su7-ytb3g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-justify-flex-end-outline-rounded" /></template>
<style>
.su7-ytb3g {
  fill: currentColor;
