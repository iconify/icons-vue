...
const content = `<g class="ft5dv1b6b"><path class="ysxw0hbdv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-clear-formatting-ga-24-filled" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
