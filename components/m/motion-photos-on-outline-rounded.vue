...
const content = `<path class="d-i5onzoe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:motion-photos-on-outline-rounded" /></template>
<style>
.d-i5onzoe {
  fill: currentColor;
