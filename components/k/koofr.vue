...
const content = `<path class="mlun1yb_s"/><path class="zwbwa6xel"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:koofr" /></template>
<style>
.mlun1yb_s {
  fill: none;
  stroke: currentColor;
