...
const content = `<path class="a4n8j7bon"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sd-card-alert" /></template>
<style>
.a4n8j7bon {
  fill: currentColor;
