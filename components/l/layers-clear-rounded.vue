...
const content = `<path class="kqlq0gbqj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:layers-clear-rounded" /></template>
<style>
.kqlq0gbqj {
  fill: currentColor;
