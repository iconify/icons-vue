...
const content = `<path class="qnpt-26ug"/><path class="le4-slhqn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-leanconfig" /></template>
<style>
.le4-slhqn {
