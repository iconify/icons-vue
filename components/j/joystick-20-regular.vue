...
const content = `<path class="uqtd8jbej"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:joystick-20-regular" /></template>
<style>
.uqtd8jbej {
  fill: currentColor;
