...
const content = `<path class="rodkdwb-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:align-flex-start-rounded" /></template>
<style>
.rodkdwb-g {
  fill: currentColor;
