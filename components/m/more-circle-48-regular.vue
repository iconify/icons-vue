...
const content = `<path class="x_ouzgcdk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:more-circle-48-regular" /></template>
<style>
.x_ouzgcdk {
  fill: currentColor;
