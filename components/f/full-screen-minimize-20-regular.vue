...
const content = `<path class="qhclzixot"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:full-screen-minimize-20-regular" /></template>
<style>
.qhclzixot {
  fill: currentColor;
