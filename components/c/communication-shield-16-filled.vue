...
const content = `<path class="kh54f-b7t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:communication-shield-16-filled" /></template>
<style>
.kh54f-b7t {
  fill: currentColor;
