...
const content = `<path class="kl-3qkbqf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-a-photo" /></template>
<style>
.kl-3qkbqf {
  fill: currentColor;
