...
const content = `<path class="najk91b1h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:road-cone-16-regular" /></template>
<style>
.najk91b1h {
  fill: currentColor;
