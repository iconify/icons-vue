...
const content = `<g class="cuyn6tgcc"><path class="t764b6bbb"/><path class="wnq89jtdf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:airplane-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
