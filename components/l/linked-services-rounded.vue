...
const content = `<path class="whaq8jttd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:linked-services-rounded" /></template>
<style>
.whaq8jttd {
  fill: currentColor;
