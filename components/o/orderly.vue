...
const content = `<path clip-rule="evenodd" class="v44he1srn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:orderly" /></template>
<style>
.v44he1srn {
