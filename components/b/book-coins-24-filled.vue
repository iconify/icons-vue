...
const content = `<path class="m2ci_veio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-coins-24-filled" /></template>
<style>
.m2ci_veio {
  fill: currentColor;
