...
const content = `<path class="efesdzb8i"/><path class="iz4b3nb1m"/><path class="le4-slhqn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-light-mdx-components" /></template>
<style>
.efesdzb8i {
