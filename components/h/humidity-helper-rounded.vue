...
const content = `<path class="ksaltvb7v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:humidity-helper-rounded" /></template>
<style>
.ksaltvb7v {
  fill: currentColor;
