...
const content = `<path class="irzh7suuj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:flexhero" /></template>
<style>
.irzh7suuj {
  fill: none;
  stroke: currentColor;
