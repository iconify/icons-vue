...
const content = `<path class="cler3yb7z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-mute-32-filled" /></template>
<style>
.cler3yb7z {
  fill: currentColor;
