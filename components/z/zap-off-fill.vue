...
const content = `<g class="nrj6p8qat"><path class="wbjvv0xjg"/><path class="ayo73pbzj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:zap-off-fill" /></template>
<style>
.ayo73pbzj {
  d: path("M2 2L22 22");
}
