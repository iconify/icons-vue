...
const content = `<path class="gxi80t1ts"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stylus-highlighter-outline" /></template>
<style>
.gxi80t1ts {
  fill: currentColor;
