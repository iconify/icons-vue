...
const content = `<path class="qiwnz4zvs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:money-off-24-regular" /></template>
<style>
.qiwnz4zvs {
  fill: currentColor;
