...
const content = `<path class="fkfzk7t1w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:household-supplies-sharp" /></template>
<style>
.fkfzk7t1w {
  fill: currentColor;
