...
const content = `<path class="rzqhjtb3q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sentiment-extremely-dissatisfied-outline-sharp" /></template>
<style>
.rzqhjtb3q {
  fill: currentColor;
