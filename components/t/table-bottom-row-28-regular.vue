...
const content = `<path class="xw70kx-6v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-bottom-row-28-regular" /></template>
<style>
.xw70kx-6v {
  fill: currentColor;
