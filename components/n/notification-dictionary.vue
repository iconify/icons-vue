...
const content = `<path class="e1qll_3td"/><path class="t6j6--bsr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:notification-dictionary" /></template>
<style>
.e1qll_3td {
  fill: none;
  stroke: currentColor;
