...
const content = `<path class="fy-02hkhd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mic-record-28-regular" /></template>
<style>
.fy-02hkhd {
  fill: currentColor;
