...
const content = `<path class="kglnhlbts"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:event-available-outline-rounded" /></template>
<style>
.kglnhlbts {
  fill: currentColor;
