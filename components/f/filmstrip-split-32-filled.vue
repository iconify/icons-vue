...
const content = `<path class="icldzwbpl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:filmstrip-split-32-filled" /></template>
<style>
.icldzwbpl {
  fill: currentColor;
