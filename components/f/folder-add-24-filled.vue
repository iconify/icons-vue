...
const content = `<path class="pjxl_lbiz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-add-24-filled" /></template>
<style>
.pjxl_lbiz {
  fill: currentColor;
