...
const content = `<path class="ti0m_rlsb"/><path class="eubhabc9r"/><path class="x6nhvdviw"/><path class="trfb7gb1j"/><circle class="di9o4vbhn"/><path class="gkzbity4a"/><path class="rvnp4gbmi"/><path class="tu3w5-z-l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-argentina" /></template>
<style>
.di9o4vbhn {
  fill: var(--svg-color--fcbf49, #FCBF49);
  cx: 18px;
  cy: 18px;
  r: 2px;
}
...
.gkzbity4a {
  fill: var(--svg-color--843511, #843511);
  d: path("M18 20.125c-1.172 0-2.125-.953-2.125-2.125s.953-2.125 2.125-2.125s2.125.953 2.125 2.125s-.953 2.125-2.125 2.125zm0-4c-1.034 0-1.875.841-1.875 1.875s.841 1.875 1.875 1.875s1.875-.841 1.875-1.875s-.841-1.875-1.875-1.875z");
}

.rvnp4gbmi {
  fill: var(--svg-color--c16540, #C16540);
  d: path("M17.801 17.774c0 .155-.261.28-.583.28c-.323 0-.584-.125-.584-.28c0-.155.261-.28.584-.28c.322 0 .583.125.583.28zm1.553-.024c0-.161-.266-.292-.594-.292c-.328 0-.594.13-.594.292s.266.292.594.292c.329 0 .594-.131.594-.292z");
}
