...
const content = `<g class="cuyn6tgcc"><path class="g-7kxbbdc"/><path class="kjh4jm0cq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:broom-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.g-7kxbbdc {
  d: path("M192.8 165.12L43.93 105.57a111 111 0 0 1 17.54-23.19a8 8 0 0 1 8.67-1.81l25.38 10.28a16 16 0 0 0 20.82-9l21-53.1c4.15-10 15.47-15.33 25.63-11.53a20 20 0 0 1 11.51 26.39l-21.35 53.1a16 16 0 0 0 8.93 20.75L187 127.3a8 8 0 0 1 5 7.43V152a105 105 0 0 0 .8 13.12");
