...
const content = `<g class="ft5dv1b6b"><path class="pllfpyhsv"/><path class="r4u9v2bcq"/><path class="o6o6f3b8z"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:chz" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
