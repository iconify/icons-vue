...
const content = `<path class="dfo7c2b9g"/><g class="x5dyrxbrh"><path class="ko7ad4-zv"/><path class="xezogbcar"/></g><path class="qwchwtbfb"/><path class="fbz3_rlln"/><path class="jum77cb4c"/><path class="rb652p37z"/><path class="x18jk4axa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-light-raku" /></template>
<style>
.dfo7c2b9g {
