...
const content = `<path class="ixc46db3z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:diversity-4" /></template>
<style>
.ixc46db3z {
  fill: currentColor;
