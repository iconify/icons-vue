...
const content = `<path class="xu-t_ix6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:social-leaderboard-outline-rounded" /></template>
<style>
.xu-t_ix6a {
  fill: currentColor;
