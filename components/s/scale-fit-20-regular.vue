...
const content = `<path class="k4a582bwi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scale-fit-20-regular" /></template>
<style>
.k4a582bwi {
  fill: currentColor;
