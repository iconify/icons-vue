...
const content = `<path class="ateawtbxo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:database-checkmark-20-filled" /></template>
<style>
.ateawtbxo {
  fill: currentColor;
