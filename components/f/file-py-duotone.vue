...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="i346959rs"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-py-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
