...
const content = `<path class="jk8o-sbbe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:luggage" /></template>
<style>
.jk8o-sbbe {
  fill: currentColor;
