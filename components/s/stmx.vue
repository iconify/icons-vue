...
const content = `<path class="ehmuw6bfh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:stmx" /></template>
<style>
.ehmuw6bfh {
  fill: var(--svg-color--ff2a4d, #ff2a4d);
