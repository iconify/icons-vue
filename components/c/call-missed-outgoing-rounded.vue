...
const content = `<path class="xoxdw758q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:call-missed-outgoing-rounded" /></template>
<style>
.xoxdw758q {
  fill: currentColor;
