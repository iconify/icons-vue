...
const content = `<path class="oiemmjb6c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:20mp-sharp" /></template>
<style>
.oiemmjb6c {
  fill: currentColor;
