...
const content = `<path class="w7x74x5kq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phonelink-ring-rounded" /></template>
<style>
.w7x74x5kq {
  fill: currentColor;
