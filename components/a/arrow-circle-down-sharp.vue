...
const content = `<path class="j5g98vd1s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-circle-down-sharp" /></template>
<style>
.j5g98vd1s {
  fill: currentColor;
