...
const content = `<path class="jfux8tb0k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:select-all-on-16-regular" /></template>
<style>
.jfux8tb0k {
  fill: currentColor;
