...
const content = `<path class="zzwui3bkl"/><path class="chgrzrbhk"/><circle class="tmxiuqb6u"/><circle class="pptlf2b0s"/><path class="r65ks63ug"/>`;
</script>
...
.r65ks63ug {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M19.38 9.563a1 1 0 0 1-.153-.527A1.076 1.076 0 0 1 20.33 7.99a1.2 1.2 0 0 1 .282.037");
}
