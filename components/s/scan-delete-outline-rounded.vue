...
const content = `<path class="sc-90ov-q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:scan-delete-outline-rounded" /></template>
<style>
.sc-90ov-q {
  fill: currentColor;
