...
const content = `<path class="accoaib0l"/><path class="c7h2m3bhv"/><path class="g7cfs_bxo"/><path class="v42ae0bsh"/><path class="twl8f4qdv"/><path class="ib_7g_bls"/><path class="y64o37cjf"/><path class="w07g__bal"/><path class="yinqz0wlr"/><path class="pq3yagbnb"/><path class="ibfllzbac"/><path class="xv-don-_s"/><path class="nhwhmrb_y"/><path class="k5hxnyb6r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="openmoji:couple-with-heart-man-man-dark-skin-tone-medium-light-skin-tone" /></template>
