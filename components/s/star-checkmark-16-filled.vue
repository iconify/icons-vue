...
const content = `<path class="xlquvnb_e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:star-checkmark-16-filled" /></template>
<style>
.xlquvnb_e {
  fill: currentColor;
