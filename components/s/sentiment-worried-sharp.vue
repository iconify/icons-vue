...
const content = `<path class="msck2ebch"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sentiment-worried-sharp" /></template>
<style>
.msck2ebch {
  fill: currentColor;
