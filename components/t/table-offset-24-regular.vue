...
const content = `<path class="c32t2cc2x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-offset-24-regular" /></template>
<style>
.c32t2cc2x {
  fill: currentColor;
