...
const content = `<path class="wdxsafbni"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:radar-outline-rounded" /></template>
<style>
.wdxsafbni {
  fill: currentColor;
