...
const content = `<path class="dqreburtx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:voice-selection-off-outline" /></template>
<style>
.dqreburtx {
  fill: currentColor;
