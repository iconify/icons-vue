...
const content = `<path class="luz63fb8z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:no-meals-outline-sharp" /></template>
<style>
.luz63fb8z {
  fill: currentColor;
