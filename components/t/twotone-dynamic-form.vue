...
const content = `<path class="mhy7sbv9o"/><path class="nk3jznbwq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-dynamic-form" /></template>
<style>
.mhy7sbv9o {
  fill: currentColor;
