...
const content = `<g class="ft5dv1b6b"><path class="x7mlvwb0o"/><path class="gl-qvvrfn"/><path class="a2g5ucczq"/><path class="lbl796bge"/><path class="mslrknbea"/><path class="vqx_gccrk"/><path class="tp8h7ob8r"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:ethx" /></template>
<style>
.a2g5ucczq {
  fill: var(--svg-color--fff, #fff);
  d: path("m12 14.218l-2.827-1.615L12 16.452z");
}
