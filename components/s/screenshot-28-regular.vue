...
const content = `<path class="o__uufbhu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:screenshot-28-regular" /></template>
<style>
.o__uufbhu {
  fill: currentColor;
