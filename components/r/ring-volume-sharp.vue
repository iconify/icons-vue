...
const content = `<path class="uthnbhb2l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ring-volume-sharp" /></template>
<style>
.uthnbhb2l {
  fill: currentColor;
