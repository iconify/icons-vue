...
const content = `<path class="ycx69w8lr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:animal-rabbit-24-regular" /></template>
<style>
.ycx69w8lr {
  fill: currentColor;
