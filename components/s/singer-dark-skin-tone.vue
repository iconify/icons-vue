...
const content = `<path class="bd1e2hbvg"/><path class="kil03bb1o"/><path class="vuykdxb-n"/><path class="q8obiybgk"/><circle class="y_tx2rbdz"/><path class="zpvwazb3b"/><path class="vkijz8noi"/><path class="rdx6pub9z"/><circle class="cjq716bgw"/><path class="awk6nwmpm"/><path class="ilpzvutts"/><path class="a6n8x1bco"/><path class="txzkjbbte"/><path class="br-hcccfh"/><path class="hzqkvlbtn"/><path class="dn02afsqr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="openmoji:singer-dark-skin-tone" /></template>
