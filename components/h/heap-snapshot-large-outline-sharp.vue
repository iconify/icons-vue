...
const content = `<path class="a_5v0h8vo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:heap-snapshot-large-outline-sharp" /></template>
<style>
.a_5v0h8vo {
  fill: currentColor;
