...
const content = `<path class="ykpyr9blm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-off-24-regular" /></template>
<style>
.ykpyr9blm {
  fill: currentColor;
