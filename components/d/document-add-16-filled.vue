...
const content = `<path class="vwaupeq9b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-add-16-filled" /></template>
<style>
.vwaupeq9b {
  fill: currentColor;
