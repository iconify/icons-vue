...
const content = `<path class="bon5nnb_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:language-gb-english-outline-sharp" /></template>
<style>
.bon5nnb_q {
  fill: currentColor;
