...
const content = `<path class="nqr049mtp"/><path class="dfwr82b2w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-plagiarism" /></template>
<style>
.dfwr82b2w {
  fill: currentColor;
