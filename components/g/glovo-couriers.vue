...
const content = `<path class="i4qo1o_1i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:glovo-couriers" /></template>
<style>
.i4qo1o_1i {
  fill: none;
  stroke: currentColor;
