...
const content = `<path class="v75_3fwkw"/><path class="eddw47b3i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-latvia" /></template>
<style>
.eddw47b3i {
