...
const content = `<path class="ib6vjyeml"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:microsoft-outlook-logo-fill" /></template>
<style>
.ib6vjyeml {
  fill: currentColor;
