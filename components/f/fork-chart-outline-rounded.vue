...
const content = `<path class="xbyuolxrv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fork-chart-outline-rounded" /></template>
<style>
.xbyuolxrv {
  fill: currentColor;
