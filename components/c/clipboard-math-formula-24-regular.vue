...
const content = `<path class="bikaiij9g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-math-formula-24-regular" /></template>
<style>
.bikaiij9g {
  fill: currentColor;
