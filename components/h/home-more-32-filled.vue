...
const content = `<path class="b3ebq-0cj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:home-more-32-filled" /></template>
<style>
.b3ebq-0cj {
  fill: currentColor;
