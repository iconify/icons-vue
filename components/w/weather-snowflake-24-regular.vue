...
const content = `<path class="c9himobgx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-snowflake-24-regular" /></template>
<style>
.c9himobgx {
  fill: currentColor;
