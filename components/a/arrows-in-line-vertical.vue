...
const content = `<path class="bahrhnbzl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrows-in-line-vertical" /></template>
<style>
.bahrhnbzl {
  fill: currentColor;
