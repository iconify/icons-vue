...
const content = `<path class="owdu-abji"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-hook-down-right-28-regular" /></template>
<style>
.owdu-abji {
  fill: currentColor;
