...
const content = `<path class="j_w5b6blf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-chat-32-filled" /></template>
<style>
.j_w5b6blf {
  fill: currentColor;
