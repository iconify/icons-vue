...
const content = `<defs><path id="SVGwsY65bTD" class="k9og6dg-m"/><path id="SVG50pTSdAf" class="g_7pjsi-u"/></defs><g class="hq1bfqbrr"><path class="ivvkq775s"/><path class="f5nnzq2hq"/><use href="#SVGwsY65bTD"/><use href="#SVG50pTSdAf"/></g><g class="jn8qy4bru"><path class="hft1hkb9e"/><path class="yrs9i8buv"/><path class="xrps05jrn"/><use href="#SVGwsY65bTD"/><use href="#SVG50pTSdAf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="openmoji:handshake-light-skin-tone" /></template>
