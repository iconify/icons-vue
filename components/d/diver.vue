...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGymlE0c5b)" class="ha7gnsbea"/><defs><linearGradient id="SVGymlE0c5b" x1="21.027" x2="3.819" y1="7.95" y2="16.684" gradientUnits="userSpaceOnUse"><stop class="lcpt_202g"/><stop offset="1" class="bh8cjov8i"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:diver" /></template>
<style>
.bh8cjov8i {
