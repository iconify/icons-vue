...
const content = `<path class="xr56blbct"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wrist-rounded" /></template>
<style>
.xr56blbct {
  fill: currentColor;
