...
const content = `<path class="hvs4mws4e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:raw-off-outline-sharp" /></template>
<style>
.hvs4mws4e {
  fill: currentColor;
