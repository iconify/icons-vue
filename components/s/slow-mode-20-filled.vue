...
const content = `<g class="ft5dv1b6b"><path class="gbgftlbvq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slow-mode-20-filled" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
