...
const content = `<path class="jgj4wpbrv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-2-28-filled" /></template>
<style>
.jgj4wpbrv {
  fill: currentColor;
