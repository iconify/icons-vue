...
const content = `<path class="z4eflbb3y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-signal-wifi-connected-no-internet-4" /></template>
<style>
.z4eflbb3y {
  fill: currentColor;
