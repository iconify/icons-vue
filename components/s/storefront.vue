...
const content = `<path class="tbq5pjmje"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:storefront" /></template>
<style>
.tbq5pjmje {
  fill: currentColor;
