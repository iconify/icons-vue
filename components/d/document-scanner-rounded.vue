...
const content = `<path class="y3354tb2w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:document-scanner-rounded" /></template>
<style>
.y3354tb2w {
  fill: currentColor;
