...
const content = `<path class="h9brizbkd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-paragraph-direction-left-20-regular" /></template>
<style>
.h9brizbkd {
  fill: currentColor;
