...
const content = `<path class="yvhle8b2x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-shake-outline-rounded" /></template>
<style>
.yvhle8b2x {
  fill: currentColor;
