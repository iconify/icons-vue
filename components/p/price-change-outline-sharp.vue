...
const content = `<path class="qhs0pebcq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:price-change-outline-sharp" /></template>
<style>
.qhs0pebcq {
  fill: currentColor;
