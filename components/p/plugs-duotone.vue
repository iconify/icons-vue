...
const content = `<g class="cuyn6tgcc"><path class="chovalboi"/><path class="wayi-tf_k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:plugs-duotone" /></template>
<style>
.chovalboi {
  d: path("m76 124l56 56l-29 29a24 24 0 0 1-33.94 0L47 186.91A24 24 0 0 1 47 153Zm133-54.91L186.91 47A24 24 0 0 0 153 47l-29 29l56 56l29-29a24 24 0 0 0 0-33.91");
