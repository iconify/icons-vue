...
const content = `<path class="rly2sxbsg"/><path class="p9m2y91dv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:rightwards-hand-medium-dark-skin-tone" /></template>
<style>
.p9m2y91dv {
