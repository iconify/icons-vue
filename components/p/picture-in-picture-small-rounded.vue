...
const content = `<path class="o_21-fbtu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:picture-in-picture-small-rounded" /></template>
<style>
.o_21-fbtu {
  fill: currentColor;
