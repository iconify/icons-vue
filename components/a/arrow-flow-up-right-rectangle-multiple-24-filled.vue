...
const content = `<path class="sweavlnfy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-flow-up-right-rectangle-multiple-24-filled" /></template>
<style>
.sweavlnfy {
  fill: currentColor;
