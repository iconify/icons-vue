...
const content = `<path class="m6hdykugr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:nest-cam-wired-stand-sharp" /></template>
<style>
.m6hdykugr {
  fill: currentColor;
