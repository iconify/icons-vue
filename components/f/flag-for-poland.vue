...
const content = `<path class="c6bgvmbcy"/><path class="vretevbvp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-poland" /></template>
<style>
.c6bgvmbcy {
