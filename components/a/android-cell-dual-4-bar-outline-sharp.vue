...
const content = `<path class="os-o39pjc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:android-cell-dual-4-bar-outline-sharp" /></template>
<style>
.os-o39pjc {
  fill: currentColor;
