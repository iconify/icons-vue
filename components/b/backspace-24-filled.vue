...
const content = `<path class="wucnobbed"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:backspace-24-filled" /></template>
<style>
.wucnobbed {
  fill: currentColor;
