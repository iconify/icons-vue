...
const content = `<path class="pd81i6h2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:account-box-rounded" /></template>
<style>
.pd81i6h2k {
  fill: currentColor;
