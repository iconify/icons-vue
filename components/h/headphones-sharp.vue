...
const content = `<path class="efks9ct0m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:headphones-sharp" /></template>
<style>
.efks9ct0m {
  fill: currentColor;
