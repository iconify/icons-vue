...
const content = `<path class="hwmsvqbat"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-arrow-up-16-regular" /></template>
<style>
.hwmsvqbat {
  fill: currentColor;
