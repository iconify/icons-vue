...
const content = `<path class="ksx30-mwm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:disabled-by-default-rounded" /></template>
<style>
.ksx30-mwm {
  fill: currentColor;
