...
const content = `<path class="jawti_bhv"/><circle class="vi_nxfq0r"/><path class="aywsvtbzb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:firefox-focus" /></template>
<style>
.aywsvtbzb {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M36.5 34.5h4m-4 4h2.6m-2.6-4v8");
}
