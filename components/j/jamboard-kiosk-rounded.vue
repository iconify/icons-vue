...
const content = `<path class="c359208hd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:jamboard-kiosk-rounded" /></template>
<style>
.c359208hd {
  fill: currentColor;
