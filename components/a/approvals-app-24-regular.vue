...
const content = `<path class="grr9ygbsf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:approvals-app-24-regular" /></template>
<style>
.grr9ygbsf {
  fill: currentColor;
