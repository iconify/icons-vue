...
const content = `<path class="hwzsut_jw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:border-style-outline-sharp" /></template>
<style>
.hwzsut_jw {
  fill: currentColor;
