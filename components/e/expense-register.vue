...
.jz2_-n9if {
  d: path("m15.051 15.826l-9.295 5.595l13.331 10.117l7.64-6.015");
}

.kykk9pbmp {
  d: path("m5.604 26.616l13.543 10.401l7.423-5.91");
}

.l6k5qxb1j {
  d: path("m16.517 14.344l7.705-4.8l10.274 8.688v12.566l-5.967 4.836V23.817zm9.541-5.086L31.9 5.646l10.46 7.293l-6.433 4.926m.277 10.748l6.296-5.14m-6.296 2.479l6.296-5.14m-6.296 2.48l6.296-5.14m-6.296 2.48l6.296-5.14");
}

.s1xoa1rph {
  d: path("m35.314 14.172l2.723-2.077l-1.865-1.247l-1.498 1.131M5.5 31.954l13.543 10.4l7.423-5.91");
}

.v299n4bzs {
  d: path("m5.5 29.285l13.543 10.4l7.423-5.91");
}
