...
const content = `<path class="i8mrblb7m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:article-person-outline" /></template>
<style>
.i8mrblb7m {
  fill: currentColor;
