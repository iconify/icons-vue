...
const content = `<path class="fd5ilx3ab"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:h-mobiledata-badge-outline-rounded" /></template>
<style>
.fd5ilx3ab {
  fill: currentColor;
