...
const content = `<path class="ytsepsb0h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screenshot-keyboard-outline-rounded" /></template>
<style>
.ytsepsb0h {
  fill: currentColor;
