...
const content = `<g class="cuyn6tgcc"><path class="p7q6-meqm"/><path class="xzriplb3t"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:patreon-logo-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
