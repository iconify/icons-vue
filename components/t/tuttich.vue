...
const content = `<path class="h_kxyib4a"/><path class="wat6mjbfv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tuttich" /></template>
<style>
.h_kxyib4a {
  fill: none;
  stroke: currentColor;
