...
const content = `<path class="gue0fpscf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:rate-review-outline-rounded" /></template>
<style>
.gue0fpscf {
  fill: currentColor;
