...
const content = `<path class="jvfciyyhe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:plug-connect" /></template>
<style>
.jvfciyyhe {
  fill: currentColor;
