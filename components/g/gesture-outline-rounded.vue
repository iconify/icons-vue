...
const content = `<path class="v1u4lvbby"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gesture-outline-rounded" /></template>
<style>
.v1u4lvbby {
  fill: currentColor;
