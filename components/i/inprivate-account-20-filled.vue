...
const content = `<path class="ap7aeccpr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:inprivate-account-20-filled" /></template>
<style>
.ap7aeccpr {
  fill: currentColor;
