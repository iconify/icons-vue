...
const content = `<path class="asd_x-bio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:change-circle-rounded" /></template>
<style>
.asd_x-bio {
  fill: currentColor;
