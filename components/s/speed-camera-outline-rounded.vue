...
const content = `<path class="hgg9bibbe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speed-camera-outline-rounded" /></template>
<style>
.hgg9bibbe {
  fill: currentColor;
