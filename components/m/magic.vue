...
const content = `<path class="d07qg831r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:magic" /></template>
<style>
.d07qg831r {
  fill: none;
  stroke: currentColor;
