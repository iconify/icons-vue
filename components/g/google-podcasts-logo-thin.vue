...
const content = `<path class="d6ls5d49v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:google-podcasts-logo-thin" /></template>
<style>
.d6ls5d49v {
  fill: currentColor;
