...
const content = `<circle class="w01xx4bie"/><path class="he1l3qbii"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-golf-course" /></template>
<style>
.he1l3qbii {
  fill: currentColor;
