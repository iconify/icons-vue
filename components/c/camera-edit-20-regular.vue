...
const content = `<path class="owv1gq_4s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:camera-edit-20-regular" /></template>
<style>
.owv1gq_4s {
  fill: currentColor;
