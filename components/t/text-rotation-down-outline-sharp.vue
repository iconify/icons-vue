...
const content = `<path class="boq3-fvup"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-rotation-down-outline-sharp" /></template>
<style>
.boq3-fvup {
  fill: currentColor;
