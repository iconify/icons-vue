...
const content = `<path class="d8pwagb6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:crossy-road" /></template>
<style>
.d8pwagb6a {
  fill: none;
  stroke: currentColor;
