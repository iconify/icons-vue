...
const content = `<path class="fit468a7c"/><circle class="nfpw185ov"/><circle class="vo4hiubuj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:glo-lottery" /></template>
<style>
.fit468a7c {
  fill: none;
  stroke: currentColor;
