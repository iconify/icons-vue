...
const content = `<path class="x0bf5ybvp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:edit-settings-20-filled" /></template>
<style>
.x0bf5ybvp {
  fill: currentColor;
