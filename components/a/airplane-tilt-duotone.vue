...
const content = `<g class="cuyn6tgcc"><path class="ometu8yua"/><path class="nc62x2bxz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:airplane-tilt-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
