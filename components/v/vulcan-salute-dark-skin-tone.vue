...
const content = `<path class="qfwy7zbiq"/><defs><path id="SVGyRSiz3ZI" class="tuigsnr-c"/></defs><clipPath id="SVGg8BHKevx"><use href="#SVGyRSiz3ZI"/></clipPath><g clip-path="url(#SVGg8BHKevx)" class="t_nvrsbrc"><path class="ud_koobjq"/><path class="p2vykcvbo"/></g><defs><use href="#SVGyRSiz3ZI" id="SVGIiOWWbQa"/></defs><clipPath id="SVGyYC8dcBl"><use href="#SVGIiOWWbQa"/></clipPath><g clip-path="url(#SVGyYC8dcBl)"><path class="fawb-zbbe"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:vulcan-salute-dark-skin-tone" /></template>
<style>
.fawb-zbbe {
