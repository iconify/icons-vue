...
const content = `<g class="gp_8x1bzb"><path class="fvd42ib4r"/><path class="ghvysybfp"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shield-plus-sharp-two-tone" /></template>
<style>
.fvd42ib4r {
  fill: currentColor;
