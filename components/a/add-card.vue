...
const content = `<path class="ohavl3fpm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-card" /></template>
<style>
.ohavl3fpm {
  fill: currentColor;
