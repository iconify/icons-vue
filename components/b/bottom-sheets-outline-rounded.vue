...
const content = `<path class="xu8xkf1eu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bottom-sheets-outline-rounded" /></template>
<style>
.xu8xkf1eu {
  fill: currentColor;
