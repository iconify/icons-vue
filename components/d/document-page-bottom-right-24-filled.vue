...
const content = `<path class="yv2o6vgfz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-page-bottom-right-24-filled" /></template>
<style>
.yv2o6vgfz {
  fill: currentColor;
