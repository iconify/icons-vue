...
const content = `<path class="z1ep50bbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-symbol-16-filled" /></template>
<style>
.z1ep50bbl {
  fill: currentColor;
