...
const content = `<path class="qbh-fgblq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:science-outline-rounded" /></template>
<style>
.qbh-fgblq {
  fill: currentColor;
