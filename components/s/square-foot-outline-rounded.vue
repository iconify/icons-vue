...
const content = `<path class="m44-u1z7m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:square-foot-outline-rounded" /></template>
<style>
.m44-u1z7m {
  fill: currentColor;
