...
const content = `<path class="kqhcf4bth"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bedroom-parent-outline" /></template>
<style>
.kqhcf4bth {
  fill: currentColor;
