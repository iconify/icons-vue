...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:search-list-duotone" /></template>
<style>
.k79gm2b1n {
  fill: currentColor;
...
.lngok0bde {
  d: path("M15 15L21 21M7.8 8L10.2 8M7.8 12L12.2 12");
}
