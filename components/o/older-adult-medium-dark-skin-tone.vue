...
const content = `<path class="p21-ze-at"/><path class="prql90b2l"/><path class="sbpdpfbix"/><path class="c-ntt1b8g"/><path class="ut2d5ibrr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:older-adult-medium-dark-skin-tone" /></template>
<style>
.c-ntt1b8g {
