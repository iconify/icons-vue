...
const content = `<path class="m3m4ct8kf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-enter-16-regular" /></template>
<style>
.m3m4ct8kf {
  fill: currentColor;
