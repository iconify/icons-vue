...
const content = `<path class="ztqpxqynn"/><path class="vjfvixzvo"/><path class="wmr_6onjs"/><path class="dqtdqdb0c"/><path class="fcl44ebjy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sgame" /></template>
<style>
.dqtdqdb0c {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M19.24 14.615c.257-1.253 2.73-3.565 3.757-4.014a37 37 0 0 1 4.72-1.092a5.38 5.38 0 0 1-.951 3.54a7 7 0 0 1-1.458 1.565a26 26 0 0 1-3.05 2.312");
}
...
.wmr_6onjs {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M35.691 23.691c.598-.953 2.525-3.49 2.59-4.067S38.922 15 38.922 15s0-2.986-.803-4.142a14.28 14.28 0 0 0-9.472-5.587c-6.133-.931-11.025-1.252-14.77.385c-1.21.529-5.074 4.207-4.785 7.835s.6 8.443.6 8.443");
}
