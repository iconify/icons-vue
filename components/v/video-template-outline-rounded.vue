...
const content = `<path class="xeywgkv-k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:video-template-outline-rounded" /></template>
<style>
.xeywgkv-k {
  fill: currentColor;
