...
const content = `<path class="l3vhhrbui"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:filter-8-rounded" /></template>
<style>
.l3vhhrbui {
  fill: currentColor;
