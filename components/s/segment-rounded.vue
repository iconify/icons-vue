...
const content = `<path class="vr00cokcm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:segment-rounded" /></template>
<style>
.vr00cokcm {
  fill: currentColor;
