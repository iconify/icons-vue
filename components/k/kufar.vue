...
const content = `<path class="ucusmnb0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kufar" /></template>
<style>
.ucusmnb0q {
  fill: none;
  stroke: currentColor;
