...
const content = `<path class="hqv4edbtc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:private-connectivity-rounded" /></template>
<style>
.hqv4edbtc {
  fill: currentColor;
