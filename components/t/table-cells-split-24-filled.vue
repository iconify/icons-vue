...
const content = `<path class="lmz79jbdq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cells-split-24-filled" /></template>
<style>
.lmz79jbdq {
  fill: currentColor;
