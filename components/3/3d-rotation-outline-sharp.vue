...
const content = `<path class="ityrx16hc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:3d-rotation-outline-sharp" /></template>
<style>
.ityrx16hc {
  fill: currentColor;
