...
const content = `<path class="db7o9x-ck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dock-panel-left-16-filled" /></template>
<style>
.db7o9x-ck {
  fill: currentColor;
