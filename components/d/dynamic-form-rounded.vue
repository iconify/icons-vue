...
const content = `<path class="sivuwdbgk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dynamic-form-rounded" /></template>
<style>
.sivuwdbgk {
  fill: currentColor;
