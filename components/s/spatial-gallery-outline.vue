...
const content = `<path class="ztqyy5bqo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:spatial-gallery-outline" /></template>
<style>
.ztqyy5bqo {
  fill: currentColor;
