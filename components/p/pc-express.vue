...
const content = `<path class="kufad0v6e"/><path class="u79o76brp"/><path class="frvaxphcu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pc-express" /></template>
<style>
.frvaxphcu {
  fill: none;
  stroke: currentColor;
