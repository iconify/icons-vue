...
const content = `<path class="cywycnbdh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-motorcycle-16-filled" /></template>
<style>
.cywycnbdh {
  fill: currentColor;
