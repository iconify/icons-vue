...
const content = `<path class="eotuzy3xk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:list-bar-tree-20-filled" /></template>
<style>
.eotuzy3xk {
  fill: currentColor;
