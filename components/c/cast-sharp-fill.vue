...
const content = `<g class="gp_8x1bzb"><path class="l824gd0ft"/><path class="dno4_nblm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:cast-sharp-fill" /></template>
<style>
.dno4_nblm {
  fill: currentColor;
