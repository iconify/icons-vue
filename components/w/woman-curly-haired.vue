...
const content = `<path class="azf449u6b"/><linearGradient id="SVGmo0UWd9T" x1="64" x2="64" y1="35.759" y2="8" gradientTransform="matrix(1 0 0 -1 0 130)" gradientUnits="userSpaceOnUse"><stop offset="0" class="xb94qyb-t"/><stop offset=".705" class="ci_fo_bpd"/><stop offset="1" class="u3kz4vb7l"/></linearGradient><path fill="url(#SVGmo0UWd9T)" class="em9qpibty"/><path class="di4nekbxr"/><path class="kw52kzb7j"/><path class="ju5-xac7k"/><g class="y73_33btq"><ellipse class="n8fq1s3jv"/><ellipse class="gba0l8b6i"/></g><path class="h634j-8aa"/><path class="lu3vcrqpk"/><path class="x6-wc51ub"/><radialGradient id="SVGwvouubhj" cx="63.798" cy="46.819" r="49.836" gradientTransform="rotate(-.109 64.883 50.393)" gradientUnits="userSpaceOnUse"><stop offset=".725" class="gjeqb-b1b"/><stop offset="1" class="no9o3hbeo"/></radialGradient><path fill="url(#SVGwvouubhj)" class="e7gfutlzg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:woman-curly-haired" /></template>
<style>
.azf449u6b {
