...
const content = `<path class="nmutdrzax"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:content-cut-outline-rounded" /></template>
<style>
.nmutdrzax {
  fill: currentColor;
