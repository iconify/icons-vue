...
const content = `<path clip-rule="evenodd" class="zse8x-bhi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-full-fill" /></template>
<style>
.zse8x-bhi {
  fill: currentColor;
  fill-rule: evenodd;
