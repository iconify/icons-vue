...
const content = `<g class="ft5dv1b6b"><path class="c21oypbbe"/><path class="zq44bhbsa"/><path class="jdm6rfbed"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:stars" /></template>
<style>
.c21oypbbe {
  stroke: currentColor;
