...
const content = `<path class="dans89brd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-margins-24-filled" /></template>
<style>
.dans89brd {
  fill: currentColor;
