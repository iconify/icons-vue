...
const content = `<path class="m41qo5gul"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-1-16-regular" /></template>
<style>
.m41qo5gul {
  fill: currentColor;
