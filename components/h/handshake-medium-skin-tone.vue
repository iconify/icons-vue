...
const content = `<path class="xzt060bdn"/><g class="zb0bdob6q"><path class="kl68i8bgp"/><path class="x57g7cbon"/></g><path class="e1avnhwsp"/><path class="knbrpnvve"/><path class="jo21i8bra"/><path class="runr8790n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:handshake-medium-skin-tone" /></template>
<style>
.e1avnhwsp {
