...
const content = `<path class="s2tijyyrc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-stories-off-rounded" /></template>
<style>
.s2tijyyrc {
  fill: currentColor;
