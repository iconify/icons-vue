...
const content = `<path class="zgeejzbip"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:download-for-offline-rounded" /></template>
<style>
.zgeejzbip {
  fill: currentColor;
