...
const content = `<path class="ijd7wkgfd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-square-48-regular" /></template>
<style>
.ijd7wkgfd {
  fill: currentColor;
