...
const content = `<path class="tzot29bax"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:office-apps-20-regular" /></template>
<style>
.tzot29bax {
  fill: currentColor;
