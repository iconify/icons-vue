...
const content = `<path class="qq9vw1b_y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:battery-vertical-full-thin" /></template>
<style>
.qq9vw1b_y {
  fill: currentColor;
