...
const content = `<path class="pdkm4ibpp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:thalia" /></template>
<style>
.pdkm4ibpp {
  fill: none;
  stroke: currentColor;
