...
const content = `<path class="zti4oeb-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:contrast-rtl-off-rounded" /></template>
<style>
.zti4oeb-j {
  fill: currentColor;
