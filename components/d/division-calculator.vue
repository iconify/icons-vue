...
const content = `<path class="e6cb6864c"/><path class="otiqlcbbk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:division-calculator" /></template>
<style>
.e6cb6864c {
  fill: none;
  stroke: currentColor;
