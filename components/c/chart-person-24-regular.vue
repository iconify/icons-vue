...
const content = `<path class="gka25dikl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chart-person-24-regular" /></template>
<style>
.gka25dikl {
  fill: currentColor;
