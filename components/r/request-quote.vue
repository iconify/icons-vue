...
const content = `<path class="rjy1l9m2f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:request-quote" /></template>
<style>
.rjy1l9m2f {
  fill: currentColor;
