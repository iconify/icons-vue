...
const content = `<path class="vc0qu0-fi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:server-link-16-regular" /></template>
<style>
.vc0qu0-fi {
  fill: currentColor;
