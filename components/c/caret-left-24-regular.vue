...
const content = `<path class="vhd5bwxgz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:caret-left-24-regular" /></template>
<style>
.vhd5bwxgz {
  fill: currentColor;
