...
const content = `<g class="cuyn6tgcc"><path class="kwsplcbqf"/><path class="vfaxm95ne"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:puzzle-piece-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
