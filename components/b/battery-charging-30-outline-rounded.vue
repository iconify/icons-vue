...
const content = `<path class="x5r8oobku"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-charging-30-outline-rounded" /></template>
<style>
.x5r8oobku {
  fill: currentColor;
