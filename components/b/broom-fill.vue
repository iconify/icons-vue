...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:broom-fill" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
...
.u723w4xsl {
  fill: currentColor;
  d: path("M11.6106 13.5362C10.257 14.466 6.6399 16.1295 3 15.3456C5.8769 18.8355 12.2148 24.7603 14.5521 20.5399C15.1662 19.4704 16.3379 17.1141 16.1118 16.2453Z");
  stroke: none;
}
