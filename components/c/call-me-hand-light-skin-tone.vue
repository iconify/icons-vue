...
const content = `<path class="ab3qhv4tc"/><defs><path id="SVGVxHWicRa" class="bo062f-dp"/></defs><clipPath id="SVG4zYiZ8kd"><use href="#SVGVxHWicRa"/></clipPath><path clip-path="url(#SVG4zYiZ8kd)" class="xyq7ygb_v"/><defs><use href="#SVGVxHWicRa" id="SVGPdwshbFC"/></defs><clipPath id="SVGCw0ZpeuJ"><use href="#SVGPdwshbFC"/></clipPath><g clip-path="url(#SVGCw0ZpeuJ)" class="oadpy4acg"><path class="qczznxftm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:call-me-hand-light-skin-tone" /></template>
<style>
.ab3qhv4tc {
