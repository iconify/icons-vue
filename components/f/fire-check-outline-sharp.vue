...
const content = `<path class="dfwf0nl8f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fire-check-outline-sharp" /></template>
<style>
.dfwf0nl8f {
  fill: currentColor;
