...
const content = `<path class="dzu95zeui"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:south-east-outline-rounded" /></template>
<style>
.dzu95zeui {
  fill: currentColor;
