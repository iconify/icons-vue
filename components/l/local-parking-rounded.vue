...
const content = `<path class="wzaou_b-c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-parking-rounded" /></template>
<style>
.wzaou_b-c {
  fill: currentColor;
