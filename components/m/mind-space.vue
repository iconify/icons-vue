...
const content = `<path class="wksv_bbbt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mind-space" /></template>
<style>
.wksv_bbbt {
  fill: none;
  stroke: currentColor;
