...
const content = `<path class="sin_skhak"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ballot-outline" /></template>
<style>
.sin_skhak {
  fill: currentColor;
