...
const content = `<g class="cuyn6tgcc"><path class="uckhkzoit"/><path class="y53ny-b9m"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:windmill-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
