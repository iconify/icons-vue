...
const content = `<path class="vmb-bb8-n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pointx" /></template>
<style>
.vmb-bb8-n {
  fill: none;
  stroke: currentColor;
