...
const content = `<path class="uci2m6flz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sound-detection-loud-sound-sharp" /></template>
<style>
.uci2m6flz {
  fill: currentColor;
