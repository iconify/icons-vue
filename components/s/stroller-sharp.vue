...
const content = `<path class="vvopmcbmz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stroller-sharp" /></template>
<style>
.vvopmcbmz {
  fill: currentColor;
