...
const content = `<path class="olz85i33r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-arrow-right-28-regular" /></template>
<style>
.olz85i33r {
  fill: currentColor;
