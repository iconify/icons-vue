...
const content = `<path class="mmo-jo0jl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fan-focus-outline-sharp" /></template>
<style>
.mmo-jo0jl {
  fill: currentColor;
