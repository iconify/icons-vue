...
const content = `<g class="gp_8x1bzb"><path class="bkcd5iben"/><path class="by26kkbis"/><path class="lju5ynbhb"/><path class="ju8v6k8zc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-alert-sharp-two-tone" /></template>
<style>
.bkcd5iben {
  fill: currentColor;
