...
const content = `<path class="rtokrlbvy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:collections-empty-20-regular" /></template>
<style>
.rtokrlbvy {
  fill: currentColor;
