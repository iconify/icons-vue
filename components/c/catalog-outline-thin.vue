...
const content = `<g class="hntgybcog"><path class="iwoy52b7h"/><path class="um6qav7po"/><path class="xbz5-ab-d"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:catalog-outline-thin" /></template>
<style>
.hntgybcog {
  fill: none;
  stroke: currentColor;
