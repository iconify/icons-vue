...
const content = `<path class="z2300p_zg"/><path class="ir4o4zb4r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cwtch" /></template>
<style>
.ir4o4zb4r {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M7.697 23.897q2.52 2.516 5.043 5.03");
}
