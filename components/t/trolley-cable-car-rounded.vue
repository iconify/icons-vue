...
const content = `<path class="iw34_feyc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:trolley-cable-car-rounded" /></template>
<style>
.iw34_feyc {
  fill: currentColor;
