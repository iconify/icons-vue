...
const content = `<path class="ule8n198x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:graph-8-rounded" /></template>
<style>
.ule8n198x {
  fill: currentColor;
