...
const content = `<path class="chve8j1mc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:cross-mark-button" /></template>
<style>
.chve8j1mc {
  fill: currentColor;
