...
const content = `<path class="a1pizybun"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-export-16-filled" /></template>
<style>
.a1pizybun {
  fill: currentColor;
