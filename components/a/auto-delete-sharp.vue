...
const content = `<path class="c7mvs2buc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-delete-sharp" /></template>
<style>
.c7mvs2buc {
  fill: currentColor;
