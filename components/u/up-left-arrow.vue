...
const content = `<path class="l081hdcpk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:up-left-arrow" /></template>
<style>
.l081hdcpk {
  fill: currentColor;
