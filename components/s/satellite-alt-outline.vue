...
const content = `<path class="nbc_r-d3e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:satellite-alt-outline" /></template>
<style>
.nbc_r-d3e {
  fill: currentColor;
