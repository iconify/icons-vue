...
const content = `<path class="qeu2sczrt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-photo-size-select-small" /></template>
<style>
.qeu2sczrt {
  fill: currentColor;
