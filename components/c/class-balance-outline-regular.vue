...
const content = `<g class="nrj6p8qat"><path class="xaafqhbdh"/><path class="uuhg5tbuk"/><path class="rjnrdobeg"/><path class="rcu9plbzq"/><path class="sm8qqabeo"/><path class="ex075abcq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:class-balance-outline-regular" /></template>
<style>
.ex075abcq {
