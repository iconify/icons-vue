...
const content = `<g class="cuyn6tgcc"><path class="nlsrpxbnn"/><path class="ydo8g0iis"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:escalator-up-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.nlsrpxbnn {
  d: path("M232 56v40a8 8 0 0 1-8 8h-40L88 208H32a8 8 0 0 1-8-8v-40a8 8 0 0 1 8-8h40l96-104h56a8 8 0 0 1 8 8");
