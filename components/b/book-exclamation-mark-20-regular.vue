...
const content = `<path class="xx8wophdq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-exclamation-mark-20-regular" /></template>
<style>
.xx8wophdq {
  fill: currentColor;
