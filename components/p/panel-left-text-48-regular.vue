...
const content = `<path class="nk2slo3zc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-text-48-regular" /></template>
<style>
.nk2slo3zc {
  fill: currentColor;
