...
const content = `<path class="oo230pb6d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-directions-boat" /></template>
<style>
.oo230pb6d {
  fill: currentColor;
