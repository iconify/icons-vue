...
const content = `<path class="d883_6bfd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-transfer-within-a-station" /></template>
<style>
.d883_6bfd {
  fill: currentColor;
