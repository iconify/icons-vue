...
const content = `<path class="sng5-nban"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:category-search-outline-sharp" /></template>
<style>
.sng5-nban {
  fill: currentColor;
