...
const content = `<path class="d0oqrfb3n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:astrophotography-off-sharp" /></template>
<style>
.d0oqrfb3n {
  fill: currentColor;
