...
<style>
.e9obj-b7u {
  d: path("M19.768 22.15c-.701-.514-1.808-.42-2.54.593c-.734 1.012-.367 2.054.341 2.592");
}
...
.f7ag0-3ex {
  ...
  d: path("M15.716 24.243v1.352l2.858 2.21l.995 1.423l.757 3.694l.339 4.84l.776.724l2.315-.194l.296-.974l-.385-4.952");
}
...
.iqhe4v3fz {
  d: path("m19.885 22.176l-5.604-4.108c-.701-.515-1.808-.42-2.541.592s-.367 2.055.342 2.592l6.808 5.168");
}

.jak2zdhur {
  d: path("m23.691 32.28l6.053 4.679l.433.611v1.365l1.407 3.546");
}

.jq8zc6b0x {
  d: path("m19.626 29.147l4.146 3.205c1.108.857 1.483 2.48 1.628 3.874l.637 6.103m6.971.106c.047-.886.036-1.696-.17-2.633l-1.82-1.408v-2.271m-6.904-.891l1.286.994");
}
...
.w7_zel7zn {
  d: path("M40.981 41.453V38.32c0-.57-.332-1.172-.784-1.521L36.835 34.2l.002-.997l-6.917-5.347c0-.587-.216-1.079-.667-1.325c-.544.08-1.001.177-1.539.183c.477.558.684 1.22.69 1.763");
}

.xrcyf9qcb {
  d: path("M20.75 20.831v-1.95l.63-.752h.554l.804.694v2.008z");
}
