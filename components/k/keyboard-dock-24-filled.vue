...
const content = `<path class="xfa8blxha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:keyboard-dock-24-filled" /></template>
<style>
.xfa8blxha {
  fill: currentColor;
