...
const content = `<path class="g6nzvfo7j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-rotation-angledown-outline-sharp" /></template>
<style>
.g6nzvfo7j {
  fill: currentColor;
