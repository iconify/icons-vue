...
const content = `<path class="v54_bybof"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:server-multiple-20-regular" /></template>
<style>
.v54_bybof {
  fill: currentColor;
