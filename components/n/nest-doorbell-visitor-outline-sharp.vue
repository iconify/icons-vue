...
const content = `<path class="xqirzsbdd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:nest-doorbell-visitor-outline-sharp" /></template>
<style>
.xqirzsbdd {
  fill: currentColor;
