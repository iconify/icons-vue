...
const content = `<g clip-rule="evenodd" class="n5l_v-b3i"><path class="shm4lcbid"/><path class="xev8n9rir"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:token" /></template>
<style>
.n5l_v-b3i {
