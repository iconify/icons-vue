...
const content = `<path class="h1n5-_b6i"/><path class="gxz5v7tah"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-view-list" /></template>
<style>
.gxz5v7tah {
  fill: currentColor;
