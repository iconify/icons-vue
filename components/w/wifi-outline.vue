...
const content = `<path class="p4uos7z4p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wifi-outline" /></template>
<style>
.p4uos7z4p {
  fill: currentColor;
