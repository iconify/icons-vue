...
const content = `<path class="lxehksbrf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:picture-in-picture-medium-outline-rounded" /></template>
<style>
.lxehksbrf {
  fill: currentColor;
