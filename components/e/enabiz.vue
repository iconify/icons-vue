...
const content = `<path class="nj9_087pv"/><path class="qf7p8ybho"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:enabiz" /></template>
<style>
.nj9_087pv {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M14 23h5l3-6l4 12l3-6h5");
}
