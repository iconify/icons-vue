...
const content = `<path class="znghkbtgf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-square-32-filled" /></template>
<style>
.znghkbtgf {
  fill: currentColor;
