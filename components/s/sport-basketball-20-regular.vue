...
const content = `<path class="w0rs-06by"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:sport-basketball-20-regular" /></template>
<style>
.w0rs-06by {
  fill: currentColor;
