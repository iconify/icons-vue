...
const content = `<path class="jzotd8s0e"/><path class="qnoxhub3m"/><path class="d1-vz682d"/><path class="h3-c1nj1z"/><path class="dl4m3sb6w"/><path class="jg3aaactd"/><path class="r2a42eetg"/><linearGradient id="SVGPYPUDbbv" x1="50.884" x2="50.637" y1="39.799" y2="57.102" gradientTransform="matrix(-1 0 0 -1 168.128 128)" gradientUnits="userSpaceOnUse"><stop offset=".267" class="s3llfdchm"/><stop offset="1" class="da5_msbne"/></linearGradient><path fill="url(#SVGPYPUDbbv)" class="bjmkgbb4o"/><path class="sli1jgwlb"/><path class="vmnsg3byi"/><linearGradient id="SVGpaOdKcYc" x1="10.756" x2="10.509" y1="39.799" y2="57.102" gradientTransform="matrix(1 0 0 -1 0 128)" gradientUnits="userSpaceOnUse"><stop offset=".267" class="s3llfdchm"/><stop offset="1" class="da5_msbne"/></linearGradient><path fill="url(#SVGpaOdKcYc)" class="c0j-xk09p"/><path class="lg1k4eb8f"/><path class="eq1gvjecg"/><path class="gcp5uhjkm"/><path class="s2yclobyp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:open-book" /></template>
<style>
.bjmkgbb4o {
  d: path("m114.3 91.87l.16-26.39h5.47l.28 32.69s-4.35-1.69-5.91-6.3");
}

.c0j-xk09p {
  d: path("m13.7 91.87l-.16-26.39H8.06l-.27 32.69s4.34-1.69 5.91-6.3");
}

.d1-vz682d {
  fill: var(--svg-color--01579b, #01579b);
  d: path("m57.76 100.79l-48.55 4.62c-4.57.44-5.74-2.11-5.74-4.27l.05-2.62l59.71-8.43c0 3-2.43 10.7-5.47 10.7");
}
...
.jg3aaactd {
  ...
  d: path("m79.54 100.43l-8.57-.74m-22.51.74l8.57-.74");
}

.jzotd8s0e {
  fill: var(--svg-color--01579b, #01579b);
  d: path("m70.24 100.79l48.55 4.62c4.57.44 5.74-2.11 5.74-4.27l-.05-2.62l-59.71-8.42c0 2.99 2.43 10.69 5.47 10.69");
}

.lg1k4eb8f {
  fill: var(--svg-color--f5f5f5, #f5f5f5);
  d: path("M115.65 27.32s-26.54-4.99-38.19-5.64c-10.96-.61-13.21 4.97-13.43 5.64h-.04c-.23-.67-2.48-6.24-13.44-5.64c-11.65.65-38.19 5.64-38.19 5.64l-1.18 64.4s31.6-6.62 39.25-5.76S64 92.72 64 92.72v-.01v.01s5.93-5.9 13.58-6.76s39.25 5.76 39.25 5.76z");
}

.qnoxhub3m {
  fill: var(--svg-color--0091ea, #0091ea);
  d: path("m72.01 98.51l7.64.67l40.91 3.95c2.2 0 3.97-1.75 3.97-3.91l-2.17-66.26c0-2.16-1.78-3.91-3.97-3.91l-46.38-4.38c-3.04 0-5.51 2.43-5.51 5.42v63c0 2.99 2.46 5.42 5.51 5.42");
}

.r2a42eetg {
  fill: var(--svg-color--94c6d6, #94c6d6);
  d: path("m119.65 32.82l-4-5.5L64 86.02l-51.65-58.7l-4 5.5l-.56 65.35s10.62 1.33 24.81-.11c12.36-1.25 18.18-4.45 22.31-3.62c4.96 1 5.86 4.05 6.02 4.57c.45 1.44 1.34 2.56 3.07 2.56s2.5-.6 3.03-2.38c.16-.52 1.1-3.74 6.06-4.74c4.13-.83 9.95 2.37 22.31 3.62c14.19 1.44 24.81.11 24.81.11z");
}

.s2yclobyp {
  fill: var(--svg-color--616161, #616161);
  d: path("M71.16 98.45c-1.12-.1-2.15.59-2.51 1.66c-.54 1.63-1.8 3.76-4.65 3.76c-2.88 0-4.15-2.14-4.7-3.77a2.415 2.415 0 0 0-2.48-1.64l-.39.03l.01.32c0 4.17 3.38 7.55 7.55 7.55s7.55-3.38 7.55-7.55c0-.1-.01-.33-.01-.33z");
}
...
.sli1jgwlb {
  fill: var(--svg-color--566b7a, #566b7a);
  d: path("m114.55 76.49l-.25 15.39s-11.96-.62-31.01-3.92C70.83 85.8 64 92.72 64 92.72l-.11-16.23z");
}

.vmnsg3byi {
  fill: var(--svg-color--566b7a, #566b7a);
  d: path("m13.45 76.49l.25 15.39s11.96-.62 31.01-3.92C57.17 85.8 64 92.72 64 92.72l-.11-16.23z");
}
