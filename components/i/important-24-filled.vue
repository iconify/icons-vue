...
const content = `<path class="nvdaoexhx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:important-24-filled" /></template>
<style>
.nvdaoexhx {
  fill: currentColor;
