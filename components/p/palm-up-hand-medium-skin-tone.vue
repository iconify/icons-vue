...
const content = `<path class="emjuqkkam"/><defs><path id="SVGdjInfc6d" class="gfzoxqb1y"/></defs><clipPath id="SVGjWQ7YdvK"><use href="#SVGdjInfc6d"/></clipPath><g clip-path="url(#SVGjWQ7YdvK)" class="byeg-0b8a"><path class="o6g99psbz"/></g><defs><use href="#SVGdjInfc6d" id="SVGaxRnVTZI"/></defs><clipPath id="SVG3VfbbcMt"><use href="#SVGaxRnVTZI"/></clipPath><g clip-path="url(#SVG3VfbbcMt)" class="lip7wrrrl"><path class="xhh92bcld"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:palm-up-hand-medium-skin-tone" /></template>
<style>
.byeg-0b8a {
