...
const content = `<path class="m-l5oshte"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-cellular-off-rounded" /></template>
<style>
.m-l5oshte {
  fill: currentColor;
