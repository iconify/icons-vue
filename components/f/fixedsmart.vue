...
const content = `<path class="e-o72_bmb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fixedsmart" /></template>
<style>
.e-o72_bmb {
  fill: none;
  stroke: currentColor;
