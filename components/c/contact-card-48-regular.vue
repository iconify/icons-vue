...
const content = `<path class="nxue2fb1o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:contact-card-48-regular" /></template>
<style>
.nxue2fb1o {
  fill: currentColor;
