...
const content = `<path class="n13q_pb9l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tooltip-quote-off-24-regular" /></template>
<style>
.n13q_pb9l {
  fill: currentColor;
