...
const content = `<path class="mqo4wob2y"/><path class="nbzm2_blb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:vr-media-player" /></template>
<style>
.mqo4wob2y {
  fill: none;
  stroke: currentColor;
