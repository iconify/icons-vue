...
const content = `<path class="v9r51a1uq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-4-lines-caret-20-regular" /></template>
<style>
.v9r51a1uq {
  fill: currentColor;
