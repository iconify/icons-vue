...
const content = `<path class="r3o3lf02o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:video-camera-back-outline-rounded" /></template>
<style>
.r3o3lf02o {
  fill: currentColor;
