...
const content = `<g class="gp_8x1bzb"><path class="tst-wub6i"/><path class="unky6y77u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:app-window-2-sharp" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
