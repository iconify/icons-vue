...
const content = `<path class="rh8fk3dbc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-add-32-regular" /></template>
<style>
.rh8fk3dbc {
  fill: currentColor;
