...
const content = `<path class="sr7nexbfm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:inbox-text-rounded" /></template>
<style>
.sr7nexbfm {
  fill: currentColor;
