...
const content = `<path class="a8c75fbnx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:audio-description-outline" /></template>
<style>
.a8c75fbnx {
  fill: currentColor;
