...
const content = `<path class="iupu6obai"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:attachment-outline-sharp" /></template>
<style>
.iupu6obai {
  fill: currentColor;
