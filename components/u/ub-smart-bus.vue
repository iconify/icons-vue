...
const content = `<path class="o9fpj9tnx"/><path class="z-0t7-b8w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ub-smart-bus" /></template>
<style>
.o9fpj9tnx {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M24 4.5a16.246 16.246 0 0 1 16.246 16.246C40.246 34.73 24 43.5 24 43.5S7.754 34.73 7.754 20.746A16.246 16.246 0 0 1 24 4.5");
}
