...
const content = `<g class="cuyn6tgcc"><path class="p-rshhb_s"/><path class="itttcv__s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-video-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.p-rshhb_s {
  d: path("M208 88h-56V32Zm-88 72a8 8 0 0 0-8-8H48a8 8 0 0 0-8 8v48a8 8 0 0 0 8 8h64a8 8 0 0 0 8-8v-12l32 20v-64l-32 20Z");
