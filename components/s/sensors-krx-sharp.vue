...
const content = `<path class="ynq8-tchj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sensors-krx-sharp" /></template>
<style>
.ynq8-tchj {
  fill: currentColor;
