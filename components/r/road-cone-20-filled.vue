...
const content = `<path class="fl59_0bht"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:road-cone-20-filled" /></template>
<style>
.fl59_0bht {
  fill: currentColor;
