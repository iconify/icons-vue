...
const content = `<path class="dzw3a9bnd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-square-20-filled" /></template>
<style>
.dzw3a9bnd {
  fill: currentColor;
