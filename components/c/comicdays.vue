...
const content = `<path class="u2pbtzb-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:comicdays" /></template>
<style>
.u2pbtzb-y {
  fill: none;
  stroke: currentColor;
