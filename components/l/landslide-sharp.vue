...
const content = `<path class="eg1sgobgj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:landslide-sharp" /></template>
<style>
.eg1sgobgj {
  fill: currentColor;
