...
const content = `<path class="vqkzeg_xr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-move-24-filled" /></template>
<style>
.vqkzeg_xr {
