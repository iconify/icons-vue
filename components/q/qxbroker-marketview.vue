...
const content = `<path class="qiox6h2py"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:qxbroker-marketview" /></template>
<style>
.qiox6h2py {
  fill: none;
  stroke: currentColor;
