...
const content = `<path class="ozrz-mbzq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-dismiss-20-regular" /></template>
<style>
.ozrz-mbzq {
  fill: currentColor;
