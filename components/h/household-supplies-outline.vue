...
const content = `<path class="hwg2_7anl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:household-supplies-outline" /></template>
<style>
.hwg2_7anl {
  fill: currentColor;
