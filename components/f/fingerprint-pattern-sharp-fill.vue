...
const content = `<path class="qppqpm--t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:fingerprint-pattern-sharp-fill" /></template>
<style>
.qppqpm--t {
  fill: none;
  stroke: currentColor;
