...
const content = `<g class="cuyn6tgcc"><path class="v6gj6fzwo"/><path class="d32teub2r"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:percent-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.v6gj6fzwo {
  d: path("M95.8 56.2a28 28 0 1 1-39.6 0a28 28 0 0 1 39.6 0m104 104a28 28 0 1 0 0 39.6a28 28 0 0 0 0-39.6");
