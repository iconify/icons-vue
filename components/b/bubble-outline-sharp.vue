...
const content = `<path class="dx_9gpnlx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bubble-outline-sharp" /></template>
<style>
.dx_9gpnlx {
  fill: currentColor;
