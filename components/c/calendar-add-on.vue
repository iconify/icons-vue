...
const content = `<path class="m6fk64icr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:calendar-add-on" /></template>
<style>
.m6fk64icr {
  fill: currentColor;
