...
const content = `<path class="wd88awuvu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:description-outline-rounded" /></template>
<style>
.wd88awuvu {
  fill: currentColor;
