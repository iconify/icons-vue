...
const content = `<path class="bquz_2pcq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:track-changes-outline-rounded" /></template>
<style>
.bquz_2pcq {
  fill: currentColor;
