...
const content = `<path class="ixwov3vfm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-key-20-regular" /></template>
<style>
.ixwov3vfm {
  fill: currentColor;
