...
const content = `<path class="dalfgf8pg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-shuffle-off-24-regular" /></template>
<style>
.dalfgf8pg {
  fill: currentColor;
