...
const content = `<path class="af7c76b_l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:workspace-premium-rounded" /></template>
<style>
.af7c76b_l {
  fill: currentColor;
