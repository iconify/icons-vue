...
const content = `<path class="ma0ndib4h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:exposure-neg-1-rounded" /></template>
<style>
.ma0ndib4h {
  fill: currentColor;
