...
const content = `<path class="d92lmubry"/><path class="zut58gbmm"/><path class="tzse-8bre"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-yemen" /></template>
<style>
.d92lmubry {
