...
const content = `<path class="b3ijbabcv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-delete-column-16-regular" /></template>
<style>
.b3ijbabcv {
  fill: currentColor;
