...
const content = `<path class="oon05umty"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:swap-driving-apps-rounded" /></template>
<style>
.oon05umty {
  fill: currentColor;
