...
const content = `<path class="n5bo-ib0s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-radar" /></template>
<style>
.n5bo-ib0s {
  fill: currentColor;
