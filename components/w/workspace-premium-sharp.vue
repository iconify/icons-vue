...
const content = `<path class="yy99ieade"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:workspace-premium-sharp" /></template>
<style>
.yy99ieade {
  fill: currentColor;
