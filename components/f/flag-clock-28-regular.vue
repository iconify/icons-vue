...
const content = `<path class="jne_zcczi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flag-clock-28-regular" /></template>
<style>
.jne_zcczi {
  fill: currentColor;
