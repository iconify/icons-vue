...
const content = `<path class="pldw1ccrg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-checkmark-24-filled" /></template>
<style>
.pldw1ccrg {
  fill: currentColor;
