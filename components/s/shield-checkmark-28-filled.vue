...
const content = `<path class="pthw35bto"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-checkmark-28-filled" /></template>
<style>
.pthw35bto {
  fill: currentColor;
