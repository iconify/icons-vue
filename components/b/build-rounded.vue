...
const content = `<path class="p2hf_n3uy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:build-rounded" /></template>
<style>
.p2hf_n3uy {
  fill: currentColor;
