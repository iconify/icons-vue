...
const content = `<path class="tm5hz1ubq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-partly-cloudy-night-20-regular" /></template>
<style>
.tm5hz1ubq {
  fill: currentColor;
