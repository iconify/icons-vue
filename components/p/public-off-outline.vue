...
const content = `<path class="rzvh4tw6v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:public-off-outline" /></template>
<style>
.rzvh4tw6v {
  fill: currentColor;
