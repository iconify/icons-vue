...
const content = `<path class="apk07hn1t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pergola-outline-rounded" /></template>
<style>
.apk07hn1t {
  fill: currentColor;
