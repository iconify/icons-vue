...
const content = `<path class="hspq9hb2b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:widget-small-sharp" /></template>
<style>
.hspq9hb2b {
  fill: currentColor;
