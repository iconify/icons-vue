...
const content = `<path class="omwanlbrh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pool-outline" /></template>
<style>
.omwanlbrh {
  fill: currentColor;
