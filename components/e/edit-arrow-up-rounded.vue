...
const content = `<path class="is_xu8b3g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-arrow-up-rounded" /></template>
<style>
.is_xu8b3g {
  fill: currentColor;
