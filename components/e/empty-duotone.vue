...
const content = `<g class="cuyn6tgcc"><path class="fw_-f4u_a"/><path class="uo97o_bgk"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:empty-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
