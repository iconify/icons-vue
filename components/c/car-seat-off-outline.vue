...
const content = `<path class="ruu06xbnh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-seat-off-outline" /></template>
<style>
.ruu06xbnh {
  fill: currentColor;
