...
const content = `<g class="cuyn6tgcc"><path class="g9eou3b7p"/><path class="hzzbx-bfb"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-more-vertical-sharp-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
