...
const content = `<path class="kiwd-p7jd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-9-20-regular" /></template>
<style>
.kiwd-p7jd {
  fill: currentColor;
