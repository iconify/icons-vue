...
const content = `<path class="cfqtcxb5k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:card-travel-outline-rounded" /></template>
<style>
.cfqtcxb5k {
  fill: currentColor;
