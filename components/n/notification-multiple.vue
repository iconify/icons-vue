...
const content = `<path class="iamzgcd7o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:notification-multiple" /></template>
<style>
.iamzgcd7o {
  fill: currentColor;
