...
const content = `<path class="kyz38ibed"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-3-lines-24-regular" /></template>
<style>
.kyz38ibed {
  fill: currentColor;
