...
const content = `<path class="v9ejg9b0u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:code-blocks-outline" /></template>
<style>
.v9ejg9b0u {
  fill: currentColor;
