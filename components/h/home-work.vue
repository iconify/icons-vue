...
const content = `<path class="j1ig3p5mc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:home-work" /></template>
<style>
.j1ig3p5mc {
  fill: currentColor;
