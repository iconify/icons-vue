...
const content = `<path class="jzru9fb1r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:hevc-outline" /></template>
<style>
.jzru9fb1r {
  fill: currentColor;
