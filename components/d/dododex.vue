...
const content = `<path class="c22ny0_gl"/><path class="fq2s_kbkh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dododex" /></template>
<style>
.c22ny0_gl {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M11.168 15.665c-6.96 9.022-5.276 20.968 3.495 25.848c9.417 5.24 20.496-.516 24.202-9.857C43.27 20.554 40.831 8.574 35.43 5.624c-5.98-3.266-17.086.737-24.262 10.04Z");
}
