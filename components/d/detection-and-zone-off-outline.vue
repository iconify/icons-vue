...
const content = `<path class="afroa0mwe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:detection-and-zone-off-outline" /></template>
<style>
.afroa0mwe {
  fill: currentColor;
