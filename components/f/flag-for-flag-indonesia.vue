...
const content = `<path class="cf6kmbb0v"/><path class="ahv46fxbf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-indonesia" /></template>
<style>
.ahv46fxbf {
