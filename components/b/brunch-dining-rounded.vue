...
const content = `<path class="i18j5fble"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brunch-dining-rounded" /></template>
<style>
.i18j5fble {
  fill: currentColor;
