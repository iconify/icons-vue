...
const content = `<path class="bwk_ii75z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pregnant-woman-outline-rounded" /></template>
<style>
.bwk_ii75z {
  fill: currentColor;
