...
const content = `<path class="wjui7ibno"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:edit-arrow-down-rounded" /></template>
<style>
.wjui7ibno {
  fill: currentColor;
