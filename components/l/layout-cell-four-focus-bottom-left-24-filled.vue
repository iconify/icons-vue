...
const content = `<path class="fgplfn15s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-cell-four-focus-bottom-left-24-filled" /></template>
<style>
.fgplfn15s {
  fill: currentColor;
