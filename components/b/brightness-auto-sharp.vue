...
const content = `<path class="txjnktd0v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:brightness-auto-sharp" /></template>
<style>
.txjnktd0v {
  fill: currentColor;
