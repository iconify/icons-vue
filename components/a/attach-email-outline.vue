...
const content = `<path class="emzvx4euk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:attach-email-outline" /></template>
<style>
.emzvx4euk {
  fill: currentColor;
