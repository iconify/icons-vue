...
const content = `<path class="iqlm_sblo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ad-off-outline-rounded" /></template>
<style>
.iqlm_sblo {
  fill: currentColor;
