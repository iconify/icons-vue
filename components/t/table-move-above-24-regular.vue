...
const content = `<path class="dev14abbm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-above-24-regular" /></template>
<style>
.dev14abbm {
  fill: currentColor;
