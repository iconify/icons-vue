...
const content = `<path class="qjr5--bar"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shades-outline-sharp" /></template>
<style>
.qjr5--bar {
  fill: currentColor;
