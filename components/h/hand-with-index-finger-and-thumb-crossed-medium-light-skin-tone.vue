...
const content = `<path class="ha1qsvbvr"/><defs><path id="SVGngJ5edLm" class="ukzpribaw"/></defs><clipPath id="SVGkyBsod2b"><use href="#SVGngJ5edLm"/></clipPath><g clip-path="url(#SVGkyBsod2b)" class="zlqwn85jm"><path class="lnq-844mv"/></g><defs><use href="#SVGngJ5edLm" id="SVGCZdLybDO"/></defs><clipPath id="SVG9bWfJdrK"><use href="#SVGCZdLybDO"/></clipPath><g clip-path="url(#SVG9bWfJdrK)" class="j9_i7vu4q"><path class="jycsq1plr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:hand-with-index-finger-and-thumb-crossed-medium-light-skin-tone" /></template>
<style>
.ha1qsvbvr {
