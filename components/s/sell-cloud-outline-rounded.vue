...
const content = `<path class="kf86sobyn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sell-cloud-outline-rounded" /></template>
<style>
.kf86sobyn {
  fill: currentColor;
