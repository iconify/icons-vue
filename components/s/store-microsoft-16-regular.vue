...
const content = `<path class="fuc1zccju"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:store-microsoft-16-regular" /></template>
<style>
.fuc1zccju {
  fill: currentColor;
