...
const content = `<path class="askezlbei"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-eraser-20-regular" /></template>
<style>
.askezlbei {
  fill: currentColor;
