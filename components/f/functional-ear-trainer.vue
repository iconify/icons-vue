...
const content = `<path class="hz90yqibn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:functional-ear-trainer" /></template>
<style>
.hz90yqibn {
  fill: none;
  stroke: currentColor;
