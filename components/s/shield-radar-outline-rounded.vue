...
const content = `<path class="c09583jff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-radar-outline-rounded" /></template>
<style>
.c09583jff {
  fill: currentColor;
