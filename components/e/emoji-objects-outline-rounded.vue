...
const content = `<path class="fiv3_yqfw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:emoji-objects-outline-rounded" /></template>
<style>
.fiv3_yqfw {
  fill: currentColor;
