...
const content = `<path class="dxw48oy6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-procfile" /></template>
<style>
.dxw48oy6i {
