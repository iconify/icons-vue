...
const content = `<path class="hu2gcbcdd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-trending-32-filled" /></template>
<style>
.hu2gcbcdd {
  fill: currentColor;
