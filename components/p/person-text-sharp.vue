...
const content = `<path class="qnr8eo92m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:person-text-sharp" /></template>
<style>
.qnr8eo92m {
  fill: currentColor;
