...
const content = `<path class="i9clfwm2k"/><path class="a-87zljyf"/><path class="anzy_pbea"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:yr" /></template>
<style>
.a-87zljyf {
  fill: none;
  stroke: currentColor;
