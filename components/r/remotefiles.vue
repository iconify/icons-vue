...
const content = `<path class="ibek2co3k"/><path class="o2srxbcsm"/><path class="ec58tkbjm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:remotefiles" /></template>
<style>
.ec58tkbjm {
  fill: none;
  stroke: currentColor;
