...
const content = `<path class="ll0g54h-q"/><path class="ym24l0wcw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:textbender" /></template>
<style>
.ll0g54h-q {
  fill: none;
  stroke: currentColor;
