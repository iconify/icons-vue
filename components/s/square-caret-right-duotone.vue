...
const content = `<g class="nrj6p8qat"><path class="lwaj0vjwi"/><path class="lcgw33bfr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-caret-right-duotone" /></template>
<style>
.lcgw33bfr {
