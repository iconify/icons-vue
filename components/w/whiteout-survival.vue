...
const content = `<path class="php1eybei"/><path class="s7d_-tzql"/><path class="bi5xh8ocx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:whiteout-survival" /></template>
<style>
.bi5xh8ocx {
  fill: none;
  stroke: currentColor;
...
.php1eybei {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M10.11 7.552c-2.527 8.128-3.3 16-3.833 25.342c1.435 3.01 2.352 4.724 4.99 8.093c3.2 2.242 16.524 1.964 27.065-.645c3.782-8.547 3.493-14.989 3.284-25.782c-2.519-4.134-4.204-6.12-6.789-8.777c-9.66-.704-15.811-.086-24.716 1.77z");
}
