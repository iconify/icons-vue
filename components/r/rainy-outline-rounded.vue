...
const content = `<path class="x0ptgpjlf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:rainy-outline-rounded" /></template>
<style>
.x0ptgpjlf {
  fill: currentColor;
