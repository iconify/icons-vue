...
const content = `<path class="e4jm6heah"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:board-split-24-filled" /></template>
<style>
.e4jm6heah {
  fill: currentColor;
