...
const content = `<path class="h3wjtrwtr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tour-sharp" /></template>
<style>
.h3wjtrwtr {
  fill: currentColor;
