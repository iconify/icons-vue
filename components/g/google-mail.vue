...
const content = `<path class="dn62scb1l"/><path class="gvd54zfir"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:google-mail" /></template>
<style>
.dn62scb1l {
  fill: none;
  stroke: currentColor;
