...
const content = `<path class="zmi9d3j7m"/><path class="o1obzrb0p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-monaco" /></template>
<style>
.o1obzrb0p {
