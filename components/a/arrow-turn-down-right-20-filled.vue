...
const content = `<path class="e9-s3lbcn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-turn-down-right-20-filled" /></template>
<style>
.e9-s3lbcn {
  fill: currentColor;
