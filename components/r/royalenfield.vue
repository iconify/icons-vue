...
const content = `<path class="asw-1t9kr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:royalenfield" /></template>
<style>
.asw-1t9kr {
  fill: none;
  stroke: currentColor;
