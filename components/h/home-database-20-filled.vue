...
const content = `<path class="t9hv-bcqd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:home-database-20-filled" /></template>
<style>
.t9hv-bcqd {
  fill: currentColor;
