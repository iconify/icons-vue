...
const content = `<rect class="j3s9ivbxi"/><path class="s2y-1nc4e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emotic" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
