...
const content = `<path class="gituuu1sb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:presence-offline-20-regular" /></template>
<style>
.gituuu1sb {
  fill: currentColor;
