...
const content = `<path class="mhpz99b1l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-bubbles-question-28-regular" /></template>
<style>
.mhpz99b1l {
  fill: currentColor;
