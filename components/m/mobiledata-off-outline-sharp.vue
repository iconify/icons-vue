...
const content = `<path class="mxwmbbc9u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobiledata-off-outline-sharp" /></template>
<style>
.mxwmbbc9u {
  fill: currentColor;
