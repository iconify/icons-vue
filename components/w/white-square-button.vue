...
const content = `<path class="o0citobrn"/><path class="wpwotabjp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:white-square-button" /></template>
<style>
.o0citobrn {
