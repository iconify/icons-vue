...
const content = `<path class="fddtdvwlu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sticker-add-outline-sharp" /></template>
<style>
.fddtdvwlu {
  fill: currentColor;
