...
const content = `<path class="fqlm3-bua"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:street-sign-20-regular" /></template>
<style>
.fqlm3-bua {
  fill: currentColor;
