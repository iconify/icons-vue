...
const content = `<path class="oe-g8ptyz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-multiple-minus-28-filled" /></template>
<style>
.oe-g8ptyz {
  fill: currentColor;
