...
const content = `<g class="nrj6p8qat"><path class="xgaf0nbdt"/><path class="z15tx_4tv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-dollar-sign" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
...
.z15tx_4tv {
  d: path("M12 6L12 18M14.5 7L10.5 7C9.1193 7 8 8.1193 8 9.5C8 10.8807 9.1193 12 10.5 12L13.5 12C14.8807 12 16 13.1193 16 14.5C16 15.8807 14.8807 17 13.5 17L9.5 17");
}
