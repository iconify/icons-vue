...
const content = `<path class="x2jnnpeye"/><path class="nmhw6dbmm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-pin-off" /></template>
<style>
.nmhw6dbmm {
  fill: currentColor;
