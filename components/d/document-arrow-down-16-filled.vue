...
const content = `<path class="eszqpsb7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-arrow-down-16-filled" /></template>
<style>
.eszqpsb7l {
  fill: currentColor;
