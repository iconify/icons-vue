...
const content = `<path class="p-llisb9b"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:marriott-bonvoy" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
