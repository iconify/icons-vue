...
const content = `<path class="fl5rzeb4j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:trip-origin-outline-rounded" /></template>
<style>
.fl5rzeb4j {
  fill: currentColor;
