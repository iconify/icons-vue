...
const content = `<path class="e26dcutmp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:king-bed-rounded" /></template>
<style>
.e26dcutmp {
  fill: currentColor;
