...
const content = `<path class="uc677-35i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-stack-above-28-regular" /></template>
<style>
.uc677-35i {
  fill: currentColor;
