...
const content = `<path class="b8010i37k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:hexagon-sparkle-24-regular" /></template>
<style>
.b8010i37k {
  fill: currentColor;
