...
const content = `<path class="wbr0lgbjm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-font-download-off" /></template>
<style>
.wbr0lgbjm {
  fill: currentColor;
