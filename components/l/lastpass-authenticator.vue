...
const content = `<path class="m15nspbcy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lastpass-authenticator" /></template>
<style>
.m15nspbcy {
  fill: none;
  stroke: currentColor;
