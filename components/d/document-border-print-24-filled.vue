...
const content = `<path class="b26wi6bjj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-border-print-24-filled" /></template>
<style>
.b26wi6bjj {
  fill: currentColor;
