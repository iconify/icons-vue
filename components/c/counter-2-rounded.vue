...
const content = `<path class="kwp2pyrqc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:counter-2-rounded" /></template>
<style>
.kwp2pyrqc {
  fill: currentColor;
