...
const content = `<path class="oy1bwzb8k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:contract-outline-sharp" /></template>
<style>
.oy1bwzb8k {
  fill: currentColor;
