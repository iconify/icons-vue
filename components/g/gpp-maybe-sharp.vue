...
const content = `<path class="yeci3uj-d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gpp-maybe-sharp" /></template>
<style>
.yeci3uj-d {
  fill: currentColor;
