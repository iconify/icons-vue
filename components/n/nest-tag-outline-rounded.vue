...
const content = `<path class="ip8ei2qcl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-tag-outline-rounded" /></template>
<style>
.ip8ei2qcl {
  fill: currentColor;
