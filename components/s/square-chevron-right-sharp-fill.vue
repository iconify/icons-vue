...
const content = `<path class="geki3y6gf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-chevron-right-sharp-fill" /></template>
<style>
.geki3y6gf {
  fill: currentColor;
