...
const content = `<defs><path id="SVGyKxtGbkX" class="ym0po11xm"/></defs><use href="#SVGyKxtGbkX" class="y9tr6bcfx"/><use href="#SVGyKxtGbkX" class="y9tr6bcfx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mymo" /></template>
<style>
.y9tr6bcfx {
  fill: none;
  stroke: currentColor;
