...
const content = `<path class="y0pvfjbhs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-motion-mode-outline-sharp" /></template>
<style>
.y0pvfjbhs {
  fill: currentColor;
