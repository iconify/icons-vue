...
const content = `<path class="su13z-b8q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:speaker-simple-high-thin" /></template>
<style>
.su13z-b8q {
  fill: currentColor;
