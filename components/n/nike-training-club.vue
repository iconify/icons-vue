...
const content = `<path class="ucctcibnk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nike-training-club" /></template>
<style>
.ucctcibnk {
  fill: none;
  stroke: currentColor;
