...
const content = `<g class="cuyn6tgcc"><path class="q5jsyf-yl"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:grab-handle-circle" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
