...
const content = `<path class="ztmbhqmft"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:backup-table-outline-rounded" /></template>
<style>
.ztmbhqmft {
  fill: currentColor;
