...
const content = `<path class="or09ku2uo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:palette-rounded" /></template>
<style>
.or09ku2uo {
  fill: currentColor;
