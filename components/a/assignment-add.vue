...
const content = `<path class="gxggahb0y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:assignment-add" /></template>
<style>
.gxggahb0y {
  fill: currentColor;
