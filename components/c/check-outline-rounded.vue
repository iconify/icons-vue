...
const content = `<path class="tge7gjbul"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:check-outline-rounded" /></template>
<style>
.tge7gjbul {
  fill: currentColor;
