...
const content = `<path class="v09tqpala"/><path class="a4tj93cqy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-add-home" /></template>
<style>
.a4tj93cqy {
  fill: currentColor;
