...
const content = `<path class="cd4wbbcvu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-flag-star" /></template>
<style>
.cd4wbbcvu {
  fill: none;
  stroke: currentColor;
