...
const content = `<path class="th9i13mww"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-3-lines-caret-16-filled" /></template>
<style>
.th9i13mww {
  fill: currentColor;
