...
const content = `<path class="y6q4k5tuj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:thermometer-simple-thin" /></template>
<style>
.y6q4k5tuj {
  fill: currentColor;
