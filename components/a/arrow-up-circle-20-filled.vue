...
const content = `<path class="w6ocgvbay"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-up-circle-20-filled" /></template>
<style>
.w6ocgvbay {
  fill: currentColor;
