...
const content = `<path class="ev-p4pbem"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:2mp-outline-sharp" /></template>
<style>
.ev-p4pbem {
  fill: currentColor;
