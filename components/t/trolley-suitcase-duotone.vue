...
const content = `<g class="cuyn6tgcc"><path class="w4-lc_t-n"/><path class="wckn8qbkg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:trolley-suitcase-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.w4-lc_t-n {
  d: path("M224 72v72a8 8 0 0 1-8 8H88a8 8 0 0 1-8-8V72a8 8 0 0 1 8-8h128a8 8 0 0 1 8 8");
