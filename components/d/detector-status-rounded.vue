...
const content = `<path class="kiww_6b-h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:detector-status-rounded" /></template>
<style>
.kiww_6b-h {
  fill: currentColor;
