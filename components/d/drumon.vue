...
const content = `<path class="z9zr4ml2p"/><path class="trqnvvilc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:drumon" /></template>
<style>
.trqnvvilc {
  fill: none;
  stroke: currentColor;
