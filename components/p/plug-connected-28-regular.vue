...
const content = `<path class="lekn3xm2x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:plug-connected-28-regular" /></template>
<style>
.lekn3xm2x {
  fill: currentColor;
