...
const content = `<path class="e3ys5hdik"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:keyman" /></template>
<style>
.e3ys5hdik {
  fill: none;
  stroke: currentColor;
