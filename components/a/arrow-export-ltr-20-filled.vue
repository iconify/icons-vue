...
const content = `<path class="ltwt3sb5e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-export-ltr-20-filled" /></template>
<style>
.ltwt3sb5e {
  fill: currentColor;
