...
const content = `<path class="iqpvlybdb"/><path class="ddbawgbjy"/><path class="xv_3eobqp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:boston-transit" /></template>
<style>
.ddbawgbjy {
  fill: none;
  stroke: currentColor;
