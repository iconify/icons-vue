...
const content = `<path class="ou864lr_u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-none-20-filled" /></template>
<style>
.ou864lr_u {
  fill: currentColor;
