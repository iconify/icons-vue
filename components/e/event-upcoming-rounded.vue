...
const content = `<path class="udjg8r_4b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:event-upcoming-rounded" /></template>
<style>
.udjg8r_4b {
  fill: currentColor;
