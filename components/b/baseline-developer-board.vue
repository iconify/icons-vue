...
const content = `<path class="c-5qxnbun"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-developer-board" /></template>
<style>
.c-5qxnbun {
  fill: currentColor;
