...
const content = `<path class="u9_95vb7n"/><path class="l8f4zxbeo"/><path class="jmq3yjs3d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-anatomical-heart" /></template>
<style>
.jmq3yjs3d {
  fill: none;
  stroke: currentColor;
...
.u9_95vb7n {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m26.144 5.5l.359 2.713l.35.046l1.19-2.225l1.877.66c-.122 1.352-1.514 3.671.931 4.563c-1.599.536-2.447 1.077-4.031-.013c-.912-.628-2.287.068-2.822.295c-.656.277-1.424.57-1.29 1.678c.035.301.331.593-.368 1.49c-1.388 1.553-2.376 1.395-4.113 4.508c-2.13-2.807-1.026-8.609 2.537-10.674l-.426-1.685l1.833-.798l1.435 2.25l.811-2.808z");
}
