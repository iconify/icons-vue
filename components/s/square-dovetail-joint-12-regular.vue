...
const content = `<path class="p_2mbylti"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-dovetail-joint-12-regular" /></template>
<style>
.p_2mbylti {
  fill: currentColor;
