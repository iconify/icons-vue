...
const content = `<path class="s65-_bbsh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-angry-20-regular" /></template>
<style>
.s65-_bbsh {
  fill: currentColor;
