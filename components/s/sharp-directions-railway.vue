...
const content = `<path class="qbzmenz9f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-directions-railway" /></template>
<style>
.qbzmenz9f {
  fill: currentColor;
