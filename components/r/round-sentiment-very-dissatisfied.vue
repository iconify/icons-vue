...
const content = `<path class="jizi7fb6h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-sentiment-very-dissatisfied" /></template>
<style>
.jizi7fb6h {
  fill: currentColor;
