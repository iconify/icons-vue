...
const content = `<path class="dthoglb-r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:car-repair-sharp" /></template>
<style>
.dthoglb-r {
  fill: currentColor;
