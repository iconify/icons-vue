...
const content = `<path class="raxrhacld"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:martins-groceries-to-go" /></template>
<style>
.raxrhacld {
  fill: none;
  stroke: currentColor;
