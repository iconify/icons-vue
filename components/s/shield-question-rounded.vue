...
const content = `<path class="i3xe_rbpo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-question-rounded" /></template>
<style>
.i3xe_rbpo {
  fill: currentColor;
