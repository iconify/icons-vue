...
const content = `<path class="if6_2accr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:countertops-outline-sharp" /></template>
<style>
.if6_2accr {
  fill: currentColor;
