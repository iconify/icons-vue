...
const content = `<path class="cpihbebsy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:perm-scan-wifi-outline-sharp" /></template>
<style>
.cpihbebsy {
  fill: currentColor;
