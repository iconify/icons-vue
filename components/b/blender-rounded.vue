...
const content = `<path class="go03o9u2z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:blender-rounded" /></template>
<style>
.go03o9u2z {
  fill: currentColor;
