...
const content = `<g class="y9tr6bcfx"><circle transform="rotate(-88.777 24 24)" class="f_v_dfbgn"/><path class="cfmj0jb1q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:moscow-electronic-school" /></template>
<style>
.cfmj0jb1q {
