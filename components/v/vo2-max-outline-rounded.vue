...
const content = `<path class="p2n9cobwa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:vo2-max-outline-rounded" /></template>
<style>
.p2n9cobwa {
  fill: currentColor;
