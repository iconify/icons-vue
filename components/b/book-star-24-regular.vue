...
const content = `<path class="r-2_occym"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-star-24-regular" /></template>
<style>
.r-2_occym {
  fill: currentColor;
