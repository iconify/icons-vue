...
const content = `<path class="q1rgp1d1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drive-train-20-regular" /></template>
<style>
.q1rgp1d1j {
  fill: currentColor;
