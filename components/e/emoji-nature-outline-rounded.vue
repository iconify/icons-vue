...
const content = `<path class="abd-sfrvb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:emoji-nature-outline-rounded" /></template>
<style>
.abd-sfrvb {
  fill: currentColor;
