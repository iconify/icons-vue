...
const content = `<path class="kl1avqrkm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-sync-circle-32-filled" /></template>
<style>
.kl1avqrkm {
  fill: currentColor;
