...
const content = `<path class="kkhgqchzu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:re-order-24-regular" /></template>
<style>
.kkhgqchzu {
  fill: currentColor;
