...
const content = `<path class="y7nj7h9qa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:paridroid" /></template>
<style>
.y7nj7h9qa {
  fill: none;
  stroke: currentColor;
