...
const content = `<path class="x6_6lehet"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:light-group-2-sharp" /></template>
<style>
.x6_6lehet {
  fill: currentColor;
