...
const content = `<path class="r0v1uzbom"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-bank-16-regular" /></template>
<style>
.r0v1uzbom {
  fill: currentColor;
