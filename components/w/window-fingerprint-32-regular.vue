...
const content = `<path class="z_v432gcm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-fingerprint-32-regular" /></template>
<style>
.z_v432gcm {
  fill: currentColor;
