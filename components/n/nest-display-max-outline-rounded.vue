...
const content = `<path class="em3td6bsh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:nest-display-max-outline-rounded" /></template>
<style>
.em3td6bsh {
  fill: currentColor;
