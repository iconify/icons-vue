...
const content = `<path class="rzm06ubmp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-double-arrow-up-rounded" /></template>
<style>
.rzm06ubmp {
  fill: currentColor;
