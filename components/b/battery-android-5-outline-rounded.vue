...
const content = `<path class="k7n50u53r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-android-5-outline-rounded" /></template>
<style>
.k7n50u53r {
  fill: currentColor;
