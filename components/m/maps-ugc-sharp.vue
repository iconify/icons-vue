...
const content = `<path class="ekwuawmox"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:maps-ugc-sharp" /></template>
<style>
.ekwuawmox {
  fill: currentColor;
