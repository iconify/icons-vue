...
const content = `<path class="fris7jben"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:le-monde" /></template>
<style>
.fris7jben {
  fill: none;
  stroke: currentColor;
