...
const content = `<path class="dnke5ca5z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-person-16-filled" /></template>
<style>
.dnke5ca5z {
  fill: currentColor;
