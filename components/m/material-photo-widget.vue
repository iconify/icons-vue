...
const content = `<path class="y5slv6xzp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:material-photo-widget" /></template>
<style>
.y5slv6xzp {
  fill: none;
  stroke: currentColor;
