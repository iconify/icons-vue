...
const content = `<path class="vdnnnackg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:detector-alarm-outline-rounded" /></template>
<style>
.vdnnnackg {
  fill: currentColor;
