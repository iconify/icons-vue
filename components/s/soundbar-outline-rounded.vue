...
const content = `<path class="fiif3jb5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:soundbar-outline-rounded" /></template>
<style>
.fiif3jb5x {
  fill: currentColor;
