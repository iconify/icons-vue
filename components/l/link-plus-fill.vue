...
const content = `<path class="i7eg1_raw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:link-plus-fill" /></template>
<style>
.i7eg1_raw {
  fill: none;
  stroke: currentColor;
