...
const content = `<circle class="cpk0fnbgt"/><path class="o79spxb8p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hp" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
