...
const content = `<path class="pxdxsop4b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:subtitles-gear" /></template>
<style>
.pxdxsop4b {
  fill: currentColor;
