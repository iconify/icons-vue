...
const content = `<path class="h0qgeuwow"/><path class="f_93xyxmv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:folder-apple" /></template>
<style>
.f_93xyxmv {
  fill: none;
  stroke: currentColor;
