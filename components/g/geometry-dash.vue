...
const content = `<path class="sqlnli29e"/><path class="qzvn2bz_t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:geometry-dash" /></template>
<style>
.qzvn2bz_t {
  fill: none;
  stroke: currentColor;
