...
const content = `<g class="cuyn6tgcc"><path class="udi43ybti"/><path class="vn4y1pttw"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:virtual-reality-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
