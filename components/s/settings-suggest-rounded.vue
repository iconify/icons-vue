...
const content = `<path class="b63e7zb-l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-suggest-rounded" /></template>
<style>
.b63e7zb-l {
  fill: currentColor;
