...
const content = `<path class="e3q8pu64i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-rectangle-landscape-20-filled" /></template>
<style>
.e3q8pu64i {
  fill: currentColor;
