...
const content = `<path class="mu3b4t-tv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-10-20-filled" /></template>
<style>
.mu3b4t-tv {
  fill: currentColor;
