...
const content = `<path class="t25toffne"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-razor" /></template>
<style>
.t25toffne {
