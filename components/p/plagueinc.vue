...
const content = `<path class="n-vd8mbul"/><path class="ihzom0rbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:plagueinc" /></template>
<style>
.ihzom0rbl {
  fill: none;
  stroke: currentColor;
...
.n-vd8mbul {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M29.2 16.5a10.25 10.25 0 0 0-10.4 0M14 24.6c.07 4.31 1.93 7.45 5.3 9.3m9.5 0a10 10 0 0 0 5.2-9.3l-2.5.5");
}
