...
const content = `<path class="iosem7bsa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tilt-arrow-up-outline" /></template>
<style>
.iosem7bsa {
  fill: currentColor;
