...
const content = `<path class="m8indo9ou"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hive-outline-sharp" /></template>
<style>
.m8indo9ou {
  fill: currentColor;
