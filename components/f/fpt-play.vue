...
const content = `<path class="rk--ofbmf"/><path class="orrh6x7pd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fpt-play" /></template>
<style>
.orrh6x7pd {
  fill: none;
  stroke: currentColor;
