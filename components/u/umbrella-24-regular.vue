...
const content = `<path class="vrlzpclfw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:umbrella-24-regular" /></template>
<style>
.vrlzpclfw {
  fill: currentColor;
