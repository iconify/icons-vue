...
const content = `<g class="gp_8x1bzb"><path class="fnsafsbbs"/><path class="o8z14obsa"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:plane-takeoff-sharp-duotone" /></template>
<style>
.fnsafsbbs {
  fill: currentColor;
