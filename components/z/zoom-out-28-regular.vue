...
const content = `<path class="c-5vd1byf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:zoom-out-28-regular" /></template>
<style>
.c-5vd1byf {
  fill: currentColor;
