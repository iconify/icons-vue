...
const content = `<path class="hpaolbcjt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:king-bed" /></template>
<style>
.hpaolbcjt {
  fill: currentColor;
