...
const content = `<path class="cdh-_b91g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:3g-mobiledata-badge" /></template>
<style>
.cdh-_b91g {
  fill: currentColor;
