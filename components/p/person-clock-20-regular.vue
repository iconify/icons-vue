...
const content = `<path class="o4w7xbbpj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-clock-20-regular" /></template>
<style>
.o4w7xbbpj {
  fill: currentColor;
