...
const content = `<path class="w93hn9bye"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:serial-port-24-filled" /></template>
<style>
.w93hn9bye {
  fill: currentColor;
