...
const content = `<path class="tawtilbcd"/><circle class="k79q3xboj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-sell" /></template>
<style>
.k79q3xboj {
  cx: 6.5px;
  cy: 6.5px;
