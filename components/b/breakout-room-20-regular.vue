...
const content = `<path class="j0dic0buj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:breakout-room-20-regular" /></template>
<style>
.j0dic0buj {
  fill: currentColor;
