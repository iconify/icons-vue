...
const content = `<path class="eu9egmb2l"/><path class="au_v0abxr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-denmark" /></template>
<style>
.au_v0abxr {
