...
const content = `<path class="vrlri9buw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:broad-activity-feed-16-filled" /></template>
<style>
.vrlri9buw {
  fill: currentColor;
