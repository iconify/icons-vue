...
const content = `<path class="rwdkkk_0v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tonality-2-outline-rounded" /></template>
<style>
.rwdkkk_0v {
  fill: currentColor;
