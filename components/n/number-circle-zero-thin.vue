...
const content = `<path class="gyy23fbpe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-circle-zero-thin" /></template>
<style>
.gyy23fbpe {
  fill: currentColor;
