...
const content = `<path class="o9mss9bql"/><path class="cy8jb3-li"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-language" /></template>
<style>
.cy8jb3-li {
  fill: currentColor;
