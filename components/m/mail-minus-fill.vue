...
const content = `<g class="nrj6p8qat"><path class="sj3q2nb3r"/><path class="q6tjvrbje"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:mail-minus-fill" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
