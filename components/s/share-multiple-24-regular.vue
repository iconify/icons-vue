...
const content = `<path class="vl_khih_u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-multiple-24-regular" /></template>
<style>
.vl_khih_u {
  fill: currentColor;
