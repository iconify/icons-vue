...
const content = `<path class="sxebhzeor"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shades-closed-sharp" /></template>
<style>
.sxebhzeor {
  fill: currentColor;
