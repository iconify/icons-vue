...
const content = `<path class="n-vtm33iu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-android-6-outline-rounded" /></template>
<style>
.n-vtm33iu {
  fill: currentColor;
