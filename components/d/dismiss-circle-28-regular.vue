...
const content = `<path class="a348mbuxe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dismiss-circle-28-regular" /></template>
<style>
.a348mbuxe {
  fill: currentColor;
