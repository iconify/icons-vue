...
const content = `<g class="cuyn6tgcc"><path class="rl1dq4bco"/><path class="htjc1yb3u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-square-up-left-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
