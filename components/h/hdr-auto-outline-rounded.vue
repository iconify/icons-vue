...
const content = `<path class="tj_z4skwm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hdr-auto-outline-rounded" /></template>
<style>
.tj_z4skwm {
  fill: currentColor;
