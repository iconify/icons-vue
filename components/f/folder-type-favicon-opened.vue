...
const content = `<path class="csyfxks9z"/><circle class="fi_zd0r9l"/><circle class="gg2gvfbwf"/><path class="lw9ofs1oy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-favicon-opened" /></template>
<style>
.csyfxks9z {
  fill: var(--svg-color--7daad3, #7daad3);
