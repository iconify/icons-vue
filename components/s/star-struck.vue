...
const content = `<path class="ngpmpqbbo"/><path class="luzp_sbwt"/><path class="nac320slo"/><path class="koidpc4kr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:star-struck" /></template>
<style>
.koidpc4kr {
  fill: var(--svg-color--e95f28, #e95f28);
  d: path("m15.682 4.413l-4.542.801L8.8.961a1.252 1.252 0 0 0-2.331.411l-.745 4.797l-4.542.801a1.25 1.25 0 0 0-.318 2.361l4.07 1.932l-.748 4.812a1.253 1.253 0 0 0 1.235 1.442c.327 0 .65-.128.891-.372l3.512-3.561l4.518 2.145a1.25 1.25 0 0 0 1.631-1.731L13.625 9.73l3.165-3.208a1.252 1.252 0 0 0-1.108-2.109m4.636 0l4.542.801L27.2.961a1.251 1.251 0 0 1 2.33.411l.745 4.797l4.542.801c.536.094.949.524 1.021 1.063s-.211 1.063-.703 1.297l-4.07 1.932l.748 4.812a1.253 1.253 0 0 1-1.235 1.442c-.327 0-.65-.128-.891-.372l-3.512-3.561l-4.518 2.145a1.25 1.25 0 0 1-1.631-1.731l2.348-4.267l-3.165-3.208a1.25 1.25 0 0 1-.217-1.459a1.26 1.26 0 0 1 1.326-.65");
}

.luzp_sbwt {
  fill: var(--svg-color--664500, #664500);
  d: path("M18 21c-3.623 0-6.027-.422-9-1c-.679-.131-2 0-2 2c0 4 4.595 9 11 9c6.404 0 11-5 11-9c0-2-1.321-2.132-2-2c-2.973.578-5.377 1-9 1");
}

.nac320slo {
  fill: var(--svg-color--fff, #fff);
  d: path("M9 22s3 1 9 1s9-1 9-1s-2 4-9 4s-9-4-9-4");
}
