...
const content = `<path class="d1-8t57bn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-two-split-top-focus-top-left-24-filled" /></template>
<style>
.d1-8t57bn {
  fill: currentColor;
