...
const content = `<path class="gux0ofbwj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-circle-up-down-thin" /></template>
<style>
.gux0ofbwj {
  fill: currentColor;
