...
const content = `<path class="j214xwbzr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:looks-5-rounded" /></template>
<style>
.j214xwbzr {
  fill: currentColor;
