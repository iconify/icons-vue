...
const content = `<path class="gjeaqyb-p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:energy-outline-rounded" /></template>
<style>
.gjeaqyb-p {
  fill: currentColor;
