...
const content = `<g class="ic-371bqb"><path class="cwnn8rv2w"/><path class="x712w6paa"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:beating-heart" /></template>
<style>
.cwnn8rv2w {
  d: path("M57.2 22.1c-5.5-14.8-23.5-8.2-25.2-.8c-2.3-7.9-19.8-13.8-25.2.8C.8 38.3 29.9 52.8 32 55.2c2.1-1.9 31.2-17.2 25.2-33.1");
}
