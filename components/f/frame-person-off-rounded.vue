...
const content = `<path class="icb-exsvp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:frame-person-off-rounded" /></template>
<style>
.icb-exsvp {
  fill: currentColor;
