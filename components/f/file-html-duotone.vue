...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="w9zefrbtj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-html-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
