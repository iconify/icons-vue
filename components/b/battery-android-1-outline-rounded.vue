...
const content = `<path class="sn5anri7w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-android-1-outline-rounded" /></template>
<style>
.sn5anri7w {
  fill: currentColor;
