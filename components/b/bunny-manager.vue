...
const content = `<path class="b27ts3ciw"/><circle class="qdwa9ubnu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bunny-manager" /></template>
<style>
.b27ts3ciw {
  fill: none;
  stroke: currentColor;
