...
const content = `<path class="o38kutb4a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:eyeglasses-outline-sharp" /></template>
<style>
.o38kutb4a {
  fill: currentColor;
