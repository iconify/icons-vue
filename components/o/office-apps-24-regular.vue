...
const content = `<path class="yo3wz3hzp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:office-apps-24-regular" /></template>
<style>
.yo3wz3hzp {
  fill: currentColor;
