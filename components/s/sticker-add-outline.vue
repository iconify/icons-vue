...
const content = `<path class="wvm530b8x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sticker-add-outline" /></template>
<style>
.wvm530b8x {
  fill: currentColor;
