...
const content = `<path class="ngpmpqbbo"/><path class="wim5w0bxn"/><path class="xu6auxbfd"/><path class="jtviw_b_p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:tired-face" /></template>
<style>
.jtviw_b_p {
  fill: var(--svg-color--664500, #664500);
  d: path("M6.001 19a1 1 0 0 1-.601-1.799c.143-.107 2.951-2.183 6.856-2.933C9.781 13.027 7.034 13 6.999 13A1.001 1.001 0 0 1 7 11c.221 0 5.452.038 8.707 3.293A1 1 0 0 1 15 16c-4.613 0-8.363 2.772-8.4 2.8a1 1 0 0 1-.599.2m23.998-.001a1 1 0 0 1-.598-.198C29.363 18.772 25.59 16 21 16a1 1 0 0 1-.707-1.707C23.549 11.038 28.779 11 29 11a1 1 0 0 1 .002 2c-.036 0-2.783.027-5.258 1.268c3.905.75 6.713 2.826 6.855 2.933a1 1 0 0 1-.6 1.798");
}
