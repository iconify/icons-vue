...
const content = `<g class="cuyn6tgcc"><path class="ky8stwb-l"/><path class="tep6bdb3d"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:motorcycle-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
