...
const content = `<path class="de6zuqs_y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speed-0-7x-outline-rounded" /></template>
<style>
.de6zuqs_y {
  fill: currentColor;
