...
const content = `<path class="x1dyygpby"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-add-24-regular" /></template>
<style>
.x1dyygpby {
  fill: currentColor;
