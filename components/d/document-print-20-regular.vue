...
const content = `<path class="qjaf-dbxg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-print-20-regular" /></template>
<style>
.qjaf-dbxg {
  fill: currentColor;
