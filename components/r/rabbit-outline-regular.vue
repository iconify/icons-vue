...
const content = `<g class="nrj6p8qat"><path class="osjmvib6z"/><path class="le7pjtb_z"/><path class="iv17tcb7u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:rabbit-outline-regular" /></template>
<style>
.iv17tcb7u {
