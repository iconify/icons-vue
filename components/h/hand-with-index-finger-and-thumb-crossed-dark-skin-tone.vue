...
const content = `<path class="kbv3c-r5o"/><defs><path id="SVGngJ5edLm" class="ukzpribaw"/></defs><clipPath id="SVGkyBsod2b"><use href="#SVGngJ5edLm"/></clipPath><g clip-path="url(#SVGkyBsod2b)" class="t_nvrsbrc"><path class="lnq-844mv"/></g><defs><use href="#SVGngJ5edLm" id="SVGCZdLybDO"/></defs><clipPath id="SVG9bWfJdrK"><use href="#SVGCZdLybDO"/></clipPath><g clip-path="url(#SVG9bWfJdrK)"><path class="jycsq1plr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:hand-with-index-finger-and-thumb-crossed-dark-skin-tone" /></template>
<style>
.jycsq1plr {
