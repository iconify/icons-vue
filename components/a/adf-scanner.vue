...
const content = `<path class="gue-ztwhe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:adf-scanner" /></template>
<style>
.gue-ztwhe {
  fill: currentColor;
