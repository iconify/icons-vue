...
const content = `<path class="y-mcsn_zh"/><path class="l57u88tix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:googleone" /></template>
<style>
.l57u88tix {
  fill: none;
  stroke: currentColor;
