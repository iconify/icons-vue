...
const content = `<path class="mv1msenau"/><path class="b7fe67bpf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:shiro" /></template>
<style>
.b7fe67bpf {
  fill: none;
  stroke: currentColor;
