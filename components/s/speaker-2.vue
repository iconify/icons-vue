...
const content = `<path class="grga7wbum"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speaker-2" /></template>
<style>
.grga7wbum {
  fill: currentColor;
