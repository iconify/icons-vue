...
const content = `<path class="k3inrab9c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:connected-32-filled" /></template>
<style>
.k3inrab9c {
  fill: currentColor;
