...
const content = `<path class="qbx-xdmeo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:the-fork" /></template>
<style>
.qbx-xdmeo {
  fill: none;
  stroke: currentColor;
