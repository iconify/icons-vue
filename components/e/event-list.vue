...
const content = `<path class="f2t6899lk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:event-list" /></template>
<style>
.f2t6899lk {
  fill: currentColor;
