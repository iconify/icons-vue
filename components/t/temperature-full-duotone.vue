...
const content = `<g class="nrj6p8qat"><path class="rqh4y-aib"/><path class="y_0xysjez"/><path class="k8te4qbon"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:temperature-full-duotone" /></template>
<style>
.k8te4qbon {
  fill: currentColor;
