...
const content = `<path class="bhe5ytc-p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:search-insights-outline-sharp" /></template>
<style>
.bhe5ytc-p {
  fill: currentColor;
