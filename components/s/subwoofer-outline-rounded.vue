...
const content = `<path class="emnqqgjvn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:subwoofer-outline-rounded" /></template>
<style>
.emnqqgjvn {
  fill: currentColor;
