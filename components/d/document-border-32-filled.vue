...
const content = `<path class="ppdvt5tvp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-border-32-filled" /></template>
<style>
.ppdvt5tvp {
  fill: currentColor;
