...
const content = `<path class="nvcb4efzb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screenshot-keyboard-rounded" /></template>
<style>
.nvcb4efzb {
  fill: currentColor;
