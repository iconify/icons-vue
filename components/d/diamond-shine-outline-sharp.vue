...
const content = `<path class="ermaqxdfd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:diamond-shine-outline-sharp" /></template>
<style>
.ermaqxdfd {
  fill: currentColor;
