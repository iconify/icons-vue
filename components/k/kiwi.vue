...
const content = `<path class="lmjqanmtj"/><path class="he8d2db8u"/><circle class="zgift6bam"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kiwi" /></template>
<style>
.he8d2db8u {
  fill: none;
  stroke: currentColor;
