...
const content = `<path class="kgxdsrbvw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:checkmark-underline-circle-24-regular" /></template>
<style>
.kgxdsrbvw {
  fill: currentColor;
