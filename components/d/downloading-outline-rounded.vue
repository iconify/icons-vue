...
const content = `<path class="nwto-cyhu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:downloading-outline-rounded" /></template>
<style>
.nwto-cyhu {
  fill: currentColor;
