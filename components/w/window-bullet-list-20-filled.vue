...
const content = `<path class="ukeu4mbjb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-bullet-list-20-filled" /></template>
<style>
.ukeu4mbjb {
  fill: currentColor;
