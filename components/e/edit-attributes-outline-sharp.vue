...
const content = `<path class="o6x_70bzk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:edit-attributes-outline-sharp" /></template>
<style>
.o6x_70bzk {
  fill: currentColor;
