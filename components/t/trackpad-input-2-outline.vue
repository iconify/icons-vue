...
const content = `<path class="dw251kbop"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:trackpad-input-2-outline" /></template>
<style>
.dw251kbop {
  fill: currentColor;
