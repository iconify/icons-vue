...
const content = `<path class="izn9c9b2v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:apartment-outline-rounded" /></template>
<style>
.izn9c9b2v {
  fill: currentColor;
