...
const content = `<path class="te1q0sb4z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shopping-bag-speed-outline" /></template>
<style>
.te1q0sb4z {
  fill: currentColor;
