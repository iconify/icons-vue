...
const content = `<path class="o4c9_xyil"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:battery-plus-vertical-thin" /></template>
<style>
.o4c9_xyil {
  fill: currentColor;
