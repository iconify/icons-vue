...
const content = `<path class="db2iygbrz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:6k-outline-sharp" /></template>
<style>
.db2iygbrz {
  fill: currentColor;
