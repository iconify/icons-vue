...
const content = `<path class="sd1oimgky"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:recommend-rounded" /></template>
<style>
.sd1oimgky {
  fill: currentColor;
