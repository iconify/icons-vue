...
const content = `<g class="ft5dv1b6b"><path class="rpacwisnv"/><path class="li0-sxb7x"/><path class="tugr0ibab"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:mntl" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
