...
const content = `<path class="tc6i50bex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:view-column-2-sharp" /></template>
<style>
.tc6i50bex {
  fill: currentColor;
