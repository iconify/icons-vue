...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-dashed-full-sharp-fill" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.lnzi09g7d {
  ...
  d: path("M7 7L17 7L17 17L7 17L7 7Z");
}
