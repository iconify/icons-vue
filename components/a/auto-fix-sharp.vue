...
const content = `<path class="chomuzb8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-fix-sharp" /></template>
<style>
.chomuzb8v {
  fill: currentColor;
