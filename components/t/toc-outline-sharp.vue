...
const content = `<path class="ivxs1m0mv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:toc-outline-sharp" /></template>
<style>
.ivxs1m0mv {
  fill: currentColor;
