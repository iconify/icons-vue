...
const content = `<path class="samqs4pyg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:sanitize-20-regular" /></template>
<style>
.samqs4pyg {
  fill: currentColor;
