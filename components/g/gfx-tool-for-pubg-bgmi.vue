...
const content = `<path class="j41h43sdy"/><path class="c3o2bt9dg"/><circle class="vd5dy4bma"/><path class="ythuskbbf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gfx-tool-for-pubg-bgmi" /></template>
<style>
.c3o2bt9dg {
  fill: none;
  stroke: currentColor;
...
.j41h43sdy {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M25.16 27.47c.09.39.13.79.13 1.2c0 3.29-2.67 5.95-5.96 5.95s-5.95-2.66-5.95-5.95c0-3.3 2.66-5.96 5.95-5.96c.41 0 .81.04 1.2.13");
}
