...
const content = `<path class="jyqksle1e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:water-orp" /></template>
<style>
.jyqksle1e {
  fill: currentColor;
