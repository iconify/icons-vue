...
const content = `<path class="ukeu0pb_r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:expand-circle-up-rounded" /></template>
<style>
.ukeu0pb_r {
  fill: currentColor;
