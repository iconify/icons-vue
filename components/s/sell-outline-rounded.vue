...
const content = `<path class="fniqm0maj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sell-outline-rounded" /></template>
<style>
.fniqm0maj {
  fill: currentColor;
