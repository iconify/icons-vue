...
const content = `<path class="qx80uccwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-android-24-regular" /></template>
<style>
.qx80uccwk {
  fill: currentColor;
