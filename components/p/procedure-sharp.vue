...
const content = `<path class="a64tsnt3s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:procedure-sharp" /></template>
<style>
.a64tsnt3s {
  fill: currentColor;
