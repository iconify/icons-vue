...
<style>
.amxqnk3kr {
  d: path("M18.125 39.277c-2.94-1.364-2.416-6.377-2.614-9.01c-1.284-2.941-2.794-6.492-.996-10.095c1.829-3.666 3.952-11.183-2.56-11.021c2.251-2.855 7.582.238 8.35 4.17");
}

.at_al_lfz {
  d: path("M25.202 9.89c-.999.349-3.178 1.15-3.703 3.16l-.151 1.847c.249 1.883 2.269 3.44 3.516 4.046c-.77 2.012 3.352 4.53 4.952 4.613c2.456 1.35 3.395 2.544 5.84 1.561");
}
...
.q_x0aqjqp {
  d: path("M16.596 37.52c1.465.355 3.111-.095 4.667-1.13");
}

.r85xq149v {
  d: path("M34.74 8.893c-1.08.88-1.982 1.842-2.695 2.9c-1.542.591-3.039 1.806-3.816 3.579c-1.107.764-2.481 2.154-3.383 3.62c-1.587 1.173-3.145 2.618-4.281 4.527c-1.207.795-3.034 2.548-3.817 4.094c-.553.54-1.132 1.021-1.582 1.778");
}
...
.wq9g0ebio {
  d: path("M17.576 38.946c2.97.158 5.847-.068 8.602-.955c2.642-.851 3.022 1.266 3.894 2.393c.635.822 1.476.824 1.864-.422c.256-.823.66-5.13-2.057-7.568");
}

.xhdw7-jpm {
  d: path("M14.39 9.586c1.775 6.245-.912 9.942-1.891 11.599c-4.252 7.193-3.386 9.404-3.42 11.192c-.04 2.114.322 2.947-2.47 5.399c.753 3.156 1.64 3.918 4.88 4.72c.75-1.192 1.5-2.436 2.266-3.084c1.384.047 3.45.253 4.37-.135");
}
