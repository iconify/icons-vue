...
const content = `<path class="nqmltzi4g"/><path class="oxgnracmr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-scss2" /></template>
<style>
.nqmltzi4g {
