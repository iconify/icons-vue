...
const content = `<path class="ucdp2rx1h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:database-arrow-down-20-regular" /></template>
<style>
.ucdp2rx1h {
  fill: currentColor;
