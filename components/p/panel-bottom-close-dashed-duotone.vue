...
const content = `<g class="nrj6p8qat"><path class="rar6yubnd"/><path class="c-yqibcyj"/><path class="r9m5pabcn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:panel-bottom-close-dashed-duotone" /></template>
<style>
.c-yqibcyj {
