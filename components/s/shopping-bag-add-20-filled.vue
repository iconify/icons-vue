...
const content = `<path class="n3se8mr-b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shopping-bag-add-20-filled" /></template>
<style>
.n3se8mr-b {
  fill: currentColor;
