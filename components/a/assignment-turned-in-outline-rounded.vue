...
const content = `<path class="pb7wplfbn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:assignment-turned-in-outline-rounded" /></template>
<style>
.pb7wplfbn {
  fill: currentColor;
