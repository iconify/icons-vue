...
const content = `<g class="nrj6p8qat"><path class="u52ozydly"/><path class="dduj_nfvr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:smartphone-arrow-down-left-two-tone" /></template>
<style>
.dduj_nfvr {
