...
const content = `<path class="uwux-kbcx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:switch-camera-outline-rounded" /></template>
<style>
.uwux-kbcx {
  fill: currentColor;
