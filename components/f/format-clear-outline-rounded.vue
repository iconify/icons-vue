...
const content = `<path class="unq4tnbgk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-clear-outline-rounded" /></template>
<style>
.unq4tnbgk {
  fill: currentColor;
