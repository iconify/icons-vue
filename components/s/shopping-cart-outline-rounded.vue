...
const content = `<path class="ejm9xbxyx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shopping-cart-outline-rounded" /></template>
<style>
.ejm9xbxyx {
  fill: currentColor;
