...
const content = `<path class="gvo9gn06l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pedometer-step-counter" /></template>
<style>
.gvo9gn06l {
  fill: none;
  stroke: currentColor;
