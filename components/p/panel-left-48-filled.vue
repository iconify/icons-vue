...
const content = `<path class="n04owm73p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-48-filled" /></template>
<style>
.n04owm73p {
  fill: currentColor;
