...
const content = `<path class="c3-p3t41n"/><rect class="rfs_dlb8c"/><rect class="fr3dbjb-p"/><rect class="saq4wfptx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:d-r" /></template>
<style>
.c3-p3t41n {
  fill: none;
  stroke: currentColor;
