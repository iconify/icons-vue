...
const content = `<path class="c916zdbrr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:copy-all-outline" /></template>
<style>
.c916zdbrr {
  fill: currentColor;
