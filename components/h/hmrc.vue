...
const content = `<path class="peb5y7w_w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hmrc" /></template>
<style>
.peb5y7w_w {
  fill: none;
  stroke: currentColor;
