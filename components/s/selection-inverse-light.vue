...
const content = `<path class="urlm46wrb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:selection-inverse-light" /></template>
<style>
.urlm46wrb {
  fill: currentColor;
