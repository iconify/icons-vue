...
const content = `<path class="nvpi1_bdz"/><path class="ghi1abb9e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:keepro-unlocker" /></template>
<style>
.ghi1abb9e {
  fill: none;
  stroke: currentColor;
