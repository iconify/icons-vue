...
const content = `<g class="y9tr6bcfx"><ellipse class="gcl71gbcz"/><path class="nvfd3dbat"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:galaxus" /></template>
<style>
.gcl71gbcz {
  cx: 24.021px;
  cy: 26px;
