...
const content = `<path class="gjl-7e7xd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sentiment-extremely-dissatisfied-outline-rounded" /></template>
<style>
.gjl-7e7xd {
  fill: currentColor;
