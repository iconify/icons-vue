...
const content = `<path class="lbwi0kb5j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:farsight-digital-rounded" /></template>
<style>
.lbwi0kb5j {
  fill: currentColor;
