...
const content = `<path class="g1l8s3zwd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:circle-hint-half-vertical-20-filled" /></template>
<style>
.g1l8s3zwd {
  fill: currentColor;
