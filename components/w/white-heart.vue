...
const content = `<path class="rrik0eb3p"/><path class="kscie4buc"/><path class="hg1vm_bjm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:white-heart" /></template>
<style>
.hg1vm_bjm {
