...
const content = `<path class="b6eit0v-v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-in-left-28-regular" /></template>
<style>
.b6eit0v-v {
  fill: currentColor;
