...
const content = `<g class="ft5dv1b6b"><path class="tqey_p2zw"/><path class="jkv-hbb7m"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:upbit" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
