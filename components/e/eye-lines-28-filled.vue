...
const content = `<path class="t7d4cnb1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:eye-lines-28-filled" /></template>
<style>
.t7d4cnb1j {
  fill: currentColor;
