...
const content = `<path class="ai2at0-_r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hov-rounded" /></template>
<style>
.ai2at0-_r {
  fill: currentColor;
