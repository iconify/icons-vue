...
const content = `<path class="ialrik-em"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:boy-rounded" /></template>
<style>
.ialrik-em {
  fill: currentColor;
