...
const content = `<path class="svu91nwyx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-all-24-regular" /></template>
<style>
.svu91nwyx {
  fill: currentColor;
