...
const content = `<path class="bixxtzbdb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:network-wifi-3-bar-outline-sharp" /></template>
<style>
.bixxtzbdb {
  fill: currentColor;
