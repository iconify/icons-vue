...
const content = `<path class="zgfyubcqw"/><circle class="rt_37l3dj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:five-oclock" /></template>
<style>
.rt_37l3dj {
  cx: 32px;
  cy: 32px;
