...
const content = `<path class="r577keb3m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dpi-tunnel" /></template>
<style>
.r577keb3m {
  fill: none;
  stroke: currentColor;
