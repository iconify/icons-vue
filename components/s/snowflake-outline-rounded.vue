...
const content = `<path class="qbh-x7byi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:snowflake-outline-rounded" /></template>
<style>
.qbh-x7byi {
  fill: currentColor;
