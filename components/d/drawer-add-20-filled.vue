...
const content = `<path class="lzk0411er"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drawer-add-20-filled" /></template>
<style>
.lzk0411er {
  fill: currentColor;
