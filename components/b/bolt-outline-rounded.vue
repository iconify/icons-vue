...
const content = `<path class="vqtvovbok"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bolt-outline-rounded" /></template>
<style>
.vqtvovbok {
  fill: currentColor;
