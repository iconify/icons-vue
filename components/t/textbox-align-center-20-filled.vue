...
const content = `<path class="q5oyw5bwq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-center-20-filled" /></template>
<style>
.q5oyw5bwq {
  fill: currentColor;
