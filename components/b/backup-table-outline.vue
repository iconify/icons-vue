...
const content = `<path class="t8h3wxb_h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:backup-table-outline" /></template>
<style>
.t8h3wxb_h {
  fill: currentColor;
