...
const content = `<path class="lco8f9_hn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:eraser-size-3-outline-rounded" /></template>
<style>
.lco8f9_hn {
  fill: currentColor;
