...
const content = `<path class="idnho312f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:missing-metadata-24-regular" /></template>
<style>
.idnho312f {
