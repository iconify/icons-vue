...
const content = `<path class="lrtm9pb0j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-flowchart-24-filled" /></template>
<style>
.lrtm9pb0j {
  fill: currentColor;
