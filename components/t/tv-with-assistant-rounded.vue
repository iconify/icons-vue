...
const content = `<path class="c1tpgjfwa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tv-with-assistant-rounded" /></template>
<style>
.c1tpgjfwa {
  fill: currentColor;
