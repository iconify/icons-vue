...
const content = `<path clip-rule="evenodd" class="oxix7to-m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:plume" /></template>
<style>
.oxix7to-m {
