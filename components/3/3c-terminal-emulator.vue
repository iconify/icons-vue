...
const content = `<path class="q54nnjmpx"/><path class="menzrtb4e"/><rect class="vuvrh43zi"/><path class="ujbypzbwr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:3c-terminal-emulator" /></template>
<style>
.menzrtb4e {
  fill: none;
  stroke: currentColor;
