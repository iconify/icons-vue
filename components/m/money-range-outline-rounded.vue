...
const content = `<path class="uui4ji_wz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:money-range-outline-rounded" /></template>
<style>
.uui4ji_wz {
  fill: currentColor;
