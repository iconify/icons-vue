...
const content = `<path class="jbmh2sb7c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-person-remove-alt-1" /></template>
<style>
.jbmh2sb7c {
  fill: currentColor;
