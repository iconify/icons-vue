...
const content = `<path class="p7hkd70wa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-double-arrow-left-outline-rounded" /></template>
<style>
.p7hkd70wa {
  fill: currentColor;
