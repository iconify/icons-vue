...
const content = `<path class="p2y_ahg-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:dots-three-outline-vertical-light" /></template>
<style>
.p2y_ahg-y {
  fill: currentColor;
