...
const content = `<path class="wp5uv2bmf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:church-outline-rounded" /></template>
<style>
.wp5uv2bmf {
  fill: currentColor;
