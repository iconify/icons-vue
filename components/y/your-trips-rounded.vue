...
const content = `<path class="r3-v63bgy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:your-trips-rounded" /></template>
<style>
.r3-v63bgy {
  fill: currentColor;
