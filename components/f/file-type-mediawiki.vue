...
const content = `<defs><linearGradient id="SVGZykBubml" x2="1" gradientTransform="matrix(25 -25 25 25 0 25)" gradientUnits="userSpaceOnUse"><stop offset="0" class="uf-sk8bni"/><stop offset=".5" class="hp_ij2ozl"/><stop offset="1" class="mj_y3gbmd"/></linearGradient><linearGradient id="SVGMkoYUcVU" x2="1" gradientTransform="matrix(25 -25 25 25 0 25)" gradientUnits="userSpaceOnUse" href="#SVGZykBubml"/></defs><g fill="url(#SVGMkoYUcVU)" clip-rule="evenodd" transform="translate(2.03 2.026)scale(1.1248)" class="gxg1dgbun"><path class="ai9j143im"/><path class="j2vetsanp"/><path class="uqyx7vq7b"/><path class="hv0135bpo"/><path class="o_3753-xw"/><path class="p104s2gvf"/><path class="ltkau_b8w"/><path class="g0lh7mblu"/><path class="lqlu3xbgl"/><path class="m2nd9pxcq"/><path class="vtci8nbyk"/><path class="lloc2f33n"/><path class="fk9x24exj"/><path class="yo7gakbsj"/><path class="btb5pxtvx"/><path class="szq2mhb-u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-mediawiki" /></template>
<style>
.ai9j143im {
