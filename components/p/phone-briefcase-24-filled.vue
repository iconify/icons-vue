...
const content = `<path class="w-zwhib0g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-briefcase-24-filled" /></template>
<style>
.w-zwhib0g {
  fill: currentColor;
