...
const content = `<path class="czgnhkb8g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-text-edit-28-regular" /></template>
<style>
.czgnhkb8g {
  fill: currentColor;
