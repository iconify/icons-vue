...
const content = `<path class="wian0q88q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:auto-transmission-rounded" /></template>
<style>
.wian0q88q {
  fill: currentColor;
