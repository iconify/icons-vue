...
const content = `<path class="yb3ol25ze"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:file-save" /></template>
<style>
.yb3ol25ze {
  fill: currentColor;
