...
const content = `<path class="doe_7s0-s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:select-outline-sharp" /></template>
<style>
.doe_7s0-s {
  fill: currentColor;
