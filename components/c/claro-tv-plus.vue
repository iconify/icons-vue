...
const content = `<path class="uo47pyvli"/><path class="cfz_hm0mz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:claro-tv-plus" /></template>
<style>
.cfz_hm0mz {
  fill: none;
  stroke: currentColor;
