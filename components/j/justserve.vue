...
const content = `<path class="psnro2qoc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:justserve" /></template>
<style>
.psnro2qoc {
  fill: none;
  stroke: currentColor;
