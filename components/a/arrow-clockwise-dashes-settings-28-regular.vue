...
const content = `<path class="psoxx5cbf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-clockwise-dashes-settings-28-regular" /></template>
<style>
.psoxx5cbf {
  fill: currentColor;
