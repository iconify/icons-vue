...
const content = `<path class="wi036ub4o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fiber-manual-record-outline-rounded" /></template>
<style>
.wi036ub4o {
  fill: currentColor;
