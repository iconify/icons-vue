...
const content = `<path class="cm5dxkbnb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-quote-24-filled" /></template>
<style>
.cm5dxkbnb {
  fill: currentColor;
