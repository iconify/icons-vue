...
const content = `<path class="hc04okdvm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-sparkle-20-filled" /></template>
<style>
.hc04okdvm {
  fill: currentColor;
