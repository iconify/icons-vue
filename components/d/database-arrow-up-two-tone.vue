...
const content = `<g class="nrj6p8qat"><path class="vhck9ybet"/><path class="e6fenacnm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-up-two-tone" /></template>
<style>
.e6fenacnm {
