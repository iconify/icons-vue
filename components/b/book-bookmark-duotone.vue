...
const content = `<g class="cuyn6tgcc"><path class="hcah5ibnw"/><path class="ajfku5bny"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:book-bookmark-duotone" /></template>
<style>
.ajfku5bny {
...
.hcah5ibnw {
  d: path("M208 32v160H72a24 24 0 0 0-24 24V56a24 24 0 0 1 24-24h40v96l32-24l32 24V32Z");
