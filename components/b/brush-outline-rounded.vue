...
const content = `<path class="omcfeqiag"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brush-outline-rounded" /></template>
<style>
.omcfeqiag {
  fill: currentColor;
