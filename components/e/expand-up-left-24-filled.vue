...
const content = `<path class="tat922z8p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:expand-up-left-24-filled" /></template>
<style>
.tat922z8p {
  fill: currentColor;
