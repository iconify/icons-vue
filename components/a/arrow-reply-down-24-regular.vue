...
const content = `<path class="dt3tmwb3w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-reply-down-24-regular" /></template>
<style>
.dt3tmwb3w {
  fill: currentColor;
