...
const content = `<path class="w0pcjac5w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-sync-16-regular" /></template>
<style>
.w0pcjac5w {
  fill: currentColor;
