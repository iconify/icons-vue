...
const content = `<path class="bygo07bmb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:error-med-rounded" /></template>
<style>
.bygo07bmb {
  fill: currentColor;
