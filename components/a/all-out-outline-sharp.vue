...
const content = `<path class="k39--cbob"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:all-out-outline-sharp" /></template>
<style>
.k39--cbob {
  fill: currentColor;
