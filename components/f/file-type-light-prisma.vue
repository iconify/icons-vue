...
const content = `<path class="svob0ny1k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-light-prisma" /></template>
<style>
.svob0ny1k {
