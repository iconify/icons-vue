...
const content = `<path class="sm1us0bnc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:coronavirus-sharp" /></template>
<style>
.sm1us0bnc {
  fill: currentColor;
