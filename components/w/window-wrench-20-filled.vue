...
const content = `<path class="pu8q2pb_z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-wrench-20-filled" /></template>
<style>
.pu8q2pb_z {
  fill: currentColor;
