...
const content = `<path class="ifw1v6gwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-screen-20-filled" /></template>
<style>
.ifw1v6gwk {
  fill: currentColor;
