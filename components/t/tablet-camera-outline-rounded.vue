...
const content = `<path class="d036vu6kp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tablet-camera-outline-rounded" /></template>
<style>
.d036vu6kp {
  fill: currentColor;
