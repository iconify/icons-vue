...
const content = `<path class="no-ujm05k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-profile-outline-rounded" /></template>
<style>
.no-ujm05k {
  fill: currentColor;
