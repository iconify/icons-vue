...
const content = `<path class="g2wn9eb6w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-list-20-regular" /></template>
<style>
.g2wn9eb6w {
  fill: currentColor;
