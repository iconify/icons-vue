...
const content = `<path class="ujg3d-b3c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:hand-pointer-left" /></template>
<style>
.ujg3d-b3c {
  fill: none;
  stroke: currentColor;
