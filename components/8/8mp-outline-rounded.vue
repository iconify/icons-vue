...
const content = `<path class="vw1n08bbh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:8mp-outline-rounded" /></template>
<style>
.vw1n08bbh {
  fill: currentColor;
