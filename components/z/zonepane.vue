...
.klmth61sg {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M38.932 28.467s2.87-.604 4.566-3.436");
}
...
.lmqd6zaae {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M15.699 12.19c2.908-2.816 7.308-3.7 11.165-2.244c3.858 1.456 6.422 4.969 6.506 8.914M22.68 33.762s6.719 1.18 8.736-4.562m1.954-10.34s6.043 3.483 5.516 10.307m-.001 0l.026 4.666");
}
...
.zbhpycfjj {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M38.96 29.936s3.1-.246 4.54-4.905");
}
