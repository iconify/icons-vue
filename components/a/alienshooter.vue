...
const content = `<path class="ul-fwuqih"/><circle class="qi7-7-wtn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:alienshooter" /></template>
<style>
.qi7-7-wtn {
  cx: 24px;
  cy: 28.875px;
