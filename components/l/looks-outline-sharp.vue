...
const content = `<path class="kiu8gtb8p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:looks-outline-sharp" /></template>
<style>
.kiu8gtb8p {
  fill: currentColor;
