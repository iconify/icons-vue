...
const content = `<path class="ksstxds-p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:blinds-outline-sharp" /></template>
<style>
.ksstxds-p {
  fill: currentColor;
