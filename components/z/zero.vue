...
const content = `<path class="hzpqnlmob"/><path class="y1-taprgu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:zero" /></template>
<style>
.hzpqnlmob {
  fill: none;
  stroke: currentColor;
