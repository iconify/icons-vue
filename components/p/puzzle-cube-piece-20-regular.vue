...
const content = `<path class="mb__wibes"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:puzzle-cube-piece-20-regular" /></template>
<style>
.mb__wibes {
  fill: currentColor;
