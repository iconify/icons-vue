...
const content = `<path class="oghx6sg4a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:search-activity-outline-sharp" /></template>
<style>
.oghx6sg4a {
  fill: currentColor;
