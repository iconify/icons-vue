...
const content = `<path class="k4vxd0poy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:volunteer-activism-outline-sharp" /></template>
<style>
.k4vxd0poy {
  fill: currentColor;
