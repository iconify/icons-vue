...
const content = `<path class="i6ibv3bot"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:support-outline-rounded" /></template>
<style>
.i6ibv3bot {
  fill: currentColor;
