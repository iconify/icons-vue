...
const content = `<g class="gp_8x1bzb"><path class="v8hgvi38z"/><path class="x-_5ilohg"/><path class="bocf8ab2v"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-more-vertical-sharp-two-tone" /></template>
<style>
.bocf8ab2v {
  fill: currentColor;
