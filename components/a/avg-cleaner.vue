...
const content = `<g class="y9tr6bcfx"><path class="fwwqiub9n"/><path class="u_c0b4bgx"/><path class="fay9j-b-l"/></g><path class="e1hu97bzd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:avg-cleaner" /></template>
<style>
.e1hu97bzd {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M29.419 26.613a3.097 3.097 0 0 0-3.088-3.074h-.72v-6.873a1.65 1.65 0 0 0-1.27-1.629a1.615 1.615 0 0 0-1.952 1.579v6.923h-.697a3.097 3.097 0 0 0-3.088 3.088l-1.648 5.174a.923.923 0 0 0 .882 1.2h12.324a.923.923 0 0 0 .881-1.2zm-10.838 0h10.838M24 31.196v-4.583m2.838 0l.84 4.583m-6.517-4.583l-.84 4.583");
}
