...
const content = `<path class="gtu4cob9w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:play-disabled-outline-sharp" /></template>
<style>
.gtu4cob9w {
  fill: currentColor;
