...
const content = `<path class="b9v25bcjt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-in-private-16-filled" /></template>
<style>
.b9v25bcjt {
  fill: currentColor;
