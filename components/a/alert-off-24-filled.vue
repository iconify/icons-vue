...
const content = `<path class="v3w_a-bvj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:alert-off-24-filled" /></template>
<style>
.v3w_a-bvj {
  fill: currentColor;
