...
const content = `<path class="yga5ccbvu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:skip-forward-10-24-regular" /></template>
<style>
.yga5ccbvu {
  fill: currentColor;
