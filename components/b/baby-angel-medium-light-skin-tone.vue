...
const content = `<path class="fddt2ibnu"/><circle class="mg1iq59mo"/><path class="y_mre8b8b"/><path class="ym2drbm2a"/><path class="wxadi7kjp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:baby-angel-medium-light-skin-tone" /></template>
<style>
.fddt2ibnu {
