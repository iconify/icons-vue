...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVG3nJVlcUB)" class="q622_hbqb"/><path fill="url(#SVG3nJVlcUB)" clip-rule="evenodd" class="stnnu9bsg"/><defs><linearGradient id="SVG3nJVlcUB" x1="4.694" x2="19.03" y1="17.281" y2="8.863" gradientUnits="userSpaceOnUse"><stop class="b5d5li0go"/><stop offset=".34" class="mv-9cxbpf"/><stop offset=".69" class="a90pzubhc"/><stop offset="1" class="t5p8xpzfr"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:iris" /></template>
<style>
.a90pzubhc {
  stop-color: var(--svg-color--ac4179, #ac4179);
}

.b5d5li0go {
  stop-color: var(--svg-color--1190d4, #1190d4);
}
