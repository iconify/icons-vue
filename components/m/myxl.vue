...
const content = `<path class="jp0xl_big"/><path class="gdqbly48t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:myxl" /></template>
<style>
.gdqbly48t {
  fill: none;
  stroke: currentColor;
