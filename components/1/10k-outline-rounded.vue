...
const content = `<path class="e-nfo0bpy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:10k-outline-rounded" /></template>
<style>
.e-nfo0bpy {
  fill: currentColor;
