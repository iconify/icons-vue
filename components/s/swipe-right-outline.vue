...
const content = `<path class="bi9eiqa4m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-right-outline" /></template>
<style>
.bi9eiqa4m {
  fill: currentColor;
