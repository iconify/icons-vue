...
const content = `<path class="fo4uk9bmg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-sync-circle-28-filled" /></template>
<style>
.fo4uk9bmg {
  fill: currentColor;
