...
const content = `<g class="ft5dv1b6b"><defs><mask id="SVGFh9wUbpR"><path class="k5-vjlrin"/><g clip-rule="evenodd" class="kvn14gsjy"><path class="rk0603btk"/><path class="dhf6_i89b"/></g></mask></defs><circle mask="url(#SVGFh9wUbpR)" class="bd9gczbnq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:money-note-circle-filled" /></template>
<style>
.bd9gczbnq {
  cx: 13px;
  cy: 13px;
...
.rk0603btk {
  d: path("M4 10.802a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v5a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3zm3-1a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-5a1 1 0 0 0-1-1z");
}
