...
const content = `<path class="i77kucv2z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:inventory-outline-sharp" /></template>
<style>
.i77kucv2z {
  fill: currentColor;
