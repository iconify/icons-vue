...
const content = `<path class="gd3annrjy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-multiple-28-filled" /></template>
<style>
.gd3annrjy {
  fill: currentColor;
