...
const content = `<path class="le_jszbcj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:full-screen-minimize-28-regular" /></template>
<style>
.le_jszbcj {
  fill: currentColor;
