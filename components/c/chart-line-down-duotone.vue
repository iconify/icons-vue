...
const content = `<g class="cuyn6tgcc"><path class="onrdkub8r"/><path class="zvodw_wmj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:chart-line-down-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
