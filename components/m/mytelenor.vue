...
const content = `<path class="rda07zbdu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mytelenor" /></template>
<style>
.rda07zbdu {
  fill: none;
  stroke: currentColor;
