...
const content = `<path class="j5p8hzb2e"/><path class="p902t1bln"/><path class="ti19ytvcr"/><path class="kjtw8iufa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-kuwait" /></template>
<style>
.j5p8hzb2e {
