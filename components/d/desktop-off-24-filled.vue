...
const content = `<path class="kaz78ql-a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-off-24-filled" /></template>
<style>
.kaz78ql-a {
  fill: currentColor;
