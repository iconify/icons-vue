...
const content = `<path class="lpbydvb6h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mountain-location-top-28-regular" /></template>
<style>
.lpbydvb6h {
  fill: currentColor;
