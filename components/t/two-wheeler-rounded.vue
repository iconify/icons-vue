...
const content = `<path class="g8odne96r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:two-wheeler-rounded" /></template>
<style>
.g8odne96r {
  fill: currentColor;
