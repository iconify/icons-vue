...
const content = `<path class="iqfroyb6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-group-20-filled" /></template>
<style>
.iqfroyb6u {
  fill: currentColor;
