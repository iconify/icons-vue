...
const content = `<path class="atsz0ab9q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:filter-none-outline" /></template>
<style>
.atsz0ab9q {
  fill: currentColor;
