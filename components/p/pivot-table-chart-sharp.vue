...
const content = `<path class="a0_lr_bac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pivot-table-chart-sharp" /></template>
<style>
.a0_lr_bac {
  fill: currentColor;
