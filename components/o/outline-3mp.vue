...
const content = `<path class="xietzojdi"/><path class="bn6ebpb5p"/><path class="nynysxwbh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-3mp" /></template>
<style>
.bn6ebpb5p {
  fill: currentColor;
