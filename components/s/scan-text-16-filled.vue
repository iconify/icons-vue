...
const content = `<path class="fp60iabtu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-text-16-filled" /></template>
<style>
.fp60iabtu {
  fill: currentColor;
