...
const content = `<path class="vev8k00oi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:box-multiple-arrow-right-24-regular" /></template>
<style>
.vev8k00oi {
  fill: currentColor;
