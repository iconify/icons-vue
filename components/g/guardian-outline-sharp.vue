...
const content = `<path class="k5cevu07a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:guardian-outline-sharp" /></template>
<style>
.k5cevu07a {
  fill: currentColor;
