...
const content = `<path class="kg4ghsblu"/><path class="gl-z5lbbc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:phone-master" /></template>
<style>
.gl-z5lbbc {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M15.579 22.36L22.131 29l10.29-11");
}
