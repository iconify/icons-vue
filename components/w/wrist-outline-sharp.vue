...
const content = `<path class="t9_3-pbus"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wrist-outline-sharp" /></template>
<style>
.t9_3-pbus {
  fill: currentColor;
