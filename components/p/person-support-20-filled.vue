...
const content = `<path class="ots2sfbiu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-support-20-filled" /></template>
<style>
.ots2sfbiu {
  fill: currentColor;
