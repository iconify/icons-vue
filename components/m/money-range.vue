...
const content = `<path class="x4pjlrq0i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:money-range" /></template>
<style>
.x4pjlrq0i {
  fill: currentColor;
