...
const content = `<path class="nw_3rob0f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-square-right-20-filled" /></template>
<style>
.nw_3rob0f {
  fill: currentColor;
