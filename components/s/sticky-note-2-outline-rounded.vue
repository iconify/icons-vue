...
const content = `<path class="sawdjmgbc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sticky-note-2-outline-rounded" /></template>
<style>
.sawdjmgbc {
  fill: currentColor;
