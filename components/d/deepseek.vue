...
const content = `<path class="ja_v0tbpc"/><path class="qss0m2blr"/><path class="agslqrber"/><circle class="gmwyf3bwy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:deepseek" /></template>
<style>
.agslqrber {
  fill: none;
  stroke: currentColor;
...
.ja_v0tbpc {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M31.97 33.128c5.146-5.785 5.618-11.022 5.797-13.649");
}
