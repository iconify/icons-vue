...
const content = `<path class="rmhtwjb0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-add-20-regular" /></template>
<style>
.rmhtwjb0q {
  fill: currentColor;
