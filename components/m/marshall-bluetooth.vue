...
const content = `<path class="rz4kbeb3g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:marshall-bluetooth" /></template>
<style>
.rz4kbeb3g {
  fill: none;
  stroke: currentColor;
