...
const content = `<path class="sz1qhj86e"/><path class="g73j72xjx"/><path class="x0curnbap"/><path class="lm2c37biv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-light-electron" /></template>
<style>
.g73j72xjx {
...
.sz1qhj86e {
  fill: var(--svg-color--7cbbbf, #7cbbbf);
