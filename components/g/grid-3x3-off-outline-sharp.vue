...
const content = `<path class="utiua4gtz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:grid-3x3-off-outline-sharp" /></template>
<style>
.utiua4gtz {
  fill: currentColor;
