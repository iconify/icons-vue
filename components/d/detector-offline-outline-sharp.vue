...
const content = `<path class="ni7_uxbgn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:detector-offline-outline-sharp" /></template>
<style>
.ni7_uxbgn {
  fill: currentColor;
