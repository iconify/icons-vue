...
const content = `<path class="j_b5x1b4s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-7-24-filled" /></template>
<style>
.j_b5x1b4s {
  fill: currentColor;
