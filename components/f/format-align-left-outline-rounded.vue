...
const content = `<path class="r89wg4bwr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-align-left-outline-rounded" /></template>
<style>
.r89wg4bwr {
  fill: currentColor;
