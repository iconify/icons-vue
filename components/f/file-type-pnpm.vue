...
const content = `<path class="nfkr24opq"/><path class="csa09yr6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-pnpm" /></template>
<style>
.csa09yr6u {
