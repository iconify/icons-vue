...
const content = `<path class="d35gxvbjc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:device-mobile-slash-bold" /></template>
<style>
.d35gxvbjc {
  fill: currentColor;
