...
const content = `<path class="t2_4dzftz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-arrow-down-sharp" /></template>
<style>
.t2_4dzftz {
  fill: currentColor;
