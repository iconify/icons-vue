...
const content = `<path class="v0slkcjvh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-feedback-28-regular" /></template>
<style>
.v0slkcjvh {
  fill: currentColor;
