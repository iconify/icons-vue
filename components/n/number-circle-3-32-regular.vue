...
const content = `<path class="dbqupxb1o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-3-32-regular" /></template>
<style>
.dbqupxb1o {
  fill: currentColor;
