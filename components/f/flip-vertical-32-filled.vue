...
const content = `<path class="ex7xyimfd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flip-vertical-32-filled" /></template>
<style>
.ex7xyimfd {
  fill: currentColor;
