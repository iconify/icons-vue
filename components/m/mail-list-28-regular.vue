...
const content = `<path class="f8egy6b5z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-list-28-regular" /></template>
<style>
.f8egy6b5z {
  fill: currentColor;
