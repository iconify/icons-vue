...
const content = `<g class="cuyn6tgcc"><path class="badrgxb8u"/><path class="kojscsd4t"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:headlights-duotone" /></template>
<style>
.badrgxb8u {
  d: path("M136 64v128a8 8 0 0 1-8 8H88a72 72 0 0 1-72-72.55C16.3 87.75 49.2 56 88.9 56H128a8 8 0 0 1 8 8");
