...
const content = `<path class="fnpgnv8tz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-radar-outline" /></template>
<style>
.fnpgnv8tz {
  fill: currentColor;
