...
const content = `<path class="z3ol75bep"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:lightbulb-filament-light" /></template>
<style>
.z3ol75bep {
  fill: currentColor;
