...
const content = `<path class="grnkhac3h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:codex" /></template>
<style>
.grnkhac3h {
  fill: var(--svg-color--f8e6b6, #f8e6b6);
