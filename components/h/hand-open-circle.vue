...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="qfubw1b_f"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:hand-open-circle" /></template>
<style>
.hdxpysbbn {
