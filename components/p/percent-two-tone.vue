...
const content = `<path class="f6s2r5bvy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:percent-two-tone" /></template>
<style>
.f6s2r5bvy {
  fill: none;
  stroke: currentColor;
