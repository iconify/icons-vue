...
const content = `<path class="n5h94bcxu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-data-link-24-filled" /></template>
<style>
.n5h94bcxu {
  fill: currentColor;
