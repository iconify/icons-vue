...
const content = `<path class="bpjd2usno"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-top-right-rounded" /></template>
<style>
.bpjd2usno {
  fill: currentColor;
