...
const content = `<path class="a-6kapysl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:timer-10-alt-1-outline" /></template>
<style>
.a-6kapysl {
  fill: currentColor;
