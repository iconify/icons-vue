...
const content = `<path class="vkoi4cbef"/><path class="g7lq41kaw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:hand-with-index-finger-and-thumb-crossed-medium-skin-tone" /></template>
<style>
.g7lq41kaw {
