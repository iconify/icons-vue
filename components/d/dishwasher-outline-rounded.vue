...
const content = `<path class="bhu0e28hr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dishwasher-outline-rounded" /></template>
<style>
.bhu0e28hr {
  fill: currentColor;
