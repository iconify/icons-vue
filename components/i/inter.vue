...
const content = `<path class="i9clfwm2k"/><path class="oe1fbhbdw"/><circle class="nc7-apm1q"/><path class="o_ospcb8j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:inter" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
