...
const content = `<path class="qy9-7pbeq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:score-sharp" /></template>
<style>
.qy9-7pbeq {
  fill: currentColor;
