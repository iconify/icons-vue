...
const content = `<path class="etkvrwe0a"/><path class="l6jl57bjj"/><path class="qy3jhkhuq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:yanosik" /></template>
<style>
.etkvrwe0a {
  fill: none;
  stroke: currentColor;
