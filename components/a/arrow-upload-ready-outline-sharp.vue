...
const content = `<path class="qs6a29bgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-upload-ready-outline-sharp" /></template>
<style>
.qs6a29bgh {
  fill: currentColor;
