...
const content = `<path class="rg6ievb4u"/><circle class="ouwef9b_x"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lime" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
