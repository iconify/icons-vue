...
const content = `<path class="piv2s-bct"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-dismiss-28-regular" /></template>
<style>
.piv2s-bct {
  fill: currentColor;
