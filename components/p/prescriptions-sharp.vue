...
const content = `<path class="e9r_fwb7k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:prescriptions-sharp" /></template>
<style>
.e9r_fwb7k {
  fill: currentColor;
