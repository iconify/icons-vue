...
const content = `<path class="ucy1exbel"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:airlines-outline-sharp" /></template>
<style>
.ucy1exbel {
  fill: currentColor;
