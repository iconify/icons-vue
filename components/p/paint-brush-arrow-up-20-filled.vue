...
const content = `<path class="iw7-ykbaa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:paint-brush-arrow-up-20-filled" /></template>
<style>
.iw7-ykbaa {
  fill: currentColor;
