...
const content = `<path class="d60atqb_s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:plug-connected-48-regular" /></template>
<style>
.d60atqb_s {
  fill: currentColor;
