...
const content = `<path class="th_4_mbmw"/><path class="jwhyydb2h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wonderous" /></template>
<style>
.jwhyydb2h {
  fill: none;
  stroke: currentColor;
