...
const content = `<path class="t1le0nbvz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wetransfer" /></template>
<style>
.t1le0nbvz {
  fill: none;
  stroke: currentColor;
