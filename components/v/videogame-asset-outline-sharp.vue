...
const content = `<path class="bzj_3bb9c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:videogame-asset-outline-sharp" /></template>
<style>
.bzj_3bb9c {
  fill: currentColor;
