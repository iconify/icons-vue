...
const content = `<path class="i4y70wd6o"/><path class="r6r07nbyh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tu-dortmund" /></template>
<style>
.i4y70wd6o {
  fill: none;
  stroke: currentColor;
