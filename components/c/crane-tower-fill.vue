...
const content = `<g class="cuyn6tgcc"><path class="p5gyxkh6h"/><path class="mt8ge3bgm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:crane-tower-fill" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
