...
const content = `<path class="kklkypbbg"/><path class="p4wl0qb7t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:earth-hero" /></template>
<style>
.kklkypbbg {
  fill: none;
  stroke: currentColor;
