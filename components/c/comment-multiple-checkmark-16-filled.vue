...
const content = `<path class="x-pedvmbz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-multiple-checkmark-16-filled" /></template>
<style>
.x-pedvmbz {
  fill: currentColor;
