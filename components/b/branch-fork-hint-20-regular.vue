...
const content = `<path class="m721qtbwb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:branch-fork-hint-20-regular" /></template>
<style>
.m721qtbwb {
  fill: currentColor;
