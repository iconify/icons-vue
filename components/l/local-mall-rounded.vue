...
const content = `<path class="b-l31vt8q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-mall-rounded" /></template>
<style>
.b-l31vt8q {
  fill: currentColor;
