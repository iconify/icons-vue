...
const content = `<g class="nrj6p8qat"><path class="n1lcj6hsg"/><path class="q-qndji8q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:server-minus" /></template>
<style>
.n1lcj6hsg {
