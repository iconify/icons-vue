...
const content = `<path class="h5cfjnd6l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:link-multiple-16-filled" /></template>
<style>
.h5cfjnd6l {
  fill: currentColor;
