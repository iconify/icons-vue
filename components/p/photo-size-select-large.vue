...
const content = `<path class="xw_bbyb9f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:photo-size-select-large" /></template>
<style>
.xw_bbyb9f {
  fill: currentColor;
