...
const content = `<path class="d3v-exmqm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:art-track" /></template>
<style>
.d3v-exmqm {
  fill: currentColor;
