...
const content = `<path class="pl3v1dyug"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:moon-stars-outline-rounded" /></template>
<style>
.pl3v1dyug {
  fill: currentColor;
