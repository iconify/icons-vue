...
const content = `<g class="cuyn6tgcc"><path class="i5-ihib6b"/><path class="q6sybcblb"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:volleyball-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.i5-ihib6b {
  d: path("M216.25 165.8A96 96 0 0 1 80 211.15a95.75 95.75 0 0 1-28.86-25.58A96 96 0 0 1 105.47 89L80 44.86a95.55 95.55 0 0 1 36.58-12.2A96 96 0 0 1 173.06 128H128l-22.53 39a96 96 0 0 0 110.78-1.22Z");
