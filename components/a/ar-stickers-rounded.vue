...
const content = `<path class="j47gjbcnw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ar-stickers-rounded" /></template>
<style>
.j47gjbcnw {
  fill: currentColor;
