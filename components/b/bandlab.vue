...
const content = `<path class="h7dktxbit"/><path class="a3ihcnboj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bandlab" /></template>
<style>
.a3ihcnboj {
  fill: none;
  stroke: currentColor;
