...
const content = `<path class="a05suubjb"/><path class="kzykk8swa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-samsung-15" /></template>
<style>
.a05suubjb {
  fill: none;
  stroke: currentColor;
