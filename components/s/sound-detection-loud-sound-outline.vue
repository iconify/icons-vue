...
const content = `<path class="bghy7dq4m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sound-detection-loud-sound-outline" /></template>
<style>
.bghy7dq4m {
  fill: currentColor;
