...
const content = `<path class="p8_7f6xpn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-add-48-regular" /></template>
<style>
.p8_7f6xpn {
  fill: currentColor;
