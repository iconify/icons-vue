...
const content = `<path class="z6ixydb8g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bookmark-add-24-regular" /></template>
<style>
.z6ixydb8g {
  fill: currentColor;
