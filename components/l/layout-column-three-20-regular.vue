...
const content = `<path class="elq6n2b2a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-column-three-20-regular" /></template>
<style>
.elq6n2b2a {
  fill: currentColor;
