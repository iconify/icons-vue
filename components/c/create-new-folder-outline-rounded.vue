...
const content = `<path class="a48xzw0so"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:create-new-folder-outline-rounded" /></template>
<style>
.a48xzw0so {
  fill: currentColor;
