...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:signal-wifi-statusbar-not-connected-rounded" /></template>
<style>
.qq_iswbjy {
  fill: currentColor;
