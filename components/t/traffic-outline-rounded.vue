...
const content = `<path class="jtleubbvi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:traffic-outline-rounded" /></template>
<style>
.jtleubbvi {
  fill: currentColor;
