...
const content = `<path class="nl43cbbbw"/><path class="odw1ocavo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-sports-mma" /></template>
<style>
.nl43cbbbw {
  fill: currentColor;
