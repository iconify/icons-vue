...
const content = `<path class="s_7miebrz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:laptop-settings-32-regular" /></template>
<style>
.s_7miebrz {
  fill: currentColor;
