...
const content = `<path class="k1pri3bpf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:top-panel-close" /></template>
<style>
.k1pri3bpf {
  fill: currentColor;
