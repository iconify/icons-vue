...
const content = `<path class="d6tgh5bdz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tv-remote-rounded" /></template>
<style>
.d6tgh5bdz {
  fill: currentColor;
