...
const content = `<path class="wpwi49q3k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pinch-zoom-in-rounded" /></template>
<style>
.wpwi49q3k {
  fill: currentColor;
