...
const content = `<path class="f44t_fbcq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:syringe-rounded" /></template>
<style>
.f44t_fbcq {
  fill: currentColor;
