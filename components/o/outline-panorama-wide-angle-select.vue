...
const content = `<path class="sxxst1_ei"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-panorama-wide-angle-select" /></template>
<style>
.sxxst1_ei {
  fill: currentColor;
