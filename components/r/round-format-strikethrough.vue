...
const content = `<path class="awi0mc8rq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-format-strikethrough" /></template>
<style>
.awi0mc8rq {
  fill: currentColor;
