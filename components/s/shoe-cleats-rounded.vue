...
const content = `<path class="oc75fsbaj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shoe-cleats-rounded" /></template>
<style>
.oc75fsbaj {
  fill: currentColor;
