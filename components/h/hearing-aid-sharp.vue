...
const content = `<path class="es2fi2byx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hearing-aid-sharp" /></template>
<style>
.es2fi2byx {
  fill: currentColor;
