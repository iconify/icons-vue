...
const content = `<g class="cuyn6tgcc"><path class="vnfml9bxi"/><path class="lhtsn8bre"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:balloon-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
