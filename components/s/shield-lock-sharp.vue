...
const content = `<path class="js_exvbjs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-lock-sharp" /></template>
<style>
.js_exvbjs {
  fill: currentColor;
