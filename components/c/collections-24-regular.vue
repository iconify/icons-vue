...
const content = `<path class="db58hh67h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:collections-24-regular" /></template>
<style>
.db58hh67h {
  fill: currentColor;
