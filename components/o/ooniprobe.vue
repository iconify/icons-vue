...
const content = `<circle class="gym2sbcjd"/><path class="xqkcr7bwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ooniprobe" /></template>
<style>
.gym2sbcjd {
  cx: 22.22px;
  cy: 13.94px;
