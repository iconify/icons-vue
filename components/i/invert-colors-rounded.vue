...
const content = `<path class="pg__49q5l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:invert-colors-rounded" /></template>
<style>
.pg__49q5l {
  fill: currentColor;
