...
const content = `<path class="f64htsnuu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-eject-20-regular" /></template>
<style>
.f64htsnuu {
  fill: currentColor;
