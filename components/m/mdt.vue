...
const content = `<g class="ft5dv1b6b"><path class="phcrfrbto"/><path class="kg9dxtgsm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:mdt" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
