...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="r6jle6v5g"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:film-frame-circle" /></template>
<style>
.hdxpysbbn {
