...
const content = `<path class="v8d400w_d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-clip-28-filled" /></template>
<style>
.v8d400w_d {
  fill: currentColor;
