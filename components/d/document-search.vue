...
const content = `<path class="clpzft_hj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:document-search" /></template>
<style>
.clpzft_hj {
  fill: currentColor;
