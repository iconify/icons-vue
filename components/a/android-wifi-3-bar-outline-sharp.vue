...
const content = `<path class="pkttsew8w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:android-wifi-3-bar-outline-sharp" /></template>
<style>
.pkttsew8w {
  fill: currentColor;
