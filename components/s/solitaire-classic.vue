...
const content = `<path class="up9zlouqg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:solitaire-classic" /></template>
<style>
.up9zlouqg {
  fill: none;
  stroke: currentColor;
