...
const content = `<path class="tdl0plbts"/><circle class="w89crsb8a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mixplorer-theme-creator" /></template>
<style>
.tdl0plbts {
  fill: none;
  stroke: currentColor;
