...
const content = `<path class="r-9db9bgp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-lock-20-regular" /></template>
<style>
.r-9db9bgp {
  fill: currentColor;
