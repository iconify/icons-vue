...
const content = `<path class="dz7gj3b0w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:router-off-outline-sharp" /></template>
<style>
.dz7gj3b0w {
  fill: currentColor;
