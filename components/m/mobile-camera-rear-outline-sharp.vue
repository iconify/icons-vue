...
const content = `<path class="sf335qbes"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobile-camera-rear-outline-sharp" /></template>
<style>
.sf335qbes {
  fill: currentColor;
