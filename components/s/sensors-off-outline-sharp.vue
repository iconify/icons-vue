...
const content = `<path class="e5bwfibqf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sensors-off-outline-sharp" /></template>
<style>
.e5bwfibqf {
  fill: currentColor;
