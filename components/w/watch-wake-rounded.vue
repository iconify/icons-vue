...
const content = `<path class="a169_sbsp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:watch-wake-rounded" /></template>
<style>
.a169_sbsp {
  fill: currentColor;
