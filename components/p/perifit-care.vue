...
const content = `<path class="s_ioeflid"/><path class="ojsv7kqtb"/><path class="s6lnpjbee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:perifit-care" /></template>
<style>
.ojsv7kqtb {
  fill: none;
  stroke: currentColor;
