...
const content = `<path class="ijxxf_b0c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:atr-outline-rounded" /></template>
<style>
.ijxxf_b0c {
  fill: currentColor;
