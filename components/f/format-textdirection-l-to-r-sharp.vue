...
const content = `<path class="zjtpudb2n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-textdirection-l-to-r-sharp" /></template>
<style>
.zjtpudb2n {
  fill: currentColor;
