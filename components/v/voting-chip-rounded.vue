...
const content = `<path class="im1cnebms"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:voting-chip-rounded" /></template>
<style>
.im1cnebms {
  fill: currentColor;
