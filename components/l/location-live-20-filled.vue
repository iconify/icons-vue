...
const content = `<path class="l2_-bf_6v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-live-20-filled" /></template>
<style>
.l2_-bf_6v {
  fill: currentColor;
