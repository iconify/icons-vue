...
const content = `<path class="i9clfwm2k"/><path class="ymvm342mt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sella" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
