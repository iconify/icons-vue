...
const content = `<path class="t8-28kb_w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tag-dismiss-24-filled" /></template>
<style>
.t8-28kb_w {
  fill: currentColor;
