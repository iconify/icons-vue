...
const content = `<path class="ofc4y3b4k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:playlist-add-check-circle-rounded" /></template>
<style>
.ofc4y3b4k {
  fill: currentColor;
