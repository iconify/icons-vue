...
const content = `<path class="aij361b7b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:freetrade" /></template>
<style>
.aij361b7b {
  fill: none;
  stroke: currentColor;
