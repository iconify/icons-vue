...
const content = `<path class="ptdbvga6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sync-problem-outline-rounded" /></template>
<style>
.ptdbvga6a {
  fill: currentColor;
