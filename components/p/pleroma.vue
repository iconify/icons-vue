...
const content = `<path class="dxpvd1e4z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pleroma" /></template>
<style>
.dxpvd1e4z {
  fill: none;
  stroke: currentColor;
