...
const content = `<path class="szsilbn3t"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mj-pdf-reader" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
