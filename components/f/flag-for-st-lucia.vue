...
const content = `<path class="uf7mznlxm"/><path class="sntdvzbzj"/><path class="wc8rhpb_r"/><path class="la-ngjb8p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-st-lucia" /></template>
<style>
.la-ngjb8p {
