...
const content = `<path class="wcb9awb9l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sentiment-neutral-sharp" /></template>
<style>
.wcb9awb9l {
  fill: currentColor;
