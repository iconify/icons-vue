...
const content = `<path class="xj4b2gb7k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:podiatry-outline-rounded" /></template>
<style>
.xj4b2gb7k {
  fill: currentColor;
