...
const content = `<path class="h_q9ossjz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:resize-small-24-filled" /></template>
<style>
.h_q9ossjz {
  fill: currentColor;
