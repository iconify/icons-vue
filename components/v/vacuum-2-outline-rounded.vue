...
const content = `<path class="lky9_wdwo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vacuum-2-outline-rounded" /></template>
<style>
.lky9_wdwo {
  fill: currentColor;
