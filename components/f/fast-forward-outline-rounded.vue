...
const content = `<path class="s_v6h92se"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fast-forward-outline-rounded" /></template>
<style>
.s_v6h92se {
  fill: currentColor;
