...
const content = `<path class="t5qwvd67e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:home-max-outline-sharp" /></template>
<style>
.t5qwvd67e {
  fill: currentColor;
