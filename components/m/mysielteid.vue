...
const content = `<path class="lz6r3ob1q"/><path class="rlr23ob0b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mysielteid" /></template>
<style>
.lz6r3ob1q {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M11.208 11.785a19.009 19.009 0 0 1 33.292 8.93m-4.16 15.5a19.009 19.009 0 0 1-33.292-8.93");
}
