...
const content = `<path class="lv6e80b7t"/><path class="uph4zqc9i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-google-13" /></template>
<style>
.lv6e80b7t {
  fill: none;
  stroke: currentColor;
