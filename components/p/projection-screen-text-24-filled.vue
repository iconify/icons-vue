...
const content = `<path class="pv0sc6xsj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:projection-screen-text-24-filled" /></template>
<style>
.pv0sc6xsj {
  fill: currentColor;
