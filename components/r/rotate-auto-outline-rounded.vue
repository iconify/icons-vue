...
const content = `<path class="pnc925xpx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:rotate-auto-outline-rounded" /></template>
<style>
.pnc925xpx {
  fill: currentColor;
