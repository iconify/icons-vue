...
const content = `<path class="t2-mw4bex"/><path class="odopgnbsh"/><circle class="iop7mnbiw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lightmeter" /></template>
<style>
.iop7mnbiw {
  cx: 24px;
  cy: 22.746px;
...
.t2-mw4bex {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M40.13 42.5a33.1 33.1 0 0 0 2.052-11c0-11.87-6.783-26-18.182-26S5.818 19.63 5.818 31.5a33.1 33.1 0 0 0 2.053 11Z");
}
