...
const content = `<path class="o67dqq0rs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nat-outline-rounded" /></template>
<style>
.o67dqq0rs {
  fill: currentColor;
