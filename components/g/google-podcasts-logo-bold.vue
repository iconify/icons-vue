...
const content = `<path class="fwoxvrbrk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:google-podcasts-logo-bold" /></template>
<style>
.fwoxvrbrk {
  fill: currentColor;
