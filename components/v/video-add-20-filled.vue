...
const content = `<path class="bee_6rb0b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-add-20-filled" /></template>
<style>
.bee_6rb0b {
  fill: currentColor;
