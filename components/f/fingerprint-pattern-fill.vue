...
const content = `<path class="htwcbkbup"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:fingerprint-pattern-fill" /></template>
<style>
.htwcbkbup {
  fill: none;
  stroke: currentColor;
