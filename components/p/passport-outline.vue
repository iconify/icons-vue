...
const content = `<path class="kp7xa3j-f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:passport-outline" /></template>
<style>
.kp7xa3j-f {
  fill: currentColor;
