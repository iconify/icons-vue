...
const content = `<path class="klxwqjbio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flight-takeoff-outline-rounded" /></template>
<style>
.klxwqjbio {
  fill: currentColor;
