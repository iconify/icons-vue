...
const content = `<path class="o5mi336os"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-circle-up-down-bold" /></template>
<style>
.o5mi336os {
  fill: currentColor;
