...
const content = `<path clip-rule="evenodd" class="je37nc8jb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:clock-7-fill" /></template>
<style>
.je37nc8jb {
  fill: currentColor;
  fill-rule: evenodd;
