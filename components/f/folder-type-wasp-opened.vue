...
const content = `<path class="tdn656-4c"/><path class="lju9fe1of"/><path class="e5viygbri"/><path class="rbtlclbqx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-wasp-opened" /></template>
<style>
.e5viygbri {
