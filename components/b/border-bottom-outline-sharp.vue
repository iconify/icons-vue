...
const content = `<path class="n765p86ft"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:border-bottom-outline-sharp" /></template>
<style>
.n765p86ft {
  fill: currentColor;
