...
const content = `<path class="rw7ygpbit"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:layers-clear-outline-rounded" /></template>
<style>
.rw7ygpbit {
  fill: currentColor;
