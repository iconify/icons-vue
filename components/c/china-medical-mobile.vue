...
const content = `<path class="ul1uotb5s"/><path class="nu3b38b0k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:china-medical-mobile" /></template>
<style>
.nu3b38b0k {
  fill: none;
  stroke: currentColor;
