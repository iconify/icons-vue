...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="psv_8pbss"/><g class="xyjtgccot"><path clip-rule="evenodd" class="ni23het1o"/><path class="jrrlputnm"/><path clip-rule="evenodd" class="qk-lqcc5d"/><path class="xhzvqabus"/><path clip-rule="evenodd" class="njsp8q4ba"/><path clip-rule="evenodd" class="onzw5rx3w"/></g><path clip-rule="evenodd" class="d120w4b8a"/><path clip-rule="evenodd" class="tm9-c6_he"/><path clip-rule="evenodd" class="knpu4gbqh"/><path class="zsuclwbnx"/><path clip-rule="evenodd" class="kspoj7vnd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-print:studio-light-side-circle-off" /></template>
