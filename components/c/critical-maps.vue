...
const content = `<circle class="y9zt6mb3r"/><path class="mqv5_xbme"/><path class="y-ll_zlfa"/><path class="iw3kzevrs"/><path class="gs09fjg3h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:critical-maps" /></template>
<style>
.gs09fjg3h {
  fill: none;
  stroke: currentColor;
...
.iw3kzevrs {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m21.769 18.749l4.559-5.326l3.544 2.663l-4.316 4.743m3.246-3.567l2.978 2.477l-5.201 6.242");
}
...
.mqv5_xbme {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m16.959 42.602l1.327-9.324L12.88 24l3.907-7.987l8.769 4.816L24 24l-4.441.237");
}
...
.y-ll_zlfa {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m25.494 14.398l-3.164-1.929l-4.03 4.375");
}
