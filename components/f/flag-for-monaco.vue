...
const content = `<path class="jscz78bwr"/><path class="cpsgke82m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-monaco" /></template>
<style>
.cpsgke82m {
