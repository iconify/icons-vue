...
const content = `<path class="cit0evxdk"/><path class="j2g5ntbzk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:expressen" /></template>
<style>
.cit0evxdk {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M14.38 6.25h19.24c1.1 0 1.99.89 1.99 1.99v27.98c0 .81-.66 1.47-1.47 1.47H13.86c-.81 0-1.47-.66-1.47-1.47V8.24c0-1.1.89-1.99 1.99-1.99");
}
