...
const content = `<path class="b8bfv4b9l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pulse-alert-sharp" /></template>
<style>
.b8bfv4b9l {
  fill: currentColor;
