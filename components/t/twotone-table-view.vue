...
const content = `<path class="ga5xokbpw"/><path class="ko3w6l4su"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-table-view" /></template>
<style>
.ga5xokbpw {
  fill: currentColor;
