...
const content = `<path class="pi9mdulmg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:frame-source-outline-sharp" /></template>
<style>
.pi9mdulmg {
  fill: currentColor;
