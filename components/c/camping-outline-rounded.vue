...
const content = `<path class="opvwucc0o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:camping-outline-rounded" /></template>
<style>
.opvwucc0o {
  fill: currentColor;
