...
const content = `<path class="e7ukadbib"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:counter-9-outline-rounded" /></template>
<style>
.e7ukadbib {
  fill: currentColor;
