...
const content = `<g class="cuyn6tgcc"><path class="y_fodlb4x"/><path class="nv7io5ium"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:heartbeat-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
