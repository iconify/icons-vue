...
const content = `<path class="k-y0k64ra"/><linearGradient id="SVGmo0UWd9T" x1="64" x2="64" y1="35.759" y2="8" gradientTransform="matrix(1 0 0 -1 0 130)" gradientUnits="userSpaceOnUse"><stop offset="0" class="xb94qyb-t"/><stop offset=".705" class="ci_fo_bpd"/><stop offset="1" class="u3kz4vb7l"/></linearGradient><path fill="url(#SVGmo0UWd9T)" class="em9qpibty"/><path class="mrf_6ib7y"/><path class="rnxpr2xlg"/><path class="o1gqozbsu"/><g class="fgqj36-ft"><ellipse class="n8fq1s3jv"/><ellipse class="gba0l8b6i"/></g><path class="j78f_r7av"/><path class="lmaqm4b1s"/><path class="erh706bmb"/><radialGradient id="SVG3FY0qrZb" cx="63.798" cy="46.819" r="49.836" gradientTransform="rotate(-.109 64.883 50.393)" gradientUnits="userSpaceOnUse"><stop offset=".725" class="mlb8vsb9l"/><stop offset="1" class="m_5onzv2u"/></radialGradient><path fill="url(#SVG3FY0qrZb)" class="e7gfutlzg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:woman-curly-haired-medium-dark-skin-tone" /></template>
<style>
.ci_fo_bpd {
...
.mrf_6ib7y {
  ...
  d: path("M72.89 90.08H55.1v9.98c0 4.51 3.62 8.17 8.09 8.17h1.62c4.46 0 8.09-3.66 8.09-8.17z");
}
