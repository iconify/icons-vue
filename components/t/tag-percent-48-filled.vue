...
const content = `<path class="rndordbdv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tag-percent-48-filled" /></template>
<style>
.rndordbdv {
  fill: currentColor;
