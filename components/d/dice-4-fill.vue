...
const content = `<path clip-rule="evenodd" class="n878sudbr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:dice-4-fill" /></template>
<style>
.n878sudbr {
  fill: currentColor;
  fill-rule: evenodd;
