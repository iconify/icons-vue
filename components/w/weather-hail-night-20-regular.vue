...
const content = `<path class="x8b4xv5nb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-hail-night-20-regular" /></template>
<style>
.x8b4xv5nb {
  fill: currentColor;
