...
const content = `<path class="h1akjcboh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:signature-outline-rounded" /></template>
<style>
.h1akjcboh {
  fill: currentColor;
