...
const content = `<path class="bp42pllcm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:discover-tune-outline-rounded" /></template>
<style>
.bp42pllcm {
  fill: currentColor;
