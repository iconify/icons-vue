...
const content = `<path class="kods2fb1l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sell-cloud-rounded" /></template>
<style>
.kods2fb1l {
  fill: currentColor;
