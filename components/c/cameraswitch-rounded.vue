...
const content = `<path class="ejaknqban"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cameraswitch-rounded" /></template>
<style>
.ejaknqban {
  fill: currentColor;
