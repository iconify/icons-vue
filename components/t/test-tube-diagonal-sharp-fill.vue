...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:test-tube-diagonal-sharp-fill" /></template>
<style>
.axh_y-hbe {
  d: path("M13.0471 1.838L20.4544 6.661");
}
