...
const content = `<path class="bsx2arepj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:more-vert-outline-rounded" /></template>
<style>
.bsx2arepj {
  fill: currentColor;
