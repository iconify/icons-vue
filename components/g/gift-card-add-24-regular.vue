...
const content = `<path class="kbwbv4bix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:gift-card-add-24-regular" /></template>
<style>
.kbwbv4bix {
  fill: currentColor;
