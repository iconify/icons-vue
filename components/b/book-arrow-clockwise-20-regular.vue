...
const content = `<path class="hbpgc4b1h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-arrow-clockwise-20-regular" /></template>
<style>
.hbpgc4b1h {
  fill: currentColor;
