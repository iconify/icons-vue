...
const content = `<path class="efatcfbvi"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kfc-alt" /></template>
<style>
.efatcfbvi {
  fill: none;
  stroke: currentColor;
