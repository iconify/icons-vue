...
const content = `<path class="viyp-fb4d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:wallet-credit-card-32-filled" /></template>
<style>
.viyp-fb4d {
  fill: currentColor;
