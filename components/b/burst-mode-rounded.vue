...
const content = `<path class="uwcc7mbde"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:burst-mode-rounded" /></template>
<style>
.uwcc7mbde {
  fill: currentColor;
