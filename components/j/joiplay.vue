...
const content = `<path class="fku8r5b4r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:joiplay" /></template>
<style>
.fku8r5b4r {
  fill: none;
  stroke: currentColor;
