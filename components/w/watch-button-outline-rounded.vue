...
const content = `<path class="mtu_i0b5a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:watch-button-outline-rounded" /></template>
<style>
.mtu_i0b5a {
  fill: currentColor;
