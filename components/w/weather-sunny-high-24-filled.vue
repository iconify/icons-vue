...
const content = `<path class="h7mrskbkc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-sunny-high-24-filled" /></template>
<style>
.h7mrskbkc {
  fill: currentColor;
