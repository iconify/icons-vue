...
const content = `<path class="aw-w5rbsd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-person-sparkle-28-filled" /></template>
<style>
.aw-w5rbsd {
  fill: currentColor;
