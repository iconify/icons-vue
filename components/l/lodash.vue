...
const content = `<g class="bi12bsetm"><path class="rrnf1s96w"/><path class="ju-8p6zho"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:lodash" /></template>
<style>
.bi12bsetm {
  fill: none;
  fill-rule: evenodd;
