...
const content = `<path class="l66d67m8l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:visual-search-24-regular" /></template>
<style>
.l66d67m8l {
  fill: currentColor;
