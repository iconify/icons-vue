...
const content = `<path class="wlvy9xbyf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-decrease-16-filled" /></template>
<style>
.wlvy9xbyf {
  fill: currentColor;
