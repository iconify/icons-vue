...
const content = `<path class="ylw_6bm0u"/><path class="fasrc0znu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-library-music" /></template>
<style>
.fasrc0znu {
  fill: currentColor;
