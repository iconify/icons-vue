...
const content = `<path class="nyj6u4b7g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:motion-photos-auto-outline-rounded" /></template>
<style>
.nyj6u4b7g {
  fill: currentColor;
