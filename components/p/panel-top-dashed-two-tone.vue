...
const content = `<g class="nrj6p8qat"><path class="ttdlueb2i"/><path class="kodnftbvm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:panel-top-dashed-two-tone" /></template>
<style>
.kodnftbvm {
