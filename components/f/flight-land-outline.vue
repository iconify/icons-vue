...
const content = `<path class="d3vqkwb0g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flight-land-outline" /></template>
<style>
.d3vqkwb0g {
  fill: currentColor;
