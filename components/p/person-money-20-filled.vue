...
const content = `<path class="fgst7jatv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-money-20-filled" /></template>
<style>
.fgst7jatv {
  fill: currentColor;
