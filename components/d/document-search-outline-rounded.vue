...
const content = `<path class="cjlvpzbdq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:document-search-outline-rounded" /></template>
<style>
.cjlvpzbdq {
  fill: currentColor;
