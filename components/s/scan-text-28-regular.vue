...
const content = `<path class="j6ij0abqb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-text-28-regular" /></template>
<style>
.j6ij0abqb {
  fill: currentColor;
