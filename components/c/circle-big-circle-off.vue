...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="avep9i2uu"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:circle-big-circle-off" /></template>
<style>
.avep9i2uu {
  fill-rule: evenodd;
