...
const content = `<path class="manrfrbzq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:celebration-outline" /></template>
<style>
.manrfrbzq {
  fill: currentColor;
