...
const content = `<path class="s9ixpyk5p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:puzzle-cube-20-regular" /></template>
<style>
.s9ixpyk5p {
  fill: currentColor;
