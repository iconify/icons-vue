...
const content = `<path class="dtfy-ibhr"/><path class="f04l4phkv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:medibuddy" /></template>
<style>
.dtfy-ibhr {
  fill: none;
  stroke: currentColor;
