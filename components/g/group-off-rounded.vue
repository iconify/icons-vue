...
const content = `<path class="fsv5c8b-i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:group-off-rounded" /></template>
<style>
.fsv5c8b-i {
  fill: currentColor;
