...
const content = `<path class="nhm8jwbru"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:app-spark-outline" /></template>
<style>
.nhm8jwbru {
  fill: currentColor;
