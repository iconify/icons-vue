...
const content = `<path class="uhfcxmbzy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ad-off-outline" /></template>
<style>
.uhfcxmbzy {
  fill: currentColor;
