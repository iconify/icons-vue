...
const content = `<g class="cuyn6tgcc"><path class="ehq57rbvh"/><path class="iymz2bbfg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:orange-slice-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.ehq57rbvh {
  d: path("M216 88a88 88 0 0 1-176 0Z");
