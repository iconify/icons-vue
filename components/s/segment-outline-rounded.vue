...
const content = `<path class="y3duoyxrk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:segment-outline-rounded" /></template>
<style>
.y3duoyxrk {
  fill: currentColor;
