...
const content = `<path class="t1hzf7b0y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-hearing-disabled" /></template>
<style>
.t1hzf7b0y {
  fill: currentColor;
