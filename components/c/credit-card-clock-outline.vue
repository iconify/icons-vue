...
const content = `<path class="niulglb0h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:credit-card-clock-outline" /></template>
<style>
.niulglb0h {
  fill: currentColor;
