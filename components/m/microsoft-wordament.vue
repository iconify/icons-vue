...
const content = `<path class="svn1wkb8v"/><path class="osn5le41n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:microsoft-wordament" /></template>
<style>
.osn5le41n {
  fill: none;
  stroke: currentColor;
...
.svn1wkb8v {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m34.505 27.406l5.807 1.024l-2.657 15.07l-15.07-2.657l1.043-5.916m.592-3.358l1.022-5.796l5.774 1.018m-7.252-10.269l-1.006 5.705l-15.07-2.657L10.346 4.5l15.07 2.658l-.996 5.646m-3.826 21.7l-1.024 5.807L4.5 37.654l2.657-15.07l15.07 2.657l-1.003 5.69m6.19-17.477l1.016-5.766l15.07 2.658l-2.657 15.07l-5.736-1.012m-3.599-.634l-5.735-1.011l1.027-5.827");
}
