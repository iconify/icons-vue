...
const content = `<path class="iqrqbdm_p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:remember-me-outline-sharp" /></template>
<style>
.iqrqbdm_p {
  fill: currentColor;
