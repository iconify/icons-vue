...
const content = `<path class="oh0y5ezvp"/><path class="x_e4y3b_i"/><path class="v75_3fwkw"/><path class="alo7wou8m"/><path class="ldduf345s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-iceland" /></template>
<style>
.alo7wou8m {
