...
const content = `<path class="u0ch5ccxn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:glance-horizontal-16-filled" /></template>
<style>
.u0ch5ccxn {
  fill: currentColor;
