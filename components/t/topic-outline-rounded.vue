...
const content = `<path class="s27zy4byz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:topic-outline-rounded" /></template>
<style>
.s27zy4byz {
  fill: currentColor;
