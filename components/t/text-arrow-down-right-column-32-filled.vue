...
const content = `<path class="uc1sttboq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-arrow-down-right-column-32-filled" /></template>
<style>
.uc1sttboq {
  fill: currentColor;
