...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="k7ki8qbzd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-css-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
