...
const content = `<path class="u-4elwpnu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-counterclockwise-info-48-regular" /></template>
<style>
.u-4elwpnu {
  fill: currentColor;
