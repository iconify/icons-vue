...
const content = `<path class="lfjzyzzal"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:javascript-20-regular" /></template>
<style>
.lfjzyzzal {
  fill: currentColor;
