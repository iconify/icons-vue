...
const content = `<path class="c8p901b3q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:subtitles-off-sharp" /></template>
<style>
.c8p901b3q {
  fill: currentColor;
