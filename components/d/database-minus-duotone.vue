...
const content = `<g class="nrj6p8qat"><path class="vhck9ybet"/><path clip-rule="evenodd" class="qa1terbik"/><path class="ugn31mube"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-minus-duotone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
