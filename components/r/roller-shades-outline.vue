...
const content = `<path class="p-qlcwbzi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:roller-shades-outline" /></template>
<style>
.p-qlcwbzi {
  fill: currentColor;
