...
const content = `<path class="nwitp1b6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:accessibility-checkmark-32-regular" /></template>
<style>
.nwitp1b6u {
  fill: currentColor;
