...
const content = `<path class="y93kcpbzs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-arrow-left-20-filled" /></template>
<style>
.y93kcpbzs {
  fill: currentColor;
