...
const content = `<path class="dvuaulb1p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fast-forward-rounded" /></template>
<style>
.dvuaulb1p {
  fill: currentColor;
