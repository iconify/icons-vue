...
const content = `<path class="bo76n9bso"/><path class="c2sld4byo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-hdr-auto" /></template>
<style>
.bo76n9bso {
  fill: currentColor;
