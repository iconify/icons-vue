...
const content = `<path class="elve40hds"/><path class="bag4m3bbr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-tuta-18" /></template>
<style>
.bag4m3bbr {
  fill: none;
  stroke: currentColor;
