...
const content = `<path class="g8r8ilsad"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sim-card-download" /></template>
<style>
.g8r8ilsad {
  fill: currentColor;
