...
const content = `<path class="gu68jvwuk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shelves-outline-sharp" /></template>
<style>
.gu68jvwuk {
  fill: currentColor;
