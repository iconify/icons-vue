...
const content = `<path class="i9clfwm2k"/><path class="xu58glpki"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:madame-coco" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
