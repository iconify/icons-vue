...
const content = `<path class="l1r8iiykb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-out-16-filled" /></template>
<style>
.l1r8iiykb {
  fill: currentColor;
