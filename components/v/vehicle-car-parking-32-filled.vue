...
const content = `<path class="s6ubplb-v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-car-parking-32-filled" /></template>
<style>
.s6ubplb-v {
  fill: currentColor;
