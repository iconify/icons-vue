...
const content = `<path class="x5d33hbfr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:touch-app-rounded" /></template>
<style>
.x5d33hbfr {
  fill: currentColor;
