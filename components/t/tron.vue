...
const content = `<path clip-rule="evenodd" class="fydkagbkm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:tron" /></template>
<style>
.fydkagbkm {
