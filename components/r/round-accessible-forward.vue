...
const content = `<circle class="mn9l6gbgf"/><path class="c-r71uhsu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-accessible-forward" /></template>
<style>
.c-r71uhsu {
  fill: currentColor;
