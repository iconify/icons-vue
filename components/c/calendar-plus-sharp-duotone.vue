...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:calendar-plus-sharp-duotone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.qwp78v52t {
  d: path("M6 11L18 11M8 2L8 8M16 2L16 8M18 14L18 22M14 18L22 18");
}
