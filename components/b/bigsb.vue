...
const content = `<g class="ft5dv1b6b"><path fill="url(#tokenBrandedBigsb0)" clip-rule="evenodd" class="alpi2obdu"/><defs><linearGradient id="tokenBrandedBigsb0" x1="2" x2="12.878" y1="18.112" y2=".313" gradientUnits="userSpaceOnUse"><stop class="vl536ablz"/><stop offset="1" class="uqbua5lsw"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:bigsb" /></template>
<style>
.alpi2obdu {
  fill-rule: evenodd;
...
.uqbua5lsw {
  stop-color: var(--svg-color--0000ad, #0000AD);
}

.vl536ablz {
  stop-color: var(--svg-color--0000fe, #0000FE);
}
