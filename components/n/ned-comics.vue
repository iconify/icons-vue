...
const content = `<path class="bnr_grbjn"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ned-comics" /></template>
<style>
.bnr_grbjn {
  fill: none;
  stroke: currentColor;
