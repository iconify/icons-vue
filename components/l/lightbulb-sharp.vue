...
const content = `<path class="g6z36x8kb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:lightbulb-sharp" /></template>
<style>
.g6z36x8kb {
  fill: currentColor;
