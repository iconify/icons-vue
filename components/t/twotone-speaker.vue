...
const content = `<path class="g2ri07m3i"/><path class="rhd0bj82a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-speaker" /></template>
<style>
.g2ri07m3i {
  fill: currentColor;
