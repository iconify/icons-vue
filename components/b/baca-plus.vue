...
const content = `<path class="r04pxhbmo"/><circle class="cxb6khbjd"/><circle class="i49bezcnf"/><ellipse class="rb4mlfwwc"/><ellipse class="mf5f82byw"/><path class="sjjfierpx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:baca-plus" /></template>
<style>
.cxb6khbjd {
  cx: 17.573px;
  cy: 14.166px;
...
.sjjfierpx {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m24.335 40.125l3.878 2.375m-3.949-5.21l.07 2.835l-5.022 1.883m8.296-2.021l5.204 1.41m-5.33-4.355l.126 2.945l-4.346 2.105");
}
