...
const content = `<path class="awy8z82iv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-object-24-regular" /></template>
<style>
.awy8z82iv {
  fill: currentColor;
