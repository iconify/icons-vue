...
const content = `<g class="cuyn6tgcc"><path class="tjdbcjb6z"/><path class="qawx45b1a"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:magnet-straight-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.tjdbcjb6z {
  d: path("M104 56v40H48V56a8 8 0 0 1 8-8h40a8 8 0 0 1 8 8m96-8h-40a8 8 0 0 0-8 8v40h56V56a8 8 0 0 0-8-8");
