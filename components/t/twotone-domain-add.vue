...
const content = `<path class="wwsvzwn9j"/><path class="vkl-2zbpe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-domain-add" /></template>
<style>
.vkl-2zbpe {
  fill: currentColor;
