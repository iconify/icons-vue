...
const content = `<path class="v48tedcno"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:smart-card-reader-off-rounded" /></template>
<style>
.v48tedcno {
  fill: currentColor;
