...
const content = `<g class="cuyn6tgcc"><path class="fy-g3jbkn"/><path class="s-3ha1bzt"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:handshake-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
