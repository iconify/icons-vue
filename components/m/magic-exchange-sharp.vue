...
const content = `<path class="ghh0xjb1g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:magic-exchange-sharp" /></template>
<style>
.ghh0xjb1g {
  fill: currentColor;
