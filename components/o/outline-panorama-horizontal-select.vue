...
const content = `<path class="sf9ia_buh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-panorama-horizontal-select" /></template>
<style>
.sf9ia_buh {
  fill: currentColor;
