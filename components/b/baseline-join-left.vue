...
const content = `<ellipse class="z7mg04vth"/><path class="a7-rd6bhf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-join-left" /></template>
<style>
.a7-rd6bhf {
  fill: currentColor;
