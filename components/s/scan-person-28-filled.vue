...
const content = `<path class="z9d6cib7u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-person-28-filled" /></template>
<style>
.z9d6cib7u {
  fill: currentColor;
