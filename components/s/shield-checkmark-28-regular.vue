...
const content = `<path class="x7ow-h5ng"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-checkmark-28-regular" /></template>
<style>
.x7ow-h5ng {
  fill: currentColor;
