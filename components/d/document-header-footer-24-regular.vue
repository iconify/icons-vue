...
const content = `<path class="ze2-u0dit"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-header-footer-24-regular" /></template>
<style>
.ze2-u0dit {
  fill: currentColor;
