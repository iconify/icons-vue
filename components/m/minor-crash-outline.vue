...
const content = `<path class="csu5t1bbv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:minor-crash-outline" /></template>
<style>
.csu5t1bbv {
  fill: currentColor;
