...
const content = `<path class="ud7ddsbmw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-cable-car-28-filled" /></template>
<style>
.ud7ddsbmw {
  fill: currentColor;
