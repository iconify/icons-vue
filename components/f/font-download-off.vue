...
const content = `<path class="pcb19cc9n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:font-download-off" /></template>
<style>
.pcb19cc9n {
  fill: currentColor;
