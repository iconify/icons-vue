...
const content = `<path class="tg31urbgg"/><path class="p366n2i6q"/><path class="mu3hjibwp"/><path class="t68tqw8kc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:face-with-tears-of-joy" /></template>
<style>
.mu3hjibwp {
...
.t68tqw8kc {
  ...
  d: path("M10.847 28.229a5 5 0 0 1-9.693-2.461c.679-2.677 6.337-8.708 7.307-8.462s3.065 8.247 2.386 10.923m14.286 0a5 5 0 0 0 6.077 3.615a5 5 0 0 0 3.616-6.076c-.68-2.677-6.338-8.708-7.308-8.462c-.968.247-3.064 8.247-2.385 10.923");
}
