...
const content = `<path class="ouv0q2dvt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-arrow-back-24-regular" /></template>
<style>
.ouv0q2dvt {
  fill: currentColor;
