...
const content = `<g class="cuyn6tgcc"><path class="nd7ilabif"/><path class="jpxx1pqxh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:cake-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
