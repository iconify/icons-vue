...
const content = `<path class="mt8n1qb2c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:account-balance-rounded" /></template>
<style>
.mt8n1qb2c {
  fill: currentColor;
