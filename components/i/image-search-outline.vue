...
const content = `<path class="w2hg9_bqm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:image-search-outline" /></template>
<style>
.w2hg9_bqm {
  fill: currentColor;
