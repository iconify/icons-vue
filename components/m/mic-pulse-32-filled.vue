...
const content = `<path class="zi4ivac5e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mic-pulse-32-filled" /></template>
<style>
.zi4ivac5e {
  fill: currentColor;
