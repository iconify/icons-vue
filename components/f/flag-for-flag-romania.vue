...
const content = `<path class="fohd6dqnc"/><path class="eu3393bvh"/><path class="t_rlincix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-romania" /></template>
<style>
.eu3393bvh {
