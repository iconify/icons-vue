...
const content = `<path class="r80_hw12x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-clockwise-32-filled" /></template>
<style>
.r80_hw12x {
  fill: currentColor;
