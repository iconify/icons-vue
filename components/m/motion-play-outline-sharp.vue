...
const content = `<path class="jgjhjxbvb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:motion-play-outline-sharp" /></template>
<style>
.jgjhjxbvb {
  fill: currentColor;
