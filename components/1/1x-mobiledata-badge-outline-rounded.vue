...
const content = `<path class="ogyxf11xe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:1x-mobiledata-badge-outline-rounded" /></template>
<style>
.ogyxf11xe {
  fill: currentColor;
