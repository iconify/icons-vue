...
const content = `<path class="e2c785bsu"/><path class="yhgdzpbsm"/><path class="mh79h9x1l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-yemen" /></template>
<style>
.e2c785bsu {
