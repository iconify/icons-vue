...
const content = `<path class="yk1c3qbrz"/><path class="qj9-mya5r"/><path class="d8kxhub2n"/><path class="xfi-0baut"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-myanmar-burma" /></template>
<style>
.d8kxhub2n {
