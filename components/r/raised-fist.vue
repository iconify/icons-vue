...
const content = `<path class="lveosybio"/><defs><path id="SVGURkcDdhU" class="ds-pt9yrt"/></defs><clipPath id="SVGPv3CACjI"><use href="#SVGURkcDdhU"/></clipPath><g clip-path="url(#SVGPv3CACjI)" class="tcw5ljb1b"><path class="lcn3aobko"/><path class="yhs7uh29m"/></g><defs><use href="#SVGURkcDdhU" id="SVGXJHrEeYt"/></defs><clipPath id="SVGr9YxBmXJ"><use href="#SVGXJHrEeYt"/></clipPath><path clip-path="url(#SVGr9YxBmXJ)" class="tp7ik8bso"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:raised-fist" /></template>
<style>
.ds-pt9yrt {
