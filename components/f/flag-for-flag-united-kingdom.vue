...
const content = `<path class="o_pq2b4_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-flag-united-kingdom" /></template>
<style>
.o_pq2b4_q {
  fill: currentColor;
