...
const content = `<path class="dh8qjnbux"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-add-28-filled" /></template>
<style>
.dh8qjnbux {
  fill: currentColor;
