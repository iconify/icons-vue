...
const content = `<path class="s53rz2b8m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-top-left-outline-rounded" /></template>
<style>
.s53rz2b8m {
  fill: currentColor;
