...
const content = `<path class="wrt234bhw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-progress-play" /></template>
<style>
.wrt234bhw {
  fill: none;
  stroke: currentColor;
