...
const content = `<path class="f9o-vdrci"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:add-a-photo-sharp" /></template>
<style>
.f9o-vdrci {
  fill: currentColor;
