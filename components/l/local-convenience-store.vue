...
const content = `<path class="sy083plgl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-convenience-store" /></template>
<style>
.sy083plgl {
  fill: currentColor;
