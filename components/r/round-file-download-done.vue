...
const content = `<path class="fb2xg8b5g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-file-download-done" /></template>
<style>
.fb2xg8b5g {
  fill: currentColor;
