...
const content = `<path class="iz5zn88qp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-screen-time-24-filled" /></template>
<style>
.iz5zn88qp {
  fill: currentColor;
