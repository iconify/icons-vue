...
const content = `<path class="c-83otb3m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:copyright" /></template>
<style>
.c-83otb3m {
  fill: currentColor;
