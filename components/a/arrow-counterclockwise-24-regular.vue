...
const content = `<path class="g7snm9b8z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-counterclockwise-24-regular" /></template>
<style>
.g7snm9b8z {
  fill: currentColor;
