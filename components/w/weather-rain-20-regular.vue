...
const content = `<path class="oj9e8db6h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-rain-20-regular" /></template>
<style>
.oj9e8db6h {
  fill: currentColor;
