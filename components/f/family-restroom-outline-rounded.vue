...
const content = `<path class="x0zh58b8g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:family-restroom-outline-rounded" /></template>
<style>
.x0zh58b8g {
  fill: currentColor;
