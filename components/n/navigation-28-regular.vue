...
const content = `<path class="stz6wfwcf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:navigation-28-regular" /></template>
<style>
.stz6wfwcf {
  fill: currentColor;
