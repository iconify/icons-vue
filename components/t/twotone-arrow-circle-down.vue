...
const content = `<path class="upuou5o2k"/><path class="bpwzstbih"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-arrow-circle-down" /></template>
<style>
.bpwzstbih {
  fill: currentColor;
