...
const content = `<path class="pkxb3ac6v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flowchart-32-filled" /></template>
<style>
.pkxb3ac6v {
  fill: currentColor;
