...
const content = `<path class="sny_cvbfb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-add-16-regular" /></template>
<style>
.sny_cvbfb {
  fill: currentColor;
