...
const content = `<path class="fi_c8lhbz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:presence-offline-16-regular" /></template>
<style>
.fi_c8lhbz {
  fill: currentColor;
