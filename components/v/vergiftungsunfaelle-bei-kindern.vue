...
const content = `<path class="m6r16q6wr"/><path class="ejg8hqbpt"/><path class="rzyaq0bse"/><path class="rcqn4wbpu"/><path class="m9pjkuboy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:vergiftungsunfaelle-bei-kindern" /></template>
<style>
.ejg8hqbpt {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M15.704 13.789c-1.141.978-1.733 1.628-1.689 3.03c.045 1.403.078 4.86.078 6.611s2.291 2.834 5.683 4.462c-.028 1.264 0 2.247 0 2.247s1.368 1.624 3.96 1.57c2.648-.054 3.832-1.521 3.832-1.521s.015-1.137 0-2.29c4.56-2.41 5.73-2.778 5.719-5.482s-.018-4.14.079-5.976s-1.124-2.307-1.124-2.307");
}
...
.rcqn4wbpu {
  ...
  stroke: currentColor;
  stroke-linejoin: round;
  d: path("m16.786 20.218l4.133.01s-.012 3.128-1.953 2.997s-2.18-3.007-2.18-3.007Zm13.857 0l-4.133.01s.012 3.128 1.953 2.997s2.18-3.007 2.18-3.007Z");
}
...
.rzyaq0bse {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m22.179 27.907l1.527-2.756l1.527 2.756");
}
