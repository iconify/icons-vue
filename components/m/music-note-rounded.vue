...
const content = `<path class="wc08lcvdw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:music-note-rounded" /></template>
<style>
.wc08lcvdw {
  fill: currentColor;
