...
const content = `<path class="o0i_ahjmt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-task-24-filled" /></template>
<style>
.o0i_ahjmt {
  fill: currentColor;
