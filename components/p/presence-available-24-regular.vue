...
const content = `<path class="q2xkix-xc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:presence-available-24-regular" /></template>
<style>
.q2xkix-xc {
  fill: currentColor;
