...
const content = `<path class="s6n4-vioi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-pizza-sharp" /></template>
<style>
.s6n4-vioi {
  fill: currentColor;
