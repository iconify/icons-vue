...
const content = `<path class="doydmpbmb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-receipt" /></template>
<style>
.doydmpbmb {
  fill: none;
  stroke: currentColor;
