...
const content = `<path class="csfg83bou"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-arrow-down-20-filled" /></template>
<style>
.csfg83bou {
  fill: currentColor;
