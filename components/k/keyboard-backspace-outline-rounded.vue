...
const content = `<path class="r2gstq-ff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-backspace-outline-rounded" /></template>
<style>
.r2gstq-ff {
  fill: currentColor;
