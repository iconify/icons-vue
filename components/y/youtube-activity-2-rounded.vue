...
const content = `<path class="oosuftaqk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:youtube-activity-2-rounded" /></template>
<style>
.oosuftaqk {
  fill: currentColor;
