...
const content = `<path class="t539obcem"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-settings-28-filled" /></template>
<style>
.t539obcem {
  fill: currentColor;
