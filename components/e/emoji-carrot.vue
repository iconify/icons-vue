...
const content = `<path class="vq20wxjmk"/><path class="vccp693bd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-carrot" /></template>
<style>
.vccp693bd {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M34.386 14.196c.42 1.121.22 2.508-.067 3.469m-3.026-6.153c-1.177.105-1.964-.456-3.669.556");
}
