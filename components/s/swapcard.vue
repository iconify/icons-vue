...
const content = `<path class="s8_r54cyv"/><path class="tzkw48kgf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:swapcard" /></template>
<style>
.s8_r54cyv {
  fill: none;
  stroke: currentColor;
