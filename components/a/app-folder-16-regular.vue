...
const content = `<path class="t50erw02v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:app-folder-16-regular" /></template>
<style>
.t50erw02v {
  fill: currentColor;
