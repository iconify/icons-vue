...
const content = `<path class="vlg74197p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-increase-rtl-rotate-270-20-filled" /></template>
<style>
.vlg74197p {
  fill: currentColor;
