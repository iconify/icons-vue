...
const content = `<path class="pns7o4b6r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mic-noise-cancel-off" /></template>
<style>
.pns7o4b6r {
  fill: currentColor;
