...
const content = `<g class="cuyn6tgcc"><path class="goeug6bgp"/><path class="osv7lgbnr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:dots-three-circle-vertical-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
