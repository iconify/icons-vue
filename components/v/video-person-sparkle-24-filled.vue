...
const content = `<path class="gvheqrblh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-person-sparkle-24-filled" /></template>
<style>
.gvheqrblh {
  fill: currentColor;
