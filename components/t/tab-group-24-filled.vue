...
const content = `<path class="o2paijbih"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-group-24-filled" /></template>
<style>
.o2paijbih {
  fill: currentColor;
