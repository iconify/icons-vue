...
const content = `<path class="js6l-mbrq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:water-orp-outline-sharp" /></template>
<style>
.js6l-mbrq {
  fill: currentColor;
