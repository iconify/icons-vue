...
const content = `<path class="x9pztvbja"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:money-hand-24-regular" /></template>
<style>
.x9pztvbja {
  fill: currentColor;
