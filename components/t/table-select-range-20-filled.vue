...
const content = `<path class="shr5-sb0s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-select-range-20-filled" /></template>
<style>
.shr5-sb0s {
  fill: currentColor;
