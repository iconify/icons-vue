...
const content = `<path class="isj322f_h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:calendar-meal-2-rounded" /></template>
<style>
.isj322f_h {
  fill: currentColor;
