...
const content = `<path class="ph_7qmb-f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vo2-max-outline-sharp" /></template>
<style>
.ph_7qmb-f {
  fill: currentColor;
