...
const content = `<path class="n6_badb9n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-right-cursor-24-regular" /></template>
<style>
.n6_badb9n {
  fill: currentColor;
