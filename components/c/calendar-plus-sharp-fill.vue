...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:calendar-plus-sharp-fill" /></template>
<style>
.b3w-c-s0b {
  fill: currentColor;
  fill-rule: evenodd;
...
.bsp85jz-y {
  d: path("M8 2L8 8M16 2L16 8M18 14L18 22M14 18L22 18");
}
