...
const content = `<path class="n08xh4b7d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-density-16-regular" /></template>
<style>
.n08xh4b7d {
  fill: currentColor;
