...
const content = `<path class="dz21soc0d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-play-24-regular" /></template>
<style>
.dz21soc0d {
  fill: currentColor;
