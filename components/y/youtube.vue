...
const content = `<path class="a_1c4zbag"/><path class="l0v_iezpn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:youtube" /></template>
<style>
.a_1c4zbag {
  fill: none;
  stroke: currentColor;
