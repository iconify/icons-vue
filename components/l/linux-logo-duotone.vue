...
const content = `<g class="cuyn6tgcc"><path class="kamb2ncmo"/><path class="lh3x_0ucz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:linux-logo-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
