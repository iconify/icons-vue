...
const content = `<path class="tdl0plbts"/><path class="gpvd0pb1r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:material-you-light-dark-icons" /></template>
<style>
.gpvd0pb1r {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M24 4.883a9.59 9.59 0 0 0-9.592 9.592c0 5.298 4.294 9.592 9.592 9.592s9.592 4.295 9.592 9.592s-4.294 9.592-9.592 9.592");
}
