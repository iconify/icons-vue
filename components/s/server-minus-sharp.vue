...
const content = `<g class="gp_8x1bzb"><path class="q4kfsb6fu"/><path class="q-qndji8q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:server-minus-sharp" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
