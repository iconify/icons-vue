...
const content = `<path class="yz_1t1b8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stacks-rounded" /></template>
<style>
.yz_1t1b8v {
  fill: currentColor;
