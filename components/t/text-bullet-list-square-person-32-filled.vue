...
const content = `<path class="gd3-bi2yc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-bullet-list-square-person-32-filled" /></template>
<style>
.gd3-bi2yc {
  fill: currentColor;
