...
const content = `<path class="hi_bf6b5f"/><path class="c3lwqhaqb"/><circle class="sosylttow"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:itvx" /></template>
<style>
.c3lwqhaqb {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M21.877 24.515c.442.781-.589 5.206-4.732 5.206s-4.462-2.27-4.462-3.782v-7.724m3.948 4.89h-3.948m0 2.834c0 2.046-1.265 3.782-3.907 3.782s-3.532-1.519-3.532-3.782v-3.914");
}
