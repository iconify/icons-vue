...
const content = `<path class="bbi-svxex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-arrow-down-right-column-28-regular" /></template>
<style>
.bbi-svxex {
  fill: currentColor;
