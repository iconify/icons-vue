...
const content = `<path class="yerotlbav"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-work-week-32-light" /></template>
<style>
.yerotlbav {
  fill: currentColor;
