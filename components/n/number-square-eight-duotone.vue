...
const content = `<g class="cuyn6tgcc"><path class="rl1dq4bco"/><path class="se39vtiow"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-eight-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
