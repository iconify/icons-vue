...
const content = `<path class="vc02sfbru"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:counter-2-outline-rounded" /></template>
<style>
.vc02sfbru {
  fill: currentColor;
