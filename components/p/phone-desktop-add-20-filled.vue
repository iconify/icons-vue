...
const content = `<path class="sxok6-b5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-desktop-add-20-filled" /></template>
<style>
.sxok6-b5x {
  fill: currentColor;
