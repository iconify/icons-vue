...
const content = `<path class="qyg0dhbdn"/><path class="cbhtvjb7y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:oncoming-fist-dark-skin-tone" /></template>
<style>
.cbhtvjb7y {
