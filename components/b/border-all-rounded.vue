...
const content = `<path class="baykdzb5l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:border-all-rounded" /></template>
<style>
.baykdzb5l {
  fill: currentColor;
