...
const content = `<g class="nrj6p8qat"><path class="ciz47rm9a"/><path class="v83ck9bug"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shield-x-two-tone" /></template>
<style>
.ciz47rm9a {
  fill: currentColor;
