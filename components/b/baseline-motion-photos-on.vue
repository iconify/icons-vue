...
const content = `<path class="znf8x1bwn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-motion-photos-on" /></template>
<style>
.znf8x1bwn {
  fill: currentColor;
