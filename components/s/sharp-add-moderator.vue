...
const content = `<path class="qzn_mokls"/><path class="qehegabkd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-add-moderator" /></template>
<style>
.qehegabkd {
  fill: currentColor;
