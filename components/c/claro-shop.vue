...
const content = `<path class="uo47pyvli"/><path class="rsi2vgbyb"/><rect class="ij39-8ehp"/><path class="c-t9z6kbe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:claro-shop" /></template>
<style>
.c-t9z6kbe {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M26.903 31.719v6.227m0-2.568a1.557 1.557 0 1 1 3.114 0v2.569m-7.388-.349c.284.239.591.348 1.28.348h.35a1.03 1.03 0 0 0 0-2.063h-.699a1.03 1.03 0 0 1 0-2.062h.35c.689 0 .996.109 1.28.348m11.17 2.221a1.557 1.557 0 1 0 3.114 0v-1.012a1.557 1.557 0 1 0-3.114 0m0-1.557v6.227");
}
