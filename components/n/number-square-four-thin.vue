...
const content = `<path class="o4zofyheb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-four-thin" /></template>
<style>
.o4zofyheb {
  fill: currentColor;
