...
const content = `<path class="hls2nwnyh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-none-24-regular" /></template>
<style>
.hls2nwnyh {
  fill: currentColor;
