...
const content = `<g class="nrj6p8qat"><path class="n9mu2_d4r"/><path class="sturihscz"/><path class="mk93lqrnh"/><path class="hzm2gxbyj"/><path class="ywoqp9dou"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:task-merge-outline-regular" /></template>
<style>
.hzm2gxbyj {
  d: path("M17 8v6");
}
