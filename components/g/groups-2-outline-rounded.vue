...
const content = `<path class="zjgz0bc1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:groups-2-outline-rounded" /></template>
<style>
.zjgz0bc1m {
  fill: currentColor;
