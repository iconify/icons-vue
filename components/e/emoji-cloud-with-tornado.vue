...
const content = `<path class="ne6u3e-aj"/><path class="p33pmybjg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-cloud-with-tornado" /></template>
<style>
.ne6u3e-aj {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M24 12.041c-10.217 0-18.5-.918-18.5-2.05");
}
