...
const content = `<path class="wibl_qb7c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:inbox-text-share" /></template>
<style>
.wibl_qb7c {
  fill: currentColor;
