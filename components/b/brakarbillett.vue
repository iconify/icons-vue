...
const content = `<path class="bsdbabbfo"/><path class="inukekbsp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:brakarbillett" /></template>
<style>
.bsdbabbfo {
  fill: none;
  stroke: currentColor;
