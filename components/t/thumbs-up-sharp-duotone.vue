...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:thumbs-up-sharp-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.u66c07b8k {
  d: path("M3 11L3 21L7 21L7 11L3 11Z");
}
