...
const content = `<g class="cuyn6tgcc"><path class="hh5u20bpy"/><path class="tbt8x3ntj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:stack-minus-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
