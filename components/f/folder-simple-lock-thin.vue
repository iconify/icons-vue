...
const content = `<path class="ucv4wwb1n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-simple-lock-thin" /></template>
<style>
.ucv4wwb1n {
  fill: currentColor;
