...
const content = `<path class="c0gl8fhec"/><path class="npp70yypc"/><path class="cw4yn7c3j"/><path class="b__6u00uj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-css-opened" /></template>
<style>
.b__6u00uj {
...
.c0gl8fhec {
  fill: var(--svg-color--a35be6, #a35be6);
...
.npp70yypc {
  fill: var(--svg-color--a45ae7, #a45ae7);
