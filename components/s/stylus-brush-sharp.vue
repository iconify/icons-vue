...
const content = `<path class="skt0k-b4w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stylus-brush-sharp" /></template>
<style>
.skt0k-b4w {
  fill: currentColor;
