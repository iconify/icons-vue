...
const content = `<path class="t-u1ow3ae"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:remove-from-queue-outline-rounded" /></template>
<style>
.t-u1ow3ae {
  fill: currentColor;
