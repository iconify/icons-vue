...
const content = `<path class="wznnebk3i"/><path class="s6btn_vru"/><path class="hycm7lx4i"/><path class="shmmsqb6b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:keeper-password-manager" /></template>
<style>
.hycm7lx4i {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M41.724 35.584L39.36 33.22l-.01-.01l-6.14-6.14H20.93v17.961M35.627 6.233L33.22 8.64l-.01.01l-6.14 6.14V3.026");
}
...
.s6btn_vru {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M35.611 41.751L33.22 39.36h-.01v-.01l-6.14-6.14v11.965");
}
...
.shmmsqb6b {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M41.788 12.352L39.36 14.78v.01h-.01l-6.14 6.14H20.93V2.78m23.734 26.524L39.36 24l5.321-5.331");
}
