...
const content = `<path class="xizkjhbcr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:widgets-outline-sharp" /></template>
<style>
.xizkjhbcr {
  fill: currentColor;
