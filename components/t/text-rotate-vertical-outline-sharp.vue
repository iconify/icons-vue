...
const content = `<path class="yyoahuqff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-rotate-vertical-outline-sharp" /></template>
<style>
.yyoahuqff {
  fill: currentColor;
