...
const content = `<path class="qt-e_96do"/><path class="x677rybzn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:textra" /></template>
<style>
.qt-e_96do {
  fill: none;
  stroke: currentColor;
