...
const content = `<path class="f0lc56bwx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-2-16-regular" /></template>
<style>
.f0lc56bwx {
  fill: currentColor;
