...
const content = `<path class="hub4hrb3t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cast-multiple-20-filled" /></template>
<style>
.hub4hrb3t {
  fill: currentColor;
