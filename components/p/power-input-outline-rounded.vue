...
const content = `<path class="ddolqmxza"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:power-input-outline-rounded" /></template>
<style>
.ddolqmxza {
  fill: currentColor;
