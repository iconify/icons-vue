...
const content = `<path class="sph4racuc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-seven-light" /></template>
<style>
.sph4racuc {
  fill: currentColor;
