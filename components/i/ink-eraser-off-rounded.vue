...
const content = `<path class="ln2o_obtw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ink-eraser-off-rounded" /></template>
<style>
.ln2o_obtw {
  fill: currentColor;
