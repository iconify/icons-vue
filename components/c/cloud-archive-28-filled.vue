...
const content = `<path class="pdzgzbcpi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-archive-28-filled" /></template>
<style>
.pdzgzbcpi {
  fill: currentColor;
