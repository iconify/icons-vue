...
const content = `<circle class="cpk0fnbgt"/><path class="z-y9o8rkz"/><path class="x7gm-sbyo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:eba-akademik" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
