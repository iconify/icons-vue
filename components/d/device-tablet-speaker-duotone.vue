...
const content = `<g class="cuyn6tgcc"><path class="k-hmvyqnc"/><path class="y8a9k3buh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:device-tablet-speaker-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
