...
const content = `<path class="ishem2xdo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:open-run-outline-sharp" /></template>
<style>
.ishem2xdo {
  fill: currentColor;
