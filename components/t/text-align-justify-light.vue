...
const content = `<path class="yorn5lgxk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:text-align-justify-light" /></template>
<style>
.yorn5lgxk {
  fill: currentColor;
