...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGSSNwqbuT)" class="gc618ebbz"/><defs><linearGradient id="SVGSSNwqbuT" x1="4.845" x2="17.563" y1="7.18" y2="20.089" gradientUnits="userSpaceOnUse"><stop class="ubakghb8j"/><stop offset="1" class="fi-au-b8x"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:gofx" /></template>
<style>
.fi-au-b8x {
