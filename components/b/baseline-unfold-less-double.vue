...
const content = `<path class="y14yqobtv"/><path class="peqb83hry"/><path class="v6p_b6bev"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-unfold-less-double" /></template>
<style>
.peqb83hry {
  fill: currentColor;
