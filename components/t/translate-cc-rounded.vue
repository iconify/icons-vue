...
const content = `<path class="dx00s6bgl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:translate-cc-rounded" /></template>
<style>
.dx00s6bgl {
  fill: currentColor;
