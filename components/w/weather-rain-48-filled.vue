...
const content = `<path class="w-6y86t0c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-rain-48-filled" /></template>
<style>
.w-6y86t0c {
  fill: currentColor;
