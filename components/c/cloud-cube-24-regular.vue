...
const content = `<path class="o8kendpmz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-cube-24-regular" /></template>
<style>
.o8kendpmz {
  fill: currentColor;
