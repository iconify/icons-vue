...
const content = `<path class="d5iq1bbfg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-select-start-outline-sharp" /></template>
<style>
.d5iq1bbfg {
  fill: currentColor;
