...
const content = `<path class="yvxtlnb9x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:event-note" /></template>
<style>
.yvxtlnb9x {
  fill: currentColor;
