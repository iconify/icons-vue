...
const content = `<path class="l2bfpnvqd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:unpaved-road-outline-rounded" /></template>
<style>
.l2bfpnvqd {
  fill: currentColor;
