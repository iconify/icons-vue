...
const content = `<path class="jdfdlccud"/><path class="jw91py0qw"/><path class="s8fxkabzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-light-mypy" /></template>
<style>
.jdfdlccud {
  fill: var(--svg-color--1a4d80, #1a4d80);
