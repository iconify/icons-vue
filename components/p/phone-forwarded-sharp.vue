...
const content = `<path class="bsjc1xbts"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phone-forwarded-sharp" /></template>
<style>
.bsjc1xbts {
  fill: currentColor;
