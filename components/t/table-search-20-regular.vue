...
const content = `<path class="pvzvfpgbo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-search-20-regular" /></template>
<style>
.pvzvfpgbo {
  fill: currentColor;
