...
const content = `<path class="zb5affbix"/><g class="xigpo383m"><path class="kl68i8bgp"/><path class="x57g7cbon"/></g><path class="e1avnhwsp"/><path class="g3o1wvywp"/><path class="jo21i8bra"/><path class="runr8790n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:handshake-light-skin-tone" /></template>
<style>
.e1avnhwsp {
