...
const content = `<g class="cuyn6tgcc"><path class="rdgw364gf"/><path class="gz_wol42f"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:function-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
