...
const content = `<path class="v628eecfo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-insert-emoticon" /></template>
<style>
.v628eecfo {
  fill: currentColor;
