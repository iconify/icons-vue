...
const content = `<path class="sjc50khvy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-week-start-20-regular" /></template>
<style>
.sjc50khvy {
  fill: currentColor;
