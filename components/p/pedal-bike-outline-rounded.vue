...
const content = `<path class="d_b7bychx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pedal-bike-outline-rounded" /></template>
<style>
.d_b7bychx {
  fill: currentColor;
