...
const content = `<path class="syferqf5f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:motion-play-outline-sharp" /></template>
<style>
.syferqf5f {
  fill: currentColor;
