...
const content = `<path class="s389d1bbj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:5mp-outline-sharp" /></template>
<style>
.s389d1bbj {
  fill: currentColor;
