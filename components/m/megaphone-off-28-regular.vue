...
const content = `<path class="h50zujshp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:megaphone-off-28-regular" /></template>
<style>
.h50zujshp {
  fill: currentColor;
