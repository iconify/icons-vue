...
const content = `<path class="xcfn8ho2a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mbs-mobile-alt" /></template>
<style>
.xcfn8ho2a {
  fill: none;
  stroke: currentColor;
