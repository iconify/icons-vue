...
const content = `<path class="ywrut451c"/><defs><path id="SVGoA31icLk" class="bjmzlpb0p"/></defs><clipPath id="SVGNLTA2d2X"><use href="#SVGoA31icLk"/></clipPath><g clip-path="url(#SVGNLTA2d2X)" class="zlqwn85jm"><path class="lwf91icnv"/><path class="in13jbbco"/><path class="p01ge2b5z"/></g><defs><use href="#SVGoA31icLk" id="SVGdD5I5cfp"/></defs><clipPath id="SVGKcFlpchc"><use href="#SVGdD5I5cfp"/></clipPath><g clip-path="url(#SVGKcFlpchc)" class="j9_i7vu4q"><path class="gu8dh7a8f"/><path class="lt4r4bcau"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:palms-up-together-medium-light-skin-tone" /></template>
<style>
.bjmzlpb0p {
