...
const content = `<g class="cuyn6tgcc"><path class="rno7hacaa"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:circle-big-filled-circle-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
