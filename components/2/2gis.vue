...
const content = `<path class="ll0g54h-q"/><path class="d5k9e5bal"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:2gis" /></template>
<style>
.d5k9e5bal {
  fill: none;
  stroke: currentColor;
