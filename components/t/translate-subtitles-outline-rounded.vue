...
const content = `<path class="iufku6bau"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:translate-subtitles-outline-rounded" /></template>
<style>
.iufku6bau {
  fill: currentColor;
