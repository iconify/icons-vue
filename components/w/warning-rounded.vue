...
const content = `<path class="tzyzoz_kd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:warning-rounded" /></template>
<style>
.tzyzoz_kd {
  fill: currentColor;
