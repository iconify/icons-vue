...
const content = `<path class="az7pobb_w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-nine-thin" /></template>
<style>
.az7pobb_w {
  fill: currentColor;
