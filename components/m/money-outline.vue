...
const content = `<path class="vho1vofvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:money-outline" /></template>
<style>
.vho1vofvo {
  fill: currentColor;
