...
const content = `<path class="a00t9ibkh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:team-dashboard-outline-rounded" /></template>
<style>
.a00t9ibkh {
  fill: currentColor;
