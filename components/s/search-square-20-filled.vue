...
const content = `<path class="kyntp_b8x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:search-square-20-filled" /></template>
<style>
.kyntp_b8x {
  fill: currentColor;
