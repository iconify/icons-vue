...
const content = `<path class="tab-6nh8u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-two-20-regular" /></template>
<style>
.tab-6nh8u {
  fill: currentColor;
