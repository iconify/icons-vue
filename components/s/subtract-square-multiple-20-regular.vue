...
const content = `<path class="htld5q68e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:subtract-square-multiple-20-regular" /></template>
<style>
.htld5q68e {
  fill: currentColor;
