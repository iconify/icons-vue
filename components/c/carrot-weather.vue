...
const content = `<path class="yw-9borvy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:carrot-weather" /></template>
<style>
.yw-9borvy {
  fill: none;
  stroke: currentColor;
