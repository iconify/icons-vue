...
const content = `<path class="do73-hb6c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:php-outline" /></template>
<style>
.do73-hb6c {
  fill: currentColor;
