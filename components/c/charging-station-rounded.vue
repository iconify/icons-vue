...
const content = `<path class="gw1045tkz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:charging-station-rounded" /></template>
<style>
.gw1045tkz {
  fill: currentColor;
