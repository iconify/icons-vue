...
const content = `<path class="pa8yyebhz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:split-horizontal-24-regular" /></template>
<style>
.pa8yyebhz {
  fill: currentColor;
