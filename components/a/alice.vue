...
const content = `<g class="ft5dv1b6b"><path class="ocgxlmbjk"/><path class="y3mc7bc6q"/><path class="i45r8lqsq"/><path class="wqyiyyegi"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:alice" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
