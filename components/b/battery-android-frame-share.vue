...
const content = `<path class="tt0ogybzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-android-frame-share" /></template>
<style>
.tt0ogybzh {
  fill: currentColor;
