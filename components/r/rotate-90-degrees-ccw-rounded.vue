...
const content = `<path class="k7gc5oxrc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:rotate-90-degrees-ccw-rounded" /></template>
<style>
.k7gc5oxrc {
  fill: currentColor;
