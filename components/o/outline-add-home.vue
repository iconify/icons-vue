...
const content = `<path class="ksbzsnyie"/><path class="a4tj93cqy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-add-home" /></template>
<style>
.a4tj93cqy {
  fill: currentColor;
