...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-quarter-fill" /></template>
<style>
.i3ri9tbis {
...
.lidcpw1ys {
  d: path("M12 6C15.3138 6 18 8.6862 18 12L12 12Z");
}
