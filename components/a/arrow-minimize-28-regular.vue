...
const content = `<path class="rtciquh4j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-minimize-28-regular" /></template>
<style>
.rtciquh4j {
  fill: currentColor;
