...
const content = `<path class="hl2dqbcwr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:monitor-weight-loss-outline" /></template>
<style>
.hl2dqbcwr {
  fill: currentColor;
