...
const content = `<path class="ry3duvbiv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-1-20-filled" /></template>
<style>
.ry3duvbiv {
  fill: currentColor;
