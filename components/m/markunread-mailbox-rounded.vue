...
const content = `<path class="s54huzb7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:markunread-mailbox-rounded" /></template>
<style>
.s54huzb7l {
  fill: currentColor;
