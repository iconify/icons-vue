...
const content = `<path class="mv9jh981r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:timer-arrow-up-outline-rounded" /></template>
<style>
.mv9jh981r {
  fill: currentColor;
