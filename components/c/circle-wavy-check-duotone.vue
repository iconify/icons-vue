...
const content = `<path class="b-9inxaad"/><path class="doxvmlbny"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:circle-wavy-check-duotone" /></template>
<style>
.b-9inxaad {
  fill: currentColor;
