...
const content = `<path class="b3kpchbbs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-wake-on-approach-rounded" /></template>
<style>
.b3kpchbbs {
  fill: currentColor;
