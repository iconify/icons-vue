...
const content = `<path class="se9d1pb0w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-in-right-20-regular" /></template>
<style>
.se9d1pb0w {
  fill: currentColor;
