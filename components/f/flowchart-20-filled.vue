...
const content = `<path class="rmbzlbcpm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flowchart-20-filled" /></template>
<style>
.rmbzlbcpm {
  fill: currentColor;
