...
const content = `<path class="fzqho7bbw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sell-cloud" /></template>
<style>
.fzqho7bbw {
  fill: currentColor;
