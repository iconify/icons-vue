...
const content = `<path class="hjs5bhb9y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:emoji-objects-outline" /></template>
<style>
.hjs5bhb9y {
  fill: currentColor;
