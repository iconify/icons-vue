...
const content = `<path class="jq753dbsl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-android-bolt-outline" /></template>
<style>
.jq753dbsl {
  fill: currentColor;
