...
const content = `<path class="n-a4_bcqr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:alrajhi-bank" /></template>
<style>
.n-a4_bcqr {
  fill: none;
  stroke: currentColor;
