...
const content = `<path class="dqj2kgxik"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-left-28-filled" /></template>
<style>
.dqj2kgxik {
  fill: currentColor;
