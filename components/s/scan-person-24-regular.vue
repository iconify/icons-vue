...
const content = `<path class="rky3kwbie"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-person-24-regular" /></template>
<style>
.rky3kwbie {
  fill: currentColor;
