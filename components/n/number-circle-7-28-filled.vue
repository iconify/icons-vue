...
const content = `<path class="et_5ey2wx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-7-28-filled" /></template>
<style>
.et_5ey2wx {
  fill: currentColor;
