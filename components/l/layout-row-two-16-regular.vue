...
const content = `<path class="og3_7vb8t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-two-16-regular" /></template>
<style>
.og3_7vb8t {
  fill: currentColor;
