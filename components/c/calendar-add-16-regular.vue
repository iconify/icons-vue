...
const content = `<path class="m1pa2ucmv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-add-16-regular" /></template>
<style>
.m1pa2ucmv {
  fill: currentColor;
