...
const content = `<path class="nxeo_knif"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:payments-outline-sharp" /></template>
<style>
.nxeo_knif {
  fill: currentColor;
