...
const content = `<path class="otrmdab8d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-speaker-off-20-filled" /></template>
<style>
.otrmdab8d {
  fill: currentColor;
