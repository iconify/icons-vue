...
const content = `<path class="wc3s07w3f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:rbru-app" /></template>
<style>
.wc3s07w3f {
  fill: none;
  stroke: currentColor;
