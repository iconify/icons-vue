...
const content = `<path class="c731h0bdt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:water-full-outline-rounded" /></template>
<style>
.c731h0bdt {
  fill: currentColor;
