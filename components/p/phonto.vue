...
const content = `<path class="i9clfwm2k"/><path class="tdhe33bcc"/><path class="b4wrgvqyz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:phonto" /></template>
<style>
.b4wrgvqyz {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M25.278 31.98s1.865.631 2.73 1.234c.864.602 2.09 2.119 2.09 2.119m-2.089-2.119l7.117-10.173");
}
