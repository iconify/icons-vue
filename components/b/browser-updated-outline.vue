...
const content = `<path class="ic25qccim"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:browser-updated-outline" /></template>
<style>
.ic25qccim {
  fill: currentColor;
