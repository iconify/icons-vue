...
const content = `<path class="tsi107bqg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:closed-caption-add-sharp" /></template>
<style>
.tsi107bqg {
  fill: currentColor;
