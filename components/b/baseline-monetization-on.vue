...
const content = `<path class="x8gkshlmh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-monetization-on" /></template>
<style>
.x8gkshlmh {
  fill: currentColor;
