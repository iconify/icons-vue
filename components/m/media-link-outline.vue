...
const content = `<path class="qf71_nz_h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:media-link-outline" /></template>
<style>
.qf71_nz_h {
  fill: currentColor;
