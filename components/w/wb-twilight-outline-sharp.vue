...
const content = `<path class="mifajxbsw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wb-twilight-outline-sharp" /></template>
<style>
.mifajxbsw {
  fill: currentColor;
