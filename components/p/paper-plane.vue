...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="hybdfpesc"/><path class="lwc5gtlli"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:paper-plane" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
