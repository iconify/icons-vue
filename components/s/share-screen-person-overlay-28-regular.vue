...
const content = `<path class="kqk9vm02p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-screen-person-overlay-28-regular" /></template>
<style>
.kqk9vm02p {
  fill: currentColor;
