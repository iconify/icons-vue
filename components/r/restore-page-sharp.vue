...
const content = `<path class="b_hoykbkp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:restore-page-sharp" /></template>
<style>
.b_hoykbkp {
  fill: currentColor;
