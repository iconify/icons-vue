...
const content = `<g class="nrj6p8qat"><path class="ibfob3b8f"/><path class="aimqgdczn"/><path class="q-qndji8q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:server-plus-duotone" /></template>
<style>
.aimqgdczn {
