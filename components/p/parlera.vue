...
const content = `<path class="m-pgbvbqp"/><path class="znnighh0e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:parlera" /></template>
<style>
.m-pgbvbqp {
  fill: none;
  stroke: currentColor;
