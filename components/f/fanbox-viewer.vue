...
const content = `<path class="d5fdbg5le"/><path class="f6eu3_b0t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fanbox-viewer" /></template>
<style>
.d5fdbg5le {
  fill: none;
  stroke: currentColor;
