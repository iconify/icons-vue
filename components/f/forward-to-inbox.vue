...
const content = `<path class="aakc5-8kx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:forward-to-inbox" /></template>
<style>
.aakc5-8kx {
  fill: currentColor;
