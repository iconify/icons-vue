...
const content = `<path class="negay1bzr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-edit-24-filled" /></template>
<style>
.negay1bzr {
  fill: currentColor;
