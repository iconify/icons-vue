...
const content = `<path class="fz_4ucckh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:transit-ticket-outline-sharp" /></template>
<style>
.fz_4ucckh {
  fill: currentColor;
