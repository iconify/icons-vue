...
const content = `<path class="y4vfe2bhe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-warning-20-regular" /></template>
<style>
.y4vfe2bhe {
  fill: currentColor;
