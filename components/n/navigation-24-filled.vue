...
const content = `<path class="ocpny8bop"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:navigation-24-filled" /></template>
<style>
.ocpny8bop {
  fill: currentColor;
