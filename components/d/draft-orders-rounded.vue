...
const content = `<path class="b-yt5246o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:draft-orders-rounded" /></template>
<style>
.b-yt5246o {
  fill: currentColor;
