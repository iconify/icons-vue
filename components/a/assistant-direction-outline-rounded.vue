...
const content = `<path class="qwy4urbop"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:assistant-direction-outline-rounded" /></template>
<style>
.qwy4urbop {
  fill: currentColor;
