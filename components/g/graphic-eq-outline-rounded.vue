...
const content = `<path class="fetjy70uk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:graphic-eq-outline-rounded" /></template>
<style>
.fetjy70uk {
  fill: currentColor;
