...
const content = `<path class="rds6imv3c"/><path class="ain98ybuh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:surfshark" /></template>
<style>
.ain98ybuh {
  fill: none;
  stroke: currentColor;
