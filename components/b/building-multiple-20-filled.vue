...
const content = `<path class="mvd2_oy5l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-multiple-20-filled" /></template>
<style>
.mvd2_oy5l {
  fill: currentColor;
