...
const content = `<path class="ow29dwbla"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fun-with-kanji" /></template>
<style>
.ow29dwbla {
  fill: none;
  stroke: currentColor;
