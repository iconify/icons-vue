...
const content = `<path class="qdnehrbkw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:multiselect-rtl-20-regular" /></template>
<style>
.qdnehrbkw {
  fill: currentColor;
