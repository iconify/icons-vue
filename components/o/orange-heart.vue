...
const content = `<path class="egk9n6b1y"/><path class="sia1oqbmn"/><path class="iv-bm2bme"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:orange-heart" /></template>
<style>
.egk9n6b1y {
