...
const content = `<path class="bz9ljzb7d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bed-rounded" /></template>
<style>
.bz9ljzb7d {
  fill: currentColor;
