...
const content = `<path class="uvaulu-cu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:speaker-notes-outline-sharp" /></template>
<style>
.uvaulu-cu {
  fill: currentColor;
