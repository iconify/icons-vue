...
const content = `<path class="twghclbmt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:candlestick-chart-rounded" /></template>
<style>
.twghclbmt {
  fill: currentColor;
