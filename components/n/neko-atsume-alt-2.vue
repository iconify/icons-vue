...
const content = `<path class="h4q2e_bfs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:neko-atsume-alt-2" /></template>
<style>
.h4q2e_bfs {
  fill: none;
  stroke: currentColor;
