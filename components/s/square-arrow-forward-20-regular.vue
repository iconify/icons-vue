...
const content = `<path class="nul0gwb6m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-arrow-forward-20-regular" /></template>
<style>
.nul0gwb6m {
  fill: currentColor;
