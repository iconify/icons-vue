...
const content = `<path class="pkd97527w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-apps-48-regular" /></template>
<style>
.pkd97527w {
  fill: currentColor;
