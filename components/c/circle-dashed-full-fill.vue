...
const content = `<g class="nrj6p8qat"><path class="i3ri9tbis"/><path class="r_9ly7e1o"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-full-fill" /></template>
<style>
.i3ri9tbis {
