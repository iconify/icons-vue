...
const content = `<path class="p61_7ibgn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-comments-disabled" /></template>
<style>
.p61_7ibgn {
  fill: currentColor;
