...
const content = `<path class="knxp2do9n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:precision-manufacturing-outline-rounded" /></template>
<style>
.knxp2do9n {
  fill: currentColor;
