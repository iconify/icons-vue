...
const content = `<path class="vwoi4ce7w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-eraser-16-regular" /></template>
<style>
.vwoi4ce7w {
  fill: currentColor;
