...
const content = `<path class="zzj4y4bcm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-up-outline-sharp" /></template>
<style>
.zzj4y4bcm {
  fill: currentColor;
