...
const content = `<path class="w9uh9ppaq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:music-note-2-20-regular" /></template>
<style>
.w9uh9ppaq {
  fill: currentColor;
