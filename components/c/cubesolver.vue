...
const content = `<path class="ejg-6obws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cubesolver" /></template>
<style>
.ejg-6obws {
  fill: none;
  stroke: currentColor;
