...
const content = `<path class="nes-cyqxp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-paste-24-regular" /></template>
<style>
.nes-cyqxp {
  fill: currentColor;
