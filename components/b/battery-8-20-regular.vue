...
const content = `<path class="shk7i6yee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-8-20-regular" /></template>
<style>
.shk7i6yee {
  fill: currentColor;
