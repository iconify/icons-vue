...
const content = `<path class="wph790v0d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-link-24-regular" /></template>
<style>
.wph790v0d {
  fill: currentColor;
