...
const content = `<path class="podabcrkk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:board-split-28-regular" /></template>
<style>
.podabcrkk {
  fill: currentColor;
