...
const content = `<path class="ylrn6dlyl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:design-services-rounded" /></template>
<style>
.ylrn6dlyl {
  fill: currentColor;
