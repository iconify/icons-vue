...
const content = `<path class="vuetwkwqe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:exposure-zero-outline-sharp" /></template>
<style>
.vuetwkwqe {
  fill: currentColor;
