...
const content = `<path class="ll0g54h-q"/><path class="tkj88icsg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:shop" /></template>
<style>
.ll0g54h-q {
  fill: none;
  stroke: currentColor;
