...
const content = `<path class="bnvkb5b3m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dual-screen-arrow-up-24-filled" /></template>
<style>
.bnvkb5b3m {
  fill: currentColor;
