...
const content = `<path class="hnnvxlb0u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sprinkler-outline-sharp" /></template>
<style>
.hnnvxlb0u {
  fill: currentColor;
