...
const content = `<path class="mh2fgmbvg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:clean-hands-sharp" /></template>
<style>
.mh2fgmbvg {
  fill: currentColor;
