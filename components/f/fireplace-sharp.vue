...
const content = `<path class="z28s3ucep"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fireplace-sharp" /></template>
<style>
.z28s3ucep {
  fill: currentColor;
