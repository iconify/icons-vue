...
const content = `<path class="ht79-ohdk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-in-left-24-regular" /></template>
<style>
.ht79-ohdk {
  fill: currentColor;
