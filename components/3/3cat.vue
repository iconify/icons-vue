...
const content = `<path class="i9clfwm2k"/><path class="s_vtsndxu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:3cat" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
