...
const content = `<path class="exk-zybvq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-up" /></template>
<style>
.exk-zybvq {
  fill: none;
  stroke: currentColor;
