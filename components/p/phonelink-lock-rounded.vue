...
const content = `<path class="g_jvysbie"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phonelink-lock-rounded" /></template>
<style>
.g_jvysbie {
  fill: currentColor;
