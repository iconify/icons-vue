...
const content = `<path class="k7rvm8xuf"/><path class="jpmdgm50e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-bookmark-remove" /></template>
<style>
.jpmdgm50e {
  fill: currentColor;
