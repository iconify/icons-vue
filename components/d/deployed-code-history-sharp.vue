...
const content = `<path class="dohbfdpac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:deployed-code-history-sharp" /></template>
<style>
.dohbfdpac {
  fill: currentColor;
