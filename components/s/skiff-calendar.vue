...
const content = `<rect class="ftofplbbd"/><path class="i8bgmhbsg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:skiff-calendar" /></template>
<style>
.ftofplbbd {
  width: 37px;
  height: 37px;
