...
const content = `<path class="tis4j4brh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:aq-indoor-sharp" /></template>
<style>
.tis4j4brh {
  fill: currentColor;
