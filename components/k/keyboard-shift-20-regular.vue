...
const content = `<path class="t0qw37b-l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:keyboard-shift-20-regular" /></template>
<style>
.t0qw37b-l {
  fill: currentColor;
