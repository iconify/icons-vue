...
const content = `<path class="tx7loxbkz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:star-shine-outline-rounded" /></template>
<style>
.tx7loxbkz {
  fill: currentColor;
