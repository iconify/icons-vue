...
const content = `<path class="tgjuev17i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:claw" /></template>
<style>
.tgjuev17i {
  fill: none;
  stroke: currentColor;
