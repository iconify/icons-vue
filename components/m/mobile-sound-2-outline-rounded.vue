...
const content = `<path class="c667ykbar"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-sound-2-outline-rounded" /></template>
<style>
.c667ykbar {
  fill: currentColor;
