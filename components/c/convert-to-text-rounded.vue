...
const content = `<path class="j2cysmbzk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:convert-to-text-rounded" /></template>
<style>
.j2cysmbzk {
  fill: currentColor;
