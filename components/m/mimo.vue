...
const content = `<path class="p-_md438e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mimo" /></template>
<style>
.p-_md438e {
  fill: currentColor;
