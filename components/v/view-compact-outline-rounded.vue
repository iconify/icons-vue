...
const content = `<path class="wkkh1bbil"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:view-compact-outline-rounded" /></template>
<style>
.wkkh1bbil {
  fill: currentColor;
