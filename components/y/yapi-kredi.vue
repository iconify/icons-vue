...
const content = `<path class="rd00_qs8p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:yapi-kredi" /></template>
<style>
.rd00_qs8p {
  fill: none;
  stroke: currentColor;
