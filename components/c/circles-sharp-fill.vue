...
const content = `<path clip-rule="evenodd" class="ya4cjjcke"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circles-sharp-fill" /></template>
<style>
.ya4cjjcke {
  fill: currentColor;
  fill-rule: evenodd;
