...
const content = `<path class="nwq1vzb2z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-bullet-list-add-20-regular" /></template>
<style>
.nwq1vzb2z {
  fill: currentColor;
