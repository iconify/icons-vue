...
const content = `<path class="h9300kbkd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:inking-tool-24-regular" /></template>
<style>
.h9300kbkd {
  fill: currentColor;
