...
const content = `<path class="w-lw-ubju"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:translate-cc-outline" /></template>
<style>
.w-lw-ubju {
  fill: currentColor;
