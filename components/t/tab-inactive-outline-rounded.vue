...
const content = `<path class="k50ow8bff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tab-inactive-outline-rounded" /></template>
<style>
.k50ow8bff {
  fill: currentColor;
