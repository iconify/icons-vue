...
const content = `<path class="js2j24bnq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:lightbulb-2-outline" /></template>
<style>
.js2j24bnq {
  fill: currentColor;
