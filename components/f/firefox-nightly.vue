...
const content = `<path class="vrb_t-b2q"/><path class="jawti_bhv"/><circle class="vi_nxfq0r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:firefox-nightly" /></template>
<style>
.jawti_bhv {
  fill: none;
  stroke: currentColor;
...
.vrb_t-b2q {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M35.977 42.692v-8l5.3 8v-8");
}
