...
const content = `<path class="v02751b7o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-car-24-filled" /></template>
<style>
.v02751b7o {
  fill: currentColor;
