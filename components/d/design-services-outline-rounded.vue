...
const content = `<path class="zgshnibxp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:design-services-outline-rounded" /></template>
<style>
.zgshnibxp {
  fill: currentColor;
