...
const content = `<path class="wt59tpbbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-sad-slight-24-filled" /></template>
<style>
.wt59tpbbq {
  fill: currentColor;
