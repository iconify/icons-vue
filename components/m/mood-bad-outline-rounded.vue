...
const content = `<path class="wnn8_roqx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mood-bad-outline-rounded" /></template>
<style>
.wnn8_roqx {
  fill: currentColor;
