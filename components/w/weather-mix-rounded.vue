...
const content = `<path class="h5xohmbno"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:weather-mix-rounded" /></template>
<style>
.h5xohmbno {
  fill: currentColor;
