...
const content = `<path class="eprf7ccgj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sos-outline-sharp" /></template>
<style>
.eprf7ccgj {
  fill: currentColor;
