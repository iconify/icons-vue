...
const content = `<path class="btwlh4bku"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-behind-24-regular" /></template>
<style>
.btwlh4bku {
  fill: currentColor;
