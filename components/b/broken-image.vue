...
const content = `<path class="a66c6bbgp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:broken-image" /></template>
<style>
.a66c6bbgp {
  fill: currentColor;
