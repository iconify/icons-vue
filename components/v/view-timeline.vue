...
const content = `<path class="dmghaiv-r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:view-timeline" /></template>
<style>
.dmghaiv-r {
  fill: currentColor;
