...
const content = `<path class="ru3_pmbej"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:atom-meditation" /></template>
<style>
.ru3_pmbej {
  fill: none;
  stroke: currentColor;
