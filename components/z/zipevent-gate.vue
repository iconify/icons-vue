...
const content = `<path class="o6ii0zwlr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:zipevent-gate" /></template>
<style>
.o6ii0zwlr {
  fill: none;
  stroke: currentColor;
