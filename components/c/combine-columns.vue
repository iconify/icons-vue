...
const content = `<path class="n0y27rbnx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:combine-columns" /></template>
<style>
.n0y27rbnx {
  fill: currentColor;
