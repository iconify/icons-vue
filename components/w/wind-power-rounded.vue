...
const content = `<path class="il2kd3blv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wind-power-rounded" /></template>
<style>
.il2kd3blv {
  fill: currentColor;
