...
const content = `<path class="kkihq8btw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:delete-dismiss-24-filled" /></template>
<style>
.kkihq8btw {
  fill: currentColor;
