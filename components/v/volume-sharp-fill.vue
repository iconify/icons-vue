...
const content = `<g class="gp_8x1bzb"><path class="tquoxdmeg"/><path class="ajg3myurd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:volume-sharp-fill" /></template>
<style>
.ajg3myurd {
