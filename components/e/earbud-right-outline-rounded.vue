...
const content = `<path class="hq7kfdcxj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:earbud-right-outline-rounded" /></template>
<style>
.hq7kfdcxj {
  fill: currentColor;
