...
const content = `<path class="csjjrodqk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:no-sound-outline-sharp" /></template>
<style>
.csjjrodqk {
  fill: currentColor;
