...
const content = `<g class="cuyn6tgcc"><path class="dm5w4csla"/><path class="wfvwu545c"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:dice-two-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
