...
const content = `<g class="nrj6p8qat"><path class="xgaf0nbdt"/><path class="c7--g1yoy"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-check" /></template>
<style>
.c7--g1yoy {
  d: path("M8 12L10.6667 15L16 9");
}
