...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="td37jglex"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:circle-big-circle" /></template>
<style>
.hdxpysbbn {
