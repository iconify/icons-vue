...
const content = `<path class="iixgb8z1f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:view-object-track-sharp" /></template>
<style>
.iixgb8z1f {
  fill: currentColor;
