...
const content = `<path class="g5xsvq1di"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-cursor-24-filled" /></template>
<style>
.g5xsvq1di {
  fill: currentColor;
