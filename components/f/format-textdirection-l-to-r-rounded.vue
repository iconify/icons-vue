...
const content = `<path class="o12ybzwvg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-textdirection-l-to-r-rounded" /></template>
<style>
.o12ybzwvg {
  fill: currentColor;
