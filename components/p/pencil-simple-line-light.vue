...
const content = `<path class="nqq298bve"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:pencil-simple-line-light" /></template>
<style>
.nqq298bve {
  fill: currentColor;
