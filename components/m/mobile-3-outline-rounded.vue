...
const content = `<path class="o0cc32gyt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-3-outline-rounded" /></template>
<style>
.o0cc32gyt {
  fill: currentColor;
