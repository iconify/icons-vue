...
const content = `<g class="ft5dv1b6b"><path clip-rule="evenodd" class="xl59_abuc"/><path class="a8gcqhb5c"/><path class="c_o2qqbza"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:fun" /></template>
<style>
.a8gcqhb5c {
  fill: var(--svg-color--000, #000);
  d: path("M4.058 8.256v7.624c0 .508.37.9.8 1.154l6.554 3.796c.323.19.593.038.588-.328v-8.164c0-.17-.175-.333-.318-.423L4.768 7.833a.46.46 0 0 0-.572.074a.5.5 0 0 0-.138.344z");
  opacity: var(--svg-opacity--0-1, 0.1);
}

.c_o2qqbza {
  fill: var(--svg-color--000, #000);
  d: path("m19.227 7.816l-6.984 4.04a.5.5 0 0 0-.243.428v8.058c0 .366.35.625.667.44l6.565-3.775a1.43 1.43 0 0 0 .71-1.25V8.24a.48.48 0 0 0-.281-.45a.47.47 0 0 0-.424.031");
