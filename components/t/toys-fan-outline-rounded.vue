...
const content = `<path class="zlj96bc5h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:toys-fan-outline-rounded" /></template>
<style>
.zlj96bc5h {
  fill: currentColor;
