...
const content = `<path class="uasjb7bvp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ice-skating-outline-rounded" /></template>
<style>
.uasjb7bvp {
  fill: currentColor;
