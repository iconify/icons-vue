...
const content = `<path class="l_x_ho7nh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vertical-align-bottom-outline-rounded" /></template>
<style>
.l_x_ho7nh {
  fill: currentColor;
