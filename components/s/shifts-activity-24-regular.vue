...
const content = `<path class="h0kj9vbfq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shifts-activity-24-regular" /></template>
<style>
.h0kj9vbfq {
  fill: currentColor;
