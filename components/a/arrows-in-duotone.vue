...
const content = `<g class="cuyn6tgcc"><path class="kbgxg_7rn"/><path class="si_sr_bpl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrows-in-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
