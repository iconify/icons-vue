...
const content = `<path class="vwtpkbb6n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:analytics" /></template>
<style>
.vwtpkbb6n {
  fill: currentColor;
