...
const content = `<path class="xezi14bmo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:file-upload-off-outline" /></template>
<style>
.xezi14bmo {
  fill: currentColor;
