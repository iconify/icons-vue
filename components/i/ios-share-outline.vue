...
const content = `<path class="bjsut3bfn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ios-share-outline" /></template>
<style>
.bjsut3bfn {
  fill: currentColor;
