...
const content = `<path class="yikocrb9f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:watch-vibration-outline-rounded" /></template>
<style>
.yikocrb9f {
  fill: currentColor;
