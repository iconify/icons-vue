...
const content = `<path class="bzspaxb5g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:rounded-corner-outline-sharp" /></template>
<style>
.bzspaxb5g {
  fill: currentColor;
