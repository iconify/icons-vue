...
const content = `<path class="wrrp_mboi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:weather-hail-rounded" /></template>
<style>
.wrrp_mboi {
  fill: currentColor;
