...
const content = `<path class="e3-h29_oq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:horizontal-align-right-rounded" /></template>
<style>
.e3-h29_oq {
  fill: currentColor;
