...
const content = `<path class="ytq4-pbww"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:emoji-people-outline-sharp" /></template>
<style>
.ytq4-pbww {
  fill: currentColor;
