...
const content = `<path class="hbxvoqnik"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:nfc-outline-sharp" /></template>
<style>
.hbxvoqnik {
  fill: currentColor;
