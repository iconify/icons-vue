...
const content = `<path class="t6le2gb_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:sound-wave-circle-28-regular" /></template>
<style>
.t6le2gb_k {
  fill: currentColor;
