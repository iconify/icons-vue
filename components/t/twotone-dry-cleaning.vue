...
const content = `<path class="udbs4ab9g"/><path class="txug0gblm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-dry-cleaning" /></template>
<style>
.txug0gblm {
  fill: currentColor;
