...
const content = `<path class="s26x9cc2p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-android-frame-full-outline-rounded" /></template>
<style>
.s26x9cc2p {
  fill: currentColor;
