...
const content = `<path class="qsad8xbqb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:stream-input-20-filled" /></template>
<style>
.qsad8xbqb {
  fill: currentColor;
  ...
  opacity: var(--svg-opacity--0-79, 0.79);
}
