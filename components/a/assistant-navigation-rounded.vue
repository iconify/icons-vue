...
const content = `<path class="nr65eubpt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:assistant-navigation-rounded" /></template>
<style>
.nr65eubpt {
  fill: currentColor;
