...
const content = `<path class="bh-yxsa4m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-right-24-regular" /></template>
<style>
.bh-yxsa4m {
  fill: currentColor;
