...
const content = `<path class="q8flc_hcg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-column-left" /></template>
<style>
.q8flc_hcg {
  fill: currentColor;
