...
const content = `<path class="m2eejbbwu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:brand-awareness-outline-sharp" /></template>
<style>
.m2eejbbwu {
  fill: currentColor;
