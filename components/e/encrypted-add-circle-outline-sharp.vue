...
const content = `<path class="pcp9rjbhk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:encrypted-add-circle-outline-sharp" /></template>
<style>
.pcp9rjbhk {
  fill: currentColor;
