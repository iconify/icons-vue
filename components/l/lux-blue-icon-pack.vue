...
const content = `<path class="c_bqz6btl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lux-blue-icon-pack" /></template>
<style>
.c_bqz6btl {
  fill: none;
  stroke: currentColor;
