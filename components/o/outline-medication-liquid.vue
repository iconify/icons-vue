...
const content = `<path class="dazs4ibex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-medication-liquid" /></template>
<style>
.dazs4ibex {
  fill: currentColor;
