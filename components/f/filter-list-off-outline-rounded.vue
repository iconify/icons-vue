...
const content = `<path class="q1myuwbqm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:filter-list-off-outline-rounded" /></template>
<style>
.q1myuwbqm {
  fill: currentColor;
