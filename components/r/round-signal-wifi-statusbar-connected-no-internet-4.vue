...
const content = `<path class="wm7f2etqw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-signal-wifi-statusbar-connected-no-internet-4" /></template>
<style>
.wm7f2etqw {
  fill: currentColor;
