...
const content = `<path class="cose7eblh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sports-esports-sharp" /></template>
<style>
.cose7eblh {
  fill: currentColor;
