...
const content = `<path class="ymq-2ac7o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:music-note-2-play-20-regular" /></template>
<style>
.ymq-2ac7o {
  fill: currentColor;
