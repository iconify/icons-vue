...
const content = `<path class="fxcp_7b5n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:crown-rounded" /></template>
<style>
.fxcp_7b5n {
  fill: currentColor;
