...
const content = `<path class="d_1fue4nh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-desktop-arrow-clockwise-16-regular" /></template>
<style>
.d_1fue4nh {
  fill: currentColor;
