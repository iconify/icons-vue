...
const content = `<path class="k63arwbep"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hard-disk-rounded" /></template>
<style>
.k63arwbep {
  fill: currentColor;
