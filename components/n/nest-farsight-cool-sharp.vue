...
const content = `<path class="qixkqzb4o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-farsight-cool-sharp" /></template>
<style>
.qixkqzb4o {
  fill: currentColor;
