...
const content = `<path class="oewnf9byy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mobile-optimized-32-regular" /></template>
<style>
.oewnf9byy {
  fill: currentColor;
