...
const content = `<path class="pb775rcvu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:remember-me-rounded" /></template>
<style>
.pb775rcvu {
  fill: currentColor;
