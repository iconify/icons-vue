...
const content = `<path class="jqu9edbel"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-square-24-filled" /></template>
<style>
.jqu9edbel {
  fill: currentColor;
