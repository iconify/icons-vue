...
const content = `<path class="x8obi_s5i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brunch-dining-outline-rounded" /></template>
<style>
.x8obi_s5i {
  fill: currentColor;
