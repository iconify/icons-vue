...
const content = `<path class="e9_x4-yon"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:metronome-alt" /></template>
<style>
.e9_x4-yon {
  fill: none;
  stroke: currentColor;
