...
const content = `<g class="gp_8x1bzb"><path class="uordzqcti"/><path clip-rule="evenodd" class="r0p7iiqoh"/><path class="c2i48fg0d"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-plus-sharp-duotone" /></template>
<style>
.c2i48fg0d {
