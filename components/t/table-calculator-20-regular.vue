...
const content = `<path class="o0bcrc1ds"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-calculator-20-regular" /></template>
<style>
.o0bcrc1ds {
  fill: currentColor;
