...
const content = `<path class="sx0zub8az"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-grammar-wand-24-regular" /></template>
<style>
.sx0zub8az {
  fill: currentColor;
