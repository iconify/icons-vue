...
const content = `<path class="sm32udbtx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-split-20-regular" /></template>
<style>
.sm32udbtx {
  fill: currentColor;
