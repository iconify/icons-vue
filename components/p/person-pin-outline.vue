...
const content = `<path class="d_pfcobpi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:person-pin-outline" /></template>
<style>
.d_pfcobpi {
  fill: currentColor;
