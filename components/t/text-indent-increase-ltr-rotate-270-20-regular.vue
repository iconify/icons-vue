...
const content = `<path class="h24i-6eig"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-increase-ltr-rotate-270-20-regular" /></template>
<style>
.h24i-6eig {
  fill: currentColor;
