...
const content = `<path class="env_uebwj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:home-max-dots-rounded" /></template>
<style>
.env_uebwj {
  fill: currentColor;
