...
const content = `<path class="eb6gj1xsx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:game-stick-l3-sharp" /></template>
<style>
.eb6gj1xsx {
  fill: currentColor;
