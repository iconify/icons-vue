...
const content = `<path class="w1mwz_3uj"/><path class="v8qc18bax"/><path class="kbnt-53fe"/><path class="apd4j2b9j"/><path class="x1lu53b3w"/><path class="egv546b5j"/><path class="bz65lrx9s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:woman-gesturing-ok" /></template>
<style>
.apd4j2b9j {
