...
const content = `<path class="si3zyobhd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:group-sharp" /></template>
<style>
.si3zyobhd {
  fill: currentColor;
