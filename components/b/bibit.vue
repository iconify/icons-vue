...
const content = `<path class="su5r_cnzw"/><path class="m_hdwhbev"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bibit" /></template>
<style>
.m_hdwhbev {
  fill: none;
  stroke: currentColor;
