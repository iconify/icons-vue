...
const content = `<path class="kqi41_aza"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:triangle-circle" /></template>
<style>
.kqi41_aza {
  fill: currentColor;
