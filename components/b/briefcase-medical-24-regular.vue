...
const content = `<path class="uwfdgkmlg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:briefcase-medical-24-regular" /></template>
<style>
.uwfdgkmlg {
  fill: currentColor;
