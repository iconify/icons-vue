...
const content = `<path class="g63vxwb5j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:lab-profile-rounded" /></template>
<style>
.g63vxwb5j {
  fill: currentColor;
