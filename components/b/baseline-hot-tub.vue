...
const content = `<circle class="j_-2hxbof"/><path class="l36d-wbwt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-hot-tub" /></template>
<style>
.j_-2hxbof {
  cx: 7px;
  cy: 6px;
