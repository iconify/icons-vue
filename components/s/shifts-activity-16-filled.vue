...
const content = `<path class="l9-vsozih"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shifts-activity-16-filled" /></template>
<style>
.l9-vsozih {
  fill: currentColor;
