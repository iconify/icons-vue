...
const content = `<path class="qvowqskuc"/><path class="vnk26xu0x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:crew" /></template>
<style>
.qvowqskuc {
  fill: none;
  stroke: currentColor;
