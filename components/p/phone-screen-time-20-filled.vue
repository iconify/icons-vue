...
const content = `<path class="s4o89wq7o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-screen-time-20-filled" /></template>
<style>
.s4o89wq7o {
  fill: currentColor;
