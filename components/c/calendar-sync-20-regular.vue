...
const content = `<path class="z7twidbbf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-sync-20-regular" /></template>
<style>
.z7twidbbf {
  fill: currentColor;
