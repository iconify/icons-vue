...
const content = `<path class="noojjmbbh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:filter-2-rounded" /></template>
<style>
.noojjmbbh {
  fill: currentColor;
