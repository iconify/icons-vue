...
const content = `<path class="mk2tg7pvb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:person-off-outline-sharp" /></template>
<style>
.mk2tg7pvb {
  fill: currentColor;
