...
const content = `<path class="cep_peb5q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:collapse-content-outline-rounded" /></template>
<style>
.cep_peb5q {
  fill: currentColor;
