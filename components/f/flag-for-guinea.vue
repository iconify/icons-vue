...
const content = `<path class="apxht593w"/><path class="arudnqcpi"/><path class="qczurlbnk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-guinea" /></template>
<style>
.apxht593w {
