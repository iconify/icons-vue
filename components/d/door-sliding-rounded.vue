...
const content = `<path class="s87-_phdx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:door-sliding-rounded" /></template>
<style>
.s87-_phdx {
  fill: currentColor;
