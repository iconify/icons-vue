...
const content = `<path class="atv-t7bgi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:speed-camera-outline-rounded" /></template>
<style>
.atv-t7bgi {
  fill: currentColor;
