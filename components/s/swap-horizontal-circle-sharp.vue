...
const content = `<path class="gsq-qybcq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swap-horizontal-circle-sharp" /></template>
<style>
.gsq-qybcq {
  fill: currentColor;
