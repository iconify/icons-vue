...
const content = `<path class="lt6fqpbll"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:reset-image-outline-sharp" /></template>
<style>
.lt6fqpbll {
  fill: currentColor;
