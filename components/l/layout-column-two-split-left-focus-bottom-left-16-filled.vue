...
const content = `<path class="of9ayv1-e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-column-two-split-left-focus-bottom-left-16-filled" /></template>
<style>
.of9ayv1-e {
  fill: currentColor;
