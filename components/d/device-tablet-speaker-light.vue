...
const content = `<path class="unmzjybxj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:device-tablet-speaker-light" /></template>
<style>
.unmzjybxj {
  fill: currentColor;
