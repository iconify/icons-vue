...
const content = `<path class="diebjs8dh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:offline-pin" /></template>
<style>
.diebjs8dh {
  fill: currentColor;
