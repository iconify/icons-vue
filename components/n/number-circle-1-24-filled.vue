...
const content = `<path class="akytpnb6c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-1-24-filled" /></template>
<style>
.akytpnb6c {
  fill: currentColor;
