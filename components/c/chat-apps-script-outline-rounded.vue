...
const content = `<path class="l5gj0bbac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chat-apps-script-outline-rounded" /></template>
<style>
.l5gj0bbac {
  fill: currentColor;
