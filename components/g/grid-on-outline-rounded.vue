...
const content = `<path class="evu1mkb5h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:grid-on-outline-rounded" /></template>
<style>
.evu1mkb5h {
  fill: currentColor;
