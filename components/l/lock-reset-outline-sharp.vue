...
const content = `<path class="gonp04g6k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lock-reset-outline-sharp" /></template>
<style>
.gonp04g6k {
  fill: currentColor;
