...
const content = `<path class="xf3v7-bdb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cable-outline-sharp" /></template>
<style>
.xf3v7-bdb {
  fill: currentColor;
