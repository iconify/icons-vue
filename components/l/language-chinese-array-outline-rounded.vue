...
const content = `<path class="q7dv98xpl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:language-chinese-array-outline-rounded" /></template>
<style>
.q7dv98xpl {
  fill: currentColor;
