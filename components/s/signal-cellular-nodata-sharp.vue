...
const content = `<path class="c3ea6nbda"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-cellular-nodata-sharp" /></template>
<style>
.c3ea6nbda {
  fill: currentColor;
