...
const content = `<path class="oef8n2hej"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:presence-available-20-regular" /></template>
<style>
.oef8n2hej {
  fill: currentColor;
