...
const content = `<path class="bbiuddbrr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:lightbulb-16-regular" /></template>
<style>
.bbiuddbrr {
  fill: currentColor;
