...
const content = `<path class="qdpg902rm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:assignment-late-sharp" /></template>
<style>
.qdpg902rm {
  fill: currentColor;
