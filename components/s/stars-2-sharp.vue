...
const content = `<path class="c9m14-bmw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stars-2-sharp" /></template>
<style>
.c9m14-bmw {
  fill: currentColor;
