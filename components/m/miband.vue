...
const content = `<path class="f2aq60dtp"/><path class="zclypo0se"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:miband" /></template>
<style>
.f2aq60dtp {
  fill: none;
  stroke: currentColor;
