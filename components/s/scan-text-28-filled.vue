...
const content = `<path class="hahw6ebxv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-text-28-filled" /></template>
<style>
.hahw6ebxv {
  fill: currentColor;
