...
const content = `<path class="r_dxujbmd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:heap-snapshot-multiple-outline-sharp" /></template>
<style>
.r_dxujbmd {
  fill: currentColor;
