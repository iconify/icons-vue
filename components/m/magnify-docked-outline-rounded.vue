...
const content = `<path class="ztivdqg-o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:magnify-docked-outline-rounded" /></template>
<style>
.ztivdqg-o {
  fill: currentColor;
