...
const content = `<path class="sd_0mvj7b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-multiple-32-filled" /></template>
<style>
.sd_0mvj7b {
  fill: currentColor;
