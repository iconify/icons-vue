...
const content = `<path class="pm3gef3fz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-drizzle-48-regular" /></template>
<style>
.pm3gef3fz {
  fill: currentColor;
