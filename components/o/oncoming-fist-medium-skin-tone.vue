...
const content = `<path class="zl3vw1b4q"/><path class="gefb4rbnv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:oncoming-fist-medium-skin-tone" /></template>
<style>
.gefb4rbnv {
