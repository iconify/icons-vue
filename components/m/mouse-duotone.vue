...
const content = `<g class="cuyn6tgcc"><path class="u3oxtwb2k"/><path class="x-cvb7bpp"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:mouse-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
