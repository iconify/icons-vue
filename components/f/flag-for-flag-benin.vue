...
const content = `<path class="a-54mdb9i"/><path class="zwq1gquwf"/><path class="apm0bwb7m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-benin" /></template>
<style>
.a-54mdb9i {
