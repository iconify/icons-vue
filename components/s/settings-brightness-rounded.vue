...
const content = `<path class="qzipb7bgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-brightness-rounded" /></template>
<style>
.qzipb7bgh {
  fill: currentColor;
