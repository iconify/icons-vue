...
const content = `<path class="j_7j1yr0b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:undereye-sharp" /></template>
<style>
.j_7j1yr0b {
  fill: currentColor;
