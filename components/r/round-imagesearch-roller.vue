...
const content = `<path class="vgu1bmbty"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-imagesearch-roller" /></template>
<style>
.vgu1bmbty {
  fill: currentColor;
