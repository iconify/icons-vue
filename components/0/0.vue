...
const content = `<linearGradient id="svgIDa" x1="64.01" x2="64.01" y1="101.193" y2="29.735" gradientUnits="userSpaceOnUse"><stop offset=".485" class="j1rdzyw_l"/><stop offset="1" class="vlzxxcccm"/></linearGradient><path fill="url(#svgIDa)" class="g-1p2pbnh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:0" /></template>
<style>
.g-1p2pbnh {
