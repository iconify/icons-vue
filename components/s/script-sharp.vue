...
const content = `<path class="iw5tccbrd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:script-sharp" /></template>
<style>
.iw5tccbrd {
  fill: currentColor;
