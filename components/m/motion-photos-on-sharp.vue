...
const content = `<path class="cvx3a7zxn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:motion-photos-on-sharp" /></template>
<style>
.cvx3a7zxn {
  fill: currentColor;
