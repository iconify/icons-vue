...
const content = `<path class="iboitsbqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wifi-add-sharp" /></template>
<style>
.iboitsbqq {
  fill: currentColor;
