...
const content = `<path class="pd73_wb2p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:temple-buddhist" /></template>
<style>
.pd73_wb2p {
  fill: currentColor;
