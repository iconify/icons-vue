...
const content = `<path class="fn6kuzb2g"/><path class="wd0crhb2d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:rightwards-hand-light-skin-tone" /></template>
<style>
.fn6kuzb2g {
