...
const content = `<path class="vpw_69-tc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:padding-right-24-regular" /></template>
<style>
.vpw_69-tc {
  fill: currentColor;
