...
const content = `<path class="a4p7fbcud"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chromecast-device-rounded" /></template>
<style>
.a4p7fbcud {
  fill: currentColor;
