...
const content = `<path class="e04uyvn0d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-swap-vertical-circle" /></template>
<style>
.e04uyvn0d {
  fill: currentColor;
