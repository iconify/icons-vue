...
const content = `<path class="lishsz4_i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:man-2" /></template>
<style>
.lishsz4_i {
  fill: currentColor;
