...
const content = `<path class="ilox-pbol"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:closed-caption-off-24-filled" /></template>
<style>
.ilox-pbol {
  fill: currentColor;
