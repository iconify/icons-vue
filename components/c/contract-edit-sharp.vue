...
const content = `<path class="ntvpt9b3p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:contract-edit-sharp" /></template>
<style>
.ntvpt9b3p {
  fill: currentColor;
