...
const content = `<path class="abnghebpo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-ribbon-16-filled" /></template>
<style>
.abnghebpo {
  fill: currentColor;
