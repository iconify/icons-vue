...
const content = `<path class="n6kk82b9h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-view-rounded" /></template>
<style>
.n6kk82b9h {
  fill: currentColor;
