...
const content = `<path class="yltlzqp7w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fiber-smart-record-outline-rounded" /></template>
<style>
.yltlzqp7w {
  fill: currentColor;
