...
const content = `<path class="xw4xx-b0q"/><circle class="hc9dg9bkk"/><circle class="r41r8tbfs"/><circle class="oad6wkbea"/><circle class="hwinkrx8l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:games-3" /></template>
<style>
.hc9dg9bkk {
  cx: 13.738px;
  cy: 18.712px;
