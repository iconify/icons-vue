...
.zstfocr6i {
  ...
  stroke: currentColor;
  stroke-linejoin: round;
  d: path("m34.406 26.605l-2.149-2.149a1.27 1.27 0 0 1-.343-.598a1.4 1.4 0 0 1 .002-.677a1.24 1.24 0 0 1 .341-.59q.261-.256.596-.34a1.34 1.34 0 0 1 1.268.34l.285.277l.284-.276a1.32 1.32 0 0 1 1.266-.341q.337.085.598.34q.255.252.34.59q.087.336 0 .677q-.082.341-.34.598z");
}
