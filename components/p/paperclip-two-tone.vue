...
const content = `<path class="sdaqwbcvd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:paperclip-two-tone" /></template>
<style>
.sdaqwbcvd {
  fill: none;
  stroke: currentColor;
