...
const content = `<path class="n6j7f3fqk"/><path class="eoj3fnesg"/><path class="s87cl7bbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-finland" /></template>
<style>
.eoj3fnesg {
