...
const content = `<path class="cluog_b0a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-add-24-regular" /></template>
<style>
.cluog_b0a {
  fill: currentColor;
