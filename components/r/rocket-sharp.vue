...
const content = `<path class="cg9g-ctoq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:rocket-sharp" /></template>
<style>
.cg9g-ctoq {
  fill: none;
  stroke: currentColor;
