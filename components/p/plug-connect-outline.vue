...
const content = `<path class="d-2bplbvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:plug-connect-outline" /></template>
<style>
.d-2bplbvo {
  fill: currentColor;
