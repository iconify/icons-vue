...
const content = `<path class="avqxdkr3z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-alert-32-regular" /></template>
<style>
.avqxdkr3z {
  fill: currentColor;
