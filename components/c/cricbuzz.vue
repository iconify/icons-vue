...
const content = `<circle class="cpk0fnbgt"/><path class="uvhl6gb8e"/><path class="w7r4j95vj"/><path class="dz3f9vb3k"/>`;
</script>
...
.dz3f9vb3k {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M21.408 30.224c-.898 1.365-2.707 2.13-4.4 1.928h0a4.885 4.885 0 0 1-4.26-5.413l.375-3.144a4.885 4.885 0 0 1 5.414-4.26h0c1.693.202 3.27 1.37 3.823 2.908");
}
