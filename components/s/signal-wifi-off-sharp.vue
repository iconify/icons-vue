...
const content = `<path class="m-avj4v1t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:signal-wifi-off-sharp" /></template>
<style>
.m-avj4v1t {
  fill: currentColor;
