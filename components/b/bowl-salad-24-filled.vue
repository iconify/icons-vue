...
const content = `<path class="qo52_nect"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bowl-salad-24-filled" /></template>
<style>
.qo52_nect {
  fill: currentColor;
