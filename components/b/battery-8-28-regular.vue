...
const content = `<path class="x56wrlbdr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-8-28-regular" /></template>
<style>
.x56wrlbdr {
  fill: currentColor;
