...
const content = `<path class="upydsybct"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:water-do-rounded" /></template>
<style>
.upydsybct {
  fill: currentColor;
