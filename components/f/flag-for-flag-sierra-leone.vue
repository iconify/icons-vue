...
const content = `<path class="fwg2hi05o"/><path class="ec63smi6v"/><path class="mh79h9x1l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-sierra-leone" /></template>
<style>
.ec63smi6v {
