...
const content = `<path class="m3c1p2a-d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:outgoing-mail-outline-sharp" /></template>
<style>
.m3c1p2a-d {
  fill: currentColor;
