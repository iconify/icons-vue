...
const content = `<path class="iupny026a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:av-timer-outline-rounded" /></template>
<style>
.iupny026a {
  fill: currentColor;
