...
const content = `<path class="h9sbo6lre"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phonelink-erase" /></template>
<style>
.h9sbo6lre {
  fill: currentColor;
