...
const content = `<path class="cp443-u-w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-external-input" /></template>
<style>
.cp443-u-w {
  fill: currentColor;
