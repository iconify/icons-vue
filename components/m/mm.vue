...
const content = `<g class="y9tr6bcfx"><path class="piarl2bel"/><path class="rw09zsbqf"/><path class="tqe3clkcz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mm" /></template>
<style>
.piarl2bel {
