...
const content = `<path class="s14qp9brx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:top-panel-close-outline-rounded" /></template>
<style>
.s14qp9brx {
  fill: currentColor;
