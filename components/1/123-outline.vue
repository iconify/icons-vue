...
const content = `<path class="musdqpbsn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:123-outline" /></template>
<style>
.musdqpbsn {
  fill: currentColor;
