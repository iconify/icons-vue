...
const content = `<path class="te-9_wm-a"/><path class="e39xfgbkl"/><path class="du_bhkhbm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:heart-hands" /></template>
<style>
.du_bhkhbm {
