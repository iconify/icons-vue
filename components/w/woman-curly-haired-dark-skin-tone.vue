...
const content = `<path class="nkb5j7bem"/><linearGradient id="SVGmo0UWd9T" x1="64" x2="64" y1="35.759" y2="8" gradientTransform="matrix(1 0 0 -1 0 130)" gradientUnits="userSpaceOnUse"><stop offset="0" class="xb94qyb-t"/><stop offset=".705" class="ci_fo_bpd"/><stop offset="1" class="u3kz4vb7l"/></linearGradient><path fill="url(#SVGmo0UWd9T)" class="em9qpibty"/><path class="epkcdmbyf"/><path class="kur726bre"/><path class="mwxqwobtb"/><g class="d2ol71wkq"><ellipse class="n8fq1s3jv"/><ellipse class="gba0l8b6i"/></g><path class="al09tpbdo"/><path class="mki1jk6jw"/><path class="imds-1rbg"/><radialGradient id="SVGg8l2MeMF" cx="63.798" cy="46.819" r="49.836" gradientTransform="rotate(-.109 64.883 50.393)" gradientUnits="userSpaceOnUse"><stop offset=".725" class="qpo2vg_rh"/><stop offset="1" class="g00j4bcaa"/></radialGradient><path fill="url(#SVGg8l2MeMF)" class="e7gfutlzg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:woman-curly-haired-dark-skin-tone" /></template>
<style>
.al09tpbdo {
