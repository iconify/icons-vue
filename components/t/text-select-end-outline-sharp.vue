...
const content = `<path class="wf-voab1s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-select-end-outline-sharp" /></template>
<style>
.wf-voab1s {
  fill: currentColor;
