...
const content = `<path class="xjr_yxbil"/><path class="xd-kx3b9d"/><path class="p20xozb-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:animex-wallpaper" /></template>
<style>
.p20xozb-j {
  fill: none;
  stroke: currentColor;
