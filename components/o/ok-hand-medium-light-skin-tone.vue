...
const content = `<path class="yenfoac1c"/><path class="mcn1v16ec"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:ok-hand-medium-light-skin-tone" /></template>
<style>
.mcn1v16ec {
