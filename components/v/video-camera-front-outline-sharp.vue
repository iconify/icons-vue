...
const content = `<path class="bzkzbefgp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:video-camera-front-outline-sharp" /></template>
<style>
.bzkzbefgp {
  fill: currentColor;
