...
const content = `<path class="b-a1onbka"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:money-hand-24-filled" /></template>
<style>
.b-a1onbka {
  fill: currentColor;
