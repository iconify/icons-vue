...
const content = `<path class="qnm_hl_zi"/><path class="ptiy6tbup"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-cancel-schedule-send" /></template>
<style>
.ptiy6tbup {
  fill: currentColor;
