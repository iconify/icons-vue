...
const content = `<path class="osmwteloa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrows-bidirectional-20-filled" /></template>
<style>
.osmwteloa {
  fill: currentColor;
