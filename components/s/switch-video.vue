...
const content = `<path class="u9j1eptgo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:switch-video" /></template>
<style>
.u9j1eptgo {
  fill: currentColor;
