...
const content = `<path class="m3ox6q7or"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:barcode-outline-rounded" /></template>
<style>
.m3ox6q7or {
  fill: currentColor;
