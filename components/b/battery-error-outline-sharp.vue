...
const content = `<path class="zd661e5mk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-error-outline-sharp" /></template>
<style>
.zd661e5mk {
  fill: currentColor;
