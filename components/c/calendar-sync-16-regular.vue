...
const content = `<path class="u7aripifr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-sync-16-regular" /></template>
<style>
.u7aripifr {
  fill: currentColor;
