...
const content = `<path class="yz0dwkbrd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-note-32-filled" /></template>
<style>
.yz0dwkbrd {
  fill: currentColor;
