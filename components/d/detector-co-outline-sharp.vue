...
const content = `<path class="yutugdbku"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:detector-co-outline-sharp" /></template>
<style>
.yutugdbku {
  fill: currentColor;
