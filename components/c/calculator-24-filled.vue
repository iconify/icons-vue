...
const content = `<path class="fjukcabzw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calculator-24-filled" /></template>
<style>
.fjukcabzw {
  fill: currentColor;
