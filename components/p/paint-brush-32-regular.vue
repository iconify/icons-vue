...
const content = `<path class="bdhqdjb3v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:paint-brush-32-regular" /></template>
<style>
.bdhqdjb3v {
  fill: currentColor;
