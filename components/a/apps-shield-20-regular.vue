...
const content = `<path class="ne6dzogrt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:apps-shield-20-regular" /></template>
<style>
.ne6dzogrt {
  fill: currentColor;
