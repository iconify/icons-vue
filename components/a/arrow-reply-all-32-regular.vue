...
const content = `<path class="q_mvc3zpt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-reply-all-32-regular" /></template>
<style>
.q_mvc3zpt {
  fill: currentColor;
