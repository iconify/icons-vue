...
const content = `<path class="t7lxhzbse"/><path class="qsv5997ug"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-display-settings" /></template>
<style>
.qsv5997ug {
  fill: currentColor;
