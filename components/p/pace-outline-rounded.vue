...
const content = `<path class="fghlfxyug"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pace-outline-rounded" /></template>
<style>
.fghlfxyug {
  fill: currentColor;
