...
const content = `<path class="z0gf66_nq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:voice-chat-off" /></template>
<style>
.z0gf66_nq {
  fill: currentColor;
