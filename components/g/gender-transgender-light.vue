...
const content = `<path class="t21pc252c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:gender-transgender-light" /></template>
<style>
.t21pc252c {
  fill: currentColor;
