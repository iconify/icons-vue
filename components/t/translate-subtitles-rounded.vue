...
const content = `<path class="rwm5jgbdi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:translate-subtitles-rounded" /></template>
<style>
.rwm5jgbdi {
  fill: currentColor;
