...
const content = `<g class="cuyn6tgcc"><g transform="translate(3 3)"><path clip-rule="evenodd" class="uafdunbzf"/><rect class="ilr5o7bbz"/><path class="xedf9ccsf"/></g><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:flag-circle-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
