...
const content = `<path class="tq3ukxb1a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:inbox-outline-rounded" /></template>
<style>
.tq3ukxb1a {
  fill: currentColor;
