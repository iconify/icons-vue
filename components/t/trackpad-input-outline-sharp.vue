...
const content = `<path class="g5z-ururl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:trackpad-input-outline-sharp" /></template>
<style>
.g5z-ururl {
  fill: currentColor;
