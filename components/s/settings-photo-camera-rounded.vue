...
const content = `<path class="hxvnksbwc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-photo-camera-rounded" /></template>
<style>
.hxvnksbwc {
  fill: currentColor;
