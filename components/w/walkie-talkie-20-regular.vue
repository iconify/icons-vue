...
const content = `<g class="cuyn6tgcc"><path class="e783_m30a"/><path class="tml441l0k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:walkie-talkie-20-regular" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
