...
const content = `<path class="jtjajci7q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sign-language-outline-sharp" /></template>
<style>
.jtjajci7q {
  fill: currentColor;
