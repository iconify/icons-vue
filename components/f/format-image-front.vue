...
const content = `<path class="m_46d465c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-image-front" /></template>
<style>
.m_46d465c {
  fill: currentColor;
