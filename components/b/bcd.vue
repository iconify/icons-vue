...
const content = `<g class="ft5dv1b6b"><path class="ucixhtbwu"/><path class="tzb6gibqz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:bcd" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
