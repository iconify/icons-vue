...
const content = `<path class="f552yc-ri"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:picture-in-picture-center-outline-rounded" /></template>
<style>
.f552yc-ri {
  fill: currentColor;
