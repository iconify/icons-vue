...
const content = `<path class="oc8yyh74e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:linea-icon" /></template>
<style>
.oc8yyh74e {
  fill: none;
  stroke: currentColor;
