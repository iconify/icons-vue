...
const content = `<path class="w-wq22_fe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mic-record-24-filled" /></template>
<style>
.w-wq22_fe {
  fill: currentColor;
