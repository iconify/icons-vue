...
const content = `<path class="b-7x8ybuq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:do-not-touch-sharp" /></template>
<style>
.b-7x8ybuq {
  fill: currentColor;
