...
const content = `<path class="e6me14bnr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calculator-multiple-20-regular" /></template>
<style>
.e6me14bnr {
  fill: currentColor;
