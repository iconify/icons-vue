...
const content = `<path class="oziro_2gv"/><path class="io94gnb0p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:microsoft-word" /></template>
<style>
.io94gnb0p {
  fill: none;
  stroke: currentColor;
