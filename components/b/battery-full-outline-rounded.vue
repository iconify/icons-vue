...
const content = `<path class="zti7-3btq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-full-outline-rounded" /></template>
<style>
.zti7-3btq {
  fill: currentColor;
