...
const content = `<path class="hzu00ca8b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-curve-down-left-16-filled" /></template>
<style>
.hzu00ca8b {
  fill: currentColor;
