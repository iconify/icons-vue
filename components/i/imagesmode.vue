...
const content = `<path class="yu-3ixbin"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:imagesmode" /></template>
<style>
.yu-3ixbin {
  fill: currentColor;
