...
const content = `<path class="hqo02kvlc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:airtable" /></template>
<style>
.hqo02kvlc {
  fill: none;
  stroke: currentColor;
