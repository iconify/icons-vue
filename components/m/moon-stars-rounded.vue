...
const content = `<path class="o17qx8_el"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:moon-stars-rounded" /></template>
<style>
.o17qx8_el {
  fill: currentColor;
