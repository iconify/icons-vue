...
const content = `<path class="a078x0b7t"/><path class="g4rubnb4z"/><path class="wwhky_b5e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:haven" /></template>
<style>
.a078x0b7t {
  fill: none;
  stroke: currentColor;
