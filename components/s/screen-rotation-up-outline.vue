...
const content = `<path class="h_2bfibrz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:screen-rotation-up-outline" /></template>
<style>
.h_2bfibrz {
  fill: currentColor;
