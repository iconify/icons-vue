...
const content = `<path class="hjm778bsl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:contactless-payment-light" /></template>
<style>
.hjm778bsl {
  fill: currentColor;
