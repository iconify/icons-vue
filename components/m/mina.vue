...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGeI61B8Pt)" clip-rule="evenodd" class="e3s09zwxu"/><defs><linearGradient id="SVGeI61B8Pt" x1="12.837" x2="12.463" y1="3.561" y2="18.13" gradientUnits="userSpaceOnUse"><stop class="yhbg5lb8l"/><stop offset=".394" class="q5aca_buc"/><stop offset=".561" class="dpr1be7tb"/><stop offset="1" class="dn3mfnbou"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:mina" /></template>
<style>
.dn3mfnbou {
