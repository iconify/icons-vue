...
const content = `<path class="pp375nbxx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:receipt-long-outline-sharp" /></template>
<style>
.pp375nbxx {
  fill: currentColor;
