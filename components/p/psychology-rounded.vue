...
const content = `<path class="xftg986xh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:psychology-rounded" /></template>
<style>
.xftg986xh {
  fill: currentColor;
