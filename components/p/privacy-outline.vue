...
const content = `<path class="d2ew9475a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:privacy-outline" /></template>
<style>
.d2ew9475a {
  fill: currentColor;
