...
const content = `<g class="cuyn6tgcc"><path class="m43firhht"/><path class="c0v7wf7zi"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:shield-chevron-duotone" /></template>
<style>
.c0v7wf7zi {
...
.m43firhht {
  d: path("M202 171.78C177.13 218.6 128 232 128 232s-49.13-13.4-74-60.22L128 120Z");
