...
const content = `<g class="nrj6p8qat"><path class="fe4pabiai"/><path class="wim8d8ecu"/><path class="qjum4lbgt"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:keyboard-duotone" /></template>
<style>
.fe4pabiai {
  fill: currentColor;
