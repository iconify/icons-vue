...
const content = `<path class="bgi2tvy5r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-justify-flex-start-rounded" /></template>
<style>
.bgi2tvy5r {
  fill: currentColor;
