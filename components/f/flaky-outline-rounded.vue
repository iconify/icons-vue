...
const content = `<path class="dblevacpj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:flaky-outline-rounded" /></template>
<style>
.dblevacpj {
  fill: currentColor;
