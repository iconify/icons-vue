...
const content = `<path class="u5kciwzrp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:padding-top-20-filled" /></template>
<style>
.u5kciwzrp {
  fill: currentColor;
