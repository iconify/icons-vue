...
const content = `<path class="y92ydgiyv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:memory-alt-outline" /></template>
<style>
.y92ydgiyv {
  fill: currentColor;
