...
const content = `<path class="d5alknb7c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tilt-arrow-up-outline-rounded" /></template>
<style>
.d5alknb7c {
  fill: currentColor;
