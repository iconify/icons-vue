...
const content = `<path class="cyru6fa2y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-fan-low-right-outline-sharp" /></template>
<style>
.cyru6fa2y {
  fill: currentColor;
