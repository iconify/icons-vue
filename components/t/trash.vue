...
const content = `<g class="cuyn6tgcc"><path class="rbe5wf74a"/><path class="ab7txzbjk"/><path clip-rule="evenodd" class="j6ace1oqn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:trash" /></template>
<style>
.ab7txzbjk {
