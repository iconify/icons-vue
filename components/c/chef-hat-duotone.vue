...
const content = `<g class="cuyn6tgcc"><path class="ytkt4ob9r"/><path class="wvav1u5qd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:chef-hat-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
