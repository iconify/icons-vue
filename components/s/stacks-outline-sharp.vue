...
const content = `<path class="fg3t63bhj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stacks-outline-sharp" /></template>
<style>
.fg3t63bhj {
  fill: currentColor;
