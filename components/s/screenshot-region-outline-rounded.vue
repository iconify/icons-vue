...
const content = `<path class="oguy3mb8q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:screenshot-region-outline-rounded" /></template>
<style>
.oguy3mb8q {
  fill: currentColor;
