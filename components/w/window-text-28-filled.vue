...
const content = `<path class="hxf0scbmx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-text-28-filled" /></template>
<style>
.hxf0scbmx {
  fill: currentColor;
