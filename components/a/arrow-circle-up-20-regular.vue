...
const content = `<path class="otxzkxi8w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-up-20-regular" /></template>
<style>
.otxzkxi8w {
  fill: currentColor;
