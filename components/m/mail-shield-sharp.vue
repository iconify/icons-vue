...
const content = `<path class="z08a5lkle"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mail-shield-sharp" /></template>
<style>
.z08a5lkle {
  fill: currentColor;
