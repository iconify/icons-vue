...
const content = `<g class="ft5dv1b6b"><path class="h5j6rbbtc"/><path class="ur31x5b8d"/><path class="t_ln7sp3n"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:renbtc" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
