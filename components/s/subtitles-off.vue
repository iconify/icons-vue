...
const content = `<path class="rndag7-re"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:subtitles-off" /></template>
<style>
.rndag7-re {
  fill: currentColor;
