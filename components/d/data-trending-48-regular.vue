...
const content = `<path class="phaiv-tre"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-trending-48-regular" /></template>
<style>
.phaiv-tre {
  fill: currentColor;
