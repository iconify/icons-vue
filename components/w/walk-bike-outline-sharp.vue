...
const content = `<path class="ll3vq7kji"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:walk-bike-outline-sharp" /></template>
<style>
.ll3vq7kji {
  fill: currentColor;
