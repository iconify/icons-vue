...
const content = `<path class="xt1um3x1l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-circle-up-outline-rounded" /></template>
<style>
.xt1um3x1l {
  fill: currentColor;
