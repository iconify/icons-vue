...
const content = `<path class="p95q0foll"/><path class="krkwucpse"/><path class="xcy7nyedm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:brown-heart" /></template>
<style>
.krkwucpse {
  fill: var(--svg-color--965a45, #965a45);
...
.p95q0foll {
  fill: var(--svg-color--b76d54, #b76d54);
...
.xcy7nyedm {
  fill: var(--svg-color--e09a84, #e09a84);
