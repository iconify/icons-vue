...
const content = `<path class="x-9a97bmf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:accessibility-checkmark-32-filled" /></template>
<style>
.x-9a97bmf {
  fill: currentColor;
