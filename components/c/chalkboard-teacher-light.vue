...
const content = `<path class="he-48z6nl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:chalkboard-teacher-light" /></template>
<style>
.he-48z6nl {
  fill: currentColor;
