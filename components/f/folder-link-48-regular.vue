...
const content = `<path class="i3qg3vbdp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-link-48-regular" /></template>
<style>
.i3qg3vbdp {
  fill: currentColor;
