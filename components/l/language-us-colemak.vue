...
const content = `<path class="d6id4bchy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:language-us-colemak" /></template>
<style>
.d6id4bchy {
  fill: currentColor;
