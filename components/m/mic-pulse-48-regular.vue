...
const content = `<path class="zviq3xufw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mic-pulse-48-regular" /></template>
<style>
.zviq3xufw {
  fill: currentColor;
