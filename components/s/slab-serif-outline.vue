...
const content = `<path class="jofi20bkh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:slab-serif-outline" /></template>
<style>
.jofi20bkh {
  fill: currentColor;
