...
const content = `<path class="o_qiusnnf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:space-3d-48-regular" /></template>
<style>
.o_qiusnnf {
  fill: currentColor;
