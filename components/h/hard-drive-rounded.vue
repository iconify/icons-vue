...
const content = `<path class="i37j08p9x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hard-drive-rounded" /></template>
<style>
.i37j08p9x {
  fill: currentColor;
