...
const content = `<path class="n7fn2sb4t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-column-one-wide-24-regular" /></template>
<style>
.n7fn2sb4t {
  fill: currentColor;
