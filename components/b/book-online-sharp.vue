...
const content = `<path class="da79h8b_e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:book-online-sharp" /></template>
<style>
.da79h8b_e {
  fill: currentColor;
