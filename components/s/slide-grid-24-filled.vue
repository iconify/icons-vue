...
const content = `<path class="o22pnnkjn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-grid-24-filled" /></template>
<style>
.o22pnnkjn {
  fill: currentColor;
