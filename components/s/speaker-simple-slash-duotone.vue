...
const content = `<g class="cuyn6tgcc"><path class="icps4mb-p"/><path class="e5-4pbcao"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:speaker-simple-slash-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
