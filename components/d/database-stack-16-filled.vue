...
const content = `<path class="pl4lq4dug"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:database-stack-16-filled" /></template>
<style>
.pl4lq4dug {
  fill: currentColor;
