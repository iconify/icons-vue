...
const content = `<path class="vwyjrpb1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drink-coffee-24-filled" /></template>
<style>
.vwyjrpb1j {
  fill: currentColor;
