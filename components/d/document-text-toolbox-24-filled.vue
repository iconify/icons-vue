...
const content = `<path class="rk6_0-bnc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-text-toolbox-24-filled" /></template>
<style>
.rk6_0-bnc {
  fill: currentColor;
