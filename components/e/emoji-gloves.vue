...
const content = `<path class="i1lk_3mmb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-gloves" /></template>
<style>
.i1lk_3mmb {
  fill: none;
  stroke: currentColor;
