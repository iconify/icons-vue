...
const content = `<path class="nnwzeqber"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:trueid" /></template>
<style>
.nnwzeqber {
  fill: none;
  stroke: currentColor;
