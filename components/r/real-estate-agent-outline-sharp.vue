...
const content = `<path class="qbn3ldb6n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:real-estate-agent-outline-sharp" /></template>
<style>
.qbn3ldb6n {
  fill: currentColor;
