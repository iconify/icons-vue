...
const content = `<path class="xol8xwimt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:do-not-disturb-on-rounded" /></template>
<style>
.xol8xwimt {
  fill: currentColor;
