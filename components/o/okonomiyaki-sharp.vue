...
const content = `<path class="ssnjw2bnn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:okonomiyaki-sharp" /></template>
<style>
.ssnjw2bnn {
  fill: currentColor;
