...
const content = `<path class="ioh3p9bxb"/><path class="t5kdzgb-p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-maps-ugc" /></template>
<style>
.ioh3p9bxb {
  fill: currentColor;
