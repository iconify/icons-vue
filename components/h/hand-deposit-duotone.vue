...
const content = `<g class="cuyn6tgcc"><path class="b203r7b5e"/><path class="rnzrcbb6x"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:hand-deposit-duotone" /></template>
<style>
.b203r7b5e {
  d: path("M184 96v106.31L173.32 186a20 20 0 0 0-36.9 14H56V96a8 8 0 0 1 8-8h112a8 8 0 0 1 8 8");
