...
const content = `<path class="l7zbaacyj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:glasses-off-16-filled" /></template>
<style>
.l7zbaacyj {
  fill: currentColor;
