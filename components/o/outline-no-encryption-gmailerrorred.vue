...
const content = `<path class="qt4wv2a6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-no-encryption-gmailerrorred" /></template>
<style>
.qt4wv2a6u {
  fill: currentColor;
