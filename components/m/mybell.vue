...
const content = `<path class="i9clfwm2k"/><path class="oacy_iqbb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mybell" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
