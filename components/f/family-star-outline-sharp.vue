...
const content = `<path class="tk5enpuxx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:family-star-outline-sharp" /></template>
<style>
.tk5enpuxx {
  fill: currentColor;
