...
const content = `<path class="tz61bebmn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:view-apps-rounded" /></template>
<style>
.tz61bebmn {
  fill: currentColor;
