...
const content = `<path class="cexrq910x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-ltr-48-regular" /></template>
<style>
.cexrq910x {
  fill: currentColor;
