...
const content = `<path class="cm9rxobbv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-read-multiple-16-regular" /></template>
<style>
.cm9rxobbv {
  fill: currentColor;
