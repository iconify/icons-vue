...
const content = `<path class="y7c240b_c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:server-person-outline-rounded" /></template>
<style>
.y7c240b_c {
  fill: currentColor;
