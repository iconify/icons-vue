...
const content = `<path class="vd3y2j2ww"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:home-max-dots-sharp" /></template>
<style>
.vd3y2j2ww {
  fill: currentColor;
