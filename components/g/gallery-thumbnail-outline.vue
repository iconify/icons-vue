...
const content = `<path class="wkzz-ibtj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:gallery-thumbnail-outline" /></template>
<style>
.wkzz-ibtj {
  fill: currentColor;
