...
const content = `<path class="fpz3yzbvc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-cellular-alt-2-bar-outline-rounded" /></template>
<style>
.fpz3yzbvc {
  fill: currentColor;
