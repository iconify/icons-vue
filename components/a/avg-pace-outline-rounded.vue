...
const content = `<path class="raph9vf0s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:avg-pace-outline-rounded" /></template>
<style>
.raph9vf0s {
  fill: currentColor;
