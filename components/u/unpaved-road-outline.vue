...
const content = `<path class="ivttl-bxr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:unpaved-road-outline" /></template>
<style>
.ivttl-bxr {
  fill: currentColor;
