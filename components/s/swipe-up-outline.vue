...
const content = `<path class="xm89sodwv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:swipe-up-outline" /></template>
<style>
.xm89sodwv {
  fill: currentColor;
