...
const content = `<path class="rlqadkbos"/><path class="ph-t8r_vp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-auto-delete" /></template>
<style>
.ph-t8r_vp {
  fill: currentColor;
