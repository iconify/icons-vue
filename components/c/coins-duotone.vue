...
const content = `<g class="cuyn6tgcc"><path class="svq2g7b-y"/><path class="lji29-b_v"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:coins-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.svq2g7b-y {
  d: path("M240 132c0 19.88-35.82 36-80 36c-19.6 0-37.56-3.17-51.47-8.44C146.76 156.85 176 142 176 124V96.72c36.52 3.34 64 17.86 64 35.28m-64-48c0-19.88-35.82-36-80-36S16 64.12 16 84s35.82 36 80 36s80-16.12 80-36");
