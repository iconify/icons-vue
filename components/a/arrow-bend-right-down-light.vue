...
const content = `<path class="upiyobcua"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-bend-right-down-light" /></template>
<style>
.upiyobcua {
  fill: currentColor;
