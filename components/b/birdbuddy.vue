...
const content = `<path class="m1qqjbzug"/><circle class="knebjacpk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:birdbuddy" /></template>
<style>
.knebjacpk {
  cx: 21.309px;
  cy: 17.84px;
