...
const content = `<path class="hsy33abeo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:heavy-plus-sign" /></template>
<style>
.hsy33abeo {
