...
const content = `<path class="bn6fpvbwl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nissan" /></template>
<style>
.bn6fpvbwl {
  fill: none;
  stroke: currentColor;
