...
const content = `<path class="ockqwjrmq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-number-list-rtl-28-regular" /></template>
<style>
.ockqwjrmq {
  fill: currentColor;
