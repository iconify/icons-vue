...
const content = `<path class="v9vbsf1ny"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tv-with-assistant-outline-sharp" /></template>
<style>
.v9vbsf1ny {
  fill: currentColor;
