...
const content = `<path class="ggdqq-w6r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:print-outline-rounded" /></template>
<style>
.ggdqq-w6r {
  fill: currentColor;
