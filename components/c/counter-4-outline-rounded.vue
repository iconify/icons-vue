...
const content = `<path class="hkxmb1bpv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:counter-4-outline-rounded" /></template>
<style>
.hkxmb1bpv {
  fill: currentColor;
