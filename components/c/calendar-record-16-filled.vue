...
const content = `<path class="ee78yzbll"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-record-16-filled" /></template>
<style>
.ee78yzbll {
  fill: currentColor;
