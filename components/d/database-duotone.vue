...
const content = `<g class="cuyn6tgcc"><path class="vbqyo9brb"/><path class="yv7vd5sbi"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:database-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.vbqyo9brb {
  d: path("M216 80c0 26.51-39.4 48-88 48s-88-21.49-88-48s39.4-48 88-48s88 21.49 88 48");
