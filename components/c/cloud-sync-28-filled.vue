...
const content = `<path class="kqvtonbeb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-sync-28-filled" /></template>
<style>
.kqvtonbeb {
  fill: currentColor;
