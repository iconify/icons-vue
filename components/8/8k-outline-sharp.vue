...
const content = `<path class="bv_5lvcvw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:8k-outline-sharp" /></template>
<style>
.bv_5lvcvw {
  fill: currentColor;
