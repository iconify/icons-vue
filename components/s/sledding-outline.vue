...
const content = `<path class="my-ek8bij"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sledding-outline" /></template>
<style>
.my-ek8bij {
  fill: currentColor;
