...
const content = `<g class="cuyn6tgcc"><path class="e8lis1llm"/><path class="rqzdfjbec"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:sidebar-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
