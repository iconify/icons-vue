...
const content = `<path class="l3fmvgbto"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:subwoofer-sharp" /></template>
<style>
.l3fmvgbto {
  fill: currentColor;
