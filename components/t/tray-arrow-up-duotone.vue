...
const content = `<g class="cuyn6tgcc"><path class="mystgmqmk"/><path class="mni3wgbdp"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:tray-arrow-up-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
