...
const content = `<path class="ou67ikz8b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:border-horizontal-outline-sharp" /></template>
<style>
.ou67ikz8b {
  fill: currentColor;
