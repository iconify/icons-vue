...
const content = `<path class="qy44prlyk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:savings-outline-rounded" /></template>
<style>
.qy44prlyk {
  fill: currentColor;
