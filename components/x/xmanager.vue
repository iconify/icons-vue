...
const content = `<path class="ng9rg1b2x"/><path class="mwfd5wbvq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:xmanager" /></template>
<style>
.mwfd5wbvq {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M34.57 25.62a22.15 22.15 0 0 0-7.5-6.62a22.15 22.15 0 0 0-9.5-3.18m11.81 13.75a16.4 16.4 0 0 0-5.58-4.94a16.34 16.34 0 0 0-7.06-2.36m7.92 10.42A10.56 10.56 0 0 0 21 29.46a10.46 10.46 0 0 0-4.62-1.54");
}
