...
const content = `<path class="t7o247bwa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:next-plan-rounded" /></template>
<style>
.t7o247bwa {
  fill: currentColor;
