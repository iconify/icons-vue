...
const content = `<path class="f7s6yhbsp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:check-alert-outline-rounded" /></template>
<style>
.f7s6yhbsp {
  fill: currentColor;
