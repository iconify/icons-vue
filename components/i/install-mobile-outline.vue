...
const content = `<path class="h7c45m_bu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:install-mobile-outline" /></template>
<style>
.h7c45m_bu {
  fill: currentColor;
