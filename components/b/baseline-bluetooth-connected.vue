...
const content = `<path class="poecy-beb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-bluetooth-connected" /></template>
<style>
.poecy-beb {
  fill: currentColor;
