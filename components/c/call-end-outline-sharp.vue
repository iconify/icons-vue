...
const content = `<path class="zhzc68msg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:call-end-outline-sharp" /></template>
<style>
.zhzc68msg {
  fill: currentColor;
