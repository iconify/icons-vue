...
const content = `<path class="dh1qqhbrc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:guilty-force" /></template>
<style>
.dh1qqhbrc {
  fill: none;
  stroke: currentColor;
