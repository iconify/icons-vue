...
const content = `<path class="n83u1zz3p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-border-vertical" /></template>
<style>
.n83u1zz3p {
  fill: currentColor;
