...
const content = `<path class="eih43kjcx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:humerus-alt-outline-sharp" /></template>
<style>
.eih43kjcx {
  fill: currentColor;
