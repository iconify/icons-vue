...
const content = `<path class="pklsvihpg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:brightness-empty-outline-sharp" /></template>
<style>
.pklsvihpg {
  fill: currentColor;
