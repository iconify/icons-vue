...
const content = `<path class="t8qjrnhrt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-curve-up-right-20-regular" /></template>
<style>
.t8qjrnhrt {
  fill: currentColor;
