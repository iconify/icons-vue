...
const content = `<path class="hwon2eb-o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:smart-toy-rounded" /></template>
<style>
.hwon2eb-o {
  fill: currentColor;
