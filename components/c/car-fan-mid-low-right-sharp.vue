...
const content = `<path class="u836jzbjr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-fan-mid-low-right-sharp" /></template>
<style>
.u836jzbjr {
  fill: currentColor;
