...
const content = `<path class="jdhc5gmnb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:plug-connect-rounded" /></template>
<style>
.jdhc5gmnb {
  fill: currentColor;
