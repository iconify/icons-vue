...
const content = `<path class="h9j290bhb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-camera-20-filled" /></template>
<style>
.h9j290bhb {
  fill: currentColor;
