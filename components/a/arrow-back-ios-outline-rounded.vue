...
const content = `<path class="vxen_1b6n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-back-ios-outline-rounded" /></template>
<style>
.vxen_1b6n {
  fill: currentColor;
