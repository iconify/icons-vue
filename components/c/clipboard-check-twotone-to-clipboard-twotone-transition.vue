...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="line-md:clipboard-check-twotone-to-clipboard-twotone-transition" /></template>
