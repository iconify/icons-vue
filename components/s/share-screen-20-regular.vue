...
const content = `<path class="zwhujo5dc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-screen-20-regular" /></template>
<style>
.zwhujo5dc {
  fill: currentColor;
