...
const content = `<path class="iiwd_mr_m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:unpaved-road" /></template>
<style>
.iiwd_mr_m {
  fill: currentColor;
