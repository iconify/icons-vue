...
const content = `<path class="tb0hp9coz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:xbox" /></template>
<style>
.tb0hp9coz {
  fill: none;
  stroke: currentColor;
