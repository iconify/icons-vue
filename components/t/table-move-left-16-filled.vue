...
const content = `<path class="y0zpkqgbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-left-16-filled" /></template>
<style>
.y0zpkqgbl {
  fill: currentColor;
