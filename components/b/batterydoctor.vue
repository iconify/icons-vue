...
const content = `<path class="yrxpivvcs"/><path class="r1gg5cv-t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:batterydoctor" /></template>
<style>
.r1gg5cv-t {
  fill: none;
  stroke: currentColor;
