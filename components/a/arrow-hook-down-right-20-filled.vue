...
const content = `<path class="fp9mskdgf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-hook-down-right-20-filled" /></template>
<style>
.fp9mskdgf {
  fill: currentColor;
