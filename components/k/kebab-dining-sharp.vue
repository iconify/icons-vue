...
const content = `<path class="v95k-cu3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:kebab-dining-sharp" /></template>
<style>
.v95k-cu3l {
  fill: currentColor;
