...
const content = `<path class="vvl4dy-iy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-bank-link-48-filled" /></template>
<style>
.vvl4dy-iy {
  fill: currentColor;
