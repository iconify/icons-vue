...
const content = `<path class="kr2qgvbvf"/><path class="n92x5ub0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:oncoming-fist" /></template>
<style>
.kr2qgvbvf {
