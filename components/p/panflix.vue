...
const content = `<path class="wno220bnk"/><path class="j8icydbck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:panflix" /></template>
<style>
.j8icydbck {
  fill: none;
  stroke: currentColor;
