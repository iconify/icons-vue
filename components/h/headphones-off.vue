...
const content = `<path class="n235_xbht"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:headphones-off" /></template>
<style>
.n235_xbht {
  fill: none;
  stroke: currentColor;
