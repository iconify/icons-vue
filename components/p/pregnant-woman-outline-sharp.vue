...
const content = `<path class="n9zy9pacq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pregnant-woman-outline-sharp" /></template>
<style>
.n9zy9pacq {
  fill: currentColor;
