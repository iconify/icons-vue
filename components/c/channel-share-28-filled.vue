...
const content = `<path class="tj5b1fbje"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:channel-share-28-filled" /></template>
<style>
.tj5b1fbje {
  fill: currentColor;
