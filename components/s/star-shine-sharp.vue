...
const content = `<path class="mv2ed7z6d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:star-shine-sharp" /></template>
<style>
.mv2ed7z6d {
  fill: currentColor;
