...
const content = `<path class="ej898wbwe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-app-settings-alt" /></template>
<style>
.ej898wbwe {
  fill: currentColor;
