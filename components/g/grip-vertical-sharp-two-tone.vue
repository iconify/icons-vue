...
const content = `<path class="l4psdzbtw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:grip-vertical-sharp-two-tone" /></template>
<style>
.l4psdzbtw {
  fill: none;
  stroke: currentColor;
