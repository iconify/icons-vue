...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="er7_ux1dh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-rs-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
