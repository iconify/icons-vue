...
const content = `<path class="hqexc9onn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:restore-page-rounded" /></template>
<style>
.hqexc9onn {
  fill: currentColor;
