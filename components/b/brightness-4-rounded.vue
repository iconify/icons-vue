...
const content = `<path class="calvzccvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brightness-4-rounded" /></template>
<style>
.calvzccvo {
  fill: currentColor;
