...
const content = `<path class="tyjnvwbyp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:texture-outline" /></template>
<style>
.tyjnvwbyp {
  fill: currentColor;
