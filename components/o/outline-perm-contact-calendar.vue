...
const content = `<path class="swtnskb7y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-perm-contact-calendar" /></template>
<style>
.swtnskb7y {
  fill: currentColor;
