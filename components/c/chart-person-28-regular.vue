...
const content = `<path class="uf1v__5jj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chart-person-28-regular" /></template>
<style>
.uf1v__5jj {
  fill: currentColor;
