...
const content = `<path class="mavohubwj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swap-horizontal-circle-rounded" /></template>
<style>
.mavohubwj {
  fill: currentColor;
