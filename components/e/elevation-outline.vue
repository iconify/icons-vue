...
const content = `<path class="z-lmc2k_e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:elevation-outline" /></template>
<style>
.z-lmc2k_e {
  fill: currentColor;
