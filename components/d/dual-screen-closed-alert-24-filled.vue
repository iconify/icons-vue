...
const content = `<path class="zm664rs2a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dual-screen-closed-alert-24-filled" /></template>
<style>
.zm664rs2a {
  fill: currentColor;
