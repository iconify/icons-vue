...
const content = `<path class="llzetopqu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:drive-folder-upload-outline-sharp" /></template>
<style>
.llzetopqu {
  fill: currentColor;
