...
const content = `<circle class="jie5odout"/><path class="yhiid1b8t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-person-search" /></template>
<style>
.jie5odout {
  cx: 10px;
  cy: 8px;
