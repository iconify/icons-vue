...
const content = `<path class="z3u4x6uay"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:terminal-outline-rounded" /></template>
<style>
.z3u4x6uay {
  fill: currentColor;
