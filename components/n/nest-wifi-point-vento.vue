...
const content = `<path class="oy-3khbxs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-wifi-point-vento" /></template>
<style>
.oy-3khbxs {
  fill: currentColor;
