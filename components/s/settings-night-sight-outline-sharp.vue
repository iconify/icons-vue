...
const content = `<path class="vygj-ib8g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-night-sight-outline-sharp" /></template>
<style>
.vygj-ib8g {
  fill: currentColor;
