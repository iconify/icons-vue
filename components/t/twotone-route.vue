...
const content = `<circle class="ejz56cbbg"/><circle class="ww4lybcbn"/><path class="smx3xez1h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-route" /></template>
<style>
.ejz56cbbg {
  cx: 6px;
  cy: 6px;
