...
const content = `<path class="gwfleacpk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:walk-band" /></template>
<style>
.gwfleacpk {
  fill: none;
  stroke: currentColor;
