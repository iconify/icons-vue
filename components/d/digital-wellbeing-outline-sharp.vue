...
const content = `<path class="lz2oe3dqg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:digital-wellbeing-outline-sharp" /></template>
<style>
.lz2oe3dqg {
  fill: currentColor;
