...
const content = `<path class="r-3rq5rhk"/><path class="db3x8nb0r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-save" /></template>
<style>
.db3x8nb0r {
  fill: currentColor;
