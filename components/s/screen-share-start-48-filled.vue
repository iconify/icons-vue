...
const content = `<path class="rvteotjyo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:screen-share-start-48-filled" /></template>
<style>
.rvteotjyo {
  fill: currentColor;
