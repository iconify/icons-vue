...
const content = `<path class="ulysfv10g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-yandex" /></template>
<style>
.ulysfv10g {
