...
const content = `<path class="qj7v8rswd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-up-exclamation-24-filled" /></template>
<style>
.qj7v8rswd {
  fill: currentColor;
