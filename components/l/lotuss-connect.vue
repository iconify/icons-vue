...
const content = `<path class="z0bbihbxw"/><path class="zw-s8n8au"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lotuss-connect" /></template>
<style>
.z0bbihbxw {
  fill: none;
  stroke: currentColor;
