...
const content = `<g class="s0phu2bbs"><path class="tkn_9lu9q"/><path class="k7cb-5bou"/><path class="jfxgqlb-n"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:kanban-column-outline-bold" /></template>
<style>
.jfxgqlb-n {
