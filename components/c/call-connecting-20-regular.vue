...
const content = `<path class="g4gq-bc2y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-connecting-20-regular" /></template>
<style>
.g4gq-bc2y {
  fill: currentColor;
