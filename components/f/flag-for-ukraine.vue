...
const content = `<path class="n8dhie24t"/><path class="buk2b0b2e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-ukraine" /></template>
<style>
.buk2b0b2e {
