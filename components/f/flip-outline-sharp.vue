...
const content = `<path class="hx0gb20rn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flip-outline-sharp" /></template>
<style>
.hx0gb20rn {
  fill: currentColor;
