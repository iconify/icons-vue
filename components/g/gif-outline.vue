...
const content = `<path class="wvn62xhah"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gif-outline" /></template>
<style>
.wvn62xhah {
  fill: currentColor;
