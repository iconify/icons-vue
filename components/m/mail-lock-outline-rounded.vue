...
const content = `<path class="v5tn9qbuy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mail-lock-outline-rounded" /></template>
<style>
.v5tn9qbuy {
  fill: currentColor;
