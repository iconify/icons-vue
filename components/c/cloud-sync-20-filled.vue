...
const content = `<path class="zfrznftkr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-sync-20-filled" /></template>
<style>
.zfrznftkr {
  fill: currentColor;
