...
const content = `<path class="q-cfbdcdn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:glance-horizontal-20-regular" /></template>
<style>
.q-cfbdcdn {
  fill: currentColor;
