...
const content = `<path class="t-egyh5-e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:gavel-outline-sharp" /></template>
<style>
.t-egyh5-e {
  fill: currentColor;
