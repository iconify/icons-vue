...
const content = `<path class="mlcvxacue"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:delete-lines-20-regular" /></template>
<style>
.mlcvxacue {
  fill: currentColor;
