...
const content = `<path class="krhl0vbcp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:progress-activity-sharp" /></template>
<style>
.krhl0vbcp {
  fill: currentColor;
