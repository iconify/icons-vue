...
const content = `<path class="us3q--btq"/><path class="g01ayn8rv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:session" /></template>
<style>
.g01ayn8rv {
  fill: none;
  stroke: currentColor;
