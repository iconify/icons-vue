...
const content = `<defs><linearGradient id="SVGusebDeuy" x1="0%" x2="100%" y1="100%" y2="0%"><stop offset="0%" class="o1-idcc_z"/><stop offset="100%" class="rr6asqhtm"/></linearGradient></defs><path fill="url(#SVGusebDeuy)" class="tmbkaq7lv"/><path class="y3b-zobdw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:aws-elb" /></template>
<style>
.o1-idcc_z {
