...
const content = `<path class="cmg3af0yn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-nine-bold" /></template>
<style>
.cmg3af0yn {
  fill: currentColor;
