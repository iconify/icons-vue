...
const content = `<path class="h8_hwncsa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tour-outline-sharp" /></template>
<style>
.h8_hwncsa {
  fill: currentColor;
