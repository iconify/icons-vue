...
const content = `<path class="vg4geqbgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-bounce-16-regular" /></template>
<style>
.vg4geqbgh {
  fill: currentColor;
