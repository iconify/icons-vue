...
const content = `<path class="cvcftdhvi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:payment-wireless-28-regular" /></template>
<style>
.cvcftdhvi {
  fill: currentColor;
