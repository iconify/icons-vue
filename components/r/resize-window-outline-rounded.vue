...
const content = `<path class="w79lowova"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:resize-window-outline-rounded" /></template>
<style>
.w79lowova {
  fill: currentColor;
