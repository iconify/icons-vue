...
const content = `<path class="m07qa3bya"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:nest-found-savings-outline-rounded" /></template>
<style>
.m07qa3bya {
  fill: currentColor;
