...
const content = `<path class="evmnoubqm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-freeze-row-24-regular" /></template>
<style>
.evmnoubqm {
  fill: currentColor;
