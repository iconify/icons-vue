...
const content = `<path class="hqtoawblf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-alarm-clock" /></template>
<style>
.hqtoawblf {
  fill: none;
  stroke: currentColor;
