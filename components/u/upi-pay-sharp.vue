...
const content = `<path class="b15ay9bdc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:upi-pay-sharp" /></template>
<style>
.b15ay9bdc {
  fill: currentColor;
