...
const content = `<path class="o2ug-dbth"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:home-more-20-filled" /></template>
<style>
.o2ug-dbth {
  fill: currentColor;
