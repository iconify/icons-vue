...
const content = `<path class="jcig4fbmm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:bed-single-sharp-fill" /></template>
<style>
.jcig4fbmm {
  fill: currentColor;
