...
const content = `<g class="cuyn6tgcc"><path class="kbgxg_7rn"/><path class="o6u6u9bny"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrows-out-simple-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
