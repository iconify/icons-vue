...
const content = `<g class="cuyn6tgcc"><path class="onrdkub8r"/><path class="ef2577bgw"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:chart-scatter-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
