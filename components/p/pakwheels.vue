...
const content = `<path class="xbxfpp3hu"/><path class="naygobmum"/><path class="xm9uzjeuh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pakwheels" /></template>
<style>
.naygobmum {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M39.495 24c0 8.558-6.937 15.495-15.495 15.495S8.505 32.558 8.505 24S15.442 8.505 24 8.505S39.495 15.442 39.495 24");
}
