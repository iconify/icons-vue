...
const content = `<path class="ccpvr-2vo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-1-lines-24-regular" /></template>
<style>
.ccpvr-2vo {
  fill: currentColor;
