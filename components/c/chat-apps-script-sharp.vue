...
const content = `<path class="xmpwuobyn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chat-apps-script-sharp" /></template>
<style>
.xmpwuobyn {
  fill: currentColor;
