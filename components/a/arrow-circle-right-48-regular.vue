...
const content = `<path class="d_pdv2boj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-right-48-regular" /></template>
<style>
.d_pdv2boj {
  fill: currentColor;
