...
const content = `<path class="h3c9r6bpe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:autorenew-outline-sharp" /></template>
<style>
.h3c9r6bpe {
  fill: currentColor;
