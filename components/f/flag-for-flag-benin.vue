...
const content = `<path class="ng_s0p59z"/><path class="v3ns7ccmm"/><path class="uuo2h7bxc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-benin" /></template>
<style>
.ng_s0p59z {
