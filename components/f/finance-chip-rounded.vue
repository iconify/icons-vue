...
const content = `<path class="ntvr-vbtu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:finance-chip-rounded" /></template>
<style>
.ntvr-vbtu {
  fill: currentColor;
