...
const content = `<path class="f3v49ueop"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:document-search-rounded" /></template>
<style>
.f3v49ueop {
  fill: currentColor;
