...
const content = `<path class="t69q6ccbv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-all-read-28-filled" /></template>
<style>
.t69q6ccbv {
  fill: currentColor;
