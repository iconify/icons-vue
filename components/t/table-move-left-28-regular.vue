...
const content = `<path class="ofy3ceb_e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-left-28-regular" /></template>
<style>
.ofy3ceb_e {
  fill: currentColor;
