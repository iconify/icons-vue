...
const content = `<path class="yj5s94btc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:turn-right-rounded" /></template>
<style>
.yj5s94btc {
  fill: currentColor;
