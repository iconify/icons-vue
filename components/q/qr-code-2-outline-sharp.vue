...
const content = `<path class="wogn7bt3i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:qr-code-2-outline-sharp" /></template>
<style>
.wogn7bt3i {
  fill: currentColor;
