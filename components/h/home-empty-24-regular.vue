...
const content = `<path class="oq6e73bjq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:home-empty-24-regular" /></template>
<style>
.oq6e73bjq {
  fill: currentColor;
