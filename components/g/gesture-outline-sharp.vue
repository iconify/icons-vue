...
const content = `<path class="il06a_8jh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:gesture-outline-sharp" /></template>
<style>
.il06a_8jh {
  fill: currentColor;
