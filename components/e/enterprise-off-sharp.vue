...
const content = `<path class="w4x522zjf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:enterprise-off-sharp" /></template>
<style>
.w4x522zjf {
  fill: currentColor;
