...
const content = `<path class="vayeu072h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-sync-28-filled" /></template>
<style>
.vayeu072h {
  fill: currentColor;
