...
const content = `<ellipse class="cxu7939_s"/><path class="c_xhedcux"/><path class="hzkd9pwnc"/><path class="ugegszbtl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:monti" /></template>
<style>
.c_xhedcux {
  fill: none;
  stroke: currentColor;
