...
const content = `<path class="jierjuwad"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:other-admission-outline-rounded" /></template>
<style>
.jierjuwad {
  fill: currentColor;
