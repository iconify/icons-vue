...
const content = `<defs><linearGradient id="SVGnb50D8bz" x1="0%" x2="100%" y1="49.999%" y2="49.999%"><stop offset="0%" class="jq5yj5b5h"/><stop offset="100%" class="rmju0ccrn"/></linearGradient></defs><path fill="url(#SVGnb50D8bz)" class="a6iavob4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:datocms-icon" /></template>
<style>
.a6iavob4n {
