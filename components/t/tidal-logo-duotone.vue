...
const content = `<g class="cuyn6tgcc"><path class="zqrz1nb3k"/><path class="iysolou-w"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:tidal-logo-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
