...
const content = `<path class="n4afjhuhv"/><path class="vnq4l5a9i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:oncoming-fist-light-skin-tone" /></template>
<style>
.n4afjhuhv {
