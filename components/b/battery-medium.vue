...
const content = `<path class="i7a5cccqn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:battery-medium" /></template>
<style>
.i7a5cccqn {
  fill: none;
  stroke: currentColor;
