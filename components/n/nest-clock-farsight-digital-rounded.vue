...
const content = `<path class="v2xaq0bhk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-clock-farsight-digital-rounded" /></template>
<style>
.v2xaq0bhk {
  fill: currentColor;
