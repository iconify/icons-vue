...
const content = `<path class="kzksusbqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:attribution-rounded" /></template>
<style>
.kzksusbqq {
  fill: currentColor;
