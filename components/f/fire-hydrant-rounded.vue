...
const content = `<path class="ioj6kkbmg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fire-hydrant-rounded" /></template>
<style>
.ioj6kkbmg {
  fill: currentColor;
