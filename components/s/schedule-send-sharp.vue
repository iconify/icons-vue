...
const content = `<path class="jihrawbej"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:schedule-send-sharp" /></template>
<style>
.jihrawbej {
  fill: currentColor;
