...
const content = `<path class="z-9phnb9x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-multiple-20-regular" /></template>
<style>
.z-9phnb9x {
  fill: currentColor;
