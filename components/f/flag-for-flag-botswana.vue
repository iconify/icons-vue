...
const content = `<path class="vbxe0xtoi"/><path class="ld6tu2-ny"/><path class="n8dcwacql"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-botswana" /></template>
<style>
.ld6tu2-ny {
