...
const content = `<path class="g88uq0ofa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-photo-size-select-small" /></template>
<style>
.g88uq0ofa {
  fill: currentColor;
