...
const content = `<path class="mcfak1q9k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:shaarlier" /></template>
<style>
.mcfak1q9k {
  fill: none;
  stroke: currentColor;
