...
const content = `<path class="rrbyggbpi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:house-outline" /></template>
<style>
.rrbyggbpi {
  fill: currentColor;
