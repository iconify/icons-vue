...
const content = `<path class="fcortjbfe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:playing-cards-outline-sharp" /></template>
<style>
.fcortjbfe {
  fill: currentColor;
