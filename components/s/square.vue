...
const content = `<g class="m4_sa2zql"><path class="mqdez3bsr"/><path class="zy0jk9lmt"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:square" /></template>
<style>
.m4_sa2zql {
