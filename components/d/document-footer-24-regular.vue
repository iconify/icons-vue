...
const content = `<path class="h_3i5bc2p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-footer-24-regular" /></template>
<style>
.h_3i5bc2p {
  fill: currentColor;
