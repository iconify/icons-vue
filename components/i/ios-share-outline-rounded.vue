...
const content = `<path class="n3c-0yb9w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ios-share-outline-rounded" /></template>
<style>
.n3c-0yb9w {
  fill: currentColor;
