...
const content = `<path class="uz7o2mqwf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:magnify-fullscreen" /></template>
<style>
.uz7o2mqwf {
  fill: currentColor;
