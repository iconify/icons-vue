...
const content = `<path class="f5j_qdwkr"/><path class="hmkibhbqn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-quiz" /></template>
<style>
.f5j_qdwkr {
  fill: currentColor;
