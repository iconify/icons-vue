...
const content = `<path class="oolsdxb3i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-off-24-filled" /></template>
<style>
.oolsdxb3i {
  fill: currentColor;
