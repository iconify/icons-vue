...
const content = `<path class="qbq69ub2s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:record-voice-over-rounded" /></template>
<style>
.qbq69ub2s {
  fill: currentColor;
