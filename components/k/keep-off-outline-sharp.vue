...
const content = `<path class="e5d5r_bck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keep-off-outline-sharp" /></template>
<style>
.e5d5r_bck {
  fill: currentColor;
