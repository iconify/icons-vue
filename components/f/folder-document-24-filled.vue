...
const content = `<path class="m90t_9l5a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-document-24-filled" /></template>
<style>
.m90t_9l5a {
  fill: currentColor;
