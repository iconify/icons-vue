...
const content = `<path class="jt4i5l69i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-add-24-filled" /></template>
<style>
.jt4i5l69i {
  fill: currentColor;
