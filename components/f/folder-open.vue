...
const content = `<path class="ju598tb3f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:folder-open" /></template>
<style>
.ju598tb3f {
  fill: currentColor;
