...
const content = `<path class="tqamoybkw"/><path class="uph4zqc9i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-google-14" /></template>
<style>
.tqamoybkw {
  fill: none;
  stroke: currentColor;
