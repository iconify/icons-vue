...
const content = `<path class="l_ise4bij"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:youtube-video-outline" /></template>
<style>
.l_ise4bij {
  fill: currentColor;
