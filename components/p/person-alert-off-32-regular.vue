...
const content = `<path class="z728s64wv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-alert-off-32-regular" /></template>
<style>
.z728s64wv {
  fill: currentColor;
