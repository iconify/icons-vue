...
const content = `<path class="yx09k6b3t"/><rect class="jc1oydeao"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:googlemovies" /></template>
<style>
.jc1oydeao {
  width: 39px;
  height: 31px;
