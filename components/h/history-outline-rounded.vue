...
const content = `<path class="rj55jfbjt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:history-outline-rounded" /></template>
<style>
.rj55jfbjt {
  fill: currentColor;
