...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-incoming-fill" /></template>
<style>
.b_gf1sbty {
  fill: currentColor;
...
.qjwl0dbsw {
  d: path("M16.5 7.5L21 3M16 2V7.5C16 7.7761 16.2239 8 16.5 8H22");
}
