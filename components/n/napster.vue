...
const content = `<path class="dxfcbgbjr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:napster" /></template>
<style>
.dxfcbgbjr {
  fill: none;
  stroke: currentColor;
