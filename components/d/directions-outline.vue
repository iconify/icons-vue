...
const content = `<path class="qgquiubrj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:directions-outline" /></template>
<style>
.qgquiubrj {
  fill: currentColor;
