...
const content = `<path class="engaucb3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:view-carousel-rounded" /></template>
<style>
.engaucb3l {
  fill: currentColor;
