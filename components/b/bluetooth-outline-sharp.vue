...
const content = `<path class="idcs78bwv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bluetooth-outline-sharp" /></template>
<style>
.idcs78bwv {
  fill: currentColor;
