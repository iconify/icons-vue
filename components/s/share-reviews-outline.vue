...
const content = `<path class="rw3405mwm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:share-reviews-outline" /></template>
<style>
.rw3405mwm {
  fill: currentColor;
