...
const content = `<path class="kyo8-xp4g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-outline-rounded" /></template>
<style>
.kyo8-xp4g {
  fill: currentColor;
