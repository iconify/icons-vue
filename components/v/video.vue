...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:video" /></template>
<style>
.f6ajjh6kh {
  fill: none;
  stroke: currentColor;
