...
const content = `<path class="kmxtikbee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-keys-outline-sharp" /></template>
<style>
.kmxtikbee {
  fill: currentColor;
