...
const content = `<path class="jue-pobmc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:passport-outline-rounded" /></template>
<style>
.jue-pobmc {
  fill: currentColor;
