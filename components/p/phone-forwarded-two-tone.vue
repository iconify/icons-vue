...
const content = `<g class="nrj6p8qat"><path class="n802joiny"/><path class="mn1hwwa6b"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-forwarded-two-tone" /></template>
<style>
.mn1hwwa6b {
