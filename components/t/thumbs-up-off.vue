...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="x1i5ien0v"/><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:thumbs-up-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
