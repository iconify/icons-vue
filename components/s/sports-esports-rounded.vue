...
const content = `<path class="aez8axb3k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sports-esports-rounded" /></template>
<style>
.aez8axb3k {
  fill: currentColor;
