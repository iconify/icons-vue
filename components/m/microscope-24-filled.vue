...
const content = `<path class="tf1cnnb5h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:microscope-24-filled" /></template>
<style>
.tf1cnnb5h {
  fill: currentColor;
