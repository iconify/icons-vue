...
const content = `<path class="gtby9mz6f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-videogame-asset-off" /></template>
<style>
.gtby9mz6f {
  fill: currentColor;
