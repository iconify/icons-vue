...
const content = `<path class="mrwcnrgva"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tab-close-inactive-sharp" /></template>
<style>
.mrwcnrgva {
  fill: currentColor;
