...
const content = `<path class="t5oc_mb5c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bid-landscape-disabled-outline-sharp" /></template>
<style>
.t5oc_mb5c {
  fill: currentColor;
