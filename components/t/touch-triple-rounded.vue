...
const content = `<path class="kqzi7xtuy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:touch-triple-rounded" /></template>
<style>
.kqzi7xtuy {
  fill: currentColor;
