...
const content = `<path class="dp6toebsy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:partygames" /></template>
<style>
.dp6toebsy {
  fill: none;
  stroke: currentColor;
