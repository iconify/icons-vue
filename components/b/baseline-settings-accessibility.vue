...
const content = `<path class="mdycqopwz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-settings-accessibility" /></template>
<style>
.mdycqopwz {
  fill: currentColor;
