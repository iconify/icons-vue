...
const content = `<path class="okoiy4b2l"/><path class="xw8leeb0i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:alditalk" /></template>
<style>
.okoiy4b2l {
  fill: none;
  stroke: currentColor;
