...
const content = `<path class="uioha4-9b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-right-add-20-regular" /></template>
<style>
.uioha4-9b {
  fill: currentColor;
