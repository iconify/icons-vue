...
const content = `<path class="zeakjwbdz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:unfold-less-outline-rounded" /></template>
<style>
.zeakjwbdz {
  fill: currentColor;
