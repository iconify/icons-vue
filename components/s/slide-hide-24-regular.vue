...
const content = `<path class="gfg9nsbgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-hide-24-regular" /></template>
<style>
.gfg9nsbgh {
  fill: currentColor;
