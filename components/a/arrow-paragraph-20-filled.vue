...
const content = `<path class="b62jqhb0m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-paragraph-20-filled" /></template>
<style>
.b62jqhb0m {
  fill: currentColor;
