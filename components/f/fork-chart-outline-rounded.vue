...
const content = `<path class="f73vc4_ih"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fork-chart-outline-rounded" /></template>
<style>
.f73vc4_ih {
  fill: currentColor;
