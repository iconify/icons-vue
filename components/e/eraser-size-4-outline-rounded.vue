...
const content = `<path class="njybhrb4g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:eraser-size-4-outline-rounded" /></template>
<style>
.njybhrb4g {
  fill: currentColor;
