...
const content = `<path class="vpicftohz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:light-group-rounded" /></template>
<style>
.vpicftohz {
  fill: currentColor;
