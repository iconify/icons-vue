...
const content = `<path class="z3539zbkd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-checkmark-20-filled" /></template>
<style>
.z3539zbkd {
  fill: currentColor;
