...
const content = `<path class="w3b9oqlpb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-timer-rounded" /></template>
<style>
.w3b9oqlpb {
  fill: currentColor;
