...
const content = `<path class="rebsbab5s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:select-window-off-outline-sharp" /></template>
<style>
.rebsbab5s {
  fill: currentColor;
