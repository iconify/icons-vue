...
const content = `<g class="fmn8yub-d"><path class="rs-j0qbjd"/><path class="sztf1qbgd"/><path class="u0p7kgbix"/><path class="gw0zvbctr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:simplified-icon-pack" /></template>
<style>
.fmn8yub-d {
  fill: none;
  stroke: currentColor;
