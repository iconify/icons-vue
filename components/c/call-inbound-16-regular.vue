...
const content = `<path class="ozvgyzbkt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-inbound-16-regular" /></template>
<style>
.ozvgyzbkt {
  fill: currentColor;
