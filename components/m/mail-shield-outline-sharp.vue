...
const content = `<path class="lgq8iqpgr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mail-shield-outline-sharp" /></template>
<style>
.lgq8iqpgr {
  fill: currentColor;
