...
const content = `<path class="vnht4mbew"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:blood-test-tracker" /></template>
<style>
.vnht4mbew {
  fill: none;
  stroke: currentColor;
