...
const content = `<path class="f9o5r5bnl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:position-to-back-20-filled" /></template>
<style>
.f9o5r5bnl {
  fill: currentColor;
