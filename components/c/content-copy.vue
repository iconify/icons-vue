...
const content = `<path class="o7pn7abgr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:content-copy" /></template>
<style>
.o7pn7abgr {
  fill: currentColor;
