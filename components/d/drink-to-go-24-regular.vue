...
const content = `<path class="wjesyhfas"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drink-to-go-24-regular" /></template>
<style>
.wjesyhfas {
  fill: currentColor;
