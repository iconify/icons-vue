...
const content = `<path class="cspk-227o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:picture-in-picture-exit-16-filled" /></template>
<style>
.cspk-227o {
  fill: currentColor;
