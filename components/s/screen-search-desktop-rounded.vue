...
const content = `<path class="pef6jfbmg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:screen-search-desktop-rounded" /></template>
<style>
.pef6jfbmg {
  fill: currentColor;
