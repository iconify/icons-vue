...
const content = `<path class="wizx_mw_t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-notch-open-light" /></template>
<style>
.wizx_mw_t {
  fill: currentColor;
