...
const content = `<path class="b4b0p4b4r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ltecleaner" /></template>
<style>
.b4b0p4b4r {
  fill: none;
  stroke: currentColor;
