...
const content = `<g class="cuyn6tgcc"><path class="sj-1a6b7h"/><path class="dyp_znbyn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:keyboard-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
