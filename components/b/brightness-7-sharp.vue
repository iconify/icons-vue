...
const content = `<path class="rm48uoqne"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brightness-7-sharp" /></template>
<style>
.rm48uoqne {
  fill: currentColor;
