...
const content = `<path class="rpncjubzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-pen-sharp" /></template>
<style>
.rpncjubzh {
  fill: none;
  stroke: currentColor;
