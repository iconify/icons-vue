...
const content = `<path class="mwsh-u93l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-increase-ltr-20-regular" /></template>
<style>
.mwsh-u93l {
  fill: currentColor;
