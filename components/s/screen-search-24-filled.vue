...
const content = `<path class="vthznzunq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:screen-search-24-filled" /></template>
<style>
.vthznzunq {
  fill: currentColor;
