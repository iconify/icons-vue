...
const content = `<path class="j6dy1zb_d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:identification-badge-bold" /></template>
<style>
.j6dy1zb_d {
  fill: currentColor;
