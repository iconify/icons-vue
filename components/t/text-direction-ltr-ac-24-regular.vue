...
const content = `<g class="ft5dv1b6b"><path class="ktvv1tbgf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-ltr-ac-24-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
