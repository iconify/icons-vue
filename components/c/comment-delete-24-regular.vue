...
const content = `<path class="fg92gmnbc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-delete-24-regular" /></template>
<style>
.fg92gmnbc {
