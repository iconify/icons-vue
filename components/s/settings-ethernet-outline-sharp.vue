...
const content = `<path class="tskpz1nxu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-ethernet-outline-sharp" /></template>
<style>
.tskpz1nxu {
  fill: currentColor;
