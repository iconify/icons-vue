...
const content = `<path class="qxrg36b_l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-arrow-up-48-regular" /></template>
<style>
.qxrg36b_l {
  fill: currentColor;
