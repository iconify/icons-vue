...
const content = `<path class="c5o6o4uad"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:antigravity-rounded" /></template>
<style>
.c5o6o4uad {
  fill: currentColor;
