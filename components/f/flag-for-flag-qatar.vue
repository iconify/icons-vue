...
const content = `<path class="h2wowwb4y"/><path class="bep-stbyn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-qatar" /></template>
<style>
.bep-stbyn {
