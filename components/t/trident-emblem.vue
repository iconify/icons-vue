...
const content = `<g class="dt4yhf73z"><path class="km79jfb4v"/><path class="evsyjmfbp"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:trident-emblem" /></template>
<style>
.dt4yhf73z {
