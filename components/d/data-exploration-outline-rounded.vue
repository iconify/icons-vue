...
const content = `<path class="arvxmh52k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:data-exploration-outline-rounded" /></template>
<style>
.arvxmh52k {
  fill: currentColor;
