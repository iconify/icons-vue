...
const content = `<path class="z8mxm6bsg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-qr-code-scanner" /></template>
<style>
.z8mxm6bsg {
  fill: currentColor;
