...
const content = `<path class="qiozqnb1b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ddproperty" /></template>
<style>
.qiozqnb1b {
  fill: none;
  stroke: currentColor;
