...
const content = `<path class="r30rlkbfq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:home-garage-20-filled" /></template>
<style>
.r30rlkbfq {
  fill: currentColor;
