...
const content = `<g class="cuyn6tgcc"><path class="jze_w5bag"/><path class="sqzhlibgr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:bomb-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
