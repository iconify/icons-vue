...
const content = `<path class="dgh7jhswh"/><path class="wt8w1bb2l"/><path class="z2if2dz2f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:place-of-worship" /></template>
<style>
.dgh7jhswh {
