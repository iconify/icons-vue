...
const content = `<path class="rhix_hz6w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:group-remove-rounded" /></template>
<style>
.rhix_hz6w {
  fill: currentColor;
