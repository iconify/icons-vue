...
const content = `<path class="t4osmli6e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cursor-click-20-filled" /></template>
<style>
.t4osmli6e {
  fill: currentColor;
