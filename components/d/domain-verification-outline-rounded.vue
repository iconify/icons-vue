...
const content = `<path class="zq_cd8dgf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:domain-verification-outline-rounded" /></template>
<style>
.zq_cd8dgf {
  fill: currentColor;
