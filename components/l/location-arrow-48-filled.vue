...
const content = `<path class="jdj53y8yf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-arrow-48-filled" /></template>
<style>
.jdj53y8yf {
  fill: currentColor;
