...
const content = `<path class="j0akd8_xp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:macro-auto-sharp" /></template>
<style>
.j0akd8_xp {
  fill: currentColor;
