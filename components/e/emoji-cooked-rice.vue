...
const content = `<path class="l5voorbhw"/><path class="vnlegntmb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-cooked-rice" /></template>
<style>
.l5voorbhw {
  fill: none;
  stroke: currentColor;
...
.vnlegntmb {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M41.146 21.074c.625.682.365 1.481.051 2.288M6.854 21.074c-.662 1.19.122 1.63.308 2.288");
}
