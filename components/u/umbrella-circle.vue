...
const content = `<g class="cuyn6tgcc"><path class="k6uj9ziot"/><path clip-rule="evenodd" class="g-ura4bog"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:umbrella-circle" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
