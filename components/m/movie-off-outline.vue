...
const content = `<path class="vvoz31bib"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:movie-off-outline" /></template>
<style>
.vvoz31bib {
  fill: currentColor;
