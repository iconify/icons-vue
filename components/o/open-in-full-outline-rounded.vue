...
const content = `<path class="zv46hx44w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:open-in-full-outline-rounded" /></template>
<style>
.zv46hx44w {
  fill: currentColor;
