...
const content = `<path class="ldzcix76j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-electric-rickshaw" /></template>
<style>
.ldzcix76j {
  fill: currentColor;
