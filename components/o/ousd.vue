...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGeAjs2j6M)" class="op83dcccy"/><path fill="url(#SVG0DCFwdVj)" class="ediscdiuq"/><path clip-rule="evenodd" class="cpz69jbln"/><path clip-rule="evenodd" class="o3oetd6aa"/><defs><linearGradient id="SVGeAjs2j6M" x1="12.127" x2="9.88" y1="17.322" y2=".981" gradientUnits="userSpaceOnUse"><stop offset=".001" class="vc--wpv5i"/><stop offset="1" class="lhlvv_pbb"/></linearGradient><linearGradient id="SVG0DCFwdVj" x1="11.716" x2="13.969" y1="6.269" y2="23.091" gradientUnits="userSpaceOnUse"><stop offset=".001" class="vc--wpv5i"/><stop offset=".997" class="n4_9860za"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:ousd" /></template>
<style>
.cpz69jbln {
  fill: var(--svg-color--fafbfc, #fafbfc);
  fill-rule: evenodd;
  d: path("M12.344 10.651q.107.026.222.046c1.931.385 4.152 1.189 4.141 4.15c0 .443-.046.863-.15 1.236a6.3 6.3 0 0 1-.672.967a5.84 5.84 0 0 1-2.428 1.725l-.128.042l-.127.04a4 4 0 0 1-.251.076V21H9.59v-2.09c-.971-.344-2.445-1.256-2.97-1.883v-.082l2.256-1.527a3.33 3.33 0 0 0 2.382 1.014c1.619 0 2.394-.885 2.394-1.596c0-1.14-1.082-1.34-2.339-1.573l-.009-.001q-.555-.087-1.099-.222c-2.012-.49-4.071-1.364-4.071-4.114c0-.805.173-1.505.52-2.087c1.506-1.772 2.56-1.883 2.854-1.913c.06-.006.088-.01.083-.023V3h3.36v1.938c1.235.287 2.134.975 2.947 1.947l.011.07l-1.861 1.923l-.079-.016c-.602-.898-1.54-1.382-2.71-1.382c-1.306 0-2.035.594-2.035 1.34c0 1.193 1.221 1.442 2.916 1.789l.033.006q.086.016.172.036");
}

.ediscdiuq {
  d: path("M13.965 8.855c.393.594.647 1.34.74 2.238c.324.152.601.326.856.525c.937.734 1.411 1.806 1.411 3.17c0 .163-.012.327-.023.49v-.011c1.157-2.627.776-6.236-1.1-8.438z");
}
