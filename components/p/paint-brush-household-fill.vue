...
const content = `<path class="rrg_n7bgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:paint-brush-household-fill" /></template>
<style>
.rrg_n7bgh {
  fill: currentColor;
