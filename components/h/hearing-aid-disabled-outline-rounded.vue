...
const content = `<path class="cfzv_4age"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hearing-aid-disabled-outline-rounded" /></template>
<style>
.cfzv_4age {
  fill: currentColor;
