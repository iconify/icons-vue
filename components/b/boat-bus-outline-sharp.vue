...
const content = `<path class="x91kghsha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:boat-bus-outline-sharp" /></template>
<style>
.x91kghsha {
  fill: currentColor;
