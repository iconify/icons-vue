...
const content = `<path class="ksug_91ae"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-checkmark-20-filled" /></template>
<style>
.ksug_91ae {
  fill: currentColor;
