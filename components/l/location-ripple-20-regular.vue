...
const content = `<path class="co-1e-biz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-ripple-20-regular" /></template>
<style>
.co-1e-biz {
  fill: currentColor;
