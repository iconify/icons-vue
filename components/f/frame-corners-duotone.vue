...
const content = `<g class="cuyn6tgcc"><path class="tm3vqw7ob"/><path class="zl1x-0byh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:frame-corners-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
