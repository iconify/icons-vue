...
const content = `<path class="k2b1l8bnl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-brush-20-filled" /></template>
<style>
.k2b1l8bnl {
  fill: currentColor;
