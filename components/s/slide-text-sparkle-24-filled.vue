...
const content = `<path class="bdet8qb0h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-text-sparkle-24-filled" /></template>
<style>
.bdet8qb0h {
  fill: currentColor;
