...
const content = `<path class="zyrd36bin"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-4-28-regular" /></template>
<style>
.zyrd36bin {
  fill: currentColor;
