...
const content = `<path class="tg09fgixp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-calculator-20-filled" /></template>
<style>
.tg09fgixp {
  fill: currentColor;
