...
const content = `<path class="yrejucbec"/><path class="ql8begekd"/><path class="mdbzljbvb"/><path class="iciekh2vo"/><path class="jjra16_9o"/><path class="lkv9v3ber"/><path class="y3js-7umg"/><path class="iidcafb5h"/><path class="v9lo33rsj"/><path class="e-9qf04qp"/><path class="o95k2ac_m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:agape" /></template>
<style>
.e-9qf04qp {
  fill: none;
  stroke: currentColor;
...
.mdbzljbvb {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M24.3 22.29c1.7-3.25 1.52-7.1-.3-10.14a10.4 10.4 0 0 0-2.83-3.09c-.77-.56-1.6-1-2.45-1.33c-2.17-.82-4.53-.87-6.69-.23c-2.11.64-4.03 1.94-5.42 3.86s-2.04 4.15-1.99 6.35c.04 2.26.82 4.48 2.27 6.29c.57.72 1.24 1.37 2.02 1.93c1.18.86 2.47 1.43 3.81 1.73h.01c3.46.79 7.17-.23 9.74-2.85");
}
...
.ql8begekd {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M23.7 22.29c-.16.02-.32.08-.46.15");
}
...
.v9lo33rsj {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M45.5 24c0 2.36-.79 4.54-2.12 6.29c-1.36 1.81-3.3 3.16-5.55 3.77a10.45 10.45 0 0 1-6.86-.47a10.43 10.43 0 0 1-6.21-8.03a1.6 1.6 0 0 0 .77-.75q.15-.255.18-.57a1 1 0 0 0 0-.48q-.03-.315-.18-.57a1.6 1.6 0 0 0-.77-.75a10.428 10.428 0 0 1 13.07-8.5c2.25.61 4.19 1.96 5.55 3.77c1.33 1.75 2.12 3.93 2.12 6.29");
}
