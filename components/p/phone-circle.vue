...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="hc0ve9bsf"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:phone-circle" /></template>
<style>
.hc0ve9bsf {
