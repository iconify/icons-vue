...
const content = `<path class="k7c2yobsj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nectwallet" /></template>
<style>
.k7c2yobsj {
  fill: none;
  stroke: currentColor;
