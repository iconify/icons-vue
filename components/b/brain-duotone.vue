...
const content = `<g class="cuyn6tgcc"><path class="blgrnnb3a"/><path class="hpwt_jb1e"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:brain-duotone" /></template>
<style>
.blgrnnb3a {
  d: path("M240 124a48 48 0 0 1-32 45.27V176a40 40 0 0 1-80 0a40 40 0 0 1-80 0v-6.73a48 48 0 0 1 0-90.54V72a40 40 0 0 1 80 0a40 40 0 0 1 80 0v6.73A48 48 0 0 1 240 124");
