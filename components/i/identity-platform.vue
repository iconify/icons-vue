...
const content = `<path class="ip5q5kb1u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:identity-platform" /></template>
<style>
.ip5q5kb1u {
  fill: currentColor;
