...
const content = `<path class="qdpv1humj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:filter-list-rounded" /></template>
<style>
.qdpv1humj {
  fill: currentColor;
