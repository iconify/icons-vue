...
const content = `<path class="td_35ja7t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:conversion-path-off-outline-sharp" /></template>
<style>
.td_35ja7t {
  fill: currentColor;
