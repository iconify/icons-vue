...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGhusL5d5U)" class="l2q47719d"/><defs><linearGradient id="SVGhusL5d5U" x1="12" x2="12" y1="3" y2="21" gradientUnits="userSpaceOnUse"><stop class="f_446jbjz"/><stop offset="1" class="mu22hj6pw"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:bcdt" /></template>
<style>
.f_446jbjz {
