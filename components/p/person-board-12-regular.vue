...
const content = `<path class="vpj_5cjnp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-board-12-regular" /></template>
<style>
.vpj_5cjnp {
  fill: currentColor;
