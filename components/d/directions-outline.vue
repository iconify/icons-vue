...
const content = `<path class="g-1ivpxyc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:directions-outline" /></template>
<style>
.g-1ivpxyc {
  fill: currentColor;
