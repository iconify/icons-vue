...
const content = `<path class="latad28ce"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bathroom-outline-sharp" /></template>
<style>
.latad28ce {
  fill: currentColor;
