...
const content = `<path class="m5vi-zqvb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:identity-aware-proxy-outline-sharp" /></template>
<style>
.m5vi-zqvb {
  fill: currentColor;
