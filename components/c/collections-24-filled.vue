...
const content = `<path class="diuvvbpzt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:collections-24-filled" /></template>
<style>
.diuvvbpzt {
  fill: currentColor;
