...
const content = `<path class="fcc0cubip"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tv-options-edit-channels-outline-sharp" /></template>
<style>
.fcc0cubip {
  fill: currentColor;
