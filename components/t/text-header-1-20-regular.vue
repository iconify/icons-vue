...
const content = `<path class="u9o3ptbse"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-1-20-regular" /></template>
<style>
.u9o3ptbse {
  fill: currentColor;
