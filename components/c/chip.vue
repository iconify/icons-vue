...
const content = `<path class="b3a4i--ny"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:chip" /></template>
<style>
.b3a4i--ny {
  fill: none;
  stroke: currentColor;
