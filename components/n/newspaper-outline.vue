...
const content = `<path class="vgmt3ybgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:newspaper-outline" /></template>
<style>
.vgmt3ybgh {
  fill: currentColor;
