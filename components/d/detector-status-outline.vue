...
const content = `<path class="kq84sff3v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:detector-status-outline" /></template>
<style>
.kq84sff3v {
  fill: currentColor;
