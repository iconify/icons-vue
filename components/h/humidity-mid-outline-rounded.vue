...
const content = `<path class="ehx9vvcyt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:humidity-mid-outline-rounded" /></template>
<style>
.ehx9vvcyt {
  fill: currentColor;
