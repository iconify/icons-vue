...
const content = `<path class="ncdadwu5t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:aod-watch-outline-rounded" /></template>
<style>
.ncdadwu5t {
  fill: currentColor;
