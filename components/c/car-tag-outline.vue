...
const content = `<path class="jwmea9ujw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-tag-outline" /></template>
<style>
.jwmea9ujw {
  fill: currentColor;
