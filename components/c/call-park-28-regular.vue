...
const content = `<path class="xboqxac0s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-park-28-regular" /></template>
<style>
.xboqxac0s {
  fill: currentColor;
