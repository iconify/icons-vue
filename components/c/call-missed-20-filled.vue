...
const content = `<path class="z25ja1bxq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-missed-20-filled" /></template>
<style>
.z25ja1bxq {
  fill: currentColor;
