...
const content = `<path class="gwbi4oz3e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:ribbon-add-24-regular" /></template>
<style>
.gwbi4oz3e {
  fill: currentColor;
