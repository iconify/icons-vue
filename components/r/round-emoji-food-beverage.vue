...
const content = `<path class="hbwn614jf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-emoji-food-beverage" /></template>
<style>
.hbwn614jf {
  fill: currentColor;
