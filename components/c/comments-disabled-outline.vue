...
const content = `<path class="olyzenbuw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:comments-disabled-outline" /></template>
<style>
.olyzenbuw {
  fill: currentColor;
