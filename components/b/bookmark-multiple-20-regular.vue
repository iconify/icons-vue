...
const content = `<path class="o4ie9ac_u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bookmark-multiple-20-regular" /></template>
<style>
.o4ie9ac_u {
  fill: currentColor;
