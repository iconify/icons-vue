...
const content = `<path class="devq_vbiq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-trending-lines-24-filled" /></template>
<style>
.devq_vbiq {
  fill: currentColor;
