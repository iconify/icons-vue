...
const content = `<path class="dkoefibun"/><path class="fas0scipg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ourhome" /></template>
<style>
.dkoefibun {
  fill: none;
  stroke: currentColor;
...
.fas0scipg {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M32.45 13.18V7.92a.4.4 0 0 1 .39-.39h5.68a.4.4 0 0 1 .39.39h0v10.75");
}
