...
const content = `<path class="n1vq-q6mz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:y-circle-sharp" /></template>
<style>
.n1vq-q6mz {
  fill: currentColor;
