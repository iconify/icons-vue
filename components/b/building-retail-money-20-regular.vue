...
const content = `<path class="tbj-tindy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-retail-money-20-regular" /></template>
<style>
.tbj-tindy {
  fill: currentColor;
