...
const content = `<g class="cuyn6tgcc"><path class="br4unobos"/><path class="jid1aybhl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:lastfm-logo-duotone" /></template>
<style>
.br4unobos {
  d: path("M240 160a32 32 0 0 1-32 32H64a48 48 0 0 1-48-48v-24a48 48 0 0 1 48-48h144a24 24 0 0 1 24 24Z");
