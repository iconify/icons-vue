...
const content = `<path class="n9q2v5brr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:boy-outline" /></template>
<style>
.n9q2v5brr {
  fill: currentColor;
