...
const content = `<path class="k4k38kziy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:amend-sharp" /></template>
<style>
.k4k38kziy {
  fill: currentColor;
