...
const content = `<path class="tc7hmxbxk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:video-library-rounded" /></template>
<style>
.tc7hmxbxk {
  fill: currentColor;
