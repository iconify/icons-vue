...
const content = `<path class="gupplebqo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-grammar-wand-20-filled" /></template>
<style>
.gupplebqo {
  fill: currentColor;
