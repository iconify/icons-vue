...
const content = `<path class="a3irmzb0w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:calendar-check-outline" /></template>
<style>
.a3irmzb0w {
  fill: currentColor;
