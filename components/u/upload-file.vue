...
const content = `<path class="n35e2qbkt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:upload-file" /></template>
<style>
.n35e2qbkt {
  fill: currentColor;
