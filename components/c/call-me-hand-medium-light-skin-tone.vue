...
const content = `<path class="tw_2x-g0i"/><defs><path id="SVGVxHWicRa" class="bo062f-dp"/></defs><clipPath id="SVG4zYiZ8kd"><use href="#SVGVxHWicRa"/></clipPath><path clip-path="url(#SVG4zYiZ8kd)" class="q5ftkjavc"/><defs><use href="#SVGVxHWicRa" id="SVGPdwshbFC"/></defs><clipPath id="SVGCw0ZpeuJ"><use href="#SVGPdwshbFC"/></clipPath><g clip-path="url(#SVGCw0ZpeuJ)" class="j9_i7vu4q"><path class="qczznxftm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:call-me-hand-medium-light-skin-tone" /></template>
<style>
.bo062f-dp {
