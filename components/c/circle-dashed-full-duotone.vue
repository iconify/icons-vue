...
const content = `<g class="nrj6p8qat"><path class="neicvubrs"/><path class="byyiqejry"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-full-duotone" /></template>
<style>
.byyiqejry {
  fill: currentColor;
