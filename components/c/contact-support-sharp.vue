...
const content = `<path class="jagu4-bgu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:contact-support-sharp" /></template>
<style>
.jagu4-bgu {
  fill: currentColor;
