...
const content = `<path class="n21a_mb5r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:earbuds-2-sharp" /></template>
<style>
.n21a_mb5r {
  fill: currentColor;
