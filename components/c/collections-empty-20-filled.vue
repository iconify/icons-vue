...
const content = `<path class="rqgsa0kwl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:collections-empty-20-filled" /></template>
<style>
.rqgsa0kwl {
  fill: currentColor;
