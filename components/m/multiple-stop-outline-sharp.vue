...
const content = `<path class="s2qqfns0f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:multiple-stop-outline-sharp" /></template>
<style>
.s2qqfns0f {
  fill: currentColor;
