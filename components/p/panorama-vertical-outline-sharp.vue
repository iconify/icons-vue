...
const content = `<path class="i9lzatbnf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:panorama-vertical-outline-sharp" /></template>
<style>
.i9lzatbnf {
  fill: currentColor;
