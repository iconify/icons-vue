...
const content = `<path class="mievohblp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:sound-wave-circle-sparkle-28-filled" /></template>
<style>
.mievohblp {
  fill: currentColor;
