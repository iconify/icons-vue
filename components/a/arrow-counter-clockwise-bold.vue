...
const content = `<path class="of8k4bc1p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-counter-clockwise-bold" /></template>
<style>
.of8k4bc1p {
  fill: currentColor;
