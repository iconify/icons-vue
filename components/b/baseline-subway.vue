...
const content = `<circle class="judm3s39l"/><circle class="h1qnjkbuv"/><path class="rir0lm6ob"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-subway" /></template>
<style>
.h1qnjkbuv {
  cx: 8.5px;
  cy: 16px;
