...
const content = `<path class="zv_funbwv"/><path class="k4n51fjcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-23mp" /></template>
<style>
.k4n51fjcs {
  fill: currentColor;
