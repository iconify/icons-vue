...
const content = `<g class="nrj6p8qat"><path class="smliiibgb"/><path class="d73-bct-o"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-dashed-quarter-fill" /></template>
<style>
.d73-bct-o {
