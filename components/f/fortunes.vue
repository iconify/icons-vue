...
const content = `<circle class="hk3cddcfq"/><path class="tpww5_bab"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fortunes" /></template>
<style>
.hk3cddcfq {
  cx: 24px;
  cy: 24px;
