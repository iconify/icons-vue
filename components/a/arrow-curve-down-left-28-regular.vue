...
const content = `<path class="nedo0905v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-curve-down-left-28-regular" /></template>
<style>
.nedo0905v {
  fill: currentColor;
