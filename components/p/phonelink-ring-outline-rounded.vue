...
const content = `<path class="xg1nmbwcf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phonelink-ring-outline-rounded" /></template>
<style>
.xg1nmbwcf {
  fill: currentColor;
