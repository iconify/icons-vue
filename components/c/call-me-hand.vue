...
const content = `<path class="nel602l4q"/><defs><path id="SVGVxHWicRa" class="bo062f-dp"/></defs><clipPath id="SVG4zYiZ8kd"><use href="#SVGVxHWicRa"/></clipPath><path clip-path="url(#SVG4zYiZ8kd)" class="cnah8llpd"/><defs><use href="#SVGVxHWicRa" id="SVGPdwshbFC"/></defs><clipPath id="SVGCw0ZpeuJ"><use href="#SVGPdwshbFC"/></clipPath><g clip-path="url(#SVGCw0ZpeuJ)" class="t3q4o6ulj"><path class="qczznxftm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:call-me-hand" /></template>
<style>
.bo062f-dp {
