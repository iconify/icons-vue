...
const content = `<path class="qss_jzvjc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:electric-bolt-outline" /></template>
<style>
.qss_jzvjc {
  fill: currentColor;
