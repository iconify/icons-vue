...
const content = `<path class="rle875bii"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:book-5-sharp" /></template>
<style>
.rle875bii {
  fill: currentColor;
