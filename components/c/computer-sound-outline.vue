...
const content = `<path class="a0y1gsb-n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:computer-sound-outline" /></template>
<style>
.a0y1gsb-n {
  fill: currentColor;
