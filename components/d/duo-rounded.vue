...
const content = `<path class="u_cxvj3uv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:duo-rounded" /></template>
<style>
.u_cxvj3uv {
  fill: currentColor;
