...
const content = `<path class="tgd-tbbum"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:detector-status" /></template>
<style>
.tgd-tbbum {
  fill: currentColor;
