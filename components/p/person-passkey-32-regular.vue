...
const content = `<path class="x7tnn58qi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-passkey-32-regular" /></template>
<style>
.x7tnn58qi {
  fill: currentColor;
