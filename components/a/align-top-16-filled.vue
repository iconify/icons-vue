...
const content = `<path class="anosfibnz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-top-16-filled" /></template>
<style>
.anosfibnz {
  fill: currentColor;
