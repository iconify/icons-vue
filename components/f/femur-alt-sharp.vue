...
const content = `<path class="gfss7qpun"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:femur-alt-sharp" /></template>
<style>
.gfss7qpun {
  fill: currentColor;
