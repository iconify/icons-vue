...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="c7stl4q4j"/><path class="lt79rppll"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:hammer-claw-circle" /></template>
<style>
.c7stl4q4j {
