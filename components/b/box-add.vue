...
const content = `<path class="gguc919pn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:box-add" /></template>
<style>
.gguc919pn {
  fill: currentColor;
