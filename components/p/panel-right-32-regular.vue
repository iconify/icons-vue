...
const content = `<path class="sz6ph22qa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-right-32-regular" /></template>
<style>
.sz6ph22qa {
  fill: currentColor;
