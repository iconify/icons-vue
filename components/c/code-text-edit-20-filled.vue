...
const content = `<path class="l8h8p5b4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:code-text-edit-20-filled" /></template>
<style>
.l8h8p5b4n {
  fill: currentColor;
