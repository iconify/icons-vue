...
const content = `<path class="d6_srwfno"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stylus-brush" /></template>
<style>
.d6_srwfno {
  fill: currentColor;
