...
const content = `<path class="ifj5mc70d"/><path class="hl72ww78g"/><path class="cczwequ4g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-drive-folder-upload" /></template>
<style>
.cczwequ4g {
  fill: currentColor;
