...
const content = `<path class="slt4oue2i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-circle-12-regular" /></template>
<style>
.slt4oue2i {
  fill: currentColor;
