...
const content = `<path class="pb-3-9b-b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:process-chart-outline-rounded" /></template>
<style>
.pb-3-9b-b {
  fill: currentColor;
