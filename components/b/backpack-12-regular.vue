...
const content = `<path class="ioxm4pbsv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:backpack-12-regular" /></template>
<style>
.ioxm4pbsv {
  fill: currentColor;
