...
const content = `<path class="zm6amu55j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:widget-medium-sharp" /></template>
<style>
.zm6amu55j {
  fill: currentColor;
