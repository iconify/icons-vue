...
const content = `<path class="rb0q2n0in"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:no-meals-sharp" /></template>
<style>
.rb0q2n0in {
  fill: currentColor;
