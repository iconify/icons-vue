...
const content = `<path class="qdrs389vc"/><path class="m-hz6t2ba"/><path class="xhjqhlbib"/><path class="e8ily1ivt"/><g class="wpq8nobzx"><circle class="dal3f-byj"/><circle class="xe5yt0fcj"/><circle class="h0fall9cf"/><circle class="iok86pkij"/></g><g class="jwyaq1-kp"><circle class="dingtypux"/><circle class="qj0b1_btg"/><circle class="hus1ozovc"/><circle class="axqb0kogj"/></g><circle class="acfmtbncs"/><path class="ra5rwqg7p"/><path class="gwj2p0-ao"/><circle class="bpliexbnx"/><path class="bpcoe-b1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-malta" /></template>
<style>
.acfmtbncs {
  cx: 6.032px;
  cy: 11.032px;
...
.m-hz6t2ba {
  ...
  d: path("M4 5a4 4 0 0 0-4 4v18a4 4 0 0 0 4 4h14V5z");
}

.qdrs389vc {
  fill: var(--svg-color--cf142b, #cf142b);
  d: path("M32 5H18v26h14a4 4 0 0 0 4-4V9a4 4 0 0 0-4-4");
}
