...
const content = `<path class="lu21hfxmr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:snowflake-outline-sharp" /></template>
<style>
.lu21hfxmr {
  fill: currentColor;
