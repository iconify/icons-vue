...
const content = `<path class="avy30fbip"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:beaker-settings-20-regular" /></template>
<style>
.avy30fbip {
  fill: currentColor;
