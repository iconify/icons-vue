...
const content = `<g class="wt8dzdiye"><path class="ueosuxbnk"/><path class="yqfnuhbge"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:swftc" /></template>
<style>
.ueosuxbnk {
  d: path("M12.78 6.6a2.42 2.42 0 0 1 1.922.936c-.756.135-.9.828-.9 1.296v6.089c0 1.54-1.273 2.38-2.579 2.475a2.1 2.1 0 0 1-1.921-.99c.68-.315.9-.81.9-1.224v-6.35c0-1.296 1.328-2.214 2.579-2.232");
}
