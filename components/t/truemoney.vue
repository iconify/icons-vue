...
const content = `<path class="tiye-f46n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:truemoney" /></template>
<style>
.tiye-f46n {
  fill: none;
  stroke: currentColor;
