...
const content = `<path class="qoi5a0bfd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chevron-down-circle-24-filled" /></template>
<style>
.qoi5a0bfd {
