...
const content = `<path class="oopqzei0y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-header-48-regular" /></template>
<style>
.oopqzei0y {
  fill: currentColor;
