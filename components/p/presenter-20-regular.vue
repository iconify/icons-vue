...
const content = `<path class="vyrg4cbbz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:presenter-20-regular" /></template>
<style>
.vyrg4cbbz {
  fill: currentColor;
