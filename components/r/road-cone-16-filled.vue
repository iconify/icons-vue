...
const content = `<path class="lkmywkfxb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:road-cone-16-filled" /></template>
<style>
.lkmywkfxb {
  fill: currentColor;
