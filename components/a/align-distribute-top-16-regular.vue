...
const content = `<path class="g9t9zgeej"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-distribute-top-16-regular" /></template>
<style>
.g9t9zgeej {
  fill: currentColor;
