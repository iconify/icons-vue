...
const content = `<path class="rmy1hccoe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-sync-32-filled" /></template>
<style>
.rmy1hccoe {
  fill: currentColor;
