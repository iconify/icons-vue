...
const content = `<path class="xn_dvz8qu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:emoji-language-sharp" /></template>
<style>
.xn_dvz8qu {
  fill: currentColor;
