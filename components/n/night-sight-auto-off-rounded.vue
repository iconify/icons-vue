...
const content = `<path class="pcw7k5wlw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:night-sight-auto-off-rounded" /></template>
<style>
.pcw7k5wlw {
  fill: currentColor;
