...
const content = `<path class="lxkh6bbng"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:filter-3-rounded" /></template>
<style>
.lxkh6bbng {
  fill: currentColor;
