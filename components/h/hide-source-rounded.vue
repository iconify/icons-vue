...
const content = `<path class="hyrmn_a1k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hide-source-rounded" /></template>
<style>
.hyrmn_a1k {
  fill: currentColor;
