...
const content = `<path class="awujtcbza"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:movie-edit-sharp" /></template>
<style>
.awujtcbza {
  fill: currentColor;
