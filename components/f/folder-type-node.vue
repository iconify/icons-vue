...
const content = `<path class="qyexaccfw"/><path class="x3hdebb3q"/><path class="kqzryhbet"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-node" /></template>
<style>
.kqzryhbet {
