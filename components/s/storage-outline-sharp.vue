...
const content = `<path class="fuf_rigco"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:storage-outline-sharp" /></template>
<style>
.fuf_rigco {
  fill: currentColor;
