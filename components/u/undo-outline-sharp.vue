...
const content = `<path class="t8b1-f6ti"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:undo-outline-sharp" /></template>
<style>
.t8b1-f6ti {
  fill: currentColor;
