...
const content = `<path class="raxftabod"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:timer-pause-sharp" /></template>
<style>
.raxftabod {
  fill: currentColor;
