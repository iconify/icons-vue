...
const content = `<path class="p4503ul5f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:book-ribbon-sharp" /></template>
<style>
.p4503ul5f {
  fill: currentColor;
