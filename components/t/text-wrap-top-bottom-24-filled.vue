...
const content = `<path class="cpecpfs_r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-wrap-top-bottom-24-filled" /></template>
<style>
.cpecpfs_r {
  fill: currentColor;
