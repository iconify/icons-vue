...
const content = `<path class="m16zfwzui"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-bend-double-up-left-thin" /></template>
<style>
.m16zfwzui {
  fill: currentColor;
