...
const content = `<path class="p99eo7wjt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:license-outline-sharp" /></template>
<style>
.p99eo7wjt {
  fill: currentColor;
