...
const content = `<path class="vn7gdow4g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:light-off-sharp" /></template>
<style>
.vn7gdow4g {
  fill: currentColor;
