...
const content = `<path class="esspykwmu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-toolbox-24-filled" /></template>
<style>
.esspykwmu {
  fill: currentColor;
