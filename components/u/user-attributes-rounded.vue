...
const content = `<path class="dxoe9ab2f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:user-attributes-rounded" /></template>
<style>
.dxoe9ab2f {
  fill: currentColor;
