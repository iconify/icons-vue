...
const content = `<path class="lm61yyb7h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:align-justify-flex-start-rounded" /></template>
<style>
.lm61yyb7h {
  fill: currentColor;
