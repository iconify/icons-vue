...
const content = `<path class="axp2tzc1q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:family-star-outline-rounded" /></template>
<style>
.axp2tzc1q {
  fill: currentColor;
