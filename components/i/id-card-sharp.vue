...
const content = `<path class="ki8wc7f0v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:id-card-sharp" /></template>
<style>
.ki8wc7f0v {
  fill: currentColor;
