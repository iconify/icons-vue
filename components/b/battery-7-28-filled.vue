...
const content = `<path class="q8d-l8fcv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-7-28-filled" /></template>
<style>
.q8d-l8fcv {
  fill: currentColor;
