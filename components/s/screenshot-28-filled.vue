...
const content = `<path class="op_7o307u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:screenshot-28-filled" /></template>
<style>
.op_7o307u {
  fill: currentColor;
