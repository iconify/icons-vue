...
const content = `<path class="g6l1ulm4q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:swipe-left-outline" /></template>
<style>
.g6l1ulm4q {
  fill: currentColor;
