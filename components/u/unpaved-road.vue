...
const content = `<path class="tswrdobii"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:unpaved-road" /></template>
<style>
.tswrdobii {
  fill: currentColor;
