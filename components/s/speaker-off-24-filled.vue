...
const content = `<path class="b0p375b0c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-off-24-filled" /></template>
<style>
.b0p375b0c {
  fill: currentColor;
