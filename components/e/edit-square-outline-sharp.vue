...
const content = `<path class="p_z1wlf8s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-square-outline-sharp" /></template>
<style>
.p_z1wlf8s {
  fill: currentColor;
