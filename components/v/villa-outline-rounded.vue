...
const content = `<path class="yaul05b0e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:villa-outline-rounded" /></template>
<style>
.yaul05b0e {
  fill: currentColor;
