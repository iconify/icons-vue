...
const content = `<path class="f4boacaee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:resize-video-20-regular" /></template>
<style>
.f4boacaee {
  fill: currentColor;
