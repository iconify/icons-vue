...
const content = `<path class="cyf0nio7t"/><path class="qnxn34bwt"/><path class="smx0ezbgg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-russia" /></template>
<style>
.cyf0nio7t {
