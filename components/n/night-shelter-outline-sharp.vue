...
const content = `<path class="xp-ds4-ad"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:night-shelter-outline-sharp" /></template>
<style>
.xp-ds4-ad {
  fill: currentColor;
