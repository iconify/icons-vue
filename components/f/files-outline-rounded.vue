...
const content = `<path class="wmksqvbdt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:files-outline-rounded" /></template>
<style>
.wmksqvbdt {
  fill: currentColor;
