...
const content = `<path class="whza1_0ug"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:double-arrow-outline-rounded" /></template>
<style>
.whza1_0ug {
  fill: currentColor;
