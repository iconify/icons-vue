...
const content = `<path class="ufdgfpvoa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:panorama-outline-rounded" /></template>
<style>
.ufdgfpvoa {
  fill: currentColor;
