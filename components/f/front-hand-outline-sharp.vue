...
const content = `<path class="m4qucab0m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:front-hand-outline-sharp" /></template>
<style>
.m4qucab0m {
  fill: currentColor;
