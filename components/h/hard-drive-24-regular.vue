...
const content = `<path class="vqi-irzyf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:hard-drive-24-regular" /></template>
<style>
.vqi-irzyf {
  fill: currentColor;
