...
const content = `<path class="iz6i2ybzx"/><path class="pyksxplae"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-devices-fold" /></template>
<style>
.iz6i2ybzx {
  fill: currentColor;
