...
const content = `<g class="cuyn6tgcc"><path class="blzj4acss"/><path class="sbb6rdbas"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:phone-x-duotone" /></template>
<style>
.blzj4acss {
