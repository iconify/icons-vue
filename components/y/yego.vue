...
const content = `<circle class="cpk0fnbgt"/><path class="b8ca42bkn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:yego" /></template>
<style>
.b8ca42bkn {
  fill: none;
  stroke: currentColor;
