...
const content = `<path class="htr6tvoyf"/><circle class="saiq40xqt"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:swile" /></template>
<style>
.htr6tvoyf {
  fill: none;
  stroke: currentColor;
