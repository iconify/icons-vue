...
const content = `<path class="gk-8ol-ij"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:water-full-outline" /></template>
<style>
.gk-8ol-ij {
  fill: currentColor;
