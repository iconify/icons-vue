...
const content = `<path class="hh_i0xbub"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:holiday-village-outline-sharp" /></template>
<style>
.hh_i0xbub {
  fill: currentColor;
