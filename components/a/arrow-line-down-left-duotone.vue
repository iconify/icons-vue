...
const content = `<g class="cuyn6tgcc"><path class="e2-wfbbbz"/><path class="d3ag7ub5l"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-line-down-left-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
