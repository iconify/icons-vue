...
const content = `<path class="twlwg5bvv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-inbox-person-32-filled" /></template>
<style>
.twlwg5bvv {
  fill: currentColor;
