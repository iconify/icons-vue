...
const content = `<path class="b76psvbae"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:down-button" /></template>
<style>
.b76psvbae {
  fill: currentColor;
