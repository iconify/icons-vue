...
const content = `<path class="pzkxd-19g"/><path class="xlbj58b_a"/><path class="hz8dlkvwx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:smiling-face-with-sunglasses" /></template>
<style>
.hz8dlkvwx {
  fill: var(--svg-color--664e27, #664e27);
  d: path("M44.6 42.3c-8.1 5.7-17.1 5.6-25.2 0c-1-.7-1.8.5-1.2 1.6c2.5 4 7.4 7.7 13.8 7.7s11.3-3.6 13.8-7.7c.6-1.1-.2-2.3-1.2-1.6");
}

.pzkxd-19g {
  fill: var(--svg-color--ffdd67, #ffdd67);
  d: path("M32 2c16.6 0 30 13.4 30 30S48.6 62 32 62S2 48.6 2 32S15.4 2 32 2");
}
