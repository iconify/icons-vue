...
const content = `<path class="v10iw94hf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:more-horiz-outline-rounded" /></template>
<style>
.v10iw94hf {
  fill: currentColor;
