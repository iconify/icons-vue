...
const content = `<path class="wjedr8bzz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:airline-seat-recline-normal-outline-sharp" /></template>
<style>
.wjedr8bzz {
  fill: currentColor;
