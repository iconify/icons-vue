...
const content = `<rect class="q54946azd"/><path class="qpo6olg9v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:clonephone" /></template>
<style>
.q54946azd {
  width: 16.775px;
  height: 32.259px;
