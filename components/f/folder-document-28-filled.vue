...
const content = `<path class="ocmqgub-c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-document-28-filled" /></template>
<style>
.ocmqgub-c {
  fill: currentColor;
