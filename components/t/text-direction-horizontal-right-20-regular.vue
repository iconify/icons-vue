...
const content = `<path class="emx6fgb_i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-horizontal-right-20-regular" /></template>
<style>
.emx6fgb_i {
  fill: currentColor;
