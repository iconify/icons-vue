...
const content = `<path class="cijfirbsm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pallet-outline-rounded" /></template>
<style>
.cijfirbsm {
  fill: currentColor;
