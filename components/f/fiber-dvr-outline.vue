...
const content = `<path class="rjn22o_6k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fiber-dvr-outline" /></template>
<style>
.rjn22o_6k {
  fill: currentColor;
