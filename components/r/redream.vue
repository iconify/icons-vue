...
const content = `<path class="mjtk3xnuv"/><path class="s9d7qtbxt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:redream" /></template>
<style>
.mjtk3xnuv {
  fill: none;
  stroke: currentColor;
...
.s9d7qtbxt {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M28.25 9.149a12.6 12.6 0 0 0-6.356 1.784c-1.224 6.457-.444 10.789-.119 15.746c3.728-5.454 4.037-6.098 4.134-5.528c.552 3.234 1.37 11.235.29 15.712c-.172.66-2.243 1.282-6.69 2.035");
}
