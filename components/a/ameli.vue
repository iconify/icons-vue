...
const content = `<path class="grdyawb0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ameli" /></template>
<style>
.grdyawb0l {
  fill: none;
  stroke: currentColor;
