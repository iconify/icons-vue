...
const content = `<path class="mhp7jobuo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sentiment-extremely-dissatisfied-rounded" /></template>
<style>
.mhp7jobuo {
  fill: currentColor;
