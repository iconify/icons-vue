...
const content = `<g class="cuyn6tgcc"><g clip-rule="evenodd" class="d2kvgvbvc"><path class="sgtu7yuar"/><path class="c6uageb_z"/><path class="yj_ury1ar"/><path class="new2gq-mz"/></g><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:clapperboard-off" /></template>
<style>
.c6uageb_z {
