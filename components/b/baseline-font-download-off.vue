...
const content = `<path class="fiv7ktv_g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-font-download-off" /></template>
<style>
.fiv7ktv_g {
  fill: currentColor;
