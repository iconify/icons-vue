...
const content = `<path class="npdjyx9ti"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:checked-bag" /></template>
<style>
.npdjyx9ti {
  fill: currentColor;
