...
const content = `<path class="jgwtwccsi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-info-16-filled" /></template>
<style>
.jgwtwccsi {
  fill: currentColor;
