...
const content = `<g class="y9tr6bcfx"><path class="evy-ncczb"/><path class="rowdfsbzc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bottledrop" /></template>
<style>
.evy-ncczb {
