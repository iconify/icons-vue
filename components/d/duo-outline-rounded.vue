...
const content = `<path class="aeozgzz2d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:duo-outline-rounded" /></template>
<style>
.aeozgzz2d {
  fill: currentColor;
