...
const content = `<path class="ufmt_x8ec"/><path class="r1yi95bps"/><path class="yyxtffboj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gcore" /></template>
<style>
.r1yi95bps {
  fill: none;
  stroke: currentColor;
