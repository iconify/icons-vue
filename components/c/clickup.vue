...
const content = `<path class="m4279zeog"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:clickup" /></template>
<style>
.m4279zeog {
  fill: none;
  stroke: currentColor;
