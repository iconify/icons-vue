...
const content = `<path class="jnfl_n1mz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-sunny-28-regular" /></template>
<style>
.jnfl_n1mz {
  fill: currentColor;
