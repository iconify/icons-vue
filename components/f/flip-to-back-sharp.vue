...
const content = `<path class="ve2q_bbad"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:flip-to-back-sharp" /></template>
<style>
.ve2q_bbad {
  fill: currentColor;
