...
const content = `<path class="l2l0nf7ga"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vpn-key-off-rounded" /></template>
<style>
.l2l0nf7ga {
  fill: currentColor;
