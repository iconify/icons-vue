...
const content = `<path class="o90t-3bcm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:6k-plus-outline-sharp" /></template>
<style>
.o90t-3bcm {
  fill: currentColor;
