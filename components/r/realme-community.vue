...
const content = `<path class="zvg8tubnn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:realme-community" /></template>
<style>
.zvg8tubnn {
  fill: none;
  stroke: currentColor;
