...
const content = `<path class="k_xo3fbkf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:skateboarding-outline" /></template>
<style>
.k_xo3fbkf {
  fill: currentColor;
