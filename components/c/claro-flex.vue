...
const content = `<path class="uo47pyvli"/><rect class="zff1mybez"/><path class="egev37bfe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:claro-flex" /></template>
<style>
.egev37bfe {
  fill: none;
  stroke: currentColor;
