...
const content = `<g class="cuyn6tgcc"><path class="dfgwsd1rs"/><path class="p3l9yi4ex"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:terminal-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
