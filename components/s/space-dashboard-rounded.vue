...
const content = `<path class="lt3mjub1q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:space-dashboard-rounded" /></template>
<style>
.lt3mjub1q {
  fill: currentColor;
