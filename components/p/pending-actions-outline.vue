...
const content = `<path class="mwbkg5b4u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pending-actions-outline" /></template>
<style>
.mwbkg5b4u {
  fill: currentColor;
