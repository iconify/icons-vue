...
const content = `<path class="h75ojr7lm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-delete-24-filled" /></template>
<style>
.h75ojr7lm {
  fill: currentColor;
