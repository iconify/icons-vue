...
const content = `<path class="nbtu2nbfe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:eyebrow-outline-sharp" /></template>
<style>
.nbtu2nbfe {
  fill: currentColor;
