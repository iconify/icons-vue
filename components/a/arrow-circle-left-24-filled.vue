...
const content = `<path class="vo_bpwb2j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-left-24-filled" /></template>
<style>
.vo_bpwb2j {
  fill: currentColor;
