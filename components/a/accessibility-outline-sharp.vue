...
const content = `<path class="ccv395bda"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:accessibility-outline-sharp" /></template>
<style>
.ccv395bda {
  fill: currentColor;
