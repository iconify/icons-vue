...
const content = `<path class="uan2h1lur"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:connected-20-regular" /></template>
<style>
.uan2h1lur {
  fill: currentColor;
