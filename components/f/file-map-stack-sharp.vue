...
const content = `<path class="lvabyac-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:file-map-stack-sharp" /></template>
<style>
.lvabyac-y {
  fill: currentColor;
