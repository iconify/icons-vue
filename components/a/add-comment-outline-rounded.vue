...
const content = `<path class="qkl7t7u-h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:add-comment-outline-rounded" /></template>
<style>
.qkl7t7u-h {
  fill: currentColor;
