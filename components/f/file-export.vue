...
const content = `<path class="sierwqwss"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:file-export" /></template>
<style>
.sierwqwss {
  fill: currentColor;
