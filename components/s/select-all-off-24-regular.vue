...
const content = `<path class="tmibwesve"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:select-all-off-24-regular" /></template>
<style>
.tmibwesve {
  fill: currentColor;
