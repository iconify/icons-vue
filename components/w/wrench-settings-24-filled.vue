...
const content = `<path class="w2140cfee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:wrench-settings-24-filled" /></template>
<style>
.w2140cfee {
  fill: currentColor;
