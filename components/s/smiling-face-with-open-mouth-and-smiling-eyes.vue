...
const content = `<path class="tg31urbgg"/><path class="twgr17b5c"/><path class="mu3hjibwp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:smiling-face-with-open-mouth-and-smiling-eyes" /></template>
<style>
.mu3hjibwp {
