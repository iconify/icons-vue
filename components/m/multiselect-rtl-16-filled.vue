...
const content = `<path class="dtgeas6hg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:multiselect-rtl-16-filled" /></template>
<style>
.dtgeas6hg {
  fill: currentColor;
