...
const content = `<path class="ppkigwdau"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:repeat-one-outline-sharp" /></template>
<style>
.ppkigwdau {
  fill: currentColor;
