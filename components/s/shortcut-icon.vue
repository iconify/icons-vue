...
const content = `<path class="neft1q7fb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:shortcut-icon" /></template>
<style>
.neft1q7fb {
  fill: var(--svg-color--58b1e4, #58b1e4);
