...
const content = `<path class="qjc3z15-z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-play-24-filled" /></template>
<style>
.qjc3z15-z {
  fill: currentColor;
