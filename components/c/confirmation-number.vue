...
const content = `<path class="poudobc4s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:confirmation-number" /></template>
<style>
.poudobc4s {
  fill: currentColor;
