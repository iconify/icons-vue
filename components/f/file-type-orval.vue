...
const content = `<g class="ft5dv1b6b"><path class="lpey1abhw"/><path clip-rule="evenodd" class="hrda3nbug"/><path class="nrvf68bvx"/><path class="p_8gvhb9r"/><path clip-rule="evenodd" class="w3pvr-tgr"/><path class="mq67rznbx"/><path class="uwpltt2ty"/></g>`;
</script>
...
.hrda3nbug {
  fill: var(--svg-color--45239b, #45239b);
  fill-rule: evenodd;
...
.mq67rznbx {
  fill: var(--svg-color--7b48d5, #7b48d5);
...
.uwpltt2ty {
  fill: var(--svg-color--f89e53, #f89e53);
