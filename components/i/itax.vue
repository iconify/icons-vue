...
const content = `<path class="ooxd0rbox"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:itax" /></template>
<style>
.ooxd0rbox {
  fill: none;
  stroke: currentColor;
