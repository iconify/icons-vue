...
const content = `<path class="b3qk577yt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bluetooth-48-regular" /></template>
<style>
.b3qk577yt {
  fill: currentColor;
