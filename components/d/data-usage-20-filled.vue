...
const content = `<path class="d43w683vu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-usage-20-filled" /></template>
<style>
.d43w683vu {
  fill: currentColor;
