...
const content = `<path class="uicfwjbvi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-mobile-screen-share" /></template>
<style>
.uicfwjbvi {
  fill: currentColor;
