...
const content = `<path class="ec63smi6v"/><path class="qrwpk_btf"/><path class="l8w5xxbqw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-gabon" /></template>
<style>
.ec63smi6v {
