...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="qk25g2bni"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-archive-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
