...
const content = `<path class="gsgmitbwz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-export-ltr-32-light" /></template>
<style>
.gsgmitbwz {
  fill: currentColor;
