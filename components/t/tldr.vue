...
const content = `<path class="ydqthzbbt"/><path class="pq7zqmbzm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tldr" /></template>
<style>
.pq7zqmbzm {
  fill: none;
  stroke: currentColor;
