...
const content = `<path class="ekn96340i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-repeat-1-16-filled" /></template>
<style>
.ekn96340i {
  fill: currentColor;
