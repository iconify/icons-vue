...
const content = `<path class="po737nzto"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flash-sparkle-20-filled" /></template>
<style>
.po737nzto {
  fill: currentColor;
