...
const content = `<g class="cuyn6tgcc"><path class="hgvv-cbcb"/><path class="w9hud-b4d"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:island-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
