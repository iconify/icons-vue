...
const content = `<path class="v0__ciusa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:directions-bus-rounded" /></template>
<style>
.v0__ciusa {
  fill: currentColor;
