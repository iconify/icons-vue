...
const content = `<path class="w7pf1flaa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-description-28-regular" /></template>
<style>
.w7pf1flaa {
  fill: currentColor;
