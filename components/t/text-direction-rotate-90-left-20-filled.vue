...
const content = `<path class="pu3dvgb2l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-rotate-90-left-20-filled" /></template>
<style>
.pu3dvgb2l {
  fill: currentColor;
