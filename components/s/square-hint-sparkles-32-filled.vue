...
const content = `<path class="ffzd3n3wh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-sparkles-32-filled" /></template>
<style>
.ffzd3n3wh {
  fill: currentColor;
