...
const content = `<path class="el6kizj0j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:desktop-cloud-stack-outline-sharp" /></template>
<style>
.el6kizj0j {
  fill: currentColor;
