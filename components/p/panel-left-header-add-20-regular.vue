...
const content = `<path class="hf9ticbfa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-header-add-20-regular" /></template>
<style>
.hf9ticbfa {
  fill: currentColor;
