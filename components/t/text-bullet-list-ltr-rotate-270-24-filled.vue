...
const content = `<path class="o_tx369mt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-bullet-list-ltr-rotate-270-24-filled" /></template>
<style>
.o_tx369mt {
  fill: currentColor;
