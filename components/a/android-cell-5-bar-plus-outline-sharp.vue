...
const content = `<path class="qlsoegprc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:android-cell-5-bar-plus-outline-sharp" /></template>
<style>
.qlsoegprc {
  fill: currentColor;
