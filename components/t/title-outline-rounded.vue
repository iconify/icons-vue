...
const content = `<path class="e1_nopbic"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:title-outline-rounded" /></template>
<style>
.e1_nopbic {
  fill: currentColor;
