...
const content = `<path class="zaykqtrlm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bookmark-28-regular" /></template>
<style>
.zaykqtrlm {
  fill: currentColor;
