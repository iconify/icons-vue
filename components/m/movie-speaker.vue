...
const content = `<path class="mo5-beb9b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:movie-speaker" /></template>
<style>
.mo5-beb9b {
  fill: currentColor;
