...
const content = `<path class="bml7y_72n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-rows-narrow-outline-rounded" /></template>
<style>
.bml7y_72n {
  fill: currentColor;
