...
const content = `<path class="yypqxlb9y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shield-with-heart-outline-sharp" /></template>
<style>
.yypqxlb9y {
  fill: currentColor;
