...
const content = `<path class="nt5fpo46x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-data-16-filled" /></template>
<style>
.nt5fpo46x {
  fill: currentColor;
