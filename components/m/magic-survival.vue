...
const content = `<path class="dzbe-zbme"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:magic-survival" /></template>
<style>
.dzbe-zbme {
  fill: none;
  stroke: currentColor;
