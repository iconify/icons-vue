...
const content = `<path class="b0mwdn7xj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:casino-outline-rounded" /></template>
<style>
.b0mwdn7xj {
  fill: currentColor;
