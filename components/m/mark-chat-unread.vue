...
const content = `<path class="zjgj2v_zi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mark-chat-unread" /></template>
<style>
.zjgj2v_zi {
  fill: currentColor;
