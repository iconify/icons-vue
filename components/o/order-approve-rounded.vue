...
const content = `<path class="is0zcbais"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:order-approve-rounded" /></template>
<style>
.is0zcbais {
  fill: currentColor;
