...
const content = `<path class="eyrno9bjs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:body-fat-outline-sharp" /></template>
<style>
.eyrno9bjs {
  fill: currentColor;
