...
const content = `<path class="j2mpfj38h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:open-in-browser-outline" /></template>
<style>
.j2mpfj38h {
  fill: currentColor;
