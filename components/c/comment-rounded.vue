...
const content = `<path class="z2k4lg_dy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:comment-rounded" /></template>
<style>
.z2k4lg_dy {
  fill: currentColor;
