...
const content = `<path class="i6te_melg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-alert-sharp" /></template>
<style>
.i6te_melg {
  fill: currentColor;
