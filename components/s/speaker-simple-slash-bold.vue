...
const content = `<path class="aryabdqof"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:speaker-simple-slash-bold" /></template>
<style>
.aryabdqof {
  fill: currentColor;
