...
const content = `<path class="zgd_ltbum"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-mirror-heat-outline" /></template>
<style>
.zgd_ltbum {
  fill: currentColor;
