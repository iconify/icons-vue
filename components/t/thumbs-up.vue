...
const content = `<path clip-rule="evenodd" class="p92apbc6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:thumbs-up" /></template>
<style>
.p92apbc6u {
  fill: currentColor;
  fill-rule: evenodd;
