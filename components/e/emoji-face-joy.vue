...
const content = `<path class="w9xcawbsm"/><path class="t1xpcl35w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-face-joy" /></template>
<style>
.t1xpcl35w {
  fill: none;
  stroke: currentColor;
...
.w9xcawbsm {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M6.58 30.35A18.53 18.53 0 0 0 24 42.5c7.95 0 14.7-5.01 17.3-12.07M5.47 23.65C5.63 13.57 13.84 5.5 24 5.5c10.18 0 18.39 8.17 18.46 18.33");
}
