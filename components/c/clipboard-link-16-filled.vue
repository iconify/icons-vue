...
const content = `<path class="exod75bwe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-link-16-filled" /></template>
<style>
.exod75bwe {
  fill: currentColor;
