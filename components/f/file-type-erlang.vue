...
const content = `<path class="qa_1u-j9r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-erlang" /></template>
<style>
.qa_1u-j9r {
  fill: var(--svg-color--a2003e, #a2003e);
