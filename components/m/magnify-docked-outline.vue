...
const content = `<path class="loketx-1v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:magnify-docked-outline" /></template>
<style>
.loketx-1v {
  fill: currentColor;
