...
const content = `<path class="ffvbwybun"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ifl-sharp" /></template>
<style>
.ffvbwybun {
  fill: currentColor;
