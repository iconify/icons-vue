...
const content = `<path class="zfr71c_hl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:branch-fork-hint-20-filled" /></template>
<style>
.zfr71c_hl {
  fill: currentColor;
