...
const content = `<path class="wqblggb6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hourglass-bottom-outline-sharp" /></template>
<style>
.wqblggb6i {
  fill: currentColor;
