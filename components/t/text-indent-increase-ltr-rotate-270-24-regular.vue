...
const content = `<path class="cqsimh6tf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-increase-ltr-rotate-270-24-regular" /></template>
<style>
.cqsimh6tf {
  fill: currentColor;
