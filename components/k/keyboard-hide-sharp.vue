...
const content = `<path class="nmw-mac6n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-hide-sharp" /></template>
<style>
.nmw-mac6n {
  fill: currentColor;
