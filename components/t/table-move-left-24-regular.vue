...
const content = `<path class="lhku3gbgw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-left-24-regular" /></template>
<style>
.lhku3gbgw {
  fill: currentColor;
