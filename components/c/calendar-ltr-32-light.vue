...
const content = `<path class="nbwojvfcv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-ltr-32-light" /></template>
<style>
.nbwojvfcv {
  fill: currentColor;
