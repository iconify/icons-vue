...
const content = `<path class="bdwp56ozc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:import-spark-sharp" /></template>
<style>
.bdwp56ozc {
  fill: currentColor;
