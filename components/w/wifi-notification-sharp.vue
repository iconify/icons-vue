...
const content = `<path class="mxm1-jlhm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wifi-notification-sharp" /></template>
<style>
.mxm1-jlhm {
  fill: currentColor;
