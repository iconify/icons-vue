...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:humidity-sharp" /></template>
<style>
.qrtcvsb7z {
  fill: none;
  stroke: currentColor;
