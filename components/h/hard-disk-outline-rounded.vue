...
const content = `<path class="y47jtlb_u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hard-disk-outline-rounded" /></template>
<style>
.y47jtlb_u {
  fill: currentColor;
