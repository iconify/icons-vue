...
const content = `<path class="m4rqhpb1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-right-32-filled" /></template>
<style>
.m4rqhpb1m {
  fill: currentColor;
