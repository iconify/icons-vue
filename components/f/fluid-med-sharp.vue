...
const content = `<path class="c1kvcubuo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fluid-med-sharp" /></template>
<style>
.c1kvcubuo {
  fill: currentColor;
