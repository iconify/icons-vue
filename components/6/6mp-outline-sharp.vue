...
const content = `<path class="xo8-9kb6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:6mp-outline-sharp" /></template>
<style>
.xo8-9kb6a {
  fill: currentColor;
