...
const content = `<path class="ic-8_09wp"/><path class="s5kxvcp2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-plumbing" /></template>
<style>
.ic-8_09wp {
  fill: currentColor;
