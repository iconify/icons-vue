...
const content = `<path class="naixi4sgq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:firefox" /></template>
<style>
.naixi4sgq {
  fill: none;
  stroke: currentColor;
