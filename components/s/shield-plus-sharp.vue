...
const content = `<path class="wbtzlbb3u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shield-plus-sharp" /></template>
<style>
.wbtzlbb3u {
  fill: none;
  stroke: currentColor;
