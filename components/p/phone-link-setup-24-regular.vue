...
const content = `<path class="zyxu39bgv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-link-setup-24-regular" /></template>
<style>
.zyxu39bgv {
  fill: currentColor;
