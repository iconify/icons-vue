...
const content = `<path class="i9clfwm2k"/><path class="a-lsb4b3x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wordreference" /></template>
<style>
.a-lsb4b3x {
  fill: none;
  stroke: currentColor;
