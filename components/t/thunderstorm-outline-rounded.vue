...
const content = `<path class="z4o8o6bsp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:thunderstorm-outline-rounded" /></template>
<style>
.z4o8o6bsp {
  fill: currentColor;
