...
const content = `<path class="mppa77b6p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:7mp" /></template>
<style>
.mppa77b6p {
  fill: currentColor;
