...
const content = `<path class="rm8y3pv6k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:double-tap-swipe-up-16-regular" /></template>
<style>
.rm8y3pv6k {
  fill: currentColor;
