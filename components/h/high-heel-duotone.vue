...
const content = `<g class="cuyn6tgcc"><path class="ww-tahbrz"/><path class="uto-p7uwl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:high-heel-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
