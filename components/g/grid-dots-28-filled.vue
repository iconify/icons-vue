...
const content = `<path class="t7bmuwbge"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:grid-dots-28-filled" /></template>
<style>
.t7bmuwbge {
  fill: currentColor;
