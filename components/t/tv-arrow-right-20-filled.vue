...
const content = `<path class="ecp79xbex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tv-arrow-right-20-filled" /></template>
<style>
.ecp79xbex {
  fill: currentColor;
