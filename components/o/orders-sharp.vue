...
const content = `<path class="eaop05b6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:orders-sharp" /></template>
<style>
.eaop05b6a {
  fill: currentColor;
