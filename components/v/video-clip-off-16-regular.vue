...
const content = `<path class="qf2_bx9bk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-clip-off-16-regular" /></template>
<style>
.qf2_bx9bk {
  fill: currentColor;
