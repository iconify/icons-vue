...
const content = `<path class="br_1d9wzb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fan-focus-outline-sharp" /></template>
<style>
.br_1d9wzb {
  fill: currentColor;
