...
const content = `<path class="izt4u5b_t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:feed-outline" /></template>
<style>
.izt4u5b_t {
  fill: currentColor;
