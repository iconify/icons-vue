...
const content = `<path class="uv0pm91tx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:table-restaurant-outline-rounded" /></template>
<style>
.uv0pm91tx {
  fill: currentColor;
