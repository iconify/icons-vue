...
const content = `<g class="cuyn6tgcc"><path class="w_vdicbgh"/><path class="u_mpg_szn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrows-out-cardinal-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.w_vdicbgh {
  d: path("M232 128L128 232L24 128L128 24Z");
