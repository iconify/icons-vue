...
const content = `<path class="y6oqv8b7o"/><g class="y9tr6bcfx"><path class="ewgaqbkpl"/><path class="su86ukb8u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:foxpay" /></template>
<style>
.ewgaqbkpl {
