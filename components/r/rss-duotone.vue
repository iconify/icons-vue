...
const content = `<g class="cuyn6tgcc"><path class="v0yfvacpt"/><path class="z_58m1bap"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:rss-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
