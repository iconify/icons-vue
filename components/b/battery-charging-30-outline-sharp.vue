...
const content = `<path class="qoxrwqbcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-charging-30-outline-sharp" /></template>
<style>
.qoxrwqbcs {
  fill: currentColor;
