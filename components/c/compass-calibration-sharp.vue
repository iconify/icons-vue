...
const content = `<path class="vv23e5vqz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:compass-calibration-sharp" /></template>
<style>
.vv23e5vqz {
  fill: currentColor;
