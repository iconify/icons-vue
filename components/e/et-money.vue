...
const content = `<path class="korijacyi"/><path class="z7-9a_g0p"/><path class="y5u_04b9n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:et-money" /></template>
<style>
.korijacyi {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M15.789 24.18c.04-4.618 3.598-8.546 8.606-8.666V2.5c-11.065.43-21.26 8.356-21.59 21.64zm10.755-8.366L30.132 3.31m-.989 13.743l7.436-10.665m-5.117 12.734l10.525-7.466M32.73 22l12.465-3.417M34.27 24.54c.03 6.077-6.007 9.146-9.855 9.375");
}
...
.z7-9a_g0p {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M38.968 24.54c0 8.146-9.146 14.603-14.253 14.043");
}
