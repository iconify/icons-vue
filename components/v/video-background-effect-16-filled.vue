...
const content = `<path class="gb5czjb-v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-background-effect-16-filled" /></template>
<style>
.gb5czjb-v {
  fill: currentColor;
