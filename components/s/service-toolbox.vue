...
const content = `<path class="glsefdwbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:service-toolbox" /></template>
<style>
.glsefdwbl {
  fill: currentColor;
