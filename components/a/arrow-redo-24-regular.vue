...
const content = `<path class="tmrtywb5o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-redo-24-regular" /></template>
<style>
.tmrtywb5o {
  fill: currentColor;
