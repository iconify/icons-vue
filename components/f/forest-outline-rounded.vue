...
const content = `<path class="kl2vgo8rt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:forest-outline-rounded" /></template>
<style>
.kl2vgo8rt {
  fill: currentColor;
