...
const content = `<path class="hxwbeioxu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-left-2-outline" /></template>
<style>
.hxwbeioxu {
  fill: currentColor;
