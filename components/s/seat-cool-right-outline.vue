...
const content = `<path class="wbvkz460w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:seat-cool-right-outline" /></template>
<style>
.wbvkz460w {
  fill: currentColor;
