...
const content = `<path class="c7r4epb8e"/><path class="recgh1bvq"/><path class="c3abd51ck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-chad" /></template>
<style>
.c3abd51ck {
