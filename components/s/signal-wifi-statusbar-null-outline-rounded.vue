...
const content = `<path class="ves8svbuh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-wifi-statusbar-null-outline-rounded" /></template>
<style>
.ves8svbuh {
  fill: currentColor;
