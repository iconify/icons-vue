...
const content = `<g class="cuyn6tgcc"><path class="djzh0xbac"/><path class="bcscanmhd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:chat-teardrop-duotone" /></template>
<style>
.bcscanmhd {
