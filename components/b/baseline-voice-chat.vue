...
const content = `<path class="z2l0rtbum"/><path class="ffp0e_bbf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-voice-chat" /></template>
<style>
.ffp0e_bbf {
  fill: currentColor;
