...
const content = `<path class="f4r5nwbws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:blender-sharp" /></template>
<style>
.f4r5nwbws {
  fill: currentColor;
