...
const content = `<path class="rcl-2-0jp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-question-24-regular" /></template>
<style>
.rcl-2-0jp {
  fill: currentColor;
