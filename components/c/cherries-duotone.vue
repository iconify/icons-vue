...
const content = `<g class="cuyn6tgcc"><path class="nqibhzd6v"/><path class="j0z17ibew"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:cherries-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
