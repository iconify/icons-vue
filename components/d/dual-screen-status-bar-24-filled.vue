...
const content = `<path class="ckrdsri_h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dual-screen-status-bar-24-filled" /></template>
<style>
.ckrdsri_h {
  fill: currentColor;
