...
const content = `<path class="j2ydmdb6c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-center-24-regular" /></template>
<style>
.j2ydmdb6c {
  fill: currentColor;
