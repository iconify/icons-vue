...
const content = `<path class="k2cj-py_n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:list-2-rounded" /></template>
<style>
.k2cj-py_n {
  fill: currentColor;
