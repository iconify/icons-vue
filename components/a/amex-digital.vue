...
const content = `<path class="j15ty4b9p"/><path class="ldbmxpb9j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:amex-digital" /></template>
<style>
.j15ty4b9p {
