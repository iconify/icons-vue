...
const content = `<path class="l7j0qjbzx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-clockwise-32-regular" /></template>
<style>
.l7j0qjbzx {
  fill: currentColor;
