...
const content = `<path class="h7izy1s0a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bowl-chopsticks-20-filled" /></template>
<style>
.h7izy1s0a {
  fill: currentColor;
