...
const content = `<circle class="w4w20mbgp"/><path class="hiugvmplw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:localsend" /></template>
<style>
.hiugvmplw {
  fill: none;
  stroke: currentColor;
