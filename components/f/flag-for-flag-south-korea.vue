...
const content = `<path class="exc8p7i9t"/><path class="hsl1yd9qu"/><path class="yj8k2vbjg"/><path class="k98t4e4ea"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-south-korea" /></template>
<style>
.exc8p7i9t {
