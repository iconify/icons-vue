...
const content = `<path class="wu-w38e3c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:read-more-outline-rounded" /></template>
<style>
.wu-w38e3c {
  fill: currentColor;
