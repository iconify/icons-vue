...
const content = `<path class="v7jhmzh4q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:church-outline-rounded" /></template>
<style>
.v7jhmzh4q {
  fill: currentColor;
