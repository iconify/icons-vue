...
const content = `<path class="i374zcq1i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-eraser-20-filled" /></template>
<style>
.i374zcq1i {
  fill: currentColor;
