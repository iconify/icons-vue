...
const content = `<g class="cuyn6tgcc"><path class="rl1dq4bco"/><path class="mg2k53uga"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:minus-square-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
