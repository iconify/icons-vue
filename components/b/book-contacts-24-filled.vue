...
const content = `<path class="tw4hbmiva"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-contacts-24-filled" /></template>
<style>
.tw4hbmiva {
  fill: currentColor;
