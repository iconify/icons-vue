...
const content = `<path class="vxktn5bgk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-hail-day-20-filled" /></template>
<style>
.vxktn5bgk {
  fill: currentColor;
