...
const content = `<path class="sv3jrvb0y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:road-cone-20-regular" /></template>
<style>
.sv3jrvb0y {
  fill: currentColor;
