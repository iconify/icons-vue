...
const content = `<path class="bw-73pdem"/><path class="v4ev5gbkq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-arrow-circle-up" /></template>
<style>
.bw-73pdem {
  fill: currentColor;
