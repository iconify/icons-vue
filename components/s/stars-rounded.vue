...
const content = `<path class="rq_wbgbep"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stars-rounded" /></template>
<style>
.rq_wbgbep {
  fill: currentColor;
