...
const content = `<path class="cg-uxgxge"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:volume-off-rounded" /></template>
<style>
.cg-uxgxge {
  fill: currentColor;
