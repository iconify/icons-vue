...
const content = `<path class="exy_bffve"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-dismiss-24-filled" /></template>
<style>
.exy_bffve {
  fill: currentColor;
