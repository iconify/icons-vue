...
const content = `<path class="lt4svzbmw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-outline-down-left-24-filled" /></template>
<style>
.lt4svzbmw {
  fill: currentColor;
