...
const content = `<path class="h5v6unsfc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:highlighter-circle-thin" /></template>
<style>
.h5v6unsfc {
  fill: currentColor;
