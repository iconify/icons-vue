...
const content = `<path class="yjhrnbbhf"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:superstar" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
