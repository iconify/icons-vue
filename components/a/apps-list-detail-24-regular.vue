...
const content = `<path class="mdt2c7awt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:apps-list-detail-24-regular" /></template>
<style>
.mdt2c7awt {
  fill: currentColor;
