...
const content = `<path class="e0u872b9d"/><circle class="cpk0fnbgt"/><circle class="vl6ukfb0p"/><circle class="md3_2-bix"/><circle class="au4143b-d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:droid-optimizer" /></template>
<style>
.au4143b-d {
  cx: 24px;
  cy: 24px;
