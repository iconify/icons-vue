...
const content = `<path class="n_9_l1b5i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-add-20-filled" /></template>
<style>
.n_9_l1b5i {
  fill: currentColor;
