...
const content = `<path class="yhkghwqwn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shelf-auto-hide-rounded" /></template>
<style>
.yhkghwqwn {
  fill: currentColor;
