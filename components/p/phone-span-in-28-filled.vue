...
const content = `<path class="en40wleru"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-span-in-28-filled" /></template>
<style>
.en40wleru {
  fill: currentColor;
