...
const content = `<path class="l6u5o-b4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-task-list-ltr-24-filled" /></template>
<style>
.l6u5o-b4n {
  fill: currentColor;
