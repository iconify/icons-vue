...
const content = `<path class="ipj32ibhj"/><path class="pkd1bzb0g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:out-of-milk" /></template>
<style>
.ipj32ibhj {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M25.739 4.331c-.017 4.13.038 8.071-.192 14.024c-2.323 6.5-1.4 11.894.444 16.984c-.035 3.139-.253 5.326-.253 7.989m-13.4-7.988h23.07");
}
