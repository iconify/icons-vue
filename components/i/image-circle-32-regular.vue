...
const content = `<path class="z69vnqe2u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-circle-32-regular" /></template>
<style>
.z69vnqe2u {
  fill: currentColor;
