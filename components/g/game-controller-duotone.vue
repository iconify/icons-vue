...
const content = `<g class="cuyn6tgcc"><path class="z1z1fn86r"/><path class="iwx7g9b5j"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:game-controller-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
