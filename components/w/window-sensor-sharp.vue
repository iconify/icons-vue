...
const content = `<path class="ic_dc2bpw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:window-sensor-sharp" /></template>
<style>
.ic_dc2bpw {
  fill: currentColor;
