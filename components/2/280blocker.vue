...
const content = `<path class="i9clfwm2k"/><path class="lfxa0wb-b"/><rect class="c5mogdb1g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:280blocker" /></template>
<style>
.c5mogdb1g {
  width: 6.625px;
  height: 10px;
