...
const content = `<path class="wg3hhwb6p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-mall-outline-rounded" /></template>
<style>
.wg3hhwb6p {
  fill: currentColor;
