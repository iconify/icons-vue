...
const content = `<path class="os778005m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:horizontal-split-outline-rounded" /></template>
<style>
.os778005m {
  fill: currentColor;
