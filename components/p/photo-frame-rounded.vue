...
const content = `<path class="podoz-qpa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:photo-frame-rounded" /></template>
<style>
.podoz-qpa {
  fill: currentColor;
