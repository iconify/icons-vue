...
const content = `<path class="rmiu7bb8y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:play-circle-sparkle-24-regular" /></template>
<style>
.rmiu7bb8y {
  fill: currentColor;
