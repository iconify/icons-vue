...
const content = `<path class="y_nvp8b9b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:account-tree-outline-rounded" /></template>
<style>
.y_nvp8b9b {
  fill: currentColor;
