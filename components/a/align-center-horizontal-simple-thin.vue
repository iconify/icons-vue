...
const content = `<path class="w28gu1evq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:align-center-horizontal-simple-thin" /></template>
<style>
.w28gu1evq {
  fill: currentColor;
