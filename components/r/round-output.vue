...
const content = `<path class="ub-axob5x"/><path class="bisamrfza"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-output" /></template>
<style>
.bisamrfza {
  fill: currentColor;
