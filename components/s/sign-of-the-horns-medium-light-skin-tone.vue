...
const content = `<path class="sfkf066jn"/><defs><path id="SVGTOqBNeBR" class="izn13ybjx"/></defs><clipPath id="SVGwOpa3N9h"><use href="#SVGTOqBNeBR"/></clipPath><g clip-path="url(#SVGwOpa3N9h)" class="zlqwn85jm"><path class="iepnxq05z"/><path class="vlyeqrv8u"/></g><defs><use href="#SVGTOqBNeBR" id="SVGjQNi3cMO"/></defs><clipPath id="SVGSOmC5dIl"><use href="#SVGjQNi3cMO"/></clipPath><g clip-path="url(#SVGSOmC5dIl)"><path class="a6h2o6bxa"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:sign-of-the-horns-medium-light-skin-tone" /></template>
<style>
.a6h2o6bxa {
