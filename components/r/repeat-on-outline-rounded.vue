...
const content = `<path class="rgpwrjvgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:repeat-on-outline-rounded" /></template>
<style>
.rgpwrjvgh {
  fill: currentColor;
