...
const content = `<path class="lr0e762qb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:family-star-outline-rounded" /></template>
<style>
.lr0e762qb {
  fill: currentColor;
