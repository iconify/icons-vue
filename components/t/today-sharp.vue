...
const content = `<path class="p9-nrbclk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:today-sharp" /></template>
<style>
.p9-nrbclk {
  fill: currentColor;
