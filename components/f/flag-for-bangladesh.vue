...
const content = `<path class="x8id3xbjo"/><circle class="yvr7uwblv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-bangladesh" /></template>
<style>
.x8id3xbjo {
