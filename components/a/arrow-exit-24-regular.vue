...
const content = `<path class="zrrklbb1b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-exit-24-regular" /></template>
<style>
.zrrklbb1b {
  fill: currentColor;
