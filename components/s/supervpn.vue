...
const content = `<path class="clyy6mbyw"/><path class="pbpoklyvj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:supervpn" /></template>
<style>
.clyy6mbyw {
  fill: none;
  stroke: currentColor;
