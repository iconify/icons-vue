...
const content = `<path class="rqnr2tkqr"/><path class="vc80y3b8t"/><path class="cstj53m1e"/><path class="ueusqblia"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:karten" /></template>
<style>
.cstj53m1e {
  fill: none;
  stroke: currentColor;
