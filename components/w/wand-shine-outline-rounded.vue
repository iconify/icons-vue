...
const content = `<path class="wiyau8bij"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wand-shine-outline-rounded" /></template>
<style>
.wiyau8bij {
  fill: currentColor;
