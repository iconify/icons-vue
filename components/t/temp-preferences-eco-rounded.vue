...
const content = `<path class="u7tejlbhs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:temp-preferences-eco-rounded" /></template>
<style>
.u7tejlbhs {
  fill: currentColor;
