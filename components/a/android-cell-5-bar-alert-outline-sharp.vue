...
const content = `<path class="entxu4p6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:android-cell-5-bar-alert-outline-sharp" /></template>
<style>
.entxu4p6i {
  fill: currentColor;
