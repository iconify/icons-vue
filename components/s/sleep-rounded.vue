...
const content = `<path class="mqma9__8b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sleep-rounded" /></template>
<style>
.mqma9__8b {
  fill: currentColor;
