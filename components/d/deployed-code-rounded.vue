...
const content = `<path class="fat1aab4e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:deployed-code-rounded" /></template>
<style>
.fat1aab4e {
  fill: currentColor;
