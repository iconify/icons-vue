...
const content = `<path class="inln-abox"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:code-xml-outline-rounded" /></template>
<style>
.inln-abox {
  fill: currentColor;
