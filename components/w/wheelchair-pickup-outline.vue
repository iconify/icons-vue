...
const content = `<path class="jghf3jbdm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wheelchair-pickup-outline" /></template>
<style>
.jghf3jbdm {
  fill: currentColor;
