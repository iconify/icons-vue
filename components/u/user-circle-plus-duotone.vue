...
const content = `<g class="cuyn6tgcc"><path class="erewjjzdk"/><path class="jc939kbaq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:user-circle-plus-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
