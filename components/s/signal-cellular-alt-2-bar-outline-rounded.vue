...
const content = `<path class="lkd1vrm9g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:signal-cellular-alt-2-bar-outline-rounded" /></template>
<style>
.lkd1vrm9g {
  fill: currentColor;
