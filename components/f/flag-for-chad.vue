...
const content = `<path class="xuph2qbqs"/><path class="yc4aorh9m"/><path class="tkqt_0b0n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-chad" /></template>
<style>
.tkqt_0b0n {
