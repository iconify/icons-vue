...
const content = `<path class="rzw9g1bkn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kleinanzeigen" /></template>
<style>
.rzw9g1bkn {
  fill: none;
  stroke: currentColor;
