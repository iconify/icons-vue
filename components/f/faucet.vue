...
const content = `<path class="qx6kuuphx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:faucet" /></template>
<style>
.qx6kuuphx {
  fill: currentColor;
