...
const content = `<path class="qduakcbsw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fulguris" /></template>
<style>
.qduakcbsw {
  fill: none;
  stroke: currentColor;
