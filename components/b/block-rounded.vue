...
const content = `<path class="d--b5flai"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:block-rounded" /></template>
<style>
.d--b5flai {
  fill: currentColor;
