...
const content = `<path class="w8f838b3w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:circle-sparkle-28-filled" /></template>
<style>
.w8f838b3w {
  fill: currentColor;
