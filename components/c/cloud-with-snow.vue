...
const content = `<path class="qsj6u-9jb"/><path class="xqmy8hkfe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:cloud-with-snow" /></template>
<style>
.qsj6u-9jb {
