...
const content = `<path class="klvidxpus"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-ios-24-filled" /></template>
<style>
.klvidxpus {
  fill: currentColor;
