...
const content = `<path class="tl0qhr-xq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-center-vertical-20-filled" /></template>
<style>
.tl0qhr-xq {
  fill: currentColor;
