...
const content = `<g class="cuyn6tgcc"><path class="usrah-haq"/><path class="nuubw4bkq"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:angle-down-circle-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
