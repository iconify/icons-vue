...
const content = `<path class="hd6t3iykl"/><path class="hsdn5pbsb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:sos-button" /></template>
<style>
.hd6t3iykl {
