...
const content = `<path class="ysb1g1b1g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-sync-28-regular" /></template>
<style>
.ysb1g1b1g {
  fill: currentColor;
