...
const content = `<path class="jipavxp0x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:personal-bag-off" /></template>
<style>
.jipavxp0x {
  fill: currentColor;
