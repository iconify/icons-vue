...
const content = `<path class="lbuacbcpx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:coin-multiple-16-filled" /></template>
<style>
.lbuacbcpx {
  fill: currentColor;
