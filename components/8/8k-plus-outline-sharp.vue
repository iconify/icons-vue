...
const content = `<path class="nag89b9vf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:8k-plus-outline-sharp" /></template>
<style>
.nag89b9vf {
  fill: currentColor;
