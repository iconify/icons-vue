...
const content = `<path class="lbq-w3oya"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nfc-off-sharp" /></template>
<style>
.lbq-w3oya {
  fill: currentColor;
