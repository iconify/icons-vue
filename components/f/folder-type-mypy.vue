...
const content = `<path class="jdfdlccud"/><path class="jw91py0qw"/><path class="nr7zdeb9z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-mypy" /></template>
<style>
.jdfdlccud {
