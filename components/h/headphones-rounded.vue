...
const content = `<path class="wu02bbdhv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:headphones-rounded" /></template>
<style>
.wu02bbdhv {
  fill: currentColor;
