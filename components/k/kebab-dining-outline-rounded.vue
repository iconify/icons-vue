...
const content = `<path class="izz0g9v2p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:kebab-dining-outline-rounded" /></template>
<style>
.izz0g9v2p {
  fill: currentColor;
