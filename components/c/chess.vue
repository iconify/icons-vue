...
const content = `<path class="n-pp74byz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chess" /></template>
<style>
.n-pp74byz {
  fill: currentColor;
