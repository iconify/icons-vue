...
const content = `<path class="k-wdr7vnu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:box-outline-rounded" /></template>
<style>
.k-wdr7vnu {
  fill: currentColor;
