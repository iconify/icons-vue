...
const content = `<path class="d8ymwv6im"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-panorama-vertical" /></template>
<style>
.d8ymwv6im {
  fill: currentColor;
