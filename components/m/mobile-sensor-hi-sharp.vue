...
const content = `<path class="a4pdidbgn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobile-sensor-hi-sharp" /></template>
<style>
.a4pdidbgn {
  fill: currentColor;
