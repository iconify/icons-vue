...
const content = `<path class="xtckc_bwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:person-simple-hike-light" /></template>
<style>
.xtckc_bwk {
  fill: currentColor;
