...
const content = `<path class="y4a20ccxb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tooltip-rounded" /></template>
<style>
.y4a20ccxb {
  fill: currentColor;
