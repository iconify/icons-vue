...
const content = `<g class="cuyn6tgcc"><path class="zd0o4d19z"/><path class="z_5nk1b_u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:mask-happy-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
