...
const content = `<path class="xdl_2qbgr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-mosque-32-filled" /></template>
<style>
.xdl_2qbgr {
  fill: currentColor;
