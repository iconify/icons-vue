...
const content = `<g class="cuyn6tgcc"><path class="wz0skn93x"/><path class="i6ba0ccym"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:hospital-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.wz0skn93x {
  d: path("M160 48v168h-32v-56H80v56H48V48a8 8 0 0 1 8-8h96a8 8 0 0 1 8 8");
