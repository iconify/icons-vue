...
const content = `<path class="g35o11biz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:huawei-phoneservice" /></template>
<style>
.g35o11biz {
  fill: none;
  stroke: currentColor;
