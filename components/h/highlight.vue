...
const content = `<path class="fv7osdbao"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:highlight" /></template>
<style>
.fv7osdbao {
  fill: currentColor;
