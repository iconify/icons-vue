...
const content = `<path class="ht53c8c_n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bookmyshow" /></template>
<style>
.ht53c8c_n {
  fill: none;
  stroke: currentColor;
