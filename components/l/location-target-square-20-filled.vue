...
const content = `<path class="pznhb-sta"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-target-square-20-filled" /></template>
<style>
.pznhb-sta {
  fill: currentColor;
