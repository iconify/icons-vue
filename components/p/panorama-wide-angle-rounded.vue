...
const content = `<path class="sw8x0z94m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:panorama-wide-angle-rounded" /></template>
<style>
.sw8x0z94m {
  fill: currentColor;
