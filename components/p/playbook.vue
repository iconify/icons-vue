...
const content = `<path class="blm1zyoqp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:playbook" /></template>
<style>
.blm1zyoqp {
  fill: none;
  stroke: currentColor;
