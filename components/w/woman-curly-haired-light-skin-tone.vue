...
const content = `<path class="u5m0-6b2w"/><linearGradient id="SVGmo0UWd9T" x1="64" x2="64" y1="35.759" y2="8" gradientTransform="matrix(1 0 0 -1 0 130)" gradientUnits="userSpaceOnUse"><stop offset="0" class="xb94qyb-t"/><stop offset=".705" class="ci_fo_bpd"/><stop offset="1" class="u3kz4vb7l"/></linearGradient><path fill="url(#SVGmo0UWd9T)" class="em9qpibty"/><path class="j821elbyk"/><path class="kzm6uvxrv"/><path class="czmrqydqu"/><g class="edr3jwbtv"><ellipse class="n8fq1s3jv"/><ellipse class="gba0l8b6i"/></g><path class="l3v4r62fj"/><path class="hlxooblzx"/><path class="k4pbnoxrk"/><radialGradient id="SVGgXkZncic" cx="63.798" cy="46.819" r="49.836" gradientTransform="rotate(-.109 64.883 50.393)" gradientUnits="userSpaceOnUse"><stop offset=".725" class="x21lzsbti"/><stop offset="1" class="fwx9zn6gv"/></radialGradient><path fill="url(#SVGgXkZncic)" class="e7gfutlzg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:woman-curly-haired-light-skin-tone" /></template>
<style>
.ci_fo_bpd {
