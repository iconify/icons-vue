...
const content = `<path class="jvb5tlb2j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobile-sound-2" /></template>
<style>
.jvb5tlb2j {
  fill: currentColor;
