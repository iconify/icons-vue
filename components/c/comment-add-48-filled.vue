...
const content = `<path class="qcbau3bul"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-add-48-filled" /></template>
<style>
.qcbau3bul {
  fill: currentColor;
