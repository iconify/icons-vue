...
const content = `<path class="dj5ga5gtc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-vibrate-24-filled" /></template>
<style>
.dj5ga5gtc {
  fill: currentColor;
