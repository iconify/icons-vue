...
const content = `<path class="r3ht9fbrn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ripples-rounded" /></template>
<style>
.r3ht9fbrn {
  fill: currentColor;
