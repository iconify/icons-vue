...
const content = `<path class="yqoch0btr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-up-left-20-filled" /></template>
<style>
.yqoch0btr {
  fill: currentColor;
