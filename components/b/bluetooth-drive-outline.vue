...
const content = `<path class="ondmafbci"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bluetooth-drive-outline" /></template>
<style>
.ondmafbci {
  fill: currentColor;
