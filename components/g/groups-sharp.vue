...
const content = `<path class="ogei6-bfn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:groups-sharp" /></template>
<style>
.ogei6-bfn {
  fill: currentColor;
