...
const content = `<path class="ai1z3d07n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cast-pause-sharp" /></template>
<style>
.ai1z3d07n {
  fill: currentColor;
