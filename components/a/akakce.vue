...
const content = `<circle class="cpk0fnbgt"/><path class="lpgjrdp9l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:akakce" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
