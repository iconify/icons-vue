...
const content = `<g class="cuyn6tgcc"><path class="vbcjs5q4p"/><path class="zyrlqp6cw"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:spiral-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
