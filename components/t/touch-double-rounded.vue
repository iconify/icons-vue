...
const content = `<path class="npczlbcso"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:touch-double-rounded" /></template>
<style>
.npczlbcso {
  fill: currentColor;
