...
const content = `<path class="zw5lloppe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-rounded-corner" /></template>
<style>
.zw5lloppe {
  fill: currentColor;
