...
const content = `<circle class="cpk0fnbgt"/><path class="p1pjq0d5l"/><path class="bip2ah6jb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fordpass" /></template>
<style>
.bip2ah6jb {
  fill: none;
  stroke: currentColor;
...
.p1pjq0d5l {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M4.116 32.022c.895-1.784 1.79-3.569 3.126-4.957s3.047-2.345 4.398-2.623s2.21.195 2.57.717s.22 1.092-.101 1.44s-.825.476-1.662 1.061s-2.005 1.63-2.594 3.17s-.596 3.28-.039 4.661c.557 1.382 1.68 2.106 3.608 2.075c1.93-.03 4.58-.791 7.134-2.49c2.553-1.698 4.85-4.237 7.348-7.411s5.166-6.949 7.108-9.507c1.941-2.56 3.156-3.902 4.078-4.83s1.552-1.438 2.18-1.949M16.161 43.985c1.628-.35 3.256-.698 5.09-1.7c1.836-1.004 3.878-2.66 6.444-5.994s5.652-8.343 8.03-12.11s4.044-6.29 5.135-7.755s1.606-1.875 2.12-2.284");
}
