...
const content = `<path class="k_20y-b0a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:error-med-sharp" /></template>
<style>
.k_20y-b0a {
  fill: currentColor;
