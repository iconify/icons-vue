...
const content = `<path class="ryosshh4o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-line-20-filled" /></template>
<style>
.ryosshh4o {
  fill: currentColor;
