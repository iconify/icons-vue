...
const content = `<path class="r7nxwacto"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-add-space-after-24-regular" /></template>
<style>
.r7nxwacto {
  fill: currentColor;
