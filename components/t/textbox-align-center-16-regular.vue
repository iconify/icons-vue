...
const content = `<path class="u-ky-lrei"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-center-16-regular" /></template>
<style>
.u-ky-lrei {
  fill: currentColor;
