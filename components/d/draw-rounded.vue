...
const content = `<path class="lpn6v-bvf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:draw-rounded" /></template>
<style>
.lpn6v-bvf {
  fill: currentColor;
