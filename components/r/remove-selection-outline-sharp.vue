...
const content = `<path class="j0pd1zblm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:remove-selection-outline-sharp" /></template>
<style>
.j0pd1zblm {
  fill: currentColor;
