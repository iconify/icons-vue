...
const content = `<g class="nrj6p8qat"><path clip-rule="evenodd" class="yjhxynbfp"/><path class="aimqgdczn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:server-plus-fill" /></template>
<style>
.aimqgdczn {
