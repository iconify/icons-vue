...
const content = `<path class="om_atffzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phone-paused-outline-sharp" /></template>
<style>
.om_atffzh {
  fill: currentColor;
