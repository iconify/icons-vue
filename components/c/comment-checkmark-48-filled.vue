...
const content = `<path class="zn_gjmkyb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-checkmark-48-filled" /></template>
<style>
.zn_gjmkyb {
  fill: currentColor;
