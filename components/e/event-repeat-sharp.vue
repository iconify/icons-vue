...
const content = `<path class="g9ux4kb9y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:event-repeat-sharp" /></template>
<style>
.g9ux4kb9y {
  fill: currentColor;
