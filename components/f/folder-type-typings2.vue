...
const content = `<path class="lb3z8rbbh"/><path class="bsuwqcbra"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-typings2" /></template>
<style>
.bsuwqcbra {
