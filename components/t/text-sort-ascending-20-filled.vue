...
const content = `<path class="xdw8yy37i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-sort-ascending-20-filled" /></template>
<style>
.xdw8yy37i {
  fill: currentColor;
