...
const content = `<path class="z39tvnb8z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:co2-outline" /></template>
<style>
.z39tvnb8z {
  fill: currentColor;
