...
const content = `<path class="y_5gu2b4c"/><path class="gzec4bcds"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-pin" /></template>
<style>
.gzec4bcds {
  fill: currentColor;
