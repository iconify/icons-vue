...
const content = `<path class="cx1-vibvx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stroke-full-outline-rounded" /></template>
<style>
.cx1-vibvx {
  fill: currentColor;
