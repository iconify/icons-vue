...
const content = `<path class="a0xa5_rnb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:eye-tracking-outline-sharp" /></template>
<style>
.a0xa5_rnb {
  fill: currentColor;
