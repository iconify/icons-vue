...
const content = `<path class="mvi4xeusa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:skip-backward-10-24-regular" /></template>
<style>
.mvi4xeusa {
  fill: currentColor;
