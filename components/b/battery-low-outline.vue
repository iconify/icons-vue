...
const content = `<path class="zma724vec"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-low-outline" /></template>
<style>
.zma724vec {
  fill: currentColor;
