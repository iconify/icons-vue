...
const content = `<path class="jyjobqhru"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:domain-verification-rounded" /></template>
<style>
.jyjobqhru {
  fill: currentColor;
