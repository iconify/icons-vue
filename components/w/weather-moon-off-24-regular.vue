...
const content = `<path class="v8jvsccye"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-moon-off-24-regular" /></template>
<style>
.v8jvsccye {
  fill: currentColor;
