...
const content = `<path class="r2fn80bzv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chat-paste-go-outline-sharp" /></template>
<style>
.r2fn80bzv {
  fill: currentColor;
