...
const content = `<path class="hc2388bpq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-freeze-column-and-row-24-filled" /></template>
<style>
.hc2388bpq {
  fill: currentColor;
