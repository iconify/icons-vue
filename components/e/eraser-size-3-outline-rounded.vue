...
const content = `<path class="h6lgqu75d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:eraser-size-3-outline-rounded" /></template>
<style>
.h6lgqu75d {
  fill: currentColor;
