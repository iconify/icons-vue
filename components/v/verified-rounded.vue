...
const content = `<path class="qkot3yxku"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:verified-rounded" /></template>
<style>
.qkot3yxku {
  fill: currentColor;
