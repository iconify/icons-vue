...
const content = `<rect class="px9_c_cmp"/><rect class="pgz_txbqx"/><rect class="b1wa3ebnm"/><path class="az0-le03y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ncp" /></template>
<style>
.az0-le03y {
  fill: none;
  stroke: currentColor;
