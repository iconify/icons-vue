...
const content = `<path class="nmsf4cb2d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-alert" /></template>
<style>
.nmsf4cb2d {
  fill: currentColor;
