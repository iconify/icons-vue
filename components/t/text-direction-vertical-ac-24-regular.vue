...
const content = `<g class="ft5dv1b6b"><path class="lbqkbljiq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-vertical-ac-24-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
