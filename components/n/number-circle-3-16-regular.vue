...
const content = `<path class="hc3vzh2ex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-3-16-regular" /></template>
<style>
.hc3vzh2ex {
  fill: currentColor;
