...
const content = `<path class="k-ytembdk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fluid-med" /></template>
<style>
.k-ytembdk {
  fill: currentColor;
