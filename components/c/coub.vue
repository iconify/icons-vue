...
const content = `<path class="lf1ve8bio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:coub" /></template>
<style>
.lf1ve8bio {
  fill: none;
  stroke: currentColor;
