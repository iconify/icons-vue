...
const content = `<path class="e483u2ime"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:piano-outline-rounded" /></template>
<style>
.e483u2ime {
  fill: currentColor;
