...
const content = `<g class="nrj6p8qat"><path class="b_gf1sbty"/><path class="lf5ibnpoe"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-outgoing-fill" /></template>
<style>
.b_gf1sbty {
  fill: currentColor;
...
.lf5ibnpoe {
  d: path("M21.5 2.5L17 7M22 8V2.5C22 2.2239 21.7761 2 21.5 2H16");
}
