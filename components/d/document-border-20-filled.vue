...
const content = `<path class="reudbrblv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-border-20-filled" /></template>
<style>
.reudbrblv {
  fill: currentColor;
