...
const content = `<path class="i9clfwm2k"/><path class="j88mu6bkf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:presto" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
