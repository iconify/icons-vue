...
const content = `<path class="cw0yguh7p"/><path class="eh1mzybkg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:app-verifier" /></template>
<style>
.cw0yguh7p {
  fill: none;
  stroke: currentColor;
