...
const content = `<path class="h2q_dhbaa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-checkmark-24-regular" /></template>
<style>
.h2q_dhbaa {
  fill: currentColor;
