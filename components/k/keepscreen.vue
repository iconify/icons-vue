...
const content = `<path class="kl-gvab6e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:keepscreen" /></template>
<style>
.kl-gvab6e {
  fill: none;
  stroke: currentColor;
