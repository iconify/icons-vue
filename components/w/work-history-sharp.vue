...
const content = `<path class="yj8xs9bjv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:work-history-sharp" /></template>
<style>
.yj8xs9bjv {
  fill: currentColor;
