...
const content = `<path class="jishpucbm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ungroup-outline-rounded" /></template>
<style>
.jishpucbm {
  fill: currentColor;
