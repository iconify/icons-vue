...
const content = `<path class="z5ochubni"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:kid-star-rounded" /></template>
<style>
.z5ochubni {
  fill: currentColor;
