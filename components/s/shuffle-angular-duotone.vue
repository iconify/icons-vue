...
const content = `<g class="cuyn6tgcc"><path class="clgch2d_d"/><path class="g8uy2gbvk"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:shuffle-angular-duotone" /></template>
<style>
.clgch2d_d {
