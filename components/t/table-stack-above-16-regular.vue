...
const content = `<path class="i-cjxevyz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-stack-above-16-regular" /></template>
<style>
.i-cjxevyz {
  fill: currentColor;
