...
const content = `<circle class="jie5odout"/><path class="pkrli7bbg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-person-search" /></template>
<style>
.jie5odout {
  cx: 10px;
  cy: 8px;
