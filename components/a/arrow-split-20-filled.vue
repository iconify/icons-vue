...
const content = `<path class="ljcyanhtm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-split-20-filled" /></template>
<style>
.ljcyanhtm {
  fill: currentColor;
