...
const content = `<g class="nrj6p8qat"><path class="t8drw368i"/><path class="ad03o1t6o"/><path class="fxypyjbih"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:gauge-duotone" /></template>
<style>
.ad03o1t6o {
  d: path("M12 12L12 7");
}
