...
const content = `<path class="o5sm29b5x"/><path class="gx0oow39y"/><path class="mhmybfofp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:red-heart" /></template>
<style>
.gx0oow39y {
