...
const content = `<path class="ctyv6ac6k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:contact-mail-outline" /></template>
<style>
.ctyv6ac6k {
  fill: currentColor;
