...
const content = `<path class="z_cmp-b3k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:motion-photos-on-rounded" /></template>
<style>
.z_cmp-b3k {
  fill: currentColor;
