...
const content = `<path class="c2p38mzgn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:wheelchair-access-24-regular" /></template>
<style>
.c2p38mzgn {
  fill: currentColor;
