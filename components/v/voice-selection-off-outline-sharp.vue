...
const content = `<path class="ju6b1ubic"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:voice-selection-off-outline-sharp" /></template>
<style>
.ju6b1ubic {
  fill: currentColor;
