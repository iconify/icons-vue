...
const content = `<path class="sjmp4j3xv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-airplanemode-inactive" /></template>
<style>
.sjmp4j3xv {
  fill: currentColor;
