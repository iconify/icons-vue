...
const content = `<path class="v8imq4pkv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrows-output-outline-sharp" /></template>
<style>
.v8imq4pkv {
  fill: currentColor;
