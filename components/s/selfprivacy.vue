...
const content = `<path class="j9bgh9lpp"/><path class="g5n83rb2y"/><path class="pb9w-ioox"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:selfprivacy" /></template>
<style>
.g5n83rb2y {
  fill: none;
  stroke: currentColor;
