...
const content = `<path class="dujlunb7b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:plug-connected-32-regular" /></template>
<style>
.dujlunb7b {
  fill: currentColor;
