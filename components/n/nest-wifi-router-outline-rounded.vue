...
const content = `<path class="k9ca-tbul"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-wifi-router-outline-rounded" /></template>
<style>
.k9ca-tbul {
  fill: currentColor;
