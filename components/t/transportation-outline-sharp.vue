...
const content = `<path class="zi2teykpj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:transportation-outline-sharp" /></template>
<style>
.zi2teykpj {
  fill: currentColor;
