...
const content = `<path class="b8zdwezkg"/><path class="iul93gkwz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-catching-pokemon" /></template>
<style>
.b8zdwezkg {
  fill: currentColor;
  d: path("M12 4c4.08 0 7.45 3.05 7.94 7h-4.06c-.45-1.73-2.02-3-3.88-3s-3.43 1.27-3.87 3H4.06C4.55 7.05 7.92 4 12 4");
