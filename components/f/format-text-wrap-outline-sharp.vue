...
const content = `<path class="xdkdzugos"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-text-wrap-outline-sharp" /></template>
<style>
.xdkdzugos {
  fill: currentColor;
