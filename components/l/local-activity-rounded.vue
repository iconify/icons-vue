...
const content = `<path class="y948hkb8k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-activity-rounded" /></template>
<style>
.y948hkb8k {
  fill: currentColor;
