...
const content = `<path class="tss_75bey"/><path class="b_bf6h1cb"/><path class="tc66w0b-b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:freifunk-auto-connect" /></template>
<style>
.b_bf6h1cb {
  fill: none;
  stroke: currentColor;
