...
const content = `<path class="douy8_bki"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:airline-seat-flat-outline-sharp" /></template>
<style>
.douy8_bki {
  fill: currentColor;
