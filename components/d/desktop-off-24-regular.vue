...
const content = `<path class="wfkqawblm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-off-24-regular" /></template>
<style>
.wfkqawblm {
  fill: currentColor;
