...
const content = `<path class="ie_045bec"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pipeline-24-regular" /></template>
<style>
.ie_045bec {
  fill: currentColor;
