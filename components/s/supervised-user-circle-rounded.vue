...
const content = `<path class="x07lvybhb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:supervised-user-circle-rounded" /></template>
<style>
.x07lvybhb {
  fill: currentColor;
