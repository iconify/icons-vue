...
const content = `<path class="aj1q46bqe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-dash-16-filled" /></template>
<style>
.aj1q46bqe {
  fill: currentColor;
