...
const content = `<path class="g2sf3abkw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-layout-20-filled" /></template>
<style>
.g2sf3abkw {
  fill: currentColor;
