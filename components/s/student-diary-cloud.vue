...
const content = `<path class="ebk9dzb0m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:student-diary-cloud" /></template>
<style>
.ebk9dzb0m {
  fill: none;
  stroke: currentColor;
