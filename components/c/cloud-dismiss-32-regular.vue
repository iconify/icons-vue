...
const content = `<path class="ymlhl7bub"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-dismiss-32-regular" /></template>
<style>
.ymlhl7bub {
  fill: currentColor;
