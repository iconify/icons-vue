...
const content = `<path class="oo3r7extf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-multi-room-outline-rounded" /></template>
<style>
.oo3r7extf {
  fill: currentColor;
