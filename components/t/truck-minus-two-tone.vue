...
const content = `<g class="nrj6p8qat"><path class="wy94go95p"/><path class="gd1f66_sz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:truck-minus-two-tone" /></template>
<style>
.gd1f66_sz {
