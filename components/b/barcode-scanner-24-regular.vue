...
const content = `<path class="ululeqbyd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:barcode-scanner-24-regular" /></template>
<style>
.ululeqbyd {
  fill: currentColor;
