...
const content = `<path class="gsiw0tbmr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:emoticon-outline-sharp" /></template>
<style>
.gsiw0tbmr {
  fill: currentColor;
