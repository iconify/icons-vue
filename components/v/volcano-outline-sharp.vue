...
const content = `<path class="qbcuugb5r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:volcano-outline-sharp" /></template>
<style>
.qbcuugb5r {
  fill: currentColor;
