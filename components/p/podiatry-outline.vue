...
const content = `<path class="c4qul4i7y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:podiatry-outline" /></template>
<style>
.c4qul4i7y {
  fill: currentColor;
