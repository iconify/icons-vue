...
const content = `<path class="wli7-q4yg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-badge-20-filled" /></template>
<style>
.wli7-q4yg {
  fill: currentColor;
