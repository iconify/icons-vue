...
const content = `<path class="uev6okb7b"/><path class="vbwirlf4e"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cross-dj" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
...
.uev6okb7b {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M24.07 14.475c5.234 0 9.5 4.249 9.5 9.493s-4.266 9.507-9.5 9.507c-5.248 0-9.5-4.262-9.5-9.507s4.252-9.493 9.5-9.493");
}
