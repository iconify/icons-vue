...
const content = `<path class="ee0uxubkm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shades-outline-sharp" /></template>
<style>
.ee0uxubkm {
  fill: currentColor;
