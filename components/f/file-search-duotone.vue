...
const content = `<path class="q5v5ckbgl"/><path class="qesztabfu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-search-duotone" /></template>
<style>
.q5v5ckbgl {
  fill: currentColor;
