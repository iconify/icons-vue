...
const content = `<path class="gwdtzlbkt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:multiplier-1x-24-filled" /></template>
<style>
.gwdtzlbkt {
  fill: currentColor;
