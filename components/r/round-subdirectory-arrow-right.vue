...
const content = `<path class="ane-7e00d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-subdirectory-arrow-right" /></template>
<style>
.ane-7e00d {
  fill: currentColor;
