...
const content = `<path class="tw_t0qqyu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mrepo" /></template>
<style>
.tw_t0qqyu {
  fill: none;
  stroke: currentColor;
