...
const content = `<path class="osvupob-f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:grid-dots-28-regular" /></template>
<style>
.osvupob-f {
  fill: currentColor;
