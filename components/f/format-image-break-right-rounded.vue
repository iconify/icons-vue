...
const content = `<path class="yb0dwy7mt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-image-break-right-rounded" /></template>
<style>
.yb0dwy7mt {
  fill: currentColor;
