...
const content = `<path class="ykzgkncsu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-bottom-center-16-filled" /></template>
<style>
.ykzgkncsu {
  fill: currentColor;
