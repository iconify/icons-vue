...
const content = `<path class="hd5ohyfdg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:accessibility-question-mark-20-regular" /></template>
<style>
.hd5ohyfdg {
  fill: currentColor;
