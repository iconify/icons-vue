...
const content = `<path class="q-9-mubbr"/><path class="qqp5zwbha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-camera-enhance" /></template>
<style>
.q-9-mubbr {
  fill: currentColor;
  d: path("m15.95 7l-.59-.65L14.12 5H9.88L8.65 6.35l-.6.65H4v12h16V7zM12 18c-2.76 0-5-2.24-5-5s2.24-5 5-5s5 2.24 5 5s-2.24 5-5 5");
