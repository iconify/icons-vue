...
const content = `<path class="law_paqsd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bluetooth-16-filled" /></template>
<style>
.law_paqsd {
  fill: currentColor;
