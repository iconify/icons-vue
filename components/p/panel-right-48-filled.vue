...
const content = `<path class="clqa3466w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-right-48-filled" /></template>
<style>
.clqa3466w {
  fill: currentColor;
