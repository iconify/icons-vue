...
const content = `<path class="tbrsuijmw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:language-us-dvorak-outline-rounded" /></template>
<style>
.tbrsuijmw {
  fill: currentColor;
