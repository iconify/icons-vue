...
const content = `<path class="q9ey1yvmw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tv-displays-rounded" /></template>
<style>
.q9ey1yvmw {
  fill: currentColor;
