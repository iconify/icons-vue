...
const content = `<path class="vum4fdbdi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:certificate-16-filled" /></template>
<style>
.vum4fdbdi {
  fill: currentColor;
