...
const content = `<path class="yzwll2bve"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:display-external-input-outline-rounded" /></template>
<style>
.yzwll2bve {
  fill: currentColor;
