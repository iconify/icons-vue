...
const content = `<path class="x-kz1kb7j"/><path class="yyl1hmbsx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:letter-x" /></template>
<style>
.x-kz1kb7j {
