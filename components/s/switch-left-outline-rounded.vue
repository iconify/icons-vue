...
const content = `<path class="o3ql-ib7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:switch-left-outline-rounded" /></template>
<style>
.o3ql-ib7l {
  fill: currentColor;
