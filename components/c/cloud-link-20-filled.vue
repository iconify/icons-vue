...
const content = `<path class="usvahzw6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-link-20-filled" /></template>
<style>
.usvahzw6a {
  fill: currentColor;
