...
const content = `<path class="uk__9kb2p"/><path class="jujtyownd"/><path class="bsuwqcbra"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-typings2-opened" /></template>
<style>
.bsuwqcbra {
