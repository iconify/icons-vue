...
const content = `<path class="bora7cbll"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:security-update-warning-outline" /></template>
<style>
.bora7cbll {
  fill: currentColor;
