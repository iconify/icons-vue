...
const content = `<path class="edn3xqznk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flashlight-off-outline-sharp" /></template>
<style>
.edn3xqznk {
  fill: currentColor;
