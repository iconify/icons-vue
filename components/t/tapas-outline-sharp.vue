...
const content = `<path class="mf6urmqim"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tapas-outline-sharp" /></template>
<style>
.mf6urmqim {
  fill: currentColor;
