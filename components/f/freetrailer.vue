...
const content = `<path class="zmbiiacbf"/><path class="ldwveewxd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:freetrailer" /></template>
<style>
.ldwveewxd {
  fill: none;
  stroke: currentColor;
