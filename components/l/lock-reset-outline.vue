...
const content = `<path class="w7w72dbpb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lock-reset-outline" /></template>
<style>
.w7w72dbpb {
  fill: currentColor;
