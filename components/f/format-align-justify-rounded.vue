...
const content = `<path class="kc4x-bcyj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-align-justify-rounded" /></template>
<style>
.kc4x-bcyj {
  fill: currentColor;
