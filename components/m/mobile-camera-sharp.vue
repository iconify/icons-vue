...
const content = `<path class="xsd8heb_g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-camera-sharp" /></template>
<style>
.xsd8heb_g {
  fill: currentColor;
