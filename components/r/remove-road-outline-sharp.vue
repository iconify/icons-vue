...
const content = `<path class="hjglm_bnh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:remove-road-outline-sharp" /></template>
<style>
.hjglm_bnh {
  fill: currentColor;
