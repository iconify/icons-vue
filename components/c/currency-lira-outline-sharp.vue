...
const content = `<path class="r7ygcxbwi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:currency-lira-outline-sharp" /></template>
<style>
.r7ygcxbwi {
  fill: currentColor;
