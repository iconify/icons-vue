...
const content = `<path class="rd95lzs5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-read-32-regular" /></template>
<style>
.rd95lzs5x {
  fill: currentColor;
