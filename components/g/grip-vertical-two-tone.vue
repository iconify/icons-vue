...
const content = `<path class="em3tw8a-m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:grip-vertical-two-tone" /></template>
<style>
.em3tw8a-m {
  fill: none;
  stroke: currentColor;
