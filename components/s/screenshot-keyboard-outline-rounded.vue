...
const content = `<path class="j6v2_xj9h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:screenshot-keyboard-outline-rounded" /></template>
<style>
.j6v2_xj9h {
  fill: currentColor;
