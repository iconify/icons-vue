...
const content = `<path class="tscr8mb0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:reading-list-16-filled" /></template>
<style>
.tscr8mb0l {
  fill: currentColor;
