...
const content = `<path class="du-uqkbax"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-desktop-24-regular" /></template>
<style>
.du-uqkbax {
  fill: currentColor;
