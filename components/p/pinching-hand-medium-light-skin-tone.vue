...
const content = `<path class="payal3b7h"/><path class="lcjq9js5b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:pinching-hand-medium-light-skin-tone" /></template>
<style>
.lcjq9js5b {
