...
const content = `<path class="e2ouh0bjm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:communication-person-20-regular" /></template>
<style>
.e2ouh0bjm {
  fill: currentColor;
