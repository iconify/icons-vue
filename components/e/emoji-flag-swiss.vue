...
const content = `<path class="e7p24tqsp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-flag-swiss" /></template>
<style>
.e7p24tqsp {
  fill: none;
  stroke: currentColor;
