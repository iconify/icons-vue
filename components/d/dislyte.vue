...
const content = `<path class="mes09dabz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dislyte" /></template>
<style>
.mes09dabz {
  fill: none;
  stroke: currentColor;
