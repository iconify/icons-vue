...
const content = `<path class="onp3zvbrw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-full-outline-rounded" /></template>
<style>
.onp3zvbrw {
  fill: currentColor;
