...
const content = `<path class="nr_t79bla"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:opacity-outline-sharp" /></template>
<style>
.nr_t79bla {
  fill: currentColor;
