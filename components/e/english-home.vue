...
const content = `<path class="i9clfwm2k"/><path class="jiaannc9h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:english-home" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
