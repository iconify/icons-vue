...
const content = `<path class="jj3h8kbjv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-person-24-regular" /></template>
<style>
.jj3h8kbjv {
  fill: currentColor;
