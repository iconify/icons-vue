...
const content = `<path class="e7zoa_byu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:move-selection-up-outline-sharp" /></template>
<style>
.e7zoa_byu {
  fill: currentColor;
