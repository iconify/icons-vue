...
const content = `<path class="ci2fv0bmn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:emergency-recording-outline-sharp" /></template>
<style>
.ci2fv0bmn {
  fill: currentColor;
