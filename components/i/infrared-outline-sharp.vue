...
const content = `<path class="v21av3aim"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:infrared-outline-sharp" /></template>
<style>
.v21av3aim {
  fill: currentColor;
