...
const content = `<path class="kb5piwy-m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:diagnosis-outline-rounded" /></template>
<style>
.kb5piwy-m {
  fill: currentColor;
