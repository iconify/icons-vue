...
const content = `<path class="e1m6zqw8t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:spatial-tracking-sharp" /></template>
<style>
.e1m6zqw8t {
  fill: currentColor;
