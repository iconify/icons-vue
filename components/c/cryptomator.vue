...
const content = `<path class="j4vfewe4p"/><path class="f9-tzlbnq"/>`;
</script>
...
.f9-tzlbnq {
  ...
  d: path("M33.31 19.59H14.69a1.48 1.48 0 0 0-1.48 1.48v6.24a10.79 10.79 0 0 0 21.58 0v-6.24a1.48 1.48 0 0 0-1.48-1.48M24 7.31A10.79 10.79 0 0 1 34.79 18.1v0a1.49 1.49 0 0 1-1.49 1.49H14.69a1.49 1.49 0 0 1-1.49-1.49v0A10.79 10.79 0 0 1 24 7.31");
}
