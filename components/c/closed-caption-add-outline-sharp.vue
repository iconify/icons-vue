...
const content = `<path class="hwo49eboy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:closed-caption-add-outline-sharp" /></template>
<style>
.hwo49eboy {
  fill: currentColor;
