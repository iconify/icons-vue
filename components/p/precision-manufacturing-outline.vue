...
const content = `<path class="zvr265rwy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:precision-manufacturing-outline" /></template>
<style>
.zvr265rwy {
  fill: currentColor;
