...
const content = `<g class="cuyn6tgcc"><path class="vvhjf2bav"/><path class="c98vkzb0q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:framer-logo-duotone" /></template>
<style>
.c98vkzb0q {
