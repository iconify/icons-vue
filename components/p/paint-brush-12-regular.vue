...
const content = `<path class="hv1r2tq-l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:paint-brush-12-regular" /></template>
<style>
.hv1r2tq-l {
  fill: currentColor;
