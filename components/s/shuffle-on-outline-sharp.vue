...
const content = `<path class="bd9ru6b3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shuffle-on-outline-sharp" /></template>
<style>
.bd9ru6b3l {
  fill: currentColor;
