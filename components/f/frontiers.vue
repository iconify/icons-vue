...
const content = `<path class="zn8wjjbol"/><path class="p8lkt8i-k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:frontiers" /></template>
<style>
.p8lkt8i-k {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M5.418 28.877c7.022 4.535 8.94 1.504 10.254-1.859");
}
