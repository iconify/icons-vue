...
const content = `<path class="o0nx97bzk"/><path class="uxncf51ab"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:creditagricole-autobank" /></template>
<style>
.o0nx97bzk {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M9.325 29.917h30.08M21.132 10.405c-7.16.885-12.178 3.509-12.178 9.183c0 3.462 3.563 5.161 6.844 5.161c6.804 0 17.15-6.567 23.978-10.416");
}
