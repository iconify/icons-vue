...
const content = `<path class="d6kam2bsw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bookmark-search-24-filled" /></template>
<style>
.d6kam2bsw {
  fill: currentColor;
