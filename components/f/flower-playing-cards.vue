...
const content = `<defs><path id="SVGvXy60cGw" class="jp7cipb5f"/></defs><use href="#SVGvXy60cGw" class="i2v6ey-hu"/><clipPath id="SVGXq7cZbIR"><use href="#SVGvXy60cGw"/></clipPath><path clip-path="url(#SVGXq7cZbIR)" class="lv_ramb3d"/><path class="vjazt4m6u"/><path class="liyu_hbyv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:flower-playing-cards" /></template>
<style>
.i2v6ey-hu {
