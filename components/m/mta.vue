...
const content = `<path class="jgxe6110j"/><path class="kt_a2gbtt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mta" /></template>
<style>
.jgxe6110j {
  fill: none;
  stroke: currentColor;
