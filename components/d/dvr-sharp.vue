...
const content = `<path class="ly7ng5qsf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dvr-sharp" /></template>
<style>
.ly7ng5qsf {
  fill: currentColor;
