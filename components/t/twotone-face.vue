...
const content = `<path class="icmwrobqx"/><path class="v73hp-bvd"/><circle class="t8-_arz4f"/><circle class="pt3nek-ut"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-face" /></template>
<style>
.icmwrobqx {
  fill: currentColor;
