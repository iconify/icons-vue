...
const content = `<path class="am5_k-ggm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:flatware-outline-sharp" /></template>
<style>
.am5_k-ggm {
  fill: currentColor;
