...
const content = `<path class="jg3ygejst"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:syringe-outline" /></template>
<style>
.jg3ygejst {
  fill: currentColor;
