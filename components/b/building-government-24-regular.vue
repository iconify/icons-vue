...
const content = `<path class="blyb63bdi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-government-24-regular" /></template>
<style>
.blyb63bdi {
  fill: currentColor;
