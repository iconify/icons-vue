...
const content = `<path class="qw70lyb9w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:image-not-supported-outline" /></template>
<style>
.qw70lyb9w {
  fill: currentColor;
