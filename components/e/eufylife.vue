...
const content = `<path class="mt-hg--9x"/><path class="emmggdcxg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:eufylife" /></template>
<style>
.emmggdcxg {
  fill: none;
  stroke: currentColor;
