...
const content = `<g class="ft5dv1b6b"><path fill="url(#tokenBrandedBuy0)" class="vimhu8bbs"/><defs><linearGradient id="tokenBrandedBuy0" x1="11.999" x2="11.999" y1="2" y2="21.849" gradientUnits="userSpaceOnUse"><stop class="ahdpg0bgp"/><stop offset=".98" class="yamaslh3t"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:buy" /></template>
<style>
.ahdpg0bgp {
  stop-color: var(--svg-color--fadb67, #FADB67);
}
