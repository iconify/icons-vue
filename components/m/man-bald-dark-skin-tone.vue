...
const content = `<path class="h-umkxlvw"/><path class="nfnrp5bsv"/><path class="iripw0_yo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:man-bald-dark-skin-tone" /></template>
<style>
.h-umkxlvw {
