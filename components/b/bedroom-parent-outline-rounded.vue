...
const content = `<path class="mw_jxbmzb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bedroom-parent-outline-rounded" /></template>
<style>
.mw_jxbmzb {
  fill: currentColor;
