...
const content = `<path class="l1nrzm8yg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:subway-walk-rounded" /></template>
<style>
.l1nrzm8yg {
  fill: currentColor;
