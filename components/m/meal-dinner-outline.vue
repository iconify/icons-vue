...
const content = `<path class="blmd6feim"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:meal-dinner-outline" /></template>
<style>
.blmd6feim {
  fill: currentColor;
