...
const content = `<path class="why9bqbqo"/><path class="bc51y1cdk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:evernote" /></template>
<style>
.bc51y1cdk {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M30.22 22.33c-.77-.07.67-1.76 1.61-1.73c1.6 0 3.42 2.15 2.55 2.08ZM19.17 4.67c-3 2.72-1.69 4-2 9.08a1.94 1.94 0 0 1-1.91 1.94c-4.51.44-7.42-.77-8.7 1.78");
}
