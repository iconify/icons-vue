...
const content = `<path class="v6476tyja"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-chart-view-outline" /></template>
<style>
.v6476tyja {
  fill: currentColor;
