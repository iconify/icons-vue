...
const content = `<circle class="cpk0fnbgt"/><path class="p0wznzb6v"/><path class="uy_j9vuwe"/><path class="ffye57qrg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:primal" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
