...
const content = `<path class="enqz0p3bp"/><path class="fon64ubwc"/><path class="s9vewpfay"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ca-lottery" /></template>
<style>
.enqz0p3bp {
  fill: none;
  stroke: currentColor;
...
.fon64ubwc {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M14.003 10.746L24.62 8.274l2.655 11.873l9.975-1.787l2.197 10.121l-20.688 3.74z");
}
...
.s9vewpfay {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M25.222 10.962c4.837.37 8.934 3.39 10.842 7.61m-21.156-3.738a12.98 12.98 0 0 0-3.704 9.091c0 7.172 5.825 12.997 13.008 12.997c5.354 0 9.955-3.232 11.942-7.845");
}
