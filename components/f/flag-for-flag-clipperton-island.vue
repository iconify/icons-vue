...
const content = `<path class="jm6i1eb8u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-flag-clipperton-island" /></template>
<style>
.jm6i1eb8u {
  fill: currentColor;
