...
const content = `<path class="wfw03y8if"/><path class="fp2syc9ia"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:db-bauarbeiten" /></template>
<style>
.fp2syc9ia {
  fill: none;
  stroke: currentColor;
