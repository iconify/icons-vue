...
const content = `<g class="gp_8x1bzb"><path class="ygul10psw"/><path class="a5a3n0bco"/><path class="unky6y77u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:app-window-x-sharp-duotone" /></template>
<style>
.a5a3n0bco {
