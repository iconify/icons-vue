...
const content = `<path class="qhlemubfo"/><path class="g1fxazpbp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gazprombank" /></template>
<style>
.g1fxazpbp {
  fill: none;
  stroke: currentColor;
