...
const content = `<path class="yo-1k7b7x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:triangle-right-48-regular" /></template>
<style>
.yo-1k7b7x {
  fill: currentColor;
