...
const content = `<path class="aak4nbbpr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:real-estate-agent-outline-sharp" /></template>
<style>
.aak4nbbpr {
  fill: currentColor;
