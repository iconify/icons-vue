...
const content = `<path class="n0cz2eb4p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:trolley-sharp" /></template>
<style>
.n0cz2eb4p {
  fill: currentColor;
