...
const content = `<path class="xpx6-b5_l"/><ellipse class="ua-ncbbxw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-plsql" /></template>
<style>
.ua-ncbbxw {
  cx: 16px;
  cy: 5.894px;
