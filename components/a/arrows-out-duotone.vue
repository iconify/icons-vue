...
const content = `<g class="cuyn6tgcc"><path class="n4g-ljr-z"/><path class="bpghd-b8q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrows-out-duotone" /></template>
<style>
.bpghd-b8q {
