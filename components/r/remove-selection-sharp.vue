...
const content = `<path class="pz0-jl4_a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:remove-selection-sharp" /></template>
<style>
.pz0-jl4_a {
  fill: currentColor;
