...
const content = `<path class="c6-nfac0o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:highlight-20-filled" /></template>
<style>
.c6-nfac0o {
  fill: currentColor;
