...
const content = `<path class="lgostvxel"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-header-16-filled" /></template>
<style>
.lgostvxel {
  fill: currentColor;
