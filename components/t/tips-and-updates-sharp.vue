...
const content = `<path class="qfpn2gbxh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tips-and-updates-sharp" /></template>
<style>
.qfpn2gbxh {
  fill: currentColor;
