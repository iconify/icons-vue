...
const content = `<path class="l_7f9wbin"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:skip-next-outline-rounded" /></template>
<style>
.l_7f9wbin {
  fill: currentColor;
