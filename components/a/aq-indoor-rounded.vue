...
const content = `<path class="unhcxe0xs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:aq-indoor-rounded" /></template>
<style>
.unhcxe0xs {
  fill: currentColor;
