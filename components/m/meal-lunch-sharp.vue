...
const content = `<path class="pp80-ibbd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:meal-lunch-sharp" /></template>
<style>
.pp80-ibbd {
  fill: currentColor;
