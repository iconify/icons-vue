...
const content = `<path class="zoia8i66e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:newsstand-outline-rounded" /></template>
<style>
.zoia8i66e {
  fill: currentColor;
