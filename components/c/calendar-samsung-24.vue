...
const content = `<path class="ebreyb52h"/><path class="kzykk8swa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-samsung-24" /></template>
<style>
.ebreyb52h {
  fill: none;
  stroke: currentColor;
