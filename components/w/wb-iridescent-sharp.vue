...
const content = `<path class="jug7fee1n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wb-iridescent-sharp" /></template>
<style>
.jug7fee1n {
  fill: currentColor;
