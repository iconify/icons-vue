...
const content = `<path class="duar-jbwx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:coffee-outline-sharp" /></template>
<style>
.duar-jbwx {
  fill: currentColor;
