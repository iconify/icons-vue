...
const content = `<path class="x7nitmb8o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dangerous-outline-sharp" /></template>
<style>
.x7nitmb8o {
  fill: currentColor;
