...
const content = `<path class="nogikcbqo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wifi-calling-bar-1-sharp" /></template>
<style>
.nogikcbqo {
  fill: currentColor;
