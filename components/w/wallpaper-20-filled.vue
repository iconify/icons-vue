...
const content = `<path class="jfo4gzp4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:wallpaper-20-filled" /></template>
<style>
.jfo4gzp4n {
  fill: currentColor;
