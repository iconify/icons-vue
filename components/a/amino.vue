...
const content = `<path class="ewjo-zqtm"/><path class="htayjvb9n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:amino" /></template>
<style>
.ewjo-zqtm {
  fill: none;
  stroke: currentColor;
