...
const content = `<path class="w6vy8bnyt"/><path class="b1am315hl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:paseo" /></template>
<style>
.b1am315hl {
  fill: none;
  stroke: currentColor;
