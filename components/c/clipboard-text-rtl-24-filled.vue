...
const content = `<path class="wbc404bow"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-text-rtl-24-filled" /></template>
<style>
.wbc404bow {
  fill: currentColor;
