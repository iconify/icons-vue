...
const content = `<path class="nojgvvblu"/><path class="xnz1ibg2v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dashwallet" /></template>
<style>
.nojgvvblu {
  fill: none;
  stroke: currentColor;
