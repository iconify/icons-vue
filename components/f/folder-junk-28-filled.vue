...
const content = `<path class="kaqajdbro"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-junk-28-filled" /></template>
<style>
.kaqajdbro {
