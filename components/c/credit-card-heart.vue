...
const content = `<path class="vcgrbbb7y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:credit-card-heart" /></template>
<style>
.vcgrbbb7y {
  fill: currentColor;
