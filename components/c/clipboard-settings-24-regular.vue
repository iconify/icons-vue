...
const content = `<path class="u05fx1ros"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-settings-24-regular" /></template>
<style>
.u05fx1ros {
  fill: currentColor;
