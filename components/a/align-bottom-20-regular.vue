...
const content = `<path class="mpg1mpbom"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-bottom-20-regular" /></template>
<style>
.mpg1mpbom {
  fill: currentColor;
