...
const content = `<path class="fi5i24bpv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:climate-mini-split-outline-rounded" /></template>
<style>
.fi5i24bpv {
  fill: currentColor;
