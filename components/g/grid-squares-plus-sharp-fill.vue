...
const content = `<g class="gp_8x1bzb"><path class="fto16pq9v"/><path class="kj2waq_ni"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:grid-squares-plus-sharp-fill" /></template>
<style>
.fto16pq9v {
  fill: currentColor;
