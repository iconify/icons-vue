...
const content = `<path class="ra6x7z8yx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-plus-sharp-fill" /></template>
<style>
.ra6x7z8yx {
  fill: none;
  stroke: currentColor;
