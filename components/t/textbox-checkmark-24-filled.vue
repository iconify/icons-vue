...
const content = `<path class="l911q5b8k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-checkmark-24-filled" /></template>
<style>
.l911q5b8k {
  fill: currentColor;
