...
const content = `<circle class="ccxx0cc_w"/><path class="bs-b-o8df"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nrf-toolbox" /></template>
<style>
.bs-b-o8df {
  fill: none;
  stroke: currentColor;
