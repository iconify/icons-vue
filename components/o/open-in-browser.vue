...
const content = `<path class="b1p_4g8hk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:open-in-browser" /></template>
<style>
.b1p_4g8hk {
  fill: currentColor;
