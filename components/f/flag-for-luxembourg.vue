...
const content = `<path class="ec63smi6v"/><path class="e2c785bsu"/><path class="teo576n8r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-luxembourg" /></template>
<style>
.e2c785bsu {
