...
const content = `<path class="t-e-2cuvk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-cell-outline-rounded" /></template>
<style>
.t-e-2cuvk {
  fill: currentColor;
