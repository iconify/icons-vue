...
const content = `<g class="cuyn6tgcc"><path class="r5nne3zxx"/><path class="mbjspabxc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-arc-left-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
