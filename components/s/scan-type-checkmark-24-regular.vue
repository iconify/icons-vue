...
const content = `<path class="l9ontivjy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-type-checkmark-24-regular" /></template>
<style>
.l9ontivjy {
  fill: currentColor;
