...
const content = `<path class="r43_jrz0n"/><path class="eiz794bdg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:vr-fps" /></template>
<style>
.eiz794bdg {
  fill: none;
  stroke: currentColor;
  ...
  d: path("m25.899 16.387l-.652-1.682l-.77 1.653a6.437 6.437 0 0 0 .597 12.846a6.435 6.435 0 0 0 .825-12.817");
}
