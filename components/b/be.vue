...
const content = `<path class="qt4y26klm"/><path class="bz-b2vb3d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:be" /></template>
<style>
.bz-b2vb3d {
  fill: none;
  stroke: currentColor;
