...
const content = `<path class="hps557b5v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:megaphone-loud-24-filled" /></template>
<style>
.hps557b5v {
  fill: currentColor;
