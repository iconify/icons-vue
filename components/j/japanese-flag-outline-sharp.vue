...
const content = `<path class="ywwdvu16e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:japanese-flag-outline-sharp" /></template>
<style>
.ywwdvu16e {
  fill: currentColor;
