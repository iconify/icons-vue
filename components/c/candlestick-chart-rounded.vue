...
const content = `<path class="ib160ibpd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:candlestick-chart-rounded" /></template>
<style>
.ib160ibpd {
  fill: currentColor;
