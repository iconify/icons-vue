...
const content = `<path class="gwva4tbws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sell-cloud-outline" /></template>
<style>
.gwva4tbws {
  fill: currentColor;
