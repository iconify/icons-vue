...
const content = `<path class="t-iehjl9k"/><defs><path id="SVGyRSiz3ZI" class="tuigsnr-c"/></defs><clipPath id="SVGg8BHKevx"><use href="#SVGyRSiz3ZI"/></clipPath><g clip-path="url(#SVGg8BHKevx)" class="tcw5ljb1b"><path class="ud_koobjq"/><path class="p2vykcvbo"/></g><defs><use href="#SVGyRSiz3ZI" id="SVGIiOWWbQa"/></defs><clipPath id="SVGyYC8dcBl"><use href="#SVGIiOWWbQa"/></clipPath><g clip-path="url(#SVGyYC8dcBl)" class="t3q4o6ulj"><path class="fawb-zbbe"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:vulcan-salute" /></template>
<style>
.fawb-zbbe {
