...
const content = `<path class="w3ac-vbun"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:convert-to-text-outline-rounded" /></template>
<style>
.w3ac-vbun {
  fill: currentColor;
