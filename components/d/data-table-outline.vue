...
const content = `<path class="s5bd_1bgy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:data-table-outline" /></template>
<style>
.s5bd_1bgy {
  fill: currentColor;
