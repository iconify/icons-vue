...
const content = `<g class="gp_8x1bzb"><path clip-rule="evenodd" class="i85dkhb0j"/><path class="kkk6uy55h"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-zap-sharp-fill" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
