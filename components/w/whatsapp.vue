...
const content = `<path class="n-83j25se"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:whatsapp" /></template>
<style>
.n-83j25se {
  fill: none;
  stroke: currentColor;
