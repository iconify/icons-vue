...
const content = `<path class="xxifw7b8z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:360-outline-sharp" /></template>
<style>
.xxifw7b8z {
  fill: currentColor;
