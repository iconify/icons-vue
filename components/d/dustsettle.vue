...
const content = `<path class="nn91s6bfg"/><path class="unjll9ufs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dustsettle" /></template>
<style>
.nn91s6bfg {
  fill: none;
  stroke: currentColor;
  ...
  d: path("m15.341 5.53l-.922 21.425c-.896.243-.934 1.592-.934 3.07c0 1.67.833 3.023 1.86 3.023s1.86-1.353 1.86-3.023c0-1.456-.055-2.79-.935-3.058Zm16.949 0l-.922 21.425c-.896.243-.935 1.592-.935 3.07c0 1.67.834 3.023 1.86 3.023s1.86-1.353 1.86-3.023c0-1.456-.054-2.79-.934-3.058Z");
}
