...
const content = `<g class="cuyn6tgcc"><path class="e3064-r1c"/><path class="a1697fyqv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-simple-minus-duotone" /></template>
<style>
.a1697fyqv {
