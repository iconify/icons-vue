...
const content = `<path class="mkilmjbxx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shield-question-outline-sharp" /></template>
<style>
.mkilmjbxx {
  fill: currentColor;
