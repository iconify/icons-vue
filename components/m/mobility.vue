...
const content = `<path class="qxhhmsouk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mobility" /></template>
<style>
.qxhhmsouk {
  fill: none;
  stroke: currentColor;
