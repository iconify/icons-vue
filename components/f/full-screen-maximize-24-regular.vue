...
const content = `<path class="u2lhvh-qs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:full-screen-maximize-24-regular" /></template>
<style>
.u2lhvh-qs {
  fill: currentColor;
