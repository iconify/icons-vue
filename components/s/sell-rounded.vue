...
const content = `<path class="k0-mqebbp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sell-rounded" /></template>
<style>
.k0-mqebbp {
  fill: currentColor;
