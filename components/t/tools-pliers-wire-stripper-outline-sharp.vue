...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tools-pliers-wire-stripper-outline-sharp" /></template>
<style>
.pe-7wnfox {
  fill: currentColor;
