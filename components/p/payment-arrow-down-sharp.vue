...
const content = `<path class="aw23g5bfz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:payment-arrow-down-sharp" /></template>
<style>
.aw23g5bfz {
  fill: currentColor;
