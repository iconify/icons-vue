...
const content = `<path class="st6f8hpmp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-bidirectional-24-regular" /></template>
<style>
.st6f8hpmp {
  fill: currentColor;
