...
const content = `<path class="evihqjbpt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-error" /></template>
<style>
.evihqjbpt {
  fill: currentColor;
