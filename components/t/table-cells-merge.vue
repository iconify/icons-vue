...
const content = `<path class="b6lbctb6d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:table-cells-merge" /></template>
<style>
.b6lbctb6d {
  fill: none;
  stroke: currentColor;
