...
const content = `<path class="nn37v2_mn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-mute-24-regular" /></template>
<style>
.nn37v2_mn {
  fill: currentColor;
