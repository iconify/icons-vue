...
const content = `<path class="wdjadx5fx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tab-close-right-outline-sharp" /></template>
<style>
.wdjadx5fx {
  fill: currentColor;
