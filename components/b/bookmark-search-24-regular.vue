...
const content = `<path class="w7p4y8d4h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bookmark-search-24-regular" /></template>
<style>
.w7p4y8d4h {
  fill: currentColor;
