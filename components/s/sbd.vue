...
const content = `<g class="ft5dv1b6b"><path class="nlp43-bsf"/><path class="qaei6be0c"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:sbd" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
