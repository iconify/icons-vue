...
const content = `<path class="l_7v4wefl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fence-outline-sharp" /></template>
<style>
.l_7v4wefl {
  fill: currentColor;
