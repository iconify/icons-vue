...
const content = `<path class="kmw96wb1o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-emergency-recording" /></template>
<style>
.kmw96wb1o {
  fill: currentColor;
