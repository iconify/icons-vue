...
const content = `<path class="z_cqbkb3u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-grammar-arrow-left-24-filled" /></template>
<style>
.z_cqbkb3u {
  fill: currentColor;
