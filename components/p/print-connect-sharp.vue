...
const content = `<path class="z15ey_bbk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:print-connect-sharp" /></template>
<style>
.z15ey_bbk {
  fill: currentColor;
