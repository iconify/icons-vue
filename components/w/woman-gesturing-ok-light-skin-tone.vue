...
const content = `<path class="wdvvseblg"/><path class="v8qc18bax"/><path class="ov_qewwdl"/><path class="apd4j2b9j"/><path class="x1lu53b3w"/><path class="egv546b5j"/><path class="j9utn56ke"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:woman-gesturing-ok-light-skin-tone" /></template>
<style>
.apd4j2b9j {
