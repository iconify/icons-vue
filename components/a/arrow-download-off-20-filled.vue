...
const content = `<path class="hwzrpuzjv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-download-off-20-filled" /></template>
<style>
.hwzrpuzjv {
  fill: currentColor;
