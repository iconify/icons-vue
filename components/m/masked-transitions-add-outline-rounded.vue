...
const content = `<path class="q1e_webxn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:masked-transitions-add-outline-rounded" /></template>
<style>
.q1e_webxn {
  fill: currentColor;
