...
const content = `<path class="y39rqtr7h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:frigate" /></template>
<style>
.y39rqtr7h {
  fill: none;
  stroke: currentColor;
