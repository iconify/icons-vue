...
const content = `<path class="iu0parb0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-arrow-right-48-regular" /></template>
<style>
.iu0parb0q {
  fill: currentColor;
