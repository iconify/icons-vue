...
const content = `<path class="pu_cb1jro"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-delete-20-regular" /></template>
<style>
.pu_cb1jro {
  fill: currentColor;
