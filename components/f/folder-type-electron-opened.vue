...
const content = `<path class="t-r-oe75q"/><path class="kk7rowbeb"/><path class="fjji9zucp"/><path class="harl5vqek"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-electron-opened" /></template>
<style>
.fjji9zucp {
  fill: var(--svg-color--9feaf9, #9feaf9);
...
.t-r-oe75q {
  fill: var(--svg-color--74989e, #74989e);
