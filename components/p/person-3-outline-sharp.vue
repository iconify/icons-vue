...
const content = `<path class="g-d2awbvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:person-3-outline-sharp" /></template>
<style>
.g-d2awbvo {
  fill: currentColor;
