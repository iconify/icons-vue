...
const content = `<path class="let4uggac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:high-chair-rounded" /></template>
<style>
.let4uggac {
  fill: currentColor;
