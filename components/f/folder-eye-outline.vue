...
const content = `<path class="vl24pjbro"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:folder-eye-outline" /></template>
<style>
.vl24pjbro {
  fill: currentColor;
