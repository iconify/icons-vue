...
const content = `<path class="i2d0c_bnz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sim-card-sharp" /></template>
<style>
.i2d0c_bnz {
  fill: currentColor;
