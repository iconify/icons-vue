...
const content = `<path class="bsajqrb-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shortpick-24-filled" /></template>
<style>
.bsajqrb-g {
  fill: currentColor;
