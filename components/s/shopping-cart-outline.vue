...
const content = `<path class="wrs8nbb1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shopping-cart-outline" /></template>
<style>
.wrs8nbb1m {
  fill: currentColor;
