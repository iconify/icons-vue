...
const content = `<g class="ahe1zu2_d"><path class="q1m7lijqp"/><path class="nbhtrgb0g"/><path class="x3dr0gb9f"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:srm" /></template>
<style>
.ahe1zu2_d {
