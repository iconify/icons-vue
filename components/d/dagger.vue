...
const content = `<path class="tocx80uqa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dagger" /></template>
<style>
.tocx80uqa {
  fill: none;
  stroke: currentColor;
