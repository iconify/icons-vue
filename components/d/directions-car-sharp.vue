...
const content = `<path class="vy3vofbqa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:directions-car-sharp" /></template>
<style>
.vy3vofbqa {
  fill: currentColor;
