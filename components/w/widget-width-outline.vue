...
const content = `<path class="irqzv5bcz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:widget-width-outline" /></template>
<style>
.irqzv5bcz {
  fill: currentColor;
