...
const content = `<path class="nnhn07-wq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:info-rounded" /></template>
<style>
.nnhn07-wq {
  fill: currentColor;
