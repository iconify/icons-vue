...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGlFPuWtLO)" clip-rule="evenodd" class="wgatvu0wi"/><defs><linearGradient id="SVGlFPuWtLO" x1="12" x2="12" y1="3" y2="21" gradientUnits="userSpaceOnUse"><stop class="d20te1bfg"/><stop offset="1" class="xclmqab0c"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:daimo" /></template>
<style>
.d20te1bfg {
  stop-color: var(--svg-color--66b95f, #66b95f);
}
...
.xclmqab0c {
  stop-color: var(--svg-color--95ce96, #95ce96);
}
