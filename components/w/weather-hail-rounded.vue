...
const content = `<path class="r0geenb-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:weather-hail-rounded" /></template>
<style>
.r0geenb-j {
  fill: currentColor;
