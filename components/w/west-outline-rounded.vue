...
const content = `<path class="mul-yxhha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:west-outline-rounded" /></template>
<style>
.mul-yxhha {
  fill: currentColor;
