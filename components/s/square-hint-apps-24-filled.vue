...
const content = `<path class="c5c37m6yx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-apps-24-filled" /></template>
<style>
.c5c37m6yx {
  fill: currentColor;
