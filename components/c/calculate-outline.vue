...
const content = `<path class="zxg_qek6r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:calculate-outline" /></template>
<style>
.zxg_qek6r {
  fill: currentColor;
