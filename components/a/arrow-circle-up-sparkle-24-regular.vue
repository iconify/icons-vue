...
const content = `<path class="ms6etcc4l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-up-sparkle-24-regular" /></template>
<style>
.ms6etcc4l {
  fill: currentColor;
