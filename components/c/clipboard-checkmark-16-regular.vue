...
const content = `<path class="k_x9labob"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-checkmark-16-regular" /></template>
<style>
.k_x9labob {
  fill: currentColor;
