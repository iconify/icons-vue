...
const content = `<path class="t1tjkfb6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:movie-edit-off-sharp" /></template>
<style>
.t1tjkfb6i {
  fill: currentColor;
