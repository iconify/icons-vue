...
const content = `<path class="s93vzn4ub"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:record-voice-over-rounded" /></template>
<style>
.s93vzn4ub {
  fill: currentColor;
