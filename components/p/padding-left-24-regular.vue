...
const content = `<path class="e9p3-mb0m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:padding-left-24-regular" /></template>
<style>
.e9p3-mb0m {
  fill: currentColor;
