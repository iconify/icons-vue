...
const content = `<path class="i13vn6bzg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:plug-connected-settings-20-regular" /></template>
<style>
.i13vn6bzg {
  fill: currentColor;
