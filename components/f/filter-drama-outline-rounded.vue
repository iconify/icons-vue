...
const content = `<path class="ch_4tlbzi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:filter-drama-outline-rounded" /></template>
<style>
.ch_4tlbzi {
  fill: currentColor;
