...
const content = `<path class="q_94fp5zf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:money-outline-rounded" /></template>
<style>
.q_94fp5zf {
  fill: currentColor;
