...
const content = `<path class="ni47fr_ov"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:eyedropper-off-24-regular" /></template>
<style>
.ni47fr_ov {
  fill: currentColor;
