...
const content = `<path class="dpwz1b7al"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-waterfall-20-regular" /></template>
<style>
.dpwz1b7al {
  fill: currentColor;
