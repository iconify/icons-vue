...
const content = `<g class="cuyn6tgcc"><path class="dnhudsqlm"/><path class="m4vipbbpn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:open-ai-logo-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.dnhudsqlm {
  d: path("m96 174.19l56-32.33v36.95l-44.5 25.69a48 48 0 0 1-66.4-64.08a48 48 0 0 0 10.4 8.08Zm108.5-66.69L160 81.81l-32 18.48l56 32.33V184a48 48 0 0 1-1.81 13a48 48 0 0 0 22.31-89.5M104 77.19l44.5-25.69a47.8 47.8 0 0 1 12.19-5A48 48 0 0 0 72 72v51.38l32 18.48Z");
