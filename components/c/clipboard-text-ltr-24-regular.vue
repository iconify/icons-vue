...
const content = `<path class="f_l5bkvzm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-text-ltr-24-regular" /></template>
<style>
.f_l5bkvzm {
  fill: currentColor;
