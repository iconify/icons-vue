...
const content = `<path class="oizfatb-u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-question-mark-16-regular" /></template>
<style>
.oizfatb-u {
  fill: currentColor;
