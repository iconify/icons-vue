...
const content = `<path class="lsltbjb3i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-copy-32-filled" /></template>
<style>
.lsltbjb3i {
  fill: currentColor;
