...
const content = `<path class="ioj_wkpbs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:trophy-off-48-regular" /></template>
<style>
.ioj_wkpbs {
  fill: currentColor;
