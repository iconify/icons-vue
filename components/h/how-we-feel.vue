...
const content = `<path class="b9vkk6bdm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:how-we-feel" /></template>
<style>
.b9vkk6bdm {
  fill: none;
  stroke: currentColor;
