...
const content = `<path class="bwwntpbdh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-warning-24-filled" /></template>
<style>
.bwwntpbdh {
  fill: currentColor;
