...
const content = `<path class="vdlb5dluc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-charging-full-outline-rounded" /></template>
<style>
.vdlb5dluc {
  fill: currentColor;
