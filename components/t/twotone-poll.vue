...
const content = `<path class="ikw92mbgj"/><path class="manzhlb6g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-poll" /></template>
<style>
.ikw92mbgj {
  fill: currentColor;
