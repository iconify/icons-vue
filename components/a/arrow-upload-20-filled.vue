...
const content = `<path class="ui_lrlbjj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-upload-20-filled" /></template>
<style>
.ui_lrlbjj {
  fill: currentColor;
