...
const content = `<path class="e_ybsyatl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-circle-up-rounded" /></template>
<style>
.e_ybsyatl {
  fill: currentColor;
