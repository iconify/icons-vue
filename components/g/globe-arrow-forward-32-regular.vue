...
const content = `<path class="p0but4l5i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-arrow-forward-32-regular" /></template>
<style>
.p0but4l5i {
  fill: currentColor;
