...
const content = `<path class="cg2fh-b9m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cancel-sharp" /></template>
<style>
.cg2fh-b9m {
  fill: currentColor;
