...
const content = `<path class="kaibjpbrk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-color-16-regular" /></template>
<style>
.kaibjpbrk {
  fill: currentColor;
