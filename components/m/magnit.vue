...
const content = `<path class="meyc1ff-i"/><path class="zhy8x-zwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:magnit" /></template>
<style>
.meyc1ff-i {
  fill: none;
  stroke: currentColor;
