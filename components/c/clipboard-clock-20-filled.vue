...
const content = `<path class="lr63unbgj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-clock-20-filled" /></template>
<style>
.lr63unbgj {
  fill: currentColor;
