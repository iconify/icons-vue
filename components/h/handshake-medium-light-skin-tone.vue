...
const content = `<path class="l9p7amb0k"/><g class="yph1ejvpg"><path class="kl68i8bgp"/><path class="x57g7cbon"/></g><path class="e1avnhwsp"/><path class="yrqx1tbur"/><path class="jo21i8bra"/><path class="runr8790n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:handshake-medium-light-skin-tone" /></template>
<style>
.e1avnhwsp {
  fill: var(--svg-color--3b946f, #3b946f);
  d: path("m53.4 16.3l3.3 17.1l-2.7 1.2c-1.4-3.7-3.5-12.6-3-16.9z");
}

.jo21i8bra {
  fill: var(--svg-color--3b946f, #3b946f);
  d: path("m6.1 35.1l5.4-18.7l2.5 1.7c.4 2.8-4.2 15.6-5.9 17.5z");
}
...
.yrqx1tbur {
  fill: var(--svg-color--e0a372, #e0a372);
  d: path("M11.1 38c-.5-1.2-.8-2.8-.8-2.8l-2.5-1.7l-.2 1.9l2.2.6c.3 1 .6 1.8 1 2.4z");
}
