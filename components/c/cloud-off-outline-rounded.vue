...
const content = `<path class="y-3z6uidb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloud-off-outline-rounded" /></template>
<style>
.y-3z6uidb {
  fill: currentColor;
