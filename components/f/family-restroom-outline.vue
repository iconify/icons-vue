...
const content = `<path class="w_uhuac2p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:family-restroom-outline" /></template>
<style>
.w_uhuac2p {
  fill: currentColor;
