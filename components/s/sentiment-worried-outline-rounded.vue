...
const content = `<path class="y39bqu3lx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sentiment-worried-outline-rounded" /></template>
<style>
.y39bqu3lx {
  fill: currentColor;
