...
const content = `<path class="yps5vab_s"/><path class="egepjnbrx"/><path class="n1y25xbkg"/><path class="v70p7o7ko"/><path class="eixupxb6o"/><path class="h3znq5qjx"/><path class="p1ny3mb9m"/><path class="xmkjbrbvd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:miru" /></template>
<style>
.egepjnbrx {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M28.115 28.54c2.098 4.97-4.72 7.891-9.403 12.863");
}
...
.h3znq5qjx {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M13.36 21.04c1.142 2.686 4.788 4.635 3.202-.92c-.717-2.495-4-.923-3.202.92");
}
...
.xmkjbrbvd {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M23.606 9.423c1.83 1.967 4.2 3.586 3.965 6.89c-1.853-.688-3.954-1.09-4.964-2.746c.421 1.767.714 3.314.088 3.296a27 27 0 0 1-2.681-2.044m9.512-2.014c5.03 6.159 4.221 10.42 2.868 16.698M9.575 13.962c-1.91 3.865 1.692 5.97 3.444 2.067m-6.068 5.474c1.444.194 3.837-1.517 5.744-2.266");
}
...
.yps5vab_s {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M7.832 42.135H31.79m-6.881-6.1c.066 2.861.62 4.452 1.153 6.1");
}
