...
const content = `<path class="qyeg5ibdw"/><path class="uwz-ayb3y"/><circle class="umaxsdd_s"/><circle class="ezxvklxqw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:scorbit" /></template>
<style>
.ezxvklxqw {
  cx: 23.378px;
  cy: 31.744px;
