...
const content = `<path class="n4kbp1byq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speed-0-2x-outline-sharp" /></template>
<style>
.n4kbp1byq {
  fill: currentColor;
