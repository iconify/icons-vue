...
const content = `<path class="xg8095b-d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edgesensor-high" /></template>
<style>
.xg8095b-d {
  fill: currentColor;
