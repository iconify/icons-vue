...
const content = `<path class="m8ki29bgw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:survivalcraft2" /></template>
<style>
.m8ki29bgw {
  fill: none;
  stroke: currentColor;
