...
const content = `<path class="sudyxzbdy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-sync-48-regular" /></template>
<style>
.sudyxzbdy {
  fill: currentColor;
