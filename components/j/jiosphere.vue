...
const content = `<circle class="cpk0fnbgt"/><path class="sr9tzhgqa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:jiosphere" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
