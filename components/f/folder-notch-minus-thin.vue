...
const content = `<path class="pjbar1bgv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-notch-minus-thin" /></template>
<style>
.pjbar1bgv {
  fill: currentColor;
