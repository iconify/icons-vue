...
const content = `<path class="f27gp2bkp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tablet-mac-outline-rounded" /></template>
<style>
.f27gp2bkp {
  fill: currentColor;
