...
const content = `<g class="cuyn6tgcc"><path class="sv7kk_bbw"/><path class="j67fn3bwu"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:code-simple-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
