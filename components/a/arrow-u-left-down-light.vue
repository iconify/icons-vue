...
const content = `<path class="ygsldg17y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-u-left-down-light" /></template>
<style>
.ygsldg17y {
  fill: currentColor;
