...
const content = `<path class="lr0s7ab5l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-two-split-top-24-regular" /></template>
<style>
.lr0s7ab5l {
  fill: currentColor;
