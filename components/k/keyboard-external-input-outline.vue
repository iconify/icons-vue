...
const content = `<path class="bapatjbxa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-external-input-outline" /></template>
<style>
.bapatjbxa {
  fill: currentColor;
