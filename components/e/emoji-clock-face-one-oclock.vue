...
const content = `<path class="fhr-20bpu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-clock-face-one-oclock" /></template>
<style>
.fhr-20bpu {
  fill: none;
  stroke: currentColor;
