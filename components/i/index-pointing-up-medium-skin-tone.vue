...
const content = `<path class="s9s3_tbuj"/><defs><path id="SVGWj2HCcSM" class="k0zim5bgm"/></defs><clipPath id="SVGhSdoVdxD"><use href="#SVGWj2HCcSM"/></clipPath><path clip-path="url(#SVGhSdoVdxD)" class="eyvl4sejl"/><defs><use href="#SVGWj2HCcSM" id="SVGt5NmHeUS"/></defs><clipPath id="SVGKUt7mcPv"><use href="#SVGt5NmHeUS"/></clipPath><path clip-path="url(#SVGKUt7mcPv)" class="uev2ksbyp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:index-pointing-up-medium-skin-tone" /></template>
<style>
.eyvl4sejl {
