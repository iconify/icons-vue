...
const content = `<path class="dho0hh79d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:photo-prints" /></template>
<style>
.dho0hh79d {
  fill: currentColor;
