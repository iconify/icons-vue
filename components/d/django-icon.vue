...
const content = `<rect class="yls1tcblz"/><path class="v-825cbph"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:django-icon" /></template>
<style>
.v-825cbph {
  fill: var(--svg-color--fffffd, #fffffd);
...
.yls1tcblz {
  width: 256px;
  height: 256px;
  fill: var(--svg-color--092e20, #092e20);
  rx: 28px;
}
