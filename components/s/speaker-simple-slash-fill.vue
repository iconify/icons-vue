...
const content = `<path class="xzo9y7bil"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:speaker-simple-slash-fill" /></template>
<style>
.xzo9y7bil {
  fill: currentColor;
