...
const content = `<path class="rqol-zl8a"/><path class="vviqgobih"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:deckboard-pro" /></template>
<style>
.rqol-zl8a {
  fill: none;
  stroke: currentColor;
