...
const content = `<path class="ppg_lklbv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:report-sharp" /></template>
<style>
.ppg_lklbv {
  fill: currentColor;
