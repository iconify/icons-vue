...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVG0E6pbbux)" class="pmf7xwbti"/><defs><linearGradient id="SVG0E6pbbux" x1="12.002" x2="12.002" y1="3" y2="21" gradientUnits="userSpaceOnUse"><stop class="cgj9ggbwn"/><stop offset="1" class="zdxws8cls"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:otk" /></template>
<style>
.cgj9ggbwn {
