...
const content = `<g class="y9tr6bcfx"><path class="sax55ubwp"/><path class="mvuufcbfn"/></g><path class="gdpz_rbbn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-fossify-18" /></template>
<style>
.gdpz_rbbn {
  fill: none;
  stroke: currentColor;
