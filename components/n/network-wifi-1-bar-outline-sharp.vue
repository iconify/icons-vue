...
const content = `<path class="eauxbsbwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:network-wifi-1-bar-outline-sharp" /></template>
<style>
.eauxbsbwk {
  fill: currentColor;
