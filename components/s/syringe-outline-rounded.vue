...
const content = `<path class="d9ty3bcvr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:syringe-outline-rounded" /></template>
<style>
.d9ty3bcvr {
  fill: currentColor;
