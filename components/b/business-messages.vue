...
const content = `<path class="ho306fthi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:business-messages" /></template>
<style>
.ho306fthi {
  fill: currentColor;
