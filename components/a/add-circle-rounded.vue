...
const content = `<path class="sqxmrjl_x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-circle-rounded" /></template>
<style>
.sqxmrjl_x {
  fill: currentColor;
