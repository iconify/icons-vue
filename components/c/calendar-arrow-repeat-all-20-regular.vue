...
const content = `<path class="upv8cfsbt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-arrow-repeat-all-20-regular" /></template>
<style>
.upv8cfsbt {
  fill: currentColor;
