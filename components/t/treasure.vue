...
const content = `<g class="ft5dv1b6b"><path class="px1o7sbej"/><path class="k_ojiubgr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:treasure" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
