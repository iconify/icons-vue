...
const content = `<path class="kzvnhdb6o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:timer-3-outline-rounded" /></template>
<style>
.kzvnhdb6o {
  fill: currentColor;
