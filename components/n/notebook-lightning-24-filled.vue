...
const content = `<path class="zg8rbgyik"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notebook-lightning-24-filled" /></template>
<style>
.zg8rbgyik {
  fill: currentColor;
