...
const content = `<path class="d0am508jw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:food-toast-24-filled" /></template>
<style>
.d0am508jw {
  fill: currentColor;
