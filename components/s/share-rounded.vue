...
const content = `<path class="u8r-w7bus"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:share-rounded" /></template>
<style>
.u8r-w7bus {
  fill: currentColor;
