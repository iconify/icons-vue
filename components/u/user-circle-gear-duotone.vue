...
const content = `<g class="cuyn6tgcc"><path class="j2z_phbnw"/><path class="kiy8om_zl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:user-circle-gear-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.j2z_phbnw {
  d: path("M224 128a95.76 95.76 0 0 1-31.8 71.37A72 72 0 0 0 128 160a40 40 0 1 0-40-40a40 40 0 0 0 40 40a72 72 0 0 0-64.2 39.37A96 96 0 0 1 184.92 50.69a16 16 0 0 0 20.39 20.39A95.6 95.6 0 0 1 224 128");
