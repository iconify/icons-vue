...
const content = `<path class="ic25dhbaf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fiber-new-sharp" /></template>
<style>
.ic25dhbaf {
  fill: currentColor;
