...
const content = `<path class="f0-ei51bv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:globe-hemisphere-east-fill" /></template>
<style>
.f0-ei51bv {
  fill: currentColor;
