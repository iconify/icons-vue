...
const content = `<path class="qfilzdb3v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tap-single-48-regular" /></template>
<style>
.qfilzdb3v {
  fill: currentColor;
