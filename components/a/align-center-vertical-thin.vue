...
const content = `<path class="qwthqd3iu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:align-center-vertical-thin" /></template>
<style>
.qwthqd3iu {
  fill: currentColor;
