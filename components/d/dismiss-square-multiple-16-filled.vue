...
const content = `<path class="hy1vzvbvn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dismiss-square-multiple-16-filled" /></template>
<style>
.hy1vzvbvn {
  fill: currentColor;
