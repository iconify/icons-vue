...
const content = `<path class="llh1cftfy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flag-clock-16-filled" /></template>
<style>
.llh1cftfy {
  fill: currentColor;
