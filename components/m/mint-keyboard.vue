...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mint-keyboard" /></template>
<style>
.bk5ojmbhy {
...
.j1gc7ccsw {
  d: path("M29.955 10.578c-2.479-.503-14.39-.711-10.671 10.659c13.346 5.353 11.48-6.78 10.67-10.66");
}
...
.n0r3sibrm {
  d: path("M17.471 21.822c4.077-.988 9.484-4.634 12.484-11.244");
}
