...
const content = `<path class="byne02b4y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:alert-on-20-regular" /></template>
<style>
.byne02b4y {
  fill: currentColor;
