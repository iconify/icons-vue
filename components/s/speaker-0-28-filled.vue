...
const content = `<path class="xv2ijbl0p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-0-28-filled" /></template>
<style>
.xv2ijbl0p {
  fill: currentColor;
