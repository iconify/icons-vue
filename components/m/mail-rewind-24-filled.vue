...
const content = `<path class="n5dfs1kre"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-rewind-24-filled" /></template>
<style>
.n5dfs1kre {
  fill: currentColor;
