...
const content = `<path class="v9hkaukiy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:prayer-times-outline-rounded" /></template>
<style>
.v9hkaukiy {
  fill: currentColor;
