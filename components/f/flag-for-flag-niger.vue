...
const content = `<circle class="ixfggn3xi"/><path class="a_d14drdr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-flag-niger" /></template>
<style>
.a_d14drdr {
  fill: currentColor;
