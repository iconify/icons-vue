...
const content = `<path class="r195lmj-q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-ticket-outline-sharp" /></template>
<style>
.r195lmj-q {
  fill: currentColor;
