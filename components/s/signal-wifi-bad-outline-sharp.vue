...
const content = `<path class="yhx13tbac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-wifi-bad-outline-sharp" /></template>
<style>
.yhx13tbac {
  fill: currentColor;
