...
const content = `<path class="ceq387buu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:database-search-32-filled" /></template>
<style>
.ceq387buu {
  fill: currentColor;
