...
const content = `<path class="erkh6y-kj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bankid" /></template>
<style>
.erkh6y-kj {
  fill: none;
  stroke: currentColor;
