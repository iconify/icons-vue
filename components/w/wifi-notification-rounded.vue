...
const content = `<path class="gm4rqtbdy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wifi-notification-rounded" /></template>
<style>
.gm4rqtbdy {
  fill: currentColor;
