...
const content = `<path class="bvxr7ytds"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:border-top-outline-sharp" /></template>
<style>
.bvxr7ytds {
  fill: currentColor;
