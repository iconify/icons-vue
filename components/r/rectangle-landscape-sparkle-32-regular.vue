...
const content = `<path class="qz_v1bp1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:rectangle-landscape-sparkle-32-regular" /></template>
<style>
.qz_v1bp1j {
  fill: currentColor;
