...
const content = `<path class="yo0zf8bxb"/><path class="to8786byg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:deepr" /></template>
<style>
.to8786byg {
  fill: none;
  stroke: currentColor;
