...
const content = `<path class="fz-c07bgq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:plug-connected-settings-20-filled" /></template>
<style>
.fz-c07bgq {
  fill: currentColor;
