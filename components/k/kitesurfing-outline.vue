...
const content = `<path class="p0yoc640l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:kitesurfing-outline" /></template>
<style>
.p0yoc640l {
  fill: currentColor;
