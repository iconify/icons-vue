...
const content = `<path class="kmb4v870n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:person-simple-ski-light" /></template>
<style>
.kmb4v870n {
  fill: currentColor;
