...
const content = `<path class="dr4h73b-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-lightning-24-regular" /></template>
<style>
.dr4h73b-g {
  fill: currentColor;
