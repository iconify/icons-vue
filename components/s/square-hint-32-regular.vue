...
const content = `<path class="si4ky9ppw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-32-regular" /></template>
<style>
.si4ky9ppw {
  fill: currentColor;
