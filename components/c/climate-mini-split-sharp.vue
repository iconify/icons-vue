...
const content = `<path class="m5r0nlb4y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:climate-mini-split-sharp" /></template>
<style>
.m5r0nlb4y {
  fill: currentColor;
