...
const content = `<g class="cuyn6tgcc"><path class="nvcmb8znw"/><path class="gsdhd-bao"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:star-half-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
