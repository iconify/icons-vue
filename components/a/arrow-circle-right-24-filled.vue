...
const content = `<path class="maw80qo5s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-right-24-filled" /></template>
<style>
.maw80qo5s {
  fill: currentColor;
