...
const content = `<path class="dl1uh1tjd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-cloudy-20-regular" /></template>
<style>
.dl1uh1tjd {
  fill: currentColor;
