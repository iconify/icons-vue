...
const content = `<g class="cuyn6tgcc"><path class="p-a0zoigs"/><path class="ms78k4l7h"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:polygon-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
