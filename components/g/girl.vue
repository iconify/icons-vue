...
const content = `<path class="o_vb6834w"/><circle class="le010cbkf"/><circle class="g0w8y82ep"/><path class="lfg7qybwi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:girl" /></template>
<style>
.g0w8y82ep {
  cx: 19.5px;
  cy: 36.504px;
