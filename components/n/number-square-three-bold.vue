...
const content = `<path class="d9maxtx6x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-three-bold" /></template>
<style>
.d9maxtx6x {
  fill: currentColor;
