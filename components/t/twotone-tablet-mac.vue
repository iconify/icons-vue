...
const content = `<path class="gsblrdbnl"/><path class="po49j3b3e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-tablet-mac" /></template>
<style>
.gsblrdbnl {
  fill: currentColor;
