...
const content = `<path class="nk6jui3uu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-quote-opening-16-filled" /></template>
<style>
.nk6jui3uu {
  fill: currentColor;
