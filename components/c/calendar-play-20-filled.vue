...
const content = `<path class="rtlz-suns"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-play-20-filled" /></template>
<style>
.rtlz-suns {
  fill: currentColor;
