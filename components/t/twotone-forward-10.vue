...
const content = `<path class="kk67gccwf"/><path class="w4c4eeb2u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-forward-10" /></template>
<style>
.kk67gccwf {
  fill: currentColor;
