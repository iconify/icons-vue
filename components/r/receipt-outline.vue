...
const content = `<path class="d0jgz8cvw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:receipt-outline" /></template>
<style>
.d0jgz8cvw {
  fill: currentColor;
