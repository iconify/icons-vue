...
const content = `<path class="r1ate1bvy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chevron-circle-left-32-filled" /></template>
<style>
.r1ate1bvy {
  fill: currentColor;
