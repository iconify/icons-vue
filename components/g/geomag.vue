...
const content = `<path class="isghkhbwj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:geomag" /></template>
<style>
.isghkhbwj {
  fill: none;
  stroke: currentColor;
