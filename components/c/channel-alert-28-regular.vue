...
const content = `<path class="mdfmoyleo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:channel-alert-28-regular" /></template>
<style>
.mdfmoyleo {
  fill: currentColor;
