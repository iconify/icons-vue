...
const content = `<path class="mi7of6n9k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:web-stories-outline-rounded" /></template>
<style>
.mi7of6n9k {
  fill: currentColor;
