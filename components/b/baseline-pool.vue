...
const content = `<path class="pnibw8b1v"/><circle class="rzy3fj1gc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-pool" /></template>
<style>
.pnibw8b1v {
  fill: currentColor;
