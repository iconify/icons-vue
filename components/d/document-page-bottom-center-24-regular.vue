...
const content = `<path class="titmy0bnk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-page-bottom-center-24-regular" /></template>
<style>
.titmy0bnk {
  fill: currentColor;
