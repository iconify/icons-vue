...
const content = `<path class="txhpclayf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:open-folder-24-regular" /></template>
<style>
.txhpclayf {
  fill: currentColor;
