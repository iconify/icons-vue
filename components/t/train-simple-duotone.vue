...
const content = `<g class="cuyn6tgcc"><path class="xl3otkjnh"/><path class="n0sf9abkb"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:train-simple-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
