...
const content = `<path class="j6qvhmbkw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mimo-disconnect" /></template>
<style>
.j6qvhmbkw {
  fill: currentColor;
