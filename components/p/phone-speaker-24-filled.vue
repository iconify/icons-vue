...
const content = `<path class="zbinnlb7j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-speaker-24-filled" /></template>
<style>
.zbinnlb7j {
  fill: currentColor;
