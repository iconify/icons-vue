...
const content = `<path class="gx_s68nhg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-mark-email-unread" /></template>
<style>
.gx_s68nhg {
  fill: currentColor;
