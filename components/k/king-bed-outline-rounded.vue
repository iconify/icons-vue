...
const content = `<path class="y8kcr5bkc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:king-bed-outline-rounded" /></template>
<style>
.y8kcr5bkc {
  fill: currentColor;
