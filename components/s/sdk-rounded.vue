...
const content = `<path class="i61qzb8dt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sdk-rounded" /></template>
<style>
.i61qzb8dt {
  fill: currentColor;
