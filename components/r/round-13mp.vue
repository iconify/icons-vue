...
const content = `<path class="k4n51fjcs"/><path class="n2w5duuqn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-13mp" /></template>
<style>
.k4n51fjcs {
  fill: currentColor;
