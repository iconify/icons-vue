...
const content = `<path class="gi5mmmb6x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:security-update-good" /></template>
<style>
.gi5mmmb6x {
  fill: currentColor;
