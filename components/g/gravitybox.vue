...
const content = `<path class="pwnbvjbot"/><circle class="edi79mb8h"/><circle class="cpk0fnbgt"/><circle class="cps8tpbrh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gravitybox" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
