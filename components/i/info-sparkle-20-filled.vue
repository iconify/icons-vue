...
const content = `<path class="su3u_bp8z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:info-sparkle-20-filled" /></template>
<style>
.su3u_bp8z {
  fill: currentColor;
