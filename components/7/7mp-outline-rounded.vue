...
const content = `<path class="bp20v1utr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:7mp-outline-rounded" /></template>
<style>
.bp20v1utr {
  fill: currentColor;
