...
const content = `<path class="ne8v0nb9r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:field-guide-ingress" /></template>
<style>
.ne8v0nb9r {
  fill: none;
  stroke: currentColor;
