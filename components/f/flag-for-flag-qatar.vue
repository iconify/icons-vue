...
const content = `<path class="scuexhb4w"/><path class="t0y22zbdi"/><path class="cucjub_ro"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-qatar" /></template>
<style>
.cucjub_ro {
