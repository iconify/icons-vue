...
const content = `<path class="mo_sbgbmr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:doorbell-chime-outline-sharp" /></template>
<style>
.mo_sbgbmr {
  fill: currentColor;
