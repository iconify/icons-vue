...
const content = `<path class="h93tmwofh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:api-outline-rounded" /></template>
<style>
.h93tmwofh {
  fill: currentColor;
