...
const content = `<path class="o7s5hjb5a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sd-card-alert-rounded" /></template>
<style>
.o7s5hjb5a {
  fill: currentColor;
