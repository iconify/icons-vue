...
const content = `<defs><linearGradient id="SVGtUOqUbCU" x1=".879" x2="1.093" y1="34.702" y2="34.702" gradientTransform="rotate(98.13 2033.217 2228.98)scale(130.809)" gradientUnits="userSpaceOnUse"><stop offset="0" class="zr_-zkkbe"/><stop offset=".041" class="zr_-zkkbe"/><stop offset=".129" class="dbqq1la-v"/><stop offset=".822" class="pnfc7rbwg"/><stop offset="1" class="pnfc7rbwg"/></linearGradient></defs><path class="bauyz0b7w"/><path fill="url(#SVGtUOqUbCU)" class="j683a7b9m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-cloudfoundry" /></template>
<style>
.bauyz0b7w {
