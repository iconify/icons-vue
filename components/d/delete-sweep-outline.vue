...
const content = `<path class="jiy4fxbms"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:delete-sweep-outline" /></template>
<style>
.jiy4fxbms {
  fill: currentColor;
