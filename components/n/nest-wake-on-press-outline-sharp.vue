...
const content = `<path class="qmjzwhg5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:nest-wake-on-press-outline-sharp" /></template>
<style>
.qmjzwhg5x {
  fill: currentColor;
