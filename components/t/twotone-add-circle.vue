...
const content = `<path class="ilwcq469z"/><path class="iuc688jhq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-add-circle" /></template>
<style>
.ilwcq469z {
  fill: currentColor;
