...
const content = `<path class="kazevbbdv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fit-page-height-outline-rounded" /></template>
<style>
.kazevbbdv {
  fill: currentColor;
