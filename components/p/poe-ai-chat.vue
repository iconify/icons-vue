...
const content = `<rect class="oxpyp4blm"/><path class="ery9bdx7q"/><path class="qc03nfwmv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:poe-ai-chat" /></template>
<style>
.ery9bdx7q {
  fill: none;
  stroke: currentColor;
