...
const content = `<path class="r7l8vebyb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calligraphy-pen-24-filled" /></template>
<style>
.r7l8vebyb {
  fill: currentColor;
