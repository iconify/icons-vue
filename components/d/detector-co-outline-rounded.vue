...
const content = `<path class="r4mlx6bjn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:detector-co-outline-rounded" /></template>
<style>
.r4mlx6bjn {
  fill: currentColor;
