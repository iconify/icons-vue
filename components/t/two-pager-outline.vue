...
const content = `<path class="mahvjsbtg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:two-pager-outline" /></template>
<style>
.mahvjsbtg {
  fill: currentColor;
