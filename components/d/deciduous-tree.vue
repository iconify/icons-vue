...
const content = `<g class="fo1_54amk"><ellipse class="i9cue_bll"/><ellipse class="enn3gotlu"/><ellipse class="jfbgtibme"/><ellipse class="txzb7kbxq"/><ellipse class="hdy3e2b-z"/></g><g class="cba75tbmi"><path class="hs6nkh4ju"/><path class="l_x9g_17u"/></g><path class="iqktgbc5u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:deciduous-tree" /></template>
<style>
.cba75tbmi {
...
.hs6nkh4ju {
  d: path("M28.9 64c.3-4-.3-8.2-.9-12.6s-1.4-8.9-1.4-13.5c-.1-4.6.5-9.3 2.1-13.6c1.5-4.3 3.8-8.2 6.5-11.7c-2.3 3.8-4 7.9-4.9 12.2c-.9 4.2-.9 8.6-.3 12.8s1.8 8.4 3.1 12.7c1.2 4.3 2.5 8.8 2.8 13.7z");
}
