...
const content = `<g class="ft5dv1b6b"><path class="air1xstav"/><path class="jk-4qnh0f"/><path fill="url(#SVGsX5cmc8u)" clip-rule="evenodd" class="war-wwmin"/><path fill="url(#SVGwYCcccFj)" clip-rule="evenodd" class="kyl82ob5o"/><defs><linearGradient id="SVGsX5cmc8u" x1="12" x2="11.541" y1="6.15" y2="16.679" gradientUnits="userSpaceOnUse"><stop offset=".04" class="u0pmas70o"/><stop offset=".26" class="it0vlabvd"/><stop offset=".36" class="r1rd8djuy"/><stop offset=".6" class="bgdbzyy3p"/><stop offset=".88" class="zpge9bbuq"/><stop offset="1" class="du_q-up6l"/></linearGradient><linearGradient id="SVGwYCcccFj" x1="3.904" x2="20.166" y1="9.183" y2="10.25" gradientUnits="userSpaceOnUse"><stop class="l2zfjkb3d"/><stop offset=".08" class="y5rs26btk"/><stop offset=".2" class="pg5s0zyep"/><stop offset=".34" class="x85ksghim"/><stop offset=".45" class="hv5tv2oes"/><stop offset=".58" class="rxlgx0b7o"/><stop offset=".69" class="jjylcdc2z"/><stop offset=".83" class="kaalyxbwt"/><stop offset=".92" class="d4gbni0ox"/><stop offset="1" class="d7nhyebrk"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:cone" /></template>
<style>
.air1xstav {
  fill: var(--svg-color--3a1704, #3a1704);
  d: path("M4.092 7.698c.432-.216.9-.09 1.08 0c.18-.364.698-1.098 1.346-1.098c.643 0 .63.55.54.824l.27-.27h1.07l.81.823l.27-.279h1.076l.27.828c.09-.18.378-.549.81-.549c.428 0 .716.18.806.27c.09-.09.378-.27.81-.27c.427 0 .895.734 1.075 1.098c.18-.459.697-1.377 1.345-1.377c.644 0 1.166.734 1.346 1.103c.18-.275.643-.824 1.08-.824c.427 0 .715.55.805.824a.95.95 0 0 1 .81-.55c.855 0 .891 1.099.806 1.648c-.433 2.861-1.62 3.577-2.16 3.577c-.086.823-.266 2.587-.266 3.024c0 .553-.27 1.102-1.615.828c-1.346-.275-8.613-.554-9.958-.275c-1.08.22-1.35-.274-1.35-.553l-.54-4.122c-.09 0-.374-.059-.806-.28c-.427-.215 0-.823.27-1.097c-.09-.643-.324-1.98-.54-2.2c-.27-.275 0-.824.54-1.103");
}
