...
const content = `<path class="pvatkg5uv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:graph-8-outline-rounded" /></template>
<style>
.pvatkg5uv {
  fill: currentColor;
