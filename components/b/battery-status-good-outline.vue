...
const content = `<path class="mynjvnbgv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-status-good-outline" /></template>
<style>
.mynjvnbgv {
  fill: currentColor;
