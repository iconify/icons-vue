...
const content = `<path class="rdwen8iuy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:currency-rupee-outline-sharp" /></template>
<style>
.rdwen8iuy {
  fill: currentColor;
