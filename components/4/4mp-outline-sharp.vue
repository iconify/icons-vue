...
const content = `<path class="s1s6bjxit"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:4mp-outline-sharp" /></template>
<style>
.s1s6bjxit {
  fill: currentColor;
