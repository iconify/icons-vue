...
const content = `<path class="t_4ynhrtx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:lightbulb-checkmark-32-filled" /></template>
<style>
.t_4ynhrtx {
  fill: currentColor;
