...
const content = `<path class="q16h0ubth"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-android-5-outline-rounded" /></template>
<style>
.q16h0ubth {
  fill: currentColor;
