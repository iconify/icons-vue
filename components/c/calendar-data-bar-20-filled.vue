...
const content = `<path class="yobuseb5d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-data-bar-20-filled" /></template>
<style>
.yobuseb5d {
  fill: currentColor;
