...
const content = `<path class="s2yovib8j"/><path class="v47jd3r3d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:phantom-black-icon" /></template>
<style>
.s2yovib8j {
  fill: none;
  stroke: currentColor;
