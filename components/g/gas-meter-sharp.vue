...
const content = `<path class="si230ctna"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gas-meter-sharp" /></template>
<style>
.si230ctna {
  fill: currentColor;
