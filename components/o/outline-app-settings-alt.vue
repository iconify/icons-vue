...
const content = `<path class="ddy237b5l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-app-settings-alt" /></template>
<style>
.ddy237b5l {
  fill: currentColor;
