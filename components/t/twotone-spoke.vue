...
const content = `<path class="l29hxhbki"/><path class="qx8l1wbff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-spoke" /></template>
<style>
.l29hxhbki {
  fill: currentColor;
