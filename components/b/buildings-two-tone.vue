...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:buildings-two-tone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
...
.nwglgkb1l {
  ...
  d: path("M3.5 5L9 5L9 4C9 2.3431 10.3431 1 12 1L20 1C21.6569 1 23 2.3431 23 4L23 20C23 21.6569 21.6569 23 20 23L3.5 23C2.1193 23 1 21.8807 1 20.5L1 7.5C1 6.1193 2.1193 5 3.5 5Z");
  stroke: none;
}
