...
const content = `<path class="cjubnxbzw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:table-chart-view-rounded" /></template>
<style>
.cjubnxbzw {
  fill: currentColor;
