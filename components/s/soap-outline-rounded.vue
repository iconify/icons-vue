...
const content = `<path class="xiumzxloz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:soap-outline-rounded" /></template>
<style>
.xiumzxloz {
  fill: currentColor;
