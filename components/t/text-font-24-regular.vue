...
const content = `<path class="p0fq-idnd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-font-24-regular" /></template>
<style>
.p0fq-idnd {
  fill: currentColor;
