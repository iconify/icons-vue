...
const content = `<path class="x0w0vn3bt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fitbit-raquetball" /></template>
<style>
.x0w0vn3bt {
  fill: currentColor;
