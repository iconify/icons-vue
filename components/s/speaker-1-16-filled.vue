...
const content = `<path class="b_pdchbzc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-1-16-filled" /></template>
<style>
.b_pdchbzc {
  fill: currentColor;
