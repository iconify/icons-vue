...
const content = `<path class="h36dicbai"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shopping-bag-add-24-filled" /></template>
<style>
.h36dicbai {
  fill: currentColor;
