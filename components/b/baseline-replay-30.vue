...
const content = `<path class="fvdrsqr7t"/><path class="lxluhfbxa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-replay-30" /></template>
<style>
.fvdrsqr7t {
  fill: currentColor;
