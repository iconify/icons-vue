...
const content = `<path class="dkfswseve"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-electric-meter" /></template>
<style>
.dkfswseve {
  fill: currentColor;
