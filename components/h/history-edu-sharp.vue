...
const content = `<path class="gt8q-3bma"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:history-edu-sharp" /></template>
<style>
.gt8q-3bma {
  fill: currentColor;
