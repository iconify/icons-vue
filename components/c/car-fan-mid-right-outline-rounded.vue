...
const content = `<path class="w6eftk62c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-fan-mid-right-outline-rounded" /></template>
<style>
.w6eftk62c {
  fill: currentColor;
