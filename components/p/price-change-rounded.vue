...
const content = `<path class="dsqlcmblc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:price-change-rounded" /></template>
<style>
.dsqlcmblc {
  fill: currentColor;
