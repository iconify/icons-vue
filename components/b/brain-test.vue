...
const content = `<path class="ppls1-bys"/><ellipse class="jgbt-uk1w"/><circle class="bkve3gbna"/><path class="tcoxd2bji"/><path class="h2d4a2bes"/><path class="vnnnf6x6y"/><ellipse class="ckddmxg2z"/><ellipse class="hosr3rphg"/><path class="ic-chkcsz"/><ellipse class="v1r7gdbxu"/><path class="mp6iiyzuc"/><ellipse class="gtei5vb8f"/><path class="qdwkkgb_a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:brain-test" /></template>
<style>
.bkve3gbna {
  cx: 32.973px;
  cy: 10.292px;
...
.ic-chkcsz {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M41.735 25.043c1.674 2.416 1.488 4.832.56 7.247m-6.557 6.046c-.4 2.537-1.883 3.743-3.897 4.294m-6.136-1.377c.448 2.162 1.896 2.844 3.896 2.708M16.59 38.569c2.293-2.037 2.705 2.184 5.544-.443M10.301 40.95c.338 1.803 1.33 1.82 2.337 1.797");
}
...
.ppls1-bys {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M20.548 6.032c-2.846-4.379 6.516-2.835.303 2.755c1.728.177 2.702 1.624 1.573 2.097c-1.866.782-1.026 2.965-.29 2.757");
}
...
.qdwkkgb_a {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M28.738 39.853v2.474m7.35-20.751c.046 2.344.248 4.781-3.383 4.9m5.798-4.9h1.906m.467-3.71h1.484m-15.975 2.721l2.668.099");
}
