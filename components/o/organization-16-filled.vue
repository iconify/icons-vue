...
const content = `<path class="xdw64fbdx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:organization-16-filled" /></template>
<style>
.xdw64fbdx {
  fill: currentColor;
