...
const content = `<path class="fzf8hubgn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kore" /></template>
<style>
.fzf8hubgn {
  fill: none;
  stroke: currentColor;
