...
const content = `<path class="nxrhrmb0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:android-cell-dual-5-bar-plus-outline-sharp" /></template>
<style>
.nxrhrmb0l {
  fill: currentColor;
