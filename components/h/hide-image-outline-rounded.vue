...
const content = `<path class="hc3js-cug"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:hide-image-outline-rounded" /></template>
<style>
.hc3js-cug {
  fill: currentColor;
