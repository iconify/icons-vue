...
const content = `<path class="b3hs_t7rs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-template-24-filled" /></template>
<style>
.b3hs_t7rs {
  fill: currentColor;
