...
const content = `<path class="yg_ehhk6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:airly" /></template>
<style>
.yg_ehhk6a {
  fill: none;
  stroke: currentColor;
