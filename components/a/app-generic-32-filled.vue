...
const content = `<path class="an91s8bdk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:app-generic-32-filled" /></template>
<style>
.an91s8bdk {
  fill: currentColor;
