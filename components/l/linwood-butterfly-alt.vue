...
const content = `<path class="nqnwq1rgr"/><path class="j3_x6r5xa"/><circle class="jyczl8bji"/><path class="jm5-v-sfk"/><path class="bjcf95bza"/><circle class="jg-fcvo0q"/><circle class="dk2uog6xi"/><circle class="wcredvb9p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:linwood-butterfly-alt" /></template>
<style>
.bjcf95bza {
  fill: none;
  stroke: currentColor;
