...
const content = `<g class="cuyn6tgcc"><path class="z7cgj468k"/><path class="mt8t5sguh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:hand-withdraw-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
