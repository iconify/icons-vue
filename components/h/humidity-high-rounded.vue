...
const content = `<path class="o8umcgblu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:humidity-high-rounded" /></template>
<style>
.o8umcgblu {
  fill: currentColor;
