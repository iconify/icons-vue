...
const content = `<path class="qv1xedcam"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-fat-line-right-bold" /></template>
<style>
.qv1xedcam {
  fill: currentColor;
