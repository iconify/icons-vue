...
const content = `<path class="hepfycbki"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ink-selection-outline" /></template>
<style>
.hepfycbki {
  fill: currentColor;
