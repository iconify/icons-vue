...
const content = `<path class="nqfq1cciq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:deceased-rounded" /></template>
<style>
.nqfq1cciq {
  fill: currentColor;
