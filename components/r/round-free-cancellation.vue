...
const content = `<path class="pttcpubmx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-free-cancellation" /></template>
<style>
.pttcpubmx {
  fill: currentColor;
