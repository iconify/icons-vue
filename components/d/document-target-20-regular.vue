...
const content = `<path class="tlsi7bdmr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-target-20-regular" /></template>
<style>
.tlsi7bdmr {
  fill: currentColor;
