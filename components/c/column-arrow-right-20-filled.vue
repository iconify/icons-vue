...
const content = `<path class="owsmx2b4d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:column-arrow-right-20-filled" /></template>
<style>
.owsmx2b4d {
  fill: currentColor;
