...
const content = `<path class="c4-tbwbwz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-tab-rtl-outline-rounded" /></template>
<style>
.c4-tbwbwz {
  fill: currentColor;
