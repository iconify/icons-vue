...
const content = `<path class="z-zdtkbtn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-charging-30-outline" /></template>
<style>
.z-zdtkbtn {
  fill: currentColor;
