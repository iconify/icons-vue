...
const content = `<path class="tpkr-20yd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:brightness-low-28-regular" /></template>
<style>
.tpkr-20yd {
  fill: currentColor;
