...
const content = `<path class="glp_o3nys"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:home-add-20-regular" /></template>
<style>
.glp_o3nys {
  fill: currentColor;
