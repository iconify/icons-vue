...
const content = `<path class="vgwk6rb3c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:child-friendly-outline-rounded" /></template>
<style>
.vgwk6rb3c {
  fill: currentColor;
