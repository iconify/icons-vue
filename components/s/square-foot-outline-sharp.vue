...
const content = `<path class="lyicr-b7n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:square-foot-outline-sharp" /></template>
<style>
.lyicr-b7n {
  fill: currentColor;
