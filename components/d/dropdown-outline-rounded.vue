...
const content = `<path class="awcv8kbvs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dropdown-outline-rounded" /></template>
<style>
.awcv8kbvs {
  fill: currentColor;
