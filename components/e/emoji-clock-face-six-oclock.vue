...
const content = `<path class="wqb4kabpy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-clock-face-six-oclock" /></template>
<style>
.wqb4kabpy {
  fill: none;
  stroke: currentColor;
