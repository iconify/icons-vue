...
const content = `<path class="a8ir1dbdl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:short-stay-outline-sharp" /></template>
<style>
.a8ir1dbdl {
  fill: currentColor;
