...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:wifi-low-duotone" /></template>
<style>
.chh9m8bfh {
  fill: currentColor;
...
.xp-ewlxlm {
  stroke-linejoin: miter;
  stroke-opacity: 0.4;
  d: path("M4 9.0557C6.2001 7.0879 9.0483 6 12 6C14.9517 6 17.7999 7.0879 20 9.0557M6.6667 12.0372C8.1334 10.7253 10.0322 10 12 10C13.9678 10 15.8666 10.7253 17.3333 12.0372");
}
