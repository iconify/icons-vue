...
const content = `<path class="ebtf6abgb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-pulse-24-regular" /></template>
<style>
.ebtf6abgb {
  fill: currentColor;
