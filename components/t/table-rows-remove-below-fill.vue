...
const content = `<g class="nrj6p8qat"><path class="a0ltxiykj"/><path class="ehs9izfha"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:table-rows-remove-below-fill" /></template>
<style>
.a0ltxiykj {
  fill: currentColor;
