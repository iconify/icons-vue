...
const content = `<path class="ndwmkq6-a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:magnify-fullscreen-rounded" /></template>
<style>
.ndwmkq6-a {
  fill: currentColor;
