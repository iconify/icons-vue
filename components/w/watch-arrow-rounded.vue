...
const content = `<path class="cr33rrs1s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:watch-arrow-rounded" /></template>
<style>
.cr33rrs1s {
  fill: currentColor;
