...
const content = `<path class="utgzim67o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:watch-vibration-sharp" /></template>
<style>
.utgzim67o {
  fill: currentColor;
