...
const content = `<path class="ms7si6bbf"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sas" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
