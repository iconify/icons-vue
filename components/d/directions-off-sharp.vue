...
const content = `<path class="e3jy9snwq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:directions-off-sharp" /></template>
<style>
.e3jy9snwq {
  fill: currentColor;
