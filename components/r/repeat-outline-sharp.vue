...
const content = `<path class="fs4vsd2ee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:repeat-outline-sharp" /></template>
<style>
.fs4vsd2ee {
  fill: currentColor;
