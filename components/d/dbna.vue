...
const content = `<path class="nzv1atbhj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dbna" /></template>
<style>
.nzv1atbhj {
  fill: none;
  stroke: currentColor;
