...
const content = `<path class="xamtpyttg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:database-off-outline-rounded" /></template>
<style>
.xamtpyttg {
  fill: currentColor;
