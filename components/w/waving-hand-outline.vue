...
const content = `<path class="nqq_rzbkw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:waving-hand-outline" /></template>
<style>
.nqq_rzbkw {
  fill: currentColor;
