...
const content = `<g class="cuyn6tgcc"><path class="bscjjlbph"/><path class="t8_tuhbrs"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:cassette-tape-duotone" /></template>
<style>
.bscjjlbph {
  d: path("m168 168l24 32H64l24-32Zm8-80a24 24 0 1 0 24 24a24 24 0 0 0-24-24m-72 24a24 24 0 1 0-24 24a24 24 0 0 0 24-24");
