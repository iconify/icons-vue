...
const content = `<path class="ik1mmvb6k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:horizontal-distribute-rounded" /></template>
<style>
.ik1mmvb6k {
  fill: currentColor;
