...
const content = `<path class="bcnj59jkh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:task-list-ltr-24-regular" /></template>
<style>
.bcnj59jkh {
  fill: currentColor;
