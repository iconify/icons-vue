...
const content = `<path class="i9clfwm2k"/><path class="zd37hqgrv"/><path class="cz83y801d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:all-gen" /></template>
<style>
.cz83y801d {
  fill: none;
  stroke: currentColor;
