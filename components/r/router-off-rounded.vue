...
const content = `<path class="i_2py5b4a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:router-off-rounded" /></template>
<style>
.i_2py5b4a {
  fill: currentColor;
