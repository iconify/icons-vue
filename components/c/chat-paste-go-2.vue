...
const content = `<path class="m02rz2b6o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chat-paste-go-2" /></template>
<style>
.m02rz2b6o {
  fill: currentColor;
