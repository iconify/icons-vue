...
const content = `<path class="oebdvn49d"/><path class="lb3xmmhzy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-agriculture" /></template>
<style>
.lb3xmmhzy {
  fill: currentColor;
