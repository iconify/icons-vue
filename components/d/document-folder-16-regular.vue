...
const content = `<path class="nkol7rbzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-folder-16-regular" /></template>
<style>
.nkol7rbzh {
  fill: currentColor;
