...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-missed-duotone" /></template>
<style>
.a6s4ubbfu {
  d: path("M22 2L16 8M16 2L22 8");
}
