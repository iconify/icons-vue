...
const content = `<path class="utv8dplyr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bus-map-pin-rounded" /></template>
<style>
.utv8dplyr {
  fill: currentColor;
