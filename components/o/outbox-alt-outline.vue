...
const content = `<path class="zaulewb-l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:outbox-alt-outline" /></template>
<style>
.zaulewb-l {
  fill: currentColor;
