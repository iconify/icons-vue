...
const content = `<path class="xzpdrcbco"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-page-top-left-24-regular" /></template>
<style>
.xzpdrcbco {
  fill: currentColor;
