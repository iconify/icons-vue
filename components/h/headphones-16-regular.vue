...
const content = `<path class="o9h8m6b1i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:headphones-16-regular" /></template>
<style>
.o9h8m6b1i {
  fill: currentColor;
