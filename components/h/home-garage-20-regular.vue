...
const content = `<path class="q84jcqbjq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:home-garage-20-regular" /></template>
<style>
.q84jcqbjq {
  fill: currentColor;
