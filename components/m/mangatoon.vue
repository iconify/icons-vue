...
const content = `<path class="ll0g54h-q"/><path class="uxh-zlw2w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mangatoon" /></template>
<style>
.ll0g54h-q {
  fill: none;
  stroke: currentColor;
