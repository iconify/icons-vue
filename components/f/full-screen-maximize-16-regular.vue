...
const content = `<path class="zo7g7xbum"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:full-screen-maximize-16-regular" /></template>
<style>
.zo7g7xbum {
  fill: currentColor;
