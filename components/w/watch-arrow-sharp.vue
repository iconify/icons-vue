...
const content = `<path class="awb7wsbcd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:watch-arrow-sharp" /></template>
<style>
.awb7wsbcd {
  fill: currentColor;
