...
const content = `<path class="h6dcc4bjo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:irccloud" /></template>
<style>
.h6dcc4bjo {
  fill: none;
  stroke: currentColor;
