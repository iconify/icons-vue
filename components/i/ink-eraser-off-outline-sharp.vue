...
const content = `<path class="qih21db5p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ink-eraser-off-outline-sharp" /></template>
<style>
.qih21db5p {
  fill: currentColor;
