...
const content = `<path class="kd3vbq_1b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:play-disabled-rounded" /></template>
<style>
.kd3vbq_1b {
  fill: currentColor;
