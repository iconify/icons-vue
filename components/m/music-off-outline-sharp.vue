...
const content = `<path class="bin8qkbyn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:music-off-outline-sharp" /></template>
<style>
.bin8qkbyn {
  fill: currentColor;
