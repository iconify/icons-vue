...
const content = `<path class="j2ltg6v_y"/><path class="cexb17ojl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-mode-edit" /></template>
<style>
.cexb17ojl {
  fill: currentColor;
