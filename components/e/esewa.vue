...
const content = `<circle class="cpk0fnbgt"/><path class="sx9_vtxnl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:esewa" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
