...
const content = `<path class="er1g2abmx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:perm-device-information-rounded" /></template>
<style>
.er1g2abmx {
  fill: currentColor;
