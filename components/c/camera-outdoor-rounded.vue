...
const content = `<path class="o2h3c1bms"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:camera-outdoor-rounded" /></template>
<style>
.o2h3c1bms {
  fill: currentColor;
