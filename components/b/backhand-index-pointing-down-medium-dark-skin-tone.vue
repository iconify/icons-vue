...
const content = `<path class="kees47b0v"/><defs><path id="SVGzH5l9cSF" class="wyyhjwgri"/></defs><clipPath id="SVG5JRthd0N"><use href="#SVGzH5l9cSF"/></clipPath><g clip-path="url(#SVG5JRthd0N)" class="k4qe_xbxk"><path class="lzfbvjbvw"/></g><defs><use href="#SVGzH5l9cSF" id="SVG3kQ6REdG"/></defs><clipPath id="SVGUA7duk8g"><use href="#SVG3kQ6REdG"/></clipPath><g clip-path="url(#SVGUA7duk8g)" class="u0e24bcck"><path class="m8qqmn07k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:backhand-index-pointing-down-medium-dark-skin-tone" /></template>
<style>
.k4qe_xbxk {
