...
const content = `<path class="l__usdb6m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-add-28-regular" /></template>
<style>
.l__usdb6m {
  fill: currentColor;
