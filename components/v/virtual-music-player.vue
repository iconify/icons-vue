...
const content = `<path class="b7na7rtic"/><circle class="ui1zimbxa"/><path class="houiembva"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:virtual-music-player" /></template>
<style>
.b7na7rtic {
  fill: none;
  stroke: currentColor;
...
.houiembva {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M21.581 19.517a.88.88 0 0 0-.439.762v7.38a.878.878 0 0 0 1.317.763l3.192-1.846l3.19-1.845a.88.88 0 0 0 0-1.523l-3.19-1.846l-3.192-1.845a.88.88 0 0 0-.878 0");
}
