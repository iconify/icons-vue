...
const content = `<path class="i8nzcjenu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:move-selection-right-rounded" /></template>
<style>
.i8nzcjenu {
  fill: currentColor;
