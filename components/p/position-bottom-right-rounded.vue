...
const content = `<path class="otoekdx_x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:position-bottom-right-rounded" /></template>
<style>
.otoekdx_x {
  fill: currentColor;
