...
const content = `<path class="ev2elqpub"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:house-with-shield-rounded" /></template>
<style>
.ev2elqpub {
  fill: currentColor;
