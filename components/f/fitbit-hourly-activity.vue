...
const content = `<path class="i9ou06b1c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fitbit-hourly-activity" /></template>
<style>
.i9ou06b1c {
  fill: currentColor;
