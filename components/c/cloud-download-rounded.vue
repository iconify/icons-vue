...
const content = `<path class="gya2njumb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloud-download-rounded" /></template>
<style>
.gya2njumb {
  fill: currentColor;
