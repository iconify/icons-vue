...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGSvLHPb3W)" clip-rule="evenodd" class="ujcerfb6c"/><defs><linearGradient id="SVGSvLHPb3W" x1="4.8" x2="18.364" y1="12" y2="12" gradientUnits="userSpaceOnUse"><stop offset=".27" class="bbb5m31wc"/><stop offset="1" class="nwlphxbuq"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:saitama" /></template>
<style>
.bbb5m31wc {
