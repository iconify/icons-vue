...
const content = `<rect class="j3s9ivbxi"/><path class="u9y1g_tvo"/><path class="ymfp-0bla"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:icon-pusher" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
...
.ymfp-0bla {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M30.46 27.895a11.1 11.1 0 0 0 2.07-3.071c1.364-2.882 1.83-3.296 1.778-5.297a24.1 24.1 0 0 0 7.207-4.159c.115-.908.448-4.451.448-4.451m-9.294 5.763c-.265-.99 1.148-2.916 3.094-2.646c.837.03 1.49.732 1.46 1.569v.021");
}
