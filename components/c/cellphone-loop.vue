...
const content = `<g class="cuyn6tgcc"><g class="xyjtgccot"><path class="uep8a6bjl"/><path clip-rule="evenodd" class="whuonmbsk"/><path class="qzng0hhev"/><path clip-rule="evenodd" class="uacajdbbc"/></g><path class="raphvibhn"/><path clip-rule="evenodd" class="cjxzckb3x"/><path clip-rule="evenodd" class="i4ctr12sy"/><path clip-rule="evenodd" class="m8tiflbie"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-print:cellphone-loop" /></template>
