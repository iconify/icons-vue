...
const content = `<path class="v4ud3lerz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:supervised-user-circle-off-outline-rounded" /></template>
<style>
.v4ud3lerz {
  fill: currentColor;
