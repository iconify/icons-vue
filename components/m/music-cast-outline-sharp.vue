...
const content = `<path class="a9ebj6ict"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:music-cast-outline-sharp" /></template>
<style>
.a9ebj6ict {
  fill: currentColor;
