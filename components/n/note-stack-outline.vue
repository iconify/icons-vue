...
const content = `<path class="wd1_1534b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:note-stack-outline" /></template>
<style>
.wd1_1534b {
  fill: currentColor;
