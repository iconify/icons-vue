...
const content = `<path class="v3vlvvbfr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-whisker-24-filled" /></template>
<style>
.v3vlvvbfr {
  fill: currentColor;
