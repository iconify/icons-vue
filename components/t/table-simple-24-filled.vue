...
const content = `<path class="xo33tgofm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-simple-24-filled" /></template>
<style>
.xo33tgofm {
  fill: currentColor;
