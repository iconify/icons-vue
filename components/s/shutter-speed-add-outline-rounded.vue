...
const content = `<path class="jtfa2sbfb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shutter-speed-add-outline-rounded" /></template>
<style>
.jtfa2sbfb {
  fill: currentColor;
