...
const content = `<path class="dxuvbwbow"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tortoise" /></template>
<style>
.dxuvbwbow {
  fill: none;
  stroke: currentColor;
