...
const content = `<path class="dmgk-cckb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:screenshot-16-filled" /></template>
<style>
.dmgk-cckb {
  fill: currentColor;
