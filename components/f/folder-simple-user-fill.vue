...
const content = `<path class="p69vqwb7j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-simple-user-fill" /></template>
<style>
.p69vqwb7j {
  fill: currentColor;
