...
const content = `<path class="xop6dps8c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-toolbox-24-regular" /></template>
<style>
.xop6dps8c {
  fill: currentColor;
