...
const content = `<path class="ath7uj9em"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:grid-4x4-outline-rounded" /></template>
<style>
.ath7uj9em {
  fill: currentColor;
