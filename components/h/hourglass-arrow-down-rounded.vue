...
const content = `<path class="qmbmrk54f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hourglass-arrow-down-rounded" /></template>
<style>
.qmbmrk54f {
  fill: currentColor;
