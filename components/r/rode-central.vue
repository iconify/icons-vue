...
const content = `<path class="awib3zyaa"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:rode-central" /></template>
<style>
.awib3zyaa {
  fill: none;
  stroke: currentColor;
