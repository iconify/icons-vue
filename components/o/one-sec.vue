...
const content = `<path class="ara_nkdys"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:one-sec" /></template>
<style>
.ara_nkdys {
  fill: none;
  stroke: currentColor;
