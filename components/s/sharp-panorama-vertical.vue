...
const content = `<path class="wdg3itb3u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-panorama-vertical" /></template>
<style>
.wdg3itb3u {
  fill: currentColor;
