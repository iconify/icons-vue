...
const content = `<path class="s2gvl-bzv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:raw-on-outline-sharp" /></template>
<style>
.s2gvl-bzv {
  fill: currentColor;
