...
const content = `<path class="em8yqbrsm"/><path class="afhptwb_j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:al-chan" /></template>
<style>
.afhptwb_j {
  fill: none;
  stroke: currentColor;
