...
const content = `<g class="cuyn6tgcc"><path class="syr-lebaa"/><path class="rz4e5yrey"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:pants-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
