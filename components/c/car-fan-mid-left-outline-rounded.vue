...
const content = `<path class="yqgao3bcl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-fan-mid-left-outline-rounded" /></template>
<style>
.yqgao3bcl {
  fill: currentColor;
