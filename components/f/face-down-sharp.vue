...
const content = `<path class="owtd4kbmm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-down-sharp" /></template>
<style>
.owtd4kbmm {
  fill: currentColor;
