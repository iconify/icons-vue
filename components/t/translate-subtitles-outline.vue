...
const content = `<path class="f5vpwxbnh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:translate-subtitles-outline" /></template>
<style>
.f5vpwxbnh {
  fill: currentColor;
