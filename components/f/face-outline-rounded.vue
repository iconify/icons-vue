...
const content = `<path class="lrvswbbry"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-outline-rounded" /></template>
<style>
.lrvswbbry {
  fill: currentColor;
