...
const content = `<path class="n3za96b2w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:earbud-case-rounded" /></template>
<style>
.n3za96b2w {
  fill: currentColor;
