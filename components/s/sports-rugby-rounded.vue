...
const content = `<path class="oz63tnbro"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sports-rugby-rounded" /></template>
<style>
.oz63tnbro {
  fill: currentColor;
