...
const content = `<path class="jjqiuy1qu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pill-off-sharp" /></template>
<style>
.jjqiuy1qu {
  fill: currentColor;
