...
const content = `<path class="miisll_2r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:south-west-outline-rounded" /></template>
<style>
.miisll_2r {
  fill: currentColor;
