...
const content = `<path class="ymc6esb8u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:learn-css" /></template>
<style>
.ymc6esb8u {
  fill: none;
  stroke: currentColor;
