...
const content = `<path class="epjs4hbxq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-add-above-20-regular" /></template>
<style>
.epjs4hbxq {
  fill: currentColor;
