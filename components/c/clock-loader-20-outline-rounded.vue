...
const content = `<path class="w-ffzyhaw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:clock-loader-20-outline-rounded" /></template>
<style>
.w-ffzyhaw {
  fill: currentColor;
