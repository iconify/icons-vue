...
const content = `<path class="bj4jxc-fj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:expansion-panels-outline" /></template>
<style>
.bj4jxc-fj {
  fill: currentColor;
