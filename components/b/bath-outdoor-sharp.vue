...
const content = `<path class="jy190fbzl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bath-outdoor-sharp" /></template>
<style>
.jy190fbzl {
  fill: currentColor;
