...
const content = `<path class="fdxbtgbho"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-data-bar-28-regular" /></template>
<style>
.fdxbtgbho {
  fill: currentColor;
