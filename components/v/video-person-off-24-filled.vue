...
const content = `<path class="bqwffl0lk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-person-off-24-filled" /></template>
<style>
.bqwffl0lk {
  fill: currentColor;
