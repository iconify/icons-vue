...
const content = `<path class="sn7v4cyjj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-atm-outline" /></template>
<style>
.sn7v4cyjj {
  fill: currentColor;
