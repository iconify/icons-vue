...
const content = `<path class="kp5l2bcpg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:kitesurfing" /></template>
<style>
.kp5l2bcpg {
  fill: currentColor;
