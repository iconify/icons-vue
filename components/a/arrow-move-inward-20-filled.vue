...
const content = `<path class="ykis_ubjy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-move-inward-20-filled" /></template>
<style>
.ykis_ubjy {
  fill: currentColor;
