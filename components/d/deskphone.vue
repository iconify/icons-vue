...
const content = `<path class="etjz19b4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:deskphone" /></template>
<style>
.etjz19b4n {
  fill: currentColor;
