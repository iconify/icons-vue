...
const content = `<path class="yf99iubga"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-bullet-list-square-20-regular" /></template>
<style>
.yf99iubga {
  fill: currentColor;
