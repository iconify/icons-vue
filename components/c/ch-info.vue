...
const content = `<path class="ud-xwdbvl"/><path class="l01gwwb7a"/><path class="uj8ax2bpa"/><path class="d-bq0jbpo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ch-info" /></template>
<style>
.d-bq0jbpo {
  fill: none;
  stroke: currentColor;
...
.uj8ax2bpa {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M6.722 30.218v-3.18a10.91 10.91 0 1 1 21.822 0v3.18");
}
