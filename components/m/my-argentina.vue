...
const content = `<path class="f0v0wzbdr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:my-argentina" /></template>
<style>
.f0v0wzbdr {
  fill: none;
  stroke: currentColor;
