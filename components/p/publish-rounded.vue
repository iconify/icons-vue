...
const content = `<path class="kfi4yfbhv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:publish-rounded" /></template>
<style>
.kfi4yfbhv {
  fill: currentColor;
