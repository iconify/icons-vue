...
const content = `<path class="fohd6dqnc"/><path class="gq4nsy2sh"/><path class="t_rlincix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-mali" /></template>
<style>
.fohd6dqnc {
