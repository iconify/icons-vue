...
const content = `<path class="vjocmaczq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:audio-file-sharp" /></template>
<style>
.vjocmaczq {
  fill: currentColor;
