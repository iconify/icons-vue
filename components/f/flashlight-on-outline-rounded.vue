...
const content = `<path class="y096bnb-d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:flashlight-on-outline-rounded" /></template>
<style>
.y096bnb-d {
  fill: currentColor;
