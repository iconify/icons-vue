...
const content = `<path class="qb34vrror"/><g class="bgo4n_1_u"><path class="kl68i8bgp"/><path class="x57g7cbon"/></g><path class="e1avnhwsp"/><path class="r_gdf-bty"/><path class="jo21i8bra"/><path class="runr8790n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:handshake-medium-dark-skin-tone" /></template>
<style>
.bgo4n_1_u {
