...
const content = `<path class="zf_zpteko"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:select-window-off-sharp" /></template>
<style>
.zf_zpteko {
  fill: currentColor;
