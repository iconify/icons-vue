...
const content = `<path class="xk7dz5bsq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:head-mounted-device-sharp" /></template>
<style>
.xk7dz5bsq {
  fill: currentColor;
