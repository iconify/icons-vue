...
const content = `<path class="po73ndbmj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:military-tech-rounded" /></template>
<style>
.po73ndbmj {
  fill: currentColor;
