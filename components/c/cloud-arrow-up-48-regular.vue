...
const content = `<path class="t3vl4obsv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-arrow-up-48-regular" /></template>
<style>
.t3vl4obsv {
  fill: currentColor;
