...
const content = `<path class="denk-1bex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:align-flex-center-rounded" /></template>
<style>
.denk-1bex {
  fill: currentColor;
