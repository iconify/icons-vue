...
const content = `<g class="cuyn6tgcc"><path class="yvw54rb7g"/><path class="dsfjocb8w"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:handbag-simple-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
