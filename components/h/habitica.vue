...
const content = `<path class="s-cy888iz"/><path class="to56211ot"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:habitica" /></template>
<style>
.s-cy888iz {
  fill: none;
  stroke: currentColor;
...
.to56211ot {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M11.77 24.44v-3.67h-3.1v6.1h1.6v1.82h4.45v-4.25zM5.88 17.9h2.79v2.88H5.88z");
}
