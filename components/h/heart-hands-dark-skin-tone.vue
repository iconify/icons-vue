...
const content = `<path class="nykcrcbfh"/><path class="rzxq0bb2x"/><path class="aba-6gj6f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:heart-hands-dark-skin-tone" /></template>
<style>
.aba-6gj6f {
