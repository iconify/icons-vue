...
const content = `<path class="rt0zlqbnb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-bank-48-filled" /></template>
<style>
.rt0zlqbnb {
  fill: currentColor;
