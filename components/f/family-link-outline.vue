...
const content = `<path class="k53_33fxd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:family-link-outline" /></template>
<style>
.k53_33fxd {
  fill: currentColor;
