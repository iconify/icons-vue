...
const content = `<path class="wkw-wtwws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pinch-outline-sharp" /></template>
<style>
.wkw-wtwws {
  fill: currentColor;
