...
const content = `<path class="gl4u2dd9k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stat-minus-2-outline-rounded" /></template>
<style>
.gl4u2dd9k {
  fill: currentColor;
