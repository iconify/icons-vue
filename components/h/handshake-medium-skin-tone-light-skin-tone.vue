...
const content = `<path class="jcmp73b3n"/><path class="z-g7fgbvp"/><defs><path id="SVGU67dBeQS" class="l439n0bap"/></defs><clipPath id="SVG617RIbte"><use href="#SVGU67dBeQS"/></clipPath><g clip-path="url(#SVG617RIbte)" class="byeg-0b8a"><path class="o4yqbwbdl"/></g><defs><use href="#SVGU67dBeQS" id="SVGCPeKAdMZ"/></defs><clipPath id="SVG3ABvZdad"><use href="#SVGCPeKAdMZ"/></clipPath><g clip-path="url(#SVG3ABvZdad)" class="lip7wrrrl"><path class="oqad6y8ry"/></g><defs/><g clip-path="url(#SVG3ABvZdad)" class="qln5uhbpq"><path class="s2_2_ccsc"/></g><defs/><g clip-path="url(#SVG3ABvZdad)" class="oadpy4acg"><path class="trz1g0bjh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:handshake-medium-skin-tone-light-skin-tone" /></template>
<style>
.byeg-0b8a {
