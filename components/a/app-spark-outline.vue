...
const content = `<path class="ome1nq94e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:app-spark-outline" /></template>
<style>
.ome1nq94e {
  fill: currentColor;
