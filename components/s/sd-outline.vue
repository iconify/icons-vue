...
const content = `<path class="y97yocdva"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sd-outline" /></template>
<style>
.y97yocdva {
  fill: currentColor;
