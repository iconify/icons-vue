...
const content = `<path class="y_t2_pbfl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:label-outline-rounded" /></template>
<style>
.y_t2_pbfl {
  fill: currentColor;
