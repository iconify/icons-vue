...
const content = `<path class="uh6fw3bid"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-pharmacy-outline-sharp" /></template>
<style>
.uh6fw3bid {
  fill: currentColor;
