...
const content = `<path class="f-8probob"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-out-24-filled" /></template>
<style>
.f-8probob {
  fill: currentColor;
