...
const content = `<path class="f4kt0qb5d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-data-link-32-regular" /></template>
<style>
.f4kt0qb5d {
  fill: currentColor;
