...
const content = `<path class="spi_2q9pi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-description-20-regular" /></template>
<style>
.spi_2q9pi {
  fill: currentColor;
