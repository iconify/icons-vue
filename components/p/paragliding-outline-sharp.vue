...
const content = `<path class="bwy-gpl2h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:paragliding-outline-sharp" /></template>
<style>
.bwy-gpl2h {
  fill: currentColor;
