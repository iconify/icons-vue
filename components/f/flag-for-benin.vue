...
const content = `<path class="b35eibb4k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-benin" /></template>
<style>
.b35eibb4k {
  fill: currentColor;
