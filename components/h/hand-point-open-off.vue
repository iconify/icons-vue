...
const content = `<g class="cuyn6tgcc"><g clip-rule="evenodd" class="d2kvgvbvc"><path class="lmqu2ibxx"/><path class="dw5lc4b5t"/></g><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:hand-point-open-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
