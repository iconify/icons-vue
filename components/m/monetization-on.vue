...
const content = `<path class="zyy1wxc1b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:monetization-on" /></template>
<style>
.zyy1wxc1b {
  fill: currentColor;
