...
const content = `<circle class="dr17ttbrw"/><path class="ecm5qojka"/><path class="nsy7fui7c"/><path class="b_9skamnn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-reactts" /></template>
<style>
.b_9skamnn {
