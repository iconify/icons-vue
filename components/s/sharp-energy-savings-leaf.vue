...
const content = `<path class="x9m8y2bnt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-energy-savings-leaf" /></template>
<style>
.x9m8y2bnt {
  fill: currentColor;
