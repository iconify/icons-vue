...
const content = `<path class="c3r786v2s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:post-add-outline" /></template>
<style>
.c3r786v2s {
  fill: currentColor;
