...
const content = `<path class="o56kpvqjy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:crop-portrait-outline-rounded" /></template>
<style>
.o56kpvqjy {
  fill: currentColor;
