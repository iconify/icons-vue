...
const content = `<path class="fzj356b9q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:landscape-rounded" /></template>
<style>
.fzj356b9q {
  fill: currentColor;
