...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:search-plus-duotone" /></template>
<style>
.evs3c5b3r {
  d: path("M15 15L21 21M7 10L13 10M10 7L10 13");
}
