...
const content = `<path class="sm_zceqae"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-mlang" /></template>
<style>
.sm_zceqae {
