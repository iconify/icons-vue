...
const content = `<path class="q_bzsdovg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-square-24-regular" /></template>
<style>
.q_bzsdovg {
  fill: currentColor;
