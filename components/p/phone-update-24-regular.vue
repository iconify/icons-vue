...
const content = `<path class="ploybghsz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-update-24-regular" /></template>
<style>
.ploybghsz {
  fill: currentColor;
