...
const content = `<path class="hnedfkbfy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-2-20-regular" /></template>
<style>
.hnedfkbfy {
  fill: currentColor;
