...
const content = `<path class="i_7yvmb1u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:presentation-chart-fill" /></template>
<style>
.i_7yvmb1u {
  fill: currentColor;
