...
const content = `<path class="fvo_st2lt"/><path class="rrla16g1f"/><path class="ti19ytvcr"/><path class="r72pl9b-r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-sudan" /></template>
<style>
.fvo_st2lt {
