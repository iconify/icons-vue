...
const content = `<path class="ud3nxkb1h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:view-in-ar-rounded" /></template>
<style>
.ud3nxkb1h {
  fill: currentColor;
