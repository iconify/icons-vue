...
const content = `<g class="hntgybcog"><path class="jfvoq9bhn"/><path class="zdgvfxbbv"/><path class="slz7u0oyn"/><path class="uea_ybysx"/><path class="it83nbbll"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:slowly-changing-dimension-outline-thin" /></template>
<style>
.hntgybcog {
  fill: none;
  stroke: currentColor;
