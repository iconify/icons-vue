...
const content = `<g class="cuyn6tgcc"><path class="rwg-ubu-o"/><path class="s1gwimqnx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:user-list-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.rwg-ubu-o {
  d: path("M120 104a40 40 0 1 1-40-40a40 40 0 0 1 40 40");
