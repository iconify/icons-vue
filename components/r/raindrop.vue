...
const content = `<path class="r4iyyok8r"/><path class="w70ucby-w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:raindrop" /></template>
<style>
.r4iyyok8r {
  fill: none;
  stroke: currentColor;
