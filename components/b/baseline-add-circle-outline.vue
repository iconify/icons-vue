...
const content = `<path class="iuc688jhq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-add-circle-outline" /></template>
<style>
.iuc688jhq {
  fill: currentColor;
