...
const content = `<path class="akvnb9l1a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:photo-size-select-large-outline-sharp" /></template>
<style>
.akvnb9l1a {
  fill: currentColor;
