...
const content = `<path class="t-soxubpv"/><path class="xmdjycc9d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tabs" /></template>
<style>
.t-soxubpv {
  fill: none;
  stroke: currentColor;
