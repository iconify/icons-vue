...
const content = `<path class="swibd0b5f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:reading-mode-mobile-24-filled" /></template>
<style>
.swibd0b5f {
  fill: currentColor;
