...
const content = `<path class="e3invgv4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-format-color-fill" /></template>
<style>
.e3invgv4n {
  fill: currentColor;
