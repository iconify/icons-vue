...
const content = `<path class="g_b_jgb6v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stat-minus-1-outline-rounded" /></template>
<style>
.g_b_jgb6v {
  fill: currentColor;
