...
const content = `<path class="q-u6uhbtr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:receipt-add-24-regular" /></template>
<style>
.q-u6uhbtr {
  fill: currentColor;
