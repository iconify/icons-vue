...
const content = `<path class="rmk57xb6x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:person-pin-outline-rounded" /></template>
<style>
.rmk57xb6x {
  fill: currentColor;
