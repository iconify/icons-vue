...
const content = `<path class="v6e8ixz8h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flow-arrow-16-filled" /></template>
<style>
.v6e8ixz8h {
  fill: currentColor;
