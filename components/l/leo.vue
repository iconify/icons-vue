...
const content = `<circle class="p1k47lb3d"/><circle class="auhbzhbai"/><path class="cym_wgbqc"/><path class="ozvy87buq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:leo" /></template>
<style>
.auhbzhbai {
  cx: 60.1px;
  cy: 63.1px;
  r: 56.1px;
  fill: var(--svg-color--fce438, #fce438);
}
