...
const content = `<path class="z8vxp2bgf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:propane-outline-sharp" /></template>
<style>
.z8vxp2bgf {
  fill: currentColor;
