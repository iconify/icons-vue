...
const content = `<path class="bs1qy9bkn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-bar" /></template>
<style>
.bs1qy9bkn {
  fill: currentColor;
