...
const content = `<path class="m0zq4gbpu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:hourglass-half-24-filled" /></template>
<style>
.m0zq4gbpu {
  fill: currentColor;
