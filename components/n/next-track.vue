...
const content = `<g class="cuyn6tgcc"><path class="g8wwzeqiw"/><path clip-rule="evenodd" class="rfnbodb8g"/><path class="zd0cs_bkv"/><path clip-rule="evenodd" class="mf7jrn0_x"/><path clip-rule="evenodd" class="f6-he1bmn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:next-track" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
