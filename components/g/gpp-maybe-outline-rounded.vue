...
const content = `<path class="uyne4cb_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gpp-maybe-outline-rounded" /></template>
<style>
.uyne4cb_k {
  fill: currentColor;
