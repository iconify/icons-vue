...
const content = `<path class="vq6v4m2gb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tag-edit-32-regular" /></template>
<style>
.vq6v4m2gb {
  fill: currentColor;
