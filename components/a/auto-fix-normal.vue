...
const content = `<path class="pzk3_4btx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-fix-normal" /></template>
<style>
.pzk3_4btx {
  fill: currentColor;
