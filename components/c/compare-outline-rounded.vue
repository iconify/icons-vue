...
const content = `<path class="v9bopyboq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:compare-outline-rounded" /></template>
<style>
.v9bopyboq {
  fill: currentColor;
