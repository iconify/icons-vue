...
const content = `<path class="pbiborbup"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tilt-arrow-down" /></template>
<style>
.pbiborbup {
  fill: currentColor;
