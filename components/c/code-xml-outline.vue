...
const content = `<path class="ms8n33b4d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:code-xml-outline" /></template>
<style>
.ms8n33b4d {
  fill: currentColor;
