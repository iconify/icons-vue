...
const content = `<path class="v9v6pnb8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:crossword-outline-sharp" /></template>
<style>
.v9v6pnb8v {
  fill: currentColor;
