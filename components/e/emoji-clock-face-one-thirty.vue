...
const content = `<path class="ka0qr4btr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-clock-face-one-thirty" /></template>
<style>
.ka0qr4btr {
  fill: none;
  stroke: currentColor;
