...
const content = `<path class="rc20v79fk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-add-16-filled" /></template>
<style>
.rc20v79fk {
  fill: currentColor;
