...
const content = `<path class="u9-8y2dqt"/><path class="a4kvn0-sf"/><path class="ebzf-obaz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:svm" /></template>
<style>
.a4kvn0-sf {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M22.597 13.617c0-1.164.94-2.104 2.104-2.104h4.909v2.104l-2.104 2.804h-2.104a2.803 2.803 0 0 1-2.805-2.804m11.221 18.626h-1.6s-5.77 2.805-8.219 2.805h-.016c-2.454 0-8.203-2.805-8.203-2.805h-1.6l2.206 3.31c1.716 2.3 4.83 3.416 7.597 3.416h.016c2.768 0 5.61-1.115 7.614-3.415z");
}
