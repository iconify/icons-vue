...
const content = `<path class="fy6315adx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:delete-lines-20-filled" /></template>
<style>
.fy6315adx {
  fill: currentColor;
