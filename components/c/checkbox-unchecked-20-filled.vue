...
const content = `<path class="cmusc2b_n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:checkbox-unchecked-20-filled" /></template>
<style>
.cmusc2b_n {
  fill: currentColor;
