...
const content = `<path class="pk14uthrc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:thermometer-rounded" /></template>
<style>
.pk14uthrc {
  fill: currentColor;
