...
const content = `<path class="lpyewhw7b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-cloudy-20-filled" /></template>
<style>
.lpyewhw7b {
  fill: currentColor;
