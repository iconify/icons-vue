...
const content = `<path class="aqhxhdlag"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:thunderstorm-outline-sharp" /></template>
<style>
.aqhxhdlag {
  fill: currentColor;
