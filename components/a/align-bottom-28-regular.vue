...
const content = `<path class="rpk6htbvv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-bottom-28-regular" /></template>
<style>
.rpk6htbvv {
  fill: currentColor;
