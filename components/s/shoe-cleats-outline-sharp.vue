...
const content = `<path class="q8e49dbih"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shoe-cleats-outline-sharp" /></template>
<style>
.q8e49dbih {
  fill: currentColor;
