...
const content = `<path class="qjesi_b9c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bed" /></template>
<style>
.qjesi_b9c {
  fill: currentColor;
