...
const content = `<path class="beybjfbny"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pan-tool-outline" /></template>
<style>
.beybjfbny {
  fill: currentColor;
