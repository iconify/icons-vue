...
const content = `<path class="zvpkvcd2d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:document-scanner-outline-rounded" /></template>
<style>
.zvpkvcd2d {
  fill: currentColor;
