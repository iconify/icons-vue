...
const content = `<g class="ft5dv1b6b"><path fill="url(#tokenBrandedBets0)" class="xhz9kgesx"/><defs><linearGradient id="tokenBrandedBets0" x1="2" x2="21.956" y1="2.585" y2="2.82" gradientUnits="userSpaceOnUse"><stop class="gziqvqkib"/><stop offset=".49" class="n90b6fb5e"/><stop offset="1" class="ymsx09b0p"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:bets" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
