...
const content = `<path class="i73nctbow"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brightness-low-rounded" /></template>
<style>
.i73nctbow {
  fill: currentColor;
