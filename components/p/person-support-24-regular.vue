...
const content = `<path class="lqurkjb5j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-support-24-regular" /></template>
<style>
.lqurkjb5j {
  fill: currentColor;
