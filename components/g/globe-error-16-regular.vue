...
const content = `<path class="ic_4gu7kg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-error-16-regular" /></template>
<style>
.ic_4gu7kg {
  fill: currentColor;
