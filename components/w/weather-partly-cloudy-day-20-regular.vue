...
const content = `<path class="uyge1cipu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-partly-cloudy-day-20-regular" /></template>
<style>
.uyge1cipu {
  fill: currentColor;
