...
const content = `<path class="g632jqbdd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-video-28-regular" /></template>
<style>
.g632jqbdd {
  fill: currentColor;
