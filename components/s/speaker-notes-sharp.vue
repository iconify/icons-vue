...
const content = `<path class="hahluwbuo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speaker-notes-sharp" /></template>
<style>
.hahluwbuo {
  fill: currentColor;
