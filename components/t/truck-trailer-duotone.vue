...
const content = `<g class="cuyn6tgcc"><path class="ba1jbj9vm"/><path class="vul8f4brg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:truck-trailer-duotone" /></template>
<style>
.ba1jbj9vm {
  d: path("M16 72h104v112h-16a24 24 0 0 0-48 0a24 24 0 0 0-48 0V80a8 8 0 0 1 8-8m200 32v-8a48 48 0 0 0-48-48h-8a8 8 0 0 0-8 8v128h48a24 24 0 0 1 48 0v-48a32 32 0 0 0-32-32");
