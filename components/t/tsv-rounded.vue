...
const content = `<path class="m0-1yu4cw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tsv-rounded" /></template>
<style>
.m0-1yu4cw {
  fill: currentColor;
