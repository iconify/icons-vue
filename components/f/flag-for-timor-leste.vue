...
const content = `<path class="ify7fm_wv"/><path class="fj9slhqkf"/><path class="jp306acec"/><path class="r73d2ccdj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-timor-leste" /></template>
<style>
.fj9slhqkf {
