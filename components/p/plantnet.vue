...
const content = `<path class="cnefxszms"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:plantnet" /></template>
<style>
.cnefxszms {
  fill: none;
  stroke: currentColor;
