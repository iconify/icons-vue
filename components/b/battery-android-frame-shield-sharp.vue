...
const content = `<path class="qui6bkykg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-android-frame-shield-sharp" /></template>
<style>
.qui6bkykg {
  fill: currentColor;
