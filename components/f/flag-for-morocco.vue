...
const content = `<circle class="ov_j9rzim"/><path class="fxkdkw-cw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-morocco" /></template>
<style>
.fxkdkw-cw {
