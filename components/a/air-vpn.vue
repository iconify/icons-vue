...
const content = `<path class="y1v6mcbsk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:air-vpn" /></template>
<style>
.y1v6mcbsk {
  fill: none;
  stroke: currentColor;
