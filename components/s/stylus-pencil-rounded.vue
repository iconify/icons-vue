...
const content = `<path class="y8fgumbuh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stylus-pencil-rounded" /></template>
<style>
.y8fgumbuh {
  fill: currentColor;
