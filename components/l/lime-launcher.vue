...
const content = `<path class="gqck1l7pu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lime-launcher" /></template>
<style>
.gqck1l7pu {
  fill: none;
  stroke: currentColor;
