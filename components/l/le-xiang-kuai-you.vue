...
const content = `<g class="y9tr6bcfx"><path class="k579n-bqs"/><path class="nj780bc-x"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:le-xiang-kuai-you" /></template>
<style>
.k579n-bqs {
