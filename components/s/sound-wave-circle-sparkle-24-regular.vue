...
const content = `<path class="t110cl3af"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:sound-wave-circle-sparkle-24-regular" /></template>
<style>
.t110cl3af {
  fill: currentColor;
