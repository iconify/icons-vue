...
const content = `<path class="eu1g_2b6r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:skyview" /></template>
<style>
.eu1g_2b6r {
  fill: none;
  stroke: currentColor;
