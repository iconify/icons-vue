...
const content = `<path class="lw7ek60wf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:globe-hemisphere-east-light" /></template>
<style>
.lw7ek60wf {
  fill: currentColor;
