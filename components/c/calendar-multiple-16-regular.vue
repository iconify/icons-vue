...
const content = `<path class="zh02y_4vw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-multiple-16-regular" /></template>
<style>
.zh02y_4vw {
  fill: currentColor;
