...
const content = `<path class="f7jmmmb9q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cardboardmuseum" /></template>
<style>
.f7jmmmb9q {
  fill: none;
  stroke: currentColor;
