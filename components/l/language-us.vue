...
const content = `<path class="fdszfr6dz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:language-us" /></template>
<style>
.fdszfr6dz {
  fill: currentColor;
