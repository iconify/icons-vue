...
const content = `<path class="k00wxabsq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:book-2-outline-sharp" /></template>
<style>
.k00wxabsq {
  fill: currentColor;
