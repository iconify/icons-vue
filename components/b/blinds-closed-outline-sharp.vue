...
const content = `<path class="kwm8weyso"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:blinds-closed-outline-sharp" /></template>
<style>
.kwm8weyso {
  fill: currentColor;
