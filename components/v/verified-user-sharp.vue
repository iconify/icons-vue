...
const content = `<path class="t9xj4sbum"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:verified-user-sharp" /></template>
<style>
.t9xj4sbum {
  fill: currentColor;
