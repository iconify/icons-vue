...
const content = `<path class="eq6u-nbmy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vpn-key-alert-sharp" /></template>
<style>
.eq6u-nbmy {
  fill: currentColor;
