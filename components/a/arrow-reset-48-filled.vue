...
const content = `<path class="irzc-bhfd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-reset-48-filled" /></template>
<style>
.irzc-bhfd {
  fill: currentColor;
