...
const content = `<path class="kyfnv44rx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-word-28-regular" /></template>
<style>
.kyfnv44rx {
  fill: currentColor;
