...
const content = `<path class="zrliizose"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:85" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
