...
const content = `<path class="qh4vztb-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tag-error-24-filled" /></template>
<style>
.qh4vztb-g {
  fill: currentColor;
