...
const content = `<path class="sg38b9p9r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:colors-outline" /></template>
<style>
.sg38b9p9r {
  fill: currentColor;
