...
const content = `<path class="b7oz6gbdg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:markdown-document" /></template>
<style>
.b7oz6gbdg {
  fill: currentColor;
