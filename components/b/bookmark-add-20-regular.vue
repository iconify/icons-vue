...
const content = `<path class="q6ihugb5q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bookmark-add-20-regular" /></template>
<style>
.q6ihugb5q {
  fill: currentColor;
