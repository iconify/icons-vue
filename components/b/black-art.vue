...
const content = `<path class="f9ap63b3f"/><path class="ixbmtmbsv"/><path class="bizmd-b3d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:black-art" /></template>
<style>
.bizmd-b3d {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M36.105 13.349c1.218 0 2.204 2.154 2.204 4.808s-.986 4.809-2.204 4.809s-2.204-2.154-2.204-4.809s.985-4.808 2.204-4.808m-11.137-.584c.384 0 .702.742.702 1.652s-.318 1.653-.702 1.653c-.392 0-.71-.743-.71-1.653s.318-1.653.71-1.653");
}
...
.ixbmtmbsv {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M32.072 8.081L43 9.125l-3.64 31.747l-7.287-.517M24.259 22.14c1.152 0 2.087 1.393 2.087 3.121c0 1.72-.935 3.122-2.087 3.122s-2.079-1.402-2.079-3.122c0-1.728.927-3.122 2.079-3.122");
}
