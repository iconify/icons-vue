...
const content = `<path class="m5dgmi01x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:math-symbols-28-regular" /></template>
<style>
.m5dgmi01x {
  fill: currentColor;
