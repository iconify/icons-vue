...
const content = `<g class="cuyn6tgcc"><path class="no0njmbpm"/><path class="vh0qtbbar"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:currency-dollar-simple-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
