...
const content = `<path class="amm_y0b8k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-fit-24-regular" /></template>
<style>
.amm_y0b8k {
  fill: currentColor;
