...
const content = `<path class="tyrfpxbta"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:circle-subtract-arrow-back-20-filled" /></template>
<style>
.tyrfpxbta {
  fill: currentColor;
