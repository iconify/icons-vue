...
const content = `<path class="xdkz3hbaj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gif-2-outline-rounded" /></template>
<style>
.xdkz3hbaj {
  fill: currentColor;
