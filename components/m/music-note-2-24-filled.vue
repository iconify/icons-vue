...
const content = `<path class="axi7gs86e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:music-note-2-24-filled" /></template>
<style>
.axi7gs86e {
  fill: currentColor;
