...
const content = `<path class="dsiwxdblh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:counter-3-outline-rounded" /></template>
<style>
.dsiwxdblh {
  fill: currentColor;
