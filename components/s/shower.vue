...
const content = `<path class="y-uuo95uv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shower" /></template>
<style>
.y-uuo95uv {
  fill: currentColor;
