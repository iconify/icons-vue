...
const content = `<path class="frqc-969k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:border-right-outline-sharp" /></template>
<style>
.frqc-969k {
  fill: currentColor;
