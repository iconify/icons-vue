...
const content = `<path class="y1jzuab2d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-goal-net" /></template>
<style>
.y1jzuab2d {
  fill: none;
  stroke: currentColor;
