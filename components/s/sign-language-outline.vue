...
const content = `<path class="ilsdtrb4x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sign-language-outline" /></template>
<style>
.ilsdtrb4x {
  fill: currentColor;
