...
const content = `<path class="o9p89mblc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:right-panel-open-outline" /></template>
<style>
.o9p89mblc {
  fill: currentColor;
