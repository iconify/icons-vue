...
const content = `<path class="ooicogbye"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:transparency-square-20-filled" /></template>
<style>
.ooicogbye {
  fill: currentColor;
