...
const content = `<g class="cuyn6tgcc"><path class="yxivojrzp"/><path class="d5d-kfagm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:eject-simple-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
