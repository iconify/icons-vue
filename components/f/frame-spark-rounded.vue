...
const content = `<path class="jl34icbbh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:frame-spark-rounded" /></template>
<style>
.jl34icbbh {
  fill: currentColor;
