...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="y3gjmeqpc"/><path class="tvegkiq6y"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:sun-circle" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
