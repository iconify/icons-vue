...
const content = `<path class="yw9v5wbuw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-real-estate-agent" /></template>
<style>
.yw9v5wbuw {
  fill: currentColor;
