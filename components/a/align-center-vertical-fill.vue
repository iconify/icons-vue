...
const content = `<path class="r-h-2jx-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:align-center-vertical-fill" /></template>
<style>
.r-h-2jx-j {
  fill: currentColor;
