...
const content = `<path class="wrote7ifi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:detection-and-zone-off-outline-sharp" /></template>
<style>
.wrote7ifi {
  fill: currentColor;
