...
const content = `<path class="r9_gqybla"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:stack-off-20-filled" /></template>
<style>
.r9_gqybla {
  fill: currentColor;
