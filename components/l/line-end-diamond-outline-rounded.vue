...
const content = `<path class="pudabdk3b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:line-end-diamond-outline-rounded" /></template>
<style>
.pudabdk3b {
  fill: currentColor;
