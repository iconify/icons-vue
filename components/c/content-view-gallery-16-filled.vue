...
const content = `<path class="bbsgp8yyv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:content-view-gallery-16-filled" /></template>
<style>
.bbsgp8yyv {
  fill: currentColor;
