...
const content = `<path class="gzsyl4bgj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screenshot-frame-2" /></template>
<style>
.gzsyl4bgj {
  fill: currentColor;
