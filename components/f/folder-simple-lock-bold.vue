...
const content = `<path class="u6kw5nzww"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-simple-lock-bold" /></template>
<style>
.u6kw5nzww {
  fill: currentColor;
