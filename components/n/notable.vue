...
const content = `<path class="la12kcc0t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:notable" /></template>
<style>
.la12kcc0t {
  fill: none;
  stroke: currentColor;
