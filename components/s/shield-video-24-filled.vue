...
const content = `<path class="j04ozob3c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-video-24-filled" /></template>
<style>
.j04ozob3c {
  fill: currentColor;
