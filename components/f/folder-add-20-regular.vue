...
const content = `<path class="q1f6pkbol"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-add-20-regular" /></template>
<style>
.q1f6pkbol {
  fill: currentColor;
