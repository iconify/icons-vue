...
const content = `<path class="ycc_5g2ij"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:notification-audio-outline" /></template>
<style>
.ycc_5g2ij {
  fill: currentColor;
