...
const content = `<path class="l6p22dbit"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shopping-bag-tag-16-regular" /></template>
<style>
.l6p22dbit {
  fill: currentColor;
