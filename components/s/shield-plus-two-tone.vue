...
const content = `<g class="nrj6p8qat"><path class="ciz47rm9a"/><path class="q_slipb0a"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shield-plus-two-tone" /></template>
<style>
.ciz47rm9a {
  fill: currentColor;
