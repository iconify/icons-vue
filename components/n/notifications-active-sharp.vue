...
const content = `<path class="gg3i3qbnz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:notifications-active-sharp" /></template>
<style>
.gg3i3qbnz {
  fill: currentColor;
