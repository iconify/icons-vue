...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:message-square-x-duotone" /></template>
<style>
.c2k-m-3ae {
  fill: currentColor;
