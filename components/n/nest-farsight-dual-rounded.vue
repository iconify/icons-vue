...
const content = `<path class="qwznzob9c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-farsight-dual-rounded" /></template>
<style>
.qwznzob9c {
  fill: currentColor;
