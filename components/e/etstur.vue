...
const content = `<path class="i9clfwm2k"/><path class="f-9ovvbtq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:etstur" /></template>
<style>
.f-9ovvbtq {
  fill: none;
  stroke: currentColor;
