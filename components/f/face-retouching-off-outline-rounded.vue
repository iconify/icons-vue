...
const content = `<path class="b-fcp8fdx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:face-retouching-off-outline-rounded" /></template>
<style>
.b-fcp8fdx {
  fill: currentColor;
