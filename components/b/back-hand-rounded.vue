...
const content = `<path class="r8m7smb9r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:back-hand-rounded" /></template>
<style>
.r8m7smb9r {
  fill: currentColor;
