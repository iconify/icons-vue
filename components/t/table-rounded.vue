...
const content = `<path class="l37nn-baw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-rounded" /></template>
<style>
.l37nn-baw {
  fill: currentColor;
