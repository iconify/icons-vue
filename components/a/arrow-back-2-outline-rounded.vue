...
const content = `<path class="g73iku13v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-back-2-outline-rounded" /></template>
<style>
.g73iku13v {
  fill: currentColor;
