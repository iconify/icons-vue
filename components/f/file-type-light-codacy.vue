...
const content = `<path class="x-kaaicld"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-light-codacy" /></template>
<style>
.x-kaaicld {
