...
const content = `<path class="fbz8_lk0d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-snow-24-regular" /></template>
<style>
.fbz8_lk0d {
  fill: currentColor;
