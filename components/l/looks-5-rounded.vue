...
const content = `<path class="ut4xghofi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:looks-5-rounded" /></template>
<style>
.ut4xghofi {
  fill: currentColor;
