...
const content = `<path class="orbd88boo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:resize-large-24-regular" /></template>
<style>
.orbd88boo {
  fill: currentColor;
