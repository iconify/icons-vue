...
const content = `<path class="zghy_mbjo"/><path class="t7-jwcbkx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-hook" /></template>
<style>
.t7-jwcbkx {
