...
const content = `<path class="kseshgbmx"/><path class="gfls3u3mg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:eslint-old" /></template>
<style>
.gfls3u3mg {
