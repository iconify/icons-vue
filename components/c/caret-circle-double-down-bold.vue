...
const content = `<path class="ppg1217fx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-circle-double-down-bold" /></template>
<style>
.ppg1217fx {
  fill: currentColor;
