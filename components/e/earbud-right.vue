...
const content = `<path class="nykpa49yk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:earbud-right" /></template>
<style>
.nykpa49yk {
  fill: currentColor;
