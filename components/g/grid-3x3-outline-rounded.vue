...
const content = `<path class="ebj1rib2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:grid-3x3-outline-rounded" /></template>
<style>
.ebj1rib2k {
  fill: currentColor;
