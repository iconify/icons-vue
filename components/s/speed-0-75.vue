...
const content = `<path class="gqwprfs6f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:speed-0-75" /></template>
<style>
.gqwprfs6f {
  fill: currentColor;
