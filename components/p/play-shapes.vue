...
const content = `<path class="to3kofbkt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:play-shapes" /></template>
<style>
.to3kofbkt {
  fill: currentColor;
