...
const content = `<path class="oeya1lbqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:barcode-scanner-dismiss-28-filled" /></template>
<style>
.oeya1lbqq {
  fill: currentColor;
