...
const content = `<path class="onq53pble"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-hospital" /></template>
<style>
.onq53pble {
  fill: currentColor;
