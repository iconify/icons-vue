...
const content = `<path class="xe3b-1oio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-up-alt" /></template>
<style>
.xe3b-1oio {
  fill: currentColor;
