...
const content = `<path class="r29gjv87y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:poker-chip-outline-sharp" /></template>
<style>
.r29gjv87y {
  fill: currentColor;
