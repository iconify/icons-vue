...
const content = `<path class="dm3r0vbem"/><path class="ctmhrbcef"/><path class="kang8_qkz"/><path class="drs1yebmy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:creaks" /></template>
<style>
.ctmhrbcef {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M28.187 42.977s-7.807 1.37-11.015-2.617l-2.246-6.645c-2.428.413-5.224-3.253-5.361-6.095s4.261-8.02 6.92-.412");
}
...
.dm3r0vbem {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M23.267 39.856s2.933 3.437 9.761 4.354c0 0 3.987-3.483 5.728-7.882c1.742-4.4.046-7.47.046-7.47l1.696-6.508l-1.97-4.307c3.222 1.267 5.972.504 5.972.504");
}
