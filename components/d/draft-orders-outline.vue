...
const content = `<path class="j90ct3b6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:draft-orders-outline" /></template>
<style>
.j90ct3b6i {
  fill: currentColor;
