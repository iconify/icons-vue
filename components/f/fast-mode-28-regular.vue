...
const content = `<g class="ft5dv1b6b"><path class="g_8amabqp"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:fast-mode-28-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
