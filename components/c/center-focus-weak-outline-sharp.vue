...
const content = `<path class="wzosdlbmj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:center-focus-weak-outline-sharp" /></template>
<style>
.wzosdlbmj {
  fill: currentColor;
