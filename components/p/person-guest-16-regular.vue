...
const content = `<path class="wgzem20tm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-guest-16-regular" /></template>
<style>
.wgzem20tm {
  fill: currentColor;
