...
const content = `<path class="bvuk_ab-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-sparkle-16-regular" /></template>
<style>
.bvuk_ab-y {
  fill: currentColor;
