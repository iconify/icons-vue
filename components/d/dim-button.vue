...
const content = `<path class="cith-lbrv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:dim-button" /></template>
<style>
.cith-lbrv {
  fill: currentColor;
