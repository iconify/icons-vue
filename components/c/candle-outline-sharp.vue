...
const content = `<path class="ljho7eybf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:candle-outline-sharp" /></template>
<style>
.ljho7eybf {
  fill: currentColor;
