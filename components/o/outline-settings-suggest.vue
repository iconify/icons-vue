...
const content = `<path class="awv8oftvf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-settings-suggest" /></template>
<style>
.awv8oftvf {
  fill: currentColor;
