...
const content = `<path class="xyaieibdi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:split-scene-left-rounded" /></template>
<style>
.xyaieibdi {
  fill: currentColor;
