...
.n4hjwsugr {
  ...
  d: path("M5.812 15.937V8.062h5.254c.203 0 .371-.185.371-.393V5.62a.37.37 0 0 0-.37-.371H3.37a.375.375 0 0 0-.37.372V18.38a.37.37 0 0 0 .371.37h7.695a.374.374 0 0 0 .371-.37v-7.167c0-.208-.168-.337-.37-.337H7.274c-.208 0-.338.13-.338.337v2.048c0 .208.13.427.338.427h1.35v2.25z");
}

.o5u8vofis {
  stop-color: var(--svg-color--6b6bf3, #6b6bf3);
}

.q2fre8b6b {
  stop-color: var(--svg-color--8e34e3, #8e34e3);
}

.ta4xl90ii {
  stop-color: var(--svg-color--7865e2, #7865e2);
}

.yefjhvbab {
  d: path("M12.563 5.61c0-.197.174-.36.393-.36h3.15c.22 0 .394.163.394.36v.18c0 .202-.174.36-.394.36h-2.07v.9h2.07c.22 0 .394.169.394.36v.18c0 .202-.174.36-.394.36h-2.07v.9h2.07c.22 0 .394.163.394.36v.18c0 .197-.174.36-.394.36h-3.15c-.219 0-.393-.163-.393-.36zm4.5 0c0-.197.174-.36.393-.36h3.15c.22 0 .394.163.394.36v.18c0 .202-.174.36-.394.36h-2.064v.9h2.064c.22 0 .394.169.394.36v.18c0 .202-.174.36-.394.36h-2.064v.9H20.6c.226 0 .394.163.394.36v.18c0 .197-.168.36-.393.36h-3.15c-.214 0-.389-.163-.389-.36z");
}

.zv670w6qg {
  stop-color: var(--svg-color--31c4fa, #31c4fa);
}
