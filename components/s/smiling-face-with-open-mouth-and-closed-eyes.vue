...
const content = `<path class="b2_hc7bjn"/><path class="d3j2atb0f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:smiling-face-with-open-mouth-and-closed-eyes" /></template>
<style>
.b2_hc7bjn {
  fill: currentColor;
