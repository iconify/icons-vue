...
const content = `<path class="g7vetjowq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chevron-circle-up-28-filled" /></template>
<style>
.g7vetjowq {
  fill: currentColor;
