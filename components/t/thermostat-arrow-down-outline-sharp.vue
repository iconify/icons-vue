...
const content = `<path class="n81wuqbms"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:thermostat-arrow-down-outline-sharp" /></template>
<style>
.n81wuqbms {
  fill: currentColor;
