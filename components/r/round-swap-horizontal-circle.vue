...
const content = `<path class="b-dbc45so"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-swap-horizontal-circle" /></template>
<style>
.b-dbc45so {
  fill: currentColor;
