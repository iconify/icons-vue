...
const content = `<path class="ixz3e0bno"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:expansion-panels-rounded" /></template>
<style>
.ixz3e0bno {
  fill: currentColor;
