...
const content = `<path class="jl3mq9vmj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-bar-horizontal-24-filled" /></template>
<style>
.jl3mq9vmj {
  fill: currentColor;
