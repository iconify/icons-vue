...
const content = `<g class="cuyn6tgcc"><path class="goeug6bgp"/><path class="dp9l9vbkq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:smiley-blank-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
