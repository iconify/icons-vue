...
const content = `<path class="zbe-q9c-w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:view-carousel-rounded" /></template>
<style>
.zbe-q9c-w {
  fill: currentColor;
