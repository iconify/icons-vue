...
<style>
.av7-m_7vo {
  d: path("M36.485 11.963a1.465 1.465 0 1 1-2.93 0a1.465 1.465 0 0 1 2.93 0m-7.718 7.667c1.155 1.513 2.819 2.794 5.12 3.452");
}

.bw1bgh2as {
  d: path("M24.605 33.841c-.13-3.285-.118-6.763 4.335-8.314c3.452-1.203 3.912-2.851 6.83-2.591c3.006.267 5.402 2.859 6.577 7.671");
}
...
.tf2r4wzqh {
  d: path("M32.91 39.529q2.312-.06 4.562-.18m-11.544.205q.582.012 1.163.018m-8.441-.362q.618.048 1.237.088m-6.453-.615q.813.103 1.63.193");
}
...
.yjsfo3bqq {
  d: path("M29.23 35.884c1.911-1.848 5.133-2.13 6.131-5.186c.403-1.233.49-2.52.426-3.84M14.926 39.575c.253-1.838 1.223-3.178 2.82-3.792c.351-.136.506.655.59 1.266c.12.879.28 2.086.537 3.45m.96.201c-.056-1.034-.191-1.592 1.02-2.826c.837-.854 1.872-1.898 2.982-1.215c2.305 1.419 1.973 2.479 2.267 4.208m2.099.277c-.547-.329-1.102-1.13-1.159-1.876c1.23-1.432 3.466-2.466 4.019-2.388c.794.133 1.117.814 1.43 1.49c.418.895.515 1.229.424 2.13");
}

.zh6b6bbmp {
  d: path("M16.685 27.564c.184 1.932.427 2.92 2.374 4.904c1.725-1.414 2.105-3.022 2.383-4.77m.501-.037c.579 2.235 1.614 3.005 2.787 2.988");
}
