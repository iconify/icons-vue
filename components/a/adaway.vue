...
const content = `<path class="r9l72ablg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:adaway" /></template>
<style>
.r9l72ablg {
  fill: none;
  stroke: currentColor;
