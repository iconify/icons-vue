...
const content = `<path class="gnx2z_-pl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:translate-cc-outline" /></template>
<style>
.gnx2z_-pl {
  fill: currentColor;
