...
const content = `<path class="u84a5e4ze"/><path class="t7lyubpyp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:defikataster" /></template>
<style>
.t7lyubpyp {
  fill: none;
  stroke: currentColor;
