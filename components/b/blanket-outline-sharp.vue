...
const content = `<path class="m227wrb4z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:blanket-outline-sharp" /></template>
<style>
.m227wrb4z {
  fill: currentColor;
