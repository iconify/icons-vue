...
const content = `<path class="iiq-d_b4e"/><path class="pbc4_dbkt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-receipt-long" /></template>
<style>
.iiq-d_b4e {
  fill: currentColor;
