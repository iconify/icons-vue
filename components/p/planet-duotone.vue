...
const content = `<g class="cuyn6tgcc"><path class="fw_-f4u_a"/><path class="ttfr27bof"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:planet-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
