...
const content = `<path class="pvc5g9iln"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wb-sunny-sharp" /></template>
<style>
.pvc5g9iln {
  fill: currentColor;
