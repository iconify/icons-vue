...
const content = `<path class="lt7dn1elo"/><path class="q6ak0lw5t"/><circle class="vedw8u99n"/><path class="zl8ialfyv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gratis" /></template>
<style>
.lt7dn1elo {
  fill: none;
  stroke: currentColor;
...
.q6ak0lw5t {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M17.103 26.875c4.13-.233 7.136-.403 10.922-.484s5.629-.044 9.072.025");
}
