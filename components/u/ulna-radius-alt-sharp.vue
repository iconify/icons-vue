...
const content = `<path class="bxxftpe7g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ulna-radius-alt-sharp" /></template>
<style>
.bxxftpe7g {
  fill: currentColor;
