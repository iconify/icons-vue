...
const content = `<path class="qaz8dy7ve"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:thai-pbs" /></template>
<style>
.qaz8dy7ve {
  fill: none;
  stroke: currentColor;
