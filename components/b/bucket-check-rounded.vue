...
const content = `<path class="v28ex1din"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bucket-check-rounded" /></template>
<style>
.v28ex1din {
  fill: currentColor;
