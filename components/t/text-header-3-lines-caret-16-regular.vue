...
const content = `<path class="pivpldbgl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-3-lines-caret-16-regular" /></template>
<style>
.pivpldbgl {
  fill: currentColor;
