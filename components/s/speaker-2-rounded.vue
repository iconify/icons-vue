...
const content = `<path class="fdc-onkra"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speaker-2-rounded" /></template>
<style>
.fdc-onkra {
  fill: currentColor;
