...
const content = `<path class="u921dhc5g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-applications-rounded" /></template>
<style>
.u921dhc5g {
  fill: currentColor;
