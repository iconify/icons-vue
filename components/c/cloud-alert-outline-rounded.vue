...
const content = `<path class="jirgx-b5o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cloud-alert-outline-rounded" /></template>
<style>
.jirgx-b5o {
  fill: currentColor;
