...
const content = `<path class="e4hujg-kx"/><path class="xxu140h0a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-bahrain" /></template>
<style>
.e4hujg-kx {
