...
const content = `<path class="zrjpqpt8y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:presence-available-16-regular" /></template>
<style>
.zrjpqpt8y {
  fill: currentColor;
