...
const content = `<path class="zvg0ynbpv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-in-diagonal-down-left-16-regular" /></template>
<style>
.zvg0ynbpv {
  fill: currentColor;
