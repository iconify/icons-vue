...
const content = `<path class="uc33582fz"/><circle class="iw6nvx_mx"/><circle class="cbwjarblr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-directions-bus-filled" /></template>
<style>
.cbwjarblr {
  cx: 15.5px;
  cy: 14.5px;
