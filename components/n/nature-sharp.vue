...
const content = `<path class="itl-56bkw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nature-sharp" /></template>
<style>
.itl-56bkw {
  fill: currentColor;
