...
const content = `<path class="vrpij_iea"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:no-sim-rounded" /></template>
<style>
.vrpij_iea {
  fill: currentColor;
