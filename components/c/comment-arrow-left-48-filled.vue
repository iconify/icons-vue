...
const content = `<path class="zftmjwbjl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-arrow-left-48-filled" /></template>
<style>
.zftmjwbjl {
  fill: currentColor;
