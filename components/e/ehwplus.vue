...
const content = `<path class="zcukar5lk"/><path class="fzy-tlbjr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ehwplus" /></template>
<style>
.fzy-tlbjr {
  fill: none;
  stroke: currentColor;
