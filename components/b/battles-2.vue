...
const content = `<path class="wi8y_acgn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:battles-2" /></template>
<style>
.wi8y_acgn {
  fill: none;
  stroke: currentColor;
