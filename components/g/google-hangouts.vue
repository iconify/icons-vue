...
const content = `<path class="kz8d9to3k"/><path class="w5n28ybpp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:google-hangouts" /></template>
<style>
.kz8d9to3k {
  fill: none;
  stroke: currentColor;
