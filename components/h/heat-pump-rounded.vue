...
const content = `<path class="h8_ujpbjh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:heat-pump-rounded" /></template>
<style>
.h8_ujpbjh {
  fill: currentColor;
