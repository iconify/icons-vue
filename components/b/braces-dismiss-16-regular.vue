...
const content = `<path class="bzaquw7-x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:braces-dismiss-16-regular" /></template>
<style>
.bzaquw7-x {
  fill: currentColor;
