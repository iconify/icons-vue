...
const content = `<path class="m-87wbbgn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:empty-dashboard" /></template>
<style>
.m-87wbbgn {
  fill: currentColor;
