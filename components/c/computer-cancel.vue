...
const content = `<path class="uskjx7vma"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:computer-cancel" /></template>
<style>
.uskjx7vma {
  fill: currentColor;
