...
const content = `<path class="jfg3gzb2v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shutter-speed-outline-sharp" /></template>
<style>
.jfg3gzb2v {
  fill: currentColor;
