...
const content = `<g class="cuyn6tgcc"><path class="hidfxz0es"/><path class="qzqu-abhe"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-three-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
