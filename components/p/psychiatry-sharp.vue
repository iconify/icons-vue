...
const content = `<path class="p5buxo2_i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:psychiatry-sharp" /></template>
<style>
.p5buxo2_i {
  fill: currentColor;
