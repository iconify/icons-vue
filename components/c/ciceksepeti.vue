...
const content = `<path class="mtjm5w9qt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ciceksepeti" /></template>
<style>
.mtjm5w9qt {
  fill: none;
  stroke: currentColor;
