...
const content = `<path class="v9o9k6brb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:heap-snapshot-multiple-outline" /></template>
<style>
.v9o9k6brb {
  fill: currentColor;
