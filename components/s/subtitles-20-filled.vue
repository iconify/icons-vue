...
const content = `<path class="yqlafybfk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:subtitles-20-filled" /></template>
<style>
.yqlafybfk {
  fill: currentColor;
