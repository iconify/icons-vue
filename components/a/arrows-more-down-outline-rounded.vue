...
const content = `<path class="ln-aq5g3j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrows-more-down-outline-rounded" /></template>
<style>
.ln-aq5g3j {
  fill: currentColor;
