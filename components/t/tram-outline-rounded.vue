...
const content = `<path class="ppjdscc6w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tram-outline-rounded" /></template>
<style>
.ppjdscc6w {
  fill: currentColor;
