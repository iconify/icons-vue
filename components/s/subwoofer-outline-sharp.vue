...
const content = `<path class="a02zlobxa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:subwoofer-outline-sharp" /></template>
<style>
.a02zlobxa {
  fill: currentColor;
