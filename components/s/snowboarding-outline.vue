...
const content = `<path class="ljv6r37ac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:snowboarding-outline" /></template>
<style>
.ljv6r37ac {
  fill: currentColor;
