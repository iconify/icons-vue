...
const content = `<defs><path id="SVG7BlNycLb" class="ig5ph1b1b"/></defs><path class="f_8ojybee"/><path class="gq7wq_7uu"/><use href="#SVG7BlNycLb" class="ww4qbxblf"/><use href="#SVG7BlNycLb" class="ww4qbxblf"/>`;
</script>
