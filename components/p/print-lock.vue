...
const content = `<path class="kdfgj722d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:print-lock" /></template>
<style>
.kdfgj722d {
  fill: currentColor;
