...
const content = `<path class="ejwbgrrgk"/><path class="hk20ls52v"/><path class="smm-t2hjd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:vszp-slovakia" /></template>
<style>
.ejwbgrrgk {
  fill: none;
  stroke: currentColor;
