...
const content = `<path class="agql8mxqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ffvii" /></template>
<style>
.agql8mxqq {
  fill: none;
  stroke: currentColor;
