...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="ocri9qb4l"/><path clip-rule="evenodd" class="vpedv7bsg"/><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:chain-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
