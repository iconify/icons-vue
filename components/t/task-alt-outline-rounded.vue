...
const content = `<path class="d9i0c7bfq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:task-alt-outline-rounded" /></template>
<style>
.d9i0c7bfq {
  fill: currentColor;
