...
const content = `<path class="blhk7db6l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:movie-edit-off" /></template>
<style>
.blhk7db6l {
  fill: currentColor;
