...
const content = `<path class="biikplbtv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wifi-notification-outline-sharp" /></template>
<style>
.biikplbtv {
  fill: currentColor;
