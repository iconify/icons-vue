...
const content = `<path class="g2wj9jbhp"/><path class="bcy0dybeh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:krungsri-we-connect" /></template>
<style>
.bcy0dybeh {
  fill: none;
  stroke: currentColor;
