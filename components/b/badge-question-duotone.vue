...
const content = `<g class="nrj6p8qat"><path class="g70whwsdk"/><path class="gz6_t9bsf"/><path class="ju8v6k8zc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-question-duotone" /></template>
<style>
.g70whwsdk {
  fill: currentColor;
