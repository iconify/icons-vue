...
const content = `<path class="x4s36bcsh"/><path class="wwxpzmbsb"/><path class="mk6l-48ub"/><path class="qevk-zbmu"/><path class="z8tia2-jq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-uzbekistan" /></template>
<style>
.mk6l-48ub {
