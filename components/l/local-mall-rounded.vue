...
const content = `<path class="fjq692ltf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-mall-rounded" /></template>
<style>
.fjq692ltf {
  fill: currentColor;
