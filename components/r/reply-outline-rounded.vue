...
const content = `<path class="j7y02xeqo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:reply-outline-rounded" /></template>
<style>
.j7y02xeqo {
  fill: currentColor;
