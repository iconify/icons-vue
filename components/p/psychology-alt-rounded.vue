...
const content = `<path class="q1_c7w4xa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:psychology-alt-rounded" /></template>
<style>
.q1_c7w4xa {
  fill: currentColor;
