...
const content = `<g class="nrj6p8qat"><path class="yelxr2brf"/><path class="aaf9dhb8c"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:user-x-fill" /></template>
<style>
.aaf9dhb8c {
  fill: currentColor;
