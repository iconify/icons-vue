...
const content = `<path class="kjsephbdm"/><path class="m_0g6j9jt"/><path class="goachacdh"/><path class="huqzdhv0p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:chatcraft" /></template>
<style>
.goachacdh {
  fill: none;
  stroke: currentColor;
