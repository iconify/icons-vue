...
const content = `<path class="wygbw7b-c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:markdown-paste-outline-sharp" /></template>
<style>
.wygbw7b-c {
  fill: currentColor;
