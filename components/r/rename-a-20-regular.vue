...
const content = `<path class="csnm4ybdx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:rename-a-20-regular" /></template>
<style>
.csnm4ybdx {
  fill: currentColor;
