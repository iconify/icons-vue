...
const content = `<path class="stavxibrw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notebook-arrow-curve-down-20-filled" /></template>
<style>
.stavxibrw {
  fill: currentColor;
