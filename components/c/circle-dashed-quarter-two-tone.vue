...
const content = `<g class="nrj6p8qat"><path class="esurwb5xo"/><path class="dxj4ljbhs"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-quarter-two-tone" /></template>
<style>
.dxj4ljbhs {
  fill: currentColor;
