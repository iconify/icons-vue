...
const content = `<path class="tnh1nbczi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:binder-triangle-24-filled" /></template>
<style>
.tnh1nbczi {
  fill: currentColor;
