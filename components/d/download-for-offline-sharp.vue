...
const content = `<path class="k9qljvbzw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:download-for-offline-sharp" /></template>
<style>
.k9qljvbzw {
  fill: currentColor;
