...
const content = `<path class="bhul04fcc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:health-metrics" /></template>
<style>
.bhul04fcc {
  fill: currentColor;
