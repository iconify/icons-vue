...
const content = `<path class="neq_qnbal"/><path class="f6k9frohn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:pinching-hand" /></template>
<style>
.f6k9frohn {
