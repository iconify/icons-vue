...
const content = `<path class="e5juj29ww"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:eye-tracking-rounded" /></template>
<style>
.e5juj29ww {
  fill: currentColor;
