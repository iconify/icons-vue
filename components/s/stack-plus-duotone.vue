...
const content = `<g class="cuyn6tgcc"><path class="hh5u20bpy"/><path class="jci3rgb9h"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:stack-plus-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
