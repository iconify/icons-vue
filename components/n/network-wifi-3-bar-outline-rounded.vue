...
const content = `<path class="sru1fib-q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:network-wifi-3-bar-outline-rounded" /></template>
<style>
.sru1fib-q {
  fill: currentColor;
