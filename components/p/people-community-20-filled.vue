...
const content = `<path class="m4z3z3oga"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-community-20-filled" /></template>
<style>
.m4z3z3oga {
  fill: currentColor;
