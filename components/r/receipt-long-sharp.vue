...
const content = `<path class="ptfxosbyh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:receipt-long-sharp" /></template>
<style>
.ptfxosbyh {
  fill: currentColor;
