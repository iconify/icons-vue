...
const content = `<path class="wh1u-wg3g"/><path class="sav447b4h"/><path class="n5tjb5b1u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:functiongenerator" /></template>
<style>
.n5tjb5b1u {
  fill: none;
  stroke: currentColor;
  ...
  d: path("m40 40l-1.6 1.9l-3.7-3.7l-3.4 3.5l-3.4-3.4l-3.2 3.3l-3.3-3.3l-3.4 3.4l-3.4-3.4l-3.4 3.4L9.6 40m31-23.2h-4.2");
}
