...
const content = `<path class="n_1qvqbbo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:square-half-bottom-thin" /></template>
<style>
.n_1qvqbbo {
  fill: currentColor;
