...
const content = `<path class="o-7h6xp9y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shopping-cart-outline" /></template>
<style>
.o-7h6xp9y {
  fill: currentColor;
