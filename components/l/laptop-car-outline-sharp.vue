...
const content = `<path class="t_y-gabyc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:laptop-car-outline-sharp" /></template>
<style>
.t_y-gabyc {
  fill: currentColor;
