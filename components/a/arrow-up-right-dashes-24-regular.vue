...
const content = `<path class="xbw-vibly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-up-right-dashes-24-regular" /></template>
<style>
.xbw-vibly {
  fill: currentColor;
