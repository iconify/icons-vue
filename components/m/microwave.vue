...
const content = `<path class="b7qdv8hwa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:microwave" /></template>
<style>
.b7qdv8hwa {
  fill: currentColor;
