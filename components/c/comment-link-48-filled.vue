...
const content = `<path class="g7rf1nbmc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-link-48-filled" /></template>
<style>
.g7rf1nbmc {
  fill: currentColor;
