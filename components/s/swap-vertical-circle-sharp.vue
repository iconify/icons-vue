...
const content = `<path class="vkin7os6t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swap-vertical-circle-sharp" /></template>
<style>
.vkin7os6t {
  fill: currentColor;
