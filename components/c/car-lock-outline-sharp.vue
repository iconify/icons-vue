...
const content = `<path class="bs98f3byz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-lock-outline-sharp" /></template>
<style>
.bs98f3byz {
  fill: currentColor;
