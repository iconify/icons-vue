...
const content = `<g class="ft5dv1b6b"><path class="mom13-bqg"/><path class="q32156b5w"/><path class="ooe5frk6i"/><path class="tctta5bwn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:bcube" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
