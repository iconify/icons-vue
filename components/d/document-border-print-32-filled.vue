...
const content = `<path class="uc708hbab"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-border-print-32-filled" /></template>
<style>
.uc708hbab {
  fill: currentColor;
