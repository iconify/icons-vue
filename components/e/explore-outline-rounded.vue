...
const content = `<path class="jrhjxabtb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:explore-outline-rounded" /></template>
<style>
.jrhjxabtb {
  fill: currentColor;
