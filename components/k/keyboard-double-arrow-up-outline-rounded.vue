...
const content = `<path class="osbt9pqqk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-double-arrow-up-outline-rounded" /></template>
<style>
.osbt9pqqk {
  fill: currentColor;
