...
const content = `<path class="pvtv_2xos"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:smart-card-reader-off-sharp" /></template>
<style>
.pvtv_2xos {
  fill: currentColor;
