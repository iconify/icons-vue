...
const content = `<g class="gp_8x1bzb"><path class="v8hgvi38z"/><path class="x-_5ilohg"/><path class="er1p0-brb"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-more-horizontal-sharp-two-tone" /></template>
<style>
.er1p0-brb {
  fill: currentColor;
