...
const content = `<path class="g8czu8bpl"/><path class="ap5r5mb7g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:smart-tutor" /></template>
<style>
.ap5r5mb7g {
  fill: none;
  stroke: currentColor;
