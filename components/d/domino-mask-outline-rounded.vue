...
const content = `<path class="dgqtkhers"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:domino-mask-outline-rounded" /></template>
<style>
.dgqtkhers {
  fill: currentColor;
