...
const content = `<path class="a2r_esbvz"/><path class="u2nj41qwf"/><path class="ky_ow7byc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cogito-old" /></template>
<style>
.a2r_esbvz {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M26.983 39.734s1.28 1.943 2.614 1.943c2.799 0 5.3-.752 7.124-3.636c.278-.44.207-1.452.173-2.3a.11.11 0 0 1 .097-.11c2.532-.318 2.695-5.788 1.532-6.696a.12.12 0 0 1-.048-.109c.13-1.417-3.292-6.717-5.499-6.466c-2.07.236-3.62 4.697-3.62 4.697");
}
