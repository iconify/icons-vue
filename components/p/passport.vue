...
const content = `<path class="rs4drqt_l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:passport" /></template>
<style>
.rs4drqt_l {
  fill: currentColor;
