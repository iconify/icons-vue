...
const content = `<g class="nrj6p8qat"><path class="xgaf0nbdt"/><path class="kgkgp47br"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-plus" /></template>
<style>
.kgkgp47br {
  d: path("M8 12H16M11.995 16.005V8.005");
}
