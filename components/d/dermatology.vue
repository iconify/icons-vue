...
const content = `<path class="bi49zuw8g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dermatology" /></template>
<style>
.bi49zuw8g {
  fill: currentColor;
