...
const content = `<path class="ynnj-_8lc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vrpano-outline" /></template>
<style>
.ynnj-_8lc {
  fill: currentColor;
