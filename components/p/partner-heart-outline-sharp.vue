...
const content = `<path class="erk5d1bnd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:partner-heart-outline-sharp" /></template>
<style>
.erk5d1bnd {
  fill: currentColor;
