...
const content = `<path class="l1ag53z0o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-bar-vertical-20-regular" /></template>
<style>
.l1ag53z0o {
  fill: currentColor;
