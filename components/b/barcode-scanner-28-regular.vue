...
const content = `<path class="hqgfpbbmc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:barcode-scanner-28-regular" /></template>
<style>
.hqgfpbbmc {
  fill: currentColor;
