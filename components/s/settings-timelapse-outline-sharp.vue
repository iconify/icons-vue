...
const content = `<path class="a2a3bybnb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-timelapse-outline-sharp" /></template>
<style>
.a2a3bybnb {
  fill: currentColor;
