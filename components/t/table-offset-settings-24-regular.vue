...
const content = `<path class="wst48brsu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-offset-settings-24-regular" /></template>
<style>
.wst48brsu {
  fill: currentColor;
