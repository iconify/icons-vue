...
const content = `<path class="t5aetqbwa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:attribution-sharp" /></template>
<style>
.t5aetqbwa {
  fill: currentColor;
