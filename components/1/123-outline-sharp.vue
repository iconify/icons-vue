...
const content = `<path class="kjycimu4r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:123-outline-sharp" /></template>
<style>
.kjycimu4r {
  fill: currentColor;
