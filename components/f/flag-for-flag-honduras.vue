...
const content = `<path class="o3_tkgbqt"/><path class="a_d14drdr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-flag-honduras" /></template>
<style>
.a_d14drdr {
  fill: currentColor;
