...
const content = `<g class="cuyn6tgcc"><path class="bg35r-f3d"/><path class="s3ghakb2f"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:matrix-logo-duotone" /></template>
<style>
.bg35r-f3d {
