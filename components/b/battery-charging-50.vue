...
const content = `<path class="oll_d0b2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-charging-50" /></template>
<style>
.oll_d0b2k {
  fill: currentColor;
