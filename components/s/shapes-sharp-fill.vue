...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shapes-sharp-fill" /></template>
<style>
.g02rumb0j {
  fill: currentColor;
...
.t_3j7e08c {
  d: path("M2.7071 2.7071L10.2929 10.2929M10.2929 2.7071L2.7071 10.2929");
}
