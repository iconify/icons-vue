...
const content = `<path class="c0m-cfizf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:panel-bottom-dashed" /></template>
<style>
.c0m-cfizf {
  fill: none;
  stroke: currentColor;
