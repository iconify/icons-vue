...
const content = `<path class="j_2ztdpvd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:camera-add-24-regular" /></template>
<style>
.j_2ztdpvd {
  fill: currentColor;
