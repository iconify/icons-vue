...
const content = `<path class="ys2i1gbha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:planner-review-outline-rounded" /></template>
<style>
.ys2i1gbha {
  fill: currentColor;
