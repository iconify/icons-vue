...
const content = `<circle class="j6m_dqbxr"/><path class="jhxlzfbgl"/><path class="x2ocrxbda"/><circle class="fznt23b3g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kaleidoscope" /></template>
<style>
.fznt23b3g {
  cx: 26.642px;
  cy: 26.895px;
