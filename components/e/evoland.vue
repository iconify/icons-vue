...
const content = `<path class="qqqszrb7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:evoland" /></template>
<style>
.qqqszrb7l {
  fill: none;
  stroke: currentColor;
