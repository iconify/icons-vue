...
const content = `<path class="sv867abee"/><path class="q9p-6ibjk"/><path class="aa47f0b6z"/><path class="im1dm_s0h"/><path class="d1tpkwano"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-style" /></template>
<style>
.aa47f0b6z {
...
.sv867abee {
  fill: var(--svg-color--5590bc, #5590bc);
