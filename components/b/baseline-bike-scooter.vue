...
const content = `<path class="buvk84bgc"/><path class="e74ny5-wq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-bike-scooter" /></template>
<style>
.buvk84bgc {
  fill: currentColor;
