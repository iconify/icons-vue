...
const content = `<path class="ya6n9isto"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-bluetooth-disabled" /></template>
<style>
.ya6n9isto {
  fill: currentColor;
