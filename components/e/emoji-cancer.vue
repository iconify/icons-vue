...
const content = `<path class="pb8k80bey"/><path class="njmq7xbhb"/><path class="b7naesbox"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-cancer" /></template>
<style>
.b7naesbox {
  fill: none;
  stroke: currentColor;
