...
const content = `<path class="nhd055bsn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:subtract-square-20-regular" /></template>
<style>
.nhd055bsn {
  fill: currentColor;
