...
const content = `<path class="lxulv-bzd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:fast-forward-28-filled" /></template>
<style>
.lxulv-bzd {
  fill: currentColor;
