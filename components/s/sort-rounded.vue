...
const content = `<path class="sbadfab2z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sort-rounded" /></template>
<style>
.sbadfab2z {
  fill: currentColor;
