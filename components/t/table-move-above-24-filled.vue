...
const content = `<path class="bszpfk52g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-above-24-filled" /></template>
<style>
.bszpfk52g {
  fill: currentColor;
