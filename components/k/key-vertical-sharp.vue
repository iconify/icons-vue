...
const content = `<path class="h1f216bul"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:key-vertical-sharp" /></template>
<style>
.h1f216bul {
  fill: currentColor;
