...
const content = `<path class="cb5gitd3u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:link-outline-rounded" /></template>
<style>
.cb5gitd3u {
  fill: currentColor;
