...
const content = `<path class="eawe5egnc"/><path class="x22dzqqzq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pimsleur" /></template>
<style>
.eawe5egnc {
  fill: none;
  stroke: currentColor;
