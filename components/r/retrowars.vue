...
const content = `<path class="syhp4ubvf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:retrowars" /></template>
<style>
.syhp4ubvf {
  fill: none;
  stroke: currentColor;
