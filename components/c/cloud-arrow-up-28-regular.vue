...
const content = `<path class="ma8tqnr7b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-arrow-up-28-regular" /></template>
<style>
.ma8tqnr7b {
  fill: currentColor;
