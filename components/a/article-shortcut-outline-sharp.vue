...
const content = `<path class="kaur9qy6g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:article-shortcut-outline-sharp" /></template>
<style>
.kaur9qy6g {
  fill: currentColor;
