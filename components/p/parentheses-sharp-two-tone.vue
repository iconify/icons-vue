...
const content = `<path class="epm1c_bnf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:parentheses-sharp-two-tone" /></template>
<style>
.epm1c_bnf {
  fill: none;
  stroke: currentColor;
