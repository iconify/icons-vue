...
const content = `<path class="trsyg_bcx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bid-landscape-disabled-rounded" /></template>
<style>
.trsyg_bcx {
  fill: currentColor;
