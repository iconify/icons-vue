...
const content = `<path clip-rule="evenodd" class="v2_r2cc1i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:phone" /></template>
<style>
.v2_r2cc1i {
  fill: currentColor;
  fill-rule: evenodd;
