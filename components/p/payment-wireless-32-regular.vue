...
const content = `<path class="j8kvlly6k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:payment-wireless-32-regular" /></template>
<style>
.j8kvlly6k {
  fill: currentColor;
