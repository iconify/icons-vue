...
const content = `<path class="v6n-zabnp"/><path class="qdczw6b9t"/><path class="c3abd51ck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-mali" /></template>
<style>
.c3abd51ck {
