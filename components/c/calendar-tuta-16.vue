...
const content = `<g class="y9tr6bcfx"><path class="shtvqpuec"/><path class="r19yqcc0k"/></g><path class="bag4m3bbr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-tuta-16" /></template>
<style>
.bag4m3bbr {
  fill: none;
  stroke: currentColor;
