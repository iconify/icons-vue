...
const content = `<g class="gp_8x1bzb"><path class="j6v-2tbep"/><path class="x2s9iubao"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:ship-sharp-fill" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
