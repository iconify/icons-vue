...
const content = `<path class="wqi82xbyb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lighthouse" /></template>
<style>
.wqi82xbyb {
  fill: none;
  stroke: currentColor;
