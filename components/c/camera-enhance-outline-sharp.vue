...
const content = `<path class="wgxovtbim"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:camera-enhance-outline-sharp" /></template>
<style>
.wgxovtbim {
  fill: currentColor;
