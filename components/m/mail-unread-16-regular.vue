...
const content = `<path class="onfjp74nb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-unread-16-regular" /></template>
<style>
.onfjp74nb {
  fill: currentColor;
