...
const content = `<path class="dvry61e2z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:brightness-3-outline-sharp" /></template>
<style>
.dvry61e2z {
  fill: currentColor;
