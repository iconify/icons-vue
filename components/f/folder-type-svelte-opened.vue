...
const content = `<path class="y-y1ngwls"/><path class="b3bag_bja"/><path class="zazi__pfw"/><path class="pav86w_yu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-svelte-opened" /></template>
<style>
.b3bag_bja {
  fill: var(--svg-color--ffb39c, #ffb39c);
...
.zazi__pfw {
  fill: var(--svg-color--ff3e00, #ff3e00);
  d: path("M29.85 12.77A6.72 6.72 0 0 0 21 10.93l-5 3.12a5.6 5.6 0 0 0-2.62 3.76a5.8 5.8 0 0 0 .6 3.79a5.6 5.6 0 0 0-.86 2.1a5.86 5.86 0 0 0 1.05 4.53A6.72 6.72 0 0 0 23 30.07L28 27a5.64 5.64 0 0 0 2.61-3.76a5.76 5.76 0 0 0-.6-3.8a5.6 5.6 0 0 0 .87-2.1a5.9 5.9 0 0 0-1.06-4.53");
}
