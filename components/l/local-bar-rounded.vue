...
const content = `<path class="nqbcwpodp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-bar-rounded" /></template>
<style>
.nqbcwpodp {
  fill: currentColor;
