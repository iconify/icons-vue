...
const content = `<path class="wcjj0gjwq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-fan-mid-left-outline-sharp" /></template>
<style>
.wcjj0gjwq {
  fill: currentColor;
