...
const content = `<path class="e6xk1-mwp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hourglass-arrow-up-outline" /></template>
<style>
.e6xk1-mwp {
  fill: currentColor;
