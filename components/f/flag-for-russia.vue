...
const content = `<path class="wojbwyb9r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-russia" /></template>
<style>
.wojbwyb9r {
  fill: currentColor;
