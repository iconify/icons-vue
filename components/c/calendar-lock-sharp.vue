...
const content = `<path class="or-4niz0p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:calendar-lock-sharp" /></template>
<style>
.or-4niz0p {
  fill: currentColor;
