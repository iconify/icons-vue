...
const content = `<path class="eoyb33ocv"/><path class="hwjxbubxz"/>`;
</script>
...
.eoyb33ocv {
  ...
  d: path("M34.445 19.721c-.815-6.302-7.03-11.07-14.43-11.071h0c-8.017 0-14.517 5.57-14.517 12.442v.002c.005 3.548 1.778 6.926 4.872 9.284l-.78 5.359l5.842-2.865c1.476.43 3.024.655 4.584.664c1.267 0 2.53-.143 3.754-.424");
}
