...
const content = `<path class="b2cd8nubp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:recent-patient-sharp" /></template>
<style>
.b2cd8nubp {
  fill: currentColor;
