...
const content = `<path class="bmlp1dldp"/><path class="dgf107chp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:b-button-blood-type" /></template>
<style>
.bmlp1dldp {
