...
const content = `<path class="uvjbyjrta"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-convert-sharp" /></template>
<style>
.uvjbyjrta {
  fill: currentColor;
