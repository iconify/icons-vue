...
const content = `<path class="rl2dzccyd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:garage-check-rounded" /></template>
<style>
.rl2dzccyd {
  fill: currentColor;
