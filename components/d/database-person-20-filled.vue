...
const content = `<path class="djypcwb1g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:database-person-20-filled" /></template>
<style>
.djypcwb1g {
  fill: currentColor;
