...
const content = `<path class="pll708lof"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:home-more-24-filled" /></template>
<style>
.pll708lof {
  fill: currentColor;
