...
const content = `<path class="qds0reane"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:siriusxm" /></template>
<style>
.qds0reane {
  fill: none;
  stroke: currentColor;
