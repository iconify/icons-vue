...
const content = `<path class="d037zhv1g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vacuum-2-on-rounded" /></template>
<style>
.d037zhv1g {
  fill: currentColor;
