...
const content = `<g class="cuyn6tgcc"><path class="my9aj1sph"/><path class="jikwaxw2d"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:bug-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.my9aj1sph {
  d: path("M208 128v16a80 80 0 0 1-160 0v-16Z");
