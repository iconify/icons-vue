...
const content = `<g class="cuyn6tgcc"><path class="yfku__iqb"/><path class="cvoz9bbsx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:app-window-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
