...
const content = `<path class="lgmvmlb0x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-cancel-24-regular" /></template>
<style>
.lgmvmlb0x {
  fill: currentColor;
