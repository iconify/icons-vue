...
const content = `<path class="fmj246b7e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cases-outline" /></template>
<style>
.fmj246b7e {
  fill: currentColor;
