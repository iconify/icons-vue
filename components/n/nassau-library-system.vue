...
const content = `<path class="bfqysqnyt"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nassau-library-system" /></template>
<style>
.bfqysqnyt {
  fill: none;
  stroke: currentColor;
