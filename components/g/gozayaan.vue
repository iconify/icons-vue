...
const content = `<path class="p4z-g8buj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gozayaan" /></template>
<style>
.p4z-g8buj {
  fill: none;
  stroke: currentColor;
