...
const content = `<path class="zmihc1n5z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chair-fireplace-outline-sharp" /></template>
<style>
.zmihc1n5z {
  fill: currentColor;
