...
const content = `<g class="cuyn6tgcc"><path class="ner24ccnr"/><path class="k-h9or9ru"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-user-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
