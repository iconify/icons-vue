...
const content = `<path class="z3-46mwlk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-data-bar-16-regular" /></template>
<style>
.z3-46mwlk {
  fill: currentColor;
