...
const content = `<path class="c4bp3i8le"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dock-panel-right-24-filled" /></template>
<style>
.c4bp3i8le {
  fill: currentColor;
