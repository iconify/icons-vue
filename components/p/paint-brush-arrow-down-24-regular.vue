...
const content = `<path class="xvb_tum9m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:paint-brush-arrow-down-24-regular" /></template>
<style>
.xvb_tum9m {
  fill: currentColor;
