...
const content = `<path class="q3zasjo_w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-factory-20-filled" /></template>
<style>
.q3zasjo_w {
  fill: currentColor;
