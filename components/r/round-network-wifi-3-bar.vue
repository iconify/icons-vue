...
const content = `<path class="fq915ce-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-network-wifi-3-bar" /></template>
<style>
.fq915ce-g {
  fill: currentColor;
