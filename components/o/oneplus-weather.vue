...
const content = `<path class="onbl4zpbh"/><path class="rme0s0b6q"/><path class="rrl0-tbbj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:oneplus-weather" /></template>
<style>
.onbl4zpbh {
  fill: none;
  stroke: currentColor;
