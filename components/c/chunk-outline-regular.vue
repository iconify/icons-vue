...
const content = `<g class="nrj6p8qat"><path class="d-4q6bcoc"/><path class="d9sl7h_4e"/><path class="tpbrklbww"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:chunk-outline-regular" /></template>
<style>
.d-4q6bcoc {
