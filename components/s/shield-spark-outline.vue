...
const content = `<path class="i0cucxbou"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-spark-outline" /></template>
<style>
.i0cucxbou {
  fill: currentColor;
