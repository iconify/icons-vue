...
const content = `<path class="eo0bjup7r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:list-arrow-outline-rounded" /></template>
<style>
.eo0bjup7r {
  fill: currentColor;
