...
const content = `<path class="o3h8fkbir"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sync-lock-outline-rounded" /></template>
<style>
.o3h8fkbir {
  fill: currentColor;
