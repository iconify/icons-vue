...
const content = `<path class="xcmc-unhv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:patient-list-sharp" /></template>
<style>
.xcmc-unhv {
  fill: currentColor;
