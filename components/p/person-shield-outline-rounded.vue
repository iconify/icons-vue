...
const content = `<path class="eb08cnzyz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:person-shield-outline-rounded" /></template>
<style>
.eb08cnzyz {
  fill: currentColor;
