...
const content = `<path class="vtpto6-rd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:book-6-sharp" /></template>
<style>
.vtpto6-rd {
  fill: currentColor;
