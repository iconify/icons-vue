...
const content = `<path class="rmxuf119x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-lightning-32-regular" /></template>
<style>
.rmxuf119x {
  fill: currentColor;
