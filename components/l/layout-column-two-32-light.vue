...
const content = `<path class="of-cgabuw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-column-two-32-light" /></template>
<style>
.of-cgabuw {
  fill: currentColor;
