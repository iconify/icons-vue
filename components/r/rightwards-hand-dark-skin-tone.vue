...
const content = `<path class="uw5exkuns"/><path class="fbyvghbly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:rightwards-hand-dark-skin-tone" /></template>
<style>
.fbyvghbly {
