...
const content = `<path class="ex86y2b0h"/><path class="lu0vn-1vz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gastromapalukehejlka" /></template>
<style>
.ex86y2b0h {
  fill: none;
  stroke: currentColor;
