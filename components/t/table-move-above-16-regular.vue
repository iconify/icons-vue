...
const content = `<path class="iqw38yx_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-above-16-regular" /></template>
<style>
.iqw38yx_q {
  fill: currentColor;
