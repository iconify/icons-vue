...
const content = `<path class="ck93lzxxe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tv-next-outline-rounded" /></template>
<style>
.ck93lzxxe {
  fill: currentColor;
