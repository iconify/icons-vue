...
const content = `<path class="h_okowbjj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-minimize-20-filled" /></template>
<style>
.h_okowbjj {
  fill: currentColor;
