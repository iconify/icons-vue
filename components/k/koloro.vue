...
const content = `<path class="r0eebpitq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:koloro" /></template>
<style>
.r0eebpitq {
  fill: none;
  stroke: currentColor;
