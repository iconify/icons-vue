...
const content = `<path class="p4ud5jf3r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:twinkly" /></template>
<style>
.p4ud5jf3r {
  fill: none;
  stroke: currentColor;
