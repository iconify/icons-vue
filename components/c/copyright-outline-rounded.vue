...
const content = `<path class="c1xfbfwwz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:copyright-outline-rounded" /></template>
<style>
.c1xfbfwwz {
  fill: currentColor;
