...
const content = `<path class="ecpzrvlsl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:strategy-rounded" /></template>
<style>
.ecpzrvlsl {
  fill: currentColor;
