...
const content = `<path class="lvmnb_bio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bookmark-stacks-outline-rounded" /></template>
<style>
.lvmnb_bio {
  fill: currentColor;
