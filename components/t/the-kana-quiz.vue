...
const content = `<path class="fybf5q98x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:the-kana-quiz" /></template>
<style>
.fybf5q98x {
  fill: none;
  stroke: currentColor;
