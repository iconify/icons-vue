...
const content = `<path class="plkl-bd4d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-left-outline-sharp" /></template>
<style>
.plkl-bd4d {
  fill: currentColor;
