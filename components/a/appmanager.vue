...
const content = `<path class="eirtrm6gp"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:appmanager" /></template>
<style>
.eirtrm6gp {
  fill: none;
  stroke: currentColor;
