...
const content = `<path class="zfj0te1mw"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gls-banking" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
