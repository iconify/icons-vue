...
const content = `<g class="nrj6p8qat"><path class="r63fawbfm"/><path class="w8wjawbcc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:app-check-duotone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
