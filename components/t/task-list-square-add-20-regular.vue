...
const content = `<path class="g71xjx1hd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:task-list-square-add-20-regular" /></template>
<style>
.g71xjx1hd {
  fill: currentColor;
