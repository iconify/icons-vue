...
const content = `<g class="ft5dv1b6b"><path class="htr-ycchg"/><path fill="url(#SVGLgVlpb5Y)" class="w_kw0uaib"/><path class="j7bhr3bqe"/><path class="cpnzno72f"/><path class="tu1jhr0hp"/><path class="dt81rnbno"/><defs><linearGradient id="SVGLgVlpb5Y" x1="8.343" x2="15.374" y1="3.844" y2="20.437" gradientUnits="userSpaceOnUse"><stop class="pi5g78zuk"/><stop offset="1" class="pue33vb4s"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:scs" /></template>
<style>
.cpnzno72f {
  fill: var(--svg-color--1f232a, #1f232a);
  d: path("m16.499 9.089l.265.794l-3.441-3.441l.529 2.912l4.235 3.97l.794 1.853l-6.617-5.559l-.265-5.294z");
}

.dt81rnbno {
  fill: var(--svg-color--d2d2d4, #d2d2d4);
  d: path("m10.66 11.407l.09.254l-1.164-1.101l.174.931l1.44 1.27l.27.594l-2.25-1.78l-.084-1.693z");
}
