...
const content = `<path clip-rule="evenodd" class="rd1fb_b7t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:letter-o" /></template>
<style>
.rd1fb_b7t {
