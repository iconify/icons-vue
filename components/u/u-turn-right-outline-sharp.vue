...
const content = `<path class="cw1eybbqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:u-turn-right-outline-sharp" /></template>
<style>
.cw1eybbqq {
  fill: currentColor;
