...
const content = `<path class="w13zo4b6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:thread-unread-outline-sharp" /></template>
<style>
.w13zo4b6u {
  fill: currentColor;
