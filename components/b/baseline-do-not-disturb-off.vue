...
const content = `<path class="vksdqacuh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-do-not-disturb-off" /></template>
<style>
.vksdqacuh {
  fill: currentColor;
