...
const content = `<path class="ca81x8twb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:change-circle-sharp" /></template>
<style>
.ca81x8twb {
  fill: currentColor;
