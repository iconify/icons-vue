...
const content = `<path class="xr_7c5b_h"/><path class="r6yz-bt3i"/><path class="nqu_d-rjo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-light-testjs" /></template>
<style>
.nqu_d-rjo {
