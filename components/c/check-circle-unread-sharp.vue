...
const content = `<path class="e16hubbig"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:check-circle-unread-sharp" /></template>
<style>
.e16hubbig {
  fill: currentColor;
