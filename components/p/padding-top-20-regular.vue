...
const content = `<path class="s51bzi0_x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:padding-top-20-regular" /></template>
<style>
.s51bzi0_x {
  fill: currentColor;
