...
const content = `<path class="ixuz6lu9q"/><path class="m7j8yp7zv"/><path class="d-jqbc8mm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-honduras" /></template>
<style>
.d-jqbc8mm {
