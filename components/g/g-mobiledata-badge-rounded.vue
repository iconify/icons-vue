...
const content = `<path class="wi5raccqd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:g-mobiledata-badge-rounded" /></template>
<style>
.wi5raccqd {
  fill: currentColor;
