...
const content = `<path class="h5-ys0-1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:queue-play-next-outline" /></template>
<style>
.h5-ys0-1m {
  fill: currentColor;
