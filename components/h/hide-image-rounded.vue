...
const content = `<path class="bkh8rqeqb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:hide-image-rounded" /></template>
<style>
.bkh8rqeqb {
  fill: currentColor;
