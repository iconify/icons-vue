...
const content = `<path class="bijjuibvu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-true-radiant-outline-rounded" /></template>
<style>
.bijjuibvu {
  fill: currentColor;
