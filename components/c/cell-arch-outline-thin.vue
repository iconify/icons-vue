...
const content = `<g class="hntgybcog"><path class="jutdvybnj"/><path class="wumf77bxt"/><path class="wi71wvbqq"/><path class="bg56fj76r"/><path class="a6z1jcjqs"/><path class="ivqg9reic"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:cell-arch-outline-thin" /></template>
<style>
.a6z1jcjqs {
