...
const content = `<path class="ufal6wbyt"/><path class="v8qc18bax"/><path class="m91xxid2v"/><path class="apd4j2b9j"/><path class="x1lu53b3w"/><path class="egv546b5j"/><path class="exiviuvxp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:woman-gesturing-ok-medium-light-skin-tone" /></template>
<style>
.apd4j2b9j {
