...
const content = `<path class="omeybbcfr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:navigation-unread-24-regular" /></template>
<style>
.omeybbcfr {
  fill: currentColor;
