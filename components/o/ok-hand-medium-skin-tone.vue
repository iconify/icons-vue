...
const content = `<path class="s4j0_-ljr"/><path class="oq6akfx4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:ok-hand-medium-skin-tone" /></template>
<style>
.oq6akfx4n {
