...
const content = `<path class="kz2u64btg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wb-auto-rounded" /></template>
<style>
.kz2u64btg {
  fill: currentColor;
