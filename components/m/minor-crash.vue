...
const content = `<path class="p429d_0za"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:minor-crash" /></template>
<style>
.p429d_0za {
  fill: currentColor;
