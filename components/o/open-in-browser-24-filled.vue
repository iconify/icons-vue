...
const content = `<path class="y3mkarycd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:open-in-browser-24-filled" /></template>
<style>
.y3mkarycd {
