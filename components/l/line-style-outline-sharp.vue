...
const content = `<path class="lzd357bxy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:line-style-outline-sharp" /></template>
<style>
.lzd357bxy {
  fill: currentColor;
