...
const content = `<path class="ncu79f3tf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:print-add-24-regular" /></template>
<style>
.ncu79f3tf {
  fill: currentColor;
