...
const content = `<circle class="cpk0fnbgt"/><path class="gu-4a4vtg"/><path class="aled8t47q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:slowly" /></template>
<style>
.aled8t47q {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M32.946 20.076a2.12 2.12 0 0 0 1.552.422h.423a1.25 1.25 0 0 0 1.247-1.25h0a1.25 1.25 0 0 0-1.247-1.25h-.847a1.25 1.25 0 0 1-1.247-1.25h0a1.25 1.25 0 0 1 1.247-1.25h.424a2.12 2.12 0 0 1 1.551.422");
}
