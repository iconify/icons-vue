...
const content = `<path class="vgjt5cbta"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:landscape-2-sharp" /></template>
<style>
.vgjt5cbta {
  fill: currentColor;
