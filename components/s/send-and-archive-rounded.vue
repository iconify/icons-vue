...
const content = `<path class="ffro11_8i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:send-and-archive-rounded" /></template>
<style>
.ffro11_8i {
  fill: currentColor;
