...
const content = `<path class="bpxzscbfw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:security-update-good-outline-rounded" /></template>
<style>
.bpxzscbfw {
  fill: currentColor;
