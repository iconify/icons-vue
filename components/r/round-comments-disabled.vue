...
const content = `<path class="gwwp2scfr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-comments-disabled" /></template>
<style>
.gwwp2scfr {
  fill: currentColor;
