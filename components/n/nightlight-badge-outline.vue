...
const content = `<path class="w5gy6iboy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nightlight-badge-outline" /></template>
<style>
.w5gy6iboy {
  fill: currentColor;
