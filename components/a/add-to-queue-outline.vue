...
const content = `<path class="bbi9t0bnr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:add-to-queue-outline" /></template>
<style>
.bbi9t0bnr {
  fill: currentColor;
