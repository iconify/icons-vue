...
const content = `<path class="w27-kqa2p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vpn-key-rounded" /></template>
<style>
.w27-kqa2p {
  fill: currentColor;
