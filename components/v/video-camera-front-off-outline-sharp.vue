...
const content = `<path class="baowbxa0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:video-camera-front-off-outline-sharp" /></template>
<style>
.baowbxa0q {
  fill: currentColor;
