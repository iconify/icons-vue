...
const content = `<path class="g8735r-je"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:coffee-sharp" /></template>
<style>
.g8735r-je {
  fill: none;
  stroke: currentColor;
