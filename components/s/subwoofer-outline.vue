...
const content = `<path class="goisri8lh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:subwoofer-outline" /></template>
<style>
.goisri8lh {
  fill: currentColor;
