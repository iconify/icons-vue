...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-call-duotone" /></template>
<style>
.n802joiny {
  fill: currentColor;
...
.wqk-npb9m {
  d: path("M14.0706 4.2726C16.8313 5.0123 18.9877 7.1687 19.7274 9.9294M13.0353 8.1363C14.4156 8.5062 15.4938 9.5844 15.8637 10.9647");
}
