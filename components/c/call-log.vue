...
const content = `<path class="qpa141bys"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:call-log" /></template>
<style>
.qpa141bys {
  fill: currentColor;
