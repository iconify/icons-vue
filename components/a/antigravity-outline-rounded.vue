...
const content = `<path class="t0w-n1bxf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:antigravity-outline-rounded" /></template>
<style>
.t0w-n1bxf {
  fill: currentColor;
