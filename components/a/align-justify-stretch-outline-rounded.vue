...
const content = `<path class="z6_94qbzc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-justify-stretch-outline-rounded" /></template>
<style>
.z6_94qbzc {
  fill: currentColor;
