...
const content = `<path class="l3gwa_w9y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-rotate-outline-sharp" /></template>
<style>
.l3gwa_w9y {
  fill: currentColor;
