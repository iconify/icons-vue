...
const content = `<path class="gwy96wbkk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:move-selection-left-outline" /></template>
<style>
.gwy96wbkk {
  fill: currentColor;
