...
const content = `<path class="g6s25zbaf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:humidity-percentage-outline-sharp" /></template>
<style>
.g6s25zbaf {
  fill: currentColor;
