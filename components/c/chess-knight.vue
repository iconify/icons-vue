...
const content = `<path class="dqx9vabky"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chess-knight" /></template>
<style>
.dqx9vabky {
  fill: currentColor;
