...
const content = `<path class="i2o133b3i"/><path class="zsfw75g9a"/><path class="h58dnjnea"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-flag-circle" /></template>
<style>
.h58dnjnea {
  fill: currentColor;
