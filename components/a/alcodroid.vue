...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:alcodroid" /></template>
<style>
.oe_9_fboo {
  fill: none;
  stroke: currentColor;
...
.ta40141ci {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M21.88 21.78c-.54.16-1.11-.15-1.27-.69s.15-1.11.69-1.27s1.11.15 1.27.69c0 .02 0 .03.01.05c.14.53-.17 1.07-.7 1.23Zm5.69-1.65c-.54.16-1.11-.15-1.27-.69s.15-1.11.69-1.27s1.11.15 1.27.69c0 .02 0 .03.01.05c.14.53-.17 1.07-.7 1.23Z");
}
