...
const content = `<path class="xjs-s8bld"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-record-24-filled" /></template>
<style>
.xjs-s8bld {
  fill: currentColor;
