...
const content = `<path class="ha7ewhb2z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dock-panel-left-20-regular" /></template>
<style>
.ha7ewhb2z {
  fill: currentColor;
