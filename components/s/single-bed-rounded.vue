...
const content = `<path class="eogfm-lfn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:single-bed-rounded" /></template>
<style>
.eogfm-lfn {
  fill: currentColor;
