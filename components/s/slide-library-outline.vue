...
const content = `<path class="w4dg1u_0d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:slide-library-outline" /></template>
<style>
.w4dg1u_0d {
  fill: currentColor;
