...
const content = `<path class="f9rjpcc3b"/><path class="epjr_3b3w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-light-yaml-official" /></template>
<style>
.epjr_3b3w {
