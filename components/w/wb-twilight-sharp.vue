...
const content = `<path class="vxq6qkb4h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wb-twilight-sharp" /></template>
<style>
.vxq6qkb4h {
  fill: currentColor;
