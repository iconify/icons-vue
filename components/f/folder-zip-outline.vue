...
const content = `<path class="f5g2-26hd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:folder-zip-outline" /></template>
<style>
.f5g2-26hd {
  fill: currentColor;
