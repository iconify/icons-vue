...
const content = `<path class="c_579jzrl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-multiple-20-filled" /></template>
<style>
.c_579jzrl {
  fill: currentColor;
