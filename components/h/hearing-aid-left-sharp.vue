...
const content = `<path class="qnyolkb4t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hearing-aid-left-sharp" /></template>
<style>
.qnyolkb4t {
  fill: currentColor;
