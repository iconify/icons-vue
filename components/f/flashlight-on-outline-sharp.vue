...
const content = `<path class="bl3ip1bzk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:flashlight-on-outline-sharp" /></template>
<style>
.bl3ip1bzk {
  fill: currentColor;
