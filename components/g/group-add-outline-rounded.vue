...
const content = `<path class="ht2yph1wl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:group-add-outline-rounded" /></template>
<style>
.ht2yph1wl {
  fill: currentColor;
