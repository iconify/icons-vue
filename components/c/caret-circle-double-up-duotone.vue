...
const content = `<g class="cuyn6tgcc"><path class="c9epvhehk"/><path class="chbia0bnw"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-circle-double-up-duotone" /></template>
<style>
.c9epvhehk {
