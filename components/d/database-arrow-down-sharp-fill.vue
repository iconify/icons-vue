...
const content = `<g class="gp_8x1bzb"><path clip-rule="evenodd" class="zv_0vqboe"/><path class="de8pmevzp"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-down-sharp-fill" /></template>
<style>
.de8pmevzp {
