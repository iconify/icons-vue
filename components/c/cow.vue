...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGjvRFMaAt)" class="jf49wj1am"/><defs><linearGradient id="SVGjvRFMaAt" x1="21" x2="3" y1="12" y2="12" gradientUnits="userSpaceOnUse"><stop class="n8kfc7bbu"/><stop offset=".52" class="wneoblbgp"/><stop offset="1" class="vc--wpv5i"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:cow" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
