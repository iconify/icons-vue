...
const content = `<path class="jbjzlsrqx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-settings-input-composite" /></template>
<style>
.jbjzlsrqx {
  fill: currentColor;
