...
const content = `<path class="ukrbhqb6c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-align-center-outline-rounded" /></template>
<style>
.ukrbhqb6c {
  fill: currentColor;
