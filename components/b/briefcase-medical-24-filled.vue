...
const content = `<path class="u38yp1sje"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:briefcase-medical-24-filled" /></template>
<style>
.u38yp1sje {
  fill: currentColor;
