...
const content = `<path class="m1atmokqx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:blokada" /></template>
<style>
.m1atmokqx {
  fill: none;
  stroke: currentColor;
