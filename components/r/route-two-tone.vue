...
const content = `<g class="nrj6p8qat"><path class="ahwfs1brb"/><path class="m0ajx4-ou"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:route-two-tone" /></template>
<style>
.ahwfs1brb {
  fill: currentColor;
