...
const content = `<path class="jubx-fz_z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-space-between-outline-rounded" /></template>
<style>
.jubx-fz_z {
  fill: currentColor;
