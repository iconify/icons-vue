...
const content = `<path class="he1-hzb7a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:touch-triple" /></template>
<style>
.he1-hzb7a {
  fill: currentColor;
