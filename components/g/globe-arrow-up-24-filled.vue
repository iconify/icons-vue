...
const content = `<path class="gv4cowbkc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-arrow-up-24-filled" /></template>
<style>
.gv4cowbkc {
  fill: currentColor;
