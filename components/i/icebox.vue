...
const content = `<path class="uutexgbar"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:icebox" /></template>
<style>
.uutexgbar {
  fill: none;
  stroke: currentColor;
