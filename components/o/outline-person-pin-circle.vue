...
const content = `<path class="ee-6efb-z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-person-pin-circle" /></template>
<style>
.ee-6efb-z {
  fill: currentColor;
