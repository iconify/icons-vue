...
const content = `<path class="f9aw_3bgf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-through-20-regular" /></template>
<style>
.f9aw_3bgf {
  fill: currentColor;
