...
const content = `<path class="oyz571vjx"/><path class="rv-lao2xl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:trackbook" /></template>
<style>
.oyz571vjx {
  fill: none;
  stroke: currentColor;
