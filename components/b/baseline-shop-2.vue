...
const content = `<path class="vcg6jsbkc"/><path class="m2lf9ebbd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-shop-2" /></template>
<style>
.m2lf9ebbd {
  fill: currentColor;
