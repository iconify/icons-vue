...
const content = `<path class="cpwn33b3t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:resize-video-24-filled" /></template>
<style>
.cpwn33b3t {
  fill: currentColor;
