...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="u5wdidcil"/><path class="gxyhfzbqm"/><path clip-rule="evenodd" class="opgn6fput"/><path class="ao4xsubva"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:train-off" /></template>
<style>
.ao4xsubva {
  d: path("M4.75 18.25v-1.5h10.501v1.5zM1.293 2.707a1 1 0 0 1 1.414-1.414l16 16a1 1 0 0 1-1.414 1.414z");
}
