...
const content = `<path class="iprsfxb8l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:draft-orders-sharp" /></template>
<style>
.iprsfxb8l {
  fill: currentColor;
