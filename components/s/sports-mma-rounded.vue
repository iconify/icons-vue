...
const content = `<path class="qy40xdvnx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sports-mma-rounded" /></template>
<style>
.qy40xdvnx {
  fill: currentColor;
