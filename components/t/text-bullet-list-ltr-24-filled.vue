...
const content = `<path class="ddca9rd-a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-bullet-list-ltr-24-filled" /></template>
<style>
.ddca9rd-a {
  fill: currentColor;
