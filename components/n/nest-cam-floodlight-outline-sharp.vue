...
const content = `<path class="oomnj1biq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-cam-floodlight-outline-sharp" /></template>
<style>
.oomnj1biq {
  fill: currentColor;
