...
const content = `<path class="g1hhmebjo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:item-compare-20-regular" /></template>
<style>
.g1hhmebjo {
  fill: currentColor;
