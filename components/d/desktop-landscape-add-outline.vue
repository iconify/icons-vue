...
const content = `<path class="ixd6adczi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:desktop-landscape-add-outline" /></template>
<style>
.ixd6adczi {
  fill: currentColor;
