...
const content = `<path class="xu3__7-nl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-header-arrow-up-24-filled" /></template>
<style>
.xu3__7-nl {
  fill: currentColor;
