...
const content = `<path class="x9vr6fb0u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:lab-panel-rounded" /></template>
<style>
.x9vr6fb0u {
  fill: currentColor;
