...
const content = `<path class="cof3_havm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kapook" /></template>
<style>
.cof3_havm {
  fill: none;
  stroke: currentColor;
