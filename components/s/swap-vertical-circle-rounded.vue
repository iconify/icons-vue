...
const content = `<path class="ukcwsbcdc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swap-vertical-circle-rounded" /></template>
<style>
.ukcwsbcdc {
  fill: currentColor;
