...
const content = `<path class="cg7a82zce"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:room-service-outline" /></template>
<style>
.cg7a82zce {
  fill: currentColor;
