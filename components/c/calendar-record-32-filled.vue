...
const content = `<path class="x2vk-kxbw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-record-32-filled" /></template>
<style>
.x2vk-kxbw {
  fill: currentColor;
