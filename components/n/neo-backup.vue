...
const content = `<path class="p8t2csbzk"/><path class="wu8uxvb8r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:neo-backup" /></template>
<style>
.p8t2csbzk {
  fill: none;
  stroke: currentColor;
