...
const content = `<path class="z2at4hbsu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:navigation-48-filled" /></template>
<style>
.z2at4hbsu {
  fill: currentColor;
