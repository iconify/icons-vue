...
const content = `<path class="mr_3k518f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:grouped-bar-chart-outline-rounded" /></template>
<style>
.mr_3k518f {
  fill: currentColor;
