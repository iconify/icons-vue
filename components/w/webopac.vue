...
const content = `<path class="hzm34tb4z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:webopac" /></template>
<style>
.hzm34tb4z {
  fill: none;
  stroke: currentColor;
