...
const content = `<path class="byegxrb7i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-warning-20-regular" /></template>
<style>
.byegxrb7i {
  fill: currentColor;
