...
const content = `<g class="cuyn6tgcc"><path class="adtorrbbm"/><path class="vw-i6hb8g"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:angle-left-circle-off" /></template>
<style>
.adtorrbbm {
