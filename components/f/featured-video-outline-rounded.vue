...
const content = `<path class="f6tl894uo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:featured-video-outline-rounded" /></template>
<style>
.f6tl894uo {
  fill: currentColor;
