...
const content = `<path class="tjs4g1b7x"/><path class="cnms0g_9c"/><path class="k62wvgxmt"/><circle class="kg5q9ub6a"/><path class="hxgoe3b7m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:microsoft-edge-canary" /></template>
<style>
.cnms0g_9c {
  fill: none;
  stroke: currentColor;
...
.hxgoe3b7m {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M41.15 10.817v.033a2.65 2.65 0 0 1-2.65 2.65a2.65 2.65 0 0 1-2.65-2.65v-2.7A2.65 2.65 0 0 1 38.5 5.5a2.65 2.65 0 0 1 2.65 2.65v.033");
}
