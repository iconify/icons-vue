...
const content = `<path class="sn6wtoh4z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:poll-horizontal-20-regular" /></template>
<style>
.sn6wtoh4z {
  fill: currentColor;
