...
const content = `<path class="htofd9bcd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-open-lightbulb-24-filled" /></template>
<style>
.htofd9bcd {
  fill: currentColor;
