...
const content = `<path class="zyj6q1b0m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:currency-dollar-simple-bold" /></template>
<style>
.zyj6q1b0m {
  fill: currentColor;
