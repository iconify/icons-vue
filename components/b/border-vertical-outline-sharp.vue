...
const content = `<path class="hh8w2rbbk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:border-vertical-outline-sharp" /></template>
<style>
.hh8w2rbbk {
  fill: currentColor;
