...
const content = `<g class="gp_8x1bzb"><path class="g70whwsdk"/><path class="wyuzi1brr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-dollar-sign-sharp-duotone" /></template>
<style>
.g70whwsdk {
  fill: currentColor;
