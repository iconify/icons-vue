...
const content = `<path class="jdnfv91sl"/><path class="fee65qlzp"/><path class="u21mhof7x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:heart-hands-light-skin-tone" /></template>
<style>
.fee65qlzp {
