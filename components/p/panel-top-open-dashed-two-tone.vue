...
const content = `<g class="nrj6p8qat"><path class="ttdlueb2i"/><path class="kodnftbvm"/><path class="ucl0xbbjf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:panel-top-open-dashed-two-tone" /></template>
<style>
.kodnftbvm {
