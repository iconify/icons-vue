...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:grid-3x2-duotone" /></template>
<style>
.l1a2lyb3a {
  d: path("M9 5L9 19M15 5L15 19M5 12L19 12");
}
