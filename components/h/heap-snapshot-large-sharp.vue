...
const content = `<path class="oqc298huz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:heap-snapshot-large-sharp" /></template>
<style>
.oqc298huz {
  fill: currentColor;
