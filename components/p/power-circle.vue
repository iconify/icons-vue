...
const content = `<g class="cuyn6tgcc"><g transform="translate(3 3)"><path class="qi4azoban"/><rect class="t9nly_bze"/></g><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:power-circle" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
