...
const content = `<path class="pkaol1l4t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:skull-outline-rounded" /></template>
<style>
.pkaol1l4t {
  fill: currentColor;
