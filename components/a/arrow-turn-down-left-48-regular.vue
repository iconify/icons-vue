...
const content = `<path class="qf6txdbub"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-turn-down-left-48-regular" /></template>
<style>
.qf6txdbub {
  fill: currentColor;
