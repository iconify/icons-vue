...
const content = `<path class="ayqsjlbst"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ballot-rounded" /></template>
<style>
.ayqsjlbst {
  fill: currentColor;
