...
.sqe_5esuq {
  cx: 128px;
  cy: 67.3px;
  fill: var(--svg-color--6181b6, #6181b6);
  rx: 123px;
  ry: 62.3px;
}
...
.ydtw3pgom {
  stop-color: var(--svg-color--4c6b97, #4c6b97);
}
