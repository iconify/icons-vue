...
const content = `<path class="qxf_pdnzz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bluetooth-drive-outline-sharp" /></template>
<style>
.qxf_pdnzz {
  fill: currentColor;
