...
const content = `<path class="uy48eebek"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:photo-library-sharp" /></template>
<style>
.uy48eebek {
  fill: currentColor;
