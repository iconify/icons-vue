...
const content = `<path class="wm272m88v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ttb-touch" /></template>
<style>
.wm272m88v {
  fill: none;
  stroke: currentColor;
