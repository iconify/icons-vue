...
const content = `<path class="mj3dtlywu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stylus-note-outline" /></template>
<style>
.mj3dtlywu {
  fill: currentColor;
