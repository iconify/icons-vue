...
const content = `<g class="nrj6p8qat"><path class="lfpevtz9v"/><path class="k4tuz2b5x"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:terminal-cursor-two-tone" /></template>
<style>
.k4tuz2b5x {
