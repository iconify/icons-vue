...
const content = `<path class="so8dcfi6b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-grammar-error-20-regular" /></template>
<style>
.so8dcfi6b {
  fill: currentColor;
