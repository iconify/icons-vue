...
const content = `<path class="zhcm5sbma"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ramp-left-outline-rounded" /></template>
<style>
.zhcm5sbma {
  fill: currentColor;
