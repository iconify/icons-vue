...
const content = `<path class="p3j_z3b3t"/><path class="p4genybfv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kitchen-philips" /></template>
<style>
.p3j_z3b3t {
  fill: none;
  stroke: currentColor;
...
.p4genybfv {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M20.98 36.413H10.903a2.186 2.186 0 0 1-2.165-1.88L5.5 11.626h2.666l.613 4.266a6.5 6.5 0 0 1 3.024-.343c1.504.187 2.887.888 4.278 1.492c1.115.484 2.282.915 3.497.956a5.65 5.65 0 0 0 2.743-.61l.862-5.8h2.783L23.75 26.99");
}
