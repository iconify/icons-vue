...
const content = `<path class="gpaiyqbpx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bnagent-rounded" /></template>
<style>
.gpaiyqbpx {
  fill: currentColor;
