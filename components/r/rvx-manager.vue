...
const content = `<path class="kr2ugpbzl"/><path class="qtjnscbaa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:rvx-manager" /></template>
<style>
.kr2ugpbzl {
  fill: none;
  stroke: currentColor;
