...
const content = `<path class="lof4m3bed"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:organization-48-filled" /></template>
<style>
.lof4m3bed {
  fill: currentColor;
