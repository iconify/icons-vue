...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGLNyCNdOZ)" clip-rule="evenodd" class="e2pv2rbit"/><defs><linearGradient id="SVGLNyCNdOZ" x1="2.839" x2="21.161" y1="12.166" y2="11.831" gradientUnits="userSpaceOnUse"><stop class="cgzdpwb5o"/><stop offset=".49" class="otegc2b8w"/><stop offset="1" class="d8vw4dhcb"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:manta-pacific" /></template>
<style>
.cgzdpwb5o {
