...
const content = `<path class="uhk2wob8g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:headphones-sound-wave-20-filled" /></template>
<style>
.uhk2wob8g {
  fill: currentColor;
