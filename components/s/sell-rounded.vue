...
const content = `<path class="f5zkk-bss"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sell-rounded" /></template>
<style>
.f5zkk-bss {
  fill: currentColor;
