...
const content = `<path class="zkwbljbjt"/><rect class="thg6gcchx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:xbox-gamepass" /></template>
<style>
.thg6gcchx {
  width: 39px;
  height: 28px;
