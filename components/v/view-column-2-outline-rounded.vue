...
const content = `<path class="e_qdqfbdb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:view-column-2-outline-rounded" /></template>
<style>
.e_qdqfbdb {
  fill: currentColor;
