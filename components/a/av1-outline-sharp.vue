...
const content = `<path class="irfqwbbft"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:av1-outline-sharp" /></template>
<style>
.irfqwbbft {
  fill: currentColor;
