...
const content = `<path class="ob62uccnn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:rectangle-landscape-sync-off-16-filled" /></template>
<style>
.ob62uccnn {
  fill: currentColor;
