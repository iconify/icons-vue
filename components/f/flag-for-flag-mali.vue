...
const content = `<path class="dit4mcb9r"/><path class="arudnqcpi"/><path class="ae9eq6qay"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-mali" /></template>
<style>
.ae9eq6qay {
