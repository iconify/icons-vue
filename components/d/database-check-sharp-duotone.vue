...
const content = `<g class="gp_8x1bzb"><path class="uordzqcti"/><path clip-rule="evenodd" class="r0p7iiqoh"/><path class="hqhuvccbb"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-check-sharp-duotone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.hqhuvccbb {
  d: path("M14.7071 18.7071L17 21L21.2929 16.7071");
}
