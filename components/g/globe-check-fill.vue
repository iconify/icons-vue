...
const content = `<g class="nrj6p8qat"><path class="gcrhrmmun"/><path class="u1m3wobsk"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:globe-check-fill" /></template>
<style>
.gcrhrmmun {
  fill: currentColor;
