...
const content = `<g class="dz-kf-l3n"><path class="zrzdhyqpt"/><circle class="btjyjgnlx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:dotted-six-pointed-star" /></template>
<style>
.btjyjgnlx {
  cx: 64px;
  cy: 64.51px;
