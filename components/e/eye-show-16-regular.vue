...
const content = `<g class="ft5dv1b6b"><path class="heuurj2jw"/><path class="oz3xksbhr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:eye-show-16-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
