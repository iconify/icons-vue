...
const content = `<path class="zzyf9-41q"/><path class="mfs7-u_9i"/><path class="qo6etfbxu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-cote-divoire" /></template>
<style>
.mfs7-u_9i {
