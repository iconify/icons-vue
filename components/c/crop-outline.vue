...
const content = `<path class="ehdeubbff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:crop-outline" /></template>
<style>
.ehdeubbff {
  fill: currentColor;
