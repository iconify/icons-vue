...
const content = `<path class="smcnx5dyh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:papers" /></template>
<style>
.smcnx5dyh {
  fill: none;
  stroke: currentColor;
