...
const content = `<path class="axo7fgphb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mobizen" /></template>
<style>
.axo7fgphb {
  fill: none;
  stroke: currentColor;
