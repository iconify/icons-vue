...
const content = `<path class="cw6xnfbgn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dapnet" /></template>
<style>
.cw6xnfbgn {
  fill: none;
  stroke: currentColor;
