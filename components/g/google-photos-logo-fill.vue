...
const content = `<path class="o1eoztm7z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:google-photos-logo-fill" /></template>
<style>
.o1eoztm7z {
  fill: currentColor;
