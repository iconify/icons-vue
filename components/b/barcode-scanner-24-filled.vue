...
const content = `<path class="ruluqwbyd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:barcode-scanner-24-filled" /></template>
<style>
.ruluqwbyd {
  fill: currentColor;
