...
const content = `<path class="g-ami6b_j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-right-20-regular" /></template>
<style>
.g-ami6b_j {
  fill: currentColor;
