...
const content = `<path class="wponzw-9c"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pdf-viewer" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
