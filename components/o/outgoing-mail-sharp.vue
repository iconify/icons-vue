...
const content = `<path class="olbyjqbeo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:outgoing-mail-sharp" /></template>
<style>
.olbyjqbeo {
  fill: currentColor;
