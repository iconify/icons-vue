...
const content = `<path class="eb--k9bau"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:house-rounded" /></template>
<style>
.eb--k9bau {
  fill: currentColor;
