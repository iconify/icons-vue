...
const content = `<path class="ll0g54h-q"/><path class="dxt7wkb3p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:portscanner" /></template>
<style>
.dxt7wkb3p {
  fill: none;
  stroke: currentColor;
