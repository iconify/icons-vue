...
const content = `<path class="foanumbwf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-offset-settings-24-filled" /></template>
<style>
.foanumbwf {
  fill: currentColor;
