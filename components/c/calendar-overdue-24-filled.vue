...
const content = `<g class="ft5dv1b6b"><path class="h9m3co9vh"/><path class="w_6lwrujz"/><path class="zle4cq05a"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-overdue-24-filled" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
