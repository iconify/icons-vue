...
const content = `<path class="lpm21vb-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:finance-chip-rounded" /></template>
<style>
.lpm21vb-j {
  fill: currentColor;
