...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:git-pull-request-sharp-duotone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.pyjjdwn5w {
  d: path("M6 22L6 9M18 15L18 6L12 6");
}
