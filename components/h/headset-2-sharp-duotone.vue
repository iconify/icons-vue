...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:headset-2-sharp-duotone" /></template>
<style>
.g5-_p6opp {
  fill: currentColor;
...
.qkdn1h9sf {
  stroke-opacity: 0.4;
  d: path("M4 10C4 5.5817 7.5817 2 12 2C16.4183 2 20 5.5817 20 10M18 17L18 21L14 21");
}
