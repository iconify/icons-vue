...
const content = `<path class="fnzlhv3pl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:youtube-video-outline-rounded" /></template>
<style>
.fnzlhv3pl {
  fill: currentColor;
