...
const content = `<path class="zeltu_tuy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:perm-media-rounded" /></template>
<style>
.zeltu_tuy {
  fill: currentColor;
