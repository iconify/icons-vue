...
const content = `<path class="grk5etbjv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:movie-edit-outline-sharp" /></template>
<style>
.grk5etbjv {
  fill: currentColor;
