...
const content = `<path class="bsscs7b6k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-checkmark-20-regular" /></template>
<style>
.bsscs7b6k {
  fill: currentColor;
