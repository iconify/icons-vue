...
const content = `<circle class="iavtnqbjc"/><path class="dqx63ybwo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:audile" /></template>
<style>
.dqx63ybwo {
  fill: none;
  stroke: currentColor;
