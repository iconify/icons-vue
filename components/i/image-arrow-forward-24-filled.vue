...
const content = `<path class="r4ba-s5iq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-arrow-forward-24-filled" /></template>
<style>
.r4ba-s5iq {
  fill: currentColor;
