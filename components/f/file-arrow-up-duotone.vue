...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="j_v2782vv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-arrow-up-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
