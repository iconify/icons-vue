...
const content = `<path class="l_3duj87p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:home-speaker-rounded" /></template>
<style>
.l_3duj87p {
  fill: currentColor;
