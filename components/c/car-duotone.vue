...
const content = `<g class="cuyn6tgcc"><path class="tyxksubxp"/><path class="i3p7xqhje"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:car-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.tyxksubxp {
  d: path("M184 176h40v24a8 8 0 0 1-8 8h-24a8 8 0 0 1-8-8ZM32 200a8 8 0 0 0 8 8h24a8 8 0 0 0 8-8v-24H32ZM194.11 44.75A8 8 0 0 0 186.8 40H69.2a8 8 0 0 0-7.31 4.75L32 112h192Z");
