...
const content = `<path class="o4y12ebih"/><path class="miryqp3yv"/><path class="c6v85ubqm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:purple-heart" /></template>
<style>
.c6v85ubqm {
