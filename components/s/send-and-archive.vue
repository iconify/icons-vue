...
const content = `<path class="octa1qeuk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:send-and-archive" /></template>
<style>
.octa1qeuk {
  fill: currentColor;
