...
const content = `<path class="cussxrxvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:movie-edit-off-rounded" /></template>
<style>
.cussxrxvo {
  fill: currentColor;
