...
const content = `<path class="vqa0dz98r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:moon-stars-sharp" /></template>
<style>
.vqa0dz98r {
  fill: currentColor;
