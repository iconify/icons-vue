...
const content = `<path class="jvv8qmbic"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-vibrate-24-regular" /></template>
<style>
.jvv8qmbic {
  fill: currentColor;
