...
const content = `<defs><linearGradient id="SVGte2wIbLN" x1="0%" x2="100%" y1="100%" y2="0%"><stop offset="0%" class="e5my0obpu"/><stop offset="100%" class="klvygvcib"/></linearGradient></defs><path fill="url(#SVGte2wIbLN)" class="tmbkaq7lv"/><path class="wpjvabc8u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:aws-rds" /></template>
<style>
.e5my0obpu {
