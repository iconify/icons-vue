...
const content = `<path class="dw20spbri"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:leaf-spark-sharp" /></template>
<style>
.dw20spbri {
  fill: currentColor;
