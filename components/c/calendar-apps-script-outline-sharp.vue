...
const content = `<path class="r1sg-oc4t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:calendar-apps-script-outline-sharp" /></template>
<style>
.r1sg-oc4t {
  fill: currentColor;
