...
const content = `<path class="noyrddscm"/><path class="s_7evzb-z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mail-com" /></template>
<style>
.noyrddscm {
  fill: none;
  stroke: currentColor;
