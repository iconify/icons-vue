...
const content = `<path class="n99eamblt"/><path class="kzykk8swa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-samsung-21" /></template>
<style>
.kzykk8swa {
  fill: none;
  stroke: currentColor;
