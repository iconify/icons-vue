...
const content = `<path class="an07wdb-q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-sports-baseball" /></template>
<style>
.an07wdb-q {
  fill: currentColor;
