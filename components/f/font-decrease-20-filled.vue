...
const content = `<path class="qk7edkx-k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:font-decrease-20-filled" /></template>
<style>
.qk7edkx-k {
  fill: currentColor;
