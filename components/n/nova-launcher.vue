...
const content = `<path class="w1aph59vd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nova-launcher" /></template>
<style>
.w1aph59vd {
  fill: none;
  stroke: currentColor;
