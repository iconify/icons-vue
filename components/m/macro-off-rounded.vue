...
const content = `<path class="pnn1pzb8c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:macro-off-rounded" /></template>
<style>
.pnn1pzb8c {
  fill: currentColor;
