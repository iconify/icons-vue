...
const content = `<path class="r0h61cbwh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-object-24-filled" /></template>
<style>
.r0h61cbwh {
  fill: currentColor;
