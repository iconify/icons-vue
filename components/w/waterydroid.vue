...
const content = `<path class="s__qe2sxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:waterydroid" /></template>
<style>
.s__qe2sxi {
  fill: none;
  stroke: currentColor;
