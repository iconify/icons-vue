...
const content = `<path class="io285fmdw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-checkmark-16-filled" /></template>
<style>
.io285fmdw {
  fill: currentColor;
