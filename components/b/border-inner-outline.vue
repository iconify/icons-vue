...
const content = `<path class="l_knogbbb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:border-inner-outline" /></template>
<style>
.l_knogbbb {
  fill: currentColor;
