...
const content = `<path class="b4pxh08kq"/><path class="klmh5xbek"/><path class="olfsqpegg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-carpentry-saw" /></template>
<style>
.b4pxh08kq {
  fill: none;
  stroke: currentColor;
