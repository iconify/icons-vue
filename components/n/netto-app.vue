...
const content = `<path class="i9clfwm2k"/><path class="zcqpg1tdb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:netto-app" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
