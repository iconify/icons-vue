...
const content = `<path class="lwk_b1a8o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:select-all-outline-sharp" /></template>
<style>
.lwk_b1a8o {
  fill: currentColor;
