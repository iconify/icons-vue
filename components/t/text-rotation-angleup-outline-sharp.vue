...
const content = `<path class="whoommbjo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-rotation-angleup-outline-sharp" /></template>
<style>
.whoommbjo {
  fill: currentColor;
