...
const content = `<path class="ct2iyebsd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-network-wifi-3-bar" /></template>
<style>
.ct2iyebsd {
  fill: currentColor;
