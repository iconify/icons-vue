...
const content = `<path class="x2kwg_a_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:stack-add-24-regular" /></template>
<style>
.x2kwg_a_k {
  fill: currentColor;
