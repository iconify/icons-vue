...
const content = `<path class="ea1uovbkz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:light-mode-rounded" /></template>
<style>
.ea1uovbkz {
  fill: currentColor;
