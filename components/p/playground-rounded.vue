...
const content = `<path class="nf-oqs_rx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:playground-rounded" /></template>
<style>
.nf-oqs_rx {
  fill: currentColor;
