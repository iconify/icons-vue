...
const content = `<path class="f9ebg7bei"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:expand-up-right-20-regular" /></template>
<style>
.f9ebg7bei {
  fill: currentColor;
