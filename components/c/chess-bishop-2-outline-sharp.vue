...
const content = `<path class="xnley2bpg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chess-bishop-2-outline-sharp" /></template>
<style>
.xnley2bpg {
  fill: currentColor;
