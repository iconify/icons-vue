...
const content = `<path class="t4tn9psyk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-off-24-filled" /></template>
<style>
.t4tn9psyk {
  fill: currentColor;
