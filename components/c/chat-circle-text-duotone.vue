...
const content = `<g class="cuyn6tgcc"><path class="dsr2iijaf"/><path class="e6hhw7yjs"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:chat-circle-text-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
