...
const content = `<path class="i9clfwm2k"/><path class="jsv8a57fo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:greenlight" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
