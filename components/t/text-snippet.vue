...
const content = `<path class="syunwkbdg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-snippet" /></template>
<style>
.syunwkbdg {
  fill: currentColor;
