...
const content = `<g class="cuyn6tgcc"><path class="s47_fcqxy"/><path class="nx8m7__0w"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:text-align-justify-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
