...
const content = `<path class="suybrdybg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:restaurant-outline-sharp" /></template>
<style>
.suybrdybg {
  fill: currentColor;
