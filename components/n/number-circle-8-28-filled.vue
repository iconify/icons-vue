...
const content = `<path class="qseynju1u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-8-28-filled" /></template>
<style>
.qseynju1u {
  fill: currentColor;
