...
const content = `<path class="cl2qxib8d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:projection-screen-16-regular" /></template>
<style>
.cl2qxib8d {
  fill: currentColor;
