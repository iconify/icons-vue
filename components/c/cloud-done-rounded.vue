...
const content = `<path class="k5l-dybtg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cloud-done-rounded" /></template>
<style>
.k5l-dybtg {
  fill: currentColor;
