...
const content = `<path class="ij5d1ac5m"/><path class="ts3-80b7e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:vk-music" /></template>
<style>
.ij5d1ac5m {
  fill: none;
  stroke: currentColor;
