...
const content = `<path class="jhc6qobqh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-import-24-filled" /></template>
<style>
.jhc6qobqh {
  fill: currentColor;
