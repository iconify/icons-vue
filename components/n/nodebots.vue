...
const content = `<path class="i-s5wym0d"/><path class="wenq2cckc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:nodebots" /></template>
<style>
.i-s5wym0d {
