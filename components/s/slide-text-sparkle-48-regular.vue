...
const content = `<path class="rwrt7cboy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-text-sparkle-48-regular" /></template>
<style>
.rwrt7cboy {
  fill: currentColor;
