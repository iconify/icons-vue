...
const content = `<path class="w1dgew86a"/><path class="gm2okh2jm"/><path class="ti19ytvcr"/><path class="iqkyaf50d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-palestinian-territories" /></template>
<style>
.gm2okh2jm {
