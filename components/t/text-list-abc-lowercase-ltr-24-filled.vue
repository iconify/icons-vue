...
const content = `<path class="zt1hqib4t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-list-abc-lowercase-ltr-24-filled" /></template>
<style>
.zt1hqib4t {
  fill: currentColor;
