...
const content = `<path class="gt-0bacjf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:momo-root-checker" /></template>
<style>
.gt-0bacjf {
  fill: none;
  stroke: currentColor;
