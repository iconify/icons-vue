...
const content = `<path class="qosnqrtio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:developer-board-outline" /></template>
<style>
.qosnqrtio {
  fill: currentColor;
