...
const content = `<path class="cqabw7b2d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:globe-2-question-outline-sharp" /></template>
<style>
.cqabw7b2d {
  fill: currentColor;
