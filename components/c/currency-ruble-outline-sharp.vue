...
const content = `<path class="nwxijmqss"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:currency-ruble-outline-sharp" /></template>
<style>
.nwxijmqss {
  fill: currentColor;
