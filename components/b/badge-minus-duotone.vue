...
const content = `<g class="nrj6p8qat"><path class="g70whwsdk"/><path class="xn4zvpbmt"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-minus-duotone" /></template>
<style>
.g70whwsdk {
  fill: currentColor;
