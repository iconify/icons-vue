...
const content = `<path class="nfr2nhd6f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-five-thin" /></template>
<style>
.nfr2nhd6f {
  fill: currentColor;
