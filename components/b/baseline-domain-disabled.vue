...
const content = `<path class="xurqvr9_h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-domain-disabled" /></template>
<style>
.xurqvr9_h {
  fill: currentColor;
