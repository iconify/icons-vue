...
const content = `<path class="ecjt37v7p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:caret-up-24-regular" /></template>
<style>
.ecjt37v7p {
  fill: currentColor;
