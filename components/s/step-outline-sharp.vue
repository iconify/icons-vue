...
const content = `<path class="i_03v87lv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:step-outline-sharp" /></template>
<style>
.i_03v87lv {
  fill: currentColor;
