...
const content = `<path class="waf58ub9v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-duotone" /></template>
<style>
.waf58ub9v {
  fill: none;
  stroke: currentColor;
