...
const content = `<path class="drgxc5beb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:camera-outdoor-outline" /></template>
<style>
.drgxc5beb {
  fill: currentColor;
