...
const content = `<path class="mmk-rlbgd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:weather-mix-outline-rounded" /></template>
<style>
.mmk-rlbgd {
  fill: currentColor;
