...
const content = `<path class="jy229kywq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mail-outline-rounded" /></template>
<style>
.jy229kywq {
  fill: currentColor;
