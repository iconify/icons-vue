...
const content = `<path class="inzm59b-e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-location-alt-outline" /></template>
<style>
.inzm59b-e {
  fill: currentColor;
