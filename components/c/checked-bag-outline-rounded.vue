...
const content = `<path class="z4nw0abuo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:checked-bag-outline-rounded" /></template>
<style>
.z4nw0abuo {
  fill: currentColor;
