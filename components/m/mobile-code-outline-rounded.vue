...
const content = `<path class="e0jmg6blq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobile-code-outline-rounded" /></template>
<style>
.e0jmg6blq {
  fill: currentColor;
