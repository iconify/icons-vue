...
const content = `<g class="cuyn6tgcc"><path class="z9xx151sb"/><path class="vf7ua06xa"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:palette-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
