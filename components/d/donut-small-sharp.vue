...
const content = `<path class="khmvehqtq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:donut-small-sharp" /></template>
<style>
.khmvehqtq {
  fill: currentColor;
