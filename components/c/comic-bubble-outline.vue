...
const content = `<path class="oey4grb3f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:comic-bubble-outline" /></template>
<style>
.oey4grb3f {
  fill: currentColor;
