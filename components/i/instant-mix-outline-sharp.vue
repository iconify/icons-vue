...
const content = `<path class="tvalyqwag"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:instant-mix-outline-sharp" /></template>
<style>
.tvalyqwag {
  fill: currentColor;
