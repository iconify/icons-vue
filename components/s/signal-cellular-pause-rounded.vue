...
const content = `<path class="zvh22zbmc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:signal-cellular-pause-rounded" /></template>
<style>
.zvh22zbmc {
  fill: currentColor;
