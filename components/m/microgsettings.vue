...
const content = `<path class="egcii3jzc"/><path class="mybosvb8k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:microgsettings" /></template>
<style>
.egcii3jzc {
  fill: none;
  stroke: currentColor;
...
.mybosvb8k {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M28.62 19.21a6.84 6.84 0 0 0-4.75-1.89a6.68 6.68 0 1 0 0 13.36a6.9 6.9 0 0 0 4.77-1.9l3.45 3.45a11.66 11.66 0 1 1-8.6-19.89h0a12 12 0 0 1 1.88.1a11.6 11.6 0 0 1 6.72 3.31Z");
}
