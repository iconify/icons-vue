...
const content = `<path class="rxjo_8bfs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:symphony-of-eternity" /></template>
<style>
.rxjo_8bfs {
  fill: none;
  stroke: currentColor;
