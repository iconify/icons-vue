...
const content = `<path class="eot-vlb2o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-a-photo-outline-sharp" /></template>
<style>
.eot-vlb2o {
  fill: currentColor;
