...
const content = `<path class="rr4d79bxk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-sync-16-regular" /></template>
<style>
.rr4d79bxk {
  fill: currentColor;
