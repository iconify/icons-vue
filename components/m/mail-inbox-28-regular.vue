...
const content = `<path class="ha011g_xc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-inbox-28-regular" /></template>
<style>
.ha011g_xc {
  fill: currentColor;
