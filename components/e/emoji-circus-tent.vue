...
const content = `<path class="kunnu1c-j"/><path class="cn82_9b1z"/><path class="eirbm1a2q"/><path class="kpyqlfbgu"/><path class="xnwnr5h2f"/><path class="eos99o0hr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-circus-tent" /></template>
<style>
.cn82_9b1z {
  fill: none;
  stroke: currentColor;
