...
const content = `<path class="p34ybybhy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobile-text-2-rounded" /></template>
<style>
.p34ybybhy {
  fill: currentColor;
