...
const content = `<path class="nt7e2olpx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:acute-outline-sharp" /></template>
<style>
.nt7e2olpx {
  fill: currentColor;
