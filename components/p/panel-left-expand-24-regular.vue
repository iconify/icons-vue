...
const content = `<path class="e9p8mdqqy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-expand-24-regular" /></template>
<style>
.e9p8mdqqy {
  fill: currentColor;
