...
const content = `<path class="aky0_66jf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mic-external-off-sharp" /></template>
<style>
.aky0_66jf {
  fill: currentColor;
