...
const content = `<path class="rj4eeubxd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-console-20-regular" /></template>
<style>
.rj4eeubxd {
  fill: currentColor;
