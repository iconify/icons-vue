...
const content = `<path class="c5k-md61j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:trackpad-input-outline" /></template>
<style>
.c5k-md61j {
  fill: currentColor;
