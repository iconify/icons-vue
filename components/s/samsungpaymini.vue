...
const content = `<rect class="jc1oydeao"/><path class="qscbn3byp"/><circle class="yl94lpfnl"/><path class="dy-vbrq6c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:samsungpaymini" /></template>
<style>
.dy-vbrq6c {
  fill: none;
  stroke: currentColor;
