...
const content = `<path class="ehe5c0bzy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:add-square-24-regular" /></template>
<style>
.ehe5c0bzy {
  fill: currentColor;
