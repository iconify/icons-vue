...
const content = `<path class="nxj71ccyl"/><circle class="l6cd208_p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-astonished-face" /></template>
<style>
.l6cd208_p {
  cx: 24px;
  cy: 24px;
