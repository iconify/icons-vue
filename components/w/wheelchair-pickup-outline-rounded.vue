...
const content = `<path class="tog6fdbiy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wheelchair-pickup-outline-rounded" /></template>
<style>
.tog6fdbiy {
  fill: currentColor;
