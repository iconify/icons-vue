...
const content = `<path class="rpuabibjb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:box-dismiss-24-regular" /></template>
<style>
.rpuabibjb {
  fill: currentColor;
