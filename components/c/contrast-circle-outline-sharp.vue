...
const content = `<path class="ogk1xcc9f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:contrast-circle-outline-sharp" /></template>
<style>
.ogk1xcc9f {
  fill: currentColor;
