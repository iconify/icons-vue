...
const content = `<path class="o02iqxbrk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:branding-watermark-rounded" /></template>
<style>
.o02iqxbrk {
  fill: currentColor;
