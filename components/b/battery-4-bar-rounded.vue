...
const content = `<path class="ijdg2qbpd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-4-bar-rounded" /></template>
<style>
.ijdg2qbpd {
  fill: currentColor;
