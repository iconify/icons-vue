...
const content = `<path class="so-wd__-t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:legend-toggle-outline-rounded" /></template>
<style>
.so-wd__-t {
  fill: currentColor;
