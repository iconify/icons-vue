...
const content = `<path class="dfhopgbha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:pencil-simple-slash-bold" /></template>
<style>
.dfhopgbha {
  fill: currentColor;
