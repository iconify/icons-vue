...
const content = `<path class="qvx709b0n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:subscript-outline" /></template>
<style>
.qvx709b0n {
  fill: currentColor;
