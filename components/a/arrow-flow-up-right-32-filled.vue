...
const content = `<path class="nyhu3jfur"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-flow-up-right-32-filled" /></template>
<style>
.nyhu3jfur {
  fill: currentColor;
