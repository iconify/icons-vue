...
const content = `<path class="dkq-3lbsb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:watch-arrow-outline-rounded" /></template>
<style>
.dkq-3lbsb {
  fill: currentColor;
