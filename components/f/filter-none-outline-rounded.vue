...
const content = `<path class="gnzt0cnzt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:filter-none-outline-rounded" /></template>
<style>
.gnzt0cnzt {
  fill: currentColor;
