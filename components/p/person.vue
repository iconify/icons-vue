...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="xte972wur"/><path class="p1nc4nb1r"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:person" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
