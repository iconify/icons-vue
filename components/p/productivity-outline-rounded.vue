...
const content = `<path class="sdy-djbbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:productivity-outline-rounded" /></template>
<style>
.sdy-djbbl {
  fill: currentColor;
