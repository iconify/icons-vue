...
const content = `<g class="nrj6p8qat"><path class="vevmidywk"/><path class="g65ozhcth"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:cloud-plus-duotone" /></template>
<style>
.g65ozhcth {
  d: path("M9.75 12.5L14.25 12.5M12 10.25L12 14.75");
}
