...
const content = `<path class="lubme8u8y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:instagram-threads" /></template>
<style>
.lubme8u8y {
  fill: none;
  stroke: currentColor;
