...
const content = `<path class="rbt-qybtn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:domain-verification-off-outline-sharp" /></template>
<style>
.rbt-qybtn {
  fill: currentColor;
