...
const content = `<path class="olhr0nb5k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:add-subtract-circle-28-filled" /></template>
<style>
.olhr0nb5k {
  fill: currentColor;
