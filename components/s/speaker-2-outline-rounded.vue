...
const content = `<path class="sxw87vxqh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:speaker-2-outline-rounded" /></template>
<style>
.sxw87vxqh {
  fill: currentColor;
