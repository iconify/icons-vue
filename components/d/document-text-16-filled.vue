...
const content = `<path class="owjeh6amk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-text-16-filled" /></template>
<style>
.owjeh6amk {
  fill: currentColor;
