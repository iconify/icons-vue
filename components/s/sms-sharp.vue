...
const content = `<path class="ja18ac3re"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sms-sharp" /></template>
<style>
.ja18ac3re {
  fill: currentColor;
