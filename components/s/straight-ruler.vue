...
const content = `<path class="x6h0y0bxi"/><circle class="x_s60mbue"/><circle class="w2d5_obpv"/><circle class="etnsftv4q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:straight-ruler" /></template>
<style>
.etnsftv4q {
  cx: 47.709px;
  cy: 50.284px;
