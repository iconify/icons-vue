...
const content = `<path class="e7dxnsb3n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hide-image-rounded" /></template>
<style>
.e7dxnsb3n {
  fill: currentColor;
