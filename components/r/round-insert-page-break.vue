...
const content = `<path class="owvc7no-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-insert-page-break" /></template>
<style>
.owvc7no-y {
  fill: currentColor;
