...
const content = `<path class="w6clud_ux"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:receipt-long-rounded" /></template>
<style>
.w6clud_ux {
  fill: currentColor;
