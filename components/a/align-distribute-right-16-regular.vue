...
const content = `<path class="ekco80rbf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-distribute-right-16-regular" /></template>
<style>
.ekco80rbf {
  fill: currentColor;
