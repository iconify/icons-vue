...
const content = `<path class="atsg-ac1n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:skip-backward-10-28-regular" /></template>
<style>
.atsg-ac1n {
  fill: currentColor;
