...
const content = `<path class="yv0mv-w8y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:conference-room-16-regular" /></template>
<style>
.yv0mv-w8y {
  fill: currentColor;
