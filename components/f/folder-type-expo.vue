...
const content = `<path class="lznw__01b"/><path class="kwff9-mtv"/><ellipse class="aocnwib8v"/><path class="yi-z-mb1x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-expo" /></template>
<style>
.aocnwib8v {
  cx: 28.552px;
  cy: 18.403px;
