...
const content = `<g class="cuyn6tgcc"><path class="o27uy3b5a"/><path class="i0vhayuka"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:presentation-chart-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.o27uy3b5a {
  d: path("M224 56v120a8 8 0 0 1-8 8H40a8 8 0 0 1-8-8V56a8 8 0 0 1 8-8h176a8 8 0 0 1 8 8");
