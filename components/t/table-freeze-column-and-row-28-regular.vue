...
const content = `<path class="tkgtu19da"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-freeze-column-and-row-28-regular" /></template>
<style>
.tkgtu19da {
  fill: currentColor;
