...
const content = `<path class="cc_y5uboe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-arrow-forward-16-regular" /></template>
<style>
.cc_y5uboe {
  fill: currentColor;
