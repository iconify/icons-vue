...
const content = `<path class="dmqh9bg6e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-lock-off-outline-sharp" /></template>
<style>
.dmqh9bg6e {
  fill: currentColor;
