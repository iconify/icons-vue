...
const content = `<path class="t5rjs5drl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:4g-mobiledata-outline" /></template>
<style>
.t5rjs5drl {
  fill: currentColor;
