...
const content = `<circle class="tvvl_sb7e"/><circle class="gp27y-2_s"/><path class="t7xrq-b1p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:based-cooking" /></template>
<style>
.gp27y-2_s {
  cx: 19.43px;
  cy: 19.928px;
