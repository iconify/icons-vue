...
const content = `<path class="m_byy7plx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:toast-takeout" /></template>
<style>
.m_byy7plx {
  fill: none;
  stroke: currentColor;
