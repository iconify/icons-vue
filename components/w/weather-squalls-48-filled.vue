...
const content = `<path class="mm6h3achu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-squalls-48-filled" /></template>
<style>
.mm6h3achu {
  fill: currentColor;
