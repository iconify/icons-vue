...
const content = `<path class="z-jysnb8c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-down-exclamation-24-regular" /></template>
<style>
.z-jysnb8c {
  fill: currentColor;
