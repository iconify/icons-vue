...
const content = `<path class="h88nld02a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-multiple-16-regular" /></template>
<style>
.h88nld02a {
  fill: currentColor;
