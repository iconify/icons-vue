...
const content = `<path class="e8k3k6bce"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:business-center-outline" /></template>
<style>
.e8k3k6bce {
  fill: currentColor;
