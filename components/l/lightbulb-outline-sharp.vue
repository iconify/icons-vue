...
const content = `<path class="e-uyytb4p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:lightbulb-outline-sharp" /></template>
<style>
.e-uyytb4p {
  fill: currentColor;
