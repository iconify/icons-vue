...
const content = `<path class="ljmt8uftq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-hexagon-28-filled" /></template>
<style>
.ljmt8uftq {
  fill: currentColor;
