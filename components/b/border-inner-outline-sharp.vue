...
const content = `<path class="so5_hyb5q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:border-inner-outline-sharp" /></template>
<style>
.so5_hyb5q {
  fill: currentColor;
