...
const content = `<path class="a_4hr_lfa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-add-20-regular" /></template>
<style>
.a_4hr_lfa {
  fill: currentColor;
