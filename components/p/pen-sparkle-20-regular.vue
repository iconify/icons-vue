...
const content = `<path class="r60z0hbbt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pen-sparkle-20-regular" /></template>
<style>
.r60z0hbbt {
  fill: currentColor;
