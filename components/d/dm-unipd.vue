...
const content = `<path class="dc-u1xbrz"/><path class="ni9o0km3b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dm-unipd" /></template>
<style>
.dc-u1xbrz {
  fill: none;
  stroke: currentColor;
