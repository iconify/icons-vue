...
const content = `<path class="r9icrdbrx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:navigation-unread-20-regular" /></template>
<style>
.r9icrdbrx {
  fill: currentColor;
