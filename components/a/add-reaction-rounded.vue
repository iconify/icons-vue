...
const content = `<path class="bn_28-npg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:add-reaction-rounded" /></template>
<style>
.bn_28-npg {
  fill: currentColor;
