...
const content = `<path class="g44i30b7g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fluid-sharp" /></template>
<style>
.g44i30b7g {
  fill: currentColor;
