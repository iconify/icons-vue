...
const content = `<path class="ba9z2imcf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:castle" /></template>
<style>
.ba9z2imcf {
  fill: none;
  stroke: currentColor;
