...
const content = `<path class="xp4hayq9h"/><path class="aq-7szbux"/><path class="sbpdpfbix"/><path class="c-ntt1b8g"/><path class="ut2d5ibrr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:older-adult" /></template>
<style>
.aq-7szbux {
