...
const content = `<path class="s5qtmybay"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chevron-circle-down-32-filled" /></template>
<style>
.s5qtmybay {
  fill: currentColor;
