...
const content = `<path class="vmno7cber"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:where-to-vote-sharp" /></template>
<style>
.vmno7cber {
  fill: currentColor;
