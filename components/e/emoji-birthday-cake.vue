...
const content = `<path class="ntvcw5bpp"/><path class="c538vmb9c"/><path class="yb-gmvbda"/><path class="mvmxnx5mk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-birthday-cake" /></template>
<style>
.c538vmb9c {
  fill: none;
  stroke: currentColor;
