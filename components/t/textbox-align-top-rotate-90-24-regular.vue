...
const content = `<path class="qk29xopti"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-top-rotate-90-24-regular" /></template>
<style>
.qk29xopti {
  fill: currentColor;
