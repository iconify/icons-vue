...
const content = `<path class="kna0iccgy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-link-28-filled" /></template>
<style>
.kna0iccgy {
  fill: currentColor;
