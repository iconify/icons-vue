...
const content = `<path class="neol7wqiv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:currency-circle-dollar-light" /></template>
<style>
.neol7wqiv {
  fill: currentColor;
