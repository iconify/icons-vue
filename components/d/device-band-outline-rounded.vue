...
const content = `<path class="h8-_45myv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:device-band-outline-rounded" /></template>
<style>
.h8-_45myv {
  fill: currentColor;
