...
const content = `<path class="vwqy98mpr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:bottle-sharp" /></template>
<style>
.vwqy98mpr {
  fill: none;
  stroke: currentColor;
