...
const content = `<path class="r6bmgccdf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fitness-trackers-rounded" /></template>
<style>
.r6bmgccdf {
  fill: currentColor;
