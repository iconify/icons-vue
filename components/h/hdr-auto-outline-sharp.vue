...
const content = `<path class="n04e75brp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hdr-auto-outline-sharp" /></template>
<style>
.n04e75brp {
  fill: currentColor;
