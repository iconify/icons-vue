...
const content = `<path class="x-kz1kb7j"/><path class="zubuv5ibd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:letter-p" /></template>
<style>
.x-kz1kb7j {
