...
const content = `<path class="k3pec1b0r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tv-rounded" /></template>
<style>
.k3pec1b0r {
  fill: currentColor;
