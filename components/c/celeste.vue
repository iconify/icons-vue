...
const content = `<path class="gzor67bsl"/><path class="g9rxikbte"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:celeste" /></template>
<style>
.g9rxikbte {
  fill: none;
  stroke: currentColor;
