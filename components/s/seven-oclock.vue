...
const content = `<circle class="yqfvb1bwf"/><circle class="f934iu1fb"/><path class="mbt1d-r9l"/><path class="shajr37is"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:seven-oclock" /></template>
<style>
.f934iu1fb {
  cx: 18px;
  cy: 18px;
