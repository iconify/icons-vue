...
const content = `<path class="o6g6ls0gg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:brightness-high-28-regular" /></template>
<style>
.o6g6ls0gg {
  fill: currentColor;
