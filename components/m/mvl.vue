...
const content = `<g class="ft5dv1b6b"><path clip-rule="evenodd" class="l3gddd8gd"/><path class="xgr-8cbkj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:mvl" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
