...
const content = `<path class="qy861ubxm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:menstrual-health-sharp" /></template>
<style>
.qy861ubxm {
  fill: currentColor;
