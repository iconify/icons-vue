...
const content = `<path class="efesdzb8i"/><path class="iz4b3nb1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-light-mdx" /></template>
<style>
.efesdzb8i {
