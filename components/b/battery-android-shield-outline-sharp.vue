...
const content = `<path class="yf-v8rfkr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-android-shield-outline-sharp" /></template>
<style>
.yf-v8rfkr {
  fill: currentColor;
