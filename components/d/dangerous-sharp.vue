...
const content = `<path class="oj7r5abjl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dangerous-sharp" /></template>
<style>
.oj7r5abjl {
  fill: currentColor;
