...
const content = `<path class="x9vtxwbhp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-arrow-left-16-regular" /></template>
<style>
.x9vtxwbhp {
  fill: currentColor;
