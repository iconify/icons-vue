...
const content = `<path class="mz5iiub7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:motion-photos-paused-outline-rounded" /></template>
<style>
.mz5iiub7l {
  fill: currentColor;
