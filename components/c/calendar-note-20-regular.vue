...
const content = `<path class="ki8c38b3v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-note-20-regular" /></template>
<style>
.ki8c38b3v {
  fill: currentColor;
