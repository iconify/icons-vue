...
const content = `<path class="fn_fzysrc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:meditation-timer" /></template>
<style>
.fn_fzysrc {
  fill: none;
  stroke: currentColor;
