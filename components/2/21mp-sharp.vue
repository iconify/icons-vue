...
const content = `<path class="aliirjdwu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:21mp-sharp" /></template>
<style>
.aliirjdwu {
  fill: currentColor;
