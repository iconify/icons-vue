...
const content = `<path class="glyx5wfmz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:allergies-sharp" /></template>
<style>
.glyx5wfmz {
  fill: currentColor;
