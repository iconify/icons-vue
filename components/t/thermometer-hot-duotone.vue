...
const content = `<g class="cuyn6tgcc"><path class="p8ehyicgk"/><path class="gbv9zn7ch"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:thermometer-hot-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
