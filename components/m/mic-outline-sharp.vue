...
const content = `<path class="mzukvkbmr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mic-outline-sharp" /></template>
<style>
.mzukvkbmr {
  fill: currentColor;
