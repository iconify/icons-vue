...
const content = `<path class="qyexaccfw"/><path class="ywac3ibpj"/><path class="oproo5hcv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-light-node" /></template>
<style>
.oproo5hcv {
...
.qyexaccfw {
  fill: var(--svg-color--8ebf55, #8ebf55);
