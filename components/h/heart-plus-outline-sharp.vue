...
const content = `<path class="ly56plb2w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:heart-plus-outline-sharp" /></template>
<style>
.ly56plb2w {
  fill: currentColor;
