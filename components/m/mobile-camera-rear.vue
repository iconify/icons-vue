...
const content = `<path class="qtr6-xt3y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-camera-rear" /></template>
<style>
.qtr6-xt3y {
  fill: currentColor;
