...
const content = `<path class="amhg14b3u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:home-storage-gear" /></template>
<style>
.amhg14b3u {
  fill: currentColor;
