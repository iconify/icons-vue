...
const content = `<path class="kguenkyrm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:metro-outline-rounded" /></template>
<style>
.kguenkyrm {
  fill: currentColor;
