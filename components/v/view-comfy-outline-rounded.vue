...
const content = `<path class="odcwgvbwe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:view-comfy-outline-rounded" /></template>
<style>
.odcwgvbwe {
  fill: currentColor;
