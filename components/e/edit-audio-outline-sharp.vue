...
const content = `<path class="lny2phbem"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:edit-audio-outline-sharp" /></template>
<style>
.lny2phbem {
  fill: currentColor;
