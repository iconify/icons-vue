...
const content = `<path class="l_tl-rbkf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-description-ltr-24-filled" /></template>
<style>
.l_tl-rbkf {
  fill: currentColor;
