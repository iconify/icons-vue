...
const content = `<path class="humnp0b2a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-simple-minus-bold" /></template>
<style>
.humnp0b2a {
  fill: currentColor;
