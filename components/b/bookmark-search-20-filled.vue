...
const content = `<path class="cuz65bc5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bookmark-search-20-filled" /></template>
<style>
.cuz65bc5x {
  fill: currentColor;
