...
const content = `<path class="bqtpq1brx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-span-in-20-filled" /></template>
<style>
.bqtpq1brx {
  fill: currentColor;
