...
const content = `<path class="jk07_zqin"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-32-filled" /></template>
<style>
.jk07_zqin {
  fill: currentColor;
