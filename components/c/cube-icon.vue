...
const content = `<path class="wtoelmshz"/><path class="yiwk1gb6i"/><path class="bih9pobvs"/><path class="holbn6bek"/><path class="d1gao0b4f"/><path class="nlwbwlwyl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:cube-icon" /></template>
<style>
.bih9pobvs {
