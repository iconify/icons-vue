...
const content = `<path class="twz-uc4yx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-circle-zero-light" /></template>
<style>
.twz-uc4yx {
  fill: currentColor;
