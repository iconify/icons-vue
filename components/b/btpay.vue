...
const content = `<path class="ra9ibrcun"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:btpay" /></template>
<style>
.ra9ibrcun {
  fill: none;
  stroke: currentColor;
