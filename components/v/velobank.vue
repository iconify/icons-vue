...
const content = `<rect class="j3s9ivbxi"/><path class="ixjgx_bve"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:velobank" /></template>
<style>
.ixjgx_bve {
  fill: none;
  stroke: currentColor;
