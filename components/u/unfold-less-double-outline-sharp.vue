...
const content = `<path class="tcrq8voxt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:unfold-less-double-outline-sharp" /></template>
<style>
.tcrq8voxt {
  fill: currentColor;
