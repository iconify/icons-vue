...
const content = `<path class="rrhvspbef"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-dash-20-filled" /></template>
<style>
.rrhvspbef {
  fill: currentColor;
