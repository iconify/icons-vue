...
const content = `<path class="uamz_pbrt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:monorail-rounded" /></template>
<style>
.uamz_pbrt {
  fill: currentColor;
