...
const content = `<path class="e2-ieelhu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-in-default-20-filled" /></template>
<style>
.e2-ieelhu {
  fill: currentColor;
