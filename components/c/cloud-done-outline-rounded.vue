...
const content = `<path class="ugckd0z-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cloud-done-outline-rounded" /></template>
<style>
.ugckd0z-y {
  fill: currentColor;
