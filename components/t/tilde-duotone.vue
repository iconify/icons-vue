...
const content = `<g class="cuyn6tgcc"><path class="rmfg5mk6q"/><path class="gfgnmcb-n"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:tilde-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
