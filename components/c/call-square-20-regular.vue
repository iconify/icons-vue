...
const content = `<path class="qnw1e6t5m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-square-20-regular" /></template>
<style>
.qnw1e6t5m {
  fill: currentColor;
