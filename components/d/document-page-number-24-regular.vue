...
const content = `<path class="dd-84t3xe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-page-number-24-regular" /></template>
<style>
.dd-84t3xe {
  fill: currentColor;
