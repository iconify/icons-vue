...
const content = `<path class="suh7whn9u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:jamboard-kiosk-outline-rounded" /></template>
<style>
.suh7whn9u {
  fill: currentColor;
