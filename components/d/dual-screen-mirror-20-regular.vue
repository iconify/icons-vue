...
const content = `<path class="vpj-y7bei"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dual-screen-mirror-20-regular" /></template>
<style>
.vpj-y7bei {
  fill: currentColor;
