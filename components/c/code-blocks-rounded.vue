...
const content = `<path class="gmkpeknht"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:code-blocks-rounded" /></template>
<style>
.gmkpeknht {
  fill: currentColor;
