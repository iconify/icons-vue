...
const content = `<path class="zggto5l_o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-mute-28-regular" /></template>
<style>
.zggto5l_o {
  fill: currentColor;
