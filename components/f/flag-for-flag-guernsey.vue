...
const content = `<path class="c-r52ubsi"/><path class="wqbbrsbfp"/><path class="bhd2s0b9l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-guernsey" /></template>
<style>
.bhd2s0b9l {
