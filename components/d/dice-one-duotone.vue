...
const content = `<g class="cuyn6tgcc"><path class="dm5w4csla"/><path class="hrwxpdbqk"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:dice-one-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
