...
const content = `<path class="u9xu7qbaw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-italic-20-filled" /></template>
<style>
.u9xu7qbaw {
  fill: currentColor;
