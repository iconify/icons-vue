...
const content = `<path class="u0wemq19a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-add-20-regular" /></template>
<style>
.u0wemq19a {
  fill: currentColor;
