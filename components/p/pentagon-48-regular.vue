...
const content = `<path class="xlog5cdry"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pentagon-48-regular" /></template>
<style>
.xlog5cdry {
  fill: currentColor;
