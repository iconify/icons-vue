...
const content = `<path class="viymixikq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:convert-to-text-outline-sharp" /></template>
<style>
.viymixikq {
  fill: currentColor;
