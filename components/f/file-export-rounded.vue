...
const content = `<path class="fmuk_eb0e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:file-export-rounded" /></template>
<style>
.fmuk_eb0e {
  fill: currentColor;
