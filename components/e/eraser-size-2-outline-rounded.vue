...
const content = `<path class="uucwhfbok"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:eraser-size-2-outline-rounded" /></template>
<style>
.uucwhfbok {
  fill: currentColor;
