...
const content = `<path class="um336lmet"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kma" /></template>
<style>
.um336lmet {
  fill: none;
  stroke: currentColor;
