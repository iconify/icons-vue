...
const content = `<path class="oaw-6ijee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-center-horizontal-24-filled" /></template>
<style>
.oaw-6ijee {
  fill: currentColor;
