...
const content = `<path class="obxqurvjn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:language-chinese-array-outline-sharp" /></template>
<style>
.obxqurvjn {
  fill: currentColor;
