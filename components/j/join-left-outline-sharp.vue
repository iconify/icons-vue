...
const content = `<path class="dnvqvjxlk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:join-left-outline-sharp" /></template>
<style>
.dnvqvjxlk {
  fill: currentColor;
