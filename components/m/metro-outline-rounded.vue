...
const content = `<path class="tfp1sabwe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:metro-outline-rounded" /></template>
<style>
.tfp1sabwe {
  fill: currentColor;
