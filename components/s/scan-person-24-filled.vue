...
const content = `<path class="dabh6y32l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-person-24-filled" /></template>
<style>
.dabh6y32l {
  fill: currentColor;
