...
const content = `<path class="onozp6bca"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:filmstrip-play-20-filled" /></template>
<style>
.onozp6bca {
  fill: currentColor;
