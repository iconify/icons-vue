...
const content = `<path class="i0jm3j8ly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:unfold-less-outline-rounded" /></template>
<style>
.i0jm3j8ly {
  fill: currentColor;
