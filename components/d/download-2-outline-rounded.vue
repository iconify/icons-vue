...
const content = `<path class="aa633tsyi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:download-2-outline-rounded" /></template>
<style>
.aa633tsyi {
  fill: currentColor;
