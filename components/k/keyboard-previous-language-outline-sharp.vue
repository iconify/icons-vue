...
const content = `<path class="c-yfmccoo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-previous-language-outline-sharp" /></template>
<style>
.c-yfmccoo {
  fill: currentColor;
