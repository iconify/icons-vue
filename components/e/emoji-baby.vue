...
const content = `<path class="a-wcklbfj"/><path class="m413n1bnf"/><path class="f4w0f3bqo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-baby" /></template>
<style>
.a-wcklbfj {
  fill: none;
  stroke: currentColor;
...
.f4w0f3bqo {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M21.836 23.161a2.163 2.163 0 0 0 4.328 0a2.163 2.163 0 0 0-4.328 0M10.293 41.904c9.05.96 18.22.61 27.414 0");
}
