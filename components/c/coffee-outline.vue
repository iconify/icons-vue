...
const content = `<path class="wpe34xbhs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:coffee-outline" /></template>
<style>
.wpe34xbhs {
  fill: currentColor;
