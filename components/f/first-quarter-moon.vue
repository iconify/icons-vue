...
.lh6lzmg_v {
  fill: var(--svg-color--1b2e35, #1b2e35);
  d: path("M62.34 8.58c-.02 1.36-3.4 2.23-7.38 2.6s-7.3.11-7.65-1.2S50 6.72 54.34 6.3s8.01.92 8 2.28");
}

.qzp-7daka {
  fill: var(--svg-color--22404c, #22404c);
  d: path("M4 64c0 33.14 26.86 60 60 60c0 0 2.9-21.47 2.9-60S64 4 64 4C30.86 4 4 30.86 4 64");
}

.tbk-439cg {
  fill: var(--svg-color--f1c688, #f1c688);
  d: path("M104.3 96.51c-1.34 1.59-4.84 5.56-6.01 6.92c-1.18 1.35-.8 2.45-.58 2.57c2.32 1.33 8.41-2.29 9.1-8.4c.15-1.27-1.18-2.68-2.51-1.09m7.34-11.29c-.62 1.56-2.29 5.51-2.85 6.84c-.56 1.34.01 2.08.21 2.12c2.12.43 5.87-3.9 4.84-8.77c-.2-1-1.58-1.75-2.2-.19M77.82 8.69c-1.01.24-1.77 1.64-.22 2.22s5.47 2.16 6.8 2.68s2.08-.07 2.12-.27c.45-2.14-3.83-5.78-8.7-4.63");
}
