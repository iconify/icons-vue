...
const content = `<path class="h0j8b3tmd"/><path class="tlsbkt65n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:uw-zorg-online" /></template>
<style>
.h0j8b3tmd {
  fill: none;
  stroke: currentColor;
