...
const content = `<path class="di6_qab5y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bookmark-added" /></template>
<style>
.di6_qab5y {
  fill: currentColor;
