...
const content = `<path class="astv_i8jk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-two-focus-top-settings-32-filled" /></template>
<style>
.astv_i8jk {
  fill: currentColor;
