...
const content = `<path class="dclxmobrt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-menu-outline-sharp" /></template>
<style>
.dclxmobrt {
  fill: currentColor;
