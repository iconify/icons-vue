...
const content = `<path class="dpi79zbau"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lte-mobiledata-badge" /></template>
<style>
.dpi79zbau {
  fill: currentColor;
