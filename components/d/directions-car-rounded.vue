...
const content = `<path class="jjvdsfdmk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:directions-car-rounded" /></template>
<style>
.jjvdsfdmk {
  fill: currentColor;
