...
const content = `<path class="k683ogh7h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:accessibility-24-filled" /></template>
<style>
.k683ogh7h {
  fill: currentColor;
