...
const content = `<path class="gxtlimzhg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-passkey-24-filled" /></template>
<style>
.gxtlimzhg {
  fill: currentColor;
