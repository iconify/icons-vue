...
const content = `<path class="cvs2pbbvd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tag-circle-20-filled" /></template>
<style>
.cvs2pbbvd {
  fill: currentColor;
