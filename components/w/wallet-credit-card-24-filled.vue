...
const content = `<path class="sq40x3biw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:wallet-credit-card-24-filled" /></template>
<style>
.sq40x3biw {
  fill: currentColor;
