...
const content = `<g class="cuyn6tgcc"><path class="b17wkeb9u"/><path class="cj10fpzvh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:square-half-duotone" /></template>
<style>
.b17wkeb9u {
