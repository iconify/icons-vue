...
const content = `<path class="zta40jb0u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:groups-3-sharp" /></template>
<style>
.zta40jb0u {
  fill: currentColor;
