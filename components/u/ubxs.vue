...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGcbpH4dAS)" class="irekmabbb"/><defs><linearGradient id="SVGcbpH4dAS" x1="12" x2="12" y1="3.527" y2="20.473" gradientUnits="userSpaceOnUse"><stop class="ljjhpmb8t"/><stop offset="1" class="ogyujtswc"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:ubxs" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
