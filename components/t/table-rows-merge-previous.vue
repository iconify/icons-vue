...
const content = `<path class="olyi7b5li"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:table-rows-merge-previous" /></template>
<style>
.olyi7b5li {
  fill: none;
  stroke: currentColor;
