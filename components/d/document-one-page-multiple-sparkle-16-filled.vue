...
const content = `<path class="fwb81sxzt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-one-page-multiple-sparkle-16-filled" /></template>
<style>
.fwb81sxzt {
  fill: currentColor;
