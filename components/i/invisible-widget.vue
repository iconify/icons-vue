...
const content = `<path class="vzb8ozenf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:invisible-widget" /></template>
<style>
.vzb8ozenf {
  fill: none;
  stroke: currentColor;
