...
const content = `<path class="wbek5lbbk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-6-28-filled" /></template>
<style>
.wbek5lbbk {
  fill: currentColor;
