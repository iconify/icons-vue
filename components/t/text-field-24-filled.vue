...
const content = `<path class="w8qczbbbg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-field-24-filled" /></template>
<style>
.w8qczbbbg {
  fill: currentColor;
