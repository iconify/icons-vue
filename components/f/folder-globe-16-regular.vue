...
const content = `<path class="dvfp-wbit"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-globe-16-regular" /></template>
<style>
.dvfp-wbit {
  fill: currentColor;
