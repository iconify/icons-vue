...
const content = `<path class="x-jc8vm0e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-indent-decrease-outline-rounded" /></template>
<style>
.x-jc8vm0e {
  fill: currentColor;
