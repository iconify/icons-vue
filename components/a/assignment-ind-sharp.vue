...
const content = `<path class="tmyabj2wt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:assignment-ind-sharp" /></template>
<style>
.tmyabj2wt {
  fill: currentColor;
