...
const content = `<path class="zl8t5jbmz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-two-settings-32-regular" /></template>
<style>
.zl8t5jbmz {
  fill: currentColor;
