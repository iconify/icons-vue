...
const content = `<path class="vnvzf_bdl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-clock-20-regular" /></template>
<style>
.vnvzf_bdl {
  fill: currentColor;
