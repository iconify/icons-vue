...
const content = `<path class="fkjdm0bgy"/><path class="j1vnxbb-g"/><path class="gwv9wrbpa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-bacon" /></template>
<style>
.fkjdm0bgy {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M30.995 10.617a2.98 2.98 0 0 1-2.981 2.984c-1.646 0-2.98 1.336-2.98 2.984s-1.335 2.985-2.981 2.985c-1.647-.001-2.981 1.335-2.981 2.984s-1.334 2.984-2.98 2.984");
}
