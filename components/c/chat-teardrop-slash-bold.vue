...
const content = `<path class="dovy7vbfk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:chat-teardrop-slash-bold" /></template>
<style>
.dovy7vbfk {
  fill: currentColor;
