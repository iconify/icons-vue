...
const content = `<path class="xpvke_3-s"/><path class="sgx-kdjjp"/><path class="hh86o0bil"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-api" /></template>
<style>
.hh86o0bil {
...
.xpvke_3-s {
  fill: var(--svg-color--a0bf55, #a0bf55);
