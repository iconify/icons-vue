...
const content = `<path class="pf-sjchkh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:diagnosis-outline-rounded" /></template>
<style>
.pf-sjchkh {
  fill: currentColor;
