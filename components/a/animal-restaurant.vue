...
const content = `<path class="i9clfwm2k"/><path class="md5ry6lnd"/><path class="s24pfz__t"/><path class="uab4xy9lh"/><ellipse transform="rotate(-79.97 23.832 17.33)" class="v8pmbxbcb"/><path class="pu7y1hb6f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:animal-restaurant" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
...
.s24pfz__t {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M38.58 24.673c-1.627 1.589-2.667 4.087-.526 5.234c1.675.897 3.049-.45 3.273-2.131s.136-2.779-.549-3.969m-7.912 15.937s.61-2.947 0-4.293c0 0 2.23.988 1.641-1.283s-4.016-3.911-5.383-4.353s-2.418.715-1.451 1.64c-2.818.316-6.205 2.253-6.183 6.373");
}
