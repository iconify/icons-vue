...
const content = `<path class="d6ws89byu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-add-28-regular" /></template>
<style>
.d6ws89byu {
  fill: currentColor;
