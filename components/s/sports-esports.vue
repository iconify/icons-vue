...
const content = `<path class="e6a2rac0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sports-esports" /></template>
<style>
.e6a2rac0l {
  fill: currentColor;
