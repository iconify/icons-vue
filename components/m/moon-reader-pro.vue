...
const content = `<path class="vu--wjb5k"/><path class="zw7ew1ddu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:moon-reader-pro" /></template>
<style>
.vu--wjb5k {
  fill: none;
  stroke: currentColor;
...
.zw7ew1ddu {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M32.32 4.5H12.73v39h24.92a2 2 0 0 0 2-2V18.43");
}
