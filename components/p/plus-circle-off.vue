...
const content = `<g class="cuyn6tgcc"><path class="i_lialbjv"/><path class="a_fwwub7q"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:plus-circle-off" /></template>
<style>
.a_fwwub7q {
