...
const content = `<path class="jru1_gb5d"/><defs><path id="SVGPedepbtP" class="us6dcifmo"/></defs><clipPath id="SVGOq0aqePL"><use href="#SVGPedepbtP"/></clipPath><g clip-path="url(#SVGOq0aqePL)" class="zlqwn85jm"><path class="g6qubybib"/></g><defs><use href="#SVGPedepbtP" id="SVGVjsgUc5R"/></defs><clipPath id="SVGXRcECbgN"><use href="#SVGVjsgUc5R"/></clipPath><g clip-path="url(#SVGXRcECbgN)" class="j9_i7vu4q"><path class="gw7qssbko"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:left-facing-fist-medium-light-skin-tone" /></template>
<style>
.g6qubybib {
