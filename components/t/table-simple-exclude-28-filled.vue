...
const content = `<path class="raripdnwt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-simple-exclude-28-filled" /></template>
<style>
.raripdnwt {
  fill: currentColor;
