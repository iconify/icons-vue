...
const content = `<circle class="k3cnofwci"/><path class="c64g-2e7d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kanal-d" /></template>
<style>
.c64g-2e7d {
  fill: none;
  stroke: currentColor;
