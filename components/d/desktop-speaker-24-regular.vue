...
const content = `<path class="tw9qt5q_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-speaker-24-regular" /></template>
<style>
.tw9qt5q_k {
  fill: currentColor;
