...
const content = `<path class="pvr2gicaz"/><circle class="jy2axactr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:be-my-eyes" /></template>
<style>
.jy2axactr {
  cx: 24px;
  cy: 24px;
