...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGeFBYwb7h)" clip-rule="evenodd" class="ou7t1gbva"/><defs><linearGradient id="SVGeFBYwb7h" x1="5.483" x2="18.284" y1="6.288" y2="18.273" gradientUnits="userSpaceOnUse"><stop class="bjqj0ue1i"/><stop offset="1" class="otg-tcc5v"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:mchc" /></template>
<style>
.bjqj0ue1i {
