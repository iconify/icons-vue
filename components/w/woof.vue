...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGLeLHDaIm)" clip-rule="evenodd" class="iy730oujm"/><defs><linearGradient id="SVGLeLHDaIm" x1="17.032" x2="6.179" y1="4.853" y2="18.882" gradientUnits="userSpaceOnUse"><stop class="kv7dhf4cl"/><stop offset=".47" class="vc9l84o9y"/><stop offset="1" class="clahyacng"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:woof" /></template>
<style>
.clahyacng {
