...
const content = `<path class="qjvxstb6d"/><path class="q-qbtn3dt"/><path class="qjotn_bkb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-germany" /></template>
<style>
.q-qbtn3dt {
