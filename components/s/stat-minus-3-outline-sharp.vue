...
const content = `<path class="ap0w3lbdk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stat-minus-3-outline-sharp" /></template>
<style>
.ap0w3lbdk {
  fill: currentColor;
