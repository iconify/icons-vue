...
const content = `<path class="ycqiqebyn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-four-focus-bottom-24-filled" /></template>
<style>
.ycqiqebyn {
  fill: currentColor;
