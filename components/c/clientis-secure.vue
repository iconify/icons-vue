...
const content = `<path class="bvad8064r"/><path class="yf74idb3v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:clientis-secure" /></template>
<style>
.bvad8064r {
  fill: none;
  stroke: currentColor;
