...
const content = `<path class="u4pr_nbob"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fullscreen-portrait-rounded" /></template>
<style>
.u4pr_nbob {
  fill: currentColor;
