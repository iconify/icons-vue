...
const content = `<path class="mcpdrfevf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:paint-brush-28-regular" /></template>
<style>
.mcpdrfevf {
  fill: currentColor;
