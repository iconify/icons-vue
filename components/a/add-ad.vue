...
const content = `<path class="d3julsbyg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-ad" /></template>
<style>
.d3julsbyg {
  fill: currentColor;
