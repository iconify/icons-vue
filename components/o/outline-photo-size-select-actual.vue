...
const content = `<path class="uf4rjbctu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-photo-size-select-actual" /></template>
<style>
.uf4rjbctu {
  fill: currentColor;
