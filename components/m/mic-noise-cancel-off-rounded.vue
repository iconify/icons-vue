...
const content = `<path class="askt5kwds"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mic-noise-cancel-off-rounded" /></template>
<style>
.askt5kwds {
  fill: currentColor;
