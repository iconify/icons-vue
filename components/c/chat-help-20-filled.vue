...
const content = `<path class="dh8-robqr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-help-20-filled" /></template>
<style>
.dh8-robqr {
  fill: currentColor;
