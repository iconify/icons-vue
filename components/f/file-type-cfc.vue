...
const content = `<defs><radialGradient id="SVGYDCalbQO" cx="26.508" cy="-543.31" r="12.833" gradientTransform="matrix(1.293 .001 .001 -1.234 -20.084 -658.573)" gradientUnits="userSpaceOnUse"><stop offset="0" class="zaj6o4ghe"/><stop offset="1" class="woiiywbji"/></radialGradient></defs><path fill="url(#SVGYDCalbQO)" class="aue0dup4m"/><path class="mhmewubvm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-cfc" /></template>
<style>
.aue0dup4m {
...
.mhmewubvm {
  fill: var(--svg-color--e5f3fc, #e5f3fc);
...
.woiiywbji {
  stop-color: var(--svg-color--26424e, #26424e);
}

.zaj6o4ghe {
  stop-color: var(--svg-color--576e71, #576e71);
  stop-opacity: 0.98;
}
