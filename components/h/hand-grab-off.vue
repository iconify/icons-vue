...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="ubvpkg8ca"/><path clip-rule="evenodd" class="vbsrkrb1w"/><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:hand-grab-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
