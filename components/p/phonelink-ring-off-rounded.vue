...
const content = `<path class="f6lals8ge"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phonelink-ring-off-rounded" /></template>
<style>
.f6lals8ge {
  fill: currentColor;
