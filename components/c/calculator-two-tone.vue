...
const content = `<g class="nrj6p8qat"><path class="d7fc_eqhq"/><path class="a8-zxxf1d"/><path class="wx6aefbne"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:calculator-two-tone" /></template>
<style>
.a8-zxxf1d {
...
.d7fc_eqhq {
  ...
  d: path("M7 1L17 1C19.2091 1 21 2.7909 21 5L21 19C21 21.2091 19.2091 23 17 23L7 23C4.7909 23 3 21.2091 3 19L3 5C3 2.7909 4.7909 1 7 1Z");
  stroke: none;
}
