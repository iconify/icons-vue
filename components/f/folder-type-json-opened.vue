...
const content = `<path class="cm4pjhbfg"/><path class="rdqohpbpm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-json-opened" /></template>
<style>
.cm4pjhbfg {
