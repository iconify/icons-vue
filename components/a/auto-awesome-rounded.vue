...
const content = `<path class="zne42bl-p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-awesome-rounded" /></template>
<style>
.zne42bl-p {
  fill: currentColor;
