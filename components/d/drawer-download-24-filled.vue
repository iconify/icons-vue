...
const content = `<g class="ft5dv1b6b"><path class="yuv-3f9lq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drawer-download-24-filled" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
