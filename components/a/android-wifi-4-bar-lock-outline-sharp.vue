...
const content = `<path class="pofnmo0ml"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:android-wifi-4-bar-lock-outline-sharp" /></template>
<style>
.pofnmo0ml {
  fill: currentColor;
