...
const content = `<path class="x0_c44b4x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:safety-check-sharp" /></template>
<style>
.x0_c44b4x {
  fill: currentColor;
