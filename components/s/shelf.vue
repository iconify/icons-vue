...
const content = `<g class="y9tr6bcfx"><path class="mzzw232pd"/><path class="vu1ix7h2f"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:shelf" /></template>
<style>
.mzzw232pd {
