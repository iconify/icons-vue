...
const content = `<path class="pufgc7bqx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:invert-colors-outline-sharp" /></template>
<style>
.pufgc7bqx {
  fill: currentColor;
