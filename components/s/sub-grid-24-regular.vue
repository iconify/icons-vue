...
const content = `<path class="rkm-687vm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:sub-grid-24-regular" /></template>
<style>
.rkm-687vm {
  fill: currentColor;
