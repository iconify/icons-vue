...
const content = `<circle class="xshp7txei"/><path class="hgc9ibbzm"/><path class="jpqk1_boq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lineage-browser" /></template>
<style>
.hgc9ibbzm {
  fill: none;
  stroke: currentColor;
