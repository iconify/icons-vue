...
const content = `<path class="nprdnqgmh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mood-heart-outline-sharp" /></template>
<style>
.nprdnqgmh {
  fill: currentColor;
