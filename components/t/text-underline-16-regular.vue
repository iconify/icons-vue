...
const content = `<path class="b2n3ruwqs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-underline-16-regular" /></template>
<style>
.b2n3ruwqs {
  fill: currentColor;
