...
const content = `<path class="goy-qccyq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:build-circle-rounded" /></template>
<style>
.goy-qccyq {
  fill: currentColor;
