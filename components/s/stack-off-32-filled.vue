...
const content = `<path class="ph_a63bfc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:stack-off-32-filled" /></template>
<style>
.ph_a63bfc {
  fill: currentColor;
