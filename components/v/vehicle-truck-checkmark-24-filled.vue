...
const content = `<path class="xzp97cklb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-truck-checkmark-24-filled" /></template>
<style>
.xzp97cklb {
  fill: currentColor;
