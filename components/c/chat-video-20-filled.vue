...
const content = `<path class="iggeyj-fa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-video-20-filled" /></template>
<style>
.iggeyj-fa {
  fill: currentColor;
