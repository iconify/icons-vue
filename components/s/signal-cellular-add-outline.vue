...
const content = `<path class="w-ufpwz5r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:signal-cellular-add-outline" /></template>
<style>
.w-ufpwz5r {
  fill: currentColor;
