...
const content = `<path class="e1if45nfn"/><circle class="ahwkywbwd"/><path class="jr32oojdj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-noise-aware" /></template>
<style>
.ahwkywbwd {
  cx: 13.5px;
  cy: 12.5px;
