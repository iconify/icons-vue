...
const content = `<path class="hqsefccuh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-flag-congo-brazzaville" /></template>
<style>
.hqsefccuh {
  fill: currentColor;
