...
const content = `<path class="yj5_nob0d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-flow-up-right-16-filled" /></template>
<style>
.yj5_nob0d {
  fill: currentColor;
