...
const content = `<path class="a5dwfhbbj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:inbox-text-person" /></template>
<style>
.a5dwfhbbj {
  fill: currentColor;
