...
const content = `<path class="ehm2l9brx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dns-rounded" /></template>
<style>
.ehm2l9brx {
  fill: currentColor;
