...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:clock-2-sharp-duotone" /></template>
<style>
.e9ewmybae {
  fill: currentColor;
...
.w1yfq4b5p {
  d: path("M12 5L12 12L16.8301 9.2113");
}
