...
const content = `<g class="cuyn6tgcc"><path class="cmb7x4l_n"/><path clip-rule="evenodd" class="i6eu-229z"/><path class="j3enf4crm"/><path clip-rule="evenodd" class="wszww20lf"/><path clip-rule="evenodd" class="ho2b1cc0b"/><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:previous-track-off" /></template>
<style>
.cmb7x4l_n {
