...
const content = `<path class="dz7lv2cfw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-star-20-regular" /></template>
<style>
.dz7lv2cfw {
  fill: currentColor;
