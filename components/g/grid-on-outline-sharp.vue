...
const content = `<path class="tft1gibsc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:grid-on-outline-sharp" /></template>
<style>
.tft1gibsc {
  fill: currentColor;
