...
const content = `<path class="l6k30uilj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-bullet-list-add-20-regular" /></template>
<style>
.l6k30uilj {
  fill: currentColor;
