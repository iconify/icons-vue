...
const content = `<path class="f507aw_ga"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-home-16-regular" /></template>
<style>
.f507aw_ga {
  fill: currentColor;
