...
const content = `<path class="s1tmawu6s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-usage-sparkle-20-regular" /></template>
<style>
.s1tmawu6s {
  fill: currentColor;
