...
const content = `<path class="dg7p2sl1i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:star-checkmark-24-filled" /></template>
<style>
.dg7p2sl1i {
  fill: currentColor;
