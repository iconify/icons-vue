...
const content = `<path class="xfrcn_bnb"/><defs><path id="SVGaK0lweFp" class="xn7kj4bfs"/></defs><clipPath id="SVGHKxxruJn"><use href="#SVGaK0lweFp"/></clipPath><g clip-path="url(#SVGHKxxruJn)" class="t_nvrsbrc"><path class="l-sg684xg"/><path class="g_j8zremu"/></g><defs><use href="#SVGaK0lweFp" id="SVGF1Wkjcor"/></defs><clipPath id="SVG59NnubzV"><use href="#SVGF1Wkjcor"/></clipPath><g clip-path="url(#SVG59NnubzV)"><path class="f30vogbmy"/><path class="mxntq6bqo"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:victory-hand-dark-skin-tone" /></template>
<style>
.f30vogbmy {
