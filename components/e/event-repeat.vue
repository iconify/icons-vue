...
const content = `<path class="hquo71b9s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:event-repeat" /></template>
<style>
.hquo71b9s {
  fill: currentColor;
