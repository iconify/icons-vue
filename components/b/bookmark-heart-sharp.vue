...
const content = `<path class="a_dkgtaof"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bookmark-heart-sharp" /></template>
<style>
.a_dkgtaof {
  fill: currentColor;
