...
const content = `<path class="d5w0qb16q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-rotation-down-outline-rounded" /></template>
<style>
.d5w0qb16q {
  fill: currentColor;
