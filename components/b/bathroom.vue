...
const content = `<path class="z0rmagdzr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bathroom" /></template>
<style>
.z0rmagdzr {
  fill: currentColor;
