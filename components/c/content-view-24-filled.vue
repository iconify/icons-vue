...
const content = `<path class="we89nwbti"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:content-view-24-filled" /></template>
<style>
.we89nwbti {
  fill: currentColor;
