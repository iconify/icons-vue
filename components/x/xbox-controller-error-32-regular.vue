...
const content = `<path class="y5amq9big"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:xbox-controller-error-32-regular" /></template>
<style>
.y5amq9big {
  fill: currentColor;
