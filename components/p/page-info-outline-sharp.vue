...
const content = `<path class="moh1w4bcw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:page-info-outline-sharp" /></template>
<style>
.moh1w4bcw {
  fill: currentColor;
