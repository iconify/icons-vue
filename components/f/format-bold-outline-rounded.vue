...
const content = `<path class="bowi8nybd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-bold-outline-rounded" /></template>
<style>
.bowi8nybd {
  fill: currentColor;
