...
const content = `<path class="vi-9m1bek"/><path class="gzkw6_brs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pixel-tips" /></template>
<style>
.gzkw6_brs {
  fill: none;
  stroke: currentColor;
