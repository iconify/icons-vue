...
const content = `<path class="uryie-28h"/><path class="ads3afb6q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hkust-qr-code" /></template>
<style>
.ads3afb6q {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M31.121 15.115h2.79c.534 0 .966.4.966.893v2.935c0 .493-.432.893-.966.893h-2.79c-.533 0-.965-.4-.965-.893v-2.935c0-.493.432-.893.965-.893M33.5 42.5h5c2.216 0 4-1.784 4-4v-5m-37 0v5c0 2.216 1.784 4 4 4h5m28-28v-5c0-2.216-1.784-4-4-4h-5m-19 0h-5c-2.216 0-4 1.784-4 4v5");
}
