...
const content = `<g class="cuyn6tgcc"><path class="nu4nfo2zt"/><path class="u86mlqbzi"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:pen-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
