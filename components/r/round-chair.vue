...
const content = `<path class="r0o58ybog"/><path class="td3a6acvt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-chair" /></template>
<style>
.r0o58ybog {
  fill: currentColor;
