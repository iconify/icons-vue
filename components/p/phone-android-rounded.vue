...
const content = `<path class="odw1u6b1o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phone-android-rounded" /></template>
<style>
.odw1u6b1o {
  fill: currentColor;
