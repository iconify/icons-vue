...
const content = `<path class="a06w50beb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:camera-video-outline-rounded" /></template>
<style>
.a06w50beb {
  fill: currentColor;
