...
const content = `<g class="cuyn6tgcc"><path class="nv3b7hbiq"/><path class="lw38hlb5q"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:angle-right-circle" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
