...
const content = `<path class="tvoob2khj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sports-golf-outline-rounded" /></template>
<style>
.tvoob2khj {
  fill: currentColor;
