...
const content = `<path class="nr5mu7bmv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-nod-sharp" /></template>
<style>
.nr5mu7bmv {
  fill: currentColor;
