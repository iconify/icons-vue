...
const content = `<path class="dro-xdnoq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:candlestick-chart-outline-rounded" /></template>
<style>
.dro-xdnoq {
  fill: currentColor;
