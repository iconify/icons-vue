...
const content = `<g class="cuyn6tgcc"><path class="ai84z2bqk"/><path class="lrwsr61al"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:image-broken-duotone" /></template>
<style>
.ai84z2bqk {
  d: path("M224 56v32l-48 16l-16 40l-23.35 9.34l-39-39a8 8 0 0 0-11.32 0L32 168.69V56a8 8 0 0 1 8-8h176a8 8 0 0 1 8 8");
