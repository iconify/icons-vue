...
const content = `<path class="bo_vhqbix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bed-rounded" /></template>
<style>
.bo_vhqbix {
  fill: currentColor;
