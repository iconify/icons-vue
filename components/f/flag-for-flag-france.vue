...
const content = `<path class="zzyf9-41q"/><path class="oak04b3jg"/><path class="cfqr_ccbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-france" /></template>
<style>
.cfqr_ccbq {
