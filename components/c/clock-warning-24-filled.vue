...
const content = `<path class="o-xna_61e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clock-warning-24-filled" /></template>
<style>
.o-xna_61e {
  fill: currentColor;
