...
const content = `<path class="t_gmt5bsg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:delivery-club" /></template>
<style>
.t_gmt5bsg {
  fill: none;
  stroke: currentColor;
