...
const content = `<path class="ccvi3qbye"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:thermometer-simple-light" /></template>
<style>
.ccvi3qbye {
  fill: currentColor;
