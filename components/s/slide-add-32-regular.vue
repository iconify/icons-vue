...
const content = `<path class="i_c-uilzy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-add-32-regular" /></template>
<style>
.i_c-uilzy {
  fill: currentColor;
