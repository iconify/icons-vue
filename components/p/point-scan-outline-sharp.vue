...
const content = `<path class="x2uusbb3z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:point-scan-outline-sharp" /></template>
<style>
.x2uusbb3z {
  fill: currentColor;
