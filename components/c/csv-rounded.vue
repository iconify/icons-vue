...
const content = `<path class="p2rk9mbrn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:csv-rounded" /></template>
<style>
.p2rk9mbrn {
  fill: currentColor;
