...
const content = `<path class="dw8lag9uu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-between-down-24-regular" /></template>
<style>
.dw8lag9uu {
  fill: currentColor;
