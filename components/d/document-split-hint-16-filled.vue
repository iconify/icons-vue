...
const content = `<path class="gc9z9t3od"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-split-hint-16-filled" /></template>
<style>
.gc9z9t3od {
  fill: currentColor;
