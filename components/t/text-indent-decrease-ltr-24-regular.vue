...
const content = `<path class="adabar7iv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-decrease-ltr-24-regular" /></template>
<style>
.adabar7iv {
  fill: currentColor;
