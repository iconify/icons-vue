...
const content = `<path class="axfluubhb"/><path class="o_9_v_bhv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:confounded-face" /></template>
<style>
.axfluubhb {
