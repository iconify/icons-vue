...
const content = `<path class="ni3svdbqs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-mention-16-filled" /></template>
<style>
.ni3svdbqs {
  fill: currentColor;
