...
const content = `<path class="uhst3_bus"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:more-up-rounded" /></template>
<style>
.uhst3_bus {
  fill: currentColor;
