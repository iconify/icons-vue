...
const content = `<g class="cuyn6tgcc"><path class="jz28tybvv"/><path class="atgrwwbwn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:dice-5-duotone" /></template>
<style>
.atgrwwbwn {
