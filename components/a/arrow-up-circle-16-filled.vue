...
const content = `<path class="mdyxbswyp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-up-circle-16-filled" /></template>
<style>
.mdyxbswyp {
  fill: currentColor;
