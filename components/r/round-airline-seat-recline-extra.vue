...
const content = `<path class="q8twof7vu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-airline-seat-recline-extra" /></template>
<style>
.q8twof7vu {
  fill: currentColor;
