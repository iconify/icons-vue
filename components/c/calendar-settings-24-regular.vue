...
const content = `<path class="tsbch3b1d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-settings-24-regular" /></template>
<style>
.tsbch3b1d {
  fill: currentColor;
