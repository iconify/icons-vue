...
const content = `<path class="d3ny2ac9a"/><path class="dj4eg5ftc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-face-slight-smile" /></template>
<style>
.d3ny2ac9a {
  fill: none;
  stroke: currentColor;
