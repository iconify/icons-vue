...
const content = `<path class="ffzd6rbek"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-meeting-room-outline-sharp" /></template>
<style>
.ffzd6rbek {
  fill: currentColor;
