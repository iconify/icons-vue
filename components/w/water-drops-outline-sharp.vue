...
const content = `<path class="g6v3urtvt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:water-drops-outline-sharp" /></template>
<style>
.g6v3urtvt {
  fill: currentColor;
