...
const content = `<path class="guhegquya"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:location-away-sharp" /></template>
<style>
.guhegquya {
  fill: currentColor;
