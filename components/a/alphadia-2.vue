...
const content = `<path class="l-b6oy20n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:alphadia-2" /></template>
<style>
.l-b6oy20n {
  fill: none;
  stroke: currentColor;
