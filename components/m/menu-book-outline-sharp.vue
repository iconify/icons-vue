...
const content = `<path class="ebhj1ukfd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:menu-book-outline-sharp" /></template>
<style>
.ebhj1ukfd {
  fill: currentColor;
