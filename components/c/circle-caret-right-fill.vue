...
const content = `<path clip-rule="evenodd" class="nbjhztbyf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-caret-right-fill" /></template>
<style>
.nbjhztbyf {
  fill: currentColor;
  fill-rule: evenodd;
