...
const content = `<path class="vgpwkmyvu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:home-mini-rounded" /></template>
<style>
.vgpwkmyvu {
  fill: currentColor;
