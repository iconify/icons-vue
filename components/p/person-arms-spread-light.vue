...
const content = `<path class="xc39wvbdl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:person-arms-spread-light" /></template>
<style>
.xc39wvbdl {
  fill: currentColor;
