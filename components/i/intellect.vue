...
const content = `<path class="ajt6rfbwn"/><path class="mrukscc2w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:intellect" /></template>
<style>
.ajt6rfbwn {
  fill: none;
  stroke: currentColor;
