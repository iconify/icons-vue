...
const content = `<path class="gzr9g4owr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:quiz-outline" /></template>
<style>
.gzr9g4owr {
  fill: currentColor;
