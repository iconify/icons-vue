...
const content = `<path class="fb_s5wbck"/><path class="ex0aer9bf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-js" /></template>
<style>
.ex0aer9bf {
...
.fb_s5wbck {
  fill: var(--svg-color--bfb555, #bfb555);
