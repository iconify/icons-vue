...
const content = `<path class="dio-ykiht"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sq4you" /></template>
<style>
.dio-ykiht {
  fill: none;
  stroke: currentColor;
