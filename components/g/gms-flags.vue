...
const content = `<path class="duzjxx5yb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gms-flags" /></template>
<style>
.duzjxx5yb {
  fill: none;
  stroke: currentColor;
