...
const content = `<path class="ebaj1u_hk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:center-horizontally-24-filled" /></template>
<style>
.ebaj1u_hk {
  fill: currentColor;
