...
const content = `<path class="jy6hpjobh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-sync-16-filled" /></template>
<style>
.jy6hpjobh {
  fill: currentColor;
