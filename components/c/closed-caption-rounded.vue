...
const content = `<path class="x4075tdba"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:closed-caption-rounded" /></template>
<style>
.x4075tdba {
  fill: currentColor;
