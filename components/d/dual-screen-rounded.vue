...
const content = `<path class="uda46oblz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dual-screen-rounded" /></template>
<style>
.uda46oblz {
  fill: currentColor;
