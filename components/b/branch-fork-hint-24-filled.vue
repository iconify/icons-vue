...
const content = `<path class="tlg89jbgb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:branch-fork-hint-24-filled" /></template>
<style>
.tlg89jbgb {
  fill: currentColor;
