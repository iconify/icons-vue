...
const content = `<path class="s7zn0db5h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mic-off-rounded" /></template>
<style>
.s7zn0db5h {
  fill: currentColor;
