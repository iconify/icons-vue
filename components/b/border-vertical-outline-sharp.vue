...
const content = `<path class="v_xso21ay"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:border-vertical-outline-sharp" /></template>
<style>
.v_xso21ay {
  fill: currentColor;
