...
const content = `<path class="yg8ux522d"/><circle class="t238zrbfy"/><path class="ocllzvr6x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cimenio" /></template>
<style>
.ocllzvr6x {
  fill: none;
  stroke: currentColor;
  ...
  d: path("m30.135 19.927l-8.18 8.146L17.865 24");
}
