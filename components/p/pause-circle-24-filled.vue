...
const content = `<path class="mkd2siwly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pause-circle-24-filled" /></template>
<style>
.mkd2siwly {
  fill: currentColor;
