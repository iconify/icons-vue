...
const content = `<path class="oon1vrbdd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:circle-wavy-warning-bold" /></template>
<style>
.oon1vrbdd {
  fill: currentColor;
