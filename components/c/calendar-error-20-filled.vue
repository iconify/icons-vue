...
const content = `<path class="itksqtbhs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-error-20-filled" /></template>
<style>
.itksqtbhs {
  fill: currentColor;
