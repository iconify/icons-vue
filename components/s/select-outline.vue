...
const content = `<path class="py-b4wb4g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:select-outline" /></template>
<style>
.py-b4wb4g {
  fill: currentColor;
