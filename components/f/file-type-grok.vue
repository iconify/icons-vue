...
const content = `<path class="avoovx_ho"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-grok" /></template>
<style>
.avoovx_ho {
