...
const content = `<path class="q5l39qk8j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:multiselect-ltr-16-filled" /></template>
<style>
.q5l39qk8j {
  fill: currentColor;
