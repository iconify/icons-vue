...
const content = `<path class="zen5vbc0r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-strikethrough-24-regular" /></template>
<style>
.zen5vbc0r {
  fill: currentColor;
