...
const content = `<path class="hp91jsbvq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tag-lock-32-regular" /></template>
<style>
.hp91jsbvq {
  fill: currentColor;
