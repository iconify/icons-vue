...
const content = `<path class="yv-36ml6j"/><defs><path id="SVGngJ5edLm" class="ukzpribaw"/></defs><clipPath id="SVGkyBsod2b"><use href="#SVGngJ5edLm"/></clipPath><g clip-path="url(#SVGkyBsod2b)" class="tcw5ljb1b"><path class="lnq-844mv"/></g><defs><use href="#SVGngJ5edLm" id="SVGCZdLybDO"/></defs><clipPath id="SVG9bWfJdrK"><use href="#SVGCZdLybDO"/></clipPath><g clip-path="url(#SVG9bWfJdrK)" class="t3q4o6ulj"><path class="jycsq1plr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:hand-with-index-finger-and-thumb-crossed" /></template>
<style>
.jycsq1plr {
