...
const content = `<g class="cuyn6tgcc"><path class="ta_khf4lj"/><path class="xwp1w6qfm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:battery-low-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
