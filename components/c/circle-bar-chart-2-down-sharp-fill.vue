...
const content = `<path clip-rule="evenodd" class="anrqqjrjv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-bar-chart-2-down-sharp-fill" /></template>
<style>
.anrqqjrjv {
  fill: currentColor;
  fill-rule: evenodd;
