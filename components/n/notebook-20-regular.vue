...
const content = `<path class="n36ncdvrf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notebook-20-regular" /></template>
<style>
.n36ncdvrf {
  fill: currentColor;
