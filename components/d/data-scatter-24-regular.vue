...
const content = `<path class="rmr2f_bsu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-scatter-24-regular" /></template>
<style>
.rmr2f_bsu {
  fill: currentColor;
