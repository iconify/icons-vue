...
const content = `<path class="w5_gd2b8h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:transcribe" /></template>
<style>
.w5_gd2b8h {
  fill: currentColor;
