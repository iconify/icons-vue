...
const content = `<path class="ktqpz0uqj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-lock-20-regular" /></template>
<style>
.ktqpz0uqj {
  fill: currentColor;
