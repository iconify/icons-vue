...
const content = `<path class="t-2zz6ecl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dock-panel-right-16-filled" /></template>
<style>
.t-2zz6ecl {
  fill: currentColor;
