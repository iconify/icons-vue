...
const content = `<path class="asdaibbnv"/><path class="con0ejjfj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-sports-motorsports" /></template>
<style>
.asdaibbnv {
  fill: currentColor;
