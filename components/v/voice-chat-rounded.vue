...
const content = `<path class="anuyyh8_h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:voice-chat-rounded" /></template>
<style>
.anuyyh8_h {
  fill: currentColor;
