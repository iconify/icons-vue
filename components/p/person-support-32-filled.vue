...
const content = `<path class="thaain4vq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-support-32-filled" /></template>
<style>
.thaain4vq {
  fill: currentColor;
