...
const content = `<g class="nrj6p8qat"><path class="vhck9ybet"/><path clip-rule="evenodd" class="qa1terbik"/><path class="as_lwow4k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-up-duotone" /></template>
<style>
.as_lwow4k {
  d: path("M18 22V16M15 19L18 16L21 19");
}
