...
const content = `<g class="cuyn6tgcc"><path class="e1fui_b5l"/><path class="pftdq7syg"/><path class="eq71uyb3g"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:share-ios" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
