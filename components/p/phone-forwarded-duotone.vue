...
const content = `<g class="nrj6p8qat"><path class="n802joiny"/><path class="w74z78bpv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-forwarded-duotone" /></template>
<style>
.n802joiny {
  fill: currentColor;
...
.w74z78bpv {
  d: path("M16 5L22 5M19 2L22 5L19 8");
}
