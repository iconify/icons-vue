...
const content = `<path class="xfvw2-b9z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-link-28-regular" /></template>
<style>
.xfvw2-b9z {
  fill: currentColor;
