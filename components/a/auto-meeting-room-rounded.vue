...
const content = `<path class="qv6j_obxs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-meeting-room-rounded" /></template>
<style>
.qv6j_obxs {
  fill: currentColor;
