...
const content = `<path class="baqtufkrx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-text-24-filled" /></template>
<style>
.baqtufkrx {
  fill: currentColor;
