...
const content = `<path class="jpcua_09i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:switch-access-3-sharp" /></template>
<style>
.jpcua_09i {
  fill: currentColor;
