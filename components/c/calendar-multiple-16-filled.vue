...
const content = `<path class="kr8gt8vpp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-multiple-16-filled" /></template>
<style>
.kr8gt8vpp {
  fill: currentColor;
