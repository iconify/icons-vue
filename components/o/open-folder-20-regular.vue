...
const content = `<path class="u6b97w0yy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:open-folder-20-regular" /></template>
<style>
.u6b97w0yy {
  fill: currentColor;
