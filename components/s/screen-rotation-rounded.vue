...
const content = `<path class="vw2_jxgyi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:screen-rotation-rounded" /></template>
<style>
.vw2_jxgyi {
  fill: currentColor;
