...
const content = `<path class="e06b82bae"/><path class="nb33ynpnx"/><path class="e1nxcob9o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:green-heart" /></template>
<style>
.e06b82bae {
