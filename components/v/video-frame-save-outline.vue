...
const content = `<path class="wwm7wacaj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:video-frame-save-outline" /></template>
<style>
.wwm7wacaj {
  fill: currentColor;
