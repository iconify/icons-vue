...
const content = `<path class="ox-avgbzt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:automation-rounded" /></template>
<style>
.ox-avgbzt {
  fill: currentColor;
