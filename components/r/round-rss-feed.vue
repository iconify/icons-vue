...
const content = `<circle class="rkvc4mvdo"/><path class="thvv71mzm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-rss-feed" /></template>
<style>
.rkvc4mvdo {
  cx: 6.18px;
  cy: 17.82px;
