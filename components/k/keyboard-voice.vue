...
const content = `<path class="isgl9g9vs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-voice" /></template>
<style>
.isgl9g9vs {
  fill: currentColor;
