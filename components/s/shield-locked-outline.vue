...
const content = `<path class="jszjj4bwl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shield-locked-outline" /></template>
<style>
.jszjj4bwl {
  fill: currentColor;
