...
const content = `<g class="cuyn6tgcc"><path class="n4g-ljr-z"/><path class="f63t8zb5u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:corners-out-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
