...
const content = `<path class="jm32jyb_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:calendar-view-month-outline-rounded" /></template>
<style>
.jm32jyb_k {
  fill: currentColor;
