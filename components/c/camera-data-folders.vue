...
const content = `<path class="smcs7pbqo"/><path class="xf9ltsbhu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:camera-data-folders" /></template>
<style>
.smcs7pbqo {
  fill: none;
  stroke: currentColor;
