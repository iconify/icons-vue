...
const content = `<path class="knq_hsb-t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:motion-photos-auto-outline-sharp" /></template>
<style>
.knq_hsb-t {
  fill: currentColor;
