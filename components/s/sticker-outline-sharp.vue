...
const content = `<path class="vzrjqwqmi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sticker-outline-sharp" /></template>
<style>
.vzrjqwqmi {
  fill: currentColor;
