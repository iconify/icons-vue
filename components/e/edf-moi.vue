...
const content = `<path class="bygth3lye"/><circle class="s45mz4bwz"/><path class="fx46dxbgo"/><path class="g2wj9jbhp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:edf-moi" /></template>
<style>
.bygth3lye {
  fill: none;
  stroke: currentColor;
...
.fx46dxbgo {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M36.138 28.49v4.467m-12.723 2.824s6.128-2.084 12.731-1.377");
}
