...
const content = `<path class="vk93w_b2w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:eyedropper-16-regular" /></template>
<style>
.vk93w_b2w {
  fill: currentColor;
