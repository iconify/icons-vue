...
const content = `<path class="puyt1dxjs"/><path class="ik_244bja"/><path class="kwnb8lq5l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-burkina-faso" /></template>
<style>
.ik_244bja {
