...
const content = `<path class="gzo2nqhlf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:backpack-32-regular" /></template>
<style>
.gzo2nqhlf {
  fill: currentColor;
