...
const content = `<path class="c5rhlmbtm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cast-connected-outline" /></template>
<style>
.c5rhlmbtm {
  fill: currentColor;
