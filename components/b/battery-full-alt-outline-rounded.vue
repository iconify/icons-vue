...
const content = `<path class="ey8vvm-ul"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-full-alt-outline-rounded" /></template>
<style>
.ey8vvm-ul {
  fill: currentColor;
