...
const content = `<path class="xfes2xbuu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:eraser-size-2-outline-rounded" /></template>
<style>
.xfes2xbuu {
  fill: currentColor;
