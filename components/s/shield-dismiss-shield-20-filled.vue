...
const content = `<path class="yjr2cbg3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-dismiss-shield-20-filled" /></template>
<style>
.yjr2cbg3l {
  fill: currentColor;
