...
const content = `<path class="swqi3obdc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-offset-add-24-regular" /></template>
<style>
.swqi3obdc {
  fill: currentColor;
