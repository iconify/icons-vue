...
const content = `<path class="k7_s99bmd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-down-48-filled" /></template>
<style>
.k7_s99bmd {
  fill: currentColor;
