...
const content = `<path class="wp_03efnh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:archwikiviewer" /></template>
<style>
.wp_03efnh {
  fill: none;
  stroke: currentColor;
