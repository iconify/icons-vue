...
const content = `<path class="ju78m60yf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-text-arrow-repeat-all-32-regular" /></template>
<style>
.ju78m60yf {
  fill: currentColor;
