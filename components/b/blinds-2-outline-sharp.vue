...
const content = `<path class="wmmcuacgp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:blinds-2-outline-sharp" /></template>
<style>
.wmmcuacgp {
  fill: currentColor;
