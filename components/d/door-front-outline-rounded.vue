...
const content = `<path class="w-v6_bcyl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:door-front-outline-rounded" /></template>
<style>
.w-v6_bcyl {
  fill: currentColor;
