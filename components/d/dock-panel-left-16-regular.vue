...
const content = `<path class="ilbk15b5z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dock-panel-left-16-regular" /></template>
<style>
.ilbk15b5z {
  fill: currentColor;
