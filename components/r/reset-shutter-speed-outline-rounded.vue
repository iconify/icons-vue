...
const content = `<path class="b2qjmfbcj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:reset-shutter-speed-outline-rounded" /></template>
<style>
.b2qjmfbcj {
  fill: currentColor;
