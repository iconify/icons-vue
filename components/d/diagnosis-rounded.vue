...
const content = `<path class="lpjgkibtr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:diagnosis-rounded" /></template>
<style>
.lpjgkibtr {
  fill: currentColor;
