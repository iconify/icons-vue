...
const content = `<path class="djyw7_hwy"/><path class="h5_znab0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-signal-cellular-connected-no-internet-2-bar" /></template>
<style>
.djyw7_hwy {
  fill: currentColor;
