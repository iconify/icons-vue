...
const content = `<path class="v_no2yg2p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-error-sharp" /></template>
<style>
.v_no2yg2p {
  fill: currentColor;
