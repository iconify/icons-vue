...
const content = `<path class="b9gqrhiym"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-settings-input-component" /></template>
<style>
.b9gqrhiym {
  fill: currentColor;
