...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGtDCj5adW)" clip-rule="evenodd" class="lco-996_l"/><defs><linearGradient id="SVGtDCj5adW" x1="12" x2="12" y1="3" y2="21" gradientUnits="userSpaceOnUse"><stop class="zkdjv7bkb"/><stop offset="1" class="jlm57rbiy"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:game" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
