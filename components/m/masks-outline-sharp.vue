...
const content = `<path class="jwy8gv5id"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:masks-outline-sharp" /></template>
<style>
.jwy8gv5id {
  fill: currentColor;
