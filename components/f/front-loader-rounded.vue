...
const content = `<path class="nx88b_a8a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:front-loader-rounded" /></template>
<style>
.nx88b_a8a {
  fill: currentColor;
