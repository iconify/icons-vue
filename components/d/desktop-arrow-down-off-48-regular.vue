...
const content = `<path class="rdab53b0o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-arrow-down-off-48-regular" /></template>
<style>
.rdab53b0o {
  fill: currentColor;
