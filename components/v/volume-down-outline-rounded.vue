...
const content = `<path class="yksxnj5nb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:volume-down-outline-rounded" /></template>
<style>
.yksxnj5nb {
  fill: currentColor;
