...
const content = `<path class="aemwagbae"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:game-stick-left-sharp" /></template>
<style>
.aemwagbae {
  fill: currentColor;
