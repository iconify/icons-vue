...
const content = `<path class="h7x61-bgr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:event-repeat-rounded" /></template>
<style>
.h7x61-bgr {
  fill: currentColor;
