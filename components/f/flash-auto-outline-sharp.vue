...
const content = `<path class="iotfljtfh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flash-auto-outline-sharp" /></template>
<style>
.iotfljtfh {
  fill: currentColor;
