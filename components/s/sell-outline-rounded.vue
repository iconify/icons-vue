...
const content = `<path class="qpqg4r_ft"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sell-outline-rounded" /></template>
<style>
.qpqg4r_ft {
  fill: currentColor;
