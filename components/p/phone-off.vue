...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="g2763sb8r"/><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:phone-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
