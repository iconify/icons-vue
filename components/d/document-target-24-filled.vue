...
const content = `<path class="zrv643bin"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-target-24-filled" /></template>
<style>
.zrv643bin {
  fill: currentColor;
