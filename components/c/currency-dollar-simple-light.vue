...
const content = `<path class="ollky8wjq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:currency-dollar-simple-light" /></template>
<style>
.ollky8wjq {
  fill: currentColor;
