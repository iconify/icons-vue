...
const content = `<path class="e7rkzv_un"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:adf-scanner-rounded" /></template>
<style>
.e7rkzv_un {
  fill: currentColor;
