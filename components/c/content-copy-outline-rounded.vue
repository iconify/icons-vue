...
const content = `<path class="w-4o16bpe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:content-copy-outline-rounded" /></template>
<style>
.w-4o16bpe {
  fill: currentColor;
