...
const content = `<g class="cuyn6tgcc"><path class="ta_khf4lj"/><path class="sn-vptbmj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:battery-full-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
