...
const content = `<g class="cuyn6tgcc"><path class="fk_p0hbrn"/><path class="kd02s7h1s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:twitter-logo-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
