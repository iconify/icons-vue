...
const content = `<path class="gcem08bwv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-flowchart-20-filled" /></template>
<style>
.gcem08bwv {
  fill: currentColor;
