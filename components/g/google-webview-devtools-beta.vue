...
const content = `<path class="irxn69bjm"/><circle class="mcgshmchu"/><path class="pnn8q2bqa"/><circle class="vi_nxfq0r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:google-webview-devtools-beta" /></template>
<style>
.irxn69bjm {
  fill: none;
  stroke: currentColor;
...
.pnn8q2bqa {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M23.995 14.736h18.14M31.012 30.057L19.159 44.182M8.764 22.002l7.491 7.09M39.372 38.5a2 2 0 1 1 0 4h-3.3v-8h3.3a2 2 0 1 1 0 4m0 0h-3.3");
}
