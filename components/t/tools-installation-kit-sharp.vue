...
const content = `<path class="wjxptkbya"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tools-installation-kit-sharp" /></template>
<style>
.wjxptkbya {
  fill: currentColor;
