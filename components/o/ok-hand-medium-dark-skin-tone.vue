...
const content = `<path class="qexg-bgun"/><path class="oi5nwxj7b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:ok-hand-medium-dark-skin-tone" /></template>
<style>
.oi5nwxj7b {
