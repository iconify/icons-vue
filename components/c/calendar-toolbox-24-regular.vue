...
const content = `<path class="vk6uflblv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-toolbox-24-regular" /></template>
<style>
.vk6uflblv {
  fill: currentColor;
