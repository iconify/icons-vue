...
const content = `<circle class="hc_5wyobp"/><circle class="iz4ladcvf"/><path class="kcv_tqtab"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pop-avain" /></template>
<style>
.hc_5wyobp {
  cx: 14.746px;
  cy: 15.08px;
