...
const content = `<path class="ammjlfgop"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:diamond" /></template>
<style>
.ammjlfgop {
  fill: currentColor;
