...
const content = `<path class="o3fqfacvy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:git-pull-request-arrow-sharp" /></template>
<style>
.o3fqfacvy {
  fill: none;
  stroke: currentColor;
