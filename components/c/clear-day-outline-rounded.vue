...
const content = `<path class="i3fozybax"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:clear-day-outline-rounded" /></template>
<style>
.i3fozybax {
  fill: currentColor;
