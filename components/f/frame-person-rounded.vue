...
const content = `<path class="f5f314k6f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:frame-person-rounded" /></template>
<style>
.f5f314k6f {
  fill: currentColor;
