...
const content = `<path class="kven56bln"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-contract-20-regular" /></template>
<style>
.kven56bln {
  fill: currentColor;
