...
const content = `<path class="hz86g-v_s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-more-20-regular" /></template>
<style>
.hz86g-v_s {
  fill: currentColor;
