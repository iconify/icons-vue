...
const content = `<path class="y9-51o8dl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:egg-alt-rounded" /></template>
<style>
.y9-51o8dl {
  fill: currentColor;
