...
const content = `<path class="yxv_h_b3x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chevron-circle-left-28-filled" /></template>
<style>
.yxv_h_b3x {
  fill: currentColor;
