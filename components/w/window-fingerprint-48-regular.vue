...
const content = `<path class="yizn89rym"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-fingerprint-48-regular" /></template>
<style>
.yizn89rym {
  fill: currentColor;
