...
const content = `<path class="wriul2bzs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-tight-24-regular" /></template>
<style>
.wriul2bzs {
  fill: currentColor;
