...
const content = `<path class="ypbl_66aj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:toys-and-games-outline-rounded" /></template>
<style>
.ypbl_66aj {
  fill: currentColor;
