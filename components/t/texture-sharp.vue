...
const content = `<path class="c82xd1btj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:texture-sharp" /></template>
<style>
.c82xd1btj {
  fill: currentColor;
