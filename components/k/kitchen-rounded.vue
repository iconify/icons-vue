...
const content = `<path class="csbj2_sam"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:kitchen-rounded" /></template>
<style>
.csbj2_sam {
  fill: currentColor;
