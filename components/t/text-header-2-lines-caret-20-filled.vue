...
const content = `<path class="ix0dzsbuo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-2-lines-caret-20-filled" /></template>
<style>
.ix0dzsbuo {
  fill: currentColor;
