...
const content = `<path class="n6ggyys5j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:temperature-degree-fahrenheit-32-filled" /></template>
<style>
.n6ggyys5j {
  fill: currentColor;
