...
const content = `<path class="g_h1y7bnw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:car-seat-off-outline-sharp" /></template>
<style>
.g_h1y7bnw {
  fill: currentColor;
