...
const content = `<path class="m6agembmw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:slab-serif" /></template>
<style>
.m6agembmw {
  fill: currentColor;
