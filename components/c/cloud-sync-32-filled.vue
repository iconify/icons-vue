...
const content = `<path class="fc_w3podi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-sync-32-filled" /></template>
<style>
.fc_w3podi {
  fill: currentColor;
