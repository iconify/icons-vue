...
const content = `<path class="tgzy50bab"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:warning-outline-rounded" /></template>
<style>
.tgzy50bab {
  fill: currentColor;
