...
const content = `<path class="f3plc7bbz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-partly-cloudy-day-24-regular" /></template>
<style>
.f3plc7bbz {
  fill: currentColor;
