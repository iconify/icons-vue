...
const content = `<g class="cuyn6tgcc"><path class="gpsc5ya0f"/><path class="vz2-h7ycr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:queue-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
