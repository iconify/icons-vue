...
const content = `<path class="anobt-b6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-add-20-regular" /></template>
<style>
.anobt-b6u {
  fill: currentColor;
