...
const content = `<path class="e_ej-21xr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:youtube-music" /></template>
<style>
.e_ej-21xr {
  fill: currentColor;
