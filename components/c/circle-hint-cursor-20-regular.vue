...
const content = `<path class="r5ahknbdn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:circle-hint-cursor-20-regular" /></template>
<style>
.r5ahknbdn {
  fill: currentColor;
