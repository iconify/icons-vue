...
const content = `<path class="nuqmcbb4v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:swipe-down-20-filled" /></template>
<style>
.nuqmcbb4v {
  fill: currentColor;
