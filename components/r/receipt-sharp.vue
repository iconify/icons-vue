...
const content = `<path class="uuhkklbel"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:receipt-sharp" /></template>
<style>
.uuhkklbel {
  fill: currentColor;
