...
const content = `<path class="wi8wc-buq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:contact-support-rounded" /></template>
<style>
.wi8wc-buq {
  fill: currentColor;
