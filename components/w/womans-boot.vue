...
const content = `<defs><path id="SVGmfNxHcFG" class="hfjt3zbay"/><path id="SVGQ1O1fe1o" class="oerjw75gt"/></defs><g class="cccublp1o"><use href="#SVGmfNxHcFG"/><use href="#SVGmfNxHcFG"/></g><g class="cccublp1o"><use href="#SVGQ1O1fe1o"/><use href="#SVGQ1O1fe1o"/></g><g class="ehej3-bmx"><ellipse class="fvd5lbcku"/><ellipse class="vx7z3t5ep"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:womans-boot" /></template>
<style>
.cccublp1o {
