...
const content = `<path class="k87wu5b7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:backspace-rounded" /></template>
<style>
.k87wu5b7l {
  fill: currentColor;
