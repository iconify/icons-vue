...
const content = `<path class="hsxn9dqvc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:collections-add-20-filled" /></template>
<style>
.hsxn9dqvc {
  fill: currentColor;
