...
const content = `<g class="gp_8x1bzb"><path class="l-1ucdbni"/><path class="er1p0-brb"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-more-horizontal-sharp" /></template>
<style>
.er1p0-brb {
  fill: currentColor;
