...
const content = `<path class="sutvrrf4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-paragraph-direction-24-regular" /></template>
<style>
.sutvrrf4n {
  fill: currentColor;
