...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="fqaf-zijl"/><path clip-rule="evenodd" class="a1mo55oec"/><path class="a_8_-56vs"/><path clip-rule="evenodd" class="jg0x75bdh"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:hourglass-circle" /></template>
<style>
.a_8_-56vs {
