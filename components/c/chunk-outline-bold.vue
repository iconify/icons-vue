...
const content = `<g class="s0phu2bbs"><path class="d-4q6bcoc"/><path class="d9sl7h_4e"/><path class="tpbrklbww"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:chunk-outline-bold" /></template>
<style>
.d-4q6bcoc {
