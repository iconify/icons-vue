...
const content = `<path class="j7gdpsknv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:electric-car-sharp" /></template>
<style>
.j7gdpsknv {
  fill: currentColor;
