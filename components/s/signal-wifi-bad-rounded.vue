...
const content = `<path class="mx8duebdu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-wifi-bad-rounded" /></template>
<style>
.mx8duebdu {
  fill: currentColor;
