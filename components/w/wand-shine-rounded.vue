...
const content = `<path class="tc8i2mbxg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wand-shine-rounded" /></template>
<style>
.tc8i2mbxg {
  fill: currentColor;
