...
const content = `<path class="o24e2unzb"/><path class="z2vld4brg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-switzerland" /></template>
<style>
.o24e2unzb {
