...
const content = `<circle class="bpwmlr2ve"/><path class="ag_go2bly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:openchaoschess" /></template>
<style>
.ag_go2bly {
  fill: none;
  stroke: currentColor;
