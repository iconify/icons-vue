...
const content = `<path class="cmwuxw09s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:specific-gravity" /></template>
<style>
.cmwuxw09s {
  fill: currentColor;
