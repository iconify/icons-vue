...
const content = `<path class="n1s033b4u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:license-outline-sharp" /></template>
<style>
.n1s033b4u {
  fill: currentColor;
