...
const content = `<path class="mcbn-rb1i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-2-lines-16-regular" /></template>
<style>
.mcbn-rb1i {
  fill: currentColor;
