...
const content = `<path class="aaibd31ce"/><path class="recgh1bvq"/><path class="fi78vq6nn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-wallis-and-futuna" /></template>
<style>
.aaibd31ce {
