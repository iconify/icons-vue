...
const content = `<path class="zncnabfco"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:markdown-copy-outline" /></template>
<style>
.zncnabfco {
  fill: currentColor;
