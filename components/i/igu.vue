...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGM66NFbiC)" class="uxo85vbhz"/><defs><linearGradient id="SVGM66NFbiC" x1="4.208" x2="21.696" y1="7.331" y2="14.011" gradientUnits="userSpaceOnUse"><stop class="y8cnyebmq"/><stop offset="1" class="f5rrk2bzu"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:igu" /></template>
<style>
.f5rrk2bzu {
