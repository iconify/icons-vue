...
const content = `<path class="mvsad4bqf"/><path class="t7lxhzbse"/><path class="zo8yn6dto"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-screenshot-monitor" /></template>
<style>
.mvsad4bqf {
  fill: currentColor;
