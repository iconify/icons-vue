...
const content = `<path class="lq98vz11d"/><path class="k4n51fjcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-3mp" /></template>
<style>
.k4n51fjcs {
  fill: currentColor;
