...
const content = `<path class="ov3--jb7w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:port-hdmi-24-regular" /></template>
<style>
.ov3--jb7w {
  fill: currentColor;
