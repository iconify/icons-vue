...
const content = `<path class="ujns21bnh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:show-chart-outline-rounded" /></template>
<style>
.ujns21bnh {
  fill: currentColor;
