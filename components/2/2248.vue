...
const content = `<rect class="qy8a8dzsd"/><rect class="ieznx5rfm"/><rect class="cm_xiujcg"/><rect class="n7959htri"/><path class="ze8fg4b9o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:2248" /></template>
<style>
.cm_xiujcg {
  width: 18.5px;
  height: 18.5px;
