...
const content = `<path class="zlq5zqyaj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:star-tv" /></template>
<style>
.zlq5zqyaj {
  fill: none;
  stroke: currentColor;
