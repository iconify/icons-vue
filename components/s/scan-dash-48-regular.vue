...
const content = `<path class="ww78qrbhr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-dash-48-regular" /></template>
<style>
.ww78qrbhr {
  fill: currentColor;
