...
const content = `<path class="dfiw_2btz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-align-left-rotate-90-24-regular" /></template>
<style>
.dfiw_2btz {
  fill: currentColor;
