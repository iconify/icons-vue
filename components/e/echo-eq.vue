...
const content = `<path class="f2fbp5q8r"/><path class="r5_x7ebjv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:echo-eq" /></template>
<style>
.f2fbp5q8r {
  fill: none;
  stroke: currentColor;
