...
const content = `<path class="ehlh_12pi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-8-28-regular" /></template>
<style>
.ehlh_12pi {
  fill: currentColor;
