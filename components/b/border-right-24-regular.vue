...
const content = `<path class="t1rweouoc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-right-24-regular" /></template>
<style>
.t1rweouoc {
  fill: currentColor;
