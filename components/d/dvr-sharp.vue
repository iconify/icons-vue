...
const content = `<path class="d-5-g3u-q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dvr-sharp" /></template>
<style>
.d-5-g3u-q {
  fill: currentColor;
