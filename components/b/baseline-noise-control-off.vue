...
const content = `<path class="ir7yd_-5r"/><circle class="ahwkywbwd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-noise-control-off" /></template>
<style>
.ahwkywbwd {
  cx: 13.5px;
  cy: 12.5px;
