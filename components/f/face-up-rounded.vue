...
const content = `<path class="kj1yjppsl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-up-rounded" /></template>
<style>
.kj1yjppsl {
  fill: currentColor;
