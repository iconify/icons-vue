...
const content = `<path class="rwpyp285h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-add-t-20-regular" /></template>
<style>
.rwpyp285h {
  fill: currentColor;
