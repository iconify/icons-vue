...
const content = `<path class="no63-qikg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:insert-text-outline-rounded" /></template>
<style>
.no63-qikg {
  fill: currentColor;
