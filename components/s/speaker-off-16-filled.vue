...
const content = `<path class="k7hy87b-u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-off-16-filled" /></template>
<style>
.k7hy87b-u {
  fill: currentColor;
