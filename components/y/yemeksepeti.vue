...
const content = `<circle class="cpk0fnbgt"/><path class="ozwhptn8f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:yemeksepeti" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
