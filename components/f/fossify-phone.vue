...
const content = `<path class="v3vfxlb2e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fossify-phone" /></template>
<style>
.v3vfxlb2e {
  fill: none;
  stroke: currentColor;
