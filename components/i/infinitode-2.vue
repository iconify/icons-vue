...
const content = `<path class="iylw6zp5d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:infinitode-2" /></template>
<style>
.iylw6zp5d {
  fill: none;
  stroke: currentColor;
