...
const content = `<path class="ikmfq2u9s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mark-email-read" /></template>
<style>
.ikmfq2u9s {
  fill: currentColor;
