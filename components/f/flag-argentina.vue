...
const content = `<path class="e85ncgbbi"/><path class="vbxe0xtoi"/><path class="m34tzdyvu"/><path class="p4n42sbjb"/><circle class="bfw895bdy"/><path class="pwz_r9b1r"/><path class="ibxyp27ik"/><path class="cezq7acdg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-argentina" /></template>
<style>
.bfw895bdy {
  cx: 18px;
  cy: 18px;
...
.cezq7acdg {
  ...
  d: path("M17.463 18.874c0-.126.246-.229.548-.229s.548.102.548.229c0 .126-.246.229-.548.229s-.548-.103-.548-.229");
}
...
.ibxyp27ik {
  ...
  d: path("M17.801 17.774c0 .155-.261.28-.583.28c-.323 0-.584-.125-.584-.28s.261-.28.584-.28s.583.125.583.28m1.553-.024c0-.161-.266-.292-.594-.292s-.594.13-.594.292s.266.292.594.292c.329 0 .594-.131.594-.292");
}
...
.pwz_r9b1r {
  fill: var(--svg-color--843511, #843511);
  d: path("M18 20.125c-1.172 0-2.125-.953-2.125-2.125s.953-2.125 2.125-2.125s2.125.953 2.125 2.125s-.953 2.125-2.125 2.125m0-4c-1.034 0-1.875.841-1.875 1.875s.841 1.875 1.875 1.875s1.875-.841 1.875-1.875s-.841-1.875-1.875-1.875");
}
