...
const content = `<path class="r40sfdbna"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:monitoring-outline" /></template>
<style>
.r40sfdbna {
  fill: currentColor;
