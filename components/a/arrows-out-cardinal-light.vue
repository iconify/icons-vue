...
const content = `<path class="oyjq4lbis"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrows-out-cardinal-light" /></template>
<style>
.oyjq4lbis {
  fill: currentColor;
