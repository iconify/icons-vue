...
const content = `<path class="x-kz1kb7j"/><path class="rzjljdbrh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:keycap-2" /></template>
<style>
.rzjljdbrh {
