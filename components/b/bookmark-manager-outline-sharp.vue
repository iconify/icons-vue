...
const content = `<path class="b9nox81vm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bookmark-manager-outline-sharp" /></template>
<style>
.b9nox81vm {
  fill: currentColor;
