...
const content = `<path class="a9-h2tbkl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:vertical-align-bottom-outline-rounded" /></template>
<style>
.a9-h2tbkl {
  fill: currentColor;
