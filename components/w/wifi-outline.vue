...
const content = `<path class="rt1ekcc9e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wifi-outline" /></template>
<style>
.rt1ekcc9e {
  fill: currentColor;
