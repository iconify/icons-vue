...
const content = `<path class="dv-_5964l"/><path class="mjxtmnb5i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:pinching-hand-medium-skin-tone" /></template>
<style>
.dv-_5964l {
