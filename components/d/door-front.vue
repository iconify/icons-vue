...
const content = `<path class="l817du1oh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:door-front" /></template>
<style>
.l817du1oh {
  fill: currentColor;
