...
const content = `<path class="fwlqi7-vl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-vertical-bottom-outline-rounded" /></template>
<style>
.fwlqi7-vl {
  fill: currentColor;
