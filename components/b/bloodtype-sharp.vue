...
const content = `<path class="wru81-bxs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bloodtype-sharp" /></template>
<style>
.wru81-bxs {
  fill: currentColor;
