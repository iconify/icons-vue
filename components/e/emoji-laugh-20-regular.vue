...
const content = `<path class="ae1youb0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-laugh-20-regular" /></template>
<style>
.ae1youb0q {
  fill: currentColor;
