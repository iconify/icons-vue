...
const content = `<path class="yxentfbzv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cube-checkmark-28-filled" /></template>
<style>
.yxentfbzv {
  fill: currentColor;
