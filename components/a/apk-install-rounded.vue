...
const content = `<path class="f6dyh3bby"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:apk-install-rounded" /></template>
<style>
.f6dyh3bby {
  fill: currentColor;
