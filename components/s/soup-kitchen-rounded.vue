...
const content = `<path class="ypfplzb8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:soup-kitchen-rounded" /></template>
<style>
.ypfplzb8v {
  fill: currentColor;
