...
const content = `<path class="i9clfwm2k"/><path class="h2vf8fblg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mi-personal-flow" /></template>
<style>
.h2vf8fblg {
  fill: none;
  stroke: currentColor;
