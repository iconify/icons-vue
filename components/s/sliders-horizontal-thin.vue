...
const content = `<path class="nxck4tfas"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:sliders-horizontal-thin" /></template>
<style>
.nxck4tfas {
  fill: currentColor;
