...
const content = `<path class="m02yu1b9r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:head-mounted-device-rounded" /></template>
<style>
.m02yu1b9r {
  fill: currentColor;
