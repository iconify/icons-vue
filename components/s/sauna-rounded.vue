...
const content = `<path class="z91y9ff2y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sauna-rounded" /></template>
<style>
.z91y9ff2y {
  fill: currentColor;
