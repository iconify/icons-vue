...
const content = `<path class="ddxqu8mhy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drink-coffee-24-regular" /></template>
<style>
.ddxqu8mhy {
  fill: currentColor;
