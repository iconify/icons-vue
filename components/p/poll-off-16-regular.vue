...
const content = `<path class="d7ae-acuc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:poll-off-16-regular" /></template>
<style>
.d7ae-acuc {
  fill: currentColor;
