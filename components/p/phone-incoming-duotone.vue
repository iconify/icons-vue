...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-incoming-duotone" /></template>
<style>
.hr9jb5p1y {
  d: path("M16.5 7.5L21 3M16 2L16 7.5C16 7.7761 16.2239 8 16.5 8L22 8");
}
