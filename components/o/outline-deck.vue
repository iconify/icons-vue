...
const content = `<path class="c5ffibcpj"/><path class="z6k6deb5g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-deck" /></template>
<style>
.c5ffibcpj {
  fill: currentColor;
