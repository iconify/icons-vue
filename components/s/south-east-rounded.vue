...
const content = `<path class="rf75ssbkb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:south-east-rounded" /></template>
<style>
.rf75ssbkb {
  fill: currentColor;
