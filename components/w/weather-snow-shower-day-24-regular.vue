...
const content = `<path class="zamp36bjw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-snow-shower-day-24-regular" /></template>
<style>
.zamp36bjw {
  fill: currentColor;
