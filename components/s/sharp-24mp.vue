...
const content = `<path class="k4n51fjcs"/><path class="znr553bsf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-24mp" /></template>
<style>
.k4n51fjcs {
  fill: currentColor;
