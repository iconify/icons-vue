...
const content = `<path class="ncddylc7q"/><path class="y7jxxkbtf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-storefront" /></template>
<style>
.ncddylc7q {
  fill: currentColor;
  d: path("M6.44 9.86L7.02 5H5.05L4.04 9.36c-.1.42-.01.84.25 1.17c.14.18.44.47.94.47c.61 0 1.13-.49 1.21-1.14M9.71 11c.74 0 1.29-.59 1.29-1.31V5H9.04l-.55 4.52c-.05.39.07.78.33 1.07c.23.26.55.41.89.41m4.51 0c.41 0 .72-.15.96-.41c.25-.29.37-.68.33-1.07L14.96 5H13v4.69c0 .72.55 1.31 1.22 1.31m4.69-6.01L16.98 5l.58 4.86c.08.65.6 1.14 1.21 1.14c.49 0 .8-.29.93-.47c.26-.33.35-.76.25-1.17z");
