...
const content = `<path class="regumnbsx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-0-24-regular" /></template>
<style>
.regumnbsx {
  fill: currentColor;
