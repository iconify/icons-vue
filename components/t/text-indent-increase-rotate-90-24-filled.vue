...
const content = `<path class="zmgr5ibqt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-increase-rotate-90-24-filled" /></template>
<style>
.zmgr5ibqt {
  fill: currentColor;
