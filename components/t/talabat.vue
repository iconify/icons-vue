...
const content = `<path class="xq-dp6bnl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:talabat" /></template>
<style>
.xq-dp6bnl {
  fill: none;
  stroke: currentColor;
