...
const content = `<path class="jrq8bnsic"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-multiple-16-filled" /></template>
<style>
.jrq8bnsic {
  fill: currentColor;
