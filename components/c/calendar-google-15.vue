...
const content = `<path class="x7o54dbzi"/><path class="uph4zqc9i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-google-15" /></template>
<style>
.uph4zqc9i {
  fill: none;
  stroke: currentColor;
