...
const content = `<path class="bl-jldblw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-group-16-regular" /></template>
<style>
.bl-jldblw {
  fill: currentColor;
