...
const content = `<path class="p9wz9nbcq"/><path class="d2vn95b9z"/><path class="xmu3-6bgk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:sunglasses" /></template>
<style>
.d2vn95b9z {
