...
const content = `<path class="b3hsjc38r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-radar-sharp" /></template>
<style>
.b3hsjc38r {
  fill: currentColor;
