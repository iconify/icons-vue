...
const content = `<g class="cuyn6tgcc"><path class="gyg41bgej"/><path class="tp9ya-98u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:eyes-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
