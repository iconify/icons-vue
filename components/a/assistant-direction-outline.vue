...
const content = `<path class="f3bcsrhnf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:assistant-direction-outline" /></template>
<style>
.f3bcsrhnf {
  fill: currentColor;
