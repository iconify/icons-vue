...
const content = `<path class="nf3qdcb5s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-star-16-filled" /></template>
<style>
.nf3qdcb5s {
  fill: currentColor;
