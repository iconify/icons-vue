...
const content = `<path class="jj8gg2b0a"/><path class="qjyghhb0s"/><path class="opmvpj8gy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-e2e-opened" /></template>
<style>
.jj8gg2b0a {
