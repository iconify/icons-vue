...
const content = `<path class="lvl736j0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cards" /></template>
<style>
.lvl736j0l {
  fill: currentColor;
