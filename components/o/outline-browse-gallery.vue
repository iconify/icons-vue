...
const content = `<path class="o_sraloft"/><path class="g2sacpbzj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-browse-gallery" /></template>
<style>
.g2sacpbzj {
  fill: currentColor;
