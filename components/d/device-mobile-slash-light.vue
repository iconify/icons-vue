...
const content = `<path class="izdu86xbc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:device-mobile-slash-light" /></template>
<style>
.izdu86xbc {
  fill: currentColor;
