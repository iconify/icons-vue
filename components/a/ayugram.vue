...
const content = `<path class="uz315_bht"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ayugram" /></template>
<style>
.uz315_bht {
  fill: none;
  stroke: currentColor;
