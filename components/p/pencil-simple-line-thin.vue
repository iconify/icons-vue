...
const content = `<path class="chqs85b2e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:pencil-simple-line-thin" /></template>
<style>
.chqs85b2e {
  fill: currentColor;
