...
const content = `<path class="z-tnmcc5n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:door-open" /></template>
<style>
.z-tnmcc5n {
  fill: currentColor;
