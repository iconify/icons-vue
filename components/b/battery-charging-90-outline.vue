...
const content = `<path class="pic33cbbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-charging-90-outline" /></template>
<style>
.pic33cbbl {
  fill: currentColor;
