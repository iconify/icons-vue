...
const content = `<path class="pemdzz56r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-down-24-regular" /></template>
<style>
.pemdzz56r {
  fill: currentColor;
