...
const content = `<path class="jqgr58obf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-work-week-24-filled" /></template>
<style>
.jqgr58obf {
  fill: currentColor;
