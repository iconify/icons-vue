...
const content = `<path class="m-_cv_bip"/><path class="x1a6b4bft"/><path class="se6dn8_9s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lets-go-fitness" /></template>
<style>
.m-_cv_bip {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M10.907 41.242c1.658-3.87 2.688-5.438 7.904-8.889c1.393-3.833 4.036-5.942 6.294-7.712c1.064-4.228 1.21-8.734.384-10.562c-.21 1.186-1.854 2.667-3.83 3.697c.851 2.025 2.332 3.862 3.918 4.647");
}
