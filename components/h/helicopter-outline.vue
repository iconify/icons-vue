...
const content = `<path class="ad7ub2npm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:helicopter-outline" /></template>
<style>
.ad7ub2npm {
  fill: currentColor;
