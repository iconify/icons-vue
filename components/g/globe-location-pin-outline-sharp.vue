...
const content = `<path class="u5on3ab5d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:globe-location-pin-outline-sharp" /></template>
<style>
.u5on3ab5d {
  fill: currentColor;
