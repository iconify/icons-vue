...
const content = `<path class="a_bpt5bbk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-arrow-down-outline-rounded" /></template>
<style>
.a_bpt5bbk {
  fill: currentColor;
