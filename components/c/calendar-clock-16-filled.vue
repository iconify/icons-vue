...
const content = `<path class="jfo88bb6x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-clock-16-filled" /></template>
<style>
.jfo88bb6x {
  fill: currentColor;
