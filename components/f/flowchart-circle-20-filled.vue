...
const content = `<path class="za9lbrb1f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flowchart-circle-20-filled" /></template>
<style>
.za9lbrb1f {
  fill: currentColor;
