...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:file-audio-duotone" /></template>
<style>
.fpd1pwb4m {
  d: path("M20 8L14 2M14 2L14 5C14 6.6569 15.3431 8 17 8L20 8M8 14V16M12 12V18M16 14V16");
}
