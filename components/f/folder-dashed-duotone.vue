...
const content = `<g class="cuyn6tgcc"><path class="px4la-y5q"/><path class="dx38qbc6r"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-dashed-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
