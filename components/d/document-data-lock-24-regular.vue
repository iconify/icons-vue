...
const content = `<path class="jteqrcb0k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-data-lock-24-regular" /></template>
<style>
.jteqrcb0k {
  fill: currentColor;
