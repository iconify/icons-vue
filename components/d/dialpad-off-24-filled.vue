...
const content = `<path class="mcwyqyblv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dialpad-off-24-filled" /></template>
<style>
.mcwyqyblv {
  fill: currentColor;
