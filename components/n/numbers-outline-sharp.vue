...
const content = `<path class="vvyw1e31h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:numbers-outline-sharp" /></template>
<style>
.vvyw1e31h {
  fill: currentColor;
