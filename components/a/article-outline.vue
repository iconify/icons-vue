...
const content = `<path class="cvq--3bwi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:article-outline" /></template>
<style>
.cvq--3bwi {
  fill: currentColor;
