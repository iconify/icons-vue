...
const content = `<path class="u_2nee78c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:build-outline" /></template>
<style>
.u_2nee78c {
  fill: currentColor;
