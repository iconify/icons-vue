...
const content = `<g class="nrj6p8qat"><path class="cc50cvs0o"/><path class="yle293-ya"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:dice-5" /></template>
<style>
.cc50cvs0o {
