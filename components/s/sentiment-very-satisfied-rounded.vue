...
const content = `<path class="t6ca_ob9z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sentiment-very-satisfied-rounded" /></template>
<style>
.t6ca_ob9z {
  fill: currentColor;
