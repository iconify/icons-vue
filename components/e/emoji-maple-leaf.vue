...
const content = `<path class="xsmx-_bpm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-maple-leaf" /></template>
<style>
.xsmx-_bpm {
  fill: none;
  stroke: currentColor;
