...
const content = `<path class="wtmfg-8si"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:swipe-right-outline" /></template>
<style>
.wtmfg-8si {
  fill: currentColor;
