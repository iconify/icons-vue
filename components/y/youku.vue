...
const content = `<path class="yexlm0_lf"/><path class="nvc64umsv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:youku" /></template>
<style>
.nvc64umsv {
  fill: none;
  stroke: currentColor;
