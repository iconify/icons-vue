...
const content = `<g class="cuyn6tgcc"><path class="jz28tybvv"/><path class="drqjmflhv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-more-horizontal-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
