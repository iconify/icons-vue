...
const content = `<path class="zybctfb3d"/><path class="vlbnp6jhe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:whobird" /></template>
<style>
.vlbnp6jhe {
  fill: none;
  stroke: currentColor;
