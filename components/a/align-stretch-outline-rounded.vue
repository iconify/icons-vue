...
const content = `<path class="cm7_q810y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-stretch-outline-rounded" /></template>
<style>
.cm7_q810y {
  fill: currentColor;
