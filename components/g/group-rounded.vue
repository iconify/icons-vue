...
const content = `<path class="bvpxr2bff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:group-rounded" /></template>
<style>
.bvpxr2bff {
  fill: currentColor;
