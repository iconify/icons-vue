...
const content = `<path class="zkwbljbjt"/><rect class="thg6gcchx"/><path class="xjdcy_7jc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:xbox-gamepass-beta" /></template>
<style>
.thg6gcchx {
  width: 39px;
  height: 28px;
...
.xjdcy_7jc {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M39 31.998a1.5 1.5 0 0 1 0 3h-2.475v-6H39a1.5 1.5 0 0 1 0 3m0 0h-2.475");
}
