...
const content = `<path class="rxg0l-bei"/><path class="exhlnnb8b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dailydozen" /></template>
<style>
.exhlnnb8b {
  fill: none;
  stroke: currentColor;
