...
const content = `<path class="jxks33bgv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:quiet-time-active" /></template>
<style>
.jxks33bgv {
  fill: currentColor;
