...
const content = `<path class="zdl4j_bbf"/><path class="s85fu0bqj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:rightwards-hand" /></template>
<style>
.s85fu0bqj {
