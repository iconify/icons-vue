...
const content = `<path class="wi0noxp0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gif-outline-rounded" /></template>
<style>
.wi0noxp0q {
  fill: currentColor;
