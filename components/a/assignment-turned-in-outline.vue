...
const content = `<path class="oy4d2knzq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:assignment-turned-in-outline" /></template>
<style>
.oy4d2knzq {
  fill: currentColor;
