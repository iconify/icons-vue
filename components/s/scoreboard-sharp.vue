...
const content = `<path class="mjof6qbza"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:scoreboard-sharp" /></template>
<style>
.mjof6qbza {
  fill: currentColor;
