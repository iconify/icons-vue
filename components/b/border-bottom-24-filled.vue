...
const content = `<path class="qh_4to7ac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-bottom-24-filled" /></template>
<style>
.qh_4to7ac {
  fill: currentColor;
