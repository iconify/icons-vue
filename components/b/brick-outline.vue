...
const content = `<path class="bk23ogb-s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:brick-outline" /></template>
<style>
.bk23ogb-s {
  fill: currentColor;
