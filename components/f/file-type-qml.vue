...
const content = `<path class="yg0p-fbay"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-qml" /></template>
<style>
.yg0p-fbay {
  fill: var(--svg-color--41cd52, #41cd52);
