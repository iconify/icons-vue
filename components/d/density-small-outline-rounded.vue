...
const content = `<path class="kfdzqwb-o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:density-small-outline-rounded" /></template>
<style>
.kfdzqwb-o {
  fill: currentColor;
