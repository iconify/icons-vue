...
const content = `<path class="e9nnkhk5f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-lightning-24-filled" /></template>
<style>
.e9nnkhk5f {
  fill: currentColor;
