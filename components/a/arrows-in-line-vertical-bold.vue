...
const content = `<path class="rhlfbqhhl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrows-in-line-vertical-bold" /></template>
<style>
.rhlfbqhhl {
  fill: currentColor;
