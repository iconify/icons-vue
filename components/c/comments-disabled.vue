...
const content = `<path class="yaouvnxht"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:comments-disabled" /></template>
<style>
.yaouvnxht {
  fill: currentColor;
