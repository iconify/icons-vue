...
const content = `<path class="qj5ox2hor"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:special-character-outline-sharp" /></template>
<style>
.qj5ox2hor {
  fill: currentColor;
