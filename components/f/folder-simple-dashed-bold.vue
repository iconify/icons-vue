...
const content = `<path class="d28naib1f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-simple-dashed-bold" /></template>
<style>
.d28naib1f {
  fill: currentColor;
