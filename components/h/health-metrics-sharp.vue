...
const content = `<path class="b9-ladb7e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:health-metrics-sharp" /></template>
<style>
.b9-ladb7e {
  fill: currentColor;
