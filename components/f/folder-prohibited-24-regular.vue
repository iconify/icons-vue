...
const content = `<path class="pka3tkb1f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-prohibited-24-regular" /></template>
<style>
.pka3tkb1f {
  fill: currentColor;
