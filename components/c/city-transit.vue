...
const content = `<path class="qena8xbsw"/><path class="p4gd38rwp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:city-transit" /></template>
<style>
.p4gd38rwp {
  fill: none;
  stroke: currentColor;
