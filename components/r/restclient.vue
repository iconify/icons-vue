...
const content = `<path class="whoum2bql"/><path class="vrij42ixt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:restclient" /></template>
<style>
.vrij42ixt {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M22.48 29.902V18.098h3.79c2.143 0 3.88 1.775 3.88 3.964s-1.737 3.965-3.88 3.965h-3.79m-3.806-.035h-5.128m-1.27 3.91l3.834-11.804l3.834 11.804");
}
