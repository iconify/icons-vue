...
const content = `<path class="wx2ryonpn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-below-28-filled" /></template>
<style>
.wx2ryonpn {
  fill: currentColor;
