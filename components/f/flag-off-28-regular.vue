...
const content = `<path class="v7bvkfb_n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flag-off-28-regular" /></template>
<style>
.v7bvkfb_n {
  fill: currentColor;
