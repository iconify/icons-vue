...
const content = `<path class="bxrkyacas"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:print-lock-rounded" /></template>
<style>
.bxrkyacas {
  fill: currentColor;
