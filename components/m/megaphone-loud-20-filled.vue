...
const content = `<path class="kbgzhdscy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:megaphone-loud-20-filled" /></template>
<style>
.kbgzhdscy {
  fill: currentColor;
