...
const content = `<path class="er7e6lb3v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:notifications-off-outline" /></template>
<style>
.er7e6lb3v {
  fill: currentColor;
