...
const content = `<path class="szcsfh1ri"/><path class="agp1z4b3c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-european-union" /></template>
<style>
.agp1z4b3c {
