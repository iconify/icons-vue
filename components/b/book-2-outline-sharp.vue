...
const content = `<path class="whm0y423t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:book-2-outline-sharp" /></template>
<style>
.whm0y423t {
  fill: currentColor;
