...
const content = `<path class="w7ry32bgp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-sparkle-24-regular" /></template>
<style>
.w7ry32bgp {
  fill: currentColor;
