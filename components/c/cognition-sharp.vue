...
const content = `<path class="x-5uf7htg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cognition-sharp" /></template>
<style>
.x-5uf7htg {
  fill: currentColor;
