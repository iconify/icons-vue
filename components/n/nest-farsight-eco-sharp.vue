...
const content = `<path class="r_p0ikbbn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-farsight-eco-sharp" /></template>
<style>
.r_p0ikbbn {
  fill: currentColor;
