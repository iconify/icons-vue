...
const content = `<circle class="ht-k_vgcf"/><rect transform="rotate(23.198 35.707 24)" class="t3ily9b8a"/><path class="lk-qpgsjq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wide-walls" /></template>
<style>
.ht-k_vgcf {
  cx: 32.143px;
  cy: 32.316px;
