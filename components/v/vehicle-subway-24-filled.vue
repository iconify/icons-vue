...
const content = `<path class="p8m-8_-5j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-subway-24-filled" /></template>
<style>
.p8m-8_-5j {
  fill: currentColor;
