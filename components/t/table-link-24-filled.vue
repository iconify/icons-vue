...
const content = `<path class="b6ypylb5u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-link-24-filled" /></template>
<style>
.b6ypylb5u {
  fill: currentColor;
