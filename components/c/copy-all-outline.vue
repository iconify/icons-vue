...
const content = `<path class="zs7me6blw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:copy-all-outline" /></template>
<style>
.zs7me6blw {
  fill: currentColor;
