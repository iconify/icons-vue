...
const content = `<path class="r44s6_2wn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-arrow-up-16-filled" /></template>
<style>
.r44s6_2wn {
  fill: currentColor;
