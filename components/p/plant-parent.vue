...
const content = `<path class="znkafc3za"/><path class="v-mdmac3k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:plant-parent" /></template>
<style>
.v-mdmac3k {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M19.35 9.693c.546-1.01 1.092-2.021 1.815-2.881s1.624-1.569 2.128-1.968c.504-.4.611-.488 1.213-.067s1.699 1.353 2.549 2.243s1.453 1.738 2.056 2.585m-5.125 18.733V43.5");
}
