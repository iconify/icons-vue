...
const content = `<path class="avbif9b4u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:place-item-outline" /></template>
<style>
.avbif9b4u {
  fill: currentColor;
