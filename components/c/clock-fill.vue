...
const content = `<path clip-rule="evenodd" class="g4ex10bfa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:clock-fill" /></template>
<style>
.g4ex10bfa {
  fill: currentColor;
  fill-rule: evenodd;
