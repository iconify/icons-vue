...
const content = `<path class="z1pcly0jx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-circle-nine-fill" /></template>
<style>
.z1pcly0jx {
  fill: currentColor;
