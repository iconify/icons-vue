...
const content = `<path class="es-hj9e0z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:kid-star-outline-sharp" /></template>
<style>
.es-hj9e0z {
  fill: currentColor;
