...
const content = `<path class="i9clfwm2k"/><path class="ypxzvkb6m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lex" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
