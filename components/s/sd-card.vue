...
const content = `<path class="kc-5ykbhe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sd-card" /></template>
<style>
.kc-5ykbhe {
  fill: currentColor;
