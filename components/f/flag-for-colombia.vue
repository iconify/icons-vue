...
const content = `<path class="g6_6jab3q"/><path class="jqo74lbth"/><path class="l1-0mcblx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-colombia" /></template>
<style>
.g6_6jab3q {
