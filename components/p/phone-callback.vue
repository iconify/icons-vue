...
const content = `<path class="p9n5cdf6o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phone-callback" /></template>
<style>
.p9n5cdf6o {
  fill: currentColor;
