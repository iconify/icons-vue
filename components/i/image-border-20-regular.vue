...
const content = `<path class="mxgru27wr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-border-20-regular" /></template>
<style>
.mxgru27wr {
  fill: currentColor;
