...
const content = `<path class="c9fepxbdi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-desktop-add-20-regular" /></template>
<style>
.c9fepxbdi {
  fill: currentColor;
