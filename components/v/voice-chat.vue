...
const content = `<path class="sskiqhiqn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:voice-chat" /></template>
<style>
.sskiqhiqn {
  fill: currentColor;
