...
const content = `<path class="gh4ai_b7o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:yoshoku-rounded" /></template>
<style>
.gh4ai_b7o {
  fill: currentColor;
