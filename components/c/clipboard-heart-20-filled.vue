...
const content = `<path class="af5ha5b_j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-heart-20-filled" /></template>
<style>
.af5ha5b_j {
  fill: currentColor;
