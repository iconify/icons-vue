...
const content = `<path class="zf3hugb_b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-database-32-regular" /></template>
<style>
.zf3hugb_b {
  fill: currentColor;
