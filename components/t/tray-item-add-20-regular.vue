...
const content = `<path class="bi1tq-bfm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tray-item-add-20-regular" /></template>
<style>
.bi1tq-bfm {
  fill: currentColor;
