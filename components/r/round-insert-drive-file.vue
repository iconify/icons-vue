...
const content = `<path class="viknp3b6l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-insert-drive-file" /></template>
<style>
.viknp3b6l {
  fill: currentColor;
