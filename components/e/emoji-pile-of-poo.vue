...
const content = `<path class="ylh_elb1b"/><path class="gtxgledwp"/><path class="ni_97qz8m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-pile-of-poo" /></template>
<style>
.gtxgledwp {
  fill: none;
  stroke: currentColor;
...
.ni_97qz8m {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M31.211 27.606a1.602 1.602 0 1 1-3.204 0a1.602 1.602 0 0 1 3.204 0m-13.136.32a1.602 1.602 0 1 1-3.204.001a1.602 1.602 0 0 1 3.204 0");
}
