...
const content = `<path class="e_cwjcboc"/><path class="p63cjk_zx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-police-car-light" /></template>
<style>
.e_cwjcboc {
  fill: none;
  stroke: currentColor;
