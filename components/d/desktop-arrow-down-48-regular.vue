...
const content = `<path class="t01jgybxo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-arrow-down-48-regular" /></template>
<style>
.t01jgybxo {
  fill: currentColor;
