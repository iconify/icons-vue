...
const content = `<path class="meh6g5bwh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:medical-information-rounded" /></template>
<style>
.meh6g5bwh {
  fill: currentColor;
