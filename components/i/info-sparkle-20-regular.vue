...
const content = `<path class="hooos9vya"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:info-sparkle-20-regular" /></template>
<style>
.hooos9vya {
  fill: currentColor;
