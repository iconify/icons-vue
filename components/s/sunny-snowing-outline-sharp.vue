...
const content = `<path class="pzku7ubtn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sunny-snowing-outline-sharp" /></template>
<style>
.pzku7ubtn {
  fill: currentColor;
