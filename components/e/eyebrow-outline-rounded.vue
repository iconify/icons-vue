...
const content = `<path class="hei9rwbch"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:eyebrow-outline-rounded" /></template>
<style>
.hei9rwbch {
  fill: currentColor;
