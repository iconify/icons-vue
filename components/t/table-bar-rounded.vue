...
const content = `<path class="nk4o7obyj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-bar-rounded" /></template>
<style>
.nk4o7obyj {
  fill: currentColor;
