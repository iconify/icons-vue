...
const content = `<path class="bwkczq46i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-top-48-regular" /></template>
<style>
.bwkczq46i {
  fill: currentColor;
