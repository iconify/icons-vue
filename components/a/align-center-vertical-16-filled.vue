...
const content = `<path class="tfu7xgbem"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-center-vertical-16-filled" /></template>
<style>
.tfu7xgbem {
  fill: currentColor;
