...
const content = `<path class="g9syw_bdn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:change-circle-outline-rounded" /></template>
<style>
.g9syw_bdn {
  fill: currentColor;
