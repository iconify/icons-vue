...
const content = `<circle class="m0cm6-3ir"/><path class="lhuj1ia-j"/><path class="d1xc_ibmw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:smiling-face-with-halo" /></template>
<style>
.d1xc_ibmw {
  fill: var(--svg-color--28a6de, #28a6de);
  d: path("M31.991.374C14.323.374 0 3.831 0 8.096s14.323 7.723 31.991 7.723s31.991-3.458 31.991-7.723S49.658.374 31.991.374m-.279 9.101c-9.782 0-17.714-1.915-17.714-4.274c0-2.364 7.933-4.276 17.714-4.276c9.785 0 17.718 1.913 17.718 4.276c0 2.36-7.933 4.274-17.718 4.274");
}
