...
const content = `<path class="bbsut2k8u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-toolbox-24-filled" /></template>
<style>
.bbsut2k8u {
  fill: currentColor;
