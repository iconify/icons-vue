...
const content = `<path class="xv3k9ub-w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-0-16-regular" /></template>
<style>
.xv3k9ub-w {
  fill: currentColor;
