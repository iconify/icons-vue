...
const content = `<path class="mpmwcqb0j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tag-question-mark-16-filled" /></template>
<style>
.mpmwcqb0j {
  fill: currentColor;
