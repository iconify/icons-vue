...
const content = `<path class="qwsrrqbhm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:done-all-outline" /></template>
<style>
.qwsrrqbhm {
  fill: currentColor;
