...
const content = `<path class="zm5_jrbjb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:visibility-lock-outline-rounded" /></template>
<style>
.zm5_jrbjb {
  fill: currentColor;
