...
const content = `<path class="v73q2xbsb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:app-spark" /></template>
<style>
.v73q2xbsb {
  fill: currentColor;
