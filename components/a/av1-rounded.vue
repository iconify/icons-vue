...
const content = `<path class="gnf-5cbpf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:av1-rounded" /></template>
<style>
.gnf-5cbpf {
  fill: currentColor;
