...
const content = `<path class="khiifybnn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:agender-outline-sharp" /></template>
<style>
.khiifybnn {
  fill: currentColor;
