...
const content = `<path class="x5fkptthv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-person-16-filled" /></template>
<style>
.x5fkptthv {
  fill: currentColor;
