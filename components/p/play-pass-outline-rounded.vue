...
const content = `<path class="vqmctn1xa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:play-pass-outline-rounded" /></template>
<style>
.vqmctn1xa {
  fill: currentColor;
