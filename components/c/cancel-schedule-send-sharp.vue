...
const content = `<path class="lkw5nmbzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cancel-schedule-send-sharp" /></template>
<style>
.lkw5nmbzh {
  fill: currentColor;
