...
const content = `<path class="g3np_gbif"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-label-outline-rounded" /></template>
<style>
.g3np_gbif {
  fill: currentColor;
