...
const content = `<path class="w2om7onnx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-left-16-regular" /></template>
<style>
.w2om7onnx {
  fill: currentColor;
