...
const content = `<path class="rjelk46un"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-video-20-regular" /></template>
<style>
.rjelk46un {
  fill: currentColor;
