...
const content = `<path class="hqe_r-7ub"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:account-child-invert-outline-sharp" /></template>
<style>
.hqe_r-7ub {
  fill: currentColor;
