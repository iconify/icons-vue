...
const content = `<path class="gmpd0bccd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:youtube-activity-2-outline" /></template>
<style>
.gmpd0bccd {
  fill: currentColor;
