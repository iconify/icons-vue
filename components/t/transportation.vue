...
const content = `<path class="s0c2ih65u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:transportation" /></template>
<style>
.s0c2ih65u {
  fill: currentColor;
