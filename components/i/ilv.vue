...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGGyrIge7U)" class="iwqgy8fft"/><defs><linearGradient id="SVGGyrIge7U" x1="12" x2="12" y1="3" y2="21" gradientUnits="userSpaceOnUse"><stop class="pzgty9nbc"/><stop offset=".49" class="uwbv3v-lj"/><stop offset="1" class="r57tztb-g"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:ilv" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
