...
const content = `<path class="m90-4mbne"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:manga-up" /></template>
<style>
.m90-4mbne {
  fill: none;
  stroke: currentColor;
