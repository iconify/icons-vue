...
import '../../css/c/c-driyb_u.css';
import '../../css/z/zeouyj7bj.css';

const props = defineProps(["width","height"]);

const viewBox = {"width":48,"height":48};
const content = `<g class="hit3bi0-v"><rect transform="rotate(-46.025 4.929 13.224)" class="u9qu0gbuv"/><rect transform="rotate(-46.025 19.321 27.11)" class="ngc3b5b7m"/><rect transform="rotate(-46.025 6.443 18.855)" class="lhctqbctq"/><rect transform="rotate(-46.025 13.64 25.798)" class="ldorkabkt"/><rect transform="rotate(-46.025 7.265 25.205)" class="awx4k5b9w"/><path class="c-driyb_u"/><path class="zeouyj7bj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="icon-park-solid:honey-one" /></template>
