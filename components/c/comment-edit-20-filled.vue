...
const content = `<path class="zq8359xae"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-edit-20-filled" /></template>
<style>
.zq8359xae {
  fill: currentColor;
