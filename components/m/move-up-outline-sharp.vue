...
const content = `<path class="mz99b9bxz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:move-up-outline-sharp" /></template>
<style>
.mz99b9bxz {
  fill: currentColor;
