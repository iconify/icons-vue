...
const content = `<path class="qgjo5vb3i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:alert-badge-32-filled" /></template>
<style>
.qgjo5vb3i {
  fill: currentColor;
