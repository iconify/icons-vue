...
const content = `<path class="y3hfjsbje"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:split-horizontal-32-regular" /></template>
<style>
.y3hfjsbje {
  fill: currentColor;
