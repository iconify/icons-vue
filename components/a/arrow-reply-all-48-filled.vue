...
const content = `<path class="u7aqx3bzr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-reply-all-48-filled" /></template>
<style>
.u7aqx3bzr {
  fill: currentColor;
