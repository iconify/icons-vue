...
const content = `<g class="y9tr6bcfx"><path class="t7fe4wk7m"/><path class="ylb5c8b2i"/><path class="avvs4wbza"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:me" /></template>
<style>
.avvs4wbza {
  d: path("M27.803 21.196c.065-.497.376-.707.769-.783a1.78 1.78 0 0 0-1.89-1.043a1.737 1.737 0 0 0-.416 3.318c.717.303 1.574.127 2.064-.509c-.38-.189-.593-.483-.527-.984");
}
