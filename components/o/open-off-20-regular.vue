...
const content = `<path class="p74_vnbdy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:open-off-20-regular" /></template>
<style>
.p74_vnbdy {
  fill: currentColor;
