...
const content = `<path class="wd5f8tobv"/><path class="zqdb_2buv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:photo-affix" /></template>
<style>
.wd5f8tobv {
  fill: none;
  stroke: currentColor;
