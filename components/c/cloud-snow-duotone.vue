...
const content = `<g class="cuyn6tgcc"><path class="w82lklnus"/><path class="nbj347b_e"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:cloud-snow-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
