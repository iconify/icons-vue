...
const content = `<path class="ff7rw8ibo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sensors-outline-sharp" /></template>
<style>
.ff7rw8ibo {
  fill: currentColor;
