...
const content = `<path class="tgx-adccc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-arrow-right-24-regular" /></template>
<style>
.tgx-adccc {
  fill: currentColor;
