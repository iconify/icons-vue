...
const content = `<path class="cr8mn7b3o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tapas-sharp" /></template>
<style>
.cr8mn7b3o {
  fill: currentColor;
