...
const content = `<g class="ft5dv1b6b"><defs><mask id="SVGjrlukbOF"><path class="k5-vjlrin"/><g clip-rule="evenodd" class="kvn14gsjy"><path class="c440bubqs"/><path class="hgh871smh"/></g></mask></defs><circle mask="url(#SVGjrlukbOF)" class="bd9gczbnq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:earth-europe-circle-filled" /></template>
<style>
.bd9gczbnq {
  cx: 13px;
  cy: 13px;
