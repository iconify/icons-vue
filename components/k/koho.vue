...
const content = `<path class="i9clfwm2k"/><path class="znphbfb8e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:koho" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
