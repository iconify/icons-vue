...
const content = `<linearGradient id="ssvg-id-pound-symbola" gradientUnits="userSpaceOnUse" x1="64.005" y1="102.5" x2="64.005" y2="24.72" gradientTransform="matrix(1 0 0 -1 0 128)"><stop offset="0" class="vlzxxcccm"/><stop offset=".515" class="fboms9lpk"/></linearGradient><path fill="url(#ssvg-id-pound-symbola)" class="men5ystrv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:pound-symbol" /></template>
<style>
.fboms9lpk {
