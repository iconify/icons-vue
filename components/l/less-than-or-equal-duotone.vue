...
const content = `<g class="cuyn6tgcc"><path class="c7it4q6rl"/><path class="pwl96hbem"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:less-than-or-equal-duotone" /></template>
<style>
.c7it4q6rl {
