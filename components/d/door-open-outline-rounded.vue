...
const content = `<path class="hglh7xb3q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:door-open-outline-rounded" /></template>
<style>
.hglh7xb3q {
  fill: currentColor;
