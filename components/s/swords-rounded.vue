...
const content = `<path class="omlfo2e6w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:swords-rounded" /></template>
<style>
.omlfo2e6w {
  fill: currentColor;
