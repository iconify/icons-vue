...
const content = `<path class="m2yqa8bfn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fact-check" /></template>
<style>
.m2yqa8bfn {
  fill: currentColor;
