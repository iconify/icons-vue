...
const content = `<path class="mj4w53b0y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:thunderstorm-sharp" /></template>
<style>
.mj4w53b0y {
  fill: currentColor;
