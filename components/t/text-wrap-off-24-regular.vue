...
const content = `<path class="rledmob_z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-wrap-off-24-regular" /></template>
<style>
.rledmob_z {
  fill: currentColor;
