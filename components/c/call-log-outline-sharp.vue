...
const content = `<path class="iq0mhubof"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:call-log-outline-sharp" /></template>
<style>
.iq0mhubof {
  fill: currentColor;
