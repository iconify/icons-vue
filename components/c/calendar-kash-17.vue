...
const content = `<path class="b1w5vio6m"/><g class="to-5kdesz"><path class="wfpy3gbmy"/><path class="lw4f_pt4y"/><path class="is-ytvijl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-kash-17" /></template>
<style>
.b1w5vio6m {
  fill: none;
  stroke: currentColor;
  ...
  d: path("m16.663 27.465l2.799-1.54m0 0v11.2m5.338 0l6.02-11.2H23.4");
}
