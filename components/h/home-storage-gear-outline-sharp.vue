...
const content = `<path class="tfyae4aeo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:home-storage-gear-outline-sharp" /></template>
<style>
.tfyae4aeo {
  fill: currentColor;
