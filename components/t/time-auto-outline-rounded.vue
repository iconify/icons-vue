...
const content = `<path class="m8j96ub9r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:time-auto-outline-rounded" /></template>
<style>
.m8j96ub9r {
  fill: currentColor;
