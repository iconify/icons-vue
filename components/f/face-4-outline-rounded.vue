...
const content = `<path class="i04k-658b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-4-outline-rounded" /></template>
<style>
.i04k-658b {
  fill: currentColor;
