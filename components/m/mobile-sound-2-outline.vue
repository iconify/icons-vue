...
const content = `<path class="s20_a0osn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-sound-2-outline" /></template>
<style>
.s20_a0osn {
  fill: currentColor;
