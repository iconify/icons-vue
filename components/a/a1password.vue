...
const content = `<circle class="cpk0fnbgt"/><path class="jkcz-ye0o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:a1password" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
