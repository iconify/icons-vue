...
const content = `<path class="tx99u7e-r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:freecodecamp" /></template>
<style>
.tx99u7e-r {
  fill: none;
  stroke: currentColor;
