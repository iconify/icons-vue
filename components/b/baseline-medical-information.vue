...
const content = `<path class="mpgb1ltox"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-medical-information" /></template>
<style>
.mpgb1ltox {
  fill: currentColor;
