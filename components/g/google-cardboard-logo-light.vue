...
const content = `<path class="rt4fsyb4h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:google-cardboard-logo-light" /></template>
<style>
.rt4fsyb4h {
  fill: currentColor;
