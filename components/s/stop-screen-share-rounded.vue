...
const content = `<path class="s1xum9heq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stop-screen-share-rounded" /></template>
<style>
.s1xum9heq {
  fill: currentColor;
