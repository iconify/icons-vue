...
const content = `<path class="zhw2iobao"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:subtract-parentheses-24-regular" /></template>
<style>
.zhw2iobao {
  fill: currentColor;
