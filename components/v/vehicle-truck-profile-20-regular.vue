...
const content = `<path class="fad3cc74m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-truck-profile-20-regular" /></template>
<style>
.fad3cc74m {
  fill: currentColor;
