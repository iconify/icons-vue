...
const content = `<path class="ky7wu-t-o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-drizzle-24-regular" /></template>
<style>
.ky7wu-t-o {
  fill: currentColor;
