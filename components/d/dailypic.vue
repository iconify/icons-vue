...
const content = `<path class="ns9ribt9h"/><path class="p9kczcb_s"/><path class="mol4wcbcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dailypic" /></template>
<style>
.mol4wcbcs {
  fill: none;
  stroke: currentColor;
