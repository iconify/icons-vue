...
const content = `<path class="r1-fm5-xv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:satellite-alt-rounded" /></template>
<style>
.r1-fm5-xv {
  fill: currentColor;
