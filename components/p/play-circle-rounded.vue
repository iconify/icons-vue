...
const content = `<path class="up3n08b5c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:play-circle-rounded" /></template>
<style>
.up3n08b5c {
  fill: currentColor;
