...
const content = `<path class="vxsm2cllo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dual-screen-closed-alert-20-regular" /></template>
<style>
.vxsm2cllo {
  fill: currentColor;
