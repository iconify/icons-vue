...
const content = `<path class="ayu7_xblb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:desktop-portrait" /></template>
<style>
.ayu7_xblb {
  fill: currentColor;
