...
const content = `<path class="yoioit92e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:attach-email-rounded" /></template>
<style>
.yoioit92e {
  fill: currentColor;
