...
const content = `<path class="nuvq0xb3r"/><path class="cydxtriih"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fladder" /></template>
<style>
.cydxtriih {
  fill: none;
  stroke: currentColor;
