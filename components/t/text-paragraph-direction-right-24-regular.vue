...
const content = `<path class="jv-tk5bkl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-paragraph-direction-right-24-regular" /></template>
<style>
.jv-tk5bkl {
  fill: currentColor;
