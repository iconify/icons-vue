...
const content = `<path class="esuqixb-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drink-wine-16-filled" /></template>
<style>
.esuqixb-g {
  fill: currentColor;
