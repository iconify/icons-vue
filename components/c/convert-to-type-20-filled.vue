...
const content = `<path class="ghvl49t7y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:convert-to-type-20-filled" /></template>
<style>
.ghvl49t7y {
  fill: currentColor;
