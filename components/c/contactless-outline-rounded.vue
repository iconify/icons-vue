...
const content = `<path class="l57gcnk0w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:contactless-outline-rounded" /></template>
<style>
.l57gcnk0w {
  fill: currentColor;
