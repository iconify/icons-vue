...
const content = `<path class="uot7lyb4p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-circle-four-thin" /></template>
<style>
.uot7lyb4p {
  fill: currentColor;
