...
const content = `<path class="kqadmrb5r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:account-tree-rounded" /></template>
<style>
.kqadmrb5r {
  fill: currentColor;
