...
const content = `<path class="g8lofsbqh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:split-scene-right-outline-rounded" /></template>
<style>
.g8lofsbqh {
  fill: currentColor;
