...
const content = `<path class="kuiud9yde"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:note-alt-outline" /></template>
<style>
.kuiud9yde {
  fill: currentColor;
