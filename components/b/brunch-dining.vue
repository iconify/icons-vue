...
const content = `<path class="wsr12gblx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brunch-dining" /></template>
<style>
.wsr12gblx {
  fill: currentColor;
