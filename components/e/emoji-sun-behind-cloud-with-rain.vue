...
const content = `<path class="ae-14x9py"/><path class="g7ubnsyth"/><path class="ihl3u6awq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-sun-behind-cloud-with-rain" /></template>
<style>
.ae-14x9py {
  fill: none;
  stroke: currentColor;
...
.g7ubnsyth {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m13.968 21.535l-4.075 2.427l.948-4.536l-4.586-.661l3.432-3.113l-3.321-3.23l4.608-.5l-.793-4.566l4.022 2.307L16.247 5.5l1.897 4.23l4.098-2.164l-.947 4.536l4.586.66l-3.639 2.7");
}
...
.ihl3u6awq {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M22.168 15.15c.065 1.034-.023 1.708-.129 2.267m-8.626 3.876c1.013.527 1.955.53 2.91.633");
}
