...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="u6w4wsfvt"/><path clip-rule="evenodd" class="sbg2dw65g"/><path clip-rule="evenodd" class="o4lhydbby"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:arrow-up-left-circle-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
