...
const content = `<path class="ggz16hbcy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ecg" /></template>
<style>
.ggz16hbcy {
  fill: currentColor;
