...
const content = `<path class="twqun0r7u"/><g class="to-5kdesz"><path class="wfpy3gbmy"/><path class="lw4f_pt4y"/><path class="is-ytvijl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-kash-5" /></template>
<style>
.is-ytvijl {
...
.twqun0r7u {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M19.92 36.18c.772.648 1.522.945 3.397.945h.322a3.14 3.14 0 0 0 3.14-3.14h0a3.14 3.14 0 0 0-3.14-3.14h-3.72v-4.92h6.86");
}
