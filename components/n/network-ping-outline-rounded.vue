...
const content = `<path class="lue73kmis"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:network-ping-outline-rounded" /></template>
<style>
.lue73kmis {
  fill: currentColor;
