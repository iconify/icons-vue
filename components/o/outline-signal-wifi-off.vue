...
const content = `<path class="eb2pcoj4l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-signal-wifi-off" /></template>
<style>
.eb2pcoj4l {
  fill: currentColor;
