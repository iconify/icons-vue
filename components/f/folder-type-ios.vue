...
const content = `<path class="hjrc8tbqg"/><path class="o6jrqvopi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-ios" /></template>
<style>
.hjrc8tbqg {
