...
const content = `<path class="jqwaol9wf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:music-note-off-2-20-regular" /></template>
<style>
.jqwaol9wf {
  fill: currentColor;
