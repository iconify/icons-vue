...
const content = `<path class="r879ih7bd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-group-24-regular" /></template>
<style>
.r879ih7bd {
  fill: currentColor;
