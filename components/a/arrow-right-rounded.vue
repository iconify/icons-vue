...
const content = `<path class="k_-0srbwi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-right-rounded" /></template>
<style>
.k_-0srbwi {
  fill: currentColor;
