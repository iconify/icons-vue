...
const content = `<path class="s6ktj0b_i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:highlight-text-cursor-outline-rounded" /></template>
<style>
.s6ktj0b_i {
  fill: currentColor;
