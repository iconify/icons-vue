...
const content = `<path class="imn49ib2l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:door-back-outline-rounded" /></template>
<style>
.imn49ib2l {
  fill: currentColor;
