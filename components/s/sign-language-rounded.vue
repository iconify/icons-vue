...
const content = `<path class="yw7uo1bkx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sign-language-rounded" /></template>
<style>
.yw7uo1bkx {
  fill: currentColor;
