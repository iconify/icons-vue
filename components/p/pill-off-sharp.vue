...
const content = `<path class="wwi6oabsu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pill-off-sharp" /></template>
<style>
.wwi6oabsu {
  fill: currentColor;
