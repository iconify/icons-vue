...
const content = `<path class="h_7ja2bnt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:home-empty-28-regular" /></template>
<style>
.h_7ja2bnt {
  fill: currentColor;
