...
const content = `<path class="y4xm8nb5g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flex-wrap-outline" /></template>
<style>
.y4xm8nb5g {
  fill: currentColor;
