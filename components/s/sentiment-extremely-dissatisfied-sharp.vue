...
const content = `<path class="o9oz-bb3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sentiment-extremely-dissatisfied-sharp" /></template>
<style>
.o9oz-bb3l {
  fill: currentColor;
