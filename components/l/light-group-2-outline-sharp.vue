...
const content = `<path class="qmxfykbpa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:light-group-2-outline-sharp" /></template>
<style>
.qmxfykbpa {
  fill: currentColor;
