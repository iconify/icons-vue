...
const content = `<g class="nrj6p8qat"><path class="ibfob3b8f"/><path class="n1lcj6hsg"/><path class="q-qndji8q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:server-minus-two-tone" /></template>
<style>
.ibfob3b8f {
  fill: currentColor;
...
.n1lcj6hsg {
  d: path("M4 2L16 2C17.1046 2 18 2.8954 18 4L18 8C18 9.1046 17.1046 10 16 10L4 10C2.8954 10 2 9.1046 2 8L2 4C2 2.8954 2.8954 2 4 2ZM12 22L4 22C2.8954 22 2 21.1046 2 20L2 16C2 14.8954 2.8954 14 4 14L12 14M16 19H22");
}
