...
const content = `<path class="rlzgxh96d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:alternate-email-outline-sharp" /></template>
<style>
.rlzgxh96d {
  fill: currentColor;
