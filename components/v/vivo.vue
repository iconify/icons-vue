...
const content = `<path class="jdnrmmfnt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:vivo" /></template>
<style>
.jdnrmmfnt {
  fill: none;
  stroke: currentColor;
