...
const content = `<path class="trgpeebhe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:temple-buddhist-outline" /></template>
<style>
.trgpeebhe {
  fill: currentColor;
