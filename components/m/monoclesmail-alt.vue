...
const content = `<path class="capzedc6q"/><path class="d0dw3kb5h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:monoclesmail-alt" /></template>
<style>
.capzedc6q {
  fill: none;
  stroke: currentColor;
