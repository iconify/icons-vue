...
const content = `<path class="mdzd3wbei"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:emoji-language-outline-rounded" /></template>
<style>
.mdzd3wbei {
  fill: currentColor;
