...
const content = `<path class="ve0cveb9v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:blur-medium-outline" /></template>
<style>
.ve0cveb9v {
  fill: currentColor;
