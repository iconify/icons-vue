...
const content = `<path class="lsa-xmdeh"/><rect class="jc1oydeao"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:harbor-freight" /></template>
<style>
.jc1oydeao {
  width: 39px;
  height: 31px;
