...
const content = `<path class="y0jd8vbit"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-precision-manufacturing" /></template>
<style>
.y0jd8vbit {
  fill: currentColor;
