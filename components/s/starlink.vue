...
const content = `<path class="iy-muabhn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:starlink" /></template>
<style>
.iy-muabhn {
  fill: none;
  stroke: currentColor;
