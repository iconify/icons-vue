...
const content = `<path class="czvga6mpq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:layers-clear" /></template>
<style>
.czvga6mpq {
  fill: currentColor;
