...
const content = `<g class="hntgybcog"><path class="jw0risdcq"/><path class="j6xe62btt"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:chunk-overlap-outline-thin" /></template>
<style>
.hntgybcog {
  fill: none;
  stroke: currentColor;
