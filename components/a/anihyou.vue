...
const content = `<path class="vyx5nvbkk"/><path class="s8drx-5dy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:anihyou" /></template>
<style>
.s8drx-5dy {
  fill: none;
  stroke: currentColor;
