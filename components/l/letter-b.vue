...
const content = `<path class="x-kz1kb7j"/><path class="dgf107chp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:letter-b" /></template>
<style>
.dgf107chp {
