...
const content = `<path class="ksipapbdp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-arrow-up-right-outline" /></template>
<style>
.ksipapbdp {
  fill: currentColor;
