...
const content = `<path class="ewi1kmbct"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:page-footer-rounded" /></template>
<style>
.ewi1kmbct {
  fill: currentColor;
