...
const content = `<path class="wxo9nibrm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pallet-rounded" /></template>
<style>
.wxo9nibrm {
  fill: currentColor;
