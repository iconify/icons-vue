...
const content = `<path class="valuakbeh"/><linearGradient id="SVGmo0UWd9T" x1="64" x2="64" y1="35.759" y2="8" gradientTransform="matrix(1 0 0 -1 0 130)" gradientUnits="userSpaceOnUse"><stop offset="0" class="xb94qyb-t"/><stop offset=".705" class="ci_fo_bpd"/><stop offset="1" class="u3kz4vb7l"/></linearGradient><path fill="url(#SVGmo0UWd9T)" class="em9qpibty"/><path class="oi-ome0fo"/><path class="ug3ob9bph"/><path class="rrk2owbar"/><g class="qp89kubki"><ellipse class="n8fq1s3jv"/><ellipse class="gba0l8b6i"/></g><path class="l3a_k9t7f"/><path class="w68cgmyka"/><path class="d617jpnjw"/><radialGradient id="SVG2pC6isaZ" cx="63.798" cy="46.819" r="49.836" gradientTransform="rotate(-.109 64.883 50.393)" gradientUnits="userSpaceOnUse"><stop offset=".725" class="l1arbqe-k"/><stop offset="1" class="atqdr-9uk"/></radialGradient><path fill="url(#SVG2pC6isaZ)" class="e7gfutlzg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:woman-curly-haired-medium-light-skin-tone" /></template>
<style>
.atqdr-9uk {
