...
const content = `<circle class="j_-2hxbof"/><path class="tzn41abjv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-hot-tub" /></template>
<style>
.j_-2hxbof {
  cx: 7px;
  cy: 6px;
