...
const content = `<path class="zzyf9-41q"/><path class="y7vz5ac5z"/><path class="t_rlincix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-italy" /></template>
<style>
.t_rlincix {
