...
const content = `<path class="ghtkyibgz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:10k-outline-sharp" /></template>
<style>
.ghtkyibgz {
  fill: currentColor;
