...
const content = `<path class="xped370_e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-android-bolt-rounded" /></template>
<style>
.xped370_e {
  fill: currentColor;
