...
const content = `<path class="aignkvbij"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:volume-off-rounded" /></template>
<style>
.aignkvbij {
  fill: currentColor;
