...
const content = `<path class="rkoyl2b7g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:date-range-outline" /></template>
<style>
.rkoyl2b7g {
  fill: currentColor;
