...
const content = `<path class="pv9z4fxcq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-type-checkmark-20-filled" /></template>
<style>
.pv9z4fxcq {
  fill: currentColor;
