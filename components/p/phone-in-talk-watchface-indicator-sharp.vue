...
const content = `<path class="t7xh1-bjg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phone-in-talk-watchface-indicator-sharp" /></template>
<style>
.t7xh1-bjg {
  fill: currentColor;
