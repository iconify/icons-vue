...
const content = `<path class="uz5z2kbzw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:select-all-on-20-filled" /></template>
<style>
.uz5z2kbzw {
  fill: currentColor;
