...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:signal-duotone" /></template>
<style>
.dno4_nblm {
  fill: currentColor;
...
.j-byqmv3j {
  d: path("M7 20V16M12 20V12M17 20V8M22 20V4");
}
