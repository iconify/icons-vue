...
const content = `<path class="ur9yas9tw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:robinhood-food" /></template>
<style>
.ur9yas9tw {
  fill: none;
  stroke: currentColor;
