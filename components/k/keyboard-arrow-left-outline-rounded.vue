...
const content = `<path class="cfap-drsj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-arrow-left-outline-rounded" /></template>
<style>
.cfap-drsj {
  fill: currentColor;
