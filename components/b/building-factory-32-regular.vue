...
const content = `<path class="xy20w811u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-factory-32-regular" /></template>
<style>
.xy20w811u {
  fill: currentColor;
