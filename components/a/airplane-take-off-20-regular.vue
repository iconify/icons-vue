...
const content = `<path class="mm9k-6h3z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:airplane-take-off-20-regular" /></template>
<style>
.mm9k-6h3z {
  fill: currentColor;
