...
const content = `<path class="lu9lo-olz"/><path class="i26hz5b5d"/><path class="u01jo0bvo"/><path class="aflk2ou_p"/><path class="a0vbcybdh"/>`;
</script>
...
.lu9lo-olz {
  fill: var(--svg-color--7495b4, #7495b4);
