...
const content = `<path class="b8x0xkboa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-location-alt-outline-rounded" /></template>
<style>
.b8x0xkboa {
  fill: currentColor;
