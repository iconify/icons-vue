...
const content = `<path class="p1ucfkock"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stack-off-outline-rounded" /></template>
<style>
.p1ucfkock {
  fill: currentColor;
