...
const content = `<path class="t4lqbstxs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-slash-sharp-fill" /></template>
<style>
.t4lqbstxs {
  fill: currentColor;
