...
const content = `<path class="i9clfwm2k"/><path class="w8xv3j37m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mango" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
