...
const content = `<path class="no1zu3izr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:redbubble" /></template>
<style>
.no1zu3izr {
  fill: none;
  stroke: currentColor;
