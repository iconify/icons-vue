...
const content = `<path class="u976tfb-r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stethoscope-rounded" /></template>
<style>
.u976tfb-r {
  fill: currentColor;
