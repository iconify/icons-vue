...
const content = `<path class="wnzqicyhl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:media-output-off-outline-rounded" /></template>
<style>
.wnzqicyhl {
  fill: currentColor;
