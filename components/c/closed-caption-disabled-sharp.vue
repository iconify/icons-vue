...
const content = `<path class="bd0_y-b0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:closed-caption-disabled-sharp" /></template>
<style>
.bd0_y-b0q {
  fill: currentColor;
