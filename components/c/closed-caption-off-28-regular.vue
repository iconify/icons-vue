...
const content = `<path class="ak4wdbb7j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:closed-caption-off-28-regular" /></template>
<style>
.ak4wdbb7j {
  fill: currentColor;
