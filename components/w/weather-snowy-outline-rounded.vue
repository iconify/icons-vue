...
const content = `<path class="elczghndf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:weather-snowy-outline-rounded" /></template>
<style>
.elczghndf {
  fill: currentColor;
