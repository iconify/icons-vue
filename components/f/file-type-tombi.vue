...
const content = `<circle class="enaoo6bhy"/><path class="l3_liubdq"/><path class="girjdsb0u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-tombi" /></template>
<style>
.enaoo6bhy {
  cx: 16px;
  cy: 16px;
