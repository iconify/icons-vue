...
const content = `<path class="yh8kirb6r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:unpaved-road-outline-sharp" /></template>
<style>
.yh8kirb6r {
  fill: currentColor;
