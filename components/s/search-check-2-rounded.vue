...
const content = `<path class="v282_2bcw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:search-check-2-rounded" /></template>
<style>
.v282_2bcw {
  fill: currentColor;
