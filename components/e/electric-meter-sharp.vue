...
const content = `<path class="eeijco27w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:electric-meter-sharp" /></template>
<style>
.eeijco27w {
  fill: currentColor;
