...
const content = `<path class="ri455xr5d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-stylelint" /></template>
<style>
.ri455xr5d {
