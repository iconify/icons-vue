...
const content = `<path class="kghp-3gov"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-eraser-20-filled" /></template>
<style>
.kghp-3gov {
  fill: currentColor;
