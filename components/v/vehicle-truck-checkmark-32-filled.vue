...
const content = `<path class="nabikk88y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-truck-checkmark-32-filled" /></template>
<style>
.nabikk88y {
  fill: currentColor;
