...
const content = `<path class="s_d86xmiq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:my-workout-plan" /></template>
<style>
.s_d86xmiq {
  fill: none;
  stroke: currentColor;
