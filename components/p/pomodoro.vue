...
const content = `<path class="mm2yyybna"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pomodoro" /></template>
<style>
.mm2yyybna {
  fill: none;
  stroke: currentColor;
