...
const content = `<path class="iagqz2b0g"/><path class="pvklgzbgz"/><path class="cju6u_w8j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:sleeping-face" /></template>
<style>
.cju6u_w8j {
  fill: var(--svg-color--664e27, #664e27);
  d: path("M50 45.2c.8 1.2 1.1 3.6-.6 4.7c-1.4.9-3.7.7-5.4 1.8c-1.8 1.2-2.5 3.3-3.9 4.2c-1.9 1.2-3.7-.2-4.5-1.4c-1.4-2.2.7-6.1 4.7-8.6c3.9-2.6 8.3-2.9 9.7-.7M38.3 33.6c7.2 5.4 14.9 1.8 15.3-7.1c0-.5-.6-.4-1.4-.5c-2.4 4.8-8.7 7.4-13.5 6.3c-.3.7-.7 1.1-.4 1.3M15.9 44.1c7.2 5.4 14.9 1.8 15.3-7.1c0-.5-.6-.4-1.4-.5c-2.4 4.8-8.7 7.4-13.5 6.3c-.3.6-.8 1-.4 1.3");
}
