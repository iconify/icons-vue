...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:maps" /></template>
<style>
.qg4zl1bkk {
  fill: none;
  stroke: currentColor;
...
.yx0htwcyc {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M35.555 6.566H38.5c2.216 0 4 1.784 4 4v29c0 2.216-1.784 4-4 4h-29c-2.216 0-4-1.784-4-4v-29c0-2.216 1.784-4 4-4h14.02");
}
