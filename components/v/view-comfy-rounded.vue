...
const content = `<path class="w5ktgebbn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:view-comfy-rounded" /></template>
<style>
.w5ktgebbn {
  fill: currentColor;
