...
const content = `<path class="mxqhm49uh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-moon-off-48-filled" /></template>
<style>
.mxqhm49uh {
  fill: currentColor;
