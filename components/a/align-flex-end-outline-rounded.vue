...
const content = `<path class="ob5jijb4k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:align-flex-end-outline-rounded" /></template>
<style>
.ob5jijb4k {
  fill: currentColor;
