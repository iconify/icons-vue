...
const content = `<path class="lnhixbbzx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-sports-volleyball" /></template>
<style>
.lnhixbbzx {
  fill: currentColor;
