...
const content = `<path class="duamlqpkz"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mts-urent" /></template>
<style>
.duamlqpkz {
  fill: none;
  stroke: currentColor;
