...
const content = `<circle class="v1zu3mb9h"/><circle class="qz-j4nozx"/><path class="mq31jvb5o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:duet" /></template>
<style>
.mq31jvb5o {
  fill: none;
  stroke: currentColor;
