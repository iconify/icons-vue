...
const content = `<path class="lcixoo07x"/><path class="brmwvccen"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tmobile-internet" /></template>
<style>
.brmwvccen {
  fill: none;
  stroke: currentColor;
