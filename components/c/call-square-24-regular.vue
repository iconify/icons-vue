...
const content = `<path class="mgz4jnuvb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-square-24-regular" /></template>
<style>
.mgz4jnuvb {
  fill: currentColor;
