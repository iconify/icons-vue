...
const content = `<path class="ura5t52yj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:moped-outline-sharp" /></template>
<style>
.ura5t52yj {
  fill: currentColor;
