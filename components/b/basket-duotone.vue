...
const content = `<g class="cuyn6tgcc"><path class="pznacm4an"/><path class="libadjbvb"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:basket-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
