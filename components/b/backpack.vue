...
const content = `<path clip-rule="evenodd" class="sri2llbtz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:backpack" /></template>
<style>
.sri2llbtz {
  fill: var(--svg-color--e33e3f, #e33e3f);
  fill-rule: evenodd;
