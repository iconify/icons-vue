...
const content = `<path class="fhu9cjbwy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:signal" /></template>
<style>
.fhu9cjbwy {
  fill: none;
  stroke: currentColor;
