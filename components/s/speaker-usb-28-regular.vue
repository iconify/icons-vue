...
const content = `<path class="k-g04498r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-usb-28-regular" /></template>
<style>
.k-g04498r {
  fill: currentColor;
