...
const content = `<g class="nrj6p8qat"><path class="az74cdzje"/><path class="ip0kgzlxo"/><path class="unky6y77u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:app-window-2-duotone" /></template>
<style>
.az74cdzje {
  fill: currentColor;
