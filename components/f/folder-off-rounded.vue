...
const content = `<path class="bumf-ab0d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:folder-off-rounded" /></template>
<style>
.bumf-ab0d {
  fill: currentColor;
