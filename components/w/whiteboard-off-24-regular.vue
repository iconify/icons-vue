...
const content = `<path class="bivql0vcr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:whiteboard-off-24-regular" /></template>
<style>
.bivql0vcr {
  fill: currentColor;
