...
const content = `<path class="w9pebjb0b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:display-settings-rounded" /></template>
<style>
.w9pebjb0b {
  fill: currentColor;
