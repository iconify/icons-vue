...
const content = `<path class="skk_w8kas"/><path class="epqkxbccl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dailytube" /></template>
<style>
.epqkxbccl {
  fill: none;
  stroke: currentColor;
