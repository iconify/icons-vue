...
const content = `<path class="mrxkr_bha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:home-speaker-outline-rounded" /></template>
<style>
.mrxkr_bha {
  fill: currentColor;
