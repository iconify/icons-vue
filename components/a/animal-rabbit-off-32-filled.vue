...
const content = `<path class="i9ex6vtso"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:animal-rabbit-off-32-filled" /></template>
<style>
.i9ex6vtso {
  fill: currentColor;
