...
const content = `<g class="nrj6p8qat"><path class="lwaj0vjwi"/><path class="dd9b8t23u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-arrow-right-duotone" /></template>
<style>
.dd9b8t23u {
