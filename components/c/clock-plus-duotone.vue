...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:clock-plus-duotone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
...
.u_cx-ss4r {
  d: path("M12 6L12 12L17 12M19 16L19 22M16 19L22 19");
}
