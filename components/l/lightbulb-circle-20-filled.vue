...
const content = `<path class="hy4vtac6v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:lightbulb-circle-20-filled" /></template>
<style>
.hy4vtac6v {
  fill: currentColor;
