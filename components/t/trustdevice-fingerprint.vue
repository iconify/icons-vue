...
const content = `<path class="dpropkaby"/><path class="wzpwyizqb"/><path class="i8iee3bse"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:trustdevice-fingerprint" /></template>
<style>
.dpropkaby {
  fill: none;
  stroke: currentColor;
...
.i8iee3bse {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M27.416 7.906L24 11.323l-3.416-3.407L24 4.5z");
}
...
.wzpwyizqb {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M27.416 7.906L24 11.323l-3.416-3.407L24 4.5zM24 15.576l-2.593 2.593M24 20.761l1.593-1.593l1-.999");
}
