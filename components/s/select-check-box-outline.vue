...
const content = `<path class="yfcuodb2e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:select-check-box-outline" /></template>
<style>
.yfcuodb2e {
  fill: currentColor;
