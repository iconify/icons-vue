...
const content = `<path class="ug5ihmbun"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:oral-disease-outline-sharp" /></template>
<style>
.ug5ihmbun {
  fill: currentColor;
