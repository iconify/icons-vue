...
const content = `<path class="ajqaiobpu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-ripple-16-filled" /></template>
<style>
.ajqaiobpu {
  fill: currentColor;
