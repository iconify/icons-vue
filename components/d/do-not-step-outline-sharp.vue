...
const content = `<path class="j2uv1cbud"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:do-not-step-outline-sharp" /></template>
<style>
.j2uv1cbud {
  fill: currentColor;
