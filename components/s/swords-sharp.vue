...
const content = `<path class="uguw5yb_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:swords-sharp" /></template>
<style>
.uguw5yb_q {
  fill: currentColor;
