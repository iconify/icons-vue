...
const content = `<path class="yjqsv6b5q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hadaf" /></template>
<style>
.yjqsv6b5q {
  fill: none;
  stroke: currentColor;
