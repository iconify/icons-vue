...
const content = `<path class="x0f6kcnhx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-1-20-regular" /></template>
<style>
.x0f6kcnhx {
  fill: currentColor;
