...
const content = `<rect class="gkbzx0-9v"/><path class="adknrvb0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kde-connect" /></template>
<style>
.adknrvb0q {
  fill: none;
  stroke: currentColor;
