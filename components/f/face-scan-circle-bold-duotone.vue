...
import '../../css/h/hkcl8zbkk.css';
import '../../css/f/fd7bfhbpn.css';
...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="solar:face-scan-circle-bold-duotone" /></template>
