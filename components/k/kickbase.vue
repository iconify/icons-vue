...
const content = `<path class="hrn93mbcp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kickbase" /></template>
<style>
.hrn93mbcp {
  fill: none;
  stroke: currentColor;
