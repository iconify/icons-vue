...
const content = `<path class="x4ms2ofdi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:content-copy-outline" /></template>
<style>
.x4ms2ofdi {
  fill: currentColor;
