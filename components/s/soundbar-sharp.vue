...
const content = `<path class="bxa6qx02l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:soundbar-sharp" /></template>
<style>
.bxa6qx02l {
  fill: currentColor;
