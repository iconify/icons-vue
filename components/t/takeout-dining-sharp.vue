...
const content = `<path class="ixszwuyym"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:takeout-dining-sharp" /></template>
<style>
.ixszwuyym {
  fill: currentColor;
