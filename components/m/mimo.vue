...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGsP8gIWFZ)" class="w-72rnbjd"/><defs><linearGradient id="SVGsP8gIWFZ" x1="5.96" x2="12.318" y1="8.411" y2="19.016" gradientUnits="userSpaceOnUse"><stop class="a5_plybwd"/><stop offset="1" class="f231scehu"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:mimo" /></template>
<style>
.a5_plybwd {
