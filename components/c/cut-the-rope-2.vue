...
const content = `<path class="qk_l6_1ll"/><path class="akqw8lbej"/><path class="dfa4wobji"/><circle class="nd2jz9byc"/><path class="nj32fccgk"/><circle class="nb7r6x--w"/><path class="biup6s7bb"/><circle class="kl99ixafu"/><circle class="j0t9gzkrs"/><path class="fm01jb4np"/><path class="u82wlcc6b"/><circle class="s26jcik0z"/><path class="ypihxccmh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cut-the-rope-2" /></template>
<style>
.akqw8lbej {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M27.091 39.984s3.345-.938 1.01-2.088m-11.218-4.278s4.122 4.047 6.87 3.947a6.3 6.3 0 0 0 4.444-2.471a1.76 1.76 0 0 1-.097 2.802m-8.07-15.62s2.354-3.188-2.976-3.482s-6.607 4.687-6.192 5.873s2.353.935 2.353.935a2.84 2.84 0 0 0-.705 3.862c1.388 2.406 5.045 2.646 8.414-1.088s.32-6.441-.894-6.1m4.858 1.924c.391 1.064.654 2.17.782 3.297c-.09.753-2.961 1.263-2.961 1.263");
}
...
.biup6s7bb {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m12.158 11.033l8.382 2.271a3.76 3.76 0 0 1-3.712.458c-2.307-.81-2.857-1.379-2.944-2.227m21.769 1.348V5.235");
}
...
.nj32fccgk {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m12.49 12.67l6.831-5.362a3.76 3.76 0 0 0-3.596 1.028c-1.808 1.646-2.092 2.384-1.84 3.199");
}
...
.u82wlcc6b {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M28.1 37.896a3.36 3.36 0 0 1-2.189.741");
}
