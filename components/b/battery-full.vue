...
const content = `<path class="cjcox5b5w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:battery-full" /></template>
<style>
.cjcox5b5w {
  fill: none;
  stroke: currentColor;
