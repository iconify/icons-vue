...
const content = `<path class="yjsgx4b8e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:content-paste-outline-sharp" /></template>
<style>
.yjsgx4b8e {
  fill: currentColor;
