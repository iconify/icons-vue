...
const content = `<path class="it6mtef0j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:transports-publics-genevois-plus" /></template>
<style>
.it6mtef0j {
  fill: none;
  stroke: currentColor;
