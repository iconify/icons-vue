...
const content = `<path class="vy48s1b_x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:piano-off-outline-sharp" /></template>
<style>
.vy48s1b_x {
  fill: currentColor;
