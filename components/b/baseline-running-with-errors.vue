...
const content = `<path class="du0aa4bng"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-running-with-errors" /></template>
<style>
.du0aa4bng {
  fill: currentColor;
