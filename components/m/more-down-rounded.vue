...
const content = `<path class="qarpeykjt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:more-down-rounded" /></template>
<style>
.qarpeykjt {
  fill: currentColor;
