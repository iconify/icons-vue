...
const content = `<path class="kmieysb1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloud-alert-rounded" /></template>
<style>
.kmieysb1j {
  fill: currentColor;
