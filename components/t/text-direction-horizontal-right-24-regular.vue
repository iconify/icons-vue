...
const content = `<path class="ovpssnovv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-horizontal-right-24-regular" /></template>
<style>
.ovpssnovv {
  fill: currentColor;
