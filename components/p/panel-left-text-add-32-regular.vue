...
const content = `<path class="aate-ybxe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-text-add-32-regular" /></template>
<style>
.aate-ybxe {
  fill: currentColor;
