...
const content = `<path class="fjjcxqbzm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:waving-hand-outline-rounded" /></template>
<style>
.fjjcxqbzm {
  fill: currentColor;
