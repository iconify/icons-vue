...
const content = `<path class="kxd8ntb_g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cardio-load-outline-rounded" /></template>
<style>
.kxd8ntb_g {
  fill: currentColor;
