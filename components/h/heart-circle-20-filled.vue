...
const content = `<path class="lq08gebvl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:heart-circle-20-filled" /></template>
<style>
.lq08gebvl {
  fill: currentColor;
