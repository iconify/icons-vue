...
const content = `<path class="klnox_6lx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-fit-20-filled" /></template>
<style>
.klnox_6lx {
  fill: currentColor;
