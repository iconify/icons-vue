...
const content = `<path class="m8fa8qbdx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:focus-to-do" /></template>
<style>
.m8fa8qbdx {
  fill: none;
  stroke: currentColor;
