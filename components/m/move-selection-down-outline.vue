...
const content = `<path class="h2og0yb2m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:move-selection-down-outline" /></template>
<style>
.h2og0yb2m {
  fill: currentColor;
