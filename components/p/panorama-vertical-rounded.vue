...
const content = `<path class="vnh6s0kzp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:panorama-vertical-rounded" /></template>
<style>
.vnh6s0kzp {
  fill: currentColor;
