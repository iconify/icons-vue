...
const content = `<path class="qgp7tpblc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-desktop-search-24-filled" /></template>
<style>
.qgp7tpblc {
  fill: currentColor;
