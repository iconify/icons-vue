...
const content = `<path class="aqcbtwznk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:money-settings-24-filled" /></template>
<style>
.aqcbtwznk {
  fill: currentColor;
