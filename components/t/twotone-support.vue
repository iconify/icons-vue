...
const content = `<path class="h-r7ir4dr"/><path class="tk0q--ffh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-support" /></template>
<style>
.h-r7ir4dr {
  fill: currentColor;
  d: path("M10.3 7.32L9.13 4.54a7.98 7.98 0 0 0-4.59 4.59l2.78 1.15c.51-1.38 1.6-2.46 2.98-2.96m-2.98 6.4l-2.78 1.15c.81 2.1 2.48 3.78 4.59 4.59l1.17-2.78a4.98 4.98 0 0 1-2.98-2.96m9.35-3.45l2.78-1.15a8 8 0 0 0-4.58-4.58l-1.15 2.78c1.37.51 2.45 1.58 2.95 2.95m.01 3.44a5 5 0 0 1-2.95 2.97l1.15 2.78c2.1-.81 3.77-2.48 4.58-4.58z");
