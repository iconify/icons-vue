...
const content = `<g class="ft5dv1b6b"><path class="z2vl1acha"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-color-ga-24-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
