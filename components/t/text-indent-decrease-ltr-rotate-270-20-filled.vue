...
const content = `<path class="ejsik-bsz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-decrease-ltr-rotate-270-20-filled" /></template>
<style>
.ejsik-bsz {
  fill: currentColor;
