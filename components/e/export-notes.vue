...
const content = `<path class="mrbmnfbbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:export-notes" /></template>
<style>
.mrbmnfbbl {
  fill: currentColor;
