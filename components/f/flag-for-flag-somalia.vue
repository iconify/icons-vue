...
const content = `<path class="rqxk3kbwo"/><path class="qflhlkbem"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-somalia" /></template>
<style>
.qflhlkbem {
