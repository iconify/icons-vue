...
const content = `<path class="l1qh6cc3r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:file-download-off-outline-sharp" /></template>
<style>
.l1qh6cc3r {
  fill: currentColor;
