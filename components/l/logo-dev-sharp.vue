...
const content = `<path class="t6dm-pbkr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:logo-dev-sharp" /></template>
<style>
.t6dm-pbkr {
  fill: currentColor;
