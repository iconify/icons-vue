...
const content = `<path class="ikzk9aczq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:play-arrow-rounded" /></template>
<style>
.ikzk9aczq {
  fill: currentColor;
