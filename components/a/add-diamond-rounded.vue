...
const content = `<path class="rs97h6bal"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-diamond-rounded" /></template>
<style>
.rs97h6bal {
  fill: currentColor;
