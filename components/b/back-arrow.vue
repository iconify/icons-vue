...
const content = `<path class="qovi5mbkq"/><path class="taetzn2em"/><path class="g_2zs9bjv"/><path class="tigitcbjl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:back-arrow" /></template>
<style>
.g_2zs9bjv {
