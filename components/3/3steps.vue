...
const content = `<path class="yzymj9tkq"/><path class="i45j2ixcq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:3steps" /></template>
<style>
.i45j2ixcq {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M41.447 38.708c.02.852-.166 1.923 1.053 1.758");
}
