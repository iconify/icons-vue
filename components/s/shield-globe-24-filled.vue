...
const content = `<path class="eivxdevbr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-globe-24-filled" /></template>
<style>
.eivxdevbr {
  fill: currentColor;
