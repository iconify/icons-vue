...
const content = `<path class="jkoip_dtj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-queue-play-next" /></template>
<style>
.jkoip_dtj {
  fill: currentColor;
