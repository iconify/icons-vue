...
const content = `<path class="rtbhfkb-q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-attributes-rounded" /></template>
<style>
.rtbhfkb-q {
  fill: currentColor;
