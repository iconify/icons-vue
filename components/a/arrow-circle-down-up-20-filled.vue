...
const content = `<path class="lrhxrxcti"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-down-up-20-filled" /></template>
<style>
.lrhxrxcti {
  fill: currentColor;
