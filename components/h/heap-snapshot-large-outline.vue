...
const content = `<path class="x_nu3_kvm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:heap-snapshot-large-outline" /></template>
<style>
.x_nu3_kvm {
  fill: currentColor;
