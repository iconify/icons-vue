...
const content = `<path class="ckpnnk06c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:accessible-outline" /></template>
<style>
.ckpnnk06c {
  fill: currentColor;
