...
const content = `<path class="rnxideb_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bluetooth-connected-20-filled" /></template>
<style>
.rnxideb_q {
  fill: currentColor;
