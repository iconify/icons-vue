...
const content = `<path class="iai51hbex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sync-saved-locally-off-outline" /></template>
<style>
.iai51hbex {
  fill: currentColor;
