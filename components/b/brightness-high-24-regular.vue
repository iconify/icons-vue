...
const content = `<path class="lc-qdh5ln"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:brightness-high-24-regular" /></template>
<style>
.lc-qdh5ln {
  fill: currentColor;
