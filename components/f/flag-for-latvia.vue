...
const content = `<path class="t2wnffbqk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-latvia" /></template>
<style>
.t2wnffbqk {
  fill: currentColor;
