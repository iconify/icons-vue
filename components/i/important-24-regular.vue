...
const content = `<path class="f-cpghb3n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:important-24-regular" /></template>
<style>
.f-cpghb3n {
  fill: currentColor;
