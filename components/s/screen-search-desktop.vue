...
const content = `<path class="t-vpxdb2l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screen-search-desktop" /></template>
<style>
.t-vpxdb2l {
  fill: currentColor;
