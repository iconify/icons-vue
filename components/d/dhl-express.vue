...
const content = `<path class="oru0_qn9b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dhl-express" /></template>
<style>
.oru0_qn9b {
  fill: none;
  stroke: currentColor;
