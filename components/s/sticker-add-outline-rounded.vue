...
const content = `<path class="jqjizi5ta"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sticker-add-outline-rounded" /></template>
<style>
.jqjizi5ta {
  fill: currentColor;
