...
const content = `<path class="tjqtmfbup"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:production-20-regular" /></template>
<style>
.tjqtmfbup {
  fill: currentColor;
