...
const content = `<path class="g69bfr--o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-arrow-right-48-regular" /></template>
<style>
.g69bfr--o {
  fill: currentColor;
