...
const content = `<path class="p0g1xebkp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:database-upload-rounded" /></template>
<style>
.p0g1xebkp {
  fill: currentColor;
