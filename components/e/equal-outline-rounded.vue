...
const content = `<path class="f9aiwsnho"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:equal-outline-rounded" /></template>
<style>
.f9aiwsnho {
  fill: currentColor;
