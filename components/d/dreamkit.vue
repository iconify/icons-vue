...
const content = `<path class="wr8c-fbyx"/><path class="afgpi_z-r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dreamkit" /></template>
<style>
.afgpi_z-r {
  fill: none;
  stroke: currentColor;
