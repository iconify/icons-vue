...
const content = `<path class="a3q0aqb2f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:go-to-line-outline-rounded" /></template>
<style>
.a3q0aqb2f {
  fill: currentColor;
