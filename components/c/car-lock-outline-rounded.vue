...
const content = `<path class="cvlx0exyl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-lock-outline-rounded" /></template>
<style>
.cvlx0exyl {
  fill: currentColor;
