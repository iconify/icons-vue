...
const content = `<path class="j2lx6nkcc"/><path class="i_f7y4bzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hsl" /></template>
<style>
.i_f7y4bzh {
  fill: none;
  stroke: currentColor;
...
.j2lx6nkcc {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m23.773 9.689l10.186 4.031l4.352 10.053l-4.031 10.186l-10.053 4.352l-10.186-4.031l-4.352-10.053l4.031-10.186z");
}
