...
const content = `<path class="lumqlibgz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-camera-16-regular" /></template>
<style>
.lumqlibgz {
  fill: currentColor;
