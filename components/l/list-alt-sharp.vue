...
const content = `<path class="amie15blm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:list-alt-sharp" /></template>
<style>
.amie15blm {
  fill: currentColor;
