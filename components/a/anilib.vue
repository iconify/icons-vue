...
const content = `<path class="qmd2tflde"/><path class="cc9w8tbic"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:anilib" /></template>
<style>
.cc9w8tbic {
  fill: none;
  stroke: currentColor;
