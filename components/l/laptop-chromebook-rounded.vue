...
const content = `<path class="b4q_di8at"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:laptop-chromebook-rounded" /></template>
<style>
.b4q_di8at {
  fill: currentColor;
