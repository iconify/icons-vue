...
const content = `<path class="oy-7-9bck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fiber-pin-sharp" /></template>
<style>
.oy-7-9bck {
  fill: currentColor;
