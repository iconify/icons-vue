...
const content = `<path class="vcl8n6e1y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:edit-square-rounded" /></template>
<style>
.vcl8n6e1y {
  fill: currentColor;
