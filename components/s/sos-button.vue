...
const content = `<path class="lgubo_ohw"/><path class="kr9s7cciw"/><path class="sf1k_j7ie"/><path class="ofkptzx_t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:sos-button" /></template>
<style>
.kr9s7cciw {
