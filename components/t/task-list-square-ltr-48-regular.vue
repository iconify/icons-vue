...
const content = `<path class="w6lig8ecm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:task-list-square-ltr-48-regular" /></template>
<style>
.w6lig8ecm {
  fill: currentColor;
