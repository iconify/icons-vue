...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGxQNaFcGk)" class="kyqvc4k6q"/><defs><linearGradient id="SVGxQNaFcGk" x1="19.332" x2="5.304" y1="5.725" y2="20.557" gradientUnits="userSpaceOnUse"><stop class="el3_t9bjj"/><stop offset=".51" class="evxm7tb6m"/><stop offset=".73" class="w8-jmm_og"/><stop offset=".84" class="ibb9aqboa"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:oce" /></template>
<style>
.el3_t9bjj {
