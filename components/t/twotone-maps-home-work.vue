...
const content = `<path class="ms873rdco"/><path class="l10j5zb2d"/><path class="gd9flbcds"/><path class="s0a2z0fjn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-maps-home-work" /></template>
<style>
.gd9flbcds {
  fill: currentColor;
