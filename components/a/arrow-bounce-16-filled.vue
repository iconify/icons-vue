...
const content = `<path class="d4ervtbmz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-bounce-16-filled" /></template>
<style>
.d4ervtbmz {
  fill: currentColor;
