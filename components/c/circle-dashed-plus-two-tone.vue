...
const content = `<g class="nrj6p8qat"><path class="esurwb5xo"/><path class="zasenvc8n"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-plus-two-tone" /></template>
<style>
.esurwb5xo {
  stroke-opacity: 0.4;
