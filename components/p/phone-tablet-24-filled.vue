...
const content = `<path class="s50fxxbdn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-tablet-24-filled" /></template>
<style>
.s50fxxbdn {
  fill: currentColor;
