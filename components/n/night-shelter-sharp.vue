...
const content = `<path class="fibpxnblu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:night-shelter-sharp" /></template>
<style>
.fibpxnblu {
  fill: currentColor;
