...
const content = `<path class="kvxhenf-v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tooltip-quote-16-regular" /></template>
<style>
.kvxhenf-v {
  fill: currentColor;
