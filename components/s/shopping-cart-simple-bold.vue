...
const content = `<path class="vczzzuzmi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:shopping-cart-simple-bold" /></template>
<style>
.vczzzuzmi {
  fill: currentColor;
