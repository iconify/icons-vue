...
const content = `<path class="gr3gjubpa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:transition-push-outline" /></template>
<style>
.gr3gjubpa {
  fill: currentColor;
