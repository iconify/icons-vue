...
const content = `<path class="l3tv_hzhy"/><path class="hxtd0ebdh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-view-quilt" /></template>
<style>
.hxtd0ebdh {
  fill: currentColor;
