...
const content = `<path class="aq77uphvi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:color-fill-28-regular" /></template>
<style>
.aq77uphvi {
  fill: currentColor;
