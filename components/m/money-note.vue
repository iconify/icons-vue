...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="kyi8wsb7v"/><path class="ubojcnb9a"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:money-note" /></template>
<style>
.kyi8wsb7v {
