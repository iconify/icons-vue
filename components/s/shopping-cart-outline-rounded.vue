...
const content = `<path class="gygv6rb6g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shopping-cart-outline-rounded" /></template>
<style>
.gygv6rb6g {
  fill: currentColor;
