...
const content = `<path class="azrda5boj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-4-24-regular" /></template>
<style>
.azrda5boj {
  fill: currentColor;
