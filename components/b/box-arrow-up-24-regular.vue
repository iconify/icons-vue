...
const content = `<path class="ei-4eoaop"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:box-arrow-up-24-regular" /></template>
<style>
.ei-4eoaop {
  fill: currentColor;
