...
const content = `<path class="jow5-ybmn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-add-28-filled" /></template>
<style>
.jow5-ybmn {
  fill: currentColor;
