...
const content = `<path class="xrvof0cjc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:voice-selection-outline-sharp" /></template>
<style>
.xrvof0cjc {
  fill: currentColor;
