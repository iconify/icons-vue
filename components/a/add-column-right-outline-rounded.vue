...
const content = `<path class="auatmbp9p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:add-column-right-outline-rounded" /></template>
<style>
.auatmbp9p {
  fill: currentColor;
