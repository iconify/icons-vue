...
const content = `<path class="kbyq90x9q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-fat-lines-right-fill" /></template>
<style>
.kbyq90x9q {
  fill: currentColor;
