...
const content = `<path class="mwvs6xb9y"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:4g" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
