...
const content = `<path class="cjef76ufx"/><defs><path id="SVGhXH6EesY" class="b8itz1bxa"/></defs><clipPath id="SVGNC2did2B"><use href="#SVGhXH6EesY"/></clipPath><g clip-path="url(#SVGNC2did2B)" class="t_nvrsbrc"><path class="dryc8nbzt"/><path class="dqpc94bbd"/></g><defs><use href="#SVGhXH6EesY" id="SVGx6KkAdNV"/></defs><clipPath id="SVGpnbIjeoe"><use href="#SVGx6KkAdNV"/></clipPath><g clip-path="url(#SVGpnbIjeoe)"><path class="pn9kme0cn"/></g><defs><path id="SVGejNokcQk" class="na867tb8t"/></defs><clipPath id="SVGkH3Rwbrc"><use href="#SVGejNokcQk"/></clipPath><g clip-path="url(#SVGkH3Rwbrc)"><path class="idlswqb5p"/><path class="d9p3yqbdz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:writing-hand-dark-skin-tone" /></template>
<style>
.b8itz1bxa {
