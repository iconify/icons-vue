...
const content = `<path class="uopn6gofb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:call-missed-outline-rounded" /></template>
<style>
.uopn6gofb {
  fill: currentColor;
