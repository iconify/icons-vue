...
const content = `<path class="upy-qlbwb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-airline-seat-legroom-extra" /></template>
<style>
.upy-qlbwb {
  fill: currentColor;
