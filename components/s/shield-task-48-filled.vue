...
const content = `<path class="gxjrvgxgf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-task-48-filled" /></template>
<style>
.gxjrvgxgf {
  fill: currentColor;
