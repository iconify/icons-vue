...
const content = `<path class="swfcx94lv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:thumbs-up-down-outline" /></template>
<style>
.swfcx94lv {
  fill: currentColor;
