...
const content = `<path class="oiya-hmef"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:target-arrow-16-filled" /></template>
<style>
.oiya-hmef {
  fill: currentColor;
