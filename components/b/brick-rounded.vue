...
const content = `<path class="ry-675smd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brick-rounded" /></template>
<style>
.ry-675smd {
  fill: currentColor;
