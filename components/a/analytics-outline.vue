...
const content = `<path class="a09nxjktp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:analytics-outline" /></template>
<style>
.a09nxjktp {
  fill: currentColor;
