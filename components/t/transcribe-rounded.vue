...
const content = `<path class="gc2a0wk3v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:transcribe-rounded" /></template>
<style>
.gc2a0wk3v {
  fill: currentColor;
