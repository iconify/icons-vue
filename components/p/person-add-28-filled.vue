...
const content = `<path class="bz_1mubnu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-add-28-filled" /></template>
<style>
.bz_1mubnu {
  fill: currentColor;
