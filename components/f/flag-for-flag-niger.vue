...
const content = `<path class="ar8wnr8gh"/><path class="tl3tdac8p"/><path class="mh79h9x1l"/><circle class="nyuss02qz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-niger" /></template>
<style>
.ar8wnr8gh {
