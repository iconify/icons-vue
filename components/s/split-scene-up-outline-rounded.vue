...
const content = `<path class="r98meac2v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:split-scene-up-outline-rounded" /></template>
<style>
.r98meac2v {
  fill: currentColor;
