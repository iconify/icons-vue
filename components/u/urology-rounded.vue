...
const content = `<path class="whnr86qha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:urology-rounded" /></template>
<style>
.whnr86qha {
  fill: currentColor;
