...
const content = `<path class="fgjnd6b2x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:enable-outline-sharp" /></template>
<style>
.fgjnd6b2x {
  fill: currentColor;
