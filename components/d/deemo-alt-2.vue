...
const content = `<path class="m4dgffbsr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:deemo-alt-2" /></template>
<style>
.m4dgffbsr {
  fill: none;
  stroke: currentColor;
