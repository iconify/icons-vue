...
const content = `<path class="d_f_bybnw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:design-services-outline" /></template>
<style>
.d_f_bybnw {
  fill: currentColor;
