...
const content = `<path class="apzjmbb9m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-top-bottom-20-regular" /></template>
<style>
.apzjmbb9m {
  fill: currentColor;
