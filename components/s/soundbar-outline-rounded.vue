...
const content = `<path class="dl2py4bxe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:soundbar-outline-rounded" /></template>
<style>
.dl2py4bxe {
  fill: currentColor;
