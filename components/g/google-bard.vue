...
const content = `<path class="hu4qttb-w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:google-bard" /></template>
<style>
.hu4qttb-w {
  fill: none;
  stroke: currentColor;
