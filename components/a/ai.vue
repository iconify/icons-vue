...
const content = `<g class="ft5dv1b6b"><path class="ha-5arbqc"/><path class="jihcs4bno"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:ai" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
