...
const content = `<path class="l2r32dbtj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-2-24-filled" /></template>
<style>
.l2r32dbtj {
  fill: currentColor;
