...
const content = `<path class="as71rpkwj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wifi-calling-outline-sharp" /></template>
<style>
.as71rpkwj {
  fill: currentColor;
