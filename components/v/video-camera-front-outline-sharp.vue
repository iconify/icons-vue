...
const content = `<path class="wibn8nfhz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:video-camera-front-outline-sharp" /></template>
<style>
.wibn8nfhz {
  fill: currentColor;
