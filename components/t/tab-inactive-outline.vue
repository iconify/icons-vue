...
const content = `<path class="kra8yvb1f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tab-inactive-outline" /></template>
<style>
.kra8yvb1f {
  fill: currentColor;
