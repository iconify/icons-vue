...
const content = `<path class="mnqzzy6hf"/><path class="smpr3xq-h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:promocatalogues" /></template>
<style>
.mnqzzy6hf {
  fill: none;
  stroke: currentColor;
