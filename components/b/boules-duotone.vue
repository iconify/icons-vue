...
const content = `<g class="cuyn6tgcc"><path class="aenu8bcxg"/><path class="wqtakib_q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:boules-duotone" /></template>
<style>
.aenu8bcxg {
