...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:graduation-cap-duotone" /></template>
<style>
.giq90bbgn {
  fill: currentColor;
  fill-rule: evenodd;
...
.s4bfw0bgo {
  stroke-opacity: 0.4;
  d: path("M6 11.0748L6 15.7967C6 16.4679 6.3367 17.0944 6.8966 17.4647C8.4102 18.4661 10.1851 19 12 19C13.8149 19 15.5898 18.4661 17.1034 17.4647C17.6633 17.0944 18 16.4679 18 15.7967L18 11.0748M2 9L2 15");
}
