...
const content = `<path class="r9-_fcb9i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:event-busy-rounded" /></template>
<style>
.r9-_fcb9i {
  fill: currentColor;
