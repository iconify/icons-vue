...
const content = `<path class="g_bmejbho"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-beaker-16-regular" /></template>
<style>
.g_bmejbho {
  fill: currentColor;
