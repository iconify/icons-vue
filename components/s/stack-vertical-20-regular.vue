...
const content = `<path class="otd-qwbun"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:stack-vertical-20-regular" /></template>
<style>
.otd-qwbun {
  fill: currentColor;
