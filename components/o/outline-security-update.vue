...
const content = `<path class="qe30z3rue"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-security-update" /></template>
<style>
.qe30z3rue {
  fill: currentColor;
