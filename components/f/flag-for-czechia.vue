...
const content = `<path class="ud0oi9t_w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-czechia" /></template>
<style>
.ud0oi9t_w {
  fill: currentColor;
