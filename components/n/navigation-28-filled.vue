...
const content = `<path class="f1i96f3ay"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:navigation-28-filled" /></template>
<style>
.f1i96f3ay {
  fill: currentColor;
