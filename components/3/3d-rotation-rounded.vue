...
const content = `<path class="q467hxblp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:3d-rotation-rounded" /></template>
<style>
.q467hxblp {
  fill: currentColor;
