...
const content = `<path class="c6308zb-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-airline-seat-flat" /></template>
<style>
.c6308zb-y {
  fill: currentColor;
