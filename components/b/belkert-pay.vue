...
const content = `<path class="uwpefacol"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:belkert-pay" /></template>
<style>
.uwpefacol {
  fill: none;
  stroke: currentColor;
