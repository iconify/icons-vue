...
const content = `<path class="uylpcjxsv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:adf-scanner-outline-rounded" /></template>
<style>
.uylpcjxsv {
  fill: currentColor;
