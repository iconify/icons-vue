...
const content = `<path class="jsf4umbqo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-remote" /></template>
<style>
.jsf4umbqo {
  fill: currentColor;
