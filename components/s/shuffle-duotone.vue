...
const content = `<g class="cuyn6tgcc"><path class="lpiduybly"/><path class="lo9gs3__w"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:shuffle-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.lpiduybly {
  d: path("M107.14 98.8L128 128l-20.86 29.2A64 64 0 0 1 55.06 184H32V72h23.06a64 64 0 0 1 52.08 26.8m93.8-26.8a64 64 0 0 0-52.08 26.8L128 128l20.86 29.2a64 64 0 0 0 52.08 26.8H232V72Z");
