...
const content = `<path class="vra1hqb_z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-48-regular" /></template>
<style>
.vra1hqb_z {
  fill: currentColor;
