...
const content = `<path class="f46_hac-s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-outline" /></template>
<style>
.f46_hac-s {
  fill: currentColor;
