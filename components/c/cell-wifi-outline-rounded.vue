...
const content = `<path class="vzts1bcgz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cell-wifi-outline-rounded" /></template>
<style>
.vzts1bcgz {
  fill: currentColor;
