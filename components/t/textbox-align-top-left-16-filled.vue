...
const content = `<path class="c7v8zuz0g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-top-left-16-filled" /></template>
<style>
.c7v8zuz0g {
  fill: currentColor;
