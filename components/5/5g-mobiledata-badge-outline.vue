...
const content = `<path class="lqzhtxbim"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:5g-mobiledata-badge-outline" /></template>
<style>
.lqzhtxbim {
  fill: currentColor;
