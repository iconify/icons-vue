...
const content = `<path class="jokiuu_vc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-repeat-1-24-filled" /></template>
<style>
.jokiuu_vc {
  fill: currentColor;
