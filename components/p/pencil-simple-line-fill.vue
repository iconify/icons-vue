...
const content = `<path class="fg3-6ib7w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:pencil-simple-line-fill" /></template>
<style>
.fg3-6ib7w {
  fill: currentColor;
