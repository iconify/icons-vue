...
const content = `<path class="bjz5kgb1x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:leaf-one-20-regular" /></template>
<style>
.bjz5kgb1x {
  fill: currentColor;
