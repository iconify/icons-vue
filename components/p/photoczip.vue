...
const content = `<path class="ydqthzbbt"/><path class="f05gbwoen"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:photoczip" /></template>
<style>
.f05gbwoen {
  fill: none;
  stroke: currentColor;
