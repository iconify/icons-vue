...
const content = `<path class="r0fddmb_l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-one-page-multiple-sparkle-16-regular" /></template>
<style>
.r0fddmb_l {
  fill: currentColor;
