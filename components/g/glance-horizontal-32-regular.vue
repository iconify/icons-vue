...
const content = `<path class="kjbnaeb_d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:glance-horizontal-32-regular" /></template>
<style>
.kjbnaeb_d {
  fill: currentColor;
