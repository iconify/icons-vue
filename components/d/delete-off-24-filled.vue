...
const content = `<path class="asznrysyf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:delete-off-24-filled" /></template>
<style>
.asznrysyf {
  fill: currentColor;
