...
const content = `<path class="rvd0v_aka"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tasks-app-20-filled" /></template>
<style>
.rvd0v_aka {
  fill: currentColor;
