...
const content = `<path class="i2cqarb5h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-8-28-filled" /></template>
<style>
.i2cqarb5h {
  fill: currentColor;
