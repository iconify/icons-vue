...
const content = `<path class="mm8pbwr1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tasks-app-24-filled" /></template>
<style>
.mm8pbwr1j {
  fill: currentColor;
