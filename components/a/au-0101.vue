...
const content = `<circle class="cpk0fnbgt"/><path class="oflw9tu2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:au-0101" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
