...
const content = `<g class="nrj6p8qat"><path class="t8drw368i"/><path class="afjmqabbu"/><path class="cvru1isjg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-pause-two-tone" /></template>
<style>
.afjmqabbu {
