...
const content = `<path class="n9k3zbcxs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-repeat-1-24-regular" /></template>
<style>
.n9k3zbcxs {
  fill: currentColor;
