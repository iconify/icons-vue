...
const content = `<path class="bf9kxnbyn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fertile-sharp" /></template>
<style>
.bf9kxnbyn {
  fill: currentColor;
