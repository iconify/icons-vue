...
const content = `<path class="mefv-db9h"/><path class="b-pg3cvoe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-developer-board" /></template>
<style>
.b-pg3cvoe {
  fill: currentColor;
