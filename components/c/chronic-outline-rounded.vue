...
const content = `<path class="y666oflby"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chronic-outline-rounded" /></template>
<style>
.y666oflby {
  fill: currentColor;
