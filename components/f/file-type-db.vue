...
const content = `<path class="crvfyhbit"/><ellipse class="p-g1gdc2t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-db" /></template>
<style>
.crvfyhbit {
  fill: var(--svg-color--c4c7ce, #c4c7ce);
