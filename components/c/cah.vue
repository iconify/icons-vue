...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVG6CMxHd5F)" class="vb7n012lj"/><path fill="url(#SVGhmhBgeBv)" class="uxbo0dbgj"/><path class="sirv48qhj"/><defs><linearGradient id="SVG6CMxHd5F" x1="12" x2="12" y1="3" y2="21" gradientUnits="userSpaceOnUse"><stop class="lad4vpbsw"/><stop offset="1" class="n8dwi6byo"/></linearGradient><linearGradient id="SVGhmhBgeBv" x1="12" x2="12" y1="5.648" y2="18.354" gradientUnits="userSpaceOnUse"><stop class="sjz_xx-wy"/><stop offset="1" class="segrwxb8i"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:cah" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
