...
const content = `<path class="pftficbku"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:microbiology-outline-sharp" /></template>
<style>
.pftficbku {
  fill: currentColor;
