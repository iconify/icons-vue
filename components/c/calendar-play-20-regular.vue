...
const content = `<path class="di8liti3m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-play-20-regular" /></template>
<style>
.di8liti3m {
  fill: currentColor;
