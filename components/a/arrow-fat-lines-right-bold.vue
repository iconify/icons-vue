...
const content = `<path class="rzclk60yx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-fat-lines-right-bold" /></template>
<style>
.rzclk60yx {
  fill: currentColor;
