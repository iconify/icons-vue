...
const content = `<path class="xm3ww1b4y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cdek" /></template>
<style>
.xm3ww1b4y {
  fill: none;
  stroke: currentColor;
