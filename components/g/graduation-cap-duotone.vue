...
const content = `<g class="cuyn6tgcc"><path class="e2aowp-3k"/><path class="ua-3edc5v"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:graduation-cap-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
