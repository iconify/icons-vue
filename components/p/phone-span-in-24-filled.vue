...
const content = `<path class="x9uub9y9k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-span-in-24-filled" /></template>
<style>
.x9uub9y9k {
  fill: currentColor;
