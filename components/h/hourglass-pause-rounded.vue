...
const content = `<path class="sjq85r68c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:hourglass-pause-rounded" /></template>
<style>
.sjq85r68c {
  fill: currentColor;
