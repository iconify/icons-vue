...
const content = `<path class="kkz3_0bvx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-column-one-fourth-left-focus-left-20-filled" /></template>
<style>
.kkz3_0bvx {
  fill: currentColor;
