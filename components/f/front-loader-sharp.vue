...
const content = `<path class="pctjilzgi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:front-loader-sharp" /></template>
<style>
.pctjilzgi {
  fill: currentColor;
