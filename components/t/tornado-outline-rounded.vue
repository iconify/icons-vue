...
const content = `<path class="evs8fk9ea"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tornado-outline-rounded" /></template>
<style>
.evs8fk9ea {
  fill: currentColor;
