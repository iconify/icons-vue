...
const content = `<path class="ndb2sqbhn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:unpaved-road-sharp" /></template>
<style>
.ndb2sqbhn {
  fill: currentColor;
