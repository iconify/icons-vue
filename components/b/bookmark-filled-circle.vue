...
const content = `<g class="cuyn6tgcc"><path class="tj56vebrw"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:bookmark-filled-circle" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
