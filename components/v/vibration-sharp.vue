...
const content = `<path class="vk8yl3y0j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:vibration-sharp" /></template>
<style>
.vk8yl3y0j {
  fill: currentColor;
