...
const content = `<path class="h_l6mqbeh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gallery-thumbnail-outline" /></template>
<style>
.h_l6mqbeh {
  fill: currentColor;
