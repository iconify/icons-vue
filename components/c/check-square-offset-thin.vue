...
const content = `<path class="cowe5xbvp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:check-square-offset-thin" /></template>
<style>
.cowe5xbvp {
  fill: currentColor;
