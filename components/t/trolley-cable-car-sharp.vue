...
const content = `<path class="hct2ytnjp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:trolley-cable-car-sharp" /></template>
<style>
.hct2ytnjp {
  fill: currentColor;
