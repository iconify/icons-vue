...
const content = `<path class="y5lwbcc8e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wb-iridescent-outline-sharp" /></template>
<style>
.y5lwbcc8e {
  fill: currentColor;
