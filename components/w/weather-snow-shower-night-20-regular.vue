...
const content = `<path class="ic2-45bbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-snow-shower-night-20-regular" /></template>
<style>
.ic2-45bbq {
  fill: currentColor;
