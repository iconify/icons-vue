...
const content = `<path class="pt2fwlb8s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:camera-dome-20-regular" /></template>
<style>
.pt2fwlb8s {
  fill: currentColor;
