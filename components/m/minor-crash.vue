...
const content = `<path class="d-zp9ac3k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:minor-crash" /></template>
<style>
.d-zp9ac3k {
  fill: currentColor;
