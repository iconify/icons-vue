...
const content = `<path class="z9jxt_bwq"/><path class="iz4b3nb1m"/><path class="le4-slhqn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-mdx-components" /></template>
<style>
.iz4b3nb1m {
