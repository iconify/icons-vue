...
const content = `<path class="ws6z-1b-c"/><circle class="cpk0fnbgt"/><path class="ft87-pwby"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nova-video-player" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
...
.ft87-pwby {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m18.046 27.623l4.532-6.063l1.67 6.77l3.273-6.66");
}
