...
const content = `<path class="aazfgab0d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:connect-without-contact-outline-rounded" /></template>
<style>
.aazfgab0d {
  fill: currentColor;
