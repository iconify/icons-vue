...
const content = `<path class="h4zf6dbrg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:rear-camera-outline" /></template>
<style>
.h4zf6dbrg {
  fill: currentColor;
