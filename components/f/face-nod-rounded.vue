...
const content = `<path class="bvp9vfb3m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-nod-rounded" /></template>
<style>
.bvp9vfb3m {
  fill: currentColor;
