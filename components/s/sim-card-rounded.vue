...
const content = `<path class="b0csvwy7j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sim-card-rounded" /></template>
<style>
.b0csvwy7j {
  fill: currentColor;
