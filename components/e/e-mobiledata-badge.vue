...
const content = `<path class="sc8sdybxw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:e-mobiledata-badge" /></template>
<style>
.sc8sdybxw {
  fill: currentColor;
