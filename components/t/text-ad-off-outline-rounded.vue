...
const content = `<path class="svyrjgbpr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-ad-off-outline-rounded" /></template>
<style>
.svyrjgbpr {
  fill: currentColor;
