...
const content = `<path class="ngpmpqbbo"/><path class="pbco1pe2f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:smirking-face" /></template>
<style>
.ngpmpqbbo {
