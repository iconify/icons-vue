...
const content = `<path class="yev4uob3v"/><circle class="z8ak7re-m"/><circle class="vbv_9ublj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:jodel" /></template>
<style>
.vbv_9ublj {
  cx: 29.674px;
  cy: 25.163px;
