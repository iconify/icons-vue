...
const content = `<path class="x-jirb1ak"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-bullet-list-rotate-90-24-regular" /></template>
<style>
.x-jirb1ak {
  fill: currentColor;
