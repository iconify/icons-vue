...
const content = `<path class="dgtamgb1p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-data-bar-20-filled" /></template>
<style>
.dgtamgb1p {
  fill: currentColor;
