...
const content = `<path class="mm84pywtp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:eraser-size-5-outline-rounded" /></template>
<style>
.mm84pywtp {
  fill: currentColor;
