...
const content = `<path class="k-1c9tiib"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-brightness-auto" /></template>
<style>
.k-1c9tiib {
  fill: currentColor;
