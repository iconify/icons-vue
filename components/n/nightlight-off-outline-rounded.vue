...
const content = `<path class="qaa4wjxvt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nightlight-off-outline-rounded" /></template>
<style>
.qaa4wjxvt {
  fill: currentColor;
