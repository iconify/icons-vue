...
const content = `<path class="d3b3z6xvb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:female-outline-rounded" /></template>
<style>
.d3b3z6xvb {
  fill: currentColor;
