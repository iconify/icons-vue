...
const content = `<path class="upp5bqj3d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:trenord" /></template>
<style>
.upp5bqj3d {
  fill: none;
  stroke: currentColor;
