...
const content = `<path class="sh1gadh1n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-middle-left-16-filled" /></template>
<style>
.sh1gadh1n {
  fill: currentColor;
