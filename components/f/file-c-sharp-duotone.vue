...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="j2k461bsy"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-c-sharp-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
