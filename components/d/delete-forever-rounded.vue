...
const content = `<path class="mkqpg6vkk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:delete-forever-rounded" /></template>
<style>
.mkqpg6vkk {
  fill: currentColor;
