...
const content = `<path class="xiticcb2o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-four-24-regular" /></template>
<style>
.xiticcb2o {
  fill: currentColor;
