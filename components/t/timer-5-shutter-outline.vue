...
const content = `<path class="ecos1xb5k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:timer-5-shutter-outline" /></template>
<style>
.ecos1xb5k {
  fill: currentColor;
