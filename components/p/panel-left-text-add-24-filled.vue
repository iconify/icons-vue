...
const content = `<path class="zvyc3ob1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-text-add-24-filled" /></template>
<style>
.zvyc3ob1j {
  fill: currentColor;
