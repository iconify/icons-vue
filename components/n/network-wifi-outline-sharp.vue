...
const content = `<path class="ylc03iboj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:network-wifi-outline-sharp" /></template>
<style>
.ylc03iboj {
  fill: currentColor;
