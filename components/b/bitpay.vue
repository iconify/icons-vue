...
const content = `<circle class="cpk0fnbgt"/><path class="qbl52bsjq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bitpay" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
