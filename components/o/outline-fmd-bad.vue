...
const content = `<path class="h6ch3rbcq"/><path class="ythcedq7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-fmd-bad" /></template>
<style>
.h6ch3rbcq {
  fill: currentColor;
