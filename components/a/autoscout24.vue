...
const content = `<path class="i9clfwm2k"/><rect class="wbicffkga"/><path class="wmym6gbye"/><rect class="z-h08ibtp"/><path class="owr60vbau"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:autoscout24" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
...
.owr60vbau {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M21.449 17.892v2.572c0 .861.698 1.559 1.559 1.559h0c.86 0 1.558-.698 1.558-1.559v-2.572m0 2.572v1.559m2.211-5.417v4.638c0 .43.349.779.78.779h.233m-1.831-4.131h1.637m-8.035 2.066h-2.763m-.684 2.065l2.065-6.235l2.066 6.235");
}
