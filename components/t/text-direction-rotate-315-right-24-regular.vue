...
const content = `<path class="ix04_g7nd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-rotate-315-right-24-regular" /></template>
<style>
.ix04_g7nd {
  fill: currentColor;
