...
const content = `<path class="g2ucxdbdo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-resize-column-20-regular" /></template>
<style>
.g2ucxdbdo {
  fill: currentColor;
