...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="psv_8pbss"/><g class="xyjtgccot"><path clip-rule="evenodd" class="b5ngtabie"/><path class="zdyxmbbtl"/><path clip-rule="evenodd" class="ej9au3kiz"/><path class="p--y7trwn"/><path clip-rule="evenodd" class="ghwje-qzr"/></g><path clip-rule="evenodd" class="wxo97db0q"/><path clip-rule="evenodd" class="ljh3cjbjt"/><path clip-rule="evenodd" class="s240anb-l"/><path clip-rule="evenodd" class="e_xujkbua"/><path class="zsuclwbnx"/><path clip-rule="evenodd" class="kspoj7vnd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-print:seedling-circle-off" /></template>
