...
const content = `<path class="wm916p77g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-list-abc-uppercase-ltr-20-filled" /></template>
<style>
.wm916p77g {
  fill: currentColor;
