...
const content = `<g class="nrj6p8qat"><path class="e1jv4fxrz"/><path class="q-qndji8q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:server-plus" /></template>
<style>
.e1jv4fxrz {
