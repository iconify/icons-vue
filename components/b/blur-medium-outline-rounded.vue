...
const content = `<path class="dx6wnab2n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:blur-medium-outline-rounded" /></template>
<style>
.dx6wnab2n {
  fill: currentColor;
