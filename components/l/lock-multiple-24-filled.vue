...
const content = `<path class="d7o02jbjd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:lock-multiple-24-filled" /></template>
<style>
.d7o02jbjd {
  fill: currentColor;
