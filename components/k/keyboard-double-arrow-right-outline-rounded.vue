...
const content = `<path class="vz9jdbb7f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-double-arrow-right-outline-rounded" /></template>
<style>
.vz9jdbb7f {
  fill: currentColor;
