...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="openmoji:kiss-woman-woman-light-skin-tone-medium-dark-skin-tone" /></template>
