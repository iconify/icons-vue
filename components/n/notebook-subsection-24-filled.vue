...
const content = `<g class="cuyn6tgcc"><path class="j821nwk3b"/><path class="e6e1bcpjc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notebook-subsection-24-filled" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
