...
const content = `<rect class="j3s9ivbxi"/><path class="iue5_nc-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cursed-house-multiplayer-gmm" /></template>
<style>
.iue5_nc-g {
  fill: none;
  stroke: currentColor;
