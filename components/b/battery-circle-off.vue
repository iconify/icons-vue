...
const content = `<g class="cuyn6tgcc"><g transform="translate(3 3)"><rect class="xwhj4xbwf"/><path class="yyulwlb7u"/><path clip-rule="evenodd" class="yhxyf4f2m"/><path class="xedf9ccsf"/></g><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:battery-circle-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
