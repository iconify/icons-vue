...
const content = `<g class="ft5dv1b6b"><path class="jxompyb4v"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-ltr-ac-20-filled" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
