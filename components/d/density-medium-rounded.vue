...
const content = `<path class="uzi5dkb9t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:density-medium-rounded" /></template>
<style>
.uzi5dkb9t {
  fill: currentColor;
