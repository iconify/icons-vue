...
const content = `<path class="p5uglcvuo"/><path class="lfqqr7b-l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:urlsanitizer" /></template>
<style>
.lfqqr7b-l {
  fill: none;
  stroke: currentColor;
