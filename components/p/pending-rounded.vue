...
const content = `<path class="j76xemwuu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pending-rounded" /></template>
<style>
.j76xemwuu {
  fill: currentColor;
