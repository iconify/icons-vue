...
const content = `<path class="rj39sccxy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:usb-plug-24-regular" /></template>
<style>
.rj39sccxy {
  fill: currentColor;
