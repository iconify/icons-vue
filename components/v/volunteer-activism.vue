...
const content = `<path class="vd859lxmf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:volunteer-activism" /></template>
<style>
.vd859lxmf {
  fill: currentColor;
