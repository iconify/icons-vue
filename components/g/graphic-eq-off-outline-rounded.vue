...
const content = `<path class="klw528j-f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:graphic-eq-off-outline-rounded" /></template>
<style>
.klw528j-f {
  fill: currentColor;
