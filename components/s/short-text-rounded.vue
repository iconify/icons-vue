...
const content = `<path class="mneoaccvk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:short-text-rounded" /></template>
<style>
.mneoaccvk {
  fill: currentColor;
