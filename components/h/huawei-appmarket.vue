...
const content = `<path class="gre2p-bxe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:huawei-appmarket" /></template>
<style>
.gre2p-bxe {
  fill: none;
  stroke: currentColor;
