...
const content = `<path class="gjzcw3vfk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:note-pin-20-regular" /></template>
<style>
.gjzcw3vfk {
  fill: currentColor;
