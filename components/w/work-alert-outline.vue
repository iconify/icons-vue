...
const content = `<path class="q70-87bhj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:work-alert-outline" /></template>
<style>
.q70-87bhj {
  fill: currentColor;
