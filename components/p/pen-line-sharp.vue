...
const content = `<path class="re2qfhbsx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:pen-line-sharp" /></template>
<style>
.re2qfhbsx {
  fill: none;
  stroke: currentColor;
