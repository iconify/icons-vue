...
const content = `<path class="u085inb5d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-right-28-regular" /></template>
<style>
.u085inb5d {
  fill: currentColor;
