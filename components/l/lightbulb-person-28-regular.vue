...
const content = `<path class="nhzn7pbfz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:lightbulb-person-28-regular" /></template>
<style>
.nhzn7pbfz {
  fill: currentColor;
