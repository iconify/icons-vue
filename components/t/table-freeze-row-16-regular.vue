...
const content = `<path class="lsljtnb9n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-freeze-row-16-regular" /></template>
<style>
.lsljtnb9n {
  fill: currentColor;
