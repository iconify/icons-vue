...
const content = `<path class="ri25j0b4x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sync-desktop" /></template>
<style>
.ri25j0b4x {
  fill: currentColor;
