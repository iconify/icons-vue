...
const content = `<circle class="jkqdj7bkp"/><path class="jbwr-ku2u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-attractions" /></template>
<style>
.jbwr-ku2u {
  fill: currentColor;
