...
const content = `<path class="jczrmqjck"/><path class="dtw0nimyy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:banano" /></template>
<style>
.dtw0nimyy {
  fill: none;
  stroke: currentColor;
