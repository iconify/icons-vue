...
const content = `<path class="ivte58b4d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-toolbox-24-filled" /></template>
<style>
.ivte58b4d {
  fill: currentColor;
