...
const content = `<path class="b6s75ibml"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-wrench-outline" /></template>
<style>
.b6s75ibml {
  fill: currentColor;
