...
const content = `<path class="jz4mqgvql"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:jazzcash" /></template>
<style>
.jz4mqgvql {
  fill: none;
  stroke: currentColor;
