...
const content = `<circle class="qm7pesb5s"/><circle class="ketqe1bnq"/><path class="jg13uvbjk"/><path class="bdq_s5d4t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:no-bicycles" /></template>
<style>
.bdq_s5d4t {
