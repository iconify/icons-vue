...
const content = `<path class="vyd2vxqxl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-density-32-light" /></template>
<style>
.vyd2vxqxl {
  fill: currentColor;
