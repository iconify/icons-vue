...
const content = `<path class="ir4v6mvqd"/><defs><path id="SVGzH5l9cSF" class="wyyhjwgri"/></defs><clipPath id="SVG5JRthd0N"><use href="#SVGzH5l9cSF"/></clipPath><g clip-path="url(#SVG5JRthd0N)" class="tcw5ljb1b"><path class="lzfbvjbvw"/></g><defs><use href="#SVGzH5l9cSF" id="SVG3kQ6REdG"/></defs><clipPath id="SVGUA7duk8g"><use href="#SVG3kQ6REdG"/></clipPath><g clip-path="url(#SVGUA7duk8g)" class="t3q4o6ulj"><path class="m8qqmn07k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:backhand-index-pointing-down" /></template>
<style>
.ir4v6mvqd {
