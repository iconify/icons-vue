...
const content = `<path class="jb0y1iu2a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:call-rounded" /></template>
<style>
.jb0y1iu2a {
  fill: currentColor;
