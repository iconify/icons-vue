...
const content = `<path class="x14rtl10b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-print-32-regular" /></template>
<style>
.x14rtl10b {
  fill: currentColor;
