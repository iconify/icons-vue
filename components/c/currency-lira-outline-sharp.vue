...
const content = `<path class="o-kj5_bjy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:currency-lira-outline-sharp" /></template>
<style>
.o-kj5_bjy {
  fill: currentColor;
