...
const content = `<path class="p4v-4hbly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-32-regular" /></template>
<style>
.p4v-4hbly {
  fill: currentColor;
