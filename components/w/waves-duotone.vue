...
const content = `<g class="cuyn6tgcc"><path class="x47nwchbb"/><path class="vn1jjv8qn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:waves-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
