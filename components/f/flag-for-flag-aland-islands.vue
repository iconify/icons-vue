...
const content = `<path class="m09c69bmg"/><path class="rog8_17ro"/><path class="e4qbsswvn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-aland-islands" /></template>
<style>
.e4qbsswvn {
