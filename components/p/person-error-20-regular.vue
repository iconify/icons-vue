...
const content = `<path class="fm7pc5h6l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-error-20-regular" /></template>
<style>
.fm7pc5h6l {
  fill: currentColor;
