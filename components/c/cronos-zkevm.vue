...
const content = `<g class="euc7iobwc"><path class="eqky58b0k"/><path class="p42005s0t"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:cronos-zkevm" /></template>
<style>
.eqky58b0k {
