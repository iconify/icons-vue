...
const content = `<path class="gq59t0fpp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:partner-heart-outline-rounded" /></template>
<style>
.gq59t0fpp {
  fill: currentColor;
