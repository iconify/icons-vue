...
const content = `<path class="l5ivg7b8s"/><circle class="w35s9qb-e"/><circle class="s3hpn47wf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:my-boy" /></template>
<style>
.l5ivg7b8s {
  fill: none;
  stroke: currentColor;
