...
const content = `<path class="l9bj9uewa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:credit-card-clock-24-regular" /></template>
<style>
.l9bj9uewa {
  fill: currentColor;
