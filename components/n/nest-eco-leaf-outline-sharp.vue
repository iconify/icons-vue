...
const content = `<path class="aufg1hbfn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:nest-eco-leaf-outline-sharp" /></template>
<style>
.aufg1hbfn {
  fill: currentColor;
