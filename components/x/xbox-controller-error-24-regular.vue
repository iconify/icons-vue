...
const content = `<path class="q52h8vq6t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:xbox-controller-error-24-regular" /></template>
<style>
.q52h8vq6t {
  fill: currentColor;
