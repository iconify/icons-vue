...
const content = `<path class="as97p0xok"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-settings-24-filled" /></template>
<style>
.as97p0xok {
  fill: currentColor;
