...
const content = `<path class="aldhtcwgq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:repartition-outline-sharp" /></template>
<style>
.aldhtcwgq {
  fill: currentColor;
