...
const content = `<path class="rw4ny127j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:in-home-mode-sharp" /></template>
<style>
.rw4ny127j {
  fill: currentColor;
