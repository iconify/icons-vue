...
const content = `<circle class="a0nt0bcoz"/><circle class="dis26tbaj"/><circle class="ytmm-cbus"/><circle class="qbm2rzm5t"/><circle class="cezh58bkh"/><path class="bobw60b-f"/><g class="y9tr6bcfx"><path class="zcy2acj5s"/><path class="tzu_jxbrk"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pcu" /></template>
<style>
.a0nt0bcoz {
  cx: 24px;
  cy: 24.022px;
...
.bobw60b-f {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M14.17 30.278v3.575h4.02m0-19.661h-4.02v3.883");
}
...
.tzu_jxbrk {
  d: path("M29.81 14.192h4.02v3.883m0 12.203v3.575h-4.02");
}
