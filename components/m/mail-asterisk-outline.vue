...
const content = `<path class="xfmua2ubo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mail-asterisk-outline" /></template>
<style>
.xfmua2ubo {
  fill: currentColor;
