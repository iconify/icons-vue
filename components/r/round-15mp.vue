...
const content = `<path class="f0_lvlgte"/><path class="k4n51fjcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-15mp" /></template>
<style>
.f0_lvlgte {
  fill: currentColor;
