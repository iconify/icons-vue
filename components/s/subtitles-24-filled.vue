...
const content = `<path class="n_i9trz4k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:subtitles-24-filled" /></template>
<style>
.n_i9trz4k {
  fill: currentColor;
