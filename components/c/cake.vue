...
.orlb_ik2y {
  fill: var(--svg-color--fbd984, #fbd984);
  d: path("M20.72 15.443c0 2.908-3.899 5.288-8.691 5.288s-8.69-2.38-8.69-5.288v-1.367h17.437v1.367z");
}

.s8-b-obwb {
  fill: var(--svg-color--522d0b, #522d0b);
  d: path("M9.75 13.969c0 .76-.37 1.406-.843 1.406s-.844-.647-.844-1.406c0-.76.371-1.406.844-1.406c.472 0 .843.646.843 1.406m6.188 0c0 .76-.371 1.406-.844 1.406c-.472 0-.843-.647-.843-1.406c0-.76.37-1.406.843-1.406s.844.646.844 1.406");
}

.s9ahn_usa {
  fill: var(--svg-color--ca7d45, #ca7d45);
  d: path("M6.697 5.352a1.72 1.72 0 0 1 1.676-2.081c.956 0 2.03.776 2.03 1.727v3.915c.602-.057.906-.113 1.564-.113c.602 0 .911-.062 1.508 0l.152-4.01c0-.951.916-1.52 1.878-1.52c1.075 0 1.913 1.013 1.738 2.082l-.528 4.275c2.52.95 3.999 2.61 3.999 4.511c0 2.908-3.893 5.282-8.685 5.282s-8.69-2.374-8.69-5.287c0-1.896 1.327-3.555 3.847-4.506z");
}
