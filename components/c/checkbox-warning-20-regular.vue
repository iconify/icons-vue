...
const content = `<path class="vxf2g2doc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:checkbox-warning-20-regular" /></template>
<style>
.vxf2g2doc {
  fill: currentColor;
