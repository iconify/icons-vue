...
const content = `<path class="xvg0194xe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:view-cozy-rounded" /></template>
<style>
.xvg0194xe {
  fill: currentColor;
