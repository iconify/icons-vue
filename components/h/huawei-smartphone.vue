...
const content = `<path class="hbut5ujss"/><path class="xfprkgbde"/><path class="ui-zwub6e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:huawei-smartphone" /></template>
<style>
.hbut5ujss {
  fill: none;
  stroke: currentColor;
