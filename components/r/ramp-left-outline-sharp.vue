...
const content = `<path class="jech00bie"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ramp-left-outline-sharp" /></template>
<style>
.jech00bie {
  fill: currentColor;
