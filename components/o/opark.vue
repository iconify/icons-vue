...
const content = `<path class="gn6v4rbhu"/><path class="xu6nonb0g"/><path class="b-455xbvw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:opark" /></template>
<style>
.b-455xbvw {
  fill: none;
  stroke: currentColor;
