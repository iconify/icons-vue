...
const content = `<circle class="cpk0fnbgt"/><path class="lda78abuw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:huawei-hiskytone" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
