...
const content = `<path class="a7zl0i17l"/><path class="hhnjl43yh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:modanisa" /></template>
<style>
.a7zl0i17l {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M16.026 20.697h-3.462L10 24l2.564 3.303h3.462l-2.448 2.448l.523 4.148l4.148.523l2.448-2.448v3.462L24 38l3.303-2.564v-3.462l2.448 2.448L33.9 33.9l.523-4.149l-2.448-2.448h3.462L38 24l-2.564-3.303h-3.462l2.448-2.448L33.9 14.1l-4.149-.523l-2.448 2.448v-3.462L24 10l-3.303 2.564v3.472l-2.448-2.458l-4.148.523l-.523 4.148z");
}
