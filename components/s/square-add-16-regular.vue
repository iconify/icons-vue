...
const content = `<path class="m13491lpz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-add-16-regular" /></template>
<style>
.m13491lpz {
  fill: currentColor;
