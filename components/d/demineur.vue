...
const content = `<path class="ziq_kbcda"/><path class="b9srb1b1f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:demineur" /></template>
<style>
.b9srb1b1f {
  fill: none;
  stroke: currentColor;
...
.ziq_kbcda {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M18.993 19.86h10v10h-10z");
}
