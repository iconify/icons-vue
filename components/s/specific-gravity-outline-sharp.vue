...
const content = `<path class="puhv0hpvf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:specific-gravity-outline-sharp" /></template>
<style>
.puhv0hpvf {
  fill: currentColor;
