...
const content = `<path class="vd1pmmbym"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:detector-offline-outline-sharp" /></template>
<style>
.vd1pmmbym {
  fill: currentColor;
