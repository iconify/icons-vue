...
const content = `<path class="q4n45bcxo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tile-small-outline-rounded" /></template>
<style>
.q4n45bcxo {
  fill: currentColor;
