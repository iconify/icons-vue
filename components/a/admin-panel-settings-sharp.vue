...
const content = `<path class="yc7fw4ijb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:admin-panel-settings-sharp" /></template>
<style>
.yc7fw4ijb {
  fill: currentColor;
