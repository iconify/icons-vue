...
const content = `<path class="yqia4abec"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cast-outline-sharp" /></template>
<style>
.yqia4abec {
  fill: currentColor;
