...
const content = `<path class="acmyksbso"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:inbox-text-share-sharp" /></template>
<style>
.acmyksbso {
  fill: currentColor;
