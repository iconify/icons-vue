...
const content = `<path class="nsqlqybnh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-one-page-20-filled" /></template>
<style>
.nsqlqybnh {
  fill: currentColor;
