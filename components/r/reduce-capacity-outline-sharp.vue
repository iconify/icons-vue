...
const content = `<path class="rold47bdq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:reduce-capacity-outline-sharp" /></template>
<style>
.rold47bdq {
  fill: currentColor;
