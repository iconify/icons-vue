...
const content = `<path class="s7d6w8btp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-bullet-list-ltr-rotate-270-24-regular" /></template>
<style>
.s7d6w8btp {
  fill: currentColor;
