...
const content = `<path class="g0qq28b7x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-inbox-all-24-regular" /></template>
<style>
.g0qq28b7x {
  fill: currentColor;
