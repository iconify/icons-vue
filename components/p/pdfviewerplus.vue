...
const content = `<path class="h-6-qlj5w"/><path class="p9y04ibjb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pdfviewerplus" /></template>
<style>
.h-6-qlj5w {
  fill: none;
  stroke: currentColor;
