...
const content = `<path class="evi9tpb-i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:reset-shutter-speed-outline-sharp" /></template>
<style>
.evi9tpb-i {
  fill: currentColor;
