...
const content = `<path class="m48_frbqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:remove-road-outline-sharp" /></template>
<style>
.m48_frbqq {
  fill: currentColor;
