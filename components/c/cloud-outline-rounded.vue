...
const content = `<path class="acghz_4fd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloud-outline-rounded" /></template>
<style>
.acghz_4fd {
  fill: currentColor;
