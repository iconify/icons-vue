...
const content = `<path class="gzw2d6bau"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:garden-cart" /></template>
<style>
.gzw2d6bau {
  fill: currentColor;
