...
const content = `<path class="o42-1wbnd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:screen-share-outline-sharp" /></template>
<style>
.o42-1wbnd {
  fill: currentColor;
