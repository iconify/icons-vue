...
const content = `<path class="g78xd4bxo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-circle-down-sharp" /></template>
<style>
.g78xd4bxo {
  fill: currentColor;
