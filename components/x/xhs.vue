...
const content = `<path class="ij6w3zb5q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:xhs" /></template>
<style>
.ij6w3zb5q {
  fill: none;
  stroke: currentColor;
