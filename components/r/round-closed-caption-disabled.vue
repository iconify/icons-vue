...
const content = `<path class="mda642u8e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-closed-caption-disabled" /></template>
<style>
.mda642u8e {
  fill: currentColor;
