...
const content = `<path class="pf7jhopid"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-in-16-regular" /></template>
<style>
.pf7jhopid {
  fill: currentColor;
