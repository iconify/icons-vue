...
const content = `<g class="cuyn6tgcc"><path class="b5en88b-p"/><path class="css8u3bjo"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:gear-fine-duotone" /></template>
<style>
.b5en88b-p {
