...
const content = `<path class="nlyd2kbmt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:rotate-90-degrees-cw-rounded" /></template>
<style>
.nlyd2kbmt {
  fill: currentColor;
