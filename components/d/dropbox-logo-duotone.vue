...
const content = `<g class="cuyn6tgcc"><path class="drxv67b4h"/><path class="ccakrft-u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:dropbox-logo-duotone" /></template>
<style>
.ccakrft-u {
