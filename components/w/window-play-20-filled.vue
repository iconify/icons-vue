...
const content = `<path class="d8856wbnt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-play-20-filled" /></template>
<style>
.d8856wbnt {
  fill: currentColor;
