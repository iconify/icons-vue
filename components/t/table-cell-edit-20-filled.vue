...
const content = `<path class="jzzpfn9yx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cell-edit-20-filled" /></template>
<style>
.jzzpfn9yx {
  fill: currentColor;
