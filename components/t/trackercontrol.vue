...
const content = `<path class="screm1ken"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:trackercontrol" /></template>
<style>
.screm1ken {
  fill: none;
  stroke: currentColor;
