...
const content = `<path class="lt510db1i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloud-lock-rounded" /></template>
<style>
.lt510db1i {
  fill: currentColor;
