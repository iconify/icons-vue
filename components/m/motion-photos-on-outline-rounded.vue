...
const content = `<path class="h1bwhzbpb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:motion-photos-on-outline-rounded" /></template>
<style>
.h1bwhzbpb {
  fill: currentColor;
