...
const content = `<path class="g5365absv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-two-split-top-focus-top-right-16-filled" /></template>
<style>
.g5365absv {
  fill: currentColor;
