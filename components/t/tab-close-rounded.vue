...
const content = `<path class="sc843eboz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tab-close-rounded" /></template>
<style>
.sc843eboz {
  fill: currentColor;
