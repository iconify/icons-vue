...
const content = `<path class="cbknijbbd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fit-screen-rounded" /></template>
<style>
.cbknijbbd {
  fill: currentColor;
