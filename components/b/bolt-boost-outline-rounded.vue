...
const content = `<path class="waox7ih-e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bolt-boost-outline-rounded" /></template>
<style>
.waox7ih-e {
  fill: currentColor;
