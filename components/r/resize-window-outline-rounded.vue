...
const content = `<path class="ctyw23jfq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:resize-window-outline-rounded" /></template>
<style>
.ctyw23jfq {
  fill: currentColor;
