...
const content = `<path class="fy2_ktb1u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-outbound-48-regular" /></template>
<style>
.fy2_ktb1u {
  fill: currentColor;
