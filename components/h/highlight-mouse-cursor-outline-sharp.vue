...
const content = `<path class="ak5-6423p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:highlight-mouse-cursor-outline-sharp" /></template>
<style>
.ak5-6423p {
  fill: currentColor;
