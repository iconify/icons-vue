...
const content = `<path class="jgdp0pdls"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-top-24-regular" /></template>
<style>
.jgdp0pdls {
  fill: currentColor;
