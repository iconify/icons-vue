...
const content = `<path class="bf4ujt5-u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-text-arrow-repeat-all-24-filled" /></template>
<style>
.bf4ujt5-u {
  fill: currentColor;
