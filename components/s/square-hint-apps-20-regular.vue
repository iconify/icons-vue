...
const content = `<path class="eo9mhacju"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-apps-20-regular" /></template>
<style>
.eo9mhacju {
  fill: currentColor;
