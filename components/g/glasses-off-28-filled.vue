...
const content = `<path class="y4a7_j5xb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:glasses-off-28-filled" /></template>
<style>
.y4a7_j5xb {
  fill: currentColor;
