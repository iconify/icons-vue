...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="c2ii1ybwa"/><path clip-rule="evenodd" class="uz3ko-b6x"/><path clip-rule="evenodd" class="yqoutbbzg"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:clock-circle-off" /></template>
<style>
.c2ii1ybwa {
  fill-rule: evenodd;
