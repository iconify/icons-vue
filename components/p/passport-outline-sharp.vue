...
const content = `<path class="ch-elsbtw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:passport-outline-sharp" /></template>
<style>
.ch-elsbtw {
  fill: currentColor;
