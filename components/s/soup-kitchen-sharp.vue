...
const content = `<path class="e0zjrwbjk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:soup-kitchen-sharp" /></template>
<style>
.e0zjrwbjk {
  fill: currentColor;
