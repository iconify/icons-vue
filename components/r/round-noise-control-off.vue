...
const content = `<path class="t9q081loz"/><circle class="ahwkywbwd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-noise-control-off" /></template>
<style>
.ahwkywbwd {
  cx: 13.5px;
  cy: 12.5px;
