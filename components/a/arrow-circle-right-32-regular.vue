...
const content = `<path class="yiaddrb5f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-right-32-regular" /></template>
<style>
.yiaddrb5f {
  fill: currentColor;
