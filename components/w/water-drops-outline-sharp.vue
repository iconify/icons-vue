...
const content = `<path class="taz76db6p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:water-drops-outline-sharp" /></template>
<style>
.taz76db6p {
  fill: currentColor;
