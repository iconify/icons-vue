...
const content = `<path class="kgvrtacbj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:key-off-rounded" /></template>
<style>
.kgvrtacbj {
  fill: currentColor;
