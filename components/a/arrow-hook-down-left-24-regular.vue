...
const content = `<path class="ls_broblw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-hook-down-left-24-regular" /></template>
<style>
.ls_broblw {
  fill: currentColor;
