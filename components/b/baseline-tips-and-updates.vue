...
const content = `<path class="lcs4_kbgv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-tips-and-updates" /></template>
<style>
.lcs4_kbgv {
  fill: currentColor;
