...
const content = `<path class="z-fkan_zo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:speaker-simple-high-bold" /></template>
<style>
.z-fkan_zo {
  fill: currentColor;
