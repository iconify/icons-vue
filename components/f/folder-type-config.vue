...
const content = `<path class="s67987czg"/><path class="e7_4qr92x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-config" /></template>
<style>
.e7_4qr92x {
...
.s67987czg {
  fill: var(--svg-color--53a2c1, #53a2c1);
