...
const content = `<path class="vbfjdkb7w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:post-outline" /></template>
<style>
.vbfjdkb7w {
  fill: currentColor;
