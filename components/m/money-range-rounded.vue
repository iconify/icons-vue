...
const content = `<path class="mzh6mfbap"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:money-range-rounded" /></template>
<style>
.mzh6mfbap {
  fill: currentColor;
