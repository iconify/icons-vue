...
const content = `<path class="z_6p83-8u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:data-saver-on-outline-sharp" /></template>
<style>
.z_6p83-8u {
  fill: currentColor;
