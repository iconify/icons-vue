...
const content = `<path class="wo0a7y-tp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fiber-dvr" /></template>
<style>
.wo0a7y-tp {
  fill: currentColor;
