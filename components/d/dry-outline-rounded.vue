...
const content = `<path class="wdmyyfa6n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dry-outline-rounded" /></template>
<style>
.wdmyyfa6n {
  fill: currentColor;
