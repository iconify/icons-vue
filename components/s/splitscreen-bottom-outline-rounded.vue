...
const content = `<path class="mjl2kacwm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:splitscreen-bottom-outline-rounded" /></template>
<style>
.mjl2kacwm {
  fill: currentColor;
