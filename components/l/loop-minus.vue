...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="ki2vueivy"/><path class="q16qzj1ip"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:loop-minus" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
