...
const content = `<rect class="j3s9ivbxi"/><path class="a6uujgbns"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bnr" /></template>
<style>
.a6uujgbns {
  fill: none;
  stroke: currentColor;
