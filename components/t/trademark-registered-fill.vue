...
const content = `<path class="uqfm2z-cw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:trademark-registered-fill" /></template>
<style>
.uqfm2z-cw {
  fill: currentColor;
