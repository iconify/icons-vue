...
const content = `<path class="i59bjabmj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dock-panel-right-28-filled" /></template>
<style>
.i59bjabmj {
  fill: currentColor;
