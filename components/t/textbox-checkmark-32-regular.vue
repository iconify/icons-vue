...
const content = `<path class="tpzuld_mi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-checkmark-32-regular" /></template>
<style>
.tpzuld_mi {
  fill: currentColor;
