...
const content = `<path class="suby13yhh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:code-circle-20-filled" /></template>
<style>
.suby13yhh {
  fill: currentColor;
