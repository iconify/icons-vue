...
const content = `<ellipse class="z7mg04vth"/><path class="ljy1yc6jm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-join-right" /></template>
<style>
.ljy1yc6jm {
  fill: currentColor;
