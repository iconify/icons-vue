...
const content = `<path class="g2hlkstzl"/><path class="gw3ywlhnb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:etchdroid" /></template>
<style>
.g2hlkstzl {
  fill: none;
  stroke: currentColor;
...
.gw3ywlhnb {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M28.938 32.888h5.467v3.461h-5.467zm-12.826 0h5.467v3.461h-5.467z");
}
