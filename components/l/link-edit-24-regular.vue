...
const content = `<path class="yvzwvrbog"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:link-edit-24-regular" /></template>
<style>
.yvzwvrbog {
  fill: currentColor;
