...
const content = `<path class="dych9iv5p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-downward-alt-rounded" /></template>
<style>
.dych9iv5p {
  fill: currentColor;
