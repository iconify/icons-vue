...
const content = `<path class="n4qghv0rk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sync-arrow-up-outline-rounded" /></template>
<style>
.n4qghv0rk {
  fill: currentColor;
