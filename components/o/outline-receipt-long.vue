...
const content = `<path class="iiq-d_b4e"/><path class="kzcui6qau"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-receipt-long" /></template>
<style>
.iiq-d_b4e {
  fill: currentColor;
