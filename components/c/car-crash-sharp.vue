...
const content = `<path class="hc60uccck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-crash-sharp" /></template>
<style>
.hc60uccck {
  fill: currentColor;
