...
const content = `<path class="y6pik1huo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloud-download-outline-sharp" /></template>
<style>
.y6pik1huo {
  fill: currentColor;
