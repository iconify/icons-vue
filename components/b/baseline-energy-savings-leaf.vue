...
const content = `<path class="ojaw8ebdu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-energy-savings-leaf" /></template>
<style>
.ojaw8ebdu {
  fill: currentColor;
