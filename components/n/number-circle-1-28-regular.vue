...
const content = `<path class="y8_-w631c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-1-28-regular" /></template>
<style>
.y8_-w631c {
  fill: currentColor;
