...
const content = `<path class="c7yhc0b5l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:block-outline-rounded" /></template>
<style>
.c7yhc0b5l {
  fill: currentColor;
