...
const content = `<g class="cuyn6tgcc"><path class="j0bmeel3n"/><path class="ctpdq4lta"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:lock-laminated-open-duotone" /></template>
<style>
.ctpdq4lta {
