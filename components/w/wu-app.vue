...
const content = `<path class="k_3wxhbes"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wu-app" /></template>
<style>
.k_3wxhbes {
  fill: none;
  stroke: currentColor;
