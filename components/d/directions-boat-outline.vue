...
const content = `<path class="alvpcdbun"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:directions-boat-outline" /></template>
<style>
.alvpcdbun {
  fill: currentColor;
