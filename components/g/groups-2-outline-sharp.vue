...
const content = `<path class="qxt9il2fq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:groups-2-outline-sharp" /></template>
<style>
.qxt9il2fq {
  fill: currentColor;
