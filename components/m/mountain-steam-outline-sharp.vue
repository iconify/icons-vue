...
const content = `<path class="rc9k6py8r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mountain-steam-outline-sharp" /></template>
<style>
.rc9k6py8r {
  fill: currentColor;
