...
const content = `<path class="n7fdj71qk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:icq" /></template>
<style>
.n7fdj71qk {
  fill: none;
  stroke: currentColor;
