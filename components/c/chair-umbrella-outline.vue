...
const content = `<path class="k654r4bcz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chair-umbrella-outline" /></template>
<style>
.k654r4bcz {
  fill: currentColor;
