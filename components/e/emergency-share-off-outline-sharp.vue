...
const content = `<path class="r9ugjyb3f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:emergency-share-off-outline-sharp" /></template>
<style>
.r9ugjyb3f {
  fill: currentColor;
