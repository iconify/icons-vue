...
const content = `<path class="a_rpd-byl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hdr-plus-off-outline" /></template>
<style>
.a_rpd-byl {
  fill: currentColor;
