...
const content = `<g class="cuyn6tgcc"><path class="d8rkm0b3g"/><path class="ymgfdgbfg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:speaker-high-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
