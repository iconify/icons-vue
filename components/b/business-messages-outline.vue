...
const content = `<path class="pjg01zxtv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:business-messages-outline" /></template>
<style>
.pjg01zxtv {
  fill: currentColor;
