...
const content = `<path class="n98csbbxl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mood-heart-outline-rounded" /></template>
<style>
.n98csbbxl {
  fill: currentColor;
