...
const content = `<path class="ob0l5fnqi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:border-horizontal-outline-sharp" /></template>
<style>
.ob0l5fnqi {
  fill: currentColor;
