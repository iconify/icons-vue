...
const content = `<path class="gnvr_zc0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-inbound-48-filled" /></template>
<style>
.gnvr_zc0l {
  fill: currentColor;
