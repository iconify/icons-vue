...
const content = `<path class="r8-11ux0o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-freeze-column-and-row-20-regular" /></template>
<style>
.r8-11ux0o {
  fill: currentColor;
