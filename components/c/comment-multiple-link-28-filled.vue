...
const content = `<path class="r3gvkkbuo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-multiple-link-28-filled" /></template>
<style>
.r3gvkkbuo {
  fill: currentColor;
