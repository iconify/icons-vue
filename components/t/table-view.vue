...
const content = `<path class="mkzpfebze"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-view" /></template>
<style>
.mkzpfebze {
  fill: currentColor;
