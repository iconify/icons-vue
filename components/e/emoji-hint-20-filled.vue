...
const content = `<path class="ri_j99-zz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-hint-20-filled" /></template>
<style>
.ri_j99-zz {
  fill: currentColor;
