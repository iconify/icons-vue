...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="rridyzb1s"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:moon-circle" /></template>
<style>
.hdxpysbbn {
