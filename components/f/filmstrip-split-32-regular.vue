...
const content = `<path class="ilner2x-e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:filmstrip-split-32-regular" /></template>
<style>
.ilner2x-e {
  fill: currentColor;
