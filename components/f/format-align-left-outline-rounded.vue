...
const content = `<path class="lbpp8jfzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-align-left-outline-rounded" /></template>
<style>
.lbpp8jfzh {
  fill: currentColor;
