...
const content = `<path class="cp_u1lb8l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sentiment-extremely-dissatisfied-rounded" /></template>
<style>
.cp_u1lb8l {
  fill: currentColor;
