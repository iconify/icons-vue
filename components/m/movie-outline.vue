...
const content = `<path class="g00-iqbxd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:movie-outline" /></template>
<style>
.g00-iqbxd {
  fill: currentColor;
