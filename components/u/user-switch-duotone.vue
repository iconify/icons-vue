...
const content = `<g class="cuyn6tgcc"><path class="erewjjzdk"/><path class="jqulihb3g"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:user-switch-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
