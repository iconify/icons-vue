...
const content = `<path class="kpu0dddws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:currency-20-regular" /></template>
<style>
.kpu0dddws {
