...
const content = `<path class="g5yfpkb5q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cube-checkmark-28-regular" /></template>
<style>
.g5yfpkb5q {
  fill: currentColor;
