...
const content = `<path class="uu03-bcut"/><path class="yb5mebcvu"/><path class="wwjb5-bzf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-testjs" /></template>
<style>
.uu03-bcut {
