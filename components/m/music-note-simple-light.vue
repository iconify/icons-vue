...
const content = `<path class="by3p6-b2w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:music-note-simple-light" /></template>
<style>
.by3p6-b2w {
  fill: currentColor;
