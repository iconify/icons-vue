...
const content = `<path class="c71sdbb4j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phone-cancel-outline-sharp" /></template>
<style>
.c71sdbb4j {
  fill: currentColor;
