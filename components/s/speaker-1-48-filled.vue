...
const content = `<path class="xx95dnbvr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-1-48-filled" /></template>
<style>
.xx95dnbvr {
  fill: currentColor;
