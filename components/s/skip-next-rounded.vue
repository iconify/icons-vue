...
const content = `<path class="bszs_0ecf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:skip-next-rounded" /></template>
<style>
.bszs_0ecf {
  fill: currentColor;
