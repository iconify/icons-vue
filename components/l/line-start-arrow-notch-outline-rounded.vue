...
const content = `<path class="wyf3uob1h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:line-start-arrow-notch-outline-rounded" /></template>
<style>
.wyf3uob1h {
  fill: currentColor;
