...
const content = `<path class="b62p1ttmp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:network-adapter-16-regular" /></template>
<style>
.b62p1ttmp {
  fill: currentColor;
