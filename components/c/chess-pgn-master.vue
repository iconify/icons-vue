...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:chess-pgn-master" /></template>
<style>
.ixkaxpbem {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M14.61 14.45v3.49m0-3.49v-1.73h.65h-1.29h.64m1.64 1.73h-3.27");
}
...
.wbbvh2b0g {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M37.482 38.483a.3.3 0 0 0 .3-.32c-.05-1.87-2.5-2-1.25-2.16c.65-.1 1.68-.85.85-1.71s-1.22-.67-.87-1s2-1.95.92-2.29c-1.6-.51-1-.7-.92-.77a2.9 2.9 0 0 0 1.61-2.28a.27.27 0 0 0-.48-.2c-.4.46-4 1.73-9.42 1.7c-.76.11-.37.91-.28 1.8c.06.54.9.65 1.28.61c.2 0 1.21-.13 1.36-.11c.64.08.79.57 1 1a2 2 0 0 0 1.92.88c.13 0-.25.15-1.13.14c-1.52 0-3.45 1.73-4.06 4.19a.39.39 0 0 0 .35.47c1.54.09 7.27.03 8.82.05");
}
