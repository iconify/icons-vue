...
const content = `<path class="kpe0tlbqp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sound-detection-loud-sound" /></template>
<style>
.kpe0tlbqp {
  fill: currentColor;
