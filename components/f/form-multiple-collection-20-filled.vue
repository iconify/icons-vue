...
const content = `<path class="htnnp5_fy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:form-multiple-collection-20-filled" /></template>
<style>
.htnnp5_fy {
  fill: currentColor;
