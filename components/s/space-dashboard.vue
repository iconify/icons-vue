...
const content = `<path class="rggnoobgu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:space-dashboard" /></template>
<style>
.rggnoobgu {
  fill: currentColor;
