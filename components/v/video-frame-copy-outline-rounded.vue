...
const content = `<path class="ysc3q7wig"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:video-frame-copy-outline-rounded" /></template>
<style>
.ysc3q7wig {
  fill: currentColor;
