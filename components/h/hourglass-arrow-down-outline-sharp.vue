...
const content = `<path class="p4oo_wyxz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hourglass-arrow-down-outline-sharp" /></template>
<style>
.p4oo_wyxz {
  fill: currentColor;
