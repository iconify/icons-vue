...
const content = `<path class="lsmdyibbg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-checkmark-24-regular" /></template>
<style>
.lsmdyibbg {
  fill: currentColor;
