...
const content = `<path class="zo5qw3bbj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cell-cross-brush-20-regular" /></template>
<style>
.zo5qw3bbj {
  fill: currentColor;
