...
const content = `<path class="r36xc_bfy"/><g class="to-5kdesz"><path class="wfpy3gbmy"/><path class="lw4f_pt4y"/><path class="is-ytvijl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-kash-14" /></template>
<style>
.is-ytvijl {
...
.r36xc_bfy {
  ...
  d: path("m16.663 27.465l2.799-1.54m0 0v11.2m9.958 0v-11.2l-6.02 7.56h7.42");
}
