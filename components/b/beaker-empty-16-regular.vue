...
const content = `<path class="j9umm5brw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:beaker-empty-16-regular" /></template>
<style>
.j9umm5brw {
  fill: currentColor;
