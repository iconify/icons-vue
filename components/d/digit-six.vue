...
const content = `<linearGradient id="ssvg-id-digit-sixa" gradientUnits="userSpaceOnUse" x1="64.02" y1="101.119" x2="64.02" y2="24.549"><stop offset=".485" class="fboms9lpk"/><stop offset="1" class="vlzxxcccm"/></linearGradient><path fill="url(#ssvg-id-digit-sixa)" class="rhx81hzgm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:digit-six" /></template>
<style>
.fboms9lpk {
