...
const content = `<path class="q0qtc4bhv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-bottom-row-16-filled" /></template>
<style>
.q0qtc4bhv {
  fill: currentColor;
