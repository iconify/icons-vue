...
const content = `<g class="cuyn6tgcc"><g clip-rule="evenodd" class="d2kvgvbvc"><path class="uckek5ijh"/><path class="qvnchoq5a"/></g><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:bulletin-notice-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
