...
const content = `<path class="t_q-8mr5u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:a-photowidget-app" /></template>
<style>
.t_q-8mr5u {
  fill: none;
  stroke: currentColor;
