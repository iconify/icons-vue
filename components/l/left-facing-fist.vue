...
const content = `<path class="d_a8_5bcq"/><defs><path id="SVGPedepbtP" class="us6dcifmo"/></defs><clipPath id="SVGOq0aqePL"><use href="#SVGPedepbtP"/></clipPath><g clip-path="url(#SVGOq0aqePL)" class="tcw5ljb1b"><path class="g6qubybib"/></g><defs><use href="#SVGPedepbtP" id="SVGVjsgUc5R"/></defs><clipPath id="SVGXRcECbgN"><use href="#SVGVjsgUc5R"/></clipPath><g clip-path="url(#SVGXRcECbgN)" class="t3q4o6ulj"><path class="gw7qssbko"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:left-facing-fist" /></template>
<style>
.d_a8_5bcq {
