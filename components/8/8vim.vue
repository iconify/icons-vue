...
const content = `<path class="rt9cv42zu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:8vim" /></template>
<style>
.rt9cv42zu {
  fill: none;
  stroke: currentColor;
