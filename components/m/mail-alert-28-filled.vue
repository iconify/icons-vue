...
const content = `<path class="i-5o8jb_w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-alert-28-filled" /></template>
<style>
.i-5o8jb_w {
  fill: currentColor;
