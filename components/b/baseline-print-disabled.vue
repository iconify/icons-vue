...
const content = `<path class="dbs0d2_4f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-print-disabled" /></template>
<style>
.dbs0d2_4f {
  fill: currentColor;
