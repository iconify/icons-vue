...
const content = `<path class="nmzpv6bix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:trackpad-input-2" /></template>
<style>
.nmzpv6bix {
  fill: currentColor;
