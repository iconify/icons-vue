...
const content = `<path class="zsvz6xdlk"/><path class="x2c4yqsoh"/><path class="dmuqxvx3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-germany" /></template>
<style>
.dmuqxvx3l {
