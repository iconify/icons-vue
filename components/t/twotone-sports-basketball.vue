...
const content = `<path class="kwdo0jb-e"/><path class="wbvwy-bsg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-sports-basketball" /></template>
<style>
.kwdo0jb-e {
  fill: currentColor;
