...
const content = `<path class="ttwlqgdsz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-rotate-sharp" /></template>
<style>
.ttwlqgdsz {
  fill: currentColor;
