...
const content = `<g class="cuyn6tgcc"><path class="feuqiklnx"/><path class="fqwbl_bix"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:signature-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
