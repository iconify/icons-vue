...
const content = `<path class="jz2keab1g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:soap-outline-rounded" /></template>
<style>
.jz2keab1g {
  fill: currentColor;
