...
const content = `<path class="jp1vnh-1p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:houseboat-outline" /></template>
<style>
.jp1vnh-1p {
  fill: currentColor;
