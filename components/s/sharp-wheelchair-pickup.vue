...
const content = `<path class="o7oloxcwq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-wheelchair-pickup" /></template>
<style>
.o7oloxcwq {
  fill: currentColor;
