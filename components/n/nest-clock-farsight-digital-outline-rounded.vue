...
const content = `<path class="cvuqtcc9b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-clock-farsight-digital-outline-rounded" /></template>
<style>
.cvuqtcc9b {
  fill: currentColor;
