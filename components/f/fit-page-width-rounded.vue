...
const content = `<path class="lt5xp_bvq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fit-page-width-rounded" /></template>
<style>
.lt5xp_bvq {
  fill: currentColor;
