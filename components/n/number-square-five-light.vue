...
const content = `<path class="h0ejl_b0n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-five-light" /></template>
<style>
.h0ejl_b0n {
  fill: currentColor;
