...
const content = `<path class="kkm4aubca"/><path class="ji7um6vlg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-ai" /></template>
<style>
.ji7um6vlg {
