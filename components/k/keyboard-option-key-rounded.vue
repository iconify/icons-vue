...
const content = `<path class="lmoo7kqet"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-option-key-rounded" /></template>
<style>
.lmoo7kqet {
  fill: currentColor;
