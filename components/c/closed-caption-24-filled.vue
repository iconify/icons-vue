...
const content = `<path class="lykrvqbtw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:closed-caption-24-filled" /></template>
<style>
.lykrvqbtw {
  fill: currentColor;
