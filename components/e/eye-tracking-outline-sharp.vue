...
const content = `<path class="mb8k92l2m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:eye-tracking-outline-sharp" /></template>
<style>
.mb8k92l2m {
  fill: currentColor;
