...
const content = `<g class="cuyn6tgcc"><path class="p1ar1kp8b"/><path class="n6-62270d"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:keyhole-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.p1ar1kp8b {
  d: path("M144 139.72L160 176H96l16-36.28a32 32 0 1 1 32 0");
