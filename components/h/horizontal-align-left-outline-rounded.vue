...
const content = `<path class="j-1yepbtk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:horizontal-align-left-outline-rounded" /></template>
<style>
.j-1yepbtk {
  fill: currentColor;
