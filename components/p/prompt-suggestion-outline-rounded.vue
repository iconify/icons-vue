...
const content = `<path class="lini54bwt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:prompt-suggestion-outline-rounded" /></template>
<style>
.lini54bwt {
  fill: currentColor;
