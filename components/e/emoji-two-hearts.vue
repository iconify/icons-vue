...
const content = `<path class="fas-c4bex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-two-hearts" /></template>
<style>
.fas-c4bex {
  fill: none;
  stroke: currentColor;
