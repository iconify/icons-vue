...
const content = `<path class="lq3lhky4a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:screenshot-24-filled" /></template>
<style>
.lq3lhky4a {
  fill: currentColor;
