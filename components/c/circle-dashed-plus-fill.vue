...
const content = `<path class="ek0kq5bce"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-plus-fill" /></template>
<style>
.ek0kq5bce {
  fill: none;
  stroke: currentColor;
