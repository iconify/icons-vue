...
const content = `<path class="xy9r4calb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cursor-20-regular" /></template>
<style>
.xy9r4calb {
  fill: currentColor;
