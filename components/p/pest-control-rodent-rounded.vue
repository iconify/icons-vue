...
const content = `<path class="o_5w9xlxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pest-control-rodent-rounded" /></template>
<style>
.o_5w9xlxi {
  fill: currentColor;
