...
const content = `<rect class="j3s9ivbxi"/><path class="r_sx-ac6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fictionlog" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
