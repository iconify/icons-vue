...
const content = `<path class="nuxp-hbap"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-flag-trinidad-and-tobago" /></template>
<style>
.nuxp-hbap {
  fill: currentColor;
