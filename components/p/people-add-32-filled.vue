...
const content = `<path class="oi2irrbhw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-add-32-filled" /></template>
<style>
.oi2irrbhw {
  fill: currentColor;
