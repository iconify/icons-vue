...
const content = `<g class="ft5dv1b6b"><path class="jqrbtzd7q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-full-24-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
