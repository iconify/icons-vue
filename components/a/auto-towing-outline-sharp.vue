...
const content = `<path class="co_voxbps"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-towing-outline-sharp" /></template>
<style>
.co_voxbps {
  fill: currentColor;
