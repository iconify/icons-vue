...
const content = `<path class="f-qxxjbsl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-start-horizontal-20-regular" /></template>
<style>
.f-qxxjbsl {
  fill: currentColor;
