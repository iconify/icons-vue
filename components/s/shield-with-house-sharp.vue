...
const content = `<path class="s9l4u9maa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-with-house-sharp" /></template>
<style>
.s9l4u9maa {
  fill: currentColor;
