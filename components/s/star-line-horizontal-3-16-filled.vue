...
const content = `<path class="vd9ym65sv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:star-line-horizontal-3-16-filled" /></template>
<style>
.vd9ym65sv {
  fill: currentColor;
