...
const content = `<path class="dsds1vfgp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speaker-2-outline-rounded" /></template>
<style>
.dsds1vfgp {
  fill: currentColor;
