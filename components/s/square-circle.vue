...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="bcyndmbqj"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:square-circle" /></template>
<style>
.bcyndmbqj {
