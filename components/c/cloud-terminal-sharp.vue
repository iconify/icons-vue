...
const content = `<path class="yw0rmbfuh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:cloud-terminal-sharp" /></template>
<style>
.yw0rmbfuh {
  fill: none;
  stroke: currentColor;
