...
const content = `<path class="wc3i36blm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:movie-edit-sharp" /></template>
<style>
.wc3i36blm {
  fill: currentColor;
