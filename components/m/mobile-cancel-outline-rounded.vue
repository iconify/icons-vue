...
const content = `<path class="svar1tb5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-cancel-outline-rounded" /></template>
<style>
.svar1tb5x {
  fill: currentColor;
