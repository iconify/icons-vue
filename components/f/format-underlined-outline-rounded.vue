...
const content = `<path class="ldcsoz7fj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-underlined-outline-rounded" /></template>
<style>
.ldcsoz7fj {
  fill: currentColor;
