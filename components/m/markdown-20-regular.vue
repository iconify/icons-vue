...
const content = `<path class="o52cwmb_g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:markdown-20-regular" /></template>
<style>
.o52cwmb_g {
  fill: currentColor;
