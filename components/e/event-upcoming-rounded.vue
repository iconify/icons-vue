...
const content = `<path class="h0o-nzwnr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:event-upcoming-rounded" /></template>
<style>
.h0o-nzwnr {
  fill: currentColor;
