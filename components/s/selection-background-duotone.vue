...
const content = `<g class="cuyn6tgcc"><path class="b5j7vmiil"/><path class="v6-hzuvwj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:selection-background-duotone" /></template>
<style>
.b5j7vmiil {
  d: path("M216 48v112a8 8 0 0 1-8 8h-40V96a8 8 0 0 0-8-8H88V48a8 8 0 0 1 8-8h112a8 8 0 0 1 8 8");
