...
const content = `<path class="t5bfysb3v"/><path class="j24slubmr"/><path class="b42jckbjd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:spacebasic" /></template>
<style>
.b42jckbjd {
  fill: none;
  stroke: currentColor;
