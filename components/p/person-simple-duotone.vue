...
const content = `<g class="cuyn6tgcc"><path class="egu3z3b4k"/><path class="iqjm9xbmt"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:person-simple-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
