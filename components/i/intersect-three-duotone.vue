...
const content = `<g class="cuyn6tgcc"><path class="lkiepxblv"/><path class="r6a8y2b0k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:intersect-three-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
