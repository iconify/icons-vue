...
const content = `<path class="w9ib1vb6p"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:credit-karma" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
