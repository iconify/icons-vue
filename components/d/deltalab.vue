...
const content = `<path class="ompr500ne"/><path class="wfwxyybip"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:deltalab" /></template>
<style>
.ompr500ne {
  fill: none;
  stroke: currentColor;
