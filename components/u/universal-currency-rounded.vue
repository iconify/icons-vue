...
const content = `<path class="thzyh3b3r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:universal-currency-rounded" /></template>
<style>
.thzyh3b3r {
  fill: currentColor;
