...
const content = `<path class="pvnkyry6e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:swap-driving-apps-wheel-outline-sharp" /></template>
<style>
.pvnkyry6e {
  fill: currentColor;
