...
const content = `<path class="ado2xt1wd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:donut-small-rounded" /></template>
<style>
.ado2xt1wd {
  fill: currentColor;
