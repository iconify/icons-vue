...
const content = `<path class="fuah0ubun"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:ear-sharp-fill" /></template>
<style>
.fuah0ubun {
  fill: none;
  stroke: currentColor;
