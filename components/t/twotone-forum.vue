...
const content = `<path class="d14512rpr"/><path class="viux_sbct"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-forum" /></template>
<style>
.d14512rpr {
  fill: currentColor;
