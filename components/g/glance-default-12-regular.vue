...
const content = `<path class="mhvrrhbzi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:glance-default-12-regular" /></template>
<style>
.mhvrrhbzi {
  fill: currentColor;
