...
const content = `<path class="fk524kbmp"/><path class="f2cdyvbux"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pc-financial" /></template>
<style>
.f2cdyvbux {
  fill: none;
  stroke: currentColor;
