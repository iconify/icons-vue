...
const content = `<path class="swzyd-dpj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phonelink-ring-rounded" /></template>
<style>
.swzyd-dpj {
  fill: currentColor;
