...
const content = `<path class="w2xzpplcp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wb-incandescent-rounded" /></template>
<style>
.w2xzpplcp {
  fill: currentColor;
