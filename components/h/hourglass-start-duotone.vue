...
const content = `<g class="nrj6p8qat"><path class="tcy-4kbqq"/><path class="bsqm65bxg"/><path class="j01bihj8h"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:hourglass-start-duotone" /></template>
<style>
.bsqm65bxg {
  fill: currentColor;
  d: path("M5 5L19 5L19 6.0633C19 6.9536 18.6045 7.7979 17.9206 8.3679L13.562 12L10.438 12L6.0794 8.3679C5.3955 7.7979 5 6.9536 5 6.0633Z");
  stroke: none;
}
