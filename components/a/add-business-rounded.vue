...
const content = `<path class="r-s5gsbkc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-business-rounded" /></template>
<style>
.r-s5gsbkc {
  fill: currentColor;
