...
const content = `<path class="b-lksdl1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:baby-2-boy-sharp" /></template>
<style>
.b-lksdl1m {
  fill: none;
  stroke: currentColor;
