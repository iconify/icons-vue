...
const content = `<path class="n1hsy2bza"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:move-selection-right-outline-sharp" /></template>
<style>
.n1hsy2bza {
  fill: currentColor;
