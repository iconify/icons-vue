...
const content = `<path class="vkp7yzbjl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-circle-down-light" /></template>
<style>
.vkp7yzbjl {
  fill: currentColor;
