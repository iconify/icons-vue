...
const content = `<circle class="bgatx5byk"/><path class="rb0jzuyka"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:input-latin-lowercase" /></template>
<style>
.bgatx5byk {
  cx: 32px;
  cy: 32px;
