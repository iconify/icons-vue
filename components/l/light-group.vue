...
const content = `<path class="btemekbme"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:light-group" /></template>
<style>
.btemekbme {
  fill: currentColor;
