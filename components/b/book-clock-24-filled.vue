...
const content = `<path class="yufm9eeyq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-clock-24-filled" /></template>
<style>
.yufm9eeyq {
  fill: currentColor;
