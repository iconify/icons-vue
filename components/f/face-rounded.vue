...
const content = `<path class="fngh6945k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-rounded" /></template>
<style>
.fngh6945k {
  fill: currentColor;
