...
const content = `<path class="x8fc3c85b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ballot-outline-rounded" /></template>
<style>
.x8fc3c85b {
  fill: currentColor;
