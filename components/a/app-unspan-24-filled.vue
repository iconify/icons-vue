...
const content = `<path class="ag90y4kij"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:app-unspan-24-filled" /></template>
<style>
.ag90y4kij {
