...
const content = `<path class="w-slo8ibz"/><path class="wg4jg_k5e"/><path class="xaq6u7bxx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fampay" /></template>
<style>
.w-slo8ibz {
  fill: none;
  stroke: currentColor;
