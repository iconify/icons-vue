...
const content = `<path class="kjh2gbbpy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:receipt-sparkles-24-regular" /></template>
<style>
.kjh2gbbpy {
  fill: currentColor;
