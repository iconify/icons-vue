...
const content = `<path class="e6alyhjud"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:add-reaction-outline-rounded" /></template>
<style>
.e6alyhjud {
  fill: currentColor;
