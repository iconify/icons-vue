...
const content = `<path class="h73hyor4x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-48-regular" /></template>
<style>
.h73hyor4x {
  fill: currentColor;
