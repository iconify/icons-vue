...
const content = `<path class="inc_814rj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sentiment-satisfied-rounded" /></template>
<style>
.inc_814rj {
  fill: currentColor;
