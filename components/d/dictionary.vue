...
const content = `<path class="vkko0qb_u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dictionary" /></template>
<style>
.vkko0qb_u {
  fill: currentColor;
