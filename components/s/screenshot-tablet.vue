...
const content = `<path class="vogez0b5f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screenshot-tablet" /></template>
<style>
.vogez0b5f {
  fill: currentColor;
