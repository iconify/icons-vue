...
const content = `<path class="fgbiznbuc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:empty-dashboard-sharp" /></template>
<style>
.fgbiznbuc {
  fill: currentColor;
