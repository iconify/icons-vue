...
const content = `<path class="buibu5btx"/><path class="a2mji1iis"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-light-fonts" /></template>
<style>
.a2mji1iis {
