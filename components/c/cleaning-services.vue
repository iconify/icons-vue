...
const content = `<path class="oe330i-6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cleaning-services" /></template>
<style>
.oe330i-6u {
  fill: currentColor;
