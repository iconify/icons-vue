...
const content = `<path class="odwdzj-eu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:watch-check-outline-rounded" /></template>
<style>
.odwdzj-eu {
  fill: currentColor;
