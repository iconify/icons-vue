...
const content = `<path class="nppd_tbud"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:checked-bag-question" /></template>
<style>
.nppd_tbud {
  fill: currentColor;
