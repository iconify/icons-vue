...
const content = `<path class="ukmeehbtl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-paragraph-settings-20-regular" /></template>
<style>
.ukmeehbtl {
  fill: currentColor;
