...
const content = `<path class="rsfreebqs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-charging-50-sharp" /></template>
<style>
.rsfreebqs {
  fill: currentColor;
