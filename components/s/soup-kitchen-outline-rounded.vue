...
const content = `<path class="xqmbhsbuq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:soup-kitchen-outline-rounded" /></template>
<style>
.xqmbhsbuq {
  fill: currentColor;
