...
const content = `<path class="ie3xnrb_v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:smartwatch-dot-20-regular" /></template>
<style>
.ie3xnrb_v {
  fill: currentColor;
