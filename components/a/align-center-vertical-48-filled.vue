...
const content = `<path class="wsshu9z8m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-center-vertical-48-filled" /></template>
<style>
.wsshu9z8m {
  fill: currentColor;
