...
const content = `<path class="g115j3bly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:groups-rounded" /></template>
<style>
.g115j3bly {
  fill: currentColor;
