...
const content = `<path class="x7x0yg21l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tapmanager" /></template>
<style>
.x7x0yg21l {
  fill: none;
  stroke: currentColor;
