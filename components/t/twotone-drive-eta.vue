...
const content = `<path class="n9y4h6_xz"/><path class="p4c0yd0ae"/><circle class="ynmar58zv"/><circle class="tad726sor"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-drive-eta" /></template>
<style>
.n9y4h6_xz {
  fill: currentColor;
