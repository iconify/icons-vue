...
const content = `<path class="pqe35dq1e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-ios-48-regular" /></template>
<style>
.pqe35dq1e {
  fill: currentColor;
