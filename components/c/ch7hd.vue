...
const content = `<path class="ppcsw9bxj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ch7hd" /></template>
<style>
.ppcsw9bxj {
  fill: none;
  stroke: currentColor;
