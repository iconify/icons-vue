...
const content = `<path class="vvkwst6hn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:picture-in-picture-enter-24-regular" /></template>
<style>
.vvkwst6hn {
  fill: currentColor;
