...
const content = `<path class="vi-y6fb1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:timer-10-alt-1-sharp" /></template>
<style>
.vi-y6fb1m {
  fill: currentColor;
