...
const content = `<path class="nlkxk3_po"/><path class="w4cbnfkfg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sketchbook" /></template>
<style>
.nlkxk3_po {
  fill: none;
  stroke: currentColor;
