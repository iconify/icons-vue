...
const content = `<path class="nazkkub9r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-through-24-regular" /></template>
<style>
.nazkkub9r {
  fill: currentColor;
