...
const content = `<path class="zfycr97af"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:subtract-circle-24-regular" /></template>
<style>
.zfycr97af {
  fill: currentColor;
