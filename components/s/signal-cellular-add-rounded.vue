...
const content = `<path class="uhwz825pi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:signal-cellular-add-rounded" /></template>
<style>
.uhwz825pi {
  fill: currentColor;
