...
const content = `<path class="vdczeonpm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-airline-seat-individual-suite" /></template>
<style>
.vdczeonpm {
  fill: currentColor;
