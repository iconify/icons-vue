...
const content = `<path class="nzlneab_o"/><path class="ioctiacvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:jellyfin" /></template>
<style>
.ioctiacvo {
  fill: none;
  stroke: currentColor;
