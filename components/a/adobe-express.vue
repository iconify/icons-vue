...
const content = `<rect class="j3s9ivbxi"/><path class="khc3-bbpk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:adobe-express" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
