...
const content = `<path class="fmar0mbkk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:e911-avatar" /></template>
<style>
.fmar0mbkk {
  fill: currentColor;
