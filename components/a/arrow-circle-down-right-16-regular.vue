...
const content = `<path class="oikjm_w1v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-down-right-16-regular" /></template>
<style>
.oikjm_w1v {
  fill: currentColor;
