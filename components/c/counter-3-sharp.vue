...
const content = `<path class="jyr2zn-0r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:counter-3-sharp" /></template>
<style>
.jyr2zn-0r {
  fill: currentColor;
