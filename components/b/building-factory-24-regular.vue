...
const content = `<path class="gsx5z7fhu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-factory-24-regular" /></template>
<style>
.gsx5z7fhu {
  fill: currentColor;
