...
const content = `<path class="fh6u8wbzw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sign-language-outline-rounded" /></template>
<style>
.fh6u8wbzw {
  fill: currentColor;
