...
const content = `<path class="q5byy1bjg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-bullet-list-multiple-24-regular" /></template>
<style>
.q5byy1bjg {
  fill: currentColor;
