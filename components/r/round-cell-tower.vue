...
const content = `<path class="f83mpi0ry"/><path class="pkjwm-74t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-cell-tower" /></template>
<style>
.f83mpi0ry {
  fill: currentColor;
