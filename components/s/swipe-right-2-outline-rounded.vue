...
const content = `<path class="dnixhsb4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-right-2-outline-rounded" /></template>
<style>
.dnixhsb4n {
  fill: currentColor;
