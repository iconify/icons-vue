...
const content = `<path class="jeo_a05_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:chooser" /></template>
<style>
.jeo_a05_k {
  fill: none;
  stroke: currentColor;
