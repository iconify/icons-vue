...
const content = `<path class="rnav7f6pj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phone-cancel-outline" /></template>
<style>
.rnav7f6pj {
  fill: currentColor;
