...
const content = `<path class="v8qkblq3k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:switch-off-outline" /></template>
<style>
.v8qkblq3k {
  fill: currentColor;
