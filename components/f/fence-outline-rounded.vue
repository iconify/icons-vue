...
const content = `<path class="yjmzkkbol"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fence-outline-rounded" /></template>
<style>
.yjmzkkbol {
  fill: currentColor;
