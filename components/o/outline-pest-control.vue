...
const content = `<path class="j3yy98btg"/><path class="y51b72pxg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-pest-control" /></template>
<style>
.j3yy98btg {
  fill: currentColor;
