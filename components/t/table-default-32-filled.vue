...
const content = `<path class="p_hod-0lp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-default-32-filled" /></template>
<style>
.p_hod-0lp {
  fill: currentColor;
