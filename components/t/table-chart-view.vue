...
const content = `<path class="k8jf37b2s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-chart-view" /></template>
<style>
.k8jf37b2s {
  fill: currentColor;
