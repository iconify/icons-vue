...
const content = `<path class="k3zntbban"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:no-stroller-outline" /></template>
<style>
.k3zntbban {
  fill: currentColor;
