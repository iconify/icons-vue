...
const content = `<path class="z5-203blj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-left-2" /></template>
<style>
.z5-203blj {
  fill: currentColor;
