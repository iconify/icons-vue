...
const content = `<path class="gb1t6ctqw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keep-off-outline" /></template>
<style>
.gb1t6ctqw {
  fill: currentColor;
