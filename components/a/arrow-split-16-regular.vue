...
const content = `<path class="arf09jz3y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-split-16-regular" /></template>
<style>
.arf09jz3y {
  fill: currentColor;
