...
const content = `<circle class="jplb9pb4e"/><path class="rle2f1bnd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:metroplayer" /></template>
<style>
.jplb9pb4e {
  cx: 8.16px;
  cy: 38.57px;
