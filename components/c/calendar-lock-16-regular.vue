...
const content = `<path class="xqf27y8ff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-lock-16-regular" /></template>
<style>
.xqf27y8ff {
  fill: currentColor;
