...
const content = `<path class="tylq-ybze"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:assignment-returned" /></template>
<style>
.tylq-ybze {
  fill: currentColor;
