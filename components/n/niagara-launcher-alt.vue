...
const content = `<path class="tfog1je_o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:niagara-launcher-alt" /></template>
<style>
.tfog1je_o {
  fill: none;
  stroke: currentColor;
