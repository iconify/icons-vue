...
const content = `<path class="t3t-gcc9f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chess-bishop-2-outline" /></template>
<style>
.t3t-gcc9f {
  fill: currentColor;
