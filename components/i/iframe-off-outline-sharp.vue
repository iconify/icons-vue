...
const content = `<path class="n3sfci71t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:iframe-off-outline-sharp" /></template>
<style>
.n3sfci71t {
  fill: currentColor;
