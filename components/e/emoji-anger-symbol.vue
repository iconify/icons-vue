...
const content = `<path class="dvpsquo9t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-anger-symbol" /></template>
<style>
.dvpsquo9t {
  fill: none;
  stroke: currentColor;
