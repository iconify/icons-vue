...
const content = `<path class="bvf1-gbuf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-text-ltr-20-filled" /></template>
<style>
.bvf1-gbuf {
  fill: currentColor;
