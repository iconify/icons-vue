...
.goym1hj9u {
  stop-color: var(--svg-color--85fbf9, #85fbf9);
}

.hy-00zbro {
  stop-color: var(--svg-color--ce3358, #ce3358);
}

.j2_907q3q {
  stop-color: var(--svg-color--24348a, #24348a);
}

.mtpc2kapo {
  stop-color: var(--svg-color--f6ce3a, #f6ce3a);
  stop-opacity: 0;
}

.nerruc8eb {
  fill-rule: evenodd;
  d: path("M12 21a9 9 0 1 0 0-18a9 9 0 0 0 0 18m0-.318a8.683 8.683 0 1 0 0-17.365a8.683 8.683 0 0 0 0 17.365");
}
...
.t-qr9mbgt {
  stop-color: var(--svg-color--b9501d, #b9501d);
}

.tf9z7ccsk {
  stop-color: var(--svg-color--281e6c, #281e6c);
}
...
.vn-wg3-3d {
  fill: var(--svg-color--9dffff, #9dffff);
  d: path("M15.442 11.354v.91l-.911-.91zm-6.883 1.291v-.91l.91.91z");
}

.xpe5p7cgk {
  stop-color: var(--svg-color--ec4dec, #ec4dec);
}

.y13jdvbdu {
  fill-opacity: var(--svg-fill-opacity--0-5, 0.5);
  fill-rule: evenodd;
  d: path("M20.809 12.07a8.81 8.81 0 1 1-17.62 0a8.81 8.81 0 0 1 17.62 0m-.249 0a8.56 8.56 0 1 1-5.644-8.048c0 .64-1.08 1.096-1.651 1.25c.106 0 1.138.386 1.64.582a6.6 6.6 0 0 1 1.568-1.085c.53.323 1.016.704 1.461 1.127c-.28.53-1.09.826-1.472.906l1.154 1.138a3.9 3.9 0 0 1 1.721-.286c.116.201.228.402.334.614c-.16.09-.43.222-.8.318c-.476.11-.741.074-.857.058c-.038 0-.059-.01-.07 0l.403.805q.316-.258.688-.424a4.4 4.4 0 0 1 .858-.265a8.5 8.5 0 0 1 .667 3.31");
}
