...
const content = `<path class="gqd5zmbzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:water-drops-outline-rounded" /></template>
<style>
.gqd5zmbzh {
  fill: currentColor;
