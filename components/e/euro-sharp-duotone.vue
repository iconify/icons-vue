...
const content = `<path class="llh2edb5w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:euro-sharp-duotone" /></template>
<style>
.llh2edb5w {
  fill: none;
  stroke: currentColor;
