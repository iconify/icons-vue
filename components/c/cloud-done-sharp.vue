...
const content = `<path class="eudwbvbal"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cloud-done-sharp" /></template>
<style>
.eudwbvbal {
  fill: currentColor;
