...
const content = `<path class="c-br-xbdn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-5-24-regular" /></template>
<style>
.c-br-xbdn {
  fill: currentColor;
