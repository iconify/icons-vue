...
const content = `<path class="ncpficckd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:circle-hint-cursor-16-regular" /></template>
<style>
.ncpficckd {
  fill: currentColor;
