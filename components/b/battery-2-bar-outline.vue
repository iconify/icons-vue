...
const content = `<path class="e5rc-abky"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-2-bar-outline" /></template>
<style>
.e5rc-abky {
  fill: currentColor;
