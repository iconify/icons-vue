...
const content = `<path class="v0q49cbre"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dutch-bros" /></template>
<style>
.v0q49cbre {
  fill: none;
  stroke: currentColor;
