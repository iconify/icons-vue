...
const content = `<g class="nrj6p8qat"><path class="g70whwsdk"/><path class="ajkm4g1km"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-x-duotone" /></template>
<style>
.ajkm4g1km {
