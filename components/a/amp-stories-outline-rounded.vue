...
const content = `<path class="yo0f5mxgc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:amp-stories-outline-rounded" /></template>
<style>
.yo0f5mxgc {
  fill: currentColor;
