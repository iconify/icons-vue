...
const content = `<path class="heq4g3w4o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:verified-off-rounded" /></template>
<style>
.heq4g3w4o {
  fill: currentColor;
