...
const content = `<path class="la_66502q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:receipt-sparkles-20-regular" /></template>
<style>
.la_66502q {
  fill: currentColor;
