...
const content = `<path class="n9c2qhycp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-text-24-filled" /></template>
<style>
.n9c2qhycp {
  fill: currentColor;
