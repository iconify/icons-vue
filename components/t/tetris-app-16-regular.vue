...
const content = `<path class="xcv6u3esf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tetris-app-16-regular" /></template>
<style>
.xcv6u3esf {
  fill: currentColor;
