...
const content = `<path class="atfy8ab1o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:hand-left-28-filled" /></template>
<style>
.atfy8ab1o {
  fill: currentColor;
