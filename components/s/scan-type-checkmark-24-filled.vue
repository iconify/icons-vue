...
const content = `<path class="s9i3mgnua"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-type-checkmark-24-filled" /></template>
<style>
.s9i3mgnua {
  fill: currentColor;
