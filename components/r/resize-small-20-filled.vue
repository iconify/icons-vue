...
const content = `<path class="b6kmbkcbh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:resize-small-20-filled" /></template>
<style>
.b6kmbkcbh {
  fill: currentColor;
