...
const content = `<path class="gks_qpbqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-snow-24-filled" /></template>
<style>
.gks_qpbqq {
  fill: currentColor;
