...
const content = `<path class="xszi21ble"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:livemagicscreen" /></template>
<style>
.xszi21ble {
  fill: none;
  stroke: currentColor;
