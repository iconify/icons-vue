...
const content = `<path class="dtbwek7vk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:thermostat-arrow-up-outline-sharp" /></template>
<style>
.dtbwek7vk {
  fill: currentColor;
