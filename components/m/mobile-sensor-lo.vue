...
const content = `<path class="nvgyxfhwm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobile-sensor-lo" /></template>
<style>
.nvgyxfhwm {
  fill: currentColor;
