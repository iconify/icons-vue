...
const content = `<path class="fuv95pk8u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-up-right-dashes-32-filled" /></template>
<style>
.fuv95pk8u {
  fill: currentColor;
