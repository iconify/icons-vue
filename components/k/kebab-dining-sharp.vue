...
const content = `<path class="f0w--riut"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:kebab-dining-sharp" /></template>
<style>
.f0w--riut {
  fill: currentColor;
