...
const content = `<path class="hs13yebrq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:computer-sound-rounded" /></template>
<style>
.hs13yebrq {
  fill: currentColor;
