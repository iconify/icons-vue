...
const content = `<path class="jkwv6_bxw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:select-to-speak-outline-rounded" /></template>
<style>
.jkwv6_bxw {
  fill: currentColor;
