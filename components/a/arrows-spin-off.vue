...
const content = `<g class="cuyn6tgcc"><path class="ibygzrm5w"/><path class="ohhdvcc5t"/><path class="phzn_bbsb"/><path class="fwhjwlbez"/><path class="o0kovfbsc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:arrows-spin-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
