...
const content = `<path class="qv0tlptfa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:important-devices" /></template>
<style>
.qv0tlptfa {
  fill: currentColor;
