...
const content = `<path class="jpun04ryu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pip-exit" /></template>
<style>
.jpun04ryu {
  fill: currentColor;
