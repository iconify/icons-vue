...
const content = `<path class="nmy9f4rem"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-monetization-on" /></template>
<style>
.nmy9f4rem {
  fill: currentColor;
