...
const content = `<path class="lzn98n5wy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:calendar-lock-outline-sharp" /></template>
<style>
.lzn98n5wy {
  fill: currentColor;
