...
const content = `<path class="kjfhrlbnj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pubtran" /></template>
<style>
.kjfhrlbnj {
  fill: none;
  stroke: currentColor;
