...
const content = `<g class="nrj6p8qat"><path class="u52ozydly"/><path class="n1ynzk7zq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:smartphone-arrow-up-left-duotone" /></template>
<style>
.n1ynzk7zq {
