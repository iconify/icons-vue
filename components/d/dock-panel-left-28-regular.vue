...
const content = `<path class="gx-qd5bsf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dock-panel-left-28-regular" /></template>
<style>
.gx-qd5bsf {
  fill: currentColor;
