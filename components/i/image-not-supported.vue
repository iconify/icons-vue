...
const content = `<path class="wtuxzfiby"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:image-not-supported" /></template>
<style>
.wtuxzfiby {
  fill: currentColor;
