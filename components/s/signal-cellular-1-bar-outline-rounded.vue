...
const content = `<path class="n0fi7b2yc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-cellular-1-bar-outline-rounded" /></template>
<style>
.n0fi7b2yc {
  fill: currentColor;
