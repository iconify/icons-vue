...
const content = `<path class="y242v6bvn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-shopping-basket" /></template>
<style>
.y242v6bvn {
  fill: currentColor;
