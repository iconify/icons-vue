...
const content = `<path class="k6dpxtbsf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:recent-patient-sharp" /></template>
<style>
.k6dpxtbsf {
  fill: currentColor;
