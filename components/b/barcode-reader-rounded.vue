...
const content = `<path class="u7cugcoqb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:barcode-reader-rounded" /></template>
<style>
.u7cugcoqb {
  fill: currentColor;
