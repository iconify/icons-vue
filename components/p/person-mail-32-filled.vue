...
const content = `<path class="x3vy8m3ek"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-mail-32-filled" /></template>
<style>
.x3vy8m3ek {
  fill: currentColor;
