...
const content = `<g class="cuyn6tgcc"><path class="n09jmit_o"/><path class="c9hmfn8ok"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:magic-wand-duotone" /></template>
<style>
.c9hmfn8ok {
...
.n09jmit_o {
  d: path("M176 112L74.34 213.66a8 8 0 0 1-11.31 0L42.34 193a8 8 0 0 1 0-11.31L144 80Z");
