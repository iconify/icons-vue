...
const content = `<path class="pfl0m297n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-or-edge-sharp" /></template>
<style>
.pfl0m297n {
  fill: currentColor;
