...
const content = `<path class="ileii5q1q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-information-20-filled" /></template>
<style>
.ileii5q1q {
  fill: currentColor;
