...
const content = `<path class="a2rbpybxn"/><path class="hspvbwbpx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-opacity" /></template>
<style>
.a2rbpybxn {
  fill: currentColor;
