...
const content = `<path class="f1lrjgb3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:app-title-24-regular" /></template>
<style>
.f1lrjgb3l {
  fill: currentColor;
