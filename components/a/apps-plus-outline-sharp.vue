...
const content = `<path class="qd5wnvypl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:apps-plus-outline-sharp" /></template>
<style>
.qd5wnvypl {
  fill: currentColor;
