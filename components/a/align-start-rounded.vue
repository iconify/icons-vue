...
const content = `<path class="m6v47m63c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-start-rounded" /></template>
<style>
.m6v47m63c {
  fill: currentColor;
