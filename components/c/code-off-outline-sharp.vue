...
const content = `<path class="h00ipn9-i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:code-off-outline-sharp" /></template>
<style>
.h00ipn9-i {
  fill: currentColor;
