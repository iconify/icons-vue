...
const content = `<path class="phz40jbie"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-flag-france" /></template>
<style>
.phz40jbie {
  fill: currentColor;
