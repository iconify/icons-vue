...
const content = `<path class="c3xuyfz3y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-align-left-20-regular" /></template>
<style>
.c3xuyfz3y {
  fill: currentColor;
