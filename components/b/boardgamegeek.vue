...
const content = `<path class="i0wso2blw"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:boardgamegeek" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
