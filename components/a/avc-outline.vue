...
const content = `<path class="rlm1qebrs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:avc-outline" /></template>
<style>
.rlm1qebrs {
  fill: currentColor;
