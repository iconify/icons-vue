...
const content = `<path class="duo7qmypo"/><path class="k-1c8jbkn"/><path class="ell6s5bck"/><path class="bhzjyknfs"/><g class="hq2-vcghy"><path class="yhagnub6s"/><path class="oj350igkv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:shrimp" /></template>
<style>
.bhzjyknfs {
  fill: var(--svg-color--3e4347, #3e4347);
  d: path("M41.8 15c-.4 1.1-1.5 1.6-2.6 1.3c-1.1-.4-1.6-1.5-1.3-2.6c.4-1.1 1.5-1.6 2.6-1.3c1.1.4 1.7 1.5 1.3 2.6");
}

.duo7qmypo {
  fill: var(--svg-color--ed4c5c, #ed4c5c);
  d: path("M37.7 13c-7.3-7.1-17 1.5-29.9-11c8 12.9 22.4 6.5 28.5 12.3z");
}

.ell6s5bck {
  fill: var(--svg-color--fff, #fff);
  d: path("M43.9 15.7c-.8 2.2-3.2 3.4-5.4 2.6s-3.4-3.2-2.6-5.4s3.2-3.4 5.4-2.6s3.4 3.2 2.6 5.4");
}
