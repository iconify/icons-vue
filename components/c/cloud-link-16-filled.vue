...
const content = `<path class="yl1_ccbqk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-link-16-filled" /></template>
<style>
.yl1_ccbqk {
  fill: currentColor;
