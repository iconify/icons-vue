...
const content = `<path class="clj-g92sf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:family-history-sharp" /></template>
<style>
.clj-g92sf {
  fill: currentColor;
