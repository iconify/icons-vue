...
const content = `<path class="xdiskyvmk"/><path class="m0bq_vtsp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-goggles" /></template>
<style>
.m0bq_vtsp {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M8.105 19.529L5.5 21.194l.229 5.08l2.722 1.591m31.444-8.336l2.605 1.665l-.229 5.08l-2.722 1.591");
}
