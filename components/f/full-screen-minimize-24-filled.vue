...
const content = `<path class="jp6zjp4qu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:full-screen-minimize-24-filled" /></template>
<style>
.jp6zjp4qu {
  fill: currentColor;
