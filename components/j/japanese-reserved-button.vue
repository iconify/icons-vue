...
const content = `<path class="s3hhwvsye"/><path class="wshatdbfe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:japanese-reserved-button" /></template>
<style>
.s3hhwvsye {
