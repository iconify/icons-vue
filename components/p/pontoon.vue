...
const content = `<path class="f32kbe2zi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pontoon" /></template>
<style>
.f32kbe2zi {
  fill: none;
  stroke: currentColor;
