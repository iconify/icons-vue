...
const content = `<path class="bbob1_bgz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clock-warning-28-filled" /></template>
<style>
.bbob1_bgz {
  fill: currentColor;
