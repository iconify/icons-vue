...
const content = `<path class="uu0dahbuv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:payments-outline" /></template>
<style>
.uu0dahbuv {
  fill: currentColor;
