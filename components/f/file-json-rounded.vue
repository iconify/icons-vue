...
const content = `<path class="mq345rboj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:file-json-rounded" /></template>
<style>
.mq345rboj {
  fill: currentColor;
