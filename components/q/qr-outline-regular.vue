...
const content = `<g class="nrj6p8qat"><path class="dngdujbqm"/><path class="nc3tobbpg"/><path class="pdc4gobyf"/><path class="j2hnp9b4t"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:qr-outline-regular" /></template>
<style>
.dngdujbqm {
