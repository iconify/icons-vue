...
const content = `<path class="r34hn3a0m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-night-sight-outline" /></template>
<style>
.r34hn3a0m {
  fill: currentColor;
