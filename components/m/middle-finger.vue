...
const content = `<path class="mee5vcbby"/><path class="hpa8slghx"/><path class="n6o-i9bhm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:middle-finger" /></template>
<style>
.hpa8slghx {
