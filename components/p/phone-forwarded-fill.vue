...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-forwarded-fill" /></template>
<style>
.b_gf1sbty {
  fill: currentColor;
...
.tfpgcvbes {
  d: path("M16 5H22M19 2L22 5L19 8");
}
