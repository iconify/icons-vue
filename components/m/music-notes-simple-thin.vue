...
const content = `<path class="nxeqm2b7g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:music-notes-simple-thin" /></template>
<style>
.nxeqm2b7g {
  fill: currentColor;
