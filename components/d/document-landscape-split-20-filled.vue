...
const content = `<path class="ctyzpnn4s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-landscape-split-20-filled" /></template>
<style>
.ctyzpnn4s {
  fill: currentColor;
