...
const content = `<path class="x93t8gr7h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shelf-position-outline" /></template>
<style>
.x93t8gr7h {
  fill: currentColor;
