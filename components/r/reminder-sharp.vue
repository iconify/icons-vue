...
const content = `<path class="naakupbdl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:reminder-sharp" /></template>
<style>
.naakupbdl {
  fill: currentColor;
