...
const content = `<path class="ffnkom7wr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:briefcase-meal-outline-sharp" /></template>
<style>
.ffnkom7wr {
  fill: currentColor;
