...
const content = `<path class="xbj50_i5u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-bottom-row-24-filled" /></template>
<style>
.xbj50_i5u {
  fill: currentColor;
