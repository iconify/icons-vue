...
const content = `<path class="k58p_1bal"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-page-bottom-right-24-regular" /></template>
<style>
.k58p_1bal {
  fill: currentColor;
