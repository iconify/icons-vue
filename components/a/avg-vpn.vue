...
const content = `<path class="kg4ghsblu"/><g class="y9tr6bcfx"><path class="i_-42jbjh"/><path class="ni6ojvtbk"/><path class="b6w2oguqe"/></g>`;
</script>
...
.i_-42jbjh {
  d: path("M24.585 14.476v-.964a.744.744 0 1 0-1.487 0v.32c0-.587-.477-1.064-1.065-1.064h0c-.588 0-1.064.477-1.064 1.065c0-.588-.477-1.065-1.064-1.065h0c-.588 0-1.065.477-1.065 1.065a1.064 1.064 0 0 0-2.129 0v-.32a.744.744 0 1 0-1.487 0v8.424h8.724m-7.237-8.104v1.762m2.129-1.762v1.762m2.129-1.762v1.762m2.129-1.762v.631");
}
