...
const content = `<path class="t719z7baa"/><circle class="yy-kfybew"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-palau" /></template>
<style>
.t719z7baa {
