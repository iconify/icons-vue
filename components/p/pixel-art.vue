...
const content = `<path class="ecza6sx2w"/><g class="y9tr6bcfx"><path class="k3a3osbga"/><path class="hhqjfmkgw"/><path class="flpnt1c0r"/></g><path class="tjx_9fodg"/>`;
</script>
...
.hhqjfmkgw {
  d: path("M30.243 17.267c-.296-.398-.746-.671-1.493-.671h-.125c-.98 0-1.775.815-1.775 1.822v1.856m12.8 0c0 1.006-.795 1.822-1.775 1.822h0c-.98 0-1.775-.816-1.775-1.822v0c0-1.006.795-1.822 1.775-1.822h0c.98 0 1.775.816 1.775 1.822");
}
