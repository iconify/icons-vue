...
const content = `<path class="atwj03bxl"/><path class="v8qc18bax"/><path class="nff259xsw"/><path class="apd4j2b9j"/><path class="hg3u2sbah"/><path class="gvl8qv61p"/><path class="bbicpbt_f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:woman-gesturing-ok-dark-skin-tone" /></template>
<style>
.apd4j2b9j {
