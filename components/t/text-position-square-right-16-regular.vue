...
const content = `<path class="zuqw0qbpl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-square-right-16-regular" /></template>
<style>
.zuqw0qbpl {
  fill: currentColor;
