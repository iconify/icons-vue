...
const content = `<path class="fojavfbda"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-bottom-row-16-regular" /></template>
<style>
.fojavfbda {
  fill: currentColor;
