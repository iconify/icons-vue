...
const content = `<path class="vtlxtkb7j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-open-48-regular" /></template>
<style>
.vtlxtkb7j {
  fill: currentColor;
