...
const content = `<path class="bxd_bgg7e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-sort-down-24-regular" /></template>
<style>
.bxd_bgg7e {
  fill: currentColor;
