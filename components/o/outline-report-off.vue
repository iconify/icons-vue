...
const content = `<path class="qnctddbnp"/><circle class="iu35e1xme"/><path class="rqxz1exkl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-report-off" /></template>
<style>
.iu35e1xme {
  cx: 12px;
  cy: 16px;
