...
const content = `<path class="azkb1gbsw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-replay-circle-filled" /></template>
<style>
.azkb1gbsw {
  fill: currentColor;
