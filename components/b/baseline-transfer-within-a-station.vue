...
const content = `<path class="cboulebrv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-transfer-within-a-station" /></template>
<style>
.cboulebrv {
  fill: currentColor;
