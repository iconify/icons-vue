...
const content = `<path class="p-nodyimu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stylus" /></template>
<style>
.p-nodyimu {
  fill: currentColor;
