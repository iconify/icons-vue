...
const content = `<path class="wt1om1bjn"/><path class="bpz89ebja"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:pinching-hand-dark-skin-tone" /></template>
<style>
.bpz89ebja {
