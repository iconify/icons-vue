...
const content = `<path class="s0nddyb2w"/><path class="ajpujnb-v"/><path class="o6gt_whqz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ytdlnis" /></template>
<style>
.ajpujnb-v {
  fill: none;
  stroke: currentColor;
