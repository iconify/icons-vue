...
const content = `<path class="k4f57qb2s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:music-note-outline-rounded" /></template>
<style>
.k4f57qb2s {
  fill: currentColor;
