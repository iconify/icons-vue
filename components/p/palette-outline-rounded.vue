...
const content = `<path class="a0qagebrw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:palette-outline-rounded" /></template>
<style>
.a0qagebrw {
  fill: currentColor;
