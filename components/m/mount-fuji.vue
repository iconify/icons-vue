...
const content = `<path class="j_edqwb9w"/><path class="h0r3857rl"/><path class="sbz9bzb4r"/><path class="ypkc0eh9s"/><path class="o10oelbnr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:mount-fuji" /></template>
<style>
.h0r3857rl {
  fill: var(--svg-color--464d51, #464d51);
  d: path("M58 41.5L37.5 33l-25.6 4.4L0 44v20h64V44z");
}
