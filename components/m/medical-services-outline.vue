...
const content = `<path class="jfqfl2_hp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:medical-services-outline" /></template>
<style>
.jfqfl2_hp {
  fill: currentColor;
