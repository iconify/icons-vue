...
const content = `<path class="hl9y-zrca"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:flare" /></template>
<style>
.hl9y-zrca {
  fill: none;
  stroke: currentColor;
