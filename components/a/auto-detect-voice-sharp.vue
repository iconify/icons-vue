...
const content = `<path class="nrxswjbpu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-detect-voice-sharp" /></template>
<style>
.nrxswjbpu {
  fill: currentColor;
