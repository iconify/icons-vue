...
const content = `<path class="ax2gl2b7a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-thermostat-sensor-eu-outline-sharp" /></template>
<style>
.ax2gl2b7a {
  fill: currentColor;
