...
const content = `<path class="ldkr-ntql"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cottage-rounded" /></template>
<style>
.ldkr-ntql {
  fill: currentColor;
