...
const content = `<path class="svn8pkbsw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:column-single-16-filled" /></template>
<style>
.svn8pkbsw {
  fill: currentColor;
