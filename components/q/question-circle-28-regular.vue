...
const content = `<path class="ueqke9umb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:question-circle-28-regular" /></template>
<style>
.ueqke9umb {
  fill: currentColor;
