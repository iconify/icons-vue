...
const content = `<path class="are7cobgj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:camping-rounded" /></template>
<style>
.are7cobgj {
  fill: currentColor;
