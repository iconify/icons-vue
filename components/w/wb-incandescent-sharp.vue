...
const content = `<path class="iko-20bga"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wb-incandescent-sharp" /></template>
<style>
.iko-20bga {
  fill: currentColor;
