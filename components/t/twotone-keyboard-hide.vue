...
const content = `<path class="j49-62b6i"/><path class="d0h_ybcxw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-keyboard-hide" /></template>
<style>
.d0h_ybcxw {
  fill: currentColor;
