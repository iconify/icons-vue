...
const content = `<path class="yrb1gsbur"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:calendar-view-day-outline-rounded" /></template>
<style>
.yrb1gsbur {
  fill: currentColor;
