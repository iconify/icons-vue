...
const content = `<path class="sbu17bb-z"/><path class="te5mh9bkw"/><path class="w9u7x0otq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tiime-invoice" /></template>
<style>
.sbu17bb-z {
  fill: none;
  stroke: currentColor;
...
.w9u7x0otq {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m24.166 26.294l1.808-4.536l-3.376 3.47l-3.317-.93L28.719 17L26.98 28.851zm-1.884 1.449L20.372 31m3.393-2.456l-.665 1.117m-3.384-.81l1.15-1.926");
}
