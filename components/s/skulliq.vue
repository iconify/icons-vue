...
const content = `<path class="wvlms8x5e"/><path class="wd-xdqkdi"/><rect class="r1v6syb4t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:skulliq" /></template>
<style>
.r1v6syb4t {
  width: 10.547px;
  height: 15.919px;
...
.wd-xdqkdi {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M10.599 27.381c1.33 1.494 2.659 2.987 2.949 3.63s-.46.435-.876.29c-.416-.138-.498-.22-.876-.29s-1.046-.126-1.456-.063c-.403.063-.548.24-.687.032c-.138-.208-.27-.807-.113-1.469s.611-1.399 1.059-2.13m6.289-5.275c1.853 0 3.36 1.469 3.36 3.284c0 1.821-1.507 3.29-3.36 3.29c-1.86 0-3.359-1.469-3.359-3.29c0-1.815 1.5-3.284 3.36-3.284m10.791-5.774v15.92m15.82 0l-5.274-5.211");
}
