...
const content = `<circle class="cpk0fnbgt"/><path class="l2kmg2bwa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:exteragram-orbit" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
