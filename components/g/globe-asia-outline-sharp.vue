...
const content = `<path class="zf7_01bio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:globe-asia-outline-sharp" /></template>
<style>
.zf7_01bio {
  fill: currentColor;
