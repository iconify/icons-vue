...
const content = `<path class="vx1vmgrra"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tools-flat-head-rounded" /></template>
<style>
.vx1vmgrra {
  fill: currentColor;
