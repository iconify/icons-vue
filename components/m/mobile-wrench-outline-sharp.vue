...
const content = `<path class="yp9a5ybum"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-wrench-outline-sharp" /></template>
<style>
.yp9a5ybum {
  fill: currentColor;
