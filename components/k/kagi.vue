...
const content = `<path class="v_81vcs2j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kagi" /></template>
<style>
.v_81vcs2j {
  fill: none;
  stroke: currentColor;
