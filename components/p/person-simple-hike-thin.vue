...
const content = `<path class="zhc0l7m4j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:person-simple-hike-thin" /></template>
<style>
.zhc0l7m4j {
  fill: currentColor;
