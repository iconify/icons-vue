...
const content = `<path class="bvh10mvwc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-vibrate" /></template>
<style>
.bvh10mvwc {
  fill: currentColor;
