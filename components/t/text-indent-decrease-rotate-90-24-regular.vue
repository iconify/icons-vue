...
const content = `<path class="fclx02bgs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-decrease-rotate-90-24-regular" /></template>
<style>
.fclx02bgs {
  fill: currentColor;
