...
const content = `<path class="bt2s27bab"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:license-sharp" /></template>
<style>
.bt2s27bab {
  fill: currentColor;
