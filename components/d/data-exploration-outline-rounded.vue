...
const content = `<path class="kemcdabhw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:data-exploration-outline-rounded" /></template>
<style>
.kemcdabhw {
  fill: currentColor;
