...
const content = `<path class="j65ksvb3p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:u-turn-left-outline-sharp" /></template>
<style>
.j65ksvb3p {
  fill: currentColor;
