...
const content = `<path class="vgwxk8b5m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-grammar-checkmark-24-filled" /></template>
<style>
.vgwxk8b5m {
  fill: currentColor;
