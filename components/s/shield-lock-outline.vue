...
const content = `<path class="xu2l7abej"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shield-lock-outline" /></template>
<style>
.xu2l7abej {
  fill: currentColor;
