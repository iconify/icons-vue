...
const content = `<path class="imi055_dc"/><rect class="p1um_wbqu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dkbbanking" /></template>
<style>
.imi055_dc {
  fill: none;
  stroke: currentColor;
