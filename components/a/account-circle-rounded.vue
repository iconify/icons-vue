...
const content = `<path class="ps9_v0x0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:account-circle-rounded" /></template>
<style>
.ps9_v0x0q {
  fill: currentColor;
