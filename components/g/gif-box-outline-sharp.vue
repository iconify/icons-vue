...
const content = `<path class="dvrqiccot"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:gif-box-outline-sharp" /></template>
<style>
.dvrqiccot {
  fill: currentColor;
