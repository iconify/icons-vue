...
const content = `<path class="n4l2w4rwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:how-to-vote" /></template>
<style>
.n4l2w4rwk {
  fill: currentColor;
