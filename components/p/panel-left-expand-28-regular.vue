...
const content = `<path class="fdedamtly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-expand-28-regular" /></template>
<style>
.fdedamtly {
  fill: currentColor;
