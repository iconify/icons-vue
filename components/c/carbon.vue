...
const content = `<g class="ft5dv1b6b"><path clip-rule="evenodd" class="e9_vlcbhp"/><path class="rymd4tbtz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:carbon" /></template>
<style>
.e9_vlcbhp {
