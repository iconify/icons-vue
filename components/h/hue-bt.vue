...
const content = `<path class="i9clfwm2k"/><path class="m94mk76uc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hue-bt" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
