...
const content = `<path class="thyamebhm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-circle-eight-fill" /></template>
<style>
.thyamebhm {
  fill: currentColor;
