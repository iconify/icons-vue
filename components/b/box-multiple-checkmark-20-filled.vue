...
const content = `<path class="f0n7j8b2a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:box-multiple-checkmark-20-filled" /></template>
<style>
.f0n7j8b2a {
  fill: currentColor;
