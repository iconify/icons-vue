...
const content = `<path class="qv-rdzziv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phonelink-ring-outline" /></template>
<style>
.qv-rdzziv {
  fill: currentColor;
