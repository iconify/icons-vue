...
const content = `<path class="yjn8h6b4j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-multiple-32-filled" /></template>
<style>
.yjn8h6b4j {
  fill: currentColor;
