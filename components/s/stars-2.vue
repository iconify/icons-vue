...
const content = `<path class="kj5qwvv-m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stars-2" /></template>
<style>
.kj5qwvv-m {
  fill: currentColor;
