...
const content = `<g class="cuyn6tgcc"><path class="yhv20gbph"/><path class="c0-2olq6l"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:currency-ngn-duotone" /></template>
<style>
.c0-2olq6l {
...
.yhv20gbph {
  d: path("M192 112v98l-51.51-66H64V46l51.51 66Z");
