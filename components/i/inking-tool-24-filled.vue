...
const content = `<path class="r13jh_b-b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:inking-tool-24-filled" /></template>
<style>
.r13jh_b-b {
  fill: currentColor;
