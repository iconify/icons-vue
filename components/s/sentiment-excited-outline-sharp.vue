...
const content = `<path class="zdxd5ov9b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sentiment-excited-outline-sharp" /></template>
<style>
.zdxd5ov9b {
  fill: currentColor;
