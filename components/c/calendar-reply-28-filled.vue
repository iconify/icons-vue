...
const content = `<path class="zr47h9bkk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-reply-28-filled" /></template>
<style>
.zr47h9bkk {
  fill: currentColor;
