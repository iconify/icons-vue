...
const content = `<path class="sgy34zb_r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-turn-down-up-48-regular" /></template>
<style>
.sgy34zb_r {
  fill: currentColor;
