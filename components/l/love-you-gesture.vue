...
const content = `<path class="ntgvf2rzd"/><defs><path id="SVG86R5pb3p" class="geq8-zbit"/></defs><clipPath id="SVGfTZPDcEH"><use href="#SVG86R5pb3p"/></clipPath><g clip-path="url(#SVGfTZPDcEH)" class="tcw5ljb1b"><path class="eqj3-etxh"/><path class="x9voxho-p"/></g><defs><use href="#SVG86R5pb3p" id="SVGKYHuyear"/></defs><clipPath id="SVGWf5bocKn"><use href="#SVGKYHuyear"/></clipPath><g clip-path="url(#SVGWf5bocKn)" class="t3q4o6ulj"><path class="v4f5wlz2e"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:love-you-gesture" /></template>
<style>
.eqj3-etxh {
