...
const content = `<path class="nzr0kmbwh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-home-lock-24-regular" /></template>
<style>
.nzr0kmbwh {
