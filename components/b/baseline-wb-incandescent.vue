...
const content = `<path class="wp0xwlbzo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-wb-incandescent" /></template>
<style>
.wp0xwlbzo {
  fill: currentColor;
