...
const content = `<path class="k8mvem9-m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:multiplier-1-2x-28-regular" /></template>
<style>
.k8mvem9-m {
  fill: currentColor;
