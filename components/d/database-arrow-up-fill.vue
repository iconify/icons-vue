...
const content = `<g class="nrj6p8qat"><path clip-rule="evenodd" class="bao7fobzx"/><path class="as_lwow4k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-up-fill" /></template>
<style>
.as_lwow4k {
