...
const content = `<path class="fblklhbox"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:border-left-outline-sharp" /></template>
<style>
.fblklhbox {
  fill: currentColor;
