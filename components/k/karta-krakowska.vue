...
const content = `<rect class="c_6m8lged"/><path class="u9zjv-bfz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:karta-krakowska" /></template>
<style>
.c_6m8lged {
  width: 31.569px;
  height: 39px;
