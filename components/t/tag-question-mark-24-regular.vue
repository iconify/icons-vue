...
const content = `<path class="r-nmge6jt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tag-question-mark-24-regular" /></template>
<style>
.r-nmge6jt {
  fill: currentColor;
