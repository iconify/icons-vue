...
const content = `<path class="vt9wqgbza"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:edit-arrow-down-outline-sharp" /></template>
<style>
.vt9wqgbza {
  fill: currentColor;
