...
const content = `<path class="xfupb8dcx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-add-below-24-regular" /></template>
<style>
.xfupb8dcx {
  fill: currentColor;
