...
const content = `<path class="upgxe9ytr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:menu-book-outline-rounded" /></template>
<style>
.upgxe9ytr {
  fill: currentColor;
