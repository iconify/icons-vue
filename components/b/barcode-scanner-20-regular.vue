...
const content = `<path class="dz05n--_n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:barcode-scanner-20-regular" /></template>
<style>
.dz05n--_n {
  fill: currentColor;
