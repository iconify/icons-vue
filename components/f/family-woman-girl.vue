...
const content = `<path class="gb7dsabnw"/><path class="gh40vebvi"/><path class="rltc34b1j"/><path class="urce0uzfd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:family-woman-girl" /></template>
<style>
.gb7dsabnw {
