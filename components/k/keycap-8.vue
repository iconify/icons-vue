...
const content = `<path class="rl1cpz9vl"/><path class="f_xx2xjft"/><path class="r0p4vjgwb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:keycap-8" /></template>
<style>
.f_xx2xjft {
