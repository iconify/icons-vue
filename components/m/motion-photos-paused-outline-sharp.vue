...
const content = `<path class="l4dwadb0s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:motion-photos-paused-outline-sharp" /></template>
<style>
.l4dwadb0s {
  fill: currentColor;
