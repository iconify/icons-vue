...
const content = `<linearGradient id="SVG8DjBhbdm" x1="50.127" x2="50.127" y1="32" y2="4" gradientTransform="matrix(1 0 0 -1 0 128)" gradientUnits="userSpaceOnUse"><stop offset="0" class="zs84mcc3v"/><stop offset=".47" class="fwmih7b7q"/><stop offset="1" class="lgwbsx_1t"/></linearGradient><path fill="url(#SVG8DjBhbdm)" class="eo6y5xb-n"/><path class="ckaqo9bez"/><path class="dmhq8abza"/><g class="qp89kubki"><ellipse class="n62bmib6i"/><ellipse class="h5wtu34ok"/></g><path class="jb-36wb8f"/><path class="be_qa_pyt"/><path class="ppje29bls"/><g class="vd8kx8r3f"><linearGradient id="SVG11coRz5g" x1="79.315" x2="71.608" y1="14.534" y2="16.177" gradientTransform="matrix(1 0 0 -1 0 128)" gradientUnits="userSpaceOnUse"><stop offset=".265" class="sozvcjboj"/><stop offset="1" class="b8btyqb8s"/></linearGradient><path fill="url(#SVG11coRz5g)" class="a75fqzb5k"/></g><linearGradient id="SVGhrtQ0bho" x1="108.165" x2="100.165" y1="64.135" y2="52.885" gradientTransform="matrix(1 0 0 -1 0 128)" gradientUnits="userSpaceOnUse"><stop offset=".5" class="gg42svbns"/><stop offset="1" class="ms-lo7bhi"/></linearGradient><path fill="url(#SVGhrtQ0bho)" class="s8d41igzf"/><linearGradient id="SVGatS2FcFr" x1="90.047" x2="90.047" y1="55.897" y2="10.657" gradientTransform="matrix(1 0 0 -1 0 128)" gradientUnits="userSpaceOnUse"><stop offset="0" class="zs84mcc3v"/><stop offset=".47" class="fwmih7b7q"/><stop offset="1" class="lgwbsx_1t"/></linearGradient><path fill="url(#SVGatS2FcFr)" class="yl8ecwbsj"/><path class="dedz1f-6f"/><radialGradient id="SVGWT5V0bmo" cx="48.254" cy="80.901" r="38.092" gradientTransform="matrix(1 0 0 -1.1282 0 138.37)" gradientUnits="userSpaceOnUse"><stop offset=".794" class="l1arbqe-k"/><stop offset="1" class="atqdr-9uk"/></radialGradient><path fill="url(#SVGWT5V0bmo)" class="poqhc3-jo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:man-tipping-hand-medium-light-skin-tone" /></template>
<style>
.a75fqzb5k {
