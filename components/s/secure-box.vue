...
const content = `<path class="g2pk2nb3s"/><path class="xerw7seku"/><rect class="b-76si4dn"/><path class="ly_jl04ok"/><circle class="icyifzbim"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:secure-box" /></template>
<style>
.b-76si4dn {
  width: 16.899px;
  height: 15.778px;
...
.xerw7seku {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M19.365 17.209a4.407 4.407 0 1 1 8.815 0v2.362");
}
