...
const content = `<path class="l5xim3boy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:alarm-add-rounded" /></template>
<style>
.l5xim3boy {
  fill: currentColor;
