...
const content = `<path class="v708c2bip"/><path class="uzd_hg1xd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:letter-d" /></template>
<style>
.uzd_hg1xd {
  fill: currentColor;
