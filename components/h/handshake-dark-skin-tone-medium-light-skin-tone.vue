...
const content = `<path class="zce6o94-i"/><path class="creje3bmt"/><defs><path id="SVGU67dBeQS" class="l439n0bap"/></defs><clipPath id="SVG617RIbte"><use href="#SVGU67dBeQS"/></clipPath><g clip-path="url(#SVG617RIbte)" class="t_nvrsbrc"><path class="o4yqbwbdl"/></g><defs><use href="#SVGU67dBeQS" id="SVGCPeKAdMZ"/></defs><clipPath id="SVG3ABvZdad"><use href="#SVGCPeKAdMZ"/></clipPath><g clip-path="url(#SVG3ABvZdad)"><path class="oqad6y8ry"/></g><defs/><g clip-path="url(#SVG3ABvZdad)" class="zlqwn85jm"><path class="s2_2_ccsc"/></g><defs/><g clip-path="url(#SVG3ABvZdad)" class="j9_i7vu4q"><path class="trz1g0bjh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:handshake-dark-skin-tone-medium-light-skin-tone" /></template>
<style>
.creje3bmt {
