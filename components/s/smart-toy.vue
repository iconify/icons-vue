...
const content = `<path class="xft5dobpu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:smart-toy" /></template>
<style>
.xft5dobpu {
  fill: currentColor;
