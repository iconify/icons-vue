...
const content = `<path class="i__zm4b8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:record-stop-48-regular" /></template>
<style>
.i__zm4b8v {
  fill: currentColor;
