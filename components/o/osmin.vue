...
const content = `<circle class="cpk0fnbgt"/><path class="rpj147b3g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:osmin" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
