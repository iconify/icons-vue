...
const content = `<path class="rymyc8biv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:person-text-rounded" /></template>
<style>
.rymyc8biv {
  fill: currentColor;
