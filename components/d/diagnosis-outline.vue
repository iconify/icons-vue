...
const content = `<path class="cz2okccnb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:diagnosis-outline" /></template>
<style>
.cz2okccnb {
  fill: currentColor;
