...
const content = `<path class="cy5yau7on"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-dev-edit-20-regular" /></template>
<style>
.cy5yau7on {
  fill: currentColor;
