...
const content = `<path class="a87-7obiz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:person-search-outline-sharp" /></template>
<style>
.a87-7obiz {
  fill: currentColor;
