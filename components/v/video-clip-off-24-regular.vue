...
const content = `<path class="aa1d5abbo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-clip-off-24-regular" /></template>
<style>
.aa1d5abbo {
  fill: currentColor;
