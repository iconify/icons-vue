...
const content = `<circle class="j5c5phb-q"/><path class="ne-jl5b8b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:boinc" /></template>
<style>
.j5c5phb-q {
  cx: 24px;
  cy: 24px;
