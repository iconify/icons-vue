...
const content = `<path class="y5y-71gep"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:air-traffic-control-fill" /></template>
<style>
.y5y-71gep {
  fill: currentColor;
