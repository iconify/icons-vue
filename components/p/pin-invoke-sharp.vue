...
const content = `<path class="mtpzacc4d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pin-invoke-sharp" /></template>
<style>
.mtpzacc4d {
  fill: currentColor;
