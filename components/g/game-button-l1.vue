...
const content = `<path class="a_5r5om-d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:game-button-l1" /></template>
<style>
.a_5r5om-d {
  fill: currentColor;
