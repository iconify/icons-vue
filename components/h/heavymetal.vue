...
const content = `<path class="nc9f8wbfm"/><path class="j5od8-fhz"/><path class="agt8kxbyl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:heavymetal" /></template>
<style>
.agt8kxbyl {
  fill: none;
  stroke: currentColor;
