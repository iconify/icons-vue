...
const content = `<path class="ozxl-hb_e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:contact-card-28-regular" /></template>
<style>
.ozxl-hb_e {
  fill: currentColor;
