...
const content = `<path class="qij39xb0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:draft-orders" /></template>
<style>
.qij39xb0l {
  fill: currentColor;
