...
const content = `<path class="ic1oeeq_s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-6-48-regular" /></template>
<style>
.ic1oeeq_s {
  fill: currentColor;
