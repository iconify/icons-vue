...
const content = `<g class="ft5dv1b6b"><g clip-path="url(#SVGHcSWxdhd)"><path fill="url(#SVGlFhzzeNl)" class="r4i437pya"/><path class="exftoclob"/><path class="g4mw-knmr"/></g><defs><linearGradient id="SVGlFhzzeNl" x1="16.752" x2="4.804" y1="5.714" y2="14.958" gradientUnits="userSpaceOnUse"><stop class="dvxpjwubi"/><stop offset="1" class="lizce5bec"/></linearGradient><clipPath id="SVGHcSWxdhd"><path class="py7ktqbvf"/></clipPath></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:dsrun-background" /></template>
<style>
.dvxpjwubi {
...
.g4mw-knmr {
  fill: var(--svg-color--fff, #fff);
  d: path("M11.765 8.74c.052-.01 1.346-.283 1.412.908c-.358 0-1.054-.254-1.412-.908");
}
