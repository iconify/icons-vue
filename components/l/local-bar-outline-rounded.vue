...
const content = `<path class="kfvfjgf1n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-bar-outline-rounded" /></template>
<style>
.kfvfjgf1n {
  fill: currentColor;
