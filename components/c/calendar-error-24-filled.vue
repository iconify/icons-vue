...
const content = `<path class="wc9lydbuk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-error-24-filled" /></template>
<style>
.wc9lydbuk {
  fill: currentColor;
