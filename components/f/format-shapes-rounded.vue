...
const content = `<path class="krywzubpe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-shapes-rounded" /></template>
<style>
.krywzubpe {
  fill: currentColor;
