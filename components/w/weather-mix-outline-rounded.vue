...
const content = `<path class="sdjcu2b0s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:weather-mix-outline-rounded" /></template>
<style>
.sdjcu2b0s {
  fill: currentColor;
