...
const content = `<g class="gp_8x1bzb"><path class="ctkwnzbjp"/><path class="nmilknoym"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:smartphone-zap-sharp-two-tone" /></template>
<style>
.ctkwnzbjp {
  fill: currentColor;
