...
const content = `<path class="yi5llrb_n"/><path class="aibtjkgta"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-signal-wifi-1-bar" /></template>
<style>
.aibtjkgta {
  fill: currentColor;
