...
const content = `<path class="z118jib_a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:android-wifi-4-bar-plus-outline" /></template>
<style>
.z118jib_a {
  fill: currentColor;
