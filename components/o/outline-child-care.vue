...
const content = `<circle class="vhr2lj4be"/><circle class="ifds6hbbc"/><path class="p4j2j1bit"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-child-care" /></template>
<style>
.ifds6hbbc {
  cx: 9.5px;
  cy: 10.5px;
