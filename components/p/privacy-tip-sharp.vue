...
const content = `<path class="dkj8nsllf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:privacy-tip-sharp" /></template>
<style>
.dkj8nsllf {
  fill: currentColor;
