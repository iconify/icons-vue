...
const content = `<path class="m2s00nkrd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:boat-bus" /></template>
<style>
.m2s00nkrd {
  fill: currentColor;
