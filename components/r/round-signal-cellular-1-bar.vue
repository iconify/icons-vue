...
const content = `<path class="ld-sdrbtn"/><path class="m80dp4bzj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-signal-cellular-1-bar" /></template>
<style>
.ld-sdrbtn {
  fill: currentColor;
