...
const content = `<path class="xo2rdfbvz"/><path class="sfwnjxuyf"/><path class="eh_730_nn"/><path class="couvmlqyt"/><path class="sop83wb4f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ovine-icons" /></template>
<style>
.couvmlqyt {
  fill: none;
  stroke: currentColor;
...
.eh_730_nn {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M10.27 17.112a2.4 2.4 0 0 0 1.623-.58a5.4 5.4 0 0 0 1.319-1.565a3.82 3.82 0 0 0 2.572 1.962c2.237.399 3.8-1.684 3.8-1.684a2.32 2.32 0 0 0 1.013 2.174a3.4 3.4 0 0 0 2.758.581a13 13 0 0 0-2.419 3.494c-.58 1.593-.888 4.29-2.39 5.609c-2.122 1.86-8.518 1.593-8.978-2.818c-.196-1.874.796-1.9.92-4.41a8.6 8.6 0 0 0-.218-2.763");
}
...
.sop83wb4f {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M15.685 25.845c-.594.299-1.782.685-2.308-1.044m-4.89-6.586c-.125-2.138-2.382-1.952-2.382-2.74c0-1.36 3.183-1.829 3.652-2.596");
}
