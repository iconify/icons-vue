...
const content = `<path class="nrvpi9bmf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:circle-sparkle-32-regular" /></template>
<style>
.nrvpi9bmf {
  fill: currentColor;
