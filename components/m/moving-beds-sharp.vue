...
const content = `<path class="mgkdopnzu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:moving-beds-sharp" /></template>
<style>
.mgkdopnzu {
  fill: currentColor;
