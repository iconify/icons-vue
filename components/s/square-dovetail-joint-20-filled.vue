...
const content = `<path class="nxbmpnbuw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-dovetail-joint-20-filled" /></template>
<style>
.nxbmpnbuw {
  fill: currentColor;
