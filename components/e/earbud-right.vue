...
const content = `<path class="eepkxdbyk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:earbud-right" /></template>
<style>
.eepkxdbyk {
  fill: currentColor;
