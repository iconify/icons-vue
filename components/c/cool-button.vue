...
const content = `<path class="a5np3_q7m"/><path class="idub11m5l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:cool-button" /></template>
<style>
.a5np3_q7m {
