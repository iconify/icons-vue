...
const content = `<path class="m-morr-6r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shopping-bag-checkmark-48-filled" /></template>
<style>
.m-morr-6r {
  fill: currentColor;
