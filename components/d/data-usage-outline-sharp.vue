...
const content = `<path class="l48hrlf8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:data-usage-outline-sharp" /></template>
<style>
.l48hrlf8v {
  fill: currentColor;
