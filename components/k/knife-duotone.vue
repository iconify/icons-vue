...
const content = `<g class="cuyn6tgcc"><path class="pt2vlxh7p"/><path class="h1f70ey_u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:knife-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.pt2vlxh7p {
  d: path("M226.2 65.8L174 118l-28-28l52.2-52.2a19.8 19.8 0 0 1 28 0a19.8 19.8 0 0 1 0 28");
