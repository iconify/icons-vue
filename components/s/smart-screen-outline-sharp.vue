...
const content = `<path class="p4ubc-e4h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:smart-screen-outline-sharp" /></template>
<style>
.p4ubc-e4h {
  fill: currentColor;
