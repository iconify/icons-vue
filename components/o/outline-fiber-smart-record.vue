...
const content = `<path class="cl8splbyr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-fiber-smart-record" /></template>
<style>
.cl8splbyr {
  fill: currentColor;
