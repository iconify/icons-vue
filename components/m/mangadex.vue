...
const content = `<path class="kk_hh8bpt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mangadex" /></template>
<style>
.kk_hh8bpt {
  fill: none;
  stroke: currentColor;
