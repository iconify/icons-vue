...
const content = `<path class="l674zvrwy"/><g class="y9tr6bcfx"><rect class="w5ztvbg7m"/><path class="w9v12qzbx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-simple-28" /></template>
<style>
.l674zvrwy {
  fill: none;
  stroke: currentColor;
