...
const content = `<path class="tdv6pc05m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:blinds-2-sharp" /></template>
<style>
.tdv6pc05m {
  fill: currentColor;
