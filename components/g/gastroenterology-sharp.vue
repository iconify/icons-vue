...
const content = `<path class="v_r2dhugr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:gastroenterology-sharp" /></template>
<style>
.v_r2dhugr {
  fill: currentColor;
