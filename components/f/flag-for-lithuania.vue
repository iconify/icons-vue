...
const content = `<path class="of7im4bah"/><path class="ykuiilbgy"/><path class="b4m-lgb2c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-lithuania" /></template>
<style>
.b4m-lgb2c {
