...
const content = `<path class="kln8b9cil"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-border-24-regular" /></template>
<style>
.kln8b9cil {
  fill: currentColor;
