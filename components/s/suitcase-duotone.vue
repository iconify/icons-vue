...
const content = `<g class="cuyn6tgcc"><path class="o5ybe-6nz"/><path class="kee94kbla"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:suitcase-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
