...
const content = `<path class="k9mf47bly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:play-circle-hint-24-filled" /></template>
<style>
.k9mf47bly {
  fill: currentColor;
