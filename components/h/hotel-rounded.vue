...
const content = `<path class="tco_vwbgx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hotel-rounded" /></template>
<style>
.tco_vwbgx {
  fill: currentColor;
