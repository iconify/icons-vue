...
const content = `<path class="s-ckuac7v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fluid-sharp" /></template>
<style>
.s-ckuac7v {
  fill: currentColor;
