...
const content = `<path class="b46nnkfrk"/><circle class="ovf7eoehk"/><circle class="enfz85iyf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-face-2" /></template>
<style>
.b46nnkfrk {
  fill: currentColor;
