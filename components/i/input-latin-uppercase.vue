...
const content = `<circle class="bgatx5byk"/><path class="zejbg_dly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:input-latin-uppercase" /></template>
<style>
.bgatx5byk {
  cx: 32px;
  cy: 32px;
