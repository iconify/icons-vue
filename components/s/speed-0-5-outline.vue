...
const content = `<path class="vh7xp39bg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speed-0-5-outline" /></template>
<style>
.vh7xp39bg {
  fill: currentColor;
