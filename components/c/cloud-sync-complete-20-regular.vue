...
const content = `<path class="mym7g3emt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-sync-complete-20-regular" /></template>
<style>
.mym7g3emt {
  fill: currentColor;
