...
const content = `<path class="e6hyb_b7m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:drag-indicator-outline-rounded" /></template>
<style>
.e6hyb_b7m {
  fill: currentColor;
