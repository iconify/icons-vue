...
const content = `<path class="w18e8_lkh"/><path class="szjx7golk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:shadow-fight-4" /></template>
<style>
.szjx7golk {
  fill: none;
  stroke: currentColor;
