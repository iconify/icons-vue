...
const content = `<path class="s2s-m8b2f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-capslock-badge-rounded" /></template>
<style>
.s2s-m8b2f {
  fill: currentColor;
