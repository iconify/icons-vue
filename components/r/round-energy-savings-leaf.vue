...
const content = `<path class="atakeybab"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-energy-savings-leaf" /></template>
<style>
.atakeybab {
  fill: currentColor;
