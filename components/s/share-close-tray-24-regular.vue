...
const content = `<path class="fipn2jbbr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-close-tray-24-regular" /></template>
<style>
.fipn2jbbr {
  fill: currentColor;
