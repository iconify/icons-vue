...
const content = `<path class="n5lvpupcf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:receipt-money-20-filled" /></template>
<style>
.n5lvpupcf {
  fill: currentColor;
