...
const content = `<path class="ic5yffbdu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:position-bottom-right-outline-rounded" /></template>
<style>
.ic5yffbdu {
  fill: currentColor;
