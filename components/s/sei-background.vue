...
const content = `<g class="ft5dv1b6b"><g clip-path="url(#SVGHcSWxdhd)"><path fill="url(#SVGnUlMmeJU)" class="r4i437pya"/><path class="upkkqhbsk"/></g><defs><linearGradient id="SVGnUlMmeJU" x1="11.976" x2="11.976" y1="4.006" y2="19.997" gradientUnits="userSpaceOnUse"><stop class="lgocgacfm"/><stop offset="1" class="r5bkdbcna"/></linearGradient><clipPath id="SVGHcSWxdhd"><path class="py7ktqbvf"/></clipPath></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:sei-background" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
