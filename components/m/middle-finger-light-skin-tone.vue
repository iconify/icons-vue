...
const content = `<path class="vn3u_-bcj"/><path class="ce8ernb0s"/><path class="j1bfy2b_w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:middle-finger-light-skin-tone" /></template>
<style>
.ce8ernb0s {
