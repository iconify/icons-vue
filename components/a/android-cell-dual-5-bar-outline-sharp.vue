...
const content = `<path class="j5kpt0bgp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:android-cell-dual-5-bar-outline-sharp" /></template>
<style>
.j5kpt0bgp {
  fill: currentColor;
