...
const content = `<path class="wjqriebbz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-sparkle-24-regular" /></template>
<style>
.wjqriebbz {
  fill: currentColor;
