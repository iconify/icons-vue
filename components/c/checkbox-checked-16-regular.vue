...
const content = `<path class="bok9_-bwi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:checkbox-checked-16-regular" /></template>
<style>
.bok9_-bwi {
  fill: currentColor;
