...
const content = `<g class="cuyn6tgcc"><path class="zrwf22r6h"/><path class="wufx7bbxh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:flag-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
