...
const content = `<path class="gafsh3g3q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:switches-sharp" /></template>
<style>
.gafsh3g3q {
  fill: currentColor;
