...
const content = `<path class="t5m5vtboa"/><path class="zj9dzebst"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-format-shapes" /></template>
<style>
.t5m5vtboa {
  fill: currentColor;
