...
const content = `<path class="cju96hboz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shopping-bag-percent-20-filled" /></template>
<style>
.cju96hboz {
  fill: currentColor;
