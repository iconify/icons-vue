...
const content = `<path class="duh5pmf7q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:app-folder-32-light" /></template>
<style>
.duh5pmf7q {
  fill: currentColor;
