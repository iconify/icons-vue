...
const content = `<path class="f35wmcumz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-settings-overscan" /></template>
<style>
.f35wmcumz {
  fill: currentColor;
