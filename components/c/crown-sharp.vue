...
const content = `<path class="bivy8sbam"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:crown-sharp" /></template>
<style>
.bivy8sbam {
  fill: currentColor;
