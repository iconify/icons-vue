...
const content = `<path class="k09ycfbjs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:eye-tracking-off-20-regular" /></template>
<style>
.k09ycfbjs {
  fill: currentColor;
