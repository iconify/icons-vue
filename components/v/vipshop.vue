...
const content = `<path class="r_r_9vjbc"/><path class="g2wj9jbhp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:vipshop" /></template>
<style>
.g2wj9jbhp {
  fill: none;
  stroke: currentColor;
