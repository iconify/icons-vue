...
const content = `<path class="tppogachj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-rounded" /></template>
<style>
.tppogachj {
  fill: currentColor;
