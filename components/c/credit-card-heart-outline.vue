...
const content = `<path class="hp50bybbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:credit-card-heart-outline" /></template>
<style>
.hp50bybbq {
  fill: currentColor;
