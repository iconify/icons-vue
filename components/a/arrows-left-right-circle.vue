...
const content = `<path class="f1x3xac2u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrows-left-right-circle" /></template>
<style>
.f1x3xac2u {
  fill: currentColor;
