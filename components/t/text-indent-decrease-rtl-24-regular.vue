...
const content = `<path class="nyqqyg3-x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-decrease-rtl-24-regular" /></template>
<style>
.nyqqyg3-x {
  fill: currentColor;
