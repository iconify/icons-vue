...
const content = `<path class="qxy67marg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:file-png-outline-rounded" /></template>
<style>
.qxy67marg {
  fill: currentColor;
