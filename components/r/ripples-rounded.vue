...
const content = `<path class="iyra6dtwy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ripples-rounded" /></template>
<style>
.iyra6dtwy {
  fill: currentColor;
