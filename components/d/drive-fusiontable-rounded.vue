...
const content = `<path class="oeah8vxhu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:drive-fusiontable-rounded" /></template>
<style>
.oeah8vxhu {
  fill: currentColor;
