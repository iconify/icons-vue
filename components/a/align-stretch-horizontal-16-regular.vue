...
const content = `<path class="ymt03k1zi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-stretch-horizontal-16-regular" /></template>
<style>
.ymt03k1zi {
  fill: currentColor;
