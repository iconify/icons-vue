...
const content = `<path class="w1m2z0bcm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:featured-video-rounded" /></template>
<style>
.w1m2z0bcm {
  fill: currentColor;
