...
const content = `<path class="hv9nvqdst"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-autofit-width-20-regular" /></template>
<style>
.hv9nvqdst {
  fill: currentColor;
