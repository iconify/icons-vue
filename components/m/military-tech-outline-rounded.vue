...
const content = `<path class="o4hpd_6gg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:military-tech-outline-rounded" /></template>
<style>
.o4hpd_6gg {
  fill: currentColor;
