...
const content = `<path class="jglan8bjx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bottom-app-bar" /></template>
<style>
.jglan8bjx {
  fill: currentColor;
