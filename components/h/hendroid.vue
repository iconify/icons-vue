...
.rop2cbcsa {
  ...
  stroke: currentColor;
  stroke-miterlimit: 10;
  d: path("M40.07 37.87s2.37 1.37 1.14 3.15c-1.11 1.6-3.58 1.33-5.26 1.48c0-1.69-.6-4.11.86-5.39c1.63-1.44 3.26.76 3.26.76");
}
