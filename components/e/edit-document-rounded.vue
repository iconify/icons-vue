...
const content = `<path class="t7qfv7o6l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-document-rounded" /></template>
<style>
.t7qfv7o6l {
  fill: currentColor;
