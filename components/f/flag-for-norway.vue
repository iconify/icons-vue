...
const content = `<path class="ik8-3_bxu"/><path class="x_e4y3b_i"/><path class="v75_3fwkw"/><path class="ux6-9wcsq"/><path class="ry653vb_n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-norway" /></template>
<style>
.ik8-3_bxu {
