...
const content = `<path class="rb0f1sbol"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-3-28-regular" /></template>
<style>
.rb0f1sbol {
  fill: currentColor;
