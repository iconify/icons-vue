...
const content = `<g class="gp_8x1bzb"><path class="b1u0brb_w"/><path class="duuhr1boc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:git-x-sharp-fill" /></template>
<style>
.b1u0brb_w {
