...
const content = `<path class="yec8bl3ry"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:android-cell-4-bar-alert-outline-sharp" /></template>
<style>
.yec8bl3ry {
  fill: currentColor;
