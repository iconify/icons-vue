...
const content = `<path class="fddt2ibnu"/><circle class="zgp3pkd1y"/><path class="tlktkhbwi"/><path class="nt2-2yfmb"/><path class="wxadi7kjp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:baby-angel-dark-skin-tone" /></template>
<style>
.fddt2ibnu {
