...
const content = `<path class="hb4hm1bhu"/><path class="av48-ymix"/><path class="ffmgmkbsf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-germany" /></template>
<style>
.av48-ymix {
