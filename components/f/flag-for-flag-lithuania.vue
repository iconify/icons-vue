...
const content = `<path class="do6g26bwg"/><path class="r3m9_5yhm"/><path class="sqy512b9q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-lithuania" /></template>
<style>
.do6g26bwg {
