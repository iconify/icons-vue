...
const content = `<linearGradient id="svgIDa" x1="64.02" x2="64.02" y1="101.119" y2="24.549" gradientUnits="userSpaceOnUse"><stop offset=".485" class="j1rdzyw_l"/><stop offset="1" class="vlzxxcccm"/></linearGradient><path fill="url(#svgIDa)" class="rhx81hzgm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:6" /></template>
<style>
.j1rdzyw_l {
