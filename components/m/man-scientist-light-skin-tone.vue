...
import '../../css/v/vdqar79xb.css';
import '../../css/q/q7d631bhb.css';
...
const content = `<path class="gdlfpmbqd"/><path class="q17hd3mza"/><path class="eyub79bmo"/><path class="vi0y5wx0b"/><path class="mnrtnzzfc"/><path class="akyq6ub0d"/><path class="vdqar79xb"/><path class="q7d631bhb"/><path class="ipat6j_-y"/><path class="j5iu12bmv"/><path class="ih_7k570e"/><path class="pffessbdu"/><path class="k5qiaqe3j"/><path class="asc9_wbpg"/><path class="ajhk-43sa"/><path class="tvsk1vk5y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="openmoji:man-scientist-light-skin-tone" /></template>
