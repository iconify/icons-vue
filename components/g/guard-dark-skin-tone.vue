...
const content = `<path class="r6wn9xbvs"/><path class="e8gedzito"/><g class="n1mjunbsu"><circle class="ed6fmyb9l"/><circle class="fqau1xbcn"/></g><path class="r4zoxmb0o"/><circle class="we5z3e49t"/><circle class="lupbmxb8l"/><circle class="u6l8n6jdv"/><circle class="lhh4opbwr"/><path class="d_lvc1h7j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:guard-dark-skin-tone" /></template>
<style>
.d_lvc1h7j {
