...
const content = `<path class="c021n0bnf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:video-library-rounded" /></template>
<style>
.c021n0bnf {
  fill: currentColor;
