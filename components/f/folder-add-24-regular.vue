...
const content = `<path class="m_6mgnbuy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-add-24-regular" /></template>
<style>
.m_6mgnbuy {
  fill: currentColor;
