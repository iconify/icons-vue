...
const content = `<path class="lj53j3ncf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:folder-match" /></template>
<style>
.lj53j3ncf {
  fill: currentColor;
