...
const content = `<path class="duib9_nvm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bug-report-outline-rounded" /></template>
<style>
.duib9_nvm {
  fill: currentColor;
