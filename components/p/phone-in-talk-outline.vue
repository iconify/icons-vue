...
const content = `<path class="t5sgdotgi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phone-in-talk-outline" /></template>
<style>
.t5sgdotgi {
  fill: currentColor;
