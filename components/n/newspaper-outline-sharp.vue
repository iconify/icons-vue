...
const content = `<path class="saljnbj7k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:newspaper-outline-sharp" /></template>
<style>
.saljnbj7k {
  fill: currentColor;
