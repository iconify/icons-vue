...
const content = `<path class="ce0lspbkk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:transmission-24-filled" /></template>
<style>
.ce0lspbkk {
  fill: currentColor;
