...
const content = `<path class="san7iyz2g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:moving-outline" /></template>
<style>
.san7iyz2g {
  fill: currentColor;
