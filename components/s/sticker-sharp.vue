...
const content = `<path class="oa25doa0c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sticker-sharp" /></template>
<style>
.oa25doa0c {
  fill: currentColor;
