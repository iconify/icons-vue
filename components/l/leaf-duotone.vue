...
const content = `<g class="cuyn6tgcc"><path class="l-v2ffbxe"/><path class="qtd48kb2u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:leaf-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
