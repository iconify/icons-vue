...
const content = `<path class="g_mxupb-a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:g-mobiledata-rounded" /></template>
<style>
.g_mxupb-a {
  fill: currentColor;
