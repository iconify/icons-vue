...
const content = `<path class="o5za53sbx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:payment-arrow-down-outline" /></template>
<style>
.o5za53sbx {
  fill: currentColor;
