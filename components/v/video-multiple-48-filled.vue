...
const content = `<path class="uj86bdbdj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-multiple-48-filled" /></template>
<style>
.uj86bdbdj {
  fill: currentColor;
