...
const content = `<path class="lsgm17-3n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:microwave-gen-outline-sharp" /></template>
<style>
.lsgm17-3n {
  fill: currentColor;
