...
const content = `<path class="d4if0kbuq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mark-chat-unread-sharp" /></template>
<style>
.d4if0kbuq {
  fill: currentColor;
