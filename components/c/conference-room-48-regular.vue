...
const content = `<path class="eqm0wxbga"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:conference-room-48-regular" /></template>
<style>
.eqm0wxbga {
  fill: currentColor;
