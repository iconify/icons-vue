...
const content = `<g class="ft5dv1b6b"><path class="ou1af-bzn"/><path class="gdg8frb8m"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:sn" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
