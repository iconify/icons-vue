...
const content = `<path class="gy6v9ubje"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-sync-circle-20-regular" /></template>
<style>
.gy6v9ubje {
  fill: currentColor;
