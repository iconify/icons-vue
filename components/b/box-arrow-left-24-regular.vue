...
const content = `<path class="v5kmh99xm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:box-arrow-left-24-regular" /></template>
<style>
.v5kmh99xm {
  fill: currentColor;
