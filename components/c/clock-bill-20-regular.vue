...
const content = `<path class="ldubf7ryw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clock-bill-20-regular" /></template>
<style>
.ldubf7ryw {
  fill: currentColor;
