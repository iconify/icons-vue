...
const content = `<path class="qezkeklxh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:last-page-outline-rounded" /></template>
<style>
.qezkeklxh {
  fill: currentColor;
