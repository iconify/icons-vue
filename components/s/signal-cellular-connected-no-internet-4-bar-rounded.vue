...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-cellular-connected-no-internet-4-bar-rounded" /></template>
<style>
.tfh8n5bom {
  fill: currentColor;
