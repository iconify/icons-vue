...
const content = `<g class="gp_8x1bzb"><path class="uk-eumb3f"/><path class="hplz24bws"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-indian-rupee-sharp" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
