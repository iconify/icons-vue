...
const content = `<path class="e0h789bif"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-usage-48-regular" /></template>
<style>
.e0h789bif {
  fill: currentColor;
