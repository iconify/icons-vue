...
const content = `<path class="va0e5yzee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dine-lamp-outline-sharp" /></template>
<style>
.va0e5yzee {
  fill: currentColor;
