...
const content = `<path class="gawn2ylaf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-sunny-16-regular" /></template>
<style>
.gawn2ylaf {
  fill: currentColor;
