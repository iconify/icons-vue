...
const content = `<path class="ww0b3ybfh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flowchart-circle-24-filled" /></template>
<style>
.ww0b3ybfh {
  fill: currentColor;
