...
const content = `<path class="b49ouqbod"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bookmark-20-regular" /></template>
<style>
.b49ouqbod {
  fill: currentColor;
