...
const content = `<path class="ar-ykgbij"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phone-in-talk-outline" /></template>
<style>
.ar-ykgbij {
  fill: currentColor;
