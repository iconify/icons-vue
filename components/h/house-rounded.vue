...
const content = `<path class="qow_tm5gw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:house-rounded" /></template>
<style>
.qow_tm5gw {
  fill: currentColor;
