...
const content = `<path class="f9octmpjq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:laptop-briefcase-20-regular" /></template>
<style>
.f9octmpjq {
  fill: currentColor;
