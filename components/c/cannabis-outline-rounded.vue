...
const content = `<path class="iho0mcc8r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cannabis-outline-rounded" /></template>
<style>
.iho0mcc8r {
  fill: currentColor;
