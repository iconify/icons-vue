...
const content = `<g class="ft5dv1b6b"><path class="mumfproca"/><path class="fx5qf2bio"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:spc-background" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
