...
const content = `<circle class="cpk0fnbgt"/><path class="c11gmxb1c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:3dlut-mobile" /></template>
<style>
.c11gmxb1c {
  fill: none;
  stroke: currentColor;
