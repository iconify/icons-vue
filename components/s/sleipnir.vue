...
const content = `<path class="vhmezcb4z"/><path class="abd-ldljf"/><path class="a8o24va_c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sleipnir" /></template>
<style>
.a8o24va_c {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M19.298 9.193c-1.298-.592-3.1-2.49-2.58-4.693a20.4 20.4 0 0 0 5.463 3.474");
}
