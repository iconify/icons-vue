...
const content = `<path class="zyq9arpqu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fitdays" /></template>
<style>
.zyq9arpqu {
  fill: none;
  stroke: currentColor;
