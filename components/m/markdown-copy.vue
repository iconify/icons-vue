...
const content = `<path class="dfsdr6-sj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:markdown-copy" /></template>
<style>
.dfsdr6-sj {
  fill: currentColor;
