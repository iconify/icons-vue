...
const content = `<path class="ociu8fb4l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shifts-day-24-filled" /></template>
<style>
.ociu8fb4l {
  fill: currentColor;
