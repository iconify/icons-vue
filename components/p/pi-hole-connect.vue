...
const content = `<path class="m98mcmb5g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pi-hole-connect" /></template>
<style>
.m98mcmb5g {
  fill: none;
  stroke: currentColor;
