...
const content = `<path class="vkdcb9new"/><path class="cxk2io8ag"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:hand-with-index-finger-and-thumb-crossed-medium-light-skin-tone" /></template>
<style>
.cxk2io8ag {
