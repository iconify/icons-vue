...
const content = `<path class="hqy8j9c4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-subtract-32-regular" /></template>
<style>
.hqy8j9c4n {
  fill: currentColor;
