...
const content = `<path class="e-4m7vbwp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-transfer-24-filled" /></template>
<style>
.e-4m7vbwp {
  fill: currentColor;
