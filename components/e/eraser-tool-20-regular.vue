...
const content = `<path class="wi4bzf25e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:eraser-tool-20-regular" /></template>
<style>
.wi4bzf25e {
  fill: currentColor;
