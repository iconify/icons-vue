...
const content = `<path class="x-yvbn9xt"/><path class="q_qtvtbhj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-timelapse" /></template>
<style>
.q_qtvtbhj {
  fill: currentColor;
