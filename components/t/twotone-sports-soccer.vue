...
const content = `<path class="l2y0x3zfp"/><path class="cm9b8mb1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-sports-soccer" /></template>
<style>
.cm9b8mb1j {
  fill: currentColor;
