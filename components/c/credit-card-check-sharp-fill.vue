...
const content = `<g class="gp_8x1bzb"><path class="bow7yubgw"/><path class="s3j__thdr"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:credit-card-check-sharp-fill" /></template>
<style>
.bow7yubgw {
  fill: currentColor;
