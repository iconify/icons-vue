...
const content = `<path class="dbt8jib9y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:accessible-menu-outline-rounded" /></template>
<style>
.dbt8jib9y {
  fill: currentColor;
