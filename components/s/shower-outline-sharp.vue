...
const content = `<path class="sbatzebuz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shower-outline-sharp" /></template>
<style>
.sbatzebuz {
  fill: currentColor;
