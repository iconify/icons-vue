...
const content = `<path class="qu7o--b0r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-photo-size-select-small" /></template>
<style>
.qu7o--b0r {
  fill: currentColor;
