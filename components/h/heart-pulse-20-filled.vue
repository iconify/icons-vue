...
const content = `<path class="ceydwmrme"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:heart-pulse-20-filled" /></template>
<style>
.ceydwmrme {
  fill: currentColor;
