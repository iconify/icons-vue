...
const content = `<path class="x0lishbra"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:rating-mature-24-regular" /></template>
<style>
.x0lishbra {
  fill: currentColor;
