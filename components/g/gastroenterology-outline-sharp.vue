...
const content = `<path class="hxl-s4sac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gastroenterology-outline-sharp" /></template>
<style>
.hxl-s4sac {
  fill: currentColor;
