...
const content = `<path class="xntt3s1zv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brightness-empty-rounded" /></template>
<style>
.xntt3s1zv {
  fill: currentColor;
