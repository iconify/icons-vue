...
const content = `<path class="d2r3264na"/><path class="mqs-173kb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:jd-com" /></template>
<style>
.d2r3264na {
  fill: none;
  stroke: currentColor;
