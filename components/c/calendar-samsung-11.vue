...
const content = `<path class="phdaqbp7k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-samsung-11" /></template>
<style>
.phdaqbp7k {
  fill: none;
  stroke: currentColor;
