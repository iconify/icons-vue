...
const content = `<path class="kbi4e525j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ripples-outline" /></template>
<style>
.kbi4e525j {
  fill: currentColor;
