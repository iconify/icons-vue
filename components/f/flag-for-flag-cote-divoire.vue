...
const content = `<path class="at11-3bve"/><path class="umjzfdcqs"/><path class="fi78vq6nn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-cote-divoire" /></template>
<style>
.at11-3bve {
