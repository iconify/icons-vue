...
const content = `<path class="hmhg9bc7t"/><path class="vd-nu0b9k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-swipe-left" /></template>
<style>
.hmhg9bc7t {
  fill: currentColor;
