...
const content = `<path class="q8yfombjt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mic-off-rounded" /></template>
<style>
.q8yfombjt {
  fill: currentColor;
