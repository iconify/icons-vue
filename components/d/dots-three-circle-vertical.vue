...
const content = `<path class="puvlhmn5t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:dots-three-circle-vertical" /></template>
<style>
.puvlhmn5t {
  fill: currentColor;
