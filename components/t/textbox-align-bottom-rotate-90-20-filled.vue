...
const content = `<path class="cac4_3bpp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-bottom-rotate-90-20-filled" /></template>
<style>
.cac4_3bpp {
  fill: currentColor;
