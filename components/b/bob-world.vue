...
const content = `<path class="l-0wj21qz"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bob-world" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
