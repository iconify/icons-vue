...
const content = `<path class="d6ca26f4x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:warehouse-outline" /></template>
<style>
.d6ca26f4x {
  fill: currentColor;
