...
const content = `<path class="wcc7yob8h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:file-download-off" /></template>
<style>
.wcc7yob8h {
  fill: currentColor;
