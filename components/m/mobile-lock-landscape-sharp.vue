...
const content = `<path class="b7rpjbbtc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobile-lock-landscape-sharp" /></template>
<style>
.b7rpjbbtc {
  fill: currentColor;
