...
const content = `<path class="pyucvry-s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-hexagon-48-filled" /></template>
<style>
.pyucvry-s {
  fill: currentColor;
