...
const content = `<path class="d06qv65br"/><path class="ph-t8r_vp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-auto-delete" /></template>
<style>
.d06qv65br {
  fill: currentColor;
