...
const content = `<path class="ac81wtb-o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:document-search-outline-rounded" /></template>
<style>
.ac81wtb-o {
  fill: currentColor;
