...
const content = `<path class="g-0z11-gu"/><defs><path id="SVGWj2HCcSM" class="k0zim5bgm"/></defs><clipPath id="SVGhSdoVdxD"><use href="#SVGWj2HCcSM"/></clipPath><path clip-path="url(#SVGhSdoVdxD)" class="rxv_c-p2q"/><defs><use href="#SVGWj2HCcSM" id="SVGt5NmHeUS"/></defs><clipPath id="SVGKUt7mcPv"><use href="#SVGt5NmHeUS"/></clipPath><path clip-path="url(#SVGKUt7mcPv)" class="mc7ybyi1s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:index-pointing-up-dark-skin-tone" /></template>
<style>
.g-0z11-gu {
