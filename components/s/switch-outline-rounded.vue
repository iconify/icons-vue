...
const content = `<path class="vphdpebod"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:switch-outline-rounded" /></template>
<style>
.vphdpebod {
  fill: currentColor;
