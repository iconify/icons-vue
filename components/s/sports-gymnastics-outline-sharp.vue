...
const content = `<path class="b1glrbcvc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sports-gymnastics-outline-sharp" /></template>
<style>
.b1glrbcvc {
  fill: currentColor;
