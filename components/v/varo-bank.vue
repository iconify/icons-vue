...
const content = `<path class="ydqthzbbt"/><path class="tbo-6k-1s"/><rect class="qq13lqbbx"/><path class="jsrfueifk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:varo-bank" /></template>
<style>
.jsrfueifk {
  fill: none;
  stroke: currentColor;
