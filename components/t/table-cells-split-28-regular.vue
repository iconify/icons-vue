...
const content = `<path class="p4z0qab3n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cells-split-28-regular" /></template>
<style>
.p4z0qab3n {
  fill: currentColor;
