...
const content = `<path class="mhdb24x-v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bottom-sheets-rounded" /></template>
<style>
.mhdb24x-v {
  fill: currentColor;
