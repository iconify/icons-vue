...
const content = `<path class="n716_0k6y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:folder-data-outline" /></template>
<style>
.n716_0k6y {
  fill: currentColor;
