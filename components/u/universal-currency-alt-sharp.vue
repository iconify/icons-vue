...
const content = `<path class="osajfobgi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:universal-currency-alt-sharp" /></template>
<style>
.osajfobgi {
  fill: currentColor;
