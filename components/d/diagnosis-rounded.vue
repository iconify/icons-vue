...
const content = `<path class="urt9nebna"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:diagnosis-rounded" /></template>
<style>
.urt9nebna {
  fill: currentColor;
