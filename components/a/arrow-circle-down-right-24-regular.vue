...
const content = `<path class="tmsy1f_iy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-circle-down-right-24-regular" /></template>
<style>
.tmsy1f_iy {
  fill: currentColor;
