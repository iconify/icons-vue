...
const content = `<path class="iy8gbccnp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:museum-outline-sharp" /></template>
<style>
.iy8gbccnp {
  fill: currentColor;
