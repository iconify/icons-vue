...
const content = `<path class="b388rpbyu"/><path class="p332zjblu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-video-settings" /></template>
<style>
.b388rpbyu {
  fill: currentColor;
  d: path("M3 6h18v5h2V6c0-1.1-.9-2-2-2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h9v-2H3z");
}
