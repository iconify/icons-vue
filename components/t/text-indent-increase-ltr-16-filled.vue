...
const content = `<path class="sq37jvb1z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-increase-ltr-16-filled" /></template>
<style>
.sq37jvb1z {
  fill: currentColor;
