...
const content = `<path class="b02wnqusc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-search-16-filled" /></template>
<style>
.b02wnqusc {
  fill: currentColor;
