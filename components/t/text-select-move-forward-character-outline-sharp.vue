...
const content = `<path class="d1dcf-bga"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-select-move-forward-character-outline-sharp" /></template>
<style>
.d1dcf-bga {
  fill: currentColor;
