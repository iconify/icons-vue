...
const content = `<path class="i9clfwm2k"/><path class="cnqwls59c"/><path class="w2zjtonmz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:banking" /></template>
<style>
.cnqwls59c {
  fill: none;
  stroke: currentColor;
...
.w2zjtonmz {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M37.458 20.305h-2.791L31.581 24l3.086 3.696h2.79L40.547 24z");
}
