...
const content = `<path class="qum7yib-c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:grid-dots-24-filled" /></template>
<style>
.qum7yib-c {
  fill: currentColor;
