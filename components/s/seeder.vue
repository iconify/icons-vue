...
const content = `<circle class="k4o_yjbkq"/><circle class="cpk0fnbgt"/><path class="n56aerbfp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:seeder" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
