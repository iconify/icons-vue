...
const content = `<path class="le_wqjn1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-progress-three-quarter-sharp-fill" /></template>
<style>
.le_wqjn1j {
  fill: none;
  stroke: currentColor;
