...
const content = `<path class="er7d7pbgl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stat-3-outline-rounded" /></template>
<style>
.er7d7pbgl {
  fill: currentColor;
