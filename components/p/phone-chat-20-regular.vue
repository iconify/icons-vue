...
const content = `<path class="bug8-ib0t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-chat-20-regular" /></template>
<style>
.bug8-ib0t {
  fill: currentColor;
