...
const content = `<path class="ft7j1-b7t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:unpaved-road-outline-sharp" /></template>
<style>
.ft7j1-b7t {
  fill: currentColor;
