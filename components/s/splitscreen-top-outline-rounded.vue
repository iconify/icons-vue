...
const content = `<path class="myxdonbcg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:splitscreen-top-outline-rounded" /></template>
<style>
.myxdonbcg {
  fill: currentColor;
