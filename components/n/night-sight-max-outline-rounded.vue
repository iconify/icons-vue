...
const content = `<path class="i_s7dfbdc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:night-sight-max-outline-rounded" /></template>
<style>
.i_s7dfbdc {
  fill: currentColor;
