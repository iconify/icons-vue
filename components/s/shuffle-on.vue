...
const content = `<path class="bl8chacww"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shuffle-on" /></template>
<style>
.bl8chacww {
  fill: currentColor;
