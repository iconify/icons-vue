...
const content = `<path class="t0hmtsbfa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:switch-access-shortcut-outline" /></template>
<style>
.t0hmtsbfa {
  fill: currentColor;
