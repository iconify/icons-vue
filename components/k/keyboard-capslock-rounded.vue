...
const content = `<path class="jdbwwgwit"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-capslock-rounded" /></template>
<style>
.jdbwwgwit {
  fill: currentColor;
