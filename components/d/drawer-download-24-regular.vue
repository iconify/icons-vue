...
const content = `<g class="ft5dv1b6b"><path class="r46np3bsj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drawer-download-24-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
