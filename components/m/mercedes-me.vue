...
const content = `<circle class="cpk0fnbgt"/><path class="i1pf-qb8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mercedes-me" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
