...
const content = `<path class="bnnep8kgk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:hanami-dango-outline-rounded" /></template>
<style>
.bnnep8kgk {
  fill: currentColor;
