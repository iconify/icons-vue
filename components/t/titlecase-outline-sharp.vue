...
const content = `<path class="mkljx6mtz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:titlecase-outline-sharp" /></template>
<style>
.mkljx6mtz {
  fill: currentColor;
