...
const content = `<path class="irvxxtnha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fork-right-outline-sharp" /></template>
<style>
.irvxxtnha {
  fill: currentColor;
