...
const content = `<path class="h1iiv63dh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:quizlet" /></template>
<style>
.h1iiv63dh {
  fill: none;
  stroke: currentColor;
