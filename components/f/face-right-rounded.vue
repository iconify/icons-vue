...
const content = `<path class="xnn1vssbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-right-rounded" /></template>
<style>
.xnn1vssbq {
  fill: currentColor;
