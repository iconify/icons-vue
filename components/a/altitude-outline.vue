...
const content = `<path class="r2iu7lbqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:altitude-outline" /></template>
<style>
.r2iu7lbqq {
  fill: currentColor;
