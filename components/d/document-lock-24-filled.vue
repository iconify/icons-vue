...
const content = `<path class="u0a01vbwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-lock-24-filled" /></template>
<style>
.u0a01vbwk {
  fill: currentColor;
