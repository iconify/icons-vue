...
const viewBox = {"width":512,"height":254};
const content = `<defs><linearGradient id="SVGG66mF8Jd" x1="50%" x2="50%" y1="0%" y2="100.002%"><stop offset="0%" class="d0zyr-6ew"/><stop offset="21.2%" class="qyltynb6a"/><stop offset="51.9%" class="mmft9abgk"/><stop offset="79.2%" class="d0jhq6s2a"/><stop offset="100%" class="z_vfqibmu"/></linearGradient></defs><path fill="url(#SVGG66mF8Jd)" class="f2_jfvb_m"/><path class="b63q2nbgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:sap" /></template>
<style>
.b63q2nbgh {
...
.d0jhq6s2a {
  stop-color: var(--svg-color--006cb8, #006cb8);
}
...
.f2_jfvb_m {
  d: path("M0 253.281h258.764L512 0H0z");
}

.mmft9abgk {
  stop-color: var(--svg-color--007cc5, #007cc5);
}

.qyltynb6a {
  stop-color: var(--svg-color--0097dc, #0097dc);
}

.z_vfqibmu {
  stop-color: var(--svg-color--0066b3, #0066b3);
}
