...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:hand-closed-duotone" /></template>
<style>
.bts1g6b3q {
  d: path("M9.8959 6.4988L9.8959 7.4634M13.3303 6.6762L13.3303 7.4634M16.7648 7.4633L16.7648 8.0931M6.937 10.297L7.0858 11.8712");
}
