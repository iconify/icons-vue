...
const content = `<circle class="cpk0fnbgt"/><path class="yq5wxkb5w"/><circle class="rksbom0mx"/><path class="bu7x0vb2e"/><rect class="ckyboq04o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:6180-the-moon" /></template>
<style>
.bu7x0vb2e {
  fill: none;
  stroke: currentColor;
