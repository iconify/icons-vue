...
const content = `<path class="i-0whkbau"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:person-simple-walk-bold" /></template>
<style>
.i-0whkbau {
  fill: currentColor;
