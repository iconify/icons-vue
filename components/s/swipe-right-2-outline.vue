...
const content = `<path class="zyp717b6d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-right-2-outline" /></template>
<style>
.zyp717b6d {
  fill: currentColor;
