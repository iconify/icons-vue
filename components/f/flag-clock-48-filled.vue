...
const content = `<path class="czsb77bte"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flag-clock-48-filled" /></template>
<style>
.czsb77bte {
  fill: currentColor;
