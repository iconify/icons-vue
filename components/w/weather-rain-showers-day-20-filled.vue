...
const content = `<path class="w7l85nbhv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-rain-showers-day-20-filled" /></template>
<style>
.w7l85nbhv {
  fill: currentColor;
