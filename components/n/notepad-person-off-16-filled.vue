...
const content = `<path class="molmv7bkl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notepad-person-off-16-filled" /></template>
<style>
.molmv7bkl {
  fill: currentColor;
