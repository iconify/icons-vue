...
const content = `<path class="qejs3ub6k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-space-around-outline-rounded" /></template>
<style>
.qejs3ub6k {
  fill: currentColor;
