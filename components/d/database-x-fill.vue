...
const content = `<g class="nrj6p8qat"><path clip-rule="evenodd" class="bao7fobzx"/><path class="m0-o-p7qp"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-x-fill" /></template>
<style>
.bao7fobzx {
  fill: currentColor;
  fill-rule: evenodd;
