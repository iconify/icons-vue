...
const content = `<path class="sv4pfqbdh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-split-hint-24-filled" /></template>
<style>
.sv4pfqbdh {
  fill: currentColor;
