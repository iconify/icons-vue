...
const content = `<path class="ieiy01usf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-h6-outline-sharp" /></template>
<style>
.ieiy01usf {
  fill: currentColor;
