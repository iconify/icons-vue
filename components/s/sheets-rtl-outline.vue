...
const content = `<path class="xbacsac1r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sheets-rtl-outline" /></template>
<style>
.xbacsac1r {
  fill: currentColor;
