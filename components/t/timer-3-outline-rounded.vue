...
const content = `<path class="cd6d9rlkx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:timer-3-outline-rounded" /></template>
<style>
.cd6d9rlkx {
  fill: currentColor;
