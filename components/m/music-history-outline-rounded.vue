...
const content = `<path class="mb06tmo6y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:music-history-outline-rounded" /></template>
<style>
.mb06tmo6y {
  fill: currentColor;
