...
const content = `<path class="nvzvrnbob"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:overview-key-outline" /></template>
<style>
.nvzvrnbob {
  fill: currentColor;
