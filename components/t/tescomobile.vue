...
const content = `<path class="by2d0vbbc"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tescomobile" /></template>
<style>
.by2d0vbbc {
  fill: none;
  stroke: currentColor;
