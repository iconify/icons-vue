...
const content = `<path class="ittqilbmb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:lock-closed-12-regular" /></template>
<style>
.ittqilbmb {
  fill: currentColor;
