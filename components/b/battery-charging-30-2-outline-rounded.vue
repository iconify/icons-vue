...
const content = `<path class="l635vxb7c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-charging-30-2-outline-rounded" /></template>
<style>
.l635vxb7c {
  fill: currentColor;
