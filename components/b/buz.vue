...
const content = `<rect class="j3s9ivbxi"/><circle class="rhnt92bta"/><path class="iv0lfabre"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:buz" /></template>
<style>
.iv0lfabre {
  fill: none;
  stroke: currentColor;
