...
const content = `<path class="oooc15bfi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-paint-rounded" /></template>
<style>
.oooc15bfi {
  fill: currentColor;
