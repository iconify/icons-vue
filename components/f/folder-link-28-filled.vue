...
const content = `<path class="c8030jb_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-link-28-filled" /></template>
<style>
.c8030jb_k {
  fill: currentColor;
