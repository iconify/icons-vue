...
const content = `<path class="ut63snbio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ink-eraser-off-outline-sharp" /></template>
<style>
.ut63snbio {
  fill: currentColor;
