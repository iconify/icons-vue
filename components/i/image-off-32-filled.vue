...
const content = `<path class="h_cu4zbvz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-off-32-filled" /></template>
<style>
.h_cu4zbvz {
  fill: currentColor;
