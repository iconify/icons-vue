...
const content = `<path class="mjv8kj4vf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nike" /></template>
<style>
.mjv8kj4vf {
  fill: none;
  stroke: currentColor;
