...
const content = `<g class="ft5dv1b6b"><path class="fc5y0hbbn"/><path class="wb3jr_x_s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pane-close-20-regular" /></template>
<style>
.fc5y0hbbn {
