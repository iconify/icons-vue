...
const content = `<path class="dgi7xxeec"/><path class="o1txgyb8m"/><circle class="my9jz3bby"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:sunflower" /></template>
<style>
.dgi7xxeec {
  fill: var(--svg-color--3e721d, #3e721d);
  d: path("M28 27c-8 0-8 6-8 6V22h-4v11s0-6-8-6c-4 0-7-2-7-2s0 9 9 9h6s0 2 2 2s2-2 2-2h6c9 0 9-9 9-9s-3 2-7 2");
}
