...
const content = `<path class="m-aj5-bts"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:diversity-1-outline-sharp" /></template>
<style>
.m-aj5-bts {
  fill: currentColor;
