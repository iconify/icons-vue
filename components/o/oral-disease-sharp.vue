...
const content = `<path class="q8rp43q7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:oral-disease-sharp" /></template>
<style>
.q8rp43q7l {
  fill: currentColor;
