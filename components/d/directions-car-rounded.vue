...
const content = `<path class="w4iauh0sj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:directions-car-rounded" /></template>
<style>
.w4iauh0sj {
  fill: currentColor;
