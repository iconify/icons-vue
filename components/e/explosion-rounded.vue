...
const content = `<path class="rq676bb5c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:explosion-rounded" /></template>
<style>
.rq676bb5c {
  fill: currentColor;
