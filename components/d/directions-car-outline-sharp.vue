...
const content = `<path class="rjnxpw5za"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:directions-car-outline-sharp" /></template>
<style>
.rjnxpw5za {
  fill: currentColor;
