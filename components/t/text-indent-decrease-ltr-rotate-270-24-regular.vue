...
const content = `<path class="ikbn93boi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-decrease-ltr-rotate-270-24-regular" /></template>
<style>
.ikbn93boi {
  fill: currentColor;
