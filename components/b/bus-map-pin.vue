...
const content = `<path class="o9mbnfmtn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bus-map-pin" /></template>
<style>
.o9mbnfmtn {
  fill: currentColor;
