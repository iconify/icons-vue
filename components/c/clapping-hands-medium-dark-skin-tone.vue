...
const content = `<path class="mtuniib5h"/><path class="n6tm2z0jk"/><defs><path id="SVGHS5T6b0Y" class="jusagjbiu"/></defs><clipPath id="SVGmyL66ddH"><use href="#SVGHS5T6b0Y"/></clipPath><path clip-path="url(#SVGmyL66ddH)" class="xbof3eqhe"/><defs><use href="#SVGHS5T6b0Y" id="SVGN1cpRcQB"/></defs><clipPath id="SVGCNTilnCF"><use href="#SVGN1cpRcQB"/></clipPath><g clip-path="url(#SVGCNTilnCF)" class="u0e24bcck"><path class="qoq2pgbqk"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:clapping-hands-medium-dark-skin-tone" /></template>
<style>
.jusagjbiu {
  d: path("M99 44.7c1.9-4.5 5.5-7.7 9.7-6.7c2.9.6 3.5 3.3 3.3 4.9c-2.3 15.9 1.1 28.1.2 39.9c-1.1 14.9-10.5 30.3-30.2 31.7c-12.5 3-26.4.9-37.6-10c-6.2-6-11.6-10.6-19.1-22.8c-3.1-5.1-7.9-13.2-7.9-18.5c0-4.5 4.5-5.9 6.8-3.8c-3-4.8-4.4-8.3-4.5-12.4c-.1-3.4 4.1-5.8 6.8-3.2c-2.3-3.7-5.5-10.2-.7-13.5c1.5-1 5.3-2.3 9.9 3.5c-1.2-2.3-2.5-6.2.7-8.8c1.7-1.4 5-1.8 7.8 1.4c-.2-1.2 1.5-4.2 4.3-4.3c3.4-.2 6.1 2.9 8.1 5.2c-2-8 6.3-10.3 10.9-4.9c2.4 2.7 8 9.5 16.4 23.5c-.2-8.4 3.9-15.8 9.9-14.7c2.1.4 4.2 1.8 4.4 5.7c.4 3.5.8 7.8.8 7.8");
}

.mtuniib5h {
  fill: var(--svg-color--bdccd4, #bdccd4);
  d: path("M19.7 85.2c-1.2.1-10.6.5-12 .6c-2.6.2-2.4 4.6.2 4.5c1.4-.1 12-.6 12-.6c2.8-.3 2.5-4.7-.2-4.5m9.3 15c-.4 1.2-3.4 10-3.9 11.4c-.8 2.5 3.4 3.9 4.2 1.4c.5-1.4 3.9-11.4 3.9-11.4c.8-2.5-3.4-3.9-4.2-1.4m82.4-81.8c-.9.8-8.2 6.7-9.2 7.7c-2 1.7.8 5.1 2.8 3.4c1.1-.9 9.2-7.7 9.2-7.7c2.1-1.8-.8-5.2-2.8-3.4M81 12.2c.4 1.2 2.9 10.2 3.3 11.5c.7 2.5 5 1.3 4.3-1.2c-.4-1.4-3.3-11.5-3.3-11.5c-.8-2.6-5.1-1.4-4.3 1.2M23.1 93.1c-1 .7-14 9.8-15.2 10.7c-2.1 1.5.5 5.2 2.6 3.6c1.2-.9 15.2-10.7 15.2-10.7c2.2-1.7-.5-5.3-2.6-3.6M99.6 5.8C99.2 7 93.8 22 93.4 23.4c-.8 2.5 3.4 4 4.2 1.5c.5-1.4 6.2-17.6 6.2-17.6c.8-2.6-3.4-4-4.2-1.5");
}
