...
const content = `<path class="szshbebgs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:science-off-outline-rounded" /></template>
<style>
.szshbebgs {
  fill: currentColor;
