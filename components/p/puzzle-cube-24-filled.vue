...
const content = `<path class="d-mf215pu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:puzzle-cube-24-filled" /></template>
<style>
.d-mf215pu {
  fill: currentColor;
