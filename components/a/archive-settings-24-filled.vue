...
const content = `<path class="d-8a670xb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:archive-settings-24-filled" /></template>
<style>
.d-8a670xb {
  fill: currentColor;
