...
const content = `<path class="puczebc-w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:electric-car-rounded" /></template>
<style>
.puczebc-w {
  fill: currentColor;
