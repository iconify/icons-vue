...
const content = `<path class="q-_ff9zwt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:man-outline" /></template>
<style>
.q-_ff9zwt {
  fill: currentColor;
