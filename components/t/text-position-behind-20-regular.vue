...
const content = `<path class="e8-16sbul"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-behind-20-regular" /></template>
<style>
.e8-16sbul {
  fill: currentColor;
