...
const content = `<path class="xaoove_5l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:headphones-sound-wave-24-filled" /></template>
<style>
.xaoove_5l {
  fill: currentColor;
