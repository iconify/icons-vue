...
const content = `<path class="lj9u31nvi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:thai-tv" /></template>
<style>
.lj9u31nvi {
  fill: none;
  stroke: currentColor;
