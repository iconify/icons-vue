...
const content = `<rect class="j3s9ivbxi"/><path class="kw5j1uazz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:normal-app" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
