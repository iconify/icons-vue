...
const content = `<path class="adiz2ibda"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:credit-card-clock-sharp" /></template>
<style>
.adiz2ibda {
  fill: currentColor;
