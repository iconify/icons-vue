...
const content = `<path class="s3jvrqlrt"/><circle class="vhr2lj4be"/><circle class="ifds6hbbc"/><path class="rbvv96b6e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-child-care" /></template>
<style>
.ifds6hbbc {
  cx: 9.5px;
  cy: 10.5px;
