...
const content = `<path class="o2m0u5bbg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:error-rounded" /></template>
<style>
.o2m0u5bbg {
  fill: currentColor;
