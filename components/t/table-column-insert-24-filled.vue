...
const content = `<path class="ari2u1yrp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-column-insert-24-filled" /></template>
<style>
.ari2u1yrp {
  fill: currentColor;
