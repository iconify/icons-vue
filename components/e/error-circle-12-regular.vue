...
const content = `<path class="u52tohwdy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:error-circle-12-regular" /></template>
<style>
.u52tohwdy {
  fill: currentColor;
