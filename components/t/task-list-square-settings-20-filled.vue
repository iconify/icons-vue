...
const content = `<path class="xe352bcus"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:task-list-square-settings-20-filled" /></template>
<style>
.xe352bcus {
  fill: currentColor;
