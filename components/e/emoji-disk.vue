...
const content = `<path class="le1rdibsu"/><path class="fk23nccrq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-disk" /></template>
<style>
.fk23nccrq {
  fill: none;
  stroke: currentColor;
