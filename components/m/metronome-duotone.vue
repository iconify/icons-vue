...
const content = `<g class="cuyn6tgcc"><path class="midkkyb8x"/><path class="ija71-4oy"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:metronome-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
