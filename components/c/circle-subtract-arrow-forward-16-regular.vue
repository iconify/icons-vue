...
const content = `<path class="s73w5u-lu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:circle-subtract-arrow-forward-16-regular" /></template>
<style>
.s73w5u-lu {
  fill: currentColor;
