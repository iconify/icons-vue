...
const content = `<path class="ru6gffq6y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:allergies-sharp" /></template>
<style>
.ru6gffq6y {
  fill: currentColor;
