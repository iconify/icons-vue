...
const content = `<path class="blt1skb6s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:moving-ministry-outline-sharp" /></template>
<style>
.blt1skb6s {
  fill: currentColor;
