...
const content = `<path class="j0y_ntbqg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:grid-squares-plus" /></template>
<style>
.j0y_ntbqg {
  fill: none;
  stroke: currentColor;
