...
const content = `<path class="f29lnabfk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:data-thresholding" /></template>
<style>
.f29lnabfk {
  fill: currentColor;
