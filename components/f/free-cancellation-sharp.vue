...
const content = `<path class="c35zo8p7a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:free-cancellation-sharp" /></template>
<style>
.c35zo8p7a {
  fill: currentColor;
