...
const content = `<path class="osyxtppji"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gamelauncher-2" /></template>
<style>
.osyxtppji {
  fill: none;
  stroke: currentColor;
