...
const content = `<g class="nrj6p8qat"><path class="tx_ah59as"/><path class="dd9b8t23u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-arrow-right" /></template>
<style>
.dd9b8t23u {
