...
const content = `<path class="uprj1cumn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:20mp-outline-rounded" /></template>
<style>
.uprj1cumn {
  fill: currentColor;
