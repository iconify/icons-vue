...
const content = `<path class="c4_dr3r7h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bowl-chopsticks-28-filled" /></template>
<style>
.c4_dr3r7h {
  fill: currentColor;
