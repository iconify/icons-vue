...
const content = `<path class="m8qg9uaqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:5k-outline-rounded" /></template>
<style>
.m8qg9uaqq {
  fill: currentColor;
