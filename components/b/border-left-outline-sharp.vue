...
const content = `<path class="tzx8rfcxe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:border-left-outline-sharp" /></template>
<style>
.tzx8rfcxe {
  fill: currentColor;
