...
const content = `<g class="gp_8x1bzb"><path class="p3z_iunwt"/><path class="etf2xkbvu"/><path class="q-qndji8q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:server-plus-sharp-duotone" /></template>
<style>
.etf2xkbvu {
