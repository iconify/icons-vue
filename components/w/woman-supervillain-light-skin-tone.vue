...
import '../../css/q/qmb051q6j.css';
import '../../css/h/h2jkzabhk.css';
...
const content = `<path class="qmb051q6j"/><path class="h2jkzabhk"/><path class="mysmt_bix"/><path class="kg9stkl6v"/><path class="c83p2dbqh"/><path class="tpqw742pr"/><path class="puovqsbqe"/><path class="gric1hicz"/><path class="pjhu3gbol"/><path class="nlc7kbc0v"/><path class="gtnjkhbvu"/><path class="j-mf60-7d"/><path class="j1d3zubbk"/><path class="pq_9pbcaq"/><path class="ptmjoubsm"/><path class="gyg7q313g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="openmoji:woman-supervillain-light-skin-tone" /></template>
