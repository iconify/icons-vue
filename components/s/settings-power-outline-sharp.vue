...
const content = `<path class="pei1tvcyw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-power-outline-sharp" /></template>
<style>
.pei1tvcyw {
  fill: currentColor;
