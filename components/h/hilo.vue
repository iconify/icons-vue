...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGZWToecid)" class="og60q6blf"/><defs><linearGradient id="SVGZWToecid" x1="3" x2="16.655" y1="6.113" y2="21.001" gradientUnits="userSpaceOnUse"><stop class="tbiy8ey5h"/><stop offset=".11" class="odpv4lbce"/><stop offset=".47" class="lukkp90wc"/><stop offset="1" class="asgldebtu"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:hilo" /></template>
<style>
.asgldebtu {
