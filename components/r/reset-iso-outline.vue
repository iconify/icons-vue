...
const content = `<path class="acrgc_pjq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:reset-iso-outline" /></template>
<style>
.acrgc_pjq {
  fill: currentColor;
