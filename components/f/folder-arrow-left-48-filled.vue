...
const content = `<path class="weyf31tac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-arrow-left-48-filled" /></template>
<style>
.weyf31tac {
  fill: currentColor;
