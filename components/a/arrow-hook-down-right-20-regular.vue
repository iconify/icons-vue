...
const content = `<path class="e-axztkxq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-hook-down-right-20-regular" /></template>
<style>
.e-axztkxq {
  fill: currentColor;
