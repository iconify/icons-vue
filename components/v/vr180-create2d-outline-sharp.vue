...
const content = `<path class="ehaqiub9j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vr180-create2d-outline-sharp" /></template>
<style>
.ehaqiub9j {
  fill: currentColor;
