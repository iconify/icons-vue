...
const content = `<path class="y_xo88b-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-outline-down-left-28-filled" /></template>
<style>
.y_xo88b-y {
  fill: currentColor;
