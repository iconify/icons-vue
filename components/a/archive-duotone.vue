...
const content = `<g class="cuyn6tgcc"><path class="ust-y5gyh"/><path class="nc7xr9rwg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:archive-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
