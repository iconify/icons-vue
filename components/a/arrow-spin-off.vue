...
const content = `<g class="cuyn6tgcc"><path class="fwvb0bbrp"/><path class="zlgf7ibdg"/><path class="nko804_7a"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:arrow-spin-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
