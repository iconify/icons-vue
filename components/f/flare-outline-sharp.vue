...
const content = `<path class="bpgcenbqo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flare-outline-sharp" /></template>
<style>
.bpgcenbqo {
  fill: currentColor;
