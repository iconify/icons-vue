...
const content = `<path class="hpc17d85y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-charging-90-outline-rounded" /></template>
<style>
.hpc17d85y {
  fill: currentColor;
