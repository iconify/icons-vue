...
const content = `<path class="qb--9bcwq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cottage-outline-sharp" /></template>
<style>
.qb--9bcwq {
  fill: currentColor;
