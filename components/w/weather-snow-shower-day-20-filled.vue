...
const content = `<path class="neumjdpjv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-snow-shower-day-20-filled" /></template>
<style>
.neumjdpjv {
  fill: currentColor;
