...
const content = `<path class="uaw14hnfr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-bullet-list-rtl-90-20-regular" /></template>
<style>
.uaw14hnfr {
  fill: currentColor;
