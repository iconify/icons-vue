...
const content = `<path class="i9clfwm2k"/><path class="sio4jhbkp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pefrect-piano" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
