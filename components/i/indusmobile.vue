...
const content = `<g class="y9tr6bcfx"><path class="hqpjgkf3n"/><path class="ccwx3e_qa"/></g><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:indusmobile" /></template>
<style>
.ccwx3e_qa {
...
.hqpjgkf3n {
  d: path("M5.692 28s4.185-.279 5.078-1.953c0 0-2.456-5.469 1.897-7.868s8.705.335 9.152 1.674c0 0-1.897-8.272 4.073-11.787c0 0 2.735-1.73 1.228.948c0 0-5.524 6.765.056 15.024c0 0-1.06-.223-1.172.837s-1.116 1.228-1.786 1.284s-2.957 3.795 1.953 7.812c0 0 1.06.726.447 1.786s.335 2.567 3.794 6.697");
}
