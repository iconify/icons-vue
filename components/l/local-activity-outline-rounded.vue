...
const content = `<path class="tnbx7f7gp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-activity-outline-rounded" /></template>
<style>
.tnbx7f7gp {
  fill: currentColor;
