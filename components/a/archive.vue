...
const content = `<path class="oan-i4b1g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:archive" /></template>
<style>
.oan-i4b1g {
  fill: currentColor;
