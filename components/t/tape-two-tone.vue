...
const content = `<g class="nrj6p8qat"><path class="h-r8a2llg"/><path class="j8jcxpbfq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:tape-two-tone" /></template>
<style>
.h-r8a2llg {
  fill: currentColor;
