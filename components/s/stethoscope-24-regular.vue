...
const content = `<path class="ge3w2pb4f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:stethoscope-24-regular" /></template>
<style>
.ge3w2pb4f {
  fill: currentColor;
