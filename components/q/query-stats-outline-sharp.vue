...
const content = `<path class="dbd7rohbe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:query-stats-outline-sharp" /></template>
<style>
.dbd7rohbe {
  fill: currentColor;
