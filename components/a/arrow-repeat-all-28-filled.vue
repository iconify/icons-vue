...
const content = `<path class="ngs9_195q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-repeat-all-28-filled" /></template>
<style>
.ngs9_195q {
  fill: currentColor;
