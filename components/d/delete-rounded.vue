...
const content = `<path class="vfc44ebwh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:delete-rounded" /></template>
<style>
.vfc44ebwh {
  fill: currentColor;
