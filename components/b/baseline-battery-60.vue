...
const content = `<path class="q1-n-cjjn"/><path class="upz1nctlr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-battery-60" /></template>
<style>
.q1-n-cjjn {
  fill: currentColor;
