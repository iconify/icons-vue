...
const content = `<path class="aod-3gbys"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-edit-24-filled" /></template>
<style>
.aod-3gbys {
  fill: currentColor;
