...
const content = `<path class="cih4vpbff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:notification-add-outline-rounded" /></template>
<style>
.cih4vpbff {
  fill: currentColor;
