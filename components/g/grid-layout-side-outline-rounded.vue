...
const content = `<path class="paww7r78v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:grid-layout-side-outline-rounded" /></template>
<style>
.paww7r78v {
  fill: currentColor;
