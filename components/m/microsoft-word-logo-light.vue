...
const content = `<path class="kh9vi0bnm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:microsoft-word-logo-light" /></template>
<style>
.kh9vi0bnm {
  fill: currentColor;
