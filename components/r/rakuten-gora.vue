...
const content = `<path class="ffdt-fb8c"/><path class="yp7nrgbhp"/><circle class="l40cd-dkp"/><path class="pjlghl6jh"/><circle class="kdfap6bnm"/><circle class="yiujgmbed"/><circle class="b4tesqbrf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:rakuten-gora" /></template>
<style>
.b4tesqbrf {
  cx: 15.55px;
  cy: 34.508px;
