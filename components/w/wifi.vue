...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGM4JRhc7r)" class="uhl_d7bur"/><defs><linearGradient id="SVGM4JRhc7r" x1="12" x2="12" y1="3" y2="21" gradientUnits="userSpaceOnUse"><stop class="rzu22jbkt"/><stop offset="1" class="b5xsunz4d"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:wifi" /></template>
<style>
.b5xsunz4d {
