...
const content = `<path class="ry7oldtls"/><path class="g7jc2qb7h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:benotes" /></template>
<style>
.g7jc2qb7h {
  fill: none;
  stroke: currentColor;
