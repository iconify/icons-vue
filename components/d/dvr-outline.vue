...
const content = `<path class="hnkz00bfo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dvr-outline" /></template>
<style>
.hnkz00bfo {
  fill: currentColor;
