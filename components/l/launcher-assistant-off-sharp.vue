...
const content = `<path class="ol8qqc-qc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:launcher-assistant-off-sharp" /></template>
<style>
.ol8qqc-qc {
  fill: currentColor;
