...
const content = `<path class="ce6j6ebze"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-row-three-16-regular" /></template>
<style>
.ce6j6ebze {
  fill: currentColor;
