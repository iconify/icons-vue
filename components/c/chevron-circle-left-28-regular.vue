...
const content = `<path class="jj4u85rir"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chevron-circle-left-28-regular" /></template>
<style>
.jj4u85rir {
  fill: currentColor;
