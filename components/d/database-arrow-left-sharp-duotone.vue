...
const content = `<g class="gp_8x1bzb"><path class="uordzqcti"/><path clip-rule="evenodd" class="r0p7iiqoh"/><path class="y16ih9r-s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-left-sharp-duotone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.y16ih9r-s {
  d: path("M22 19L15 19M18.2929 15.7071L15 19L18.2929 22.2929");
}
