...
const content = `<path class="o9on2e1lo"/><path class="m30-3d_zx"/><g class="n1mjunbsu"><circle transform="matrix(1 -.00386 .00386 1 -.073 1.11)" class="lzteeucdc"/><path class="ov2ynwbjg"/><path class="g4tzv5nda"/><path class="hmff0acwl"/><path class="d4lt3nd_f"/><path class="lf5_xf-wf"/><path class="qic9ajblm"/><path class="yv0x2bawe"/></g><path class="qmh44eosk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:baby-symbol" /></template>
<style>
.d4lt3nd_f {
  d: path("M275.34 47.98h11.93v16.14h-11.93zm11.93 0h11.93v16.14h-11.93z");
}

.g4tzv5nda {
  d: path("m266.48 46.48l-13.43 19.2a4.587 4.587 0 0 0 1.13 6.39c2.08 1.45 4.94.95 6.39-1.13l14.91-21.29z");
}

.hmff0acwl {
  d: path("M272.07 54.52s.91-1.09 2.07-.6c1.2.51 1.2 2.07 1.2 2.07l1 .37l2.08-4.29l-5.38-.96l-1.58 3.21zm35.97-8.04l13.45 19.2c1.45 2.08.95 4.94-1.13 6.39a4.587 4.587 0 0 1-6.39-1.13l-14.91-21.29z");
}

.lf5_xf-wf {
  d: path("M302.47 54.52s-.91-1.09-2.07-.6c-1.2.51-1.2 2.07-1.2 2.07l-1 .37l-2.08-4.29l5.38-.96l1.58 3.21zm-28.88 17.66l-8.52 10.18c-2.47 2.95-2.09 7.34.86 9.82s7.34 2.09 9.82-.86l8.52-10.18z");
}
...
.ov2ynwbjg {
  d: path("M309.72 51.53c0-6.69-8.58-12.11-15.27-12.11h-14.38c-6.69 0-15.27 5.42-15.27 12.11v.18h44.91v-.18z");
}

.qic9ajblm {
  d: path("m264.66 90.79l10.72 15.18a5.275 5.275 0 0 0 7.36 1.26a5.275 5.275 0 0 0 1.26-7.36l-10.72-15.18zm36.29-18.61l8.52 10.18c2.47 2.95 2.09 7.34-.86 9.82s-7.34 2.09-9.82-.86l-8.52-10.18z");
}
...
.yv0x2bawe {
  d: path("m309.88 90.79l-10.72 15.18a5.275 5.275 0 0 1-7.36 1.26a5.275 5.275 0 0 1-1.26-7.36l10.72-15.18z");
}
