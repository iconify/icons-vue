...
const content = `<path class="g2wj9jbhp"/><path class="j3opzsb3r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:true-app" /></template>
<style>
.g2wj9jbhp {
  fill: none;
  stroke: currentColor;
