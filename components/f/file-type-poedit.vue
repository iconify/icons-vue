...
.a_ds7tbuu {
  ...
  d: path("m25.758 8.732l.217-.482a.875.875 0 0 1 1.519.866l-.216.481Z");
}

.a-_ofk96q {
  fill: var(--svg-color--ddb967, #ddb967);
  d: path("m26.727 9.889l.2-.447l.023.012c-.063.139-.047.1-.2.448l-.025-.014Z");
}

.a-opx89wa {
  fill: var(--svg-color--fff, #fff);
  d: path("M7.736 7.681a.722.722 0 1 1 .664-.992a.723.723 0 0 1-.4.94a.7.7 0 0 1-.264.052m0-1.415a.69.69 0 0 0-.64.951a.69.69 0 0 0 .9.384a.694.694 0 0 0 .383-.9a.69.69 0 0 0-.641-.433Z");
}

.ac2trc7ru {
  fill: var(--svg-color--d7b66e, #d7b66e);
...
.asqv_vl2l {
  fill: var(--svg-color--d2b372, #d2b372);
  d: path("M26.158 9.563c.062-.137.047-.1.2-.445l.047.027a1.3 1.3 0 0 0-.2.448z");
}
...
.b4jkcdbns {
  fill: var(--svg-color--c7ab7b, #c7ab7b);
  d: path("M26.444 9.725a1.3 1.3 0 0 1 .2-.446l.047.027c-.063.138-.046.1-.2.446l-.045-.028Z");
}

.b87xgqb-v {
  fill: var(--svg-color--ccb078, #ccb078);
...
.c0405ni4u {
  fill: var(--svg-color--c8ad78, #c8ad78);
  d: path("M26.489 9.753a3 3 0 0 1 .2-.446l.047.027c-.062.137-.047.1-.2.447l-.049-.028Z");
}

.carrdux5h {
  fill: var(--svg-color--cdb175, #cdb175);
  d: path("M26.23 9.605c.062-.137.046-.1.2-.448l.046.027c-.061.138-.047.1-.2.448l-.048-.027Z");
}

.cchvxn2rd {
  fill: var(--svg-color--f0c52d, #f0c52d);
  d: path("m25.707 9.307l.2-.446l.023.014l-.2.447l-.024-.015Z");
}

.ce15edbdq {
  fill: var(--svg-color--1b6a9e, #1b6a9e);
...
.d5yn_fu6b {
  fill: var(--svg-color--e1bb63, #e1bb63);
  d: path("m25.92 9.431l.2-.447l.027.016c-.062.139-.046.1-.2.446l-.023-.012Z");
}
...
.dd5j01mqc {
  fill: var(--svg-color--f6ca2a, #f6ca2a);
  d: path("M25.565 9.227c.062-.139.047-.1.2-.448l.024.013l-.2.448z");
}
...
.e02_9f7re {
  d: path("M14.144 5.744a.707.707 0 1 1-.922-.39a.71.71 0 0 1 .922.39");
}

.e4rbkh2kw {
  fill: var(--svg-color--dab86a, #dab86a);
  d: path("M26.016 9.484c.062-.138.046-.1.2-.447l.047.027l-.2.447z");
}

.ehvns1bnt {
  fill: var(--svg-color--444b4c, #444b4c);
  d: path("M10.3 6.628a.12.12 0 0 1-.121-.084l-.681-3l.8-.129l.683 2.944a.126.126 0 0 1-.105.14l-.543.121zm-.763-3.056l.674 2.965a.1.1 0 0 0 .12.058l.543-.121a.1.1 0 0 0 .083-.105l-.676-2.917Z");
}

.ei6a7f_yp {
  fill: var(--svg-color--ebc24f, #ebc24f);
  d: path("M26.846 9.957c.063-.138.048-.1.2-.447l.024.014c-.063.137-.047.1-.2.447z");
}

.eix40tbbr {
  fill: var(--svg-color--c7ab78, #c7ab78);
  d: path("m26.35 9.673l.2-.448l.047.028c-.061.137-.047.1-.2.446l-.046-.027Z");
}

.exywqbcll {
  d: path("M19.868 4.8a.707.707 0 1 1-.921-.39a.71.71 0 0 1 .921.39");
}

.f3dt7kbps {
  fill: var(--svg-color--d1b374, #d1b374);
  d: path("M26.562 9.795a2.7 2.7 0 0 1 .2-.447l.046.028a3 3 0 0 0-.2.447l-.048-.027Z");
}

.fabftv5mt {
  fill: var(--svg-color--e9c158, #e9c158);
  d: path("m25.826 9.376l.2-.448l.025.014c-.063.137-.048.1-.2.447z");
}
...
.g8pvcobvc {
  fill: var(--svg-color--444b4c, #444b4c);
  d: path("M13.266 6.153a.12.12 0 0 1-.119-.082l-.577-3.02l.809-.13v.014l.567 2.957a.1.1 0 0 1-.014.074a.14.14 0 0 1-.091.062l-.541.122zM12.6 3.076l.571 2.99a.1.1 0 0 0 .118.056L13.838 6a.12.12 0 0 0 .072-.049a.07.07 0 0 0 .01-.052l-.565-2.944Z");
}

.ghm_d7b3a {
  stop-color: var(--svg-color--cc772f, #cc772f);
}
...
.gqr0lgw6e {
  fill: var(--svg-color--fff, #fff);
  d: path("M16.414 6.248a.721.721 0 1 1 .668-.991a.722.722 0 0 1-.668.991m0-1.414a.692.692 0 1 0 .258 1.334a.69.69 0 0 0 .383-.9a.69.69 0 0 0-.642-.434Z");
}

.gwxszhbvd {
  fill: var(--svg-color--f6ca2a, #f6ca2a);
  d: path("m25.589 9.241l.2-.448l.022.015l-.2.446l-.024-.013Z");
}

.h-3rifbjx {
  fill: var(--svg-color--f4c92a, #f4c92a);
  d: path("M25.613 9.254c.061-.138.046-.1.2-.446l.024.013c-.062.139-.046.1-.2.447l-.023-.014Z");
}

.h0svu4cbr {
  fill: var(--svg-color--e9c158, #e9c158);
  d: path("m26.823 9.944l.2-.448l.023.014c-.062.138-.046.1-.2.447z");
}

.h8onzwb-j {
  d: path("M17.068 5.262a.707.707 0 1 1-.922-.391a.706.706 0 0 1 .922.391");
}

.hfs-46ywu {
  fill: var(--svg-color--f4c92a, #f4c92a);
  d: path("M25.637 9.267c.061-.137.046-.1.2-.447l.024.014c-.063.139-.047.1-.2.447l-.023-.014Z");
}

.i489r9bxf {
  fill: var(--svg-color--ecc23a, #ecc23a);
  d: path("M25.731 9.322c.062-.139.047-.1.2-.447l.047.027l-.2.447z");
}
...
.jdifgmbex {
  fill: var(--svg-color--343833, #343833);
  d: path("m25.744 8.766l.015-.035zm1.535.831l.023.014l-.014.034l-.025-.014Zm-1.113 2.523l-.023-.014Z");
}
...
.jsz6gibvy {
  fill: var(--svg-color--cdb175, #cdb175);
  d: path("M26.538 9.781a3 3 0 0 1 .2-.447l.047.026c-.062.138-.046.1-.2.448z");
}

.jvh4wbczb {
  fill: var(--svg-color--d4b470, #d4b470);
  d: path("M26.111 9.538c.062-.139.046-.1.2-.447l.048.027c-.063.137-.048.1-.2.445z");
}

.jxm7rpvkw {
  fill: var(--svg-color--d2b270, #d2b270);
...
.k2-bolgkj {
  stop-color: var(--svg-color--edce27, #edce27);
}

.k35un5byo {
  fill: var(--svg-color--dcba67, #dcba67);
  d: path("M25.968 9.457a1.3 1.3 0 0 1 .2-.447l.024.012l-.2.448z");
}
...
.kkkcz8smn {
  ...
  d: path("m26.68 9.862l.2-.447l.048.027a2.6 2.6 0 0 0-.2.447z");
}

.kldrn_bej {
  fill: var(--svg-color--ddb967, #ddb967);
  d: path("M25.968 9.457c.062-.137.046-.1.2-.447l.047.027c-.063.137-.046.1-.2.447z");
}

.klhux3b9u {
  fill: var(--svg-color--d4b46f, #d4b46f);
  d: path("M26.087 9.524c.063-.138.047-.1.2-.447l.049.028c-.063.137-.048.1-.2.446l-.047-.027Z");
}

.ks-rc-5ty {
  fill: var(--svg-color--e1bb64, #e1bb64);
  d: path("M26.753 9.9c.061-.138.046-.1.2-.448l.023.014c-.062.139-.046.1-.2.447z");
}

.kscsed3od {
  stop-color: var(--svg-color--9fa4ab, #9fa4ab);
}
...
.lpidftm2r {
  fill: var(--svg-color--fff, #fff);
  d: path("M13.49 6.731a.722.722 0 0 1-.665-1a.7.7 0 0 1 .392-.386a.724.724 0 0 1 .941.4a.72.72 0 0 1-.668.992Zm0-1.414a.7.7 0 0 0-.26.05a.693.693 0 0 0-.381.9a.692.692 0 1 0 1.281-.517a.69.69 0 0 0-.643-.433Z");
}
...
.mhju60xgh {
  ...
  d: path("M26.183 9.578a2.6 2.6 0 0 1 .2-.447l.024.014c-.062.139-.046.1-.2.448l-.023-.015Z");
}

.mhohas8ci {
  fill: var(--svg-color--db3c72, #db3c72);
  d: path("m18.544 18.912l-.071-.347l.434-.088l.877-4.521l-1.29.263l-.072-.347l1.848-.375l.011.016l2.758 4.125l.427-.087l.07.348l-1.728.351l-.072-.346l.893-.181l-.781-1.171l-2.263.459l-.251 1.38l.837-.168l.07.346Zm0-.3l.047.232l1.583-.322l-.047-.232l-.864.174l.274-1.5h.019l2.321-.471l.851 1.276l-.92.187l.048.232l1.614-.327l-.047-.233l-.408.083l-.015-.025l-2.755-4.126l-1.752.356l.048.232l1.318-.268l-.9 4.646Zm1.025-1.9l.572-2.854l1.594 2.414Zm.6-2.7l-.527 2.628l1.995-.4Zm.455-.857l-.01-.006l-1.968-1.193l.828-.168l.011.009l1.551 1.276ZM18.8 11.979l1.831 1.11l.269-.054l-1.445-1.189Z");
}

.mlur4ib4o {
  d: path("M11.243 6.223a.707.707 0 1 1-.923-.391a.71.71 0 0 1 .923.391");
}

.mxdjgc26a {
  fill: var(--svg-color--f2c62c, #f2c62c);
  d: path("M25.683 9.294c.062-.137.047-.1.2-.446l.023.013c-.063.138-.046.1-.2.446l-.024-.013Z");
}

.mz-1elbgr {
  fill: var(--svg-color--f2c82b, #f2c82b);
  d: path("m26.942 10.012l.2-.449l.023.014l-.2.447l-.023-.013Z");
}
...
.ntij6pbcf {
  fill: var(--svg-color--e4bf61, #e4bf61);
  d: path("M25.9 9.415c.063-.137.046-.1.2-.446l.024.015c-.063.137-.046.1-.2.447z");
}

.nwi-mm3qf {
  d: path("m17.942 25.507l6.683-14.265l1.519.864l-6.683 14.265c-.791 1.02-.627.465-.4-.229c-.147.262-.517.615-.356-.2c-.959 1.657-.416.065-.309-.177c-.663 1.006-.473-.008-.451-.256Z");
}

.od3cg1bnb {
  fill: var(--svg-color--f0c631, #f0c631);
  d: path("M25.731 9.322a2.5 2.5 0 0 1 .2-.447l.023.014c-.062.138-.047.1-.2.446z");
}

.opd2o7kev {
  fill: var(--svg-color--d2b270, #d2b270);
  d: path("M26.134 9.551c.062-.138.047-.1.2-.446l.046.026a2.5 2.5 0 0 0-.2.447l-.049-.027Z");
}

.or16pidyg {
  fill: var(--svg-color--e5bd87, #e5bd87);
  d: path("m19.461 26.371l-1.947 2.654a.229.229 0 0 0-.378-.214l.806-3.3c-.022.248-.212 1.262.451.256c-.108.242-.65 1.835.309.177c-.161.816.209.464.356.2c-.224.694-.387 1.249.4.229Z");
}

.otbmv4o1b {
  fill: var(--svg-color--444b4c, #444b4c);
  d: path("M7.466 7.264a.116.116 0 0 1-.119-.077l-.679-3.18h.015l.829-.135l.638 3.134a.1.1 0 0 1-.013.07a.14.14 0 0 1-.092.061L7.5 7.26zM6.7 4.031l.676 3.149a.1.1 0 0 0 .12.052l.544-.123a.12.12 0 0 0 .073-.048a.06.06 0 0 0 .009-.048L7.49 3.9Z");
}

.p2-3di2zh {
  fill: var(--svg-color--ecc344, #ecc344);
  d: path("m25.755 9.334l.2-.446l.045.027c-.063.137-.047.1-.2.446l-.047-.027Z");
}

.pca0fjmtv {
  fill: var(--svg-color--e4bf61, #e4bf61);
  d: path("M26.775 9.915a3 3 0 0 1 .2-.447l.025.014c-.063.139-.047.1-.2.447l-.023-.014Z");
}

.pcy6jcb6x {
  d: path("m18.3 2.142l.574 3a.11.11 0 0 0 .134.067l.546-.122a.11.11 0 0 0 .094-.118l-.568-2.957Z");
}

.ph2qmkbaa {
  fill: var(--svg-color--d7b66e, #d7b66e);
  d: path("M26.657 9.848a2.6 2.6 0 0 1 .2-.447l.047.027a2.7 2.7 0 0 0-.2.447z");
}

.pk2h7_nuo {
  stop-color: var(--svg-color--6aa7ce, #6aa7ce);
}
...
.rxcobtstt {
  fill: var(--svg-color--ccae77, #ccae77);
  d: path("m26.278 9.633l.2-.448l.048.027l-.2.447c-.025-.012 0 0-.047-.026Z");
}

.rxe0r8bkn {
  fill: var(--svg-color--8a9196, #8a9196);
  d: path("m17.136 28.81l-.293 1.173l.656-.924c.038-.282-.215-.382-.364-.249Z");
}

.s-h1d5j4e {
  stop-color: var(--svg-color--c48e30, #c48e30);
}

.s01crhb4d {
  d: path("M8.389 6.694a.706.706 0 1 1-.92-.391a.707.707 0 0 1 .92.391");
}

.s0jiz_6rd {
  fill: var(--svg-color--dab869, #dab869);
  d: path("M26.7 9.876c.062-.137.046-.1.2-.447l.047.026a2.7 2.7 0 0 0-.2.448z");
}
...
.shv1nde8m {
  fill: var(--svg-color--c8ac7a, #c8ac7a);
  d: path("M26.467 9.741a1.3 1.3 0 0 1 .2-.447l.047.027c-.061.137-.046.1-.2.447l-.046-.027Z");
}

.sq8jnmbgl {
  stop-color: var(--svg-color--90bedb, #90bedb);
}

.svzc8fbww {
  fill: var(--svg-color--cc772f, #cc772f);
  d: path("M18.917 26.991a.1.1 0 0 1-.045-.012c-.086-.046-.075-.183.036-.552a.21.21 0 0 1-.2.072c-.075-.027-.108-.116-.1-.279c-.322.529-.4.549-.469.515c-.1-.049-.021-.354.064-.614c-.106.116-.186.155-.254.13c-.135-.05-.113-.322-.073-.647c0-.04.009-.075.012-.1l.005-.02L24.6 11.16l1.621.922l-.023.049L19.511 26.4v.005c-.379.486-.517.586-.594.586m.09-.878l.107.046a3.4 3.4 0 0 0-.182.707a2.2 2.2 0 0 0 .48-.527l6.656-14.209l-1.417-.806L18 25.523c0 .026-.007.058-.011.1c-.039.321-.04.5 0 .524c0 0 .084 0 .358-.411l.1.056a4 4 0 0 0-.245.81a4 4 0 0 0 .45-.686l.108.04c-.077.389-.015.437-.014.437c.025.007.161-.103.26-.28Z");
}

.t6xyk7kjx {
  stop-color: var(--svg-color--cce1ee, #cce1ee);
}
...
.u4pp43e8h {
  fill: var(--svg-color--f4c92a, #f4c92a);
  d: path("M26.965 10.025c.063-.138.047-.1.2-.447l.025.013c-.062.138-.047.1-.2.447z");
}
...
.web8h2bey {
  fill: var(--svg-color--f0c52d, #f0c52d);
  d: path("M26.918 10c.063-.137.047-.1.2-.445l.025.012c-.063.137-.047.1-.2.449z");
}

.weoys1gzh {
  fill: var(--svg-color--d4b470, #d4b470);
  d: path("M26.634 9.835a2.5 2.5 0 0 1 .2-.447l.047.027a2.6 2.6 0 0 0-.2.447z");
}
...
.xdeggjbny {
  fill: var(--svg-color--f6ca2a, #f6ca2a);
  d: path("M27.013 10.052c.061-.139.047-.1.2-.448l.024.014c-.062.138-.047.1-.2.448l-.022-.014Z");
}
...
.y_yjvq5hs {
  fill: var(--svg-color--c7ab7a, #c7ab7a);
...
.z2twmobbj {
  fill: var(--svg-color--aa342e, #aa342e);
...
.zub-5nllz {
  fill: var(--svg-color--ccae77, #ccae77);
  d: path("M26.514 9.768a2.7 2.7 0 0 1 .2-.447l.049.027c-.063.138-.047.1-.2.447l-.048-.027Z");
}
