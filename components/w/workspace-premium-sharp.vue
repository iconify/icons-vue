...
const content = `<path class="bz71ejtwc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:workspace-premium-sharp" /></template>
<style>
.bz71ejtwc {
  fill: currentColor;
