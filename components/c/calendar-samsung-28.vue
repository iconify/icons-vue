...
const content = `<path class="l674zvrwy"/><path class="kzykk8swa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-samsung-28" /></template>
<style>
.kzykk8swa {
  fill: none;
  stroke: currentColor;
