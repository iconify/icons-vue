...
const content = `<path class="r164pyv9c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tag-multiple-20-filled" /></template>
<style>
.r164pyv9c {
  fill: currentColor;
