...
const content = `<path class="f8h_-lmht"/><defs><path id="SVGPedepbtP" class="us6dcifmo"/></defs><clipPath id="SVGOq0aqePL"><use href="#SVGPedepbtP"/></clipPath><g clip-path="url(#SVGOq0aqePL)" class="qln5uhbpq"><path class="g6qubybib"/></g><defs><use href="#SVGPedepbtP" id="SVGVjsgUc5R"/></defs><clipPath id="SVGXRcECbgN"><use href="#SVGVjsgUc5R"/></clipPath><g clip-path="url(#SVGXRcECbgN)" class="oadpy4acg"><path class="gw7qssbko"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:left-facing-fist-light-skin-tone" /></template>
<style>
.f8h_-lmht {
