...
const content = `<path class="d2w6475sn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-panorama-vertical-select" /></template>
<style>
.d2w6475sn {
  fill: currentColor;
