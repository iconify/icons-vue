...
const content = `<path class="sohw0cbws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dine-heart" /></template>
<style>
.sohw0cbws {
  fill: currentColor;
