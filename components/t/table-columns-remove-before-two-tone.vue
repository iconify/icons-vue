...
const content = `<g class="nrj6p8qat"><path class="txzca0s1j"/><path class="b458ftblo"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:table-columns-remove-before-two-tone" /></template>
<style>
.b458ftblo {
