...
const content = `<path class="uig-gb4_c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dark-mode-rounded" /></template>
<style>
.uig-gb4_c {
  fill: currentColor;
