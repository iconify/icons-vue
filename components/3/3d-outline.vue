...
const content = `<path class="tixrdsbtp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:3d-outline" /></template>
<style>
.tixrdsbtp {
  fill: currentColor;
