...
const content = `<path class="yev19c4ck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:star-one-quarter-24-regular" /></template>
<style>
.yev19c4ck {
  fill: currentColor;
