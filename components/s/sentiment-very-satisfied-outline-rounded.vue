...
const content = `<path class="fvzq7f11h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sentiment-very-satisfied-outline-rounded" /></template>
<style>
.fvzq7f11h {
  fill: currentColor;
