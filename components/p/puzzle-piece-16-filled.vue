...
const content = `<path class="eygmr6t4k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:puzzle-piece-16-filled" /></template>
<style>
.eygmr6t4k {
  fill: currentColor;
