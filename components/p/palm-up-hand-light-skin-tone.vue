...
const content = `<path class="dgzkn7-pf"/><defs><path id="SVGdjInfc6d" class="gfzoxqb1y"/></defs><clipPath id="SVGjWQ7YdvK"><use href="#SVGdjInfc6d"/></clipPath><g clip-path="url(#SVGjWQ7YdvK)" class="qln5uhbpq"><path class="o6g99psbz"/></g><defs><use href="#SVGdjInfc6d" id="SVGaxRnVTZI"/></defs><clipPath id="SVG3VfbbcMt"><use href="#SVGaxRnVTZI"/></clipPath><g clip-path="url(#SVG3VfbbcMt)" class="oadpy4acg"><path class="xhh92bcld"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:palm-up-hand-light-skin-tone" /></template>
<style>
.dgzkn7-pf {
