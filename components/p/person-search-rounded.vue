...
const content = `<path class="yj7apvfos"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:person-search-rounded" /></template>
<style>
.yj7apvfos {
  fill: currentColor;
