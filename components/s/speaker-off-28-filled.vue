...
const content = `<path class="dwjx3lb7y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-off-28-filled" /></template>
<style>
.dwjx3lb7y {
  fill: currentColor;
