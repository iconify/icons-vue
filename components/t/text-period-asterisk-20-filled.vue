...
const content = `<path class="aig44hb1s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-period-asterisk-20-filled" /></template>
<style>
.aig44hb1s {
  fill: currentColor;
