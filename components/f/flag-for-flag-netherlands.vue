...
const content = `<path class="t76_qd-2z"/><path class="n8-91eb0z"/><path class="gxshwrbot"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-netherlands" /></template>
<style>
.gxshwrbot {
