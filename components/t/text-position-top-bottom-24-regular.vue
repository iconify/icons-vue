...
const content = `<path class="qk5lzs7fe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-top-bottom-24-regular" /></template>
<style>
.qk5lzs7fe {
  fill: currentColor;
