...
const content = `<path class="x215y1u5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pages-outline-rounded" /></template>
<style>
.x215y1u5x {
  fill: currentColor;
