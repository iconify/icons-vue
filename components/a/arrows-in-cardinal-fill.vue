...
const content = `<path class="oh245ee6b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrows-in-cardinal-fill" /></template>
<style>
.oh245ee6b {
  fill: currentColor;
