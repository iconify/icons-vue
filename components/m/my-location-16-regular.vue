...
const content = `<path class="bnyqwoobk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:my-location-16-regular" /></template>
<style>
.bnyqwoobk {
  fill: currentColor;
