...
const content = `<path class="ekzuqenpe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:view-desktop-mobile-24-regular" /></template>
<style>
.ekzuqenpe {
  fill: currentColor;
