...
const content = `<path class="ncmp9hb2x"/><path clip-rule="evenodd" class="mur_2ibsm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-zed" /></template>
<style>
.mur_2ibsm {
  fill-rule: evenodd;
