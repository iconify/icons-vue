...
const content = `<path class="walz67rrg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-grammar-lightning-28-filled" /></template>
<style>
.walz67rrg {
  fill: currentColor;
