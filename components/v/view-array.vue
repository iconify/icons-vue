...
const content = `<path class="qou9gjzbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:view-array" /></template>
<style>
.qou9gjzbq {
  fill: currentColor;
