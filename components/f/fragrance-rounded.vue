...
const content = `<path class="guko3gb-u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fragrance-rounded" /></template>
<style>
.guko3gb-u {
  fill: currentColor;
