...
const content = `<path class="b7ndhubee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:folder-code-sharp" /></template>
<style>
.b7ndhubee {
  fill: currentColor;
