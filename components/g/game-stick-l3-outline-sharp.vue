...
const content = `<path class="d57rambzp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:game-stick-l3-outline-sharp" /></template>
<style>
.d57rambzp {
  fill: currentColor;
