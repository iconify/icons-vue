...
const content = `<circle class="mvuunccaj"/><path class="sdny4rbat"/><path class="marzq08vn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:device-utility" /></template>
<style>
.marzq08vn {
  fill: none;
  stroke: currentColor;
...
.sdny4rbat {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M34.89 30.29V17.71L24 11.43l-10.89 6.28v12.58L24 36.57z");
}
