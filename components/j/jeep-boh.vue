...
const content = `<path class="i9clfwm2k"/><path class="k_w5heb-s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:jeep-boh" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
