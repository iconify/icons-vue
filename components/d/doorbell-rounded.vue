...
const content = `<path class="ns7qx4b-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:doorbell-rounded" /></template>
<style>
.ns7qx4b-y {
  fill: currentColor;
