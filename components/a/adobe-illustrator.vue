...
const content = `<rect class="d6z7lqbkq"/><path class="k741brict"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:adobe-illustrator" /></template>
<style>
.d6z7lqbkq {
  width: 256px;
  height: 249.6px;
