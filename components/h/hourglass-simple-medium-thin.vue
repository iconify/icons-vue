...
const content = `<path class="ltgdc7qxd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:hourglass-simple-medium-thin" /></template>
<style>
.ltgdc7qxd {
  fill: currentColor;
