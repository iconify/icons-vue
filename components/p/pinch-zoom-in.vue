...
const content = `<path class="whoh9w8vk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pinch-zoom-in" /></template>
<style>
.whoh9w8vk {
  fill: currentColor;
