...
const content = `<path class="ovd28vb4v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-circle-double-right" /></template>
<style>
.ovd28vb4v {
  fill: currentColor;
