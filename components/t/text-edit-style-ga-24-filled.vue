...
const content = `<g class="ft5dv1b6b"><path class="pc_o23b6g"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-edit-style-ga-24-filled" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
