...
const content = `<path class="fsg5_ubsv"/><rect class="tk1y-acic"/><path class="s4_gmnovw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dasher" /></template>
<style>
.fsg5_ubsv {
  fill: none;
  stroke: currentColor;
