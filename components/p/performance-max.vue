...
const content = `<path class="ejnfv6tpc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:performance-max" /></template>
<style>
.ejnfv6tpc {
  fill: currentColor;
