...
const content = `<g class="cuyn6tgcc"><path class="esl9iju3d"/><path class="in9uwmx8k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:compass-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.esl9iju3d {
  d: path("M128 32a96 96 0 1 0 96 96a96 96 0 0 0-96-96m16 112l-64 32l32-64l64-32Z");
