...
const content = `<path class="ygqqx7bql"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-text-28-regular" /></template>
<style>
.ygqqx7bql {
  fill: currentColor;
