...
const content = `<path class="w06whobly"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:femur-alt-rounded" /></template>
<style>
.w06whobly {
  fill: currentColor;
