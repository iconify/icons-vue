...
const content = `<path class="o94qydtpm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:scooter-outline-rounded" /></template>
<style>
.o94qydtpm {
  fill: currentColor;
