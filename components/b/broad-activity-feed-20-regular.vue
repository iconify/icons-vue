...
const content = `<path class="jd0r_m-vo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:broad-activity-feed-20-regular" /></template>
<style>
.jd0r_m-vo {
  fill: currentColor;
