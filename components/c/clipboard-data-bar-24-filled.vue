...
const content = `<path class="sx8y852bc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-data-bar-24-filled" /></template>
<style>
.sx8y852bc {
  fill: currentColor;
