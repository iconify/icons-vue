...
const content = `<path class="x-dvctflr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:receipt-cube-20-regular" /></template>
<style>
.x-dvctflr {
  fill: currentColor;
