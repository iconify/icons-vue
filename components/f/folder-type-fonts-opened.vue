...
const content = `<path class="q_xqj5t4o"/><path class="beot0_hxg"/><path class="wamm93s3y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-fonts-opened" /></template>
<style>
.beot0_hxg {
