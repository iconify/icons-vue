...
const content = `<path class="kgmg8wb8i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:toggle-multiple-20-regular" /></template>
<style>
.kgmg8wb8i {
  fill: currentColor;
