...
const content = `<path class="cy_u8vbpu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:splitscreen-landscape-outline" /></template>
<style>
.cy_u8vbpu {
  fill: currentColor;
