...
const content = `<path class="wa-e8acav"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:incognito-32-regular" /></template>
<style>
.wa-e8acav {
  fill: currentColor;
