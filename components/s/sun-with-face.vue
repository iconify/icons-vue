...
const content = `<g class="aed_zrbyo"><path class="co7xjpg4a"/><path class="zo50aybfg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:sun-with-face" /></template>
<style>
.aed_zrbyo {
