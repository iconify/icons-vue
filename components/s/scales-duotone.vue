...
const content = `<g class="cuyn6tgcc"><path class="ood7rob_j"/><path class="kihzxjujd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:scales-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
