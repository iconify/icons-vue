...
const content = `<path class="h2h2hmbfm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:brick-outline-rounded" /></template>
<style>
.h2h2hmbfm {
  fill: currentColor;
