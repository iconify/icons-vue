...
const content = `<path class="roa046b6e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-settings-28-regular" /></template>
<style>
.roa046b6e {
  fill: currentColor;
