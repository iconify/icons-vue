...
const content = `<path class="hw33z0c_p"/><path class="plsh0ebyj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:yamaps" /></template>
<style>
.hw33z0c_p {
  fill: none;
  stroke: currentColor;
