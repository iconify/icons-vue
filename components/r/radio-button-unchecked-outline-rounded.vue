...
const content = `<path class="s_lmssb4t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:radio-button-unchecked-outline-rounded" /></template>
<style>
.s_lmssb4t {
  fill: currentColor;
