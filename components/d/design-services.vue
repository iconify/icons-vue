...
const content = `<path class="tfoj4jbpb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:design-services" /></template>
<style>
.tfoj4jbpb {
  fill: currentColor;
