...
const content = `<path class="fr0y7k63j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-desktop-28-regular" /></template>
<style>
.fr0y7k63j {
  fill: currentColor;
