...
const content = `<g class="cuyn6tgcc"><g class="xyjtgccot"><path clip-rule="evenodd" class="f0lj31bio"/><path class="n8u8vib0c"/><path clip-rule="evenodd" class="re_5s3b7r"/><path class="tdlddsubd"/><path clip-rule="evenodd" class="ys1-x_bax"/><path class="acnichwao"/><path clip-rule="evenodd" class="dvt7l-bye"/></g><path clip-rule="evenodd" class="b_drxzbot"/><path clip-rule="evenodd" class="q6zrlybpu"/><path clip-rule="evenodd" class="kzhpbebmd"/><path clip-rule="evenodd" class="dwgs_gdah"/><path class="mo5netbri"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-print:sliders-off" /></template>
