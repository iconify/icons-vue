...
const content = `<path class="q2e67hbpm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:star-rate-outline-sharp" /></template>
<style>
.q2e67hbpm {
  fill: currentColor;
