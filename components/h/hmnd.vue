...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVG23b3SdHk)" class="odg79xbbo"/><path fill="url(#SVGEGA4gbWa)" class="nda2t5b9y"/><defs><linearGradient id="SVG23b3SdHk" x1="12" x2="12" y1="4.125" y2="19.874" gradientUnits="userSpaceOnUse"><stop class="i3azj5r5m"/><stop offset="1" class="yq6u_xb4h"/></linearGradient><linearGradient id="SVGEGA4gbWa" x1="13.845" x2="19.453" y1="15.881" y2="18.969" gradientUnits="userSpaceOnUse"><stop class="z2w44cc9f"/><stop offset="1" class="a-iu01evo"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:hmnd" /></template>
<style>
.a-iu01evo {
  stop-color: var(--svg-color--fec574, #fec574);
}
...
.z2w44cc9f {
  stop-color: var(--svg-color--fdc570, #fdc570);
  stop-opacity: 0;
}
