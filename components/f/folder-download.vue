...
const content = `<path class="h0qgeuwow"/><path class="c7ck3qbxe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:folder-download" /></template>
<style>
.c7ck3qbxe {
  fill: none;
  stroke: currentColor;
