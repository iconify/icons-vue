...
const content = `<path class="rs7odfzbn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:print-add-sharp" /></template>
<style>
.rs7odfzbn {
  fill: currentColor;
