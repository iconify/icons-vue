...
const content = `<path class="f1y5an-jo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:person-remove-rounded" /></template>
<style>
.f1y5an-jo {
  fill: currentColor;
