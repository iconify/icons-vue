...
const content = `<path class="u8r9b-baj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:no-food-sharp" /></template>
<style>
.u8r9b-baj {
  fill: currentColor;
