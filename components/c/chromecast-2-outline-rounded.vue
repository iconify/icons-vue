...
const content = `<path class="lnavvhl0a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chromecast-2-outline-rounded" /></template>
<style>
.lnavvhl0a {
  fill: currentColor;
