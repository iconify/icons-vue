...
const content = `<path class="oiiq3ibaa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:man-2-outline-rounded" /></template>
<style>
.oiiq3ibaa {
  fill: currentColor;
