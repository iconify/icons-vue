...
const content = `<path class="nblmvwbat"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:styler-outline-rounded" /></template>
<style>
.nblmvwbat {
  fill: currentColor;
