...
const content = `<path class="lynix2bui"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:outlet-rounded" /></template>
<style>
.lynix2bui {
  fill: currentColor;
