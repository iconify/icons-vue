...
const content = `<path class="cyw334h8y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-clip-off-16-filled" /></template>
<style>
.cyw334h8y {
  fill: currentColor;
