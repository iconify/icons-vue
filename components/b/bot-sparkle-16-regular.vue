...
const content = `<path class="mkctezkva"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bot-sparkle-16-regular" /></template>
<style>
.mkctezkva {
  fill: currentColor;
