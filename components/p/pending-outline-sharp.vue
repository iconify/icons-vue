...
const content = `<path class="hj_nxvbum"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pending-outline-sharp" /></template>
<style>
.hj_nxvbum {
  fill: currentColor;
