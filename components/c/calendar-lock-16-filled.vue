...
const content = `<path class="ha4t3bcie"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-lock-16-filled" /></template>
<style>
.ha4t3bcie {
  fill: currentColor;
