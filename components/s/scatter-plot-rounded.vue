...
const content = `<path class="c7m6o1ihg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:scatter-plot-rounded" /></template>
<style>
.c7m6o1ihg {
  fill: currentColor;
