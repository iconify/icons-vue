...
const content = `<path class="zk9apvbek"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:heavy-division-sign" /></template>
<style>
.zk9apvbek {
