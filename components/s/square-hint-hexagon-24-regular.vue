...
const content = `<path class="v440zaben"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-hexagon-24-regular" /></template>
<style>
.v440zaben {
  fill: currentColor;
