...
const content = `<path class="q_yizpn1r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cultfit" /></template>
<style>
.q_yizpn1r {
  fill: none;
  stroke: currentColor;
