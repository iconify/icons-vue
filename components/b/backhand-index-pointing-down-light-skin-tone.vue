...
const content = `<path class="b9m-1accy"/><defs><path id="SVGzH5l9cSF" class="wyyhjwgri"/></defs><clipPath id="SVG5JRthd0N"><use href="#SVGzH5l9cSF"/></clipPath><g clip-path="url(#SVG5JRthd0N)" class="qln5uhbpq"><path class="lzfbvjbvw"/></g><defs><use href="#SVGzH5l9cSF" id="SVG3kQ6REdG"/></defs><clipPath id="SVGUA7duk8g"><use href="#SVG3kQ6REdG"/></clipPath><g clip-path="url(#SVGUA7duk8g)" class="oadpy4acg"><path class="m8qqmn07k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:backhand-index-pointing-down-light-skin-tone" /></template>
<style>
.b9m-1accy {
