...
const content = `<path class="s3cdiv7yy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-1-48-regular" /></template>
<style>
.s3cdiv7yy {
  fill: currentColor;
