...
const content = `<path class="omcg0dleb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-export-up-16-regular" /></template>
<style>
.omcg0dleb {
  fill: currentColor;
