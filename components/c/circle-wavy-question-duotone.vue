...
const content = `<path class="b-9inxaad"/><path class="k4flu_u9d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:circle-wavy-question-duotone" /></template>
<style>
.b-9inxaad {
  fill: currentColor;
