...
const content = `<path class="her2aeb3r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-accounts-24-filled" /></template>
<style>
.her2aeb3r {
  fill: currentColor;
