...
const content = `<path class="qm6gkfhfy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-taxi-rounded" /></template>
<style>
.qm6gkfhfy {
  fill: currentColor;
