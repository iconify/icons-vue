...
const content = `<path class="gaxidq_-u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:aroma-joes" /></template>
<style>
.gaxidq_-u {
  fill: none;
  stroke: currentColor;
