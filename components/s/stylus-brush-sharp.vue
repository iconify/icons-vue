...
const content = `<path class="u-9y8f2ie"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stylus-brush-sharp" /></template>
<style>
.u-9y8f2ie {
  fill: currentColor;
