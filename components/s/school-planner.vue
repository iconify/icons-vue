...
const content = `<path class="yc__36ryq"/><path class="jn4yse2du"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:school-planner" /></template>
<style>
.jn4yse2du {
  fill: none;
  stroke: currentColor;
