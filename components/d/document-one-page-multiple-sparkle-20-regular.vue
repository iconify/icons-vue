...
const content = `<path class="gxh9pncoi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-one-page-multiple-sparkle-20-regular" /></template>
<style>
.gxh9pncoi {
  fill: currentColor;
