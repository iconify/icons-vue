...
const content = `<path class="verqrpbal"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:walk-bike-outline-rounded" /></template>
<style>
.verqrpbal {
  fill: currentColor;
