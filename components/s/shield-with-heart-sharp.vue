...
const content = `<path class="irhixkoiv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shield-with-heart-sharp" /></template>
<style>
.irhixkoiv {
  fill: currentColor;
