...
const content = `<path class="w1tz4rb8z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:breakdowntimer" /></template>
<style>
.w1tz4rb8z {
  fill: none;
  stroke: currentColor;
