...
const content = `<path class="b1t52bckm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-arrow-down-20-regular" /></template>
<style>
.b1t52bckm {
  fill: currentColor;
