...
const content = `<path class="adokubcgr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:save-search-20-regular" /></template>
<style>
.adokubcgr {
  fill: currentColor;
