...
const content = `<path class="z4xc29tto"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-bottom-expand-20-regular" /></template>
<style>
.z4xc29tto {
  fill: currentColor;
