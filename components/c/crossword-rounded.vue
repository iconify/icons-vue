...
const content = `<path class="vgoy3wsce"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:crossword-rounded" /></template>
<style>
.vgoy3wsce {
  fill: currentColor;
