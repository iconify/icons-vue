...
const content = `<path class="t-ju8jbdq"/><path class="nh6894b9i"/><g class="y9tr6bcfx"><path class="l4vp12b8d"/><path class="jnnej2b_k"/><path class="j4ni2djic"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:next" /></template>
<style>
.j4ni2djic {
  d: path("M15.804 29.015c1.654.028 3.332-1.375 4.324-3.108");
}

.jnnej2b_k {
  d: path("M19.491 32.29c2.047.035 4.13-2.122 4.905-4.384m-10.354 1.068c-.956-1.68 1.243-1.803 2.208-1.623c.98.182 1.825.794 2.045 1.614");
}

.l4vp12b8d {
  d: path("M17.73 32.25c-.957-1.68 1.243-1.804 2.207-1.624c.98.182 1.825.794 2.045 1.614");
}
...
.nh6894b9i {
  ...
  d: path("M19.794 6.843c-2.026-.22-2.032-1.389-1.69-2.261m2.869 1.025c-.837-.302-1.025-.776-.802-1.315M29.942 33.9c.833 9.08-18.566 11.713-15.122 1.247m18.017-5.564c4.033 10.544-10.789 19.348-14.205 10.48");
}
