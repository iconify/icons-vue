...
const content = `<path class="m8_-34bxl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-back-ios-new-rounded" /></template>
<style>
.m8_-34bxl {
  fill: currentColor;
