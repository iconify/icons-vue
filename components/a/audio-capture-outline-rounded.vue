...
const content = `<path class="j1g8o3bdu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:audio-capture-outline-rounded" /></template>
<style>
.j1g8o3bdu {
  fill: currentColor;
