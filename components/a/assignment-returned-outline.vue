...
const content = `<path class="z_68yybuu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:assignment-returned-outline" /></template>
<style>
.z_68yybuu {
  fill: currentColor;
