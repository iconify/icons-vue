...
const content = `<path class="u23da_b8z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:authenticator" /></template>
<style>
.u23da_b8z {
  fill: currentColor;
