...
const content = `<g class="gp_8x1bzb"><path class="cgy2znb4u"/><path class="qj43urbvu"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:cake-sharp" /></template>
<style>
.cgy2znb4u {
