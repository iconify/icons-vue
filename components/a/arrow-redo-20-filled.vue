...
const content = `<path class="tnsv0uesp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-redo-20-filled" /></template>
<style>
.tnsv0uesp {
  fill: currentColor;
