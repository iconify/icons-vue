...
const content = `<path class="zhf1v50de"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:paint-bucket-20-filled" /></template>
<style>
.zhf1v50de {
  fill: currentColor;
