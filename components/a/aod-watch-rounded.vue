...
const content = `<path class="jyh0tub0o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:aod-watch-rounded" /></template>
<style>
.jyh0tub0o {
  fill: currentColor;
