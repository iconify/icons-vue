...
const content = `<path class="uok0usfdp"/><path class="d7g4idb-l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:deufeitage" /></template>
<style>
.d7g4idb-l {
  fill: none;
  stroke: currentColor;
