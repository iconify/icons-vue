...
const content = `<path class="y77rpachu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-timer" /></template>
<style>
.y77rpachu {
  fill: currentColor;
