...
const content = `<path class="hclr1sb_w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:explore-rounded" /></template>
<style>
.hclr1sb_w {
  fill: currentColor;
