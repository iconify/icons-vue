...
const content = `<path class="fnbr18bid"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:commerzbank-banking" /></template>
<style>
.fnbr18bid {
  fill: none;
  stroke: currentColor;
