...
const content = `<path class="qhc-gibsw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-ribbon-28-regular" /></template>
<style>
.qhc-gibsw {
  fill: currentColor;
