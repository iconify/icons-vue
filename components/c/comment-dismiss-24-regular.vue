...
const content = `<path class="mw7m0kbsz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-dismiss-24-regular" /></template>
<style>
.mw7m0kbsz {
  fill: currentColor;
