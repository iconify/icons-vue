...
const content = `<path class="axgi38k0g"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mgr-online" /></template>
<style>
.axgi38k0g {
  fill: none;
  stroke: currentColor;
