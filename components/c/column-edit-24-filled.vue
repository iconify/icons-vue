...
const content = `<path class="cb3fulg7r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:column-edit-24-filled" /></template>
<style>
.cb3fulg7r {
  fill: currentColor;
