...
const content = `<path class="oq0p9fbqs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:winzip" /></template>
<style>
.oq0p9fbqs {
  fill: none;
  stroke: currentColor;
