...
.ta9mbzgvl {
  ...
  d: path("M89 89.1H39c-2.21 0-4-1.79-4-4s1.79-4 4-4h50c2.21 0 4 1.79 4 4s-1.79 4-4 4M44.82 43.04c-4.19 0-8 3.54-8 9.42s3.81 9.42 8 9.42s8-3.54 8-9.42s-3.81-9.42-8-9.42");
}
...
.wdykbqy_j {
  fill: var(--svg-color--422b0d, #422b0d);
  d: path("M83.18 43.04c-4.19 0-8 3.54-8 9.42s3.81 9.42 8 9.42s8-3.54 8-9.42s-3.81-9.42-8-9.42");
}
...
.yr249lbky {
  fill: var(--svg-color--896024, #896024);
  d: path("M44.43 46.97c-1.03-.72-2.58-.49-3.58.95s-.67 2.97.36 3.69s2.58.49 3.58-.95c1-1.45.67-2.97-.36-3.69");
}
