...
const content = `<g class="nrj6p8qat"><path class="xgaf0nbdt"/><path class="ianaz7b0e"/><path class="ff45hndep"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-info" /></template>
<style>
.ff45hndep {
  fill: currentColor;
  d: path("M13 7C13 6.4477 12.5523 6 12 6C11.4477 6 11 6.4477 11 7C11 7.5523 11.4477 8 12 8C12.5523 8 13 7.5523 13 7Z");
  stroke: none;
}
