...
const content = `<path class="d96deg_lu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phone-cancel-sharp" /></template>
<style>
.d96deg_lu {
  fill: currentColor;
