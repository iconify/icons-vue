...
const content = `<path class="jll2mjqid"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-saver-outline" /></template>
<style>
.jll2mjqid {
  fill: currentColor;
