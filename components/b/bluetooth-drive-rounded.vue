...
const content = `<path class="yk0bdk_lr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bluetooth-drive-rounded" /></template>
<style>
.yk0bdk_lr {
  fill: currentColor;
