...
const content = `<g class="gp_8x1bzb"><path class="u_vjevdkc"/><path class="a57frnbtw"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:git-x-sharp-two-tone" /></template>
<style>
.a57frnbtw {
