...
const content = `<path class="u5-ni2b4p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-search-24-filled" /></template>
<style>
.u5-ni2b4p {
  fill: currentColor;
