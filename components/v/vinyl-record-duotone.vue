...
const content = `<g class="cuyn6tgcc"><path class="y66rv31of"/><path class="phrf_jbcx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:vinyl-record-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.y66rv31of {
  d: path("M128 32a96 96 0 1 0 96 96a96 96 0 0 0-96-96m0 120a24 24 0 1 1 24-24a24 24 0 0 1-24 24");
