...
const content = `<path class="luodt47mg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-arrow-right-48-filled" /></template>
<style>
.luodt47mg {
  fill: currentColor;
