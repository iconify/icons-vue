...
const content = `<path class="mzaouji8i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:surface-hub-24-regular" /></template>
<style>
.mzaouji8i {
  fill: currentColor;
