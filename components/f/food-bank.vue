...
const content = `<path class="u8axolb6v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:food-bank" /></template>
<style>
.u8axolb6v {
  fill: currentColor;
