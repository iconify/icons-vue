...
const content = `<circle class="ly-ophbks"/><path class="r15lkccaa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tim-hortons" /></template>
<style>
.ly-ophbks {
  cx: 22.574px;
  cy: 14.883px;
