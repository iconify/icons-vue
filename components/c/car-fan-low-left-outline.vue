...
const content = `<path class="jm-8--iuk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-fan-low-left-outline" /></template>
<style>
.jm-8--iuk {
  fill: currentColor;
