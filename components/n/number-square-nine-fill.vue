...
const content = `<path class="k8-xwhbll"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-nine-fill" /></template>
<style>
.k8-xwhbll {
  fill: currentColor;
