...
const content = `<path class="meq3qabck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:translate-cc" /></template>
<style>
.meq3qabck {
  fill: currentColor;
