...
const content = `<path class="rweoibxik"/><path class="cffli1b-r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:blackplayer" /></template>
<style>
.cffli1b-r {
  fill: none;
  stroke: currentColor;
