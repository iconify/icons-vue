...
const content = `<path class="h49_jobtm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:meal-dinner" /></template>
<style>
.h49_jobtm {
  fill: currentColor;
