...
const content = `<path class="h4z-dnbgk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ev-mobiledata-badge-outline-rounded" /></template>
<style>
.h4z-dnbgk {
  fill: currentColor;
