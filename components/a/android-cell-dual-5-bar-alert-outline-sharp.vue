...
const content = `<path class="iyd4k9bqx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:android-cell-dual-5-bar-alert-outline-sharp" /></template>
<style>
.iyd4k9bqx {
  fill: currentColor;
