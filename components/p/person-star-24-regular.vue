...
const content = `<path class="hzrqucbfk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-star-24-regular" /></template>
<style>
.hzrqucbfk {
  fill: currentColor;
