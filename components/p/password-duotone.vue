...
const content = `<g class="cuyn6tgcc"><path class="f5796ccqh"/><path class="zov2iab2f"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:password-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.f5796ccqh {
  d: path("M256 72v112a16 16 0 0 1-16 16H16a16 16 0 0 1-16-16V72a16 16 0 0 1 16-16h224a16 16 0 0 1 16 16");
