...
const content = `<path class="nwju0tbao"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:microsoft-teams-logo-bold" /></template>
<style>
.nwju0tbao {
  fill: currentColor;
