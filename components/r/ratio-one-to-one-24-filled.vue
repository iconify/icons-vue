...
const content = `<path class="el5mwot-n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:ratio-one-to-one-24-filled" /></template>
<style>
.el5mwot-n {
  fill: currentColor;
