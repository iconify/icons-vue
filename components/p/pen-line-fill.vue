...
const content = `<g class="nrj6p8qat"><path class="hble56f9w"/><path class="fpvahdpsw"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:pen-line-fill" /></template>
<style>
.fpvahdpsw {
