...
const content = `<path class="dj4oepbtu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:g-mobiledata-badge-outline" /></template>
<style>
.dj4oepbtu {
  fill: currentColor;
