...
const content = `<path class="w4nztuu5h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flashlight-off-20-filled" /></template>
<style>
.w4nztuu5h {
  fill: currentColor;
