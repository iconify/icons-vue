...
const content = `<path class="ps-0dvqzj"/><path class="gl86mqbeq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:blizzardauthenticator" /></template>
<style>
.gl86mqbeq {
  fill: none;
  stroke: currentColor;
