...
const content = `<path class="xhacgihmw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:selection-background-fill" /></template>
<style>
.xhacgihmw {
  fill: currentColor;
