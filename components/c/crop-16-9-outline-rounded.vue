...
const content = `<path class="bi2cr7m0e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:crop-16-9-outline-rounded" /></template>
<style>
.bi2cr7m0e {
  fill: currentColor;
