...
const content = `<g class="cuyn6tgcc"><path class="lg4tcoiwl"/><path class="w7cr0gb5d"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:threads-logo-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
