...
const content = `<path class="aub_vtb6z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-chat-28-regular" /></template>
<style>
.aub_vtb6z {
  fill: currentColor;
