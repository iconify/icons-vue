...
const content = `<g class="gtkpbccoc"><path class="f_atgtb3w"/><path class="wwrq5ik6c"/><path class="es6pm8bzc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:trava" /></template>
<style>
.es6pm8bzc {
  d: path("M17.294 8.595c-.64.392-1.286.784-1.921 1.186a.14.14 0 0 1-.17 0L8.745 5.97a.14.14 0 0 0-.164 0c-1.128.688-2.255 1.366-3.388 2.048a.13.13 0 0 0-.074.138V12c-.043.006-.059-.016-.085-.032l-1.959-1.143a.13.13 0 0 1-.074-.132v-3.76a.14.14 0 0 1 .08-.132l5.505-3.245a.13.13 0 0 1 .159 0l.836.492l7.644 4.5z");
}

.f_atgtb3w {
  d: path("m10.708 8.981l-1.165.667c-.227.138-.391.27-.63.402a.15.15 0 0 0-.068.059a.15.15 0 0 0-.021.095v5.717a.12.12 0 0 0 .063.122c1.043.635 2.012 1.281 3.054 1.927a.11.11 0 0 0 .128 0l5.14-3.06c.085-.047.085-.047.085.053v2.229c0 .026 0 .053-.016.074a.12.12 0 0 1-.053.053L12.1 20.442a.15.15 0 0 1-.174 0l-5.146-3.08a.13.13 0 0 1-.053-.054a.13.13 0 0 1-.02-.074V9.05a.13.13 0 0 1 .073-.127L8.628 7.79a.13.13 0 0 1 .159 0l1.836 1.128q.054.017.085.063");
}
