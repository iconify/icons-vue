...
const content = `<path class="kidnwsyfk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dismiss-circle-32-light" /></template>
<style>
.kidnwsyfk {
  fill: currentColor;
