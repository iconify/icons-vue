...
const content = `<path class="bwdre11tf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:request-quote-rounded" /></template>
<style>
.bwdre11tf {
  fill: currentColor;
