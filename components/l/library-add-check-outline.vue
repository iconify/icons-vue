...
const content = `<path class="ktgblvbyh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:library-add-check-outline" /></template>
<style>
.ktgblvbyh {
  fill: currentColor;
