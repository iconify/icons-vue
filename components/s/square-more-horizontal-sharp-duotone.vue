...
const content = `<g class="cuyn6tgcc"><path class="l6fbk-bit"/><path class="drqjmflhv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-more-horizontal-sharp-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
