...
const content = `<path class="hi_-ybldx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:speaker-simple-none-thin" /></template>
<style>
.hi_-ybldx {
  fill: currentColor;
