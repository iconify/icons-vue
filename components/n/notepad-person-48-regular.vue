...
const content = `<path class="akyepbadq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notepad-person-48-regular" /></template>
<style>
.akyepbadq {
  fill: currentColor;
