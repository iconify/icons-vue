...
const content = `<g class="nrj6p8qat"><path class="l-quodbjv"/><path class="mxr27sfts"/><path class="q054rm63k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:git-pull-request-draft-two-tone" /></template>
<style>
.l-quodbjv {
  fill: currentColor;
