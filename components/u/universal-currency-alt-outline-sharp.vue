...
const content = `<path class="ts6mkw9np"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:universal-currency-alt-outline-sharp" /></template>
<style>
.ts6mkw9np {
  fill: currentColor;
