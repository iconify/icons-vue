...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGRq2sjZzn)" clip-rule="evenodd" class="za5h5mpri"/><defs><linearGradient id="SVGRq2sjZzn" x1="12" x2="12" y1="3.56" y2="20.434" gradientUnits="userSpaceOnUse"><stop class="txrgv-pxc"/><stop offset="1" class="u0lfcebpw"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:srlty" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
