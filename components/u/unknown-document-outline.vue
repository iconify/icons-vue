...
const content = `<path class="q8r3xgxcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:unknown-document-outline" /></template>
<style>
.q8r3xgxcs {
  fill: currentColor;
