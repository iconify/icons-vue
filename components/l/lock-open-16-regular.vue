...
const content = `<path class="pvtqpmbnz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:lock-open-16-regular" /></template>
<style>
.pvtqpmbnz {
  fill: currentColor;
