...
const content = `<ellipse class="a6307mbck"/><path class="m-w19gbcf"/><path class="t8pxiubsl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:pouting-cat-face" /></template>
<style>
.a6307mbck {
  cx: 61.75px;
  cy: 83.35px;
