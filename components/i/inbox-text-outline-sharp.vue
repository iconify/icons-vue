...
const content = `<path class="n28v44bcp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:inbox-text-outline-sharp" /></template>
<style>
.n28v44bcp {
  fill: currentColor;
