...
const content = `<path class="gwl0w7w8s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:24mp-outline-rounded" /></template>
<style>
.gwl0w7w8s {
  fill: currentColor;
