...
const content = `<path class="kdn6kso_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-ltr-20-filled" /></template>
<style>
.kdn6kso_q {
  fill: currentColor;
