...
const content = `<path class="u5chcobci"/><path class="x_w7mebum"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:detexify" /></template>
<style>
.u5chcobci {
  fill: none;
  stroke: currentColor;
