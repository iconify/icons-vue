...
const content = `<path class="q-480sogm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bookmark-added-rounded" /></template>
<style>
.q-480sogm {
  fill: currentColor;
