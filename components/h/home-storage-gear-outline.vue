...
const content = `<path class="fplgcqcbi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:home-storage-gear-outline" /></template>
<style>
.fplgcqcbi {
  fill: currentColor;
