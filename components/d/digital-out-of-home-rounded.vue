...
const content = `<path class="xfc-yrbvz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:digital-out-of-home-rounded" /></template>
<style>
.xfc-yrbvz {
  fill: currentColor;
