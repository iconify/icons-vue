...
const content = `<path class="bd5qw5b9s"/><circle class="ylquf2d4x"/><path class="x76b07xvl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bulbapedia" /></template>
<style>
.bd5qw5b9s {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M34.219 6.546c.94 2.295 2.827 2.905 4.144 3.596");
}
