...
const content = `<g class="cuyn6tgcc"><path class="r43vr8y9y"/><path class="y6kwbd_wj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:eyedropper-sample-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
