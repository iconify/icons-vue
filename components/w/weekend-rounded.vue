...
const content = `<path class="g2_bdp2zi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:weekend-rounded" /></template>
<style>
.g2_bdp2zi {
  fill: currentColor;
