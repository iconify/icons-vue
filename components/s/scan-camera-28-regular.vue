...
const content = `<path class="g53z7uqlh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-camera-28-regular" /></template>
<style>
.g53z7uqlh {
  fill: currentColor;
