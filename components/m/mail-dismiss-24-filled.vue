...
const content = `<path class="k9e70-bvv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-dismiss-24-filled" /></template>
<style>
.k9e70-bvv {
  fill: currentColor;
