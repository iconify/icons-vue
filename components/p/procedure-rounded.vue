...
const content = `<path class="t8l-ovbby"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:procedure-rounded" /></template>
<style>
.t8l-ovbby {
  fill: currentColor;
