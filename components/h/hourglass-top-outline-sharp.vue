...
const content = `<path class="jh2xxeb3z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:hourglass-top-outline-sharp" /></template>
<style>
.jh2xxeb3z {
  fill: currentColor;
