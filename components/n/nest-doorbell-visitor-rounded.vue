...
const content = `<path class="nudac3l9d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-doorbell-visitor-rounded" /></template>
<style>
.nudac3l9d {
  fill: currentColor;
