...
const content = `<path class="wg5-t5bvn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phone-disabled-rounded" /></template>
<style>
.wg5-t5bvn {
  fill: currentColor;
