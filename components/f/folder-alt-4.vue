...
const content = `<path class="h0qgeuwow"/><path class="rbokjn7vv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:folder-alt-4" /></template>
<style>
.h0qgeuwow {
  fill: none;
  stroke: currentColor;
