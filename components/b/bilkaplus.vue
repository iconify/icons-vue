...
const content = `<path class="nm-_wcb_u"/><ellipse class="zfoapfb-e"/><path class="h0djpp6fv"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bilkaplus" /></template>
<style>
.h0djpp6fv {
  fill: none;
  stroke: currentColor;
...
.nm-_wcb_u {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M14.532 16.328c1.448 0 2.633 1.176 2.633 2.612s-1.185 2.613-2.633 2.613H10.19V11.104h4.342c1.448 0 2.633 1.176 2.633 2.612s-1.185 2.612-2.633 2.612m0 0h-4.341");
}
