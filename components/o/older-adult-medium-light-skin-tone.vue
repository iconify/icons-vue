...
const content = `<path class="l6k-98_3h"/><path class="aq-7szbux"/><path class="sbpdpfbix"/><path class="c-ntt1b8g"/><path class="ut2d5ibrr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:older-adult-medium-light-skin-tone" /></template>
<style>
.aq-7szbux {
