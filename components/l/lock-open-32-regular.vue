...
const content = `<path class="z4s99rbjh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:lock-open-32-regular" /></template>
<style>
.z4s99rbjh {
  fill: currentColor;
