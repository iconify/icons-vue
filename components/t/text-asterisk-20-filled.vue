...
const content = `<path class="m54aksb_n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-asterisk-20-filled" /></template>
<style>
.m54aksb_n {
  fill: currentColor;
