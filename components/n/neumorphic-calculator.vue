...
const content = `<path class="ejai3-bbc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:neumorphic-calculator" /></template>
<style>
.ejai3-bbc {
  fill: none;
  stroke: currentColor;
