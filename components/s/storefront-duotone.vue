...
const content = `<g class="cuyn6tgcc"><path class="r2268zjxa"/><path class="vu9d-7b8x"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:storefront-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.r2268zjxa {
  d: path("M224 96v16a32 32 0 0 1-64 0V96H96v16a32 32 0 0 1-64 0V96l14.34-50.2A8 8 0 0 1 54 40h148a8 8 0 0 1 7.69 5.8Z");
