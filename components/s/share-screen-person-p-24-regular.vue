...
const content = `<path class="w83s454yn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-screen-person-p-24-regular" /></template>
<style>
.w83s454yn {
  fill: currentColor;
