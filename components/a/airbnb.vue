...
const content = `<path class="q_l19pndb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:airbnb" /></template>
<style>
.q_l19pndb {
  fill: none;
  stroke: currentColor;
