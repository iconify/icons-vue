...
const content = `<path class="wvflk6bvm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:poker-chip-outline-rounded" /></template>
<style>
.wvflk6bvm {
  fill: currentColor;
