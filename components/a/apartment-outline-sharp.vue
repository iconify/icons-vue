...
const content = `<path class="uxrjj95qy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:apartment-outline-sharp" /></template>
<style>
.uxrjj95qy {
  fill: currentColor;
