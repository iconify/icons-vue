...
const content = `<path class="ublvmn24m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:parking-sign-sharp" /></template>
<style>
.ublvmn24m {
  fill: currentColor;
