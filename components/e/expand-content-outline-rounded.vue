...
const content = `<path class="jlu-acc6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:expand-content-outline-rounded" /></template>
<style>
.jlu-acc6i {
  fill: currentColor;
