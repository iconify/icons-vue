...
const content = `<path class="oxy28obfi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-inside-20-regular" /></template>
<style>
.oxy28obfi {
  fill: currentColor;
