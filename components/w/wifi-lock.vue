...
const content = `<path class="vjskedb-b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wifi-lock" /></template>
<style>
.vjskedb-b {
  fill: currentColor;
