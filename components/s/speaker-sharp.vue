...
const content = `<path class="av1ni5b-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:speaker-sharp" /></template>
<style>
.av1ni5b-y {
  fill: currentColor;
