...
const content = `<path class="n6qd1hirg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vertical-shades-closed-rounded" /></template>
<style>
.n6qd1hirg {
  fill: currentColor;
