...
const content = `<path class="qwy0sbcex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:audio-file-outline" /></template>
<style>
.qwy0sbcex {
  fill: currentColor;
