...
const content = `<path class="ij--4ebys"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:video-call-rounded" /></template>
<style>
.ij--4ebys {
  fill: currentColor;
