...
const content = `<path class="k1k5hrwjy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chess-rook" /></template>
<style>
.k1k5hrwjy {
  fill: currentColor;
