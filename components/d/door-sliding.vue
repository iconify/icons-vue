...
const content = `<path class="dgbs68_2o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:door-sliding" /></template>
<style>
.dgbs68_2o {
  fill: currentColor;
