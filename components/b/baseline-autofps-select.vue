...
const content = `<path class="x6spekq-o"/><path class="jxdmxab3w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-autofps-select" /></template>
<style>
.jxdmxab3w {
  fill: currentColor;
