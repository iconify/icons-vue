...
const content = `<g class="nrj6p8qat"><path clip-rule="evenodd" class="yjhxynbfp"/><path class="v_n61vb4y"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:server-minus-fill" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
