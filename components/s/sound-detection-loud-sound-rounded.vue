...
const content = `<path class="es7n5obbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sound-detection-loud-sound-rounded" /></template>
<style>
.es7n5obbl {
  fill: currentColor;
