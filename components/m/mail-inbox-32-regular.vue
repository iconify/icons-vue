...
const content = `<path class="sdcncpbys"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-inbox-32-regular" /></template>
<style>
.sdcncpbys {
  fill: currentColor;
