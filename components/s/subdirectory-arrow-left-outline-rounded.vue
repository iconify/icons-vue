...
const content = `<path class="kg5b52cgo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:subdirectory-arrow-left-outline-rounded" /></template>
<style>
.kg5b52cgo {
  fill: currentColor;
