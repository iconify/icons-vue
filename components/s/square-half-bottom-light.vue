...
const content = `<path class="fwgprdbmx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:square-half-bottom-light" /></template>
<style>
.fwgprdbmx {
  fill: currentColor;
