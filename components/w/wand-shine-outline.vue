...
const content = `<path class="wzuk611pn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wand-shine-outline" /></template>
<style>
.wzuk611pn {
  fill: currentColor;
