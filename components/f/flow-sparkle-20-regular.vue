...
const content = `<path class="v6d-t3bdp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flow-sparkle-20-regular" /></template>
<style>
.v6d-t3bdp {
  fill: currentColor;
