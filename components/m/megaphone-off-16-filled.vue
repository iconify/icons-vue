...
const content = `<path class="qu0apzqxp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:megaphone-off-16-filled" /></template>
<style>
.qu0apzqxp {
  fill: currentColor;
