...
const content = `<path class="iq3vmcb7a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:unknown-med-outline-rounded" /></template>
<style>
.iq3vmcb7a {
  fill: currentColor;
