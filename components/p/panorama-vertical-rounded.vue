...
const content = `<path class="n0gr_eccv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:panorama-vertical-rounded" /></template>
<style>
.n0gr_eccv {
  fill: currentColor;
