...
const content = `<path class="xhz2zzlee"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:chikichiki" /></template>
<style>
.xhz2zzlee {
  fill: none;
  stroke: currentColor;
