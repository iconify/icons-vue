...
const content = `<path class="k33quzqqe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:partner-heart-rounded" /></template>
<style>
.k33quzqqe {
  fill: currentColor;
