...
const content = `<path class="mx3u0vl8o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:touch-long-outline" /></template>
<style>
.mx3u0vl8o {
  fill: currentColor;
