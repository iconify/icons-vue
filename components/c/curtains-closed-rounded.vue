...
const content = `<path class="td-6pli-v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:curtains-closed-rounded" /></template>
<style>
.td-6pli-v {
  fill: currentColor;
