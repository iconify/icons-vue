...
const content = `<path class="jgjyddcmd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:h-plus-mobiledata-badge" /></template>
<style>
.jgjyddcmd {
  fill: currentColor;
