...
const content = `<path class="dkqycepzl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chat-paste-go" /></template>
<style>
.dkqycepzl {
  fill: currentColor;
