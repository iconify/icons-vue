...
const content = `<path class="w9tu8qbxw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notebook-lightning-24-regular" /></template>
<style>
.w9tu8qbxw {
  fill: currentColor;
