...
const content = `<path class="ng9rg1b2x"/><path class="l4auw7bjd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:appopsx" /></template>
<style>
.l4auw7bjd {
  fill: none;
  stroke: currentColor;
  ...
  d: path("m23.12 14.67l-7.55 3.12v7.66c0 4.12 8.43 8.05 8.43 8.05s8.43-3.93 8.43-8v-7.71l-7.55-3.12a2.33 2.33 0 0 0-1.76 0M24 33.5v-19M15.57 24h16.86");
}
