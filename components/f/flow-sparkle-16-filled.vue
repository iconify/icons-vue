...
const content = `<path class="xkdjt8uxs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flow-sparkle-16-filled" /></template>
<style>
.xkdjt8uxs {
  fill: currentColor;
