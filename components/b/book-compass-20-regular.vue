...
const content = `<path class="dw7b7vkpb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-compass-20-regular" /></template>
<style>
.dw7b7vkpb {
  fill: currentColor;
