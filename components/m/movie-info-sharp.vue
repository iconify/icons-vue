...
const content = `<path class="w-0argbth"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:movie-info-sharp" /></template>
<style>
.w-0argbth {
  fill: currentColor;
