...
const content = `<path class="rynfl2bqz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-unread-48-filled" /></template>
<style>
.rynfl2bqz {
  fill: currentColor;
