...
const content = `<path class="ig08xyb_a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:add-square-multiple-24-filled" /></template>
<style>
.ig08xyb_a {
  fill: currentColor;
