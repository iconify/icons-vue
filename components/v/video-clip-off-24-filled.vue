...
const content = `<path class="jbdx6gppf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-clip-off-24-filled" /></template>
<style>
.jbdx6gppf {
  fill: currentColor;
