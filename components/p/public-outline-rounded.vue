...
const content = `<path class="wkow3ebyc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:public-outline-rounded" /></template>
<style>
.wkow3ebyc {
  fill: currentColor;
