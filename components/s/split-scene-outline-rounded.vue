...
const content = `<path class="x01s78byb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:split-scene-outline-rounded" /></template>
<style>
.x01s78byb {
  fill: currentColor;
