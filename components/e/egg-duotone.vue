...
const content = `<g class="cuyn6tgcc"><path class="imex7zdcz"/><path class="giep9w19a"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:egg-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
