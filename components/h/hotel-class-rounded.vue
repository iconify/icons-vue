...
const content = `<path class="jz6gwyb2r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hotel-class-rounded" /></template>
<style>
.jz6gwyb2r {
  fill: currentColor;
