...
const content = `<path class="qj281mb6q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:solo-leveling-arise" /></template>
<style>
.qj281mb6q {
  fill: none;
  stroke: currentColor;
