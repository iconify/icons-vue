...
const content = `<path class="p75mzacna"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:contrast-square-outline" /></template>
<style>
.p75mzacna {
  fill: currentColor;
