...
const content = `<path class="dg7knobdl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:no-stroller-outline-rounded" /></template>
<style>
.dg7knobdl {
  fill: currentColor;
