...
const content = `<rect class="j3s9ivbxi"/><path class="h_81d-brv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sky-news" /></template>
<style>
.h_81d-brv {
  fill: none;
  stroke: currentColor;
