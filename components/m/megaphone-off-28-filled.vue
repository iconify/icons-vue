...
const content = `<path class="uimc809db"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:megaphone-off-28-filled" /></template>
<style>
.uimc809db {
  fill: currentColor;
