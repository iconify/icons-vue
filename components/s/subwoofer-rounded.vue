...
const content = `<path class="w0qm76bmd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:subwoofer-rounded" /></template>
<style>
.w0qm76bmd {
  fill: currentColor;
