...
const content = `<path class="yoioebbws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ad-group-rounded" /></template>
<style>
.yoioebbws {
  fill: currentColor;
