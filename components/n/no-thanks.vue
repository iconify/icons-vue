...
const content = `<g class="y9tr6bcfx"><path class="ofgfcwbwq"/><path class="eo6nvrong"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:no-thanks" /></template>
<style>
.eo6nvrong {
