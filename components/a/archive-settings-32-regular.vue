...
const content = `<path class="aefh6gqme"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:archive-settings-32-regular" /></template>
<style>
.aefh6gqme {
  fill: currentColor;
