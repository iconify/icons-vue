...
const content = `<path class="gqp6-3bld"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:science-rounded" /></template>
<style>
.gqp6-3bld {
  fill: currentColor;
