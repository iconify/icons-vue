...
const content = `<path class="yxafj3b9l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:grouped-bar-chart-rounded" /></template>
<style>
.yxafj3b9l {
  fill: currentColor;
