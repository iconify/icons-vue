...
const content = `<g class="ft5dv1b6b"><path class="k1c3sxgdi"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-design-24-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
