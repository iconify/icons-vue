...
const content = `<path class="aj9jxfbio"/><path class="mlxyhlb5p"/><path class="k4n51fjcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-19mp" /></template>
<style>
.aj9jxfbio {
  fill: currentColor;
  d: path("M13.5 6.5H15V8h-1.5z");
}
