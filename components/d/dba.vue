...
const content = `<path class="i9clfwm2k"/><path class="i26r67ujb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dba" /></template>
<style>
.i26r67ujb {
  fill: none;
  stroke: currentColor;
