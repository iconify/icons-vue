...
const content = `<path class="yx0fs2bgq"/><path class="qgklrj5jl"/><path class="fv5gamngk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:trcamera" /></template>
<style>
.fv5gamngk {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M13 28.69a2 2 0 0 1-.59-1.57m2.93 5.27a2.9 2.9 0 0 0 .85 1.18");
}
...
.qgklrj5jl {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M10 27.17c.09-2.94 1.79-6.18 6.48-8.24s11.28-.48 12.49.45c0 0-3.64.08-4.37 1.41c0 0 5.38 3 5.38 7.48s-2.91 6-2.91 6");
}
