...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="uafdunbzf"/><rect class="ilr5o7bbz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:flag" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
