...
const content = `<circle class="cpa8pz1nt"/><circle class="g8ll7b7pf"/><circle class="n3_7dmu3k"/><path class="fdfpz4b3k"/><circle class="yfz3w9lrl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-stream" /></template>
<style>
.cpa8pz1nt {
  cx: 20px;
  cy: 12px;
