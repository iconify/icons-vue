...
const content = `<g class="hntgybcog"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="n708z7b3q"/><path class="ia7llpjvs"/><path class="edletn6ej"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:chart-heatmap-outline-thin" /></template>
<style>
.edletn6ej {
