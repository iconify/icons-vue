...
const content = `<g class="cuyn6tgcc"><path class="ib3jsv8qh"/><path class="vc7pxfzih"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:plant-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
