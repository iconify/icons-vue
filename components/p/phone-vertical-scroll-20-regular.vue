...
const content = `<path class="bclbp778e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-vertical-scroll-20-regular" /></template>
<style>
.bclbp778e {
  fill: currentColor;
