...
const content = `<defs><linearGradient id="SVGYPnorcPn" x1="0%" x2="100%" y1="100%" y2="0%"><stop offset="0%" class="veqob3-an"/><stop offset="100%" class="ktfvysbch"/></linearGradient></defs><path fill="url(#SVGYPnorcPn)" class="tmbkaq7lv"/><path class="zfmmknryg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:aws-shield" /></template>
<style>
.ktfvysbch {
  stop-color: var(--svg-color--ff5252, #ff5252);
}
