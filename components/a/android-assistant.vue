...
const content = `<path class="izchqxlkn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:android-assistant" /></template>
<style>
.izchqxlkn {
  fill: none;
  stroke: currentColor;
