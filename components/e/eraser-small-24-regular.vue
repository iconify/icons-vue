...
const content = `<path class="b9-c6kbfe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:eraser-small-24-regular" /></template>
<style>
.b9-c6kbfe {
  fill: currentColor;
