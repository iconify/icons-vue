...
const content = `<path class="b77npgbvy"/><path class="wa6aekaav"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:beelinguapp" /></template>
<style>
.b77npgbvy {
  fill: none;
  stroke: currentColor;
