...
const content = `<g class="cuyn6tgcc"><path class="i3pncjbtb"/><path class="c58r43hlo"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:medal-duotone" /></template>
<style>
.c58r43hlo {
...
.i3pncjbtb {
  d: path("M176 96a48 48 0 1 1-48-48a48 48 0 0 1 48 48");
