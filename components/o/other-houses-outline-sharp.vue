...
const content = `<path class="op91kob5n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:other-houses-outline-sharp" /></template>
<style>
.op91kob5n {
  fill: currentColor;
