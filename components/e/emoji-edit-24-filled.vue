...
const content = `<path class="xn6y_4bxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-edit-24-filled" /></template>
<style>
.xn6y_4bxi {
  fill: currentColor;
