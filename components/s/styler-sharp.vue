...
const content = `<path class="nsgdqshzk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:styler-sharp" /></template>
<style>
.nsgdqshzk {
  fill: currentColor;
