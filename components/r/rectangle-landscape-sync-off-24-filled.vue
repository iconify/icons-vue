...
const content = `<path class="d6oba_b8q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:rectangle-landscape-sync-off-24-filled" /></template>
<style>
.d6oba_b8q {
  fill: currentColor;
