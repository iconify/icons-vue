...
const content = `<path class="lags3pb9u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-toolbox-24-regular" /></template>
<style>
.lags3pb9u {
  fill: currentColor;
