...
const content = `<path class="jt7-mabjt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tv-with-assistant-sharp" /></template>
<style>
.jt7-mabjt {
  fill: currentColor;
