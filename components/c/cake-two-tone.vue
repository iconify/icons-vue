...
const content = `<g class="nrj6p8qat"><path class="w6-9ocequ"/><path class="iweqpwb-x"/><path class="k_4lfsbqx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:cake-two-tone" /></template>
<style>
.iweqpwb-x {
...
.w6-9ocequ {
  ...
  d: path("M6 10L18 10C19.1046 10 20 10.8954 20 12L20 19C20 20.1046 19.1046 21 18 21L6 21C4.8954 21 4 20.1046 4 19L4 12C4 10.8954 4.8954 10 6 10Z");
  stroke: none;
}
