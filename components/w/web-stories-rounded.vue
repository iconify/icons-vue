...
const content = `<path class="wyj2-vfsc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:web-stories-rounded" /></template>
<style>
.wyj2-vfsc {
  fill: currentColor;
