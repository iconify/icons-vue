...
const content = `<path class="k7yy14qxf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pedal-bike-outline-sharp" /></template>
<style>
.k7yy14qxf {
  fill: currentColor;
