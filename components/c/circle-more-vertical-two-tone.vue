...
const content = `<g class="nrj6p8qat"><path class="yw3lpkbij"/><path class="ox_05kl4h"/><path class="bocf8ab2v"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-more-vertical-two-tone" /></template>
<style>
.bocf8ab2v {
  fill: currentColor;
