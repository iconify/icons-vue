...
const content = `<path class="oqh70s82f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:6k-outline-sharp" /></template>
<style>
.oqh70s82f {
  fill: currentColor;
