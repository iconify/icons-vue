...
const content = `<path class="rmgi3rb4v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-add-32-regular" /></template>
<style>
.rmgi3rb4v {
  fill: currentColor;
