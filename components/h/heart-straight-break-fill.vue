...
const content = `<path class="qbu5oekbm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:heart-straight-break-fill" /></template>
<style>
.qbu5oekbm {
  fill: currentColor;
