...
const content = `<path class="uwh30kbpt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-globe-20-filled" /></template>
<style>
.uwh30kbpt {
  fill: currentColor;
