...
const content = `<path class="yxrktr19h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:image-aspect-ratio-rounded" /></template>
<style>
.yxrktr19h {
  fill: currentColor;
