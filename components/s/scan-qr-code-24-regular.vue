...
const content = `<path class="vzz3eyv6s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-qr-code-24-regular" /></template>
<style>
.vzz3eyv6s {
  fill: currentColor;
