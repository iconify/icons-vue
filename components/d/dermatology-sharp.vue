...
const content = `<path class="z1e9jnbrh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dermatology-sharp" /></template>
<style>
.z1e9jnbrh {
  fill: currentColor;
