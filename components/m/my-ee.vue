...
const content = `<path class="rnzd8imao"/><path class="g3z6a510a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:my-ee" /></template>
<style>
.g3z6a510a {
  fill: none;
  stroke: currentColor;
