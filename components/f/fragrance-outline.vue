...
const content = `<path class="j-n6o81yv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fragrance-outline" /></template>
<style>
.j-n6o81yv {
  fill: currentColor;
