...
const content = `<path class="q4mvx5akm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pest-control-rodent-outline" /></template>
<style>
.q4mvx5akm {
  fill: currentColor;
