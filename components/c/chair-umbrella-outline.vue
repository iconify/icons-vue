...
const content = `<path class="cq54dlbri"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chair-umbrella-outline" /></template>
<style>
.cq54dlbri {
  fill: currentColor;
