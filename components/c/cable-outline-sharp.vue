...
const content = `<path class="f0d9fvz5e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cable-outline-sharp" /></template>
<style>
.f0d9fvz5e {
  fill: currentColor;
