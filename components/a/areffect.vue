...
const content = `<circle class="cpk0fnbgt"/><path class="my8ntibgx"/><path class="c6gkd0bay"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:areffect" /></template>
<style>
.c6gkd0bay {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M20.24 10.28a4 4 0 0 1 2.77 2c.31 1 .19 2.41-1 2.32s-2.77-1.44-2.78-2.37s.17-1.95 1.01-1.95m-3.65 33.91c1.14-3.44 2.44-7.25 2.72-7.63c.51-.71 3.09-3.1 3.09-3.1m10.37-7.89l.32 2.07l1.42.39l-.77 1.53l1.53.79l-.75 1.31l1.61.24l.2 1.56");
}
