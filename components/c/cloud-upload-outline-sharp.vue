...
const content = `<path class="dogloibpc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloud-upload-outline-sharp" /></template>
<style>
.dogloibpc {
  fill: currentColor;
