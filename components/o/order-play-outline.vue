...
const content = `<path class="kfbydybhd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:order-play-outline" /></template>
<style>
.kfbydybhd {
  fill: currentColor;
