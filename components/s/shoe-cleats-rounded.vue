...
const content = `<path class="blemkynxf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shoe-cleats-rounded" /></template>
<style>
.blemkynxf {
  fill: currentColor;
