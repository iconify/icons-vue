...
const content = `<circle class="qjti9roez"/><path class="wx2h1ktma"/><path class="lwqjkv8jx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:newsblur" /></template>
<style>
.lwqjkv8jx {
  fill: none;
  stroke: currentColor;
  stroke-linecap: round;
  d: path("m9.107 38.87l-.31.33M2.953 23.983l-.453.015M9.129 9.104l-.331-.309M24.015 2.95L24 2.497m14.894 6.629l.308-.331m5.846 15.217l.452-.015m-6.627 14.895l.33.308m-15.217 5.845l.015.452");
}
