...
const content = `<path class="v98l0ybvv"/><path class="r21ly5bgl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nlweer" /></template>
<style>
.r21ly5bgl {
  fill: none;
  stroke: currentColor;
