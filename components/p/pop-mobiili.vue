...
const content = `<path class="a-zdt9b1v"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pop-mobiili" /></template>
<style>
.a-zdt9b1v {
  fill: none;
  stroke: currentColor;
