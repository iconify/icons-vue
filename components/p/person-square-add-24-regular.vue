...
const content = `<path class="qk9kd1jpl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-square-add-24-regular" /></template>
<style>
.qk9kd1jpl {
  fill: currentColor;
