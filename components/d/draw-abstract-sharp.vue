...
const content = `<path class="cfa65-bil"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:draw-abstract-sharp" /></template>
<style>
.cfa65-bil {
  fill: currentColor;
