...
const content = `<path class="ozd60xrbx"/><path class="ww-ixubqw"/><path class="p5fp323zp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:heart-hands-medium-skin-tone" /></template>
<style>
.ozd60xrbx {
