...
const content = `<path class="qlfid3bla"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bluetooth-48-filled" /></template>
<style>
.qlfid3bla {
  fill: currentColor;
