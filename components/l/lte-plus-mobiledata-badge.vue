...
const content = `<path class="fqhpx_epc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lte-plus-mobiledata-badge" /></template>
<style>
.fqhpx_epc {
  fill: currentColor;
