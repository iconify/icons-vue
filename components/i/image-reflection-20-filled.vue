...
const content = `<path class="radn3peqp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-reflection-20-filled" /></template>
<style>
.radn3peqp {
  fill: currentColor;
