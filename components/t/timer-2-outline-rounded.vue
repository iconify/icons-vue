...
const content = `<path class="bih3k4bvw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:timer-2-outline-rounded" /></template>
<style>
.bih3k4bvw {
  fill: currentColor;
