...
const content = `<path class="l47qap-ki"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:single-bed-outline" /></template>
<style>
.l47qap-ki {
  fill: currentColor;
