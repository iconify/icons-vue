...
const content = `<path class="tplyylhww"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-menu-close-outline-rounded" /></template>
<style>
.tplyylhww {
  fill: currentColor;
