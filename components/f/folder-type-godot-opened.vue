...
const content = `<path class="bkk94bcsn"/><path class="u0a487b8n"/><path class="qfkmslkqh"/><path class="q_j4m0b2k"/><path class="hhh5u8bzi"/><path class="iecohtb2j"/><path class="i60wxqb9h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-godot-opened" /></template>
<style>
.bkk94bcsn {
  fill: var(--svg-color--37719a, #37719a);
