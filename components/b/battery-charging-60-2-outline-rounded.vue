...
const content = `<path class="njm9o4xsq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-charging-60-2-outline-rounded" /></template>
<style>
.njm9o4xsq {
  fill: currentColor;
