...
const content = `<path class="e4ftf0bep"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sokxay-plus" /></template>
<style>
.e4ftf0bep {
  fill: none;
  stroke: currentColor;
