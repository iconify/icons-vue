...
const content = `<path class="kgjsqcbyd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-american-football" /></template>
<style>
.kgjsqcbyd {
  fill: none;
  stroke: currentColor;
