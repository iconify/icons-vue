...
const content = `<path class="ns3zh8b5r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-4g-plus-mobiledata" /></template>
<style>
.ns3zh8b5r {
  fill: currentColor;
