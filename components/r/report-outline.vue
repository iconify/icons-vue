...
const content = `<path class="yrv8szb8x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:report-outline" /></template>
<style>
.yrv8szb8x {
  fill: currentColor;
