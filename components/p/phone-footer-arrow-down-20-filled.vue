...
const content = `<path class="hg-z03bnc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-footer-arrow-down-20-filled" /></template>
<style>
.hg-z03bnc {
  fill: currentColor;
