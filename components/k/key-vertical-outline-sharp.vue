...
const content = `<path class="lqsa8nbei"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:key-vertical-outline-sharp" /></template>
<style>
.lqsa8nbei {
  fill: currentColor;
