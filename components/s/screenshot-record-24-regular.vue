...
const content = `<path class="zfw_sjije"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:screenshot-record-24-regular" /></template>
<style>
.zfw_sjije {
  fill: currentColor;
