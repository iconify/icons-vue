...
const content = `<path class="l55swybjo"/><path class="i8u9j022l"/><path class="u5hbk2b5z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:magisk-delta" /></template>
<style>
.i8u9j022l {
  fill: none;
  stroke: currentColor;
