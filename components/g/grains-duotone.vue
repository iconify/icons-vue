...
const content = `<g class="cuyn6tgcc"><path class="sf6r23bbm"/><path class="vcrwc_byb"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:grains-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
