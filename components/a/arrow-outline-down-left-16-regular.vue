...
const content = `<path class="d0uj2o8oo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-outline-down-left-16-regular" /></template>
<style>
.d0uj2o8oo {
  fill: currentColor;
