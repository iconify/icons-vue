...
const content = `<path class="jo9a94bov"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-bank-28-regular" /></template>
<style>
.jo9a94bov {
  fill: currentColor;
