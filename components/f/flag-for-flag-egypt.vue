...
const content = `<path class="d245zxgwh"/><path class="yhgdzpbsm"/><path class="mh79h9x1l"/><g class="n1mjunbsu"><path class="n40gyz4bc"/><path class="dsiz3x6mj"/><path class="tm6stubid"/></g><path class="vx82xyb4p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-egypt" /></template>
<style>
.d245zxgwh {
...
.n40gyz4bc {
  d: path("M30.6 25.1c.3-.2.5 0 .7.2c.1.2.1.8-.1 1.5c-.1.4-.4.8-.6 1.1c.4 0 .9-.1 1.4-.3c.5.2.9.3 1.4.3c-.2-.4-.4-1.2-.3-1.8c0-.9-.1-1.2-.3-1.4s-.7-.3-1-.3c-.2 0-.2.1-.2.1q-.6-.15-.9 0c-.2.2-.2.7-.1.6");
}

.tm6stubid {
  d: path("M31.1 29.7v3.9s0 .1.1.1c.1.2.3.3.4.5l.3.3l.3-.3l.5-.5v-3.8c-.3-.1-.6-.2-.8-.4c-.1-.1-.4 0-.8.2");
}

.vx82xyb4p {
  fill: var(--svg-color--c09300, #c09300);
