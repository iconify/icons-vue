...
const content = `<path class="t25x0abtx"/><path class="s_pwi8n2i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:3d-geeks" /></template>
<style>
.s_pwi8n2i {
  fill: none;
  stroke: currentColor;
