...
const content = `<g class="cuyn6tgcc"><path class="p-k7b9bsr"/><path class="uion6bbfo"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:heart-break-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
