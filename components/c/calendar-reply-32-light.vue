...
const content = `<path class="ds3vombfi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-reply-32-light" /></template>
<style>
.ds3vombfi {
  fill: currentColor;
