...
const content = `<g class="cuyn6tgcc"><path class="gmzrykbem"/><path class="fejvggegl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:soccer-ball-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
