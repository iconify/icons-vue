...
const content = `<path class="lgcm68-ey"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:api-outline-sharp" /></template>
<style>
.lgcm68-ey {
  fill: currentColor;
