...
const content = `<path class="bdj3brn4e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:night-sight-auto-sharp" /></template>
<style>
.bdj3brn4e {
  fill: currentColor;
