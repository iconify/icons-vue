...
const content = `<path class="b-58jgbgn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-fan-mid-left-outline" /></template>
<style>
.b-58jgbgn {
  fill: currentColor;
