...
const content = `<path class="umzfno23k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:vietnamworks" /></template>
<style>
.umzfno23k {
  fill: none;
  stroke: currentColor;
