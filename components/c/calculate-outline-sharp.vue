...
const content = `<path class="jw36gweln"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:calculate-outline-sharp" /></template>
<style>
.jw36gweln {
  fill: currentColor;
