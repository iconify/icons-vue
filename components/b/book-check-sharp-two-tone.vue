...
const content = `<g class="gp_8x1bzb"><path class="q68xhu0of"/><path class="az-eq3rud"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:book-check-sharp-two-tone" /></template>
<style>
.az-eq3rud {
