...
const content = `<path class="s4so8m5md"/><circle class="rt_37l3dj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:eleven-oclock" /></template>
<style>
.rt_37l3dj {
  cx: 32px;
  cy: 32px;
