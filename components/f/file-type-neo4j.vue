...
const content = `<path class="ygm2a3_hg"/><path class="vfwbl4bpi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-neo4j" /></template>
<style>
.vfwbl4bpi {
