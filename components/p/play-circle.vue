...
const content = `<g class="cuyn6tgcc"><path class="wjlnj5bqo"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:play-circle" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
