...
const content = `<path class="vn1v6ib3b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shopping-bag-play-20-regular" /></template>
<style>
.vn1v6ib3b {
  fill: currentColor;
