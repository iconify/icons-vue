...
const content = `<path class="g3cr3c5tq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-header-48-filled" /></template>
<style>
.g3cr3c5tq {
  fill: currentColor;
