...
const content = `<path class="hckib2bvp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:note-alt-sharp" /></template>
<style>
.hckib2bvp {
  fill: currentColor;
