...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="skq5i_trj"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:checkmark-filled-circle" /></template>
<style>
.hdxpysbbn {
