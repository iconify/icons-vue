...
const content = `<path class="a8sergzia"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:payment-arrow-down-sharp" /></template>
<style>
.a8sergzia {
  fill: currentColor;
