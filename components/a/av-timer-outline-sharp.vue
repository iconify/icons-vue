...
const content = `<path class="d3960gy_h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:av-timer-outline-sharp" /></template>
<style>
.d3960gy_h {
  fill: currentColor;
