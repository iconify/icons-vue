...
const content = `<g class="hntgybcog"><path class="is1bv_axc"/><path class="ys58egb0o"/><path class="gn7q9ebir"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:terraform-outline-thin" /></template>
<style>
.gn7q9ebir {
