...
const content = `<path class="ryuadtgwt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-list-numbered-rtl-sharp" /></template>
<style>
.ryuadtgwt {
  fill: currentColor;
