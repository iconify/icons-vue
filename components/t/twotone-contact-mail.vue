...
const content = `<path class="lal0kab5t"/><path class="g4htzfb1v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-contact-mail" /></template>
<style>
.g4htzfb1v {
  fill: currentColor;
...
.lal0kab5t {
  fill: currentColor;
  d: path("M2 19h20V5H2zM14 6h7v5h-7zM9 6c1.65 0 3 1.35 3 3s-1.35 3-3 3s-3-1.35-3-3s1.35-3 3-3M3 16.59C3 14.08 6.97 13 9 13s6 1.08 6 3.58V18H3z");
