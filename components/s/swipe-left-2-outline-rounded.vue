...
const content = `<path class="b_-52p-ai"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-left-2-outline-rounded" /></template>
<style>
.b_-52p-ai {
  fill: currentColor;
