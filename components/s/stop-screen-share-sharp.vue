...
const content = `<path class="n_z4amb_e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stop-screen-share-sharp" /></template>
<style>
.n_z4amb_e {
  fill: currentColor;
