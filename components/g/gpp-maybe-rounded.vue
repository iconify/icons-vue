...
const content = `<path class="q7p_68-mh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gpp-maybe-rounded" /></template>
<style>
.q7p_68-mh {
  fill: currentColor;
