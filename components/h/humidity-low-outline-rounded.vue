...
const content = `<path class="kd_n8cbfe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:humidity-low-outline-rounded" /></template>
<style>
.kd_n8cbfe {
  fill: currentColor;
