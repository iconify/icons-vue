...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:map" /></template>
<style>
.rjv7omb2j {
  fill: none;
  stroke: currentColor;
