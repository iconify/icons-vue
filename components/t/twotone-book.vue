...
const content = `<path class="taj93kbky"/><path class="jtw4p1b_a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-book" /></template>
<style>
.jtw4p1b_a {
  fill: currentColor;
