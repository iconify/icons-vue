...
const content = `<path class="dq8_d-bpk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pin-end-outline-sharp" /></template>
<style>
.dq8_d-bpk {
  fill: currentColor;
