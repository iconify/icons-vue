...
const content = `<path class="buibu5btx"/><path class="wamm93s3y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-fonts" /></template>
<style>
.buibu5btx {
