...
const content = `<g clip-rule="evenodd" class="bi12bsetm"><path class="f-iwhhjoy"/><path class="egpoorbgc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:scb" /></template>
<style>
.bi12bsetm {
  fill: none;
  fill-rule: evenodd;
