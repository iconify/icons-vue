...
const content = `<g class="gp_8x1bzb"><path class="uordzqcti"/><path clip-rule="evenodd" class="r0p7iiqoh"/><path class="e8jq6wmcl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-x-sharp-duotone" /></template>
<style>
.e8jq6wmcl {
  d: path("M14.7071 15.7071L21.2929 22.2929M21.2929 15.7071L14.7071 22.2929");
}
