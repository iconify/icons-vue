...
const content = `<path class="s-3n0rayd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:your-trips-outline-rounded" /></template>
<style>
.s-3n0rayd {
  fill: currentColor;
