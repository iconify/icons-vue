...
const content = `<path class="lr0fpqb8n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-airline-seat-legroom-reduced" /></template>
<style>
.lr0fpqb8n {
  fill: currentColor;
