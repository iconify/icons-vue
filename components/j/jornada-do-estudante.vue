...
const content = `<path class="fyz4urblf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:jornada-do-estudante" /></template>
<style>
.fyz4urblf {
  fill: none;
  stroke: currentColor;
