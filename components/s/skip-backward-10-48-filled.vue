...
const content = `<g class="ft5dv1b6b"><path class="ooj6e5byn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:skip-backward-10-48-filled" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
