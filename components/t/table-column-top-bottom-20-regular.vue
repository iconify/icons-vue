...
const content = `<path class="cr1__s0vi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-column-top-bottom-20-regular" /></template>
<style>
.cr1__s0vi {
  fill: currentColor;
