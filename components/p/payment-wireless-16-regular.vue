...
const content = `<path class="c3yzsvbip"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:payment-wireless-16-regular" /></template>
<style>
.c3yzsvbip {
  fill: currentColor;
