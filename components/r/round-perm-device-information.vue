...
const content = `<path class="a80_b4bid"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-perm-device-information" /></template>
<style>
.a80_b4bid {
  fill: currentColor;
