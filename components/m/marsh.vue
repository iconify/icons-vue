...
const content = `<path class="j0ychjbeo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:marsh" /></template>
<style>
.j0ychjbeo {
  fill: var(--svg-color--34d399, #34d399);
