...
const content = `<path class="ra7q-s48i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-ltr-12-regular" /></template>
<style>
.ra7q-s48i {
  fill: currentColor;
