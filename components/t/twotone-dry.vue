...
const content = `<path class="ljy1cmbar"/><path class="f5hssy9-o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-dry" /></template>
<style>
.f5hssy9-o {
  fill: currentColor;
...
.ljy1cmbar {
  fill: currentColor;
  d: path("M10 21H4c-.55 0-1-.45-1-1v-6c0-.39.23-.64.36-.75L7 9.87V12h3z");
