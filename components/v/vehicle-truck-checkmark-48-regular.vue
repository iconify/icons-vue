...
const content = `<path class="wx8b66pnq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-truck-checkmark-48-regular" /></template>
<style>
.wx8b66pnq {
  fill: currentColor;
