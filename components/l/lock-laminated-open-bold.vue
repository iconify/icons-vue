...
const content = `<path class="bpcgluboq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:lock-laminated-open-bold" /></template>
<style>
.bpcgluboq {
  fill: currentColor;
