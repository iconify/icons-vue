...
const content = `<path class="cqcoy34tx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nightlight-badge-outline-rounded" /></template>
<style>
.cqcoy34tx {
  fill: currentColor;
