...
const content = `<path class="d15i7cxdh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-error-24-filled" /></template>
<style>
.d15i7cxdh {
  fill: currentColor;
