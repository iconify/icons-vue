...
const content = `<path class="kf3lbabqs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:brightness-high-32-filled" /></template>
<style>
.kf3lbabqs {
  fill: currentColor;
