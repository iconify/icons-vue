...
const content = `<path class="fxdu8ybxk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-circle-left-light" /></template>
<style>
.fxdu8ybxk {
  fill: currentColor;
