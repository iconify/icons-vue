...
const content = `<path class="e1-nahabz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:network-ping-outline-sharp" /></template>
<style>
.e1-nahabz {
  fill: currentColor;
