...
const content = `<path class="oafewvbwy"/><path class="hrfa-tbtq"/><circle class="cugg4120k"/><circle class="w4h258_1n"/><circle class="rx4758bsa"/><circle class="uk6xadbpc"/><circle class="uyka6jbyy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bricksbreakerballscrush" /></template>
<style>
.cugg4120k {
  cx: 32.664px;
  cy: 21.833px;
...
.hrfa-tbtq {
  ...
  d: path("M21.833 34.836h4.334v4.334h-4.334z");
}
