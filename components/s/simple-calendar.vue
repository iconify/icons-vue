...
const content = `<path class="lq8ccqeeh"/><path class="y5pepgnpq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:simple-calendar" /></template>
<style>
.lq8ccqeeh {
  fill: none;
  stroke: currentColor;
