...
const content = `<path class="k0ud9fbgk"/><path class="f5-xe1s4o"/><path class="tfj0swb0e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:man-bald-medium-skin-tone" /></template>
<style>
.f5-xe1s4o {
