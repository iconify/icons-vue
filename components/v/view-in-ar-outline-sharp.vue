...
const content = `<path class="kxvhxp8wt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:view-in-ar-outline-sharp" /></template>
<style>
.kxvhxp8wt {
  fill: currentColor;
