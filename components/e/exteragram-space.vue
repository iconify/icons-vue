...
const content = `<circle class="cpk0fnbgt"/><path class="scdeczbsd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:exteragram-space" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
