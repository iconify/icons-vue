...
const content = `<path class="f--n6gb5r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ear-sound-sharp" /></template>
<style>
.f--n6gb5r {
  fill: currentColor;
