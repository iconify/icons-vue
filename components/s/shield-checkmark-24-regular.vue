...
const content = `<path class="cozncpbmi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-checkmark-24-regular" /></template>
<style>
.cozncpbmi {
  fill: currentColor;
