...
const content = `<path class="kglap0t6n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-top-left-24-regular" /></template>
<style>
.kglap0t6n {
  fill: currentColor;
