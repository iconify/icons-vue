...
const content = `<path class="ngeof0b4w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bug-report-outline-rounded" /></template>
<style>
.ngeof0b4w {
  fill: currentColor;
