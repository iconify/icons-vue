...
const content = `<path class="j6dw5rw4l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:multiple-stop-outline-sharp" /></template>
<style>
.j6dw5rw4l {
  fill: currentColor;
