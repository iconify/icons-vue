...
const content = `<path class="el5a7cblu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:move-to-inbox-rounded" /></template>
<style>
.el5a7cblu {
  fill: currentColor;
