...
const content = `<path class="j_nyaz5fz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-increase-ltr-20-filled" /></template>
<style>
.j_nyaz5fz {
  fill: currentColor;
