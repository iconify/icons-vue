...
const content = `<path class="v9akipb7h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sports-motorsports-outline-sharp" /></template>
<style>
.v9akipb7h {
  fill: currentColor;
