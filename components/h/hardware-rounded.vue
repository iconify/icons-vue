...
const content = `<path class="oo_obbbmc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hardware-rounded" /></template>
<style>
.oo_obbbmc {
  fill: currentColor;
