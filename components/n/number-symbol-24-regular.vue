...
const content = `<path class="ykaoujnjq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-symbol-24-regular" /></template>
<style>
.ykaoujnjq {
  fill: currentColor;
