...
const content = `<path class="fqyxw5byy"/><path class="o_-aw9bjb"/><circle class="k0g_w2bev"/><path class="gu-wa5b2a"/><circle class="ogvbrorqg"/><path class="j2slkh9-v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:shopping-cart" /></template>
<style>
.fqyxw5byy {
  fill: var(--svg-color--ccd6dd, #ccd6dd);
  d: path("M31 22H11L9 10h24z");
}

.gu-wa5b2a {
  fill: var(--svg-color--292f33, #292f33);
  d: path("M14 35c-2.206 0-4-1.794-4-4s1.794-4 4-4s4 1.794 4 4s-1.794 4-4 4m0-6c-1.103 0-2 .897-2 2s.897 2 2 2s2-.897 2-2s-.897-2-2-2");
}

.j2slkh9-v {
  fill: var(--svg-color--292f33, #292f33);
  d: path("M28 35c-2.206 0-4-1.794-4-4s1.794-4 4-4s4 1.794 4 4s-1.794 4-4 4m0-6c-1.103 0-2 .897-2 2s.897 2 2 2s2-.897 2-2s-.897-2-2-2");
}
