...
const content = `<path class="r77020bir"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:step-outline-rounded" /></template>
<style>
.r77020bir {
  fill: currentColor;
