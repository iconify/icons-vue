...
const content = `<path class="tunl1cc3b"/><circle class="gnfukcbyd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:darker" /></template>
<style>
.gnfukcbyd {
  cx: 24px;
  cy: 24px;
