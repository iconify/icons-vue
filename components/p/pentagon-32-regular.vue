...
const content = `<path class="wsh8hpbei"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pentagon-32-regular" /></template>
<style>
.wsh8hpbei {
  fill: currentColor;
