...
const content = `<path class="tqpq_ub2z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:highlight-text-cursor-rounded" /></template>
<style>
.tqpq_ub2z {
  fill: currentColor;
