...
const content = `<path class="d40koccjx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:room-service" /></template>
<style>
.d40koccjx {
  fill: currentColor;
