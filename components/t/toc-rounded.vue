...
const content = `<path class="e2-x3nbxb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:toc-rounded" /></template>
<style>
.e2-x3nbxb {
  fill: currentColor;
