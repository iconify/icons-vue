...
const content = `<path class="etfsozrby"/><path class="ju1ivmpdq"/><path class="qklq0ccnd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:boursorama-banque" /></template>
<style>
.etfsozrby {
  fill: none;
  stroke: currentColor;
