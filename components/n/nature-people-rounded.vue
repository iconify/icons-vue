...
const content = `<path class="r1gez_biy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nature-people-rounded" /></template>
<style>
.r1gez_biy {
  fill: currentColor;
