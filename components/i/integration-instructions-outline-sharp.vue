...
const content = `<path class="p1g19-lim"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:integration-instructions-outline-sharp" /></template>
<style>
.p1g19-lim {
  fill: currentColor;
