...
const content = `<path class="ntc1rib5p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-laptop-16-regular" /></template>
<style>
.ntc1rib5p {
  fill: currentColor;
