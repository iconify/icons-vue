...
const content = `<path class="ngx-f87vv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-smile-slight-24-regular" /></template>
<style>
.ngx-f87vv {
  fill: currentColor;
