...
const content = `<path class="bcphbgq5o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:corporate-fare-outline-rounded" /></template>
<style>
.bcphbgq5o {
  fill: currentColor;
