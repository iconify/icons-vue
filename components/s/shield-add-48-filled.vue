...
const content = `<path class="c07olo0tz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-add-48-filled" /></template>
<style>
.c07olo0tz {
  fill: currentColor;
