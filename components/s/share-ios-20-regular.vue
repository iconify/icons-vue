...
const content = `<path class="hhew5_bgr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-ios-20-regular" /></template>
<style>
.hhew5_bgr {
  fill: currentColor;
