...
const content = `<path class="zn_damhdq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:folder-copy-rounded" /></template>
<style>
.zn_damhdq {
  fill: currentColor;
