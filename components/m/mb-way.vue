...
const content = `<path class="av_8pabgi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mb-way" /></template>
<style>
.av_8pabgi {
  fill: none;
  stroke: currentColor;
