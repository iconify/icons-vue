...
const content = `<path class="k8xpdf0db"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bookmark-stacks-outline-sharp" /></template>
<style>
.k8xpdf0db {
  fill: currentColor;
