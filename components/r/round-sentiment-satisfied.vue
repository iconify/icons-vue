...
const content = `<circle class="mmn7xsb7v"/><circle class="an0_1xo_x"/><path class="t-b4dfb5v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-sentiment-satisfied" /></template>
<style>
.an0_1xo_x {
  cx: 8.5px;
  cy: 9.5px;
