...
const content = `<path class="y77-vujuu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chess-bishop-outline-rounded" /></template>
<style>
.y77-vujuu {
  fill: currentColor;
