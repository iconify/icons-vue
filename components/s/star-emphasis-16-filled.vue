...
const content = `<path class="fe3w3zb-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:star-emphasis-16-filled" /></template>
<style>
.fe3w3zb-j {
  fill: currentColor;
