...
const content = `<path class="cj6p1dcud"/><circle class="mwhu5f91p"/><path class="bjdtmibhe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:gomo-ph" /></template>
<style>
.bjdtmibhe {
  fill: none;
  stroke: currentColor;
