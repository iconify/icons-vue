...
const content = `<path class="ctx-6zb6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-keyboard-20-filled" /></template>
<style>
.ctx-6zb6a {
  fill: currentColor;
