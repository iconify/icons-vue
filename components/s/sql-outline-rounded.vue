...
const content = `<path class="zl26gccqs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sql-outline-rounded" /></template>
<style>
.zl26gccqs {
  fill: currentColor;
