...
const content = `<circle class="d7c2esppr"/><path class="mj_7e1_cj"/><path class="f_9n76bpv"/><path class="k7rb_70iz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-reactjs" /></template>
<style>
.d7c2esppr {
  cx: 16px;
  cy: 15.974px;
