...
const content = `<path class="xittbabof"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:smart-toy-outline" /></template>
<style>
.xittbabof {
  fill: currentColor;
