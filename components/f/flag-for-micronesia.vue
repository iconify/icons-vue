...
const content = `<circle class="ux0iofbdv"/><path class="s-eomy-zu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-micronesia" /></template>
<style>
.s-eomy-zu {
