...
const content = `<path class="fdy8y-b_x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-communication-48-regular" /></template>
<style>
.fdy8y-b_x {
  fill: currentColor;
