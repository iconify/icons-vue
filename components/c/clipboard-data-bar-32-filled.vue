...
const content = `<path class="ochy9kbyu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-data-bar-32-filled" /></template>
<style>
.ochy9kbyu {
  fill: currentColor;
