...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="dowozdblg"/><path class="azt7m7kqg"/><path clip-rule="evenodd" class="muiqxrbuk"/><path class="xedf9ccsf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:lock-open-off" /></template>
<style>
.azt7m7kqg {
