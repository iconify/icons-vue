...
const content = `<path class="ij9c60bqn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:game-button-r1-sharp" /></template>
<style>
.ij9c60bqn {
  fill: currentColor;
