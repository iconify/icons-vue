...
const content = `<path class="k09kmx1-f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:lab-research-outline" /></template>
<style>
.k09kmx1-f {
  fill: currentColor;
