...
const content = `<path class="tt0qs7bni"/><defs><path id="SVG86R5pb3p" class="geq8-zbit"/></defs><clipPath id="SVGfTZPDcEH"><use href="#SVG86R5pb3p"/></clipPath><g clip-path="url(#SVGfTZPDcEH)" class="zlqwn85jm"><path class="eqj3-etxh"/><path class="x9voxho-p"/></g><defs><use href="#SVG86R5pb3p" id="SVGKYHuyear"/></defs><clipPath id="SVGWf5bocKn"><use href="#SVGKYHuyear"/></clipPath><g clip-path="url(#SVGWf5bocKn)" class="j9_i7vu4q"><path class="v4f5wlz2e"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:love-you-gesture-medium-light-skin-tone" /></template>
<style>
.eqj3-etxh {
