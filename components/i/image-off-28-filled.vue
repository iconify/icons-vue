...
const content = `<path class="zd35-zbhj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-off-28-filled" /></template>
<style>
.zd35-zbhj {
  fill: currentColor;
