...
const content = `<path class="f6xqeqbiv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:watch-button-rounded" /></template>
<style>
.f6xqeqbiv {
  fill: currentColor;
