...
const content = `<path class="ifjp1svqy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sticker-rounded" /></template>
<style>
.ifjp1svqy {
  fill: currentColor;
