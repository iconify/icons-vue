...
const content = `<path class="vuthq0boe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:projection-screen-28-regular" /></template>
<style>
.vuthq0boe {
  fill: currentColor;
