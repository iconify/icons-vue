...
const content = `<path class="ue06w8ill"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ring" /></template>
<style>
.ue06w8ill {
  fill: none;
  stroke: currentColor;
