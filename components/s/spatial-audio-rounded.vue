...
const content = `<path class="u6cidqqty"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:spatial-audio-rounded" /></template>
<style>
.u6cidqqty {
  fill: currentColor;
