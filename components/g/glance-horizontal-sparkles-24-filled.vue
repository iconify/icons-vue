...
const content = `<path class="l9vbfbbmm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:glance-horizontal-sparkles-24-filled" /></template>
<style>
.l9vbfbbmm {
  fill: currentColor;
