...
const content = `<path class="b5bzs3b5n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:wb-iridescent-outline-sharp" /></template>
<style>
.b5bzs3b5n {
  fill: currentColor;
