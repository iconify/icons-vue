...
const content = `<path class="ib4i_0bvw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:braces-checkmark-16-filled" /></template>
<style>
.ib4i_0bvw {
  fill: currentColor;
