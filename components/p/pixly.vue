...
const content = `<path class="vg23d4b7r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:pixly" /></template>
<style>
.vg23d4b7r {
  fill: none;
  stroke: currentColor;
