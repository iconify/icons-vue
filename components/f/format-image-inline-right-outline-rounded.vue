...
const content = `<path class="fu2rr-udl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-image-inline-right-outline-rounded" /></template>
<style>
.fu2rr-udl {
  fill: currentColor;
