...
const content = `<path class="s3z1lwaiq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-board-32-regular" /></template>
<style>
.s3z1lwaiq {
  fill: currentColor;
