...
const content = `<path class="a-jauo90c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-3-28-filled" /></template>
<style>
.a-jauo90c {
  fill: currentColor;
