...
const content = `<path class="limoipbyk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-desktop-20-regular" /></template>
<style>
.limoipbyk {
  fill: currentColor;
