...
const content = `<path class="rl1cpz9vl"/><path class="f_xx2xjft"/><path class="hkawd9t_p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:keycap-1" /></template>
<style>
.f_xx2xjft {
...
.hkawd9t_p {
  ...
  d: path("M38 45h-6.1V22c-2.2 2.1-4.9 3.6-7.9 4.6v-5.5c1.6-.5 3.3-1.5 5.2-3s3.2-3.2 3.8-5.1h5z");
}
