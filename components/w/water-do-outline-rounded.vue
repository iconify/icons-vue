...
const content = `<path class="x9zn5snqy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:water-do-outline-rounded" /></template>
<style>
.x9zn5snqy {
  fill: currentColor;
