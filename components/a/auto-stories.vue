...
const content = `<path class="tuh-6ccmj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-stories" /></template>
<style>
.tuh-6ccmj {
  fill: currentColor;
