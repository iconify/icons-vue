...
const content = `<path class="s0ykeobmr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:apartment-rounded" /></template>
<style>
.s0ykeobmr {
  fill: currentColor;
