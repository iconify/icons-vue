...
const content = `<path class="c4ov24sip"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-bottom-double-24-filled" /></template>
<style>
.c4ov24sip {
  fill: currentColor;
