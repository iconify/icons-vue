...
const content = `<path class="hwoyigs9g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-simple-checkmark-32-filled" /></template>
<style>
.hwoyigs9g {
  fill: currentColor;
