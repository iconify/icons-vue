...
const content = `<path class="g5ap4dd_e"/><defs><path id="SVGKWyaFZun" class="myeaa8bof"/></defs><clipPath id="SVGJDYcnGqI"><use href="#SVGKWyaFZun"/></clipPath><g clip-path="url(#SVGJDYcnGqI)" class="t_nvrsbrc"><path class="zkoo3518s"/></g><defs><use href="#SVGKWyaFZun" id="SVG6ObibegY"/></defs><clipPath id="SVGHoDwib4P"><use href="#SVG6ObibegY"/></clipPath><g clip-path="url(#SVGHoDwib4P)"><path class="hi_dlcbdf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:backhand-index-pointing-left-dark-skin-tone" /></template>
<style>
.g5ap4dd_e {
