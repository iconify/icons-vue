...
const content = `<path class="r-epcbcqk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-taxi-outline-rounded" /></template>
<style>
.r-epcbcqk {
  fill: currentColor;
