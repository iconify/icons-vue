...
const content = `<path class="tnnslsb8y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wifi-notification-outline" /></template>
<style>
.tnnslsb8y {
  fill: currentColor;
