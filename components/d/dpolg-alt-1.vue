...
const content = `<path class="junr9kbvh"/><ellipse class="g-lr-3b3a"/><path class="y0zcqxbrm"/><ellipse class="dl3ycybdq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dpolg-alt-1" /></template>
<style>
.dl3ycybdq {
  cx: 24px;
  cy: 24px;
...
.junr9kbvh {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M26.286 17.537v15.6m2.461-16.438v14.524M24 19.81s2.464-3.111 4.218-3.151c1.347-.03 2.82 1.028 3.345 2.27c1.157 2.733-.722 7.172-.722 7.172m-11.588-9.4v14.523M24 19.81s-2.463-3.111-4.218-3.151c-1.347-.03-2.82 1.028-3.345 2.27c-1.157 2.733.722 7.172.722 7.172m5.548-11.19H24v18.227m-2.286-15.6v15.6");
}
