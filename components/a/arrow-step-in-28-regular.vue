...
const content = `<path class="mofzuuerw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-step-in-28-regular" /></template>
<style>
.mofzuuerw {
  fill: currentColor;
