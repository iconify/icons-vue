...
const content = `<path class="beoktiopj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lightbulb-2-outline-rounded" /></template>
<style>
.beoktiopj {
  fill: currentColor;
