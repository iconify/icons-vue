...
const content = `<path class="qd2t74aca"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:work-rounded" /></template>
<style>
.qd2t74aca {
  fill: currentColor;
