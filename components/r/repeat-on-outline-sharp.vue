...
const content = `<path class="iqchcr03w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:repeat-on-outline-sharp" /></template>
<style>
.iqchcr03w {
  fill: currentColor;
