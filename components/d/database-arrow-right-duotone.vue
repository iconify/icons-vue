...
const content = `<g class="nrj6p8qat"><path class="vhck9ybet"/><path clip-rule="evenodd" class="qa1terbik"/><path class="nhgdc0brq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-right-duotone" /></template>
<style>
.nhgdc0brq {
  d: path("M15 19H21M18 16L21 19L18 22");
}
