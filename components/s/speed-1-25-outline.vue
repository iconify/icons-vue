...
const content = `<path class="j99n23itx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:speed-1-25-outline" /></template>
<style>
.j99n23itx {
  fill: currentColor;
