...
const content = `<path class="ijivg5dok"/><path class="qejo4kibf"/><path class="rejqn0bmc"/><circle class="o_oecybui"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:showtv" /></template>
<style>
.ijivg5dok {
  fill: none;
  stroke: currentColor;
...
.qejo4kibf {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M40.789 14.302L27.469 22c-.35-.61-.86-1.12-1.47-1.47l7.698-13.32c.584-1.01 1.92-1.33 2.866-.649c1.876 1.351 3.524 3 4.875 4.875c.681.946.36 2.282-.65 2.866Z");
}
...
.rejqn0bmc {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M33.7 7.205L26 20.53a4 4 0 0 0-2-.54V4.604c0-1.168 1-2.113 2.162-1.997c2.36.236 4.606.855 6.677 1.795c1.06.481 1.444 1.796.862 2.803ZM24 4.604V19.99c-.73 0-1.41.2-2 .54L14.3 7.204c-.583-1.007-.198-2.322.86-2.803a21.3 21.3 0 0 1 6.679-1.795C23 2.491 24 3.437 24 4.604");
}
