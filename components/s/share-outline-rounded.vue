...
const content = `<path class="pw7xa6bew"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:share-outline-rounded" /></template>
<style>
.pw7xa6bew {
  fill: currentColor;
