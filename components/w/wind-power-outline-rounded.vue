...
const content = `<path class="wql1gqzsv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wind-power-outline-rounded" /></template>
<style>
.wql1gqzsv {
  fill: currentColor;
