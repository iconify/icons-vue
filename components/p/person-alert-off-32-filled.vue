...
const content = `<path class="r4f5wgb3b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-alert-off-32-filled" /></template>
<style>
.r4f5wgb3b {
  fill: currentColor;
