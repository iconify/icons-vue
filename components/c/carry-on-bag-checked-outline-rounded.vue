...
const content = `<path class="nvimufgel"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:carry-on-bag-checked-outline-rounded" /></template>
<style>
.nvimufgel {
  fill: currentColor;
