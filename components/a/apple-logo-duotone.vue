...
const content = `<g class="cuyn6tgcc"><path class="vqvk8890n"/><path class="h6wilebwl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:apple-logo-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
