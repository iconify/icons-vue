...
const content = `<path class="xviplcbhp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:photo-camera-outline-rounded" /></template>
<style>
.xviplcbhp {
  fill: currentColor;
