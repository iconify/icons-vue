...
const content = `<path class="hdrtipley"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:end-arrow" /></template>
<style>
.hdrtipley {
  fill: currentColor;
