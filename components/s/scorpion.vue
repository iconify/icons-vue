...
const content = `<path class="m35r1-bid"/><g class="dbhyolblu"><path class="ikbad75dl"/><path class="howzl3boi"/></g><ellipse class="j1jwsfbud"/><ellipse class="hcpuc87by"/><ellipse class="d938ha-wo"/><ellipse class="v78jwib9j"/><path class="r0sk2mj-a"/><path class="w2k66c8ko"/><path class="zlb2h_bmj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:scorpion" /></template>
<style>
.d938ha-wo {
  cx: 28.5px;
  cy: 36.8px;
...
.dbhyolblu {
  fill: var(--svg-color--6b6b6d, #6b6b6d);
}
...
.m35r1-bid {
  fill: var(--svg-color--3e4347, #3e4347);
  d: path("M51.3 28.2s.4-1.4-.4-2.9c2.5-3.2 2.4-8.1.7-10.5c1.4-2 1.4-5.1-.4-6.6c0 0-.2-5.1-3.5-5.5L40 7.3s2 1.2 5.5-.3c.2 1.4.8 2.3 1.5 3.1c-.8 1.5.1 3.2.1 3.2s-3 2.8-3.7 3.7c-2.1 2.6-2.3 5.9-2.3 5.9L23.6 34.2l-10.1.2l2.8 2.9s.8-.1 1.1-.1l9.3 7.1l-4.1 3.4c1.6.9 17.7-3 17.7-3c.5-.4 2-1.7.4-4l.3-3.5z");
}

.r0sk2mj-a {
  fill: var(--svg-color--c94747, #c94747);
  d: path("m39.4 11.6l-5.9-.2c-1 4.2 5.6 3.4 5.6 5.2c0 .6-.9 1.3-.1 1c3-1 2.4-5.3.4-6");
}
...
.w2k66c8ko {
  fill: var(--svg-color--6b6b6d, #6b6b6d);
  d: path("M39.8 5c-5 .8-7.1 6-5.7 7.3c1 1 2.6.8 4.9-1c1.4-1.1 2.8-2.9 3.3-4.4c2.8-.1 5.4-1.8 6-3.7c-1.2-2.1-6.8-1.4-8.5 1.8");
}

.zlb2h_bmj {
  fill: var(--svg-color--3e4347, #3e4347);
  d: path("M33.7 10.5c-1.1 2.5 2.8 3.9 5.5 1.4c2-1.8 3.8-4.1 3.1-6.5c-3.9 7.5-8.4 6.8-8.6 5.1M28 59.6c-.8 1.2-.8 2.4-.8 2.4c2.1-2.1 3.3-2 3-4.1s.7-3 2.2-4.5s-1.1-3.1-1.1-4.7s-1.6-3-1.9-1.2c-.3 1.7-1.2 1-2.9 3.7c-1.5 2.4-.5 4.4-.2 4.9c0 0 0 .1.1.1c0 0-.5-1.3.4-1.8s-.5-1.4.3-1.8s-.2-1.4 1.1-2.4c1.3-.9 1.5-1.8 1.5-1.8s1.6.9.4 2.2c-1.3 1.4-.1 1.4.9 1.7s-2.1.7-1 1.6s-1.5.8-.8 1.9c.6 1.2-1.4.6-.7 1.9c.7 1.4.3.6-.5 1.9M5.8 50.2c.5-1.2-.3-.8 1.1-1.4c1.5-.6-.2-1.1 1.1-1.5c1.3-.5-.3-1.5 1-1.6s-.2-1.7.6-1.5s1.5.8 1.8-.6c.3-1.3 2-1.3 2-1.3s-.6.7-.5 1.8c0 1.1-1.4 1.4-1.2 2s-1.3.6-1.2 1.3c.2.7-1.2 1.3-1.2 1.3c4.9-.9 6.6-3.3 7.2-5.6c-.9 1.8-3.1 2-2.1.4c1.1-2.1-1.2-4-2.5-2.4c-1.3 1.7-3.1 1.6-4.3 4S5.2 45.5 5 48c-.2 2.6-.6 4.1-.6 4.1s.9-.8 1.4-1.9");
}
