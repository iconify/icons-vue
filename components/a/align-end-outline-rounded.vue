...
const content = `<path class="vww-pjw7o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-end-outline-rounded" /></template>
<style>
.vww-pjw7o {
  fill: currentColor;
