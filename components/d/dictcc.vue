...
const content = `<path class="o707_xbjc"/><path class="u9pt2ab9f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dictcc" /></template>
<style>
.o707_xbjc {
  fill: none;
  stroke: currentColor;
