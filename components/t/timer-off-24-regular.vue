...
const content = `<path class="l6wi-ilcx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:timer-off-24-regular" /></template>
<style>
.l6wi-ilcx {
  fill: currentColor;
