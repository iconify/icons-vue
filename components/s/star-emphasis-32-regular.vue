...
const content = `<path class="sjvfqtbrh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:star-emphasis-32-regular" /></template>
<style>
.sjvfqtbrh {
  fill: currentColor;
