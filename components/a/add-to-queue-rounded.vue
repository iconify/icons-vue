...
const content = `<path class="f1b7994xx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-to-queue-rounded" /></template>
<style>
.f1b7994xx {
  fill: currentColor;
