...
const content = `<path class="tg_x-cbev"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:contacts-sharp" /></template>
<style>
.tg_x-cbev {
  fill: currentColor;
