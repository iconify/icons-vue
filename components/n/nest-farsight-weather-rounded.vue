...
const content = `<path class="q2wo61o1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-farsight-weather-rounded" /></template>
<style>
.q2wo61o1j {
  fill: currentColor;
