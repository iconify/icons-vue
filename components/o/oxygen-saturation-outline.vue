...
const content = `<path class="u3tcukmad"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:oxygen-saturation-outline" /></template>
<style>
.u3tcukmad {
  fill: currentColor;
