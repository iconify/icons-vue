...
const content = `<g class="cuyn6tgcc"><path class="hidfxz0es"/><path class="htmflcc4f"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:tornado-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
