...
const content = `<path class="tj3vozb5h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hand-package" /></template>
<style>
.tj3vozb5h {
  fill: currentColor;
