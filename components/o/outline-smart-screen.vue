...
const content = `<path class="faab-lbtd"/><path class="idwqf0d1x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-smart-screen" /></template>
<style>
.faab-lbtd {
  fill: currentColor;
