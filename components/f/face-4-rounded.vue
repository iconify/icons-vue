...
const content = `<path class="fqabc7y_h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:face-4-rounded" /></template>
<style>
.fqabc7y_h {
  fill: currentColor;
