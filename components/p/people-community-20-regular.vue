...
const content = `<path class="fcb5a1bjw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-community-20-regular" /></template>
<style>
.fcb5a1bjw {
  fill: currentColor;
