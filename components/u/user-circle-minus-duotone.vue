...
const content = `<g class="cuyn6tgcc"><path class="erewjjzdk"/><path class="gbigp0bek"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:user-circle-minus-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
