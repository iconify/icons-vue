...
const content = `<path class="b_9c_3byd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-usage-toolbox-24-regular" /></template>
<style>
.b_9c_3byd {
  fill: currentColor;
