...
const content = `<path class="mvcvy_q2p"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:line-pop" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
