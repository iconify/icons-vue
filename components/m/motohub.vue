...
const content = `<path class="i9clfwm2k"/><path class="enyy7pb_g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:motohub" /></template>
<style>
.enyy7pb_g {
  fill: none;
  stroke: currentColor;
