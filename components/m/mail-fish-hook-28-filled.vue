...
const content = `<path class="ynpp29s6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-fish-hook-28-filled" /></template>
<style>
.ynpp29s6a {
  fill: currentColor;
