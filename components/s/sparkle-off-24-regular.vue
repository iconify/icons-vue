...
const content = `<path class="c0iifprbt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:sparkle-off-24-regular" /></template>
<style>
.c0iifprbt {
  fill: currentColor;
