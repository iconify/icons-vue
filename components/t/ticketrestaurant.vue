...
const content = `<path class="xfmv4tzxu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ticketrestaurant" /></template>
<style>
.xfmv4tzxu {
  fill: none;
  stroke: currentColor;
