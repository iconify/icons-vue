...
const content = `<path class="m8dwf_b3x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:percent-discount-sharp" /></template>
<style>
.m8dwf_b3x {
  fill: currentColor;
