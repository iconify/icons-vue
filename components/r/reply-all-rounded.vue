...
const content = `<path class="kdzu0ac8s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:reply-all-rounded" /></template>
<style>
.kdzu0ac8s {
  fill: currentColor;
