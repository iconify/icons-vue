...
const content = `<path class="ouguvunfs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:game-button-l2-outline-sharp" /></template>
<style>
.ouguvunfs {
  fill: currentColor;
