...
const content = `<path class="h4cj8hb4r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-flow-up-right-16-regular" /></template>
<style>
.h4cj8hb4r {
  fill: currentColor;
