...
const content = `<path class="oyylom2kr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phonelink-ring-off-outline" /></template>
<style>
.oyylom2kr {
  fill: currentColor;
