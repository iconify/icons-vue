...
const content = `<path class="vzds8ejvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-circle-one-light" /></template>
<style>
.vzds8ejvo {
  fill: currentColor;
