...
const content = `<path class="b1w0qbcqt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-autofit-height-20-regular" /></template>
<style>
.b1w0qbcqt {
  fill: currentColor;
