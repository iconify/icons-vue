...
const content = `<path class="tj-_6ibfy"/><g class="jdlfu_dix"><path class="hzg1akbgk"/><path class="x57g7cbon"/></g><path class="e1avnhwsp"/><path class="syr43ybks"/><path class="jo21i8bra"/><path class="runr8790n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:handshake" /></template>
<style>
.e1avnhwsp {
