...
const content = `<path class="dca9t9blb"/><path class="ghbyqhk-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dnv" /></template>
<style>
.dca9t9blb {
  fill: none;
  stroke: currentColor;
