...
const content = `<path class="ouxknnyve"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:shipping-container-fill" /></template>
<style>
.ouxknnyve {
  fill: currentColor;
