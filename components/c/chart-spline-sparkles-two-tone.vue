...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:chart-spline-sparkles-two-tone" /></template>
<style>
.i0e4rqb2u {
...
.ylvvsozxa {
  stroke-opacity: 0.4;
  d: path("M4 12L4 20C4 21.1046 4.8954 22 6 22L22 22");
}
