...
const content = `<path class="inktik0hu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bubbles-sharp" /></template>
<style>
.inktik0hu {
  fill: currentColor;
