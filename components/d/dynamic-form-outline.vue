...
const content = `<path class="elyh2hbey"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dynamic-form-outline" /></template>
<style>
.elyh2hbey {
  fill: currentColor;
