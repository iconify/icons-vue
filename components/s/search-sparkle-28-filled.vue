...
const content = `<path class="xznsopbrb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:search-sparkle-28-filled" /></template>
<style>
.xznsopbrb {
  fill: currentColor;
