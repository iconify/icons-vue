...
const content = `<path class="e6o4o8bfu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-assignment-returned" /></template>
<style>
.e6o4o8bfu {
  fill: currentColor;
