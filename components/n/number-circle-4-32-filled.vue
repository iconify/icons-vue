...
const content = `<path class="pgoxx1bow"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-4-32-filled" /></template>
<style>
.pgoxx1bow {
  fill: currentColor;
