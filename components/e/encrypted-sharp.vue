...
const content = `<path class="l9lf6el_g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:encrypted-sharp" /></template>
<style>
.l9lf6el_g {
  fill: currentColor;
