...
const content = `<path class="p48j94bzv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:report-off-rounded" /></template>
<style>
.p48j94bzv {
  fill: currentColor;
