...
const content = `<path class="kh239ibnn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-sound-2" /></template>
<style>
.kh239ibnn {
  fill: currentColor;
