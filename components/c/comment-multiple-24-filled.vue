...
const content = `<path class="yqkfgdbdn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-multiple-24-filled" /></template>
<style>
.yqkfgdbdn {
  fill: currentColor;
