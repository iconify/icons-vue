...
const content = `<path class="eexdil8gf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:electric-bike-outline" /></template>
<style>
.eexdil8gf {
  fill: currentColor;
