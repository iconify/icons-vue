...
const content = `<path class="en92gyz8m"/><path class="q6y4y29ds"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:powercenter" /></template>
<style>
.en92gyz8m {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M20.634 4.5v4.964H16.38c-.786 0-1.418.632-1.418 1.418v31.2c0 .786.632 1.418 1.418 1.418h14.89c.786 0 1.419-.632 1.419-1.418v-31.2c0-.786-.633-1.418-1.418-1.418h-4.255V4.5z");
}
