...
const content = `<path class="ewgf16bcm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fossify-thankyou" /></template>
<style>
.ewgf16bcm {
  fill: none;
  stroke: currentColor;
