...
const content = `<path class="jibgedy0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-hail-day-24-regular" /></template>
<style>
.jibgedy0l {
  fill: currentColor;
