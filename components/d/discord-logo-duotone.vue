...
const content = `<g class="cuyn6tgcc"><path class="uesf4jnky"/><path class="mhpp9-bui"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:discord-logo-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
