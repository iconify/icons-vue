...
const content = `<path class="xnsv5gbgl"/><path class="vubdscbal"/><path class="r66uli3dk"/><g class="hxik4rbqd"><path class="w8w2y4prq"/><circle class="aom7hvbij"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-philippines" /></template>
<style>
.aom7hvbij {
  cx: 15.7px;
  cy: 32px;
