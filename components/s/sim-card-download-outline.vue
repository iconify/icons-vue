...
const content = `<path class="zfohbsbuj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sim-card-download-outline" /></template>
<style>
.zfohbsbuj {
  fill: currentColor;
