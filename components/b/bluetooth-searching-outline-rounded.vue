...
const content = `<path class="twpot3bwa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bluetooth-searching-outline-rounded" /></template>
<style>
.twpot3bwa {
  fill: currentColor;
