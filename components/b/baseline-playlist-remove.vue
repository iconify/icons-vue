...
const content = `<path class="osmxkx6qh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-playlist-remove" /></template>
<style>
.osmxkx6qh {
  fill: currentColor;
