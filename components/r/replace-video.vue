...
const content = `<path class="ju749rb2w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:replace-video" /></template>
<style>
.ju749rb2w {
  fill: currentColor;
