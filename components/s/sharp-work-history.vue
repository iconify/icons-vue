...
const content = `<path class="tjete5bsi"/><path class="aj67gvb6m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-work-history" /></template>
<style>
.aj67gvb6m {
  fill: currentColor;
