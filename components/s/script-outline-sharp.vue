...
const content = `<path class="s0lwjx33n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:script-outline-sharp" /></template>
<style>
.s0lwjx33n {
  fill: currentColor;
