...
const content = `<path class="vdmwfwbhb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:copy-all" /></template>
<style>
.vdmwfwbhb {
  fill: currentColor;
