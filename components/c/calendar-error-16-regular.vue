...
const content = `<path class="k49hdrm5u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-error-16-regular" /></template>
<style>
.k49hdrm5u {
  fill: currentColor;
