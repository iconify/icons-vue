...
const content = `<path class="lf5ckjfeo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:subheader-outline-rounded" /></template>
<style>
.lf5ckjfeo {
  fill: currentColor;
