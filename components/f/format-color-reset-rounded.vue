...
const content = `<path class="hghzlhbiz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-color-reset-rounded" /></template>
<style>
.hghzlhbiz {
  fill: currentColor;
