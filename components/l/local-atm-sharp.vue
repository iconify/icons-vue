...
const content = `<path class="nt_r-4owt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-atm-sharp" /></template>
<style>
.nt_r-4owt {
  fill: currentColor;
