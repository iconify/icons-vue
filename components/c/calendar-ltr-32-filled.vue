...
const content = `<path class="gj-9nezfk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-ltr-32-filled" /></template>
<style>
.gj-9nezfk {
  fill: currentColor;
