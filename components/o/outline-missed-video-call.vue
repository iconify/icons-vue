...
const content = `<path class="rgesmft3r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-missed-video-call" /></template>
<style>
.rgesmft3r {
  fill: currentColor;
