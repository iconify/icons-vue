...
const content = `<path class="yffb-7b_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:convert-to-table-24-regular" /></template>
<style>
.yffb-7b_k {
  fill: currentColor;
