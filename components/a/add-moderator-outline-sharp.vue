...
const content = `<path class="oh7bt63ek"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-moderator-outline-sharp" /></template>
<style>
.oh7bt63ek {
  fill: currentColor;
