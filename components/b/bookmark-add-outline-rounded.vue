...
const content = `<path class="s6u4uvu8s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bookmark-add-outline-rounded" /></template>
<style>
.s6u4uvu8s {
  fill: currentColor;
