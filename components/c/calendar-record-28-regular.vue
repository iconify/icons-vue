...
const content = `<path class="ps58r9btt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-record-28-regular" /></template>
<style>
.ps58r9btt {
  fill: currentColor;
