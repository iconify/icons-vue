...
const content = `<path class="dn6lj7lmp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mark-email-unread-sharp" /></template>
<style>
.dn6lj7lmp {
  fill: currentColor;
