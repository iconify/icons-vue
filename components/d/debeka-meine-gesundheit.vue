...
const content = `<path class="ok42n-8-s"/><path class="vqrqqnbts"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:debeka-meine-gesundheit" /></template>
<style>
.ok42n-8-s {
  fill: none;
  stroke: currentColor;
