...
const content = `<path class="a12ssqpzf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:boat-railway" /></template>
<style>
.a12ssqpzf {
  fill: currentColor;
