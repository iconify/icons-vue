...
const content = `<path class="s_4b7hb5t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:auto-fit-height-28-regular" /></template>
<style>
.s_4b7hb5t {
  fill: currentColor;
