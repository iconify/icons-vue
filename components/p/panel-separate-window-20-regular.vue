...
const content = `<path class="hrpznpg2v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-separate-window-20-regular" /></template>
<style>
.hrpznpg2v {
  fill: currentColor;
