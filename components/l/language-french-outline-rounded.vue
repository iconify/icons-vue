...
const content = `<path class="h6do8bcff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:language-french-outline-rounded" /></template>
<style>
.h6do8bcff {
  fill: currentColor;
