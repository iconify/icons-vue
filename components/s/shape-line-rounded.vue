...
const content = `<path class="ctjqshoco"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shape-line-rounded" /></template>
<style>
.ctjqshoco {
  fill: currentColor;
