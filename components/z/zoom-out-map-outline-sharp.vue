...
const content = `<path class="cgylcbc-r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:zoom-out-map-outline-sharp" /></template>
<style>
.cgylcbc-r {
  fill: currentColor;
