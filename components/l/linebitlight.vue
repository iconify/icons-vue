...
const content = `<path class="brwv6cwkv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:linebitlight" /></template>
<style>
.brwv6cwkv {
  fill: none;
  stroke: currentColor;
