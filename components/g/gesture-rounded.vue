...
const content = `<path class="ughkkdcoi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:gesture-rounded" /></template>
<style>
.ughkkdcoi {
  fill: currentColor;
