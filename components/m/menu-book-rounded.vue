...
const content = `<path class="jo8an5grc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:menu-book-rounded" /></template>
<style>
.jo8an5grc {
  fill: currentColor;
