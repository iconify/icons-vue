...
const content = `<path class="h5j5-nbew"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-cloud-with-lightning" /></template>
<style>
.h5j5-nbew {
  fill: none;
  stroke: currentColor;
