...
const content = `<g class="nrj6p8qat"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="c_vx4nbon"/><path class="t04j2mb6v"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:fleet-cluster-outline-regular" /></template>
<style>
.c_vx4nbon {
