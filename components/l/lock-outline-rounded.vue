...
const content = `<path class="jz922m9-b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:lock-outline-rounded" /></template>
<style>
.jz922m9-b {
  fill: currentColor;
