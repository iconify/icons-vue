...
const content = `<path class="eoxnsjtvm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-simple-32-regular" /></template>
<style>
.eoxnsjtvm {
  fill: currentColor;
