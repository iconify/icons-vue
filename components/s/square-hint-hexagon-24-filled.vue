...
const content = `<path class="d4555g_xb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-hexagon-24-filled" /></template>
<style>
.d4555g_xb {
  fill: currentColor;
