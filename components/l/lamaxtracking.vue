...
const content = `<path class="i9clfwm2k"/><path class="b0atx3hsz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lamaxtracking" /></template>
<style>
.b0atx3hsz {
  fill: none;
  stroke: currentColor;
