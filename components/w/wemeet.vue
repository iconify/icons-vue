...
const content = `<path class="a9cp5dbvl"/><path class="rnyji3x5i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wemeet" /></template>
<style>
.a9cp5dbvl {
  fill: none;
  stroke: currentColor;
