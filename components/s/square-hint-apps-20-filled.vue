...
const content = `<path class="qow5y0bhm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-hint-apps-20-filled" /></template>
<style>
.qow5y0bhm {
  fill: currentColor;
