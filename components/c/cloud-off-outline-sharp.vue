...
const content = `<path class="plm8k6bzw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloud-off-outline-sharp" /></template>
<style>
.plm8k6bzw {
  fill: currentColor;
