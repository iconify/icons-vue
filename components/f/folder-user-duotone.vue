...
const content = `<g class="cuyn6tgcc"><path class="rjyehobsy"/><path class="z2vmwnbdg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-user-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
