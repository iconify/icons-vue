...
const content = `<g class="cuyn6tgcc"><path class="qn9efdb3p"/><path class="v1bwnd0yp"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:disco-ball-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
