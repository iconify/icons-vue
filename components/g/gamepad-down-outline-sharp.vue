...
const content = `<path class="ct8yd04gk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:gamepad-down-outline-sharp" /></template>
<style>
.ct8yd04gk {
  fill: currentColor;
