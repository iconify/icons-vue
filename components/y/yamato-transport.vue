...
const content = `<path class="jcrgnuc-e"/><path class="zl0ckzb0x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:yamato-transport" /></template>
<style>
.jcrgnuc-e {
  fill: none;
  stroke: currentColor;
...
.zl0ckzb0x {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M14.58 18.461c.862-.49 1.528-.768 2.57-.903m-5.77.903c-.86-.49-1.527-.768-2.569-.903m1.563 6.469a7.5 7.5 0 0 1 1.868-.352m-3.68.352a7.5 7.5 0 0 0-1.868-.352");
}
