...
const content = `<path class="i-6v8hbbs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-arrow-repeat-all-20-regular" /></template>
<style>
.i-6v8hbbs {
  fill: currentColor;
