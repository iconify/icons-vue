...
const content = `<path class="f00345bul"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:thumbs-up-down-outline-sharp" /></template>
<style>
.f00345bul {
  fill: currentColor;
