...
const content = `<path class="jijk20bno"/><circle class="rzy3fj1gc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-pool" /></template>
<style>
.jijk20bno {
  fill: currentColor;
