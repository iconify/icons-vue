...
const content = `<path class="xuoydwbam"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:location-arrow-16-regular" /></template>
<style>
.xuoydwbam {
  fill: currentColor;
