...
const content = `<path class="qhwm10bsd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:oven-gen-outline-rounded" /></template>
<style>
.qhwm10bsd {
  fill: currentColor;
