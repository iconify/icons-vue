...
const content = `<path class="xgr77obtq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:no-adult-content-outline-rounded" /></template>
<style>
.xgr77obtq {
  fill: currentColor;
