...
const content = `<path class="rexca-b0e"/><path class="e8gedzito"/><g class="n1mjunbsu"><circle class="ed6fmyb9l"/><circle class="fqau1xbcn"/></g><g class="fbp0m0b1e"><path class="cm3wbab7c"/><circle class="h3w494vbn"/></g><path class="qkva-gbfy"/><circle class="u6l8n6jdv"/><circle class="unarhpbhk"/><path class="d_lvc1h7j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:guard-medium-light-skin-tone" /></template>
<style>
.cm3wbab7c {
...
.qkva-gbfy {
  ...
  d: path("M42.7 46c0 .7-.6 1.3-1.2 1.3c-.7 0-1.3-.6-1.3-1.3s.6-1.3 1.3-1.3c.6 0 1.2.6 1.2 1.3");
}
