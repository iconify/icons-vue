...
const content = `<path class="bpw583boz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-outline-up-right-32-regular" /></template>
<style>
.bpw583boz {
  fill: currentColor;
