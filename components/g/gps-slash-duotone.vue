...
const content = `<g class="cuyn6tgcc"><path class="b5en88b-p"/><path class="h34unhb6x"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:gps-slash-duotone" /></template>
<style>
.b5en88b-p {
