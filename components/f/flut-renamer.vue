...
const content = `<path class="rv8nmjg8g"/><path class="dfzqigbnd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:flut-renamer" /></template>
<style>
.dfzqigbnd {
  fill: none;
  stroke: currentColor;
