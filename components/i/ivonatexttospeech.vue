...
const content = `<path class="gwiga8bef"/><circle class="smomcxbck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ivonatexttospeech" /></template>
<style>
.gwiga8bef {
  fill: none;
  stroke: currentColor;
