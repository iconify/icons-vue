...
const content = `<path class="wwzayzbgz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-connecting-20-filled" /></template>
<style>
.wwzayzbgz {
  fill: currentColor;
