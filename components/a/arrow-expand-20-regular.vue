...
const content = `<path class="lnkv9pb0r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-expand-20-regular" /></template>
<style>
.lnkv9pb0r {
  fill: currentColor;
