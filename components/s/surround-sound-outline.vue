...
const content = `<path class="oabx9cbdb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:surround-sound-outline" /></template>
<style>
.oabx9cbdb {
  fill: currentColor;
