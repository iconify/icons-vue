...
const content = `<path class="d53shv4jk"/><path class="zp_-khbma"/><path class="h6sxwsbmy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:free-download-manager" /></template>
<style>
.d53shv4jk {
  fill: none;
  stroke: currentColor;
