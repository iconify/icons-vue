...
const content = `<path class="uomqr8bjg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:trademark-registered-bold" /></template>
<style>
.uomqr8bjg {
  fill: currentColor;
