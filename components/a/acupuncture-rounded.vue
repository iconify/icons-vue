...
const content = `<path class="gzqb-fkxq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:acupuncture-rounded" /></template>
<style>
.gzqb-fkxq {
  fill: currentColor;
