...
const content = `<path class="aclk8kb3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:airline-seat-flat-angled" /></template>
<style>
.aclk8kb3l {
  fill: currentColor;
