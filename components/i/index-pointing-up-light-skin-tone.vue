...
const content = `<path class="dcvhr53ba"/><defs><path id="SVGWj2HCcSM" class="k0zim5bgm"/></defs><clipPath id="SVGhSdoVdxD"><use href="#SVGWj2HCcSM"/></clipPath><path clip-path="url(#SVGhSdoVdxD)" class="k3-h_zzxi"/><defs><use href="#SVGWj2HCcSM" id="SVGt5NmHeUS"/></defs><clipPath id="SVGKUt7mcPv"><use href="#SVGt5NmHeUS"/></clipPath><path clip-path="url(#SVGKUt7mcPv)" class="m_0h_obwp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:index-pointing-up-light-skin-tone" /></template>
<style>
.dcvhr53ba {
