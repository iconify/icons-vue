...
const content = `<path class="ooe4fw2_e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-text-16-regular" /></template>
<style>
.ooe4fw2_e {
  fill: currentColor;
