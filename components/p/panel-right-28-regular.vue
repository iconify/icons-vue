...
const content = `<path class="m8g7_wh4u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-right-28-regular" /></template>
<style>
.m8g7_wh4u {
  fill: currentColor;
