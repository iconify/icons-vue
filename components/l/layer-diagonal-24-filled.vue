...
const content = `<path class="bph_5-hcl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layer-diagonal-24-filled" /></template>
<style>
.bph_5-hcl {
  fill: currentColor;
