...
const content = `<path class="s035tib_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:battery-warning-vertical-thin" /></template>
<style>
.s035tib_k {
  fill: currentColor;
