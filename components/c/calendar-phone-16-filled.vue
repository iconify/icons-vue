...
const content = `<path class="m5zoidwuh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-phone-16-filled" /></template>
<style>
.m5zoidwuh {
  fill: currentColor;
