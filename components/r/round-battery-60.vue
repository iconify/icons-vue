...
const content = `<path class="khbpg3fdm"/><path class="upz1nctlr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-battery-60" /></template>
<style>
.khbpg3fdm {
  fill: currentColor;
