...
const content = `<path class="g0xg75wnk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:engineering-sharp" /></template>
<style>
.g0xg75wnk {
  fill: currentColor;
