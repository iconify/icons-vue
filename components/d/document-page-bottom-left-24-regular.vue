...
const content = `<path class="z96jwo4yx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-page-bottom-left-24-regular" /></template>
<style>
.z96jwo4yx {
  fill: currentColor;
