...
const content = `<path class="c5qzl6bft"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:new-label" /></template>
<style>
.c5qzl6bft {
  fill: currentColor;
