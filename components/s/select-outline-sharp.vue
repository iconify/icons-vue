...
const content = `<path class="y9hz515vn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:select-outline-sharp" /></template>
<style>
.y9hz515vn {
  fill: currentColor;
