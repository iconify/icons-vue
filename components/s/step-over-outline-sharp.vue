...
const content = `<path class="isacr0boa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:step-over-outline-sharp" /></template>
<style>
.isacr0boa {
  fill: currentColor;
