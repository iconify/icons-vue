...
const content = `<g class="cuyn6tgcc"><path class="b1sqawbzr"/><path class="o2b7cp6ee"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:magnifying-glass-minus-duotone" /></template>
<style>
.b1sqawbzr {
