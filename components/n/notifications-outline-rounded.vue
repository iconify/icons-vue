...
const content = `<path class="rba_y6ghe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:notifications-outline-rounded" /></template>
<style>
.rba_y6ghe {
  fill: currentColor;
