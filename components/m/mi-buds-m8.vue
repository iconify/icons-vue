...
const content = `<path class="at8lckcgp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mi-buds-m8" /></template>
<style>
.at8lckcgp {
  fill: none;
  stroke: currentColor;
