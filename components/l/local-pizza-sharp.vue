...
const content = `<path class="ssiru9bax"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-pizza-sharp" /></template>
<style>
.ssiru9bax {
  fill: currentColor;
