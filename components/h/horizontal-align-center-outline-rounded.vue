...
const content = `<path class="ut9bw6bgi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:horizontal-align-center-outline-rounded" /></template>
<style>
.ut9bw6bgi {
  fill: currentColor;
