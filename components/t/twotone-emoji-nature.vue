...
const content = `<circle class="hnbliswjk"/><path class="qi_ueabvb"/><path class="l-kglkbcn"/><path class="q6r3l6nlu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-emoji-nature" /></template>
<style>
.hnbliswjk {
  cx: 18px;
  cy: 6px;
