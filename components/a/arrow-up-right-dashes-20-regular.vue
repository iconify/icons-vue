...
const content = `<path class="ci78ymb8g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-up-right-dashes-20-regular" /></template>
<style>
.ci78ymb8g {
  fill: currentColor;
