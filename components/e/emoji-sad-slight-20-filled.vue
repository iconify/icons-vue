...
const content = `<path class="monnj3ebp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-sad-slight-20-filled" /></template>
<style>
.monnj3ebp {
  fill: currentColor;
