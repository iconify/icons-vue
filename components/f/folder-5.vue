...
const content = `<path class="h0qgeuwow"/><path class="r5m638bba"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:folder-5" /></template>
<style>
.h0qgeuwow {
  fill: none;
  stroke: currentColor;
