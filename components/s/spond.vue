...
const content = `<circle class="cpk0fnbgt"/><path class="bfn47vb_v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:spond" /></template>
<style>
.bfn47vb_v {
  fill: none;
  stroke: currentColor;
