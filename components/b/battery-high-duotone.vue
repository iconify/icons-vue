...
const content = `<g class="cuyn6tgcc"><path class="ta_khf4lj"/><path class="bd_910j5g"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:battery-high-duotone" /></template>
<style>
.bd_910j5g {
