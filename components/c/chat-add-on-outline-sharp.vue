...
const content = `<path class="w330l1b1h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chat-add-on-outline-sharp" /></template>
<style>
.w330l1b1h {
  fill: currentColor;
