...
const content = `<path class="g2iqzxb8e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:border-outer-outline" /></template>
<style>
.g2iqzxb8e {
  fill: currentColor;
