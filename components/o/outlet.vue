...
const content = `<path class="seqoq3bqc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:outlet" /></template>
<style>
.seqoq3bqc {
  fill: currentColor;
