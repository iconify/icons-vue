...
const content = `<path class="oplph6bns"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:credit-score-rounded" /></template>
<style>
.oplph6bns {
  fill: currentColor;
