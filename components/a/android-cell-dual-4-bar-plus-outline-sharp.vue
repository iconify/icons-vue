...
const content = `<path class="s6emnddza"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:android-cell-dual-4-bar-plus-outline-sharp" /></template>
<style>
.s6emnddza {
  fill: currentColor;
