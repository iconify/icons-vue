...
const content = `<path class="gx6a0l4vu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:card-travel-rounded" /></template>
<style>
.gx6a0l4vu {
  fill: currentColor;
