...
const content = `<path class="aax2cybvw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-decrease-ltr-rotate-270-24-filled" /></template>
<style>
.aax2cybvw {
  fill: currentColor;
