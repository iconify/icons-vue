...
const content = `<path class="xyqjybbwn"/><path class="jl6117dmc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:handelsbanken" /></template>
<style>
.jl6117dmc {
  fill: none;
  stroke: currentColor;
