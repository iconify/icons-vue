...
const content = `<path class="wyknkcb8q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:android-wifi-4-bar-off-outline" /></template>
<style>
.wyknkcb8q {
  fill: currentColor;
