...
const content = `<path class="cvcvyeb9j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:credit-card-heart" /></template>
<style>
.cvcvyeb9j {
  fill: currentColor;
