...
const content = `<path class="a_x7o5bdj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shadow-add-outline" /></template>
<style>
.a_x7o5bdj {
  fill: currentColor;
