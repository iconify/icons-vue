...
const content = `<path class="hij0ebcjp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:yakitori-outline-rounded" /></template>
<style>
.hij0ebcjp {
  fill: currentColor;
