...
const content = `<g class="cuyn6tgcc"><path class="r2meezbdb"/><path class="pamafabgx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:tree-palm-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
