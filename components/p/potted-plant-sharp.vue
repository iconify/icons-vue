...
const content = `<path class="di3nsffby"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:potted-plant-sharp" /></template>
<style>
.di3nsffby {
  fill: currentColor;
