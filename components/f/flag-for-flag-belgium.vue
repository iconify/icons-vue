...
const content = `<path class="fohd6dqnc"/><path class="cqownccta"/><path class="t_rlincix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-belgium" /></template>
<style>
.cqownccta {
