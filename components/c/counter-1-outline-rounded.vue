...
const content = `<path class="o2tn0vqvp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:counter-1-outline-rounded" /></template>
<style>
.o2tn0vqvp {
  fill: currentColor;
