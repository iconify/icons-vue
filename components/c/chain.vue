...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="tqbhefbpm"/><path class="q0enigkep"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:chain" /></template>
<style>
.n1lsf0bnc {
  fill: currentColor;
  fill-rule: evenodd;
