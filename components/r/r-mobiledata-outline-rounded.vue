...
const content = `<path class="dcyollbin"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:r-mobiledata-outline-rounded" /></template>
<style>
.dcyollbin {
  fill: currentColor;
