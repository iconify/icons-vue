...
const content = `<path class="nvk11hb7w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:door-back" /></template>
<style>
.nvk11hb7w {
  fill: currentColor;
