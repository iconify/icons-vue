...
const content = `<path class="ajd49zbpg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:contact-emergency-rounded" /></template>
<style>
.ajd49zbpg {
  fill: currentColor;
