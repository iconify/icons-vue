...
const content = `<rect class="j3s9ivbxi"/><path class="h-evtwb-e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tab" /></template>
<style>
.h-evtwb-e {
  fill: none;
  stroke: currentColor;
