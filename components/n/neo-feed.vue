...
const content = `<path class="wm0jo_bqc"/><path class="p8t2csbzk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:neo-feed" /></template>
<style>
.p8t2csbzk {
  fill: none;
  stroke: currentColor;
