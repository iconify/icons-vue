...
const content = `<path class="mql5ofvnp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-filter-tilt-shift" /></template>
<style>
.mql5ofvnp {
  fill: currentColor;
