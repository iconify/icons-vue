...
const content = `<path class="pce8qkbva"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notebook-error-24-filled" /></template>
<style>
.pce8qkbva {
  fill: currentColor;
