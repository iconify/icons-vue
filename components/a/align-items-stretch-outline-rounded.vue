...
const content = `<path class="aq7qqwblh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-items-stretch-outline-rounded" /></template>
<style>
.aq7qqwblh {
  fill: currentColor;
