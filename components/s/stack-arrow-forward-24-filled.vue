...
const content = `<path class="h-a0l2b5q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:stack-arrow-forward-24-filled" /></template>
<style>
.h-a0l2b5q {
  fill: currentColor;
