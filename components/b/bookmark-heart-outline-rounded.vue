...
const content = `<path class="og4m80b4u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bookmark-heart-outline-rounded" /></template>
<style>
.og4m80b4u {
  fill: currentColor;
