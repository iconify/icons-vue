...
const content = `<path class="x3v5ifs0p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:water-drops-sharp" /></template>
<style>
.x3v5ifs0p {
  fill: currentColor;
