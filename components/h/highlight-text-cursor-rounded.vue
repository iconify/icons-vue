...
const content = `<path class="gbrjgubum"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:highlight-text-cursor-rounded" /></template>
<style>
.gbrjgubum {
  fill: currentColor;
