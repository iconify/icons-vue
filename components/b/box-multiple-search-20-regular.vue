...
const content = `<path class="vujet9b-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:box-multiple-search-20-regular" /></template>
<style>
.vujet9b-j {
  fill: currentColor;
