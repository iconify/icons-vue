...
const content = `<path class="juqgsgw1a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:show-chart-outline-rounded" /></template>
<style>
.juqgsgw1a {
  fill: currentColor;
