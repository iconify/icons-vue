...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGXPILveGM)" class="toyu-kbwl"/><defs><linearGradient id="SVGXPILveGM" x1="3" x2="21" y1="12" y2="12" gradientUnits="userSpaceOnUse"><stop class="ov87g3b_i"/><stop offset="1" class="ghqnkmbsh"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:ultron" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
