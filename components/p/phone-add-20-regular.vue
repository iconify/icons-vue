...
const content = `<path class="sziw4ybrq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-add-20-regular" /></template>
<style>
.sziw4ybrq {
  fill: currentColor;
