...
const content = `<path class="td_xoubps"/><path class="kzykk8swa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-samsung-20" /></template>
<style>
.kzykk8swa {
  fill: none;
  stroke: currentColor;
