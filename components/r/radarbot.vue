...
const content = `<path class="hqo15y6eh"/><path class="ouij8hbjj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:radarbot" /></template>
<style>
.hqo15y6eh {
  fill: none;
  stroke: currentColor;
