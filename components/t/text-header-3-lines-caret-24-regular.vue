...
const content = `<path class="bw-7rbz7w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-3-lines-caret-24-regular" /></template>
<style>
.bw-7rbz7w {
  fill: currentColor;
