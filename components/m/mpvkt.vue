...
const content = `<path class="t1ngo9agg"/><path class="yo6hrzkof"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mpvkt" /></template>
<style>
.t1ngo9agg {
  fill: none;
  stroke: currentColor;
