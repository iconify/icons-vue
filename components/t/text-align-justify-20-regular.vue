...
const content = `<path class="gorau9bhf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-align-justify-20-regular" /></template>
<style>
.gorau9bhf {
  fill: currentColor;
