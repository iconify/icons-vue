...
const content = `<path class="d-s66_wor"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-split-hint-off-24-filled" /></template>
<style>
.d-s66_wor {
  fill: currentColor;
