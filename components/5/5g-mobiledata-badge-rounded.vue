...
const content = `<path class="bhsyhybyi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:5g-mobiledata-badge-rounded" /></template>
<style>
.bhsyhybyi {
  fill: currentColor;
