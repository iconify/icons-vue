...
const content = `<path class="y9es4nbli"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:switch-off-rounded" /></template>
<style>
.y9es4nbli {
  fill: currentColor;
