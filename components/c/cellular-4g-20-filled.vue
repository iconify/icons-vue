...
const content = `<path class="w-88eu33e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cellular-4g-20-filled" /></template>
<style>
.w-88eu33e {
  fill: currentColor;
