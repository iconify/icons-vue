...
const content = `<path class="d9_l2ormg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-upward-outline-rounded" /></template>
<style>
.d9_l2ormg {
  fill: currentColor;
