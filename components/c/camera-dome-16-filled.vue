...
const content = `<path class="svyavvafw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:camera-dome-16-filled" /></template>
<style>
.svyavvafw {
  fill: currentColor;
