...
const content = `<path class="sl1iepbdy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sort-outline-rounded" /></template>
<style>
.sl1iepbdy {
  fill: currentColor;
