...
const content = `<path class="pkdm99jhb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:counter-0-rounded" /></template>
<style>
.pkdm99jhb {
  fill: currentColor;
