...
const content = `<path class="bkg602w8n"/><path class="mnnv-jbyh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:vs-button" /></template>
<style>
.bkg602w8n {
