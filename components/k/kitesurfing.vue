...
const content = `<path class="fia9ecbui"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:kitesurfing" /></template>
<style>
.fia9ecbui {
  fill: currentColor;
