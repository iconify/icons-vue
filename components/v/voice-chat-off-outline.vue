...
const content = `<path class="b7yubuxjv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:voice-chat-off-outline" /></template>
<style>
.b7yubuxjv {
  fill: currentColor;
