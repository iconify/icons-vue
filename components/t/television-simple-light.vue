...
const content = `<path class="npdz8_fvw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:television-simple-light" /></template>
<style>
.npdz8_fvw {
  fill: currentColor;
