...
const content = `<path class="xaxshyi7x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nga-client" /></template>
<style>
.xaxshyi7x {
  fill: none;
  stroke: currentColor;
