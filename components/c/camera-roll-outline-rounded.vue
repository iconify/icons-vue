...
const content = `<path class="k_muzehsm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:camera-roll-outline-rounded" /></template>
<style>
.k_muzehsm {
  fill: currentColor;
