...
const content = `<path class="foybid0tu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-multiple-20-regular" /></template>
<style>
.foybid0tu {
  fill: currentColor;
