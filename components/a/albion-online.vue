...
const content = `<path class="uahkptbcm"/><path class="z3h8tbq7a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:albion-online" /></template>
<style>
.uahkptbcm {
  fill: none;
  stroke: currentColor;
...
.z3h8tbq7a {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M25.15 12.529c-1.075 1.267-1.682 3.01-1.8 4.838a.65.65 0 0 0 .665.68l3.866-.02a.69.69 0 0 0 .685-.688v-2.392c0-.378-.227-.89-.519-1.131a27 27 0 0 0-1.94-1.432c-.266-.182-.516-.307-.557-.282z");
}
