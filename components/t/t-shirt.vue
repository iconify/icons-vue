...
const content = `<path class="x8v3p68xv"/><path class="cf4alsb6s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:t-shirt" /></template>
<style>
.cf4alsb6s {
  fill: var(--svg-color--22648c, #22648c);
...
.x8v3p68xv {
  ...
  d: path("M63.7 16.1S57.6 4.1 56 3.2s-10.5-.7-13.8-2c0 0-4.1 4.8-10.2 4.8S21.8 1.2 21.8 1.2C18.4 2.5 9.6 2.3 8 3.2S.2 16.1.2 16.1c3.4 7.7 11.4 9.4 11.4 9.4l3.2-5l-1.5 38.7C21 63.7 26.6 64 32 64s10.9-.3 18.6-4.7l-1.5-38.7l3.2 5c0-.1 8.1-1.7 11.4-9.5");
}
