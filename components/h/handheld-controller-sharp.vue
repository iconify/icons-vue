...
const content = `<path class="o09hgtbrt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:handheld-controller-sharp" /></template>
<style>
.o09hgtbrt {
  fill: currentColor;
