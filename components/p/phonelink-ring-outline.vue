...
const content = `<path class="bh33fkwze"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phonelink-ring-outline" /></template>
<style>
.bh33fkwze {
  fill: currentColor;
