...
const content = `<path class="r12ethrzq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dining-sharp" /></template>
<style>
.r12ethrzq {
  fill: currentColor;
