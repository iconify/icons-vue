...
const content = `<path class="iaayklbrb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desk-multiple-20-regular" /></template>
<style>
.iaayklbrb {
  fill: currentColor;
