...
const content = `<path class="slug1wbxm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-arrow-down-outline-sharp" /></template>
<style>
.slug1wbxm {
  fill: currentColor;
