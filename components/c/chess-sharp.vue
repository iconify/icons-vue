...
const content = `<path class="hzeylpd3a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chess-sharp" /></template>
<style>
.hzeylpd3a {
  fill: currentColor;
