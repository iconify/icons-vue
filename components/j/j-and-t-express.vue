...
const content = `<path class="kt_ridfzh"/><path class="rvno_8b-t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:j-and-t-express" /></template>
<style>
.kt_ridfzh {
  fill: none;
  stroke: currentColor;
