...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:calendar-x-sharp-fill" /></template>
<style>
.b3w-c-s0b {
  fill: currentColor;
  fill-rule: evenodd;
...
.o70mxzb3u {
  d: path("M8 2L8 8M16 2L16 8M14.7071 14.7071L21.2929 21.2929M21.2929 14.7071L14.7071 21.2929");
}
