...
const content = `<path class="jqo_uxb1y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:speaker-2-outline" /></template>
<style>
.jqo_uxb1y {
  fill: currentColor;
