...
const content = `<path class="bg_frq4xq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:glucose-rounded" /></template>
<style>
.bg_frq4xq {
  fill: currentColor;
