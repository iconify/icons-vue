...
const content = `<path class="xnqb81c_m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-sad-16-regular" /></template>
<style>
.xnqb81c_m {
  fill: currentColor;
