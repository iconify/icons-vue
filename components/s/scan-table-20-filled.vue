...
const content = `<path class="z8fs9855w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-table-20-filled" /></template>
<style>
.z8fs9855w {
  fill: currentColor;
