...
const content = `<path class="ixcl1kv6y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-text-rotation-angledown" /></template>
<style>
.ixcl1kv6y {
  fill: currentColor;
