...
const content = `<g class="gp_8x1bzb"><path class="xgaf0nbdt"/><path class="p3qfggx2o"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-check-sharp" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.p3qfggx2o {
  d: path("M7.7016 11.6644L10.6667 15L16.2984 8.6644");
}
