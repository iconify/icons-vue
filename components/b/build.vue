...
const content = `<path class="mu04t9b8q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:build" /></template>
<style>
.mu04t9b8q {
  fill: currentColor;
