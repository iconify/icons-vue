...
const content = `<path class="kd9ascbuz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:google-photos-logo-light" /></template>
<style>
.kd9ascbuz {
  fill: currentColor;
