...
const content = `<path class="hev9gobyd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-header-dismiss-24-filled" /></template>
<style>
.hev9gobyd {
  fill: currentColor;
