...
const content = `<path class="mjw4kjb1o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:package-outline" /></template>
<style>
.mjw4kjb1o {
  fill: currentColor;
