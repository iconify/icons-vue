...
const content = `<path class="d_tehs2uk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:double-swipe-down-20-filled" /></template>
<style>
.d_tehs2uk {
  fill: currentColor;
