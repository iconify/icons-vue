...
const content = `<path class="ahldkytwm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tasker" /></template>
<style>
.ahldkytwm {
  fill: none;
  stroke: currentColor;
