...
const content = `<path class="ikay4kb2p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:potted-plant-outline-sharp" /></template>
<style>
.ikay4kb2p {
  fill: currentColor;
