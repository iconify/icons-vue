...
const content = `<path class="u3geqvb9c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:expand-content-outline-rounded" /></template>
<style>
.u3geqvb9c {
  fill: currentColor;
