...
const content = `<path class="sab63gz6p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-people-24-filled" /></template>
<style>
.sab63gz6p {
  fill: currentColor;
