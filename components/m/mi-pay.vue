...
const content = `<path class="o7lcddc0y"/><g class="y9tr6bcfx"><path class="d-c07eu5x"/><path class="bi6m2w25r"/></g><path class="lywm_rb0h"/><path class="fto1rpb4m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mi-pay" /></template>
<style>
.bi6m2w25r {
