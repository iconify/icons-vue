...
const content = `<path class="aohwg-kvb"/><path class="av2c1zbah"/><path class="fe62gacxq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:beanconqueror" /></template>
<style>
.aohwg-kvb {
  fill: none;
  stroke: currentColor;
