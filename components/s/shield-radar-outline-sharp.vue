...
const content = `<path class="o6egl9bno"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-radar-outline-sharp" /></template>
<style>
.o6egl9bno {
  fill: currentColor;
