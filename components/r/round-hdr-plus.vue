...
const content = `<path class="xjqla2bkx"/><path class="u0xetdo6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-hdr-plus" /></template>
<style>
.u0xetdo6u {
  fill: currentColor;
