...
const content = `<g class="nrj6p8qat"><path clip-rule="evenodd" class="djkklnbjb"/><path class="w8wjawbcc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:app-check-fill" /></template>
<style>
.djkklnbjb {
  fill: currentColor;
  fill-rule: evenodd;
