...
const content = `<path class="v84p8qr8w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:automan-folder-widget" /></template>
<style>
.v84p8qr8w {
  fill: none;
  stroke: currentColor;
