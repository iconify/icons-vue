...
const content = `<path class="b0mfs5v3o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:comic-bubble-outline-sharp" /></template>
<style>
.b0mfs5v3o {
  fill: currentColor;
