...
const content = `<path class="smzwlc4dy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:border-right-outline-sharp" /></template>
<style>
.smzwlc4dy {
  fill: currentColor;
