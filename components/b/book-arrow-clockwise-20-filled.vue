...
const content = `<path class="fvcx0sbfc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:book-arrow-clockwise-20-filled" /></template>
<style>
.fvcx0sbfc {
  fill: currentColor;
