...
const content = `<path class="kcbrfbb_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:settings-20-regular" /></template>
<style>
.kcbrfbb_q {
  fill: currentColor;
