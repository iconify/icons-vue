...
const content = `<g class="ft5dv1b6b"><path class="oc4eb6huh"/><path class="f5iexqbdc"/><path fill="url(#SVGiNmZecxc)" clip-rule="evenodd" class="qwvnsgbys"/><defs><linearGradient id="SVGiNmZecxc" x1="7.752" x2="17.223" y1="4.128" y2="20.272" gradientUnits="userSpaceOnUse"><stop class="j6-7k9b4t"/><stop offset="1" class="p4p_w0i5b"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:dxgm" /></template>
<style>
.f5iexqbdc {
  fill: var(--svg-color--ee008e, #ee008e);
  d: path("M17 7.003h-2.09L13.5 9.322L14.566 11z");
}
