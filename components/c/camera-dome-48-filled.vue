...
const content = `<path class="bq8pwqb9c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:camera-dome-48-filled" /></template>
<style>
.bq8pwqb9c {
  fill: currentColor;
