...
const content = `<path class="neeqskn_j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-ad-outline-rounded" /></template>
<style>
.neeqskn_j {
  fill: currentColor;
