...
const content = `<path class="g5ky9bbxz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:helicopter-outline-rounded" /></template>
<style>
.g5ky9bbxz {
  fill: currentColor;
