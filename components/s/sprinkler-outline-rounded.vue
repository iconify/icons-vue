...
const content = `<path class="g6cw9m4ys"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sprinkler-outline-rounded" /></template>
<style>
.g6cw9m4ys {
  fill: currentColor;
