...
const content = `<path class="ss_0dej9z"/><path class="ahs0-vifi"/><path class="sw__qlo3e"/>`;
</script>
...
.ahs0-vifi {
  ...
  d: path("M22.421 20.425c-4.49.43-5.525 2.732-5.525 2.732c0-3.885 3.148-7.035 7.03-7.035s7.03 3.15 7.03 7.035c0 0-1.036-2.302-5.527-2.732");
}
