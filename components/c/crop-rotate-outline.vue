...
const content = `<path class="b6-y_ubfw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:crop-rotate-outline" /></template>
<style>
.b6-y_ubfw {
  fill: currentColor;
