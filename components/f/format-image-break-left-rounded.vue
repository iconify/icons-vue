...
const content = `<path class="wtuxpgkag"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-image-break-left-rounded" /></template>
<style>
.wtuxpgkag {
  fill: currentColor;
