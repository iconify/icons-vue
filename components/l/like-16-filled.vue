...
const content = `<g class="ft5dv1b6b"><path class="l5sedwkrj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:like-16-filled" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
