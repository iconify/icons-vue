...
const content = `<path class="ahc9kxb_s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:question-circle-20-filled" /></template>
<style>
.ahc9kxb_s {
  fill: currentColor;
