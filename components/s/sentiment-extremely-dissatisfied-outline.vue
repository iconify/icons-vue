...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sentiment-extremely-dissatisfied-outline" /></template>
<style>
.rzqhjtb3q {
  fill: currentColor;
