...
const content = `<path class="mt8f5q9fm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-align-bottom-right-16-filled" /></template>
<style>
.mt8f5q9fm {
  fill: currentColor;
