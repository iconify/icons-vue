...
const content = `<path class="xv9c_mbpe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bumrungrad" /></template>
<style>
.xv9c_mbpe {
  fill: none;
  stroke: currentColor;
