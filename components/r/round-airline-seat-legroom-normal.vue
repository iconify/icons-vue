...
const content = `<path class="q3v7b-b1d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-airline-seat-legroom-normal" /></template>
<style>
.q3v7b-b1d {
  fill: currentColor;
