...
const content = `<g class="cuyn6tgcc"><path class="tcqfacbcl"/><path class="p2e14xb7w"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:lightning-a-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
