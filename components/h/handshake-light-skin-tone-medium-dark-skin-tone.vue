...
const content = `<path class="irq7wbb2e"/><path class="vhbcblygw"/><defs><path id="SVGU67dBeQS" class="l439n0bap"/></defs><clipPath id="SVG617RIbte"><use href="#SVGU67dBeQS"/></clipPath><g clip-path="url(#SVG617RIbte)" class="qln5uhbpq"><path class="o4yqbwbdl"/></g><defs><use href="#SVGU67dBeQS" id="SVGCPeKAdMZ"/></defs><clipPath id="SVG3ABvZdad"><use href="#SVGCPeKAdMZ"/></clipPath><g clip-path="url(#SVG3ABvZdad)" class="oadpy4acg"><path class="oqad6y8ry"/></g><defs/><g clip-path="url(#SVG3ABvZdad)" class="k4qe_xbxk"><path class="s2_2_ccsc"/></g><defs/><g clip-path="url(#SVG3ABvZdad)" class="u0e24bcck"><path class="trz1g0bjh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:handshake-light-skin-tone-medium-dark-skin-tone" /></template>
<style>
.irq7wbb2e {
  fill: var(--svg-color--f9ddbd, #f9ddbd);
  d: path("M69.3 31.7c11.4-1.9 31.6 1.3 44.8-7.6c1.7-1.2 2.6-.1 3 .4c3.2 4.1 6.7 28.5 4.9 34.7c-.5 1.7-1.2 2.2-2.1 2.8c-2.1 1.6-9 6.8-15.9 16c1.8 3.1 1.2 5.6-.8 7.7c-2 2.2-4.3 3-7.3 2c0 2.4-.2 3.7-1.7 5.2c-2.3 2.2-5.6 2.8-8.1 2.3c.2 2.5-1.3 3.8-2.4 4.6c-2.5 1.9-4.9 2.4-8.3 1c-.7 1.4-5.3 6-10.9 2.4c-1.1-.7-3.7-2.6-3.7-2.6s-5.3 5-10.8 2.8c-1.1-.4-2.6-1.8-3-3.1c-1.3.9-5 1.2-6.9-.2c-1.8-1.4-4.2-3.6-3.6-7.3c-2 .8-3.8.9-6.5-1.6c-2-1.9-3.7-4.4-2.4-6.6c-2.1.4-3.7-.3-4.7-1.5s-3.4-4.8-.7-8.2c-7.5-5-11.9-9.5-13.8-10.4c-1.1-.6-1.9-1.5-2.2-2.8c-.9-4.7 0-30.5 5.1-36c.9-1 2.1-.7 2.7-.3c29.7 18.1 37.5 0 55.3 6.3");
}
...
.o4yqbwbdl {
  d: path("M22.5 72.1s-14-8.7-15-9.3s-1.6-1.6-2.3-3s-.8 1.4-.8 1.4l12.2 17.5c2.2-1.9 4.4-3.8 6.6-5.9c-.2-.5-.7-.7-.7-.7m82.6 5.4c-4.7-1.9-5.9-8.2-10.5-10c1.9 2.7 4.7 6.8 5.3 7.6c1.6 2.2.8 3.6.3 4.5c-.6.9-1.9 2.5-3.1 3.5c-1.8 1.5-4.2.9-5.3.2s-3.3-.4-2 1.2c2.3 3 1.3 4.3 1 4.9c-.5.8-1.5 1.9-2.2 2.5c-1.4 1.2-4.4.9-5.5.2s-3.6-.9-2.5.4c1.7 2 .4 3.6.1 4s-1 1.1-2 2.2c-.8.9-2.9 1-4.1.3c-.7-.4-4.2-3.3-5-3.8s-2.4-.1-.9 2c1.5 2.2 1.3 2.7.8 3.5c-.2.3-.6.8-1.3 1.5c-1.4 1.4-3.3-.2-3.3-.2l-5.7-4s-.3.2-1.1.7c.3 2.7 1.3 5.4 1.7 8l2.3.3l22.4-4.3l23.8-18.2zM80.8 52.2c-1.9-1.1-4.2-2.6-7.7-1s-11.6 5.4-13.9 6.4c-2.4 1-8.4 2.6-11.9-2.5c4.6-1.3 19.8-7 19.8-7l6.8-.9l5.3 1.9s1.8 1.4 2.4 2c.7.6-.8 1.1-.8 1.1M78 20.5c-30.6.2-68.9.4-68.9.4l.6 5c31.8 19.3 40.3 4.9 51.5 6.9c3.2-.5 8.8-1.6 10.7-1.8c6.5-3.4 5.7-1.2 6.1-10.5");
}
