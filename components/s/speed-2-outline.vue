...
const content = `<path class="ivmjulb5m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speed-2-outline" /></template>
<style>
.ivmjulb5m {
  fill: currentColor;
