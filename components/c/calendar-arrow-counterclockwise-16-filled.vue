...
const content = `<path class="udo92hb7b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-arrow-counterclockwise-16-filled" /></template>
<style>
.udo92hb7b {
  fill: currentColor;
