...
const content = `<path class="d40ppybar"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:save-multiple-20-filled" /></template>
<style>
.d40ppybar {
  fill: currentColor;
