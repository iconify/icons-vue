...
const content = `<path class="ulda4wckn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cookie-outline-rounded" /></template>
<style>
.ulda4wckn {
  fill: currentColor;
