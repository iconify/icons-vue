...
const content = `<path class="icw-3rx6e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:virtual-pag-ibig" /></template>
<style>
.icw-3rx6e {
  fill: none;
  stroke: currentColor;
