...
const content = `<path class="gbb5l-bws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:markdown-paste-outline-rounded" /></template>
<style>
.gbb5l-bws {
  fill: currentColor;
