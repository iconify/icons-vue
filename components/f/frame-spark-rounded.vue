...
const content = `<path class="z8-qlwidl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:frame-spark-rounded" /></template>
<style>
.z8-qlwidl {
  fill: currentColor;
