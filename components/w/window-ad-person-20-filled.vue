...
const content = `<path class="dbb5gm2ad"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-ad-person-20-filled" /></template>
<style>
.dbb5gm2ad {
  fill: currentColor;
