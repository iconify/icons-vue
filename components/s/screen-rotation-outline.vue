...
const content = `<path class="r4m-ztbxf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screen-rotation-outline" /></template>
<style>
.r4m-ztbxf {
  fill: currentColor;
