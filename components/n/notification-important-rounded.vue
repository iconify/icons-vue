...
const content = `<path class="udbuhy_eb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:notification-important-rounded" /></template>
<style>
.udbuhy_eb {
  fill: currentColor;
