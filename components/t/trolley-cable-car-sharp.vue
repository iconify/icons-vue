...
const content = `<path class="q04tzdsdy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:trolley-cable-car-sharp" /></template>
<style>
.q04tzdsdy {
  fill: currentColor;
