...
const content = `<path class="whxmucdae"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:airlines-rounded" /></template>
<style>
.whxmucdae {
  fill: currentColor;
