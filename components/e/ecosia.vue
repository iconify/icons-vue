...
const content = `<path class="ija4tzb-t"/><path class="um5v1dbyi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ecosia" /></template>
<style>
.ija4tzb-t {
  fill: none;
  stroke: currentColor;
...
.um5v1dbyi {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M26.805 24h-3.662v-2.448H29v-5.72H19v16.336h10v-5.591h-5.857v-2.578");
}
