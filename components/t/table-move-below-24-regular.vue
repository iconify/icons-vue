...
const content = `<path class="vznduxd9i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-below-24-regular" /></template>
<style>
.vznduxd9i {
  fill: currentColor;
