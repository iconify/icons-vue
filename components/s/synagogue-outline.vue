...
const content = `<path class="qz998mmsn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:synagogue-outline" /></template>
<style>
.qz998mmsn {
  fill: currentColor;
