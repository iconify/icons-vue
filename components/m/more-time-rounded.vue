...
const content = `<path class="hwjm2rzon"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:more-time-rounded" /></template>
<style>
.hwjm2rzon {
  fill: currentColor;
