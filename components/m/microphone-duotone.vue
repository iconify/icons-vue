...
const content = `<g class="cuyn6tgcc"><path class="o-v2ke6hu"/><path class="t5xzafrpl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:microphone-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
