...
const content = `<path class="v89rv-b1q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-missed-24-filled" /></template>
<style>
.v89rv-b1q {
  fill: currentColor;
