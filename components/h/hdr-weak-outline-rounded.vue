...
const content = `<path class="t44bfbcbh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hdr-weak-outline-rounded" /></template>
<style>
.t44bfbcbh {
  fill: currentColor;
