...
const content = `<path class="b32xzzb-m"/><path class="c912xaciq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wireless-adb" /></template>
<style>
.b32xzzb-m {
  fill: none;
  stroke: currentColor;
