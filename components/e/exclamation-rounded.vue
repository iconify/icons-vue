...
const content = `<path class="q-jo4d_6e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:exclamation-rounded" /></template>
<style>
.q-jo4d_6e {
  fill: currentColor;
