...
const content = `<path class="jkagxrbsa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:contract-up-right-48-filled" /></template>
<style>
.jkagxrbsa {
  fill: currentColor;
