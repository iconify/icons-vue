...
const content = `<path class="relhynbgu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:coin-multiple-24-filled" /></template>
<style>
.relhynbgu {
  fill: currentColor;
