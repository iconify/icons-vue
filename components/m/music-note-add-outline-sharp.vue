...
const content = `<path class="fgsfpkbsz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:music-note-add-outline-sharp" /></template>
<style>
.fgsfpkbsz {
  fill: currentColor;
