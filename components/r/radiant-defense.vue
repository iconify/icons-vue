...
const content = `<path class="elvj37b-w"/><path class="wn573eboi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:radiant-defense" /></template>
<style>
.elvj37b-w {
  fill: none;
  stroke: currentColor;
