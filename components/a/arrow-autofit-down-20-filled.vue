...
const content = `<path class="rurneccdw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-autofit-down-20-filled" /></template>
<style>
.rurneccdw {
  fill: currentColor;
