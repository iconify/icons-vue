...
const content = `<path class="lg5v3wbad"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:funicular-rounded" /></template>
<style>
.lg5v3wbad {
  fill: currentColor;
