...
const content = `<path class="tj5w-lgkk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-chat-24-filled" /></template>
<style>
.tj5w-lgkk {
  fill: currentColor;
