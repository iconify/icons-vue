...
const content = `<path class="bcu-3voyp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-bar-vertical-add-20-regular" /></template>
<style>
.bcu-3voyp {
  fill: currentColor;
