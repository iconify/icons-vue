...
const content = `<path class="cffrlxb6l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:material-you-dynamic-icon-pack" /></template>
<style>
.cffrlxb6l {
  fill: none;
  stroke: currentColor;
