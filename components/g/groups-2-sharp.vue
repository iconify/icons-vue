...
const content = `<path class="raffdzb3z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:groups-2-sharp" /></template>
<style>
.raffdzb3z {
  fill: currentColor;
