...
const content = `<path class="hbnq4abnf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:garage-door-outline-sharp" /></template>
<style>
.hbnq4abnf {
  fill: currentColor;
