...
const content = `<path class="wicjwtw-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:colorize-rounded" /></template>
<style>
.wicjwtw-j {
  fill: currentColor;
