...
const content = `<path class="ri-8yvked"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dry-rounded" /></template>
<style>
.ri-8yvked {
  fill: currentColor;
