...
const content = `<path class="xsbtwlbyp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:subtitles-24-regular" /></template>
<style>
.xsbtwlbyp {
  fill: currentColor;
