...
const content = `<path class="lubh10bow"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-detect-voice-rounded" /></template>
<style>
.lubh10bow {
  fill: currentColor;
