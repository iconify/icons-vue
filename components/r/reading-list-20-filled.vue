...
const content = `<path class="bu84bgb7k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:reading-list-20-filled" /></template>
<style>
.bu84bgb7k {
  fill: currentColor;
