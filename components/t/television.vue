...
const content = `<path class="ci3w3ifqo"/><path class="n6y2pccpj"/><circle class="neilyrbng"/><circle class="boeevwxic"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:television" /></template>
<style>
.boeevwxic {
  cx: 55.688px;
  cy: 37.625px;
