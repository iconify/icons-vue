...
const content = `<path class="xnyp-4bws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-text-dismiss-32-regular" /></template>
<style>
.xnyp-4bws {
  fill: currentColor;
