...
const content = `<path class="o4z070bhh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:drag-pan-outline" /></template>
<style>
.o4z070bhh {
  fill: currentColor;
