...
const content = `<path class="tpc-85hea"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:code-blocks-rounded" /></template>
<style>
.tpc-85hea {
  fill: currentColor;
