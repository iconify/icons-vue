...
const content = `<path class="cjrnley4y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-square-20-filled" /></template>
<style>
.cjrnley4y {
  fill: currentColor;
