...
const content = `<path class="xhbq0bc6e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fork-chart-rounded" /></template>
<style>
.xhbq0bc6e {
  fill: currentColor;
