...
const content = `<path class="xdz_jgbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-lock-rounded" /></template>
<style>
.xdz_jgbgt {
  fill: currentColor;
