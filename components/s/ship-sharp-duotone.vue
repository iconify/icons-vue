...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:ship-sharp-duotone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.u-_p63bcs {
  ...
  d: path("M13 13L11 13L11 16L13 16L13 13Z");
  stroke: none;
}
