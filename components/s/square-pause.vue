...
const content = `<path class="xm_q1n7-m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-pause" /></template>
<style>
.xm_q1n7-m {
  fill: none;
  stroke: currentColor;
