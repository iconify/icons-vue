...
const content = `<path class="t0tdk2h5g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-star-48-regular" /></template>
<style>
.t0tdk2h5g {
  fill: currentColor;
