...
const content = `<path class="wuf2o5jsd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gastroenterology-sharp" /></template>
<style>
.wuf2o5jsd {
  fill: currentColor;
