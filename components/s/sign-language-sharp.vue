...
const content = `<path class="c5pjkibtx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sign-language-sharp" /></template>
<style>
.c5pjkibtx {
  fill: currentColor;
