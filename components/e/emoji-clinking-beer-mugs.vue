...
const content = `<path class="yory0fo6b"/><path class="t0lvwiwtv"/><path class="ah60bkqqy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-clinking-beer-mugs" /></template>
<style>
.ah60bkqqy {
  fill: none;
  stroke: currentColor;
  ...
  d: path("m15.438 18.478l-4.21-.577l-2.046 14.835l11.734 1.609l1.917-11.49");
}
