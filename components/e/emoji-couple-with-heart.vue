...
const content = `<path class="e6m5tzbly"/><path class="aiye20bvh"/><path class="agcxyrbqz"/><path class="p8mgg-vdn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-couple-with-heart" /></template>
<style>
.agcxyrbqz {
  fill: none;
  stroke: currentColor;
...
.e6m5tzbly {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M19.342 25.41c0 3.797-2.388 6.92-5.328 6.92s-5.33-3.123-5.33-6.92v-.428");
}
