...
const content = `<path class="m13vlvidc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:two-wheeler-outline-rounded" /></template>
<style>
.m13vlvidc {
  fill: currentColor;
