...
const content = `<path class="qezwqj-zr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-distribute-bottom-16-regular" /></template>
<style>
.qezwqj-zr {
  fill: currentColor;
