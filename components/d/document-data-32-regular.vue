...
const content = `<path class="gxv6x8qxp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-data-32-regular" /></template>
<style>
.gxv6x8qxp {
  fill: currentColor;
