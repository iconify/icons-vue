...
const content = `<path class="rik5m2-ix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:building-16-regular" /></template>
<style>
.rik5m2-ix {
  fill: currentColor;
