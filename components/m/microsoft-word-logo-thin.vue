...
const content = `<path class="xt3-3ebjy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:microsoft-word-logo-thin" /></template>
<style>
.xt3-3ebjy {
  fill: currentColor;
