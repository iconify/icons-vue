...
const content = `<path class="qdfcdb7yr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-rtl-24-filled" /></template>
<style>
.qdfcdb7yr {
  fill: currentColor;
