...
const content = `<path class="v4x32eb0z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:rounded-corners" /></template>
<style>
.v4x32eb0z {
