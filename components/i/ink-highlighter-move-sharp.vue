...
const content = `<path class="m7rinpbbf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ink-highlighter-move-sharp" /></template>
<style>
.m7rinpbbf {
  fill: currentColor;
