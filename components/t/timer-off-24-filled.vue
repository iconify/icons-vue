...
const content = `<path class="tt4ed7bfg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:timer-off-24-filled" /></template>
<style>
.tt4ed7bfg {
  fill: currentColor;
