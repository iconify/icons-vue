...
const content = `<path class="rj8gptb1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-subtract-24-filled" /></template>
<style>
.rj8gptb1j {
  fill: currentColor;
