...
const content = `<path class="d_0b8o21l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:manga-outline" /></template>
<style>
.d_0b8o21l {
  fill: currentColor;
