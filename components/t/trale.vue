...
const content = `<path class="xlmuqkawl"/><path class="tlgc0gbjw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:trale" /></template>
<style>
.tlgc0gbjw {
  fill: none;
  stroke: currentColor;
