...
const content = `<path class="zof9d_afd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mystery-outline-rounded" /></template>
<style>
.zof9d_afd {
  fill: currentColor;
