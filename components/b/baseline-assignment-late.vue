...
const content = `<path class="gb4fhtbkm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-assignment-late" /></template>
<style>
.gb4fhtbkm {
  fill: currentColor;
