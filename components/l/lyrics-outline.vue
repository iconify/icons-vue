...
const content = `<path class="f2v_61qkd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lyrics-outline" /></template>
<style>
.f2v_61qkd {
  fill: currentColor;
