...
const content = `<path class="pg9agbs_x"/><path class="g-8g8_b-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:netguard" /></template>
<style>
.g-8g8_b-y {
  fill: none;
  stroke: currentColor;
...
.pg9agbs_x {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M14.51 10.51H24V20h-9.49ZM24 20h9.49v9.49H24Z");
}
