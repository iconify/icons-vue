...
const content = `<path class="uqqyy9byd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:barcode-reader-outline-sharp" /></template>
<style>
.uqqyy9byd {
  fill: currentColor;
