...
const content = `<g class="nrj6p8qat"><path class="ciz47rm9a"/><path class="dygl0op_e"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shield-minus-duotone" /></template>
<style>
.ciz47rm9a {
  fill: currentColor;
