...
const content = `<g class="cuyn6tgcc"><path class="o-v2ke6hu"/><path class="h7nmtfaqg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:microphone-slash-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
