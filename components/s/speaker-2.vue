...
const content = `<path class="ap9wa9bsq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:speaker-2" /></template>
<style>
.ap9wa9bsq {
  fill: currentColor;
