...
const content = `<path class="buc8zubnu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrows-out-line-horizontal-fill" /></template>
<style>
.buc8zubnu {
  fill: currentColor;
