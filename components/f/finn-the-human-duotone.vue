...
const content = `<g class="cuyn6tgcc"><path class="pq6njdbmt"/><path class="mxvu67e9y"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:finn-the-human-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.pq6njdbmt {
  d: path("M208 48a24 24 0 0 0-24 24H72a24 24 0 0 0-48 0v80a64 64 0 0 0 64 64h80a64 64 0 0 0 64-64V72a24 24 0 0 0-24-24m-8 104a32 32 0 0 1-32 32H88a32 32 0 0 1-32-32v-8a32 32 0 0 1 32-32h80a32 32 0 0 1 32 32Z");
