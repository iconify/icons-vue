...
const content = `<path class="r__7kkbuw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:contact-card-20-regular" /></template>
<style>
.r__7kkbuw {
  fill: currentColor;
