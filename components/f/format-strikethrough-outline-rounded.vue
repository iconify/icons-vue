...
const content = `<path class="ic7sccc4o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-strikethrough-outline-rounded" /></template>
<style>
.ic7sccc4o {
  fill: currentColor;
