...
const content = `<path class="tot9bk2ec"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:justanotherworkouttimer" /></template>
<style>
.tot9bk2ec {
  fill: none;
  stroke: currentColor;
