...
const content = `<path class="t_v80cktg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sentiment-extremely-dissatisfied-outline-rounded" /></template>
<style>
.t_v80cktg {
  fill: currentColor;
