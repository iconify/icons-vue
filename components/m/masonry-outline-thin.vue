...
const content = `<g class="hntgybcog"><path class="v0renrgmb"/><path class="g9-a5bsup"/><path class="j3t1fbcok"/><path class="r2hn0nart"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:masonry-outline-thin" /></template>
<style>
.g9-a5bsup {
