...
const content = `<path class="sx_0imbqr"/><path class="jchcg9bbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lien-quan-mobile" /></template>
<style>
.jchcg9bbq {
  fill: none;
  stroke: currentColor;
