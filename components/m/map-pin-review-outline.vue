...
const content = `<path class="tb8ur8bey"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:map-pin-review-outline" /></template>
<style>
.tb8ur8bey {
  fill: currentColor;
