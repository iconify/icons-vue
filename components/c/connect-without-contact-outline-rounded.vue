...
const content = `<path class="b8r9bxq7d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:connect-without-contact-outline-rounded" /></template>
<style>
.b8r9bxq7d {
  fill: currentColor;
