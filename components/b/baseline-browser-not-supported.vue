...
const content = `<path class="g3bjaxnym"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-browser-not-supported" /></template>
<style>
.g3bjaxnym {
  fill: currentColor;
