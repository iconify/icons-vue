...
const content = `<path class="atqa3831g"/><path class="evz-qzr-s"/><path class="x01pbmbfu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-mjml" /></template>
<style>
.atqa3831g {
  fill: var(--svg-color--bf555d, #bf555d);
