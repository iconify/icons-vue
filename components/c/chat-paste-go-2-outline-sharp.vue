...
const content = `<path class="reitbfzid"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chat-paste-go-2-outline-sharp" /></template>
<style>
.reitbfzid {
  fill: currentColor;
