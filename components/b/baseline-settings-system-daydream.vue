...
const content = `<path class="a43k3p_nh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-settings-system-daydream" /></template>
<style>
.a43k3p_nh {
  fill: currentColor;
