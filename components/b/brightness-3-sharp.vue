...
const content = `<path class="ahr_45b_g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:brightness-3-sharp" /></template>
<style>
.ahr_45b_g {
  fill: currentColor;
