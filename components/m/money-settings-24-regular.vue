...
const content = `<path class="oj4bxjikr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:money-settings-24-regular" /></template>
<style>
.oj4bxjikr {
  fill: currentColor;
