...
const content = `<path class="bdcmzoysj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:heart-off-20-filled" /></template>
<style>
.bdcmzoysj {
  fill: currentColor;
