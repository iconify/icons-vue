...
const content = `<path class="d-uk_jbll"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-directions-bus-filled" /></template>
<style>
.d-uk_jbll {
  fill: currentColor;
