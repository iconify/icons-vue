...
const content = `<path class="y7rk5z4mn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phone-bluetooth-speaker-outline" /></template>
<style>
.y7rk5z4mn {
  fill: currentColor;
