...
const content = `<path class="weppshb-t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobile-unlock-sharp" /></template>
<style>
.weppshb-t {
  fill: currentColor;
