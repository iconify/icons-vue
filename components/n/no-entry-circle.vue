...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="tt41a4bld"/><path class="ai334w5xn"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:no-entry-circle" /></template>
<style>
.ai334w5xn {
