...
const content = `<path class="t8jbkh07h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:battery-charging-vertical-thin" /></template>
<style>
.t8jbkh07h {
  fill: currentColor;
