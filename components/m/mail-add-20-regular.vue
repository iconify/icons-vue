...
const content = `<path class="psca09k0a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-add-20-regular" /></template>
<style>
.psca09k0a {
  fill: currentColor;
