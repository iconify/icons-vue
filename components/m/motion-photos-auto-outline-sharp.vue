...
const content = `<path class="x6tyft70v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:motion-photos-auto-outline-sharp" /></template>
<style>
.x6tyft70v {
  fill: currentColor;
