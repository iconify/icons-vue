...
const content = `<path class="ifgbpwzqt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-simple-minus-fill" /></template>
<style>
.ifgbpwzqt {
  fill: currentColor;
