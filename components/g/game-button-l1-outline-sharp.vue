...
const content = `<path class="m3q4gomno"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:game-button-l1-outline-sharp" /></template>
<style>
.m3q4gomno {
  fill: currentColor;
