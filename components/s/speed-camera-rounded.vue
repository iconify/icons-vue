...
const content = `<path class="lhq37-b9g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speed-camera-rounded" /></template>
<style>
.lhq37-b9g {
  fill: currentColor;
