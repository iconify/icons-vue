...
const content = `<path class="e51rhv38y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-color-reset-sharp" /></template>
<style>
.e51rhv38y {
  fill: currentColor;
