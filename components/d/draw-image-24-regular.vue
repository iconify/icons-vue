...
const content = `<path class="tdst-gbdl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:draw-image-24-regular" /></template>
<style>
.tdst-gbdl {
  fill: currentColor;
