...
const content = `<path class="ytmwi3bjk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:plug-disconnected-28-filled" /></template>
<style>
.ytmwi3bjk {
  fill: currentColor;
