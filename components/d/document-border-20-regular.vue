...
const content = `<path class="ifwzp8bbn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-border-20-regular" /></template>
<style>
.ifwzp8bbn {
  fill: currentColor;
