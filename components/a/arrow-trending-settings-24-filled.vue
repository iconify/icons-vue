...
const content = `<path class="c24h-jsvt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-trending-settings-24-filled" /></template>
<style>
.c24h-jsvt {
  fill: currentColor;
