...
const content = `<path class="y9_6vqltg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:reply-outline-rounded" /></template>
<style>
.y9_6vqltg {
  fill: currentColor;
