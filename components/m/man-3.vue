...
const content = `<path class="wc8a6nbhf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:man-3" /></template>
<style>
.wc8a6nbhf {
  fill: currentColor;
