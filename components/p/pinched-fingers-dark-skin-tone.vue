...
const content = `<path class="q6198qbyy"/><defs><path id="SVGlkFp1dLP" class="r1we34bzq"/></defs><clipPath id="SVG8HdKS35r"><use href="#SVGlkFp1dLP"/></clipPath><g clip-path="url(#SVG8HdKS35r)" class="t_nvrsbrc"><path class="r6t_-qbfg"/></g><defs><use href="#SVGlkFp1dLP" id="SVG7YEAUbkJ"/></defs><clipPath id="SVGvexFieej"><use href="#SVG7YEAUbkJ"/></clipPath><g clip-path="url(#SVGvexFieej)"><path class="jo0zed99v"/><path class="zz9evgrel"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:pinched-fingers-dark-skin-tone" /></template>
<style>
.jo0zed99v {
