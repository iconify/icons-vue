...
const content = `<path class="gsim-eb8m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-update-checkmark-20-filled" /></template>
<style>
.gsim-eb8m {
  fill: currentColor;
