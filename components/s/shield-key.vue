...
const content = `<path class="btudnce0w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shield-key" /></template>
<style>
.btudnce0w {
  fill: none;
  stroke: currentColor;
