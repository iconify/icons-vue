...
const content = `<g class="cuyn6tgcc"><path class="blzj4acss"/><path class="e-oi6jsyv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:phone-pause-duotone" /></template>
<style>
.blzj4acss {
