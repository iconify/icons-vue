...
const content = `<path class="n4t8asb4o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:print-disabled" /></template>
<style>
.n4t8asb4o {
  fill: currentColor;
