...
const content = `<path class="pyl-ar1pc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nightlife-outline" /></template>
<style>
.pyl-ar1pc {
  fill: currentColor;
