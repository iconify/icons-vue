...
const content = `<path class="sc1_uvbwu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:star-line-horizontal-3-24-filled" /></template>
<style>
.sc1_uvbwu {
  fill: currentColor;
