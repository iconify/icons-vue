...
const content = `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="dum0qmlbg"/><path clip-rule="evenodd" class="hxwnbkbbq"/><path clip-rule="evenodd" class="rqt0p4zic"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:code-circle-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
