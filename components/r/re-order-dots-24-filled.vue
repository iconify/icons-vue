...
const content = `<path class="fe-6x4qdh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:re-order-dots-24-filled" /></template>
<style>
.fe-6x4qdh {
  fill: currentColor;
