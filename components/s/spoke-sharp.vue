...
const content = `<path class="szd19nb9k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:spoke-sharp" /></template>
<style>
.szd19nb9k {
  fill: currentColor;
