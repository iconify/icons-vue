...
const content = `<path class="q91erjblo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:subtract-circle-28-regular" /></template>
<style>
.q91erjblo {
  fill: currentColor;
