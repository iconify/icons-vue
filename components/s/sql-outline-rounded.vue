...
const content = `<path class="wrr0jwy0e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sql-outline-rounded" /></template>
<style>
.wrr0jwy0e {
  fill: currentColor;
