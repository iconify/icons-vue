...
const content = `<path class="gkga3abbe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-add-32-filled" /></template>
<style>
.gkga3abbe {
  fill: currentColor;
