...
const content = `<path class="y9xf-7xcd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-inbox-28-filled" /></template>
<style>
.y9xf-7xcd {
  fill: currentColor;
