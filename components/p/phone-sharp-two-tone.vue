...
const content = `<g class="gp_8x1bzb"><path class="ehmp1dbtn"/><path class="vk9v_xb8o"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:phone-sharp-two-tone" /></template>
<style>
.ehmp1dbtn {
  fill: currentColor;
