...
const content = `<path class="j4qzaub6g"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kvaesitso-icons-alt" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
