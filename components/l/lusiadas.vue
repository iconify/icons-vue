...
const content = `<path class="e8mfsztwh"/><path class="v2727cben"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lusiadas" /></template>
<style>
.e8mfsztwh {
  fill: none;
  stroke: currentColor;
