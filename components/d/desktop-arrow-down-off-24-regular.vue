...
const content = `<path class="awinakbfm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-arrow-down-off-24-regular" /></template>
<style>
.awinakbfm {
  fill: currentColor;
