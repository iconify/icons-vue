...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGGCZNObZJ)" class="srr58fb4t"/><defs><linearGradient id="SVGGCZNObZJ" x1="3" x2="21" y1="12" y2="12" gradientUnits="userSpaceOnUse"><stop class="vh9-4hb8q"/><stop offset="1" class="r9zkbkbnp"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:myst" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
