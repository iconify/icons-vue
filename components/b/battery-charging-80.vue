...
const content = `<path class="h2dj_2bks"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-charging-80" /></template>
<style>
.h2dj_2bks {
  fill: currentColor;
