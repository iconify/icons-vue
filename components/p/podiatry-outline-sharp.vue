...
const content = `<path class="wi0mjhb9a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:podiatry-outline-sharp" /></template>
<style>
.wi0mjhb9a {
  fill: currentColor;
