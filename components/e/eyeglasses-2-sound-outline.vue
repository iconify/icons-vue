...
const content = `<path class="ska547b-q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:eyeglasses-2-sound-outline" /></template>
<style>
.ska547b-q {
  fill: currentColor;
