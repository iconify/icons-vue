...
const content = `<g class="gp_8x1bzb"><path class="yrnc_2blo"/><path class="la84i2bgs"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-half-sharp-two-tone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.la84i2bgs {
  fill: currentColor;
  d: path("M12 19C15.866 19 19 15.866 19 12C19 8.134 15.866 5 12 5L12 19Z");
  stroke: none;
}
