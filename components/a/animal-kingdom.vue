...
const content = `<path class="zg43q6n3a"/><path class="b64ui11lf"/><path class="hz0irub7f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:animal-kingdom" /></template>
<style>
.b64ui11lf {
  fill: none;
  stroke: currentColor;
...
.hz0irub7f {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M25.036 31.776s-1.08-.113-2.03-.861c-.952-.75-1.167-1.317-1.167-1.317");
}
