...
const content = `<path class="bofd8vbei"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-3-day-24-filled" /></template>
<style>
.bofd8vbei {
  fill: currentColor;
