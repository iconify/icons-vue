...
const content = `<path class="h5v4h58rm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-sync-16-filled" /></template>
<style>
.h5v4h58rm {
  fill: currentColor;
