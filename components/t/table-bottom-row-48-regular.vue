...
const content = `<path class="ptyvh531x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-bottom-row-48-regular" /></template>
<style>
.ptyvh531x {
  fill: currentColor;
