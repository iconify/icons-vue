...
const content = `<path class="ar9dpqaix"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-2-20-regular" /></template>
<style>
.ar9dpqaix {
  fill: currentColor;
