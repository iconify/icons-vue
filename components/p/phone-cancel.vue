...
const content = `<path class="e-ele2b2x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phone-cancel" /></template>
<style>
.e-ele2b2x {
  fill: currentColor;
