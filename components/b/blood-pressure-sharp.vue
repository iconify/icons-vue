...
const content = `<path class="rflsm-txg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:blood-pressure-sharp" /></template>
<style>
.rflsm-txg {
  fill: currentColor;
