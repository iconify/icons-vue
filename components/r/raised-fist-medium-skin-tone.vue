...
const content = `<path class="pf6r2bdyu"/><defs><path id="SVGURkcDdhU" class="ds-pt9yrt"/></defs><clipPath id="SVGPv3CACjI"><use href="#SVGURkcDdhU"/></clipPath><g clip-path="url(#SVGPv3CACjI)" class="byeg-0b8a"><path class="lcn3aobko"/><path class="yhs7uh29m"/></g><defs><use href="#SVGURkcDdhU" id="SVGXJHrEeYt"/></defs><clipPath id="SVGr9YxBmXJ"><use href="#SVGXJHrEeYt"/></clipPath><path clip-path="url(#SVGr9YxBmXJ)" class="tckcrxblw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:raised-fist-medium-skin-tone" /></template>
<style>
.byeg-0b8a {
