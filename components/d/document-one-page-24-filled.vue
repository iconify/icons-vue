...
const content = `<path class="cigdmkbtk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-one-page-24-filled" /></template>
<style>
.cigdmkbtk {
  fill: currentColor;
