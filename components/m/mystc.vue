...
const content = `<path class="gi6u2zbpf"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mystc" /></template>
<style>
.gi6u2zbpf {
  fill: none;
  stroke: currentColor;
