...
const content = `<path class="hdvdp_bbz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:steppers-outline-rounded" /></template>
<style>
.hdvdp_bbz {
  fill: currentColor;
