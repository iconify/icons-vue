...
const content = `<path class="f9s6xg7vn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:globe-error-20-regular" /></template>
<style>
.f9s6xg7vn {
  fill: currentColor;
