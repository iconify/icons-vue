...
const content = `<path class="esfd1h0ag"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:explore-sharp" /></template>
<style>
.esfd1h0ag {
  fill: currentColor;
