...
const content = `<path class="yvs83zboj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:byjus-the-learning-app" /></template>
<style>
.yvs83zboj {
  fill: none;
  stroke: currentColor;
