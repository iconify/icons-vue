...
const content = `<path class="jmyli3jpt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:note-stack" /></template>
<style>
.jmyli3jpt {
  fill: currentColor;
