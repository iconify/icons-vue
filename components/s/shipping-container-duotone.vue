...
const content = `<g class="cuyn6tgcc"><path class="nzw92yb3f"/><path class="humxovsgg"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:shipping-container-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.nzw92yb3f {
  d: path("M240 86v84a8 8 0 0 1-5.8 7.69L128 208V48l106.2 30.34A8 8 0 0 1 240 86");
