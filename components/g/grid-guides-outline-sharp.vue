...
const content = `<path class="frrxlpbdq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:grid-guides-outline-sharp" /></template>
<style>
.frrxlpbdq {
  fill: currentColor;
