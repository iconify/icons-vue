...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:battery-low-duotone" /></template>
<style>
.aewu89bmt {
  fill: currentColor;
...
.ytkl_vacf {
  d: path("M22 9.5L22 14.5M6 10L6 14");
}
