...
const content = `<path class="u3ea_ebjk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-double-arrow-right-outline-rounded" /></template>
<style>
.u3ea_ebjk {
  fill: currentColor;
