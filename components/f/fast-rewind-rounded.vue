...
const content = `<path class="iq41dq9_l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fast-rewind-rounded" /></template>
<style>
.iq41dq9_l {
  fill: currentColor;
