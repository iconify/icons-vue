...
const content = `<path class="vuu5gdc7u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-3-lines-16-regular" /></template>
<style>
.vuu5gdc7u {
  fill: currentColor;
