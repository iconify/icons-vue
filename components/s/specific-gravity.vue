...
const content = `<path class="mezr3tb8q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:specific-gravity" /></template>
<style>
.mezr3tb8q {
  fill: currentColor;
