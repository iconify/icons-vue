...
const content = `<path class="cn82ip1ca"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:check-circle-rounded" /></template>
<style>
.cn82ip1ca {
  fill: currentColor;
