...
const content = `<path class="hd6t3iykl"/><path class="nd8rg_9dq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:ab-button" /></template>
<style>
.hd6t3iykl {
