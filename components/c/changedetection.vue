...
const content = `<path class="ft66his9f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:changedetection" /></template>
<style>
.ft66his9f {
  fill: none;
  stroke: currentColor;
