...
const content = `<path class="jbq2gp7vy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brightness-empty-outline-rounded" /></template>
<style>
.jbq2gp7vy {
  fill: currentColor;
