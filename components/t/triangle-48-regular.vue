...
const content = `<path class="fzghtxbup"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:triangle-48-regular" /></template>
<style>
.fzghtxbup {
  fill: currentColor;
