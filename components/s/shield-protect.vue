...
const content = `<path class="kg4ghsblu"/><path class="j92vuwomt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:shield-protect" /></template>
<style>
.j92vuwomt {
  fill: none;
  stroke: currentColor;
  ...
  d: path("m17.788 23.982l5.487 5.486l10.937-10.936");
}
