...
const content = `<path class="ac197dl6w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-record-24-regular" /></template>
<style>
.ac197dl6w {
  fill: currentColor;
