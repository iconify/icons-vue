...
const content = `<path class="jb8ch-bng"/><path class="jwg3eebfp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:planet-fitness" /></template>
<style>
.jb8ch-bng {
  fill: none;
  stroke: currentColor;
...
.jwg3eebfp {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M15.547 25.276a3.925 3.925 0 0 0 3.925 3.925h0a3.925 3.925 0 0 0 3.926-3.925v-2.552a3.925 3.925 0 0 0-3.925-3.925h0a3.925 3.925 0 0 0-3.926 3.925m0-3.925V34.5m0-15.701h-1.472M17.019 34.5h-2.944m14.327-5.3V16.249a2.75 2.75 0 0 1 2.747-2.748h0c1.352 0 2.197.4 2.776 1.15m-7.851 4.148h5.496m-1.697 10.402H26.93");
}
