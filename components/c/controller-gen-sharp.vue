...
const content = `<path class="c3j8856da"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:controller-gen-sharp" /></template>
<style>
.c3j8856da {
  fill: currentColor;
