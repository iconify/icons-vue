...
const content = `<path class="wicwrmbra"/><path class="y_8qbu_bk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:u-next" /></template>
<style>
.wicwrmbra {
  fill: none;
  stroke: currentColor;
