...
const content = `<path class="vhe00d0pq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrows-bidirectional-24-regular" /></template>
<style>
.vhe00d0pq {
  fill: currentColor;
