...
const content = `<path class="hcygsisxd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screen-rotation-outline-sharp" /></template>
<style>
.hcygsisxd {
  fill: currentColor;
