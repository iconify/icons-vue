...
const content = `<path class="n5_ahsbjt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:channel-add-20-regular" /></template>
<style>
.n5_ahsbjt {
  fill: currentColor;
