...
const content = `<path class="k-ah6vbpu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bookmark-star" /></template>
<style>
.k-ah6vbpu {
  fill: currentColor;
