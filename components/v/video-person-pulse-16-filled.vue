...
const content = `<path class="ua1kdobmh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-person-pulse-16-filled" /></template>
<style>
.ua1kdobmh {
  fill: currentColor;
