...
const content = `<path class="rfpsmew3i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:multiple-airports-outline" /></template>
<style>
.rfpsmew3i {
  fill: currentColor;
