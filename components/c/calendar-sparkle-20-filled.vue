...
const content = `<path class="ydk__gbid"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-sparkle-20-filled" /></template>
<style>
.ydk__gbid {
  fill: currentColor;
