...
const content = `<path class="ke59q6-zs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-increase-rotate-90-20-regular" /></template>
<style>
.ke59q6-zs {
  fill: currentColor;
