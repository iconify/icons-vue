...
const content = `<path class="glcm_abcr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chair-alt-outline" /></template>
<style>
.glcm_abcr {
  fill: currentColor;
