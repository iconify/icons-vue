...
const content = `<path class="wmvyracll"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:slack" /></template>
<style>
.wmvyracll {
  fill: none;
  stroke: currentColor;
