...
const content = `<path class="u-x3s7v-i"/><path class="o7djefbtg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-access-alarm" /></template>
<style>
.o7djefbtg {
  fill: currentColor;
