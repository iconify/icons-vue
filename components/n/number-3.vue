...
const content = `<rect class="j3s9ivbxi"/><path class="bss894joo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:number-3" /></template>
<style>
.bss894joo {
  fill: none;
  stroke: currentColor;
