...
const content = `<path class="lv2te0ces"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:water-bottle-large-outline-sharp" /></template>
<style>
.lv2te0ces {
  fill: currentColor;
