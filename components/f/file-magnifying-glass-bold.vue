...
const content = `<path class="y_leiqbhw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-magnifying-glass-bold" /></template>
<style>
.y_leiqbhw {
  fill: currentColor;
