...
const content = `<path class="x83ogizdt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-down-32-filled" /></template>
<style>
.x83ogizdt {
  fill: currentColor;
