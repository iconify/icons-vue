...
const content = `<path class="mib44tblv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tamper-detection-on-sharp" /></template>
<style>
.mib44tblv {
  fill: currentColor;
