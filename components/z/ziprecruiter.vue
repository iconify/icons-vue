...
const content = `<path class="m4qi14b7f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ziprecruiter" /></template>
<style>
.m4qi14b7f {
  fill: none;
  stroke: currentColor;
