...
const content = `<path class="g29k806ph"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:turkcell" /></template>
<style>
.g29k806ph {
  fill: none;
  stroke: currentColor;
