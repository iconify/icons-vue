...
const content = `<path class="uepng198v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:paid-outline-sharp" /></template>
<style>
.uepng198v {
  fill: currentColor;
