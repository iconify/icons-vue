...
const content = `<path class="ujg_3tbxc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bus" /></template>
<style>
.ujg_3tbxc {
  fill: none;
  stroke: currentColor;
