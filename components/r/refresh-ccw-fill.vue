...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:refresh-ccw-fill" /></template>
<style>
.mg8-oacpo {
  fill: none;
  stroke: currentColor;
