...
const content = `<path class="ic0ujynkj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:flowchart-outline-sharp" /></template>
<style>
.ic0ujynkj {
  fill: currentColor;
