...
const content = `<path class="nya3y7buf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cognition" /></template>
<style>
.nya3y7buf {
  fill: currentColor;
