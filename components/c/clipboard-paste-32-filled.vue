...
const content = `<path class="n9o4aeb2n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-paste-32-filled" /></template>
<style>
.n9o4aeb2n {
  fill: currentColor;
