...
const content = `<path class="fddt2ibnu"/><circle class="y38q0qb8j"/><path class="sdyy-mb6r"/><path class="ym2drbm2a"/><path class="wxadi7kjp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:baby-angel" /></template>
<style>
.fddt2ibnu {
