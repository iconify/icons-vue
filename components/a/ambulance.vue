...
const content = `<path class="reyqep0py"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ambulance" /></template>
<style>
.reyqep0py {
  fill: currentColor;
