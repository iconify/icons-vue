...
const content = `<path class="voff4zbvk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:question-circle-28-filled" /></template>
<style>
.voff4zbvk {
  fill: currentColor;
