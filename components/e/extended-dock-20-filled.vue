...
const content = `<path class="nx7n6sb9h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:extended-dock-20-filled" /></template>
<style>
.nx7n6sb9h {
  fill: currentColor;
