...
const content = `<path class="lsbywmb2l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-brightness-outline-rounded" /></template>
<style>
.lsbywmb2l {
  fill: currentColor;
