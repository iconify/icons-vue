...
const content = `<path class="rpqmz00bb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-edit-16-filled" /></template>
<style>
.rpqmz00bb {
  fill: currentColor;
