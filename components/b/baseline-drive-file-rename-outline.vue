...
const content = `<path class="rv196vbnh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-drive-file-rename-outline" /></template>
<style>
.rv196vbnh {
  fill: currentColor;
