...
const content = `<path class="kkr82pbcj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:flip-horizontal-16-filled" /></template>
<style>
.kkr82pbcj {
  fill: currentColor;
