...
const content = `<path class="v_aablbdu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:maximize-2-sharp-two-tone" /></template>
<style>
.v_aablbdu {
  fill: none;
  stroke: currentColor;
