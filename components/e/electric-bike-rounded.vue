...
const content = `<path class="tabugfb4c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:electric-bike-rounded" /></template>
<style>
.tabugfb4c {
  fill: currentColor;
