...
const content = `<path class="i0q-6eb-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:5k-plus-outline-sharp" /></template>
<style>
.i0q-6eb-j {
  fill: currentColor;
