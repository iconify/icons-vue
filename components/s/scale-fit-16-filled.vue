...
const content = `<path class="rgw6jvbjl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scale-fit-16-filled" /></template>
<style>
.rgw6jvbjl {
  fill: currentColor;
