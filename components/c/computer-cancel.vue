...
const content = `<path class="h7a7dhqma"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:computer-cancel" /></template>
<style>
.h7a7dhqma {
  fill: currentColor;
