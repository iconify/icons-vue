...
const content = `<path class="g0gh8kv1q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:low-density-outline-sharp" /></template>
<style>
.g0gh8kv1q {
  fill: currentColor;
