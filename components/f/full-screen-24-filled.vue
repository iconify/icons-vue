...
const content = `<path class="jd6_3m4qz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:full-screen-24-filled" /></template>
<style>
.jd6_3m4qz {
  fill: currentColor;
