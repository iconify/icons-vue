...
const content = `<path class="bnl4ocbxl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-paragraph-direction-left-24-regular" /></template>
<style>
.bnl4ocbxl {
  fill: currentColor;
