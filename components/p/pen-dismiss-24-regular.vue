...
const content = `<path class="bgez8b15i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pen-dismiss-24-regular" /></template>
<style>
.bgez8b15i {
  fill: currentColor;
