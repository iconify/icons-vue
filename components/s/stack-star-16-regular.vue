...
const content = `<path class="h9irnysrm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:stack-star-16-regular" /></template>
<style>
.h9irnysrm {
  fill: currentColor;
