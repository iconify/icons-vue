...
const content = `<path class="uw_txybpo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tv-arrow-right-20-regular" /></template>
<style>
.uw_txybpo {
  fill: currentColor;
