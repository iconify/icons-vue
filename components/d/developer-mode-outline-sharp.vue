...
const content = `<path class="u7qdbpyes"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:developer-mode-outline-sharp" /></template>
<style>
.u7qdbpyes {
  fill: currentColor;
