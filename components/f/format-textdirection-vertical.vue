...
const content = `<path class="a8klvzbba"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-textdirection-vertical" /></template>
<style>
.a8klvzbba {
  fill: currentColor;
