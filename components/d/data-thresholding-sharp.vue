...
const content = `<path class="t1tw0wbdi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:data-thresholding-sharp" /></template>
<style>
.t1tw0wbdi {
  fill: currentColor;
