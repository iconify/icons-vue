...
const content = `<path class="x22oztboi"/><path class="o17d2hbgv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:minimus" /></template>
<style>
.o17d2hbgv {
  fill: none;
  stroke: currentColor;
