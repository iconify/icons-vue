...
const content = `<path class="x7urqss7a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ink-eraser-off-rounded" /></template>
<style>
.x7urqss7a {
  fill: currentColor;
