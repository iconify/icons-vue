...
const content = `<rect class="owr_4mwof"/><path class="quu02s0bu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:office-nx-planmaker" /></template>
<style>
.owr_4mwof {
  width: 22.5px;
  height: 22.5px;
