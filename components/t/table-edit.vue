...
const content = `<path class="fpa_nrrnx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:table-edit" /></template>
<style>
.fpa_nrrnx {
  fill: currentColor;
