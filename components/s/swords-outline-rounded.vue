...
const content = `<path class="b8vpt6vls"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:swords-outline-rounded" /></template>
<style>
.b8vpt6vls {
  fill: currentColor;
