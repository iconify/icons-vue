...
const content = `<path class="ds9hzob8g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:location-searching-outline-sharp" /></template>
<style>
.ds9hzob8g {
  fill: currentColor;
