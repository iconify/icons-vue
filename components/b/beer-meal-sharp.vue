...
const content = `<path class="revap-qwr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:beer-meal-sharp" /></template>
<style>
.revap-qwr {
  fill: currentColor;
