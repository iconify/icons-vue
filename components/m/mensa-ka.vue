...
const content = `<path class="bdb85y89n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mensa-ka" /></template>
<style>
.bdb85y89n {
  fill: none;
  stroke: currentColor;
