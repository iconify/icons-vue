...
const content = `<path class="jp7-en6rp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wifi-proxy-outline-rounded" /></template>
<style>
.jp7-en6rp {
  fill: currentColor;
