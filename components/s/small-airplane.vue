...
const content = `<path class="y5qx_fb5g"/><ellipse class="uevmy2b2k"/><ellipse class="e20c10bzq"/><ellipse class="g911_evnt"/><path class="ja_kvn9ci"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:small-airplane" /></template>
<style>
.e20c10bzq {
  cx: 25.924px;
  cy: 38.404px;
...
.y5qx_fb5g {
  fill: currentColor;
  d: path("M13.389 39.519c-.212.551-.691 2.035-.811 4.414c2.04-.405 3.578-2.222 3.578-4.406h-2.664c-.035-.001-.068-.008-.103-.008");
}
