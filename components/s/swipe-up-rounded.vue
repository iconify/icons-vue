...
const content = `<path class="a8f78acvh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-up-rounded" /></template>
<style>
.a8f78acvh {
  fill: currentColor;
