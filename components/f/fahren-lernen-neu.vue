...
const content = `<path class="mko4ncc8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fahren-lernen-neu" /></template>
<style>
.mko4ncc8v {
  fill: none;
  stroke: currentColor;
