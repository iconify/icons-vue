...
const content = `<path class="yh1z_5bur"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shifts-availability-24-regular" /></template>
<style>
.yh1z_5bur {
  fill: currentColor;
