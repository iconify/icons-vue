...
const content = `<path class="g4vqa2vsi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:subwoofer-rounded" /></template>
<style>
.g4vqa2vsi {
  fill: currentColor;
