...
const content = `<path class="x8edosw9d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notebook-eye-20-regular" /></template>
<style>
.x8edosw9d {
  fill: currentColor;
