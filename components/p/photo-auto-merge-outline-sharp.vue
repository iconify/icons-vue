...
const content = `<path class="n8fl8nrbx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:photo-auto-merge-outline-sharp" /></template>
<style>
.n8fl8nrbx {
  fill: currentColor;
