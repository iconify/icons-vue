...
const content = `<path class="pj3-xpbck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:compass-northwest-28-regular" /></template>
<style>
.pj3-xpbck {
  fill: currentColor;
