...
const content = `<path class="gc7asbwfa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-quote-16-filled" /></template>
<style>
.gc7asbwfa {
  fill: currentColor;
