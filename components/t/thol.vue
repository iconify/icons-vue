...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGD4oXpb9E)" clip-rule="evenodd" class="i42wdjczk"/><defs><linearGradient id="SVGD4oXpb9E" x1="2.386" x2="9.284" y1="10.856" y2="10.856" gradientUnits="userSpaceOnUse"><stop offset=".16" class="vanysdb7t"/><stop offset="1" class="fnvtalzqw"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:thol" /></template>
<style>
.fnvtalzqw {
