...
const content = `<circle class="yqfvb1bwf"/><circle class="f934iu1fb"/><path class="tederrkaj"/><path class="th4vr_ono"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:ten-thirty" /></template>
<style>
.f934iu1fb {
  cx: 18px;
  cy: 18px;
