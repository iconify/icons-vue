...
const content = `<path class="uugzbugwv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-unfold-more-double" /></template>
<style>
.uugzbugwv {
  fill: currentColor;
