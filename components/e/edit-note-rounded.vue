...
const content = `<path class="gdg7azuqj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:edit-note-rounded" /></template>
<style>
.gdg7azuqj {
  fill: currentColor;
