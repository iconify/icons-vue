...
const content = `<path class="yrj_qtbah"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fit-page-outline-rounded" /></template>
<style>
.yrj_qtbah {
  fill: currentColor;
