...
const content = `<path class="w7yvfcnhn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:list-arrow-outline-rounded" /></template>
<style>
.w7yvfcnhn {
  fill: currentColor;
