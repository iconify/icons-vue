...
const content = `<path class="lb9-zqbiq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:browse-activity-outline-rounded" /></template>
<style>
.lb9-zqbiq {
  fill: currentColor;
