...
const content = `<path class="y7xoxhb8i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:nest-farsight-seasonal-rounded" /></template>
<style>
.y7xoxhb8i {
  fill: currentColor;
