...
const content = `<path class="zzyf9-41q"/><path class="m__a8sjkq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-nigeria" /></template>
<style>
.m__a8sjkq {
