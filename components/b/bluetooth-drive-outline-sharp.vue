...
const content = `<path class="jciyvmbng"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bluetooth-drive-outline-sharp" /></template>
<style>
.jciyvmbng {
  fill: currentColor;
