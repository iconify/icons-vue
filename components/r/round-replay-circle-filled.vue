...
const content = `<path class="ju2lg664s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-replay-circle-filled" /></template>
<style>
.ju2lg664s {
  fill: currentColor;
