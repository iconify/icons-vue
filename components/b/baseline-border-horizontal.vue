...
const content = `<path class="fv9wbobjt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-border-horizontal" /></template>
<style>
.fv9wbobjt {
  fill: currentColor;
