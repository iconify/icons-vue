...
const content = `<path class="m-vs5yymh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:navigation-24-regular" /></template>
<style>
.m-vs5yymh {
  fill: currentColor;
