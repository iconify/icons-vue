...
const content = `<path class="r0sil_p6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-briefcase-20-filled" /></template>
<style>
.r0sil_p6u {
  fill: currentColor;
