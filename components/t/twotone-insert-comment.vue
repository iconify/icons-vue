...
const content = `<path class="cxftbfa-d"/><path class="cq2hl9bjd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-insert-comment" /></template>
<style>
.cq2hl9bjd {
  fill: currentColor;
