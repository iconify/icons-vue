...
const content = `<path class="i7bi13k1z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nova-launcher-prime" /></template>
<style>
.i7bi13k1z {
  fill: none;
  stroke: currentColor;
