...
const content = `<path class="ru5cv4gks"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:side-navigation-outline-rounded" /></template>
<style>
.ru5cv4gks {
  fill: currentColor;
