...
const content = `<path class="xiqtjho2k"/><circle class="tj8b-tbhb"/><circle class="sy28tfbol"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:labd" /></template>
<style>
.sy28tfbol {
  cx: 18.514px;
  cy: 13.041px;
