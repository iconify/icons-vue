...
const content = `<path class="wgu7_acfd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-directions-bus-filled" /></template>
<style>
.wgu7_acfd {
  fill: currentColor;
