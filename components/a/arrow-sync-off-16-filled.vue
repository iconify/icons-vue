...
const content = `<path class="e-7hrebfl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-sync-off-16-filled" /></template>
<style>
.e-7hrebfl {
  fill: currentColor;
