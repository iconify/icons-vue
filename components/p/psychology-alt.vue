...
const content = `<path class="vn7_tbbvi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:psychology-alt" /></template>
<style>
.vn7_tbbvi {
  fill: currentColor;
