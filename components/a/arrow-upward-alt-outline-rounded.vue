...
const content = `<path class="lpngq9lcj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-upward-alt-outline-rounded" /></template>
<style>
.lpngq9lcj {
  fill: currentColor;
