...
const content = `<path class="tuapnnb7v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:convert-to-text-24-regular" /></template>
<style>
.tuapnnb7v {
  fill: currentColor;
