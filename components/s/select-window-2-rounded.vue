...
const content = `<path class="jmkl64b5s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:select-window-2-rounded" /></template>
<style>
.jmkl64b5s {
  fill: currentColor;
