...
const content = `<path class="m3qptsb1w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sd-card-rounded" /></template>
<style>
.m3qptsb1w {
  fill: currentColor;
