...
const content = `<path class="vn7pt8bhp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:communication-20-filled" /></template>
<style>
.vn7pt8bhp {
  fill: currentColor;
