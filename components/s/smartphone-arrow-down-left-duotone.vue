...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:smartphone-arrow-down-left-duotone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
...
.w_e4tyv6v {
  d: path("M13.5 6L10.5 6M13.5 21.5L18 17M13 16L13 21.5C13 21.7761 13.2239 22 13.5 22L19 22");
}
