...
const content = `<path class="i1jluabgw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:control-button-24-filled" /></template>
<style>
.i1jluabgw {
  fill: currentColor;
