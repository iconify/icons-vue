...
const content = `<path class="viawbpulw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:goblim" /></template>
<style>
.viawbpulw {
  fill: none;
  stroke: currentColor;
