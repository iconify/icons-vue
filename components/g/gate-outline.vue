...
const content = `<path class="jafur8bvs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:gate-outline" /></template>
<style>
.jafur8bvs {
  fill: currentColor;
