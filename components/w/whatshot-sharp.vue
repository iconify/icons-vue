...
const content = `<path class="hqbawog_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:whatshot-sharp" /></template>
<style>
.hqbawog_q {
  fill: currentColor;
