...
const content = `<path class="ufv3qrm3f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-funnel-24-regular" /></template>
<style>
.ufv3qrm3f {
  fill: currentColor;
