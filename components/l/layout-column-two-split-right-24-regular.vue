...
const content = `<path class="od0fzxk3x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-column-two-split-right-24-regular" /></template>
<style>
.od0fzxk3x {
  fill: currentColor;
