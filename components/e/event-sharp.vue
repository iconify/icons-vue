...
const content = `<path class="jesshac-p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:event-sharp" /></template>
<style>
.jesshac-p {
  fill: currentColor;
