...
const content = `<path class="oic9apflo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:shopeefood-driver" /></template>
<style>
.oic9apflo {
  fill: none;
  stroke: currentColor;
