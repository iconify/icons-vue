...
const content = `<path class="ncs3zbctu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sensify" /></template>
<style>
.ncs3zbctu {
  fill: none;
  stroke: currentColor;
