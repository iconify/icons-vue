...
const content = `<path class="qgtz5-j8k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:book-3-rounded" /></template>
<style>
.qgtz5-j8k {
  fill: currentColor;
