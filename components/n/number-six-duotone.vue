...
const content = `<g class="cuyn6tgcc"><path class="hidfxz0es"/><path class="zii__vm0n"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-six-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
