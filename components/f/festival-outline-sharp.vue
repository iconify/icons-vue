...
const content = `<path class="ce45b9uok"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:festival-outline-sharp" /></template>
<style>
.ce45b9uok {
  fill: currentColor;
