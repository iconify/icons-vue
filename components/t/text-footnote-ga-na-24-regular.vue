...
const content = `<g class="ft5dv1b6b"><path class="i_coupd0t"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-footnote-ga-na-24-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
