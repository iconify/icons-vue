...
const content = `<path class="r_hrrls7v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-multiple-24-regular" /></template>
<style>
.r_hrrls7v {
  fill: currentColor;
