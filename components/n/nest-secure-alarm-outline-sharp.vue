...
const content = `<path class="n-onbfbsj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-secure-alarm-outline-sharp" /></template>
<style>
.n-onbfbsj {
  fill: currentColor;
