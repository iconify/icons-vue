...
const content = `<path class="wvsbg4hrx"/><path class="aw3xdxs3e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:hand-with-index-finger-and-thumb-crossed-light-skin-tone" /></template>
<style>
.aw3xdxs3e {
