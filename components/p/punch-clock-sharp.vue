...
const content = `<path class="xh1c8sytg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:punch-clock-sharp" /></template>
<style>
.xh1c8sytg {
  fill: currentColor;
