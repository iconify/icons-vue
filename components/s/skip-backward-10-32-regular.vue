...
const content = `<g class="ft5dv1b6b"><path class="q6h3mobin"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:skip-backward-10-32-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
