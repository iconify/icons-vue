...
const content = `<path class="vnct4msgd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-grammar-dismiss-24-filled" /></template>
<style>
.vnct4msgd {
  fill: currentColor;
