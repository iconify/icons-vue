...
const content = `<path class="h-6cjybyu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pin-invoke-outline" /></template>
<style>
.h-6cjybyu {
  fill: currentColor;
