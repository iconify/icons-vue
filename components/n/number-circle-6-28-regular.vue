...
const content = `<path class="c6lcsjp_m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-6-28-regular" /></template>
<style>
.c6lcsjp_m {
  fill: currentColor;
