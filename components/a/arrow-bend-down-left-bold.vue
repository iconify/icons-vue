...
const content = `<path class="u4s0utbwi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-bend-down-left-bold" /></template>
<style>
.u4s0utbwi {
  fill: currentColor;
