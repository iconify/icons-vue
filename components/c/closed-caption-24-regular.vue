...
const content = `<path class="esdla6b8k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:closed-caption-24-regular" /></template>
<style>
.esdla6b8k {
  fill: currentColor;
