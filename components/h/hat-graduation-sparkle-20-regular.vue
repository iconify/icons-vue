...
const content = `<path class="zxyie6tzf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:hat-graduation-sparkle-20-regular" /></template>
<style>
.zxyie6tzf {
  fill: currentColor;
