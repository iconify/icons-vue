...
const content = `<path class="nqunpendk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-note-24-filled" /></template>
<style>
.nqunpendk {
  fill: currentColor;
