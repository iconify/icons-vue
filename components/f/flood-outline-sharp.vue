...
const content = `<path class="hj7nrmz2i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:flood-outline-sharp" /></template>
<style>
.hj7nrmz2i {
  fill: currentColor;
