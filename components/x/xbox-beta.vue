...
const content = `<path class="endx7rbaq"/><circle class="vi_nxfq0r"/><path class="funm8-8nd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:xbox-beta" /></template>
<style>
.endx7rbaq {
  fill: none;
  stroke: currentColor;
...
.funm8-8nd {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M39.536 38.5a2 2 0 1 1 0 4h-3.3v-8h3.3a2 2 0 1 1 0 4m0 0h-3.3");
}
