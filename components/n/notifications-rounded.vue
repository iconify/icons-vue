...
const content = `<path class="eogd0qieq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:notifications-rounded" /></template>
<style>
.eogd0qieq {
  fill: currentColor;
