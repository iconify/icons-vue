...
const content = `<path class="lmvg4na9w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:subtract-circle-32-regular" /></template>
<style>
.lmvg4na9w {
  fill: currentColor;
