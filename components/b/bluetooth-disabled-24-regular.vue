...
const content = `<path class="y7o8p5b7r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bluetooth-disabled-24-regular" /></template>
<style>
.y7o8p5b7r {
  fill: currentColor;
