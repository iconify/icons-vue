...
const content = `<path class="p_6d2uy7n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:play-for-work-outline" /></template>
<style>
.p_6d2uy7n {
  fill: currentColor;
