...
const content = `<path class="k5e4ctb9j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-landscape-20-regular" /></template>
<style>
.k5e4ctb9j {
  fill: currentColor;
