...
const content = `<path clip-rule="evenodd" class="zo5346bid"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:menu" /></template>
<style>
.zo5346bid {
  fill: currentColor;
  fill-rule: evenodd;
