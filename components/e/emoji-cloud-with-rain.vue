...
const content = `<path class="wh3d51bfk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-cloud-with-rain" /></template>
<style>
.wh3d51bfk {
  fill: none;
  stroke: currentColor;
