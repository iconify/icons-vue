...
const content = `<path class="szcscmbdr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:exercise-sharp" /></template>
<style>
.szcscmbdr {
  fill: currentColor;
