...
const content = `<path class="evsyf28fy"/><circle class="kutmos6dc"/><path class="xc_030z1f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-person-remove-alt-1" /></template>
<style>
.evsyf28fy {
  fill: currentColor;
