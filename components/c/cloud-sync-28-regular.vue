...
const content = `<path class="bvfqcccsi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-sync-28-regular" /></template>
<style>
.bvfqcccsi {
  fill: currentColor;
