...
const content = `<path class="ohglwrban"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-page-bottom-center-20-filled" /></template>
<style>
.ohglwrban {
  fill: currentColor;
