...
const content = `<path class="tmb0vubmd"/><path class="wz-sxib2z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-manifest" /></template>
<style>
.tmb0vubmd {
