...
const content = `<path class="gpurj_bmh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-double-right-thin" /></template>
<style>
.gpurj_bmh {
  fill: currentColor;
