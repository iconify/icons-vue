...
const content = `<path class="a9qewqbvm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shift-lock-off-outline-sharp" /></template>
<style>
.a9qewqbvm {
  fill: currentColor;
