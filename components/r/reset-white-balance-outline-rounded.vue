...
const content = `<path class="k86ugsbbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:reset-white-balance-outline-rounded" /></template>
<style>
.k86ugsbbl {
  fill: currentColor;
