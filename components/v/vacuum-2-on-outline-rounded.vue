...
const content = `<path class="wk561hblh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vacuum-2-on-outline-rounded" /></template>
<style>
.wk561hblh {
  fill: currentColor;
