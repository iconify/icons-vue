...
const content = `<path class="airpq_byo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:browse-activity-outline" /></template>
<style>
.airpq_byo {
  fill: currentColor;
