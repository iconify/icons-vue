...
const content = `<path class="xrz3g1cci"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:rectangle-landscape-sync-off-24-regular" /></template>
<style>
.xrz3g1cci {
  fill: currentColor;
