...
const content = `<path class="dlxt4ht9d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:andor" /></template>
<style>
.dlxt4ht9d {
  fill: none;
  stroke: currentColor;
