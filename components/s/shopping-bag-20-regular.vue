...
const content = `<path class="nc0c0twql"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shopping-bag-20-regular" /></template>
<style>
.nc0c0twql {
  fill: currentColor;
