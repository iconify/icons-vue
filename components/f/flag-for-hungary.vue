...
const content = `<path class="d245zxgwh"/><path class="tl3tdac8p"/><path class="mh79h9x1l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-hungary" /></template>
<style>
.d245zxgwh {
