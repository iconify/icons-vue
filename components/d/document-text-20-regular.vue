...
const content = `<path class="gnaqd-bqr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-text-20-regular" /></template>
<style>
.gnaqd-bqr {
  fill: currentColor;
