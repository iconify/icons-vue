...
const content = `<path class="kgezd5b5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-signature-24-regular" /></template>
<style>
.kgezd5b5x {
  fill: currentColor;
