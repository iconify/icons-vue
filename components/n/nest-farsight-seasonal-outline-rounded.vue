...
const content = `<path class="ns8sipb_o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-farsight-seasonal-outline-rounded" /></template>
<style>
.ns8sipb_o {
  fill: currentColor;
