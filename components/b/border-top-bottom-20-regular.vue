...
const content = `<path class="j1kbsmr9b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-top-bottom-20-regular" /></template>
<style>
.j1kbsmr9b {
  fill: currentColor;
