...
const content = `<path class="fjqlm7b5h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:warning-off-sharp" /></template>
<style>
.fjqlm7b5h {
  fill: currentColor;
