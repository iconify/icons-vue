...
const content = `<path class="lurx66bnu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:headphones-sound-wave-48-regular" /></template>
<style>
.lurx66bnu {
  fill: currentColor;
