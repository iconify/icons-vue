...
const content = `<path class="q3kgf5jrh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-circle-24-regular" /></template>
<style>
.q3kgf5jrh {
  fill: currentColor;
