...
const content = `<path class="aklup3b1i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-background-effect-horizontal-24-filled" /></template>
<style>
.aklup3b1i {
  fill: currentColor;
