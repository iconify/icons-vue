...
const content = `<g class="cuyn6tgcc"><path class="rggamvb0u"/><path class="s9jswxbnd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:crown-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
