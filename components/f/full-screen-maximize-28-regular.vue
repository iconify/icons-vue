...
const content = `<path class="bewr8cbfv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:full-screen-maximize-28-regular" /></template>
<style>
.bewr8cbfv {
  fill: currentColor;
