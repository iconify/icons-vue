...
const content = `<path class="i0x84bcbe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-clock-24-regular" /></template>
<style>
.i0x84bcbe {
  fill: currentColor;
