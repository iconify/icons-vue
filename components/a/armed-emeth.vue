...
const content = `<path class="c2z2scb7h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:armed-emeth" /></template>
<style>
.c2z2scb7h {
  fill: none;
  stroke: currentColor;
