...
const content = `<path class="l9kx2vbwv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-enter-20-regular" /></template>
<style>
.l9kx2vbwv {
  fill: currentColor;
