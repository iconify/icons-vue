...
const content = `<g class="nrj6p8qat"><path class="dl2nz2boo"/><path class="dpdi-e33o"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:grid-3x2-two-tone" /></template>
<style>
.dl2nz2boo {
  fill: currentColor;
