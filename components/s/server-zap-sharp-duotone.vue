...
const content = `<g class="gp_8x1bzb"><path class="wu4br8bxj"/><path class="r7vujjb4z"/><path class="r0sazqbgm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:server-zap-sharp-duotone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.wu4br8bxj {
  ...
  d: path("M3 1L19 1C19.5523 1 20 1.4477 20 2L20 10C20 10.5523 19.5523 11 19 11L3 11C2.4477 11 2 10.5523 2 10L2 2C2 1.4477 2.4477 1 3 1ZM3 13L14 13L14 23L3 23C2.4477 23 2 22.5523 2 22L2 14C2 13.4477 2.4477 13 3 13Z");
  stroke: none;
}
