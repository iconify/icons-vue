...
const content = `<path class="dt4_wxbyg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:credit-card-clock-rounded" /></template>
<style>
.dt4_wxbyg {
  fill: currentColor;
