...
const content = `<path class="vr6hmhxtb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-upload-ready-outline-sharp" /></template>
<style>
.vr6hmhxtb {
  fill: currentColor;
