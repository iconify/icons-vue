...
const content = `<path class="zzsnx9bop"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-upward-alt-rounded" /></template>
<style>
.zzsnx9bop {
  fill: currentColor;
