...
const content = `<path class="jn8bffb9v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-column-four-focus-center-left-16-filled" /></template>
<style>
.jn8bffb9v {
  fill: currentColor;
