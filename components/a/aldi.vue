...
const content = `<path class="y9v-ro3qg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:aldi" /></template>
<style>
.y9v-ro3qg {
  fill: none;
  stroke: currentColor;
