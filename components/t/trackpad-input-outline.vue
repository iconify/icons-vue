...
const content = `<path class="tp3vmgjki"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:trackpad-input-outline" /></template>
<style>
.tp3vmgjki {
  fill: currentColor;
