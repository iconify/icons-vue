...
const content = `<path class="pjjjhmb9z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layer-diagonal-20-filled" /></template>
<style>
.pjjjhmb9z {
  fill: currentColor;
