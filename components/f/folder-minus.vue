...
const content = `<path class="yz3ozkfdd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:folder-minus" /></template>
<style>
.yz3ozkfdd {
  fill: none;
  stroke: currentColor;
