...
const content = `<path class="cbqnvpp4w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:keyboard-hide-outline-sharp" /></template>
<style>
.cbqnvpp4w {
  fill: currentColor;
