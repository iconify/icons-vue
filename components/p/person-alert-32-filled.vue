...
const content = `<path class="r_biscc2i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-alert-32-filled" /></template>
<style>
.r_biscc2i {
  fill: currentColor;
