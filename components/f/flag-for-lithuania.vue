...
const content = `<path class="o_gjz8qww"/><path class="s3sig6tkv"/><path class="smx0ezbgg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-lithuania" /></template>
<style>
.o_gjz8qww {
