...
const content = `<path class="birsw-eyj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:aspect-ratio-rounded" /></template>
<style>
.birsw-eyj {
  fill: currentColor;
