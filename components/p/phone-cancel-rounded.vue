...
const content = `<path class="ti7ahdb1l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:phone-cancel-rounded" /></template>
<style>
.ti7ahdb1l {
  fill: currentColor;
