...
const content = `<path class="ylwl-cjye"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:modeling-outline-sharp" /></template>
<style>
.ylwl-cjye {
  fill: currentColor;
