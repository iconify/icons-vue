...
const content = `<path class="wvo3-_-mx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-decrease-ltr-24-filled" /></template>
<style>
.wvo3-_-mx {
  fill: currentColor;
