...
const content = `<path class="rpoz87_zh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:transgender-outline-sharp" /></template>
<style>
.rpoz87_zh {
  fill: currentColor;
