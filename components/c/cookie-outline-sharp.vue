...
const content = `<path class="jzf1kb6fb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cookie-outline-sharp" /></template>
<style>
.jzf1kb6fb {
  fill: currentColor;
