...
const content = `<path class="ywcqcfbqc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-wrap-off-20-regular" /></template>
<style>
.ywcqcfbqc {
  fill: currentColor;
