...
const content = `<path class="aw1w0nbel"/><path class="p6v1whbvr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:stadtradeln" /></template>
<style>
.aw1w0nbel {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M24 46.271c11.874 0 21.5-9.626 21.5-21.5s-9.626-21.5-21.5-21.5s-21.5 9.626-21.5 21.5s9.626 21.5 21.5 21.5");
}
