...
const content = `<g class="cuyn6tgcc"><path class="nnu0x1y2t"/><path class="c48-ycc6q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:crane-duotone" /></template>
<style>
.c48-ycc6q {
