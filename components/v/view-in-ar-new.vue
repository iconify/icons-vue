...
const content = `<path class="pa42llb9b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:view-in-ar-new" /></template>
<style>
.pa42llb9b {
  fill: currentColor;
