...
const content = `<path class="ny86ap99x"/><path class="va44kubtz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:google-photos" /></template>
<style>
.ny86ap99x {
  fill: none;
  stroke: currentColor;
