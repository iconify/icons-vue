...
const content = `<path class="on_dolakg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-android-frame-bolt-outline" /></template>
<style>
.on_dolakg {
  fill: currentColor;
