...
const content = `<path class="r-l74z54m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tree-evergreen-20-filled" /></template>
<style>
.r-l74z54m {
  fill: currentColor;
