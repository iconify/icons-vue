...
const content = `<path class="pzmrkcchn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:folder-info-outline" /></template>
<style>
.pzmrkcchn {
  fill: currentColor;
