...
const content = `<path class="izsed3b8f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:burst-mode-outline-rounded" /></template>
<style>
.izsed3b8f {
  fill: currentColor;
