...
const content = `<path class="wabgsgbsc"/><path class="rhomx7bkh"/>`;
</script>
...
.rhomx7bkh {
  ...
  d: path("M35.112 24c0 6.18-4.975 11.19-11.112 11.19S12.889 30.18 12.889 24S17.863 12.81 24 12.81S35.112 17.82 35.112 24");
}
