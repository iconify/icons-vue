...
const content = `<path class="uek89bc4m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-circle-eight-light" /></template>
<style>
.uek89bc4m {
  fill: currentColor;
