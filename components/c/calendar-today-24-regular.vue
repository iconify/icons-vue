...
const content = `<path class="i02ndqeho"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-today-24-regular" /></template>
<style>
.i02ndqeho {
  fill: currentColor;
