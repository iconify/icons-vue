...
const content = `<path class="uaeg5801z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:home-empty-24-filled" /></template>
<style>
.uaeg5801z {
  fill: currentColor;
