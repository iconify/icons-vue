...
const content = `<path class="prpk_qb2j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:scene-rounded" /></template>
<style>
.prpk_qb2j {
  fill: currentColor;
