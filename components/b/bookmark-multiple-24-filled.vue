...
const content = `<path class="d6t9abczl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bookmark-multiple-24-filled" /></template>
<style>
.d6t9abczl {
  fill: currentColor;
