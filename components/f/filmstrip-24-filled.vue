...
const content = `<path class="zpm90qc7v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:filmstrip-24-filled" /></template>
<style>
.zpm90qc7v {
  fill: currentColor;
