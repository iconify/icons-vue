...
const content = `<g class="gp_8x1bzb"><path class="fbkrm7bgj"/><path class="fpol88mud"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-three-quarter-sharp-fill" /></template>
<style>
.fbkrm7bgj {
...
.fpol88mud {
  ...
  d: path("M6 12L12 12L12 6C15.3138 6 18 8.6862 18 12C18 15.3138 15.3138 18 12 18C8.6862 18 6 15.3138 6 12Z");
}
