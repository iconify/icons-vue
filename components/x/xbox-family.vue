...
const content = `<path class="endx7rbaq"/><circle class="vi_nxfq0r"/><path class="jfftxbcir"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:xbox-family" /></template>
<style>
.endx7rbaq {
  fill: none;
  stroke: currentColor;
...
.jfftxbcir {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M36.5 38.5h2.6m-2.6 4v-8h4");
}
