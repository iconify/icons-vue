...
const content = `<path class="staa3-qig"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:print-add-24-filled" /></template>
<style>
.staa3-qig {
  fill: currentColor;
