...
const content = `<path class="lii3h5biz"/><path class="xm9uzjeuh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:autel-charge" /></template>
<style>
.lii3h5biz {
  fill: none;
  stroke: currentColor;
