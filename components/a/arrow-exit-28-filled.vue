...
const content = `<path class="zoyosdb-l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-exit-28-filled" /></template>
<style>
.zoyosdb-l {
  fill: currentColor;
