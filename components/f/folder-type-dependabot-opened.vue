...
const content = `<path class="z2jgf8hvp"/><path class="vye7w_b9l"/><path class="smcge4b0z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-dependabot-opened" /></template>
<style>
.smcge4b0z {
...
.z2jgf8hvp {
  fill: var(--svg-color--7fa4cc, #7fa4cc);
