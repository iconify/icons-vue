...
const content = `<path class="ig4v4wbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hourglass-arrow-up-outline-rounded" /></template>
<style>
.ig4v4wbxi {
  fill: currentColor;
