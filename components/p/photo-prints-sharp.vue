...
const content = `<path class="flft1m7kb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:photo-prints-sharp" /></template>
<style>
.flft1m7kb {
  fill: currentColor;
