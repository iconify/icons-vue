...
const content = `<path class="m0upz9eaw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sim-card-rounded" /></template>
<style>
.m0upz9eaw {
  fill: currentColor;
