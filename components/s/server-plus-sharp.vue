...
const content = `<g class="gp_8x1bzb"><path class="g0v-9nbsk"/><path class="q-qndji8q"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:server-plus-sharp" /></template>
<style>
.g0v-9nbsk {
  d: path("M2 2L18 2L18 10L2 10L2 2ZM13 22L2 22L2 14L13 14M19 15L19 23M15 19L23 19");
}
