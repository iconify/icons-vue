...
const content = `<path class="y8uw43bzt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bottom-right-click" /></template>
<style>
.y8uw43bzt {
  fill: currentColor;
