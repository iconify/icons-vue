...
const content = `<path class="xxdwnacdw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-available-20-regular" /></template>
<style>
.xxdwnacdw {
  fill: currentColor;
