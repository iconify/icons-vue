...
const content = `<path class="cp3hh6gxz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-table-restaurant" /></template>
<style>
.cp3hh6gxz {
  fill: currentColor;
