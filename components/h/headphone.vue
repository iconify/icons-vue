...
const content = `<g class="cuyn6tgcc"><path class="ngxdn5ure"/><path class="za5ig0byw"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:headphone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
