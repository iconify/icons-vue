...
const content = `<path class="nlpfblbug"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-snow-shower-night-24-regular" /></template>
<style>
.nlpfblbug {
  fill: currentColor;
