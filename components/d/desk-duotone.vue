...
const content = `<g class="cuyn6tgcc"><path class="gholeacef"/><path class="h03zoqb3i"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:desk-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
