...
const content = `<g class="cuyn6tgcc"><path class="buzt9q1ip"/><path class="qyo9u0bfx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:building-duotone" /></template>
<style>
.buzt9q1ip {
  d: path("M200 24v208h-48v-48h-48v48H56V24Z");
