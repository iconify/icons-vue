...
const content = `<path class="celwd09hh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:play-circle-hint-20-filled" /></template>
<style>
.celwd09hh {
  fill: currentColor;
