...
const content = `<path class="md_csp_nl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-key-32-regular" /></template>
<style>
.md_csp_nl {
  fill: currentColor;
