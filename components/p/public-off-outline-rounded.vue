...
const content = `<path class="nw8iqtb4f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:public-off-outline-rounded" /></template>
<style>
.nw8iqtb4f {
  fill: currentColor;
