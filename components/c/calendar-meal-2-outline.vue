...
const content = `<path class="tq69k6bnv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:calendar-meal-2-outline" /></template>
<style>
.tq69k6bnv {
  fill: currentColor;
