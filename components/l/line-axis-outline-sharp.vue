...
const content = `<path class="kl5ngg-qn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:line-axis-outline-sharp" /></template>
<style>
.kl5ngg-qn {
  fill: currentColor;
