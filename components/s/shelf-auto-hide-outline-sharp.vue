...
const content = `<path class="jh36jrbft"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shelf-auto-hide-outline-sharp" /></template>
<style>
.jh36jrbft {
  fill: currentColor;
