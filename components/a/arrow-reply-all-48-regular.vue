...
const content = `<path class="h5qr7_krk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-reply-all-48-regular" /></template>
<style>
.h5qr7_krk {
  fill: currentColor;
