...
const content = `<path class="m-sp39bdx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:scrollable-header-rounded" /></template>
<style>
.m-sp39bdx {
  fill: currentColor;
