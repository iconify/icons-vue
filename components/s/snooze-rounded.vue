...
const content = `<path class="dw411mbxc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:snooze-rounded" /></template>
<style>
.dw411mbxc {
  fill: currentColor;
