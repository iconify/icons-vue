...
const content = `<path class="zcw8gdbhj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:pause-presentation-outline-rounded" /></template>
<style>
.zcw8gdbhj {
  fill: currentColor;
