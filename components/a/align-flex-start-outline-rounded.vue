...
const content = `<path class="l0d4p-36b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-flex-start-outline-rounded" /></template>
<style>
.l0d4p-36b {
  fill: currentColor;
