...
const content = `<path class="iz4wzfbbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:trackpad-input-rounded" /></template>
<style>
.iz4wzfbbq {
  fill: currentColor;
