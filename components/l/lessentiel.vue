...
const content = `<path class="bo_7t4t-d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lessentiel" /></template>
<style>
.bo_7t4t-d {
  fill: none;
  stroke: currentColor;
