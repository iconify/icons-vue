...
const content = `<path class="adeypsbxh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cells-split-32-light" /></template>
<style>
.adeypsbxh {
  fill: currentColor;
