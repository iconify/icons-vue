...
const content = `<path class="nwme90bea"/><path class="r4as2hbio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:comico-justoon" /></template>
<style>
.nwme90bea {
  fill: none;
  stroke: currentColor;
