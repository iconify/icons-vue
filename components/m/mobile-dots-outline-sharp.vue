...
const content = `<path class="ztcgqu9-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobile-dots-outline-sharp" /></template>
<style>
.ztcgqu9-j {
  fill: currentColor;
