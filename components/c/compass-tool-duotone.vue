...
const content = `<g class="cuyn6tgcc"><path class="t528wubgx"/><path class="r5jqzbc9d"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:compass-tool-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
