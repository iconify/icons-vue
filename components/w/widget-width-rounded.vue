...
const content = `<path class="du15mybnu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:widget-width-rounded" /></template>
<style>
.du15mybnu {
  fill: currentColor;
