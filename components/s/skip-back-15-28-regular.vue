...
const content = `<path class="wzf57jbmg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:skip-back-15-28-regular" /></template>
<style>
.wzf57jbmg {
  fill: currentColor;
