...
const content = `<path class="ddy237b5l"/><path class="be625c6pp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-app-settings-alt" /></template>
<style>
.be625c6pp {
  fill: currentColor;
