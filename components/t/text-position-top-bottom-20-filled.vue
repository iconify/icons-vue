...
const content = `<path class="m2ha0xbmu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-top-bottom-20-filled" /></template>
<style>
.m2ha0xbmu {
  fill: currentColor;
