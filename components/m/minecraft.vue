...
const content = `<path class="jt3nzbkaa"/><path class="expm-pbwx"/><path class="tjy1rabhv"/><path class="p67sessdx"/><path class="tbm3pobcq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:minecraft" /></template>
<style>
.expm-pbwx {
  fill: none;
  stroke: currentColor;
