...
const content = `<path class="vua24gvas"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-bullet-list-clock-24-filled" /></template>
<style>
.vua24gvas {
  fill: currentColor;
