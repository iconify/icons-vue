...
const content = `<g class="rumydibuh"><path class="sq9o68-be"/><path class="jmpfc5s0o"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:agix" /></template>
<style>
.jmpfc5s0o {
