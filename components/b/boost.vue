...
const content = `<path class="vr963oosb"/><path class="utt-j_z4w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:boost" /></template>
<style>
.utt-j_z4w {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M13 35c4-.74 11.1-7.4 11.93-11.93C20.37 23.94 13.71 31 13 35");
}
