...
const content = `<path class="yebdyeb0t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:scanner-outline" /></template>
<style>
.yebdyeb0t {
  fill: currentColor;
