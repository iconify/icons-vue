...
const content = `<path class="tnlnbjdhf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:science-rounded" /></template>
<style>
.tnlnbjdhf {
  fill: currentColor;
