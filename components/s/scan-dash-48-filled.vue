...
const content = `<path class="klh3bltfq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:scan-dash-48-filled" /></template>
<style>
.klh3bltfq {
  fill: currentColor;
