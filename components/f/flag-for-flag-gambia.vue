...
const content = `<path class="rsz0kbczt"/><path class="lyoabd47f"/><path class="t42tkekqp"/><path class="vpvs36pfv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-gambia" /></template>
<style>
.lyoabd47f {
  fill: var(--svg-color--e6e7e8, #e6e7e8);
  d: path("M0 24h64v3H0zm0 13h64v3H0z");
}
