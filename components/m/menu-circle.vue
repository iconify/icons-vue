...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="gxuyijy_c"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:menu-circle" /></template>
<style>
.gxuyijy_c {
