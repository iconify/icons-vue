...
const content = `<path class="et0wqksoz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cell-merge-outline-sharp" /></template>
<style>
.et0wqksoz {
  fill: currentColor;
