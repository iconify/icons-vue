...
const content = `<path class="aj2tr9bdr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:roller-shades-rounded" /></template>
<style>
.aj2tr9bdr {
  fill: currentColor;
