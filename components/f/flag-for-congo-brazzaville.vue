...
const content = `<path class="v1uudqb1q"/><path class="n97i-i-mr"/><path class="u8rrg1krc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-congo-brazzaville" /></template>
<style>
.n97i-i-mr {
