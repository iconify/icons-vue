...
const content = `<path class="av4l4eb6b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-circle-seven-light" /></template>
<style>
.av4l4eb6b {
  fill: currentColor;
