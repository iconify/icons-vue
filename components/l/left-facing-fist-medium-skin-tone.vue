...
const content = `<path class="eqow_34zd"/><defs><path id="SVGPedepbtP" class="us6dcifmo"/></defs><clipPath id="SVGOq0aqePL"><use href="#SVGPedepbtP"/></clipPath><g clip-path="url(#SVGOq0aqePL)" class="byeg-0b8a"><path class="g6qubybib"/></g><defs><use href="#SVGPedepbtP" id="SVGVjsgUc5R"/></defs><clipPath id="SVGXRcECbgN"><use href="#SVGVjsgUc5R"/></clipPath><g clip-path="url(#SVGXRcECbgN)" class="lip7wrrrl"><path class="gw7qssbko"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:left-facing-fist-medium-skin-tone" /></template>
<style>
.byeg-0b8a {
