...
const content = `<path class="vh9uxab4q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-edgesensor-high" /></template>
<style>
.vh9uxab4q {
  fill: currentColor;
