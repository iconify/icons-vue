...
const content = `<path class="fm-r3tbnm"/><path class="t-c92lb-f"/><path class="v3dsncbox"/><path class="co8b8obus"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-south-korea" /></template>
<style>
.co8b8obus {
...
.t-c92lb-f {
  ...
  d: path("M21.441 13.085a6 6 0 0 0-8.356 1.474A3.001 3.001 0 0 0 18 18a3 3 0 0 1 4.915 3.442a6 6 0 0 0-1.474-8.357");
}

.v3dsncbox {
  fill: var(--svg-color--003478, #003478);
  d: path("M22.178 17.264A3 3 0 0 0 18 18a3.001 3.001 0 0 1-4.915-3.442a6 6 0 1 0 9.829 6.882a2.997 2.997 0 0 0-.736-4.176");
}
