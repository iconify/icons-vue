...
const content = `<path class="dbty8_4zc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:verified-sharp" /></template>
<style>
.dbty8_4zc {
  fill: currentColor;
