...
const content = `<path class="mjivo9sdk"/><path class="upmf6ob0d"/><path class="zroc16cla"/><path class="hb3leus3r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-mauritius" /></template>
<style>
.hb3leus3r {
