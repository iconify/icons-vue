...
const content = `<path class="ouzwnub4c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:acute-rounded" /></template>
<style>
.ouzwnub4c {
  fill: currentColor;
