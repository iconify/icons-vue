...
const content = `<path class="sdicexbdp"/><path class="j-fahdbhy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-keyboard-double-arrow-down" /></template>
<style>
.j-fahdbhy {
  fill: currentColor;
