...
const content = `<path class="b69rm_9vp"/><path class="ptoytlc-g"/><path class="jw91py0qw"/><path class="s8fxkabzh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-light-mypy-opened" /></template>
<style>
.b69rm_9vp {
