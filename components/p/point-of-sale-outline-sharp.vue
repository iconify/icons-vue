...
const content = `<path class="aqxrgkbpm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:point-of-sale-outline-sharp" /></template>
<style>
.aqxrgkbpm {
  fill: currentColor;
