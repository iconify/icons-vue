...
const content = `<path class="gows3b59k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:double-tap-swipe-up-24-filled" /></template>
<style>
.gows3b59k {
  fill: currentColor;
