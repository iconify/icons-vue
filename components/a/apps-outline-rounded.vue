...
const content = `<path class="zs9n2n88n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:apps-outline-rounded" /></template>
<style>
.zs9n2n88n {
  fill: currentColor;
