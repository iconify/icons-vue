...
const content = `<path class="ta0v8ro_d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-list-28-filled" /></template>
<style>
.ta0v8ro_d {
  fill: currentColor;
