...
const content = `<g class="nrj6p8qat"><path class="vhck9ybet"/><path clip-rule="evenodd" class="qa1terbik"/><path class="m0-o-p7qp"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-x-duotone" /></template>
<style>
.m0-o-p7qp {
  d: path("M15 16L21 22M21 16L15 22");
}
