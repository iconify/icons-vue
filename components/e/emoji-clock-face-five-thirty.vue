...
const content = `<path class="xd94f627o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-clock-face-five-thirty" /></template>
<style>
.xd94f627o {
  fill: none;
  stroke: currentColor;
