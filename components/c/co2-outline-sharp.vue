...
const content = `<path class="kflhi5bup"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:co2-outline-sharp" /></template>
<style>
.kflhi5bup {
  fill: currentColor;
