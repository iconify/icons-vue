...
const content = `<path class="hrakn7wqo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-bottom-expand-20-filled" /></template>
<style>
.hrakn7wqo {
  fill: currentColor;
