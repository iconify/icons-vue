...
const content = `<path class="nkyhmnkdp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:multiplier-1-8x-28-regular" /></template>
<style>
.nkyhmnkdp {
  fill: currentColor;
