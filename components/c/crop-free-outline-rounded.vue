...
const content = `<path class="m-jpr4ohg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:crop-free-outline-rounded" /></template>
<style>
.m-jpr4ohg {
  fill: currentColor;
