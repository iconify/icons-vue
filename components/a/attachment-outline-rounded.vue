...
const content = `<path class="hnghrkrni"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:attachment-outline-rounded" /></template>
<style>
.hnghrkrni {
  fill: currentColor;
