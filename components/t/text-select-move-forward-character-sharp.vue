...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:text-select-move-forward-character-sharp" /></template>
<style>
.d1dcf-bga {
  fill: currentColor;
