...
const content = `<path class="hsmnhxzfq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-bullet-list-24-regular" /></template>
<style>
.hsmnhxzfq {
  fill: currentColor;
