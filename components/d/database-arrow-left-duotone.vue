...
const content = `<g class="nrj6p8qat"><path class="vhck9ybet"/><path clip-rule="evenodd" class="qa1terbik"/><path class="zzeg1dblh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-left-duotone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
...
.zzeg1dblh {
  d: path("M21 19H15M18 16L15 19L18 22");
}
