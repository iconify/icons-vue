...
const content = `<g class="gp_8x1bzb"><path clip-rule="evenodd" class="zv_0vqboe"/><path class="geyr2rn_m"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-minus-sharp-fill" /></template>
<style>
.geyr2rn_m {
  d: path("M14 19L22 19");
}
