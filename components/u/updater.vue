...
const content = `<path class="tzbp4wu4h"/><path class="inj4nfbks"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:updater" /></template>
<style>
.inj4nfbks {
  fill: none;
  stroke: currentColor;
...
.tzbp4wu4h {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M24 31.186V16.814l5.456 5.884M24 16.814l-5.456 5.884");
}
