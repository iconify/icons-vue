...
const content = `<path class="xt8vfabet"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:router-off-sharp" /></template>
<style>
.xt8vfabet {
  fill: currentColor;
