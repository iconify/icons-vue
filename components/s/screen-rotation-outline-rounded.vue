...
const content = `<path class="a4aovjwmn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screen-rotation-outline-rounded" /></template>
<style>
.a4aovjwmn {
  fill: currentColor;
