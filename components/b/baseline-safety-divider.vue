...
const content = `<path class="ze5f5-rhb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-safety-divider" /></template>
<style>
.ze5f5-rhb {
  fill: currentColor;
