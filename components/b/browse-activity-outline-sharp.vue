...
const content = `<path class="vl8u8qbvj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:browse-activity-outline-sharp" /></template>
<style>
.vl8u8qbvj {
  fill: currentColor;
