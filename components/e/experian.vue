...
const content = `<path class="qgvpaccxg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:experian" /></template>
<style>
.qgvpaccxg {
  fill: none;
  stroke: currentColor;
