...
const content = `<path class="fkztgpbfi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:immersive-reader-32-light" /></template>
<style>
.fkztgpbfi {
  fill: currentColor;
