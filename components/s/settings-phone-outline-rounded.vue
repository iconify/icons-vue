...
const content = `<path class="h7hfh8peu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-phone-outline-rounded" /></template>
<style>
.h7hfh8peu {
  fill: currentColor;
