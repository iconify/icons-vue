...
const content = `<path class="qjraa_00a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sensor-window-outline-rounded" /></template>
<style>
.qjraa_00a {
  fill: currentColor;
