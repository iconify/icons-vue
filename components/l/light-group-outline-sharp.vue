...
const content = `<path class="lccvwh6wp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:light-group-outline-sharp" /></template>
<style>
.lccvwh6wp {
  fill: currentColor;
