...
const content = `<path class="s1cho2bvu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:concierge-rounded" /></template>
<style>
.s1cho2bvu {
  fill: currentColor;
