...
const content = `<path class="s0v5tszcv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:jiten" /></template>
<style>
.s0v5tszcv {
  fill: none;
  stroke: currentColor;
