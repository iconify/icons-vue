...
const content = `<path class="uot920bnk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-checkmark-32-filled" /></template>
<style>
.uot920bnk {
  fill: currentColor;
