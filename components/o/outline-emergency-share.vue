...
const content = `<path class="ilrjtub8b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-emergency-share" /></template>
<style>
.ilrjtub8b {
  fill: currentColor;
