...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shopping-cart-sharp-fill" /></template>
<style>
.aoal70b6v {
  fill: currentColor;
  fill-rule: evenodd;
