...
const content = `<path class="c8pzut1xc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:domain-verification-outline-rounded" /></template>
<style>
.c8pzut1xc {
  fill: currentColor;
