...
const content = `<g class="cuyn6tgcc"><path class="x-b-j3bbr"/><path class="o4kkjab1r"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:wrench-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
