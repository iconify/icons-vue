...
const content = `<path class="czihr1ylq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-pharmacy-outline-rounded" /></template>
<style>
.czihr1ylq {
  fill: currentColor;
