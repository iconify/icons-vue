...
const content = `<path class="ni7-f0tha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:package-rounded" /></template>
<style>
.ni7-f0tha {
  fill: currentColor;
