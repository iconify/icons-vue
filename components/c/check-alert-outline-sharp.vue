...
const content = `<path class="vd5434b_b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:check-alert-outline-sharp" /></template>
<style>
.vd5434b_b {
  fill: currentColor;
