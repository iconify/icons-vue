...
const content = `<path class="dhdu0ub6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:co2-outline-rounded" /></template>
<style>
.dhdu0ub6u {
  fill: currentColor;
