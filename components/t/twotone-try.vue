...
const content = `<path class="nit-viblq"/><path class="lz9ejnhqg"/><path class="a5qou4b4x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-try" /></template>
<style>
.a5qou4b4x {
  fill: currentColor;
