...
const content = `<path class="tdngwtb0w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shield-person-outline-rounded" /></template>
<style>
.tdngwtb0w {
  fill: currentColor;
