...
const content = `<path class="ekwnbex_k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-contact-emergency" /></template>
<style>
.ekwnbex_k {
  fill: currentColor;
