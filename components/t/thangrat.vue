...
const content = `<path class="igvc1tbwv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:thangrat" /></template>
<style>
.igvc1tbwv {
  fill: none;
  stroke: currentColor;
