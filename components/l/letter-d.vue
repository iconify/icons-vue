...
const content = `<path class="x-kz1kb7j"/><path class="z47h3obmw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:letter-d" /></template>
<style>
.x-kz1kb7j {
