...
const content = `<path class="lr51hiq9y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-right-expand-20-filled" /></template>
<style>
.lr51hiq9y {
  fill: currentColor;
