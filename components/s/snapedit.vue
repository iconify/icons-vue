...
const content = `<path class="m08eq3b-a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:snapedit" /></template>
<style>
.m08eq3b-a {
  fill: none;
  stroke: currentColor;
