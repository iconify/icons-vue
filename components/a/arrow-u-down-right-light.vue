...
const content = `<path class="zrk08pb_p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-u-down-right-light" /></template>
<style>
.zrk08pb_p {
  fill: currentColor;
