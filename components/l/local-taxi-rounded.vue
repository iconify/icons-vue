...
const content = `<path class="dpr2tab2o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:local-taxi-rounded" /></template>
<style>
.dpr2tab2o {
  fill: currentColor;
