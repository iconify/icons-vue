...
const content = `<path class="ehg7ko_cj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-dismiss-24-regular" /></template>
<style>
.ehg7ko_cj {
  fill: currentColor;
