...
const content = `<path class="xtltxg6zu"/><path class="egd59tb2y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bank-norwegian" /></template>
<style>
.egd59tb2y {
  fill: none;
  stroke: currentColor;
