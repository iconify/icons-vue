...
const content = `<path class="o2kh82bgb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:subwoofer" /></template>
<style>
.o2kh82bgb {
  fill: currentColor;
