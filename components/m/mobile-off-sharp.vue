...
const content = `<path class="c90kml0-l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-off-sharp" /></template>
<style>
.c90kml0-l {
  fill: currentColor;
