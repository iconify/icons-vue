...
const content = `<path class="evt3tsbvk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tap-and-play-sharp" /></template>
<style>
.evt3tsbvk {
  fill: currentColor;
