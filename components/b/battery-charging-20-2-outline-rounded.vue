...
const content = `<path class="j8x7dht8c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:battery-charging-20-2-outline-rounded" /></template>
<style>
.j8x7dht8c {
  fill: currentColor;
