...
const content = `<path class="ippidhbcm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:steering-wheel-cool-outline-sharp" /></template>
<style>
.ippidhbcm {
  fill: currentColor;
