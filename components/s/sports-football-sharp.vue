...
const content = `<path class="akfx4_bef"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sports-football-sharp" /></template>
<style>
.akfx4_bef {
  fill: currentColor;
