...
const content = `<path class="rmmm8q1xw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:books-movies-and-music-rounded" /></template>
<style>
.rmmm8q1xw {
  fill: currentColor;
