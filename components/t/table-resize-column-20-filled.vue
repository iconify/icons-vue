...
const content = `<path class="wuznl8-pj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-resize-column-20-filled" /></template>
<style>
.wuznl8-pj {
  fill: currentColor;
