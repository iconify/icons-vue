...
const content = `<path class="jb-1047_d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:person-pin-circle-outline-sharp" /></template>
<style>
.jb-1047_d {
  fill: currentColor;
