...
const content = `<path class="cdj_y1r7t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:grid-view-rounded" /></template>
<style>
.cdj_y1r7t {
  fill: currentColor;
