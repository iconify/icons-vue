...
const content = `<path class="iz5fs4bpd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-one-page-sparkle-20-regular" /></template>
<style>
.iz5fs4bpd {
  fill: currentColor;
