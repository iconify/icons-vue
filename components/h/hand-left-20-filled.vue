...
const content = `<path class="htd78qbpa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:hand-left-20-filled" /></template>
<style>
.htd78qbpa {
  fill: currentColor;
