...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="bandpxtlp"/><path class="edn98bbuh"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:chain-circle" /></template>
<style>
.bandpxtlp {
