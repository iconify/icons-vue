...
const content = `<path class="os51j2zfq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-crescent-moon" /></template>
<style>
.os51j2zfq {
  fill: none;
  stroke: currentColor;
