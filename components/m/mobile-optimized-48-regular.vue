...
const content = `<path class="tkixhbcnn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mobile-optimized-48-regular" /></template>
<style>
.tkixhbcnn {
  fill: currentColor;
