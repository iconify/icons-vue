...
const content = `<path class="cyjhhmb2c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-arrow-up-outline-sharp" /></template>
<style>
.cyjhhmb2c {
  fill: currentColor;
