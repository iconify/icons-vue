...
const content = `<path class="lpalclbmn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-move-right-28-regular" /></template>
<style>
.lpalclbmn {
  fill: currentColor;
