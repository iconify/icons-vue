...
const content = `<circle class="cpk0fnbgt"/><path class="l3-kb8bqp"/><path class="dma3_wbqa"/><circle class="n4hy8b8qs"/><circle class="rzgb5yb9y"/><circle class="yfjdnob4y"/><circle class="cs_zt6n6s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:capod" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
...
.dma3_wbqa {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m30.851 13.304l2.023 3.635c.2.345-.118.902-.709 1.243l-.019.011c-.591.341-1.232.338-1.431-.008l-1.947-3.502m-11.537-1.379l-2.06 3.636c-.2.346.118.902.709 1.244l.019.01c.591.342 1.232.338 1.431-.007l1.917-3.491");
}
