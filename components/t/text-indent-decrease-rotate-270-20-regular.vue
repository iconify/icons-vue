...
const content = `<path class="l1sm5vk4y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-indent-decrease-rotate-270-20-regular" /></template>
<style>
.l1sm5vk4y {
  fill: currentColor;
