...
const content = `<path class="yxhu-vn1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-dismiss-16-regular" /></template>
<style>
.yxhu-vn1j {
  fill: currentColor;
