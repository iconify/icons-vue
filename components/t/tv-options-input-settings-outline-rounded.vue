...
const content = `<path class="rttdljpzo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tv-options-input-settings-outline-rounded" /></template>
<style>
.rttdljpzo {
  fill: currentColor;
