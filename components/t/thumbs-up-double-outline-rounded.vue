...
const content = `<path class="jd67pseli"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:thumbs-up-double-outline-rounded" /></template>
<style>
.jd67pseli {
  fill: currentColor;
