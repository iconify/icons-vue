...
const content = `<path class="u94jq6kwv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mycicero" /></template>
<style>
.u94jq6kwv {
  fill: none;
  stroke: currentColor;
