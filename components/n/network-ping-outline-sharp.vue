...
const content = `<path class="xdt1b0bcx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:network-ping-outline-sharp" /></template>
<style>
.xdt1b0bcx {
  fill: currentColor;
