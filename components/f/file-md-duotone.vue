...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="dzh-fq9op"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-md-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
