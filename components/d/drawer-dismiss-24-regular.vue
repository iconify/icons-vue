...
const content = `<path class="l-heve01d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drawer-dismiss-24-regular" /></template>
<style>
.l-heve01d {
  fill: currentColor;
