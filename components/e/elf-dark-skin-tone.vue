...
const content = `<path class="m0u3czblj"/><path class="gs03v_q9g"/><path class="vs4zh0bpe"/><path class="bmu0p_bfu"/><g class="e_raf5bng"><path class="wbrbhdb-b"/><path class="mfm66mb-f"/></g><path class="n99br4bgh"/><path class="idh88ol5q"/><path class="vzob3pdol"/><path class="wshm-gqdu"/><circle class="tqw0884fe"/><path class="ts62ygwrs"/><path class="fr0hjibbj"/><path class="v898yxnlx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="openmoji:elf-dark-skin-tone" /></template>
