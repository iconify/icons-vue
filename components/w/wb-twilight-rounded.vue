...
const content = `<path class="ywiz4cafu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wb-twilight-rounded" /></template>
<style>
.ywiz4cafu {
  fill: currentColor;
