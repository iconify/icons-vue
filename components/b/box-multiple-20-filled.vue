...
const content = `<path class="rw-g570ms"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:box-multiple-20-filled" /></template>
<style>
.rw-g570ms {
  fill: currentColor;
