...
const content = `<g class="cuyn6tgcc"><path class="udi-sb2hv"/><path class="ito-wr5_a"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:rug-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
