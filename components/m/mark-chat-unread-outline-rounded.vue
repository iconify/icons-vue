...
const content = `<path class="bnb3mvbqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mark-chat-unread-outline-rounded" /></template>
<style>
.bnb3mvbqq {
  fill: currentColor;
