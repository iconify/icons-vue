...
const content = `<path class="chm2gvbnv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:hourglass-simple-low-bold" /></template>
<style>
.chm2gvbnv {
  fill: currentColor;
