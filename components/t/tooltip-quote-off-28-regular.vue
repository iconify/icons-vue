...
const content = `<path class="f1x527a4z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tooltip-quote-off-28-regular" /></template>
<style>
.f1x527a4z {
  fill: currentColor;
