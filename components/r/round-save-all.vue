...
const content = `<path clip-rule="evenodd" class="ianha5b-p"/><path class="kvvre9b5e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-save-all" /></template>
<style>
.ianha5b-p {
  fill: currentColor;
  fill-rule: evenodd;
