...
const content = `<path class="ecx3aacjw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:file-json-sharp" /></template>
<style>
.ecx3aacjw {
  fill: currentColor;
