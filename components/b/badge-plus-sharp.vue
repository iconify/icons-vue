...
const content = `<g class="gp_8x1bzb"><path class="xgaf0nbdt"/><path class="vo1f5lbpj"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:badge-plus-sharp" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.vo1f5lbpj {
  d: path("M7 12L17 12M11.995 17.005L11.995 7.005");
}
