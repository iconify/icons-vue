...
const content = `<g class="cuyn6tgcc"><path class="nvjq80alh"/><path class="bse-cdbpy"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:file-sql-duotone" /></template>
<style>
.bse-cdbpy {
