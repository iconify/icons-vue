...
const content = `<path class="frwz-zb5f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:shift-lock-outline-rounded" /></template>
<style>
.frwz-zb5f {
  fill: currentColor;
