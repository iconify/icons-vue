...
const content = `<path class="dh78p4zsr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:flash-off-outline-sharp" /></template>
<style>
.dh78p4zsr {
  fill: currentColor;
