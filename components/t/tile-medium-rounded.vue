...
const content = `<path class="b3ad8fbxz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tile-medium-rounded" /></template>
<style>
.b3ad8fbxz {
  fill: currentColor;
