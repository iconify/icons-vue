...
const content = `<g class="nrj6p8qat"><path class="norrpj21j"/><path class="szh19hpiz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:wrench-duotone" /></template>
<style>
.norrpj21j {
  fill: currentColor;
