...
const content = `<path class="mtm_3vbdm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-seating-outline-sharp" /></template>
<style>
.mtm_3vbdm {
  fill: currentColor;
