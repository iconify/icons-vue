...
const content = `<path class="ny1da3b4g"/><path class="g2wj9jbhp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sso-plus" /></template>
<style>
.g2wj9jbhp {
  fill: none;
  stroke: currentColor;
