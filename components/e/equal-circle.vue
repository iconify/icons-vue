...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="n4lgfbb5x"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:equal-circle" /></template>
<style>
.hdxpysbbn {
