...
const content = `<path class="skrqhqbhf"/><path class="i90qnxd_h"/><path class="h0e0dcc4q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-light-rubocop" /></template>
<style>
.h0e0dcc4q {
