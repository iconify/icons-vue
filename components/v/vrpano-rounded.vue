...
const content = `<path class="dwphwnbhe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:vrpano-rounded" /></template>
<style>
.dwphwnbhe {
  fill: currentColor;
