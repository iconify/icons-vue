...
const content = `<path class="tcb60bgwx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:currency-yuan-outline-rounded" /></template>
<style>
.tcb60bgwx {
  fill: currentColor;
