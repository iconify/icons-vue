...
const content = `<path class="ufifh5b_n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-screen-rotation-alt" /></template>
<style>
.ufifh5b_n {
  fill: currentColor;
