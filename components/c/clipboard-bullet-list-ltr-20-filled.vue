...
const content = `<path class="t2xo9pb2g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-bullet-list-ltr-20-filled" /></template>
<style>
.t2xo9pb2g {
  fill: currentColor;
