...
const content = `<path class="lgr4pgvlx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:myoffice-documents" /></template>
<style>
.lgr4pgvlx {
  fill: none;
  stroke: currentColor;
