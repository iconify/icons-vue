...
const content = `<path class="pywjikbfq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:edit-settings-24-filled" /></template>
<style>
.pywjikbfq {
  fill: currentColor;
