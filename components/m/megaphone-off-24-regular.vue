...
const content = `<path class="o_13ahckb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:megaphone-off-24-regular" /></template>
<style>
.o_13ahckb {
  fill: currentColor;
