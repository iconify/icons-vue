...
const content = `<path class="nfbebzb_v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-vertical-24-regular" /></template>
<style>
.nfbebzb_v {
  fill: currentColor;
