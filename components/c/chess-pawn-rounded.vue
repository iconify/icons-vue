...
const content = `<path class="nd7efkhwa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chess-pawn-rounded" /></template>
<style>
.nd7efkhwa {
  fill: currentColor;
