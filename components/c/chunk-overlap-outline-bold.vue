...
const content = `<g class="s0phu2bbs"><path class="jw0risdcq"/><path class="j6xe62btt"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:chunk-overlap-outline-bold" /></template>
<style>
.j6xe62btt {
