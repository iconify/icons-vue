...
const content = `<path class="thgdtob0g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-off-sharp" /></template>
<style>
.thgdtob0g {
  fill: currentColor;
