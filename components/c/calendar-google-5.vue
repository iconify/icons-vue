...
const content = `<path class="p37m2nbur"/><path class="uph4zqc9i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-google-5" /></template>
<style>
.p37m2nbur {
  fill: none;
  stroke: currentColor;
