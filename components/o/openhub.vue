...
const content = `<path class="l_nh3ibvd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:openhub" /></template>
<style>
.l_nh3ibvd {
  fill: none;
  stroke: currentColor;
