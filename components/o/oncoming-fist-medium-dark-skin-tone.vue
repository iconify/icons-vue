...
const content = `<path class="vgysfybyd"/><path class="ek3ct0bnr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:oncoming-fist-medium-dark-skin-tone" /></template>
<style>
.ek3ct0bnr {
