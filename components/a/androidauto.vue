...
const content = `<path class="jwyztr91h"/><path class="mds1wrbrw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:androidauto" /></template>
<style>
.jwyztr91h {
  fill: none;
  stroke: currentColor;
