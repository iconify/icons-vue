...
const content = `<path class="lh06n7u4u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-mac-32-regular" /></template>
<style>
.lh06n7u4u {
  fill: currentColor;
