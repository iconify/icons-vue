...
const content = `<path class="b8z7pmb4e"/><path class="g2wj9jbhp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tts-server" /></template>
<style>
.b8z7pmb4e {
  fill: none;
  stroke: currentColor;
