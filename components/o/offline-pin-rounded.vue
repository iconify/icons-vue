...
const content = `<path class="f6wgobczb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:offline-pin-rounded" /></template>
<style>
.f6wgobczb {
  fill: currentColor;
