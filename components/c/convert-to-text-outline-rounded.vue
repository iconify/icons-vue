...
const content = `<path class="si359odbw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:convert-to-text-outline-rounded" /></template>
<style>
.si359odbw {
  fill: currentColor;
