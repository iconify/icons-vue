...
const content = `<path class="btl6l-b_a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:inbox-text-person-sharp" /></template>
<style>
.btl6l-b_a {
  fill: currentColor;
