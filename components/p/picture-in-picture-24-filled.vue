...
const content = `<path class="m602jcboq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:picture-in-picture-24-filled" /></template>
<style>
.m602jcboq {
  fill: currentColor;
