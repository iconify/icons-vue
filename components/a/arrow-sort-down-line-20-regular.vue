...
const content = `<path class="z89no7bua"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-sort-down-line-20-regular" /></template>
<style>
.z89no7bua {
  fill: currentColor;
