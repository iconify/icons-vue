...
const content = `<path class="kupqwnbur"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:android-cell-4-bar-plus-outline-sharp" /></template>
<style>
.kupqwnbur {
  fill: currentColor;
