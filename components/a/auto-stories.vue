...
const content = `<path class="zl7d9535b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:auto-stories" /></template>
<style>
.zl7d9535b {
  fill: currentColor;
