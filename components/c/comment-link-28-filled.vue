...
const content = `<path class="rghvd-nbj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:comment-link-28-filled" /></template>
<style>
.rghvd-nbj {
  fill: currentColor;
