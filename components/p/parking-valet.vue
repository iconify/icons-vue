...
const content = `<path class="kmvplsbxc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:parking-valet" /></template>
<style>
.kmvplsbxc {
  fill: currentColor;
