...
const content = `<path class="ht6sreb1u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:phonelink-lock-sharp" /></template>
<style>
.ht6sreb1u {
  fill: currentColor;
