...
const content = `<path class="ir0t33bvk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:rocket-2-sharp" /></template>
<style>
.ir0t33bvk {
  fill: none;
  stroke: currentColor;
