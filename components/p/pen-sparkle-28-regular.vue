...
const content = `<path class="q3mjhpitw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pen-sparkle-28-regular" /></template>
<style>
.q3mjhpitw {
  fill: currentColor;
