...
const content = `<g class="cuyn6tgcc"><path class="xa44s_6_c"/><path class="rsm2p1bvz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:hands-clapping-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
