...
const content = `<path class="zwh0h6b6a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:detector-outline" /></template>
<style>
.zwh0h6b6a {
  fill: currentColor;
