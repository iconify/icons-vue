...
const content = `<path class="dn2mlw9xi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:transports-publics-genevois" /></template>
<style>
.dn2mlw9xi {
  fill: none;
  stroke: currentColor;
