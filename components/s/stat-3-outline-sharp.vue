...
const content = `<path class="ju2p7768e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:stat-3-outline-sharp" /></template>
<style>
.ju2p7768e {
  fill: currentColor;
