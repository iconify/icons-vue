...
const content = `<path class="q_37d_b9n"/><path class="bq53zre-s"/><path class="nrkhn6bvo"/><path class="gjt1s2bgb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-test-opened" /></template>
<style>
.bq53zre-s {
