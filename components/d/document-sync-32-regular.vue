...
const content = `<path class="p4rcgbbel"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-sync-32-regular" /></template>
<style>
.p4rcgbbel {
  fill: currentColor;
