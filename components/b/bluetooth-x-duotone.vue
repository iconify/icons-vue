...
const content = `<g class="cuyn6tgcc"><path class="f6u96mo3d"/><path class="j3--websu"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:bluetooth-x-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
