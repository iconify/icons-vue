...
const content = `<path class="cr1bpmbky"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:water-bottle-sharp" /></template>
<style>
.cr1bpmbky {
  fill: currentColor;
