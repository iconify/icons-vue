...
.j-twbtbiv {
  d: path("M14.849 15.2c-5.19-2.783-4.99-5.933-6.228-4.993c-.817.62-.677 5.384 2.397 7.906c2.051.019 3.442-1.678 3.831-2.913");
}

.opa-albas {
  d: path("M35.375 23.46c3.095 0 6.998 5.086 3.62 9.75c-1.517 2.096-3.247 3.174-5.444 3.186c-4.62.027-5.627-3.657-9.442-3.657s-4.823 3.684-9.443 3.657c-2.197-.012-3.926-1.09-5.444-3.186c-3.378-4.664.525-9.75 3.62-9.75zM15.71 26.847v5.86m2.928-2.93h-5.855");
}

.y614vuktf {
  d: path("M12.975 14.026c-.72 1.16-1.894 2.022-3.217 2.723m1.25-4.506a12 12 0 0 1-2.434 2.05m24.577.907c5.19-2.783 4.99-5.933 6.228-4.993c.817.62.677 5.384-2.397 7.906c-2.051.019-3.442-1.678-3.831-2.913");
}
