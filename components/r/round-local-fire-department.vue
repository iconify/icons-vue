...
const content = `<path class="zjyspvcdg"/><path class="ogsptyb2r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-local-fire-department" /></template>
<style>
.ogsptyb2r {
  fill: currentColor;
...
.zjyspvcdg {
  fill: currentColor;
  d: path("m12 12.9l-2.03 2c-.46.46-.82 1.03-.93 1.67C8.74 18.41 10.18 20 12 20s3.26-1.59 2.96-3.42c-.11-.64-.46-1.22-.93-1.67z");
}
