...
const content = `<path class="qkg-l24ha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clock-warning-28-regular" /></template>
<style>
.qkg-l24ha {
  fill: currentColor;
