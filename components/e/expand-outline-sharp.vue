...
const content = `<path class="gofi7tnoh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:expand-outline-sharp" /></template>
<style>
.gofi7tnoh {
  fill: currentColor;
