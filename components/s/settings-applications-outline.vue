...
const content = `<path class="ptjlzrb8n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-applications-outline" /></template>
<style>
.ptjlzrb8n {
  fill: currentColor;
