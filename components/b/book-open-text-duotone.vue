...
const content = `<g class="cuyn6tgcc"><path class="d6kzl2bws"/><path class="jjxw058tf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:book-open-text-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.d6kzl2bws {
  d: path("M232 56v144h-72a32 32 0 0 0-32 32V88a32 32 0 0 1 32-32Z");
