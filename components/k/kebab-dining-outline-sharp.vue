...
const content = `<path class="ij2-vdi3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:kebab-dining-outline-sharp" /></template>
<style>
.ij2-vdi3l {
  fill: currentColor;
