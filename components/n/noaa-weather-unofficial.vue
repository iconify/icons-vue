...
const content = `<path class="x4fy_cp9w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:noaa-weather-unofficial" /></template>
<style>
.x4fy_cp9w {
  fill: none;
  stroke: currentColor;
