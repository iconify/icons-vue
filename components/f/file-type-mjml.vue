...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-mjml" /></template>
<style>
.mz_6y8b0c {
...
.nbgejx56b {
  ...
  d: path("M4.361 13a3.322 3.322 0 1 1-1.91 4.851A3.338 3.338 0 0 1 4.361 13");
}
