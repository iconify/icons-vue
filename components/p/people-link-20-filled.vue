...
const content = `<path class="oxwx82hkl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-link-20-filled" /></template>
<style>
.oxwx82hkl {
  fill: currentColor;
