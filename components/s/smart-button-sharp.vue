...
const content = `<path class="lgsuzl05l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:smart-button-sharp" /></template>
<style>
.lgsuzl05l {
  fill: currentColor;
