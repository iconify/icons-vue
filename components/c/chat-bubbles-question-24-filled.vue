...
const content = `<path class="r-3-w-ldh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-bubbles-question-24-filled" /></template>
<style>
.r-3-w-ldh {
  fill: currentColor;
