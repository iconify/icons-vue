...
const content = `<path class="q1fx0obcr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:upgrade-outline-rounded" /></template>
<style>
.q1fx0obcr {
  fill: currentColor;
