...
const content = `<path class="p-c7fndrh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:speaker-1-28-filled" /></template>
<style>
.p-c7fndrh {
  fill: currentColor;
