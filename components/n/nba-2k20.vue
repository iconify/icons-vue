...
const content = `<path class="x7qp66b4c"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nba-2k20" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
