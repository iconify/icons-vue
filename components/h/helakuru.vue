...
const content = `<path class="q3eqo4b2g"/><path class="rudfucc0e"/><path class="kcnmyjbug"/><path class="cl_m1rbnm"/><path class="esqehqb_m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:helakuru" /></template>
<style>
.cl_m1rbnm {
  fill: none;
  stroke: currentColor;
...
.esqehqb_m {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M10.224 30.906c.274-.807 1.686-2.161 2.427.164");
}
...
.q3eqo4b2g {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M25.433 20.618a9.347 9.347 0 1 0 .413-11.095");
}
...
.rudfucc0e {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M20.71 22.68A9.346 9.346 0 0 0 15.441 5.5a9.346 9.346 0 0 0-5.816 16.517");
}
