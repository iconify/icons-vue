...
const content = `<path class="jbmv8abrr"/><path class="whawzkbwx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:eg-payment" /></template>
<style>
.jbmv8abrr {
  fill: none;
  stroke: currentColor;
