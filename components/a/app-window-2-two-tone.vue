...
const content = `<g class="nrj6p8qat"><path class="az74cdzje"/><path class="e_14kn8by"/><path class="unky6y77u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:app-window-2-two-tone" /></template>
<style>
.az74cdzje {
  fill: currentColor;
...
.e_14kn8by {
  d: path("M6 3L18 3C19.6569 3 21 4.3431 21 6L21 18C21 19.6569 19.6569 21 18 21L6 21C4.3431 21 3 19.6569 3 18L3 6C3 4.3431 4.3431 3 6 3ZM3 11L21 11");
}
