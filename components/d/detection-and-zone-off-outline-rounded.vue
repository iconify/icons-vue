...
const content = `<path class="qh7p34flh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:detection-and-zone-off-outline-rounded" /></template>
<style>
.qh7p34flh {
  fill: currentColor;
