...
const content = `<path class="djfne4b3e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cards-stack-outline" /></template>
<style>
.djfne4b3e {
  fill: currentColor;
