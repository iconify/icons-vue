...
const content = `<path class="i18o8zbkh"/><path class="trb4t1bkh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mzabaps" /></template>
<style>
.i18o8zbkh {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M27.626 31.396c0-5.001-18.806-5.001-18.806-5.001V43.5h18.806z");
}
