...
const content = `<path class="fqp63x94z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:blender-sharp" /></template>
<style>
.fqp63x94z {
  fill: currentColor;
