...
const content = `<path class="gu_v1mbmq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-disabled-visible" /></template>
<style>
.gu_v1mbmq {
  fill: currentColor;
