...
const content = `<path class="wfkgu3o2d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:target-add-20-filled" /></template>
<style>
.wfkgu3o2d {
  fill: currentColor;
