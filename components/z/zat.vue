...
const content = `<g class="ft5dv1b6b"><path class="gs-w_pi-l"/><path class="usvffmmwf"/><path class="iny1p0f4g"/><path class="z3uw5ubsb"/><path class="f4yp3qrlp"/><path class="c6n-j-bxp"/><path class="u34zgc3xu"/><path class="d8yirm7xt"/><path class="eb0nw_gqh"/><path class="judj5ubyt"/><path class="ty0wxbbal"/><path class="s967kxbpg"/><path class="lh0hpr9so"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:zat" /></template>
<style>
.c6n-j-bxp {
  fill: var(--svg-color--000, #000);
  d: path("M16.765 9.209v.476h-9.53V9.21z");
}

.d8yirm7xt {
  fill: var(--svg-color--000, #000);
  d: path("M7.236 10.126h9.529v.556h-9.53z");
}

.eb0nw_gqh {
  fill: var(--svg-color--b9ff01, #b9ff01);
  d: path("M7.236 10.682h9.529v.434h-9.53z");
}

.f4yp3qrlp {
  fill: var(--svg-color--b9ff01, #b9ff01);
  d: path("M7.68 8.749c.033.021.054.032.075.032h8.56l.027-.006l.02-.015c.017 0 .027 0 .038.01l.339.37c.026.027.031.054.016.07H7.268c-.01 0-.01 0-.01-.011z");
}
