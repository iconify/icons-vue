...
const content = `<g class="nrj6p8qat"><path class="y5rhuefdb"/><path class="in_inbcvv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:ship-two-tone" /></template>
<style>
.in_inbcvv {
  d: path("M7 11.3L7 7C7 5.8954 7.8954 5 9 5L15 5C16.1046 5 17 5.8954 17 7L17 11.3M12 5L12 3M7.2083 20.6226L6.5521 20C4.6068 18.1541 3.6017 15.268 4.1928 12.6255C6.6256 11.3464 9.2068 10.1362 12 10C14.7932 10.1362 17.3744 11.3464 19.8072 12.6255C20.3892 15.2745 19.3973 18.1502 17.4479 20L17.2447 20.1928M2 20.3479C4.3679 21.6637 7.179 20.7413 9.5 19.8407C11.671 18.7159 14.2704 18.7635 16.4239 19.8595C18.1685 20.6303 20.0809 21.0813 22 20.8551M12 14L12 15");
}
