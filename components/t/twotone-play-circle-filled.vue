...
const content = `<path class="fpzdv3b-x"/><path class="cageyqbjd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-play-circle-filled" /></template>
<style>
.cageyqbjd {
  fill: currentColor;
