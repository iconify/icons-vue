...
const content = `<path class="cn7k2smap"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fdj" /></template>
<style>
.cn7k2smap {
  fill: none;
  stroke: currentColor;
