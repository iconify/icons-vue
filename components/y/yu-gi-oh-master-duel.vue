...
const content = `<path class="ftxya8byf"/><path class="ug6n0ub9x"/><path class="r59gl9bcl"/><circle class="cpk0fnbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:yu-gi-oh-master-duel" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
...
.ug6n0ub9x {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M39.04 8.65c-1.01.48-1.93 1.1-2.58 1.9c0 .01-.01.02-.02.03M9.824 27.413c2.332-1.41 10.252-1.36 13.598-.57c.303 3.498-6.356 10.494-9.265 11.923");
}
