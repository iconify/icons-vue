...
const content = `<path class="xq3ejbbbb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-vb-16-filled" /></template>
<style>
.xq3ejbbbb {
  fill: currentColor;
