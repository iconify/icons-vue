...
const content = `<path class="c8o6skb5t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-fan-low-left-outline-sharp" /></template>
<style>
.c8o6skb5t {
  fill: currentColor;
