...
const content = `<path class="v7_e_zo3g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:hourglass-three-quarter-24-regular" /></template>
<style>
.v7_e_zo3g {
  fill: currentColor;
