...
const content = `<path class="wp_3f22dz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:notepad-person-off-28-filled" /></template>
<style>
.wp_3f22dz {
  fill: currentColor;
