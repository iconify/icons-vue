...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGSCV9nbqF)" class="lto8ccb2c"/><path fill="url(#SVGaJi2Ebvd)" class="cjvgi2mxq"/><defs><linearGradient id="SVGSCV9nbqF" x1="16.237" x2="8.037" y1="7.846" y2="19.188" gradientUnits="userSpaceOnUse"><stop class="apk7g2z9o"/><stop offset="1" class="x4sfqjn1x"/></linearGradient><linearGradient id="SVGaJi2Ebvd" x1="16.237" x2="8.037" y1="7.847" y2="19.188" gradientUnits="userSpaceOnUse"><stop class="apk7g2z9o"/><stop offset="1" class="x4sfqjn1x"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:tig" /></template>
<style>
.apk7g2z9o {
...
.lto8ccb2c {
  d: path("M11.446 11.434h-.01v-.01c1.408-2.468 2.806-4.94 4.225-7.402a.6.6 0 0 0 .053-.127l-.276-.021L16.566 3l-.106 1.403l-.238-.217a138 138 0 0 1-4.776 7.253zm3.405-6.47c-.196.254-.43.302-.72.18a7.42 7.42 0 0 0-4.702-.386a9.6 9.6 0 0 0-1.641.566q-.318.144-.699.223c-.095.02-.206.053-.302.058c.8 1.562 1.642 3.118 2.383 4.712c-.937-1.684-1.906-3.346-2.864-5.014c-.016-.021.015-.032.031-.021a.8.8 0 0 0 .445.08a3 3 0 0 0 .514-.096a5 5 0 0 0 .788-.275a9.5 9.5 0 0 1 2.563-.773q.96-.127 1.62-.08c.895.07 1.79.408 2.584.826");
}
