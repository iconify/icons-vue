...
const content = `<path class="f4126e5gz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:remove-from-queue" /></template>
<style>
.f4126e5gz {
  fill: currentColor;
