...
const content = `<path class="f-r3czx1t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:select-window-outline-rounded" /></template>
<style>
.f-r3czx1t {
  fill: currentColor;
