...
const content = `<path class="lipjsib7r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:data-info-alert-outline" /></template>
<style>
.lipjsib7r {
  fill: currentColor;
