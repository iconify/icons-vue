...
const content = `<path class="lfx3cbbpw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:score" /></template>
<style>
.lfx3cbbpw {
  fill: currentColor;
