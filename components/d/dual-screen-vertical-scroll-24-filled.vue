...
const content = `<path class="v-xukjbnh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dual-screen-vertical-scroll-24-filled" /></template>
<style>
.v-xukjbnh {
  fill: currentColor;
