...
const content = `<path class="lhsqjr08z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pergola-rounded" /></template>
<style>
.lhsqjr08z {
  fill: currentColor;
