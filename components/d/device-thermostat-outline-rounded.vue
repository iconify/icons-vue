...
const content = `<path class="c1_j2hala"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:device-thermostat-outline-rounded" /></template>
<style>
.c1_j2hala {
  fill: currentColor;
