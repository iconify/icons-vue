...
const content = `<path class="lwpbufz4s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:task-list-square-ltr-20-regular" /></template>
<style>
.lwpbufz4s {
  fill: currentColor;
