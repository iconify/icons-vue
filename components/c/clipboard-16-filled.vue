...
const content = `<path class="i116fsfby"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-16-filled" /></template>
<style>
.i116fsfby {
  fill: currentColor;
