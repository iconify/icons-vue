...
const content = `<path class="ihn1lmbmv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-column-one-wide-20-filled" /></template>
<style>
.ihn1lmbmv {
  fill: currentColor;
