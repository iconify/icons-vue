...
const content = `<path class="nqa-9soic"/><path class="gp0o37bde"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-query-builder" /></template>
<style>
.gp0o37bde {
  fill: currentColor;
