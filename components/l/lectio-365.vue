...
const content = `<path class="ty11r03br"/><path class="jvz7jqb7x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lectio-365" /></template>
<style>
.jvz7jqb7x {
  fill: none;
  stroke: currentColor;
