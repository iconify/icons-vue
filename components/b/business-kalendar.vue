...
const content = `<path class="i9clfwm2k"/><path class="i_8k4qwhd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:business-kalendar" /></template>
<style>
.i_8k4qwhd {
  fill: none;
  stroke: currentColor;
