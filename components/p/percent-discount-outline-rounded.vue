...
const content = `<path class="i4xbljbip"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:percent-discount-outline-rounded" /></template>
<style>
.i4xbljbip {
  fill: currentColor;
