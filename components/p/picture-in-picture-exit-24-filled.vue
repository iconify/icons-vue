...
const content = `<path class="j71ca_bri"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:picture-in-picture-exit-24-filled" /></template>
<style>
.j71ca_bri {
  fill: currentColor;
