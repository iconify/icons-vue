...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-half-fill" /></template>
<style>
.bqwgv6iro {
  d: path("M12 6C15.3138 6 18 8.6862 18 12C18 15.3138 15.3138 18 12 18Z");
}
