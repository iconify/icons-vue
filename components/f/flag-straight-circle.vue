...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="puz9tcwyf"/><path class="vomx7qbtd"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:flag-straight-circle" /></template>
<style>
.hdxpysbbn {
