...
const content = `<path class="q04a6rbeo"/><path class="f3mhcexpn"/><path class="hlv7oibbb"/><circle class="nmya-1jcl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-niger" /></template>
<style>
.f3mhcexpn {
