...
const content = `<g class="nrj6p8qat"><path class="iwoy52b7h"/><path class="um6qav7po"/><path class="xbz5-ab-d"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:catalog-outline-regular" /></template>
<style>
.iwoy52b7h {
