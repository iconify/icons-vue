...
const content = `<path class="qv483kb7i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-meeting-room-outline-rounded" /></template>
<style>
.qv483kb7i {
  fill: currentColor;
