...
const content = `<path class="ou9x6sbxt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-cell-four-focus-bottom-right-24-filled" /></template>
<style>
.ou9x6sbxt {
  fill: currentColor;
