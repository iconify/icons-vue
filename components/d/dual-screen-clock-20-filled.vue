...
const content = `<path class="kmz0o6bwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dual-screen-clock-20-filled" /></template>
<style>
.kmz0o6bwk {
  fill: currentColor;
