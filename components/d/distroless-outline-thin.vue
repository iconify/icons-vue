...
const content = `<g class="hntgybcog"><path class="v1-fmxxhj"/><path class="h1cr44bva"/><path class="epou1mbuy"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:distroless-outline-thin" /></template>
<style>
.epou1mbuy {
