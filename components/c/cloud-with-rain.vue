...
const content = `<path class="qsj6u-9jb"/><path class="r3bm41bef"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:cloud-with-rain" /></template>
<style>
.qsj6u-9jb {
