...
const content = `<path class="wm66390nz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:lightstrip-rounded" /></template>
<style>
.wm66390nz {
  fill: currentColor;
