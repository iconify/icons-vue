...
const content = `<path class="dbm-o4l9p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-1-bar-outline-rounded" /></template>
<style>
.dbm-o4l9p {
  fill: currentColor;
