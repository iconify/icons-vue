...
const content = `<path class="ep0v_7niz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:hourglass-arrow-down-outline-rounded" /></template>
<style>
.ep0v_7niz {
  fill: currentColor;
