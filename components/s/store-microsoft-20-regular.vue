...
const content = `<path class="ypbfovsxb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:store-microsoft-20-regular" /></template>
<style>
.ypbfovsxb {
  fill: currentColor;
