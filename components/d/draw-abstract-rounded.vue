...
const content = `<path class="ne65o6d3a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:draw-abstract-rounded" /></template>
<style>
.ne65o6d3a {
  fill: currentColor;
