...
const content = `<path class="evr51rbmt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bang-dream" /></template>
<style>
.evr51rbmt {
  fill: none;
  stroke: currentColor;
