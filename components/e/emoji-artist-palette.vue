...
const content = `<path class="b5oj_sbbb"/><path class="dim_yrb1a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-artist-palette" /></template>
<style>
.b5oj_sbbb {
  fill: none;
  stroke: currentColor;
