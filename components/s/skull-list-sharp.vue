...
const content = `<path class="msdci2b8c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:skull-list-sharp" /></template>
<style>
.msdci2b8c {
  fill: currentColor;
