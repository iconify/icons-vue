...
const content = `<path class="ln_0r11hu"/><defs><path id="SVG86R5pb3p" class="geq8-zbit"/></defs><clipPath id="SVGfTZPDcEH"><use href="#SVG86R5pb3p"/></clipPath><g clip-path="url(#SVGfTZPDcEH)" class="t_nvrsbrc"><path class="eqj3-etxh"/><path class="x9voxho-p"/></g><defs><use href="#SVG86R5pb3p" id="SVGKYHuyear"/></defs><clipPath id="SVGWf5bocKn"><use href="#SVGKYHuyear"/></clipPath><g clip-path="url(#SVGWf5bocKn)"><path class="v4f5wlz2e"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:love-you-gesture-dark-skin-tone" /></template>
<style>
.eqj3-etxh {
