...
const content = `<path class="utqnriaws"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:loupe" /></template>
<style>
.utqnriaws {
  fill: currentColor;
