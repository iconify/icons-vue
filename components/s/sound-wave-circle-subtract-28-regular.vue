...
const content = `<path class="katdjgbhl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:sound-wave-circle-subtract-28-regular" /></template>
<style>
.katdjgbhl {
  fill: currentColor;
