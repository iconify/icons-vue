...
const content = `<path class="hngdhbb9y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:calendar-view-week-rounded" /></template>
<style>
.hngdhbb9y {
  fill: currentColor;
