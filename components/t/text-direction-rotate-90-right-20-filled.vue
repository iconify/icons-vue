...
const content = `<path class="m9yzvacwi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-rotate-90-right-20-filled" /></template>
<style>
.m9yzvacwi {
  fill: currentColor;
