...
const content = `<path class="jvavi9b2e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:contract-outline" /></template>
<style>
.jvavi9b2e {
  fill: currentColor;
