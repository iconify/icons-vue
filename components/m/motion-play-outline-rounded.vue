...
const content = `<path class="b2xexub-c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:motion-play-outline-rounded" /></template>
<style>
.b2xexub-c {
  fill: currentColor;
