...
const content = `<path class="vbtn2m8nh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:alert-urgent-24-regular" /></template>
<style>
.vbtn2m8nh {
  fill: currentColor;
