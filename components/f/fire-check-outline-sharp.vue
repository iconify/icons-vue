...
const content = `<path class="h2l05qklm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fire-check-outline-sharp" /></template>
<style>
.h2l05qklm {
  fill: currentColor;
