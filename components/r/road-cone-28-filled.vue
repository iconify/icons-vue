...
const content = `<path class="f9-oi_b-s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:road-cone-28-filled" /></template>
<style>
.f9-oi_b-s {
  fill: currentColor;
