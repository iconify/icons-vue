...
const content = `<path class="zh4lqnvww"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:king-bed-outline" /></template>
<style>
.zh4lqnvww {
  fill: currentColor;
