...
const content = `<path class="dg7xilbnm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nature-rounded" /></template>
<style>
.dg7xilbnm {
  fill: currentColor;
