...
const content = `<path class="md9rpq6zp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-js-16-filled" /></template>
<style>
.md9rpq6zp {
  fill: currentColor;
