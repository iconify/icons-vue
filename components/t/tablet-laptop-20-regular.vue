...
const content = `<path class="jiwg1acgc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tablet-laptop-20-regular" /></template>
<style>
.jiwg1acgc {
  fill: currentColor;
