...
const content = `<path class="zkz0sdzve"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:video-label-outline-rounded" /></template>
<style>
.zkz0sdzve {
  fill: currentColor;
