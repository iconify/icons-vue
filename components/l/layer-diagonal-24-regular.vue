...
const content = `<path class="mcpt4hq7o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layer-diagonal-24-regular" /></template>
<style>
.mcpt4hq7o {
  fill: currentColor;
