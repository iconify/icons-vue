...
const content = `<path class="gjp2i2bpl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:money-off-24-filled" /></template>
<style>
.gjp2i2bpl {
  fill: currentColor;
