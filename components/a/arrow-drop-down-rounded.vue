...
const content = `<path class="qi9b2kjdk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-drop-down-rounded" /></template>
<style>
.qi9b2kjdk {
  fill: currentColor;
