...
const content = `<path class="janw3eb6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-restore-from-trash" /></template>
<style>
.janw3eb6u {
  fill: currentColor;
