...
const content = `<g class="al7hx3ugy"><path class="gguiawz5w"/><path class="ldc49pb-r"/></g><g class="hq2-vcghy"><path class="bui_xxb-c"/><path class="lf8w4db0m"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:linked-paperclips" /></template>
<style>
.al7hx3ugy {
