...
const content = `<path class="se30-fnlv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:contact-card-generic-28-regular" /></template>
<style>
.se30-fnlv {
  fill: currentColor;
