...
const content = `<path class="kr4qsmtbz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:highlight-rounded" /></template>
<style>
.kr4qsmtbz {
  fill: currentColor;
