...
const content = `<path class="fmd58fbrq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:tatami-seat-sharp" /></template>
<style>
.fmd58fbrq {
  fill: currentColor;
