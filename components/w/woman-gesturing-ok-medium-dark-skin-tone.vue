...
const content = `<path class="vctw93b8d"/><path class="v8qc18bax"/><path class="r_-817b0h"/><path class="apd4j2b9j"/><path class="el51r6xpk"/><path class="egv546b5j"/><path class="xo55s0bne"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:woman-gesturing-ok-medium-dark-skin-tone" /></template>
<style>
.apd4j2b9j {
