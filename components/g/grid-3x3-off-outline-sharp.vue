...
const content = `<path class="taaiy_04e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:grid-3x3-off-outline-sharp" /></template>
<style>
.taaiy_04e {
  fill: currentColor;
