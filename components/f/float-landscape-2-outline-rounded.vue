...
const content = `<path class="ydgjn1mdg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:float-landscape-2-outline-rounded" /></template>
<style>
.ydgjn1mdg {
  fill: currentColor;
