...
const content = `<path class="w5h556bfb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:move-down-outline-sharp" /></template>
<style>
.w5h556bfb {
  fill: currentColor;
