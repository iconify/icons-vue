...
const content = `<path class="jnvin79qk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-multiple-48-regular" /></template>
<style>
.jnvin79qk {
  fill: currentColor;
