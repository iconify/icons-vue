...
const content = `<path class="h0qgeuwow"/><path class="equ05wbbo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:amaze" /></template>
<style>
.equ05wbbo {
  fill: none;
  stroke: currentColor;
