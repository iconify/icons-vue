...
const content = `<g class="cuyn6tgcc"><path class="cw5fhcbxr"/><path class="v7g2mvbjv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:repeat-once-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.cw5fhcbxr {
  d: path("M224 64v64a64 64 0 0 1-64 64H32v-64a64 64 0 0 1 64-64Z");
