...
const content = `<path class="wuoliqbfv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:signal-cellular-nodata-outline-sharp" /></template>
<style>
.wuoliqbfv {
  fill: currentColor;
