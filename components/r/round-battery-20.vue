...
const content = `<path class="x6kb9db8s"/><path class="pkzn_jbre"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-battery-20" /></template>
<style>
.pkzn_jbre {
  fill: currentColor;
