...
const content = `<path class="zajp45bya"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:weather-moon-24-regular" /></template>
<style>
.zajp45bya {
  fill: currentColor;
