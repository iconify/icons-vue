...
const content = `<path class="aippnozkq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-row-insert-24-filled" /></template>
<style>
.aippnozkq {
  fill: currentColor;
