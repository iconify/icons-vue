...
const content = `<path class="jdwps0wwt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lloydsdirect" /></template>
<style>
.jdwps0wwt {
  fill: none;
  stroke: currentColor;
