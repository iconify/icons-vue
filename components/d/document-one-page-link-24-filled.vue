...
const content = `<path class="ba1mpwhsc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-one-page-link-24-filled" /></template>
<style>
.ba1mpwhsc {
  fill: currentColor;
