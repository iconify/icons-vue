...
const content = `<path class="r0-tky2bu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:movie-edit-off-outline-rounded" /></template>
<style>
.r0-tky2bu {
  fill: currentColor;
