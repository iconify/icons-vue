...
const content = `<path class="debh1l0tb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:filmstrip-24-regular" /></template>
<style>
.debh1l0tb {
  fill: currentColor;
