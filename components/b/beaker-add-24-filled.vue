...
const content = `<path class="r408ym1ri"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:beaker-add-24-filled" /></template>
<style>
.r408ym1ri {
  fill: currentColor;
