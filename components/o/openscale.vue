...
const content = `<path class="exrb7cb5q"/><path class="ll0g54h-q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:openscale" /></template>
<style>
.exrb7cb5q {
  fill: none;
  stroke: currentColor;
