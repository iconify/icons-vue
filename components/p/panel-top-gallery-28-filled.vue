...
const content = `<path class="n3a2rbbgn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-top-gallery-28-filled" /></template>
<style>
.n3a2rbbgn {
  fill: currentColor;
