...
const content = `<path class="nnn9axb5p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:co2-rounded" /></template>
<style>
.nnn9axb5p {
  fill: currentColor;
