...
const content = `<path class="zy35fymcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:store-rounded" /></template>
<style>
.zy35fymcs {
  fill: currentColor;
