...
const content = `<path class="ccaiueber"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:align-center-horizontal-simple-light" /></template>
<style>
.ccaiueber {
  fill: currentColor;
