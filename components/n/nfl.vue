...
const content = `<path class="po0lrc9xj"/><path class="aofw4sbmi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nfl" /></template>
<style>
.aofw4sbmi {
  fill: none;
  stroke: currentColor;
