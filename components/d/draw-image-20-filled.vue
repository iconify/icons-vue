...
const content = `<path class="hdayqjbvb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:draw-image-20-filled" /></template>
<style>
.hdayqjbvb {
  fill: currentColor;
