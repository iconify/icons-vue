...
const content = `<path class="e_c0c040g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cell-center-20-filled" /></template>
<style>
.e_c0c040g {
  fill: currentColor;
