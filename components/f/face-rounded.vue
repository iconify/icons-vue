...
const content = `<path class="zsl6q3all"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:face-rounded" /></template>
<style>
.zsl6q3all {
  fill: currentColor;
