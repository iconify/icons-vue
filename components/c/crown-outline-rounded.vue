...
const content = `<path class="fn_2yik8q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:crown-outline-rounded" /></template>
<style>
.fn_2yik8q {
  fill: currentColor;
