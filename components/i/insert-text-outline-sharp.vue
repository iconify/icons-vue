...
const content = `<path class="h6_3desfp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:insert-text-outline-sharp" /></template>
<style>
.h6_3desfp {
  fill: currentColor;
