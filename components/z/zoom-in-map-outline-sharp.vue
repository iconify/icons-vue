...
const content = `<path class="gfk5zynne"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:zoom-in-map-outline-sharp" /></template>
<style>
.gfk5zynne {
  fill: currentColor;
