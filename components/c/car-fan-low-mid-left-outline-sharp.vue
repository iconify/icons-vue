...
const content = `<path class="drf5y445q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-fan-low-mid-left-outline-sharp" /></template>
<style>
.drf5y445q {
  fill: currentColor;
