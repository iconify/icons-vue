...
const content = `<path class="ob738qbex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:print-lock-outline-rounded" /></template>
<style>
.ob738qbex {
  fill: currentColor;
