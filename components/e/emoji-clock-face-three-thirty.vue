...
const content = `<path class="aytg5eait"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-clock-face-three-thirty" /></template>
<style>
.aytg5eait {
  fill: none;
  stroke: currentColor;
