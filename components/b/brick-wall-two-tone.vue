...
const content = `<g class="nrj6p8qat"><path class="az74cdzje"/><path class="u8-b2zk1e"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:brick-wall-two-tone" /></template>
<style>
.az74cdzje {
  fill: currentColor;
