...
const content = `<path class="l8ca9k62v"/><path class="plxse3xvl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:videotranscoder" /></template>
<style>
.l8ca9k62v {
  fill: none;
  stroke: currentColor;
...
.plxse3xvl {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M26.69 33.45H40.2a3.3 3.3 0 0 0 3.3-3.3V5.38h-7.14l3.94 5.74h-4.91l-3.94-5.74H27.5l3.95 5.74h-4.91l-3.95-5.74h-3.94l3.94 5.74h-4.91l-3.94-5.74H11.5a3.3 3.3 0 0 0-3.3 3.3V22.8");
}
