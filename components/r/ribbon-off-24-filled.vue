...
const content = `<path class="kshw0spne"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:ribbon-off-24-filled" /></template>
<style>
.kshw0spne {
  fill: currentColor;
