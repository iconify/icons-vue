...
const content = `<path class="u3ltsq4ke"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wrist-outline" /></template>
<style>
.u3ltsq4ke {
  fill: currentColor;
