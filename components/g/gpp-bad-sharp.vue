...
const content = `<path class="aly_b9buk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:gpp-bad-sharp" /></template>
<style>
.aly_b9buk {
  fill: currentColor;
