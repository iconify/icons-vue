...
const content = `<path class="g1--tjb4a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mobile-sensor-lo-outline" /></template>
<style>
.g1--tjb4a {
  fill: currentColor;
