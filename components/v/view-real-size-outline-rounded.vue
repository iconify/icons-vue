...
const content = `<path class="u8dxnqvdp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:view-real-size-outline-rounded" /></template>
<style>
.u8dxnqvdp {
  fill: currentColor;
