...
const content = `<path class="o-xhgab2z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrows-out-line-horizontal" /></template>
<style>
.o-xhgab2z {
  fill: currentColor;
