...
const content = `<path class="j5dhkgyym"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:batch-prediction-outline-rounded" /></template>
<style>
.j5dhkgyym {
  fill: currentColor;
