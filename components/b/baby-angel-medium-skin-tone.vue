...
const content = `<path class="fddt2ibnu"/><circle class="e4woe9m3f"/><path class="la6s_db0g"/><path class="ym2drbm2a"/><path class="wxadi7kjp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:baby-angel-medium-skin-tone" /></template>
<style>
.e4woe9m3f {
  cx: 18px;
  cy: 21px;
