...
const content = `<path class="t_0cvibso"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:rubric-outline" /></template>
<style>
.t_0cvibso {
  fill: currentColor;
