...
const content = `<path class="jawti_bhv"/><circle class="vi_nxfq0r"/><path class="fwub5xy9i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:firefox-lite" /></template>
<style>
.fwub5xy9i {
  fill: none;
  stroke: currentColor;
