...
const content = `<path class="iu8wnrbla"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sentiment-neutral-outline-sharp" /></template>
<style>
.iu8wnrbla {
  fill: currentColor;
