...
const content = `<path class="jxslwqbmc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-full-24-filled" /></template>
<style>
.jxslwqbmc {
  fill: currentColor;
