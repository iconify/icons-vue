...
const content = `<path class="jc4f95bww"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:h-mobiledata-badge" /></template>
<style>
.jc4f95bww {
  fill: currentColor;
