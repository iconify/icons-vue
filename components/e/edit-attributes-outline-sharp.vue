...
const content = `<path class="bl2281e-f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-attributes-outline-sharp" /></template>
<style>
.bl2281e-f {
  fill: currentColor;
