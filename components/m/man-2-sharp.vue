...
const content = `<path class="tr1hnt8oi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:man-2-sharp" /></template>
<style>
.tr1hnt8oi {
  fill: currentColor;
