...
const content = `<path class="rku5lwbdh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-circle-up-down-light" /></template>
<style>
.rku5lwbdh {
  fill: currentColor;
