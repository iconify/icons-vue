...
const content = `<path class="yiu4x-piq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fan-indirect-outline" /></template>
<style>
.yiu4x-piq {
  fill: currentColor;
