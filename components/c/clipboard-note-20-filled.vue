...
const content = `<path class="ty6agyq3q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-note-20-filled" /></template>
<style>
.ty6agyq3q {
  fill: currentColor;
