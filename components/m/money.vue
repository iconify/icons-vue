...
const content = `<path class="p6oj6vztu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:money" /></template>
<style>
.p6oj6vztu {
  fill: currentColor;
