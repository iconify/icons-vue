...
const content = `<path class="jvyhnlb1z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cells-merge-32-light" /></template>
<style>
.jvyhnlb1z {
  fill: currentColor;
