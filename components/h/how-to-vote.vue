...
const content = `<path class="uh6zkacrf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:how-to-vote" /></template>
<style>
.uh6zkacrf {
  fill: currentColor;
