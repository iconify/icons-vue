...
const content = `<path class="uujgg1bcb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:spatula-spoon-16-filled" /></template>
<style>
.uujgg1bcb {
  fill: currentColor;
