...
const content = `<path class="jjotvj33a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:reset-focus-outline-sharp" /></template>
<style>
.jjotvj33a {
  fill: currentColor;
