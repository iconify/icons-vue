...
const content = `<path class="ir2569b-v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:animal-turtle-16-regular" /></template>
<style>
.ir2569b-v {
  fill: currentColor;
