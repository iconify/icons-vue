...
const content = `<path class="lsu9ekahy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sdk-rounded" /></template>
<style>
.lsu9ekahy {
  fill: currentColor;
