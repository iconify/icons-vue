...
const content = `<path class="v53ladkvd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fire-truck" /></template>
<style>
.v53ladkvd {
  fill: currentColor;
