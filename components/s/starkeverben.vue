...
const content = `<path class="up0kmac_v"/><path class="q9upa7bsb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:starkeverben" /></template>
<style>
.q9upa7bsb {
  fill: none;
  stroke: currentColor;
