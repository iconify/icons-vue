...
const content = `<g class="cuyn6tgcc"><path class="okuvmnb_u"/><path class="hi78wybki"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:paper-plane-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
