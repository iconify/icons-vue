...
const content = `<path class="rzqxpqbkf"/><path class="oxy-n1e2y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-square-foot" /></template>
<style>
.oxy-n1e2y {
  fill: currentColor;
