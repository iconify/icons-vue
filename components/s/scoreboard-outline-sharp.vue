...
const content = `<path class="a90v0ccas"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:scoreboard-outline-sharp" /></template>
<style>
.a90v0ccas {
  fill: currentColor;
