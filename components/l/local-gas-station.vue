...
const content = `<path class="exky279uq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-gas-station" /></template>
<style>
.exky279uq {
  fill: currentColor;
