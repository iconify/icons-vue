...
const content = `<path class="g92rv8l8w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:encrypted-add-circle-sharp" /></template>
<style>
.g92rv8l8w {
  fill: currentColor;
