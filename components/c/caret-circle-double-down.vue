...
const content = `<path class="ej0tvcbrd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-circle-double-down" /></template>
<style>
.ej0tvcbrd {
  fill: currentColor;
