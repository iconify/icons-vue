...
const content = `<path class="pezs0kumg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-cellular-connected-no-internet-0-bar-outline-rounded" /></template>
<style>
.pezs0kumg {
  fill: currentColor;
