...
const content = `<path class="xafd0oh_i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bento-outline-rounded" /></template>
<style>
.xafd0oh_i {
  fill: currentColor;
