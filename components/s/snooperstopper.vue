...
const content = `<path class="nx2gu620b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:snooperstopper" /></template>
<style>
.nx2gu620b {
  fill: none;
  stroke: currentColor;
