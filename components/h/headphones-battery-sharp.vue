...
const content = `<path class="a7azckbbx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:headphones-battery-sharp" /></template>
<style>
.a7azckbbx {
  fill: currentColor;
