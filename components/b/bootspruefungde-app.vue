...
const content = `<path class="qygvlbbdv"/><path class="a4a6awbcr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:bootspruefungde-app" /></template>
<style>
.a4a6awbcr {
  fill: none;
  stroke: currentColor;
