...
const content = `<path class="xc2r_775n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:align-justify-flex-end-outline-rounded" /></template>
<style>
.xc2r_775n {
  fill: currentColor;
