...
const content = `<path class="g6zr1cb2u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:carpenter-rounded" /></template>
<style>
.g6zr1cb2u {
  fill: currentColor;
