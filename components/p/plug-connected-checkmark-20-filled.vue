...
const content = `<path class="brot-5f1j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:plug-connected-checkmark-20-filled" /></template>
<style>
.brot-5f1j {
  fill: currentColor;
