...
const content = `<path class="it88_1bqy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mystery-outline-sharp" /></template>
<style>
.it88_1bqy {
  fill: currentColor;
