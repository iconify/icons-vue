...
const content = `<path class="xzn5lgm8r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:garden-cart-rounded" /></template>
<style>
.xzn5lgm8r {
  fill: currentColor;
