...
const content = `<path class="xpswh93iz"/><path class="gkftbqpgw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:airgap-wallet" /></template>
<style>
.gkftbqpgw {
  fill: none;
  stroke: currentColor;
