...
const content = `<path class="hsgzvcn0n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nearby-error-sharp" /></template>
<style>
.hsgzvcn0n {
  fill: currentColor;
