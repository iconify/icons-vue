...
const content = `<path class="q9sr4xbrl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:chromecast-2-outline-rounded" /></template>
<style>
.q9sr4xbrl {
  fill: currentColor;
