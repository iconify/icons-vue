...
const content = `<path class="rmoswmjoa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-person-24-filled" /></template>
<style>
.rmoswmjoa {
  fill: currentColor;
