...
const content = `<path class="c5essefef"/><circle class="mp627f0sa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:asn-bankieren-beta" /></template>
<style>
.c5essefef {
  fill: none;
  stroke: currentColor;
