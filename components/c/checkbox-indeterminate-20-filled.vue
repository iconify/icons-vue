...
const content = `<path class="y5sf7snru"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:checkbox-indeterminate-20-filled" /></template>
<style>
.y5sf7snru {
  fill: currentColor;
