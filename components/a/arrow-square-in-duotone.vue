...
const content = `<g class="cuyn6tgcc"><path class="hqszybbyz"/><path class="via_6_sjn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-square-in-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
