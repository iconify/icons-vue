...
const content = `<path class="z67rtf9lh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-arrow-left-24-regular" /></template>
<style>
.z67rtf9lh {
  fill: currentColor;
