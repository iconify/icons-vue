...
const content = `<path class="q1f5z6bic"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-arrow-repeat-all-48-regular" /></template>
<style>
.q1f5z6bic {
  fill: currentColor;
