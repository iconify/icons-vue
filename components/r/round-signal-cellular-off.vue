...
const content = `<path class="xhfkwtbla"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-signal-cellular-off" /></template>
<style>
.xhfkwtbla {
  fill: currentColor;
