...
const content = `<path class="wzbpjvb4z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-minimize-24-regular" /></template>
<style>
.wzbpjvb4z {
  fill: currentColor;
