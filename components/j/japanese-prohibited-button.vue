...
const content = `<path class="hd6t3iykl"/><path class="q7xo1jsfh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:japanese-prohibited-button" /></template>
<style>
.hd6t3iykl {
