...
const content = `<path class="twzs8mbpp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:crisis-alert-outline-sharp" /></template>
<style>
.twzs8mbpp {
  fill: currentColor;
