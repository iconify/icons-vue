...
const content = `<path class="h0qgeuwow"/><path class="dibexcbmm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:folder-pound" /></template>
<style>
.dibexcbmm {
  fill: none;
  stroke: currentColor;
