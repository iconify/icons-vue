...
const content = `<path class="o-iqvqb3l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:theaters-outline" /></template>
<style>
.o-iqvqb3l {
  fill: currentColor;
