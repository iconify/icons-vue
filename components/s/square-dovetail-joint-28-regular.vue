...
const content = `<path class="budo-wxad"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:square-dovetail-joint-28-regular" /></template>
<style>
.budo-wxad {
  fill: currentColor;
