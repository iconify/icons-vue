...
const content = `<rect class="ii8siykrv"/><path class="sn490xb4w"/><path class="nu2ug1b5t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kanji-study" /></template>
<style>
.ii8siykrv {
  width: 19.593px;
  height: 28.186px;
...
.sn490xb4w {
  ...
  stroke: currentColor;
  stroke-linejoin: round;
  d: path("M30.288 7.417c-.164 0-.327.034-.478.098l-15.78 6.704a1.225 1.225 0 0 0-.649 1.606l.001.002l10.047 23.689c.142.331.423.583.768.687a1.22 1.22 0 0 1-.289-.785V13.683a1.22 1.22 0 0 1 1.218-1.226h8.112l-1.82-4.292a1.22 1.22 0 0 0-1.129-.749z");
}
