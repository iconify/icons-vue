...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="ykjo09jtf"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:grid-circle" /></template>
<style>
.hdxpysbbn {
