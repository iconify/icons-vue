...
const content = `<path class="kao55pbou"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:groups-sharp" /></template>
<style>
.kao55pbou {
  fill: currentColor;
