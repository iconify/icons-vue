...
const content = `<path class="k3lotcb6g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:globe-location-pin-outline" /></template>
<style>
.k3lotcb6g {
  fill: currentColor;
