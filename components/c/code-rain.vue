...
const content = `<rect class="j3s9ivbxi"/><path class="owp2agblx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:code-rain" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
