...
const content = `<path class="dtgaxbbtm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-stack-right-28-regular" /></template>
<style>
.dtgaxbbtm {
  fill: currentColor;
