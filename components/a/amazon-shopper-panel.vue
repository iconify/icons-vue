...
const content = `<circle class="cpk0fnbgt"/><path class="mem18ybbx"/><path class="ss-bq-p5d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:amazon-shopper-panel" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
