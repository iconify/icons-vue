...
const content = `<path class="uzefm-bcr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-off-outline" /></template>
<style>
.uzefm-bcr {
  fill: currentColor;
