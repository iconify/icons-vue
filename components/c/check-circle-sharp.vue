...
const content = `<path class="xxap4iiei"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:check-circle-sharp" /></template>
<style>
.xxap4iiei {
  fill: currentColor;
