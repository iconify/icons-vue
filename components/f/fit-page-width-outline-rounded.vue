...
const content = `<path class="svqvne-bj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fit-page-width-outline-rounded" /></template>
<style>
.svqvne-bj {
  fill: currentColor;
