...
const content = `<path class="pv85g197r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:projection-screen-24-filled" /></template>
<style>
.pv85g197r {
  fill: currentColor;
