...
const content = `<path class="t3j01575b"/><path class="s7t1ugb9p"/><circle class="skoo02blj"/><path class="sv1fygbtq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:findmydevice" /></template>
<style>
.s7t1ugb9p {
  fill: none;
  stroke: currentColor;
