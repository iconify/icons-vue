...
const content = `<g class="cuyn6tgcc"><path class="dsr2iijaf"/><path class="xqw-e9o8g"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:chat-circle-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
