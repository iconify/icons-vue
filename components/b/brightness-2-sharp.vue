...
const content = `<path class="wasmbuevl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brightness-2-sharp" /></template>
<style>
.wasmbuevl {
  fill: currentColor;
