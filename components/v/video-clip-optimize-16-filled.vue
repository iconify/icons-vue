...
const content = `<path class="uz7wgx4yx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-clip-optimize-16-filled" /></template>
<style>
.uz7wgx4yx {
  fill: currentColor;
