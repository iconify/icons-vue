...
<style>
.e-2xv94-a {
  d: path("M10.498 26.43c-.51.004-1.083-.307-1.603-.706c.91 3.41-1.308 3.433-2.46 2.924");
}

.f-hj0b7dp {
  d: path("M15.578 37.764c-4.286.257-7.704-2.7-8.823-7.255c-.989-4.026-.141-9.522 1.004-8.596c1.134.918 1.782 1.152 2.612 1.312");
}

.m63ut2r-c {
  d: path("M40.364 11.912c.185 3.396-.973 5.695-3.617 6.78c.303-.584.328-.92.39-1.72c-.613-.035-1.11.013-1.589.222c.231-.553.227-.876.257-1.554c-.71-.063-1.034-.068-1.552 0c1.236-2.78 3.544-3.545 6.11-3.728m-32.727 0c-.185 3.396.973 5.695 3.617 6.78c-.304-.584-.329-.92-.39-1.72c.613-.035 1.11.013 1.588.222c-.23-.553-.227-.876-.256-1.554c.71-.063 1.034-.068 1.552 0c-1.236-2.78-3.544-3.545-6.11-3.728");
}
