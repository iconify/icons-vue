...
const content = `<path class="c1od862xw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-wifi-pro-2-rounded" /></template>
<style>
.c1od862xw {
  fill: currentColor;
