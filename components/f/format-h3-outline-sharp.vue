...
const content = `<path class="i70hmpbqh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-h3-outline-sharp" /></template>
<style>
.i70hmpbqh {
  fill: currentColor;
