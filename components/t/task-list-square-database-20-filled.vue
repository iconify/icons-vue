...
const content = `<path class="qcrhrabqm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:task-list-square-database-20-filled" /></template>
<style>
.qcrhrabqm {
  fill: currentColor;
