...
const content = `<path class="nzlw7hbeb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-header-footer-32-regular" /></template>
<style>
.nzlw7hbeb {
  fill: currentColor;
