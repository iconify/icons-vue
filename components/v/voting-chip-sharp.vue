...
const content = `<path class="r86n-tb0j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:voting-chip-sharp" /></template>
<style>
.r86n-tb0j {
  fill: currentColor;
