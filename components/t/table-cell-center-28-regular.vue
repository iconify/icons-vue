...
const content = `<path class="wjuoadksq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cell-center-28-regular" /></template>
<style>
.wjuoadksq {
  fill: currentColor;
