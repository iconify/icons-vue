...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:chart-area-sharp-two-tone" /></template>
<style>
.e5vqnab3e {
  d: path("M7 15L13 9L16 12L21 7L21 17L7 17L7 15Z");
}
