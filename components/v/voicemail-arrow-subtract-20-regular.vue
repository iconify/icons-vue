...
const content = `<path class="r-43bmeck"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:voicemail-arrow-subtract-20-regular" /></template>
<style>
.r-43bmeck {
  fill: currentColor;
