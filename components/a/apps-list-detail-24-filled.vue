...
const content = `<path class="a2k4rnb7q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:apps-list-detail-24-filled" /></template>
<style>
.a2k4rnb7q {
  fill: currentColor;
