...
const content = `<path class="qmrn6zbbd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bus-railway-sharp" /></template>
<style>
.qmrn6zbbd {
  fill: currentColor;
