...
const content = `<path class="qo-tf1bnf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:personal-bag-outline" /></template>
<style>
.qo-tf1bnf {
  fill: currentColor;
