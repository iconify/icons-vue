...
const content = `<path class="yko4w8-oe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:niyox" /></template>
<style>
.yko4w8-oe {
  fill: none;
  stroke: currentColor;
