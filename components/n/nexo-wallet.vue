...
const content = `<path class="ea65dnbyu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nexo-wallet" /></template>
<style>
.ea65dnbyu {
  fill: none;
  stroke: currentColor;
