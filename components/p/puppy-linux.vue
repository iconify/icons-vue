...
const content = `<defs><linearGradient id="svgIDb" x1="45.005%" x2="56.616%" y1="-24.35%" y2="92.496%"><stop offset="0%" class="f73j7ybru"/><stop offset="100%" class="gu60k00xw"/></linearGradient><linearGradient id="svgIDc" x1="39.303%" x2="56.252%" y1="18.5%" y2="80.217%"><stop offset="0%" class="tlcmntu3e"/><stop offset="100%" class="gu60k00xw"/></linearGradient><linearGradient id="svgIDd" x1="53.115%" x2="46.472%" y1="73.736%" y2="23.561%"><stop offset="0%" class="lhe1c4rii"/><stop offset="100%" class="u9ryddc_y"/></linearGradient><radialGradient id="svgIDa" cx="31.072%" cy="36.946%" r="128.144%" fx="31.072%" fy="36.946%"><stop offset="0%" class="d70r_4hxq"/><stop offset="100%" class="gu60k00xw"/></radialGradient><radialGradient id="svgIDe" cx="52.024%" cy="38.118%" r="87.154%" fx="22.024%" fy="32.118%"><stop offset="0%" class="k05n1gbkm"/><stop offset="63.26%" class="gu60k00xw"/><stop offset="69.75%" class="vi24w5bqi"/><stop offset="99.699%" class="y7ktnlm4y"/><stop offset="100%"/></radialGradient><filter id="svgIDf" width="200%" height="200%" x="-50%" y="-50%" filterUnits="objectBoundingBox"><feGaussianBlur in="SourceGraphic" result="blur" stdDeviation="8"/></filter></defs><g transform="translate(-1)"><path fill="url(#svgIDa)" class="u7l317sck"/><path fill="url(#svgIDb)" class="zdweixpzv"/><path fill="url(#svgIDc)" class="dmg6o6ztx"/><path class="ri7yr7b0x"/><ellipse fill="url(#svgIDd)" class="zkex7p8kg"/><path class="isukj-kev"/><path fill="url(#svgIDe)" filter="url(#svgIDf)" class="i2tyl2b3y"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:puppy-linux" /></template>
<style>
.d70r_4hxq {
  stop-opacity: 0.23;
}
...
.dmg6o6ztx {
  d: path("M127.8 7.7c41.5 0 75.2 17.8 75.2 39.8c0 22-33.7 39.8-75.2 39.8c-12.9 0-25-1.7-35.6-4.7c.4-.1.7-.2 1.1-.2c2.7-.7 5.4-2.2 8-4.8c2.4-2.8 4.1-5.8 5-9.2c.9-3.3.9-7 0-11c-.9-3.9-2.2-7.6-3.7-11.1c-1.6-3.5-3.4-6.9-5.5-10.2c-2.5-3.7-5.2-7.2-8.2-10.3c-3-3.1-6.4-5.9-10.3-8.3c13.2-6.1 30.4-9.8 49.2-9.8Z");
}

.f73j7ybru {
  stop-color: var(--svg-color--fffdff, #FFFDFF);
}
...
.i2tyl2b3y {
  d: path("M238.8 85.4c0 68.2-55.3 123.5-123.5 123.5c-46.4 0-86.9-25.6-108-63.5c8.6 59.7 60.1 105.7 122.2 105.7c68.2 0 123.5-55.3 123.5-123.5c.1-21.8-5.6-42.3-15.5-60c.8 5.8 1.3 11.7 1.3 17.8Z");
}

.isukj-kev {
  fill: var(--svg-color--141414, #141414);
  fill-opacity: var(--svg-fill-opacity--0-392, 0.392);
  d: path("M97.4 85.8c10.1 0 13.8-7 13.8-15.5c0-4.8-3.2-14.4-5.5-17.5l-.507.722c1.1 4 1.69 7.94 1.39 11.54c-.5 5.9-2.83 10.666-7.73 14.066c-4.9 3.6-10.22 4.125-16.02 3.025c4.9 1.8 10.767 3.647 14.567 3.647ZM229.9 76c3.8 1.2 6.934 1.164 9.634.464c-.8-1.8-1.784-3.69-2.684-5.39c-2 1.1-4.106 1.946-6.506 2.346c-1.7.2-3.244.38-4.644.28c1.4 1 2.8 1.9 4.2 2.3Z");
}
...
.zdweixpzv {
  d: path("M184.6 7c27.6 0 49.9 8.5 49.9 19c0 8.1-13.2 15-31.9 17.7c-2.7-15.1-21.5-27.8-47.1-33.2c8.2-2.2 18.3-3.5 29.1-3.5Z");
}
