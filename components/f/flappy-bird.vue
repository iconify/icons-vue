...
const content = `<path class="dh0u3jbpu"/><rect class="bx0ostfyq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:flappy-bird" /></template>
<style>
.bx0ostfyq {
  width: 2.672px;
  height: 5.069px;
