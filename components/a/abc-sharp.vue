...
const content = `<path class="qlyv-4cec"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:abc-sharp" /></template>
<style>
.qlyv-4cec {
  fill: currentColor;
