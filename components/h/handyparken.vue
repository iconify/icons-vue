...
const content = `<path class="yohvmbb4g"/><path class="ia5lan3ke"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:handyparken" /></template>
<style>
.ia5lan3ke {
  fill: none;
  stroke: currentColor;
