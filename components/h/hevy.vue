...
const content = `<path class="iw487qi7t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hevy" /></template>
<style>
.iw487qi7t {
  fill: none;
  stroke: currentColor;
