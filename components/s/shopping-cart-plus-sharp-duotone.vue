...
const content = `<g class="gp_8x1bzb"><path class="zeadxxzag"/><path class="wnb6zxb9g"/><path class="czbbm17fv"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shopping-cart-plus-sharp-duotone" /></template>
<style>
.czbbm17fv {
  fill: currentColor;
...
.wnb6zxb9g {
  d: path("M1 3L4 3L5 7M19 2L19 10M15 6L23 6");
}
