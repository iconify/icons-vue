...
const content = `<path class="h6lv3fcsp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-seating-sharp" /></template>
<style>
.h6lv3fcsp {
  fill: currentColor;
