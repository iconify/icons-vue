...
const content = `<path class="y2z6r5bqi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:filter-9-rounded" /></template>
<style>
.y2z6r5bqi {
  fill: currentColor;
