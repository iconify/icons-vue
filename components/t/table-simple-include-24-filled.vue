...
const content = `<path class="dg8hf-btv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-simple-include-24-filled" /></template>
<style>
.dg8hf-btv {
  fill: currentColor;
