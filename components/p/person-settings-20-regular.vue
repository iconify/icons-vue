...
const content = `<path class="l0nh_c11e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-settings-20-regular" /></template>
<style>
.l0nh_c11e {
  fill: currentColor;
