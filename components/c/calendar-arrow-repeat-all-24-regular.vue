...
const content = `<path class="vtv885b4u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-arrow-repeat-all-24-regular" /></template>
<style>
.vtv885b4u {
  fill: currentColor;
