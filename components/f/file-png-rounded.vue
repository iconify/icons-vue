...
const content = `<path class="c74rgs44m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:file-png-rounded" /></template>
<style>
.c74rgs44m {
  fill: currentColor;
