...
const content = `<path class="shl8wbb-c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:align-justify-center-outline-rounded" /></template>
<style>
.shl8wbb-c {
  fill: currentColor;
