...
const content = `<path class="vuy0_shfi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:subwoofer-outline-rounded" /></template>
<style>
.vuy0_shfi {
  fill: currentColor;
