...
const content = `<path class="l7cvvibhb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:book-4-outline-sharp" /></template>
<style>
.l7cvvibhb {
  fill: currentColor;
