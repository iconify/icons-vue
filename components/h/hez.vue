...
const content = `<g class="ft5dv1b6b"><path class="pqpdhqb4g"/><path class="ivjb-y-ld"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:hez" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
