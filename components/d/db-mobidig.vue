...
const content = `<path class="ncek8rbcm"/><rect class="a69my5ynw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:db-mobidig" /></template>
<style>
.a69my5ynw {
  width: 23.913px;
  height: 15.197px;
