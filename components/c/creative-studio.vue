...
const content = `<rect class="n4oa_3bls"/><path class="hq8i549as"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:creative-studio" /></template>
<style>
.hq8i549as {
  fill: none;
  stroke: currentColor;
