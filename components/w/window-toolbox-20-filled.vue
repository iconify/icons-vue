...
const content = `<path class="gl-20nbwm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-toolbox-20-filled" /></template>
<style>
.gl-20nbwm {
  fill: currentColor;
