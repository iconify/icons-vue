...
const content = `<path class="pu21pkn0q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-add-16-regular" /></template>
<style>
.pu21pkn0q {
  fill: currentColor;
