...
const content = `<path class="yg4y83-sx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:title-rounded" /></template>
<style>
.yg4y83-sx {
  fill: currentColor;
