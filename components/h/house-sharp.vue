...
const content = `<path class="gkm72k64t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:house-sharp" /></template>
<style>
.gkm72k64t {
  fill: currentColor;
