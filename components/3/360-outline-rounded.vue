...
const content = `<path class="ublbyt82r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:360-outline-rounded" /></template>
<style>
.ublbyt82r {
  fill: currentColor;
