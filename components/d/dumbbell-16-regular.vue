...
const content = `<path class="l22by7bcf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dumbbell-16-regular" /></template>
<style>
.l22by7bcf {
  fill: currentColor;
