...
const content = `<path class="cbasxm-uy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:puzzle-piece-20-filled" /></template>
<style>
.cbasxm-uy {
  fill: currentColor;
