...
const content = `<path class="ppebiob1s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-mac-32-filled" /></template>
<style>
.ppebiob1s {
  fill: currentColor;
