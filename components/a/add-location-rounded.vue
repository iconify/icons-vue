...
const content = `<path class="od42sxbea"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-location-rounded" /></template>
<style>
.od42sxbea {
  fill: currentColor;
