...
const content = `<path class="lh-e40blr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:clean-hands" /></template>
<style>
.lh-e40blr {
  fill: currentColor;
