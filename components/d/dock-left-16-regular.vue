...
const content = `<path class="yysm6jbio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dock-left-16-regular" /></template>
<style>
.yysm6jbio {
