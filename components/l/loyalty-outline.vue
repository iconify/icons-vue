...
const content = `<path class="z3xfmcbac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:loyalty-outline" /></template>
<style>
.z3xfmcbac {
  fill: currentColor;
