...
const content = `<path class="dbwufubmo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-checkmark-24-regular" /></template>
<style>
.dbwufubmo {
  fill: currentColor;
