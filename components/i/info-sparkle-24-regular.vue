...
const content = `<path class="kpl426mhq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:info-sparkle-24-regular" /></template>
<style>
.kpl426mhq {
  fill: currentColor;
