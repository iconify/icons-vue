...
const content = `<path class="z_wvbyapj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:task-list-add-24-filled" /></template>
<style>
.z_wvbyapj {
  fill: currentColor;
