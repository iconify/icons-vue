...
const content = `<path class="q_xso-00k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:settings-phone-outline-sharp" /></template>
<style>
.q_xso-00k {
  fill: currentColor;
