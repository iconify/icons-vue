...
const content = `<path class="zik1ribvf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:component-2-double-tap-swipe-down-24-regular" /></template>
<style>
.zik1ribvf {
  fill: currentColor;
