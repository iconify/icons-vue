...
const content = `<g class="cuyn6tgcc"><path class="gx39vbbwk"/><path class="amz9a4bpq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:pencil-circle-duotone" /></template>
<style>
.amz9a4bpq {
...
.gx39vbbwk {
  d: path("M224 128a96 96 0 1 0-144 83.16V176l48-104l48 104v35.16A96 96 0 0 0 224 128");
