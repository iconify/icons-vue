...
const content = `<g class="nrj6p8qat"><path class="ciz47rm9a"/><path class="c7--g1yoy"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shield-check-duotone" /></template>
<style>
.c7--g1yoy {
