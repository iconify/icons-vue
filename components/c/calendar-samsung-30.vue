...
const content = `<path class="jg0acgbpj"/><path class="kzykk8swa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:calendar-samsung-30" /></template>
<style>
.jg0acgbpj {
  fill: none;
  stroke: currentColor;
