...
const content = `<path class="m7o8a6e2e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-desktop-multiple-20-regular" /></template>
<style>
.m7o8a6e2e {
  fill: currentColor;
