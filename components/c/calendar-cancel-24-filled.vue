...
const content = `<path class="lhbhgcbow"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-cancel-24-filled" /></template>
<style>
.lhbhgcbow {
  fill: currentColor;
