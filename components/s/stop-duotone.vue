...
const content = `<g class="cuyn6tgcc"><path class="a61atdw8z"/><path class="id5mn6m5n"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:stop-duotone" /></template>
<style>
.a61atdw8z {
