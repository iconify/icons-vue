...
const content = `<g class="nrj6p8qat"><path class="vhck9ybet"/><path clip-rule="evenodd" class="qa1terbik"/><path class="x4nuazbrz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-down-duotone" /></template>
<style>
.nrj6p8qat {
  fill: none;
  stroke: currentColor;
...
.x4nuazbrz {
  d: path("M18 16V22M15 19L18 22L21 19");
}
