...
const content = `<path class="xavz1bc9x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bus-map-pin-rounded" /></template>
<style>
.xavz1bc9x {
  fill: currentColor;
