...
const content = `<path class="pgc4yguag"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:air-india" /></template>
<style>
.pgc4yguag {
  fill: none;
  stroke: currentColor;
