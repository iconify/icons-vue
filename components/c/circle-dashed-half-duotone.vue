...
const content = `<g class="nrj6p8qat"><path class="neicvubrs"/><path class="a1zr_kb_y"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-half-duotone" /></template>
<style>
.a1zr_kb_y {
  fill: currentColor;
