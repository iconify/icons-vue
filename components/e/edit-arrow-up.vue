...
const content = `<path class="owt4qub9w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-arrow-up" /></template>
<style>
.owt4qub9w {
  fill: currentColor;
