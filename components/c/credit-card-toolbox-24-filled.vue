...
const content = `<path class="hp-fd_w1r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:credit-card-toolbox-24-filled" /></template>
<style>
.hp-fd_w1r {
  fill: currentColor;
