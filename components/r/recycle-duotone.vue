...
const content = `<g class="cuyn6tgcc"><path class="yxxc2223z"/><path class="cwl8eu-ct"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:recycle-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
