...
const content = `<path class="g8vygpb6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:outdoor-grill-sharp" /></template>
<style>
.g8vygpb6i {
  fill: currentColor;
