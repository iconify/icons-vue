...
const content = `<path class="nswsbjb_y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:layout-column-four-16-regular" /></template>
<style>
.nswsbjb_y {
  fill: currentColor;
