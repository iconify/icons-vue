...
const content = `<path class="oco7d7byq"/><path class="of_frvb8m"/><path class="t7-jwcbkx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-hook-opened" /></template>
<style>
.oco7d7byq {
