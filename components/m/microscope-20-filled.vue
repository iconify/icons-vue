...
const content = `<path class="kftiphwwg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:microscope-20-filled" /></template>
<style>
.kftiphwwg {
  fill: currentColor;
