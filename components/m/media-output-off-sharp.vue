...
const content = `<path class="nbixa9m9c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:media-output-off-sharp" /></template>
<style>
.nbixa9m9c {
  fill: currentColor;
