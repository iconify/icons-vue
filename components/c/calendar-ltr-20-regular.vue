...
const content = `<path class="e0qd8cbms"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-ltr-20-regular" /></template>
<style>
.e0qd8cbms {
  fill: currentColor;
