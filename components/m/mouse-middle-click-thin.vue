...
const content = `<path class="y80t-x98w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:mouse-middle-click-thin" /></template>
<style>
.y80t-x98w {
  fill: currentColor;
