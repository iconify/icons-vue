...
const content = `<path class="w7wsjfw9s"/><path class="tc2jcgrnw"/><path class="ynhbyejhc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:middle-finger-dark-skin-tone" /></template>
<style>
.tc2jcgrnw {
