...
const content = `<path class="lkcnsrx7c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:number-circle-0-48-filled" /></template>
<style>
.lkcnsrx7c {
  fill: currentColor;
