...
const content = `<path class="t8si3ub3h"/><path class="ioglg3bqs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:netto-plus" /></template>
<style>
.ioglg3bqs {
  fill: none;
  stroke: currentColor;
