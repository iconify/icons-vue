...
const content = `<path class="cxa9bvkdq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:view-agenda-rounded" /></template>
<style>
.cxa9bvkdq {
  fill: currentColor;
