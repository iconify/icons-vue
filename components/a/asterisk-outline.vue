...
const content = `<path class="t-_nublke"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:asterisk-outline" /></template>
<style>
.t-_nublke {
  fill: currentColor;
