...
const content = `<path class="fwq5y1ypc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:apps-list-24-regular" /></template>
<style>
.fwq5y1ypc {
  fill: currentColor;
