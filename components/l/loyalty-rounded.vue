...
const content = `<path class="qqodkwpzw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:loyalty-rounded" /></template>
<style>
.qqodkwpzw {
  fill: currentColor;
