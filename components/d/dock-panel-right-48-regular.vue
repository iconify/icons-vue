...
const content = `<path class="xdnmkzbcw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dock-panel-right-48-regular" /></template>
<style>
.xdnmkzbcw {
  fill: currentColor;
