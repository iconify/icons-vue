...
const content = `<path class="d8pts2g_e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:font-increase-20-regular" /></template>
<style>
.d8pts2g_e {
  fill: currentColor;
