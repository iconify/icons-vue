...
const content = `<path class="txgtao_xs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wifi-find-outline-rounded" /></template>
<style>
.txgtao_xs {
  fill: currentColor;
