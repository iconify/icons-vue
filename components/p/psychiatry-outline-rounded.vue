...
const content = `<path class="a1rgeh0nf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:psychiatry-outline-rounded" /></template>
<style>
.a1rgeh0nf {
  fill: currentColor;
