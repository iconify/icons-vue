...
const content = `<path class="swyx6siiw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fiber-smart-record" /></template>
<style>
.swyx6siiw {
  fill: currentColor;
