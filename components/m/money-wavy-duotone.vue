...
const content = `<g class="cuyn6tgcc"><path class="ezv7ps6jk"/><path class="clr-7s89t"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:money-wavy-duotone" /></template>
<style>
.clr-7s89t {
...
.ezv7ps6jk {
  d: path("M16 69.21v120c91.64-44.77 132.36 42.35 224-2.42v-120c-91.64 44.77-132.36-42.35-224 2.42M128 152a24 24 0 1 1 24-24a24 24 0 0 1-24 24");
