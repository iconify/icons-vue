...
const content = `<path class="tu0v5ib2r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:surfing-outline-sharp" /></template>
<style>
.tu0v5ib2r {
  fill: currentColor;
