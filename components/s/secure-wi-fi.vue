...
const content = `<path class="bjac1bqww"/><circle class="yz9fesbuz"/><path class="kg4ghsblu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:secure-wi-fi" /></template>
<style>
.bjac1bqww {
  fill: none;
  stroke: currentColor;
