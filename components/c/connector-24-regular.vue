...
const content = `<path class="yqk6_6bhf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:connector-24-regular" /></template>
<style>
.yqk6_6bhf {
  fill: currentColor;
