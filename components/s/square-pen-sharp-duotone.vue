...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-pen-sharp-duotone" /></template>
<style>
.db-zerbsw {
  fill: currentColor;
...
.fpwl1qbal {
  stroke-opacity: 0.4;
  d: path("M13 3L3 3L3 21L21 21L21 11");
}
