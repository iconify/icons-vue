...
const content = `<path class="hhdu3bbxs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-export-ltr-16-regular" /></template>
<style>
.hhdu3bbxs {
  fill: currentColor;
