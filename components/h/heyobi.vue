...
const content = `<path class="p0u0dqy9h"/><path class="ucaa7mv2l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:heyobi" /></template>
<style>
.p0u0dqy9h {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M38.317 13.413V8.91H5.5v30.18l4.036-3.17h28.676v-4.652");
}
