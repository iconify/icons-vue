...
const content = `<path class="mbfn2nbya"/><path class="lkt7r273q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-verified" /></template>
<style>
.lkt7r273q {
  fill: currentColor;
