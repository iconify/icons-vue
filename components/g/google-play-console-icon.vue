...
const content = `<path class="eapmrskld"/><path class="f2cg0_bvg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:google-play-console-icon" /></template>
<style>
.eapmrskld {
