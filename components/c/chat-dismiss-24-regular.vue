...
const content = `<path class="cnua8sbtc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-dismiss-24-regular" /></template>
<style>
.cnua8sbtc {
  fill: currentColor;
