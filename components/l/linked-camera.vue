...
const content = `<path class="i9v22b7oc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:linked-camera" /></template>
<style>
.i9v22b7oc {
  fill: currentColor;
