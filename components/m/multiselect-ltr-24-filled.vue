...
const content = `<path class="xgvnfjb5i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:multiselect-ltr-24-filled" /></template>
<style>
.xgvnfjb5i {
  fill: currentColor;
