...
const content = `<path class="dis_p2c3i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:9k-plus-sharp" /></template>
<style>
.dis_p2c3i {
  fill: currentColor;
