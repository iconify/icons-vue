...
const content = `<path class="h14hzeb3q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:star-emphasis-32-filled" /></template>
<style>
.h14hzeb3q {
  fill: currentColor;
