...
const content = `<path class="hss4_2stl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:checkey" /></template>
<style>
.hss4_2stl {
  fill: none;
  stroke: currentColor;
