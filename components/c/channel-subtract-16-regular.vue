...
const content = `<path class="k5uf5ab6s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:channel-subtract-16-regular" /></template>
<style>
.k5uf5ab6s {
  fill: currentColor;
