...
const content = `<path class="mikrvsbyn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mysmartfren" /></template>
<style>
.mikrvsbyn {
  fill: none;
  stroke: currentColor;
