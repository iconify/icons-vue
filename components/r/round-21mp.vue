...
const content = `<path class="k4n51fjcs"/><path class="xwvt6soji"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-21mp" /></template>
<style>
.k4n51fjcs {
  fill: currentColor;
