...
const content = `<path class="z95rfbrfm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:position-top-right-rounded" /></template>
<style>
.z95rfbrfm {
  fill: currentColor;
