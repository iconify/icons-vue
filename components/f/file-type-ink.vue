...
const content = `<defs><linearGradient id="SVGiUzy0cKm" x1="16" x2="16" y1="32" y2="4" gradientTransform="matrix(1 0 0 -1 0 34)" gradientUnits="userSpaceOnUse"><stop offset="0" class="ey5cfuq_s"/><stop offset="1" class="r2dnp3wpl"/></linearGradient></defs><path fill="url(#SVGiUzy0cKm)" class="yptknom3s"/><path class="ex3e6rmbv"/><path class="s8r28p-kc"/><path class="qzr1ee2dn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-ink" /></template>
<style>
.ex3e6rmbv {
...
.qzr1ee2dn {
  ...
  d: path("M18.144 14.033c0 .14-.122.253-.324.253s-.3-.113-.3-.253s.093-.253.3-.253s.324.113.324.253m-3 1.183c0 .14-.132.174-.257.174s-.2-.035-.2-.174a.187.187 0 0 1 .212-.2c.123 0 .24.06.24.2Zm5.448 5.159c.056.244.354.517-.027.733c-.221.125-.492-.183-.619-.656c-.059-.218-.1-.573.217-.677s.372.371.424.6Zm6.563-3.717c-.157.292-.522.5-.757.369s-.119-.465.038-.757s.371-.554.606-.427a.62.62 0 0 1 .108.815Zm-.765-1.581c.028.1-.034.2-.175.241a.185.185 0 0 1-.257-.118c-.028-.1.014-.195.155-.236s.244.016.272.113Zm-16.354 1.728c0 .111-.1.2-.258.2s-.235-.09-.235-.2s.074-.2.235-.2s.258.088.258.2m16.509-4.776c.055.09-.015.17-.24.312s-.42.2-.465.1s.014-.243.243-.377c.279-.164.388-.156.462-.035");
}
...
.s8r28p-kc {
  fill: var(--svg-color--040404, #040404);
  d: path("M12.075 23.05a1.99 1.99 0 0 0-1.094-1.55a.41.41 0 0 1-.256-.435c.05-.408-.188-.7-.759-.653a.744.744 0 0 1-.875-.706a1.06 1.06 0 0 1 .562-.811a1.87 1.87 0 0 0 .923-1.373a2.28 2.28 0 0 0-1.6-1.931a2.06 2.06 0 0 0-1.6.558c-.3.268-.63 1.026-1.338 1.1a5.7 5.7 0 0 1-1.538-.411v.006a11.52 11.52 0 0 0 4.658 8.44s.579-.116.844-.166c1.134-.218 2.129-.991 2.073-2.068M25.086 8.9c-.048.684-.338 1.154-.2 1.552c.193.553-.45.794-.438 1.441c.023 1.213 1.087 1.319 1.062 1.613c-.029.338-1.488.156-1.488 1.978a1.875 1.875 0 0 0 1.855 1.926a1.76 1.76 0 0 0 1.636-.789A11.47 11.47 0 0 0 25.086 8.9");
}

.yptknom3s {
  d: path("M16 2a14 14 0 1 0 14 14A14 14 0 0 0 16 2");
}
