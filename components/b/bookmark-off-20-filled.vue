...
const content = `<path class="y15n-tbmo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:bookmark-off-20-filled" /></template>
<style>
.y15n-tbmo {
  fill: currentColor;
