...
const content = `<path class="suk_2jcbm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:family-star-sharp" /></template>
<style>
.suk_2jcbm {
  fill: currentColor;
