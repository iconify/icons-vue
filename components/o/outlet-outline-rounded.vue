...
const content = `<path class="v3gj6tpmw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:outlet-outline-rounded" /></template>
<style>
.v3gj6tpmw {
  fill: currentColor;
