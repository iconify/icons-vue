...
const content = `<path class="ppesh_8lx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:hearing-aid-disabled-outline-sharp" /></template>
<style>
.ppesh_8lx {
  fill: currentColor;
