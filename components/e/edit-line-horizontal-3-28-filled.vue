...
const content = `<path class="mu0e62bag"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:edit-line-horizontal-3-28-filled" /></template>
<style>
.mu0e62bag {
  fill: currentColor;
