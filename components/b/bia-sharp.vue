...
const content = `<path class="da_ca-bwp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bia-sharp" /></template>
<style>
.da_ca-bwp {
  fill: currentColor;
