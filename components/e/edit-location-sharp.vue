...
const content = `<path class="o1hqqrcxv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:edit-location-sharp" /></template>
<style>
.o1hqqrcxv {
  fill: currentColor;
