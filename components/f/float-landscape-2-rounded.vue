...
const content = `<path class="ewoo92bkv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:float-landscape-2-rounded" /></template>
<style>
.ewoo92bkv {
  fill: currentColor;
