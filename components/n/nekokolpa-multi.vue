...
const content = `<path class="gd__l71ef"/><path class="y2uqz8bnh"/><circle class="xt60wwb0h"/><path class="j8dh1ac4f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:nekokolpa-multi" /></template>
<style>
.gd__l71ef {
  fill: none;
  stroke: currentColor;
...
.j8dh1ac4f {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M32.174 35.583v-5.994l3 6l3-5.991v5.991");
}
...
.y2uqz8bnh {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M16.037 23.876q2.672-.764 3.757 1.888q-.537-2.077 1.567-4.022q-2.785-.226-4.012-2.917q.548 2.805-1.312 5.05m10.715-2.029q2.737-.49 3.55 2.256q-.33-2.124 1.963-3.842q-2.747-.51-3.7-3.314q.263 2.851-1.813 4.9M3.5 25.98q5.768-3.615 10.488-2.784m-9.166 5.277q4.739-3.578 8.855-3.757m19.476-3.049q5.693-2.73 11.205-2.077m-10.516 3.38q6.353-.794 10.658.405");
}
