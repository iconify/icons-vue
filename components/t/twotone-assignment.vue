...
const content = `<path class="f87q51b3k"/><path class="w3t7r8bkr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-assignment" /></template>
<style>
.f87q51b3k {
  fill: currentColor;
