...
const content = `<path class="fddt2ibnu"/><circle class="aa38lcwip"/><path class="hgvj-zrvy"/><path class="ajg5_kqqw"/><path class="wxadi7kjp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:baby-angel-medium-dark-skin-tone" /></template>
<style>
.aa38lcwip {
  cx: 18px;
  cy: 21px;
...
.ajg5_kqqw {
  ...
  d: path("M16 22a1 1 0 1 1-2 0v-2a1 1 0 1 1 2 0zm6 0a1 1 0 1 1-2 0v-2a1 1 0 1 1 2 0z");
}
...
.hgvj-zrvy {
  fill: var(--svg-color--60352a, #60352a);
  d: path("M18 5.205c-7.444 0-13.5 6.056-13.5 13.5c0 1.9.396 3.751 1.178 5.499a.5.5 0 0 0 .952-.134c.393-2.755 2.581-4.706 4.512-6.428c1.793-1.599 3.498-3.119 3.444-5.041c6.516 1.171 14.006 6.017 14.784 11.469a.5.5 0 0 0 .951.134a13.4 13.4 0 0 0 1.179-5.499c0-7.444-6.056-13.5-13.5-13.5M14 27h8s-1 2-4 2s-4-2-4-2");
}
