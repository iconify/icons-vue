...
const content = `<path class="k4wc6v7vz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fit-page-width-outline" /></template>
<style>
.k4wc6v7vz {
  fill: currentColor;
