...
const content = `<path class="yfnjy2bem"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:handshake-outline" /></template>
<style>
.yfnjy2bem {
  fill: currentColor;
