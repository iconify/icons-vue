...
const content = `<path class="i9clfwm2k"/><path class="ijplfmboy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:computrabajo" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
