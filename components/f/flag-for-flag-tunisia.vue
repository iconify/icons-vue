...
const content = `<path class="ik8-3_bxu"/><circle class="ycswj9bcv"/><path class="v_fpfvb2f"/><path class="nolv3xbmn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-tunisia" /></template>
<style>
.ik8-3_bxu {
