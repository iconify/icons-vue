...
const content = `<path class="dq4n3lbay"/><g class="rg_g2tbxj"><path class="k-4s_kb-m"/><path class="axs-tfgmh"/><path class="t3uwr7rnt"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:sign-of-the-horns-medium-skin-tone" /></template>
<style>
.axs-tfgmh {
