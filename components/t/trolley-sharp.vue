...
const content = `<path class="wt-czmoqt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:trolley-sharp" /></template>
<style>
.wt-czmoqt {
  fill: currentColor;
