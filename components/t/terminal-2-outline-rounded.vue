...
const content = `<path class="dmqx-bw7r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:terminal-2-outline-rounded" /></template>
<style>
.dmqx-bw7r {
  fill: currentColor;
