...
const content = `<path class="qg60lmbba"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:slow-motion-video-outline-rounded" /></template>
<style>
.qg60lmbba {
  fill: currentColor;
