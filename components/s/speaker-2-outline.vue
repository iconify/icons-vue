...
const content = `<path class="wql634bub"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speaker-2-outline" /></template>
<style>
.wql634bub {
  fill: currentColor;
