...
const content = `<g class="gp_8x1bzb"><path class="b2ps5cbvw"/><path class="djeeryqkq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:mail-sharp-two-tone" /></template>
<style>
.b2ps5cbvw {
  fill: currentColor;
