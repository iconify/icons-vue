...
const content = `<path class="evsx29bjd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:procedure-outline-sharp" /></template>
<style>
.evsx29bjd {
  fill: currentColor;
