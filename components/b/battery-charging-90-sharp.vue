...
const content = `<path class="tao24g5lr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-charging-90-sharp" /></template>
<style>
.tao24g5lr {
  fill: currentColor;
