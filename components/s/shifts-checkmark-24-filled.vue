...
const content = `<path class="fdgk1_bsn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shifts-checkmark-24-filled" /></template>
<style>
.fdgk1_bsn {
  fill: currentColor;
