...
const content = `<path class="prdcsvzge"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:megaphone-loud-32-filled" /></template>
<style>
.prdcsvzge {
  fill: currentColor;
