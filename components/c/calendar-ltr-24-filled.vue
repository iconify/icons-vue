...
const content = `<path class="w04hczbzk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-ltr-24-filled" /></template>
<style>
.w04hczbzk {
  fill: currentColor;
