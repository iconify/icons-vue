...
const content = `<path class="e7mb7_xac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:add-circle-48-filled" /></template>
<style>
.e7mb7_xac {
  fill: currentColor;
