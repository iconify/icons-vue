...
const content = `<path class="rei8b3clg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:launcher-settings-20-filled" /></template>
<style>
.rei8b3clg {
  fill: currentColor;
