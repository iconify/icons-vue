...
const content = `<path class="k04g2idzb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:medication" /></template>
<style>
.k04g2idzb {
  fill: currentColor;
