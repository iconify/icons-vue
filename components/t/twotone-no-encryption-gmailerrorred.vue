...
const content = `<path class="uicwy5b-w"/><path class="qt4wv2a6u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-no-encryption-gmailerrorred" /></template>
<style>
.qt4wv2a6u {
  fill: currentColor;
...
.uicwy5b-w {
  fill: currentColor;
  d: path("M6 20h10.78l-10-10H6zm6.44-10L18 15.56V10z");
