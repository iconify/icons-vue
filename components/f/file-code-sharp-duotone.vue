...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:file-code-sharp-duotone" /></template>
<style>
.g6hnddcux {
  fill: currentColor;
  fill-rule: evenodd;
...
.vd217ndtg {
  d: path("M10.2969 11.5547L8 15L10.2969 18.4453M13.7031 11.5547L16 15L13.7031 18.4453");
}
