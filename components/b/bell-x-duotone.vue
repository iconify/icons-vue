...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:bell-x-duotone" /></template>
<style>
.chjbymbwi {
  d: path("M8.2679 20C8.6252 20.6188 9.2855 21 10 21C10.7145 21 11.3748 20.6188 11.7321 20M16 2L22 8M22 2L16 8");
}
