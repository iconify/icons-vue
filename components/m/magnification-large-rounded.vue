...
const content = `<path class="oph27ccob"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:magnification-large-rounded" /></template>
<style>
.oph27ccob {
  fill: currentColor;
