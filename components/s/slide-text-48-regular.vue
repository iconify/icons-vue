...
const content = `<path class="ic50dcb9v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:slide-text-48-regular" /></template>
<style>
.ic50dcb9v {
  fill: currentColor;
