...
const content = `<path class="i6ie6cc1c"/><path class="ta7tdabff"/><path class="uc52tobhn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ac-odyssey-map" /></template>
<style>
.i6ie6cc1c {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M25.374 10.18c4.794 0 8.495 4.371 8.301 9.76");
}
