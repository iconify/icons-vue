...
const content = `<circle class="f0f4r9n8l"/><circle class="j2mm6bbcp"/><path class="zqk955bda"/><path class="cdc2mtbff"/><path class="pb5k62tcq"/><path class="so2ffcbhv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-montenegro" /></template>
<style>
.cdc2mtbff {
  fill: var(--svg-color--428bc1, #428bc1);
  d: path("M27 31h10v6H27z");
}
