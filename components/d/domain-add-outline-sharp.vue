...
const content = `<path class="dh9aytgon"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:domain-add-outline-sharp" /></template>
<style>
.dh9aytgon {
  fill: currentColor;
