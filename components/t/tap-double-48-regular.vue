...
const content = `<path class="ife6yn-cm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tap-double-48-regular" /></template>
<style>
.ife6yn-cm {
  fill: currentColor;
