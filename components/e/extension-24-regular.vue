...
const content = `<g class="ft5dv1b6b"><path class="v4r1ctb5w"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:extension-24-regular" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
