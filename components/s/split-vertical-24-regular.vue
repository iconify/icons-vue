...
const content = `<path class="d2vylkbdl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:split-vertical-24-regular" /></template>
<style>
.d2vylkbdl {
  fill: currentColor;
