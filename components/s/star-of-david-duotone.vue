...
const content = `<g class="cuyn6tgcc"><path class="i8ztlzbiz"/><path class="r-wg48b1f"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:star-of-david-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
