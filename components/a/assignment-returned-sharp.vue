...
const content = `<path class="miobbts6d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:assignment-returned-sharp" /></template>
<style>
.miobbts6d {
  fill: currentColor;
