...
const content = `<path class="t2g17jbat"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:globe-asia-outline-rounded" /></template>
<style>
.t2g17jbat {
  fill: currentColor;
