...
const content = `<path class="lsljf5b6l"/><path class="qla7mebyf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-testcafe" /></template>
<style>
.lsljf5b6l {
