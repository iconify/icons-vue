...
const content = `<path class="qucwrlp-y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-box-settings-20-regular" /></template>
<style>
.qucwrlp-y {
  fill: currentColor;
