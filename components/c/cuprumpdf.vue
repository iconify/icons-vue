...
const content = `<path class="j98an1bqd"/><path class="s7hhl2bwc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:cuprumpdf" /></template>
<style>
.j98an1bqd {
  fill: none;
  stroke: currentColor;
