...
const content = `<path class="xq57j_jcm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:code-outline-rounded" /></template>
<style>
.xq57j_jcm {
  fill: currentColor;
