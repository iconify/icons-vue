...
const content = `<path class="yf2nq7bdm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vaccines-outline-rounded" /></template>
<style>
.yf2nq7bdm {
  fill: currentColor;
