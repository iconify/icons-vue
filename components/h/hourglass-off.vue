...
const content = `<g class="cuyn6tgcc"><g class="xyjtgccot"><path class="ag7zr8swn"/><path clip-rule="evenodd" class="n2upzxbar"/><path class="y-4hcgbed"/><path clip-rule="evenodd" class="ct68avbys"/><path clip-rule="evenodd" class="s5-z42b4o"/></g><path clip-rule="evenodd" class="agkjp5bec"/><path clip-rule="evenodd" class="chhgf-xbk"/><path clip-rule="evenodd" class="w_4htojmi"/><path class="mo5netbri"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-print:hourglass-off" /></template>
