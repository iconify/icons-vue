...
const content = `<g class="cuyn6tgcc"><path class="w8985q_4s"/><path class="x8p88ibjf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:user-check-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
