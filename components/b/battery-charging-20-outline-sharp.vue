...
const content = `<path class="ao3meci7w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-charging-20-outline-sharp" /></template>
<style>
.ao3meci7w {
  fill: currentColor;
