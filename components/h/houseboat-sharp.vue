...
const content = `<path class="jctxdrbzz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:houseboat-sharp" /></template>
<style>
.jctxdrbzz {
  fill: currentColor;
