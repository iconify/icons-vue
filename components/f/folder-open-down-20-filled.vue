...
const content = `<path class="wq-idx7ew"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-open-down-20-filled" /></template>
<style>
.wq-idx7ew {
  fill: currentColor;
