...
const content = `<path class="fgrp5tbru"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:leaf-one-16-regular" /></template>
<style>
.fgrp5tbru {
  fill: currentColor;
