...
const content = `<path class="vu5pinaxf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:credit-card-clock-outline" /></template>
<style>
.vu5pinaxf {
  fill: currentColor;
