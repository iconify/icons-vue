...
const content = `<path class="kg4ghsblu"/><path class="bvod8lb1g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kpn-veilig" /></template>
<style>
.bvod8lb1g {
  fill: none;
  stroke: currentColor;
