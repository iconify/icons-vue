...
const content = `<path class="qopaqy9xo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:home-repair-service-rounded" /></template>
<style>
.qopaqy9xo {
  fill: currentColor;
