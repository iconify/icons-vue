...
const content = `<path class="eg50r069e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-flag-centered-cross" /></template>
<style>
.eg50r069e {
  fill: none;
  stroke: currentColor;
