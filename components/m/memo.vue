...
const content = `<path class="ku125-uti"/><path class="q8nebdcjf"/><g class="q1tv0ue9d"><path class="zashw-bne"/><path class="x5iso_boj"/><path class="i27uwzb-a"/></g><path class="msfzd70ad"/><path class="snxg8tu2w"/><path class="bkj5vznzu"/><path class="btn6krd4j"/><path class="tbsx4yl4d"/><path class="rx83orbgv"/><path class="ylzd9hd0w"/><path class="bhlmi6btw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:memo" /></template>
<style>
.bhlmi6btw {
  fill: var(--svg-color--ff8736, #ff8736);
  d: path("m40.656 25.869l14.07-14.074l2.545 2.546l-14.07 14.073z");
}

.bkj5vznzu {
  fill: var(--svg-color--93a2aa, #93a2aa);
  d: path("m49.703 6.679l2.05-2.05l7.566 7.567l-2.051 2.05z");
}

.btn6krd4j {
  fill: var(--svg-color--c7d3d8, #c7d3d8);
  d: path("m50.552 7.527l2.05-2.05l5.94 5.939l-2.05 2.05z");
}
...
.ku125-uti {
  fill: var(--svg-color--efd8b1, #efd8b1);
  d: path("M0 20.3S28.2 50.2 31.2 64c0 0 8.1-17.9 32.8-25.4c0 0-8.8-20.6-32.2-37c0 0-23.9 7.2-31.8 18.7");
}

.msfzd70ad {
  fill: var(--svg-color--ffce31, #ffce31);
  d: path("m35.658 20.801l16.124-16.12l7.565 7.567l-16.124 16.12z");
}
