...
const content = `<path class="p81kqjbhy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:collapse-all-outline-rounded" /></template>
<style>
.p81kqjbhy {
  fill: currentColor;
