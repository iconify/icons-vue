...
const content = `<path class="ygicpm2sj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:position-bottom-left-rounded" /></template>
<style>
.ygicpm2sj {
  fill: currentColor;
