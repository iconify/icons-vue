...
const content = `<path class="mxkocd9nh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-bidirectional-up-down-20-regular" /></template>
<style>
.mxkocd9nh {
  fill: currentColor;
