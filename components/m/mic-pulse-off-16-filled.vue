...
const content = `<path class="n8ly5ccoq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mic-pulse-off-16-filled" /></template>
<style>
.n8ly5ccoq {
  fill: currentColor;
