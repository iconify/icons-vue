...
const content = `<path class="p6knt7jxa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-left-outline-rounded" /></template>
<style>
.p6knt7jxa {
  fill: currentColor;
