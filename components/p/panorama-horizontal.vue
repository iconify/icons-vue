...
const content = `<path class="wxglovfdn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:panorama-horizontal" /></template>
<style>
.wxglovfdn {
  fill: currentColor;
