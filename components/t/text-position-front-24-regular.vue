...
const content = `<path class="ihvf25k6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-front-24-regular" /></template>
<style>
.ihvf25k6i {
  fill: currentColor;
