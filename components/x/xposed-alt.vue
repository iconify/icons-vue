...
const content = `<path class="unr5e65uf"/><path class="sfd3fm2kw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:xposed-alt" /></template>
<style>
.sfd3fm2kw {
  fill: none;
  stroke: currentColor;
