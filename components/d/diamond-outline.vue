...
const content = `<path class="m8c050b6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:diamond-outline" /></template>
<style>
.m8c050b6i {
  fill: currentColor;
