...
const content = `<g class="cuyn6tgcc"><path class="bbwwx_-me"/><path class="c5cd6qoin"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:shield-warning-duotone" /></template>
<style>
.bbwwx_-me {
