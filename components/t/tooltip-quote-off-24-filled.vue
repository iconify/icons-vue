...
const content = `<path class="pjg4uy95v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tooltip-quote-off-24-filled" /></template>
<style>
.pjg4uy95v {
  fill: currentColor;
