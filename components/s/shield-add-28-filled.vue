...
const content = `<path class="q414blbgf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:shield-add-28-filled" /></template>
<style>
.q414blbgf {
  fill: currentColor;
