...
const content = `<path class="g_7t-kbfk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:camera-switch-24-filled" /></template>
<style>
.g_7t-kbfk {
  fill: currentColor;
