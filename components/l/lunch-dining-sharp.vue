...
const content = `<path class="smlo_xbvh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lunch-dining-sharp" /></template>
<style>
.smlo_xbvh {
  fill: currentColor;
