...
const content = `<path class="gjv2ufbgp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-wrap-16-regular" /></template>
<style>
.gjv2ufbgp {
  fill: currentColor;
