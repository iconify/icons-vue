...
const content = `<path class="wvr8hbq-j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:road-cone-48-regular" /></template>
<style>
.wvr8hbq-j {
  fill: currentColor;
