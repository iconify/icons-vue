...
const content = `<path class="nn3ac1cqt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-community-28-filled" /></template>
<style>
.nn3ac1cqt {
  fill: currentColor;
