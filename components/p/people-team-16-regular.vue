...
const content = `<path class="o6dvq4tlg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-team-16-regular" /></template>
<style>
.o6dvq4tlg {
  fill: currentColor;
