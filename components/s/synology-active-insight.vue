...
const content = `<path class="tsafl6fyb"/><path class="h_0eawbao"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:synology-active-insight" /></template>
<style>
.h_0eawbao {
  fill: none;
  stroke: currentColor;
