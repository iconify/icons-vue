...
const content = `<path class="uj4mckobf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-description-20-filled" /></template>
<style>
.uj4mckobf {
  fill: currentColor;
