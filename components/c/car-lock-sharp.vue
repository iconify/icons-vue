...
const content = `<path class="qpv0dqb4o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-lock-sharp" /></template>
<style>
.qpv0dqb4o {
  fill: currentColor;
