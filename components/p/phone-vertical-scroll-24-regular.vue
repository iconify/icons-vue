...
const content = `<path class="vy2q5cbgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:phone-vertical-scroll-24-regular" /></template>
<style>
.vy2q5cbgt {
  fill: currentColor;
