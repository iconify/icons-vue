...
const content = `<path class="om3tk-b1b"/><path class="duonj0bgt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-monitor-heart" /></template>
<style>
.duonj0bgt {
  fill: currentColor;
