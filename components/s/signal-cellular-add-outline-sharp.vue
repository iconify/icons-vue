...
const content = `<path class="ndzm86bff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-cellular-add-outline-sharp" /></template>
<style>
.ndzm86bff {
  fill: currentColor;
