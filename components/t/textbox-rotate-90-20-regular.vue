...
const content = `<path class="ts5bp40xz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:textbox-rotate-90-20-regular" /></template>
<style>
.ts5bp40xz {
  fill: currentColor;
