...
const content = `<path class="h-o-3wbzp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sync-arrow-up-outline-sharp" /></template>
<style>
.h-o-3wbzp {
  fill: currentColor;
