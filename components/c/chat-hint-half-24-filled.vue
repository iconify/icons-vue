...
const content = `<path class="ugxz4iqyu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-hint-half-24-filled" /></template>
<style>
.ugxz4iqyu {
  fill: currentColor;
