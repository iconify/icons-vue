...
const content = `<path class="v-wttzbqg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-car-parking-16-filled" /></template>
<style>
.v-wttzbqg {
  fill: currentColor;
