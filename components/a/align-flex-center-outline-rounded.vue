...
const content = `<path class="g5lhe3bci"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-flex-center-outline-rounded" /></template>
<style>
.g5lhe3bci {
  fill: currentColor;
