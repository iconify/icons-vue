...
const content = `<path class="kgdpbzf6v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pause-circle-32-regular" /></template>
<style>
.kgdpbzf6v {
  fill: currentColor;
