...
const content = `<path class="pqqs2obil"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-outbound-28-regular" /></template>
<style>
.pqqs2obil {
  fill: currentColor;
