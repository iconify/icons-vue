...
const content = `<path class="i-9-ffsho"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:wifi-warning-20-filled" /></template>
<style>
.i-9-ffsho {
  fill: currentColor;
