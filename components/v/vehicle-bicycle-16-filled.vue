...
const content = `<path class="t1gxjmbib"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-bicycle-16-filled" /></template>
<style>
.t1gxjmbib {
  fill: currentColor;
