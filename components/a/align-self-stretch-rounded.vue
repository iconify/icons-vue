...
const content = `<path class="ummve7m4n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:align-self-stretch-rounded" /></template>
<style>
.ummve7m4n {
  fill: currentColor;
