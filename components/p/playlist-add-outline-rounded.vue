...
const content = `<path class="mrt3vlhxk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:playlist-add-outline-rounded" /></template>
<style>
.mrt3vlhxk {
  fill: currentColor;
