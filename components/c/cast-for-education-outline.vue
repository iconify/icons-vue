...
const content = `<path class="v_l0cin_z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cast-for-education-outline" /></template>
<style>
.v_l0cin_z {
  fill: currentColor;
