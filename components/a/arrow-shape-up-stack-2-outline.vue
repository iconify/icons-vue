...
const content = `<path class="h-wy3ctco"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-shape-up-stack-2-outline" /></template>
<style>
.h-wy3ctco {
  fill: currentColor;
