...
const content = `<path class="x-kz1kb7j"/><path class="su4pyjmrq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:keycap-pound" /></template>
<style>
.su4pyjmrq {
