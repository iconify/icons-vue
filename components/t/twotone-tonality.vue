...
const content = `<path class="eitlbzbhj"/><path class="clg9lib4g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-tonality" /></template>
<style>
.clg9lib4g {
  fill: currentColor;
...
.eitlbzbhj {
  fill: currentColor;
  d: path("M4 12c0 4.08 3.06 7.44 7 7.93V4.07C7.05 4.56 4 7.92 4 12");
