...
const content = `<path class="k4n51fjcs"/><path class="xe8g9bcdr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-4mp" /></template>
<style>
.k4n51fjcs {
  fill: currentColor;
