...
const content = `<path class="qy8jnbufi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-quote-opening-24-regular" /></template>
<style>
.qy8jnbufi {
  fill: currentColor;
