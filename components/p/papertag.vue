...
const content = `<path class="k4p6i6_jw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:papertag" /></template>
<style>
.k4p6i6_jw {
  fill: none;
  stroke: currentColor;
