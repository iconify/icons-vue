...
const content = `<path class="s3dwq6a1f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-left-alt-rounded" /></template>
<style>
.s3dwq6a1f {
  fill: currentColor;
