...
const content = `<path class="ipqxf7afp"/><path class="pyl0xob3b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:ok-hand-dark-skin-tone" /></template>
<style>
.ipqxf7afp {
