...
const content = `<g class="nrj6p8qat"><path clip-rule="evenodd" class="bao7fobzx"/><path class="x4nuazbrz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-down-fill" /></template>
<style>
.bao7fobzx {
  fill: currentColor;
  fill-rule: evenodd;
