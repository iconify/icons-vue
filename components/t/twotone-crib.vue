...
const content = `<path class="rn2hrcb8h"/><path class="t3pdsjk6g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-crib" /></template>
<style>
.rn2hrcb8h {
  fill: currentColor;
