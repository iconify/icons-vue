...
const content = `<path class="apm7fmbfw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:mood-outline-sharp" /></template>
<style>
.apm7fmbfw {
  fill: currentColor;
