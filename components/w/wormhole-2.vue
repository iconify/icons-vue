...
const content = `<path class="cdzz7qbin"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wormhole-2" /></template>
<style>
.cdzz7qbin {
  fill: none;
  stroke: currentColor;
