...
const content = `<path class="q_7cqmb8i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shop" /></template>
<style>
.q_7cqmb8i {
  fill: currentColor;
