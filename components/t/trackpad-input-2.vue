...
const content = `<path class="zb3tvubva"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:trackpad-input-2" /></template>
<style>
.zb3tvubva {
  fill: currentColor;
