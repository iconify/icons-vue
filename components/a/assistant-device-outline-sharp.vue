...
const content = `<path class="ze-4j9byh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:assistant-device-outline-sharp" /></template>
<style>
.ze-4j9byh {
  fill: currentColor;
