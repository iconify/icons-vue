...
const content = `<path class="e_ndxk6ir"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-cell-center-arrow-repeat-all-20-regular" /></template>
<style>
.e_ndxk6ir {
  fill: currentColor;
