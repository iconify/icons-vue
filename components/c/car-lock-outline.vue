...
const content = `<path class="a51hfmbxe"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:car-lock-outline" /></template>
<style>
.a51hfmbxe {
  fill: currentColor;
