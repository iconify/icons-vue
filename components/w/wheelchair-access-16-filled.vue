...
const content = `<path class="ih6hz7bsl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:wheelchair-access-16-filled" /></template>
<style>
.ih6hz7bsl {
  fill: currentColor;
