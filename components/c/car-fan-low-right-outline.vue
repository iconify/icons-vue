...
const content = `<path class="p7j8ei-iv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:car-fan-low-right-outline" /></template>
<style>
.p7j8ei-iv {
  fill: currentColor;
