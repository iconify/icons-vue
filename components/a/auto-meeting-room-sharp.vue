...
const content = `<path class="hrmq_rpyu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-meeting-room-sharp" /></template>
<style>
.hrmq_rpyu {
  fill: currentColor;
