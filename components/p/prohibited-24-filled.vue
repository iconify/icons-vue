...
const content = `<path class="zexo25bub"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:prohibited-24-filled" /></template>
<style>
.zexo25bub {
  fill: currentColor;
