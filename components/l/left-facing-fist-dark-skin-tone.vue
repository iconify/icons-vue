...
const content = `<path class="ezdzcm5-f"/><defs><path id="SVGPedepbtP" class="us6dcifmo"/></defs><clipPath id="SVGOq0aqePL"><use href="#SVGPedepbtP"/></clipPath><g clip-path="url(#SVGOq0aqePL)" class="t_nvrsbrc"><path class="g6qubybib"/></g><defs><use href="#SVGPedepbtP" id="SVGVjsgUc5R"/></defs><clipPath id="SVGXRcECbgN"><use href="#SVGVjsgUc5R"/></clipPath><g clip-path="url(#SVGXRcECbgN)"><path class="gw7qssbko"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:left-facing-fist-dark-skin-tone" /></template>
<style>
.ezdzcm5-f {
