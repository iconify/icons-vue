...
const content = `<path class="p38e9t2yk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-chat-28-filled" /></template>
<style>
.p38e9t2yk {
  fill: currentColor;
