...
const content = `<path class="sjuhlacwr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-add-20-regular" /></template>
<style>
.sjuhlacwr {
  fill: currentColor;
