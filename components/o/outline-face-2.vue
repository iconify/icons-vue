...
const content = `<path class="u6qy7ib7v"/><circle class="ovf7eoehk"/><circle class="enfz85iyf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:outline-face-2" /></template>
<style>
.enfz85iyf {
  cx: 15px;
  cy: 14px;
