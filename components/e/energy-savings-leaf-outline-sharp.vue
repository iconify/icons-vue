...
const content = `<path class="gyt1m-sau"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:energy-savings-leaf-outline-sharp" /></template>
<style>
.gyt1m-sau {
  fill: currentColor;
