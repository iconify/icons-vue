...
const content = `<path class="bgqjm_bsi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bottom-drawer-rounded" /></template>
<style>
.bgqjm_bsi {
  fill: currentColor;
