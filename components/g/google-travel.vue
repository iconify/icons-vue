...
const content = `<path class="oml-jpbio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:google-travel" /></template>
<style>
.oml-jpbio {
  fill: currentColor;
