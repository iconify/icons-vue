...
const content = `<path class="gv3hcsb8h"/><path class="jh41v0x-q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-flag-vietnam" /></template>
<style>
.gv3hcsb8h {
