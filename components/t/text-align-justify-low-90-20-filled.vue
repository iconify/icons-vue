...
const content = `<path class="fe_k65rsf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-align-justify-low-90-20-filled" /></template>
<style>
.fe_k65rsf {
  fill: currentColor;
