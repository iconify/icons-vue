...
const content = `<path class="y2yux-nmm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:uppercase-outline" /></template>
<style>
.y2yux-nmm {
  fill: currentColor;
