...
const content = `<path class="g2pa121ot"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-insert-column-16-regular" /></template>
<style>
.g2pa121ot {
  fill: currentColor;
