...
const content = `<path class="rbnnzqnbj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:multiplier-1-2x-24-regular" /></template>
<style>
.rbnnzqnbj {
  fill: currentColor;
