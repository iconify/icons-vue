...
const content = `<path class="n8rvis0ty"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cooking-outline-sharp" /></template>
<style>
.n8rvis0ty {
  fill: currentColor;
