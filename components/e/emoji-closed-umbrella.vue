...
const content = `<path class="d068whgwt"/><path class="pm1nlrbra"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-closed-umbrella" /></template>
<style>
.d068whgwt {
  fill: none;
  stroke: currentColor;
