...
const content = `<path class="jl1y0-ohx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:5k-rounded" /></template>
<style>
.jl1y0-ohx {
  fill: currentColor;
