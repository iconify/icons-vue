...
const content = `<path class="w5z81cbgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:telegram-alt-3" /></template>
<style>
.w5z81cbgh {
  fill: none;
  stroke: currentColor;
