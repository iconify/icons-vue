...
const content = `<path class="xjtbevbpj"/><path class="ge6ieb12h"/><path class="jixhx7bvb"/><path class="ys3n3ybcv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-united-arab-emirates" /></template>
<style>
.ge6ieb12h {
