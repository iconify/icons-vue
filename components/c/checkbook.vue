...
const content = `<path class="wddddob_i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:checkbook" /></template>
<style>
.wddddob_i {
  fill: currentColor;
