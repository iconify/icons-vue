...
const viewBox = {"width":256,"height":549};
const content = `<path class="iuu6ccbvj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:mongodb-icon" /></template>
<style>
.iuu6ccbvj {
  fill: var(--svg-color--01ec64, #01ec64);
