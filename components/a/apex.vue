...
const content = `<g class="wxmhpabni"><path class="vz91m3bqh"/><path class="x56qe9a5b"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:apex" /></template>
<style>
.vz91m3bqh {
  d: path("m13.054 14.817l-.032.005a2.88 2.88 0 0 1-2.056 0c-.09-.032-.159.069-.095.127c.286.265.678.43 1.123.43c.414.005.816-.147 1.123-.425c.053-.053.01-.137-.058-.137z");
}
