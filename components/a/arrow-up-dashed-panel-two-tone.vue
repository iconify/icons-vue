...
const content = `<g class="nrj6p8qat"><path class="cdi5gyd-n"/><path class="iggkh_bss"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:arrow-up-dashed-panel-two-tone" /></template>
<style>
.cdi5gyd-n {
  stroke-opacity: 0.4;
