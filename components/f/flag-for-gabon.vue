...
const content = `<path class="md8dn8b1e"/><path class="ixk09fb2q"/><path class="en95f2bez"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:flag-for-gabon" /></template>
<style>
.en95f2bez {
