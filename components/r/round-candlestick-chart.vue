...
const content = `<path class="f_5a0zbup"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-candlestick-chart" /></template>
<style>
.f_5a0zbup {
  fill: currentColor;
