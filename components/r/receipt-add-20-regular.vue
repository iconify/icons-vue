...
const content = `<path class="pfwjfmk4y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:receipt-add-20-regular" /></template>
<style>
.pfwjfmk4y {
  fill: currentColor;
