...
const content = `<path class="iodn8n1ui"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sports-football-rounded" /></template>
<style>
.iodn8n1ui {
  fill: currentColor;
