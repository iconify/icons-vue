...
const content = `<path class="o_nzoyyms"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:watch-arrow-down" /></template>
<style>
.o_nzoyyms {
  fill: currentColor;
