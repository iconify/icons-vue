...
const content = `<g class="gp_8x1bzb"><path class="v8hgvi38z"/><path class="tst-wub6i"/><path class="unky6y77u"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:app-window-2-sharp-two-tone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
...
.tst-wub6i {
  d: path("M3 3L21 3L21 21L3 21L3 3ZM3 11L21 11");
}
