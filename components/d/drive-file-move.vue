...
const content = `<path class="imgsilb0a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:drive-file-move" /></template>
<style>
.imgsilb0a {
  fill: currentColor;
