...
const content = `<path class="zjv1i6b4b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:heart-pulse-checkmark-20-filled" /></template>
<style>
.zjv1i6b4b {
  fill: currentColor;
