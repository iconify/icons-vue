...
const content = `<path class="na6x-9bcj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:book-4-sharp" /></template>
<style>
.na6x-9bcj {
  fill: currentColor;
