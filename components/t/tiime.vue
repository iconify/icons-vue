...
const content = `<path class="sbu17bb-z"/><path class="te5mh9bkw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tiime" /></template>
<style>
.sbu17bb-z {
  fill: none;
  stroke: currentColor;
