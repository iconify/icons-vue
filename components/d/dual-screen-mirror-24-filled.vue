...
const content = `<path class="sidiglb1l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:dual-screen-mirror-24-filled" /></template>
<style>
.sidiglb1l {
  fill: currentColor;
