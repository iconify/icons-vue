...
const content = `<path class="zfj734knn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:switch-rounded" /></template>
<style>
.zfj734knn {
  fill: currentColor;
