...
const content = `<path class="rpzzcoben"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stylus-fountain-pen" /></template>
<style>
.rpzzcoben {
  fill: currentColor;
