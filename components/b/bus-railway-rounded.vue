...
const content = `<path class="x8_6wwdrb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bus-railway-rounded" /></template>
<style>
.x8_6wwdrb {
  fill: currentColor;
