...
const content = `<circle class="x18rz_cgq"/><path class="wd3-wrbbz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:smash-hit" /></template>
<style>
.wd3-wrbbz {
  fill: none;
  stroke: currentColor;
