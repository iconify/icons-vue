...
const content = `<path class="nwihhj7wq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cellular-4g-24-regular" /></template>
<style>
.nwihhj7wq {
  fill: currentColor;
