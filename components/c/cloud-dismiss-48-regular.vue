...
const content = `<path class="dqvsc_beb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cloud-dismiss-48-regular" /></template>
<style>
.dqvsc_beb {
  fill: currentColor;
