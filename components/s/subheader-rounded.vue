...
const content = `<path class="eze8esb1q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:subheader-rounded" /></template>
<style>
.eze8esb1q {
  fill: currentColor;
