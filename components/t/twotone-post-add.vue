...
const content = `<path class="bocyg_bwf"/><path class="fgi612zmg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-post-add" /></template>
<style>
.bocyg_bwf {
  fill: currentColor;
