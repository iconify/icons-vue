...
const content = `<path class="wxgsz3b5v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-position-tight-20-regular" /></template>
<style>
.wxgsz3b5v {
  fill: currentColor;
