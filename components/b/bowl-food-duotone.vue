...
const content = `<g class="cuyn6tgcc"><path class="dls66ke6w"/><path class="e0abrwbmi"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:bowl-food-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
