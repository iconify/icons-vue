...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:radar-sharp-fill" /></template>
<style>
.d-a_qsb5c {
  fill: currentColor;
