...
const content = `<circle class="cpk0fnbgt"/><path class="m2xv0jbxj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:banabikurye" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
