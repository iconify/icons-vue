...
const content = `<g class="to-5kdesz"><path class="e96rvjj3x"/><path class="g8c9o7bqu"/><path class="j25z1hbhu"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:vectorifydahome" /></template>
<style>
.e96rvjj3x {
