...
const content = `<path class="rd67d0buj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:heart-off-20-regular" /></template>
<style>
.rd67d0buj {
  fill: currentColor;
