...
const content = `<path class="s9z6bcl7p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-upload-16-filled" /></template>
<style>
.s9z6bcl7p {
  fill: currentColor;
