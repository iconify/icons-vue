...
const content = `<path class="iv-t7ybiy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:approvals-app-24-filled" /></template>
<style>
.iv-t7ybiy {
  fill: currentColor;
