...
const content = `<path class="ipkyw0bcm"/><path class="ll0g54h-q"/><path class="ffy9wj9eh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ap15" /></template>
<style>
.ffy9wj9eh {
  fill: none;
  stroke: currentColor;
