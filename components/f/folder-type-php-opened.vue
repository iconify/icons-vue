...
const content = `<defs><radialGradient id="SVGlxZqEdbh" cx="-10.216" cy="31.126" r="13.788" gradientTransform="translate(26.52 -9.307)" gradientUnits="userSpaceOnUse"><stop offset="0" class="vc--wpv5i"/><stop offset=".5" class="irf8jsb_m"/><stop offset="1" class="c0xyygbvy"/></radialGradient></defs><path class="cachzne7o"/><path class="zpri73opd"/><ellipse fill="url(#SVGlxZqEdbh)" class="kj_s6eibc"/><ellipse class="wue3pub_m"/><path class="jfcd7jbyz"/><path class="uv18ldbti"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-php-opened" /></template>
<style>
.c0xyygbvy {
...
.cachzne7o {
  fill: var(--svg-color--7a9edd, #7a9edd);
