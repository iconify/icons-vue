...
const content = `<path class="qc0h9jl8q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-circle-five-thin" /></template>
<style>
.qc0h9jl8q {
  fill: currentColor;
