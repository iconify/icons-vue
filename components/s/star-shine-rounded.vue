...
const content = `<path class="ew01ezb1t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:star-shine-rounded" /></template>
<style>
.ew01ezb1t {
  fill: currentColor;
