...
const content = `<path class="i78l8hb_m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:drive-train-24-filled" /></template>
<style>
.i78l8hb_m {
  fill: currentColor;
