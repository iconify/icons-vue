...
const content = `<path class="bio402fkf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bedtime-sharp" /></template>
<style>
.bio402fkf {
  fill: currentColor;
