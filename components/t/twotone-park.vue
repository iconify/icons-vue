...
const content = `<path class="l-_-r_b9l"/><path class="f-1v_4bkn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-park" /></template>
<style>
.f-1v_4bkn {
  fill: currentColor;
