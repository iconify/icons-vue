...
const content = `<path class="cw060zzjy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-usage-16-filled" /></template>
<style>
.cw060zzjy {
  fill: currentColor;
