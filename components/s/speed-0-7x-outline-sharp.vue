...
const content = `<path class="iamn3mbzt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:speed-0-7x-outline-sharp" /></template>
<style>
.iamn3mbzt {
  fill: currentColor;
