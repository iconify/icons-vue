...
const content = `<path class="apq22h2te"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:pen-prohibited-16-filled" /></template>
<style>
.apq22h2te {
  fill: currentColor;
