...
const content = `<path class="vv867cbcu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:remix-add-24-regular" /></template>
<style>
.vv867cbcu {
  fill: currentColor;
