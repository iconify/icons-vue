...
const content = `<path class="w_ti6-6pj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:on-hub-device-rounded" /></template>
<style>
.w_ti6-6pj {
  fill: currentColor;
