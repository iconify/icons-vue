...
const content = `<path class="gvyifzbnn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:security-update-warning-rounded" /></template>
<style>
.gvyifzbnn {
  fill: currentColor;
