...
const content = `<path class="dsdj-_-um"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cinematic-blur-sharp" /></template>
<style>
.dsdj-_-um {
  fill: currentColor;
