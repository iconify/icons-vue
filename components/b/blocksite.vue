...
const content = `<path class="vmz7id66t"/><path class="c4j_j8e-u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:blocksite" /></template>
<style>
.c4j_j8e-u {
  fill: none;
  stroke: currentColor;
