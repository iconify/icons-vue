...
const content = `<path class="p56parbvc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:widget-small-rounded" /></template>
<style>
.p56parbvc {
  fill: currentColor;
