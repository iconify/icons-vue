...
const content = `<path class="jf1kn6b-i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:help-outline-rounded" /></template>
<style>
.jf1kn6b-i {
  fill: currentColor;
