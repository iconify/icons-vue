...
const content = `<g class="cuyn6tgcc"><path class="r_an0kbes"/><path class="eehh-mbfy"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:translate-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
