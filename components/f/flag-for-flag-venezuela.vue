...
const content = `<path class="bpn-oncsg"/><path class="pk07sfbhl"/><path class="u7es78bok"/><path class="kmhnvub0y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:flag-for-flag-venezuela" /></template>
<style>
.bpn-oncsg {
