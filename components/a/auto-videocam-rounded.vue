...
const content = `<path class="oojm7obqz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-videocam-rounded" /></template>
<style>
.oojm7obqz {
  fill: currentColor;
