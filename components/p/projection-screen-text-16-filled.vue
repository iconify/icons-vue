...
const content = `<path class="om1m661zx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:projection-screen-text-16-filled" /></template>
<style>
.om1m661zx {
  fill: currentColor;
