...
const content = `<path class="af0et-rhi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:screenshot-keyboard" /></template>
<style>
.af0et-rhi {
  fill: currentColor;
