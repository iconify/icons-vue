...
const content = `<g class="nrj6p8qat"><path class="esurwb5xo"/><path class="c7--g1yoy"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-dashed-check-two-tone" /></template>
<style>
.c7--g1yoy {
