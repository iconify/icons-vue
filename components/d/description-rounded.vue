...
const content = `<path class="o047_ie0t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:description-rounded" /></template>
<style>
.o047_ie0t {
  fill: currentColor;
