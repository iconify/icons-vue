...
const content = `<path class="adixkuwvs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:rema1000-ae" /></template>
<style>
.adixkuwvs {
  fill: none;
  stroke: currentColor;
