...
const content = `<path class="o-71y9zkf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:conditions-outline-rounded" /></template>
<style>
.o-71y9zkf {
  fill: currentColor;
