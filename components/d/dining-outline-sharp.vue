...
const content = `<path class="gpkdytt-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:dining-outline-sharp" /></template>
<style>
.gpkdytt-g {
  fill: currentColor;
