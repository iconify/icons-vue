...
const content = `<path class="i9jam6rid"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:clock-loader-40-outline-rounded" /></template>
<style>
.i9jam6rid {
  fill: currentColor;
