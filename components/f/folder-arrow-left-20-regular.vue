...
const content = `<path class="tro-soooh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:folder-arrow-left-20-regular" /></template>
<style>
.tro-soooh {
  fill: currentColor;
