...
const content = `<g class="cuyn6tgcc"><path class="c9epvhehk"/><path class="tiu0tzxno"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:caret-circle-double-right-duotone" /></template>
<style>
.c9epvhehk {
