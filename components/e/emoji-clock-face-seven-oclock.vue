...
const content = `<path class="nbr93-b5k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-clock-face-seven-oclock" /></template>
<style>
.nbr93-b5k {
  fill: none;
  stroke: currentColor;
