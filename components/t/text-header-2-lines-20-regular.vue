...
const content = `<path class="h4n906b7g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-header-2-lines-20-regular" /></template>
<style>
.h4n906b7g {
  fill: currentColor;
