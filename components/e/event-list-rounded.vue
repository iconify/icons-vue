...
const content = `<path class="ty6q-xmmf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:event-list-rounded" /></template>
<style>
.ty6q-xmmf {
  fill: currentColor;
