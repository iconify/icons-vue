...
const content = `<path class="f-7ekin3q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:video-template-rounded" /></template>
<style>
.f-7ekin3q {
  fill: currentColor;
