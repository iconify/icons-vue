...
const content = `<g class="cuyn6tgcc"><path class="oe27r3bdg"/><path class="m4nmkdiav"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:scan-smiley-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.oe27r3bdg {
  d: path("M192 128a64 64 0 1 1-64-64a64 64 0 0 1 64 64");
