...
const content = `<path class="tvp1plywv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:receipt-sharp" /></template>
<style>
.tvp1plywv {
  fill: currentColor;
