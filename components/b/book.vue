...
const content = `<path class="ugpyrh4-u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:book" /></template>
<style>
.ugpyrh4-u {
  fill: currentColor;
