...
const content = `<path class="m7c8librf"/><path class="m61p2sb6q"/><circle class="i41e6pm1x"/><circle class="icc3mmbjf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-directions-car-filled" /></template>
<style>
.i41e6pm1x {
  cx: 7.5px;
  cy: 14.5px;
