...
const content = `<path class="zscod1qqs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:lte-plus-mobiledata-badge-outline-sharp" /></template>
<style>
.zscod1qqs {
  fill: currentColor;
