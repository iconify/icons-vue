...
const content = `<path class="da-qxv46o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-code-24-regular" /></template>
<style>
.da-qxv46o {
  fill: currentColor;
