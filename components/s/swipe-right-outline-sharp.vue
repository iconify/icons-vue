...
const content = `<path class="lar6bxpdr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:swipe-right-outline-sharp" /></template>
<style>
.lar6bxpdr {
  fill: currentColor;
