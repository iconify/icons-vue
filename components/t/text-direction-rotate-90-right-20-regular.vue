...
const content = `<path class="isujp2byr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-direction-rotate-90-right-20-regular" /></template>
<style>
.isujp2byr {
  fill: currentColor;
