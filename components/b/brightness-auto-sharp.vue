...
const content = `<path class="hdpuqpbhy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:brightness-auto-sharp" /></template>
<style>
.hdpuqpbhy {
  fill: currentColor;
