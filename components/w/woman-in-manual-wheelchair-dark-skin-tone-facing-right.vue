...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="openmoji:woman-in-manual-wheelchair-dark-skin-tone-facing-right" /></template>
