...
const content = `<g class="gp_8x1bzb"><path class="hw_sn9wmj"/><path class="sd8cfcjbo"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:divide-sharp-two-tone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
