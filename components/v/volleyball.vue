...
const content = `<circle class="iv3e9x1ye"/><path class="oq2aihnvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:volleyball" /></template>
<style>
.iv3e9x1ye {
  cx: 32px;
  cy: 32px;
