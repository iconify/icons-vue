...
const content = `<path class="ww-_ssp6x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fan-indirect-outline-sharp" /></template>
<style>
.ww-_ssp6x {
  fill: currentColor;
