...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVG8JipGcrB)" clip-rule="evenodd" class="pxnd9zbul"/><defs><linearGradient id="SVG8JipGcrB" x1="18.203" x2="6.199" y1="5.452" y2="18.956" gradientUnits="userSpaceOnUse"><stop class="ce3mtpr9y"/><stop offset="1" class="j9z38lb5y"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:hop" /></template>
<style>
.ce3mtpr9y {
  stop-color: var(--svg-color--e995a5, #e995a5);
}
