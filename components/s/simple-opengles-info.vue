...
const content = `<rect class="j3s9ivbxi"/><path class="splyi9b6c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:simple-opengles-info" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
