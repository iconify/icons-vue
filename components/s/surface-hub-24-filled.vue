...
const content = `<path class="w_--arb2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:surface-hub-24-filled" /></template>
<style>
.w_--arb2k {
  fill: currentColor;
