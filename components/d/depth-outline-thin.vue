...
const content = `<g class="hntgybcog"><path class="naxvjtbgo"/><path class="csk4szidm"/><path class="efg_y9-xm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:depth-outline-thin" /></template>
<style>
.csk4szidm {
