...
const content = `<g class="cuyn6tgcc"><path class="eqhvg30_b"/><path class="k313bdcct"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:baseball-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.eqhvg30_b {
  d: path("M60.66 59.58A95.74 95.74 0 0 1 89.33 128a95.74 95.74 0 0 1-28.67 68.42a96 96 0 0 1 0-136.84m134.68 0a96 96 0 0 0 0 136.84a96 96 0 0 0 0-136.84");
