...
const content = `<path class="qoxxc_3ns"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:window-fingerprint-48-filled" /></template>
<style>
.qoxxc_3ns {
  fill: currentColor;
