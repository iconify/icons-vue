...
const content = `<path class="x1btavumy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:aod-watch-rounded" /></template>
<style>
.x1btavumy {
  fill: currentColor;
