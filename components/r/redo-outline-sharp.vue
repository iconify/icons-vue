...
const content = `<path class="t4kj9iv0y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:redo-outline-sharp" /></template>
<style>
.t4kj9iv0y {
  fill: currentColor;
