...
const content = `<path class="rn6gpsbsi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:inbox-text-share-outline-sharp" /></template>
<style>
.rn6gpsbsi {
  fill: currentColor;
