...
const content = `<circle class="mmn7xsb7v"/><circle class="an0_1xo_x"/><path class="i29omnb3v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-sentiment-slightly-dissatisfied" /></template>
<style>
.an0_1xo_x {
  cx: 8.5px;
  cy: 9.5px;
