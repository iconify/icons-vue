...
const content = `<path class="htek8ib0l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:roller-shades-closed-rounded" /></template>
<style>
.htek8ib0l {
  fill: currentColor;
