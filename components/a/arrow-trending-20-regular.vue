...
const content = `<path class="vct-vqb1u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-trending-20-regular" /></template>
<style>
.vct-vqb1u {
  fill: currentColor;
