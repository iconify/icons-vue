...
const content = `<g class="cuyn6tgcc"><path class="bod25nbdw"/><path class="xoen9sl1a"/><path class="cf7y0id-t"/><path class="t_21e8bxb"/><path class="ye3p08btn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:expand-off" /></template>
<style>
.bod25nbdw {
