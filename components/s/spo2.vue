...
const content = `<path class="fhhrm3bjn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:spo2" /></template>
<style>
.fhhrm3bjn {
  fill: currentColor;
