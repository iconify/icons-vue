...
const content = `<rect class="j3s9ivbxi"/><path class="qfurlsp6q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hueber" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
