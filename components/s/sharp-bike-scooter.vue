...
const content = `<path class="j8z7zsurq"/><path class="e74ny5-wq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-bike-scooter" /></template>
<style>
.e74ny5-wq {
  fill: currentColor;
