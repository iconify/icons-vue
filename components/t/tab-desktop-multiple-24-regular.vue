...
const content = `<path class="fmed_jhqq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-desktop-multiple-24-regular" /></template>
<style>
.fmed_jhqq {
  fill: currentColor;
