...
const content = `<path class="vrwasgj1m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:video-person-20-regular" /></template>
<style>
.vrwasgj1m {
  fill: currentColor;
