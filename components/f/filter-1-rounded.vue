...
const content = `<path class="g7qne5bah"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:filter-1-rounded" /></template>
<style>
.g7qne5bah {
  fill: currentColor;
