...
const content = `<path class="fyk0bsbbh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dropdown-menu-outline-sharp" /></template>
<style>
.fyk0bsbbh {
  fill: currentColor;
