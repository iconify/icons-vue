...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:grip-horizontal-sharp-two-tone" /></template>
<style>
.l7smbpbll {
  fill: none;
  stroke: currentColor;
