...
const content = `<path class="ipf505wgl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:panel-left-key-20-regular" /></template>
<style>
.ipf505wgl {
  fill: currentColor;
