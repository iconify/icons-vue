...
const content = `<path class="xf7dyrd6k"/><path class="x71uk_lzd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-sd-storage" /></template>
<style>
.x71uk_lzd {
  fill: currentColor;
