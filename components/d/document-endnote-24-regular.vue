...
const content = `<path class="qwtsqcb-g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-endnote-24-regular" /></template>
<style>
.qwtsqcb-g {
  fill: currentColor;
