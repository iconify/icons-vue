...
const content = `<path class="y4229qbtr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:picture-in-picture-20-filled" /></template>
<style>
.y4229qbtr {
  fill: currentColor;
