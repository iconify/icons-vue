...
const content = `<path class="a49ejbr7v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:explicit-outline" /></template>
<style>
.a49ejbr7v {
  fill: currentColor;
