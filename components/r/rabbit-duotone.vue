...
const content = `<g class="cuyn6tgcc"><path class="kox_n_bzq"/><path class="yy4-toboz"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:rabbit-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
