...
const content = `<path class="pp0_cqytz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-arrow-forward-16-regular" /></template>
<style>
.pp0_cqytz {
  fill: currentColor;
