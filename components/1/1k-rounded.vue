...
const content = `<path class="a7af6_qdx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:1k-rounded" /></template>
<style>
.a7af6_qdx {
  fill: currentColor;
