...
const content = `<path class="h4ppbtbxb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:notification-sound-outline" /></template>
<style>
.h4ppbtbxb {
  fill: currentColor;
