...
const content = `<path class="d8gz63b1a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:nfc-sharp" /></template>
<style>
.d8gz63b1a {
  fill: currentColor;
