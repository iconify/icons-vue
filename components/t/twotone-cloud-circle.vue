...
const content = `<path class="hpv118t4f"/><path class="iiz6xs8_q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-cloud-circle" /></template>
<style>
.hpv118t4f {
  fill: currentColor;
  d: path("M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8s8-3.59 8-8s-3.59-8-8-8m4.08 12H8.5a3.5 3.5 0 0 1-.38-6.98a4.373 4.373 0 0 1 8.17 1.16c1.52.1 2.71 1.35 2.71 2.89c0 1.62-1.31 2.93-2.92 2.93");
