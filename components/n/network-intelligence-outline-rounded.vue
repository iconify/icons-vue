...
const content = `<path class="jx6b6n51q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:network-intelligence-outline-rounded" /></template>
<style>
.jx6b6n51q {
  fill: currentColor;
