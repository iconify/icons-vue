...
const content = `<path class="oof-8hbia"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:battery-0-24-regular" /></template>
<style>
.oof-8hbia {
  fill: currentColor;
