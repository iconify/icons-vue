...
const content = `<path class="za0awc-_y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:diversity-4-outline-rounded" /></template>
<style>
.za0awc-_y {
  fill: currentColor;
