...
const content = `<path class="ukm78lbnm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:sound-wave-circle-sparkle-16-regular" /></template>
<style>
.ukm78lbnm {
  fill: currentColor;
