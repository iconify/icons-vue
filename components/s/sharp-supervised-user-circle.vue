...
const content = `<path class="ly_vxmb2g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-supervised-user-circle" /></template>
<style>
.ly_vxmb2g {
  fill: currentColor;
