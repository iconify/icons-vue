...
const content = `<path class="k8pf8rbky"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:high-density-sharp" /></template>
<style>
.k8pf8rbky {
  fill: currentColor;
