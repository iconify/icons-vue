...
const content = `<path class="htl0zgbui"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:top-panel-open-outline" /></template>
<style>
.htl0zgbui {
  fill: currentColor;
