...
const content = `<path class="wipc3lbbs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:photo-album-outline-rounded" /></template>
<style>
.wipc3lbbs {
  fill: currentColor;
