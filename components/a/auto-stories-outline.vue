...
const content = `<path class="ethxbpbme"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:auto-stories-outline" /></template>
<style>
.ethxbpbme {
  fill: currentColor;
