...
const content = `<path clip-rule="evenodd" class="va52lqbjn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:xcur" /></template>
<style>
.va52lqbjn {
