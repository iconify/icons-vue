...
const content = `<path class="ghovbkb2m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:payments-outline-sharp" /></template>
<style>
.ghovbkb2m {
  fill: currentColor;
