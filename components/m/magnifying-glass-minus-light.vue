...
const content = `<path class="q3giucb_d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:magnifying-glass-minus-light" /></template>
<style>
.q3giucb_d {
  fill: currentColor;
