...
const content = `<path class="rw-2skh8u"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dott" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
