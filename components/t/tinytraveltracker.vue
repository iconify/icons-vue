...
const content = `<path class="mupu_lt-a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tinytraveltracker" /></template>
<style>
.mupu_lt-a {
  fill: none;
  stroke: currentColor;
