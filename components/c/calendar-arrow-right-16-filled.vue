...
const content = `<path class="p2sx2acrs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-arrow-right-16-filled" /></template>
<style>
.p2sx2acrs {
  fill: currentColor;
