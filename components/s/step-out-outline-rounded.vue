...
const content = `<path class="f4v234bye"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:step-out-outline-rounded" /></template>
<style>
.f4v234bye {
  fill: currentColor;
