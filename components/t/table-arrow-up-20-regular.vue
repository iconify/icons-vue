...
const content = `<path class="si--6depy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-arrow-up-20-regular" /></template>
<style>
.si--6depy {
  fill: currentColor;
