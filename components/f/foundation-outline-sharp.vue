...
const content = `<path class="zs7y_jbbu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:foundation-outline-sharp" /></template>
<style>
.zs7y_jbbu {
  fill: currentColor;
