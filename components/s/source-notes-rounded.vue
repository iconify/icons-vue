...
const content = `<path class="rvcw8ub0g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:source-notes-rounded" /></template>
<style>
.rvcw8ub0g {
  fill: currentColor;
