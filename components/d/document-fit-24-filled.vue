...
const content = `<path class="jn0o60oxr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-fit-24-filled" /></template>
<style>
.jn0o60oxr {
  fill: currentColor;
