...
const content = `<g class="nrj6p8qat"><path class="dl2nz2boo"/><path class="jfp2fyuan"/><path class="g7ycs1b4z"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:table-cells-rows-duotone" /></template>
<style>
.dl2nz2boo {
  fill: currentColor;
