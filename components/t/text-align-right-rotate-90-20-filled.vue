...
const content = `<path class="u5a7uknyw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-align-right-rotate-90-20-filled" /></template>
<style>
.u5a7uknyw {
  fill: currentColor;
