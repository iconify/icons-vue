...
const content = `<path class="lcer-f6nb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:circle-notifications-rounded" /></template>
<style>
.lcer-f6nb {
  fill: currentColor;
