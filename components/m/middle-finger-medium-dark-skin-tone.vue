...
const content = `<path class="yup_hy08g"/><path class="sktk5k4fp"/><path class="y_f4exs-i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:middle-finger-medium-dark-skin-tone" /></template>
<style>
.sktk5k4fp {
