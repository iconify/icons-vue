...
const content = `<path class="zhmv_vbnb"/><path class="vpskdnb8d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:wolfie-for-kwgt" /></template>
<style>
.vpskdnb8d {
  fill: none;
  stroke: currentColor;
