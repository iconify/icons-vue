...
const content = `<path class="j69wvqbjk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:detector-battery-rounded" /></template>
<style>
.j69wvqbjk {
  fill: currentColor;
