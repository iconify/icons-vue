...
const content = `<path class="q8gmxpb2w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:text-compare-outline" /></template>
<style>
.q8gmxpb2w {
  fill: currentColor;
