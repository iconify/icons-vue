...
const content = `<path class="uz-edsg6y"/><circle class="tbb72rihx"/><path class="vk1e_ukdu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:speaker-group" /></template>
<style>
.tbb72rihx {
  cx: 14px;
  cy: 12.5px;
