...
const content = `<path class="g9t215bex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wifi-lock-outline-rounded" /></template>
<style>
.g9t215bex {
  fill: currentColor;
