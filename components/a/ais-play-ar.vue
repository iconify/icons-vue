...
const content = `<path class="w0tefxwua"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ais-play-ar" /></template>
<style>
.w0tefxwua {
  fill: none;
  stroke: currentColor;
