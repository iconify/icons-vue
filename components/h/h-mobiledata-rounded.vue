...
const content = `<path class="q2_7hdbuo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:h-mobiledata-rounded" /></template>
<style>
.q2_7hdbuo {
  fill: currentColor;
