...
const content = `<path class="tdmomhoym"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-flow-up-right-20-regular" /></template>
<style>
.tdmomhoym {
  fill: currentColor;
