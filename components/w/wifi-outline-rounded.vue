...
const content = `<path class="cylksib5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wifi-outline-rounded" /></template>
<style>
.cylksib5x {
  fill: currentColor;
