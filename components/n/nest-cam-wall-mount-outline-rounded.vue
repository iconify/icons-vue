...
const content = `<path class="vrjlm83yo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:nest-cam-wall-mount-outline-rounded" /></template>
<style>
.vrjlm83yo {
  fill: currentColor;
