...
const content = `<path class="z1uszrb8v"/><path class="q0vmbubqv"/><circle class="ux5xnzb2o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sbanken" /></template>
<style>
.q0vmbubqv {
  fill: none;
  stroke: currentColor;
