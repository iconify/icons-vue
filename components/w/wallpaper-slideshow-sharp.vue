...
const content = `<path class="w-oqgfb5p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wallpaper-slideshow-sharp" /></template>
<style>
.w-oqgfb5p {
  fill: currentColor;
