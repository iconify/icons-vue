...
const content = `<path class="tjw58cf0k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:check-box" /></template>
<style>
.tjw58cf0k {
  fill: currentColor;
