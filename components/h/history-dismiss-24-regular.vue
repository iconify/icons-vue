...
const content = `<path class="nwbgh2jfx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:history-dismiss-24-regular" /></template>
<style>
.nwbgh2jfx {
  fill: currentColor;
