...
const content = `<path class="efxhy9ekf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:storefront-outline-sharp" /></template>
<style>
.efxhy9ekf {
  fill: currentColor;
