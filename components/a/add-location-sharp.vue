...
const content = `<path class="dturrabwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:add-location-sharp" /></template>
<style>
.dturrabwk {
  fill: currentColor;
