...
const viewBox = {"width":256,"height":372};
const content = `<defs><linearGradient id="SVGXZk54C4L" x1="32.157%" x2="70.686%" y1="46.417%" y2="49.75%"><stop offset="0%" class="oxxv4vb-r"/><stop offset="100%" class="rqv-3-lfl"/></linearGradient><linearGradient id="SVGDR93EbVL" x1="53.539%" x2="53.539%" y1="68.101%" y2="19.969%"><stop offset="0%" class="n1r15jqdn"/><stop offset="100%" class="dzp654dku"/></linearGradient></defs><g class="bi12bsetm"><path class="rd95xqqsg"/><path class="kbmzzbtfi"/><path class="c38j9yiqr"/><path fill="url(#SVGXZk54C4L)" class="uj7iadb5m"/><path fill="url(#SVGDR93EbVL)" class="g5xqorbmv"/><path class="lzou6ob0y"/><path class="rrjddkb8g"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="logos:madge" /></template>
<style>
.bi12bsetm {
  fill: none;
  fill-rule: evenodd;
...
.c38j9yiqr {
  ...
  fill-opacity: var(--svg-fill-opacity--0-498, 0.498);
  fill-rule: nonzero;
  d: path("m56.92 0l132.569 283.122H0z");
}
...
.g5xqorbmv {
  fill-rule: nonzero;
  d: path("M26.541 263.876L66.234 61.131l64.732 146.563l67.052-146.563l35.663 202.745h-29.19l-18.198-113.83l-55.815 122.502L76.25 149.924L55.976 263.876z");
}
...
.kbmzzbtfi {
  ...
  fill-opacity: var(--svg-fill-opacity--0-498, 0.498);
  fill-rule: nonzero;
  d: path("M205.037 0L70.092 283.122h184.422z");
}
...
.lzou6ob0y {
  ...
  d: path("m44.666 243.948l24.739-133.313m59.784 124.38L70.092 107.198m61.846 126.44l60.471-126.44m22.677 139.497L192.41 109.948");
}
