...
const content = `<path class="a3zn7sniy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-trending-down-24-regular" /></template>
<style>
.a3zn7sniy {
  fill: currentColor;
