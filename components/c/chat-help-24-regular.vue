...
const content = `<path class="sxuj6ac0d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-help-24-regular" /></template>
<style>
.sxuj6ac0d {
  fill: currentColor;
