...
const content = `<g class="cuyn6tgcc"><path class="zf53l6jjo"/><path class="ryyojvbpx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:brackets-curly-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
