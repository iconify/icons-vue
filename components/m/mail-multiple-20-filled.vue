...
const content = `<path class="i-qw-8ufy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-multiple-20-filled" /></template>
<style>
.i-qw-8ufy {
  fill: currentColor;
