...
const content = `<path class="isqhm7pey"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:work-alert-outline-sharp" /></template>
<style>
.isqhm7pey {
  fill: currentColor;
