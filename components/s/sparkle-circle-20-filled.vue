...
const content = `<path class="if73uecch"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:sparkle-circle-20-filled" /></template>
<style>
.if73uecch {
  fill: currentColor;
