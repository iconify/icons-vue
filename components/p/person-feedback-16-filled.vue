...
const content = `<path class="y6jrj2-vw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-feedback-16-filled" /></template>
<style>
.y6jrj2-vw {
  fill: currentColor;
