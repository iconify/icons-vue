...
const content = `<path class="gvqno2bta"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:combine-columns-outline" /></template>
<style>
.gvqno2bta {
  fill: currentColor;
