...
const content = `<path class="jp38irr4c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:tour-rounded" /></template>
<style>
.jp38irr4c {
  fill: currentColor;
