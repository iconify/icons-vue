...
const content = `<path class="l8ay8_bvk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:carpenter-outline-sharp" /></template>
<style>
.l8ay8_bvk {
  fill: currentColor;
