...
const content = `<path class="o6yo74w6f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shield-radar-rounded" /></template>
<style>
.o6yo74w6f {
  fill: currentColor;
