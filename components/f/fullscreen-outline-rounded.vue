...
const content = `<path class="p_whw_npp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:fullscreen-outline-rounded" /></template>
<style>
.p_whw_npp {
  fill: currentColor;
