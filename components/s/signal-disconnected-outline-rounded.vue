...
const content = `<path class="wlb7pacvf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:signal-disconnected-outline-rounded" /></template>
<style>
.wlb7pacvf {
  fill: currentColor;
