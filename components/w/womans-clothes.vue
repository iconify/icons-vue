...
const content = `<path class="x0lt-ucdq"/><path class="vxrk24b1h"/><circle class="om286uf9u"/><circle class="v9g0m3i6c"/><circle class="bkp0-vbll"/><circle class="a31j8z5ph"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto-v1:womans-clothes" /></template>
<style>
.a31j8z5ph {
  cx: 63.69px;
  cy: 30.91px;
