...
const content = `<path class="ddak7ribv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:acute-sharp" /></template>
<style>
.ddak7ribv {
  fill: currentColor;
