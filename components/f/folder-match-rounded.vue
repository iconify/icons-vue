...
const content = `<path class="slije_s0z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:folder-match-rounded" /></template>
<style>
.slije_s0z {
  fill: currentColor;
