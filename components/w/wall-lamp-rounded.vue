...
const content = `<path class="bi8hwbbyz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wall-lamp-rounded" /></template>
<style>
.bi8hwbbyz {
  fill: currentColor;
