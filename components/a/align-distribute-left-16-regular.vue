...
const content = `<path class="knd8u6ctl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-distribute-left-16-regular" /></template>
<style>
.knd8u6ctl {
  fill: currentColor;
