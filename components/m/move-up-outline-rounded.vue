...
const content = `<path class="xpssr0tyn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:move-up-outline-rounded" /></template>
<style>
.xpssr0tyn {
  fill: currentColor;
