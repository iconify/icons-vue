...
const content = `<path class="ordolsvaj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:equal-rounded" /></template>
<style>
.ordolsvaj {
  fill: currentColor;
