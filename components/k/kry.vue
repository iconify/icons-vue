...
const content = `<path class="i9clfwm2k"/><path class="ztz4g0brl"/><path class="kg7g4brju"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kry" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
