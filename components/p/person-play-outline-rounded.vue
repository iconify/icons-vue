...
const content = `<path class="rrzrf09tl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:person-play-outline-rounded" /></template>
<style>
.rrzrf09tl {
  fill: currentColor;
