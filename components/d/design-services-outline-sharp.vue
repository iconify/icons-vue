...
const content = `<path class="b2ybd5boy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:design-services-outline-sharp" /></template>
<style>
.b2ybd5boy {
  fill: currentColor;
