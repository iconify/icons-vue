...
const content = `<path class="aidf5hw7v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-pest-control-rodent" /></template>
<style>
.aidf5hw7v {
  fill: currentColor;
