...
const content = `<path class="wozpn8uvp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sync-arrow-down-outline-rounded" /></template>
<style>
.wozpn8uvp {
  fill: currentColor;
