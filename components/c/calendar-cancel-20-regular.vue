...
const content = `<path class="epge9b1xk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-cancel-20-regular" /></template>
<style>
.epge9b1xk {
  fill: currentColor;
