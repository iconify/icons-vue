...
const content = `<path class="ekqt4sbys"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:newspaper-outline-sharp" /></template>
<style>
.ekqt4sbys {
  fill: currentColor;
