...
const content = `<g class="cuyn6tgcc"><path class="tz5ml6k-l"/><path class="xd5t7mhnl"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:axe-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
