...
const content = `<g class="nrj6p8qat"><path class="naqffhgja"/><path class="te51ribhu"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:table-columns-add-after-two-tone" /></template>
<style>
.naqffhgja {
  fill: currentColor;
