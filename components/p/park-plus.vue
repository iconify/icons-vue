...
const content = `<path class="fbeui6bcs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:park-plus" /></template>
<style>
.fbeui6bcs {
  fill: none;
  stroke: currentColor;
