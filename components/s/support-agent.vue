...
const content = `<path class="vkh56sbmc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:support-agent" /></template>
<style>
.vkh56sbmc {
  fill: currentColor;
