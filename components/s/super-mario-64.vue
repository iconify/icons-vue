...
const content = `<path class="mthcamv9k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:super-mario-64" /></template>
<style>
.mthcamv9k {
  fill: none;
  stroke: currentColor;
