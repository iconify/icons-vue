...
const content = `<path class="y5hcskbnp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-vertical-align-bottom" /></template>
<style>
.y5hcskbnp {
  fill: currentColor;
