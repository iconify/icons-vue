...
const content = `<path class="gjr0kx_vs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:gitlab-logo-simple-light" /></template>
<style>
.gjr0kx_vs {
  fill: currentColor;
