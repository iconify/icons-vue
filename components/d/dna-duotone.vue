...
const content = `<g class="cuyn6tgcc"><path class="tvt187bty"/><path class="x4gemzb1h"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:dna-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.tvt187bty {
  d: path("M103.8 140.1L128 128l24.2 12.1a72 72 0 0 1 39.8 64.4v3.5H64v-3.5a72 72 0 0 1 39.8-64.4M192 51.5V48H64v3.5a72 72 0 0 0 39.8 64.4L128 128l24.2-12.1A72 72 0 0 0 192 51.5");
