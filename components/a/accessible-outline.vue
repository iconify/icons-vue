...
const content = `<path class="l91qxu9ho"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:accessible-outline" /></template>
<style>
.l91qxu9ho {
  fill: currentColor;
