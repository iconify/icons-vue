...
const content = `<path class="mokjfgb8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sentiment-sad-rounded" /></template>
<style>
.mokjfgb8v {
  fill: currentColor;
