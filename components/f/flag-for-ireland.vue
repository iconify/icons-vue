...
const content = `<path class="zzyf9-41q"/><path class="gq4nsy2sh"/><path class="wr7djrcrn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-ireland" /></template>
<style>
.gq4nsy2sh {
