...
const content = `<path class="cm7cgpbyb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:wb-iridescent-sharp" /></template>
<style>
.cm7cgpbyb {
  fill: currentColor;
