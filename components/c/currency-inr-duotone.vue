...
const content = `<g class="cuyn6tgcc"><path class="tqk8w9e4n"/><path class="lwn910y7g"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:currency-inr-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
