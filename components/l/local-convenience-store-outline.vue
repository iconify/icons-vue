...
const content = `<path class="uiam52bhp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:local-convenience-store-outline" /></template>
<style>
.uiam52bhp {
  fill: currentColor;
