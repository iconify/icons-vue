...
const content = `<path class="iw5c1ma2a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:blur-linear-outline-rounded" /></template>
<style>
.iw5c1ma2a {
  fill: currentColor;
