...
const content = `<path class="grsl7zb_i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-emoji-emotions" /></template>
<style>
.grsl7zb_i {
  fill: currentColor;
