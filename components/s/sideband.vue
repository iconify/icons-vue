...
const content = `<path class="dg_12jbat"/><path class="he0znwbih"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:sideband" /></template>
<style>
.dg_12jbat {
  fill: none;
  stroke: currentColor;
