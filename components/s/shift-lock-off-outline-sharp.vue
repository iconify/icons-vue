...
const content = `<path class="qyyfb_oki"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shift-lock-off-outline-sharp" /></template>
<style>
.qyyfb_oki {
  fill: currentColor;
