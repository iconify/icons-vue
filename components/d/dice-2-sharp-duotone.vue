...
const content = `<g class="cuyn6tgcc"><path class="l6fbk-bit"/><path class="xgkzoactd"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:dice-2-sharp-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
