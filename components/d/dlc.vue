...
const content = `<g class="ft5dv1b6b"><path fill="url(#SVGFTmYVdBo)" clip-rule="evenodd" class="qpa80pz-v"/><defs><linearGradient id="SVGFTmYVdBo" x1="3.603" x2="20.397" y1="12" y2="12" gradientUnits="userSpaceOnUse"><stop class="t25sync1b"/><stop offset="1" class="t3ietpblc"/></linearGradient></defs></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:dlc" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
