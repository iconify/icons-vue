...
const content = `<path class="tj085xb6p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:group-off-sharp" /></template>
<style>
.tj085xb6p {
  fill: currentColor;
