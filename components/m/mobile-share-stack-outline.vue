...
const content = `<path class="t6kqd5dkk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mobile-share-stack-outline" /></template>
<style>
.t6kqd5dkk {
  fill: currentColor;
