...
const content = `<path class="tkg710b_j"/><path class="zazi__pfw"/><path class="pav86w_yu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-svelte" /></template>
<style>
.pav86w_yu {
...
.tkg710b_j {
  fill: var(--svg-color--ff815a, #ff815a);
