...
const content = `<path class="qkc_pnhru"/><path class="gb5ovy6fx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-mark-email-read" /></template>
<style>
.gb5ovy6fx {
  fill: currentColor;
