...
const content = `<g class="cuyn6tgcc"><path class="k88fxymmp"/><path class="g1j_m9bqh"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:traffic-sign-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.k88fxymmp {
  d: path("M237.49 134.05L134.05 237.49a8.54 8.54 0 0 1-12.1 0L18.51 134.05a8.54 8.54 0 0 1 0-12.1L122 18.51a8.54 8.54 0 0 1 12.1 0L237.49 122a8.54 8.54 0 0 1 0 12.05");
