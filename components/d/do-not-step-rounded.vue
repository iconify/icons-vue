...
const content = `<path class="jhr81vbzc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:do-not-step-rounded" /></template>
<style>
.jhr81vbzc {
  fill: currentColor;
