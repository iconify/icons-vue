...
const content = `<path class="aezkjhb2s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:apps-list-32-regular" /></template>
<style>
.aezkjhb2s {
  fill: currentColor;
