...
const content = `<path class="zeebntbsf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dishwasher-outline" /></template>
<style>
.zeebntbsf {
  fill: currentColor;
