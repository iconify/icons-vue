...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:durak" /></template>
<style>
.ars2uvi7b {
  fill: none;
  stroke: currentColor;
