...
const content = `<g class="nrj6p8qat"><path class="bp-w5nx6c"/><path class="ui1v-pbxk"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:calendar-zap-duotone" /></template>
<style>
.bp-w5nx6c {
  fill: currentColor;
