...
const content = `<path class="xqiiysm4m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:file-map-stack-outline-sharp" /></template>
<style>
.xqiiysm4m {
  fill: currentColor;
