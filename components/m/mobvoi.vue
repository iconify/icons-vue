...
const content = `<path class="mbge5fbfr"/><path class="y4-v73wzl"/><path class="mt3ugfl6p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:mobvoi" /></template>
<style>
.mbge5fbfr {
  fill: none;
  stroke: currentColor;
