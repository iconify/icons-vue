...
const content = `<path class="v7aen3buy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mic-settings-24-regular" /></template>
<style>
.v7aen3buy {
  fill: currentColor;
