...
const content = `<path class="ajrfhvb9f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-bar-vertical-arrow-down-24-regular" /></template>
<style>
.ajrfhvb9f {
  fill: currentColor;
