...
const content = `<path class="julpvkb9y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:ssid-chart-outline" /></template>
<style>
.julpvkb9y {
  fill: currentColor;
