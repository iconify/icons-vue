...
const content = `<path class="i19ue8b3w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:new-label" /></template>
<style>
.i19ue8b3w {
  fill: currentColor;
