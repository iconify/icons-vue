...
const content = `<path class="opcenrk-b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cards-star-outline-sharp" /></template>
<style>
.opcenrk-b {
  fill: currentColor;
