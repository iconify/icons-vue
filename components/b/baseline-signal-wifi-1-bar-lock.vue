...
const content = `<path class="xpa4zjbgw"/><path class="bxixdwdoe"/><path class="niufhab5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-signal-wifi-1-bar-lock" /></template>
<style>
.bxixdwdoe {
  fill: currentColor;
