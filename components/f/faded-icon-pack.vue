...
const content = `<path class="whvegrbth"/><path class="pwah1qiqd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:faded-icon-pack" /></template>
<style>
.pwah1qiqd {
  fill: none;
  stroke: currentColor;
