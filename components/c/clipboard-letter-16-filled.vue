...
const content = `<g class="cuyn6tgcc"><path class="tgknekbuc"/><path class="k3lcwabfx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:clipboard-letter-16-filled" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
