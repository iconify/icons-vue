...
const content = `<path class="sjmg5cidj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:your-trips" /></template>
<style>
.sjmg5cidj {
  fill: currentColor;
