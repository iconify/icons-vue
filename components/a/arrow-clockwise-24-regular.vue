...
const content = `<path class="jyajco2du"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-clockwise-24-regular" /></template>
<style>
.jyajco2du {
  fill: currentColor;
