...
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:search-minus-duotone" /></template>
<style>
.cobiw4baz {
  d: path("M15 15L21 21M7 10L13 10");
}
