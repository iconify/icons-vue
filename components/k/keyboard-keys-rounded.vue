...
const content = `<path class="v_xcp9bbl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-keys-rounded" /></template>
<style>
.v_xcp9bbl {
  fill: currentColor;
