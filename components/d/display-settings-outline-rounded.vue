...
const content = `<path class="a6agofblf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:display-settings-outline-rounded" /></template>
<style>
.a6agofblf {
  fill: currentColor;
