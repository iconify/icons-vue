...
const content = `<path class="lcjqtwczs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:content-paste-off-outline-sharp" /></template>
<style>
.lcjqtwczs {
  fill: currentColor;
