...
const content = `<path class="cyg--ovjd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:magnifying-glass-minus-bold" /></template>
<style>
.cyg--ovjd {
  fill: currentColor;
