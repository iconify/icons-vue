...
const content = `<path class="wppyv6b7v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bubbles-sharp" /></template>
<style>
.wppyv6b7v {
  fill: currentColor;
