...
const content = `<path class="ta73_99xr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:game-button-l-outline-sharp" /></template>
<style>
.ta73_99xr {
  fill: currentColor;
