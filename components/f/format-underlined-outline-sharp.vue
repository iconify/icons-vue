...
const content = `<path class="gjava7b-w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-underlined-outline-sharp" /></template>
<style>
.gjava7b-w {
  fill: currentColor;
