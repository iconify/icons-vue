...
const content = `<path class="m8azdhbub"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:energy-savings-leaf-sharp" /></template>
<style>
.m8azdhbub {
  fill: currentColor;
