...
const content = `<path class="m_omhqr4i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:climate-mini-split-outline" /></template>
<style>
.m_omhqr4i {
  fill: currentColor;
