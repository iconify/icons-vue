...
const content = `<path class="qtmt2zw-i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-error-20-regular" /></template>
<style>
.qtmt2zw-i {
  fill: currentColor;
