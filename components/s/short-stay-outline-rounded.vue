...
const content = `<path class="e9hvwqk2z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:short-stay-outline-rounded" /></template>
<style>
.e9hvwqk2z {
  fill: currentColor;
