...
const content = `<path class="a__sysbox"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:macro-auto-outline-rounded" /></template>
<style>
.a__sysbox {
  fill: currentColor;
