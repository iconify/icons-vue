...
const content = `<path class="e3vskx0nh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:flex-no-wrap-rounded" /></template>
<style>
.e3vskx0nh {
  fill: currentColor;
