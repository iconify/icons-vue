...
const content = `<path class="ps4wsqybg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:unfold-more-rounded" /></template>
<style>
.ps4wsqybg {
  fill: currentColor;
