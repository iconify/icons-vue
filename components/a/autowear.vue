...
const content = `<circle class="t238zrbfy"/><path class="pjsj-tbfo"/><path class="b2to3db_c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:autowear" /></template>
<style>
.b2to3db_c {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M20.792 16.854h6.716v3.679h-6.716zm0 5.306h6.716v3.68h-6.716zm-.15 5.308h6.716v3.679h-6.716zm8.709 1.371s4.378-4.735-.054-9.44m-10.648 9.425s-4.378-4.737.054-9.44");
}
