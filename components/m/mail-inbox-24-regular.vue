...
const content = `<path class="ytjmombsh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-inbox-24-regular" /></template>
<style>
.ytjmombsh {
  fill: currentColor;
