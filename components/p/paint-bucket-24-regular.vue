...
const content = `<path class="ymgtqg47r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:paint-bucket-24-regular" /></template>
<style>
.ymgtqg47r {
  fill: currentColor;
