...
const content = `<path class="z2jr2o6cy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:id-card-sharp" /></template>
<style>
.z2jr2o6cy {
  fill: none;
  stroke: currentColor;
