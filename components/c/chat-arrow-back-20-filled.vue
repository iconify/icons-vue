...
const content = `<path class="h0ilq7zqy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chat-arrow-back-20-filled" /></template>
<style>
.h0ilq7zqy {
  fill: currentColor;
