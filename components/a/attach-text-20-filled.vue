...
const content = `<path class="ziwkb-xcx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:attach-text-20-filled" /></template>
<style>
.ziwkb-xcx {
  fill: currentColor;
