...
const content = `<path class="ybpkxcl-z"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:barcode-scanner-16-regular" /></template>
<style>
.ybpkxcl-z {
  fill: currentColor;
