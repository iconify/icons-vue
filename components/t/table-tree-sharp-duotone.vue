...
const content = `<g class="gp_8x1bzb"><path class="v8hgvi38z"/><path class="zyu_ccbvv"/><path class="y4d-7n49k"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:table-tree-sharp-duotone" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
