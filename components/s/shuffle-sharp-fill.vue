...
const content = `<path class="kn62k951t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:shuffle-sharp-fill" /></template>
<style>
.kn62k951t {
  fill: none;
  stroke: currentColor;
