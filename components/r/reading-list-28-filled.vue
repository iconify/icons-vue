...
const content = `<path class="vqre6snkd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:reading-list-28-filled" /></template>
<style>
.vqre6snkd {
  fill: currentColor;
