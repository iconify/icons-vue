...
const content = `<path class="bsum68b-a"/><path class="ixji6ioom"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:sparkling-heart" /></template>
<style>
.bsum68b-a {
