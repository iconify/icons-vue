...
const content = `<path class="o37j_00wg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-grammar-dismiss-20-filled" /></template>
<style>
.o37j_00wg {
  fill: currentColor;
