...
const content = `<path class="ner90pb9w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fire-extinguisher-outline-sharp" /></template>
<style>
.ner90pb9w {
  fill: currentColor;
