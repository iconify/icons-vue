...
const content = `<g class="y9tr6bcfx"><path class="lzmqmbdid"/><path class="z5xi9jbqx"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:slitherlink" /></template>
<style>
.lzmqmbdid {
