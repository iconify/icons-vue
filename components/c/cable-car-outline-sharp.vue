...
const content = `<path class="kwa_vynzj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cable-car-outline-sharp" /></template>
<style>
.kwa_vynzj {
  fill: currentColor;
