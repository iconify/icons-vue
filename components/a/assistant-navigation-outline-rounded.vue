...
const content = `<path class="uvlhdi-ox"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:assistant-navigation-outline-rounded" /></template>
<style>
.uvlhdi-ox {
  fill: currentColor;
