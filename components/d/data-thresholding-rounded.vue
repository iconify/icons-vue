...
const content = `<path class="hnnb1452q"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:data-thresholding-rounded" /></template>
<style>
.hnnb1452q {
  fill: currentColor;
