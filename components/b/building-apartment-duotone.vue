...
const content = `<g class="cuyn6tgcc"><path class="upuwh9b9d"/><path class="gpyndrbqk"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:building-apartment-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
...
.upuwh9b9d {
  d: path("M224 72v144h-80v-48h-32v48H32V104h48V40h96v32Z");
