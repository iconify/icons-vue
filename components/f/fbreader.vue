...
const content = `<path class="pu172hbfg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fbreader" /></template>
<style>
.pu172hbfg {
  fill: none;
  stroke: currentColor;
