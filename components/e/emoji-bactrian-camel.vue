...
const content = `<path class="unqpdwbvf"/><path class="mf-3w120h"/><path class="oqerujbiu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:emoji-bactrian-camel" /></template>
<style>
.mf-3w120h {
  fill: none;
  stroke: currentColor;
...
.oqerujbiu {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M33.359 25.255c.276.735.566 1.471.803 2.207m7.247-7.233c-.984-.75-1.142-.663-1.758-.897");
}
