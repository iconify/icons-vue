...
const content = `<g class="cuyn6tgcc"><path class="wj6n_hb5d"/><path class="zawlaubkc"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:star-and-crescent-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
