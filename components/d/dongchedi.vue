...
const content = `<path class="byivusbpv"/><path class="pcycbw-ab"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:dongchedi" /></template>
<style>
.byivusbpv {
  fill: none;
  stroke: currentColor;
