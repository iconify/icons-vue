...
const content = `<path class="r9439db0n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:radio-button-24-filled" /></template>
<style>
.r9439db0n {
  fill: currentColor;
