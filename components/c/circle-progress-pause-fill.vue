...
const content = `<path class="vy7gtmbed"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-progress-pause-fill" /></template>
<style>
.vy7gtmbed {
  fill: none;
  stroke: currentColor;
