...
const content = `<path class="kt992f6wb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-multiple-24-filled" /></template>
<style>
.kt992f6wb {
  fill: currentColor;
