...
const content = `<g class="cuyn6tgcc"><path class="m5hszsbyv"/><path class="vhj5su52s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:mouse-simple-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
