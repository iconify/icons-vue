...
const content = `<path class="hut_02afo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:password-2-off-outline-rounded" /></template>
<style>
.hut_02afo {
  fill: currentColor;
