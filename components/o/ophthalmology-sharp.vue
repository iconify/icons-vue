...
const content = `<path class="g38rmacmv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:ophthalmology-sharp" /></template>
<style>
.g38rmacmv {
  fill: currentColor;
