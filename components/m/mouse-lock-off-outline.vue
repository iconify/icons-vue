...
const content = `<path class="r81950b3m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:mouse-lock-off-outline" /></template>
<style>
.r81950b3m {
  fill: currentColor;
