...
const content = `<path class="t6cf7mbjg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:people-checkmark-24-regular" /></template>
<style>
.t6cf7mbjg {
  fill: currentColor;
