...
const content = `<path class="a0vfanb9d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:screen-rotation-up-sharp" /></template>
<style>
.a0vfanb9d {
  fill: currentColor;
