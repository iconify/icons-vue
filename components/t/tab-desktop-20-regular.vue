...
const content = `<path class="a1qbtqbym"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:tab-desktop-20-regular" /></template>
<style>
.a1qbtqbym {
  fill: currentColor;
