...
const content = `<path class="im5-fh8df"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:data-bar-vertical-16-regular" /></template>
<style>
.im5-fh8df {
  fill: currentColor;
