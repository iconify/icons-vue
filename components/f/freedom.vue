...
const content = `<path class="yg-tpck8w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:freedom" /></template>
<style>
.yg-tpck8w {
  fill: none;
  stroke: currentColor;
