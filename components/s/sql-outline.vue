...
const content = `<path class="x0mkzccff"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sql-outline" /></template>
<style>
.x0mkzccff {
  fill: currentColor;
