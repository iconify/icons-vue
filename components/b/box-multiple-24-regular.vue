...
const content = `<path class="v-2sktbww"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:box-multiple-24-regular" /></template>
<style>
.v-2sktbww {
  fill: currentColor;
