...
const content = `<path class="pf6hp8bio"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:notes-rounded" /></template>
<style>
.pf6hp8bio {
  fill: currentColor;
