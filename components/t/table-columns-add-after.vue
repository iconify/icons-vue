...
const content = `<path class="v68m2fc6k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:table-columns-add-after" /></template>
<style>
.v68m2fc6k {
  fill: none;
  stroke: currentColor;
