...
const content = `<path class="kp-kk6yos"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:center-horizontal-24-regular" /></template>
<style>
.kp-kk6yos {
  fill: currentColor;
