...
const content = `<path class="yl9zlxb9x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:settings-input-component" /></template>
<style>
.yl9zlxb9x {
  fill: currentColor;
