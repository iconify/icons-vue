...
const content = `<path class="jtiq49-zo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:clock-arrow-up-sharp" /></template>
<style>
.jtiq49-zo {
  fill: none;
  stroke: currentColor;
