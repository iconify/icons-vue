...
const content = `<path class="zw4r-6bip"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:edit-note-outline-sharp" /></template>
<style>
.zw4r-6bip {
  fill: currentColor;
