...
const content = `<path class="nxwlvwbif"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:resize-table-24-filled" /></template>
<style>
.nxwlvwbif {
  fill: currentColor;
