...
const content = `<path class="efle9eb5y"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lookyourloot" /></template>
<style>
.efle9eb5y {
  fill: none;
  stroke: currentColor;
