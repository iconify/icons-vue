...
const content = `<path class="b-9inxaad"/><path class="xg1a5ks4s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:circle-wavy-duotone" /></template>
<style>
.b-9inxaad {
  fill: currentColor;
