...
const content = `<path class="enk28pe8k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:clear-day-rounded" /></template>
<style>
.enk28pe8k {
  fill: currentColor;
