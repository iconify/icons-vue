...
const content = `<path class="eyvfl4h4a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:chat-centered-dots-bold" /></template>
<style>
.eyvfl4h4a {
  fill: currentColor;
