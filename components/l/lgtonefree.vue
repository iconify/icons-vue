...
const content = `<path class="senusqa2m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:lgtonefree" /></template>
<style>
.senusqa2m {
  fill: none;
  stroke: currentColor;
