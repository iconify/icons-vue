...
const content = `<path class="djavwobyp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:puzzle-cube-24-regular" /></template>
<style>
.djavwobyp {
  fill: currentColor;
