...
const content = `<g class="cuyn6tgcc"><path class="r0gxw56ki"/><path class="q8loy-b5i"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:music-note-single-circle-off" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
