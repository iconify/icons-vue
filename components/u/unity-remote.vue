...
const content = `<path class="j-eqmmtob"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:unity-remote" /></template>
<style>
.j-eqmmtob {
  fill: none;
  stroke: currentColor;
