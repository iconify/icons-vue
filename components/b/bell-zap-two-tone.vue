...
const content = `<g class="nrj6p8qat"><path class="yp6w4xkla"/><path class="j162g8bdm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:bell-zap-two-tone" /></template>
<style>
.j162g8bdm {
