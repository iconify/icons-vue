...
const content = `<g class="cuyn6tgcc"><path class="onrdkub8r"/><path class="y_eppp-yq"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:chart-line-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
