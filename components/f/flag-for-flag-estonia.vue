...
const content = `<path class="ubq_58bja"/><path class="dtf4y2b9t"/><path class="tou9icbzd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-estonia" /></template>
<style>
.dtf4y2b9t {
