...
const content = `<path class="a5u9acb4x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:convert-range-24-regular" /></template>
<style>
.a5u9acb4x {
  fill: currentColor;
