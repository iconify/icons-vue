...
const content = `<path class="rqy8_oyby"/><path class="xbxhvibrw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-room-service" /></template>
<style>
.rqy8_oyby {
  fill: currentColor;
