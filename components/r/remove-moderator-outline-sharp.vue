...
const content = `<path class="fe8xzbcxu"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:remove-moderator-outline-sharp" /></template>
<style>
.fe8xzbcxu {
  fill: currentColor;
