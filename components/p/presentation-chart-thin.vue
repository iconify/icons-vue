...
const content = `<path class="z_2zs0bkm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:presentation-chart-thin" /></template>
<style>
.z_2zs0bkm {
  fill: currentColor;
