...
const content = `<path clip-rule="evenodd" class="ow0agqb6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-alert-fill" /></template>
<style>
.ow0agqb6i {
  fill: currentColor;
  fill-rule: evenodd;
