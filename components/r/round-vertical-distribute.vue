...
const content = `<path class="v-cyhfb8g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-vertical-distribute" /></template>
<style>
.v-cyhfb8g {
  fill: currentColor;
