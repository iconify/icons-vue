...
const content = `<path class="sf2faxb0a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:mail-pause-16-filled" /></template>
<style>
.sf2faxb0a {
  fill: currentColor;
