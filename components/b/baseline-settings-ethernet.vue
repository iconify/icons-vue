...
const content = `<path class="p0fl37bcy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:baseline-settings-ethernet" /></template>
<style>
.p0fl37bcy {
  fill: currentColor;
