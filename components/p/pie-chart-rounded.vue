...
const content = `<path class="au6-c-b3i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:pie-chart-rounded" /></template>
<style>
.au6-c-b3i {
  fill: currentColor;
