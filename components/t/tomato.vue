...
const content = `<path class="j80eurbxv"/><path class="ki4fccoxd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tomato" /></template>
<style>
.j80eurbxv {
  fill: none;
  stroke: currentColor;
