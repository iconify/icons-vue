...
const content = `<path class="ekdm3tudg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:arrow-right-alt-outline-rounded" /></template>
<style>
.ekdm3tudg {
  fill: currentColor;
