...
const content = `<path class="cm01wsb_l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:share-ios-48-filled" /></template>
<style>
.cm01wsb_l {
  fill: currentColor;
