...
const content = `<g class="gp_8x1bzb"><path class="t8drw368i"/><path class="roob0fhsb"/><path class="fxypyjbih"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:gauge-sharp-two-tone" /></template>
<style>
.fxypyjbih {
  fill: currentColor;
...
.roob0fhsb {
  d: path("M22 12C22 17.5228 17.5228 22 12 22C6.4772 22 2 17.5228 2 12C2 6.4772 6.4772 2 12 2C17.5228 2 22 6.4772 22 12ZM12 12L12 6");
}
