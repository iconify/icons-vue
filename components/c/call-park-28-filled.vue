...
const content = `<path class="fy40y6g_m"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-park-28-filled" /></template>
<style>
.fy40y6g_m {
  fill: currentColor;
