...
const content = `<path class="rr-tbw28r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:backlight-low-outline-rounded" /></template>
<style>
.rr-tbw28r {
  fill: currentColor;
