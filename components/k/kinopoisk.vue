...
const content = `<path class="kc8nlp2gv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:kinopoisk" /></template>
<style>
.kc8nlp2gv {
  fill: none;
  stroke: currentColor;
