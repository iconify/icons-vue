...
const content = `<path class="uxuoqvbzf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:eraser-small-20-regular" /></template>
<style>
.uxuoqvbzf {
  fill: currentColor;
