...
const content = `<path class="wy_0l13ev"/><path class="or50o2b4g"/><circle class="d981hsizk"/><circle class="ek542kbtn"/><circle class="ggfwjjbyi"/><circle class="d8t40cboz"/><path class="ipo337byp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:rocket" /></template>
<style>
.d8t40cboz {
  cx: 53.771px;
  cy: 14.8px;
