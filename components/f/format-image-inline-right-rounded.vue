...
const content = `<path class="akfrrvbkg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-image-inline-right-rounded" /></template>
<style>
.akfrrvbkg {
  fill: currentColor;
