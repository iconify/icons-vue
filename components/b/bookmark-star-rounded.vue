...
const content = `<path class="n-ookzbrk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:bookmark-star-rounded" /></template>
<style>
.n-ookzbrk {
  fill: currentColor;
