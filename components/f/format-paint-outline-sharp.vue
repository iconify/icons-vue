...
const content = `<path class="e7650gbfv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:format-paint-outline-sharp" /></template>
<style>
.e7650gbfv {
  fill: currentColor;
