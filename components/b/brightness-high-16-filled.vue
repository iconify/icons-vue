...
const content = `<path class="esq6f_bxf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:brightness-high-16-filled" /></template>
<style>
.esq6f_bxf {
  fill: currentColor;
