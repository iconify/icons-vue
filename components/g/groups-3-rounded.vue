...
const content = `<path class="k86chmgpq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:groups-3-rounded" /></template>
<style>
.k86chmgpq {
  fill: currentColor;
