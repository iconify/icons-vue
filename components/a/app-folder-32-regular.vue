...
const content = `<path class="hywbsqb-c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:app-folder-32-regular" /></template>
<style>
.hywbsqb-c {
  fill: currentColor;
