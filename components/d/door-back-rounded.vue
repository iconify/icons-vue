...
const content = `<path class="p_ua0yb4w"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:door-back-rounded" /></template>
<style>
.p_ua0yb4w {
  fill: currentColor;
