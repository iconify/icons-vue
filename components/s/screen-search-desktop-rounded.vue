...
const content = `<path class="ixd2whg4v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:screen-search-desktop-rounded" /></template>
<style>
.ixd2whg4v {
  fill: currentColor;
