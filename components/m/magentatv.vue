...
const content = `<rect class="j3s9ivbxi"/><path class="urit8gmvl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:magentatv" /></template>
<style>
.j3s9ivbxi {
  width: 37px;
  height: 37px;
