...
const content = `<path class="l9pfxsbjc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-bend-double-up-right-thin" /></template>
<style>
.l9pfxsbjc {
  fill: currentColor;
