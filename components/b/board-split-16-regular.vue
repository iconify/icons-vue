...
const content = `<path class="ag6gag7km"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:board-split-16-regular" /></template>
<style>
.ag6gag7km {
  fill: currentColor;
