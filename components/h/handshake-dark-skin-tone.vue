...
const content = `<path class="y_g-ue1zh"/><g class="w89d9nsjy"><path class="kl68i8bgp"/><path class="x57g7cbon"/></g><path class="e1avnhwsp"/><path class="synulxbju"/><path class="jo21i8bra"/><path class="runr8790n"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione:handshake-dark-skin-tone" /></template>
<style>
.e1avnhwsp {
