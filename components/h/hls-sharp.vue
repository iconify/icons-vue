...
const content = `<path class="ilmqwzeda"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:hls-sharp" /></template>
<style>
.ilmqwzeda {
  fill: currentColor;
