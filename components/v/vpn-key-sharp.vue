...
const content = `<path class="zt4hywb-s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:vpn-key-sharp" /></template>
<style>
.zt4hywb-s {
  fill: currentColor;
