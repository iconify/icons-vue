...
const content = `<path class="h5jjeib_b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:simpmusic" /></template>
<style>
.h5jjeib_b {
  fill: none;
  stroke: currentColor;
