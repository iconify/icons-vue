...
const content = `<path class="i0t1-ir_t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-export-ltr-20-regular" /></template>
<style>
.i0t1-ir_t {
  fill: currentColor;
