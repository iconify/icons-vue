...
const content = `<path class="lk3_0lbiz"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:goldenone" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
