...
const content = `<path class="or2b75b7t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:laptop-mac-rounded" /></template>
<style>
.or2b75b7t {
  fill: currentColor;
