...
const content = `<path class="umb9h1bpd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:cellular-4g-24-filled" /></template>
<style>
.umb9h1bpd {
  fill: currentColor;
