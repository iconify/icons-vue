...
const content = `<path class="iwdhzxttk"/><path class="exthxzbac"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-light-redux" /></template>
<style>
.exthxzbac {
...
.iwdhzxttk {
  fill: var(--svg-color--a699bf, #a699bf);
