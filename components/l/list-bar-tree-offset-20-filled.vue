...
const content = `<path class="kyf3vgbsy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:list-bar-tree-offset-20-filled" /></template>
<style>
.kyf3vgbsy {
  fill: currentColor;
