...
const content = `<path class="ql0f1jbxt"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:battery-share-outline-sharp" /></template>
<style>
.ql0f1jbxt {
  fill: currentColor;
