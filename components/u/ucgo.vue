...
const content = `<path class="qt2qaqb2w"/><path class="i9clfwm2k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ucgo" /></template>
<style>
.i9clfwm2k {
  fill: none;
  stroke: currentColor;
