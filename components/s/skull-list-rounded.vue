...
const content = `<path class="ezzr-0bxx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:skull-list-rounded" /></template>
<style>
.ezzr-0bxx {
  fill: currentColor;
