...
const content = `<path class="yj05tmxxx"/><path class="vndntrcrv"/><path class="y7ysveare"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-botswana" /></template>
<style>
.vndntrcrv {
