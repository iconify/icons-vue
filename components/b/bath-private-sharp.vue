...
const content = `<path class="spll9lbeg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bath-private-sharp" /></template>
<style>
.spll9lbeg {
  fill: currentColor;
