...
const content = `<path class="bqqkjfo0c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-phone-bluetooth-speaker" /></template>
<style>
.bqqkjfo0c {
  fill: currentColor;
