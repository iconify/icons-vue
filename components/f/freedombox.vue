...
const content = `<path class="hv_6-s1iw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:freedombox" /></template>
<style>
.hv_6-s1iw {
  fill: none;
  stroke: currentColor;
