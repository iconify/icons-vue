...
const content = `<path class="izjm0gbze"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:table-simple-checkmark-24-regular" /></template>
<style>
.izjm0gbze {
  fill: currentColor;
