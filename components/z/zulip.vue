...
const content = `<path class="ewy19bgxm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:zulip" /></template>
<style>
.ewy19bgxm {
  fill: none;
  stroke: currentColor;
