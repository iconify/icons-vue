...
const content = `<path class="fkpyysbtc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:call-transfer-24-regular" /></template>
<style>
.fkpyysbtc {
  fill: currentColor;
