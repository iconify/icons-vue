...
const content = `<path class="h0qgeuwow"/><path class="b8j-6z-ni"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:axet-file-manager" /></template>
<style>
.b8j-6z-ni {
  fill: none;
  stroke: currentColor;
