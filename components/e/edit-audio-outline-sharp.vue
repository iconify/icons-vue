...
const content = `<path class="e961-h68h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-audio-outline-sharp" /></template>
<style>
.e961-h68h {
  fill: currentColor;
