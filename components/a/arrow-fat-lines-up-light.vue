...
const content = `<path class="xrtbvkqwk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-fat-lines-up-light" /></template>
<style>
.xrtbvkqwk {
  fill: currentColor;
