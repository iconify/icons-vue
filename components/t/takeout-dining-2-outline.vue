...
const content = `<path class="sdbc6oo8v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:takeout-dining-2-outline" /></template>
<style>
.sdbc6oo8v {
  fill: currentColor;
