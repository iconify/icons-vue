...
const content = `<circle class="n1xy6nh9u"/><path class="pp3q-kvaj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:round-settings-applications" /></template>
<style>
.n1xy6nh9u {
  cx: 12px;
  cy: 12px;
