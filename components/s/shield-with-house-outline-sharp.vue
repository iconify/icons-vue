...
const content = `<path class="uyuq_pk7h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:shield-with-house-outline-sharp" /></template>
<style>
.uyuq_pk7h {
  fill: currentColor;
