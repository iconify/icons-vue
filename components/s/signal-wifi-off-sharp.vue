...
const content = `<path class="anjvf1bvl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:signal-wifi-off-sharp" /></template>
<style>
.anjvf1bvl {
  fill: currentColor;
