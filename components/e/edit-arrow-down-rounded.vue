...
const content = `<path class="ufs3vsb1k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:edit-arrow-down-rounded" /></template>
<style>
.ufs3vsb1k {
  fill: currentColor;
