...
const content = `<path class="u6wrcwkdw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:magnification-large-outline-rounded" /></template>
<style>
.u6wrcwkdw {
  fill: currentColor;
