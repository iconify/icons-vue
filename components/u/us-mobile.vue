...
const content = `<path class="qeveerbcm"/><path class="uu8qi8bcx"/><path class="xu8n5jbej"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:us-mobile" /></template>
<style>
.qeveerbcm {
  fill: none;
  stroke: currentColor;
  ...
  d: path("M16.35 29.97c1.872.893 3.954 1.334 6.06 1.72l-5.25-9.094h13.624");
}
