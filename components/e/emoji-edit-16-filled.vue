...
const content = `<path class="sym33_65h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-edit-16-filled" /></template>
<style>
.sym33_65h {
  fill: currentColor;
