...
const content = `<path class="mawct3gym"/><path class="wu8efm62y"/><path class="ys9oyvb-b"/><path class="pou5yswhm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-senegal" /></template>
<style>
.mawct3gym {
