...
const content = `<path class="swn8icjsf"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:fit-page-height-outline-rounded" /></template>
<style>
.swn8icjsf {
  fill: currentColor;
