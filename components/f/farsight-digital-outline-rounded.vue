...
const content = `<path class="y0e7mdbuc"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:farsight-digital-outline-rounded" /></template>
<style>
.y0e7mdbuc {
  fill: currentColor;
