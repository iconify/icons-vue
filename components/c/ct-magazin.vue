...
const content = `<path class="i9clfwm2k"/><path class="g6x-qui2p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ct-magazin" /></template>
<style>
.g6x-qui2p {
  fill: none;
  stroke: currentColor;
