...
const content = `<path class="ogp381bbc"/><path class="c67dtbqsj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:twotone-signal-wifi-3-bar" /></template>
<style>
.c67dtbqsj {
  fill: currentColor;
