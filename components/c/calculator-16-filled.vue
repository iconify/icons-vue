...
const content = `<path class="b1086-gch"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calculator-16-filled" /></template>
<style>
.b1086-gch {
  fill: currentColor;
