...
const content = `<defs><linearGradient id="SVGn2MHwese" x2="1" y1="500.019" y2="500.019" gradientTransform="rotate(-74.61 -56582.086 43258.207)scale(-173.67 173.67)" gradientUnits="userSpaceOnUse"><stop offset="0" class="cxqk8zbds"/><stop offset="1"/></linearGradient><linearGradient id="SVGVbV6qbuh" x2="1" y1="500.066" y2="500.066" gradientTransform="matrix(136.419 107.5 107.5 -136.419 -53573.749 68567.906)" gradientUnits="userSpaceOnUse"><stop offset="0" class="cxqk8zbds"/><stop offset="1" class="d9ofppbqf"/></linearGradient></defs><path class="jw_so-blo"/><path class="cskfjibci"/><path class="uphsg3b2c"/><path class="ksbqr1t8z"/><path fill="url(#SVGn2MHwese)" class="x3x-yvb5g"/><path class="mpde6ubvh"/><path class="o5otz7bts"/><path fill="url(#SVGVbV6qbuh)" class="vz2podbno"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:folder-type-cypress" /></template>
<style>
.cskfjibci {
