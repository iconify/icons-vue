...
const content = `<path class="rlp4m1tta"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bomb-outline" /></template>
<style>
.rlp4m1tta {
  fill: currentColor;
