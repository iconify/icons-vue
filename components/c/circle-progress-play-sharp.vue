...
const content = `<path class="yo36oacna"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-progress-play-sharp" /></template>
<style>
.yo36oacna {
  fill: none;
  stroke: currentColor;
