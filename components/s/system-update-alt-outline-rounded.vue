...
const content = `<path class="ifajkh67u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:system-update-alt-outline-rounded" /></template>
<style>
.ifajkh67u {
  fill: currentColor;
