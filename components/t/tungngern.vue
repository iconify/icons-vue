...
const content = `<path class="sfha3l_sr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:tungngern" /></template>
<style>
.sfha3l_sr {
  fill: none;
  stroke: currentColor;
