...
const content = `<g clip-rule="evenodd" class="n1lsf0bnc"><path class="iwv9-sbrd"/><path class="hdxpysbbn"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:heart-circle" /></template>
<style>
.hdxpysbbn {
