...
const content = `<path class="a-jw8fbgp"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:play-shapes-rounded" /></template>
<style>
.a-jw8fbgp {
  fill: currentColor;
