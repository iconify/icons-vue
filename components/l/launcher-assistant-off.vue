...
const content = `<path class="klqch9c5x"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:launcher-assistant-off" /></template>
<style>
.klqch9c5x {
  fill: currentColor;
