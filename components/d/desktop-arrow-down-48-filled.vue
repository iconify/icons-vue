...
const content = `<path class="mumn5y6hb"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:desktop-arrow-down-48-filled" /></template>
<style>
.mumn5y6hb {
  fill: currentColor;
