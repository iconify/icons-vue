...
const content = `<g class="nrj6p8qat"><path class="tx_ah59as"/><path class="er1p0-brb"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:circle-more-horizontal" /></template>
<style>
.er1p0-brb {
  fill: currentColor;
