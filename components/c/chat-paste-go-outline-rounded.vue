...
const content = `<path class="kr9m10ohn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:chat-paste-go-outline-rounded" /></template>
<style>
.kr9m10ohn {
  fill: currentColor;
