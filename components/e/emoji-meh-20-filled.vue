...
const content = `<path class="xa0hq58cq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-meh-20-filled" /></template>
<style>
.xa0hq58cq {
  fill: currentColor;
