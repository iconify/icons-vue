...
const content = `<g class="ft5dv1b6b"><path class="mw0wx4bna"/><path class="ryrnxtbqj"/><path clip-rule="evenodd" class="s1v9cvbzr"/><path class="o0ixjj85c"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:polc" /></template>
<style>
.ft5dv1b6b {
  fill: none;
}
