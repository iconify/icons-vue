...
const content = `<path class="gkyce-kez"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:keyboard-shift-uppercase-20-regular" /></template>
<style>
.gkyce-kez {
  fill: currentColor;
