...
const content = `<path class="akpolacpl"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:arrow-square-down-24-filled" /></template>
<style>
.akpolacpl {
  fill: currentColor;
