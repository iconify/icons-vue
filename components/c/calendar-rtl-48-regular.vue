...
const content = `<path class="d_g13t1fo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:calendar-rtl-48-regular" /></template>
<style>
.d_g13t1fo {
  fill: currentColor;
