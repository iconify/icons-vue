...
const content = `<path class="uvuoi1jgw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-meh-24-filled" /></template>
<style>
.uvuoi1jgw {
  fill: currentColor;
