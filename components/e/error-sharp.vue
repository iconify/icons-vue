...
const content = `<path class="a1ok-y37p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:error-sharp" /></template>
<style>
.a1ok-y37p {
  fill: currentColor;
