...
const content = `<path class="ab1-szb3l"/><path class="tvkhl6h3a"/><path class="lh6d3obip"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:automatag" /></template>
<style>
.ab1-szb3l {
  fill: none;
  stroke: currentColor;
