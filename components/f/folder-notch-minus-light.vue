...
const content = `<path class="fu1vo4blm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:folder-notch-minus-light" /></template>
<style>
.fu1vo4blm {
  fill: currentColor;
