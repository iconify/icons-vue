...
const content = `<path class="s1vvtqbkq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:house-siding-outline-sharp" /></template>
<style>
.s1vvtqbkq {
  fill: currentColor;
