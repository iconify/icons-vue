...
const content = `<g class="nrj6p8qat"><path class="dl2nz2boo"/><path class="jqyjtvb9i"/><path class="xw2-rqb8f"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:table-cells-merge-duotone" /></template>
<style>
.dl2nz2boo {
  fill: currentColor;
