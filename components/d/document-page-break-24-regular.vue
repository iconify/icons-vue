...
const content = `<path class="usi0e-bgq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:document-page-break-24-regular" /></template>
<style>
.usi0e-bgq {
  fill: currentColor;
