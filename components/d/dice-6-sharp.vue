...
const content = `<g class="gp_8x1bzb"><path class="x-_5ilohg"/><path class="nk5pr_b_i"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:dice-6-sharp" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
