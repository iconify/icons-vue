...
const content = `<path class="me1frcc7b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:convert-to-type-24-regular" /></template>
<style>
.me1frcc7b {
  fill: currentColor;
