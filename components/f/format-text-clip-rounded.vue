...
const content = `<path class="sfvy-y8qw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:format-text-clip-rounded" /></template>
<style>
.sfvy-y8qw {
  fill: currentColor;
