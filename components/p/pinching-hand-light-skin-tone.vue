...
const content = `<path class="q4fd3repj"/><path class="iz94c5t7l"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="twemoji:pinching-hand-light-skin-tone" /></template>
<style>
.iz94c5t7l {
