...
const content = `<path class="nl0xqgboa"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:keyboard-dock-20-filled" /></template>
<style>
.nl0xqgboa {
  fill: currentColor;
