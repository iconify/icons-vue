...
const content = `<path class="vklhhsxmo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:source-notes-sharp" /></template>
<style>
.vklhhsxmo {
  fill: currentColor;
