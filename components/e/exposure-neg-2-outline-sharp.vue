...
const content = `<path class="ng14uib8d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:exposure-neg-2-outline-sharp" /></template>
<style>
.ng14uib8d {
  fill: currentColor;
