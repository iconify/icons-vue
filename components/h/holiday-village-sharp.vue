...
const content = `<path class="zulkekpcy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:holiday-village-sharp" /></template>
<style>
.zulkekpcy {
  fill: currentColor;
