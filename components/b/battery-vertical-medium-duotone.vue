...
const content = `<g class="cuyn6tgcc"><path class="ichl0c_jx"/><path class="v1c8hac-f"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:battery-vertical-medium-duotone" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
