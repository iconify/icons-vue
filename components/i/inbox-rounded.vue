...
const content = `<path class="s0xwvlb3d"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:inbox-rounded" /></template>
<style>
.s0xwvlb3d {
  fill: currentColor;
