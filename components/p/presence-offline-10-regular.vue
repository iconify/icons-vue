...
const content = `<path class="zrjw-7bpi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:presence-offline-10-regular" /></template>
<style>
.zrjw-7bpi {
  fill: currentColor;
