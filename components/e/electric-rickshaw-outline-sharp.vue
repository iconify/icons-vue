...
const content = `<path class="ahe96fb6i"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:electric-rickshaw-outline-sharp" /></template>
<style>
.ahe96fb6i {
  fill: currentColor;
