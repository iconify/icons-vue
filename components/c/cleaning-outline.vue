...
const content = `<path class="cewgiccbg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:cleaning-outline" /></template>
<style>
.cewgiccbg {
  fill: currentColor;
