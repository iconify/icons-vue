...
const content = `<g class="gp_8x1bzb"><path clip-rule="evenodd" class="zv_0vqboe"/><path class="y16ih9r-s"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:database-arrow-left-sharp-fill" /></template>
<style>
.gp_8x1bzb {
  fill: none;
  stroke: currentColor;
