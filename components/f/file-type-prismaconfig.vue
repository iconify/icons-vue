...
const content = `<path class="b3ih33bds"/><path class="p3nnhp3za"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="vscode-icons:file-type-prismaconfig" /></template>
<style>
.b3ih33bds {
