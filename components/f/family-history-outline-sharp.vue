...
const content = `<path class="nrxswsbqh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:family-history-outline-sharp" /></template>
<style>
.nrxswsbqh {
  fill: currentColor;
