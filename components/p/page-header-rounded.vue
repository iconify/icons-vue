...
const content = `<path class="nwz4kbbim"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:page-header-rounded" /></template>
<style>
.nwz4kbbim {
  fill: currentColor;
