...
const content = `<rect class="j3s9ivbxi"/><path class="tp5q4xbao"/><ellipse class="kd6bc46rf"/><path class="sh1-s5bjs"/>`;
</script>
...
.tp5q4xbao {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M21.195 29.585c.99 0 1.792.796 1.792 1.779v1.156c0 .982-.802 1.778-1.792 1.778h0c-.99 0-1.792-.796-1.792-1.778v-1.156c0-.983.802-1.779 1.792-1.779m-10.71 1.779c0-.982.802-1.779 1.792-1.779s1.792.797 1.792 1.779v2.935m-3.584-4.714v4.714m3.584-2.935c0-.982.802-1.779 1.792-1.779s1.792.797 1.792 1.779v2.935");
}
