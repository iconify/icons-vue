...
const content = `<path class="umz1s6bel"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:3d-rotation-outline" /></template>
<style>
.umz1s6bel {
  fill: currentColor;
