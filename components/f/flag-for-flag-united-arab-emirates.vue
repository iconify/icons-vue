...
const content = `<path class="hwk5csx9o"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-monotone:flag-for-flag-united-arab-emirates" /></template>
<style>
.hwk5csx9o {
  fill: currentColor;
