...
const content = `<path class="tqdyuqa_t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:align-top-24-regular" /></template>
<style>
.tqdyuqa_t {
  fill: currentColor;
