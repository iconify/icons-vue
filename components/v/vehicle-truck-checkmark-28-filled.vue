...
const content = `<path class="fb7j6gikh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:vehicle-truck-checkmark-28-filled" /></template>
<style>
.fb7j6gikh {
  fill: currentColor;
