...
const content = `<path class="cwknql68a"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:airplane-take-off-20-filled" /></template>
<style>
.cwknql68a {
  fill: currentColor;
