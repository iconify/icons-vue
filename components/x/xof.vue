...
const content = `<circle class="cpk0fnbgt"/><path class="oxax_n1og"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:xof" /></template>
<style>
.cpk0fnbgt {
  cx: 24px;
  cy: 24px;
