...
const content = `<path class="e8rhe5lge"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:music-note-1-24-filled" /></template>
<style>
.e8rhe5lge {
  fill: currentColor;
