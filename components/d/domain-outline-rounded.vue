...
const content = `<path class="ps9kitbnz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:domain-outline-rounded" /></template>
<style>
.ps9kitbnz {
  fill: currentColor;
