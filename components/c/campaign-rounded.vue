...
const content = `<path class="rmk1ijb3t"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:campaign-rounded" /></template>
<style>
.rmk1ijb3t {
  fill: currentColor;
