...
const content = `<path class="hvs528yfs"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:selection-background-thin" /></template>
<style>
.hvs528yfs {
  fill: currentColor;
