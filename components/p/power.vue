...
const content = `<g class="cuyn6tgcc"><path class="qi4azoban"/><rect class="t9nly_bze"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="pepicons-pop:power" /></template>
<style>
.cuyn6tgcc {
  fill: currentColor;
}
