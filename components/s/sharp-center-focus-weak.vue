...
const content = `<path class="t1qmdlbks"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ic:sharp-center-focus-weak" /></template>
<style>
.t1qmdlbks {
  fill: currentColor;
