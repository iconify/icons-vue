...
const content = `<path class="qqgrjvp2b"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:hr-resting-outline" /></template>
<style>
.qqgrjvp2b {
  fill: currentColor;
