...
const content = `<path class="d65kvlbgx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:border-right-24-filled" /></template>
<style>
.d65kvlbgx {
  fill: currentColor;
