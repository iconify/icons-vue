...
const content = `<path class="bt3_gjgyh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:image-split-24-regular" /></template>
<style>
.bt3_gjgyh {
  fill: currentColor;
