...
const content = `<path class="qgm_dzbvg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:music-video-sharp" /></template>
<style>
.qgm_dzbvg {
  fill: currentColor;
