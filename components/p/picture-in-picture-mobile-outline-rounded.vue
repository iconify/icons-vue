...
const content = `<path class="oplugoo7h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:picture-in-picture-mobile-outline-rounded" /></template>
<style>
.oplugoo7h {
  fill: currentColor;
