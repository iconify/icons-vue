...
const content = `<path class="c-t6p0t5r"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:devices-fold-2-rounded" /></template>
<style>
.c-t6p0t5r {
  fill: currentColor;
