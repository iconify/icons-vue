...
const content = `<path class="mw26v2bxn"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:vacuum-2-rounded" /></template>
<style>
.mw26v2bxn {
  fill: currentColor;
