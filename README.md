...
```bash
npm install gitlab:iconify-icons/vue#{prefix}
```
...
```bash
npm install gitlab:iconify-icons/vue#mdi
```
...
- [#vscode-icons](https://github.com/iconify/icons-vue/tree/vscode-icons): **VSCode Icons** (1597 icons, MIT)
