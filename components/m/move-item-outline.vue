...
const content = `<path class="fw1dxnbbq"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:move-item-outline" /></template>
<style>
.fw1dxnbbq {
  fill: currentColor;
