...
const content = `<path class="ay690b4kj"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:text-font-20-regular" /></template>
<style>
.ay690b4kj {
  fill: currentColor;
