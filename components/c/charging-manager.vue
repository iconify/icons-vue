...
const content = `<path class="q0sow6whe"/><path class="mvcif148g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:charging-manager" /></template>
<style>
.mvcif148g {
  fill: none;
  stroke: currentColor;
