...
const content = `<path class="gqpqzgnis"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:network-check-24-filled" /></template>
<style>
.gqpqzgnis {
  fill: currentColor;
