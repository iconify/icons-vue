...
const content = `<path class="yw0p4tclx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:head-mounted-device-sharp" /></template>
<style>
.yw0p4tclx {
  fill: currentColor;
