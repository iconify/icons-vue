...
const content = `<path class="f3pvvrbqw"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:arrow-forward-ios-outline-rounded" /></template>
<style>
.f3pvvrbqw {
  fill: currentColor;
