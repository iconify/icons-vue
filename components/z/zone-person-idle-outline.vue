...
const content = `<path class="jo075v9fy"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:zone-person-idle-outline" /></template>
<style>
.jo075v9fy {
  fill: currentColor;
