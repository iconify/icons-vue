...
const content = `<path class="jb-h0d41v"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:camera-off-24-regular" /></template>
<style>
.jb-h0d41v {
  fill: currentColor;
