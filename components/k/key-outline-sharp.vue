...
const content = `<path class="i60u6mq8s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:key-outline-sharp" /></template>
<style>
.i60u6mq8s {
  fill: currentColor;
