...
const content = `<path class="f_xedebwo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:arrow-u-down-right-bold" /></template>
<style>
.f_xedebwo {
  fill: currentColor;
