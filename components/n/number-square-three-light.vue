...
const content = `<path class="t5gytqbgm"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="ph:number-square-three-light" /></template>
<style>
.t5gytqbgm {
  fill: currentColor;
