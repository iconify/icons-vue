...
const content = `<path class="yovyx_bgh"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:goldex" /></template>
<style>
.yovyx_bgh {
  fill: none;
  stroke: currentColor;
