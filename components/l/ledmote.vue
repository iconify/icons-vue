...
const content = `<rect class="uul2cmi7x"/><path class="fumew9bsr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:ledmote" /></template>
<style>
.fumew9bsr {
  fill: none;
  stroke: currentColor;
