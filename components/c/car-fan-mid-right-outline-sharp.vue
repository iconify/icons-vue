...
const content = `<path class="nes-3hp9j"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:car-fan-mid-right-outline-sharp" /></template>
<style>
.nes-3hp9j {
  fill: currentColor;
