...
const content = `<path class="jeq6w547p"/><path class="nbtbbbb7v"/><circle class="m37ka3bpg"/><path class="c9xi8xbkr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:hearthstone" /></template>
<style>
.c9xi8xbkr {
  fill: none;
  stroke: currentColor;
...
.nbtbbbb7v {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m2.5 24l1-.578l7.156-4.14M2.5 24h7.35");
}
