...
const content = `<path class="xt3lmbccm"/><path class="vrgiaybvo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:slovenija" /></template>
<style>
.vrgiaybvo {
  fill: none;
  stroke: currentColor;
