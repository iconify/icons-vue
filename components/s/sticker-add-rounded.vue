...
const content = `<path class="qg-508bhz"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:sticker-add-rounded" /></template>
<style>
.qg-508bhz {
  fill: currentColor;
