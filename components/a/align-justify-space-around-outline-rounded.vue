...
const content = `<path class="oyo461bbk"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:align-justify-space-around-outline-rounded" /></template>
<style>
.oyo461bbk {
  fill: currentColor;
