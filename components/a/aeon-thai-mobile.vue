...
const content = `<path class="aydfdqolp"/><path class="j08rfw_ku"/><path class="ai54ch02g"/><rect class="j3s9ivbxi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:aeon-thai-mobile" /></template>
<style>
.ai54ch02g {
  fill: none;
  stroke: currentColor;
