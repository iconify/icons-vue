...
const content = `<path class="af__z6b6f"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:blinds-2-closed-sharp" /></template>
<style>
.af__z6b6f {
  fill: currentColor;
