...
const content = `<g class="nrj6p8qat"><path class="jfvoq9bhn"/><path class="zdgvfxbbv"/><path class="slz7u0oyn"/><path class="uea_ybysx"/><path class="it83nbbll"/><path class="coh5p5slf"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="iconmind:change-log-table-outline-regular" /></template>
<style>
.coh5p5slf {
