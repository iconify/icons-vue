...
const content = `<path class="tee70reex"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:undereye-outline-sharp" /></template>
<style>
.tee70reex {
  fill: currentColor;
