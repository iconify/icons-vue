...
const content = `<path class="iaqstha5p"/><path class="dcaedetha"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:fake-gps" /></template>
<style>
.dcaedetha {
  fill: none;
  stroke: currentColor;
