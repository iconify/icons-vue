...
const content = `<path class="x5_mo7b2c"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:float-portrait-2-outline-rounded" /></template>
<style>
.x5_mo7b2c {
  fill: currentColor;
