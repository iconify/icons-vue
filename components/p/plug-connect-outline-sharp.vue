...
const content = `<path class="qwzsm8brx"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:plug-connect-outline-sharp" /></template>
<style>
.qwzsm8brx {
  fill: currentColor;
