...
const content = `<path class="yyqmqxm4u"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:chevron-circle-up-12-regular" /></template>
<style>
.yyqmqxm4u {
  fill: currentColor;
