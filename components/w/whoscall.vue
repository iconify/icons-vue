...
const content = `<path class="f9lq3xjnz"/><path class="na11pk4kd"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:whoscall" /></template>
<style>
.f9lq3xjnz {
  fill: none;
  stroke: currentColor;
