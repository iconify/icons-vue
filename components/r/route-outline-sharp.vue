...
const content = `<path class="taljgidce"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:route-outline-sharp" /></template>
<style>
.taljgidce {
  fill: currentColor;
