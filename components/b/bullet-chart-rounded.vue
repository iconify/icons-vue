...
const content = `<path class="blqyq6d5g"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:bullet-chart-rounded" /></template>
<style>
.blqyq6d5g {
  fill: currentColor;
