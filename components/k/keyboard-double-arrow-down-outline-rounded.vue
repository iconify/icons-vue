...
const content = `<path class="dw4v1ubjg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:keyboard-double-arrow-down-outline-rounded" /></template>
<style>
.dw4v1ubjg {
  fill: currentColor;
