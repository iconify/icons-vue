...
const content = `<path class="hok3s6l4s"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:sip-outline-sharp" /></template>
<style>
.hok3s6l4s {
  fill: currentColor;
