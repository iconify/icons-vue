...
const content = `<path class="j38rvrbxg"/><path class="k8pu8bbdr"/><path class="pg5h2jkzu"/><path class="mbzw1rb8h"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="emojione-v1:flag-for-flag-united-arab-emirates" /></template>
<style>
.j38rvrbxg {
