...
const content = `<path class="dy-g9p80e"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:outlet-outline" /></template>
<style>
.dy-g9p80e {
  fill: currentColor;
