...
const content = `<path class="cezlqzgtz"/><path class="ksmcc-zyv"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="arcticons:phocus-launcher" /></template>
<style>
.cezlqzgtz {
  fill: none;
  stroke: currentColor;
