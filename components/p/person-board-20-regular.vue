...
const content = `<path class="ghnmh1uos"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:person-board-20-regular" /></template>
<style>
.ghnmh1uos {
  fill: currentColor;
