...
const content = `<path class="h157hjbyr"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:router-off-24-regular" /></template>
<style>
.h157hjbyr {
  fill: currentColor;
