...
const content = `<path class="ruzyr4bys"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:stars-rounded" /></template>
<style>
.ruzyr4bys {
  fill: currentColor;
