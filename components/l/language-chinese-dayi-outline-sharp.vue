...
const content = `<path class="xoysrvbec"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:language-chinese-dayi-outline-sharp" /></template>
<style>
.xoysrvbec {
  fill: currentColor;
