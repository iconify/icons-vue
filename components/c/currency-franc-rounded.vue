...
const content = `<path class="pjvteewdi"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols-light:currency-franc-rounded" /></template>
<style>
.pjvteewdi {
  fill: currentColor;
