...
const content = `<g class="ft5dv1b6b"><path class="pbn16bbkh"/><path class="d7z9pxtln"/><path class="mkhros8bw"/><path class="jwhqc3bbh"/><path class="sokb8bjfw"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="token-branded:brock" /></template>
<style>
.d7z9pxtln {
  fill: var(--svg-color--a2a3a5, #a2a3a5);
  d: path("M7.146 13.299A1105 1105 0 0 0 3.668 8.13c-.228-.333-.191-.587.259-.603l7.084-.747a.053.053 0 0 1 .053.053v.021L7.304 13.4a.05.05 0 0 1-.041.027a.05.05 0 0 1-.042-.021a1 1 0 0 1-.075-.106m13.051-5.766a.307.307 0 0 1 .249.328a.3.3 0 0 1-.053.143l-3.67 5.4a.03.03 0 0 1-.017.018a.03.03 0 0 1-.025-.001l-.01-.016l-3.76-6.55c-.031-.053-.015-.074.038-.074z");
}
