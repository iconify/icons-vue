...
const content = `<path clip-rule="evenodd" class="as3krsimg"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="keyline-icons:square-bar-chart-2-down-sharp-fill" /></template>
<style>
.as3krsimg {
  fill: currentColor;
  fill-rule: evenodd;
