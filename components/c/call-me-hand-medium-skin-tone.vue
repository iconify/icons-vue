...
const content = `<path class="kdb2flw9g"/><defs><path id="SVGVxHWicRa" class="bo062f-dp"/></defs><clipPath id="SVG4zYiZ8kd"><use href="#SVGVxHWicRa"/></clipPath><path clip-path="url(#SVG4zYiZ8kd)" class="fnyxfjbah"/><defs><use href="#SVGVxHWicRa" id="SVGPdwshbFC"/></defs><clipPath id="SVGCw0ZpeuJ"><use href="#SVGPdwshbFC"/></clipPath><g clip-path="url(#SVGCw0ZpeuJ)" class="lip7wrrrl"><path class="qczznxftm"/></g>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="noto:call-me-hand-medium-skin-tone" /></template>
<style>
.bo062f-dp {
