...
const content = `<path class="a0ftcsz8p"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:dine-heart-outline" /></template>
<style>
.a0ftcsz8p {
  fill: currentColor;
