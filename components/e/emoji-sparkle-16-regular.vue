...
const content = `<path class="c5nmc3t5k"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="fluent:emoji-sparkle-16-regular" /></template>
<style>
.c5nmc3t5k {
  fill: currentColor;
