...
const content = `<path class="dguy3klpo"/>`;
</script>
<template><Icon :width="width" :height="height" :viewBox="viewBox" :content="content" fallback="material-symbols:cloudy-snowing-sharp" /></template>
<style>
.dguy3klpo {
  fill: currentColor;
